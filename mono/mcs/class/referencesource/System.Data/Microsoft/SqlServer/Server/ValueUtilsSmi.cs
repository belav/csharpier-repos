    ...
    internal static class ValueUtilsSmi
    {
        ...
        )
        {
            ...
            length = CheckXetParameters(
                metaData.SqlDbType,
                metaData.MaxLength * sizeof(char),
                value.Length,
                fieldOffset,
                buffer.Length,
                bufferOffset,
        ...
        internal static long GetBytesInternal(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal,
            SmiMetaData metaData,
        ...
        internal static DateTimeOffset GetDateTimeOffset(
            ...
            int ordinal,
            SmiMetaData metaData,
            bool gettersSupportKatmaiDateTime
        )
        {
        ...
        internal static Int16 GetInt16(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal,
            SmiMetaData metaData
        ...
        internal static SqlBinary GetSqlBinary(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal,
            SmiMetaData metaData
        ...
        internal static SqlBoolean GetSqlBoolean(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal,
            SmiMetaData metaData
        ...
        internal static SqlByte GetSqlByte(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal,
            SmiMetaData metaData
        ...
        internal static SqlDateTime GetSqlDateTime(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal,
            SmiMetaData metaData
        ...
        internal static SqlDecimal GetSqlDecimal(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal,
            SmiMetaData metaData
        ...
        internal static SqlDouble GetSqlDouble(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal,
            SmiMetaData metaData
        ...
        internal static SqlGuid GetSqlGuid(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal,
            SmiMetaData metaData
        ...
        internal static SqlInt16 GetSqlInt16(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal,
            SmiMetaData metaData
        ...
        internal static SqlInt32 GetSqlInt32(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal,
            SmiMetaData metaData
        ...
        internal static SqlInt64 GetSqlInt64(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal,
            SmiMetaData metaData
        ...
        internal static SqlMoney GetSqlMoney(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal,
            SmiMetaData metaData
        ...
        internal static SqlSingle GetSqlSingle(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal,
            SmiMetaData metaData
        ...
        internal static SqlSequentialStreamSmi GetSequentialStream(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal,
            SmiMetaData metaData,
        ...
        {
            Debug.Assert(
                !ValueUtilsSmi.IsDBNull_Unchecked(sink, getters, ordinal),
                "Should not try to get a SqlSequentialStreamSmi on a null column"
            );
            ThrowIfITypedGettersIsNull(sink, getters, ordinal);
            if (
                (!bypassTypeCheck)
        ...
        internal static SqlSequentialTextReaderSmi GetSequentialTextReader(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal,
            SmiMetaData metaData
        )
        {
            Debug.Assert(
                !ValueUtilsSmi.IsDBNull_Unchecked(sink, getters, ordinal),
                "Should not try to get a SqlSequentialTextReaderSmi on a null column"
            );
            ThrowIfITypedGettersIsNull(sink, getters, ordinal);
        ...
        internal static TextReader GetTextReader(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal,
            SmiMetaData metaData
            ...
            else
            {
                switch (metaData.SqlDbType)
                {
                    case SqlDbType.Variant: // Handle variants specifically for v200, since they could contain v200 types
                        ...
                        Debug.Assert(
                            SqlDbType.Variant != metaData.SqlDbType,
        ...
        internal static SqlBuffer.StorageType SqlDbTypeToStorageType(SqlDbType dbType)
        {
            ...
            Debug.Assert(
                index >= 0 && index < __dbTypeToStorageType.Length,
                string.Format(CultureInfo.InvariantCulture, "Unexpected dbType value: {0}", dbType)
            );
            ...
            else
            {
                switch (metaData.SqlDbType)
                {
                    ...
                    case SqlDbType.Real:
                        ...
                        break;
                    case SqlDbType.UniqueIdentifier:
                        targetBuffer.SqlGuid = new SqlGuid(
                            GetGuid_Unchecked(sink, getters, ordinal)
                        );
                        break;
                    case SqlDbType.SmallInt:
            ...
            else
            {
                switch (metaData.SqlDbType)
                {
                    ...
                    case SqlDbType.Date:
                        ...
                        break;
                    case SqlDbType.DateTime2:
                        targetBuffer.SetToDateTime2(
                            GetDateTime_Unchecked(sink, getters, ordinal),
                            metaData.Scale
                        );
                        break;
                    case SqlDbType.Time:
                        targetBuffer.SetToTime(
                            GetTimeSpan_Unchecked(sink, getters, ordinal),
                            metaData.Scale
                        );
                        break;
                    case SqlDbType.DateTimeOffset:
                        targetBuffer.SetToDateTimeOffset(
                            GetDateTimeOffset_Unchecked(sink, getters, ordinal),
                            metaData.Scale
                        );
                        break;
                    default:
                        result = GetOutputParameterV3Smi(
                            sink,
                            getters,
                            ordinal,
                            metaData,
        ...
        //      2) push the data
        internal static void SetDBNull(
            SmiEventSink_Default sink,
        ...
        internal static void SetBoolean(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        internal static long SetBytesLength(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        internal static void SetDateTimeOffset(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        internal static void SetDecimal(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        internal static void SetSingle(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        internal static void SetSqlBoolean(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        internal static void SetSqlByte(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        internal static void SetSqlBytes(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        internal static void SetSqlChars(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        internal static void SetSqlDateTime(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        internal static void SetSqlDecimal(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        internal static void SetSqlDouble(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        internal static void SetSqlGuid(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        internal static void SetSqlInt16(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        internal static void SetSqlInt32(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        internal static void SetSqlInt64(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        internal static void SetSqlMoney(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        internal static void SetSqlSingle(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        internal static void SetSqlString(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        internal static void SetSqlXml(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        internal static void SetTimeSpan(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        )
        {
            ...
            Debug.Assert(
                (
                    ExtendedClrTypeCode.DataTable != typeCode
        ...
        )
        {
            ...
            switch (typeCode)
            {
                ...
                case ExtendedClrTypeCode.IEnumerableOfSqlDataRecord:
                    SetIEnumerableOfSqlDataRecord_Unchecked(
                        sink,
                        setters,
                        ordinal,
                        metaData,
                ...
                else
                {
                    switch (metaData[i].SqlDbType)
                    {
                        ...
                        case SqlDbType.Binary:
                            ...
                            ValueUtilsSmi.SetSqlBytes_LengthChecked(
                                sink,
                                setters,
                                i,
                                metaData[i],
                                reader.GetSqlBytes(i),
                                0
                            );
                            break;
                        case SqlDbType.Bit:
                        ...
                        case SqlDbType.Money:
                            ...
                            SetSqlMoney_Unchecked(
                                sink,
                                setters,
                                i,
                                metaData[i],
                                reader.GetSqlMoney(i)
                            );
                            break;
                        case SqlDbType.NChar:
                        case SqlDbType.NText:
                        ...
                        case SqlDbType.Variant:
                            ...
                            ExtendedClrTypeCode typeCode =
                                MetaDataUtilsSmi.DetermineExtendedTypeCode(o);
                        ...
                        default:
                            ...
                            Debug.Assert(
                                false,
                                "unsupported DbType:" + metaData[i].SqlDbType.ToString()
                            );
        ...
        //  Assumes caller enforces that reader and setter metadata are compatible
        internal static void FillCompatibleSettersFromReader(
            SmiEventSink_Default sink,
            SmiTypedGetterSetter setters,
            IList<SmiExtendedMetaData> metaData,
            DbDataReader reader
        )
        {
                    ...
                    switch (metaData[i].SqlDbType)
                    {
                        ...
                        case SqlDbType.Decimal:
                            { // block to scope sqlReader local to avoid conflicts
                                ...
                                if (null != sqlReader)
                                {
                                    SetSqlDecimal_Unchecked(
                                        sink,
                                        setters,
                                        i,
                                        sqlReader.GetSqlDecimal(i)
                                    );
                                }
                                else
                                {
                                    SetSqlDecimal_Unchecked(
                                        ...
                                        setters,
                                        i,
                                        new SqlDecimal(reader.GetDecimal(i))
                                    );
                                }
                            }
                            break;
                        ...
                        case SqlDbType.Money:
                            ...
                            SetSqlMoney_Checked(
                                ...
                                i,
                                metaData[i],
                                new SqlMoney(reader.GetDecimal(i))
                            );
                            break;
                        case SqlDbType.NChar:
                        case SqlDbType.NText:
                        ...
                        case SqlDbType.Variant:
                            { // block to scope sqlReader local and avoid conflicts
                                ...
                                if (
                                    (storageType == SqlBuffer.StorageType.DateTime2)
        ...
        internal static void FillCompatibleITypedSettersFromRecord(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            SmiMetaData[] metaData,
        ...
        internal static void FillCompatibleITypedSettersFromRecord(
            ...
            SmiMetaData[] metaData,
            SqlDataRecord record,
            SmiDefaultFieldsProperty useDefaultValues
        )
        {
            for (int i = 0; i < metaData.Length; ++i)
            {
        ...
        internal static void FillCompatibleSettersFromRecord(
            SmiEventSink_Default sink,
            SmiTypedGetterSetter setters,
            SmiMetaData[] metaData,
            SqlDataRecord record,
        ...
        internal static SqlStreamChars CopyIntoNewSmiScratchStreamChars(
            Stream source,
            SmiEventSink_Default sink,
            SmiContext context
        )
        {
            SqlClientWrapperSmiStreamChars dest = new SqlClientWrapperSmiStreamChars(
                sink,
                context.GetScratchStream(sink)
            );
        ...
        //
        private static object GetUdt_LengthChecked(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal,
            SmiMetaData metaData
        ...
        private static Decimal GetDecimal_PossiblyMoney(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal,
            SmiMetaData metaData
        )
        {
            ...
            {
                Debug.Assert(
                    SqlDbType.Money == metaData.SqlDbType
        ...
        private static void SetDateTime_Checked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        )
        {
            ...
            SetDateTime_Unchecked(
                sink,
                setters,
                ordinal,
                ((SqlDbType.Date == metaData.SqlDbType) ? value.Date : value)
            );
        }

        private static void SetTimeSpan_Checked(
            SmiEventSink_Default sink,
            SmiTypedGetterSetter setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        private static void SetSqlDateTime_Checked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        private static void SetDateTime2_Checked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        private static void SetDate_Checked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        private static void SetSqlMoney_Checked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        )
        {
            if (!value.IsNull && SqlDbType.SmallMoney == metaData.SqlDbType)
            {
                ...
                if (
                    TdsEnums.SQL_SMALL_MONEY_MIN > decimalValue
                    || TdsEnums.SQL_SMALL_MONEY_MAX < decimalValue
                )
                {
        ...
        private static void SetByteArray_LengthChecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        private static void SetCharArray_LengthChecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        private static void SetSqlBinary_LengthChecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        private static void SetBytes_FromRecord(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        private static void SetBytes_FromReader(
            SmiEventSink_Default sink,
            SmiTypedGetterSetter setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        )
        {
            ...
            length = CheckXetParameters(
                ...
                ,
                0,
                NoLengthLimit /* buffer length */
                ,
                offset,
                NoLengthLimit /* requested length */
            );
        ...
        private static void SetSqlBytes_LengthChecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        private static void SetChars_FromRecord(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        )
        {
            ...
            length = CheckXetParameters(
                ...
                checked((int)bufferLength),
                offset,
                checked((int)bufferLength - offset)
            );
            ...
            {
                charsWritten = setters.SetChars(
                    sink,
                    ordinal,
                    currentOffset,
                    buffer,
                    0,
                    checked((int)charsRead)
                );
                sink.ProcessMessagesAndThrow();
                checked
                {
        ...
        private static void SetCharsOrString_FromReader(
            SmiEventSink_Default sink,
            SmiTypedGetterSetter setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        private static void SetChars_FromReader(
            SmiEventSink_Default sink,
            SmiTypedGetterSetter setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        )
        {
            ...
            int length = CheckXetParameters(
                ...
                value.Length,
                0,
                NoLengthLimit /* buffer */
                ,
                offset,
                NoLengthLimit /* request */
            );
        ...
        private static void SetSqlChars_LengthChecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        private static void SetSqlString_LengthChecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        private static void SetString_LengthChecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        )
        {
            int length = CheckXetParameters(
                ...
                value.Length,
                offset,
                checked(value.Length - offset)
            );
            Debug.Assert(length >= 0, "value.Length was invalid!");
            SetString_Unchecked(sink, setters, ordinal, value, offset, length);
        }

        private static void SetUdt_LengthChecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        private static void ThrowIfInvalidSetterAccess(
            SmiMetaData metaData,
            ExtendedClrTypeCode setterTypeCode
        )
        {
        ...
        private static void ThrowIfITypedGettersIsNull(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal
        )
        ...
        )
        {
            ...
            Debug.Assert(
                ExtendedClrTypeCode.First == 0
                    && (int)ExtendedClrTypeCode.Last == __canAccessGetterDirectly.GetLength(0) - 1,
                "ExtendedClrTypeCodes does not match with __canAccessGetterDirectly"
            );
            Debug.Assert(
                SqlDbType.BigInt == 0
                    && (int)SqlDbType.DateTimeOffset == __canAccessGetterDirectly.GetLength(1) - 1,
                "SqlDbType does not match with __canAccessGetterDirectly"
            );
            Debug.Assert(
                ExtendedClrTypeCode.First <= setterTypeCode
                    && ExtendedClrTypeCode.Last >= setterTypeCode
            );
            Debug.Assert(
                SqlDbType.BigInt <= metaData.SqlDbType
                    && SqlDbType.DateTimeOffset >= metaData.SqlDbType
            );

            bool returnValue = __canAccessGetterDirectly[
                (int)setterTypeCode,
                (int)metaData.SqlDbType
            ];
        ...
        )
        {
            ...
            Debug.Assert(
                ExtendedClrTypeCode.First == 0
                    && (int)ExtendedClrTypeCode.Last == __canAccessSetterDirectly.GetLength(0) - 1,
                "ExtendedClrTypeCodes does not match with __canAccessSetterDirectly"
            );
            Debug.Assert(
                SqlDbType.BigInt == 0
                    && (int)SqlDbType.DateTimeOffset == __canAccessSetterDirectly.GetLength(1) - 1,
                "SqlDbType does not match with __canAccessSetterDirectly"
            );
            Debug.Assert(
                ExtendedClrTypeCode.First <= setterTypeCode
                    && ExtendedClrTypeCode.Last >= setterTypeCode
            ...
            bool returnValue = __canAccessSetterDirectly[
                (int)setterTypeCode,
                (int)metaData.SqlDbType
            ];
        ...
        )
        {
            ...
            Debug.Assert(
                0 > maxLength || 0 > actualLength || maxLength >= actualLength,
                "Actual = " + actualLength + ", max = " + maxLength + ", sqldbtype=" + dbType
            );
        ...
        //
        private static bool IsDBNull_Unchecked(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal
        )
        ...
        private static bool GetBoolean_Unchecked(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal
        )
        ...
        private static byte GetByte_Unchecked(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal
        )
        ...
        private static byte[] GetByteArray_Unchecked(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal
        )
        ...
        internal static int GetBytes_Unchecked(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal,
            long fieldOffset,
        ...
        )
        {
            ...
            Debug.Assert(
                bufferOffset >= 0 && length >= 0 && bufferOffset + length <= buffer.Length,
                string.Format(
                    "Bad offset or length. bufferOffset: {0}, length: {1}, buffer.Length{2}",
                    bufferOffset,
                    length,
                    buffer.Length
                )
        ...
        private static long GetBytesLength_Unchecked(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal
        )
        ...
        private static char[] GetCharArray_Unchecked(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal
        )
        ...
        internal static int GetChars_Unchecked(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal,
            long fieldOffset,
        ...
        private static long GetCharsLength_Unchecked(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal
        )
        ...
        private static DateTime GetDateTime_Unchecked(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal
        )
        ...
        private static DateTimeOffset GetDateTimeOffset_Unchecked(
            SmiEventSink_Default sink,
            SmiTypedGetterSetter getters,
            int ordinal
        )
        ...
        private static Double GetDouble_Unchecked(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal
        )
        ...
        private static Guid GetGuid_Unchecked(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal
        )
        ...
        private static Int16 GetInt16_Unchecked(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal
        )
        ...
        private static Int32 GetInt32_Unchecked(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal
        )
        ...
        private static Int64 GetInt64_Unchecked(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal
        )
        ...
        private static Single GetSingle_Unchecked(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal
        )
        ...
        private static SqlBinary GetSqlBinary_Unchecked(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal
        )
        ...
        private static SqlDecimal GetSqlDecimal_Unchecked(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal
        )
        ...
        private static SqlMoney GetSqlMoney_Unchecked(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal
        )
        ...
        private static String GetString_Unchecked(
            SmiEventSink_Default sink,
            ITypedGettersV3 getters,
            int ordinal
        )
        ...
        private static TimeSpan GetTimeSpan_Unchecked(
            SmiEventSink_Default sink,
            SmiTypedGetterSetter getters,
            int ordinal
        )
        ...
        private static void SetBoolean_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            Boolean value
        ...
        private static void SetByteArray_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            byte[] buffer,
        ...
        private static void SetStream_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metadata,
        ...
        private static void SetTextReader_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metadata,
        ...
        private static void SetByte_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            Byte value
        ...
        private static int SetBytes_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            long fieldOffset,
        ...
        private static void SetCharArray_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            char[] buffer,
        ...
        private static int SetChars_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            long fieldOffset,
        ...
        private static void SetDBNull_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal
        )
        ...
        private static void SetDecimal_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            Decimal value
        ...
        private static void SetDateTime_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            DateTime value
        ...
        private static void SetDateTime2_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        private static void SetDate_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        private static void SetTimeSpan_Unchecked(
            SmiEventSink_Default sink,
            SmiTypedGetterSetter setters,
            int ordinal,
            TimeSpan value
        ...
        private static void SetDateTimeOffset_Unchecked(
            SmiEventSink_Default sink,
            SmiTypedGetterSetter setters,
            int ordinal,
            DateTimeOffset value
        ...
        private static void SetDouble_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            Double value
        ...
        private static void SetGuid_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            Guid value
        ...
        private static void SetInt16_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            Int16 value
        ...
        private static void SetInt32_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            Int32 value
        ...
        private static void SetInt64_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            Int64 value
        ...
        private static void SetSingle_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            Single value
        ...
        private static void SetSqlBinary_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SqlBinary value,
        ...
        private static void SetSqlBoolean_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SqlBoolean value
        ...
        private static void SetSqlByte_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SqlByte value
        ...
        private static void SetSqlBytes_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SqlBytes value,
        ...
        private static void SetSqlChars_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SqlChars value,
        ...
        private static void SetSqlDecimal_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SqlDecimal value
        ...
        private static void SetSqlDouble_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SqlDouble value
        ...
        private static void SetSqlGuid_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SqlGuid value
        ...
        private static void SetSqlInt16_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SqlInt16 value
        ...
        private static void SetSqlInt32_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SqlInt32 value
        ...
        private static void SetSqlInt64_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SqlInt64 value
        ...
        private static void SetSqlMoney_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        private static void SetSqlSingle_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SqlSingle value
        ...
        private static void SetSqlString_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SmiMetaData metaData,
        ...
        private static void SetSqlXml_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            SqlXml value
        ...
        private static void SetXmlReader_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            XmlReader xmlReader
        )
        {
            ...
            System.IO.Stream target = new SmiSettersStream(
                sink,
                setters,
                ordinal,
        ...
        private static void SetString_Unchecked(
            SmiEventSink_Default sink,
            ITypedSettersV3 setters,
            int ordinal,
            String value,
        ...
        )
        {
            ...
            try
            {
                ...
                SmiExtendedMetaData[] mdFields = new SmiExtendedMetaData[
                    metaData.FieldMetaData.Count
                ];
                metaData.FieldMetaData.CopyTo(mdFields, 0);

                SmiDefaultFieldsProperty defaults = (SmiDefaultFieldsProperty)
                    metaData.ExtendedProperties[SmiPropertySelector.DefaultFields];
                ...
                if (null != peekAhead && null != peekAhead.FirstRecord)
                {
                    ...
                    setters.NewElement(sink);
                    sink.ProcessMessagesAndThrow();
                    FillCompatibleSettersFromRecord(
                        sink,
                        setters,
                        mdFields,
                        peekAhead.FirstRecord,
                        defaults
                    );
                    recordNumber++;
                }
                ...
                using (enumerator)
                {
                    while (enumerator.MoveNext())
                    {
                        ...
                        {
                            if (
                                !MetaDataUtilsSmi.IsCompatible(
                                    metaData.FieldMetaData[i],
                                    record.GetSqlMetaData(i)
                                )
                            )
                            {
                                throw SQL.EnumeratedRecordMetaDataChanged(
                                    record.GetName(i),
                                    recordNumber
                                );
                            }
