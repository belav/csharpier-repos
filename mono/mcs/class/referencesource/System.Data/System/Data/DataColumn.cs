...
namespace System.Data
{
    ...
    [
        ...
        Editor(
            "Microsoft.VSDesigner.Data.Design.DataColumnEditor, " + AssemblyRef.MicrosoftVSDesigner,
    ...
    public class DataColumn : MarshalByValueComponent
    {
        ...
        public bool AllowDBNull
        {
            ...
            set
            {
                ...
                Bid.ScopeEnter(
                    out hscp,
                    "<ds.DataColumn.set_AllowDBNull|API> %d#, %d{bool}\n",
                    ObjectID,
                    value
                );
                try
        ...
        {
            get { return ((null != autoInc) && (autoInc.Auto)); }
            set
            {
        ...
        internal object AutoIncrementCurrent
        {
            ...
            {
                if (
                    (System.Numerics.BigInteger)this.AutoIncrementSeed
                    != BigIntegerStorage.ConvertToBigInteger(value, this.FormatProvider)
                )
                {
        ...
        {
            get { return ((null != this.autoInc) ? this.autoInc.Seed : 0L); }
            set
            {
                Bid.Trace(
                    "<ds.DataColumn.set_AutoIncrementSeed|API> %d#, %I64d\n",
                    ObjectID,
                    value
                );
        ...
        {
            get { return ((null != this.autoInc) ? this.autoInc.Step : 1L); }
            set
            {
                Bid.Trace(
                    "<ds.DataColumn.set_AutoIncrementStep|API> %d#, %I64d\n",
                    ObjectID,
                    value
                );
        ...
        {
            get { return (caption != null) ? caption : _columnName; }
            set
            {
                if (value == null)
                    value = "";
                ...
                if (dataType != value)
                {
                    ...
                    if (!DefaultValueIsNull)
                    {
                        try
                        {
                            ...
                            {
                                this.defaultValue = BigIntegerStorage.ConvertFromBigInteger(
                                    (System.Numerics.BigInteger)this.defaultValue,
                                    value,
                                    this.FormatProvider
                                );
                            }
                            ...
                            {
                                this.defaultValue = BigIntegerStorage.ConvertToBigInteger(
                                    this.defaultValue,
                                    this.FormatProvider
                                );
                            }
                            else if (typeof(string) == value)
                            { // since string types can be null in value! DO NOT REMOVE THIS
                    ...
                    if (AutoIncrement)
                    {
                        ...
                        if (null != this.autoInc)
                        {
                            ...
                            {
                                this.AutoInc.Current = (System.Numerics.BigInteger)
                                    (long)inc.Current;
                            }
                            else
                            {
                                this.AutoInc.Current = checked(
                                    (long)(System.Numerics.BigInteger)inc.Current
                                );
                            }
                        }
                    }
        ...
        public object DefaultValue
        {
            get
            {
                ...
                if (defaultValue == DBNull.Value && this.implementsINullable)
                    ...
                    defaultValueIsNull =
                        (
                            ...
                            || (
                                ...
                                && DataStorage.IsObjectSqlNull(newDefaultValue)
                            )
                        )
                            ? true
                            : false;
        ...
        {
            get { return (this.expression == null ? "" : this.expression.Expression); }
            set
            {
                IntPtr hscp;
                Bid.ScopeEnter(
        ...
        {
            get { return implementsINullable; }
        }

        internal bool ImplementsIChangeTracking
        {
            get { return implementsIChangeTracking; }
        }

        internal bool ImplementsIRevertibleChangeTracking
        {
            get { return implementsIRevertibleChangeTracking; }
        }
        ...
        private void SetMaxLengthSimpleType()
        {
            ...
            {
                Debug.Assert(
                    this.simpleType.CanHaveMaxLength(),
                    "expected simpleType to be string"
                );
        ...
        public int MaxLength
        {
            ...
            set
            {
                ...
                Bid.ScopeEnter(
                    out hscp,
                    "<ds.DataColumn.set_MaxLength|API> %d#, %d\n",
                    ObjectID,
                    value
                );
                    ...
                    if (
                        ...
                        || (
                            ...
                            && (
                                (table.DataSet == null)
                                || (
                                    !table.DataSet.fIsSchemaLoading
                                    && !table.DataSet.fInitInProgress
                                )
                            )
                        )
                    )
                    ...
                    if (unique != value)
                    {
                        ...
                        if (table != null)
                        {
                            if (value)
                            {
                                ...
                                Debug.Assert(
                                    table.Constraints.FindKeyConstraint(this) == null,
        ...
        /// </devdoc>
        [DefaultValue(MappingType.Element), ResDescriptionAttribute(Res.DataColumnMappingDescr)]
        ...
        protected internal void CheckNotAllowNull()
        {
            ...
            if (sortIndex != null)
            {
                if (sortIndex.IsKeyInIndex(_storage._nullValue))
        ...
        internal DataColumn Clone()
        {
            ...
            clone.defaultValueIsNull =
                (
                    ...
                    || (clone.ImplementsINullable && DataStorage.IsObjectSqlNull(defaultValue))
                )
                    ? true
                    : false;
        ...
        {
            get { return implementsIXMLSerializable; }
        }
        ...
        internal void AddDependentColumn(DataColumn expressionColumn)
        {
            ...
            Debug.Assert(
                !dependentColumns.Contains(expressionColumn),
        ...
        internal AutoIncrementValue Clone()
        {
            AutoIncrementValue clone =
                (this is AutoIncrementInt64)
                    ? (AutoIncrementValue)new AutoIncrementInt64()
                    : (AutoIncrementValue)new AutoIncrementBigInteger();
    ...
    internal sealed class AutoIncrementInt64 : AutoIncrementValue
    {
        ...
        {
            return (
                ((this.step < 0) && (value <= this.current))
                || ((0 < this.step) && (this.current <= value))
            );
        }
    }
    ...
    internal sealed class AutoIncrementBigInteger : AutoIncrementValue
    {
        ...
        internal override Type DataType
        {
            get { return typeof(System.Numerics.BigInteger); }
        }
