...
namespace System.Data
{
    ...
    [
        ...
        Editor(
            "Microsoft.VSDesigner.Data.Design.ForeignKeyConstraintEditor, "
    ...
    public class ForeignKeyConstraint : Constraint
    {
        ...
        /// <devdoc>
        ///    <para>
        ///       Initializes a new instance of the <see cref='System.Data.ForeignKeyConstraint'/> class
        ...
        )
        {
            ...
            //            ForeignKeyConstraint(constraintName, parentTableName, null, parentColumnNames,
        ...
        internal void CheckCanRemoveParentRow(DataRow row)
        {
            ...
            if (
                DataRelation
                    .GetChildRows(this.ParentKey, this.ChildKey, row, DataRowVersion.Default)
                    .Length > 0
            )
            {
        ...
        internal void CheckCascade(DataRow row, DataRowAction action)
        {
            ...
            try
            {
                ...
                else
                {
                    Debug.Assert(
                        false,
                        "attempt to cascade unknown action: " + ((Enum)action).ToString()
                    );
                }
            }
            finally
        ...
        /// <devdoc>
        /// <para>Gets a value indicating whether the current <see cref='System.Data.ForeignKeyConstraint'/>
        ...
        public override bool Equals(object key)
        {
            ...
            return this.ParentKey.ColumnsEqual(key2.ParentKey)
                && this.ChildKey.ColumnsEqual(key2.ChildKey);
        }
