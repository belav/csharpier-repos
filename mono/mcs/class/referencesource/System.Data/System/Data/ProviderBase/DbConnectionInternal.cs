...
namespace System.Data.ProviderBase
{
    ...
    { // V1.1.3300
        ...
        protected bool EnlistedTransactionDisposed
        {
            get
            {
                ...
                try
                {
                    ...
                    SysTx.Transaction currentEnlistedTransactionOriginal =
                        _enlistedTransactionOriginal;
                    if (currentEnlistedTransactionOriginal != null)
                    {
                        disposed =
                            currentEnlistedTransactionOriginal.TransactionInformation == null;
                    }
                    else
                    {
                    ...
                    try
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                if (
                                    this.GetType()
                                    != typeof(System.Data.SqlClient.SqlInternalConnectionSmi)
                                )
                                {
                                    Dispose();
                                }
        ...
        public virtual void Dispose()
        {
            ...
            SysTx.Transaction enlistedTransaction = Interlocked.Exchange(
                ref _enlistedTransaction,
                null
            );
        ...
        //  transaction.
        protected virtual void CleanupTransactionOnCompletion(SysTx.Transaction transaction) { }
        ...
        {
            transaction.TransactionCompleted += new SysTx.TransactionCompletedEventHandler(
