...
namespace System.Data.ProviderBase
{
    ...
    internal sealed class DbConnectionPool
    {
        ...
        {
            get { return _pooledDbAuthenticationContexts; }
        }
        ...
        private void CleanupCallback(Object state)
        {
            ...
            Bid.PoolerTrace(
                "<prov.DbConnectionPool.CleanupCallback|RES|INFO|CPOOL> %d#\n",
                ObjectID
            );
        ...
        {
            var poolGroupConnectionOptions =
                _connectionPoolGroup.ConnectionOptions as SqlConnectionString;
            ...
            switch (policy)
            {
                ...
                default:
                {
                    ...
                    Debug.Fail(
                        "Unknown PoolBlockingPeriod. Please specify explicit results in above switch case statement."
                    );
                    return true;
                }
            }
            ...
            do
            {
                ...
                try
                {
                    ...
                    while (_pendingOpens.TryDequeue(out next))
                    {
                        ...
                        {
#if DEBUG
                            System.Data.SqlClient.TdsParser.ReliabilitySection tdsReliabilitySection =
                                new System.Data.SqlClient.TdsParser.ReliabilitySection();
                        ...
                        if (NeedToReplenish)
                        {
                            ...
                            try
                            {
                                ...
                                else
                                {
                                    ...
                                    Bid.PoolerTrace(
                                        "<prov.DbConnectionPool.PoolCreateRequest|RES|CPOOL> %d#, PoolCreateRequest called WaitForSingleObject failed %d",
                                        ObjectID,
                                        waitResult
                                    );
                                }
                            ...
                            catch (Exception e)
                            {
                                ...
                                Bid.PoolerTrace(
                                    "<prov.DbConnectionPool.PoolCreateRequest|RES|CPOOL> %d#, PoolCreateRequest called CreateConnection which threw an exception: %ls",
                                    ObjectID,
                                    e
                                );
                            }
