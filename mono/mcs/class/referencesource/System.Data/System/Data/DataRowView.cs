...
namespace System.Data
{
            ...
            System.ComponentModel.INotifyPropertyChanged
    {
        ...
        private static PropertyDescriptorCollection zeroPropertyDescriptorCollection =
        ...
        public object this[string property]
        {
            get
            {
                ...
                if (null != column)
                {
                    ...
                    dataView.Table.DataSet != null
                    && dataView.Table.DataSet.Relations.Contains(property)
                )
                {
        ...
        {
            get { return Row.GetColumnError(colName); }
        }

        string System.ComponentModel.IDataErrorInfo.Error
        {
            get { return Row.RowError; }
        }
        ...
        {
            get { return (RowVersionDefault & ~DataRowVersion.Proposed); }
        }
        ...
        {
            get { return Row.GetDefaultRowVersion(dataView.RowStateFilter); }
        }
        ...
        public bool IsNew
        {
            get { return (_row == dataView.addNewRow); }
        }
        ...
        public bool IsEdit
        {
            get
            {
                return (
                    ...
                    || // It was edited or
                    delayBeginEdit
                ); // DataRowView.BegingEdit() was called, but not edited yet.
            }
        }
        ...
        PropertyDescriptorCollection ICustomTypeDescriptor.GetProperties(Attribute[] attributes)
        {
            return (
                dataView.Table != null
                    ? dataView.Table.GetPropertyDescriptorCollection(attributes)
