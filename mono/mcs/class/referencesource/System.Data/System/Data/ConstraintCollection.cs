...
namespace System.Data
{
    ...
    [
        ...
        Editor(
            "Microsoft.VSDesigner.Data.Design.ConstraintsCollectionEditor, "
    ...
    { // WebData 111752
        ...
        internal void Add(Constraint constraint, bool addUniqueWhenAddingForeign)
        {
            ...
            {
                throw ExceptionBuilder.DuplicateConstraint(
                    FindConstraint(constraint).ConstraintName
                );
            }
                ...
                else
                {
                    ...
                    for (int j = 0; j < colCount; j++)
                    {
                        if (constr.parentTableNamespace == null)
                            parents[j] = table.DataSet.Tables[constr.parentTableName].Columns[
