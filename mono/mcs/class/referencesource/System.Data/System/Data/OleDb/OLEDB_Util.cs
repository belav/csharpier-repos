    ...
    internal static class ODB
    {
        ...
        )
        {
            switch (status)
            {
                ...
                case DBStatus.E_BADACCESSOR:
                    builder.Append(
                        Res.GetString(
                            Res.OleDb_CommandParameterBadAccessor,
                ...
                case DBStatus.E_CANTCONVERTVALUE:
                    builder.Append(
                        Res.GetString(
                            Res.OleDb_CommandParameterCantConvertValue,
                            index.ToString(CultureInfo.InvariantCulture),
                            ""
                        )
                    );
                ...
                case DBStatus.E_SIGNMISMATCH:
                    builder.Append(
                        Res.GetString(
                            Res.OleDb_CommandParameterSignMismatch,
                            index.ToString(CultureInfo.InvariantCulture),
                            ""
                        )
                    );
                ...
                case DBStatus.E_DATAOVERFLOW:
                    builder.Append(
                        Res.GetString(
                            Res.OleDb_CommandParameterDataOverflow,
                            index.ToString(CultureInfo.InvariantCulture),
                            ""
                        )
                    );
                ...
                case DBStatus.E_UNAVAILABLE:
                    builder.Append(
                        Res.GetString(
                            Res.OleDb_CommandParameterUnavailable,
                            index.ToString(CultureInfo.InvariantCulture),
                            ""
                        )
                    );
                ...
                case DBStatus.S_DEFAULT: // MDAC 66626
                    builder.Append(
                        Res.GetString(
                            Res.OleDb_CommandParameterDefault,
                            index.ToString(CultureInfo.InvariantCulture),
                            ""
                        )
                    );
        ...
        internal static Exception UninitializedParameters(int index, OleDbType dbtype)
        {
            return ADP.InvalidOperation(
                Res.GetString(
                    Res.OleDb_UninitializedParameters,
                    index.ToString(CultureInfo.InvariantCulture),
                    dbtype.ToString()
                )
            );
        ...
        )
        {
            ...
            switch (status)
            {
                ...
                default:
                    ...
                    builder.Append(
                        Res.GetString(
                            Res.OleDb_PropertyStatusUnknown,
        ...
        )
        {
            ...
            if (!ADP.IsEmpty(provider))
            {
                e = new OleDbException(
                    Res.GetString(Res.OleDb_NoErrorInformation2, provider, ODB.ELookup(hr)),
                    hr,
                    inner
                );
            }
            ...
            {
                e = new OleDbException(
                    Res.GetString(Res.OleDb_NoErrorInformation, ODB.ELookup(hr)),
                    hr,
                    inner
                );
            }
        ...
        {
            return ADP.DataAdapter(
                Res.GetString(Res.OleDb_CommandTextNotSupported, provider),
                inner
            ); // 72632
        }
        ...
        {
            return ADP.DataAdapter(
                Res.GetString(Res.OleDb_TransactionsNotSupported, provider),
                inner
            ); // 72632
        }
        ...
        )
        {
            return ADP.Argument(
                Res.GetString(
                    Res.OleDb_NotSupportedSchemaTable,
        ...
        )
        {
            return ADP.DataAdapter(
                Res.GetString(
                    Res.OleDb_BadStatusRowAccessor,
        ...
        {
            return ADP.Argument(
                Res.GetString(Res.OleDb_Fill_EmptyRecordSet, "IRowset"),
                parameter,
                innerException
            );
        }
        ...
        {
            return ADP.Argument(
                Res.GetString(Res.OleDb_Fill_EmptyRecord),
                parameter,
                innerException
            );
        }
