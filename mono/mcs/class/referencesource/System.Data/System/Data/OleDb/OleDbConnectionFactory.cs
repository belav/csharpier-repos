...
namespace System.Data.OleDb
{
    ...
    internal sealed class OleDbConnectionFactory : DbConnectionFactory
    {
        ...
        public static readonly OleDbConnectionFactory SingletonInstance =
            new OleDbConnectionFactory();
        ...
        {
            DbConnectionInternal result = new OleDbConnectionInternal(
                (OleDbConnectionString)options,
                (OleDbConnection)owningObject
            );
            return result;
        }
        ...
        )
        {
            ...
            OleDbConnectionString result = new OleDbConnectionString(
                connectionString,
                (null != previous)
            );
            return result;
        ...
        )
        {
            ...
            if (XMLStream == null)
            {
                XMLStream = System.Reflection.Assembly
            ...
            return new OleDbMetaDataFactory(
                XMLStream,
