                                ...
                                )
                                {
                                    ...
                                    )
                                    {
                                        ...
                                        if (0 <= (int)hr)
                                        {
                                            ...
                                            {
                                                Guid propertyset;
                                                tagDBPROP[] props = propset.GetPropertySet(
                                                    i,
                                                    out propertyset
                                                );
                                                        ...
                                                        )
                                                        {
                                                            ...
                                                            if (null == info._defaultValue)
                                                            {
                                                                if (typeof(string) == info._type)
                                                                {
                                                                    ...
                                                                    typeof(Int32) == info._type
                                                                )
                                                                {
                                                                    info._defaultValue = 0;
                                                                }
                                                                else if (
                                                                    typeof(Boolean) == info._type
                                                                )
                                                                {
                    ...
                    { // not a strongly typed property
                        ...
                        if (OleDbPropertySetGuid.DBInit == info._propertySet)
                        {
                            switch (info._propertyID)
                            {
                                ...
                                case ODB.DBPROP_INIT_OLEDBSERVICES:
                                    Debug.Assert(
                                        false,
                                        "should be handled via strongly typed property"
                                    );
                                    goto default;
#endif
                                ...
                                case ODB.DBPROP_AUTH_PERSIST_ENCRYPTED:
                                    ...
                                    refreshOnChange = (
                                        ODB.DBPROP_AUTH_INTEGRATED == info._propertyID
                                    );
                                    break;
                        ...
                        )
                        {
                            attributes = new Attribute[]
                            {
                                ...
                                new TypeConverterAttribute(
                                    typeof(OleDbConnectionStringBuilder.OleDbProviderConverter)
                                ),
                            };
                            refreshOnChange = true;
                        }
                        ...
                        DbConnectionStringBuilderDescriptor descriptor =
                            new DbConnectionStringBuilderDescriptor(
                                info._description,
                                typeof(OleDbConnectionStringBuilder),
                                info._type,
                                isReadOnly,
                                attributes
                            );
                ...
                if (null == _standardValues)
                {
                    ...
                    foreach (DataRow row in table.Rows)
                    {
                        ...
                        )
                        {
                            ...
                            if (
                                !OleDbConnectionString.IsMSDASQL(
                                    progid.ToLower(CultureInfo.InvariantCulture)
                                )
                            )
                            {
