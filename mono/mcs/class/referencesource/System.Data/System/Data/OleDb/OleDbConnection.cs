...
#pragma warning restore 618
            ...
            Editor(
                "Microsoft.VSDesigner.Data.ADO.Design.OleDbConnectionStringEditor, "
        ...
        public override int ConnectionTimeout
        {
            get
            {
                ...
                Bid.ScopeEnter(
                    out hscp,
                    "<oledb.OleDbConnection.get_ConnectionTimeout|API> %d#\n",
                    ObjectID
                );
                try
                {
                    ...
                    else
                    {
                        ...
                        value =
                            (null != constr) ? constr.ConnectTimeout : ADP.DefaultConnectionTimeout;
                    }
                    if (null != value)
                    {
        ...
        public override string DataSource
        {
            get
            {
                ...
                Bid.ScopeEnter(
                    out hscp,
                    "<oledb.OleDbConnection.get_DataSource|API> %d#\n",
                    ObjectID
                );
                try
                {
        ...
        public override void ChangeDatabase(string value)
        {
            ...
            Bid.ScopeEnter(
                out hscp,
                "<oledb.OleDbConnection.ChangeDatabase|API> %d#, value='%ls'\n",
                ObjectID,
                value
            );
            try
        ...
        object ICloneable.Clone()
        {
            ...
            Bid.Trace(
                "<oledb.OleDbConnection.Clone|API> %d#, clone=%d#\n",
                ObjectID,
                clone.ObjectID
            );
            return clone;
        ...
        protected override DbTransaction BeginDbTransaction(IsolationLevel isolationLevel)
        {
            ...
            Bid.ScopeEnter(
                out hscp,
                "<prov.OleDbConnection.BeginDbTransaction|API> %d#, isolationLevel=%d{ds.IsolationLevel}",
                ObjectID,
                (int)isolationLevel
            );
            try
        ...
        { // MDAC 61846
            ...
            Bid.ScopeEnter(
                out hscp,
                "<oledb.OleDbConnection.GetOleDbSchemaTable|API> %d#, schema=%ls, restrictions\n",
                ObjectID,
                schema
            );
            try
        ...
        )
        {
            ...
            if (null != handler)
            {
                try
                {
                    ...
                    {
                        Bid.Trace(
                            "<oledb.OledbConnection.OnInfoMessage|API|INFO> %d#, Message='%ls'\n",
                            ObjectID,
                            e.Message
                        );
                    }
