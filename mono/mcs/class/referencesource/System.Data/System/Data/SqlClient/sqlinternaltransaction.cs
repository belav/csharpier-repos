...
namespace System.Data.SqlClient
{
    ...
    internal sealed class SqlInternalTransaction
    {
        ...
        internal SqlInternalTransaction(
            SqlInternalConnection innerConnection,
        ...
        {
            get { return (TransactionState.Aborted == _transactionState); }
        }

        internal bool IsActive
        {
            get { return (TransactionState.Active == _transactionState); }
        }

        internal bool IsCommitted
        {
            get { return (TransactionState.Committed == _transactionState); }
        }
        ...
        internal bool IsCompleted
        {
            ...
            {
                return (
                    TransactionState.Aborted == _transactionState
        ...
        internal bool IsLocal
        {
            ...
            {
                bool result = (
                    TransactionType.LocalFromTSQL == _transactionType
                    || TransactionType.LocalFromAPI == _transactionType
        ...
        internal bool IsOrphaned
        {
            get
            {
                ...
                if (null == _parent)
                {
                    ...
                    Debug.Assert(
                        _transactionType == TransactionType.LocalFromTSQL,
                        "invalid state"
                    );
                    result = false;
                }
        ...
        {
            get { return (null == _innerConnection); }
        }
        ...
        internal long TransactionId
        {
            ...
            {
                Debug.Assert(
                    NullTransactionId == _transactionId,
                    "setting transaction cookie while one is active?"
                );
        ...
        internal void CloseFromConnection()
        {
            ...
            try
            {
                innerConnection.ExecuteTransaction(
                    SqlInternalConnection.TransactionRequest.IfRollback,
                    null,
        ...
        internal void Commit()
        {
            ...
            try
            {
                ...
                try
                {
                    ...
                    _innerConnection.ExecuteTransaction(
                        SqlInternalConnection.TransactionRequest.Commit,
                        null,
                        IsolationLevel.Unspecified,
                        null,
                        false
        ...
        {
            Debug.Assert(
                TransactionState.Active < transactionState,
                "invalid transaction completion state?"
            );
        ...
        {
            Bid.PoolerTrace(
                "<sc.SqlInteralTransaction.Dispose|RES|CPOOL> %d#, Disposing\n",
                ObjectID
            );
            if (disposing)
            {
        ...
        private int GetServerTransactionLevel()
        {
            ...
            using (
                SqlCommand transactionLevelCommand = new SqlCommand(
                    "set @out = @@trancount",
                    (SqlConnection)(_innerConnection.Owner)
                )
            )
            {
                ...
                transactionLevelCommand.RunExecuteReader(
                    0,
                    RunBehavior.UntilDone,
                    false /* returnDataStream */
                    ,
                    ADP.GetServerTransactionLevel
                );
        ...
        internal void Rollback(string transactionName)
        {
            ...
            Bid.ScopeEnter(
                out hscp,
                "<sc.SqlInternalTransaction.Rollback|API> %d#, transactionName='%ls'",
                ObjectID,
                transactionName
            );
            ...
            try
            {
                ...
                {
                    _innerConnection.ExecuteTransaction(
                        SqlInternalConnection.TransactionRequest.Rollback,
                        transactionName,
                        IsolationLevel.Unspecified,
                        null,
                        false
        ...
        internal void Save(string savePointName)
        {
            ...
            Bid.ScopeEnter(
                out hscp,
                "<sc.SqlInternalTransaction.Save|API> %d#, savePointName='%ls'",
                ObjectID,
                savePointName
            );
            ...
            try
            {
                ...
                {
                    _innerConnection.ExecuteTransaction(
                        SqlInternalConnection.TransactionRequest.Save,
                        savePointName,
                        IsolationLevel.Unspecified,
                        null,
                        false
