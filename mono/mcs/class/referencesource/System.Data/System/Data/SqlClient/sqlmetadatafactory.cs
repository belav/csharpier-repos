...
namespace System.Data.SqlClient
{
    ...
    { // V1.2.3300
        ...
        private void addUDTsToDataTypesTable(
        ...
        )
        {
            ...
            DataColumn isLiteralSupported = dataTypesTable.Columns[
            ...
            using (IDataReader reader = command.ExecuteReader())
            {
                ...
                while (reader.Read())
                {
                    ...
                    if (
                        (values[assemblyNameIndex] != DBNull.Value)
                    ...
                    )
                    {
                        ...
                        if (values[publicKeyIndex] != DBNull.Value)
                        {
                            ...
                            {
                                resultString.Append(
                                    String.Format((IFormatProvider)null, "{0,-2:x2}", b)
                                );
                            }
        ...
        private void AddTVPsToDataTypesTable(
            DataTable dataTypesTable,
            SqlConnection connection,
            String ServerVersion
        )
