...
namespace System.Data.SqlClient
{
    ...
    sealed class SqlCachedBuffer : System.Data.SqlTypes.INullable
    {
        ...
        internal XmlReader ToXmlReader()
        {
            ...
            MethodInfo createSqlReaderMethodInfo = typeof(System.Xml.XmlReader).GetMethod(
                "CreateSqlReader",
        ...
        public bool IsNull
        {
            get { return (_cachedBytes == null) ? true : false; }
        }
    }
}
