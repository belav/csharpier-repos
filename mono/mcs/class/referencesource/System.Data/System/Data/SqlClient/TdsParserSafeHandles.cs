...
namespace System.Data.SqlClient
{
    ...
    internal sealed class SNILoadHandle : SafeHandle
    {
        ...
        internal readonly SNINativeMethodWrapper.SqlAsyncCallbackDelegate ReadAsyncCallbackDispatcher =
            new SNINativeMethodWrapper.SqlAsyncCallbackDelegate(ReadDispatcher);
        internal readonly SNINativeMethodWrapper.SqlAsyncCallbackDelegate WriteAsyncCallbackDispatcher =
            new SNINativeMethodWrapper.SqlAsyncCallbackDelegate(WriteDispatcher);
            ...
            : base(IntPtr.Zero, true)
        {
            ...
            finally
            {
                ...
                if (TdsEnums.SNI_SUCCESS == _sniStatus)
                {
                    ...
                    SNINativeMethodWrapper.SNIQueryInfo(
                        SNINativeMethodWrapper.QTypes.SNI_QUERY_CLIENT_ENCRYPT_POSSIBLE,
                        ref value
                    );
                }

                _encryptionOption =
                    (value == 0) ? EncryptionOptions.NOT_SUP : EncryptionOptions.OFF;
    ...
    internal sealed class SNIHandle : SafeHandle
    {
            ...
            : base(IntPtr.Zero, true)
        {
            ...
            finally
            {
                ...
                _status = SNINativeMethodWrapper.SNIOpenSyncEx(
                    myInfo,
                    serverName,
                    ref base.handle,
                    spnBuffer,
            ...
            : base(IntPtr.Zero, true)
        {
            ...
            {
                _status = SNINativeMethodWrapper.SNIOpenMarsSession(
                    myInfo,
                    parent,
                    ref base.handle,
                    parent._fSync
    ...
    internal sealed class SNIPacket : SafeHandle
    {
        internal SNIPacket(SafeHandle sniHandle)
            : base(IntPtr.Zero, true)
        {
            SNINativeMethodWrapper.SNIPacketAllocate(
                sniHandle,
