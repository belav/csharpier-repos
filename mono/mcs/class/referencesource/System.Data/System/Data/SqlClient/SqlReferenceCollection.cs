...
namespace System.Data.SqlClient
{
    internal sealed class SqlReferenceCollection : DbReferenceCollection
    {
        ...
        public override void Add(object value, int tag)
        {
            ...
            Debug.Assert(
                DataReaderTag != tag || value is SqlDataReader,
                "tag doesn't match object type: SqlDataReader"
            );
            Debug.Assert(
                CommandTag != tag || value is SqlCommand,
                "tag doesn't match object type: SqlCommand"
            );
            Debug.Assert(
                BulkCopyTag != tag || value is SqlBulkCopy,
                "tag doesn't match object type: SqlBulkCopy"
            );
        ...
        public override void Remove(object value)
        {
            Debug.Assert(
                ...
                "SqlReferenceCollection.Remove expected a SqlDataReader or SqlCommand or SqlBulkCopy"
            );
