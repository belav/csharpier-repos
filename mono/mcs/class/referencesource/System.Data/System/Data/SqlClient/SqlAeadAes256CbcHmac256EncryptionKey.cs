...
namespace System.Data.SqlClient
{
    ...
    internal class SqlAeadAes256CbcHmac256EncryptionKey : SqlClientSymmetricKey
    {
        ...
        /// </summary>
        private const string _encryptionKeySaltFormat =
            @"Microsoft SQL Server cell encryption key with encryption algorithm:{0} and key length:{1}";

        /// <summary>
        /// MAC Key Salt format. This is used to derive the MAC key from the root key.
        /// </summary>
        private const string _macKeySaltFormat =
            ...
            : base(rootKey)
        {
            ...
            SqlSecurityUtility.GetHMACWithSHA256(
                Encoding.Unicode.GetBytes(encryptionKeySalt),
                RootKey,
                buff1
            );
            ...
            SqlSecurityUtility.GetHMACWithSHA256(
                Encoding.Unicode.GetBytes(macKeySalt),
                RootKey,
                buff2
            );
            ...
            SqlSecurityUtility.GetHMACWithSHA256(
                Encoding.Unicode.GetBytes(ivKeySalt),
                RootKey,
                buff3
            );
