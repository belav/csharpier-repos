...
namespace System.Data.SqlClient
{
    ...
    internal enum RunBehavior
    {
        ...
        Attention =
            13 // 1101 binary - Clean AND UntilDone AND Attention
        ,
    }
    ...
    internal struct SqlTceCipherInfoEntry
    {
        ...
        {
            Debug.Assert(
                _columnEncryptionKeyValues != null,
                "_columnEncryptionKeyValues should already be initialized."
            );
            ...
            else
            {
                ...
                Debug.Assert(
                    _cekMdVersion != null
                        && cekMdVersion != null
                        && _cekMdVersion.Length == _cekMdVersion.Length
                );
            }
        }
    ...
    internal sealed class SqlCollation
    {
        ...
        private const uint MaskCompareOpt =
            IgnoreCase | IgnoreNonSpace | IgnoreWidth | IgnoreKanaType | BinarySort;
        ...
        internal int LCID
        {
            ...
            get { return unchecked((int)(info & MaskLcid)); }
            set
            {
                ...
                Debug.Assert(
                    (versionBits & MaskLcidVersion) == versionBits,
                    "invalid version returned by FirstSupportedCollationVersion"
                );

                // combine the current compare options with the new locale ID and its first supported version
                info =
                    (info & MaskCompareOpt) | unchecked((uint)lcid) | unchecked((uint)versionBits);
            }
        }
        ...
        internal SqlCompareOptions SqlCompareOptions
        {
            ...
            {
                Debug.Assert(
                    (value & SqlString.x_iValidSqlCompareOptionMask) == value,
                    "invalid set_SqlCompareOptions value"
                );
                uint tmp = 0;
    ...
    internal sealed class _SqlMetaData : SqlMetaDataPriv, ICloneable
    {
        ...
        {
            get { return multiPartTableName.ServerName; }
        }
        internal string catalogName
        {
            get { return multiPartTableName.CatalogName; }
        }
        internal string schemaName
        {
            get { return multiPartTableName.SchemaName; }
        }
        internal string tableName
        {
            get { return multiPartTableName.TableName; }
        }
        ...
        {
            get { return type == SqlDbType.Udt && length == Int32.MaxValue; }
        }
    ...
    internal sealed class _SqlMetaDataSet : ICloneable
    {
        ...
        internal int Length
        {
            get { return metaDataArray.Length; }
        }

        internal _SqlMetaData this[int index]
        {
            get { return metaDataArray[index]; }
            set
            {
    ...
    internal class SqlCipherMetadata
    {
        ...
        {
            get { return _sqlTceCipherInfoEntry; }
            set
            {
                Debug.Assert(
                    !_sqlTceCipherInfoEntry.HasValue,
                    "We can only set the EncryptionInfo once."
                );
        ...
        {
            get { return _cipherAlgorithmName; }
        }
        ...
        internal byte NormalizationRuleVersion
        {
            get { return _normalizationRuleVersion; }
        }
        ...
        {
            get { return _sqlClientEncryptionAlgorithm; }
            set
            {
                Debug.Assert(
                    _sqlClientEncryptionAlgorithm == null,
                    "_sqlClientEncryptionAlgorithm should not be set more than once."
                );
        ...
        {
            get { return _sqlEncryptionKeyInfo; }
            set
            {
                Debug.Assert(
                    !_sqlEncryptionKeyInfo.HasValue,
                    "_sqlEncryptionKeyInfo should not be set more than once."
                );
        ...
        {
            Debug.Assert(
                !sqlTceCipherInfoEntry.Equals(default(SqlTceCipherInfoEntry)),
                "sqlTceCipherInfoEntry should not be un-initialized."
            );
    ...
    sealed internal class SqlColumnEncryptionInputParameterInfo
    {
        ...
        {
            get { return _smiParameterMetadata; }
        }
        ...
        {
            get { return _serializedWireFormat; }
        }
        ...
        internal SqlColumnEncryptionInputParameterInfo(
            SmiParameterMetaData smiParameterMetadata,
        ...
        )
        {
            ...
            Debug.Assert(
                cipherMetadata.EncryptionKeyInfo.HasValue,
                "cipherMetadata.EncryptionKeyInfo.HasValue should be true."
            );
        ...
        private byte[] SerializeToWriteFormat()
        {
            ...
            SerializeIntIntoBuffer(
                _cipherMetadata.EncryptionKeyInfo.Value.databaseId,
            ...
            SerializeIntIntoBuffer(
                _cipherMetadata.EncryptionKeyInfo.Value.cekId,
                serializedWireFormat,
                ref consumedBytes
            );
            ...
            SerializeIntIntoBuffer(
                _cipherMetadata.EncryptionKeyInfo.Value.cekVersion,
                serializedWireFormat,
                ref consumedBytes
            );
            ...
            Buffer.BlockCopy(
                _cipherMetadata.EncryptionKeyInfo.Value.cekMdVersion,
                0,
                serializedWireFormat,
                consumedBytes,
                _cipherMetadata.EncryptionKeyInfo.Value.cekMdVersion.Length
            );
    ...
    internal struct MultiPartTableName
    {
        ...
        internal static readonly MultiPartTableName Null = new MultiPartTableName(
