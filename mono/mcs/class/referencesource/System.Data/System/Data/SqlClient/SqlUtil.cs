...
namespace System.Data.SqlClient
{
    ...
    static internal class SQL
    {
        ...
        static internal Exception InvalidTableDerivedPrecisionForTvp(
            string columnName,
            byte precision
        )
        {
        ...
        static internal Exception EnumeratedRecordMetaDataChanged(
            string fieldName,
            int recordNumber
        )
        {
        ...
        static internal Exception UnsupportedColumnTypeForSqlProvider(
            string columnName,
            string typeName
        )
        {
        ...
        static internal Exception SortOrdinalGreaterThanFieldCount(
            int columnOrdinal,
            int sortOrdinal
        )
        {
        ...
        static internal Exception BulkLoadLcidMismatch(
            int sourceLcid,
        ...
        static internal Exception LargeCertificatePathLength(
            int actualLength,
            int maxLength,
            bool isSystemOp
        )
        ...
        static internal Exception InvalidCertificatePath(
        ...
        static internal Exception InvalidCspName(
            string cspName,
        ...
        static internal Exception InvalidCspKeyIdentifier(
        ...
        static internal Exception InvalidCertificateLocation(
        ...
        static internal Exception InvalidCertificateStore(
        ...
        static internal Exception EmptyCertificateThumbprint(
            string certificatePath,
            bool isSystemOp
        )
        {
        ...
        static internal Exception CertificateNotFound(
            string thumbprint,
            string certificateLocation,
            string certificateStore,
            bool isSystemOp
        ...
        static internal Exception InvalidCiphertextLengthInEncryptedCEK(
            int actual,
            int expected,
        ...
        static internal Exception InvalidCiphertextLengthInEncryptedCEKCsp(
            int actual,
            int expected,
            string masterKeyPath
        )
        ...
        static internal Exception InvalidCiphertextLengthInEncryptedCEKCng(
            int actual,
            int expected,
            string masterKeyPath
        )
        ...
        static internal Exception InvalidSignatureInEncryptedCEK(
            int actual,
            int expected,
            string masterKeyPath
        )
        ...
        static internal Exception InvalidSignatureInEncryptedCEKCsp(
            int actual,
            int expected,
            string masterKeyPath
        )
        ...
        static internal Exception InvalidSignatureInEncryptedCEKCng(
            int actual,
            int expected,
            string masterKeyPath
        )
        ...
        static internal Exception InvalidKeySize(
        ...
        static internal Exception InvalidEncryptionType(
            string algorithmName,
        ...
        static internal Exception VeryLargeCiphertext(
        ...
        static internal Exception ParamEncryptionMetadataMissing(
            string paramName,
        ...
        static internal Exception ParamInvalidForceColumnEncryptionSetting(
            string paramName,
            string procedureName
        )
        {
        ...
        static internal Exception ParamUnExpectedEncryptionMetadata(
            string paramName,
            string procedureName
        )
        {
        ...
        static internal Exception ParamEncryptionFailed(
            string paramName,
            string serverName,
            Exception e
        )
        ...
        static internal Exception ParamDecryptionFailed(
            string paramName,
            string serverName,
            Exception e
        )
        ...
        static internal Exception ColumnDecryptionFailed(
            string columnName,
            string serverName,
            Exception e
        )
        ...
        static internal Exception UnknownColumnEncryptionAlgorithmId(
            int algoId,
        ...
        static internal Exception UnrecognizedKeyStoreProviderName(
            string providerName,
        ...
        static internal Exception InvalidDataTypeForEncryptedParameter(
        ...
        static internal Exception InvalidCustomKeyStoreProviderName(
            string providerName,
            string prefix
        )
        {
        ...
        static internal Exception ROR_FailoverNotSupportedServer(
            SqlInternalConnectionTds internalConnection
        )
        {
            SqlErrorCollection errors = new SqlErrorCollection();
        ...
        static internal Exception ROR_RecursiveRoutingNotSupported(
            SqlInternalConnectionTds internalConnection
        )
        {
            SqlErrorCollection errors = new SqlErrorCollection();
        ...
        static internal Exception ROR_UnexpectedRoutingInfo(
            SqlInternalConnectionTds internalConnection
        )
        {
            SqlErrorCollection errors = new SqlErrorCollection();
        ...
        static internal Exception ROR_InvalidRoutingInfo(
            SqlInternalConnectionTds internalConnection
        )
        {
            SqlErrorCollection errors = new SqlErrorCollection();
        ...
        static internal Exception ROR_TimeoutAfterRoutingInfo(
            SqlInternalConnectionTds internalConnection
        )
        {
            SqlErrorCollection errors = new SqlErrorCollection();
        ...
        static internal SqlException CR_AllAttemptsFailed(
            SqlException innerException,
            Guid connectionId
        )
        {
        ...
        static internal SqlException CR_NoCRAckAtReconnection(
            SqlInternalConnectionTds internalConnection
        )
        {
            SqlErrorCollection errors = new SqlErrorCollection();
        ...
        static internal SqlException CR_TDSVersionNotPreserved(
            SqlInternalConnectionTds internalConnection
        )
        {
            SqlErrorCollection errors = new SqlErrorCollection();
    ...
    sealed internal class SQLMessage
    {
        ...
        static internal string Duration_PreLoginHandshake(
        ...
        static internal string Duration_Login_Begin(
            long PreLoginBeginDuration,
            long PreLoginHandshakeDuration,
        ...
        static internal string Duration_Login_ProcessConnectionAuth(
            long PreLoginBeginDuration,
            long PreLoginHandshakeDuration,
            long LoginBeginDuration,
        ...
        static internal string Duration_PostLogin(
            long PreLoginBeginDuration,
            long PreLoginHandshakeDuration,
            long LoginBeginDuration,
            long LoginAuthDuration,
