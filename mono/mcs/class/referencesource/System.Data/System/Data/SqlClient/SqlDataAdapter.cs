...
namespace System.Data.SqlClient
{
    ...
    [
        ...
        ToolboxItem(
            "Microsoft.VSDesigner.Data.VS.SqlDataAdapterToolboxItem, "
                + AssemblyRef.MicrosoftVSDesigner
        ),
        Designer(
            "Microsoft.VSDesigner.Data.VS.SqlDataAdapterDesigner, "
                + AssemblyRef.MicrosoftVSDesigner
        )
    ]
    public sealed class SqlDataAdapter : DbDataAdapter, IDbDataAdapter, ICloneable
    {
        ...
        public event SqlRowUpdatingEventHandler RowUpdating
        {
            add
            {
                ...
                {
                    SqlRowUpdatingEventHandler d = (SqlRowUpdatingEventHandler)
        ...
        {
            Debug.Assert(
                commandIdentifier < _commandSet.CommandCount,
                "commandIdentifier out of range"
            );
            Debug.Assert(
                parameterIndex < _commandSet.GetParameterCount(commandIdentifier),
        ...
        )
        {
            ...
            return _commandSet.GetBatchedAffected(
                commandIdentifier,
                out recordsAffected,
                out error
            );
