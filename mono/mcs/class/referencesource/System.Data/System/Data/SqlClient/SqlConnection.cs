...
[assembly: System.Runtime.CompilerServices.InternalsVisibleTo(
    "System.Data.DataSetExtensions, PublicKey=" + AssemblyRef.EcmaPublicKeyFull
)] // DevDiv Bugs 92166
...
namespace System.Data.SqlClient
{
    ...
    public sealed partial class SqlConnection : DbConnection, ICloneable
    {
        ...
        > _SystemColumnEncryptionKeyStoreProviders = new Dictionary<
            string,
            SqlColumnEncryptionKeyStoreProvider
        ...
        /// </summary>
        static private ReadOnlyDictionary<
            string,
            SqlColumnEncryptionKeyStoreProvider
        ...
        /// </summary>
        static private readonly ConcurrentDictionary<
            string,
            IList<string>
        > _ColumnEncryptionTrustedMasterKeyPaths = new ConcurrentDictionary<string, IList<string>>(
            concurrencyLevel: 4
        ...
        {
            get { return _ColumnEncryptionTrustedMasterKeyPaths; }
        }
        ...
        [
            ...
            ResDescriptionAttribute(
                Res.TCE_SqlConnection_ColumnEncryptionQueryMetadataCacheEnabled
            ),
        ]
        public static bool ColumnEncryptionQueryMetadataCacheEnabled
        {
            get { return _ColumnEncryptionQueryMetadataCacheEnabled; }
            set { _ColumnEncryptionQueryMetadataCacheEnabled = value; }
        }
        ...
        {
            get { return _ColumnEncryptionKeyCacheTtl; }
        ...
        static public void RegisterColumnEncryptionKeyStoreProviders(
        ...
        )
        {
            ...
            foreach (string key in customProviders.Keys)
            {
                ...
                if (
                    key.StartsWith(
                        ADP.ColumnEncryptionSystemProviderNamePrefix,
                        StringComparison.InvariantCultureIgnoreCase
                    )
                )
                {
                    throw SQL.InvalidCustomKeyStoreProviderName(
                        key,
                        ADP.ColumnEncryptionSystemProviderNamePrefix
                    );
                }
            ...
            lock (_CustomColumnEncryptionKeyProvidersLock)
            {
                ...
                Dictionary<
                    string,
                    SqlColumnEncryptionKeyStoreProvider
                > customColumnEncryptionKeyStoreProviders = new Dictionary<
                    string,
                    SqlColumnEncryptionKeyStoreProvider
                >(customProviders, StringComparer.OrdinalIgnoreCase);

                // Set the dictionary to the ReadOnly dictionary.
                _CustomColumnEncryptionKeyStoreProviders = new ReadOnlyDictionary<
                    string,
                    SqlColumnEncryptionKeyStoreProvider
        ...
        static internal bool TryGetColumnEncryptionKeyStoreProvider(
            string providerName,
        ...
        )
        {
            ...
            if (
                _SystemColumnEncryptionKeyStoreProviders.TryGetValue(
                    providerName,
            ...
            lock (_CustomColumnEncryptionKeyProvidersLock)
            {
                ...
                return _CustomColumnEncryptionKeyStoreProviders.TryGetValue(
                    providerName,
                    out columnKeyStoreProvider
                );
            }
        ...
        static internal List<string> GetColumnEncryptionSystemKeyStoreProviders()
        {
            HashSet<string> providerNames = new HashSet<string>(
                _SystemColumnEncryptionKeyStoreProviders.Keys
            );
        ...
        static internal List<string> GetColumnEncryptionCustomKeyStoreProviders()
        {
            ...
            {
                HashSet<string> providerNames = new HashSet<string>(
                    _CustomColumnEncryptionKeyStoreProviders.Keys
                );
                return providerNames.ToList();
            }
        ...
        {
            get { return (_AsyncCommandInProgress); }
        ...
        internal bool IsColumnEncryptionSettingEnabled
        {
            get
            {
                SqlConnectionString opt = (SqlConnectionString)ConnectionOptions;
                return opt != null
                    ? opt.ColumnEncryptionSetting == SqlConnectionColumnEncryptionSetting.Enabled
                    : false;
            }
        }
        ...
        {
            get { return ((SqlConnectionString)ConnectionOptions).TransactionBinding; }
        }

        internal SqlConnectionString.TypeSystem TypeSystem
        {
            get { return ((SqlConnectionString)ConnectionOptions).TypeSystemVersion; }
        }

        internal Version TypeSystemAssemblyVersion
        {
            get { return ((SqlConnectionString)ConnectionOptions).TypeSystemAssemblyVersion; }
        }

        internal PoolBlockingPeriod PoolBlockingPeriod
        {
            get { return ((SqlConnectionString)ConnectionOptions).PoolBlockingPeriod; }
        }

        internal int ConnectRetryInterval
        {
            get { return ((SqlConnectionString)ConnectionOptions).ConnectRetryInterval; }
        }
        ...
        public string AccessToken
        {
            get
            {
                ...
                if (
                    InnerConnection.ShouldHidePassword
                    && connectionOptions != null
                    && !connectionOptions.PersistSecurityInfo
                )
                {
                    result = null;
                }
...
#pragma warning restore 618
        ...
        public override int ConnectionTimeout
        {
            get
            {
                ...
                return (
                    (null != constr)
                        ? constr.ConnectTimeout
                        : SqlConnectionString.DEFAULT.Connect_Timeout
                );
            }
        }
                ...
                else
                {
                    ...
                    result = (
                        (null != constr)
                            ...
                            : SqlConnectionString.DEFAULT.Initial_Catalog
                    );
                }
                return result;
            }
        ...
        public int PacketSize
        {
            ...
            get
            {
                ...
                SqlInternalConnectionTds innerConnection = (
                ...
                else
                {
                    ...
                    result = (
                        (null != constr)
                            ? constr.PacketSize
                            : SqlConnectionString.DEFAULT.Packet_Size
                    );
                }
                return result;
            }
        ...
        {
            get { return GetOpenConnection().ServerVersion; }
        }
        ...
        {
            add { Events.AddHandler(EventInfoMessage, value); }
            remove { Events.RemoveHandler(EventInfoMessage, value); }
        }

        public bool FireInfoMessageEventOnUserErrors
        {
            get { return _fireInfoMessageEventOnUserErrors; }
        ...
        protected override DbTransaction BeginDbTransaction(IsolationLevel isolationLevel)
        {
            ...
            Bid.ScopeEnter(
                out hscp,
                "<prov.SqlConnection.BeginDbTransaction|API> %d#, isolationLevel=%d{ds.IsolationLevel}",
                ObjectID,
                (int)isolationLevel
            );
            try
        ...
        public SqlTransaction BeginTransaction(IsolationLevel iso, string transactionName)
        {
            ...
            try
            {
                ...
                do
                {
                    transaction = GetOpenConnection()
                        .BeginSqlTransaction(iso, transactionName, isFirstAttempt); // do not reconnect twice
                    Debug.Assert(
                        isFirstAttempt
                            || !transaction.InternalTransaction.ConnectionHasBeenRestored,
        ...
        public override void Close()
        {
            ...
            Bid.CorrelationTrace(
                "<sc.SqlConnection.Close|API|Correlation> ObjectID%d#, ActivityID %ls\n",
                ObjectID
            );
            try
            {
                ...
                try
                {
...
#else
                    {
                        ...
                        if (reconnectTask != null && !reconnectTask.IsCompleted)
                        {
                            ...
                            ); // we do not need to deal with possible exceptions in reconnection
        ...
        override public void Open()
        {
            ...
            Bid.CorrelationTrace(
                "<sc.SqlConnection.Open|API|Correlation> ObjectID%d#, ActivityID %ls\n",
                ObjectID
            );
            ...
            try
            {
                ...
                for (int attempt = 0; attempt < retryCount; attempt++)
                {
...
#if DEBUG
                            Debug.Assert(
                                _recoverySessionData._debugReconnectDataApplied,
                    ...
                    catch (SqlException e)
                    {
                        ...
                        if (
                            timeout > 0
                            && ADP.TimerRemaining(commandTimeoutExpiration)
                                < ADP.TimerFromSeconds(ConnectRetryInterval)
                        )
                        {
                            throw SQL.CR_NextAttemptWillExceedQueryTimeout(
                                e,
        ...
        internal Task ValidateAndReconnect(Action beforeDisconnect, int timeout)
        {
            ...
            while (runningReconnect != null && runningReconnect.IsCompleted)
            {
                ...
                Interlocked.CompareExchange<Task>(
                        ...
                        if (!stateObj.ValidateSNIConnection())
                        {
                            if (tdsConn.Parser._sessionPool != null)
                            {
                                if (tdsConn.Parser._sessionPool.ActiveSessionsCount > 0)
                                {
                                    ...
                                    OnError(
                                        SQL.CR_UnrecoverableClient(ClientConnectionId),
                                        true,
                                        null
                                    );
                                }
                                    ...
                                    if (runningReconnect == null)
                                    {
                                        ...
                                        { // could change since the first check, but now is stable since connection is know to be broken
                                            ...
                                            Debug.Assert(
                                                ...
                                                "Duplicate reconnection tasks detected"
                                            );
        ...
        void CancelOpenAndWait()
        {
            ...
            Debug.Assert(
                ...
                "After waiting for an async call to complete, there should be no completion source"
            );
        }
        ...
        public override Task OpenAsync(CancellationToken cancellationToken)
        {
            ...
            Bid.CorrelationTrace(
                "<sc.SqlConnection.OpenAsync|API|Correlation> ObjectID%d#, ActivityID %ls\n",
                ObjectID
            );
            try
            {
                ...
                try
                {
                    ...
                    TaskCompletionSource<DbConnectionInternal> completion =
                        new TaskCompletionSource<DbConnectionInternal>(transaction);
                    ...
                    if (IsContextConnection)
                    {
                        ...
                        result.SetException(
                            ADP.ExceptionWithStackTrace(SQL.NotAvailableOnContextConnection())
                        );
                        return result.Task;
                    }
                    ...
                    else
                    {
                        ...
                        _currentCompletion = new Tuple<
                            TaskCompletionSource<DbConnectionInternal>,
                            Task
                            ...
                            else
                            {
                                ...
                                _result.SetException(
                                    ADP.ExceptionWithStackTrace(
                                        ADP.InternalError(
                                            ADP.InternalErrorCode.CompletedConnectReturnedPending
                                        )
                                    )
                                );
                            }
        ...
        private bool TryOpen(TaskCompletionSource<DbConnectionInternal> retry)
        {
            ...
            {
                using (
                    WindowsIdentity identity = DbConnectionPoolIdentity.GetCurrentWindowsIdentity()
                )
                {
                    ...
                    {
                        using (
                            WindowsImpersonationContext context = _impersonateIdentity.Impersonate()
                        )
                        {
                            return TryOpenInner(retry);
                        }
            ...
            {
                if (
                    this.UsesIntegratedSecurity(connectionOptions)
        ...
        private bool TryOpenInner(TaskCompletionSource<DbConnectionInternal> retry)
        {
            ...
            try
            {
...
#else
                {
                    ...
                    {
                        if (
                            !InnerConnection.TryReplaceConnection(
                                this,
                                ConnectionFactory,
                                retry,
                    ...
                    {
                        if (
                            !InnerConnection.TryOpenConnection(
                                this,
                                ConnectionFactory,
                                retry,
                                UserConnectionOptions
        ...
        {
            get { return GetOpenConnection().HasLocalTransaction; }
        }
        ...
        internal bool Asynchronous
        {
            get
            {
                ...
                return (
                    (null != constr)
                        ? constr.Asynchronous
                        : SqlConnectionString.DEFAULT.Asynchronous
                );
            }
        }
            ...
            if (asyncWaitingForReconnection != null)
            {
                ...
                else
                {
                    Interlocked.CompareExchange(
                        ref _asyncWaitingForReconnection,
                        null,
                        asyncWaitingForReconnection
                    );
                }
            }
            if (_currentReconnectionTask != null)
        ...
        internal void OnError(
            ...
            Action<Action> wrapCloseInAction
        )
        {
            Debug.Assert(
                exception != null && exception.Errors.Count != 0,
                "SqlConnection: OnError called with null or empty exception!"
            );
            ...
            if (breakConnection && (ConnectionState.Open == State))
            {
                if (wrapCloseInAction != null)
                {
                    ...
                    Action closeAction = () =>
                    {
                        ...
                        {
                            Bid.Trace(
                                "<sc.SqlConnection.OnError|INFO> %d#, Connection broken.\n",
                                ObjectID
                            );
                            Close();
                        }
        ...
        private void CompleteOpen()
        {
            ...
            if (!GetOpenConnection().IsYukonOrNewer && System.Diagnostics.Debugger.IsAttached)
            {
        ...
        private void CheckSQLDebugOnConnect()
        {
            ...
            {
                IntPtr pMemMap = NativeMethods.MapViewOfFile(
                    hFileMap,
                    0x4 /*FILE_MAP_READ*/
                    ,
                    0,
...
#pragma warning restore 618
            ...
            {
                if (
                    sdc.fOption /*TdsEnums.SQLDEBUG_ON*/
                )
                {
                    // turn on
                    sdc.active = true;
            ...
            {
                if (
                    !sdc.fOption /*TdsEnums.SQLDEBUG_OFF*/
                )
                {
        ...
        )
        {
            ...
            SqlParameter p = new SqlParameter(
                null,
                SqlDbType.VarChar,
                TdsEnums.SQLDEBUG_MODE_NAMES[option].Length
            );
        ...
        public static void ChangePassword(string connectionString, string newPassword)
        {
            ...
            Bid.CorrelationTrace(
                "<sc.SqlConnection.ChangePassword|API|Correlation> ActivityID %ls\n"
            );
            try
            {
                ...
                SqlConnectionString connectionOptions =
                    SqlConnectionFactory.FindSqlConnectionOptions(key);
                if (
                ...
                if (!ADP.IsEmpty(connectionOptions.AttachDBFilename))
                {
                    throw SQL.ChangePasswordUseOfUnallowedKey(
                        SqlConnectionString.KEY.AttachDBFilename
                    );
                }
                if (connectionOptions.ContextConnection)
                {
                    throw SQL.ChangePasswordUseOfUnallowedKey(
                        SqlConnectionString.KEY.Context_Connection
                    );
                }

                System.Security.PermissionSet permissionSet =
                    connectionOptions.CreatePermissionSet();
        ...
        )
        {
            ...
            try
            {
                ...
                {
                    throw ADP.InvalidArgumentLength(
                        "newSecurePassword",
                        TdsEnums.MAXLEN_NEWPASSWORD
                    );
                }
                ...
                if (
                    !ADP.IsEmpty(connectionOptions.UserID)
        ...
        )
        {
            ...
            //
            using (
                SqlInternalConnectionTds con = new SqlInternalConnectionTds(
                    null,
                    connectionOptions,
                    credential,
                    null,
        ...
        private Assembly ResolveTypeAssembly(AssemblyName asmRef, bool throwOnError)
        {
            ...
            )
            {
                if (Bid.TraceOn)
                {
                    ...
                    {
                        Bid.Trace(
                            "<sc.SqlConnection.ResolveTypeAssembly> SQL CLR type version change: Server sent %ls, client will instantiate %ls",
                            asmRef.Version.ToString(),
                            TypeSystemAssemblyVersion.ToString()
                        );
                    }
                }
        ...
        internal void CheckGetExtendedUDTInfo(SqlMetaDataPriv metaData, bool fThrow)
        {
            ...
            { // If null, we have not obtained extended info.
                Debug.Assert(
                    !ADP.IsEmpty(metaData.udtAssemblyQualifiedName),
                    "Unexpected state on GetUDTInfo"
                );
                // Parameter throwOnError determines whether exception from Assembly.Load is thrown.
                metaData.udtType = Type.GetType(
                    typeName: metaData.udtAssemblyQualifiedName,
                    assemblyResolver: asmRef => ResolveTypeAssembly(asmRef, fThrow),
                    typeResolver: null,
                    throwOnError: fThrow
                );
        ...
        internal byte[] GetBytes(
            object o,
            out Microsoft.SqlServer.Server.Format format,
            out int maxSize
        )
        {
    ...
    public sealed class SQLDebugging : ISQLDebug
    {
        ...
        private IntPtr CreateSD(ref IntPtr pDacl)
        {
            ...
            if (NativeMethods.InitializeAcl(pDacl, cbAcl, ACL_REVISION))
                if (NativeMethods.AddAccessDeniedAce(pDacl, ACL_REVISION, WRITE_DAC, pUserSid))
                    if (
                        NativeMethods.AddAccessAllowedAce(
                            pDacl,
                            ACL_REVISION,
                            GENERIC_READ,
                            pUserSid
                        ...
                        if (
                            ...
                            if (
                                NativeMethods.InitializeSecurityDescriptor(
                                    pSecurityDescriptor,
                                    SECURITY_DESCRIPTOR_REVISION
                                )
                            )
                                if (
                                    NativeMethods.SetSecurityDescriptorDacl(
                                        pSecurityDescriptor,
                                        true,
                                        pDacl,
                                        false
        ...
        )
        {
            ...
            if (
                pszMachineName.Length > TdsEnums.SDCI_MAX_MACHINENAME
            ...
            pMemMap = NativeMethods.MapViewOfFile(
                hFileMap,
            ...
            Marshal.Copy(
                rgbMachineName,
                0,
                ADP.IntPtrOffset(pMemMap, offset),
                rgbMachineName.Length
            );
