...
namespace System.Data.SqlClient
{
    ...
    [System.ComponentModel.TypeConverterAttribute(
        typeof(SqlConnectionStringBuilder.SqlConnectionStringBuilderConverter)
    )]
    public sealed class SqlConnectionStringBuilder : DbConnectionStringBuilder
    {
        ...
        private bool _multipleActiveResultSets =
            DbConnectionStringDefaults.MultipleActiveResultSets;
        ...
        private SqlConnectionColumnEncryptionSetting _columnEncryptionSetting =
            DbConnectionStringDefaults.ColumnEncryptionSetting;
        ...
        static SqlConnectionStringBuilder()
        {
            ...
            validKeywords[(int)Keywords.ApplicationIntent] =
                DbConnectionStringKeywords.ApplicationIntent;
            validKeywords[(int)Keywords.ApplicationName] =
                DbConnectionStringKeywords.ApplicationName;
            validKeywords[(int)Keywords.AsynchronousProcessing] =
                DbConnectionStringKeywords.AsynchronousProcessing;
            validKeywords[(int)Keywords.AttachDBFilename] =
                DbConnectionStringKeywords.AttachDBFilename;
            validKeywords[(int)Keywords.PoolBlockingPeriod] =
                DbConnectionStringKeywords.PoolBlockingPeriod;
            validKeywords[(int)Keywords.ConnectionReset] =
                DbConnectionStringKeywords.ConnectionReset;
            validKeywords[(int)Keywords.ContextConnection] =
            ...
            validKeywords[(int)Keywords.CurrentLanguage] =
                DbConnectionStringKeywords.CurrentLanguage;
            ...
            validKeywords[(int)Keywords.FailoverPartner] =
                DbConnectionStringKeywords.FailoverPartner;
            validKeywords[(int)Keywords.InitialCatalog] = DbConnectionStringKeywords.InitialCatalog;
            validKeywords[(int)Keywords.IntegratedSecurity] =
                DbConnectionStringKeywords.IntegratedSecurity;
            validKeywords[(int)Keywords.LoadBalanceTimeout] =
                DbConnectionStringKeywords.LoadBalanceTimeout;
            ...
            validKeywords[(int)Keywords.MultipleActiveResultSets] =
                DbConnectionStringKeywords.MultipleActiveResultSets;
            validKeywords[(int)Keywords.MultiSubnetFailover] =
            ...
            validKeywords[(int)Keywords.PersistSecurityInfo] =
            ...
            validKeywords[(int)Keywords.TransactionBinding] =
                DbConnectionStringKeywords.TransactionBinding;
            validKeywords[(int)Keywords.TrustServerCertificate] =
                DbConnectionStringKeywords.TrustServerCertificate;
            validKeywords[(int)Keywords.TypeSystemVersion] =
                DbConnectionStringKeywords.TypeSystemVersion;
            ...
            validKeywords[(int)Keywords.ConnectRetryCount] =
                DbConnectionStringKeywords.ConnectRetryCount;
            validKeywords[(int)Keywords.ConnectRetryInterval] =
                DbConnectionStringKeywords.ConnectRetryInterval;
            validKeywords[(int)Keywords.Authentication] = DbConnectionStringKeywords.Authentication;
            validKeywords[(int)Keywords.ColumnEncryptionSetting] =
                DbConnectionStringKeywords.ColumnEncryptionSetting;
            _validKeywords = validKeywords;

            Dictionary<string, Keywords> hash = new Dictionary<string, Keywords>(
                KeywordsCount + SqlConnectionString.SynonymCount,
            ...
            hash.Add(
                DbConnectionStringKeywords.ColumnEncryptionSetting,
                Keywords.ColumnEncryptionSetting
            );
            ...
            Debug.Assert(
                (KeywordsCount + SqlConnectionString.SynonymCount) == hash.Count,
                "initial expected size is incorrect"
            );
            _keywords = hash;
        }
                ...
                if (null != value)
                {
                    ...
                    switch (index)
                    {
                        ...
                        case Keywords.ColumnEncryptionSetting:
                            ColumnEncryptionSetting = ConvertToColumnEncryptionSetting(
                                keyword,
                                value
                            );
                            break;
...
#pragma warning restore 618
        ...
        //
        [Editor(
            "System.Windows.Forms.Design.FileNameEditor, " + AssemblyRef.SystemDesign,
            ...
            set
            {
                if (value < 0)
                {
                    throw ADP.InvalidConnectionOptionValue(
                        DbConnectionStringKeywords.ConnectTimeout
                    );
                }
        ...
        public SqlConnectionColumnEncryptionSetting ColumnEncryptionSetting
        {
            ...
            set
            {
                ...
                {
                    throw ADP.InvalidEnumerationValue(
        ...
        [SuppressMessage(
            ...
            Justification = "Reviewed and Approved by UE"
        )]
        ...
        */
        ...
        {
            get { return new System.Data.Common.ReadOnlyCollection<string>(_validKeywords); }
        }
        ...
        private static SqlAuthenticationMethod ConvertToAuthenticationType(
            string keyword,
            object value
        )
        {
        ...
        private static SqlConnectionColumnEncryptionSetting ConvertToColumnEncryptionSetting(
            string keyword,
            object value
        )
        {
...
#pragma warning restore 618
        ...
        protected override void GetProperties(Hashtable propertyDescriptors)
        {
            foreach (PropertyDescriptor reflected in TypeDescriptor.GetProperties(this, true))
            {
                ...
                if (DbConnectionStringKeywords.IntegratedSecurity == displayName)
                {
                    ...
                    (DbConnectionStringKeywords.Password == displayName)
                ...
                DbConnectionStringBuilderDescriptor descriptor =
                    new DbConnectionStringBuilderDescriptor(
                        reflected.Name,
        ...
        private void Reset(Keywords index)
        {
            switch (index)
            {
                ...
                case Keywords.MultiSubnetFailover:
                    ...
                    break;
                case Keywords.TransparentNetworkIPResolution:
                    _transparentNetworkIPResolution =
                        DbConnectionStringDefaults.TransparentNetworkIPResolution;
                    break;
        ...
        {
            Debug.Assert(
                DbConnectionStringBuilderUtil.IsValidApplicationIntentValue(value),
                "Invalid value for ApplicationIntent"
            );
            base[DbConnectionStringKeywords.ApplicationIntent] =
                DbConnectionStringBuilderUtil.ApplicationIntentToString(value);
        }

        private void SetPoolBlockingPeriodValue(PoolBlockingPeriod value)
        {
            Debug.Assert(
                DbConnectionStringBuilderUtil.IsValidPoolBlockingPeriodValue(value),
                "Invalid value for PoolBlockingPeriod"
            );
            base[DbConnectionStringKeywords.PoolBlockingPeriod] =
                DbConnectionStringBuilderUtil.PoolBlockingPeriodToString(value);
        }

        private void SetAuthenticationValue(SqlAuthenticationMethod value)
        {
            Debug.Assert(
                DbConnectionStringBuilderUtil.IsValidAuthenticationTypeValue(value),
                "Invalid value for AuthenticationType"
            );
            base[DbConnectionStringKeywords.Authentication] =
                DbConnectionStringBuilderUtil.AuthenticationTypeToString(value);
        }

        private void SetColumnEncryptionSettingValue(SqlConnectionColumnEncryptionSetting value)
        {
            Debug.Assert(
                DbConnectionStringBuilderUtil.IsValidColumnEncryptionSetting(value),
                "Invalid value for SqlConnectionColumnEncryptionSetting"
            );
            base[DbConnectionStringKeywords.ColumnEncryptionSetting] =
                DbConnectionStringBuilderUtil.ColumnEncryptionSettingToString(value);
        }
        ...
        public override bool ShouldSerialize(string keyword)
        {
            ADP.CheckArgumentNull(keyword, "keyword");
            Keywords index;
            return _keywords.TryGetValue(keyword, out index)
        ...
        private sealed class NetworkLibraryConverter : TypeConverter
        {
            ...
            )
            {
                ...
                {
                    string[] names = new string[] { NamedPipes, SharedMemory, TCPIP, VIA, };
        ...
        private sealed class SqlInitialCatalogConverter : StringConverter
        {
            ...
            private bool GetStandardValuesSupportedInternal(ITypeDescriptorContext context)
            {
                ...
                if (null != context)
                {
                    SqlConnectionStringBuilder constr = (
                        context.Instance as SqlConnectionStringBuilder
                    );
                    if (null != constr)
                    {
                        if (
                            (0 < constr.DataSource.Length)
                            && (constr.IntegratedSecurity || (0 < constr.UserID.Length))
                        )
                        {
                            flag = true;
                        }
            ...
            )
            {
                ...
                if (GetStandardValuesSupportedInternal(context))
                {
                    ...
                    try
                    {
                        SqlConnectionStringBuilder constr = (SqlConnectionStringBuilder)
                            context.Instance;
        ...
        sealed internal class SqlConnectionStringBuilderConverter : ExpandableObjectConverter
        {
            ...
            private System.ComponentModel.Design.Serialization.InstanceDescriptor ConvertToInstanceDescriptor(
                SqlConnectionStringBuilder options
            )
            {
                Type[] ctorParams = new Type[] { typeof(string) };
                object[] ctorValues = new object[] { options.ConnectionString };
                System.Reflection.ConstructorInfo ctor =
                    typeof(SqlConnectionStringBuilder).GetConstructor(ctorParams);
