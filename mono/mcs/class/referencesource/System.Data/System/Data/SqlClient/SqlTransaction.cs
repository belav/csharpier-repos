...
namespace System.Data.SqlClient
{
    ...
    public sealed class SqlTransaction : DbTransaction
    {
        ...
        )
        {
            ...
            {
                _internalTransaction = new SqlInternalTransaction(
                    internalConnection,
            ...
            {
                Debug.Assert(
                    internalConnection.CurrentTransaction == internalTransaction,
        ...
        {
            get { return (null != _internalTransaction && _internalTransaction.IsCompleted); }
        }
        ...
        override public void Commit()
        {
            ...
            Bid.CorrelationTrace(
                "<sc.SqlTransaction.Commit|API|Correlation> ObjectID%d#, ActivityID %ls",
                ObjectID
            );
        ...
        public override void Rollback()
        {
            if (IsYukonPartialZombie)
            {
                ...
                {
                    Bid.Trace(
                        "<sc.SqlTransaction.Rollback|ADV> %d# partial zombie no rollback required\n",
                        ObjectID
                    );
                }
            ...
            else
            {
                ...
                Bid.CorrelationTrace(
                    "<sc.SqlTransaction.Rollback|API|Correlation> ObjectID%d#, ActivityID %ls\n",
                    ObjectID
                );
        ...
        public void Rollback(string transactionName)
        {
            ...
            Bid.ScopeEnter(
                out hscp,
                "<sc.SqlTransaction.Rollback|API> %d# transactionName='%ls'",
                ObjectID,
                transactionName
            );
        ...
        public void Save(string savePointName)
        {
            ...
            Bid.ScopeEnter(
                out hscp,
                "<sc.SqlTransaction.Save|API> %d# savePointName='%ls'",
                ObjectID,
                savePointName
            );
        ...
        internal void Zombie()
        {
            ...
            SqlInternalConnection internalConnection = (
                _connection.InnerConnection as SqlInternalConnection
            );
            if (null != internalConnection && internalConnection.IsYukonOrNewer && !_isFromAPI)
            {
                ...
                {
                    Bid.Trace(
                        "<sc.SqlTransaction.Zombie|ADV> %d# yukon deferred zombie\n",
                        ObjectID
                    );
                }
            }
