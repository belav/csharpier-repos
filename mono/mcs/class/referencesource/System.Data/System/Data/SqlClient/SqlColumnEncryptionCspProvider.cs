...
namespace System.Data.SqlClient
{
    ...
    public class SqlColumnEncryptionCspProvider : SqlColumnEncryptionKeyStoreProvider
    {
        ...
        )
        {
            ...
            RSACryptoServiceProvider rsaProvider = CreateRSACryptoProvider(
                masterKeyPath,
                isSystemOp: true
            );
            ...
            UInt16 keyPathLength = BitConverter.ToUInt16(
            ...
            UInt16 cipherTextLength = BitConverter.ToUInt16(
                encryptedColumnEncryptionKey,
                currentIndex
            );
            currentIndex += sizeof(UInt16);
            ...
            {
                throw SQL.InvalidCiphertextLengthInEncryptedCEKCsp(
                    cipherTextLength,
                    keySizeInBytes,
                    masterKeyPath
                );
            ...
            {
                throw SQL.InvalidSignatureInEncryptedCEKCsp(
                    signatureLength,
                    keySizeInBytes,
                    masterKeyPath
                );
        ...
        )
        {
            ...
            Debug.Assert(
                RSAVerifySignature(hash, signedHash, rsaProvider),
        ...
        private void GetCspProviderAndKeyName(
            string keyPath,
            bool isSystemOp,
            out string cspProviderName,
        ...
        )
        {
            ...
            keyIdentifier = keyPath.Substring(
                indexOfSlash + 1,
                keyPath.Length - (indexOfSlash + 1)
            );
        ...
        private int GetProviderType(string providerName, string keyPath, bool isSystemOp)
        {
            string keyName = String.Format(
                @"SOFTWARE\Microsoft\Cryptography\Defaults\Provider\{0}",
                providerName
            );
