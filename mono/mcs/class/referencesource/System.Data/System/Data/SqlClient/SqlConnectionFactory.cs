...
namespace System.Data.SqlClient
{
    ...
    internal sealed class SqlConnectionFactory : DbConnectionFactory
    {
        ...
        )
        {
            ...
            bool applyTransientFaultHandling =
                sqlOwningConnection != null
                    ? sqlOwningConnection._applyTransientFaultHandling
                    : false;
            ...
            else
            {
                ...
                if (opt.UserInstance)
                {
                    ...
                    if ((null == pool) || (null != pool && pool.Count <= 0))
                    { // Non-pooled or pooled and no connections in the pool.
                        ...
                        try
                        {
                            ...
                            SqlConnectionString sseopt = new SqlConnectionString(
                                ...
                                ,
                                false /* set Enlist = false */
                            );
                            sseConnection = new SqlInternalConnectionTds(
                                identity,
                                sseopt,
                                key.Credential,
                                null,
                            ...
                            { // Pooled connection - cache result
                                SqlConnectionPoolProviderInfo providerInfo =
                                    (SqlConnectionPoolProviderInfo)pool.ProviderInfo;
                    ...
                    { // Cached info from pool.
                        SqlConnectionPoolProviderInfo providerInfo = (SqlConnectionPoolProviderInfo)
                            pool.ProviderInfo;
                        // No lock since we are already in creation mutex
                    ...
                    opt = new SqlConnectionString(
                        ...
                        ,
                        null /* do not modify the Enlist value */
                    );
                    poolGroupProviderInfo = null; // null so we do not pass to constructor below...
                }
                result = new SqlInternalConnectionTds(
                    identity,
                    opt,
                    key.Credential,
                    poolGroupProviderInfo,
        ...
        )
        {
            ...
            NameValueCollection settings = (NameValueCollection)
                PrivilegedConfigurationManager.GetSection("system.data.sqlclient");
            if (settings != null)
            {
        ...
        {
            SqlConnectionString connectionOptions = (SqlConnectionString)
        ...
        )
        {
            ...
            SqlInternalConnectionSmi result = (SqlInternalConnectionSmi)
    ...
    internal sealed class SqlPerformanceCounters : DbConnectionPoolCounters
    {
        ...
        public static readonly SqlPerformanceCounters SingletonInstance =
            new SqlPerformanceCounters();
