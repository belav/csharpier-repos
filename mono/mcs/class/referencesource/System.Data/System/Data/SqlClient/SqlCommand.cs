...
namespace System.Data.SqlClient
{
    ...
    [
        ...
        ToolboxItem(true),
        Designer(
            "Microsoft.VSDesigner.Data.VS.SqlCommandDesigner, " + AssemblyRef.MicrosoftVSDesigner
        )
    ]
    public sealed class SqlCommand : DbCommand, ICloneable
    {
        ...
        internal bool IsColumnEncryptionEnabled
        {
            ...
            {
                return (
                        _columnEncryptionSetting == SqlCommandColumnEncryptionSetting.Enabled
                        || (
        ...
        {
            get { return _isDescribeParameterEncryptionRPCCurrentlyInProgress; }
        }
        ...
        sealed private class CommandEventSink : SmiEventSink_Default
        {
            ...
            internal override void StatementCompleted(int rowsAffected)
            {
                ...
                {
                    Bid.Trace(
                        "<sc.SqlCommand.CommandEventSink.StatementCompleted|ADV> %d#, rowsAffected=%d.\n",
                        _command.ObjectID,
                        rowsAffected
                    );
                }
            ...
            internal override void BatchCompleted()
            {
                ...
                {
                    Bid.Trace(
                        "<sc.SqlCommand.CommandEventSink.BatchCompleted|ADV> %d#.\n",
                        _command.ObjectID
                    );
                }
            }

            internal override void ParametersAvailable(
                SmiParameterMetaData[] metaData,
                ITypedGettersV3 parameterValues
            )
            {
                if (Bid.AdvancedOn)
                {
                    Bid.Trace(
                        ...
                        _command.ObjectID,
                        (null != metaData) ? metaData.Length : -1
                    );
                    ...
                    if (null != metaData)
                    {
                        for (int i = 0; i < metaData.Length; i++)
                        {
                            Bid.Trace(
                                ...
                                _command.ObjectID,
                                i,
                                metaData[i].GetType().ToString(),
                                metaData[i].TraceString()
                            );
                        }
                    }
                }
        ...
        { // Clone
            ...
            {
                parameters.Add(
                    (parameter is ICloneable) ? (parameter as ICloneable).Clone() : parameter
                );
            }
        }
        ...
        new public SqlConnection Connection
        {
            ...
            set
            {
                ...
                Bid.Trace(
                    "<sc.SqlCommand.set_Connection|API> %d#, %d#\n",
                    ObjectID,
                    ((null != value) ? value.ObjectID : -1)
                );
            }
        }
        ...
        {
            get { return (SqlInternalConnectionSmi)_activeConnection.InnerConnection; }
        }

        private SqlInternalConnectionTds InternalTdsConnection
        {
            get { return (SqlInternalConnectionTds)_activeConnection.InnerConnection; }
        }
        ...
        {
            get { return _notificationAutoEnlist; }
        ...
        [
            DefaultValue(""),
            Editor(
                "Microsoft.VSDesigner.Data.SQL.Design.SqlCommandTextEditor, "
                    + AssemblyRef.MicrosoftVSDesigner,
                "System.Drawing.Design.UITypeEditor, " + AssemblyRef.SystemDrawing
            ),
        ...
        { // V1.2.3300, XXXCommand V1.0.5000
            ...
            {
                Bid.Trace(
                    "<sc.SqlCommand.set_CommandType|API> %d#, %d{ds.CommandType}\n",
                    ObjectID,
                    (int)value
                );
        ...
        {
            add { _statementCompletedEventHandler += value; }
            remove { _statementCompletedEventHandler -= value; }
        }
        ...
        override public void Prepare()
        {
            ...
            Bid.CorrelationTrace(
                "<sc.SqlCommand.Prepare|API|Correlation> ObjectID%d#, ActivityID %ls\n",
                ObjectID
            );
        ...
        private void InternalPrepare()
        {
            ...
            {
                Debug.Assert(
                    _cachedMetaData == null || !_dirty,
                    "dirty query should not have cached metadata!"
            ...
            Debug.Assert(
                null != _stateObj.Parser,
                "TdsParser class should not be null in Command.Execute!"
            );
            Debug.Assert(
                _stateObj.Parser == _activeConnection.Parser,
                "stateobject parser not same as connection parser"
            );
            Debug.Assert(
                false == _inPrepare,
                "Already in Prepare cycle, this.inPrepare should be false!"
            );
        ...
        internal void Unprepare()
        {
            ...
            if (
                (_activeConnection.CloseCount != _preparedConnectionCloseCount)
        ...
        override public void Cancel()
        {
            ...
            Bid.CorrelationTrace(
                "<sc.SqlCommand.Cancel|API|Correlation> ObjectID%d#, ActivityID %ls\n",
                ObjectID
            );
            ...
            try
            {
                ...
                SqlInternalConnectionTds connection = (
                    _activeConnection.InnerConnection as SqlInternalConnectionTds
                );
                if (null == connection)
                ...
                lock (connection)
                {
                    ...
                    try
                    {
                        ...
                        {
#endif //DEBUG
                            bestEffortCleanupTarget =
                                SqlInternalConnection.GetBestEffortCleanupTarget(_activeConnection);
        ...
        override public object ExecuteScalar()
        {
            ...
            Bid.CorrelationTrace(
                "<sc.SqlCommand.ExecuteScalar|API|Correlation> ObjectID%d#, ActivityID %ls\n",
                ObjectID
            );
        ...
        override public int ExecuteNonQuery()
        {
            ...
            Bid.CorrelationTrace(
                "<sc.SqlCommand.ExecuteNonQuery|API|Correlation> ObjectID%d#, ActivityID %ls\n",
                ObjectID
            );
            bool success = false;
            int? sqlExceptionNumber = null;
        ...
        {
            Bid.CorrelationTrace(
                "<sc.SqlCommand.BeginExecuteNonQuery|API|Correlation> ObjectID%d#, ActivityID %ls\n",
                ObjectID
            );
            SqlConnection.ExecutePermission.Demand();
        ...
        )
        {
            ...
            if (completionTask.IsCanceled)
            {
                ...
                {
                    Debug.Assert(
                        _reconnectionCompletionSource == null
                            || _reconnectionCompletionSource.Task.IsCanceled,
            ...
            if (
                (_activeConnection.State != ConnectionState.Open)
        ...
        public int EndExecuteNonQuery(IAsyncResult asyncResult)
        {
            ...
            {
                Bid.CorrelationTrace(
                    "<sc.SqlCommand.EndExecuteNonQuery|API|Correlation> ObjectID%d#, ActivityID %ls\n",
                    ObjectID
                );
            }
        }
        ...
        private void ThrowIfReconnectionHasBeenCanceled()
        {
            if (_stateObj == null)
            {
                ...
                if (
                    reconnectionCompletionSource != null
                    && reconnectionCompletionSource.Task.IsCanceled
                )
                {
                    throw SQL.CR_ReconnectionCancelled();
                }
...
#else
                {
                    ...
                    if (IsColumnEncryptionEnabled)
                    {
                        VerifyEndExecuteState(
                            (Task)asyncResult,
                            endMethod,
                            fullCheckForColumnEncryption: true
                        );
                    }
        ...
        public XmlReader ExecuteXmlReader()
        {
            ...
            Bid.CorrelationTrace(
                "<sc.SqlCommand.ExecuteXmlReader|API|Correlation> ObjectID%d#, ActivityID %ls\n",
                ObjectID
            );
            bool success = false;
            int? sqlExceptionNumber = null;
        ...
        {
            Bid.CorrelationTrace(
                "<sc.SqlCommand.BeginExecuteXmlReader|API|Correlation> ObjectID%d#, ActivityID %ls\n",
                ObjectID
            );
            SqlConnection.ExecutePermission.Demand();
        ...
        public XmlReader EndExecuteXmlReader(IAsyncResult asyncResult)
        {
            ...
            {
                Bid.CorrelationTrace(
                    "<sc.SqlCommand.EndExecuteXmlReader|API|Correlation> ObjectID%d#, ActivityID %ls\n",
                    ObjectID
                );
            }
        }
        ...
        private XmlReader CompleteXmlReader(SqlDataReader ds)
        {
            ...
            bool isXmlCapable = (
                ...
                && md.Length == 1
                && (
                    md[0].SqlDbType == SqlDbType.NText
            ...
            if (isXmlCapable)
            {
                try
                {
                    SqlStream sqlBuf = new SqlStream(
                        ...
                        ,
                        (md[0].SqlDbType == SqlDbType.Xml) ? false : true /*process all rows*/
                    );
        ...
        new public SqlDataReader ExecuteReader()
        {
            ...
            Bid.CorrelationTrace(
                "<sc.SqlCommand.ExecuteReader|API|Correlation> ObjectID%d#, ActivityID %ls\n",
                ObjectID
            );
            try
            {
        ...
        new public SqlDataReader ExecuteReader(CommandBehavior behavior)
        {
            ...
            Bid.ScopeEnter(
                out hscp,
                "<sc.SqlCommand.ExecuteReader|API> %d#, behavior=%d{ds.CommandBehavior}",
                ObjectID,
                (int)behavior
            );
            Bid.CorrelationTrace(
                "<sc.SqlCommand.ExecuteReader|API|Correlation> ObjectID%d#, behavior=%d{ds.CommandBehavior}, ActivityID %ls\n",
                ObjectID,
                (int)behavior
            );
            try
        ...
        internal SqlDataReader ExecuteReader(CommandBehavior behavior, string method)
        {
            ...
            try
            {
...
#else
                {
                    ...
                    statistics = SqlStatistics.StartTimer(Statistics);
                    SqlDataReader result = RunExecuteReader(
                        behavior,
                        RunBehavior.ReturnImmediately,
                        true,
                        method
        ...
        {
            return BeginExecuteReaderInternal(
                behavior,
                callback,
                stateObject,
                CommandTimeout,
        ...
        private bool TriggerInternalEndAndRetryIfNecessary(
            ...
            Func<IAsyncResult, string, bool, object> endFunc,
        ...
        )
        {
            ...
            if (
                (IsColumnEncryptionEnabled && !inRetry && usedCache)
#if DEBUG
        ...
        private SqlDataReader InternalEndExecuteReader(
            IAsyncResult asyncResult,
            string endMethod,
            bool isInternal
        )
        ...
        {
            Bid.CorrelationTrace(
                "<sc.SqlCommand.ExecuteNonQueryAsync|API|Correlation> ObjectID%d#, ActivityID %ls\n",
                ObjectID
            );
            SqlConnection.ExecutePermission.Demand();
        ...
        internal void DeriveParameters()
        {
            ...
            try
            {
                ...
                while (r.Read())
                {
                    ...
                    {
                        p.SqlDbType = MetaType.GetSqlDbTypeFromOleDbType(
                            (short)r[colNames[(int)ProcParamsColIndex.DataType]],
                    ...
                    // direction
                    p.Direction = ParameterDirectionFromOleDbDirection(
                        (short)r[colNames[(int)ProcParamsColIndex.ParameterType]]
                    );

                    if (p.SqlDbType == SqlDbType.Decimal)
                    {
                        p.ScaleInternal = (byte)(
                            (short)r[colNames[(int)ProcParamsColIndex.NumericScale]] & 0xff
                        );
                        p.PrecisionInternal = (byte)(
                            (short)r[colNames[(int)ProcParamsColIndex.NumericPrecision]] & 0xff
                        );
                    }
                    ...
                    {
                        Debug.Assert(
                            this._activeConnection.IsYukonOrNewer,
                        ...
                        //read the type name
                        p.UdtTypeName =
                            r[colNames[(int)ProcParamsColIndex.TypeCatalogName]]
                            + "."
                    ...
                    {
                        Debug.Assert(
                            this._activeConnection.IsKatmaiOrNewer,
                            "Invalid datatype token received from pre-katmai server"
                        );
                    ...
                    if (SqlDbType.Xml == p.SqlDbType)
                    {
                        ...
                        p.XmlSchemaCollectionDatabase = ADP.IsNull(value)
                            ? String.Empty
                            : (string)value;

                        value = r[colNames[(int)ProcParamsColIndex.XmlSchemaCollectionSchemaName]];
                        p.XmlSchemaCollectionOwningSchema = ADP.IsNull(value)
                            ? String.Empty
                            : (string)value;

                        value = r[colNames[(int)ProcParamsColIndex.XmlSchemaCollectionName]];
                        p.XmlSchemaCollectionName = ADP.IsNull(value)
                            ? String.Empty
                            : (string)value;
                    }
        ...
        {
            Debug.Assert(
                oledbDirection >= 1 && oledbDirection <= 4,
            ...
            if (null != Notification)
            {
                if (_sqlDep != null)
                {
                    if (null == _sqlDep.Options)
                    {
                        ...
                        {
                            identityUserName = new SqlDependency.IdentityUserNamePair(
        ...
        static internal string SqlNotificationContext()
        {
            ...
            return (
                System.Runtime.Remoting.Messaging.CallContext.GetData("MS.SqlDependencyCookie")
                as string
            );
        }

        // Tds-specific logic for ExecuteNonQuery run handling
        private Task RunExecuteNonQueryTds(
            string methodName,
            bool async,
            int timeout,
            bool asyncWrite
                        ...
                        AsyncHelper.ContinueTask(
                            ...
                            () =>
                            {
                                ...
                                Interlocked.CompareExchange(
                                    ref _reconnectionCompletionSource,
                                    null,
                                    completion
                                );
                                timeoutCTS.Cancel();
            ...
            try
            {
...
#else
                {
                    ...
                    try
                    {
                        ...
                        Debug.Assert(
                            fetchInputParameterEncryptionInfoTask == null || async,
                            "Task returned by TryFetchInputParameterEncryptionInfo, when in sync mode, in PrepareForTransparentEncryption."
                        );

                        Debug.Assert(
                            (describeParameterEncryptionRpcOriginalRpcMap != null) == BatchRPCMode,
                        ...
                        {
                            Debug.Assert(
                                null == fetchInputParameterEncryptionInfoTask,
                        ...
                        if (fetchInputParameterEncryptionInfoTask != null)
                        {
                            ...
                            returnTask = AsyncHelper.CreateContinuationTask(
                                ...
                                () =>
                                {
                                    ...
                                    {
#if DEBUG
                                        TdsParser.ReliabilitySection tdsReliabilitySectionAsync =
                                            new TdsParser.ReliabilitySection();
                                        RuntimeHelpers.PrepareConstrainedRegions();
                                        try
                                        {
        ...
        )
        {
            ...
            if (BatchRPCMode)
            {
                ...
                describeParameterEncryptionRpcOriginalRpcMap = new ReadOnlyDictionary<
                    _SqlRPC,
                    _SqlRPC
                ...
                Debug.Assert(
                    _sqlRPCParameterEncryptionReqArray.Length <= _SqlRPCBatchArray.Length,
            ...
            else if (0 != GetParameterCount(_parameters))
            {
                ...
                Debug.Assert(
                    _sqlRPCParameterEncryptionReqArray[0] != null,
        ...
        private SqlParameter GetSqlParameterWithQueryText(string queryText)
        {
            SqlParameter sqlParam = new SqlParameter(
                null,
                ((queryText.Length << 1) <= TdsEnums.TYPE_SIZE_LIMIT)
                    ? SqlDbType.NVarChar
                    : SqlDbType.NText,
                queryText.Length
            );
        ...
        )
        {
            ...
            {
                Debug.Assert(
                    originalRpcRequest.parameters != null
                        && originalRpcRequest.parameters.Length > 0,
            ...
            else
            {
                ...
                if (CommandType == Data.CommandType.StoredProcedure)
                {
                    ...
                    sqlParam = BuildStoredProcedureStatementForColumnEncryption(
                        text,
                        originalRpcRequest.parameters
                    );
                }
                else
                {
            ...
            Debug.Assert(
                text != null,
                "@tsql parameter is null in PrepareDescribeParameterEncryptionRequest."
            );
            ...
            else
            {
                ...
                if (_activeConnection.Parser != null)
                {
                    ...
                    if (
                        (tdsParser == null)
                        || (tdsParser.State == TdsParserState.Broken)
                        || (tdsParser.State == TdsParserState.Closed)
                    )
                    {
            ...
            Debug.Assert(
                ...
                "parameterList should not be null or empty or whitespace."
            );

            sqlParam = new SqlParameter(
                null,
                ((parameterList.Length << 1) <= TdsEnums.TYPE_SIZE_LIMIT)
                    ? SqlDbType.NVarChar
                    : SqlDbType.NText,
        ...
        )
        {
            ...
            Dictionary<int, SqlTceCipherInfoEntry> columnEncryptionKeyTable =
                new Dictionary<int, SqlTceCipherInfoEntry>();
            ...
            do
            {
                ...
                while (ds.Read())
                {
                    ...
                    Debug.Assert(
                        !cipherInfoEntry.Equals(default(SqlTceCipherInfoEntry)),
                        "cipherInfoEntry should not be un-initialized."
                    );

                    // Read the CEK.
                    byte[] encryptedKey = null;
                    int encryptedKeyLength = (int)
                        ds.GetBytes(
                    ...
                    string providerName = ds.GetString(
                        (int)DescribeParameterEncryptionResultSet1.ProviderName
                    );
                    ...
                    cipherInfoEntry.Add(
                        ...
                        algorithmName: ds.GetString(
                            (int)DescribeParameterEncryptionResultSet1.KeyEncryptionAlgorithm
                        )
                    );
                }
                ...
                {
                    Debug.Assert(
                        _sqlRPCParameterEncryptionReqArray[resultSetSequenceNumber] != null,
                    ...
                    lookupDictionaryResult =
                        describeParameterEncryptionRpcOriginalRpcMap.TryGetValue(
                ...
                while (ds.Read())
                {
                    ...
                    Debug.Assert(
                        rpc != null,
                        "Describe Parameter Encryption requested for non-tce spec proc"
                    );
                    string parameterName = ds.GetString(
                    ...
                    for (
                        ...
                        paramIdx < rpc.parameters.Length && rpc.parameters[paramIdx] != null;
                        paramIdx++
                    )
                    {
                        ...
                        {
                            Debug.Assert(
                                sqlParameter.CipherMetadata == null,
                                "param.CipherMetadata should be null."
                            );
                            sqlParameter.HasReceivedMetadata = true;

                            // Found the param, setup the encryption info.
                            byte columnEncryptionType = ds.GetByte(
                                (int)DescribeParameterEncryptionResultSet2.ColumnEncrytionType
                            );
                            if ((byte)SqlClientEncryptionType.PlainText != columnEncryptionType)
                            {
                                byte cipherAlgorithmId = ds.GetByte(
                                    (int)
                                        DescribeParameterEncryptionResultSet2.ColumnEncryptionAlgorithm
                                );
                                int columnEncryptionKeyOrdinal = ds.GetInt32(
                                    (int)
                                        DescribeParameterEncryptionResultSet2.ColumnEncryptionKeyOrdinal
                                );
                                byte columnNormalizationRuleVersion = ds.GetByte(
                                    (int)
                                        DescribeParameterEncryptionResultSet2.NormalizationRuleVersion
                                );

                                // Lookup the key, failing which throw an exception
                                if (
                                    !columnEncryptionKeyTable.TryGetValue(
                                        columnEncryptionKeyOrdinal,
                                        out cipherInfoEntry
                                    )
                                )
                                {
                                    throw SQL.InvalidEncryptionKeyOrdinal(
                                        columnEncryptionKeyOrdinal,
                                ...
                                Debug.Assert(
                                    _activeConnection != null,
                                    @"_activeConnection should not be null"
                                );
                                SqlSecurityUtility.DecryptSymmetricKey(
                                    sqlParameter.CipherMetadata,
                ...
                {
                    if (
                        !rpc.parameters[paramIdx].HasReceivedMetadata
                    ...
                    )
                    {
                        ...
                        throw SQL.ParamEncryptionMetadataMissing(
                            rpc.parameters[paramIdx].ParameterName,
                            rpc.GetCommandTextOrRpcName()
                        );
                    }
                }
...
#if DEBUG
                Debug.Assert(
                    rowsAffected == RowsAffectedByDescribeParameterEncryption,
            ...
            if (!BatchRPCMode)
            {
                SqlQueryMetadataCache
                    .GetInstance()
                    .AddQueryMetadata(this, ignoreQueriesWithReturnValueParams: true);
            }
        }
        ...
        )
        {
            ...
            try
            {
...
#else
                {
                    ...
                    {
                        if (
                            (!this.IsDirty && this.IsPrepared && !_hiddenPrepare)
                    ...
                    else if (IsColumnEncryptionEnabled)
                    {
                        ...
                        Debug.Assert(
                            usedCache || (async == (returnTask != null)),
                            @"if we didn't use the cache, returnTask should be null if and only if async is false."
                        );
        ...
        )
        {
            ...
            try
            {
                ...
                else if (BatchRPCMode)
                {
                    Debug.Assert(
                        inSchema == false,
                        "Batch RPC does not support schema only command beahvior"
                    );
                ...
                )
                {
                    ...
                    Debug.Assert(
                        !IsUserPrepared,
                        "CommandType.Text with no params should not be prepared!"
                    );
                    if (returnStream)
                    {
                        Bid.Trace(
                ...
                else if (System.Data.CommandType.Text == this.CommandType)
                {
                    ...
                    {
                        Debug.Assert(
                            this.IsPrepared && (_prepareHandle != -1),
                            "invalid attempt to call sp_execute without a handle!"
                        );
        ...
        private SqlDataReader CompleteAsyncExecuteReader(
            ...
            bool forDescribeParameterEncryption = false
        )
        {
        ...
        internal void OnDoneDescribeParameterEncryptionProc(TdsParserStateObject stateObj)
        {
            ...
            if (BatchRPCMode)
            {
                ...
                _sqlRPCParameterEncryptionReqArray[
                    ...
                    (
                        ...
                        ? (
                            ...
                            - Math.Max(
                                _sqlRPCParameterEncryptionReqArray[
                                    _currentlyExecutingDescribeParameterEncryptionRPC - 1
                ...
                _sqlRPCParameterEncryptionReqArray[
                    _currentlyExecutingDescribeParameterEncryptionRPC
                ].errorsIndexEnd = stateObj.ErrorCount;
                _sqlRPCParameterEncryptionReqArray[
                    _currentlyExecutingDescribeParameterEncryptionRPC
                ].errors = stateObj._errors;
                ...
                _sqlRPCParameterEncryptionReqArray[
                    _currentlyExecutingDescribeParameterEncryptionRPC
                ].warningsIndexEnd = stateObj.WarningCount;
                _sqlRPCParameterEncryptionReqArray[
                    _currentlyExecutingDescribeParameterEncryptionRPC
                ].warnings = stateObj._warnings;
        ...
        { // called per rpc batch complete
            if (BatchRPCMode)
            {
                // track the records affected for the just completed rpc batch
                // _rowsAffected is cumulative for ExecuteNonQuery across all rpc batches
                _SqlRPCBatchArray[_currentlyExecutingBatch].cumulativeRecordsAffected =
                    _rowsAffected;
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                if (parameter.Direction == ParameterDirection.ReturnValue)
                {
                    ...
                    if (!BatchRPCMode && CachingQueryMetadataPostponed)
                    {
                        SqlQueryMetadataCache
                            .GetInstance()
                            .AddQueryMetadata(this, ignoreQueriesWithReturnValueParams: false);
                    }
        ...
        internal void OnReturnValue(SqlReturnValue rec, TdsParserStateObject stateObj)
        {
            ...
            SqlParameter thisParam = GetParameterForOutputValueExtraction(
                parameters,
                rec.parameter,
                count
            );
        ...
        internal void OnParametersAvailableSmi(
            SmiParameterMetaData[] paramMetaData,
            ITypedGettersV3 parameterValues
        )
        {
        ...
        internal void OnParameterAvailableSmi(
            SmiParameterMetaData metaData,
            ITypedGettersV3 parameterValues,
            int ordinal
        )
            ...
            else
            {
                for (int i = 0; i < paramCount; i++)
                {
                    ...
                    if (
                        ...
                        && thisParam.Direction != ParameterDirection.ReturnValue
                        && paramName == thisParam.ParameterNameFixed
                    )
                    {
                        foundParam = true;
                        break; // found it
        ...
        private void GetRPCObject(
            int paramCount,
            ref _SqlRPC rpc,
            bool forSpDescribeParameterEncryption = false
        )
        {
        ...
        private void SetUpRPCParameters(
            _SqlRPC rpc,
            int startCount,
            bool inSchema,
            SqlParameterCollection parameters
        )
        {
            ...
            for (ii = 0; ii < paramCount; ii++)
            {
                ...
                if (
                    (!parameter.ValidateTypeLengths(yukonOrNewer).IsPlp)
                ...
                if (ShouldSendParameter(parameter))
                {
                    ...
                    if (parameter.Direction != ParameterDirection.Output)
                    {
                        ...
                        if (
                            ...
                            && (!inSchema || SqlDbType.Structured == parameter.SqlDbType)
                        )
                        {
        ...
        private _SqlRPC BuildPrepExec(CommandBehavior behavior)
        {
            ...
            sqlParam = new SqlParameter(
                null,
                ((paramList.Length << 1) <= TdsEnums.TYPE_SIZE_LIMIT)
                    ? SqlDbType.NVarChar
                    : SqlDbType.NText,
                paramList.Length
            );
            ...
            sqlParam = new SqlParameter(
                null,
                ((text.Length << 1) <= TdsEnums.TYPE_SIZE_LIMIT)
                    ? SqlDbType.NVarChar
                    : SqlDbType.NText,
                text.Length
            );
        ...
        private _SqlRPC BuildUnprepare()
        {
            Debug.Assert(
                _prepareHandle != 0,
                "Invalid call to sp_unprepare without a valid handle!"
            );
        ...
        private _SqlRPC BuildExecute(bool inSchema)
        {
            Debug.Assert(
                _prepareHandle != -1,
                "Invalid call to sp_execute without a valid handle!"
            );
            int j = 1;
        ...
        )
        {
            ...
            sqlParam = new SqlParameter(
                null,
                ((commandText.Length << 1) <= TdsEnums.TYPE_SIZE_LIMIT)
                    ? SqlDbType.NVarChar
                    : SqlDbType.NText,
                commandText.Length
            );
        ...
        )
        {
            ...
            Debug.Assert(
                parameters != null,
                "parameters cannot be null in BuildStoredProcedureStatementForColumnEncryption"
            );
            ...
            SqlParameter tsqlParameter = new SqlParameter(
                null,
                ((execStatement.Length << 1) <= TdsEnums.TYPE_SIZE_LIMIT)
                    ? SqlDbType.NVarChar
                    : SqlDbType.NText,
        ...
        internal string BuildParamList(
            TdsParser parser,
            SqlParameterCollection parameters,
        ...
        )
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                else if (mt.IsVarTime)
                {
                    ...
                    false == mt.IsFixed
                    && false == mt.IsLong
                    && mt.SqlDbType != SqlDbType.Timestamp
        ...
        private string GetSetOptionsString(CommandBehavior behavior)
        {
            ...
            if (
                (System.Data.CommandBehavior.SchemaOnly == (behavior & CommandBehavior.SchemaOnly))
                ...
                return (
                    ...
                    && (
                        ...
                        || (
                            (activeConnection != null)
                            && (
                                (activeConnection.CloseCount != _preparedConnectionCloseCount)
                                || (
                                    activeConnection.ReconnectCount
        ...
        {
            get { return _rowsAffectedBySpDescribeParameterEncryption; }
            set
            {
        ...
        private void SetColumnEncryptionSetting(
            SqlCommandColumnEncryptionSetting newColumnEncryptionSetting
        )
        {
        ...
        internal SqlException GetErrors(int commandIndex)
        {
            ...
            int length = (
                _SqlRPCBatchArray[commandIndex].errorsIndexEnd
            ...
            if (0 < length)
            {
                ...
                for (
                    int i = _SqlRPCBatchArray[commandIndex].errorsIndexStart;
                    i < _SqlRPCBatchArray[commandIndex].errorsIndexEnd;
                    ++i
                )
                {
                ...
                for (
                    int i = _SqlRPCBatchArray[commandIndex].warningsIndexStart;
                    i < _SqlRPCBatchArray[commandIndex].warningsIndexEnd;
                    ++i
                )
                {
        ...
        private SmiRequestExecutor SetUpSmiRequest(SqlInternalConnectionSmi innerConnection)
        {
                ...
                for (int index = 0; index < count; index++)
                {
                    ...
                    if (!innerConnection.IsKatmaiOrNewer)
                    {
                        MetaType mt = MetaType.GetMetaTypeFromSqlDbType(
                            requestMetaData[index].SqlDbType,
            ...
            {
                if (
                    ParameterDirection.Output != requestMetaData[index].Direction
                ...
                )
                {
                    ...
                    ExtendedClrTypeCode typeCode =
                        MetaDataUtilsSmi.DetermineExtendedTypeCodeForUseWithSqlDbType(
                            ...
                            requestMetaData[index].IsMultiValued,
                            value,
                            null /* parameters don't use CLR Type for UDTs */
                            ,
                            SmiContextFactory.Instance.NegotiatedSmiVersion
                        );
                    ...
                    if (
                        CommandType.StoredProcedure == cmdType
                    ...
                    else
                    {
                        ...
                        if (
                            size != 0
                            && size != SmiMetaData.UnlimitedMaxLengthIndicator
                            && !param.SizeInferred
                        )
                        {
                            switch (requestMetaData[index].SqlDbType)
                            {
                                ...
                                case SqlDbType.VarChar:
                                    ...
                                    if (
                                        size > 0
                                        && size != Int32.MaxValue
                                        && requestMetaData[index].MaxLength
                                ...
                                case SqlDbType.Variant:
                                    ...
                                    if (null != value)
                                    {
                                        ...
                                        if (
                                            (
                                                mt.IsNCharType
                                                && size < SmiMetaData.MaxUnicodeCharacters
                                            )
                                            || (mt.IsBinType && size < SmiMetaData.MaxBinaryLength)
                                            || (
                                                mt.IsAnsiType
                                                && size < SmiMetaData.MaxANSICharacters
                                            )
                                        )
                                        {
                                            throw SQL.ParameterSizeRestrictionFailure(index);
        ...
        )
        {
            ...
            else
            {
                ...
                if (tempCachedAsyncState != null)
                {
                    ...
                    if (reader != null)
                    {
                        reader.CompletePendingReadWithFailure(
                            errorCode,
