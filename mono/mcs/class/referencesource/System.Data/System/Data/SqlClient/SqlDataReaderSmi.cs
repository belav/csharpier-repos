...
namespace System.Data.SqlClient
{
    ...
    internal sealed class SqlDataReaderSmi : SqlDataReader
    {
        ...
        public override String GetDataTypeName(int ordinal)
        {
            ...
            {
                return md.TypeSpecificNamePart1
                    + "."
                    + md.TypeSpecificNamePart2
                    + "."
                    + md.TypeSpecificNamePart3;
            }
            else
            {
                return md.TypeName;
            ...
            else
            {
                return MetaType
                    .GetMetaTypeFromSqlDbType(
                        _currentMetaData[ordinal].SqlDbType,
                        _currentMetaData[ordinal].IsMultiValued
                    )
                    .ClassType;
            }
        }
        ...
        public override Object GetValue(int ordinal)
        {
            ...
            if (_currentConnection.IsKatmaiOrNewer)
            {
                return ValueUtilsSmi.GetValue200(
                    ...
                    ordinal,
                    metaData,
                    _currentConnection.InternalContext
                );
            }
            else
            {
        ...
        )
        {
            ...
            return ADP.CreatedTaskWithException<T>(
        ...
        internal override SqlBuffer.StorageType GetVariantInternalStorageType(int ordinal)
        {
            Debug.Assert(
                ...
                "Attempting to get variant internal storage type without calling GetValue first"
            );
            if (IsDBNull(ordinal))
                return SqlBuffer.StorageType.Empty;

            SmiMetaData valueMetaData = _currentColumnValuesV3.GetVariantType(
                _readerEventSink,
                ordinal
            );
        ...
        public override int GetValues(object[] values)
        {
            ...
            int copyLength =
                (values.Length < _visibleColumnCount) ? values.Length : _visibleColumnCount;
        ...
        {
            get { return GetValue(GetOrdinal(strName)); }
        }
        ...
        {
            // As per Async spec, Context Connections do not support async
            return ADP.CreatedTaskWithException<bool>(
                ADP.ExceptionWithStackTrace(SQL.NotAvailableOnContextConnection())
            );
        }
        ...
        public override bool GetBoolean(int ordinal)
        {
            ...
            return ValueUtilsSmi.GetBoolean(
                _readerEventSink,
                _currentColumnValuesV3,
                ordinal,
        ...
        internal override long GetBytesInternal(
            int ordinal,
            long fieldOffset,
            byte[] buffer,
            int bufferOffset,
        ...
        {
            EnsureCanGetCol("GetBytes", ordinal);
            return ValueUtilsSmi.GetBytesInternal(
                _readerEventSink,
                _currentColumnValuesV3,
                ordinal,
                _currentMetaData[ordinal],
        ...
        public override Single GetFloat(int ordinal)
        {
            ...
            return ValueUtilsSmi.GetSingle(
                _readerEventSink,
                _currentColumnValuesV3,
                ordinal,
                _currentMetaData[ordinal]
        ...
        public override Double GetDouble(int ordinal)
        {
            ...
            return ValueUtilsSmi.GetDouble(
                _readerEventSink,
                _currentColumnValuesV3,
                ordinal,
                _currentMetaData[ordinal]
        ...
        public override String GetString(int ordinal)
        {
            ...
            return ValueUtilsSmi.GetString(
                _readerEventSink,
                _currentColumnValuesV3,
                ordinal,
                _currentMetaData[ordinal]
        ...
        public override Decimal GetDecimal(int ordinal)
        {
            ...
            return ValueUtilsSmi.GetDecimal(
                _readerEventSink,
                _currentColumnValuesV3,
                ordinal,
                _currentMetaData[ordinal]
        ...
        public override DateTime GetDateTime(int ordinal)
        {
            ...
            return ValueUtilsSmi.GetDateTime(
                _readerEventSink,
                _currentColumnValuesV3,
                ordinal,
                _currentMetaData[ordinal]
        ...
        {
            get { return IsReallyClosed(); }
        }

        public override int RecordsAffected
        {
            get { return base.Command.InternalRecordsAffected; }
        }
        ...
        internal unsafe bool InternalNextResult(bool ignoreNonFatalMessages)
        {
            ...
            if (Bid.AdvancedOn)
            {
                Bid.ScopeEnter(
                    out hscp,
                    "<sc.SqlDataReaderSmi.InternalNextResult|ADV> %d#",
                    ObjectID
                );
            }
            try
            ...
            try
            {
                ...
                if (FInResults())
                {
                    ...
                    while (
                        ...
                        && // Did we find a row?
                        null == _currentColumnValuesV3
                        && // Did we find a V3 row?
                        FInResults()
                        && // Was the batch terminated due to a serious error?
                        PositionState.AfterRows != _currentPosition
                        && // Have we seen a statement completed event?
        ...
        public override DataTable GetSchemaTable()
        {
            ...
            if (null == _schemaTable && FInResults())
            {
                ...
                DataColumn ProviderSpecificDataType = new DataColumn(
                ...
                DataColumn NonVersionedProviderType = new DataColumn(
                    SchemaTableColumn.NonVersionedProviderType,
                    typeof(System.Int32)
                );
                ...
                DataColumn IsHidden = new DataColumn(
                ...
                DataColumn UdtAssemblyQualifiedName = new DataColumn(
                    "UdtAssemblyQualifiedName",
                    typeof(System.String)
                );
                // Xml metadata specific
                DataColumn XmlSchemaCollectionDatabase = new DataColumn(
                    "XmlSchemaCollectionDatabase",
                    typeof(System.String)
                );
                DataColumn XmlSchemaCollectionOwningSchema = new DataColumn(
                    "XmlSchemaCollectionOwningSchema",
                    typeof(System.String)
                );
                DataColumn XmlSchemaCollectionName = new DataColumn(
                ...
                for (int i = 0; i < InternalFieldCount; i++)
                {
                    ...
                    MetaType metaType = MetaType.GetMetaTypeFromSqlDbType(
                    ...
                    if (SmiMetaData.UnlimitedMaxLengthIndicator == maxLength)
                    {
                        ...
                        maxLength =
                            (metaType.IsSizeInCharacters && !metaType.IsPlp)
                                ? (0x7fffffff / 2)
                                : 0x7fffffff;
                    }
                    ...
                    //
                    if (
                        SqlDbType.Decimal == colMetaData.SqlDbType
                    ...
                    {
                        schemaRow[DataTypeName] =
                            colMetaData.TypeSpecificNamePart1
                            + "."
                            + colMetaData.TypeSpecificNamePart2
                            + "."
                            + colMetaData.TypeSpecificNamePart3;
                    }
                    else
                    {
                    ...
                    if (SqlDbType.Xml == colMetaData.SqlDbType)
                    {
                        ...
                        schemaRow[XmlSchemaCollectionOwningSchema] =
                            colMetaData.TypeSpecificNamePart2;
        ...
        public override SqlBinary GetSqlBinary(int ordinal)
        {
            ...
            return ValueUtilsSmi.GetSqlBinary(
                _readerEventSink,
                _currentColumnValuesV3,
                ordinal,
                _currentMetaData[ordinal]
        ...
        public override SqlBoolean GetSqlBoolean(int ordinal)
        {
            ...
            return ValueUtilsSmi.GetSqlBoolean(
                _readerEventSink,
                _currentColumnValuesV3,
                ordinal,
                _currentMetaData[ordinal]
        ...
        public override SqlByte GetSqlByte(int ordinal)
        {
            ...
            return ValueUtilsSmi.GetSqlByte(
                _readerEventSink,
                _currentColumnValuesV3,
                ordinal,
                _currentMetaData[ordinal]
        ...
        public override SqlInt16 GetSqlInt16(int ordinal)
        {
            ...
            return ValueUtilsSmi.GetSqlInt16(
                _readerEventSink,
                _currentColumnValuesV3,
                ordinal,
                _currentMetaData[ordinal]
        ...
        public override SqlInt32 GetSqlInt32(int ordinal)
        {
            ...
            return ValueUtilsSmi.GetSqlInt32(
                _readerEventSink,
                _currentColumnValuesV3,
                ordinal,
                _currentMetaData[ordinal]
        ...
        public override SqlInt64 GetSqlInt64(int ordinal)
        {
            ...
            return ValueUtilsSmi.GetSqlInt64(
                _readerEventSink,
                _currentColumnValuesV3,
                ordinal,
                _currentMetaData[ordinal]
        ...
        public override SqlSingle GetSqlSingle(int ordinal)
        {
            ...
            return ValueUtilsSmi.GetSqlSingle(
                _readerEventSink,
                _currentColumnValuesV3,
                ordinal,
                _currentMetaData[ordinal]
        ...
        public override SqlDouble GetSqlDouble(int ordinal)
        {
            ...
            return ValueUtilsSmi.GetSqlDouble(
                _readerEventSink,
                _currentColumnValuesV3,
                ordinal,
                _currentMetaData[ordinal]
        ...
        public override SqlMoney GetSqlMoney(int ordinal)
        {
            ...
            return ValueUtilsSmi.GetSqlMoney(
                _readerEventSink,
                _currentColumnValuesV3,
                ordinal,
                _currentMetaData[ordinal]
        ...
        public override SqlDateTime GetSqlDateTime(int ordinal)
        {
            ...
            return ValueUtilsSmi.GetSqlDateTime(
                _readerEventSink,
                _currentColumnValuesV3,
                ordinal,
                _currentMetaData[ordinal]
        ...
        public override SqlDecimal GetSqlDecimal(int ordinal)
        {
            ...
            return ValueUtilsSmi.GetSqlDecimal(
                _readerEventSink,
                _currentColumnValuesV3,
                ordinal,
                _currentMetaData[ordinal]
        ...
        public override SqlString GetSqlString(int ordinal)
        {
            ...
            return ValueUtilsSmi.GetSqlString(
                _readerEventSink,
                _currentColumnValuesV3,
                ordinal,
                _currentMetaData[ordinal]
        ...
        public override SqlGuid GetSqlGuid(int ordinal)
        {
            ...
            return ValueUtilsSmi.GetSqlGuid(
                _readerEventSink,
                _currentColumnValuesV3,
                ordinal,
                _currentMetaData[ordinal]
        ...
        public override TimeSpan GetTimeSpan(int ordinal)
        {
            ...
            return ValueUtilsSmi.GetTimeSpan(
                _readerEventSink,
                _currentColumnValuesV3,
                ordinal,
                _currentMetaData[ordinal],
                _currentConnection.IsKatmaiOrNewer
            );
        }
        ...
        public override DateTimeOffset GetDateTimeOffset(int ordinal)
        {
            ...
            return ValueUtilsSmi.GetDateTimeOffset(
                _readerEventSink,
                _currentColumnValuesV3,
                ordinal,
                _currentMetaData[ordinal],
        ...
        public override Stream GetStream(int ordinal)
        {
            ...
            if (
                (metaData.SqlDbType != SqlDbType.Variant)
            ...
            )
            {
                ...
                _currentStream = ValueUtilsSmi.GetSequentialStream(
                    _readerEventSink,
                    _currentColumnValuesV3,
                    ordinal,
                    metaData
            ...
            {
                return ValueUtilsSmi.GetStream(
                    _readerEventSink,
                    _currentColumnValuesV3,
                    ordinal,
                    metaData
        ...
        public override TextReader GetTextReader(int ordinal)
        {
            ...
            )
            {
                ...
                _currentTextReader = ValueUtilsSmi.GetSequentialTextReader(
                    _readerEventSink,
                    _currentColumnValuesV3,
                    ordinal,
                    metaData
            ...
            {
                return ValueUtilsSmi.GetTextReader(
                    _readerEventSink,
                    _currentColumnValuesV3,
                    ordinal,
                    metaData
        ...
        public override XmlReader GetXmlReader(int ordinal)
        {
            ...
            {
                stream = ValueUtilsSmi.GetStream(
                    _readerEventSink,
                    _currentColumnValuesV3,
                    ordinal,
                    _currentMetaData[ordinal],
...
#endif
                SmiExtendedMetaData[] visibleMetaData = new SmiExtendedMetaData[
                    _visibleColumnCount
                ];
        ...
        {
            return (
                PositionState.AfterResults == _currentPosition
                || PositionState.BeforeResults == _currentPosition
            );
        }
        ...
        private bool HasActiveStreamOrTextReaderOnColumn(int columnIndex)
        {
            ...
            active |= (
                (_currentTextReader != null) && (_currentTextReader.ColumnIndex == columnIndex)
            );
