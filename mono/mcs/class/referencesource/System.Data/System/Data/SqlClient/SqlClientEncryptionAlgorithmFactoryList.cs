...
namespace System.Data.SqlClient
{
    ...
    sealed internal class SqlClientEncryptionAlgorithmFactoryList
    {
        ...
        private static readonly SqlClientEncryptionAlgorithmFactoryList _singletonInstance =
            new SqlClientEncryptionAlgorithmFactoryList();

        private SqlClientEncryptionAlgorithmFactoryList()
        {
            _encryptionAlgoFactoryList = new ConcurrentDictionary<
                string,
                SqlClientEncryptionAlgorithmFactory
            >(
                concurrencyLevel: 4
        ...
        internal void GetAlgorithm(
            SqlClientSymmetricKey key,
            byte type,
            string algorithmName,
            out SqlClientEncryptionAlgorithm encryptionAlgorithm
        )
        {
            ...
            {
                throw SQL.UnknownColumnEncryptionAlgorithm(
                    algorithmName,
