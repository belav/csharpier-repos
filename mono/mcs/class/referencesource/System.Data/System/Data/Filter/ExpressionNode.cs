    ...
    internal abstract class ExpressionNode
    {
        ...
        internal static bool IsUnsignedSql(StorageType type)
        {
            return (
                ...
                || type == StorageType.UInt64
                || type == StorageType.SqlByte
                || // SqlByte represents an 8-bit unsigned integer, in the range of 0 through 255,
                type == StorageType.Byte
            );
        }
        ...
        {
            return (IsFloatSql(type) || IsIntegerSql(type));
        }
        ...
        internal static bool IsFloatSql(StorageType type)
        {
            return (
                ...
                || // I expect decimal to be Integer!
                type == StorageType.SqlMoney
                || // if decimal is here, this should be definitely here!
