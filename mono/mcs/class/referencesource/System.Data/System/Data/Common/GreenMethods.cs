...
namespace System.Data.Common
{
    internal static class GreenMethods
    {
        private const string ExtensionAssemblyRef =
            "System.Data.Entity, Version=4.0.0.0, Culture=neutral, PublicKeyToken="
        ...
        internal static Type SystemDataCommonDbProviderServices_Type = Type.GetType(
            SystemDataCommonDbProviderServices_TypeName,
            false
        );

        //------------------------------------------------------------------------------
        // Access to the SqlProviderServices class singleton instance;
        private const string SystemDataSqlClientSqlProviderServices_TypeName =
            "System.Data.SqlClient.SqlProviderServices, " + ExtensionAssemblyRef;
        ...
        internal static object SystemDataSqlClientSqlProviderServices_Instance()
        {
            if (null == SystemDataSqlClientSqlProviderServices_Instance_FieldInfo)
            {
                ...
                if (null != t)
                {
                    SystemDataSqlClientSqlProviderServices_Instance_FieldInfo = t.GetField(
                        "Instance",
