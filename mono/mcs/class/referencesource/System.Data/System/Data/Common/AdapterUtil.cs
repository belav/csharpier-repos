...
namespace System.Data.Common
{
...
#if !MOBILE
    using System.Data.Odbc;using System.Data.OleDb;
#endif
    using System.Data.Sql;using System.Data.SqlTypes;using System.Diagnostics;using System.Globalization;using System.IO;using System.Reflection;using System.Runtime.ConstrainedExecution;using System.Runtime.InteropServices;using System.Runtime.Serialization;using System.Security;using System.Security.Permissions;using System.Data.SqlClient;using System.Text;using System.Threading;using System.Threading.Tasks;using System.Xml;using SysTx = System.Transactions;
#if !MOBILE
    using SysES = System.EnterpriseServices;
#endif
    using System.Runtime.Versioning;using Microsoft.SqlServer.Server;
    ...
    internal static class ADP
    {
        ...
        internal static Task<bool> s_trueTask = Task.FromResult<bool>(true);

        internal static Task<bool> s_falseTask = Task.FromResult<bool>(false);

#if MONO
        static internal Task<bool> TrueTask => s_trueTask;
        internal static Task<bool> FalseTask => s_falseTask;
#endif
        ...
        internal static ArgumentException DoubleValuedProperty(
            string propertyName,
            string value1,
            string value2
        )
        ...
        internal static ArgumentOutOfRangeException NotSupportedCommandBehavior(
        ...
        internal static ArgumentOutOfRangeException InvalidUserDefinedTypeSerializationFormat(
        ...
        internal static ArgumentOutOfRangeException NotSupportedUserDefinedTypeSerializationFormat(
            Microsoft.SqlServer.Server.Format value,
            string method
        )
        {
        ...
        */
        ...
        internal static Exception MissingConnectionOptionValue(
            string key,
        ...
        internal static string FixUpDecimalSeparator(
