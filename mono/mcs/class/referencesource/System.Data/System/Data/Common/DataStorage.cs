...
namespace System.Data.Common
{
    ...
    internal abstract class DataStorage
    {
        ...
        )
        {
            ...
            IsStringType = (
                (StorageType.String == StorageTypeCode)
                || (StorageType.SqlString == StorageTypeCode)
            );
        ...
        {
            get { return Column.DateTimeMode; }
        }

        internal IFormatProvider FormatProvider
        {
            get { return Table.FormatProvider; }
        }
        ...
        )
        {
            ...
            switch (typeCode)
            {
                ...
                case StorageType.SqlDateTime:
                    return new SqlDateTimeStorage(column); //???/ what to do
        ...
        )
        {
            ...
            else
            {
                ...
                Tuple<bool, bool, bool, bool> interfaces = _typeImplementsInterface.GetOrAdd(
                    dataType,
        ...
        internal static Type GetType(string value)
        {
            ...
            // Dev10 671061: prevent reading type from schema which implements IDynamicMetaObjectProvider and
