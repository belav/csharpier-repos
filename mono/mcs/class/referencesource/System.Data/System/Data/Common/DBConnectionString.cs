...
namespace System.Data.Common
{
    ...
    internal sealed class DBConnectionString
    {
        ...
        readonly string _encryptedUsersConnectionString;

        private
        // hash of unique keys to values
        readonly Hashtable _parsetable;
...
#pragma warning disable 169
        ...
        readonly string _encryptedActualConnectionString;
            ...
            )
            {
                if (componentSet._behavior == KeyRestrictionBehavior.AllowOnly)
                {
                    ...
                    else
                    {
                        Debug.Assert(
                            false,
                            string.Format(
                                "Unknown behavior for combined set: {0}",
                ...
                else
                {
                    Debug.Assert(
                        false,
                        string.Format(
                            "Unknown behavior for component set: {0}",
