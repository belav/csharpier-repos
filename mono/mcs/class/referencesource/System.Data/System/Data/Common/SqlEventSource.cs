...
namespace System.Data
{
    ...
    internal sealed class SqlEventSource : EventSource
    {
        ...
        // if desired)
        /// <remarks>The visibility of the enum has to be public, otherwise there will be an
        // ArgumentException on calling related WriteEvent method.</remarks>
        /// </summary>
        ...
        // unfortunately these are not marked as Start/Stop opcodes.  The reason is that we dont want them
        // to participate in
        // the EventSource activity IDs (because they currently don't use tasks and this simply confuses the
        // logic) and
        // because of versioning requirements we don't have ActivityOptions capability (because mscorlib and
        // System.Data version
        ...
        {
            // we do not use unsafe code for better performance optization here because optimized helpers make
            // the code unsafe where that would not be the case otherwise.
            // This introduces the question of partial trust, which is complex in the SQL case (there are a lot
            // of scenarios and SQL has special security support).
            WriteEvent(
