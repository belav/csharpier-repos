...
namespace System.Data.Common
{
    ...
    { // V1.2.3300
        ...
        */
                        ...
                        case DbProviderConfigurationHandler.settings:
                            if (foundSettings)
                            {
                                throw ADP.ConfigSectionsUnique(
                                    DbProviderConfigurationHandler.settings
                                );
                            }
                            foundSettings = true;
                            DbProviderDictionarySectionHandler.CreateStatic(
        ...
        private sealed class DbProviderDictionarySectionHandler /* : IConfigurationSectionHandler*/
        {
