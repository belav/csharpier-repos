...
namespace System.Data.Common
{
    ...
    internal static class UnsafeNativeMethods
    {
        ...
        */
        ...
        internal interface ICommandWithParameters
        {
            ...
            System.Data.OleDb.OleDbHResult SetParameterInfo(
                ...
                [In, MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.Struct)]
                    System.Data.OleDb.tagDBPARAMBINDINFO[] rgParamBindInfo
            );
        }
        ...
        internal interface IErrorRecords
        {
            ...
            [return: MarshalAs(UnmanagedType.Interface)]
            IErrorInfo GetErrorInfo([In] Int32 ulRecordNum, [In] Int32 lcid);
    ...
    IErrorRecords : public IUnknown
        ...
        internal interface ISQLErrorInfo
        {
            ...
            Int32 GetSQLInfo([Out, MarshalAs(UnmanagedType.BStr)] out String pbstrSQLState);
        }
        ...
        {
            [Obsolete("not used", true)]
            void Commit( /*deleted parameter signature*/
            );

            [Obsolete("not used", true)]
            void Abort( /*deleted parameter signature*/
            );
