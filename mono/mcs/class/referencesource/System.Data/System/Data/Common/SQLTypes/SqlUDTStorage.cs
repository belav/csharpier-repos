...
namespace System.Data.Common
{
    ...
    internal sealed class SqlUdtStorage : DataStorage
    {
        ...
        private static readonly Dictionary<Type, object> TypeToNull =
        ...
        internal static object GetStaticNullForUdtType(Type type)
        {
            ...
            {
                System.Reflection.PropertyInfo propInfo = type.GetProperty(
                    "Null",
                ...
                {
                    System.Reflection.FieldInfo fieldInfo = type.GetField(
                        "Null",
        ...
        public override void Set(int recordNo, Object value)
        {
            ...
            { // WebData  113331 do not clone the value
