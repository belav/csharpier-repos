...
namespace System.Data.Common
{
    ...
    internal class DbConnectionOptions
    {
        ...
        private static readonly Regex ConnectionStringRegexOdbc = new Regex(
        ...
        private const string ConnectionStringQuoteOdbcValuePattern =
            "^\\{([^\\}\u0000]|\\}\\})*\\}$"; // do not quote odbc value if it matches this pattern
        ...
        private static readonly Regex ConnectionStringQuoteValueRegex = new Regex(
            ConnectionStringQuoteValuePattern,
            RegexOptions.Compiled
        );
        private static readonly Regex ConnectionStringQuoteOdbcValueRegex = new Regex(
            ConnectionStringQuoteOdbcValuePattern,
            RegexOptions.ExplicitCapture | RegexOptions.Compiled
        );
        ...
        private static void DebugTraceKeyValuePair(
            string keyname,
            string keyvalue,
            Hashtable synonyms
        )
        {
            if (Bid.AdvancedOn)
            {
                ...
                { // don't trace passwords ever!
                    ...
                    {
                        Bid.Trace(
                            "<comm.DbConnectionOptions|INFO|ADV> KeyName='%ls', KeyValue='%ls'\n",
                            keyname,
                            keyvalue
                        );
                    }
        ...
        static internal int GetKeyValuePair(
...
#if DEBUG
        private static Hashtable SplitConnectionString(
            string connectionString,
            Hashtable synonyms,
            bool firstKey
        )
