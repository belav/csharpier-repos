...
namespace System.Data.Common
{
    ...
    { // V1.0.3300
...
#if DEBUG
            Debug.Assert(
                !_debugHookNonEmptySelectCommand || readerHandler.FieldCount > 0,
        ...
        void AssertSchemaMapping(SchemaMapping mapping)
        {
            ...
            {
                Debug.Assert(
                    mapping != null && mapping.DataValues != null && mapping.DataTable != null,
                    "Debug hook specifies that non-empty results are not expected"
                );
            }
#endif
        }
        ...
        { // V1.2.3300
            ...
            Bid.ScopeEnter(
                out hscp,
                "<comm.DataAdapter.FillSchema|API> %d#, dataTable, schemaType, dataReader\n",
                ObjectID
            );
            try
            {
        ...
        { // V1.2.3300
            ...
            Bid.ScopeEnter(
                out hscp,
                "<comm.DataAdapter.Fill|API> %d#, dataTables[], dataReader, startRecord, maxRecords\n",
                ObjectID
            );
            try
            {
...
#if DEBUG
                            Debug.Assert(
                                !_debugHookNonEmptySelectCommand,
                                "Debug hook asserts data reader should be open"
                            );
#endif
                            break;
                        }
