...
namespace System.Data.Common
{
    ...
    */
    ...
    internal static class DbConnectionStringBuilderUtil
    {
        ...
        internal static bool TryConvertToPoolBlockingPeriod(
            string value,
            out PoolBlockingPeriod result
        )
        {
            Debug.Assert(
                Enum.GetNames(typeof(PoolBlockingPeriod)).Length == 3,
                "PoolBlockingPeriod enum has changed, update needed"
            );
            ...
            if (StringComparer.OrdinalIgnoreCase.Equals(value, PoolBlockingPeriodAutoString))
            {
                ...
                StringComparer.OrdinalIgnoreCase.Equals(value, PoolBlockingPeriodAlwaysBlockString)
            )
            {
                ...
                StringComparer.OrdinalIgnoreCase.Equals(value, PoolBlockingPeriodNeverBlockString)
            )
            {
        ...
        internal static bool IsValidPoolBlockingPeriodValue(PoolBlockingPeriod value)
        {
            ...
            return value == PoolBlockingPeriod.Auto
                || value == PoolBlockingPeriod.AlwaysBlock
                || value == PoolBlockingPeriod.NeverBlock;
        }
        ...
        internal static bool TryConvertToApplicationIntent(
            string value,
            out ApplicationIntent result
        )
        {
            Debug.Assert(
                Enum.GetNames(typeof(ApplicationIntent)).Length == 2,
                "ApplicationIntent enum has changed, update needed"
            );
            ...
            if (StringComparer.OrdinalIgnoreCase.Equals(value, ApplicationIntentReadOnlyString))
            {
                ...
                StringComparer.OrdinalIgnoreCase.Equals(value, ApplicationIntentReadWriteString)
            )
            {
        ...
        internal static bool TryConvertToAuthenticationType(
            string value,
            out SqlAuthenticationMethod result
        )
        {
            Debug.Assert(
                Enum.GetNames(typeof(SqlAuthenticationMethod)).Length == 4,
                "SqlAuthenticationMethod enum has changed, update needed"
            );
        ...
        /// <returns></returns>
        internal static bool TryConvertToColumnEncryptionSetting(
            string value,
            out SqlConnectionColumnEncryptionSetting result
        )
        {
            bool isSuccess = false;
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        internal static bool IsValidColumnEncryptionSetting(
            SqlConnectionColumnEncryptionSetting value
        )
        {
            Debug.Assert(
                Enum.GetNames(typeof(SqlConnectionColumnEncryptionSetting)).Length == 2,
                "SqlConnectionColumnEncryptionSetting enum has changed, update needed"
            );
            return value == SqlConnectionColumnEncryptionSetting.Enabled
                || value == SqlConnectionColumnEncryptionSetting.Disabled;
        }
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        internal static string ColumnEncryptionSettingToString(
            SqlConnectionColumnEncryptionSetting value
        )
        {
            Debug.Assert(
                IsValidColumnEncryptionSetting(value),
                "value is not a valid connection level column encryption setting."
            );
        ...
        internal static SqlAuthenticationMethod ConvertToAuthenticationType(
            string keyword,
            object value
        )
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    catch (ArgumentException e)
                    {
                        // to be consistent with the messages we send in case of wrong type usage, replace
                        // the error with our exception, and keep the original one as inner one for troubleshooting
                        throw ADP.ConvertFailed(
                            value.GetType(),
                            typeof(SqlAuthenticationMethod),
                            e
                        );
                    }
                }
        ...
        /// <param name="value"></param>
        /// <returns></returns>
        internal static SqlConnectionColumnEncryptionSetting ConvertToColumnEncryptionSetting(
            string keyword,
            object value
        )
        {
