...
namespace System.Data
{
    ...
    internal sealed class XmlToDatasetMap
    {
                ...
                if (tableSchemaInfo != null)
                {
                    ...
                    { // Do we have a child tables ?
                        ...
                        { // Is it nested?
                            ...
                            string _tableLocalName = XmlConvert.EncodeLocalName(
        ...
        public object GetColumnSchema(XmlNode node, bool fIgnoreNamespace)
        {
            ...
            do
            {
                ...
                tableSchemaInfo = (TableSchemaInfo)(
                    fIgnoreNamespace
                        ? tableSchemaMap[nodeRegion.LocalName]
        ...
        public object GetColumnSchema(DataTable table, XmlReader dataReader, bool fIgnoreNamespace)
        {
            if ((lastTableSchemaInfo == null) || (lastTableSchemaInfo.TableSchema != table))
            {
                lastTableSchemaInfo = (TableSchemaInfo)(
                    fIgnoreNamespace
                        ? tableSchemaMap[table.EncodedTableName]
        ...
        {
            TableSchemaInfo tableSchemaInfo = (TableSchemaInfo)(
                fIgnoreNamespace ? tableSchemaMap[node.LocalName] : tableSchemaMap[node]
            );
            if (tableSchemaInfo != null)
            {
        ...
        private void HandleSpecialColumn(
            DataColumn col,
            XmlNameTable nameTable,
            XmlNodeIdHashtable columns
        )
