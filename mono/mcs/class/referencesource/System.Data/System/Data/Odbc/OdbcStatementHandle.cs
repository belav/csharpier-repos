...
namespace System.Data.Odbc
{
    ...
    internal sealed class OdbcStatementHandle : OdbcHandle
    {
        ...
        internal ODBC32.RetCode BindColumn2(
            int columnNumber,
        ...
        {
            ODBC32.RetCode retcode = UnsafeNativeMethods.SQLBindCol(
                this,
        ...
        internal ODBC32.RetCode BindColumn3(
            int columnNumber,
            ODBC32.SQL_C targetType,
            IntPtr srLen_or_Ind
        )
        ...
        internal ODBC32.RetCode BindParameter(
            short ordinal,
            short parameterDirection,
        ...
        {
            ODBC32.RetCode retcode = UnsafeNativeMethods.SQLBindParameter(
                this,
        ...
        {
            IntPtr result;
            ODBC32.RetCode retcode = UnsafeNativeMethods.SQLColAttributeW(
                this,
                checked((short)columnNumber),
                fieldIdentifier,
                characterAttribute,
                characterAttribute.ShortLength,
                out stringLength,
                out result
            );
        ...
        internal ODBC32.RetCode Columns(
            string tableCatalog,
            string tableSchema,
            string tableName,
            string columnName
        ...
        {
            ODBC32.RetCode retcode = UnsafeNativeMethods.SQLColumnsW(
                this,
                tableCatalog,
        ...
        {
            ODBC32.RetCode retcode = UnsafeNativeMethods.SQLExecDirectW(
                this,
                commandText,
                ODBC32.SQL_NTS
            );
        ...
        internal ODBC32.RetCode GetData(
            int index,
            ODBC32.SQL_C sqlctype,
        ...
        {
            ODBC32.RetCode retcode = UnsafeNativeMethods.SQLGetData(
                this,
        ...
        internal ODBC32.RetCode GetStatementAttribute(
            ODBC32.SQL_ATTR attribute,
            out IntPtr value,
            out int stringLength
        )
        {
            ODBC32.RetCode retcode = UnsafeNativeMethods.SQLGetStmtAttrW(
                this,
                attribute,
                out value,
                ADP.PtrSize,
        ...
        {
            ODBC32.RetCode retcode = UnsafeNativeMethods.SQLNumResultCols(
                this,
                out columnsAffected
            );
        ...
        {
            ODBC32.RetCode retcode = UnsafeNativeMethods.SQLPrepareW(
                this,
                commandText,
                ODBC32.SQL_NTS
            );
        ...
        {
            ODBC32.RetCode retcode = UnsafeNativeMethods.SQLPrimaryKeysW(
                this,
                catalogName,
                ODBC.ShortStringLength(catalogName), // CatalogName
                schemaName,
                ODBC.ShortStringLength(schemaName), // SchemaName
                tableName,
                ODBC.ShortStringLength(tableName) // TableName
            );
            ODBC.TraceODBC(3, "SQLPrimaryKeysW", retcode);
            return retcode;
        }

        internal ODBC32.RetCode Procedures(
            string procedureCatalog,
            string procedureSchema,
            string procedureName
        )
        {
            ODBC32.RetCode retcode = UnsafeNativeMethods.SQLProceduresW(
                this,
                procedureCatalog,
        ...
        internal ODBC32.RetCode ProcedureColumns(
            string procedureCatalog,
            string procedureSchema,
            string procedureName,
            string columnName
        ...
        {
            ODBC32.RetCode retcode = UnsafeNativeMethods.SQLProcedureColumnsW(
                this,
                procedureCatalog,
                ODBC.ShortStringLength(procedureCatalog),
                procedureSchema,
        ...
        internal ODBC32.RetCode SetStatementAttribute(
            ODBC32.SQL_ATTR attribute,
            IntPtr value,
            ODBC32.SQL_IS stringLength
        )
        {
            ODBC32.RetCode retcode = UnsafeNativeMethods.SQLSetStmtAttrW(
                this,
                (int)attribute,
                value,
                (int)stringLength
        ...
        {
            ODBC32.RetCode retcode = UnsafeNativeMethods.SQLSpecialColumnsW(
                this,
                ODBC32.SQL_SPECIALCOLS.ROWVER,
                null,
                0,
                null,
                0,
                quotedTable,
                ODBC.ShortStringLength(quotedTable),
                ODBC32.SQL_SCOPE.SESSION,
                ODBC32.SQL_NULLABILITY.NO_NULLS
            );
            ODBC.TraceODBC(3, "SQLSpecialColumnsW", retcode);
            return retcode;
        }

        internal ODBC32.RetCode Statistics(
            string tableCatalog,
            string tableSchema,
            string tableName,
            Int16 unique,
        ...
        {
            ODBC32.RetCode retcode = UnsafeNativeMethods.SQLStatisticsW(
                this,
                tableCatalog,
                ODBC.ShortStringLength(tableCatalog),
                tableSchema,
        ...
        internal ODBC32.RetCode Tables(
            string tableCatalog,
            string tableSchema,
            string tableName,
            string tableType
        ...
        {
            ODBC32.RetCode retcode = UnsafeNativeMethods.SQLTablesW(
                this,
                tableCatalog,
                ODBC.ShortStringLength(tableCatalog),
                tableSchema,
