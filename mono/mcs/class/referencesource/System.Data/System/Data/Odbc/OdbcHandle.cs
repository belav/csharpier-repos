...
namespace System.Data.Odbc
{
            ...
            try
            {
                ...
                switch (handleType)
                {
                    case ODBC32.SQL_HANDLE.ENV:
                        ...
                        retcode = UnsafeNativeMethods.SQLAllocHandle(
                            handleType,
                            IntPtr.Zero,
                            out base.handle
                        );
            ...
            if (IntPtr.Zero != handle)
            {
                ...
                switch (handleType)
                {
                    ...
                    case ODBC32.SQL_HANDLE.STMT:
                        ...
                        Bid.TraceSqlReturn(
                            "<odbc.SQLFreeHandle|API|ODBC|RET> %08X{SQLRETURN}\n",
                            retcode
                        );
                        break;
    ...
    internal sealed class OdbcDescriptorHandle : OdbcHandle
    {
        ...
        {
            ODBC32.RetCode retcode = UnsafeNativeMethods.SQLGetDescFieldW(
                this,
                checked((short)i),
                attribute,
                buffer,
        ...
        {
            ODBC32.RetCode retcode = UnsafeNativeMethods.SQLSetDescFieldW(
                this,
                ordinal,
                type,
                value,
