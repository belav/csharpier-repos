    ...
    public sealed partial class OdbcParameter : DbParameter, ICloneable, IDbDataParameter
    {
        ...
        private int GetColumnSize(object value, int offset, int ordinal)
        {
            ...
            Debug.Assert(
                ...
                String.Format(
                    ...
                    "GetColumnSize: cch = {0} out of range, _internalShouldSerializeSize = {1}, _internalSize = {2}",
                    cch,
                    _internalShouldSerializeSize,
                    _internalSize
                )
        ...
        private int GetValueSize(object value, int offset)
        {
            ...
            Debug.Assert(
                ...
                String.Format(
                    (IFormatProvider)null,
                    "GetValueSize: cch = {0} out of range, _internalShouldSerializeSize = {1}, _internalSize = {2}",
                    cch,
                    _internalShouldSerializeSize,
                    _internalSize
                )
        ...
        )
        {
            ...
            if (ODBC32.RetCode.SUCCESS != retcode)
            {
                ...
                {
                    Bid.Trace(
                        "<odbc.OdbcParameter.Bind|ERR> Call to BindParameter returned errorcode [07006]\n"
                    );
        ...
        sealed internal class OdbcParameterConverter : ExpandableObjectConverter
        {
            ...
            )
            {
                ...
                )
                {
                    ...
                    System.Reflection.ConstructorInfo ctor = typeof(OdbcParameter).GetConstructor(
                        ctorParams
                    );
                    if (null != ctor)
                    {
