...
namespace System.Data.Odbc
{
    internal sealed class OdbcConnectionHandle : OdbcHandle
    {
        ...
        private ODBC32.RetCode AutoCommitOff()
        {
            ...
            {
                retcode = UnsafeNativeMethods.SQLSetConnectAttrW(
                    this,
        ...
        private ODBC32.RetCode CompleteTransaction(short transactionOperation, IntPtr handle)
        {
            ...
            finally
            {
                ...
                { // AutoCommitOn
                    ...
                    Bid.TraceSqlReturn(
                        "<odbc.SQLSetConnectAttr|API|ODBC|RET> %08X{SQLRETURN}\n",
                        retcode
                    );
                }
            }
        ...
        private ODBC32.RetCode Connect(string connectionString)
        {
            ...
            {
                short cbActualSize;
                retcode = UnsafeNativeMethods.SQLDriverConnectW(
                    this,
                    ADP.PtrZero,
                    connectionString,
                    ODBC32.SQL_NTS,
        ...
        {
            ODBC32.RetCode retcode = UnsafeNativeMethods.SQLGetConnectAttrW(
                this,
                attribute,
                buffer,
                buffer.Length,
        ...
        {
            ODBC32.RetCode retcode = UnsafeNativeMethods.SQLGetFunctions(
                this,
                fFunction,
                out fExists
            );
        ...
        {
            ODBC32.RetCode retcode = UnsafeNativeMethods.SQLGetInfoW(
                this,
                info,
                buffer,
            ...
            Bid.Trace(
                "<odbc.SQLGetInfo|ODBC> SQLRETURN=%d, InfoType=%d, BufferLength=%d, StringLength=%d\n",
                (int)retcode,
                (int)info,
                buffer.Length,
                (int)cbActual
        ...
        {
            ODBC32.RetCode retcode = UnsafeNativeMethods.SQLSetConnectAttrW(
                this,
                attribute,
                value,
                length
