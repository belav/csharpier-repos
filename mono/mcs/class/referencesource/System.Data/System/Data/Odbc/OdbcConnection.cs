...
namespace System.Data.Odbc
{
    ...
    public sealed partial class OdbcConnection : DbConnection, ICloneable
    {
        ...
        [
            DefaultValue(""),
            Editor(
                "Microsoft.VSDesigner.Data.Odbc.Design.OdbcConnectionStringEditor, "
...
#pragma warning restore 618
        ...
        {
            get { return (this.State | _extraState); }
        }
        ...
        {
            add { infoMessageEventHandler += value; }
            remove { infoMessageEventHandler -= value; }
        }
            ...
            if (null != connectionHandle)
            {
                ...
                )
                {
                    value = Encoding.Unicode.GetString(
                        buffer,
                        0,
                        Math.Min(cbActual, buffer.Length)
                    );
                }
        ...
        protected override DbTransaction BeginDbTransaction(IsolationLevel isolationLevel)
        {
            ...
            Bid.ScopeEnter(
                out hscp,
                "<prov.OdbcConnection.BeginDbTransaction|API> %d#, isolationLevel=%d{ds.IsolationLevel}",
                ObjectID,
                (int)isolationLevel
            );
            try
        ...
        internal void Open_EnlistTransaction(SysTx.Transaction transaction)
        {
            ...
            if (null == oleTxTransaction)
            {
                retcode = connectionHandle.SetConnectionAttribute2(
                    ODBC32.SQL_ATTR.SQL_COPT_SS_ENLIST_IN_DTC,
                    (IntPtr)ODBC32.SQL_DTC_DONE,
                    ODBC32.SQL_IS_PTR
                );
            }
            else
