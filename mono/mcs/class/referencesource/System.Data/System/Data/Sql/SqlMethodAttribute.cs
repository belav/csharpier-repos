...
namespace Microsoft.SqlServer.Server
{
    ...
    public sealed class SqlMethodAttribute : SqlFunctionAttribute
    {
        ...
        {
            get { return m_fCallOnNullInputs; }
            set { m_fCallOnNullInputs = value; }
        } // CallOnNullInputs

        public bool IsMutator
        {
            get { return m_fMutator; }
            set { m_fMutator = value; }
        } // IsMutator

        public bool InvokeIfReceiverIsNull
        {
            get { return m_fInvokeIfReceiverIsNull; }
            set { m_fInvokeIfReceiverIsNull = value; }
