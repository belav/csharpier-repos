...
namespace Microsoft.SqlServer.Server
{
    ...
    public sealed class SqlUserDefinedAggregateAttribute : Attribute
    {
        ...
        {
            get { return this.m_fInvariantToDup; }
            set { this.m_fInvariantToDup = value; }
        }

        public bool IsInvariantToNulls
        {
            get { return this.m_fInvariantToNulls; }
            set { this.m_fInvariantToNulls = value; }
        }

        public bool IsInvariantToOrder
        {
            get { return this.m_fInvariantToOrder; }
            set { this.m_fInvariantToOrder = value; }
        }

        public bool IsNullIfEmpty
        {
            get { return this.m_fNullIfEmpty; }
            set { this.m_fNullIfEmpty = value; }
        }
