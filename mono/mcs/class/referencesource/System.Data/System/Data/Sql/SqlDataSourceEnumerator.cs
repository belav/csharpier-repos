        ...
        override public DataTable GetDataSources()
        {
            ...
            try
            {
                ...
                if (ADP.PtrZero != handle)
                {
                    ...
                    {
                        readLength = SNINativeMethodWrapper.SNIServerEnumRead(
                            handle,
                            buffer,
                            bufferSize,
                            ref more
            ...
            if (failure)
            {
                ...
                Bid.Trace(
                    "<sc.SqlDataSourceEnumerator.GetDataSources|ERR> GetDataSources:SNIServerEnumRead returned bad length, requested %d, received %d",
                    bufferSize,
                    readLength
                );
