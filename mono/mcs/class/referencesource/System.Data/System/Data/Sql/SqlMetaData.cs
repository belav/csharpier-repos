...
namespace Microsoft.SqlServer.Server
{
    ...
    public sealed class SqlMetaData
    {
        ...
        private const SqlCompareOptions x_eDefaultStringCompareOptions =
        ...
        public SqlMetaData(String name, SqlDbType dbType)
        {
            Construct(
                name,
                dbType,
                x_defaultUseServerDefault,
                x_defaultIsUniqueKey,
                x_defaultColumnSortOrder,
        ...
        {
            get { return m_eCompareOptions; }
        }

        public DbType DbType
        {
            get { return sxm_rgSqlDbTypeToDbType[(int)m_sqlDbType]; }
        }

        public bool IsUniqueKey
        {
            get { return m_isUniqueKey; }
        }

        public long LocaleId
        {
            get { return m_lLocale; }
        }
        ...
        {
            get { return m_columnSortOrder; }
        }

        public int SortOrdinal
        {
            get { return m_sortOrdinal; }
        }
        ...
        {
            get { return m_serverTypeName; }
        }

        public bool UseServerDefault
        {
            get { return m_useServerDefault; }
        }

        public string XmlSchemaCollectionDatabase
        {
            get { return m_XmlSchemaCollectionDatabase; }
        }

        public string XmlSchemaCollectionName
        {
            get { return m_XmlSchemaCollectionName; }
        }

        public string XmlSchemaCollectionOwningSchema
        {
            get { return m_XmlSchemaCollectionOwningSchema; }
        }

        internal bool IsPartialLength
        {
            get { return m_bPartialLength; }
        }
        ...
        )
        {
            ...
            if (
                SqlCompareOptions.BinarySort != compareOptions
                && 0
                    != (
                        ~(
                            (int)SqlCompareOptions.IgnoreCase
                            | (int)SqlCompareOptions.IgnoreNonSpace
                            | (int)SqlCompareOptions.IgnoreKanaType
                            | (int)SqlCompareOptions.IgnoreWidth
                        ) & (int)compareOptions
                    )
            )
        ...
        public SqlString Adjust(SqlString value)
        {
            ...
            if (value.Value.Length > MaxLength && Max != MaxLength)
                value = new SqlString(
                    value.Value.Remove((int)MaxLength, (int)(value.Value.Length - MaxLength))
                );
                ...
                if (!value.IsNull)
                {
                    ...
                    if (value.Length < MaxLength)
                    {
                        ...
                        Array.Clear(
                            rgbNewValue,
                            rgbValue.Length,
                            rgbNewValue.Length - rgbValue.Length
                        );
                ...
                case TypeCode.Object:
                    ...
                    else if (dataType == typeof(SqlString))
                    {
                        ...
                        else
                        {
                            smd = new SqlMetaData(
                                name,
                                SqlDbType.NVarChar,
                                sxm_rgDefaults[(int)SqlDbType.NVarChar].MaxLength
                            );
                        }
                    }
                    else if (dataType == typeof(SqlChars))
                    ...
                    else if (dataType == typeof(SqlBytes))
                    {
                        ...
                        smd = new SqlMetaData(
                            ...
                            SqlDbType.Time,
                            0,
                            InferScaleFromTimeTicks(((TimeSpan)value).Ticks)
                        );
                    else if (dataType == typeof(DateTimeOffset))
                        smd = new SqlMetaData(
                            name,
                            ...
                            0,
                            InferScaleFromTimeTicks(((DateTimeOffset)value).Ticks)
                        );
                    else
                        throw ADP.UnknownDataType(dataType);
                    break;
                ...
                if (null != value)
                {
                    ...
                    if (value.Length < MaxLength)
                    {
                        ...
                        Array.Clear(
                            rgbNewValue,
                            value.Length,
                            (int)rgbNewValue.Length - value.Length
                        );
                        return rgbNewValue;
                    }
                }
        ...
        internal static SqlMetaData GetPartialLengthMetaData(SqlMetaData md)
        {
            ...
            {
                SqlMetaData mdnew = new SqlMetaData(
                    md.Name,
                    md.SqlDbType,
                    SqlMetaData.Max,
                    0,
        ...
        void VerifyDateTimeRange(DateTime value)
        {
            if (
                ...
                && (x_dtSmallMax < value || x_dtSmallMin > value)
            )
                ThrowInvalidType();
        }

        private static readonly SqlMoney x_smSmallMax = new SqlMoney(
            ((Decimal)Int32.MaxValue) / 10000
        );
        private static readonly SqlMoney x_smSmallMin = new SqlMoney(
            ((Decimal)Int32.MinValue) / 10000
        );
        ...
        void VerifyMoneyRange(SqlMoney value)
        {
            if (
                SqlDbType.SmallMoney == SqlDbType
                && ((x_smSmallMax < value).Value || (x_smSmallMin > value).Value)
            )
                ThrowInvalidType();
        }
        ...
        internal static SqlMetaData[] sxm_rgDefaults =
        {
            ...
            new SqlMetaData("float", SqlDbType.Float, 8, 53, 0, 0, SqlCompareOptions.None, false), // SqlDbType.Float
            new SqlMetaData(
                "image",
                SqlDbType.Image,
                x_lMax,
            ...
            new SqlMetaData("int", SqlDbType.Int, 4, 10, 0, 0, SqlCompareOptions.None, false), // SqlDbType.Int
            new SqlMetaData("money", SqlDbType.Money, 8, 19, 4, 0, SqlCompareOptions.None, false), // SqlDbType.Money
            new SqlMetaData(
                "nchar",
                SqlDbType.NChar,
                1,
            ...
            new SqlMetaData("real", SqlDbType.Real, 4, 24, 0, 0, SqlCompareOptions.None, false), // SqlDbType.Real
            new SqlMetaData(
                "uniqueidentifier",
            ...
            new SqlMetaData("udt", SqlDbType.Udt, 0, 0, 0, 0, SqlCompareOptions.None, false), // SqlDbType.Udt = 29  Bug Fix: 302698
            new SqlMetaData(
                "table",
            ...
            new SqlMetaData("date", SqlDbType.Date, 3, 10, 0, 0, SqlCompareOptions.None, false), // SqlDbType.Date
            new SqlMetaData("time", SqlDbType.Time, 5, 0, 7, 0, SqlCompareOptions.None, false), // SqlDbType.Time
            new SqlMetaData(
                "datetime2",
                SqlDbType.DateTime2,
                8,
