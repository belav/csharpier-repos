...
namespace Microsoft.SqlServer.Server
{
    ...
    public sealed class SqlUserDefinedTypeAttribute : Attribute
    {
            ...
            switch (format)
            {
                case Format.Unknown:
                    throw ADP.NotSupportedUserDefinedTypeSerializationFormat(
                        (Microsoft.SqlServer.Server.Format)format,
                        "format"
                    );
                case Format.Native:
                case Format.UserDefined:
                    ...
                    break;
                default:
                    throw ADP.InvalidUserDefinedTypeSerializationFormat(
                        (Microsoft.SqlServer.Server.Format)format
                    );
            }
        }
        ...
        {
            get { return this.m_IsFixedLength; }
            set { this.m_IsFixedLength = value; }
        }
        ...
        {
            get { return this.m_IsByteOrdered; }
            set { this.m_IsByteOrdered = value; }
        }
        ...
        {
            get { return this.m_ValidationMethodName; }
            set { this.m_ValidationMethodName = value; }
        }
