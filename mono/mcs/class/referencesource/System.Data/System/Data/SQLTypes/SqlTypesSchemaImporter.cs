...
namespace System.Data.SqlTypes
{
    ...
    public class SqlTypesSchemaImporterExtensionHelper : SchemaImporterExtension
    {
        ...
        public SqlTypesSchemaImporterExtensionHelper(
            string name,
        ...
        )
        {
            if (m_direct)
            {
                ...
                {
                    if (
                        (0 == string.CompareOrdinal(m_name, name))
                        && (0 == string.CompareOrdinal(m_targetNamespace, xmlNamespace))
                    )
                    {
        ...
        )
        {
            if (!m_direct)
            {
                if ((type is XmlSchemaSimpleType) && (context is XmlSchemaElement))
                {
                    ...
                    if (
                        (0 == string.CompareOrdinal(m_name, qname.Name))
                        && (0 == string.CompareOrdinal(m_targetNamespace, qname.Namespace))
                    )
                    {
                        compileUnit.ReferencedAssemblies.AddRange(m_references);
                        mainNamespace.Imports.AddRange(m_namespaceImports);
    ...
    */
    ...
    public sealed class TypeSmallDateTimeSchemaImporterExtension
    ...
    public sealed class TypeSmallMoneySchemaImporterExtension
        : SqlTypesSchemaImporterExtensionHelper
    {
