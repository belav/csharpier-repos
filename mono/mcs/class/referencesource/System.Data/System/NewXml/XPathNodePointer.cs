...
namespace System.Xml
{
    ...
    internal sealed class XPathNodePointer : IXmlDataVirtualNode
    {
        ...
        static XPathNodePointer()
        {
            ...
            xmlNodeType_To_XpathNodeType_Map[(int)(XmlNodeType.Element)] = (int)
                XPathNodeType.Element;
            xmlNodeType_To_XpathNodeType_Map[(int)(XmlNodeType.Attribute)] = (int)
            ...
            xmlNodeType_To_XpathNodeType_Map[(int)(XmlNodeType.ProcessingInstruction)] = (int)
                XPathNodeType.ProcessingInstruction;
            xmlNodeType_To_XpathNodeType_Map[(int)(XmlNodeType.Comment)] = (int)
            ...
            xmlNodeType_To_XpathNodeType_Map[(int)(XmlNodeType.DocumentFragment)] = (int)
                XPathNodeType.Root;
            xmlNodeType_To_XpathNodeType_Map[(int)(XmlNodeType.Notation)] = -1;
            xmlNodeType_To_XpathNodeType_Map[(int)(XmlNodeType.Whitespace)] = (int)
                XPathNodeType.Whitespace;
            xmlNodeType_To_XpathNodeType_Map[(int)(XmlNodeType.SignificantWhitespace)] = (int)
        ...
        internal string LocalName
        {
            get
            {
                ...
                else if (this._column == null)
                {
                    ...
                    if (
                        IsNamespaceNode(nt, this._node.NamespaceURI)
            ...
            if (be != null)
            {
                if (be.IsFoliated)
                {
                    ...
                    while (attrInd > 0)
                    {
                        ...
                        if (
                            bFound
                            && attr.NamespaceURI == s_strReservedXmlns
                ...
                { //defoliated so that we need to search through its column
                    ...
                    {
                        if (
                            curCol.Namespace == s_strReservedXmlns
        ...
        private void AssertValid()
        {
            ...
            if (this._column != null)
            {
                ...
                Debug.Assert(
                    (this._column.ColumnMapping == MappingType.SimpleContent)
                        ? (this._fOnValue == true)
                        : true
                );
            }
