...
namespace System.Workflow.Runtime
{
    ...
    public class TimerEventSubscriptionCollection : ICollection
    {
        ...
        private KeyedPriorityQueue<Guid, TimerEventSubscription, DateTime> queue =
            new KeyedPriorityQueue<Guid, TimerEventSubscription, DateTime>();
...
#pragma warning restore 0414
        ...
        private void OnFirstElementChanged(
            object source,
            KeyedPriorityQueueHeadChangedEventArgs<TimerEventSubscription> e
        )
        {
            lock (locker)
            {
