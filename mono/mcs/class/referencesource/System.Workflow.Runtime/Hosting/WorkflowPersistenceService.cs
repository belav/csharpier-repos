...
namespace System.Workflow.Runtime.Hosting
{
    ...
    public abstract class WorkflowPersistenceService : WorkflowRuntimeService
    {
        ...
        protected internal abstract void SaveWorkflowInstanceState(
        ...
        protected internal abstract Activity LoadCompletedContextActivity(
            Guid scopeId,
        ...
        protected static byte[] GetDefaultSerializedForm(Activity activity)
        {
            ...
            using (MemoryStream stream = new MemoryStream(10240))
            {
                ...
                using (MemoryStream compressedStream = new MemoryStream((int)stream.Length))
                {
                    ...
                    ActivityExecutionContextInfo executionContextInfo =
