...
namespace System.Workflow.Runtime
{
    internal sealed class WorkflowStateRollbackService
    {
        ...
        {
            Debug.Assert(
                this.workflowExecutor.InstanceId != null,
                "instance id null at checkpoint time"
            );
            ...
            this.completedContextActivities = (Hashtable)
                this.workflowExecutor.CompletedContextActivities.Clone();
        ...
        )
        {
            ...
            this.activityContextId = ContextActivityUtils.ContextId(
        ...
        internal void RevertToCheckpointState()
        {
            Debug.Assert(
                this.clonedInstanceStateStream != null,
                "cloned instance-state stream null at restore time"
            );
            ...
            {
                clonedRootActivity = Activity.Load(
                    this.clonedInstanceStateStream,
            ...
            newWorkflowExecutor.Initialize(
                clonedRootActivity,
                this.workflowExecutor.WorkflowRuntime,
            ...
            Activity activityContext = newWorkflowExecutor.GetContextActivityForId(
            ...
            newWorkflowExecutor.BatchCollection.WorkItemOrderId = this.workflowExecutor
                .BatchCollection
                .WorkItemOrderId;
            ...
            foreach (KeyValuePair<object, WorkBatch> batch in this.workflowExecutor.BatchCollection)
            {
                ...
                if (oldActivity != null)
                {
                    Activity newactivity = activityContext.GetActivityByName(
                        oldActivity.QualifiedName
                    );
