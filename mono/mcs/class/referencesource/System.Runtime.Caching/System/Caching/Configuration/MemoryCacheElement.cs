...
namespace System.Runtime.Caching.Configuration
{
    ...
    public sealed class MemoryCacheElement : ConfigurationElement
    {
        ...
        static MemoryCacheElement()
        {
            ...
            _propPhysicalMemoryLimitPercentage = new ConfigurationProperty(
            ...
            _propCacheMemoryLimitMegabytes = new ConfigurationProperty(
            ...
            _propPollingInterval = new ConfigurationProperty(
                "pollingInterval",
                typeof(TimeSpan),
