...
namespace System.Web.UI.Design.WebControls
{
    public class EntityDesignerDataSourceView : DesignerDataSourceView
    {
        ...
        {
            get { return CanModify && _helper.EnableDelete; }
        }

        public override bool CanInsert
        {
            get { return CanModify && _helper.EnableInsert; }
        }
        ...
        {
            get { return _helper.CanPage; }
        }

        public override bool CanSort
        {
            get { return _helper.CanSort; }
        }

        public override bool CanUpdate
        {
            get { return CanModify && _helper.EnableUpdate; }
        }
        ...
        public override IEnumerable GetDesignTimeData(int minimumRows, out bool isSampleData)
        {
            ...
            {
                isSampleData = true;
                return DesignTimeData.GetDesignTimeDataSource(
                    DesignTimeData.CreateSampleDataTable(new DataView(schemaTable), true),
                    minimumRows
                );
            }
