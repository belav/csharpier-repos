...
namespace System.Web.UI.Design.WebControls
{
    ...
    internal delegate void EntityDataSourceContainerChangedEventHandler(
        object sender,
    ...
    internal class EntityDataSourceConfigureObjectContext
    {
        ...
        #region Constructors
        internal EntityDataSourceConfigureObjectContext(
            EntityDataSourceConfigureObjectContextPanel panel,
        ...
        {
            add { _containerNameChanged += value; }
            remove { _containerNameChanged -= value; }
        }
        ...
        internal void LoadState()
        {
            ...
            LoadContainerNames(
                _entityDataSourceState.DefaultContainerName,
                true /*initialLoad*/
            );
        }
        ...
        private void LoadContainerNames(string containerName, bool initialLoad)
        {
            ...
            _containerNames = _helper.GetContainerNames(
                false /*sortResults*/
            );

            // Try to find the specified container in list
            _selectedContainerName = FindContainerName(
                containerName,
                initialLoad /*addIfNotFound*/
            );
            ...
            _panel.SetSelectedContainerName(
        ...
        /// <returns></returns>
        private EntityDataSourceContainerNameItem FindContainerName(
            string containerName,
            bool addIfNotFound
        )
        {
            Debug.Assert(
                _containerNames != null,
                "_containerNames have already been initialized and should not be null"
            );
            ...
            if (!String.IsNullOrEmpty(containerName))
            {
                ...
                foreach (EntityDataSourceContainerNameItem containerNameItem in _containerNames)
                {
                    ...
                    if (
                        String.Equals(
                            containerName,
                            containerNameItem.EntityContainerName,
                ...
                Debug.Assert(
                    addIfNotFound == false || containerToSelect != null,
                    "expected a non-null EntityDataSourceContainerNameItem"
                );
        ...
        private void SaveContainerName()
        {
            Debug.Assert(
                ...
                "wizard data should not be saved if container name is empty"
            );
            _entityDataSourceState.DefaultContainerName =
                _selectedContainerName.EntityContainerName;
        }
        #endregion
        ...
        private void LoadConnectionStrings()
        {
            ...
            _namedConnections = _helper.GetNamedEntityClientConnections(
                false /*sortResults*/
            );

            EntityConnectionStringBuilderItem connStrBuilderItem =
                _helper.GetEntityConnectionStringBuilderItem(
                    _entityDataSourceState.ConnectionString
                );
            Debug.Assert(
                connStrBuilderItem != null,
                "expected GetEntityConnectionStringBuilder to always return non-null"
            );
            ...
            if (connStrBuilderItem.IsNamedConnection)
            {
                ...
                Debug.Assert(
                    connStrBuilderItem != null,
                    "expected a non-null connStrBuilderItem for the named connection because it should have added it if it didn't exist"
                );
            }
        ...
        private EntityConnectionStringBuilderItem FindCurrentNamedConnection(
            EntityConnectionStringBuilderItem newBuilderItem
        )
        {
            Debug.Assert(
                _namedConnections != null,
                "_namedConnections should have already been initialized and should not be null"
            );
            Debug.Assert(
                newBuilderItem != null && newBuilderItem.IsNamedConnection,
            ...
            {
                if (
                    ((IComparable<EntityConnectionStringBuilderItem>)newBuilderItem).CompareTo(
                        namedConnectionItem
                    ) == 0
                )
                {
        ...
        internal bool SelectConnectionStringBuilder(
            EntityConnectionStringBuilderItem selectedConnection,
            bool resetContainer
        )
        {
            ...
            if (selectedConnection != null)
            {
                ...
                {
                    metadataLoaded = _helper.LoadMetadata(
                        selectedConnection.EntityConnectionStringBuilder
                    );
                }
                else
                {
            ...
            if (resetContainer)
            {
                string defaultContainerName =
                    _selectedConnectionStringBuilder.EntityConnectionStringBuilder == null
                        ? null
                        : _selectedConnectionStringBuilder.EntityConnectionStringBuilder.Name;
                LoadContainerNames(
        ...
        {
            Debug.Assert(
                _selectedConnectionStringBuilder != null,
                "wizard data should not be saved if connection string is empty"
            );
            _entityDataSourceState.ConnectionString =
                _selectedConnectionStringBuilder.ConnectionString;
        }
        ...
        {
            get { return _selectedContainerName != null && _connectionStringHasValue; }
        }
        #endregion
    }
}
