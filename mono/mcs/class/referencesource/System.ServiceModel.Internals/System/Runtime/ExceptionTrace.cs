...
namespace System.Runtime
{
    ...
    class ExceptionTrace
    {
        ...
        )
        {
            Fx.Assert(
                targetInvocationException != null,
                "targetInvocationException cannot be null."
            );
        ...
        )
        {
            ...
            foreach (Exception nextInnerException in innerExceptions)
            {
                ...
                TargetInvocationException targetInvocationException =
                    nextInnerException as TargetInvocationException;
            ...
            if (favoredException == null)
            {
                Fx.Assert(
                    ...
                    "InnerException.Count is known to be > 0 here."
                );
        ...
        {
            return TraceException<ArgumentNullException>(
        ...
        {
            return TraceException<ArgumentOutOfRangeException>(
        ...
        public ObjectDisposedException ObjectDisposed(string message)
        {
            ...
            return TraceException<ObjectDisposedException>(
        ...
        public void TraceEtwException(Exception exception, TraceEventType eventType)
        {
            switch (eventType)
            {
                ...
                case TraceEventType.Warning:
                    ...
                    {
                        TraceCore.ThrowingEtwException(
                            this.diagnosticTrace,
                ...
                default:
                    ...
                    {
                        TraceCore.ThrowingEtwExceptionVerbose(
                            this.diagnosticTrace,
                            this.eventSourceName,
                            exception != null ? exception.ToString() : string.Empty,
                            exception
