...
namespace System.Data.Common
{
    ...
    public abstract class DbXmlEnabledProviderManifest : DbProviderManifest
    {
        ...
        private Dictionary<
            PrimitiveType,
            System.Collections.ObjectModel.ReadOnlyCollection<FacetDescription>
        > _facetDescriptions =
            new Dictionary<
                PrimitiveType,
                System.Collections.ObjectModel.ReadOnlyCollection<FacetDescription>
        ...
        private Dictionary<string, PrimitiveType> _storeTypeNameToEdmPrimitiveType =
            new Dictionary<string, PrimitiveType>();
        private Dictionary<string, PrimitiveType> _storeTypeNameToStorePrimitiveType =
            new Dictionary<string, PrimitiveType>();
        ...
        protected DbXmlEnabledProviderManifest(XmlReader reader)
        {
            if (reader == null)
            {
                throw EntityUtil.ProviderIncompatible(
                    Strings.IncorrectProviderManifest,
        ...
        {
            get { return this._storeTypeNameToEdmPrimitiveType; }
        }

        protected Dictionary<string, PrimitiveType> StoreTypeNameToStorePrimitiveType
        {
            get { return this._storeTypeNameToStorePrimitiveType; }
        }
        ...
        public override System.Collections.ObjectModel.ReadOnlyCollection<FacetDescription> GetFacetDescriptions(
            EdmType type
        )
        {
            Debug.Assert(
                type is PrimitiveType,
                "DbXmlEnabledProviderManifest.GetFacetDescriptions(): Argument is not a PrimitiveType"
            );
            return GetReadOnlyCollection(
                type as PrimitiveType,
                _facetDescriptions,
                Helper.EmptyFacetDescriptionEnumerable
            );
        }
        ...
        {
            Schema schema;
            IList<EdmSchemaError> errors = SchemaManager.LoadProviderManifest(
                reader,
                reader.BaseURI.Length > 0 ? reader.BaseURI : null,
            ...
            {
                throw EntityUtil.ProviderIncompatible(
                    Strings.IncorrectProviderManifest + Helper.CombineErrorMessage(errors)
                );
            }
            ...
            foreach (
                System.Data.EntityModel.SchemaObjectModel.SchemaType schemaType in schema.SchemaTypes
            )
            {
                ...
                if (typeElement != null)
                {
                    ...
                    _storeTypeNameToEdmPrimitiveType.Add(
                        ...
                        EdmProviderManifest.Instance.GetPrimitiveType(type.PrimitiveTypeKind)
                    );
            ...
            if (
                !EnumerableToReadOnlyCollection<EdmFunction, GlobalItem>(items, out this._functions)
            )
            {
        ...
        private static System.Collections.ObjectModel.ReadOnlyCollection<T> GetReadOnlyCollection<T>(
            PrimitiveType type,
            Dictionary<
                PrimitiveType,
                System.Collections.ObjectModel.ReadOnlyCollection<T>
            > typeDictionary,
            System.Collections.ObjectModel.ReadOnlyCollection<T> useIfEmpty
        )
        {
        ...
        private static bool EnumerableToReadOnlyCollection<Target, BaseType>(
            ...
            out System.Collections.ObjectModel.ReadOnlyCollection<Target> collection
        )
