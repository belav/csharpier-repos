...
namespace System.Data.Common.CommandTrees
{
    ...
    public sealed class DbOrExpression : DbBinaryExpression
    {
            ...
            : base(DbExpressionKind.Or, booleanResultType, left, right)
        {
            Debug.Assert(
                TypeSemantics.IsPrimitiveType(booleanResultType, PrimitiveTypeKind.Boolean),
                "DbOrExpression requires a Boolean result type"
            );
        }
    ...
    public sealed class DbArithmeticExpression : DbExpression
    {
        ...
        {
            Debug.Assert(
                TypeSemantics.IsNumericType(numericResultType),
                "DbArithmeticExpression result type must be numeric"
            );
            ...
            Debug.Assert(
                ...
                "Invalid DbExpressionKind used in DbArithmeticExpression: "
                    + Enum.GetName(typeof(DbExpressionKind), kind)
            );

            Debug.Assert(args != null, "DbArithmeticExpression arguments cannot be null");

            Debug.Assert(
                (DbExpressionKind.UnaryMinus == kind && 1 == args.Count) || 2 == args.Count,
    ...
    public sealed class DbCaseExpression : DbExpression
    {
            ...
            : base(DbExpressionKind.Case, commonResultType)
        {
            ...
            Debug.Assert(
                whens.Count == thens.Count,
                "DbCaseExpression whens count must match thens count"
            );
    ...
    public sealed class DbCastExpression : DbUnaryExpression
    {
        ...
        {
            Debug.Assert(
                TypeSemantics.IsCastAllowed(argument.ResultType, type),
                "DbCastExpression represents an invalid cast"
            );
        }
    ...
    public sealed class DbComparisonExpression : DbBinaryExpression
    {
            ...
            : base(kind, booleanResultType, left, right)
        {
            ...
            Debug.Assert(
                TypeSemantics.IsBooleanType(booleanResultType),
                "DbComparisonExpression result type must be a Boolean type"
            );
            Debug.Assert(
                ...
                "Invalid DbExpressionKind used in DbComparisonExpression: "
                    + Enum.GetName(typeof(DbExpressionKind), kind)
            );
        }
    ...
    public sealed class DbIsEmptyExpression : DbUnaryExpression
    {
            ...
            : base(DbExpressionKind.IsEmpty, booleanResultType, argument)
        {
            Debug.Assert(
                TypeSemantics.IsBooleanType(booleanResultType),
                "DbIsEmptyExpression requires a Boolean result type"
            );
        }
    ...
    public sealed class DbIsNullExpression : DbUnaryExpression
    {
        internal DbIsNullExpression(
            TypeUsage booleanResultType,
            DbExpression arg,
            bool isRowTypeArgumentAllowed
        )
            : base(DbExpressionKind.IsNull, booleanResultType, arg)
        {
            Debug.Assert(
                TypeSemantics.IsBooleanType(booleanResultType),
                "DbIsNullExpression requires a Boolean result type"
            );
        }
    ...
    public sealed class DbIsOfExpression : DbUnaryExpression
    {
        ...
        {
            Debug.Assert(
                DbExpressionKind.IsOf == this.ExpressionKind
                    || DbExpressionKind.IsOfOnly == this.ExpressionKind,
                string.Format(
                    CultureInfo.InvariantCulture,
                    "Invalid DbExpressionKind used in DbIsOfExpression: {0}",
                    Enum.GetName(typeof(DbExpressionKind), this.ExpressionKind)
                )
            );
            Debug.Assert(
                TypeSemantics.IsBooleanType(booleanResultType),
                "DbIsOfExpression requires a Boolean result type"
            );
    ...
    public sealed class DbOfTypeExpression : DbUnaryExpression
    {
        ...
        {
            Debug.Assert(
                DbExpressionKind.OfType == ofTypeKind || DbExpressionKind.OfTypeOnly == ofTypeKind,
    ...
    public sealed class DbTreatExpression : DbUnaryExpression
    {
        ...
        {
            Debug.Assert(
                TypeSemantics.IsValidPolymorphicCast(argument.ResultType, asType),
                "DbTreatExpression represents an invalid treat"
            );
        }
    ...
    public sealed class DbLikeExpression : DbExpression
    {
            ...
            : base(DbExpressionKind.Like, booleanResultType)
        {
            ...
            Debug.Assert(
                TypeSemantics.IsBooleanType(booleanResultType),
                "DbLikeExpression must have a Boolean result type"
            );
    ...
    public sealed class DbEntityRefExpression : DbUnaryExpression
    {
        ...
        {
            Debug.Assert(
                TypeSemantics.IsReferenceType(refResultType),
                "DbEntityRefExpression requires a reference result type"
            );
        }
    ...
    public sealed class DbRefKeyExpression : DbUnaryExpression
    {
        ...
        {
            Debug.Assert(
                TypeSemantics.IsRowType(rowResultType),
                "DbRefKeyExpression requires a row result type"
            );
        }
