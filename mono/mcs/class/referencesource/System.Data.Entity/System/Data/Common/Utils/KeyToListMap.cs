...
namespace System.Data.Common.Utils
{
    ...
    internal class KeyToListMap<TKey, TValue> : InternalBase
    {
        ...
        internal bool TryGetListForKey(
            TKey key,
            out System.Collections.ObjectModel.ReadOnlyCollection<TValue> valueCollection
        )
        {
            List<TValue> list;
            ...
            {
                valueCollection = new System.Collections.ObjectModel.ReadOnlyCollection<TValue>(
                    list
                );
                return true;
            }
