...
namespace System.Data.Common
{
    ...
    public abstract class DbProviderManifest
    {
        ...
        public abstract System.Collections.ObjectModel.ReadOnlyCollection<FacetDescription> GetFacetDescriptions(
            EdmType edmType
        );
        ...
        public XmlReader GetInformation(string informationType)
        {
            ...
            catch (Exception e)
            {
                ...
                if (EntityUtil.IsCatchableExceptionType(e))
                {
                    ...
                    throw EntityUtil.ProviderIncompatible(
                        System.Data.Entity.Strings.EntityClient_FailedToGetInformation(
                            informationType
                        ),
                        e
                    );
            ...
            if (reader == null)
            {
                ...
                if (
                    informationType == ConceptualSchemaDefinitionVersion3
                ...
                throw EntityUtil.ProviderIncompatible(
                    System.Data.Entity.Strings.ProviderReturnedNullForGetDbInformation(
                        informationType
                    )
                );
            }
        ...
        {
            throw EntityUtil.ProviderIncompatible(
                System.Data.Entity.Strings.ProviderShouldOverrideEscapeLikeArgument
            );
        }
    }
}
