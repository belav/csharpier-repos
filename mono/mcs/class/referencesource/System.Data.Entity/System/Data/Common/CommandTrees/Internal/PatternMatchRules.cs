...
namespace System.Data.Common.CommandTrees.Internal
{
    ...
    internal class PatternMatchRuleProcessor : DbExpressionRuleProcessingVisitor
    {
        ...
        private PatternMatchRuleProcessor(
            System.Collections.ObjectModel.ReadOnlyCollection<PatternMatchRule> rules
        )
        {
            Debug.Assert(rules.Count() != 0, "At least one PatternMatchRule is required");
            Debug.Assert(
                rules.Where(r => r == null).Count() == 0,
                "Individual PatternMatchRules must not be null"
            );
        ...
        internal static Func<DbExpression, DbExpression> Create(params PatternMatchRule[] rules)
        {
            ...
            return new PatternMatchRuleProcessor(
                new System.Collections.ObjectModel.ReadOnlyCollection<PatternMatchRule>(rules)
            ).Process;
        }
    }
    ...
    internal static class Patterns
    {
        ...
        /// </summary>
        internal static Func<DbExpression, bool> MatchBooleanType
        {
            get { return (e => TypeSemantics.IsBooleanType(e.ResultType)); }
        }
#endif
        ...
        /// </summary>
        internal static Func<IEnumerable<DbExpression>, bool> MatchForAny(
            Func<DbExpression, bool> elementPattern
        )
        {
            return (elems => elems.FirstOrDefault(e => elementPattern(e)) != null);
        ...
        /// </summary>
        internal static Func<DbExpression, bool> MatchUnary(
            Func<DbExpression, bool> argumentPattern
        )
        {
            return (
                e => (e is DbUnaryExpression) && argumentPattern(((DbUnaryExpression)e).Argument)
            );
        }
#endif
        ...
        /// </summary>
        internal static Func<DbExpression, bool> MatchBinary(
            Func<DbExpression, bool> leftPattern,
            Func<DbExpression, bool> rightPattern
        )
        {
            return (
                e =>
                {
                    DbBinaryExpression binEx = (e as DbBinaryExpression);
                    return (binEx != null && leftPattern(binEx.Left) && rightPattern(binEx.Right));
                }
            );
        }
#endif
        ...
        )
        {
            return (
                e =>
                {
                    ...
                    {
                        DbFilterExpression filterEx = (DbFilterExpression)e;
                        return inputPattern(filterEx.Input.Expression)
                            && predicatePattern(filterEx.Predicate);
                    }
                }
            );
        }
        ...
        )
        {
            return (
                e =>
                {
                    ...
                    {
                        DbProjectExpression projectEx = (DbProjectExpression)e;
                        return inputPattern(projectEx.Input.Expression)
                            && projectionPattern(projectEx.Projection);
                    }
                }
            );
        }
        ...
        )
        {
            return (
                e =>
                {
                    ...
                    {
                        DbCaseExpression caseEx = (DbCaseExpression)e;
                        return whenPattern(caseEx.When)
                            && thenPattern(caseEx.Then)
                            && elsePattern(caseEx.Else);
                    }
                }
            );
        }
        ...
        )
        {
            return (
                e =>
                {
                    ...
                    {
                        DbNewInstanceExpression newInst = (DbNewInstanceExpression)e;
