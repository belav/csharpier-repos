...
{
    /// <summary>
    /// Generates monotonically increasing names of the form PrefixCounter, where Prefix is an optional
    // prefix string and Counter is the string representation of a monotonically increasing int value
    // that
    // wraps to zero at int.MaxValue
    /// </summary>
    internal sealed class AliasGenerator
    {
        // beyond this size - we recycle the cache and regenerate names
        // this recycling is in place because CTreeGenerator.GenerateNameForVar has prefix of "columnName"
        // which could be unbounded
        ...
        // We are using a copy-on-write instead of lock-on-read because dictionary is not
        // multi-reader/single-writer safe.
        // safe for frequent multi-thread reading by creating new instances (copy of previous instance) for
        // uncommon writes.
        ...
        /// </summary>
        /// <param name="prefix">The prefix string that will appear as the first part of all aliases
        // generated by this AliasGenerator. May be null to indicate that no prefix should be used</param>
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage(
            ...
            MessageId = "System.Collections.Generic.Dictionary`2<System.String,System.String[]>.#ctor(System.Int32,System.Collections.Generic.IEqualityComparer`1<System.String>)"
        )]
        internal AliasGenerator(string prefix, int cacheSize)
        {
            ...
            if (0 < cacheSize)
            {
                ...
                while (
                    (null == (prefixCounter = _prefixCounter))
                ...
                )
                {
                    ...
                    updatedCache = new Dictionary<string, string[]>(
                        capacity,
