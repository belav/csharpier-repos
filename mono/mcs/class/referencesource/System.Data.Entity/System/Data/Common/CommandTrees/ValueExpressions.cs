...
namespace System.Data.Common.CommandTrees
{
    ...
    public sealed class DbConstantExpression : DbExpression
    {
            ...
            : base(DbExpressionKind.Constant, resultType)
        {
            ...
            Debug.Assert(
                ...
                "DbConstantExpression must have a primitive or enum value"
            );
            Debug.Assert(
                ...
                Helper.AsPrimitive(resultType.EdmType).ClrEquivalentType
                    == (
                        value.GetType().IsEnum
                            ? value.GetType().GetEnumUnderlyingType()
                            : value.GetType()
                    ),
    ...
    public sealed class DbParameterReferenceExpression : DbExpression
    {
            ...
            : base(DbExpressionKind.ParameterReference, type)
        {
            Debug.Assert(
                ...
                "DbParameterReferenceExpression name should be valid"
            );
            ...
            : base(DbExpressionKind.Property, resultType)
        {
            ...
            Debug.Assert(
                Helper.IsEdmProperty(property)
                    ...
                    || Helper.IsNavigationProperty(property),
                "DbExpression property must be a property, navigation property, or relationship end"
            );
    ...
    public sealed class DbFunctionExpression : DbExpression
    {
            ...
            : base(DbExpressionKind.Function, resultType)
        {
            ...
            Debug.Assert(
                object.ReferenceEquals(resultType, function.ReturnParameter.TypeUsage),
    ...
    public sealed class DbLambdaExpression : DbExpression
    {
            ...
            : base(DbExpressionKind.Lambda, resultType)
        {
            ...
            Debug.Assert(
                object.ReferenceEquals(resultType, lambda.Body.ResultType),
                "DbLambdaExpression result type must be Lambda body result type"
            );
            Debug.Assert(
                lambda.Variables.Count == args.Count,
                "DbLambdaExpression argument count does not match Lambda parameter count"
            );
            ...
            : base(cmdTree, ExpressionKind.Method)
        {
            ...
            if (cmdTree.TypeHelper.IsNullOrNullType(methodInfo.Type))
            {
                throw EntityUtil.Argument(
                    System.Data.Entity.Strings.Cqt_Method_VoidResultInvalid,
                    "methodInfo"
                );
            }
            ...
            if (methodInfo.IsStatic)
            {
                ...
                {
                    throw EntityUtil.Argument(
                        System.Data.Entity.Strings.Cqt_Method_InstanceInvalidForStatic,
                        "instance"
                    );
                }
            }
            else
            {
                ...
                {
                    throw EntityUtil.Argument(
                        System.Data.Entity.Strings.Cqt_Method_InstanceRequiredForInstance,
                        "instance"
                    );
                }
    ...
    public sealed class DbRelationshipNavigationExpression : DbExpression
    {
            ...
            : base(DbExpressionKind.RelationshipNavigation, resultType)
        {
            Debug.Assert(
                relType != null,
                "DbRelationshipNavigationExpression relationship type cannot be null"
            );
            Debug.Assert(
                fromEnd != null,
                "DbRelationshipNavigationExpression 'from' end cannot be null"
            );
            Debug.Assert(
                toEnd != null,
                "DbRelationshipNavigationExpression 'to' end cannot be null"
            );
            Debug.Assert(
                navigateFrom != null,
                "DbRelationshipNavigationExpression navigation source cannot be null"
            );
    ...
    internal sealed class DbRelatedEntityRef
    {
        ...
        )
        {
            ...
            {
                throw EntityUtil.Argument(
                    System.Data.Entity.Strings.Cqt_RelatedEntityRef_TargetEndSameAsSourceEnd,
                    "targetEnd"
                );
            }
            ...
            {
                throw EntityUtil.Argument(
                    System.Data.Entity.Strings.Cqt_RelatedEntityRef_TargetEndMustBeAtMostOne,
                    "targetEnd"
                );
            }
            ...
            {
                throw EntityUtil.Argument(
                    System.Data.Entity.Strings.Cqt_RelatedEntityRef_TargetEntityNotRef,
                    "targetEntityRef"
                );
            }
            ...
            EntityTypeBase endType = TypeHelpers
                .GetEdmType<RefType>(targetEnd.TypeUsage)
                .ElementType;
            EntityTypeBase targetType = TypeHelpers
                .GetEdmType<RefType>(targetEntityRef.ResultType)
                .ElementType;
            //
            if (!endType.EdmEquals(targetType) && !TypeSemantics.IsSubTypeOf(targetType, endType))
            {
                throw EntityUtil.Argument(
                    System.Data.Entity.Strings.Cqt_RelatedEntityRef_TargetEntityNotCompatible,
                    "targetEntityRef"
                );
            }
    ...
    public sealed class DbNewInstanceExpression : DbExpression
    {
        ...
        internal DbNewInstanceExpression(
            ...
            System.Collections.ObjectModel.ReadOnlyCollection<DbRelatedEntityRef> relationships
        )
            : this(resultType, attributeValues)
        {
            Debug.Assert(
                TypeSemantics.IsEntityType(resultType),
                "An entity type is required to create a NewEntityWithRelationships expression"
            );
    ...
    public sealed class DbRefExpression : DbUnaryExpression
    {
            ...
            : base(DbExpressionKind.Ref, refResultType, refKeys)
        {
            Debug.Assert(
                ...
                "DbRefExpression requires a reference result type"
            );
    ...
    public sealed class DbDerefExpression : DbUnaryExpression
    {
        ...
        {
            Debug.Assert(
                TypeSemantics.IsEntityType(entityResultType),
                "DbDerefExpression requires an entity result type"
            );
        }
