...
namespace System.Data.Common.Utils
{
    ...
    /// Instantiation of the singleton instance is not synchronized and may be invoked multiple times by
    // different threads,
    ...
    /// 2. The instantiation function will be invoked whenever the Value property is accessed and the
    // current value is null,
    ///    not just the first time; avoid returning null from the instantiation function unless the
    // intent is for instantiation to be retried.
    /// </summary>
        ...
        where TValue : class
    {
        ...
        /// <summary>
        /// Retrieves the singleton value, either by evaluating the value function or returning the already
        // cached instance.
        /// </summary>
