...
namespace System.Data.Common.EntitySql.AST
{
    ...
    internal sealed class Literal : Node
    {
        ...
        internal bool IsString
        {
            get
            {
                return _literalKind == LiteralKind.String
                    || _literalKind == LiteralKind.UnicodeString;
            }
        }
            ...
            if (!_wasValueComputed)
            {
                ...
                switch (_literalKind)
                {
                    ...
                    case LiteralKind.String:
                        _computedValue = GetStringLiteralValue(
                            _originalValue,
                            false /* isUnicode */
                        );
                        break;
        ...
        static char[] numberSuffixes = new char[]
        {
            'U',
            'u',
            'L',
        ...
        private static object ConvertNumericLiteral(ErrorContext errCtx, string numericString)
        {
            ...
            if (-1 != k)
            {
                ...
                string numberPart = numericString.Substring(
                    0,
                    numericString.Length - suffix.Length
                );
                switch (suffix)
                {
                    case "U":
        ...
        )
        {
            ...
            if (!Boolean.TryParse(booleanLiteralValue, out result))
            {
                throw EntityUtil.EntitySqlError(
                    errCtx,
                    System.Data.Entity.Strings.InvalidLiteralFormat("Boolean", booleanLiteralValue)
                );
            }
            return result;
        }
        ...
        private static string GetStringLiteralValue(string stringLiteralValue, bool isUnicode)
        {
            ...
            Debug.Assert(
                isUnicode == ('N' == stringLiteralValue[0]),
            ...
            {
                throw EntityUtil.EntitySqlError(
                    System.Data.Entity.Strings.MalformedStringLiteralPayload
                );
            }
            ...
            Debug.Assert(
                before % 2 == 0,
                "must have an even number of delimiters in the string literal"
            );
            if (0 != (before % 2))
            {
                throw EntityUtil.EntitySqlError(
            ...
            //
            result = stringLiteralValue.Substring(
                startIndex,
                stringLiteralValue.Length - (1 + startIndex)
            );
        ...
        )
        {
            ...
            if (hasOddBytes)
            {
                binaryValue[arrayIndex++] = (byte)HexDigitToBinaryValue(
                    binaryLiteralValue[startIndex++]
                );
            }

            while (startIndex < endIndex)
            {
                binaryValue[arrayIndex++] = (byte)(
        ...
        {
            string[] datetimeParts = datetimeLiteralValue.Split(
                _datetimeSeparators,
            ...
            Debug.Assert(
                ...
                "datetime literal value must have at least 5 parts"
            );
        ...
        {
            string[] datetimeParts = datetimeLiteralValue.Split(
                _datetimeOffsetSeparators,
                StringSplitOptions.RemoveEmptyEntries
            );

            Debug.Assert(
                datetimeParts.Length >= 7,
                "datetime literal value must have at least 7 parts"
            );
            ...
            catch (ArgumentOutOfRangeException e)
            {
                throw EntityUtil.EntitySqlError(
                    errCtx,
                    System.Data.Entity.Strings.InvalidDateTimeOffsetLiteral(datetimeLiteralValue),
                    e
                );
            }
        }
        ...
        )
        {
            ...
            Debug.Assert(
                ...
                "time literal value must have at least 2 parts"
            );
        ...
        )
        {
            ...
            {
                throw EntityUtil.EntitySqlError(
                    System.Data.Entity.Strings.InvalidYear(datetimeParts[0], datetimeLiteralValue)
                );
            }
            month = Int32.Parse(
                datetimeParts[1],
            ...
            {
                throw EntityUtil.EntitySqlError(
                    System.Data.Entity.Strings.InvalidMonth(datetimeParts[1], datetimeLiteralValue)
                );
            }
            ...
            {
                throw EntityUtil.EntitySqlError(
                    System.Data.Entity.Strings.InvalidDay(datetimeParts[2], datetimeLiteralValue)
                );
            }
