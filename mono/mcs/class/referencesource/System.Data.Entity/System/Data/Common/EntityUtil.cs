...
namespace System.Data
{
    ...
    internal static class EntityUtil
    {
        ...
        internal static EntityCommandExecutionException CommandExecution(
            string message,
        ...
        internal static EntityCommandCompilationException CommandCompilation(
            string message,
            Exception innerException
        )
        {
        ...
        internal static PropertyConstraintException PropertyConstraint(
            string message,
            string propertyName
        )
        {
        ...
        internal static InvalidOperationException NonSequentialArrayOffsetAccess(
            long badIndex,
            long currIndex,
            string method
        )
        ...
        internal static NotSupportedException KeysRequiredForJoinOverNest(Query.InternalTrees.Op op)
        {
            return NotSupported(
        ...
        internal static NotSupportedException NestingNotSupported(
        ...
        internal static EntityException ProviderExceptionWithMessage(
            string message,
            Exception inner
        )
        {
        ...
        internal static ArgumentException ItemDuplicateIdentity(
            string identity,
            string parameter,
            Exception inner
        )
        ...
        internal static ArgumentException MissingDefaultValueForConstantFacet(
            string facetName,
            string typeName
        )
        {
        ...
        internal static ArgumentException BothMinAndMaxValueMustBeSpecifiedForNonConstantFacet(
            string facetName,
            string typeName
        )
        {
        ...
        internal static ArgumentException MinAndMaxValueMustBeDifferentForNonConstantFacet(
            string facetName,
            string typeName
        )
        {
        ...
        internal static ArgumentException MinMustBeLessThanMax(
            string minimumValue,
            string facetName,
            string typeName
        )
        ...
        internal static ArgumentException TypeNotInEntitySet(
        ...
        internal static ArgumentException TypeNotInAssociationSet(
            string setName,
            string rootEntityTypeName,
            string typeName
        )
        ...
        internal static UpdateException UpdateMissingEntity(
            string relationshipSetName,
            string entitySetName
        )
        {
        ...
        internal static ArgumentException CollectionParameterElementIsNullOrEmpty(
            string parameterName
        )
        {
            return Argument(
        ...
        internal static Exception EntityParameterCollectionInvalidParameterName(
            string parameterName
        )
        {
            return new IndexOutOfRangeException(
        ...
        internal static T GenericCheckArgumentNull<T>(T value, string parameterName)
            where T : class
        {
        ...
        internal static bool AssemblyNamesMatch(
        ...
        private static readonly Type CommandCompilationType =
