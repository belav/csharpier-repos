...
namespace System.Data
{
    ...
    internal static class EntityUtil
    {
        ...
        {
            const BindingFlags constructorBinding =
        ...
        static internal EntityCommandExecutionException CommandExecution(
            string message,
        ...
        static internal EntityCommandCompilationException CommandCompilation(
            string message,
            Exception innerException
        )
        {
        ...
        static internal PropertyConstraintException PropertyConstraint(
            string message,
            string propertyName
        )
        {
        ...
        {
            return Argument(
                System.Data.Entity.Strings.InvalidStringArgument(parameterName),
                parameterName
            );
        }
        ...
        /// <param name="message"></param>
        /// <returns>EntityException</returns>
        static internal EntitySqlException EntitySqlError(
            System.Data.Common.EntitySql.ErrorContext errCtx,
            string message
        )
        {
        ...
        static internal ProviderIncompatibleException CannotCloneStoreProvider()
        {
            return ProviderIncompatible(
                System.Data.Entity.Strings.EntityClient_CannotCloneStoreProvider
            );
        }
        ...
        static internal InvalidOperationException NonSequentialArrayOffsetAccess(
            long badIndex,
            long currIndex,
            string method
        )
        ...
        {
            return NotSupported(
                System.Data.Entity.Strings.ADP_KeysRequiredForJoinOverNest(op.OpType.ToString())
            );
        }
        ...
        static internal NotSupportedException NestingNotSupported(
            Query.InternalTrees.Op parentOp,
            Query.InternalTrees.Op childOp
        )
        {
            return NotSupported(
        ...
        static internal EntityCommandExecutionException CommandExecutionDataReaderFieldCountForScalarType()
        {
            return CommandExecution(
                System.Data.Entity.Strings.ADP_InvalidDataReaderFieldCountForScalarType
            );
        }
        ...
        static internal EntityCommandExecutionException CommandExecutionDataReaderMissinDiscriminatorColumn(
            string columnName,
        ...
        static internal EntityException Provider(Exception inner)
        {
            return new EntityException(
                System.Data.Entity.Strings.EntityClient_ProviderGeneralError,
                inner
            );
        }
        ...
        {
            return new EntityException(
                System.Data.Entity.Strings.EntityClient_ProviderSpecificError(parameter),
                inner
            );
        }

        static internal EntityException ProviderExceptionWithMessage(
            string message,
            Exception inner
        )
        {
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.SqlProvider_SqlTypesAssemblyNotFound
            );
        }
        ...
        {
            return ProviderIncompatible(
                System.Data.Entity.Strings.SqlProvider_GeographyValueNotSqlCompatible
            );
        }
        ...
        {
            return ProviderIncompatible(
                System.Data.Entity.Strings.SqlProvider_GeometryValueNotSqlCompatible
            );
        }
        ...
        {
            return Metadata(
                System.Data.Entity.Strings.InvalidCollectionForMapping(space.ToString())
            );
        }
        ...
        static internal ArgumentException ItemDuplicateIdentity(
            string identity,
            string parameter,
            Exception inner
        )
        {
            return Argument(
                System.Data.Entity.Strings.ItemDuplicateIdentity(identity),
                parameter,
                inner
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.MoreThanOneItemMatchesIdentity(identity)
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.ItemCollectionAlreadyRegistered(space.ToString())
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.NoCollectionForSpace(space.ToString())
            );
        }
        ...
        static internal MetadataException DifferentSchemaVersionInCollection(
            string itemCollectionType,
            double versionToRegister,
            double currentSchemaVersion
        )
        {
            return Metadata(
                Strings.DifferentSchemaVersionInCollection(
                    itemCollectionType,
                    versionToRegister,
        ...
        //FacetDescription.cs
        static internal ArgumentException MinAndMaxValueMustBeSameForConstantFacet(
            string facetName,
            string typeName
        )
        {
        ...
        static internal ArgumentException MissingDefaultValueForConstantFacet(
            string facetName,
            string typeName
        )
        {
            return Argument(
                System.Data.Entity.Strings.MissingDefaultValueForConstantFacet(facetName, typeName)
            );
        }

        static internal ArgumentException BothMinAndMaxValueMustBeSpecifiedForNonConstantFacet(
            string facetName,
            string typeName
        )
        {
        ...
        static internal ArgumentException MinAndMaxValueMustBeDifferentForNonConstantFacet(
            string facetName,
            string typeName
        )
        {
        ...
        {
            return Argument(
                System.Data.Entity.Strings.MinAndMaxMustBePositive(facetName, typeName)
            );
        }

        static internal ArgumentException MinMustBeLessThanMax(
            string minimumValue,
            string facetName,
            string typeName
        )
        {
            return Argument(
                System.Data.Entity.Strings.MinMustBeLessThanMax(minimumValue, facetName, typeName)
            );
        }
        ...
        static internal ArgumentException TypeNotInEntitySet(
        ...
        static internal ArgumentException TypeNotInAssociationSet(
            string setName,
            string rootEntityTypeName,
            string typeName
        )
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.ADP_InternalProviderError((int)internalError)
            );
        }
        ...
        )
        {
            ...
            return InvalidOperation(
                System.Data.Entity.Strings.ADP_InternalProviderError(sb.ToString())
            );
        }
        ...
        internal static ArgumentException InvalidTypeForComplexTypeProperty(string argument)
        {
            return EntityUtil.Argument(
                System.Data.Entity.Strings.ObjectStateEntry_InvalidTypeForComplexTypeProperty,
                argument
            );
        }
        ...
        {
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.ObjectStateEntry_InvalidState
            );
        }
        ...
        {
            throw EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.ObjectStateEntry_CantModifyDetachedDeletedEntries
            );
        }
        ...
        {
            throw EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.ObjectStateEntry_SetModifiedStates(methodName)
            );
        }
        ...
        {
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.Entity_EntityCantHaveMultipleChangeTrackers
            );
        }
        ...
        {
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.ObjectStateEntry_CantModifyRelationValues
            );
        }
        ...
        {
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.ObjectStateEntry_CantModifyRelationState
            );
        }
        ...
        {
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.ObjectStateEntry_CantSetEntityKey
            );
        }
        ...
        {
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.ObjectStateEntry_CannotAccessKeyEntryValues
            );
        }
        ...
        {
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.ObjectStateEntry_CannotModifyKeyEntryState
            );
        }
        ...
        {
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.ObjectStateEntry_CannotDeleteOnKeyEntry
            );
        }
        ...
        {
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.ObjectStateManager_NoEntryExistForEntityKey
            );
        }
        ...
        {
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.ObjectStateManager_CannotFixUpKeyToExistingValues
            );
        }
        ...
        {
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.ObjectStateManager_InvalidKey
            );
        }
        ...
        {
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.ObjectStateManager_AcceptChangesEntityKeyIsNotValid
            );
        }
        ...
        internal static ArgumentException ChangeOnUnmappedComplexProperty(
        ...
        internal static ArgumentException EntityTypeDoesNotMatchEntitySet(
            string entityType,
            string entitysetName,
            string argument
        )
        ...
        {
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.ObjectStateManager_EntityNotTracked
            );
        }
        ...
        {
            return InvalidOperation(
                Strings.ObjectStateEntry_SetOriginalComplexProperties(propertyName)
            );
        }
        ...
        internal static InvalidOperationException ValueNullReferenceCast(Type destinationType)
        {
            ...
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.Materializer_NullReferenceCast(destinationType.Name)
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.Materializer_CannotReEnumerateQueryResults
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.ObjectView_CannotReplacetheEntityorRow
            );
        }
        ...
        {
            return NotSupported(
                System.Data.Entity.Strings.ObjectView_IndexBasedInsertIsNotSupported
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.ObjectView_WriteOperationNotAllowedOnReadOnlyBindingList
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.ObjectView_AddNewOperationNotAllowedOnAbstractBindingList
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.ObjectView_CannotResolveTheEntitySet(type.FullName)
            );
        }
        ...
        internal static InvalidOperationException NoRelationshipSetMatched(string relationshipName)
        {
            ...
            return InvalidOperation(
                System.Data.Entity.Strings.Collections_NoRelationshipSetMatched(relationshipName)
            );
        }

        internal static InvalidOperationException ExpectedCollectionGotReference(
            string typeName,
            string roleName,
        ...
        internal static InvalidOperationException CannotFillTryDifferentMergeOption(
            string relationshipName,
            string roleName
        )
        {
            return InvalidOperation(
                Strings.Collections_CannotFillTryDifferentMergeOption(relationshipName, roleName)
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.Collections_UnableToMergeCollections
            );
        }

        internal static InvalidOperationException ExpectedReferenceGotCollection(
            string typeName,
            string roleName,
            string relationshipName
        )
        ...
        {
            return Argument(
                System.Data.Entity.Strings.EntityReference_CannotSetSpecialKeys,
                "value"
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.EntityReference_EntityKeyValueMismatch
            );
        }

        internal static InvalidOperationException RelatedEndNotAttachedToContext(
            string relatedEndType
        )
        {
            return InvalidOperation(
                System.Data.Entity.Strings.RelatedEnd_RelatedEndNotAttachedToContext(relatedEndType)
            );
        }

        internal static InvalidOperationException CannotCreateRelationshipBetweenTrackedAndNoTrackedEntities(
            string roleName
        )
        {
            return InvalidOperation(
        ...
        internal static InvalidOperationException InvalidContainedTypeReference(
            string entityType,
            string relatedEndType
        )
        {
        ...
        internal static InvalidOperationException CannotRemoveFromFixedSizeArray(
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.RelatedEnd_UnableToAddRelationshipWithDeletedEntity
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.RelatedEnd_ConflictingChangeOfRelationshipDetected
            );
        }

        internal static InvalidOperationException InvalidRelationshipFixupDetected(
            string propertyName,
            string entityType
        )
        {
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.EntityReference_LessThanExpectedRelatedEntitiesFound
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.EntityReference_MoreThanExpectedRelatedEntitiesFound
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.EntityReference_CannotChangeReferentialConstraintProperty
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.RelatedEnd_LoadCalledOnNonEmptyNoTrackedRelatedEnd
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.RelatedEnd_LoadCalledOnAlreadyLoadedNoTrackedRelatedEnd
            );
        }

        internal static InvalidOperationException MismatchedMergeOptionOnLoad(
            MergeOption mergeOption
        )
        {
            return InvalidOperation(
                System.Data.Entity.Strings.RelatedEnd_MismatchedMergeOptionOnLoad(mergeOption)
            );
        }

        internal static InvalidOperationException EntitySetIsNotValidForRelationship(
            string entitySetContainerName,
            string entitySetName,
            string roleName,
            string associationSetContainerName,
        ...
        internal static ArgumentException UnableToFindRelationshipTypeInMetadata(
            string relationshipName,
            string parameterName
        )
        {
        ...
        internal static ArgumentException InvalidTargetRole(
            string relationshipName,
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.RelationshipManager_UnexpectedNullContext
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.Collections_InvalidEntityStateSource
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.Collections_InvalidEntityStateLoad(relatedEndType)
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.RelatedEnd_InvalidOwnerStateForAttach
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.RelatedEnd_InvalidNthElementNullForAttach(index)
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.RelatedEnd_InvalidNthElementContextForAttach(index)
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.RelatedEnd_InvalidNthElementStateForAttach(index)
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.RelatedEnd_InvalidEntityContextForAttach
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.RelatedEnd_InvalidEntityStateForAttach
            );
        }
        ...
        internal static InvalidOperationException ProxyMetadataIsUnavailable(
            Type type,
            Exception inner
        )
        {
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.EntityProxyTypeInfo_DuplicateOSpaceType(type.FullName)
            );
        }
        #endregion
        ...
        {
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.ObjectContext_ClientEntityRemovedFromStore(entitiesKeys)
            );
        }
        ...
        {
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.ObjectContext_StoreEntityNotPresentInClient
            );
        }
        ...
        {
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.ObjectContext_MetadataHasChanged
            );
        }

        internal static ArgumentException InvalidConnection(
        ...
        {
            return EntityUtil.Argument(
                System.Data.Entity.Strings.ObjectContext_InvalidConnectionString,
                parameter,
                inner
            );
        }
        ...
        {
            return EntityUtil.Argument(
                System.Data.Entity.Strings.ObjectContext_InvalidConnection,
                parameter,
                inner
            );
        }
        ...
        {
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.ObjectContext_InvalidDataAdapter
            );
        }

        internal static ArgumentException InvalidDefaultContainerName(
            string parameter,
        ...
        {
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.ObjectContext_NthElementInAddedState(i)
            );
        }
        ...
        {
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.ObjectContext_NthElementIsDuplicate(i)
            );
        }
        ...
        {
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.ObjectContext_NthElementIsNull(i)
            );
        }
        ...
        {
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.ObjectContext_NthElementNotInObjectStateManager(i)
            );
        }

        internal static ObjectDisposedException ObjectContextDisposed()
        {
            return EntityUtil.ObjectDisposed(
                System.Data.Entity.Strings.ObjectContext_ObjectDisposed
            );
        }

        internal static ObjectNotFoundException ObjectNotFound()
        {
            return EntityUtil.ObjectNotFound(
                System.Data.Entity.Strings.ObjectContext_ObjectNotFound
            );
        }
        ...
        internal static InvalidOperationException InvalidEntityType(Type type)
        {
            ...
            return InvalidOperation(
                System.Data.Entity.Strings.ObjectContext_NoMappingForEntityType(type.FullName)
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.ObjectContext_CannotDeleteEntityNotInObjectStateManager
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.ObjectContext_CannotDetachEntityNotInObjectStateManager
            );
        }
        ...
        {
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.ObjectContext_EntitySetNotFoundForName(entitySetName)
            );
        }

        internal static InvalidOperationException EntityContainterNotFoundForName(
        ...
        {
            return Argument(
                System.Data.Entity.Strings.ObjectContext_InvalidCommandTimeout,
                argument
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.ObjectContext_EntityAlreadyExistsInObjectStateManager
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.ObjectContext_CannotAttachEntityWithoutKey
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.ObjectContext_CannotAttachEntityWithTemporaryKey
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.ObjectContext_EntitySetNameOrEntityKeyRequired
            );
        }

        internal static InvalidOperationException ExecuteFunctionTypeMismatch(
            Type typeArgument,
            EdmType expectedElementType
        )
        {
            return InvalidOperation(
        ...
        {
            return Argument(
                System.Data.Entity.Strings.ObjectContext_QualfiedEntitySetName,
                parameterName
            );
        }
        ...
        {
            return Argument(
                System.Data.Entity.Strings.ObjectContext_ContainerQualifiedEntitySetNameRequired,
                argument
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.ObjectContext_CannotSetDefaultContainerName
            );
        }

        internal static ArgumentException EntitiesHaveDifferentType(
            string originalEntityTypeName,
            string changedEntityTypeName
        )
        {
            return Argument(
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.ObjectContext_AcceptAllChangesFailure(e.Message)
            );
        }

        internal static ArgumentException InvalidEntitySetOnEntity(
            string entitySetName,
            Type entityType,
            string parameter
        )
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.ObjectContext_RequiredMetadataNotAvailble
            );
        }
        ...
        internal static ArgumentException MultipleEntitySetsFoundInAllContainers(
            string entityTypeName,
            string exceptionParameterName
        )
        {
        ...
        internal static ArgumentException NoEntitySetFoundForType(
            string entityTypeName,
            string exceptionParameterName
        )
        {
            return Argument(
                System.Data.Entity.Strings.ObjectContext_NoEntitySetFoundForType(entityTypeName),
                exceptionParameterName
            );
        }
        ...
        {
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.ComplexObject_ComplexObjectAlreadyAttachedToParent
            );
        }

        internal static ArgumentException ComplexChangeRequestedOnScalarProperty(
            string propertyName
        )
        {
            return EntityUtil.Argument(
        ...
        {
            return Argument(
                System.Data.Entity.Strings.ADP_InvalidMultipartNameDelimiterUsage,
                "path"
            );
        }
        ...
        internal static ArgumentException EntitySetDoesNotMatch(
            string argument,
            string entitySetName
        )
        {
            return Argument(
                System.Data.Entity.Strings.EntityKey_EntitySetDoesNotMatch(entitySetName),
                argument
            );
        }
        ...
        internal static ArgumentException NoCorrespondingOSpaceTypeForEnumKeyField(
            string argument,
            string keyField,
        ...
        internal static ArgumentException MissingKeyValue(
            string argument,
            string keyField,
            string typeName
        )
        ...
        {
            return Argument(
                System.Data.Entity.Strings.EntityKey_MissingKeyValue(keyField, typeName),
                argument
            );
        }
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.EntityKey_NullKeyValue(keyField, typeName)
            );
        }

        internal static InvalidOperationException MissingKeyValueInvalidOperation(
            string keyField,
            string typeName
        )
        {
        ...
        {
            return Argument(
                System.Data.Entity.Strings.EntityKey_NoNullsAllowedInKeyValuePairs,
                argument
            );
        }
        ...
        {
            return Argument(
                System.Data.Entity.Strings.EntityKey_InvalidQualifiedEntitySetName,
        ...
        internal static InvalidOperationException UnexpectedNullEntityKey()
        {
            return new InvalidOperationException(
                System.Data.Entity.Strings.EntityKey_UnexpectedNull
            );
        }
        ...
        {
            return new InvalidOperationException(
                System.Data.Entity.Strings.RelationshipManager_UnexpectedNull
            );
        }
        ...
        {
            return EntityUtil.InvalidOperation(
                System.Data.Entity.Strings.RelationshipManager_InvalidRelationshipManagerOwner
            );
        }
        ...
        )
        {
            ...
            Debug.Assert(
                null != entitySet.EntityContainer,
            ...
            if (
                !StringComparer.Ordinal.Equals(containerName1, containerName2)
        ...
        // UpdateException
        //
        static private IEnumerable<ObjectStateEntry> ProcessStateEntries(
            IEnumerable<IEntityStateEntry> stateEntries
        )
        {
            return stateEntries
        ...
        static internal void ValidateNecessaryModificationFunctionMapping(
            StorageModificationFunctionMapping mapping,
            string currentState,
        ...
        static internal UpdateException Update(
            string message,
            Exception innerException,
        ...
        static internal OptimisticConcurrencyException UpdateConcurrency(
            long rowsAffected,
            Exception innerException,
            IEnumerable<IEntityStateEntry> stateEntries
        )
        {
            ...
            return new OptimisticConcurrencyException(
                message,
                innerException,
                ProcessStateEntries(stateEntries)
            );
        }

        static internal UpdateException UpdateRelationshipCardinalityConstraintViolation(
        ...
        static internal UpdateException UpdateEntityMissingConstraintViolation(
            string relationshipSetName,
            string endName,
            IEntityStateEntry stateEntry
        )
        ...
        static internal UpdateException UpdateMissingEntity(
            string relationshipSetName,
            string entitySetName
        )
        {
            return Update(
                System.Data.Entity.Strings.Update_MissingEntity(relationshipSetName, entitySetName),
                null
            );
        }
        ...
        {
            return Argument(
                System.Data.Entity.Strings.ADP_CollectionParameterElementIsNull(parameterName)
            );
        }

        static internal ArgumentException CollectionParameterElementIsNullOrEmpty(
            string parameterName
        )
        {
            return Argument(
        ...
        {
            return InvalidOperation(
                System.Data.Entity.Strings.Cqt_UDF_FunctionHasNoDefinition(function.Identity)
            );
        }

        static internal InvalidOperationException FunctionDefinitionResultTypeMismatch(
            EdmFunction function,
            TypeUsage generatedDefinitionResultType
        )
        {
            return InvalidOperation(
        ...
        static internal Exception EntityParameterCollectionInvalidParameterName(
            string parameterName
        )
        {
            return new IndexOutOfRangeException(
        ...
        static internal Exception EntityParameterNull(string parameter)
        {
            return new ArgumentNullException(
                parameter,
                System.Data.Entity.Strings.EntityParameterNull
            );
        }
        ...
        static internal Exception InvalidEntityParameterType(object invalidValue)
        {
            return new InvalidCastException(
                System.Data.Entity.Strings.InvalidEntityParameterType(invalidValue.GetType().Name)
            );
        }
        ...
        static internal ArgumentException EntityParameterCollectionRemoveInvalidObject()
        {
            return new ArgumentException(
                System.Data.Entity.Strings.EntityParameterCollectionRemoveInvalidObject
            );
        }
        ...
        {
            return new ArgumentException(
                System.Data.Entity.Strings.EntityParameterContainedByAnotherCollection
            );
        }
        ...
        static internal IEnumerable<T> CheckArgumentContainsNull<T>(
            ...
            foreach (T item in enumerableArgument)
            {
                if (item == null)
                {
                    throw EntityUtil.Argument(
                        Strings.CheckArgumentContainsNullFailed(argumentName)
                    );
                }
            }
        ...
        static internal IEnumerable<T> CheckArgumentEmpty<T>(
            ref IEnumerable<T> enumerableArgument,
        ...
        static internal T GenericCheckArgumentNull<T>(T value, string parameterName)
            where T : class
        {
        ...
        static internal bool AssemblyNamesMatch(
        ...
        )
        {
            ...
            if (
                (targetAssemblyName.Version.Major != assemblyName.Version.Major)
        ...
        static private readonly Type CommandCompilationType =
            ...
            get
            {
                if (!useFx40CompatMode.HasValue)
                {
                    ...
                    if (string.IsNullOrWhiteSpace(fxname))
                    {
                        ...
                        {
                            TargetFrameworkAttribute fxAttrib =
