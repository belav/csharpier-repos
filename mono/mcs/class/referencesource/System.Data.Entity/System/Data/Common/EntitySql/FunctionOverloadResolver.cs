    ...
    internal static class FunctionOverloadResolver
    {
            ...
            where TFunctionMetadata : class
        {
            ...
            )
            {
                ...
                {
                    Debug.Assert(
                        rank.Length == bestCandidateRank.Length,
        ...
        )
        {
            ...
            {
                int rank = GetPromotionRank(
                    flatArgumentList[i],
                    flatOverloadParamList[i],
                    isPromotableTo,
                    isStructurallyEqual
                );
                totalRank += rank;
        ...
        )
        {
            ...
            if (primitiveFromType != null && primitiveToType != null)
            {
                ...
                IList<PrimitiveType> promotions = EdmProviderManifest.Instance.GetPromotionTypes(
                    primitiveFromType
                );
                ...
                if (promotionIndex < 0)
                {
                    throw EntityUtil.InternalError(
                        EntityUtil.InternalErrorCode.FailedToGeneratePromotionRank,
                        1
                    );
                }
            ...
            if (entityBaseFromType != null && entityBaseToType != null)
            {
                ...
                EdmType t;
                for (
                    t = entityBaseFromType;
                    t != entityBaseToType && t != null;
                    t = t.BaseType, ++promotionIndex
                )
                    ;
