...
namespace System.Data.Common.CommandTrees
{
    ...
    public sealed class DbApplyExpression : DbExpression
    {
            ...
            : base(applyKind, resultRowCollectionTypeUsage)
        {
            ...
            Debug.Assert(
                DbExpressionKind.CrossApply == applyKind
                    || DbExpressionKind.OuterApply == applyKind,
    ...
    public sealed class DbDistinctExpression : DbUnaryExpression
    {
        ...
        {
            Debug.Assert(
                TypeSemantics.IsCollectionType(argument.ResultType),
    ...
    public sealed class DbExceptExpression : DbBinaryExpression
    {
        ...
        {
            Debug.Assert(
                object.ReferenceEquals(resultType, left.ResultType),
    ...
    public sealed class DbGroupByExpression : DbExpression
    {
            ...
            : base(DbExpressionKind.GroupBy, collectionOfRowResultType)
        {
            ...
            Debug.Assert(
                groupKeys.Count > 0 || aggregates.Count > 0,
                "At least one key or aggregate is required"
            );
    ...
    public sealed class DbCrossJoinExpression : DbExpression
    {
        ...
        internal DbCrossJoinExpression(
            TypeUsage collectionOfRowResultType,
            System.Collections.ObjectModel.ReadOnlyCollection<DbExpressionBinding> inputs
        )
    ...
    public sealed class DbLimitExpression : DbExpression
    {
            ...
            : base(DbExpressionKind.Limit, resultType)
        {
            ...
            Debug.Assert(
                object.ReferenceEquals(resultType, argument.ResultType),
    ...
    public sealed class DbSkipExpression : DbExpression
    {
        ...
        internal DbSkipExpression(
            TypeUsage resultType,
            DbExpressionBinding input,
            System.Collections.ObjectModel.ReadOnlyCollection<DbSortClause> sortOrder,
            DbExpression count
        )
