    ...
    public abstract class DbProviderServices
    {
            ...
            catch (Exception e)
            {
                if (EntityUtil.IsCatchableExceptionType(e))
                {
                    throw EntityUtil.ProviderIncompatible(
                        Strings.ProviderDidNotCreateACommandDefinition,
                        e
                    );
                }
                throw;
        ...
        public string GetProviderManifestToken(DbConnection connection)
        {
            try
            {
                ...
                {
                    throw EntityUtil.ProviderIncompatible(
                        Strings.ProviderDidNotReturnAProviderManifestToken
                    );
                }
        ...
        public DbProviderManifest GetProviderManifest(string manifestToken)
        {
            try
            {
                ...
                {
                    throw EntityUtil.ProviderIncompatible(
                        Strings.ProviderDidNotReturnAProviderManifest
                    );
                }
            ...
            catch (Exception e)
            {
                ...
                {
                    throw EntityUtil.ProviderIncompatible(
                        System.Data.Entity.Strings.ProviderDidNotReturnAProviderManifest,
                        e
                    );
                }
                throw;
        ...
        )
        {
            try
            {
                DbSpatialDataReader spatialReader = GetDbSpatialDataReader(
                    fromReader,
                    manifestToken
                );
            ...
            catch (Exception e)
            {
                ...
                {
                    throw EntityUtil.ProviderIncompatible(
                        System.Data.Entity.Strings.ProviderDidNotReturnSpatialServices,
                        e
                    );
                }
                throw;
        ...
        )
        {
            ...
            Debug.Assert(
                parameterType != null,
                "Validate parameterType before calling SetParameterValue"
            );
        ...
        internal static XmlReader GetConceptualSchemaDefinition(string csdlName)
        {
            return DbProviderServices.GetXmlResource(
                "System.Data.Resources.DbProviderServices." + csdlName + ".csdl"
            );
        }
        ...
        {
            throw EntityUtil.ProviderIncompatible(
                Strings.ProviderDoesNotSupportCreateDatabaseScript
            );
        }
