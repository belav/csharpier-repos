    ...
    public sealed class ObjectResult<T> : ObjectResult, IEnumerable<T>
    {
        ...
        internal override IList GetIListSourceListInternal()
        {
            ...
            if (_cachedBindingList == null)
            {
                ...
                _cachedBindingList = ObjectViewFactory.CreateViewForQuery<T>(
                    this._resultItemType,
                    this,
                    this._shaper.Context,
                    forceReadOnly,
        ...
        {
            return null != _nextResultGenerator
                ? _nextResultGenerator.GetNextResult<TElement>(_reader)
                : null;
        }
