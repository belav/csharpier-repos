...
namespace System.Data.Objects.Internal
{
    ...
    internal static class EntityWrapperFactory
    {
        ...
        private static Func<object, IEntityWrapper> CreateWrapperDelegate(Type entityType)
        {
            ...
            bool isIEntityWithChangeTracker = typeof(IEntityWithChangeTracker).IsAssignableFrom(
                entityType
            );
            ...
            )
            {
                createDelegate = typeof(EntityWrapperFactory).GetMethod(
                    "CreateWrapperDelegateTypedLightweight",
            ...
            else if (isIEntityWithRelationships)
            {
                ...
                createDelegate = typeof(EntityWrapperFactory).GetMethod(
                    "CreateWrapperDelegateTypedWithRelationships",
                    BindingFlags.NonPublic | BindingFlags.Static
                );
            }
            else
            {
                createDelegate = typeof(EntityWrapperFactory).GetMethod(
                    "CreateWrapperDelegateTypedWithoutRelationships",
                    BindingFlags.NonPublic | BindingFlags.Static
                );
            }
            ...
            where TEntity : IEntityWithRelationships
        {
            ...
            CreateStrategies<TEntity>(
                out propertyAccessorStrategy,
                out changeTrackingStrategy,
                out keyStrategy
            );

            return (entity) =>
                new EntityWrapperWithRelationships<TEntity>(
                    (TEntity)entity,
        ...
        internal static IEntityWrapper WrapEntityUsingContext(object entity, ObjectContext context)
        {
            ...
            return WrapEntityUsingStateManagerGettingEntry(
                entity,
                context == null ? null : context.ObjectStateManager,
                out existingEntry
            );
        }
        ...
        /// <returns>a new or existing wrapper</returns>
        internal static IEntityWrapper WrapEntityUsingStateManager(
            object entity,
        ...
        > GetPocoPropertyAccessorStrategyFunc()
        {
        ...
        internal static Func<
            object,
            IPropertyAccessorStrategy
        > GetNullPropertyAccessorStrategyFunc()
        {
        ...
        > GetEntityWithChangeTrackerStrategyFunc()
        {
            return (object entity) =>
                new EntityWithChangeTrackerStrategy((IEntityWithChangeTracker)entity);
        }
