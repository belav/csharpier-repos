    ...
    public class RelationshipManager
    {
            ...
            where TTargetEntity : class
        {
            ...
            if (existingRelatedEnd == null)
            {
                if (relatedEnd != null)
                {
                    ...
                    Debug.Assert(
                        collection != null,
                        "should never receive anything but an EntityCollection here"
                    );
                    return collection;
                }
                else
                {
                    RelationshipNavigation navigation = new RelationshipNavigation(
                        relationshipName,
                        sourceRoleName,
                        targetRoleName,
                        sourceAccessor,
                    ...
                    return CreateRelatedEnd<TSourceEntity, TTargetEntity>(
                            navigation,
                            sourceRoleMultiplicity,
                            RelationshipMultiplicity.Many,
                            existingRelatedEnd
                        ) as EntityCollection<TTargetEntity>;
                }
            }
            else
            {
                ...
                Debug.Assert(
                    existingRelatedEnd._onAssociationChanged == null,
                    "Disconnected RelatedEnd had events"
                );
                ...
                if (collection != null)
                {
                    ...
                    {
                        RemergeCollections(
                            relatedEnd as EntityCollection<TTargetEntity>,
                            collection
                        );
                        doCleanup = false;
                    }
                    finally
                    {
                        ...
                        if (doCleanup && relatedEnd != null)
                        {
                            Debug.Assert(
                                _relationships != null,
                                "Expected _relationships to be non-null."
                            );
            ...
            where TTargetEntity : class
        {
            ...
            if (TryGetCachedRelatedEnd(relationshipName, targetRoleName, out relatedEnd))
            {
                ...
                Debug.Assert(
                    entityRef != null,
                    "should never receive anything but an EntityReference here"
                );
                return entityRef;
            }
            else
            {
                ...
                return CreateRelatedEnd<TSourceEntity, TTargetEntity>(
                        ...
                        existingRelatedEnd
                    ) as EntityReference<TTargetEntity>;
            }
        }
        ...
        internal RelatedEnd GetRelatedEndInternal(string relationshipName, string targetRoleName)
        {
            ...
            )
            {
                if (_relationships != null)
                {
                    ...
                    relatedEnd = (
                        from RelatedEnd end in _relationships
                        where
                            end.RelationshipName == relationshipName
            ...
            if (relatedEnd == null)
            {
                ...
                relatedEnd = GetRelatedEndInternal(
                    relationshipName,
                    targetRoleName, /*existingRelatedEnd*/
                    null,
                    associationType
                );
            }
        ...
        )
        {
            ...
            Debug.Assert(
                relationship.AssociationEndMembers.Count == 2,
                "Only 2-way relationships are currently supported"
            );
            ...
            if (targetEnd.Identity != targetRoleName)
            {
                ...
                if (targetEnd.Identity != targetRoleName)
                {
                    if (throwOnError)
                    {
                        throw EntityUtil.InvalidTargetRole(
                            relationshipName,
                            targetRoleName,
                            "targetRoleName"
                        );
            ...
            else if (VerifyRelationship(relationship, sourceEnd.Name, throwOnError))
            {
                ...
                result = LightweightCodeGenerator.GetRelatedEnd(
                    this,
                    sourceEnd,
                    targetEnd,
                    existingRelatedEnd
            ...
            where TTargetEntity : class
        {
            ...
            AssociationType relationship = GetRelationshipType(
                wrappedOwner.IdentityType,
                relationshipName
            );
            ...
            if (reference == null)
            {
                throw EntityUtil.ExpectedReferenceGotCollection(
                    typeof(TTargetEntity).Name,
                    targetRoleName,
                    relationshipName
                );
            }
            ...
            where TTargetEntity : class
        {
            ...
            if (collection == null)
            {
                throw EntityUtil.ExpectedCollectionGotReference(
                    typeof(TTargetEntity).Name,
                    targetRoleName,
                    relationshipName
                );
        ...
        private string PrependNamespaceToRelationshipName(string relationshipName)
        {
            ...
            if (!relationshipName.Contains('.'))
            {
                ...
                {
                    Dictionary<string, EdmType> types = ObjectItemCollection.LoadTypesExpensiveWay(
                        WrappedOwner.IdentityType.Assembly
                    );
                    if (types != null)
                    {
        ...
        private bool TryGetOwnerEntityType(out EntityType entityType)
        {
            ...
            Map map;
            if (
                TryGetObjectMappingItemCollection(WrappedOwner, out mappings)
        ...
        )
        {
            if (wrappedOwner.Context != null && wrappedOwner.Context.MetadataWorkspace != null)
            {
                collection = (DefaultObjectMappingItemCollection)
                    wrappedOwner.Context.MetadataWorkspace.GetItemCollection(DataSpace.OCSpace);
        ...
        )
        {
            ...
            if (objectItemCollection != null)
            {
                associationType = objectItemCollection.GetRelationshipType(
                    entityClrType,
                    relationshipName
                );
            }
            ...
            {
                associationType = ObjectItemCollection.GetRelationshipTypeExpensiveWay(
                    entityClrType,
                    relationshipName
                );
            }
        ...
        {
            ArgumentException argException = EntityUtil.UnableToFindRelationshipTypeInMetadata(
                relationshipName,
                "relationshipName"
            );
            if (EntityProxyFactory.IsProxyType(wrappedOwner.Entity.GetType()))
            {
                return EntityUtil.ProxyMetadataIsUnavailable(
                    wrappedOwner.IdentityType,
                    argException
                );
            }
        ...
        {
            foreach (
                AssociationSet assocSet in MetadataHelper.GetAssociationsForEntitySet(
                    ownerEntitySet
                )
            )
            {
        ...
        private IEnumerable<AssociationEndMember> GetAllTargetEnds(Type entityClrType)
        {
            ...
            else
            {
                ...
                associations = ObjectItemCollection.GetAllRelationshipTypesExpensiveWay(
            ...
            foreach (AssociationType association in associations)
            {
                ...
                RefType referenceType =
                    association.AssociationEndMembers[0].TypeUsage.EdmType as RefType;
                if (
                    referenceType != null
        ...
        )
        {
            ...
            )
            {
                ...
                association = MetadataHelper.GetAssociationsForEntitySetAndAssociationType(
                    entityContainer,
                    ownerKey.EntitySetName,
                    (AssociationType)associationTypeUsage.EdmType,
                    sourceEndName,
                    out entitySet
                );
        ...
        internal RelatedEnd CreateRelatedEnd<TSourceEntity, TTargetEntity>(
            ...
            where TTargetEntity : class
        {
            IRelationshipFixer relationshipFixer = new RelationshipFixer<
                TSourceEntity,
                TTargetEntity
            ...
            switch (targetRoleMultiplicity)
            {
                ...
                case RelationshipMultiplicity.One:
                    if (existingRelatedEnd != null)
                    {
                        ...
                        existingRelatedEnd.InitializeRelatedEnd(
                            wrappedOwner,
                            navigation,
                            relationshipFixer
                        );
                    ...
                    {
                        relatedEnd = new EntityReference<TTargetEntity>(
                            wrappedOwner,
                            navigation,
                            relationshipFixer
                        );
                ...
                case RelationshipMultiplicity.Many:
                    ...
                    {
                        relatedEnd = new EntityCollection<TTargetEntity>(
                            wrappedOwner,
                            navigation,
                            relationshipFixer
                        );
        ...
        public IEnumerable<IRelatedEnd> GetAllRelatedEnds()
        {
            ...
            else
            {
                ...
                {
                    foreach (
                        AssociationEndMember endMember in GetAllTargetEnds(
                            wrappedOwner.IdentityType
                        )
                    )
                    {
                        yield return GetRelatedEnd(
                            endMember.DeclaringType.FullName,
                            endMember.Name
                        );
                    }
                }
        ...
        public void OnSerializing(StreamingContext context)
        {
            ...
            {
                throw new InvalidOperationException(
                    System.Data.Entity.Strings.RelatedEnd_CannotSerialize("RelationshipManager")
                );
            }
        ...
        internal void AddRelatedEntitiesToObjectStateManager(bool doAttach)
        {
            if (null != _relationships)
            {
                ...
                try
                {
                    ...
                    {
                        relatedEnd.Include( /*addRelationshipAsUnchanged*/
                            false,
                            doAttach
                        );
                    }
                ...
                finally
                {
                    ...
                    if (doCleanup)
                    {
                        ...
                        Debug.Assert(
                            wrappedOwner.Context != null
                                && wrappedOwner.Context.ObjectStateManager != null,
                        ...
                        Debug.Assert(
                            doAttach == (transManager.IsAttachTracking),
                ...
                foreach (RelatedEnd relatedEnd in Relationships)
                {
                    if (relatedEnd.IsForeignKey)
                    {
                        foreach (IEntityWrapper dependent in relatedEnd.GetWrappedEntities())
                        {
                            ...
                            if (
                                dependentEnd.IsDependentEndOfReferentialConstraint(
                                    checkIdentifying: false
                                )
                            )
                            {
                                Debug.Assert(
                                    dependentEnd is EntityReference,
        ...
        )
        {
            ...
            if (ownerKey.IsTemporary)
            {
                ...
                this.FindNamesOfReferentialConstraintProperties(
                    out propertiesToRetrieve,
        ...
        internal void CheckReferentialConstraintProperties(EntityEntry ownerEntry)
        {
            ...
            if (
                (propertiesToRetrieve != null || propertiesToPropagateExist)
                && _relationships != null
            )
            {
        ...
        )
        {
            ...
            List<AssociationSet> associations = MetadataHelper.GetAssociationsForEntitySet(
                entitySet
            );
            ...
            foreach (AssociationSet association in associations)
            {
                ...
                else
                {
                    ...
                    {
                        if (
                            constraint.ToRole.TypeUsage.EdmType
                        ...
                        if (
                            constraint.FromRole.TypeUsage.EdmType
                            == entitySet.ElementType.GetReferenceType()
                        )
                        {
        ...
        )
        {
            ...
            if (null != _relationships)
            {
                ...
                foreach (RelatedEnd relatedEnd in Relationships)
                {
                    ...
                    relatedEnd.FindRelationshipSet(
                        context,
                        entitySet,
        ...
        )
        {
            ...
            if (null != _relationships)
            {
                foreach (RelatedEnd relatedEnd in Relationships)
                {
                    ...
                    {
                        wrappedEntity.ResetContext(
                            context,
                            relatedEnd.GetTargetEntitySetFromRelationshipSet(),
                            mergeOption
                        );
                    }
                }
