...
namespace System.Data.Objects.ELinq
{
    internal sealed partial class ExpressionConverter
    {
        private sealed partial class MethodCallTranslator : TypedTranslator<MethodCallExpression>
        {
            ...
            {
                private static readonly Dictionary<MethodInfo, string> methodFunctionRenames =
                    GetRenamedMethodFunctions();
                ...
                private static MethodInfo GetStaticMethod<TResult>(Expression<Func<TResult>> lambda)
                {
                    ...
                    Debug.Assert(
                        method.IsStatic
                            && method.IsPublic
                            && (
                                method.DeclaringType == typeof(System.Data.Spatial.DbGeography)
                ...
                private static IEnumerable<MethodInfo> GetSupportedMethods()
                {
                    ...
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeography geo) => geo.AsGml()
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeography geo) => geo.AsText()
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeography geo) =>
                            geo.SpatialEquals(default(System.Data.Spatial.DbGeography))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeography geo) =>
                            geo.Disjoint(default(System.Data.Spatial.DbGeography))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeography geo) =>
                            geo.Intersects(default(System.Data.Spatial.DbGeography))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeography geo) => geo.Buffer(default(double))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeography geo) =>
                            geo.Distance(default(System.Data.Spatial.DbGeography))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeography geo) =>
                            geo.Intersection(default(System.Data.Spatial.DbGeography))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeography geo) =>
                            geo.Union(default(System.Data.Spatial.DbGeography))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeography geo) =>
                            geo.Difference(default(System.Data.Spatial.DbGeography))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeography geo) =>
                            geo.SymmetricDifference(default(System.Data.Spatial.DbGeography))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeography geo) => geo.ElementAt(default(int))
                    );
                    yield return GetInstanceMethod(
                    ...
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeometry geo) => geo.AsGml()
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeometry geo) => geo.AsText()
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeometry geo) =>
                            geo.SpatialEquals(default(System.Data.Spatial.DbGeometry))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeometry geo) =>
                            geo.Disjoint(default(System.Data.Spatial.DbGeometry))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeometry geo) =>
                            geo.Intersects(default(System.Data.Spatial.DbGeometry))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeometry geo) =>
                            geo.Touches(default(System.Data.Spatial.DbGeometry))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeometry geo) =>
                            geo.Crosses(default(System.Data.Spatial.DbGeometry))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeometry geo) =>
                            geo.Within(default(System.Data.Spatial.DbGeometry))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeometry geo) =>
                            geo.Contains(default(System.Data.Spatial.DbGeometry))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeometry geo) =>
                            geo.Overlaps(default(System.Data.Spatial.DbGeometry))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeometry geo) =>
                            geo.Relate(default(System.Data.Spatial.DbGeometry), default(string))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeometry geo) => geo.Buffer(default(double))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeometry geo) =>
                            geo.Distance(default(System.Data.Spatial.DbGeometry))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeometry geo) =>
                            geo.Intersection(default(System.Data.Spatial.DbGeometry))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeometry geo) =>
                            geo.Union(default(System.Data.Spatial.DbGeometry))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeometry geo) =>
                            geo.Difference(default(System.Data.Spatial.DbGeometry))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeometry geo) =>
                            geo.SymmetricDifference(default(System.Data.Spatial.DbGeometry))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeometry geo) => geo.ElementAt(default(int))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeometry geo) => geo.PointAt(default(int))
                    );
                    yield return GetInstanceMethod(
                        (System.Data.Spatial.DbGeometry geo) => geo.InteriorRingAt(default(int))
                    );
                }
                ...
                private static Dictionary<MethodInfo, string> GetRenamedMethodFunctions()
                {
                    ...
                    result.Add(
                        GetStaticMethod(
                            () =>
                                System.Data.Spatial.DbGeography.FromGml(
                                    default(string),
                                    default(int)
                                )
                        ),
                    ...
                    result.Add(
                        GetInstanceMethod((System.Data.Spatial.DbGeography geo) => geo.AsBinary()),
                        "AsBinary"
                    );
                    result.Add(
                        GetInstanceMethod((System.Data.Spatial.DbGeography geo) => geo.AsGml()),
                        "AsGml"
                    );
                    result.Add(
                        GetInstanceMethod((System.Data.Spatial.DbGeography geo) => geo.AsText()),
                        "AsText"
                    );
                    result.Add(
                        GetInstanceMethod(
                    ...
                    result.Add(
                        GetStaticMethod(
                            () =>
                                System.Data.Spatial.DbGeometry.FromText(
                                    default(string),
                                    default(int)
                                )
                        ),
                    ...
                    result.Add(
                        GetInstanceMethod((System.Data.Spatial.DbGeometry geo) => geo.AsBinary()),
                        "AsBinary"
                    );
                    result.Add(
                        GetInstanceMethod((System.Data.Spatial.DbGeometry geo) => geo.AsGml()),
                        "AsGml"
                    );
                    result.Add(
                        GetInstanceMethod((System.Data.Spatial.DbGeometry geo) => geo.AsText()),
                        "AsText"
                    );
                    result.Add(
                        GetInstanceMethod(
                ...
                )
                {
                    ...
                    if (method.IsStatic)
                    {
                        Debug.Assert(
                            call.Object == null,
                            "Static method call with instance argument?"
                        );
                    ...
                    else
                    {
                        Debug.Assert(
                            call.Object != null,
                            "Instance method call with no instance argument?"
                        );
