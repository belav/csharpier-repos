...
namespace System.Data.Objects.Internal
{
    ...
    internal sealed class ObjectQueryExecutionPlan
    {
        ...
        )
        {
            ...
            if (connection == null)
            {
                throw EntityUtil.InvalidOperation(
                    System.Data.Entity.Strings.ObjectQuery_InvalidConnection
                );
            }
            ...
            ShaperFactory shaperFactory = ShaperFactory.Create(
                elementType,
                cacheManager,
                entityDefinition.CreateColumnMap(null),
        ...
        internal string ToTraceString()
        {
            ...
            EntityCommandDefinition entityCommandDef =
                this.CommandDefinition as EntityCommandDefinition;
        ...
        internal ObjectResult<TResultType> Execute<TResultType>(
            ObjectContext context,
        ...
        )
        {
            ...
            try
            {
                ...
                EntityCommandDefinition commandDefinition = (EntityCommandDefinition)
                ...
                ShaperFactory<TResultType> shaperFactory =
                    (ShaperFactory<TResultType>)this.ResultShaperFactory;
                Shaper<TResultType> shaper = shaperFactory.Create(
                    storeReader,
                    context,
                    context.MetadataWorkspace,
                    this.MergeOption,
                ...
                return new ObjectResult<TResultType>(
                    shaper,
                    this._singleEntitySet,
                    resultItemEdmType
                );
            }
            catch (Exception)
        ...
        )
        {
            ...
            ObjectQueryExecutionPlan execPlan = ObjectQueryExecutionPlan.Prepare(
                context,
                query,
                typeof(TResultType),
                mergeOption,
                null,
                null,
                System.Data.Common.CommandTrees.ExpressionBuilder.DbExpressionBuilder.AliasGenerator
            );
