...
namespace System.Data.EntityModel.SchemaObjectModel
{
    internal struct XmlSchemaResource
    {
        ...
        {
            Dictionary<string, XmlSchemaResource> schemaResourceMap = new Dictionary<
                string,
                XmlSchemaResource
        ...
        /// </summary>
        /// <param name="schemaResourceMap">The XmlNamespace to XmlSchemaResource map to add entries
        // to.</param>
        ...
        )
        {
            ...
            XmlSchemaResource ssdlSchema = new XmlSchemaResource(
                XmlConstants.TargetNamespace_1,
            ...
            {
                XmlSchemaResource ssdlSchema2 = new XmlSchemaResource(
                    XmlConstants.TargetNamespace_2,
            ...
            {
                Debug.Assert(
                    XmlConstants.SchemaVersionLatest == XmlConstants.StoreVersionForV3,
                    "Did you add a new schema version"
                );

                XmlSchemaResource ssdlSchema3 = new XmlSchemaResource(
            ...
            XmlSchemaResource providerManifest = new XmlSchemaResource(
                XmlConstants.ProviderManifestNamespace,
        ...
        {
            XmlSchemaResource msl1 = new XmlSchemaResource(
                StorageMslConstructs.NamespaceUriV1,
                StorageMslConstructs.ResourceXsdNameV1
            );
            schemaResourceMap.Add(msl1.NamespaceUri, msl1);

            if (schemaVersion >= XmlConstants.EdmVersionForV2)
            {
                XmlSchemaResource msl2 = new XmlSchemaResource(
                    StorageMslConstructs.NamespaceUriV2,
                    StorageMslConstructs.ResourceXsdNameV2
                );
            ...
            if (schemaVersion >= XmlConstants.EdmVersionForV3)
            {
                ...
                XmlSchemaResource msl3 = new XmlSchemaResource(
                    StorageMslConstructs.NamespaceUriV3,
                    StorageMslConstructs.ResourceXsdNameV3
                );
        ...
        )
        {
            ...
            XmlSchemaResource csdlSchema_1 = new XmlSchemaResource(
                XmlConstants.ModelNamespace_1,
                "System.Data.Resources.CSDLSchema_1.xsd",
                csdlImports
            );
            schemaResourceMap.Add(csdlSchema_1.NamespaceUri, csdlSchema_1);

            XmlSchemaResource csdlSchema_1_1 = new XmlSchemaResource(
                XmlConstants.ModelNamespace_1_1,
            ...
            if (schemaVersion >= XmlConstants.EdmVersionForV2)
            {
                XmlSchemaResource csdlSchema_2 = new XmlSchemaResource(
                    XmlConstants.ModelNamespace_2,
            ...
            if (schemaVersion >= XmlConstants.EdmVersionForV3)
            {
                ...
                XmlSchemaResource csdlSchema_3 = new XmlSchemaResource(
                    XmlConstants.ModelNamespace_3,
