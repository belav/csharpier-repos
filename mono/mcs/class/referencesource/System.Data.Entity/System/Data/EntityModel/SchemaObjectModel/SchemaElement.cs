...
namespace System.Data.EntityModel.SchemaObjectModel
{
    ...
    internal abstract class SchemaElement
    {
        ...
        internal SchemaElement ParentElement
        {
            ...
            private set { _parentElement = value; }
        }
        ...
        internal void Parse(XmlReader reader)
        {
            ...
            for (
                bool more = reader.MoveToFirstAttribute();
                more;
                more = reader.MoveToNextAttribute()
            )
            {
        ...
        internal SchemaElement(SchemaElement parentElement)
        {
            if (parentElement != null)
            {
                ...
                for (
                    SchemaElement element = parentElement;
                    element != null;
        ...
        protected ReturnValue<string> HandleDottedNameAttribute(
            XmlReader reader,
            string field,
            Func<object, string> errorFormat
        )
        {
        ...
        private void ParseAttribute(XmlReader reader)
        {
            ...
            if (
                attributeNamespace == XmlConstants.AnnotationNamespace
            ...
            else if (!Schema.IsParseableXmlNamespace(attributeNamespace, true))
            {
                ...
                !ProhibitAttribute(attributeNamespace, reader.LocalName) && HandleAttribute(reader)
            )
            {
                return;
            }
            ...
            )
            {
                ...
                )
                {
                    AddError(
                        ...
                        EdmSchemaErrorSeverity.Error,
                        reader,
                        System.Data.Entity.Strings.UnexpectedXmlAttribute(reader.Name)
                    );
                }
            }
        }
        ...
        private bool AddOtherContent(XmlReader reader)
        {
            ...
            {
                if (
                    this._schema.SchemaVersion == XmlConstants.EdmVersionForV1
                ...
                if (
                    this._schema.SchemaVersion >= XmlConstants.EdmVersionForV2
                ...
                )
                {
                    ...
                    AddError(
                        ...
                        lineNumber,
                        linePosition,
                        Strings.NoCodeGenNamespaceInStructuralAnnotation(
            ...
            else
            {
                AddError(
                    ...
                    lineNumber,
                    linePosition,
                    Strings.DuplicateAnnotation(property.Identity, this.FQName)
                );
            }
            return false;
        }
        ...
        private bool ParseElement(XmlReader reader)
        {
            ...
            if (
                !Schema.IsParseableXmlNamespace(elementNamespace, true)
            ...
            else
            {
                ...
                )
                {
                    AddError(
                        ...
                        EdmSchemaErrorSeverity.Error,
                        reader,
                        System.Data.Entity.Strings.UnexpectedXmlElement(reader.Name)
                    );
                }
                return true;
            }
        ...
        {
            return reader.NamespaceURI == Schema.SchemaXmlNamespace
        ...
        private void ParseText(XmlReader reader)
        {
            ...
            else
            {
                AddError(
                    ...
                    EdmSchemaErrorSeverity.Error,
                    reader,
                    System.Data.Entity.Strings.TextNotAllowed(reader.Value)
                );
            }
        }
        #endregion
        ...
        internal static void AssertReaderConsidersSchemaInvalid(XmlReader reader)
        {
            Debug.Assert(
                reader.SchemaInfo == null
                    || reader.SchemaInfo.Validity != System.Xml.Schema.XmlSchemaValidity.Valid,
