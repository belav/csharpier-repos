    ...
    internal static class SpatialExceptions
    {
        ...
        internal static Exception ProviderValueNotCompatibleWithSpatialServices()
        {
            ...
            return EntityUtil.Argument(
                System.Data.Entity.Strings.Spatial_ProviderValueNotCompatibleWithSpatialServices,
                "providerValue"
            );
        }
        ...
        internal static Exception GeographyValueNotCompatibleWithSpatialServices(
            string argumentName
        )
        {
            //
            return EntityUtil.Argument(
                System.Data.Entity.Strings.Spatial_GeographyValueNotCompatibleWithSpatialServices,
                argumentName
            );
        }
        ...
        internal static Exception WellKnownGeographyValueNotValid(string argumentName)
        {
            //
            return EntityUtil.Argument(
                System.Data.Entity.Strings.Spatial_WellKnownGeographyValueNotValid,
                argumentName
            );
        }
        ...
        internal static Exception CouldNotCreateWellKnownGeographyValueNoWkbOrWkt(
            string argumentName
        )
        {
            //
        ...
        internal static Exception GeometryValueNotCompatibleWithSpatialServices(string argumentName)
        {
            //
            return EntityUtil.Argument(
                System.Data.Entity.Strings.Spatial_GeometryValueNotCompatibleWithSpatialServices,
                argumentName
            );
        }
        ...
        internal static Exception WellKnownGeometryValueNotValid(string argumentName)
        {
            ...
            throw EntityUtil.Argument(
                System.Data.Entity.Strings.Spatial_WellKnownGeometryValueNotValid,
                argumentName
            );
        }
        ...
        internal static Exception CouldNotCreateWellKnownGeometryValueNoWkbOrWkt(
            String argumentName
        )
        {
            //
