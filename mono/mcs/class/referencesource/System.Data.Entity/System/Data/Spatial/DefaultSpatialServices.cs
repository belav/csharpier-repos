...
namespace System.Data.Spatial
{
    ...
    internal sealed class DefaultSpatialServices : DbSpatialServices
    {
        ...
        private sealed class ReadOnlySpatialValues
        {
            ...
            {
                return (this.wkb == null ? null : (byte[])this.wkb.Clone());
            }
        ...
        private static ReadOnlySpatialValues CheckCompatible(DbGeography geographyValue)
        {
            Debug.Assert(
                geographyValue != null,
                "Validate geographyValue is non-null before calling CheckCompatible"
            );
            if (geographyValue != null)
            {
                ReadOnlySpatialValues expectedValue =
                    geographyValue.ProviderValue as ReadOnlySpatialValues;
                if (expectedValue != null)
                {
                    return expectedValue;
                }
            }
            throw SpatialExceptions.GeographyValueNotCompatibleWithSpatialServices(
                "geographyValue"
            );
        }
        ...
        private static ReadOnlySpatialValues CheckCompatible(DbGeometry geometryValue)
        {
            Debug.Assert(
                geometryValue != null,
                "Validate geometryValue is non-null before calling CheckCompatible"
            );
            if (geometryValue != null)
            {
                ReadOnlySpatialValues expectedValue =
                    geometryValue.ProviderValue as ReadOnlySpatialValues;
                if (expectedValue != null)
                {
                    return expectedValue;
                }
