...
namespace System.Data.Spatial
{
    ...
    {
        /// <summary>
        /// When implemented in derived types, reads an instance of <see cref="DbGeography"/> from the
        // column at the specified column ordinal.
        /// </summary>
        ...
        /// <summary>
        /// When implemented in derived types, reads an instance of <see cref="DbGeometry"/> from the column
        // at the specified column ordinal.
        /// </summary>
        /// <param name="ordinal">The ordinal of the data record column that contains the provider-specific
        // geometry data</param>
