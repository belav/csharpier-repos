...
namespace System.Data.Mapping
{
    ...
    internal class ObjectTypeMapping : Map
    {
        ...
        {
            Debug.Assert(
                clrType.BuiltInTypeKind == cdmType.BuiltInTypeKind,
                "BuiltInTypeKind must be the same for both types"
            );
            ...
            {
                m_memberMapping = new Dictionary<string, ObjectMemberMapping>(
                    ((StructuralType)cdmType).Members.Count
                );
            }
            else
            {
        ...
        {
            ObjectMemberMapping memberMapping = GetMemberMap(
                propertyName,
                false /*ignoreCase*/
            );
        ...
        internal void AddMemberMap(ObjectMemberMapping memberMapping)
        {
            ...
            Debug.Assert(
                !Type.ReferenceEquals(m_memberMapping, EmptyMemberMapping),
