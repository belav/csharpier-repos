...
namespace System.Data.Mapping.ViewGeneration.CqlGeneration
{
    ...
    internal sealed class CaseCqlBlock : CqlBlock
    {
        ...
        internal CaseCqlBlock(
            ...
            : base(
                slots,
                new List<CqlBlock>(new CqlBlock[] { child }),
                whereClause,
                identifiers,
                blockAliasNum
            )
        ...
        )
        {
            ...
            Debug.Assert(
                m_caseSlotInfo.OutputMember != null,
                "We only construct member slots, not boolean slots."
            );
            ...
            if (
                false
                == BoolExpression.EqualityComparer.Equals(this.WhereClause, BoolExpression.True)
            )
            {
                StringUtil.IndentNewLine(builder, indentLevel);
        ...
        internal override DbExpression AsCqt(bool isTopLevel)
        {
            Debug.Assert(
                m_caseSlotInfo.OutputMember != null,
                "We only construct real slots not boolean slots"
            );
