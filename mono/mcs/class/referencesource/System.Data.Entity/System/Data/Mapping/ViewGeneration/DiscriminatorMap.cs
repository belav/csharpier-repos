...
namespace System.Data.Mapping.ViewGeneration
{
    ...
    internal class DiscriminatorMap
    {
        ...
        /// </summary>
        internal readonly System.Collections.ObjectModel.ReadOnlyCollection<
        ...
        /// </summary>
        internal readonly System.Collections.ObjectModel.ReadOnlyCollection<
            KeyValuePair<EdmProperty, DbExpression>
        > PropertyMap;
        ...
        /// </summary>
        internal readonly System.Collections.ObjectModel.ReadOnlyCollection<
            KeyValuePair<Query.InternalTrees.RelProperty, DbExpression>
        > RelPropertyMap;
        ...
        )
        {
            ...
            if (
                !ViewSimplifier.TryMatchDiscriminatorPredicate(
                    filterExpression,
                    (equalsExp, discriminatorValue) => discriminatorDomain.Add(discriminatorValue)
                )
            )
            {
                return false;
            ...
            var typeToRelPropertyMap =
                new Dictionary<EntityType, List<Query.InternalTrees.RelProperty>>();
            ...
            typeMap.Add(
                new KeyValuePair<object, EntityType>(discriminatorDomain.Single(), elseType)
            );
            ...
            int uniqueValueCount = discriminatorValues
                .Distinct(TrailingSpaceComparer.Instance)
                .Count();
        ...
        )
        {
            ...
            foreach (Query.InternalTrees.RelProperty relProperty in relPropertyMap.Keys)
            {
                foreach (
                    KeyValuePair<
                        EntityType,
                        List<Query.InternalTrees.RelProperty>
        ...
        )
        {
            ...
            Debug.Assert(
                entityType.Properties.Count == constructor.Arguments.Count,
                "invalid new instance"
            );
            ...
            if (constructor.HasRelatedEntityReferences)
            {
                ...
                {
                    Query.InternalTrees.RelProperty relProperty =
                        new System.Data.Query.InternalTrees.RelProperty(
        ...
        private static bool ExpressionsCompatible(DbExpression x, DbExpression y)
        {
            ...
            switch (x.ExpressionKind)
            {
                ...
                case DbExpressionKind.Ref:
                {
                    ...
                    return (
                        refX.EntitySet.EdmEquals(refY.EntitySet)
