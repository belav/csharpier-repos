...
namespace System.Data.Mapping
{
    ...
    public partial class StorageMappingItemCollection : MappingItemCollection
    {
        ...
        private ConcurrentDictionary<
            Tuple<EntitySetBase, EntityTypeBase, InterestingMembersKind>,
        ...
        )
        {
            ...
            this.m_viewDictionary = new ViewDictionary(
                this,
                out userDefinedQueryViewsDict,
                out userDefinedQueryViewsOfTypeDict
            );

            List<EdmSchemaError> errors = new List<EdmSchemaError>();

            if (
                this.m_edmCollection.EdmVersion != XmlConstants.UndefinedVersion
            ...
            )
            {
                errors.Add(
                    new EdmSchemaError(
                        ...
                        (int)StorageMappingErrorCode.MappingDifferentEdmStoreVersion,
        ...
        {
            get { return this.m_edmCollection; }
        }
        ...
        {
            get { return this.m_mappingVersion; }
        }
        ...
        {
            get { return this.m_storeItemCollection; }
        }
        ...
        internal Dictionary<EntitySetBase, string> GenerateEntitySetViews(
            out IList<EdmSchemaError> errors
        )
        {
                ...
                if (entityContainerMapping != null)
                {
                        ...
                        errors.Add(
                            new EdmSchemaError(
                                Strings.Mapping_AllQueryViewAtCompileTime(
                                    entityContainerMapping.Identity
                                ),
                    ...
                    else
                    {
                        ViewGenResults viewGenResults = ViewgenGatekeeper.GenerateViewsFromMapping(
                            ...
                            new ConfigViewGenerator() { GenerateEsql = true }
                        );
                        if (viewGenResults.HasErrors)
                        {
                            ((List<EdmSchemaError>)errors).AddRange(viewGenResults.Errors);
                        }
                        KeyToListMap<EntitySetBase, GeneratedView> extentMappingViews =
                            viewGenResults.Views;
                        foreach (
                            KeyValuePair<
                                EntitySetBase,
                                List<GeneratedView>
                            > extentViewPair in extentMappingViews.KeyValuePairs
                        )
                        {
        ...
        )
        {
            ...
            var key = new Tuple<EntitySetBase, EntityTypeBase, InterestingMembersKind>(
                entitySet,
                entityType,
                interestingMembersKind
            );
            return _cachedInterestingMembers.GetOrAdd(
                key,
                FindInterestingMembers(entitySet, entityType, interestingMembersKind)
            );
        }
        ...
        )
        {
            ...
            foreach (
                var storageTypeMapping in MappingMetadataHelper.GetMappingsForEntitySetAndSuperTypes(
                    this,
            ...
            )
            {
                StorageAssociationTypeMapping associationTypeMapping =
                    storageTypeMapping as StorageAssociationTypeMapping;
                if (associationTypeMapping != null)
                {
                    FindInterestingAssociationMappingMembers(
                ...
                {
                    Debug.Assert(
                        storageTypeMapping is StorageEntityTypeMapping,
                        "StorageEntityTypeMapping expected."
                    );

                    FindInterestingEntityMappingMembers(
                        (StorageEntityTypeMapping)storageTypeMapping,
                        interestingMembersKind,
                        interestingMembers
                    );
                }
            ...
            foreach (
                var functionMappings in MappingMetadataHelper
                    .GetModificationFunctionMappingsForEntitySetAndType(
                        this,
                        entitySet.EntityContainer,
                        entitySet,
                        entityType
            ...
            {
                FindInterestingFunctionMappingMembers(
                    functionMappings,
                    interestingMembersKind,
                    ref interestingMembers
                );
            }
        ...
        )
        {
            ...
            interestingMembers.AddRange(
                associationTypeMapping
                    .MappingFragments.SelectMany(m => m.AllProperties)
        ...
        )
        {
            ...
            foreach (
                var propertyMapping in entityTypeMapping.MappingFragments.SelectMany(mf =>
                    mf.AllProperties
                )
            )
            {
                ...
                StorageComplexPropertyMapping complexPropMapping =
                    propertyMapping as StorageComplexPropertyMapping;
                StorageConditionPropertyMapping conditionMapping =
                    propertyMapping as StorageConditionPropertyMapping;

                Debug.Assert(
                    !(propertyMapping is StorageEndPropertyMapping),
                    "association mapping properties should be handled elsewhere."
                );
                ...
                Debug.Assert(
                    ...
                    "Unimplemented property mapping"
                );
                ...
                if (scalarPropMapping != null && scalarPropMapping.EdmProperty != null)
                {
                    ...
                    //(3) if a scalar property has Fixed concurrency mode then it is "interesting"
                        ...
                        MetadataHelper.GetConcurrencyMode(scalarPropMapping.EdmProperty)
                ...
                else if (complexPropMapping != null)
                {
                    ...
                    if (
                        interestingMembersKind == InterestingMembersKind.PartialUpdate
        ...
        private static bool HasFixedConcurrencyModeInAnyChildProperty(
            StorageComplexPropertyMapping complexMapping
        )
        {
            ...
            )
            {
                StorageScalarPropertyMapping childScalarPropertyMapping =
                    propertyMapping as StorageScalarPropertyMapping;
                StorageComplexPropertyMapping childComplexPropertyMapping =
                    propertyMapping as StorageComplexPropertyMapping;

                Debug.Assert(
                    childScalarPropertyMapping != null || childComplexPropertyMapping != null,
                    "Unimplemented property mapping for complex property"
                );

                //scalar property and has Fixed CC mode
                if (
                    childScalarPropertyMapping != null
                    && MetadataHelper.GetConcurrencyMode(childScalarPropertyMapping.EdmProperty)
                        == ConcurrencyMode.Fixed
                )
                {
                    return true;
                ...
                // Complex Prop and sub-properties or itself has fixed CC mode
                    ...
                    childComplexPropertyMapping != null
                    && (
        ...
        /// <param name="interestingMembers">The list the interesting members (if any) will be added to. Must not be null.</param>
        private void FindForeignKeyProperties(
            ...
            if (entitySet != null && entitySet.HasForeignKeyRelationships)
            {
                ...
                interestingMembers.AddRange(
                    MetadataHelper
                        ...
                        .Where(p =>
                            entitySet
                                .ForeignKeyDependents.SelectMany(fk => fk.Item2.ToProperties)
                                .Contains(p)
                        )
                );
            }
        ...
        private static void FindInterestingFunctionMappingMembers(
            StorageEntityTypeModificationFunctionMapping functionMappings,
            InterestingMembersKind interestingMembersKind,
        ...
        )
        {
            ...
            if (interestingMembersKind == InterestingMembersKind.PartialUpdate)
            {
                ...
                interestingMembers.AddRange(
                    functionMappings.UpdateFunctionMapping.ParameterBindings.Select(p =>
                        p.MemberPath.Members.Last()
                    )
                );
            }
            else
        ...
        private void AddInternal(Map storageMap)
        {
            ...
            {
                throw new MappingException(
                    System.Data.Entity.Strings.Mapping_Duplicate_Type(storageMap.EdmItem.Identity),
                    e
                );
            }
        }
        ...
        internal bool ContainsStorageEntityContainer(string storageEntityContainerName)
        {
            ...
            return entityContainerMaps.Any(map =>
        ...
        )
        {
            ...
            foreach (XmlReader xmlReader in xmlReaders)
            {
                ...
                if (
                    MetadataHelper.CheckIfAllErrorsAreWarnings(errors)
            ...
            foreach (StorageSetMapping setMapping in entityContainerMapping.AllSetMaps)
            {
                if (setMapping.QueryView != null)
                {
                    ...
                    if (!userDefinedQueryViewsDict.TryGetValue(setMapping.Set, out generatedView))
                    {
                        ...
                        if (
                            GeneratedView.TryParseUserSpecifiedView(
                                setMapping,
        ...
        )
        {
            ...
            if (
                expectedVersion != XmlConstants.UndefinedVersion
            ...
            )
            {
                ...
                errors.Add(
                    new EdmSchemaError(
                        ...
                        (int)StorageMappingErrorCode.MappingDifferentMappingEdmStoreVersion,
                        EdmSchemaErrorSeverity.Error
                    )
                );
            }
            if (
                currentLoaderVersion != m_mappingVersion
                && currentLoaderVersion != XmlConstants.UndefinedVersion
            )
            {
                ...
                errors.Add(
                    new EdmSchemaError(
                        ...
                        (int)
                            StorageMappingErrorCode.CannotLoadDifferentVersionOfSchemaInTheSameItemCollection,
                        EdmSchemaErrorSeverity.Error
                    )
                );
            }
                ...
                if (storeItemCollection.Contains(item.Identity))
                {
                    errorCollection.Add(
                        new EdmSchemaError(
                            ...
                            (int)
                                StorageMappingErrorCode.ItemWithSameNameExistsBothInCSpaceAndSSpace,
                            EdmSchemaErrorSeverity.Error
                        )
                    );
                }
