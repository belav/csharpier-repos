...
namespace System.Data.Metadata.Edm
{
    ...
    {
        protected const BindingFlags PropertyReflectionBindingFlags =
        ...
        )
        {
            ...
            {
                sessionData.ObjectItemAssemblyLoaderFactory =
                    ObjectItemConventionAssemblyLoader.Create;
                return new ObjectItemCachedAssemblyLoader(assembly, cacheEntry, sessionData);
            }
            else if (sessionData.ObjectItemAssemblyLoaderFactory == null)
            {
                if (ObjectItemAttributeAssemblyLoader.IsSchemaAttributePresent(assembly))
                {
                    ...
                    ObjectItemConventionAssemblyLoader.SessionContainsConventionParameters(
                        sessionData
                    )
                )
                {
        ...
        internal static bool IsAttributeLoader(object loaderCookie)
        {
            ...
            return IsAttributeLoader(
                loaderCookie
                    as Func<Assembly, ObjectItemLoadingSessionData, ObjectItemAssemblyLoader>
            );
        }
