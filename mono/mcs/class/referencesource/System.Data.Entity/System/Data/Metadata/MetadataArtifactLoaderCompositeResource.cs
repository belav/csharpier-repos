...
namespace System.Data.Metadata.Edm
{
    ...
    internal class MetadataArtifactLoaderCompositeResource : MetadataArtifactLoader
    {
        ...
        )
        {
            ...
            _children = LoadResources(assemblyName, resourceName, uriRegistry, resolver)
                .AsReadOnly();
        }
        ...
        )
        {
            ...
            List<MetadataArtifactLoaderResource> loaders =
                new List<MetadataArtifactLoaderResource>();
        ...
        )
        {
            ...
            {
                loaders.Add(
                    new MetadataArtifactLoaderResource(assembly, resourceName, uriRegistry)
                );
            }
        }
        ...
        )
        {
            ...
            createCompositeResLoader =
                (assemblyName != null) && (resourceName == null || assemblyName.Trim() == wildcard);

            ValidateExtension(extensionCheck, validExtension, resourceName);

            if (createCompositeResLoader)
            {
                return new MetadataArtifactLoaderCompositeResource(
                    path,
                    assemblyName,
                    resourceName,
                    uriRegistry,
            ...
            Debug.Assert(
                ...
                "we should not get here is the resourceName is null"
            );
            Assembly assembly = ResolveAssemblyName(assemblyName, resolver);
        ...
        )
        {
            ...
            string[] result = path.Substring(prefixLength)
                .Split(
                    new string[]
                    {
