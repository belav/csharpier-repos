...
namespace System.Data.Metadata.Edm
{
    ...
    public abstract class RelationshipSet : EntitySetBase
    {
        ...
        // EntitySet</param>
        /// <param name="relationshipType">The entity type of the entities that this entity set type
        // contains</param>
        /// <exception cref="System.ArgumentNullException">Thrown if the argument name or entityType is
        // null</exception>
