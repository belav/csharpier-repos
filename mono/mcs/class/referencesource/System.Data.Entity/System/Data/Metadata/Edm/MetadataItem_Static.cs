...
namespace System.Data.Metadata.Edm
{
    ...
    public abstract partial class MetadataItem
    {
        ...
        static MetadataItem()
        {
            ...
            ////////////////////////////////////////////////////////////////////////////////////////////////
            TypeUsage stringTypeUsage = TypeUsage.Create(
                EdmProviderManifest.GetPrimitiveType(PrimitiveTypeKind.String)
            );
            TypeUsage booleanTypeUsage = TypeUsage.Create(
                EdmProviderManifest.GetPrimitiveType(PrimitiveTypeKind.Boolean)
            );
            TypeUsage edmTypeUsage = TypeUsage.Create(
                MetadataItem.GetBuiltInType(BuiltInTypeKind.EdmType)
            );
            TypeUsage typeUsageTypeUsage = TypeUsage.Create(
                MetadataItem.GetBuiltInType(BuiltInTypeKind.TypeUsage)
            );
            TypeUsage complexTypeUsage = TypeUsage.Create(
                MetadataItem.GetBuiltInType(BuiltInTypeKind.ComplexType)
            );
            ...
            AddBuiltInTypeProperties(
                ...
                new EdmProperty[]
                {
                    new EdmProperty(
                        ...
                        TypeUsage.Create(
                            GetBuiltInType(BuiltInTypeKind.MetadataProperty).GetCollectionType()
                        )
                    ),
                    new EdmProperty(
                        EdmConstants.Documentation,
            ...
            AddBuiltInTypeProperties(
                ...
                new EdmProperty[]
                {
                    new EdmProperty(
                        EdmConstants.ToRole,
                        TypeUsage.Create(GetBuiltInType(BuiltInTypeKind.RelationshipEndMember))
                    ),
                    new EdmProperty(
                        EdmConstants.FromRole,
                        TypeUsage.Create(GetBuiltInType(BuiltInTypeKind.RelationshipEndMember))
                    ),
                    new EdmProperty(
            ...
            AddBuiltInTypeProperties(
                ...
                new EdmProperty[]
                {
                    ...
                    new EdmProperty(
                        ...
                        TypeUsage.Create(GetBuiltInType(BuiltInTypeKind.FunctionParameter))
                    ),
                    new EdmProperty(
                        EdmConstants.Parameters,
                        TypeUsage.Create(
