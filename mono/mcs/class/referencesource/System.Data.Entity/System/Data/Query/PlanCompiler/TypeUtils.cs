...
namespace System.Data.Query.PlanCompiler
{
    ...
    sealed internal class TypeUsageEqualityComparer : IEqualityComparer<md.TypeUsage>
    {
        ...
        internal static readonly TypeUsageEqualityComparer Instance =
            new TypeUsageEqualityComparer();

        #region IEqualityComparer<TypeUsage> Members

        public bool Equals(
            System.Data.Metadata.Edm.TypeUsage x,
            System.Data.Metadata.Edm.TypeUsage y
        )
        {
            if (x == null || y == null)
            {
    ...
    internal static class TypeUtils
    {
        ...
        {
            return (
                md.TypeSemantics.IsReferenceType(type)
