...
namespace System.Data.Query.PlanCompiler
{
    internal class TransformationRulesContext : RuleProcessingContext
    {
        ...
        {
            get { return this.m_projectionPruningRequired; }
        }
        ...
        {
            get { return this.m_reapplyNullabilityRules; }
        }
        ...
        internal Node ReMap(Node node, Dictionary<Var, Node> varMap)
        {
            PlanCompiler.Assert(
                node.Op.IsScalarOp,
                "Expected a scalarOp: Found " + Dump.AutoString.ToString(node.Op.OpType)
            );
        ...
        internal bool CanChangeNullSentinelValue
        {
            get
            {
                ...
                var applyAncestors = this.m_relOpAncestors.Where(
                    a => a.Op.OpType == OpType.CrossApply || a.Op.OpType == OpType.OuterApply
                );
                ...
                {
                    if (
                        !this.m_relOpAncestors.Contains(applyAncestor.Child1)
        ...
        internal Dictionary<Var, Node> GetVarMap(
            Node varDefListNode,
        ...
        internal static bool TryGetInt32Var(IEnumerable<Var> varList, out Var int32Var)
        {
            foreach (Var v in varList)
            {
                ...
                if (
                    System.Data.Common.TypeHelpers.TryGetPrimitiveTypeKind(v.Type, out typeKind)
                    && typeKind == System.Data.Metadata.Edm.PrimitiveTypeKind.Int32
                )
                {
                    int32Var = v;
                    return true;
        ...
        internal override void PostProcessSubTree(Node subtree)
        {
            ...
            {
                PlanCompiler.Assert(
                    m_relOpAncestors.Count != 0,
                    "The RelOp ancestors stack is empty when post processing a RelOp subtree"
                );
                Node poppedNode = m_relOpAncestors.Pop();
                PlanCompiler.Assert(
                    Object.ReferenceEquals(subtree, poppedNode),
                    "The popped ancestor is not equal to the root of the subtree being post processed"
                );
            }
        }
        ...
        internal override void PostProcess(Node n, InternalTrees.Rule rule)
        {
            if (rule != null)
            {
...
#endif
                if (
                    !this.m_projectionPruningRequired
                ...
                if (
                    ...
                    && TransformationRules.RulesRequiringNullabilityRulesToBeReapplied.Contains(
                        rule
                    )
                )
                {
    ...
    internal static class TransformationRules
    {
        ...
        internal static readonly ReadOnlyCollection<
            ReadOnlyCollection<InternalTrees.Rule>
        ...
        /// </summary>
        internal static readonly HashSet<InternalTrees.Rule> RulesRequiringProjectionPruning =
        ...
        /// </summary>
        internal static readonly HashSet<InternalTrees.Rule> RulesRequiringNullabilityRulesToBeReapplied =
        ...
        private static ReadOnlyCollection<
            ReadOnlyCollection<InternalTrees.Rule>
        > BuildLookupTableForRules(IEnumerable<InternalTrees.Rule> rules)
        {
            ReadOnlyCollection<InternalTrees.Rule> NoRules =
                new ReadOnlyCollection<InternalTrees.Rule>(new InternalTrees.Rule[0]);

            List<InternalTrees.Rule>[] lookupTable = new List<InternalTrees.Rule>[
            ...
            ReadOnlyCollection<InternalTrees.Rule>[] rulesPerType =
                new ReadOnlyCollection<InternalTrees.Rule>[lookupTable.Length];
            for (int i = 0; i < lookupTable.Length; ++i)
            {
                if (null != lookupTable[i])
                {
                    rulesPerType[i] = new ReadOnlyCollection<InternalTrees.Rule>(
        ...
        {
            HashSet<InternalTrees.Rule> rulesRequiringProjectionPruning =
                new HashSet<InternalTrees.Rule>();
        ...
        {
            HashSet<InternalTrees.Rule> rulesRequiringNullabilityRulesToBeReapplied =
                new HashSet<InternalTrees.Rule>();

            rulesRequiringNullabilityRulesToBeReapplied.Add(
        ...
        private static bool Process(
            PlanCompiler compilerState,
            ReadOnlyCollection<ReadOnlyCollection<InternalTrees.Rule>> rulesTable,
        ...
        )
        {
            ...
            compilerState.Command.Root = ruleProcessor.ApplyRulesToSubtree(
                context,
                rulesTable,
                compilerState.Command.Root
            );
    ...
    internal static class ScalarOpRules
    {
        ...
        private static bool ProcessSimplifyCase_Collapse(
            CaseOp caseOp,
            Node caseOpNode,
            out Node newNode
        )
        ...
        internal static readonly PatternMatchRule Rule_EqualsOverConstant = new PatternMatchRule(
            new Node(
        ...
        )
        {
            newNode = node;
            PlanCompiler.Assert(
                node.Op.OpType == OpType.EQ || node.Op.OpType == OpType.NE,
            ...
            bool result =
                (node.Op.OpType == OpType.EQ) ? (bool)comparisonStatus : !((bool)comparisonStatus);
        ...
        internal static readonly PatternMatchRule Rule_LikeOverConstants = new PatternMatchRule(
            new Node(
                LikeOp.Pattern,
                new Node(InternalConstantOp.Pattern),
                new Node(InternalConstantOp.Pattern),
        ...
        internal static readonly PatternMatchRule Rule_AndOverConstantPred1 = new PatternMatchRule(
            new Node(
        ...
        internal static readonly PatternMatchRule Rule_AndOverConstantPred2 = new PatternMatchRule(
            new Node(
                ConditionalOp.PatternAnd,
                new Node(ConstantPredicateOp.Pattern),
                new Node(LeafOp.Pattern)
        ...
        internal static readonly PatternMatchRule Rule_OrOverConstantPred1 = new PatternMatchRule(
            new Node(
        ...
        internal static readonly PatternMatchRule Rule_OrOverConstantPred2 = new PatternMatchRule(
            new Node(
                ConditionalOp.PatternOr,
                new Node(ConstantPredicateOp.Pattern),
                new Node(LeafOp.Pattern)
        ...
        internal static readonly PatternMatchRule Rule_NotOverConstantPred = new PatternMatchRule(
            new Node(ConditionalOp.PatternNot, new Node(ConstantPredicateOp.Pattern)),
        ...
        #region IsNull Rules
        internal static readonly PatternMatchRule Rule_IsNullOverConstant = new PatternMatchRule(
            new Node(ConditionalOp.PatternIsNull, new Node(InternalConstantOp.Pattern)),
            ProcessIsNullOverConstant
        );
        internal static readonly PatternMatchRule Rule_IsNullOverNullSentinel =
            new PatternMatchRule(
                new Node(ConditionalOp.PatternIsNull, new Node(NullSentinelOp.Pattern)),
                ProcessIsNullOverConstant
            );
        ...
        internal static readonly PatternMatchRule Rule_IsNullOverNull = new PatternMatchRule(
            new Node(ConditionalOp.PatternIsNull, new Node(NullOp.Pattern)),
        ...
        internal static readonly PatternMatchRule Rule_NullCast = new PatternMatchRule(
            new Node(CastOp.Pattern, new Node(NullOp.Pattern)),
            ProcessNullCast
        );
        ...
        internal static readonly PatternMatchRule Rule_IsNullOverVarRef = new PatternMatchRule(
            new Node(ConditionalOp.PatternIsNull, new Node(VarRefOp.Pattern)),
    ...
    internal static class FilterOpRules
    {
        ...
        private static Node GetPushdownPredicate(
            Command command,
            Node filterNode,
            VarVec columns,
            out Node nonPushdownPredicateNode
        )
        {
        ...
        internal static readonly PatternMatchRule Rule_FilterOverFilter = new PatternMatchRule(
            new Node(
                FilterOp.Pattern,
                new Node(FilterOp.Pattern, new Node(LeafOp.Pattern), new Node(LeafOp.Pattern)),
                new Node(LeafOp.Pattern)
            ),
        ...
        internal static readonly PatternMatchRule Rule_FilterOverProject = new PatternMatchRule(
            new Node(
                FilterOp.Pattern,
                new Node(ProjectOp.Pattern, new Node(LeafOp.Pattern), new Node(LeafOp.Pattern)),
                new Node(LeafOp.Pattern)
            ),
        ...
        internal static readonly PatternMatchRule Rule_FilterOverUnionAll = new PatternMatchRule(
            new Node(
                FilterOp.Pattern,
                new Node(UnionAllOp.Pattern, new Node(LeafOp.Pattern), new Node(LeafOp.Pattern)),
                new Node(LeafOp.Pattern)
            ),
            ProcessFilterOverSetOp
        );
        internal static readonly PatternMatchRule Rule_FilterOverIntersect = new PatternMatchRule(
            new Node(
                FilterOp.Pattern,
                new Node(IntersectOp.Pattern, new Node(LeafOp.Pattern), new Node(LeafOp.Pattern)),
                new Node(LeafOp.Pattern)
            ),
            ProcessFilterOverSetOp
        );
        internal static readonly PatternMatchRule Rule_FilterOverExcept = new PatternMatchRule(
            new Node(
                FilterOp.Pattern,
                new Node(ExceptOp.Pattern, new Node(LeafOp.Pattern), new Node(LeafOp.Pattern)),
                new Node(LeafOp.Pattern)
            ),
            ProcessFilterOverSetOp
        );
        ...
        )
        {
            ...
            Node pushdownPredicate = GetPushdownPredicate(
                trc.Command,
                filterNode,
                null,
        ...
        internal static readonly PatternMatchRule Rule_FilterOverDistinct = new PatternMatchRule(
            new Node(
                FilterOp.Pattern,
                new Node(DistinctOp.Pattern, new Node(LeafOp.Pattern)),
                new Node(LeafOp.Pattern)
            ),
        ...
        )
        {
            ...
            Node pushdownFilterNode = context.Command.CreateNode(
                context.Command.CreateFilterOp(),
                distinctNode.Child0,
                pushdownPredicate
            );
        ...
        internal static readonly PatternMatchRule Rule_FilterOverGroupBy = new PatternMatchRule(
            new Node(
                FilterOp.Pattern,
                new Node(
                    GroupByOp.Pattern,
        ...
        internal static readonly PatternMatchRule Rule_FilterOverCrossJoin = new PatternMatchRule(
            new Node(
                FilterOp.Pattern,
                new Node(CrossJoinOp.Pattern, new Node(LeafOp.Pattern), new Node(LeafOp.Pattern)),
                new Node(LeafOp.Pattern)
            ),
            ProcessFilterOverJoin
        );
        internal static readonly PatternMatchRule Rule_FilterOverInnerJoin = new PatternMatchRule(
            new Node(
                FilterOp.Pattern,
                new Node(
                    InnerJoinOp.Pattern,
        ...
        )
        {
            ...
            {
                Predicate leftSingleTablePredicates = predicate.GetSingleTablePredicates(
                    leftTableInfo.Definitions,
                    out predicate
                );
            ...
            if (
                (rightInputNode.Op.OpType != OpType.ScanTable)
                && (joinOp.OpType != OpType.LeftOuterJoin)
            )
            {
                Predicate rightSingleTablePredicates = predicate.GetSingleTablePredicates(
                    rightTableNodeInfo.Definitions,
                    out predicate
                );
            ...
            {
                Predicate joinPredicate = predicate.GetJoinPredicates(
                    leftTableInfo.Definitions,
                    rightTableNodeInfo.Definitions,
                    out predicate
                );
            ...
            {
                leftInputNode = command.CreateNode(
                    command.CreateFilterOp(),
                    leftInputNode,
                    leftSingleTablePredicateNode
                );
                needsTransformation = true;
            }
            if (rightSingleTablePredicateNode != null)
            {
                rightInputNode = command.CreateNode(
                    command.CreateFilterOp(),
                    rightInputNode,
                    rightSingleTablePredicateNode
                );
                needsTransformation = true;
            }
            ...
            if (newJoinPredicateNode != null)
            {
                ...
                else
                {
                    ...
                    newJoinPredicateNode = PlanCompilerUtil.CombinePredicates(
                        joinNode.Child2,
            ...
            {
                newJoinNode = command.CreateNode(
                    joinOp,
                    leftInputNode,
                    rightInputNode,
                    newJoinPredicateNode
        ...
        internal static readonly PatternMatchRule Rule_FilterOverOuterApply = new PatternMatchRule(
            new Node(
                FilterOp.Pattern,
                new Node(OuterApplyOp.Pattern, new Node(LeafOp.Pattern), new Node(LeafOp.Pattern)),
                new Node(LeafOp.Pattern)
            ),
        ...
        )
        {
            ...
            if (!predicate.PreservesNulls(rightTableNodeInfo.Definitions, true))
            {
                Node newApplyNode = command.CreateNode(
                    command.CreateCrossApplyOp(),
                    applyNode.Child0,
                    applyRightInputNode
                );
                Node newFilterNode = command.CreateNode(
                    command.CreateFilterOp(),
                    newApplyNode,
                    filterNode.Child1
                );
        ...
        )
        {
            ...
            //
            if (
                n.Child0.Op.OpType == OpType.SingleRowTable
                || (
    ...
    internal static class ProjectOpRules
    {
        ...
        internal static readonly PatternMatchRule Rule_ProjectOverProject = new PatternMatchRule(
            new Node(
                ProjectOp.Pattern,
                new Node(ProjectOp.Pattern, new Node(LeafOp.Pattern), new Node(LeafOp.Pattern)),
                new Node(LeafOp.Pattern)
        ...
        internal static readonly SimpleRule Rule_ProjectOpWithSimpleVarRedefinitions =
            new SimpleRule(OpType.Project, ProcessProjectWithSimpleVarRedefinitions);
        ...
        )
        {
            ...
            Node newVarDefListNode = command.CreateNode(
        ...
        )
        {
            ...
            if (
                ...
                || !TransformationRulesContext.TryGetInt32Var(
                    relOpInputNodeInfo.NonNullableDefinitions,
                    out inputSentinel
                )
            )
            {
                ...
                if (
                    ...
                    || !TransformationRulesContext.TryGetInt32Var(
                        n.Child1.Children
                            .Where(
                                child =>
                                    child.Child0.Op.OpType == OpType.Constant
                                    || child.Child0.Op.OpType == OpType.InternalConstant
                            )
                            .Select(child => ((VarDefOp)(child.Op)).Var),
                        out inputSentinel
                    )
                )
                {
                    inputSentinel = n.Child1.Children
                        .Where(child => child.Child0.Op.OpType == OpType.NullSentinel)
                        .Select(child => ((VarDefOp)(child.Op)).Var)
                        .FirstOrDefault();
    ...
    internal static class ApplyOpRules
    {
        ...
        internal static readonly PatternMatchRule Rule_CrossApplyOverFilter = new PatternMatchRule(
            new Node(
        ...
        internal static readonly PatternMatchRule Rule_OuterApplyOverFilter = new PatternMatchRule(
            new Node(
                ...
                new Node(
                    ...
                    new Node(
                        ...
                        new Node(
                            ...
                            new Node(VarDefOp.Pattern, new Node(InternalConstantOp.Pattern))
                        )
                    )
                ),
            ...
            new PatternMatchRule(
                new Node(
                    ...
                    new Node(
                        ...
                        new Node(
                            VarDefListOp.Pattern,
                            new Node(VarDefOp.Pattern, new Node(NullSentinelOp.Pattern))
                        )
                    )
                ),
                ProcessOuterApplyOverDummyProjectOverFilter
        ...
        )
        {
            ...
            if (
                ...
                || filterInputNodeInfo.ExternalReferences.Overlaps(
            ...
            if (
                TransformationRulesContext.TryGetInt32Var(
                    filterInputNodeInfo.NonNullableDefinitions,
                    out sentinelVar
                )
            )
            {
            ...
            if (sentinelVar != null)
            {
                ...
                {
                    varDefNode.Child0 = context.Command.CreateNode(
            ...
            // filter predicate acting as the join condition
            //
            Node joinNode = command.CreateNode(
                command.CreateLeftOuterJoinOp(),
                applyNode.Child0,
                joinNodeRightInput,
                filterNode.Child1
            );
        ...
        internal static readonly PatternMatchRule Rule_CrossApplyOverProject = new PatternMatchRule(
            new Node(
                CrossApplyOp.Pattern,
                new Node(LeafOp.Pattern),
                new Node(ProjectOp.Pattern, new Node(LeafOp.Pattern), new Node(LeafOp.Pattern))
        ...
        internal static readonly PatternMatchRule Rule_OuterApplyOverProject = new PatternMatchRule(
            new Node(
                OuterApplyOp.Pattern,
                new Node(LeafOp.Pattern),
                new Node(ProjectOp.Pattern, new Node(LeafOp.Pattern), new Node(LeafOp.Pattern))
        ...
        )
        {
            ...
            TransformationRulesContext trc = (TransformationRulesContext)context;
            ExtendedNodeInfo inputNodeInfo = context.Command.GetExtendedNodeInfo(
                projectNode.Child0
            );
            ...
            {
                PlanCompiler.Assert(
                    varDefNode.Op.OpType == OpType.VarDef,
                ...
                if (varRefOp == null || !projectInputNodeInfo.Definitions.IsSet(varRefOp.Var))
                {
                    ...
                    if (
                        nullSentinelDefinitionOp != null
                        && (
                            (true == nullSentinelDefinitionOp.IsEquivalent(varDefNode.Child0.Op))
                            ||
                    ...
                    {
                        currentDefinition = trc.BuildNullIfExpression(
                            sentinelVar,
                            varDefNode.Child0
                        );
                    }
        ...
        internal static readonly PatternMatchRule Rule_CrossApplyOverAnything =
            new PatternMatchRule(
                new Node(CrossApplyOp.Pattern, new Node(LeafOp.Pattern), new Node(LeafOp.Pattern)),
        ...
        )
        {
            ...
            if (
                applyOp.OpType == OpType.OuterApply
            ...
            //
            if (
                applyRightChildNodeInfo.ExternalReferences.Overlaps(
                    applyLeftChildNodeInfo.Definitions
                )
            )
            {
        ...
        {
            Command command = context.Command;
            ExtendedNodeInfo applyRightChildNodeInfo = command.GetExtendedNodeInfo(
                applyNode.Child1
            );
            ...
            Node elementNode = command.CreateNode(
                command.CreateElementOp(oldVar.Type),
                applyNode.Child1
            );
        ...
        internal class VarDefinitionRemapper : VarRemapper
        {
            ...
            public override void Visit(ScanTableOp op, Node n)
            {
                ...
                {
                    ScanTableOp newScanTableOp = m_command.CreateScanTableOp(
    ...
    internal static class JoinOpRules
    {
        ...
        internal static readonly PatternMatchRule Rule_CrossJoinOverProject1 = new PatternMatchRule(
            new Node(
                CrossJoinOp.Pattern,
                new Node(LeafOp.Pattern),
                new Node(ProjectOp.Pattern, new Node(LeafOp.Pattern), new Node(LeafOp.Pattern))
        ...
        internal static readonly PatternMatchRule Rule_CrossJoinOverProject2 = new PatternMatchRule(
            new Node(
                CrossJoinOp.Pattern,
                new Node(ProjectOp.Pattern, new Node(LeafOp.Pattern), new Node(LeafOp.Pattern)),
                new Node(LeafOp.Pattern)
        ...
        internal static readonly PatternMatchRule Rule_InnerJoinOverProject1 = new PatternMatchRule(
            new Node(
                InnerJoinOp.Pattern,
                new Node(LeafOp.Pattern),
                new Node(ProjectOp.Pattern, new Node(LeafOp.Pattern), new Node(LeafOp.Pattern)),
        ...
        internal static readonly PatternMatchRule Rule_InnerJoinOverProject2 = new PatternMatchRule(
            new Node(
                InnerJoinOp.Pattern,
                new Node(ProjectOp.Pattern, new Node(LeafOp.Pattern), new Node(LeafOp.Pattern)),
                new Node(LeafOp.Pattern),
        ...
        internal static readonly PatternMatchRule Rule_OuterJoinOverProject2 = new PatternMatchRule(
            new Node(
                LeftOuterJoinOp.Pattern,
                new Node(ProjectOp.Pattern, new Node(LeafOp.Pattern), new Node(LeafOp.Pattern)),
                new Node(LeafOp.Pattern),
        ...
        )
        {
            ...
            )
            {
                ...
                if (joinConditionNode != null)
                {
                    ...
                    newJoinNode = context.Command.CreateNode(
                        joinNode.Op,
                        joinNode.Child0.Child0,
                        joinNode.Child1.Child0,
                        joinConditionNode
                    );
                }
                else
                ...
                Node varDefListNode = command.CreateNode(command.CreateVarDefListOp(), varDefNodes);
                newProjectNode = command.CreateNode(newProjectOp, newJoinNode, varDefListNode);
                newNode = newProjectNode;
                return true;
            }
            ...
            ExtendedNodeInfo otherChildInfo = command.GetExtendedNodeInfo(
                joinNode.Children[otherNodeIdx]
            );
            VarVec vec = command.CreateVarVec(projectOp.Outputs);
        ...
        internal static readonly PatternMatchRule Rule_CrossJoinOverFilter1 = new PatternMatchRule(
            new Node(
                CrossJoinOp.Pattern,
                new Node(LeafOp.Pattern),
                new Node(FilterOp.Pattern, new Node(LeafOp.Pattern), new Node(LeafOp.Pattern))
        ...
        internal static readonly PatternMatchRule Rule_CrossJoinOverFilter2 = new PatternMatchRule(
            new Node(
                CrossJoinOp.Pattern,
                new Node(FilterOp.Pattern, new Node(LeafOp.Pattern), new Node(LeafOp.Pattern)),
                new Node(LeafOp.Pattern)
        ...
        internal static readonly PatternMatchRule Rule_InnerJoinOverFilter1 = new PatternMatchRule(
            new Node(
                InnerJoinOp.Pattern,
                new Node(LeafOp.Pattern),
                new Node(FilterOp.Pattern, new Node(LeafOp.Pattern), new Node(LeafOp.Pattern)),
        ...
        internal static readonly PatternMatchRule Rule_InnerJoinOverFilter2 = new PatternMatchRule(
            new Node(
                InnerJoinOp.Pattern,
                new Node(FilterOp.Pattern, new Node(LeafOp.Pattern), new Node(LeafOp.Pattern)),
                new Node(LeafOp.Pattern),
        ...
        internal static readonly PatternMatchRule Rule_OuterJoinOverFilter2 = new PatternMatchRule(
            new Node(
                LeftOuterJoinOp.Pattern,
                new Node(FilterOp.Pattern, new Node(LeafOp.Pattern), new Node(LeafOp.Pattern)),
                new Node(LeafOp.Pattern),
        ...
        )
        {
            ...
            if (
                joinNode.Child1.Op.OpType == OpType.Filter
                && joinNode.Op.OpType != OpType.LeftOuterJoin
            )
            {
    ...
    internal static class SingleRowOpRules
    {
        internal static readonly PatternMatchRule Rule_SingleRowOpOverAnything =
            new PatternMatchRule(
                new Node(SingleRowOp.Pattern, new Node(LeafOp.Pattern)),
        ...
        )
        {
            ...
            TransformationRulesContext trc = (TransformationRulesContext)context;
            ExtendedNodeInfo childNodeInfo = context.Command.GetExtendedNodeInfo(
                singleRowNode.Child0
            );
    ...
    internal static class SetOpRules
    {
        ...
        internal static readonly SimpleRule Rule_UnionAllOverEmptySet = new SimpleRule(
            OpType.UnionAll,
            ProcessSetOpOverEmptySet
        );
        internal static readonly SimpleRule Rule_IntersectOverEmptySet = new SimpleRule(
            OpType.Intersect,
            ProcessSetOpOverEmptySet
        );
        internal static readonly SimpleRule Rule_ExceptOverEmptySet = new SimpleRule(
            OpType.Except,
            ProcessSetOpOverEmptySet
        );
        ...
        {
            bool leftChildIsEmptySet =
                context.Command.GetExtendedNodeInfo(setOpNode.Child0).MaxRows == RowCount.Zero;
            bool rightChildIsEmptySet =
                context.Command.GetExtendedNodeInfo(setOpNode.Child1).MaxRows == RowCount.Zero;
            ...
            SetOp setOp = (SetOp)setOpNode.Op;
            if (
                !rightChildIsEmptySet && setOp.OpType == OpType.UnionAll
    ...
    internal static class GroupByOpRules
    {
        ...
        internal static readonly SimpleRule Rule_GroupByOpWithSimpleVarRedefinitions =
            new SimpleRule(OpType.GroupBy, ProcessGroupByWithSimpleVarRedefinitions);
        ...
        internal static readonly PatternMatchRule Rule_GroupByOverProject = new PatternMatchRule(
            new Node(
                GroupByOp.Pattern,
                new Node(ProjectOp.Pattern, new Node(LeafOp.Pattern), new Node(LeafOp.Pattern)),
                new Node(LeafOp.Pattern),
        ...
        )
        {
            ...
            for (int i = 0; i < projectNodeVarDefList.Children.Count; i++)
            {
                ...
                if (
                    varDefNode.Child0.Op.OpType == OpType.Constant
            ...
            Dictionary<Var, Node> varToDefiningNode = new Dictionary<Var, Node>(
        ...
        internal class VarRefReplacer : BasicOpVisitorOfNode
        {
            ...
            /// <param name="command"></param>
            /// <returns></returns>
            internal static Node Replace(
                Dictionary<Var, Node> varReplacementTable,
                Node root,
                Command command
            )
            {
        ...
        )
        {
            ...
            {
                newNode = command.CreateNode(
                    command.CreateDistinctOp(command.CreateVarVec(op.Keys)),
                    newNode
                );
            }
            return true;
        ...
        internal static readonly SimpleRule Rule_GroupByOpOnAllInputColumnsWithAggregateOperation =
            new SimpleRule(OpType.GroupBy, ProcessGroupByOpOnAllInputColumnsWithAggregateOperation);
        ...
        )
        {
            ...
            if (rootOp == null || rootOp.Outputs.Count > 1)
            {
                return false;
            }
            ...
            Var newVar;
            var varDefListNode = command.CreateVarDefListNode(
                command.CreateNode(command.CreateVarRefOp(groupByOp.Outputs.First)),
                out newVar
            );
            ...
            var filter = command.CreateNode(command.CreateFilterOp(), n.Child0, equality);
            n.Child0 = filter;
    ...
    internal static class SortOpRules
    {
        ...
        )
        {
            ExtendedNodeInfo nodeInfo = (
                (TransformationRulesContext)context
            ).Command.GetExtendedNodeInfo(n.Child0);
