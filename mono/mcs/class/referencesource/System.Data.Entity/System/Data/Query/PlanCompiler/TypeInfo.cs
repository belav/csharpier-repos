...
namespace System.Data.Query.PlanCompiler
{
    ...
    internal class TypeInfo
    {
        ...
        internal bool TryGetNewProperty(
            ...
            bool throwIfMissing,
            out md.EdmProperty newProperty
        )
        {
        ...
        internal IEnumerable<PropertyRef> GetKeyPropertyRefs()
        {
            ...
            {
                // Eventually this could be RelationshipEndMember, but currently only properties are suppported as
                // key members
                PlanCompiler.Assert(
                    p is md.EdmProperty,
                    "Non-EdmProperty key members are not supported"
                );
    ...
    internal class RootTypeInfo : TypeInfo
    {
        ...
        /// <summary>
        /// Determines the offset for structured types in Flattened type. For instance, if the original type
        // is of the form:
        ///
        ///     { int X, ComplexType Y }
        ///
