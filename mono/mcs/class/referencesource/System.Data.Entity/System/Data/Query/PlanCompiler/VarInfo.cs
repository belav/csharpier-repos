...
namespace System.Data.Query.PlanCompiler
{
    ...
    internal class StructuredVarInfo : VarInfo
    {
        ...
        internal StructuredVarInfo(
            md.RowType newType,
            List<Var> newVars,
            List<md.EdmProperty> newTypeProperties,
    ...
    internal class VarInfoMap
    {
        ...
        internal VarInfo CreateStructuredVarInfo(
            ...
            md.RowType newType,
            List<Var> newVars,
            List<md.EdmProperty> newProperties,
            bool newVarsIncludeNullSentinelVar
        )
        {
            VarInfo varInfo = new StructuredVarInfo(
                newType,
                newVars,
                newProperties,
        ...
        internal VarInfo CreatePrimitiveTypeVarInfo(Var v, Var newVar)
        {
            ...
            PlanCompiler.Assert(
                md.TypeSemantics.IsScalarType(v.Type),
                "The current variable should be of primitive or enum type."
            );
            PlanCompiler.Assert(
                md.TypeSemantics.IsScalarType(newVar.Type),
