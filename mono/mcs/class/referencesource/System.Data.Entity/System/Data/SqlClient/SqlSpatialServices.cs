...
namespace System.Data.SqlClient
{
    ...
    internal sealed partial class SqlSpatialServices : DbSpatialServices, ISerializable
    {
        ...
        internal static readonly SqlSpatialServices Instance = new SqlSpatialServices(
            SqlProviderServices.GetSqlTypesAssembly
        );
        ...
        private SqlSpatialServices(Func<SqlTypesAssembly> getSqlTypes)
        {
            Debug.Assert(
                getSqlTypes != null,
                "Validate SqlTypes assembly delegate before constructing SqlSpatialServiceS"
            );
                ...
                lock (Instance)
                {
                    ...
                    )
                    {
                        ...
                        if (SqlTypesAssembly.TryGetSqlTypesAssembly(assembly, out sqlAssembly))
                        {
                            ...
                            {
                                otherSpatialServices = new Dictionary<string, SqlSpatialServices>(
                                    1
                                );
                            }
        ...
        {
            get { return this._sqlTypesAssemblySingleton.Value; }
        }
        ...
        public override DbGeography GeographyFromProviderValue(object providerValue)
        {
            ...
            object normalizedProviderValue = NormalizeProviderValue(
                providerValue,
                this.SqlTypes.SqlGeographyType
            );
            return this.SqlTypes.IsSqlGeographyNull(normalizedProviderValue)
                ? null
                : DbSpatialServices.CreateGeography(this, normalizedProviderValue);
        }
        ...
        {
            Debug.Assert(
                expectedSpatialType == this.SqlTypes.SqlGeographyType
            ...
            if (providerValueType != expectedSpatialType)
            {
                ...
                if (
                    TryGetSpatialServiceFromAssembly(
                        providerValue.GetType().Assembly,
                        out otherServices
                    )
                )
                {
                    if (expectedSpatialType == this.SqlTypes.SqlGeographyType)
                    {
                        ...
                        {
                            return ConvertToSqlValue(
                                otherServices.GeographyFromProviderValue(providerValue),
                                "providerValue"
                            );
                        }
                    }
                    else // expectedSpatialType == this.SqlTypes.SqlGeometryType
                    {
                        ...
                        {
                            return ConvertToSqlValue(
                                otherServices.GeometryFromProviderValue(providerValue),
                                "providerValue"
                            );
                        }
                    }
                ...
                throw SpatialExceptions.SqlSpatialServices_ProviderValueNotSqlType(
                    expectedSpatialType
                );
            }
        ...
        public override DbGeographyWellKnownValue CreateWellKnownValue(DbGeography geographyValue)
        {
            ...
            DbGeographyWellKnownValue result = CreateWellKnownValue(
                spatialValue,
                () =>
                    SpatialExceptions.CouldNotCreateWellKnownGeographyValueNoSrid("geographyValue"),
                () =>
                    SpatialExceptions.CouldNotCreateWellKnownGeographyValueNoWkbOrWkt(
                        "geographyValue"
                    ),
                (srid, wkb, wkt) =>
                    new DbGeographyWellKnownValue()
                    {
        ...
        public override DbGeometry GeometryFromProviderValue(object providerValue)
        {
            ...
            return this.SqlTypes.IsSqlGeometryNull(normalizedProviderValue)
                ? null
                : DbSpatialServices.CreateGeometry(this, normalizedProviderValue);
        }
        ...
        public override DbGeometryWellKnownValue CreateWellKnownValue(DbGeometry geometryValue)
        {
            ...
            DbGeometryWellKnownValue result = CreateWellKnownValue(
                spatialValue,
                () => SpatialExceptions.CouldNotCreateWellKnownGeometryValueNoSrid("geometryValue"),
                () =>
                    SpatialExceptions.CouldNotCreateWellKnownGeometryValueNoWkbOrWkt(
                        "geometryValue"
                    ),
                (srid, wkb, wkt) =>
                    new DbGeometryWellKnownValue()
                    {
                        CoordinateSystemId = srid,
                        WellKnownBinary = wkb,
                        WellKnownText = wkt,
