...
namespace System.Data.EntityClient
{
    ...
    public sealed class EntityConnection : DbConnection
    {
        ...
        private static readonly DbConnectionOptions s_emptyConnectionOptions =
            new DbConnectionOptions(String.Empty, null);
        ...
        public EntityConnection(MetadataWorkspace workspace, DbConnection connection)
        {
            ...
            {
                throw EntityUtil.Argument(
                    System.Data.Entity.Strings.EntityClient_ConnectionMustBeClosed
                );
            }
            ...
            if (DbProviderFactories.GetFactory(connection) == null)
            {
                throw EntityUtil.ProviderIncompatible(
                    System.Data.Entity.Strings.EntityClient_DbConnectionHasNoProvider(connection)
                );
            }

            StoreItemCollection collection = (StoreItemCollection)
        ...
        public override string ConnectionString
        {
            get
            {
                ...
                if (this._userConnectionOptions == null)
                {
                    ...
                    if (
                        !EntityUtil.TryGetProviderInvariantName(
                            DbProviderFactories.GetFactory(_storeConnection),
                            out invariantName
                        )
                    )
                    {
                ...
                if (
                    object.ReferenceEquals(_userConnectionOptions, _effectiveConnectionOptions)
                ...
                )
                {
                    ...
                    //
                    string userStoreConnectionString = this._userConnectionOptions[
                        EntityConnectionStringBuilder.ProviderConnectionStringParameterName
                    ];
                    if (
                        (storeConnectionString != userStoreConnectionString)
                        && !(
                            string.IsNullOrEmpty(storeConnectionString)
                            && string.IsNullOrEmpty(userStoreConnectionString)
                        )
                    )
                    {
                        ...
                        EntityConnectionStringBuilder connectionStringBuilder =
                            new EntityConnectionStringBuilder(userConnectionString);
        ...
        public override string ServerVersion
        {
            get
            {
                ...
                {
                    throw EntityUtil.InvalidOperation(
                        System.Data.Entity.Strings.EntityClient_ConnectionNotOpen
                    );
                }
        ...
        {
            get { return this._storeConnection; }
        }
        ...
        {
            return GetMetadataWorkspace(
                true /* initializeAllCollections */
            );
        }
        ...
        private bool ShouldRecalculateMetadataArtifactLoader(List<MetadataArtifactLoader> loaders)
        {
            if (
                loaders.Any(loader =>
                    loader.GetType() == typeof(MetadataArtifactLoaderCompositeFile)
                )
            )
            {
        ...
        internal MetadataWorkspace GetMetadataWorkspace(bool initializeAllCollections)
        {
            ...
            if (
                ...
                || (
                    ...
                    && !_metadataWorkspace.IsItemCollectionAlreadyRegistered(DataSpace.SSpace)
                )
            )
            {
                ...
                lock (_connectionStringLock)
                {
                    ...
                    if (_metadataWorkspace == null)
                    {
                        ...
                        string paths = _effectiveConnectionOptions[
                            EntityConnectionStringBuilder.MetadataParameterName
                        ];
                        ...
                        if (!string.IsNullOrEmpty(paths))
                        {
                            ...
                            else
                            {
                                ...
                                _artifactLoader = MetadataArtifactLoader.Create(
                                    MetadataCache.SplitPaths(paths)
                                );
                            }
                        }
                        else
                    ...
                    else
                    {
                        edmItemCollection = (EdmItemCollection)
                            _metadataWorkspace.GetItemCollection(DataSpace.CSpace);
                    }
        ...
        internal EntityTransaction CurrentTransaction
        {
            get
            {
                ...
                if (
                    ...
                    && (
                        (null == _currentTransaction.StoreTransaction.Connection)
        ...
        internal bool EnlistedInUserTransaction
        {
            get
            {
                try
                {
                    return _enlistedTransaction != null
        ...
        public override void Open()
        {
            ...
            {
                throw EntityUtil.InvalidOperation(
                    System.Data.Entity.Strings.EntityClient_CannotReopenConnection
                );
            }
        ...
        private void ResetStoreConnection(
            DbConnection newConnection,
            DbConnection originalConnection,
            bool closeOriginalConnection
        )
        {
        ...
        private void ChangeConnectionString(string newConnectionString)
        {
            ...
            {
                userConnectionOptions = new DbConnectionOptions(
                    newConnectionString,
                    EntityConnectionStringBuilder.Synonyms
                );
            }
            ...
            if (!userConnectionOptions.IsEmpty)
            {
                ...
                string namedConnection = userConnectionOptions[
                    EntityConnectionStringBuilder.NameParameterName
                ];
                if (!string.IsNullOrEmpty(namedConnection))
                {
                    ...
                    {
                        throw EntityUtil.Argument(
                            System.Data.Entity.Strings.EntityClient_InvalidNamedConnection
                        );
                    }
                    ...
                    string nestedNamedConnection = effectiveConnectionOptions[
                        EntityConnectionStringBuilder.NameParameterName
                    ];
                ...
                ValidateValueForTheKeyword(
                    effectiveConnectionOptions,
                    EntityConnectionStringBuilder.MetadataParameterName
                );

                string providerName = ValidateValueForTheKeyword(
                    effectiveConnectionOptions,
                    EntityConnectionStringBuilder.ProviderParameterName
                );
                ...
                try
                {
                    ...
                    string providerConnectionString = effectiveConnectionOptions[
                        EntityConnectionStringBuilder.ProviderConnectionStringParameterName
                    ];
        ...
        )
        {
            ...
            {
                throw EntityUtil.Argument(
                    System.Data.Entity.Strings.EntityClient_ConnectionStringMissingInfo(keywordName)
                );
            }
            return keywordValue;
        }
        ...
        )
        {
            ...
            string edmCacheKey = CreateMetadataCacheKey(
                artifactLoader.GetOriginalPaths(DataSpace.CSpace),
                null,
                null
            );
            ...
            object entryToken;
            EdmItemCollection edmItemCollection = MetadataCache.GetOrCreateEdmItemCollection(
                edmCacheKey,
                artifactLoader,
                out entryToken
            );
        ...
        {
            Debug.Assert(
                workspace.IsItemCollectionAlreadyRegistered(DataSpace.CSpace),
            ...
            //
            string providerConnectionString = connectionOptions[
                EntityConnectionStringBuilder.ProviderConnectionStringParameterName
            ];
            ...
            // Build a string as the key and look up the MetadataCache for a match
            string storeCacheKey = CreateMetadataCacheKey(
        ...
        private static string CreateMetadataCacheKey(
            IList<string> paths,
            string providerName,
        ...
        )
        {
            ...
            System.Diagnostics.Debug.Assert(!buildResult || (result.Length == resultCount));
        }
        ...
        private void ValidateChangesPermitted()
        {
            ...
            {
                throw EntityUtil.InvalidOperation(
                    System.Data.Entity.Strings.EntityClient_SettingsCannotBeChangedOnOpenConnection
                );
            }
        }
        ...
        private DbProviderFactory GetFactory(string providerString)
        {
            ...
            {
                throw EntityUtil.Argument(
                    System.Data.Entity.Strings.EntityClient_InvalidStoreProvider,
                    e
                );
            }
        }
