...
namespace System.ServiceModel.Security
{
    ...
    class RelAssertionDirectKeyIdentifierClause : SecurityKeyIdentifierClause
    {
        ...
        public RelAssertionDirectKeyIdentifierClause(
            string assertionId,
        ...
        {
            RelAssertionDirectKeyIdentifierClause that =
                keyIdentifierClause as RelAssertionDirectKeyIdentifierClause;

            // PreSharp Bug: Parameter 'that' to this public method must be validated: A null-dereference can occur here.
#pragma warning suppress 56506
            return (
                ReferenceEquals(this, that)
                || (that != null && that.AssertionId == this.AssertionId)
            );
        }
    }
}
