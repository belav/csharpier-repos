...
namespace System.IdentityModel
{
    ...
    sealed class PreDigestedSignedInfo : SignedInfo
    {
        ...
        sealed class SignedInfoCanonicalFormWriter : CanonicalFormWriter
        {
            ...
            const string xml4WithStrTransform =
            ...
            static readonly SignedInfoCanonicalFormWriter instance =
                new SignedInfoCanonicalFormWriter();
            ...
            )
            {
                DiagnosticUtility.DebugAssert(
                    XmlSignatureStrings.Prefix.Length == 0,
                    "Update SignedInfoCanonicalFormWriter to match new XmlDSig prefix"
                );
                ...
                for (int i = 0; i < referenceCount; i++)
                {
                    ...
                    {
                        stream.Write(
                            this.fragment4StrTransform,
                            0,
                            this.fragment4StrTransform.Length
                        );
                    }
                    else
                    {
