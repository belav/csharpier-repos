...
#pragma warning disable 1591
    public partial class ConfigurationElementInterceptor : ConfigurationElement
    {
        ...
        protected override void DeserializeElement(XmlReader reader, bool serializeCollectionKey)
        {
            ...
            // by the framework.
            using (
                XmlReader newReader = XmlDictionaryReader.CreateTextReader(
                    Encoding.UTF8.GetBytes(elementXml.DocumentElement.OuterXml),
        ...
        // 2. The config system walks up the inheritance chain and finds that it can instantiate the section
        // at the parent level.
        // 3. The config system populates the section with the values from the parent, including setting the
        // custom XML property.
        // 4. Now, the config system tries to instantiage the section at the child level. It creates a brand
        // new instance of the section.
        // 5. The config system takes the parent section as a template and uses it to initialize the child
        // (by calling this Reset method).
        // 6. Then the config system populates the child with values that were overwritten at the child
        // level.
        //
