    ...
    internal class WSTrustFeb2005ConstantsAdapter : WSTrustConstantsAdapter
    {
        ...
        internal class WSTrustFeb2005Actions : WSTrustActions
        {
            internal WSTrustFeb2005Actions()
            {
                ...
                this.RequestSecurityContextToken = WSTrustFeb2005Constants.Actions
                    .RequestSecurityContextToken;
                this.RequestSecurityContextTokenCancel = WSTrustFeb2005Constants.Actions
                    .RequestSecurityContextTokenCancel;
                this.RequestSecurityContextTokenResponse = WSTrustFeb2005Constants.Actions
                    .RequestSecurityContextTokenResponse;
                this.RequestSecurityContextTokenResponseCancel = WSTrustFeb2005Constants.Actions
