...
namespace System.IdentityModel.Protocols.WSTrust
{
    ...
    public class Entropy : ProtectedKey
    {
        ...
        /// </summary>
        /// <param name="entropySizeInBits">The entropySizeInBits of the key material inside the
        // entropy.</param>
        ...
        public Entropy(ProtectedKey protectedKey)
            : base(
                GetKeyBytesFromProtectedKey(protectedKey),
                GetWrappingCredentialsFromProtectedKey(protectedKey)
            ) { }
