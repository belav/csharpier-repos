...
namespace System.IdentityModel.Protocols.WSTrust
{
    ...
    public class WSTrust13RequestSerializer : WSTrustRequestSerializer
    {
        ...
        )
        {
            ...
            return WSTrustSerializationHelper.CreateRequest(
                reader,
                context,
                this,
        ...
        )
        {
            ...
            )
            {
                ...
                {
                    rst.ValidateTarget = new SecurityTokenElement(
                        WSTrustSerializationHelper.ReadInnerXml(reader),
        ...
        )
        {
            ...
            WSTrustSerializationHelper.WriteKnownRequestElement(
                rst,
                writer,
                context,
                this,
        ...
        )
        {
            ...
            WSTrustSerializationHelper.WriteRequest(
                request,
                writer,
                context,
                this,
        ...
        )
        {
            ...
            )
            {
                ...
                foreach (
                    KeyValuePair<string, object> messageParam in secondaryParameters.Properties
                )
                {
                    this.WriteXmlElement(
                        writer,
            ...
            WSTrustSerializationHelper.WriteRSTXml(
                writer,
                elementName,
                elementValue,
                context,
