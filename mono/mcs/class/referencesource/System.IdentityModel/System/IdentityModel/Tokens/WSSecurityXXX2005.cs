...
namespace System.IdentityModel.Tokens
{
    ...
    class WSSecurityXXX2005 : WSSecurityJan2004
    {
        ...
        public override void PopulateStrEntries(IList<StrEntry> strEntries)
        {
            ...
            strEntries.Add(
                new X509ThumbprintStrEntry(this.SecurityTokenSerializer.EmitBspRequiredAttributes)
            );
            strEntries.Add(
                new EncryptedKeyHashStrEntry(this.SecurityTokenSerializer.EmitBspRequiredAttributes)
            );
        }
        ...
        public override void PopulateKeyIdentifierClauseEntries(
            IList<KeyIdentifierClauseEntry> clauseEntries
        )
        {
            List<StrEntry> strEntries = new List<StrEntry>();
            this.SecurityTokenSerializer.PopulateStrEntries(strEntries);
            SecurityTokenReferenceXXX2005ClauseEntry strClause =
                new SecurityTokenReferenceXXX2005ClauseEntry(
        ...
        {
            public SecurityTokenReferenceXXX2005ClauseEntry(
            ...
            protected override string ReadTokenType(XmlDictionaryReader reader)
            {
                return reader.GetAttribute(
                    XD.SecurityXXX2005Dictionary.TokenTypeAttribute,
                ...
                for (int i = 0; i < this.StrEntries.Count; ++i)
                {
                    if (this.StrEntries[i].SupportsCore(keyIdentifierClause))
                    {
                        writer.WriteStartElement(
                            ...
                            XD.SecurityJan2004Dictionary.SecurityTokenReference,
                            XD.SecurityJan2004Dictionary.Namespace
                        );

                        string tokenTypeUri = this.GetTokenTypeUri(
                            this.StrEntries[i],
                            keyIdentifierClause
                        );
            ...
            )
            {
                ...
                if (emitTokenType)
                {
                    ...
                    {
                        tokenTypeUri = (str as LocalReferenceStrEntry).GetLocalTokenTypeUri(
                            keyIdentifierClause
                        );
            ...
            private bool EmitTokenType(StrEntry str)
            {
                ...
                {
                    if ((str is KerberosHashStrEntry) || (str is LocalReferenceStrEntry))
                    {
                        emitTokenType = true;
                    }
                }
        ...
        class EncryptedKeyHashStrEntry : WSSecurityJan2004.KeyIdentifierStrEntry
        {
            ...
            {
                get { return typeof(EncryptedKeyHashIdentifierClause); }
            }
            public override Type TokenType
            {
                get { return typeof(WrappedKeySecurityToken); }
            }
            protected override string ValueTypeUri
            {
                get { return SecurityXXX2005Strings.EncryptedKeyHashValueType; }
            }
            ...
            protected override SecurityKeyIdentifierClause CreateClause(
                byte[] bytes,
        ...
        class X509ThumbprintStrEntry : WSSecurityJan2004.KeyIdentifierStrEntry
        {
            protected override Type ClauseType
            {
                get { return typeof(X509ThumbprintKeyIdentifierClause); }
            }
            public override Type TokenType
            {
            ...
            protected override string ValueTypeUri
            {
                get { return SecurityXXX2005Strings.ThumbprintSha1ValueType; }
            }
        ...
        class SamlDirectStrEntry : StrEntry
        {
            public override bool CanReadClause(XmlDictionaryReader reader, string tokenType)
            {
                ...
                return (
                    reader.IsStartElement(
                        XD.SecurityJan2004Dictionary.Reference,
                        XD.SecurityJan2004Dictionary.Namespace
                    )
                );
            }
            ...
            public override SecurityKeyIdentifierClause ReadClause(
            ...
            )
            {
                ...
                return new SamlAssertionDirectKeyIdentifierClause(
                    samlUri,
                    derivationNone,
                    derivationLength
                );
            ...
            {
                return typeof(SamlAssertionDirectKeyIdentifierClause).IsAssignableFrom(
                    clause.GetType()
                );
            }
            ...
            {
                SamlAssertionDirectKeyIdentifierClause samlClause =
                    clause as SamlAssertionDirectKeyIdentifierClause;
                writer.WriteStartElement(
                    XD.SecurityJan2004Dictionary.Prefix.Value,
                    XD.SecurityJan2004Dictionary.Reference,
                    XD.SecurityJan2004Dictionary.Namespace
                ...
                writer.WriteAttributeString(
                    XD.SecurityJan2004Dictionary.URI,
                    null,
                    samlClause.SamlUri
                );
                writer.WriteEndElement();
