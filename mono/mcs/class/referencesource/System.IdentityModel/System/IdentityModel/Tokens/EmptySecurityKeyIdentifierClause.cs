...
{
    /// <summary>
    /// Represents an empty SecurityKeyClause.  This class is used when an 'encrypted data element' or '
    // signature element' does
    /// not contain a 'key info element' that is used to describe the key required to decrypt the data
    ...
    public class EmptySecurityKeyIdentifierClause : SecurityKeyIdentifierClause
    {
        ...
        /// </summary>
        /// <remarks>This constructor assumes that the user knows how to resolve the key required without
        // any context.</remarks>
        ...
        /// Creates an instance of <see cref="EmptySecurityKeyIdentifierClause"/>
        /// </summary>
        /// <param name="context">Used to provide a hint when there is a need resolve an empty clause to a
        // particular key.
