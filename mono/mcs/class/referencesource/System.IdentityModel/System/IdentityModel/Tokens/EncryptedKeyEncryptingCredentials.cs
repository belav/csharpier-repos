    ...
    public class EncryptedKeyEncryptingCredentials : EncryptingCredentials
    {
        ...
        public EncryptedKeyEncryptingCredentials(X509Certificate2 certificate)
            : this(
                ...
                SecurityAlgorithms.DefaultSymmetricKeyLength,
                SecurityAlgorithms.DefaultEncryptionAlgorithm
            ) { }
        ...
        public EncryptedKeyEncryptingCredentials(
            ...
            : this(
                new X509EncryptingCredentials(certificate, keyWrappingAlgorithm),
                keySizeInBits,
                encryptionAlgorithm
            ) { }
        ...
        )
        {
            ...
            //
            if (
                encryptionAlgorithm == SecurityAlgorithms.DesEncryption
            ...
            // key identifier
            //
            byte[] encryptedKey = _wrappingCredentials.SecurityKey.EncryptKey(
                _wrappingCredentials.Algorithm,
                _keyBytes
            );
            base.SecurityKeyIdentifier = new SecurityKeyIdentifier(
                new EncryptedKeyIdentifierClause(
                    encryptedKey,
                    _wrappingCredentials.Algorithm,
                    _wrappingCredentials.SecurityKeyIdentifier
                )
            );
