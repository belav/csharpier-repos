    ...
    public class Saml2SecurityTokenHandler : SecurityTokenHandler
    {
        ...
        public override ReadOnlyCollection<ClaimsIdentity> ValidateToken(SecurityToken token)
        {
            ...
            try
            {
                ...
                Saml2SubjectConfirmation subjectConfirmation = samlToken.Assertion
                    .Subject
...
#pragma warning suppress 56504 // bogus - thinks reader.LocalName, reader.NamespaceURI need validation
        ...
        )
        {
            ...
            if (hasScope)
            {
                conditions.AudienceRestrictions
        ...
        protected virtual DateTime GetTokenReplayCacheEntryExpirationTime(Saml2SecurityToken token)
        {
            ...
            if (assertion != null)
            {
                ...
                )
                {
                    ...
                    tokenExpiration = assertion.Subject
                        .SubjectConfirmations[0]
                        .SubjectConfirmationData
                        .NotOnOrAfter
                        .Value;
        ...
        )
        {
            ...
            if (nameId != null)
            {
                ...
                {
                    claim.Properties[ClaimProperties.SamlNameIdentifierFormat] = nameId.Format
                        .AbsoluteUri;
                }
        ...
        )
        {
            ...
            else if (Saml2Constants.ConfirmationMethods.HolderOfKey == subjectConfirmation.Method)
            {
                ...
                foreach (
                    SecurityKeyIdentifier keyIdentifier in subjectConfirmation.SubjectConfirmationData
                        .KeyIdentifiers
                )
                {
                    key = null;
