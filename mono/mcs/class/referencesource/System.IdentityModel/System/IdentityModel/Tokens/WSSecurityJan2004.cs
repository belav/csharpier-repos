...
namespace System.IdentityModel.Tokens
{
    ...
    class WSSecurityJan2004 : SecurityTokenSerializer.SerializerEntries
    {
        ...
        )
        {
            ...
            SecurityTokenReferenceJan2004ClauseEntry strClause =
                new SecurityTokenReferenceJan2004ClauseEntry(
        ...
        {
            strEntries.Add(
                new LocalReferenceStrEntry(
                    this.securityTokenSerializer.EmitBspRequiredAttributes,
                    this.securityTokenSerializer
                )
            );
            strEntries.Add(
                new KerberosHashStrEntry(this.securityTokenSerializer.EmitBspRequiredAttributes)
            );
            strEntries.Add(
                new X509SkiStrEntry(this.securityTokenSerializer.EmitBspRequiredAttributes)
            );
        ...
        protected class SecurityTokenReferenceJan2004ClauseEntry : KeyIdentifierClauseEntry
        {
            ...
            public SecurityTokenReferenceJan2004ClauseEntry(
                bool emitBspRequiredAttributes,
                IList<StrEntry> strEntries
            )
            {
            ...
            {
                get { return this.strEntries; }
            }

            protected override XmlDictionaryString LocalName
            {
                get { return XD.SecurityJan2004Dictionary.SecurityTokenReference; }
            }
            ...
            )
            {
                ...
                )
                {
                    string nonceString = reader.GetAttribute(
                        XD.SecureConversationFeb2005Dictionary.Nonce,
                    ...
                    string lengthString = reader.GetAttribute(
                        XD.SecureConversationFeb2005Dictionary.Length,
                        XD.SecureConversationFeb2005Dictionary.Namespace
                    );
        ...
        protected abstract class KeyIdentifierStrEntry : StrEntry
        {
            ...
            protected const string EncodingTypeValueBase64Binary =
                SecurityJan2004Strings.EncodingTypeValueBase64Binary;
            protected const string EncodingTypeValueHexBinary =
                SecurityJan2004Strings.EncodingTypeValueHexBinary;
            protected const string EncodingTypeValueText =
                SecurityJan2004Strings.EncodingTypeValueText;

            protected abstract Type ClauseType { get; }
            protected virtual string DefaultEncodingType
            {
                get { return EncodingTypeValueBase64Binary; }
            }
            ...
            public override bool CanReadClause(XmlDictionaryReader reader, string tokenType)
            {
                if (
                    reader.IsStartElement(
                        XD.SecurityJan2004Dictionary.KeyIdentifier,
                        XD.SecurityJan2004Dictionary.Namespace
                    )
                )
                {
            ...
            protected abstract SecurityKeyIdentifierClause CreateClause(
                byte[] bytes,
            ...
            )
            {
                ...
                {
                    writer.WriteString(
                        new UTF8Encoding().GetString(keyIdentifier, 0, keyIdentifier.Length)
                    );
                }
                writer.WriteEndElement();
            }
        ...
        protected class KerberosHashStrEntry : KeyIdentifierStrEntry
        {
            ...
            {
                get { return typeof(KerberosTicketHashKeyIdentifierClause); }
            }
            public override Type TokenType
            {
                get { return typeof(KerberosRequestorSecurityToken); }
            }
            protected override string ValueTypeUri
            {
                get { return SecurityJan2004Strings.KerberosHashValueType; }
            }
            ...
            )
            {
                ...
                KerberosTicketHashKeyIdentifierClause binaryClause =
                    clause as KerberosTicketHashKeyIdentifierClause;
                if (this.EmitBspRequiredAttributes)
                {
                    // Emit the encodingType attribute.
                    writer.WriteAttributeString(
        ...
        protected class X509SkiStrEntry : KeyIdentifierStrEntry
        {
            protected override Type ClauseType
            {
                get { return typeof(X509SubjectKeyIdentifierClause); }
            }
            public override Type TokenType
            {
            ...
            protected override string ValueTypeUri
            {
                get { return SecurityJan2004Strings.X509SKIValueType; }
            }
        ...
        protected class LocalReferenceStrEntry : StrEntry
        {
            ...
            )
            {
                ...
                SecurityKeyIdentifierClause clause = new LocalIdKeyIdentifierClause(
                    uri.Substring(1),
                    derivationNonce,
                    derivationLength,
                    tokenTypes
        ...
        protected class SamlJan2004KeyIdentifierStrEntry : StrEntry
        {
            ...
            public override bool CanReadClause(XmlDictionaryReader reader, string tokenType)
            {
                if (
                    reader.IsStartElement(
                        XD.SamlDictionary.AuthorityBinding,
            ...
            public override bool SupportsCore(SecurityKeyIdentifierClause clause)
            {
                ...
                {
                    SamlAssertionKeyIdentifierClause samlclause =
                        clause as SamlAssertionKeyIdentifierClause;
                    if (
                        (samlclause.TokenTypeUri == null)
                        || (samlclause.TokenTypeUri == this.GetTokenTypeUri())
                    )
                    {
                        return true;
                    }
            ...
            )
            {
                SamlAssertionKeyIdentifierClause samlClause =
                    clause as SamlAssertionKeyIdentifierClause;
                if (
                    !string.IsNullOrEmpty(samlClause.Binding)
                    || !string.IsNullOrEmpty(samlClause.Location)
                    || !string.IsNullOrEmpty(samlClause.AuthorityKind)
                )
                {
                    writer.WriteStartElement(
                        XD.SamlDictionary.PreferredPrefix.Value,
                        XD.SamlDictionary.AuthorityBinding,
                        XD.SecurityJan2004Dictionary.SamlUri
                    );
                    ...
                    {
                        writer.WriteAttributeString(
                            XD.SamlDictionary.AuthorityKind,
                            null,
                            samlClause.AuthorityKind
                        );
                    }
                    writer.WriteEndElement();
                }
                ...
                string valueType = string.IsNullOrEmpty(samlClause.ValueType)
                    ? XD.SecurityJan2004Dictionary.SamlAssertionIdValueType.Value
                    : samlClause.ValueType;
                writer.WriteAttributeString(
                    XD.SecurityJan2004Dictionary.ValueType,
                    null,
                    valueType
        ...
        protected class RelDirectStrEntry : StrEntry
        {
            ...
            )
            {
                ...
                return new RelAssertionDirectKeyIdentifierClause(
                    assertionId,
                    derivationNone,
                    derivationLength
                );
            ...
            public override bool SupportsCore(SecurityKeyIdentifierClause clause)
            {
                return typeof(RelAssertionDirectKeyIdentifierClause).IsAssignableFrom(
                    clause.GetType()
                );
            }
            ...
            {
                RelAssertionDirectKeyIdentifierClause relClause =
                    clause as RelAssertionDirectKeyIdentifierClause;
                writer.WriteStartElement(
                    XD.SecurityJan2004Dictionary.Prefix.Value,
                    XD.SecurityJan2004Dictionary.Reference,
                    XD.SecurityJan2004Dictionary.Namespace
                ...
                writer.WriteAttributeString(
                    XD.SecurityJan2004Dictionary.ValueType,
                    null,
                    SecurityJan2004Strings.RelAssertionValueType
                );
                writer.WriteAttributeString(
                    XD.SecurityJan2004Dictionary.URI,
                    null,
                    relClause.AssertionId
                );
                writer.WriteEndElement();
            }
        }
        ...
        protected class X509IssuerSerialStrEntry : StrEntry
        {
            ...
            {
                X509IssuerSerialKeyIdentifierClause issuerClause =
                ...
                writer.WriteElementString(
                    ...
                    XD.XmlSignatureDictionary.X509IssuerName,
                    XD.XmlSignatureDictionary.Namespace,
                    issuerClause.IssuerName
                );
                writer.WriteElementString(
                    XD.XmlSignatureDictionary.Prefix.Value,
                    XD.XmlSignatureDictionary.X509SerialNumber,
                    XD.XmlSignatureDictionary.Namespace,
                    issuerClause.IssuerSerialNumber
                );
                writer.WriteEndElement();
                writer.WriteEndElement();
            }
