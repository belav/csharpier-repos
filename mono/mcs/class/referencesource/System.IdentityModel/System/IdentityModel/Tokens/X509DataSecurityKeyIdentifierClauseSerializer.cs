...
namespace System.IdentityModel.Tokens
{
        ...
        : SecurityKeyIdentifierClauseSerializer
    {
        ...
        public override SecurityKeyIdentifierClause ReadKeyIdentifierClause(XmlReader reader)
        {
            ...
            {
                if (
                    dictionaryReader.IsStartElement(
                        XmlSignatureConstants.Elements.X509IssuerSerial,
                        XmlSignatureConstants.Namespace
                    )
                )
                {
                ...
                )
                {
                    ...
                    dictionaryReader.IsStartElement(
                        XmlSignatureConstants.Elements.X509Certificate,
                        XmlSignatureConstants.Namespace
                    )
                )
                {
        ...
        )
        {
            ...
            X509IssuerSerialKeyIdentifierClause issuerSerialClause =
                securityKeyIdentifierClause as X509IssuerSerialKeyIdentifierClause;
            if (issuerSerialClause != null)
            {
                ...
                writer.WriteElementString(
                    XmlSignatureConstants.Prefix,
                    XmlSignatureConstants.Elements.X509IssuerName,
                    XmlSignatureConstants.Namespace,
                    issuerSerialClause.IssuerName
                );
                writer.WriteElementString(
                    XmlSignatureConstants.Prefix,
                    XmlSignatureConstants.Elements.X509SerialNumber,
                    XmlSignatureConstants.Namespace,
            ...
            X509SubjectKeyIdentifierClause skiClause =
                securityKeyIdentifierClause as X509SubjectKeyIdentifierClause;
            if (skiClause != null)
            {
                writer.WriteStartElement(
                    XmlSignatureConstants.Prefix,
            ...
            X509ChainRawDataKeyIdentifierClause x509ChainDataClause =
                securityKeyIdentifierClause as X509ChainRawDataKeyIdentifierClause;
            ...
            X509RawDataKeyIdentifierClause rawDataClause =
                securityKeyIdentifierClause as X509RawDataKeyIdentifierClause;
        ...
        private static SecurityKeyIdentifierClause CreateIssuerSerialKeyIdentifierClause(
        ...
        )
        {
            ...
            string issuerName = dictionaryReader.ReadElementContentAsString(
                XmlSignatureConstants.Elements.X509IssuerName,
                XmlSignatureConstants.Namespace
            );
            ...
            string serialNumber = dictionaryReader.ReadElementContentAsString(
                XmlSignatureConstants.Elements.X509SerialNumber,
                XmlSignatureConstants.Namespace
            );
        ...
        private static SecurityKeyIdentifierClause CreateSubjectKeyIdentifierClause(
            XmlDictionaryReader dictionaryReader
        )
        {
        ...
        private static SecurityKeyIdentifierClause CreateRawDataKeyIdentifierClause(
            XmlDictionaryReader dictionaryReader
        )
        {
#if INCLUDE_CERT_CHAIN
