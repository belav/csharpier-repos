...
namespace System.Security.Claims
{
    internal static class ClaimsHelper
    {
        ...
        /// </summary>
        /// <param name="x509Certificate">The certificate to use to map to the associated <see
        // cref="WindowsIdentity"/></param>
        /// <returns></returns>
...
/// </summary>
/// <returns>A <see cref="WindowsClaimsIdentity"/> whose base <see cref="WindowsIdentity"/> has a
Windows token for the NT AUTHORITY\ANONYMOUS LOGON user.</returns>
/// <exception cref="Win32Exception">Thrown if this method fails to open the current thread
token.</exception>
/// <exception cref="Win32Exception">Thrown if this method fails to impersonate NT
AUTHORITY\ANONYMOUS LOGON.</exception>
/// <exception cref="Win32Exception">Thrown if this method fails in attempt to reset thread
token.</exception>
