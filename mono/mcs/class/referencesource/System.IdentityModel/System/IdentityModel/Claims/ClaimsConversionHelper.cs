...
namespace System.Security.Claims
{
    ...
    {
        public static ClaimsIdentity CreateClaimsIdentityFromClaimSet(
            System.IdentityModel.Claims.ClaimSet claimset,
        ...
        public static System.Security.Claims.Claim CreateClaimFromWcfClaim(
            System.IdentityModel.Claims.Claim wcfClaim
        )
        {
        ...
        )
        {
            ...
            else
            {
                AssignClaimFromSysClaim(
                    ...
                    out value,
                    out valueType,
                    out samlNameIdentifierFormat,
                    out samlNameIdentifierNameQualifier
                );
            }
            ...
            System.Security.Claims.Claim newClaim = new System.Security.Claims.Claim(
                claimType,
                value,
                valueType,
                issuer,
            ...
            newClaim.Properties[ClaimProperties.SamlNameIdentifierFormat] =
                samlNameIdentifierFormat;
            newClaim.Properties[ClaimProperties.SamlNameIdentifierNameQualifier] =
                samlNameIdentifierNameQualifier;
            return newClaim;
        }

        static void AssignClaimFromStringResourceSysClaim(
        ...
        static void AssignClaimFromSysClaim(
            System.IdentityModel.Claims.Claim claim,
            out string _type,
            out string _value,
            out string _valueType,
            out string samlNameIdentifierFormat,
            out string samlNameIdentifierNameQualifier
        )
        {
            ...
            if (
                StringComparer.Ordinal.Equals(claim.ClaimType, ClaimTypes.Sid)
                && claim.Resource is SecurityIdentifier
            )
            {
                if (claim.Right == System.IdentityModel.Claims.Rights.Identity)
                {
                ...
                StringComparer.Ordinal.Equals(claim.ClaimType, ClaimTypes.Email)
                && claim.Resource is MailAddress
            )
            {
                ...
                StringComparer.Ordinal.Equals(claim.ClaimType, ClaimTypes.Thumbprint)
                && claim.Resource is byte[]
            )
            {
                _type = claim.ClaimType;
                ...
                StringComparer.Ordinal.Equals(claim.ClaimType, ClaimTypes.Hash)
                && claim.Resource is byte[]
            )
            {
                _type = claim.ClaimType;
                ...
                StringComparer.Ordinal.Equals(claim.ClaimType, ClaimTypes.NameIdentifier)
                && claim.Resource is SamlNameIdentifierClaimResource
            )
            {
                _type = claim.ClaimType;
                ...
                StringComparer.Ordinal.Equals(claim.ClaimType, ClaimTypes.X500DistinguishedName)
            ...
            )
            {
                ...
                StringComparer.Ordinal.Equals(claim.ClaimType, ClaimTypes.Uri)
                && claim.Resource is Uri
            )
            {
                _type = claim.ClaimType;
                ...
                StringComparer.Ordinal.Equals(claim.ClaimType, ClaimTypes.Rsa)
                && claim.Resource is RSA
            )
            {
                _type = claim.ClaimType;
                ...
                StringComparer.Ordinal.Equals(claim.ClaimType, ClaimTypes.DenyOnlySid)
                && claim.Resource is SecurityIdentifier
            )
            {
                _type = claim.ClaimType;
