...
namespace System.IdentityModel
{
    ...
    public abstract class RequestException : Exception
    {
        ...
        /// </summary>
        /// <param name="message">The message describes what was causing the exception.</param>
        /// <param name="innerException">The inner exception indicates the real reason the exception was
        // thrown.</param>
        protected RequestException(string message, Exception innerException)
            : base(message, innerException) { }

        /// <summary>
        /// Constructor that sets the System.Runtime.Serialization.SerializationInfo with information about
        // the exception.
        /// </summary>
