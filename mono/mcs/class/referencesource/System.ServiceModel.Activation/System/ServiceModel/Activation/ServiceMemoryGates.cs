...
namespace System.ServiceModel.Activation
{
    ...
    static class ServiceMemoryGates
    {
        ...
        internal static bool Check(
            int minFreeMemoryPercentage,
            bool throwOnLowMemory,
            out ulong availableMemoryBytes
        )
        {
            ...
            if (
                ...
                < (memoryStatus.ullTotalVirtual / 100 * (ulong)minFreeMemoryPercentage)
            )
            {
                ...
                < (memoryStatus.ullTotalPhys / 100 * (ulong)minFreeMemoryPercentage)
            )
            {
        ...
        {
            memoryStatus.dwLength = (uint)
                Marshal.SizeOf(typeof(UnsafeNativeMethods.MEMORYSTATUSEX));
