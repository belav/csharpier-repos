...
namespace System.ServiceModel
{
    ...
    static class AspNetPartialTrustHelpers
    {
        ...
        [Fx.Tag.SecurityNote(
            Critical = "Critical field used to prevent usage of System.Web types in partial trust outside the ASP.NET context."
        )]
        [SecurityCritical]
        ...
        [Fx.Tag.SecurityNote(
            Miscellaneous = "RequiresReview - determines if the given PermissionSet is full trust."
                ...
                if (!isInitialized)
                {
                    ...
                    if (!IsFullTrust(aspNetPermissionSet))
                    {
                        try
                        {
                            ...
                            aspNetSecurityContext = System.Runtime
                                .PartialTrustHelpers
        ...
        /// </summary>
        [Fx.Tag.SecurityNote(
            Critical = "Critical because it uses security critical fields.",
