...
namespace System.ServiceModel.Activation
{
    ...
    {
        [Fx.Tag.SecurityNote(
            Critical = "Holds pointer to BeginProcessRequest which is SecurityCritical."
        ...
        [Fx.Tag.SecurityNote(
            Critical = "Entry-point from ASP.NET, accesses begin/bndProcessRequest which are SecurityCritical."
        )]
        [SecurityCritical]
        ...
        )
        {
            ...
            if (ServiceHostingEnvironment.AspNetCompatibilityEnabled)
            {
                ...
                if (
                    serviceType == ServiceHostingEnvironment.ServiceType.Workflow
                ...
                )
                {
                    IHttpHandler cbaHandler = new ServiceHttpHandlerFactory().GetHandler(
                        ...
                        application.Request.RawUrl.ToString(),
