...
namespace System.ServiceModel.Activation
{
    ...
    public class ServiceRoute : Route
    {
        ...
        public ServiceRoute(
            ...
            : base(
                CheckAndCreateRouteString(routePrefix),
                new ServiceRouteHandler(routePrefix, serviceHostFactory, serviceType)
            )
        {
            if (TD.AspNetRouteIsEnabled())
            {
                TD.AspNetRoute(
                    ...
                    serviceHostFactory.GetType().AssemblyQualifiedName
                );
            }
        }
