...
namespace System.ServiceModel.Activation
{
    ...
    sealed class NamedPipeHostedTransportConfiguration : HostedTransportConfigurationBase
    {
            ...
            : base(Uri.UriSchemeNetPipe)
        {
            ...
            {
                BaseUriWithWildcard listenAddress = BaseUriWithWildcard.CreateHostedPipeUri(
                    bindings[i],
                ...
                {
                    Debug.Print(
                        "NamedPipeHostedTransportConfiguration.ctor() Creating the unique NamedPipeTransportManager with ListenUri:"
                ...
                NamedPipeChannelListener.StaticTransportManagerTable.RegisterUri(
                    listenAddress.BaseAddress,
