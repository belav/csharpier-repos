...
namespace System.Net.PeerToPeer.Collaboration
{
    ...
    public sealed class ContactManager : IDisposable
    {
        ...
        internal ContactManager()
        {
            ...
            OnCreateContactCompletedDelegate = new SendOrPostCallback(
                CreateContactCompletedWaitCallback
            );
        }
        ...
        public static PeerContact LocalContact
        {
            ...
            get
            {
                ...
                Logging
                    .P2PTraceSource
                    .TraceEvent(TraceEventType.Information, 0, "Get MyContact called.");
                ...
                try
                {
                    ...
                    int errorCode = UnsafeCollabNativeMethods.PeerCollabGetContact(
                        null,
                        out contact
                    );
                    if (errorCode != 0)
                    {
                        Logging
                            ...
                            .TraceEvent(
                                ...
                                0,
                                "PeerCollabGetContact returned with errorcode {0}",
                                errorCode
                            );
                        return null;
                    }
                    pc = (PEER_CONTACT)
                        Marshal.PtrToStructure(contact.DangerousGetHandle(), typeof(PEER_CONTACT));
                    myContact = (MyContact)
                        CollaborationHelperFunctions.ConvertPEER_CONTACTToPeerContact(pc, true);
                }
                finally
                {
                    if (contact != null)
                ...
                Logging
                    .P2PTraceSource
                    .TraceEvent(TraceEventType.Information, 0, "Get MyContact successful.");
        ...
        // </SecurityKernel>
        [System.Security.SecurityCritical]
        private void AddSubscriptionListChanged(
            EventHandler<SubscriptionListChangedEventArgs> callback
        )
        {
            //
            ...
            lock (LockSubLstChangedEvent)
            {
                if (m_subscriptionListChanged == null)
                {
                    ...
                    m_regSubLstChangedWaitHandle = ThreadPool.RegisterWaitForSingleObject(
                        m_subLstChangedEvent, //Event that triggers the callback
                    ...
                    if (errorCode != 0)
                    {
                        ...
                        throw PeerToPeerException.CreateFromHr(
                            SR.GetString(SR.Collab_SubListChangedRegFailed),
                            errorCode
                        );
                    }
                }
            ...
            Logging
                ...
                .TraceEvent(
                    ...
                    0,
                    "AddSubscriptionListChanged() successful."
                );
        }
        ...
        // </SecurityKernel>
        [System.Security.SecurityCritical]
        private void RemoveSubscriptionListChanged(
            EventHandler<SubscriptionListChangedEventArgs> callback
        )
        {
            Logging
                ...
                .TraceEvent(
                    TraceEventType.Information,
                    0,
                    "RemoveSubscriptionListChanged() called."
                );
            ...
            lock (LockSubLstChangedEvent)
            {
                ...
                if (m_subscriptionListChanged == null)
                {
                    CollaborationHelperFunctions.CleanEventVars(
                        ref m_regSubLstChangedWaitHandle,
                    ...
                    Logging
                        ...
                        .TraceEvent(
                            TraceEventType.Information,
                            0,
                            "Clean SubscriptionListChanged variables successful."
                        );
                }
            }
            Logging
                ...
                .TraceEvent(
                    TraceEventType.Information,
                    0,
                    "RemoveSubscriptionListChanged() successful."
                );
        }
        ...
        private void SubListChangedCallback(object state, bool timedOut)
        {
            ...
            Logging
                .P2PTraceSource
                .TraceEvent(TraceEventType.Information, 0, "SubListChangedCallback() called.");
            ...
            while (true)
            {
                ...
                try
                {
                    lock (LockSubLstChangedEvent)
                    {
                        if (m_safeSubLstChangedEvent.IsInvalid)
                            return;
                        errorCode = UnsafeCollabNativeMethods.PeerCollabGetEventData(
                            m_safeSubLstChangedEvent,
                            out eventData
                        );
                    }
                    ...
                    else if (errorCode != 0)
                    {
                        ...
                        throw PeerToPeerException.CreateFromHr(
                            SR.GetString(SR.Collab_GetSubListChangedDataFailed),
                            errorCode
                        );
                    }
                    ...
                    if (ped.eventType == PeerCollabEventType.WatchListChanged)
                    {
                        ...
                        if (watchlistData.pContact != IntPtr.Zero)
                        {
                            PEER_CONTACT pc = (PEER_CONTACT)
                                Marshal.PtrToStructure(
                                    watchlistData.pContact,
                                    typeof(PEER_CONTACT)
                                );
                            peerContact =
                                CollaborationHelperFunctions.ConvertPEER_CONTACTToPeerContact(pc);
                        }

                        subListChangedArgs = new SubscriptionListChangedEventArgs(
                            null,
                            peerContact,
                ...
                if ((subListChangedArgs != null) && (handlerCopy != null))
                {
                    if (SynchronizingObject != null && SynchronizingObject.InvokeRequired)
                        SynchronizingObject.BeginInvoke(
                            handlerCopy,
                            new object[] { this, subListChangedArgs }
                        );
                    else
                    ...
                    Logging
                        ...
                        .TraceEvent(
                            TraceEventType.Information,
                            0,
                            "Fired the subscription list changed event callback."
                        );
                }
            }
            Logging
        ...
        private void AddNameChanged(EventHandler<NameChangedEventArgs> callback)
        {
            ...
            lock (LockNameChangedEvent)
            {
                if (m_nameChanged == null)
                {
                    ...
                    m_regNameChangedWaitHandle = ThreadPool.RegisterWaitForSingleObject(
                        m_nameChangedEvent, //Event that triggers the callback
        ...
        private void RemoveNameChanged(EventHandler<NameChangedEventArgs> callback)
        {
            ...
            lock (LockNameChangedEvent)
            {
                ...
                {
                    CollaborationHelperFunctions.CleanEventVars(
                        ref m_regNameChangedWaitHandle,
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    if (ped.eventType == PeerCollabEventType.EndPointChanged)
                    {
                        ...
                        {
                            PEER_CONTACT pc = (PEER_CONTACT)
                                Marshal.PtrToStructure(endpointData.pContact, typeof(PEER_CONTACT));
                            peerContact =
                                CollaborationHelperFunctions.ConvertPEER_CONTACTToPeerContact(pc);
                        }
                        ...
                        nameChangedArgs = new NameChangedEventArgs(
                            peerEndPoint,
                            peerContact,
                            newName
                        );
                ...
                if ((nameChangedArgs != null) && (handlerCopy != null))
                {
                    if (SynchronizingObject != null && SynchronizingObject.InvokeRequired)
                        SynchronizingObject.BeginInvoke(
                            handlerCopy,
                            new object[] { this, nameChangedArgs }
                        );
                    else
        ...
        private void AddPresenceChanged(EventHandler<PresenceChangedEventArgs> callback)
        {
            ...
            lock (LockPresenceChangedEvent)
            {
                if (m_presenceChanged == null)
                {
                    ...
                    m_regPresenceChangedWaitHandle = ThreadPool.RegisterWaitForSingleObject(
                        m_presenceChangedEvent, //Event that triggers the callback
        ...
        private void RemovePresenceChanged(EventHandler<PresenceChangedEventArgs> callback)
        {
            ...
            lock (LockPresenceChangedEvent)
            {
                ...
                {
                    CollaborationHelperFunctions.CleanEventVars(
                        ref m_regPresenceChangedWaitHandle,
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    if (ped.eventType == PeerCollabEventType.EndPointPresenceChanged)
                    {
                        ...
                        {
                            PEER_PRESENCE_INFO ppi = (PEER_PRESENCE_INFO)
                                Marshal.PtrToStructure(
                                    presenceData.pPresenceInfo,
                        ...
                        {
                            PEER_CONTACT pc = (PEER_CONTACT)
                                Marshal.PtrToStructure(presenceData.pContact, typeof(PEER_CONTACT));
                            peerContact =
                                CollaborationHelperFunctions.ConvertPEER_CONTACTToPeerContact(pc);
                        }
                        ...
                        presenceChangedArgs = new PresenceChangedEventArgs(
                            peerEndPoint,
                            peerContact,
                ...
                if ((presenceChangedArgs != null) && (handlerCopy != null))
                {
                    if (SynchronizingObject != null && SynchronizingObject.InvokeRequired)
                        SynchronizingObject.BeginInvoke(
                            handlerCopy,
                            new object[] { this, presenceChangedArgs }
                        );
                    else
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    if (ped.eventType == PeerCollabEventType.EndPointApplicationChanged)
                    {
                        ...
                        {
                            PEER_ENDPOINT pe = (PEER_ENDPOINT)
                                Marshal.PtrToStructure(appData.pEndPoint, typeof(PEER_ENDPOINT));
                            peerEndPoint =
                                CollaborationHelperFunctions.ConvertPEER_ENDPOINTToPeerEndPoint(pe);
                        }
        ...
        private void AddObjectChangedEvent(EventHandler<ObjectChangedEventArgs> callback)
        {
            ...
            Logging
                .P2PTraceSource
                .TraceEvent(TraceEventType.Information, 0, "AddObjectChangedEvent() called.");
                ...
                if (m_objectChanged == null)
                {
                    ...
                    Logging
                        ...
                        .TraceEvent(
                            TraceEventType.Information,
                            0,
                            "Clean ObjectChanged variables successful."
                        );
                }
            }
            ...
            while (true)
            {
                ...
                try
                {
                    ...
                    if (ped.eventType == PeerCollabEventType.EndPointObjectChanged)
                    {
                        ...
                        {
                            PEER_ENDPOINT pe = (PEER_ENDPOINT)
                                Marshal.PtrToStructure(objData.pEndPoint, typeof(PEER_ENDPOINT));
                            peerEndPoint =
                                CollaborationHelperFunctions.ConvertPEER_ENDPOINTToPeerEndPoint(pe);
                        }
                ...
                if ((objectChangedArgs != null) && (handlerCopy != null))
                {
                    if (SynchronizingObject != null && SynchronizingObject.InvokeRequired)
                        SynchronizingObject.BeginInvoke(
                            handlerCopy,
                            new object[] { this, objectChangedArgs }
                        );
                    else
        ...
        public PeerContactCollection GetContacts()
        {
            ...
            Logging
                .P2PTraceSource
                .TraceEvent(TraceEventType.Information, 0, "Entering GetContacts()");
            ...
            try
            {
                ...
                if (errorCode != 0)
                {
                    Logging
                        ...
                        .TraceEvent(
                            TraceEventType.Error,
                            0,
                            "PeerCollabEnumContacts returned with errorcode {0}",
                            errorCode
                        );
                    throw PeerToPeerException.CreateFromHr(
                        SR.GetString(SR.Collab_GetContactsFailed),
                        errorCode
                    );
                }

                errorCode = UnsafeCollabNativeMethods.PeerGetItemCount(
                    handlePeerEnum,
                    ref contactCount
                );
                if (errorCode != 0)
                ...
                unsafe
                {
                    ...
                    try
                    {
                        errorCode = UnsafeCollabNativeMethods.PeerGetNextItem(
                            handlePeerEnum,
                            ref contactCount,
                            out contactArray
                        );
                        if (errorCode != 0)
                        {
                            Logging
                                ...
                                .TraceEvent(
                                    TraceEventType.Error,
                                    0,
                                    "PeerGetNextItem returned with errorcode {0}",
                                    errorCode
                                );
                            throw PeerToPeerException.CreateFromHr(
                                SR.GetString(SR.Collab_GetContactsFailed),
                        ...
                        for (ulong i = 0; i < contactCount; i++)
                        {
                            ...
                            PEER_CONTACT pc = (PEER_CONTACT)
                                Marshal.PtrToStructure(pContactPtr, typeof(PEER_CONTACT));
        ...
        public PeerContact GetContact(PeerName peerName)
        {
            ...
            Logging
                ...
                .TraceEvent(
                    TraceEventType.Information,
                    0,
                    "Entering GetContact() with peername {0}",
                    peerName.ToString()
                );

            try
            {
                errorCode = UnsafeCollabNativeMethods.PeerCollabGetContact(
                    peerName.ToString(),
                    out safeContact
                );
                if (errorCode == UnsafeCollabReturnCodes.PEER_E_CONTACT_NOT_FOUND)
                {
                    Logging
                        ...
                        .TraceEvent(
                            TraceEventType.Error,
                            0,
                            "Contact not found in Contact Manager"
                        );
                ...
                else if (errorCode != 0)
                {
                    ...
                    throw PeerToPeerException.CreateFromHr(
                        SR.GetString(SR.Collab_GetContactFailed),
                        errorCode
                    );
                }
                ...
                if (!safeContact.DangerousGetHandle().Equals(IntPtr.Zero))
                {
                    Logging
                        .P2PTraceSource
                        .TraceEvent(TraceEventType.Information, 0, "Found contact.");
                    PEER_CONTACT pc = (PEER_CONTACT)
                        Marshal.PtrToStructure(
                            safeContact.DangerousGetHandle(),
                            typeof(PEER_CONTACT)
                        );
                ...
                else
                {
                    Logging
                        .P2PTraceSource
                        .TraceEvent(TraceEventType.Information, 0, "No contact found.");
                }
            }
            finally
            {
            ...
            Logging
                .P2PTraceSource
                .TraceEvent(TraceEventType.Information, 0, "Leaving GetContact()");
        ...
        public PeerContact CreateContact(PeerNearMe peerNearMe)
        {
            ...
            if (
                (peerNearMe.PeerEndPoints == null)
                || (peerNearMe.PeerEndPoints.Count == 0)
                || (peerNearMe.PeerEndPoints[0].EndPoint == null)
            )
            ...
            Logging
                ...
                .TraceEvent(
                    TraceEventType.Information,
                    0,
                    "Entering CreateContact() with peernearme",
                    peerNearMe.ToString()
                );
            ...
            pe.peerAddress = CollaborationHelperFunctions.ConvertIPEndpointToPEER_ADDRESS(
            ...
            errorCode = UnsafeCollabNativeMethods.PeerCollabQueryContactData(
                ptrPeerEP,
                ref contactData
            );
            if (errorCode != 0)
            {
                ...
                throw PeerToPeerException.CreateFromHr(
                    SR.GetString(SR.Collab_CreateContactFailed),
                    errorCode
                );
            }
            ...
            try
            {
                errorCode = UnsafeCollabNativeMethods.PeerCollabParseContact(
                    contactData,
                    out contact
                );
                if (errorCode != 0)
            ...
            Logging
                .P2PTraceSource
                .TraceEvent(TraceEventType.Information, 0, "Leaving CreateContact().");
        ...
        Dictionary<object, AsyncOperation> m_createContactAsyncList =
        ...
        public void CreateContactAsync(PeerNearMe peerNearMe, Object userToken)
        {
            ...
            if (Logging.P2PTraceSource.Switch.ShouldTrace(TraceEventType.Information))
            {
                Logging
                    ...
                    .TraceEvent(
                        TraceEventType.Information,
                        0,
                        "Entering CreateContactAsync() with token {0} and following peernearme",
                        userToken
                    );
            ...
            ThreadPool.QueueUserWorkItem(
                new WaitCallback(CreateContactAsyncHelper),
                new CreateContactAsyncState(peerNearMe, userToken)
            );

            Logging
                .P2PTraceSource
                .TraceEvent(TraceEventType.Information, 0, "Leaving CreateContactAsync().");
        }
        ...
        private void CreateContactAsyncHelper(object state)
        {
            ...
            catch (ObjectDisposedException e)
            {
                Logging
                    ...
                    .TraceEvent(
                        TraceEventType.Error,
                        0,
                        "CreateContactAsyncHelper caught error {0}",
                        e.Message
                    );
                ex = e;
            }
            ...
            if (ex == null)
            {
                createContactCompletedArgs = new CreateContactCompletedEventArgs(
                    peerContact,
                    null,
                    false,
                    userToken
            ...
            PrepareToRaiseCreateContactCompletedEvent(
                m_createContactAsyncList[userToken],
            ...
            if (handlerCopy != null)
            {
                ...
                Logging
                    ...
                    .TraceEvent(
                        TraceEventType.Information,
                        0,
                        "Fired the create contact completed event callback."
                    );
            }
        }
        ...
        internal void PrepareToRaiseCreateContactCompletedEvent(
            AsyncOperation asyncOP,
            CreateContactCompletedEventArgs args
        )
        {
        ...
        public void AddContact(PeerContact peerContact)
        {
            ...
            if (peerContact.ContactXml == null)
            {
                ...
                catch (PeerToPeerException e)
                {
                    throw new PeerToPeerException(
                        SR.GetString(SR.Collab_AddContactFailedNoXml),
                        e.InnerException
                    );
                }
            }
            ...
            if (Logging.P2PTraceSource.Switch.ShouldTrace(TraceEventType.Information))
            {
                Logging
                    ...
                    .TraceEvent(
                        TraceEventType.Information,
                        0,
                        "Entering AddContact() with following peercontact"
                    );
            ...
            if (errorCode == UnsafeCollabReturnCodes.PEER_E_ALREADY_EXISTS)
            {
                Logging
                    ...
                    .TraceEvent(
                        TraceEventType.Error,
                        0,
                        "PeerCollabAddContact returned with errorcode {0}. Contact already exists.",
                        errorCode
                    );
                throw new ArgumentException(
                    SR.GetString(SR.Collab_AddContactFailed)
                        + " "
                        + SR.GetString(SR.Collab_ContactExists)
                );
            }
            else if (errorCode != 0)
            {
                Logging
                    ...
                    .TraceEvent(
                        TraceEventType.Error,
                        0,
                        "PeerCollabAddContact returned with errorcode {0}",
                        errorCode
                    );
                throw PeerToPeerException.CreateFromHr(
                    SR.GetString(SR.Collab_AddContactFailed),
            ...
            Logging
                .P2PTraceSource
                .TraceEvent(TraceEventType.Information, 0, "Leaving AddContact() successfully.");
        }
        ...
        public void DeleteContact(PeerContact peerContact)
        {
            Logging
                .P2PTraceSource
                .TraceEvent(TraceEventType.Information, 0, "Entering DeleteContact().");
            ...
            Logging
                .P2PTraceSource
                .TraceEvent(TraceEventType.Information, 0, "Leaving DeleteContact() successfully.");
        }
        ...
        public void DeleteContact(PeerName peerName)
        {
            ...
            Logging
                .P2PTraceSource
                .TraceEvent(TraceEventType.Information, 0, "Peername is {0}", peerName.ToString());
            ...
            if (errorCode == UnsafeCollabReturnCodes.PEER_E_CONTACT_NOT_FOUND)
            {
                Logging
                    .P2PTraceSource
                    .TraceEvent(TraceEventType.Error, 0, "Contact not found in Contact Manager");
            ...
            else if (errorCode != 0)
            {
                Logging
                    ...
                    .TraceEvent(
                        TraceEventType.Error,
                        0,
                        "PeerCollabDeleteContact returned with errorcode {0}",
                        errorCode
                    );
                throw (
                    PeerToPeerException.CreateFromHr(
                        SR.GetString(SR.Collab_DeleteContactFailed),
                        errorCode
                    )
                );
            }
        ...
        public void UpdateContact(PeerContact peerContact)
        {
            ...
            if (Logging.P2PTraceSource.Switch.ShouldTrace(TraceEventType.Information))
            {
                Logging
                    ...
                    .TraceEvent(
                        TraceEventType.Information,
                        0,
                        "Entering UpdateContact() with following peercontact"
                    );
                peerContact.TracePeerContact();
            }
            ...
            try
            {
                PEER_CONTACT pc = CollaborationHelperFunctions.ConvertPeerContactToPEER_CONTACT(
                    peerContact,
                    ref safeCredentials
                );
            ...
            else if (errorCode != 0)
            {
                Logging
                    ...
                    .TraceEvent(
                        TraceEventType.Error,
                        0,
                        "PeerCollabUpdateContact returned with errorcode {0}",
                        errorCode
                    );
                throw (
                    PeerToPeerException.CreateFromHr(
                        SR.GetString(SR.Collab_UpdateContactFailed),
                        errorCode
                    )
                );
            }
            Logging
                .P2PTraceSource
                .TraceEvent(TraceEventType.Information, 0, "Leaving UpdateContact() successfully.");
        }
