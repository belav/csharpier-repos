...
namespace System.Net.PeerToPeer.Collaboration
{
    ...
    public class PeerContact : Peer, IEquatable<PeerContact>, ISerializable
    {
        ...
        public override PeerEndPointCollection PeerEndPoints
        {
            ...
            // Name="UnsafeCollabNativeMethods.PeerCollabEnumEndpoints(System.Net.PeerToPeer.Collaboration.PEER_CONTACT&,System.Net.PeerToPeer.Collaboration.SafeCollabEnum&):System.Int32"
            // />
            // <CallsSuppressUnmanagedCode
            ...
            // CollaborationHelperFunctions.ConvertPeerContactToPEER_CONTACT(System.Net.PeerToPeer.Collaboration.PeerContact,System.Net.PeerToPeer.Collaboration.SafeCollabMemory&):System.Net.PeerToPeer.Collaboration.PEER_CONTACT"
            // Ring="1" />
            // <ReferencesCritical Name="Method:
            ...
            get
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        //
                        PEER_CONTACT pc =
                            CollaborationHelperFunctions.ConvertPeerContactToPEER_CONTACT(
                                this,
                                ref safeCredentials
                            );

                        errorCode = UnsafeCollabNativeMethods.PeerCollabEnumEndpoints(
                            ref pc,
                            out handlePeerEnum
                        );
                    }
                    ...
                    unsafe
                    {
                        ...
                        for (ulong i = 0; i < pepCount; i++)
                        {
                            ...
                            PEER_ENDPOINT pe = (PEER_ENDPOINT)
                                Marshal.PtrToStructure(pEndPointPtr, typeof(PEER_ENDPOINT));
            ...
            : this()
        {
            ...
            m_subscribeAllowed = (SubscriptionType)
                serializationInfo.GetValue("_SubscribeAllowed", typeof(SubscriptionType));
        ...
        // <SecurityKernel Critical="True" Ring="0">
        // <CallsSuppressUnmanagedCode
        // Name="UnsafeCollabNativeMethods.PeerCollabExportContact(System.String,System.String&):System.Int32"
        // />
        // <ReferencesCritical Name="Method:
        ...
        // <SatisfiesLinkDemand Name="SafeHandle.Dispose():System.Void" />
        // <CallsSuppressUnmanagedCode
        // Name="UnsafeCollabNativeMethods.PeerCollabParseContact(System.String,System.Net.PeerToPeer.Collaboration.SafeCollabData&):System.Int32"
        // />
        // <CallsSuppressUnmanagedCode
        // Name="UnsafeCollabNativeMethods.PeerCollabGetContact(System.String,System.Net.PeerToPeer.Collaboration.SafeCollabData&):System.Int32"
        // />
        ...
        private void InternalSubscribe(object isAsyncObj)
        {
            ...
            if (isAsync)
            {
                ...
                if (ex == null)
                {
                    subscribeArgs = new SubscribeCompletedEventArgs(
                        null,
                        this,
                        null,
                        false,
        ...
        internal void PrepareToRaiseSubscribeCompletedEvent(
            AsyncOperation asyncOP,
            SubscribeCompletedEventArgs args
        )
        {
        ...
        // <ReferencesCritical Name="Method: InternalInviteAllEndPoints(PeerEndPointCollection, String,
        // Byte[], Guid):PeerInvitationResponse" Ring="2" />
        // </SecurityKernel>
        [System.Security.SecurityCritical]
        ...
        // <SecurityKernel Critical="True" Ring="1">
        // <ReferencesCritical Name="Method:
        // Peer.InternalInviteEndPoint(System.Guid,System.String,System.Byte[],System.Net.PeerToPeer.Collaboration.PeerEndPoint,System.Net.PeerToPeer.Collaboration.PeerContact):System.Net.PeerToPeer.Collaboration.PeerInvitationResponse"
        // Ring="1" />
        // </SecurityKernel>
        [System.Security.SecurityCritical]
        ...
        )
        {
            ...
            {
                PeerInvitationResponse endPointResponse = InternalInviteEndPoint(
                    applicationId,
                    message,
                    invitationData,
                    peerEndPoint,
                ...
                if (
                    endPointResponse.PeerInvitationResponseType
        ...
        // <ReferencesCritical Name="Method: Peer.get_CurrentApplicationGuid():System.Guid" Ring="1" />
        // <ReferencesCritical Name="Method:
        // Peer.InternalInviteAsync(System.Guid,System.String,System.Byte[],System.Net.PeerToPeer.Collaboration.PeerEndPointCollection,System.Net.PeerToPeer.Collaboration.PeerContact,System.Object):System.Void"
        // Ring="2" />
        // </SecurityKernel>
        [System.Security.SecurityCritical]
        ...
        //
        // <SecurityKernel Critical="True" Ring="2">
        // <ReferencesCritical Name="Method: InternalGetAllApplications(Guid,
        // Boolean):PeerApplicationCollection" Ring="2" />
        // </SecurityKernel>
        [System.Security.SecurityCritical]
        ...
        //
        // <SecurityKernel Critical="True" Ring="1">
        // <ReferencesCritical Name="Method: InternalGetApplications(Guid, Boolean,
        // PeerEndPoint):PeerApplicationCollection" Ring="1" />
        // </SecurityKernel>
        [System.Security.SecurityCritical]
        ...
        // </SecurityKernel>
        [System.Security.SecurityCritical]
        private PeerApplicationCollection InternalGetAllApplications(
            Guid applicationId,
            bool guidSupplied
        )
        {
            Dictionary<Guid, PeerApplication> mergedApplications =
                new Dictionary<Guid, PeerApplication>();
            ...
            foreach (PeerEndPoint peerEndPoint in peerEndPoints)
            {
                peerApplicationCollection = InternalGetApplications(
                    applicationId,
                    guidSupplied,
                    peerEndPoint
                );
            ...
            Dictionary<Guid, PeerApplication>.ValueCollection applications =
                mergedApplications.Values;
        ...
        // </SecurityKernel>
        [System.Security.SecurityCritical]
        private static PeerApplicationCollection InternalGetApplications(
            Guid applicationId,
            bool guidSupplied,
            PeerEndPoint peerEndPoint
        )
        ...
        // <SecurityKernel Critical="True" Ring="1">
        // <ReferencesCritical Name="Method:
        // Peer.InternalGetObjects(System.Guid,System.Boolean,System.Net.PeerToPeer.Collaboration.PeerEndPoint):System.Net.PeerToPeer.Collaboration.PeerObjectCollection"
        // Ring="1" />
        // </SecurityKernel>
        [System.Security.SecurityCritical]
        ...
        {
            set { m_regAppChangedWaitHandle = value; }
        }

        private AutoResetEvent m_appChangedEvent;
        internal AutoResetEvent AppChangedEvent
        {
            get { return m_appChangedEvent; }
            set { m_appChangedEvent = value; }
        }
        ...
        // </SecurityKernel>
        [System.Security.SecurityCritical]
        internal virtual void AddApplicationChanged(
        ...
        // </SecurityKernel>
        [System.Security.SecurityCritical]
        internal virtual void RemoveApplicationChanged(
            EventHandler<ApplicationChangedEventArgs> callback
        )
        {
            Logging.P2PTraceSource.TraceEvent(
                    ...
                    if (ped.eventType == PeerCollabEventType.EndPointApplicationChanged)
                    {
                        ...
                        if (peerContact != null && Equals(peerContact))
                        {
                            PEER_APPLICATION pa = (PEER_APPLICATION)
                                Marshal.PtrToStructure(
                                    appData.pApplication,
                                    typeof(PEER_APPLICATION)
                                );
        ...
        {
            set { m_regObjChangedWaitHandle = value; }
        }

        private AutoResetEvent m_objChangedEvent;
        internal AutoResetEvent ObjChangedEvent
        {
            get { return m_objChangedEvent; }
            set { m_objChangedEvent = value; }
        }
        ...
        // </SecurityKernel>
        [System.Security.SecurityCritical]
        internal virtual void RemoveObjectChangedEvent(
        ...
        {
            set { m_regPresenceChangedWaitHandle = value; }
        }

        private AutoResetEvent m_presenceChangedEvent;
        internal AutoResetEvent PresenceChangedEvent
        {
            get { return m_presenceChangedEvent; }
            set { m_presenceChangedEvent = value; }
        }
        ...
        // <SecurityKernel Critical="True" Ring="0">
        // <SatisfiesLinkDemand
        // Name="Peer.GetObjectData(System.Runtime.Serialization.SerializationInfo,System.Runtime.Serialization.StreamingContext):System.Void"
        // />
        // </SecurityKernel>
        [SuppressMessage(
            "Microsoft.Security",
