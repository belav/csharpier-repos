        ...
        )
        {
            ...
            else
            {
                try
                {
                    ...
                    try
                    {
                        ...
                        string xomlVirtualPath = Path.Combine(
                            AspNetEnvironment.Current.CurrentVirtualPath,
                            constructorString
                        );
                        ...
                        if (HostingEnvironment.VirtualPathProvider.FileExists(xomlVirtualPath))
                        {
                            ...
                            string ruleFilePath = Path.ChangeExtension(
                                xomlVirtualPath,
                                WorkflowServiceBuildProvider.ruleFileExtension
                            );
            ...
            if (DiagnosticUtility.ShouldTraceInformation)
            {
                TraceUtility.TraceEvent(
                    ...
                    TraceCode.WorkflowServiceHostCreated,
                    SR.GetString(SR.TraceCodeWorkflowServiceHostCreated),
                    this
                );
            }
            return serviceHost;
            ...
            if (workflowType == null)
            {
                ...
                try
                {
                    ...
                    try
                    {
                        ...
                        compiledString = BuildManager.GetCompiledCustomString(
