...
namespace System.ServiceModel.Description
{
    ...
    {
        internal static readonly TimeSpan DefaultPersistenceOperationTimeout = TimeSpan.Parse(
            DefaultPersistenceOperationTimeoutString,
        ...
        public PersistenceProviderBehavior(
        ...
        {
            get { return this.persistenceOperationTimeout; }
            set
            {
        ...
        {
            get { return this.persistenceProviderFactory; }
            set
            {
                if (value == null)
                {
        ...
        void IWmiInstanceProvider.FillInstance(IWmiInstance wmiInstance)
        {
            wmiInstance.SetProperty(
                ...
                this.PersistenceOperationTimeout.ToString()
            );
            wmiInstance.SetProperty(
                "PersistenceProviderFactoryType",
                this.PersistenceProviderFactory.GetType().FullName
            );
        }
