...
namespace System.ServiceModel
{
    ...
    public class WorkflowServiceHost : ServiceHostBase
    {
        ...
        public WorkflowServiceHost(string workflowDefinitionPath, params Uri[] baseAddress)
            : this(
                new StreamedWorkflowDefinitionContext(workflowDefinitionPath, null, null),
                baseAddress
            ) { }
        ...
        public WorkflowServiceHost(Stream workflowDefinition, params Uri[] baseAddress)
            : this(
                new StreamedWorkflowDefinitionContext(workflowDefinition, null, null),
                baseAddress
            ) { }
        ...
        public WorkflowServiceHost(
            ...
            : this(
                new StreamedWorkflowDefinitionContext(workflowDefinition, ruleDefinition, null),
                baseAddress
            ) { }
            ...
            : base()
        {
            InitializeDescription(
                ...
                new UriSchemeKeyedCollection(baseAddress)
            );
        }
        ...
        )
        {
            ...
            ServiceEndpoint endpoint = base.AddServiceEndpoint(
                ContractDescription.GetContract(implementedContract).ConfigurationName,
                binding,
                address
            );
        ...
        )
        {
            ...
            return new DescriptionCreator(this.workflowDefinitionContext).BuildServiceDescription(
                out implementedContracts,
                out this.reflectedContracts
            );
        }
