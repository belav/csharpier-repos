...
namespace System.Workflow.Activities
{
    ...
    public sealed class WorkflowServiceAttributes : DependencyObject, IServiceDescriptionBuilder
    {
        ...
        private static readonly DependencyProperty NameProperty = DependencyProperty.Register(
            "Name",
            typeof(string),
            typeof(WorkflowServiceAttributes),
            new PropertyMetadata(null, DependencyPropertyOptions.Metadata)
        ...
        private static readonly DependencyProperty NamespaceProperty = DependencyProperty.Register(
            "Namespace",
            typeof(string),
            typeof(WorkflowServiceAttributes),
            new PropertyMetadata(null, DependencyPropertyOptions.Metadata)
        ...
        public AddressFilterMode AddressFilterMode
        {
            get
            {
                return (AddressFilterMode)
                    this.GetValue(WorkflowServiceAttributes.AddressFilterModeProperty);
            }
        ...
        public string ConfigurationName
        {
            get
            {
                return (string)this.GetValue(WorkflowServiceAttributes.ConfigurationNameProperty);
            }
        ...
        public bool IgnoreExtensionDataObject
        {
            ...
            {
                return (bool)
                    this.GetValue(WorkflowServiceAttributes.IgnoreExtensionDataObjectProperty);
            }
            set
            {
                this.SetValue(WorkflowServiceAttributes.IgnoreExtensionDataObjectProperty, value);
            }
        }
        ...
        public bool IncludeExceptionDetailInFaults
        {
            ...
            {
                return (bool)
                    this.GetValue(WorkflowServiceAttributes.IncludeExceptionDetailInFaultsProperty);
            }
            set
            {
                this.SetValue(
        ...
        public int MaxItemsInObjectGraph
        {
            get
            {
                return (int)this.GetValue(WorkflowServiceAttributes.MaxItemsInObjectGraphProperty);
            }
        ...
        public bool UseSynchronizationContext
        {
            ...
            {
                return (bool)
                    this.GetValue(WorkflowServiceAttributes.UseSynchronizationContextProperty);
            }
            set
            {
                this.SetValue(WorkflowServiceAttributes.UseSynchronizationContextProperty, value);
            }
        }
        ...
        public bool ValidateMustUnderstand
        {
            ...
            {
                return (bool)
                    this.GetValue(WorkflowServiceAttributes.ValidateMustUnderstandProperty);
            }
        ...
        void IServiceDescriptionBuilder.BuildServiceDescription(ServiceDescriptionContext context)
        {
            ...
            workflowServiceBehavior.IncludeExceptionDetailInFaults =
