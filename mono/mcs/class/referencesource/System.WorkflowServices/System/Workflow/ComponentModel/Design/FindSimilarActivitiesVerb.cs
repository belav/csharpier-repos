...
namespace System.Workflow.ComponentModel.Design
{
    ...
    // </summary>
    internal class FindSimilarActivitiesVerb<TActivity> : ActivityDesignerVerb
        where TActivity : Activity
    {
        ...
        {
            FindSimilarActivitiesVerb<TActivity> designerVerb =
                source as FindSimilarActivitiesVerb<TActivity>;
            ActivityDesigner activityDesigner = designerVerb.owner;
            List<ActivityDesigner> highlightedDesigners = designerVerb.GetMatchingActivityDesigners(
                activityDesigner
            );
            ActivityDesignerHighlighter hightlighter = new ActivityDesignerHighlighter(
                activityDesigner
            );
        ...
        private List<ActivityDesigner> GetMatchingActivityDesigners(
            ActivityDesigner activityDesigner
        )
        {
            CompositeActivityDesigner rootDesigner = DesignerPainter.GetRootDesigner(
                activityDesigner
            );
