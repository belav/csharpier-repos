...
namespace System.Web.UI.MobileControls
{
    ...
    public sealed class MobileControlsSection : ConfigurationSection
    {
        ...
        private static readonly ConfigurationProperty _propDictType = new ConfigurationProperty(
        ...
        private static readonly ConfigurationProperty _propDevices = new ConfigurationProperty(
            null,
        ...
        [ConfigurationProperty(
            "cookielessDataDictionaryType",
            DefaultValue = typeof(System.Web.Mobile.CookielessData)
        )]
        ...
        {
            get { return (Type)base[_propDictType]; }
            set { base[_propDictType] = value; }
        }

        [ConfigurationProperty("allowCustomAttributes", DefaultValue = false)]
        public bool AllowCustomAttributes
        {
            get { return (bool)base[_propAllowCustomAttributes]; }
            set { base[_propAllowCustomAttributes] = value; }
        }

        [ConfigurationProperty("", IsDefaultCollection = true)]
        public DeviceElementCollection Devices
        {
            get { return (DeviceElementCollection)base[_propDevices]; }
        }
    }
    ...
    public sealed class DeviceElement : ConfigurationElement
    {
        private static readonly ConfigurationElementProperty s_elemProperty =
            new ConfigurationElementProperty(
                new CallbackValidator(typeof(DeviceElement), ValidateElement)
            );
        private static ConfigurationPropertyCollection _properties;
        ...
        private static readonly ConfigurationProperty _propInheritsFrom = new ConfigurationProperty(
            "inheritsFrom",
            typeof(string),
            null,
            null,
        ...
        private static readonly ConfigurationProperty _propPageAdapter = new ConfigurationProperty(
            "pageAdapter",
            typeof(Type),
            null,
            MobileControlsSection.StdTypeNameConverter,
        ...
        {
            get { return (string)base[_propInheritsFrom]; }
            set { base[_propInheritsFrom] = value; }
        }
        ...
        {
            get { return (Type)base[_propPredicateClass]; }
            set { base[_propPredicateClass] = value; }
        }
        ...
        {
            get { return (string)base[_propPredicateMethod]; }
            set { base[_propPredicateMethod] = value; }
        }
        ...
        {
            get { return (Type)base[_propPageAdapter]; }
            set { base[_propPageAdapter] = value; }
        }

        [ConfigurationProperty("", IsDefaultCollection = true)]
        public ControlElementCollection Controls
        {
            get { return (ControlElementCollection)base[_propControls]; }
        }
        ...
        internal IndividualDeviceConfig.DeviceQualifiesDelegate GetDelegate()
        {
            ...
            catch
            {
                throw new ConfigurationErrorsException(
                    SR.GetString(
                        SR.MobileControlsSectionHandler_CantCreateMethodOnClass,
                        PredicateMethod,
                        PredicateClass.FullName
                    ),
        ...
        private static void ValidateElement(object value)
        {
            ...
            if (string.IsNullOrEmpty(elem.InheritsFrom))
            {
                ...
                {
                    throw new ConfigurationErrorsException(
                        SR.GetString(SR.ConfigSect_MissingValue, "predicateClass"),
                ...
                {
                    throw new ConfigurationErrorsException(
                        SR.GetString(SR.ConfigSect_MissingValue, "pageAdapter"),
                        elem.ElementInformation.Source,
                        elem.ElementInformation.LineNumber
                    );
                }
    ...
    public sealed class ControlElementCollection : ConfigurationElementCollection
    {
        ...
        {
            get { return (ControlElement)BaseGet(name); }
        }
        public ControlElement this[int index]
        {
            get { return (ControlElement)BaseGet(index); }
            set
            {
                if (BaseGet(index) != null)
                {
    ...
    public sealed class ControlElement : ConfigurationElement
    {
        private static readonly ConfigurationElementProperty s_elemProperty =
            new ConfigurationElementProperty(
                new CallbackValidator(typeof(ControlElement), ValidateElement)
            );
        private static readonly ConfigurationValidatorBase s_SubclassTypeValidator =
            new SubclassTypeValidator(typeof(MobileControl));
        private static ConfigurationPropertyCollection _properties;
        ...
        private static readonly ConfigurationProperty _propAdapter = new ConfigurationProperty(
            "adapter",
            typeof(Type),
            null,
            MobileControlsSection.StdTypeNameConverter,
        ...
        public Type Adapter
        {
            get { return (Type)base[_propAdapter]; }
            set { base[_propAdapter] = value; }
        }
        ...
        private static void ValidateElement(object value)
        {
            ...
            Type tp =
                MobileControlsSection.StdTypeNameConverter.ConvertFromInvariantString(elem.Name)
                as Type;
        ...
        )
        {
            ...
            if (valueType == null)
            {
                throw new ArgumentException(
                    SR.GetString(
                        SR.MobileTypeNameConverter_UnsupportedValueType,
