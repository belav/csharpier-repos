...
#endif
{
    ...
    public class XhtmlControlAdapter : ControlAdapter
    {
        ...
        {
            get { return Page.Adapter as XhtmlPageAdapter; }
        }
        ...
        )
        {
            ...
            writer.Write(" href=\"");
            PageAdapter.RenderUrlPostBackEvent(
                writer,
                Control.UniqueID /* target */
                ,
                argument
            );
            writer.Write("\" ");
        ...
        protected virtual void RenderBeginLink(
            XhtmlMobileTextWriter writer,
            String target,
            String accessKey,
            Style style,
        ...
        {
            bool appendCookielessDataDictionary =
            ...
            else
            {
                ...
                // ASURT 147179
                if (
                    (String)Device["requiresAbsolutePostbackUrl"] == "true" && IsRelativeUrl(target)
                )
                {
                    String templateSourceDirectory = Page.TemplateSourceDirectory;
                    String prefix = writer.EncodeUrlInternal(
                        Page.Response.ApplyAppPathModifier(Page.TemplateSourceDirectory)
                    );
        ...
        private void RenderFormNavigationHrefValue(XhtmlMobileTextWriter writer, String target)
        {
            ...
            PageAdapter.RenderUrlPostBackEvent(
                ...
                Control.UniqueID /* target */
                ,
                form.UniqueID /* argument */
            );
        }

        private void RenderCookielessDataDictionaryInQueryString(
            XhtmlMobileTextWriter writer,
        ...
        protected virtual int SecondaryUIMode
        {
            ...
            set { ((XhtmlFormAdapter)Control.Form.Adapter).SetSecondaryUIMode(Control, value); }
        }
        ...
        protected virtual void ConditionalEnterStyle(
            XhtmlMobileTextWriter writer,
            Style style,
            String tag
        )
        ...
        protected virtual String StyleSheetLocationAttributeValue
        {
            ...
            {
                return (String)
                    Page.ActiveForm.CustomAttributes[
        ...
        protected virtual String StyleSheetStorageApplicationSetting
        {
            ...
            {
                return (String)
                    ConfigurationManager.AppSettings[XhtmlConstants.CssStateLocationAppSettingKey];
            }
        }
        ...
        protected virtual Doctype DocumentType
        {
            get
            {
                ...
                if (
                    browserCap == null
                    || !String.Equals(browserCap, "false", StringComparison.OrdinalIgnoreCase)
                )
        ...
        protected virtual StyleSheetLocation CssLocation
        {
            get
            {
                ...
                if (
                    ...
                    && StyleSheetLocationAttributeValue.Length > 0
                )
                {
                ...
                if (
                    String.Compare(
                        ...
                        XhtmlConstants.CacheStyleSheetValue,
        ...
        protected virtual void ConditionalRenderClassAttribute(XhtmlMobileTextWriter writer)
        {
            ...
            String classAttribute = (String)
                Control.CustomAttributes[XhtmlConstants.CssClassCustomAttribute];
            if (
        ...
        protected virtual void ConditionalRenderClosingSpanElement(XhtmlMobileTextWriter writer)
        {
            ...
            {
                Debug.Assert(
                    _physicalCssClassPushed,
                    "_physicalSpanClassOpen implies _physicalCssClassPushed"
                );
        ...
        protected virtual void ConditionalRenderCustomAttribute(
            XhtmlMobileTextWriter writer,
        ...
        protected virtual void RenderOpeningListTag(XhtmlMobileTextWriter writer, String tagName)
        {
            ...
            if (
                CssLocation == StyleSheetLocation.PhysicalFile
                && (String)Device[XhtmlConstants.RequiresXhtmlCssSuppression] != "true"
            )
            {
        ...
        protected virtual void ClearPendingBreakIfDeviceBreaksOnBlockLevel(
            XhtmlMobileTextWriter writer
        )
        {
        ...
        protected void RenderOffPageVariables(
            XhtmlMobileTextWriter writer,
            Control control,
            int page
        )
                ...
                foreach (Control child in control.Controls)
                {
                    ...
                    if (mobileCtl != null)
                    {
                        if (
                            ...
                            && (
                                mobileCtl
                                    == ((XhtmlFormAdapter)mobileCtl.Form.Adapter).SecondaryUIControl
                                || null
                                    == ((XhtmlFormAdapter)mobileCtl.Form.Adapter).SecondaryUIControl
                            )
                        )
            ...
            while (offset < length)
            {
                ...
                if (pos == -1)
                {
                    processedString.Append(
                        queryString.Substring(offset, queryString.Length - offset)
                    );
                    break;
                }
