    ...
    public class XhtmlFormAdapter : XhtmlControlAdapter
    {
        ...
        public override void Render(XhtmlMobileTextWriter writer)
        {
            ...
            writer.WriteAttribute(
                "method",
                Control.Method.ToString().ToLower(CultureInfo.CurrentCulture)
            );
            writer.Write(" action=\"");
            ...
            if (Control.Method != FormMethod.Get && Control.Action.Length == 0)
            { // VSWhidbey 411176: We don't include QueryStringText if Action is explicitly set
        ...
        private void RenderPostBackHeader(XhtmlMobileTextWriter writer)
        {
            ...
            if (!postBack)
            {
                writer.WriteHiddenField(
                    PageAdapter.EventSourceKey,
                    XhtmlConstants.PostedFromOtherFile
                );
            }
        ...
        )
        {
            ...
            ConditionalRenderCustomAttribute(
                writer,
