...
#endif
{
    ...
    public class XhtmlMobileTextWriter : MobileTextWriter
    {
        ...
        private static readonly XhtmlStyleClass _defaultStyleClass = new XhtmlStyleClass(
            _defaultStyle,
            XhtmlConstants.All
        );
        ...
        public virtual String CacheKey
        {
            get
            {
                ...
                if (!_cacheKeyValid)
                {
                    throw new Exception(SR.GetString(SR.XhtmlMobileTextWriter_CacheKeyNotSet));
                }
                return _cacheKey;
            }
        }
        ...
        {
            get { return _physicalCssClasses.Count > 0; }
        }
#endif
        ...
        public virtual String SessionKey
        {
            ...
            get
            {
                if (!_sessionKeyValid)
                {
                    throw new Exception(SR.GetString(SR.XhtmlMobileTextWriter_SessionKeyNotSet));
                }
                return _sessionKey;
            }
        }
        ...
        {
            get { return _supportsNoWrapStyle; }
        ...
        internal bool DiffersFromCurrentPhysicalCssClass(String cssClass)
        {
            ...
            return _physicalCssClasses.Count == 0
                || String.Compare(
                    cssClass,
                    (String)_physicalCssClasses.Peek(),
        ...
        private XhtmlStyleClass EnsureXhtmlStyleClassInHashtable(XhtmlStyleClass styleClass)
        {
            ...
            string className =
                existingClass == null ? "s" + _styleCount++ : existingClass.StyleClassName;
        ...
        public override void EnterFormat(Style style)
        {
            ...
            EnterStyleInternal(
                new XhtmlFormatStyleClass(style, filter),
                "span",
        ...
        public override void EnterLayout(Style style)
        {
            ...
            EnterStyleInternal(
                new XhtmlLayoutStyleClass(style, filter),
                "div",
                null /* no additional attributes */
                ,
                true /* force tag to be written */
            );
        }
        ...
        internal void EnterStyleInternal(
            XhtmlStyleClass styleClass,
            String styleTag,
        ...
        )
        {
            ...
            if (styleClass.Filter == StyleFilter.None && !forceTag)
            { // value comparison
                WritePendingBreak();
            ...
            if (
                ...
                && styleClass.Filter != StyleFilter.None
            )
            {
        ...
        internal string GetStyles()
        {
            ...
            string bodyStyleClassDefinition =
                _bodyStyle == null ? null : _bodyStyle.GetClassDefinition();
            if (
                bodyStyleClassDefinition != null && bodyStyleClassDefinition.Trim().Length > 0
