...
#endif
{
    ...
    public class XhtmlPageAdapter : XhtmlControlAdapter, IPageAdapter
    {
        ...
        private void ConditionalRenderLinkElement(XhtmlMobileTextWriter writer)
        {
            ...
            String cssLocation = (String)
                Page.ActiveForm.CustomAttributes[XhtmlConstants.StyleSheetLocationCustomAttribute];
            if (cssLocation != null && cssLocation.Length != 0)
            {
            ...
            else if (!writer.IsStyleSheetEmpty() && CssLocation != StyleSheetLocation.Internal)
            {
                ...
                writer.Write(
                    " href=\""
                        + XhtmlConstants.CssMappedFileName
                        + "?"
                        + XhtmlConstants.CssQueryStringName
                        + "="
                        + queryStringValue
                        + "\"/>"
                );
        ...
        )
        {
            if (
                baseCollection != null
                && baseCollection[EventSourceKey] == XhtmlConstants.PostedFromOtherFile
            )
            {
                return null;
            }
        ...
        {
            writer.UseDivsForBreaks =
                (String)Device[XhtmlConstants.BreaksOnInlineElements] == "true";
            writer.SuppressNewLine =
                (String)Device[XhtmlConstants.RequiresNewLineSuppression] == "true";
            writer.SupportsNoWrapStyle =
                (String)Device[XhtmlConstants.SupportsNoWrapStyle] != "false";
        }
        ...
        public override void Render(XhtmlMobileTextWriter writer)
        {
            ...
            writer.BeginFile(
                ...
                Page.Device.PreferredRenderingMime,
            ...
            {
                if (
                    CssLocation == StyleSheetLocation.ApplicationCache
        ...
        private void RenderOpeningBodyElement(XhtmlMobileTextWriter writer)
        {
            ...
            if (CssLocation == StyleSheetLocation.PhysicalFile)
            {
                String cssClass = (String)
                    activeForm.CustomAttributes[XhtmlConstants.CssClassCustomAttribute];
