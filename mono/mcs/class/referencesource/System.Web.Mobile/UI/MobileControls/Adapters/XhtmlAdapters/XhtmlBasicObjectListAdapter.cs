    ...
    public class XhtmlObjectListAdapter : XhtmlControlAdapter
    {
                ...
                case ObjectListViewMode.List:
                    ...
                    else
                    {
                        ...
                        catch (System.FormatException)
                        {
                            //
                            throw new Exception(
                                SR.GetString(SR.XhtmlObjectListAdapter_InvalidPostedData)
                            );
                        }
        ...
        protected virtual void RenderItemDetails(XhtmlMobileTextWriter writer, ObjectListItem item)
        {
            ...
            String backCommandText =
                (controlBCT == null || controlBCT.Length == 0)
        ...
        private void RenderItemFieldsInDetailsView(
            XhtmlMobileTextWriter writer,
            ObjectListItem item
        )
        {
        ...
        protected virtual void RenderItemsList(XhtmlMobileTextWriter writer)
        {
            ...
            for (int i = 0; i < pageSize; i++)
            {
                ...
                RenderListViewItem(
                    ...
                    fieldCount,
                    fieldIndices,
                    itemRequiresMoreButton,
                    itemRequiresHyperlink
                );
            }
            RenderRule(writer, foreColor, fieldCount + (itemRequiresMoreButton ? 1 : 0));
        ...
        private void RenderItemsListWithoutTableTags(XhtmlMobileTextWriter writer)
        {
            ...
            for (int i = startIndex; i < nextStartIndex; i++)
            {
                ...
                String itemClass = GetCustomAttributeValue(
                    item,
                ...
                if (itemRequiresMoreButton)
                {
                    ...
                    String moreText =
                        (controlMT == null || controlMT.Length == 0)
        ...
        private void RenderListViewItem(
            XhtmlMobileTextWriter writer,
            ObjectListItem item,
            int fieldCount,
            int[] fieldIndices,
            bool itemRequiresMoreButton,
            bool itemRequiresHyperlink
        )
        {
            Style style = Style;
            Style subCommandStyle = Control.CommandStyle;
        ...
        private void RenderListViewTableHeader(
            XhtmlMobileTextWriter writer,
            int fieldCount,
            int[] fieldIndices,
            bool itemRequiresMoreButton
        ...
        private void RenderRule(XhtmlMobileTextWriter writer, Color foreColor, int columnSpan)
        {
            if (
                CssLocation == StyleSheetLocation.PhysicalFile
                || Device["requiresXhtmlCssSuppression"] == "true"
            )
            {
        ...
        {
            return Control.MobilePage.ActiveForm == Control.Form
                && Control.Visible
                && (
