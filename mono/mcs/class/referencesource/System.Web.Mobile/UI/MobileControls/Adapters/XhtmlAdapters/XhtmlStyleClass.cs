...
#endif
{
    ...
    internal class XhtmlStyleClass
    {
...
#if UNUSED_CODE
        public XhtmlStyleClass(Style source, string className, StyleFilter filter)
            : this(source, filter)
        {
        ...
        private void BuildStyleClassAlignment(StringBuilder classBuilder)
        {
            ...
            if (styleAlignment != Alignment.NotSet)
            {
                classBuilder.Append(
                    "text-align: "
                        + styleAlignment.ToString().ToLower(CultureInfo.InvariantCulture)
                        + ";\r\n"
                );
            }
        }
        ...
        private void BuildStyleClassBackgroundColor(StringBuilder classBuilder)
        {
            ...
            if (styleColor != Color.Empty)
            {
                classBuilder.Append(
                    "background-color: "
                        + ColorTranslator.ToHtml(styleColor).ToLower(CultureInfo.InvariantCulture)
                        + ";\r\n"
                );
            }
        }
        ...
        protected virtual StyleFilter GetFilterInternal(Style style)
        {
            ...
            if (
                (BooleanOption)_controlStyle[Style.BoldKey, true]
                != (BooleanOption)style[Style.BoldKey, true]
            )
            {
                returnValue |= StyleFilter.Bold;
            }
            if (
                (BooleanOption)_controlStyle[Style.ItalicKey, true]
                != (BooleanOption)style[Style.ItalicKey, true]
            )
            {
                returnValue |= StyleFilter.Italic;
            }
            if (
                (String)_controlStyle[Style.FontNameKey, true]
            ...
            if (
                (FontSize)_controlStyle[Style.FontSizeKey, true]
            ...
            if (
                (Color)_controlStyle[Style.BackColorKey, true]
                != (Color)style[Style.BackColorKey, true]
            )
            { // value comparison
                returnValue |= StyleFilter.BackgroundColor;
            }
            if (
                (Color)_controlStyle[Style.ForeColorKey, true]
                != (Color)style[Style.ForeColorKey, true]
            )
            { // value comparison
            ...
            if (
                (Alignment)_controlStyle[Style.AlignmentKey, true]
            ...
            if (
                (Wrapping)_controlStyle[Style.WrappingKey, true]
                != (Wrapping)style[Style.WrappingKey, true]
            )
            {
    ...
    {
#if UNUSED_CODE
        public XhtmlFormatStyleClass(Style source, string className, StyleFilter filter)
            : base(source, className, filter) { }
#endif

        public XhtmlFormatStyleClass(Style source, StyleFilter filter)
            : base(source, filter)
        {
    ...
    {
#if UNUSED_CODE
        public XhtmlLayoutStyleClass(Style source, string className, StyleFilter filter)
            : base(source, className, filter) { }
#endif

        public XhtmlLayoutStyleClass(Style source, StyleFilter filter)
            : base(source, filter)
        {
