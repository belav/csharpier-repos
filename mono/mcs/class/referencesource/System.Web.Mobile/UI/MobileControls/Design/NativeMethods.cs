...
namespace System.Web.UI.Design.MobileControls
{
    ...
    internal class NativeMethods
    {
        ...
        internal const int OLEIVERB_PRIMARY = 0,
            OLEIVERB_SHOW = -1,
            OLEIVERB_OPEN = -2,
            OLEIVERB_HIDE = -3,
        ...
        {
            void SetAttribute(
                [In, MarshalAs(UnmanagedType.BStr)] string strAttributeName,
                [In, MarshalAs(UnmanagedType.Struct)] Object AttributeValue,
                [In, MarshalAs(UnmanagedType.I4)] int lFlags
            );

            void GetAttribute(
                [In, MarshalAs(UnmanagedType.BStr)] string strAttributeName,
                [In, MarshalAs(UnmanagedType.I4)] int lFlags,
                [Out, MarshalAs(UnmanagedType.LPArray)] Object[] pvars
            );
        ...
        internal interface IHTMLDocument2
        {
            ...
            object Open(
                ...
                [In, MarshalAs(UnmanagedType.Struct)] Object name,
                [In, MarshalAs(UnmanagedType.Struct)] Object features,
                [In, MarshalAs(UnmanagedType.Struct)] Object replace
            );
            ...
            [return: MarshalAs(UnmanagedType.Bool)]
            bool ExecCommand(
                [In, MarshalAs(UnmanagedType.BStr)] string cmdID,
                [In, MarshalAs(UnmanagedType.Bool)] bool showUI,
            ...
            IHTMLElement ElementFromPoint(
                [In, MarshalAs(UnmanagedType.I4)] int x,
                [In, MarshalAs(UnmanagedType.I4)] int y
            );
        ...
        internal interface IHTMLDocument3
        {
            ...
            void Recalc([In, MarshalAs(UnmanagedType.Bool)] bool fForce);
            ...
            [return: MarshalAs(UnmanagedType.Bool)]
            bool AttachEvent(
                [In, MarshalAs(UnmanagedType.BStr)] string ev,
                [In, MarshalAs(UnmanagedType.Interface)] object pdisp
            );
            ...
            void SetOnstop([In, MarshalAs(UnmanagedType.Struct)] Object p);
            ...
            void SetEnableDownload([In, MarshalAs(UnmanagedType.Bool)] bool p);

            [return: MarshalAs(UnmanagedType.Bool)]
            bool GetEnableDownload();

            void SetBaseUrl([In, MarshalAs(UnmanagedType.BStr)] string p);
            ...
            void SetInheritStyleSheets([In, MarshalAs(UnmanagedType.Bool)] bool p);
        ...
        internal interface IHTMLStyleSheet
        {
            ...
            [return: MarshalAs(UnmanagedType.I4)]
            int AddRule(
                [In, MarshalAs(UnmanagedType.BStr)] string bstrSelector,
        ...
        internal interface IHTMLDOMNode
        {
            ...
            IHTMLDOMNode InsertBefore(
                [In, MarshalAs(UnmanagedType.Interface)] IHTMLDOMNode newChild,
                [In, MarshalAs(UnmanagedType.Struct)] Object refChild
            );
            ...
            [return: MarshalAs(UnmanagedType.Interface)]
            IHTMLDOMNode CloneNode([In, MarshalAs(UnmanagedType.Bool)] bool fDeep);

            [return: MarshalAs(UnmanagedType.Interface)]
            IHTMLDOMNode RemoveNode([In, MarshalAs(UnmanagedType.Bool)] bool fDeep);
            ...
            IHTMLDOMNode ReplaceNode(
                [In, MarshalAs(UnmanagedType.Interface)] IHTMLDOMNode replacement
            );
        ...
        internal interface IOleClientSite
        {
            ...
            [PreserveSig]
            int GetContainer([System.Runtime.InteropServices.Out] out IOleContainer ppContainer);
        ...
        internal interface IOleInPlaceSite
        {
            ...
            [return: MarshalAs(UnmanagedType.I4)]
            [PreserveSig]
            int Scroll([In, MarshalAs(UnmanagedType.U4)] tagSIZE scrollExtant);
        ...
        internal interface IDocHostUIHandler
        {
            ...
            [return: MarshalAs(UnmanagedType.I4)]
            [PreserveSig]
            int GetExternal([Out, MarshalAs(UnmanagedType.Interface)] out object ppDispatch);
        ...
        internal interface IOleObject
        {
            ...
            [PreserveSig]
            int InitFromData(
                [In, MarshalAs(UnmanagedType.Interface)] IOleDataObject pDataObject,
        ...
        internal interface IOleDropTarget
        {
            ...
            [PreserveSig]
            int OleDragEnter(
                [In, MarshalAs(UnmanagedType.Interface)] IOleDataObject pDataObj,
                [In, MarshalAs(UnmanagedType.U4)] int grfKeyState,
                [In] POINTL pt,
                [In, Out, MarshalAs(UnmanagedType.I4)] ref int pdwEffect
            );
        ...
        internal interface IOleDataObject
        {
            ...
            int OleSetData(
                ...
                STGMEDIUM pmedium,
                [In, MarshalAs(UnmanagedType.I4)] int fRelease
            );

            [return: MarshalAs(UnmanagedType.Interface)]
            object OleEnumFormatEtc([In, MarshalAs(UnmanagedType.U4)] int dwDirection);
        ...
        internal interface IHTMLElement2
        {
            ...
            IHTMLElement ApplyElement(
                [In, MarshalAs(UnmanagedType.Interface)] IHTMLElement apply,
                [In, MarshalAs(UnmanagedType.BStr)] string @where
            );
            ...
            object GetBehavior(
                ...
                [In, MarshalAs(UnmanagedType.BStr)] string bstrUrn
            );
        }
