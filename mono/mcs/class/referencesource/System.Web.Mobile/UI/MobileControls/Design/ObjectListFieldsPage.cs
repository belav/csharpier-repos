...
namespace System.Web.UI.Design.MobileControls
{
    ...
    internal sealed class ObjectListFieldsPage : ListComponentEditorPage
    {
        ...
        {
            get { return "net.Mobile.ObjectListProperties.Fields"; }
        }
        ...
        protected override void InitForm()
        {
            ...
            _ckbAutoGenerateFields.Text = SR.GetString(
                SR.ObjectListFieldsPage_AutoGenerateFieldsCaption
            );
            ...
            lblDataFormatString.Text = SR.GetString(
                SR.ObjectListFieldsPage_DataFormatStringCaption
            );
        ...
        private void LoadDataSourceFields()
        {
            using (new LoadingModeResource(this))
            {
                ...
                IEnumerable dataSource = (
                    (IDataSourceProvider)objectListDesigner
        ...
        private class FieldTreeNode : ListTreeNode
        {
            ...
            internal FieldTreeNode(String fieldID)
                : this(fieldID, new ObjectListField()) { }
