...
*/
            ...
            IStateManager
    {
        ...
        internal ObjectListFieldCollection(ObjectList owner)
            : base(new ArrayList())
        {
            _owner = owner;
        }
        ...
        internal ObjectListFieldCollection(ObjectList owner, ArrayList fields)
            : base(fields)
        {
            _owner = owner;
        ...
        public int IndexOf(String fieldIDOrName)
        {
            ...
            foreach (ObjectListField field in fields)
            {
                ...
                if (
                    id != null
                    && String.Compare(id, fieldIDOrName, StringComparison.OrdinalIgnoreCase) == 0
                )
                {
                    return i;
                }
