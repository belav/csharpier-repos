...
namespace System.Web.Mobile
{
    ...
    {
        internal delegate bool EvaluateCapabilitiesDelegate(
        ...
        {
            result = false;
            PropertyDescriptor propertyDescriptor = TypeDescriptor.GetProperties(this)[
                evaluatorName
            ];
            ...
            bool invariantCultureIgnoreCase = (
                propertyDescriptor.PropertyType == typeof(bool) && parameter != null
            );
            StringComparison compareOption = invariantCultureIgnoreCase
        ...
        /// <include file='doc\MobileCapabilities.uex'
        // path='docs/doc[@for="MobileCapabilities.HasCapability"]/*' />
        public bool HasCapability(String delegateName, String optionalParameter)
        {
            ...
            if (String.IsNullOrEmpty(delegateName))
            {
                throw new ArgumentException(
                    SR.GetString(SR.MobCap_DelegateNameNoValue),
                    "delegateName"
                );
            }
            ...
            String hashKey =
                (
                    (currentFilters == null)
                        ? "null"
                        : currentFilters.GetHashCode().ToString(CultureInfo.InvariantCulture)
                ) + delegateName;
        ...
        /// <include file='doc\MobileCapabilities.uex'
        // path='docs/doc[@for="MobileCapabilities.MobileDeviceManufacturer"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.MobileDeviceModel"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.GatewayVersion"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.GatewayMajorVersion"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.GatewayMinorVersion"]/*' />
...
*/
        /// <include file='doc\MobileCapabilities.uex'
        // path='docs/doc[@for="MobileCapabilities.PreferredRenderingTypeHtml32"]/*' />
        public static readonly String PreferredRenderingTypeHtml32 = "html32";

        /// <include file='doc\MobileCapabilities.uex'
        // path='docs/doc[@for="MobileCapabilities.PreferredRenderingTypeWml11"]/*' />
        public static readonly String PreferredRenderingTypeWml11 = "wml11";

        /// <include file='doc\MobileCapabilities.uex'
        // path='docs/doc[@for="MobileCapabilities.PreferredRenderingTypeWml12"]/*' />
        public static readonly String PreferredRenderingTypeWml12 = "wml12";

        /// <include file='doc\MobileCapabilities.uex'
        // path='docs/doc[@for="MobileCapabilities.PreferredRenderingTypeChtml10"]/*' />
        public static readonly String PreferredRenderingTypeChtml10 = "chtml10";

/*
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.PreferredRenderingType"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.PreferredRenderingMime"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.PreferredImageMime"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.ScreenCharactersWidth"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.ScreenCharactersHeight"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.ScreenPixelsWidth"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.ScreenPixelsHeight"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.ScreenBitDepth"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.InputType"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.NumberOfSoftkeys"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.MaximumSoftkeyLabelLength"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.CanInitiateVoiceCall"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.CanSendMail"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.HasBackButton"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.RendersWmlDoAcceptsInline"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.RendersWmlSelectsAsMenuCards"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.RendersBreaksAfterWmlAnchor"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.RendersBreaksAfterWmlInput"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.RendersBreakBeforeWmlSelectAndInput"]/*' />
...
{
_rendersBreakBeforeWmlSelectAndInput =
Convert.ToBoolean(rendersBreaksBeforeWmlSelectAndInputString);
}
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.RequiresPhoneNumbersAsPlainText"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.RequiresUrlEncodedPostfieldValues"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.RequiredMetaTagNameValue"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.RendersBreaksAfterHtmlLists"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.RequiresUniqueHtmlInputNames"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.RequiresUniqueHtmlCheckboxNames"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.SupportsCss"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.HidesRightAlignedMultiselectScrollbars"]/*' />
...
{
String hidesRightAlignedMultiselectScrollbarsString =
...
{
_hidesRightAlignedMultiselectScrollbars =
Convert.ToBoolean(hidesRightAlignedMultiselectScrollbarsString);
}
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.IsMobileDevice"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.RequiresAttributeColonSubstitution"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.CanRenderOneventAndPrevElementsTogether"]/*' />
...
{
String canRenderOneventAndPrevElementsTogetherString =
...
Convert.ToBoolean(canRenderOneventAndPrevElementsTogetherString);
}
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.CanRenderInputAndSelectElementsTogether"]/*' />
...
{
String canRenderInputAndSelectElementsTogetherString =
...
{
_canRenderInputAndSelectElementsTogether =
Convert.ToBoolean(canRenderInputAndSelectElementsTogetherString);
}
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.CanRenderAfterInputOrSelectElement"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.CanRenderPostBackCards"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.CanRenderMixedSelects"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.CanCombineFormsInDeck"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.CanRenderSetvarZeroWithMultiSelectionList"]/*' />
...
{
String canRenderSetvarZeroWithMultiSelectionListString =
...
{
_canRenderSetvarZeroWithMultiSelectionList =
Convert.ToBoolean(canRenderSetvarZeroWithMultiSelectionListString);
}
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.SupportsImageSubmit"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.RequiresUniqueFilePathSuffix"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.RequiresNoBreakInFormatting"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.RequiresLeadingPageBreak"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.SupportsSelectMultiple"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.SupportsBold"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.SupportsItalic"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.SupportsFontSize"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.SupportsFontName"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.SupportsFontColor"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.SupportsBodyColor"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.SupportsDivAlign"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.SupportsDivNoWrap"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.RequiresContentTypeMetaTag"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.RequiresDBCSCharacter"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.RequiresHtmlAdaptiveErrorReporting"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.RequiresOutputOptimization"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.SupportsAccesskeyAttribute"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.SupportsInputIStyle"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.SupportsInputMode"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.SupportsIModeSymbols"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.SupportsJPhoneSymbols"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.SupportsJPhoneMultiMediaAttributes"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.MaximumRenderedPageSize"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.RequiresSpecialViewStateEncoding"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.SupportsQueryStringInFormAction"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.SupportsCacheControlMetaTag"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.SupportsUncheck"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.CanRenderEmptySelects"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.SupportsRedirectWithCookie"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.SupportsEmptyStringInCookieValue"]/*' />
...
/// <include file='doc\MobileCapabilities.uex'
path='docs/doc[@for="MobileCapabilities.DefaultSubmitButtonLimit"]/*' />
