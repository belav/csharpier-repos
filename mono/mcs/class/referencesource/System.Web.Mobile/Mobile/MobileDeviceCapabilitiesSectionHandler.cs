...
namespace System.Web.Mobile
{
    ...
    public class MobileDeviceCapabilitiesSectionHandler : IConfigurationSectionHandler
    {
        ...
        /// <internalonly/>
        Object IConfigurationSectionHandler.Create(Object parent, Object context, XmlNode node)
        {
        ...
        protected object Create(Object parent, Object context, XmlNode node)
        {
            ...
            if (
                context == null
                || context.GetType() != typeof(System.Web.Configuration.HttpConfigurationContext)
            )
            {
                return null;
            }
            ...
            foreach (XmlNode child in node.ChildNodes)
            {
                ...
                if (child.Name.Equals("filter"))
                {
                    ...
                    if (className != null)
                    {
                        ...
                        String methodName = helper.RemoveStringAttribute(
                            methodAttributeName,
                            false
                        );
                        ...
                        if (className == String.Empty)
                        {
                            throw new ConfigurationErrorsException(
                                SR.GetString(SR.DevCapSect_EmptyClass),
                                child
                            );
                        }
                        ...
                        {
                            throw new ConfigurationErrorsException(
                                SR.GetString(SR.ConfigSect_MissingAttr, methodAttributeName),
                                child
                            );
                        }
                        ...
                        {
                            throw new ConfigurationErrorsException(
                                SR.GetString(SR.ConfigSect_MissingValue, methodAttributeName),
                                child
                            );
                        }
                        ...
                        {
                            String msg = SR.GetString(SR.DevCapSect_NoTypeInfo, className);
                            throw new ConfigurationErrorsException(msg, child);
                        }
                        ...
                        catch (Exception e)
                        {
                            String msg = SR.GetString(
                                SR.DevCapSect_NoCapabilityEval,
                                methodName,
                                e.Message
                            );
                            throw new ConfigurationErrorsException(msg, child);
                    ...
                    else
                    {
                        ...
                        try
                        {
                            currentFilterDictionary.AddComparisonDelegate(
                                name,
                                capabilityName,
                                argumentValue
                            );
                        ...
                        {
                            String msg = SR.GetString(
                                SR.DevCapSect_UnableAddDelegate,
                                name,
                                e.Message
                            );
                            throw new ConfigurationErrorsException(msg, child);
                ...
                {
                    String msg = SR.GetString(SR.DevCapSect_UnrecognizedTag, child.Name);
                    throw new ConfigurationErrorsException(msg, child);
                }
