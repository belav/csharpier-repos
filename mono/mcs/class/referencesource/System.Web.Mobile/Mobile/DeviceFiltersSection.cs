...
namespace System.Web.Mobile
{
    ...
    public sealed class DeviceFiltersSection : ConfigurationSection
    {
        ...
        private static readonly ConfigurationProperty _propFilters = new ConfigurationProperty(
            null,
        ...
        {
            get { return (DeviceFilterElementCollection)base[_propFilters]; }
        }
        ...
        private DeviceFilterDictionary CreateDeviceFilters()
        {
            ...
            foreach (DeviceFilterElement deviceFilter in Filters)
            {
                ...
                {
                    filterDictionary.AddCapabilityDelegate(
                        deviceFilter.Name,
                        deviceFilter.GetDelegate()
                    );
                }
                else
                {
                    try
                    {
                        filterDictionary.AddComparisonDelegate(
                            deviceFilter.Name,
                            deviceFilter.Compare,
                            deviceFilter.Argument
                        );
                    }
                    catch (Exception e)
                    {
    ...
    public sealed class DeviceFilterElementCollection : ConfigurationElementCollection
    {
        ...
        {
            get { return (DeviceFilterElement)BaseGet(name); }
        }

        public DeviceFilterElement this[int index]
        {
            get { return (DeviceFilterElement)BaseGet(index); }
            set
            {
    ...
    public sealed class DeviceFilterElement : ConfigurationElement
    {
        private static readonly ConfigurationElementProperty s_elemProperty =
            new ConfigurationElementProperty(
                new CallbackValidator(typeof(DeviceFilterElement), ValidateElement)
            );
        private static ConfigurationPropertyCollection _properties;
        ...
        private static readonly ConfigurationProperty _propFilterClass = new ConfigurationProperty(
            "type",
            typeof(Type),
            null,
        ...
        private static readonly ConfigurationProperty _propMethod = new ConfigurationProperty(
            "method",
            typeof(string),
            null,
            null,
        ...
        private static readonly ConfigurationProperty _propCompare = new ConfigurationProperty(
            "compare",
            typeof(string),
            null,
            null,
        ...
        private static readonly ConfigurationProperty _propArgument = new ConfigurationProperty(
            "argument",
            typeof(string),
            null,
            null,
        ...
        {
            get { return (Type)base[_propFilterClass]; }
            set { base[_propFilterClass] = value; }
        }
        ...
        {
            get { return (string)base[_propMethod]; }
            set { base[_propMethod] = value; }
        }
        ...
        {
            get { return (string)base[_propCompare]; }
            set { base[_propCompare] = value; }
        }
        ...
        {
            get { return (string)base[_propArgument]; }
            set { base[_propArgument] = value; }
        }
        ...
        private static void ValidateElement(object value)
        {
            ...
            if (elem.FilterClass != null)
            {
                ...
                {
                    throw new ConfigurationErrorsException(
                        SR.GetString(SR.DevCapSect_ExtraCompareDelegator)
                    );
                }
                else if (!string.IsNullOrEmpty(elem.Argument))
                {
                    throw new ConfigurationErrorsException(
                        SR.GetString(SR.DevCapSect_ExtraArgumentDelegator)
                    );
                }
            ...
            else
            {
                if (string.IsNullOrEmpty(elem.Compare))
                {
                    throw new ConfigurationErrorsException(SR.GetString(SR.DevCapSect_MustSpecify));
                }
