...
namespace System.Web
{
    ...
    internal sealed class AspNetSynchronizationContext : AspNetSynchronizationContextBase
    {
        ...
        {
            get { return _state.AllowAsyncDuringSyncStages; }
            set { _state.AllowAsyncDuringSyncStages = value; }
        }
        ...
        [SuppressMessage(
            ...
            Justification = "Used only during debug."
        )]
        internal override void AssociateWithCurrentThread()
        {
            ...
            disassociationAction = new DisposableAction(() =>
            {
                Debug.Assert(
                    ...
                    String.Format(
                        "AssociateWithCurrentThread was called on thread ID '{0}', but DisassociateFromCurrentThread was called on thread ID '{1}'.",
        ...
        internal override void DisassociateFromCurrentThread()
        {
            ...
            Debug.Assert(
                _state.SyncControlDisassociationActions.Count > 0,
                "DisassociateFromCurrentThread() was called on a thread which hadn't previously called AssociateWithCurrentThread()."
            );
        ...
        public override void OperationStarted()
        {
            ...
            if (!AllowAsyncDuringSyncStages && !_state.AllowVoidAsyncOperations)
            {
                InvalidOperationException ex = new InvalidOperationException(
                    SR.GetString(SR.Async_operation_cannot_be_started)
                );
                throw ex;
            }
        ...
        internal override void ProhibitVoidAsyncOperations()
        {
            ...
            if (
                ...
                && Volatile.Read(ref _state.VoidAsyncOutstandingOperationCount) > 0
            )
            {
                InvalidOperationException ex = new InvalidOperationException(
                    SR.GetString(SR.Async_operation_cannot_be_pending)
                );
        ...
        private sealed class State
        {
            ...
            internal Stack<IDisposable> SyncControlDisassociationActions = new Stack<IDisposable>(
                capacity: 1
            );
