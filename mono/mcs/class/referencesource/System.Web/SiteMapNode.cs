    ...
    public class SiteMapNode : ICloneable, IHierarchyData, INavigateUIData
    {
            ...
            set
            {
                if (_readonly)
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.SiteMapNode_readonly, "Attributes")
                    );
                }
        ...
        public virtual string this[string key]
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.SiteMapNode_readonly, "Item")
                    );
                }
        ...
        public virtual SiteMapNodeCollection ChildNodes
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.SiteMapNode_readonly, "ChildNodes")
                    );
                }
        ...
        public virtual string Description
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.SiteMapNode_readonly, "Description")
                    );
                }
        ...
        public virtual SiteMapNode ParentNode
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.SiteMapNode_readonly, "ParentNode")
                    );
                }
        ...
        public String ResourceKey
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.SiteMapNode_readonly, "ResourceKey")
                    );
                }
        ...
        public IList Roles
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.SiteMapNode_readonly, "Roles")
                    );
                }
        ...
        public virtual string Title
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.SiteMapNode_readonly, "Title")
                    );
                }
        ...
        public virtual string Url
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.SiteMapNode_readonly, "Url")
                    );
                }
        ...
        )
        {
            ...
            if (_resourceKeys != null)
            {
                ...
                if (keys != null && keys.Length > 1)
                {
                    ...
                    {
                        text =
                            ResourceExpressionBuilder.GetGlobalResourceObject(keys[0], keys[1])
                            as string;
                    }
        ...
        protected string GetImplicitResourceString(string attributeName)
        {
            ...
            if (!String.IsNullOrEmpty(_resourceKey))
            {
                ...
                {
                    text =
                        ResourceExpressionBuilder.GetGlobalResourceObject(
                            Provider.ResourceKey,
                            ResourceKey + "." + attributeName
                        ) as String;
                }
                catch { }
            }
