...
namespace System.Web.Compilation
{
    ...
    public sealed class CompilerType
    {
        ...
        [SuppressMessage(
            ...
            Justification = "This is used on codeDomProviderTypes which are not com types."
        )]
        ...
        public override bool Equals(Object o)
        {
            ...
            return _codeDomProviderType == other._codeDomProviderType
                ...
                && _compilParams.IncludeDebugInformation
                    == other._compilParams.IncludeDebugInformation
        ...
        {
            return CreateAssemblyBuilder(
                compConfig,
                referencedAssemblies,
                null /*generatedFilesDir*/
                ,
        ...
        )
        {
            ...
            {
                return new CbmCodeGeneratorBuildProviderHost(
                    compConfig,
                    referencedAssemblies,
                    this,
                    generatedFilesDir,
        ...
        {
            return GetDefaultAssemblyBuilder(
                compConfig,
                referencedAssemblies,
                configPath,
                null /*generatedFilesDir*/
        ...
        )
        {
            ...
            return ctwp.CreateAssemblyBuilder(
                compConfig,
                referencedAssemblies,
                generatedFilesDir,
                outputAssemblyName
