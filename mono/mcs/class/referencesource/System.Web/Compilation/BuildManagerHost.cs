...
namespace System.Web.Compilation
{
    ...
    internal class BuildManagerHost : MarshalByRefObject, IRegisteredObject
    {
        ...
        {
            get { return HostingEnvironment.ApplicationHostInternal; }
        }
        ...
        internal void RegisterAssembly(String assemblyName, String assemblyLocation)
        {
            Debug.Trace(
                "BuildManagerHost",
                "RegisterAssembly '" + assemblyName + "','" + assemblyLocation + "'"
            );
        ...
        [PermissionSet(SecurityAction.Assert, Unrestricted = true)]
        internal void GetCodeDirectoryInformation(
            VirtualPath virtualCodeDir,
        ...
        )
        {
            ...
            try
            {
                ...
                _buildManager.GetCodeDirectoryInformation(
                    virtualCodeDir,
                    out codeDomProviderType,
                    out compParams,
        ...
        internal void GetCompilerParams(
        ...
        )
        {
            ...
            try
            {
                ...
                GetCompilerParamsAndBuildProvider(
                    virtualPath,
                    out codeDomProviderType,
                    out compParams
                );
        ...
        internal string[] GetCompiledTypeAndAssemblyName(
            VirtualPath virtualPath,
            ClientBuildManagerCallback callback
        )
        {
            ...
            try
            {
                if (!virtualPath.DirectoryExists())
                {
                    throw new ArgumentException(
                        SR.GetString(
                            SR.GetGeneratedSourceFile_Directory_Only,
        ...
        internal string GetGeneratedFileVirtualPath(string filePath)
        {
            ...
            try
            {
                ...
                Dictionary<String, String>.Enumerator e = BuildManager.GenerateFileTable
                    .GetEnumerator();
                while (e.MoveNext())
                {
        ...
        )
        {
            ...
            try
            {
                ...
                {
                    CodeDomProvider codeProvider = CompilationUtil.CreateCodeDomProvider(
                        codeDomProviderType
                    );
        ...
        )
        {
            ...
            try
            {
                ...
                string cacheKey =
                    BuildManager.GetCacheKeyFromVirtualPath(virtualPath) + "_CBMResult";
                BuildResultCodeCompileUnit result = (BuildResultCodeCompileUnit)
                    BuildManager.GetBuildResultFromCache(cacheKey, virtualPath);
                ...
                if (result == null)
                {
                    lock (_lock)
                    {
                        ...
                        CodeCompileUnit ccu = internalBuildProvider.GetCodeCompileUnit(
                            out linePragmasTable
                        );
                        ...
                        if (ccu != null)
                        {
                            ...
                            foreach (
                                String assemblyString in compilerParameters.ReferencedAssemblies
                            )
                            {
        ...
        private void FixupReferencedAssemblies(
            VirtualPath virtualPath,
            CompilerParameters compilerParameters
        )
        {
            ...
            Util.AddAssembliesToStringCollection(
                referencedAssemblies,
                compilerParameters.ReferencedAssemblies
            );
        }

        private BuildProvider GetCompilerParamsAndBuildProvider(
            VirtualPath virtualPath,
            out Type codeDomProviderType,
            out CompilerParameters compilerParameters
        )
        {
            ...
            if (
                StringUtil.EqualsIgnoreCase(
                    virtualPath.VirtualPathString,
                    BuildManager.GlobalAsaxVirtualPath.VirtualPathString
                )
            )
            {
            ...
            {
                buildProvider = BuildManager.CreateBuildProvider(
                    virtualPath,
                    compConfig,
                    referencedAssemblies,
                    true /*failIfUnknown*/
            ...
            try
            {
                ...
                if (_client.CBMTypeDescriptionProviderBridge != null)
                {
                    TargetFrameworkUtil.CBMTypeDescriptionProviderBridge =
                        _client.CBMTypeDescriptionProviderBridge;
                }
                ...
                HttpRuntime.AppDomainShutdown += new BuildManagerHostUnloadEventHandler(
                    this.OnAppDomainShutdown
                );
            }
            finally
            {
        ...
        {
            get { return HostingEnvironment.InitializationException; }
        }
        ...
        internal bool UnloadAppDomain()
        {
            ...
            return HttpRuntime.ShutdownAppDomain(
                ApplicationShutdownReason.UnloadAppDomainCalled,
                "CBM called UnloadAppDomain"
            );
        }
        ...
        internal class ClientVirtualPathProvider : VirtualPathProvider
        {
            ...
            public override VirtualFile GetFile(string virtualPath)
            {
                ...
                return _virtualFileString != null
                    ? new ClientVirtualFile(virtualPath, _virtualFileString)
