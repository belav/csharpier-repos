...
namespace System.Web.Compilation
{
    ...
    internal abstract class BaseTemplateCodeDomTreeGenerator : BaseCodeDomTreeGenerator
    {
        ...
        protected static readonly string templateSourceDirectoryName =
        ...
        private CodeStatement GetOutputWriteStatement(CodeExpression expr, bool encode)
        {
            ...
            methodInvoke.Method.TargetObject = new CodeArgumentReferenceExpression(
        ...
        {
            CodeStatement outputWriteStmt = GetOutputWriteStatement(
                expr,
                false /*encode*/
            );
            if (linePragma != null)
        ...
        private static void BuildAddParsedSubObjectStatement(
            ...
            ref bool gotParserVariable
        )
        {
            if (!gotParserVariable)
            {
                // e.g. IParserAccessor __parser = ((IParserAccessor)__ctrl);
                CodeVariableDeclarationStatement parserDeclaration =
            ...
            CodeMethodInvokeExpression methCallExpression = new CodeMethodInvokeExpression(
                new CodeVariableReferenceExpression("__parser"),
                "AddParsedSubObject"
            );
            methCallExpression.Parameters.Add(ctrlToAdd);
            CodeExpressionStatement methCallStatement = new CodeExpressionStatement(
                methCallExpression
            );
        ...
        )
        {
            ...
            container.AddService(
                ...
                HttpCapabilitiesBase.EmptyHttpCapabilitiesBase
            );
                ...
                if (builder.ControlType != null)
                {
                    ...
                    else
                    {
                        PartialCachingAttribute cacheAttrib = (PartialCachingAttribute)
                            TypeDescriptor.GetAttributes(builder.ControlType)[
                        ...
                        else
                        {
                            ...
                            method.ReturnType = CodeDomUtility.BuildGlobalCodeTypeReference(
                                builder.ControlType
                            );
                        }
                    }
        ...
        [SuppressMessage(
            ...
            Justification = "This is used for caching - it's ok to supress."
        )]
        ...
        )
        {
            ...
            {
                CodeTypeReference ctrlTypeRef = CodeDomUtility.BuildGlobalCodeTypeReference(
                    ctrlType
                );
                ...
                if (!builder.IsGeneratedID)
                {
                    ...
                    CodeFieldReferenceExpression ctrlNameExpr = new CodeFieldReferenceExpression(
                        new CodeThisReferenceExpression(),
                        builder.ID
                    );

                    // e.g. {{controlName}} = __ctrl;
                    CodeAssignStatement underscoreCtlSet = new CodeAssignStatement(
                        ctrlNameExpr,
                        ctrlRefExpr
                    );
                ...
                if (
                    topLevelControlInTemplate && !typeof(TemplateControl).IsAssignableFrom(ctrlType)
                )
                {
                ...
                if (fStandardControl)
                {
                    ...
                    if (builder.SkinID != null)
                    {
                        ...
                        set.Left = new CodePropertyReferenceExpression(
                            ctrlRefExpr,
                            skinIDPropertyName
                        );
                    ...
                    if (ThemeableAttribute.IsTypeThemeable(ctrlType))
                    {
                        ...
                        CodeMethodInvokeExpression applyStyleSheetExpr =
                            new CodeMethodInvokeExpression(ctrlRefExpr, applyStyleSheetMethodName);
                ...
                foreach (TemplatePropertyEntry pseSub in builder.TemplatePropertyEntries)
                {
                    ...
                    if (pseSub.BindableTemplate)
                    {
                        ...
                        if (pseSub.Builder.HasTwoWayBoundProperties)
                        {
                            ...
                            ((CodeDelegateCreateExpression)newExtractValuesDelegate).DelegateType =
                            ...
                            ((CodeDelegateCreateExpression)newExtractValuesDelegate).TargetObject =
                                new CodeThisReferenceExpression();
                            ((CodeDelegateCreateExpression)newExtractValuesDelegate).MethodName =
                                extractTemplateValuesMethodPrefix + controlName;
                        }
                        else
                        {
                        ...
                        newExpr = new CodeObjectCreateExpression(
                            typeof(CompiledBindableTemplateBuilder)
                        );
            ...
            if (
                typeof(UserControl).IsAssignableFrom(ctrlType)
                && fControlFieldDeclared
                && !fControlSkin
            )
            {
            ...
            {
                string templateName = (
                    (System.Web.UI.WebControls.ContentPlaceHolderBuilder)builder
                ).Name;
                autoTemplateName = MasterPageControlBuilder.AutoTemplatePrefix + templateName;

                Debug.Assert(
                    autoTemplateName != null && autoTemplateName.Length > 0,
                ...
                CodeAttributeDeclarationCollection attrDeclarations =
                    new CodeAttributeDeclarationCollection();

                CodeAttributeDeclaration templateContainerAttrDeclaration =
                ...
                {
                    CodeAttributeDeclaration templateInstanceAttrDeclaration =
                        new CodeAttributeDeclaration(
                ...
                if (builder is System.Web.UI.WebControls.ContentPlaceHolderBuilder)
                {
                    ...
                    setStatement.Right = new CodeCastExpression(
                        typeof(ITemplate),
                    ...
                    CodeBinaryOperatorExpression contentNullCheckExpr =
                    ...
                    CodeMethodInvokeExpression removeExpr = new CodeMethodInvokeExpression(
                        contentTemplatesFieldRef,
                        "Remove"
                    );
                ...
                {
                    instantiateTemplateExpr = new CodeMethodInvokeExpression(
                        new CodeThisReferenceExpression(),
                        "InstantiateInContentPlaceHolder"
                    );
                ...
                templateIfStmt.Condition = new CodeBinaryOperatorExpression(
                    templateFieldRef,
                    CodeBinaryOperatorType.IdentityInequality,
                    new CodePrimitiveExpression(null)
                );
            ...
            if (builder is FileLevelPageControlBuilder)
            {
                contentBuilderEntries = (
                    (FileLevelPageControlBuilder)builder
                ).ContentBuilderEntries;
                ...
                if (contentBuilderEntries != null)
                {
                    ...
                    foreach (TemplatePropertyEntry entry in contentBuilderEntries)
                    {
                        ...
                        CodeDelegateCreateExpression newDelegate =
                            new CodeDelegateCreateExpression();
                        newDelegate.DelegateType = new CodeTypeReference(
                        ...
                        // e.g.     new BuildTemplateMethod(this.__BuildControl {{controlName}}));
                        CodeObjectCreateExpression cocExpr = new CodeObjectCreateExpression(
                            typeof(CompiledTemplateBuilder)
                        );
                        cocExpr.Parameters.Add(newDelegate);

                        CodeMethodInvokeExpression cmiExpression = new CodeMethodInvokeExpression(
                            new CodeThisReferenceExpression(),
                            "AddContentTemplate"
                        );
                        cmiExpression.Parameters
            ...
            else if (builder.SubBuilders != null)
            {
                ...
                {
                    if (
                        child is ControlBuilder
                        && !(child is CodeBlockBuilder)
                        && !(child is CodeStatementBuilder)
                        && !(child is System.Web.UI.WebControls.ContentBuilderInternal)
                    )
                    {
                        ...
                        if (fControlSkin)
                        {
                            throw new HttpParseException(
                                SR.GetString(SR.ControlSkin_cannot_contain_controls),
                                null,
                                builder.VirtualPath,
                                null,
                                builder.Line
                        ...
                        PartialCachingAttribute cacheAttrib = (PartialCachingAttribute)
                            TypeDescriptor.GetAttributes(ctrlBuilder.ControlType)[
                                typeof(PartialCachingAttribute)
                            ];
                        ...
                        if (cacheAttrib == null)
                        {
                            string localVariableRef =
                                _localVariableRef
                                + (localVarIndex++).ToString(CultureInfo.InvariantCulture);

                            // Variable reference to the local control variable
                            CodeVariableReferenceExpression childCtrlRefExpr =
                                new CodeVariableReferenceExpression(localVariableRef);
                            ...
                            CodeAssignStatement setCtl = new CodeAssignStatement(
                                childCtrlRefExpr,
                                methCallExpression
                            );
                            setCtl.LinePragma = linePragma;
                        ...
                        else
                        {
                            ...
                            call.Method.TargetObject = new CodeTypeReferenceExpression(
                                typeof(System.Web.UI.StaticPartialCachingControl)
                            );
                            ...
                            if (cacheAttrib.Shared)
                            {
                                ...
                                call.Parameters
                                    .Add(new CodePrimitiveExpression(Guid.NewGuid().ToString()));
                            call.Parameters.Add(new CodePrimitiveExpression(cacheAttrib.Duration));
                            call.Parameters
                                .Add(new CodePrimitiveExpression(cacheAttrib.VaryByParams));
                            call.Parameters
                                .Add(new CodePrimitiveExpression(cacheAttrib.VaryByControls));
                            call.Parameters
                                .Add(new CodePrimitiveExpression(cacheAttrib.VaryByCustom));
                            call.Parameters
                                .Add(new CodePrimitiveExpression(cacheAttrib.SqlDependency));
                            CodeDelegateCreateExpression newDelegate =
                                new CodeDelegateCreateExpression();
                        ...
                        if (!fControlSkin || !builder.AllowWhitespaceLiterals())
                        {
                            ...
                            else
                            {
                                ...
                                int offset,
                                    size;
                                bool fAsciiOnly;
                                _stringResourceBuilder.AddString(
                                    s,
                                    out offset,
                                    out size,
                                    out fAsciiOnly
                                ...
                                methCallExpression = new CodeMethodInvokeExpression();
                                methCallExpression.Method.TargetObject =
                                    new CodeThisReferenceExpression();
            ...
            if (builder.ComplexPropertyEntries.Count > 0)
            {
                ...
                foreach (ComplexPropertyEntry pseSub in builder.ComplexPropertyEntries)
                {
                    ...
                    if (pseSub.Builder is StringPropertyBuilder)
                    {
                        ...
                        CodeAssignStatement setStatment = new CodeAssignStatement(
                            leftExpr,
                            rightExpr
                        );
                    ...
                    if (pseSub.ReadOnly)
                    {
                        if (
                            fControlSkin
                            && pseSub.Builder != null
                            && pseSub.Builder is CollectionBuilder
                        ...
                        )
                        {
                            ...
                            {
                                CodeMethodReferenceExpression refExpr =
                                    new CodeMethodReferenceExpression();
                                refExpr.MethodName = "Clear";
                                refExpr.TargetObject = new CodePropertyReferenceExpression(
                                    ctrlRefExpr,
                                    pseSub.Name
                                );
                                CodeMethodInvokeExpression invokeClearExpr =
            ...
            if (builder.BoundPropertyEntries.Count > 0)
            {
                ...
                if (hasDataBindingEntry)
                {
                    ...
                    newDelegate.TargetObject = new CodeThisReferenceExpression();
                    newDelegate.MethodName = GetExpressionBuilderMethodName(
                        eventInfo.Name,
                        builder
                    );
            ...
            if (builder.EventEntries.Count > 0)
            {
                foreach (EventEntry eventEntry in builder.EventEntries)
                {
                    ...
                    {
                        CodeRemoveEventStatement detachEvent = new CodeRemoveEventStatement(
                            ctrlRefExpr,
                            eventEntry.Name,
                            newDelegate
                        );
        ...
        protected void BuildExtractMethod(ControlBuilder builder)
        {
            ...
            if (bindableTemplateBuilder != null && bindableTemplateBuilder.HasTwoWayBoundProperties)
            {
                ...
                CodeObjectCreateExpression newTableExpression = new CodeObjectCreateExpression(
                    typeof(OrderedDictionary)
                );
                CodeAssignStatement newTableAssign = new CodeAssignStatement(
                    new CodeVariableReferenceExpression(tableVarName),
                    newTableExpression
                );
                newTableAssign.LinePragma = linePragma;
                statements.Add(newTableAssign);

                BuildExtractStatementsRecursive(
        ...
        private void BuildExtractStatementsRecursive(
                ...
                if (controlBuilder != null)
                {
                    ...
                    foreach (BoundPropertyEntry entry in controlBuilder.BoundPropertyEntries)
                    {
                        ...
                        if (newControl)
                        {
                            ...
                            // eg. TextBox t1;
                            CodeVariableDeclarationStatement controlDecl =
                                new CodeVariableDeclarationStatement(
                                    entry.ControlType,
                                    entry.ControlID
                                );
                            ...
                            CodeMethodInvokeExpression findControlCallExpression =
                                new CodeMethodInvokeExpression(
                                    new CodeVariableReferenceExpression(containerVarName),
                                    "FindControl"
                                );
                            string findControlParameter = entry.ControlID;
                            findControlCallExpression.Parameters
                            ...
                            CodeAssignStatement findControlAssign = new CodeAssignStatement(
                                new CodeVariableReferenceExpression(entry.ControlID),
                                castExpression
                            );
                        ...
                        CodeBinaryOperatorExpression ensureControlExpression =
                            new CodeBinaryOperatorExpression();
                        ensureControlExpression.Operator =
                            CodeBinaryOperatorType.IdentityInequality;
                        ensureControlExpression.Left = new CodeVariableReferenceExpression(
                            entry.ControlID
                        );
                        ...
                        CodeIndexerExpression tableIndexer = new CodeIndexerExpression(
                            new CodeVariableReferenceExpression(tableVarName),
                        ...
                        CodeExpression controlPropertyExpression =
                            CodeDomUtility.BuildPropertyReferenceExpression(
                                new CodeVariableReferenceExpression(entry.ControlID),
                                entry.Name
                            );
                        if (_usingVJSCompiler)
                        {
                            controlPropertyExpression = CodeDomUtility.BuildJSharpCastExpression(
                                entry.Type,
                                controlPropertyExpression
                            );
                        }
                        CodeAssignStatement tableIndexAssign = new CodeAssignStatement(
                            tableIndexer,
                            controlPropertyExpression
                        );
        ...
        private void BuildFieldDeclaration(ControlBuilder builder)
        {
                ...
                if (memberType != null)
                {
                    if (!memberType.IsAssignableFrom(builder.ControlType))
                    {
                        ...
                        else
                        {
                            throw new HttpParseException(
                                SR.GetString(
                                    SR.Base_class_field_with_type_different_from_type_of_control,
                                    builder.ID,
                                    memberType.FullName,
                                    builder.ControlType.FullName
                                ),
            ...
            CodeMemberField field = new CodeMemberField(
                CodeDomUtility.BuildGlobalCodeTypeReference(builder.DeclareType),
                builder.ID
            );
        ...
        )
        {
            ...
            if (builder is DataBoundLiteralControlBuilder)
            {
                ...
                // {{controlType}} target;
                CodeVariableDeclarationStatement targetDecl = new CodeVariableDeclarationStatement(
                    builder.ControlType,
                    "target"
                );
                Type bindingContainerType = builder.BindingContainerType;

                CodeVariableDeclarationStatement containerDecl =
                    new CodeVariableDeclarationStatement(bindingContainerType, "Container");

                topMethodStatements.Add(containerDecl);
                topMethodStatements.Add(targetDecl);

                // target = ({{controlType}}) sender;
                CodeAssignStatement setTarget = new CodeAssignStatement(
                    new CodeVariableReferenceExpression(targetDecl.Name),
                ...
                CodeAssignStatement setContainer = new CodeAssignStatement(
                    new CodeVariableReferenceExpression(containerDecl.Name),
                    new CodeCastExpression(
                ...
                DataBindingExpressionBuilder.GenerateItemTypeExpressions(
                    builder,
                    topMethodStatements,
                ...
                foreach (object child in builder.SubBuilders)
                {
                    ...
                    if (_designerMode)
                    {
                        tempObjectVariableDeclared = GenerateSimpleAssignmentAtDesignTime(
                            tempObjectVariableDeclared,
                            topMethodStatements,
                            otherMethodStatements,
                            codeBlock.Content,
                            CreateCodeLinePragma(codeBlock)
                        );
                        continue;
                    }
                    ...
                    CodeStatement setDataBoundStringCall = new CodeExpressionStatement(
                        methCallExpression
                    );
            ...
            else
            {
                ...
                foreach (BoundPropertyEntry entry in builder.BoundPropertyEntries)
                {
                    ...
                    if (firstEntry)
                    {
                        ...
                        DataBindingExpressionBuilder.BuildExpressionSetup(
                            builder,
                            topStatements,
                            otherStatements,
                            linePragma,
                    ...
                    {
                        int generatedColumn =
                            tempObjectVariable.Length
                            + BaseCodeDomTreeGenerator.GetGeneratedColumnOffset(_codeDomProvider);
                        CodeLinePragma codeLinePragma = CreateCodeLinePragma(
                            virtualPath: builder.PageVirtualPath,
                            lineNumber: entry.Line,
                            column: entry.Column,
                            generatedColumn: generatedColumn,
                            codeLength: entry.Expression.Length
                        );
                        tempObjectVariableDeclared = GenerateSimpleAssignmentAtDesignTime(
                            tempObjectVariableDeclared,
                            topStatements,
                    ...
                    {
                        Debug.Assert(
                            !entry.ReadOnlyProperty,
                            "We should not attempt to build a data binding handler if the two way entry is read only."
                        );
                        Debug.Assert(
                            !entry.UseSetAttribute,
                            "Two-way binding is not supported on expandos - this should have been prevented in ControlBuilder"
                        );
                        DataBindingExpressionBuilder.BuildEvalExpression(
                            entry.FieldName,
                            entry.FormatString,
                            entry.Name,
                            entry.Type,
                    ...
                    {
                        DataBindingExpressionBuilder.BuildExpressionStatic(
                            entry,
                            builder,
                            null,
                            topStatements,
            ...
            if (builder.SubBuilders != null)
            {
                ...
                for (int i = 0; en.MoveNext(); i++)
                {
                    ...
                    else if (child is CodeBlockBuilder)
                    {
                        ...
                        if (
                            codeBlockBuilder.BlockType == CodeBlockType.Expression
                            || codeBlockBuilder.BlockType == CodeBlockType.EncodedExpression
                        )
                        {
                            ...
                            _codeDomProvider.GenerateCodeFromStatement(
                                outputWrite,
                                w,
                                null /*CodeGeneratorOptions*/
                            );
                    ...
                    else if (child is CodeStatementBuilder)
                    {
                        ...
                        CodeStatement statement = statementBuilder.BuildStatement(
                    ...
                    else if (child is ControlBuilder)
                    {
                        ...
                        CodeMethodInvokeExpression methodInvoke = new CodeMethodInvokeExpression();
                        CodeExpressionStatement methodCall = new CodeExpressionStatement(
                            methodInvoke
                        );
                        methodInvoke.Method.TargetObject = new CodeIndexerExpression(
                            new CodePropertyReferenceExpression(
                                new CodeArgumentReferenceExpression("parameterContainer"),
                                "Controls"
                            ),
                            new CodeExpression[] { new CodePrimitiveExpression(controlIndex++) }
                        );
        ...
        private bool GenerateSimpleAssignmentAtDesignTime(
            bool tempObjectVariableDeclared,
            CodeStatementCollection topMethodStatements,
            CodeStatementCollection otherMethodStatements,
            string content,
            CodeLinePragma linePragma
        )
        {
            ...
            if (!tempObjectVariableDeclared)
            {
                ...
                // object __o;
                topMethodStatements.Add(
                    new CodeVariableDeclarationStatement(typeof(object), tempObjectVariable)
                );
            }
        ...
        )
        {
                ...
                foreach (object child in builder.SubBuilders)
                {
                    if (child is ControlBuilder)
                    {
                        ...
                        bool isTopLevelCtrlInTemplate =
                            fTemplate
                            && typeof(Control).IsAssignableFrom(((ControlBuilder)child).ControlType)
                            && !(builder is RootBuilder);
                        BuildSourceDataTreeFromBuilder(
                            (ControlBuilder)child,
                            fInTemplate,
                            isTopLevelCtrlInTemplate,
                            null
                        );
                    }
                }
            ...
            foreach (TemplatePropertyEntry entry in builder.TemplatePropertyEntries)
            {
                ...
                BuildSourceDataTreeFromBuilder(
                    ((TemplatePropertyEntry)entry).Builder,
                    inTemplate,
                    false /*topLevelControlInTemplate*/
                    ,
                    entry
                );
            }
            ...
            foreach (ComplexPropertyEntry entry in builder.ComplexPropertyEntries)
            {
                ...
                {
                    BuildSourceDataTreeFromBuilder(
                        ((ComplexPropertyEntry)entry).Builder,
                        fInTemplate,
                        false /*topLevelControlInTemplate*/
                        ,
                        entry
        ...
        internal virtual CodeExpression BuildStringPropertyExpression(PropertyEntry pse)
        {
            ...
            return CodeDomUtility.GenerateExpressionForValue(
                pse.PropertyInfo,
                value,
                typeof(string)
            );
        ...
        private void HandleDeviceFilterConditional(
            ref PropertyEntry previous,
            PropertyEntry current,
        ...
        {
            bool sameAsPrevious =
                (previous != null) && StringUtil.EqualsIgnoreCase(previous.Name, current.Name);
