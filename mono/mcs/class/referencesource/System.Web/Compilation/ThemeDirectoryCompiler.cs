...
namespace System.Web.Compilation
{
    ...
    internal static class ThemeDirectoryCompiler
    {
        ...
        internal static BuildResultCompiledType GetThemeBuildResultType(
            HttpContext context,
            string themeName
        )
        {
        ...
        {
            string appThemeCacheKey,
                globalThemeCacheKey = null;
            ...
            if (result == null)
            {
                ...
                result = (BuildResultCompiledType)
                    BuildManager.GetBuildResultFromCache(globalThemeCacheKey);
            }
            ...
            try
            {
                ...
                VirtualPath appVirtualDir,
                    globalVirtualDir = null;
                ...
                BuildProvidersCompiler bpc = new BuildProvidersCompiler(
                    virtualDir,
                    themeBuildProvider.AssemblyNamePrefix
                        + BuildManager.GenerateRandomAssemblyName(themeName)
                );
        ...
        private static void AddThemeFilesToBuildProvider(
            VirtualDirectory vdir,
            PageThemeBuildProvider themeBuildProvider,
            bool topLevel
        )
        {
            ...
            foreach (VirtualFileBase child in vdir.Children)
            {
                ...
                {
                    AddThemeFilesToBuildProvider(
                        child as VirtualDirectory,
                        themeBuildProvider,
                        false
                    );
                    continue;
