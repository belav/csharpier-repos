...
namespace System.Web.Compilation
{
    ...
    {
        internal static BooleanSwitch WebFormsCompilation = new BooleanSwitch(
            "WebFormsCompilation",
            "Outputs information about the WebForms compilation of ASPX templates"
        );

        internal /*public*/
        static CodeExpression GenerateExpressionForValue(
            ...
            else
            {
                    ...
                    if (desc != null)
                    {
                            ...
                            CodeFieldReferenceExpression fieldRef =
                                new CodeFieldReferenceExpression(
                                    BuildGlobalCodeTypeReferenceExpression(
                                        desc.MemberInfo.DeclaringType.FullName
                                    ),
                                    desc.MemberInfo.Name
                                );
                            rightExpr = fieldRef;
                            added = true;
                        }
                        ...
                        else
                        {
                            ...
                            if (desc.MemberInfo is MethodInfo)
                            {
                                ...
                                {
                                    expressions[i] = GenerateExpressionForValue(
                                        null,
                                        args[i],
                                ...
                                CodeMethodInvokeExpression methCall =
                ...
                if (!added)
                {
                    ...
                    if (
                        valueType.GetMethod(
                            "Parse",
                            new Type[] { typeof(string), typeof(CultureInfo) }
                        ) != null
                    )
                    {
                        CodeMethodInvokeExpression methCall = new CodeMethodInvokeExpression(
                            BuildGlobalCodeTypeReferenceExpression(valueType.FullName),
                            "Parse"
                        );
        ...
        )
        {
            ...
            if (useSetAttribute)
            {
                ...
                methodInvoke.Method.TargetObject = new CodeCastExpression(
                    typeof(IAttributeAccessor),
                    target
                );
        ...
        internal static CodeExpression GenerateConvertToString(CodeExpression value)
        {
            ...
            invokeExpr.Method.TargetObject = BuildGlobalCodeTypeReferenceExpression(
        ...
        internal static CodeCastExpression BuildJSharpCastExpression(
            Type castType,
        ...
        private static CodeTypeReferenceExpression BuildGlobalCodeTypeReferenceExpression(
            string typeName
        )
        {
