...
namespace System.Web.Compilation
{
    ...
    internal class DataBindingExpressionBuilder : ExpressionBuilder
    {
        ...
        internal static void BuildEvalExpression(
            string field,
            string formatString,
            string propertyName,
            Type propertyType,
        ...
        )
        {
            ...
            getDataItemExpr.Method.TargetObject = new CodePropertyReferenceExpression(
            ...
            ifStmt.Condition = new CodeBinaryOperatorExpression(
                getDataItemExpr,
        ...
        )
        {
            ...
            CodeDomUtility.CreatePropertySetStatements(
                methodStatements,
                statements,
                new CodeVariableReferenceExpression("dataBindingExpressionBuilderTarget"),
                propertyName,
                propertyType,
                expression,
                linePragma
        ...
        )
        {
            ...
            CodeVariableReferenceExpression targetExp = new CodeVariableReferenceExpression(
                targetDecl.Name
            );
            ...
            CodeAssignStatement setContainer = new CodeAssignStatement(
                ...
                new CodeCastExpression(
                    bindingContainerType,
                    new CodePropertyReferenceExpression(targetExp, "BindingContainer")
                )
            );
        ...
        internal static void GenerateItemTypeExpressions(
            ControlBuilder controlBuilder,
            CodeStatementCollection declarationStatements,
        ...
        )
        {
            ...
            if (!String.IsNullOrEmpty(itemType))
            {
                ...
                CodeAssignStatement setDataItem = new CodeAssignStatement(
                    new CodeVariableReferenceExpression(itemTypeDecl.Name),
                    new CodeCastExpression(
                        itemType,
