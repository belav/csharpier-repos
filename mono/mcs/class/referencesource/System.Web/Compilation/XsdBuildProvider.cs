...
namespace System.Web.Compilation
{
    ...
    internal class XsdBuildProvider : BuildProvider
    {
        [SuppressMessage(
            ...
            Justification = "Developer-controlled .xsd files in application directory are implicitly trusted by ASP.Net."
        )]
        [SuppressMessage(
        ...
        public override void GenerateCode(AssemblyBuilder assemblyBuilder)
        {
            ...
            bool isVer35OrAbove = CompilationUtil.IsCompilerVersion35OrAbove(
                assemblyBuilder.CodeDomProvider.GetType()
            );
            ...
            if (isVer35OrAbove)
            {
                ...
                TypedDataSetGenerator.Generate(
                    content,
                    codeCompileUnit,
                    codeNamespace,
            ...
            {
                var isVer35 = CompilationUtil.IsCompilerVersion35(
                    assemblyBuilder.CodeDomProvider.GetType()
                );
