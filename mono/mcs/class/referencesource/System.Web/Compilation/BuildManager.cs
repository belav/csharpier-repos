...
namespace System.Web.Compilation
{
    ...
    public sealed class BuildManager
    {
        ...
        private const string ResourcesDirectoryAssemblyName =
            AssemblyNamePrefix + "GlobalResources";
        private const string LocalResourcesDirectoryAssemblyName =
            AssemblyNamePrefix + "LocalResources";
        private const string WebRefDirectoryAssemblyName = AssemblyNamePrefix + "WebReferences";
        internal const string GlobalAsaxAssemblyName =
            AssemblyNamePrefix + HttpApplicationFactory.applicationFileName;
        ...
        {
            get { return _theBuildManager._compilationStage; }
        }
        ...
        {
            get { return _theBuildManager._scriptVirtualDir; }
        }
        internal static VirtualPath GlobalAsaxVirtualPath
        {
            get { return _theBuildManager._globalAsaxVirtualPath; }
        }
        ...
        {
            get { return _theBuildManager._cbmCallback; }
        }
        ...
        {
            get { return _topLevelAssembliesIndexTable; }
        }
        ...
        internal static Dictionary<String, String> GenerateFileTable
        {
            get
            {
                ...
                {
                    _theBuildManager._generatedFileTable = new Dictionary<String, String>(
        ...
        {
            get { return _theBuildManager._appResourcesAssembly; }
        }
        ...
        private static HashSet<Assembly> s_dynamicallyAddedReferencedAssembly =
        ...
        public static void AddCompilationDependency(string dependency)
        {
            if (String.IsNullOrEmpty(dependency))
            {
                throw new ArgumentException(
                    SR.GetString(SR.Parameter_can_not_be_empty),
                    "dependency"
                );
            }
        ...
        private void Initialize()
        {
            ...
            _globalAsaxVirtualPath = HttpRuntime.AppDomainAppVirtualPathObject
        ...
        private void PrecompilationModeInitialize()
        {
            ...
            string targetBinDir = Path.Combine(
        ...
        {
            string licAssemblyPath = Path.Combine(
                HttpRuntime.BinDirectoryInternal,
        ...
        private long CheckTopLevelFilesUpToDateInternal(long cachedHash)
        {
            ...
            if (!OptimizeCompilations)
            {
                ...
                specialFilesHashCodeCombiner.AddResourcesDirectory(
                    HttpRuntime.ResourcesDirectoryVirtualPath.MapPathInternal()
                );

                specialFilesHashCodeCombiner.AddDirectory(
                    HttpRuntime.WebRefDirectoryVirtualPath.MapPathInternal()
                );

                specialFilesHashCodeCombiner.AddDirectory(
                    HttpRuntime.CodeDirectoryVirtualPath.MapPathInternal()
                );
        ...
        private void AfterPreAppStartExecute(
            Tuple<long, long> currentHash,
            Tuple<long, long> cachedTopLevelFilesHash
        )
        {
            bool gotLock = false;
            try
        ...
        private void CheckCodeGenFiles(long currentHash, long cachedTopLevelFilesHash)
        {
            ...
            if (PrecompilingForCleanBuild || currentHash != cachedTopLevelFilesHash)
            {
                ...
                else
                {
                    Debug.Trace(
                        "BuildManager",
                        "EnsureFirstTimeInit: hash codes don't match.  Old="
                            + cachedTopLevelFilesHash
                            + " New="
                            + currentHash
                    );
                }
        ...
        private void OnWebHashFileChange(Object sender, FileChangeEvent e)
        {
            ...
            Debug.Trace(
                "BuildManager",
                _webHashFilePath + " changed - shutting down the app domain"
            );
            Debug.Trace(
                "AppDomainFactory",
                "Shutting down appdomain because " + _webHashFilePath + " file changed"
            );
        ...
        internal static bool IsReservedAssemblyName(string assemblyName)
        {
            if (
                String.Compare(
                    assemblyName,
                    CodeDirectoryAssemblyName,
                    StringComparison.OrdinalIgnoreCase
                ) == 0
                || String.Compare(
                    assemblyName,
                    ResourcesDirectoryAssemblyName,
                    StringComparison.OrdinalIgnoreCase
                ) == 0
                || String.Compare(
                    assemblyName,
                    WebRefDirectoryAssemblyName,
                    StringComparison.OrdinalIgnoreCase
                ) == 0
                || String.Compare(
                    assemblyName,
        ...
        internal static void ThrowIfPreAppStartNotRunning()
        {
            if (PreStartInitStage != PreStartInitStage.DuringPreStartInit)
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Method_can_only_be_called_during_pre_start_init)
                );
            }
        }
        ...
        internal static void ExecutePreAppStart()
        {
            ...
            string preStartInitListPath = Path.Combine(
                HttpRuntime.CodegenDirInternal,
                "preStartInitList.web"
            );
            Tuple<long, long> specialFilesCombinedHash = _theBuildManager._codeGenCache
            ...
            ISet<string> preApplicationStartAssemblyNames = CallPreStartInitMethods(
                preStartInitListPath,
                out hasUpdated
            );

            // Check if pre application start code hashes have changed since.
            var currentHash = Tuple.Create(
                topLevelFilesHash,
                _theBuildManager._preAppStartHashCodeCombiner.CombinedHash
            );
            ...
            if (hasUpdated)
            {
                SavePreStartInitAssembliesToFile(
                    preStartInitListPath,
                    preApplicationStartAssemblyNames
                );
            }
        }

        // this method requires global lock as the part of the fix of DevDiv bug 501777
        private static ISet<string> CallPreStartInitMethods(
            string preStartInitListPath,
            out bool isRefAssemblyLoaded
        )
        {
            ...
            using (new ApplicationImpersonationContext())
            {
                ...
                ICollection<Assembly> cachedPreStartAssemblies = LoadCachedPreAppStartAssemblies(
                    preStartInitListPath
                );
                if (cachedPreStartAssemblies != null)
                {
                    methods = GetPreStartInitMethodsFromAssemblyCollection(
                        cachedPreStartAssemblies,
                ...
                return new HashSet<string>(
                    methods.Select(m => m.DeclaringType.Assembly.FullName),
                    StringComparer.OrdinalIgnoreCase
                );
            }
        }
        ...
        )
        {
            try
            {
                ...
                return assemblyList.Select(Assembly.Load).Distinct().ToList();
            }
            catch
            {
                return null;
        ...
        internal static void InvokePreStartInitMethodsCore(
            ICollection<MethodInfo> methods,
            Func<IDisposable> setHostingEnvironmentCultures
        )
        {
            // Remove dupes
            ...
            foreach (var method in methodsToExecute)
            {
                ...
                catch (TargetInvocationException e)
                {
                    ...
                    throw new InvalidOperationException(
                        SR.GetString(
                            SR.Pre_application_start_init_method_threw_exception,
                            method.Name,
        ...
        {
            CompilationSection compConfig = MTConfigUtil.GetCompilationConfig(
                HttpRuntime.AppDomainAppVirtualPath
            );
            var referencedAssemblies = BuildManager
                .GetReferencedAssemblies(compConfig)
                .Cast<Assembly>();
            return GetPreStartInitMethodsFromAssemblyCollection(
                ...
                else
                {
                    foreach (PreApplicationStartMethodAttribute attribute in attributes)
                    {
                        ...
                        else
                        {
                            throw new HttpException(
                                SR.GetString(
                                    SR.Invalid_PreApplicationStartMethodAttribute_value,
                                    assembly.FullName,
                                    (
                                        attribute.Type != null
                                            ? attribute.Type.FullName
                                            : String.Empty
                                    ),
        ...
        // own assemblies).
        private Assembly CompileCodeDirectory(
            VirtualPath virtualDir,
        ...
        )
        {
            Debug.Trace(
                "BuildManager",
                "CompileCodeDirectory(" + virtualDir.VirtualPathString + ")"
            );
            ...
            AssemblyReferenceInfo info = new AssemblyReferenceInfo(
                _topLevelReferencedAssemblies.Count
            );
            ...
            Debug.Trace(
                "BuildManager",
                "CompileCodeDirectory generated assembly: "
        ...
        private void CompileResourcesDirectory()
        {
            ...
            _appResourcesAssembly = CompileCodeDirectory(
                virtualDir,
                CodeDirectoryType.AppResources,
                ResourcesDirectoryAssemblyName,
        ...
        {
            CompileCodeDirectory(
                HttpRuntime.WebRefDirectoryVirtualPath,
                CodeDirectoryType.WebReferences,
                WebRefDirectoryAssemblyName,
                null /*excludedSubdirectories*/
            );
        }
        ...
        private void CompileCodeDirectories()
        {
            ...
            CompileCodeDirectory(
                ...
                CodeDirectoryAssemblyName,
                _excludedCodeSubdirectories
            );
        }

        private void CompileGlobalAsax()
        {
            _globalAsaxBuildResult = ApplicationBuildProvider.GetGlobalAsaxBuildResult(
                IsPrecompiledApp
            );
        ...
        internal void EnsureTopLevelFilesCompiled()
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Method_cannot_be_called_during_pre_start_init)
                );
            }
            ...
            using (new ApplicationImpersonationContext())
            {
                ...
                try
                {
                    ...
                    _topLevelAssembliesIndexTable = new Dictionary<String, AssemblyReferenceInfo>(
                        StringComparer.OrdinalIgnoreCase
                    );
        ...
        {
            return GenerateRandomAssemblyName(
                baseName,
                true /*topLevel*/
            );
        }
        ...
        public static Type GetType(string typeName, bool throwOnError, bool ignoreCase)
        {
            ...
            try
            {
                type = typeof(BuildManager).Assembly
                    .GetType(
                        typeName,
                        false /*throwOnError*/
                        ,
            ...
            catch (ArgumentException e)
            {
                ...
                throw new HttpException(SR.GetString(SR.Invalid_type, typeName), e);
            }
            ...
            type = Util.GetTypeFromAssemblies(
                TheBuildManager.TopLevelReferencedAssemblies,
                typeName,
                ignoreCase
            );
        ...
        */
        ...
        internal static BuildProvider CreateBuildProvider(
        ...
        internal static void AddFolderLevelBuildProviders(
            BuildProviderSet buildProviders,
            VirtualPath virtualPath,
        ...
        )
        {
            ...
            List<Type> buildProviderTypes = CompilationUtil.GetFolderLevelBuildProviderTypes(
                compConfig,
                appliesTo
            );
        ...
        {
            _theBuildManager.ValidateVirtualPathInternal(
                virtualPath,
                false /*allowCrossApp*/
                ,
                true /*codeFile*/
        ...
        private void ValidateVirtualPathInternal(
            VirtualPath virtualPath,
            bool allowCrossApp,
            bool codeFile
        )
        {
            ...
            {
                throw new HttpException(
                    SR.GetString(SR.Illegal_special_dir, virtualPathString, dir)
                );
            }
        }
        ...
        )
        {
            ...
            {
                return GetVPathBuildResultWithNoAssert(
                    context,
                    virtualPath,
                    noBuild,
                    allowCrossApp,
                    ...
                    ensureIsUpToDate: ensureIsUpToDate
                );
            }
            else
            {
                return GetVPathBuildResultWithAssert(
                    context,
                    virtualPath,
                    noBuild,
                    allowCrossApp,
        ...
        )
        {
            using (new ApplicationImpersonationContext())
            {
                return _theBuildManager.GetVPathBuildResultInternal(
                    virtualPath,
                    noBuild,
                    allowCrossApp,
                    allowBuildInPrecompile,
        ...
        private BuildResult GetVPathBuildResultInternal(
            VirtualPath virtualPath,
            bool noBuild,
            bool allowCrossApp,
            bool allowBuildInPrecompile,
        ...
        )
        {
            ...
            BuildResult result = GetVPathBuildResultFromCacheInternal(
                virtualPath,
                ensureIsUpToDate
            );
            if (result != null)
            ...
            {
                throw new HttpException(SR.GetString(SR.Cant_update_precompiled_app, virtualPath));
            }
            ...
            try
            {
                ...
                circularReferenceChecker =
                    CallContext.GetData(CircularReferenceCheckerSlotName) as VirtualPathSet;
        ...
        private void EnsureFirstTimeDirectoryInit(VirtualPath virtualDir)
        {
            ...
            VirtualPath localResDir = virtualDir.SimpleCombineWithDir(
            ...
            if (dirExists)
            {
                ...
                try
                {
                    ...
                    resourceAssembly = CompileCodeDirectory(
                        localResDir,
                        CodeDirectoryType.LocalResources,
                        localResAssemblyName,
                        null /*excludedSubdirectories*/
                    );
                }
                finally
        ...
        {
            return LocalResourcesDirectoryAssemblyName
                + "."
                + GetGeneratedAssemblyBaseName(virtualDir);
        }
        ...
        {
            get { return s_batchCompilationEnabled; }
            set
            {
                ThrowIfPreAppStartNotRunning();
        ...
        private bool BatchCompileWebDirectory(
        ...
        )
        {
            ...
            directoryBatchCompilerChecker =
                CallContext.GetData(BatchCompilationSlotName) as CaseInsensitiveStringSet;
        ...
        )
        {
            ...
            try
            {
                GetCodeDirectoryInformationInternal(
                    virtualCodeDir,
        ...
        private void GetCodeDirectoryInformationInternal(
            VirtualPath virtualCodeDir,
            out Type codeDomProviderType,
            out CompilerParameters compilerParameters,
            out string generatedFilesDir
        )
        {
            ...
            // If virtualCodeDir is a subdir of WebReference virtual path.
                ...
                String.Compare(
                    virtualCodeDir.VirtualPathString,
                    0,
                    HttpRuntime.WebRefDirectoryVirtualPath.VirtualPathString,
                    0,
                    HttpRuntime.WebRefDirectoryVirtualPath.VirtualPathString.Length,
                    StringComparison.OrdinalIgnoreCase
                ) == 0
            )
            {
            ...
            AssemblyReferenceInfo info = TheBuildManager.TopLevelAssembliesIndexTable[
                virtualCodeDir.VirtualPathString
            ];
            if (info == null)
            {
        ...
        private static string GetCacheKeyFromVirtualPathInternal(VirtualPath virtualPath)
        {
            ...
            */
            ...
            return name
                + "."
                + StringUtil.GetStringHashCode(dir).ToString("x", CultureInfo.InvariantCulture);
        }
        ...
        private BuildResult GetVPathBuildResultFromCacheInternal(
            VirtualPath virtualPath,
            bool ensureIsUpToDate = true
        )
        {
            ...
            return GetBuildResultFromCacheInternal(
                cacheKey,
                keyFromVPP,
                virtualPath,
                0 /*hashCode*/
        ...
        {
            return _theBuildManager.GetBuildResultFromCacheInternal(
                cacheKey,
                false /*keyFromVPP*/
                ,
                null /*virtualPath*/
        ...
        internal static BuildResult GetBuildResultFromCache(
            string cacheKey,
            VirtualPath virtualPath
        )
        {
        ...
        )
        {
            ...
            Debug.Trace(
                "BuildManager",
                "Didn't find '" + virtualPath + "' in memory cache before lock"
            );
            ...
            lock (this)
            {
                ...
                for (i = 0; i < _caches.Length; i++)
                {
                    ...
                    if (result != null)
                    {
                        ...
                        {
                            EnsureFirstTimeDirectoryInitForDependencies(
        ...
        private BuildResult PostProcessFoundBuildResult(
            BuildResult result,
            bool keyFromVPP,
            VirtualPath virtualPath
        )
        ...
        internal static bool CacheVPathBuildResult(
            VirtualPath virtualPath,
            BuildResult result,
            DateTime utcStart
        )
        ...
        private bool CacheVPathBuildResultInternal(
            VirtualPath virtualPath,
            BuildResult result,
            DateTime utcStart
        )
        ...
        internal static bool CacheBuildResult(
            string cacheKey,
            BuildResult result,
            DateTime utcStart
        )
        {
            return _theBuildManager.CacheBuildResultInternal(
                cacheKey,
                result,
                0 /*hashCode*/
                ,
        ...
        internal void SetPrecompilationInfo(HostingEnvironmentParameters hostingParameters)
        {
            ...
            _precompilationFlags = hostingParameters.ClientBuildManagerParameter
                .PrecompilationFlags;

            _strongNameKeyFile = hostingParameters.ClientBuildManagerParameter.StrongNameKeyFile;
            _strongNameKeyContainer = hostingParameters.ClientBuildManagerParameter
        ...
        [PermissionSet(SecurityAction.Assert, Unrestricted = true)]
        private void PrecompileApp(
            VirtualPath startingVirtualDir,
            IEnumerable<string> excludedVirtualPaths
        )
        {
            using (new ApplicationImpersonationContext())
        ...
        private void PrecompileAppInternal(
            VirtualPath startingVirtualDir,
            IEnumerable<string> excludedVirtualPaths
        )
        {
            ...
            _excludedCompilationPaths = excludedVirtualPaths
                .Select(path => VirtualPath.Create(UrlPath.Combine("~", path)))
                .ToList();
        ...
        private void CreatePrecompMarkerFile()
        {
            ...
            string precompMarkerFile = Path.Combine(
                _precompTargetPhysicalDir,
        ...
        {
            get { return (_theBuildManager._precompilationFlags & PrecompilationFlags.Clean) != 0; }
        }
        ...
        internal static bool PrecompilingWithDebugInfo
        {
            get
            {
                ...
                return (_theBuildManager._precompilationFlags & PrecompilationFlags.ForceDebug)
                    != 0;
            }
        }
        ...
        internal static bool PrecompilingWithCodeAnalysisSymbol
        {
            get
            {
                return (_theBuildManager._precompilationFlags & PrecompilationFlags.CodeAnalysis)
                    != 0;
            }
        }
        ...
        private static bool CompileWithFixedAssemblyNames
        {
            get
            {
                return (_theBuildManager._precompilationFlags & PrecompilationFlags.FixedNames)
                    != 0;
            }
        }
        ...
        internal static bool CompileWithAllowPartiallyTrustedCallersAttribute
        {
            ...
            {
                return (
                        _theBuildManager._precompilationFlags
                        & PrecompilationFlags.AllowPartiallyTrustedCallers
                    ) != 0;
            }
        }
        ...
        internal static bool IgnoreBadImageFormatException
        {
            get
            {
                return (
                        _theBuildManager._precompilationFlags
                        & PrecompilationFlags.IgnoreBadImageFormatException
                    ) != 0;
            }
        }
        ...
        {
            get { return _theBuildManager._strongNameKeyFile; }
        }

        internal static string StrongNameKeyContainer
        {
            get { return _theBuildManager._strongNameKeyContainer; }
        }
        ...
        internal static TextWriter GetUpdatableDeploymentTargetWriter(
            VirtualPath virtualPath,
        ...
        private bool IsPrecompiledAppInternal
        {
            get
            {
                ...
                {
                    _isPrecompiledApp = ReadPrecompMarkerFile(
        ...
        {
            get { return _theBuildManager.IsPrecompiledAppInternal; }
        }

        private bool IsUpdatablePrecompiledAppInternal
        {
            get { return IsPrecompiledApp && _isUpdatablePrecompiledApp; }
        }

        public static bool IsUpdatablePrecompiledApp
        {
            get { return _theBuildManager.IsUpdatablePrecompiledAppInternal; }
        }
        ...
        {
            string appPhysicalDir = Path.Combine(
                HttpRuntime.AppDomainAppPathInternal,
            ...
            if (Directory.Exists(appPhysicalDir))
            {
                ...
                foreach (string themeDirPath in themeDirs)
                {
                    ...
                    ThemeDirectoryCompiler.GetThemeBuildResultType(
                        null /*context*/
                        ,
                        themeDirName
                    );
        ...
        private void CopyPrecompiledFile(VirtualFile vfile, string destPhysicalPath)
        {
            ...
            if (
                CompilationUtil.NeedToCopyFile(
                    vfile.VirtualPathObject,
                    PrecompilingForUpdatableDeployment,
                    out createStub
                )
            )
            {
                ...
                if (File.Exists(destPhysicalPath))
                {
                    ...
                    BuildResultCompiledType result =
                        GetVPathBuildResult(
                            null,
                            vfile.VirtualPathObject,
                            true /*noBuild*/
                    ...
                    newAspxFile = newAspxFile.Replace(
        ...
        {
            ITypedWebObjectFactory factory = GetVirtualPathObjectFactory(
                virtualPath,
                null /*context*/
                ,
                false /*allowCrossApp*/
        ...
        {
            ITypedWebObjectFactory objectFactory = GetVirtualPathObjectFactory(
                virtualPath,
                context,
                allowCrossApp
            );
        ...
        private static ITypedWebObjectFactory GetVirtualPathObjectFactory(
            VirtualPath virtualPath,
            HttpContext context,
            bool allowCrossApp
        )
        {
            return GetVirtualPathObjectFactory(
                virtualPath,
                context,
                allowCrossApp,
                true /*throwIfNotFound*/
        ...
        public static Assembly GetCompiledAssembly(string virtualPath)
        {
            ...
            BuildResultCompiledAssemblyBase resultAssembly =
                result as BuildResultCompiledAssemblyBase;
            if (resultAssembly == null)
                return null;
        ...
        {
            get { return MultiTargetingUtil.TargetFrameworkName; }
        }
            ...
            foreach (CodeSubDirectory directory in codeSubDirectories)
            {
                if (
                    assemblyName.StartsWith(
                        SubCodeDirectoryAssemblyNamePrefix + directory.AssemblyName + ".",
        ...
        private static string UserCachePath
        {
            get
            {
                if (_userCachePath == null)
                {
                    ...
                    string userCachePath = Path.Combine(
                        HttpRuntime.CodegenDirInternal,
                        "UserCache"
                    );
