...
namespace System.Web.Compilation
{
    ...
    internal abstract class BaseTemplateBuildProvider : InternalBuildProvider
    {
        ...
        internal abstract BaseCodeDomTreeGenerator CreateCodeDomTreeGenerator(
        ...
        )
        {
            ...
            CodeCompileUnit ccu = treeGenerator.GetCodeDomTree(
                codeDomProvider,
                new StringResourceBuilder(),
                VirtualPathObject
            );
        ...
        public override void GenerateCode(AssemblyBuilder assemblyBuilder)
        {
            ...
            CodeCompileUnit ccu = treeGenerator.GetCodeDomTree(
                ...
                assemblyBuilder.StringResourceBuilder,
                VirtualPathObject
            );
        ...
        internal override ICollection GetGeneratedTypeNames()
        {
            ...
            {
                collection.Add(
                    Util.MakeFullTypeName(_parser.BaseTypeNamespace, _parser.BaseTypeName)
                );
            }
