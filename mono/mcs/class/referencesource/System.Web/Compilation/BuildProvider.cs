...
namespace System.Web.Compilation
{
    ...
    {
        private static Dictionary<string, BuildProviderInfo> s_dynamicallyRegisteredProviders =
            new Dictionary<string, BuildProviderInfo>();
        ...
        internal /*protected*/
        Stream OpenStream(VirtualPath virtualPath)
        {
        ...
        internal /*protected*/
        TextReader OpenReader(VirtualPath virtualPath)
        {
        ...
        public static void RegisterBuildProvider(string extension, Type providerType)
        {
            ...
            s_dynamicallyRegisteredProviders[extension] = new CompilationBuildProviderInfo(
                providerType
            );
        }

        internal static BuildProviderInfo GetBuildProviderInfo(
            System.Web.Configuration.CompilationSection config,
            string extension
        )
        {
        ...
        {
            return CompilationUtil.GetDefaultLanguageCompilerInfo(
                null /*compConfig*/
                ,
                VirtualPathObject
            );
...
#pragma warning restore 0649
        ...
        internal static CompilerType GetCompilerTypeFromBuildProvider(BuildProvider buildProvider)
        {
            ...
            if (
                ...
                && (context = HttpContext.Current) != null
            )
        ...
        internal BuildProviderAppliesTo AppliesTo
        {
            get
            {
                ...
                object[] attrs = Type.GetCustomAttributes(
                    typeof(BuildProviderAppliesToAttribute), /*inherit*/
                    true
                );
