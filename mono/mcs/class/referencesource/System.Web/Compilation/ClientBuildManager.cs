...
*/
        ...
        )
        {
            ...
            _hostingParameters.HostingFlags =
                HostingEnvironmentFlags.DontCallAppInitialize
            ...
            )
            {
                ...
                if (endSlash > 0)
                {
                    _hostingParameters.IISExpressVersion = appVirtualDir.Substring(
                        IISExpressPrefix.Length,
                        endSlash - IISExpressPrefix.Length
                    );
...
*/
        ...
        )
        {
            ...
            _host.GetCodeDirectoryInformation(
                VirtualPath.CreateTrailingSlash(virtualCodeDir),
...
*/
        ...
        )
        {
            ...
            return GenerateCodeCompileUnit(
                virtualPath,
                null,
                out codeDomProviderType,
                out compilerParameters,
        ...
        )
        {
            ...
            return _host.GenerateCodeCompileUnit(
                VirtualPath.Create(virtualPath),
                virtualFileString,
                out codeDomProviderType,
                out compilerParameters,
...
*/
        ...
        public Type GetCompiledType(string virtualPath)
        {
            ...
            string[] typeAndAsemblyName = _host.GetCompiledTypeAndAssemblyName(
                VirtualPath.Create(virtualPath),
                null
            );
...
*/
        ...
        public void PrecompileApplication(ClientBuildManagerCallback callback, bool forceCleanBuild)
        {
            ...
            try
            {
                ...
                _host.PrecompileApp(
                    callback,
                    _hostingParameters.ClientBuildManagerParameter.ExcludedVirtualPaths
                );
            }
            finally
            {
        ...
        private void EnsureHostCreated()
        {
            ...
            if (_hostCreationException != null)
            {
                ...
                throw new HttpException(_hostCreationException.Message, _hostCreationException);
            }
        }
        ...
        private void CreateHost()
        {
            ...
            try
            {
                ...
                host = (BuildManagerHost)
                    appManager.CreateObjectWithDefaultAppHostAndAppId(
                        _physicalPath,
                        _virtualPath,
                        typeof(BuildManagerHost),
                        false /*failIfExists*/
                        ,
                        _hostingParameters,
                        out appId,
        ...
        private void OnAppDomainShutdownCallback(Object o)
        {
            if (AppDomainShutdown != null)
            {
                AppDomainShutdown(
                    this,
                    new BuildManagerHostUnloadEventArgs((ApplicationShutdownReason)o)
                );
            }
        }
        ...
        private void InitializeCBMTDPBridge(TypeDescriptionProvider typeDescriptionProvider)
        {
            ...
            _cbmTdpBridge = new ClientBuildManagerTypeDescriptionProviderBridge(
    ...
    public delegate void BuildManagerHostUnloadEventHandler(
        object sender,
...
*/
    ...
    public sealed class LinePragmaCodeInfo
    {
        ...
        {
            get { return _startGeneratedColumn; }
        }
