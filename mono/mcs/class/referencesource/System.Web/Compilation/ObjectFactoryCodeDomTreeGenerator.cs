...
namespace System.Web.Compilation
{
    ...
    internal class ObjectFactoryCodeDomTreeGenerator
    {
        ...
        private const string factoryFullClassNameBase =
            BaseCodeDomTreeGenerator.internalAspNamespace + "." + factoryClassNameBase;
        ...
        internal ObjectFactoryCodeDomTreeGenerator(string outputAssemblyName)
        {
            ...
            string factoryClassName =
                ...
                + Util.MakeValidTypeNameFromString(outputAssemblyName)
        ...
        internal static InstantiateObject GetFastObjectCreationDelegate(Type t)
        {
            ...
            Type factoryType = a.GetType(
                factoryFullClassNameBase + Util.MakeValidTypeNameFromString(shortAssemblyName)
            );
            if (factoryType == null)
                return null;
            ...
            try
            {
                return (InstantiateObject)
                    Delegate.CreateDelegate(typeof(InstantiateObject), factoryType, methodName);
            }
            catch
            {
                return null;
