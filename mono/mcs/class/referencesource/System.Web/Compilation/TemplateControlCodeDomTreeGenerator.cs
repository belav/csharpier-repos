    ...
    internal abstract class TemplateControlCodeDomTreeGenerator : BaseTemplateCodeDomTreeGenerator
    {
        ...
        )
        {
            ...
            if (_stringResourceBuilder.HasStrings)
            {
                ...
                CodeMemberField stringResourcePointer = new CodeMemberField(
                    typeof(Object),
                ...
                readResource.Left = new CodeFieldReferenceExpression(
                    _classTypeExpr,
                    stringResourcePointerName
                );
            ...
            CodeTypeReference classTypeRef = CodeDomUtility.BuildGlobalCodeTypeReference(
                Parser.BaseType
            );

            CodeAssignStatement setProp = new CodeAssignStatement(
                new CodePropertyReferenceExpression(
                    new CodeCastExpression(classTypeRef, new CodeThisReferenceExpression()),
            ...
            if (!_designerMode && Parser.CodeFileVirtualPath != null)
            {
                setProp.LinePragma = CreateCodeLinePragmaHelper(
                    Parser.CodeFileVirtualPath.VirtualPathString,
        ...
        internal void BuildStronglyTypedProperty(string propertyName, Type propertyType)
        {
            ...
            prop.Attributes |=
                MemberAttributes.Final | MemberAttributes.New | MemberAttributes.Public;
