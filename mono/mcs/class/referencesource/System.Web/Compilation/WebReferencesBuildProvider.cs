...
#endif // !FEATURE_PAL
    using System.Web.Hosting;using System.Web.UI;using System.Web.Util;using Util = System.Web.UI.Util;

    internal class WebReferencesBuildProvider : BuildProvider
    {
        private VirtualDirectory _vdir;

        private const string IndigoWebRefProviderTypeName =
        ...
        public override void GenerateCode(AssemblyBuilder assemblyBuilder)
        {
            ...
            {
                s_indigoWebRefProviderType = BuildManager.GetType(
                    IndigoWebRefProviderTypeName,
                    false /*throwOnError*/
                );
            ...
            if (s_indigoWebRefProviderType != null)
            {
                BuildProvider buildProvider = (BuildProvider)
                    HttpRuntime.CreateNonPublicInstance(s_indigoWebRefProviderType);
            ...
            Debug.Assert(
                StringUtil.StringStartsWithIgnoreCase(
                    ...
                    rootWebRefDirVirtualPath.VirtualPathString
                )
            );
            ...
            if (
                ...
                == currentWebRefDirVirtualPath.Length
            )
            {
            ...
            else
            {
                ...
                currentWebRefDirVirtualPath = UrlPath.RemoveSlashFromPathIfNeeded(
                    currentWebRefDirVirtualPath
                );
            ...
            StringCollection shareWarnings = ServiceDescriptionImporter.GenerateWebReferences(
                webs,
                assemblyBuilder.CodeDomProvider,
                codeCompileUnit,
                options
            );
