    ...
    static class BrowserCapabilitiesCompiler
    {
        ...
        static BrowserCapabilitiesCompiler()
        {
            ...
            String publicKeyToken =
                BrowserCapabilitiesCodeGenerator.BrowserCapAssemblyPublicKeyToken;
            ...
            if (publicKeyToken != null)
            {
                try
                {
                    ...
                    assembly = Assembly.Load(
                        "ASP.BrowserCapsFactory, Version="
                            + version
            ...
            {
                _browserCapabilitiesFactoryBaseType =
                    typeof(System.Web.Configuration.BrowserCapabilitiesFactory);
            }
            else
            {
                _browserCapabilitiesFactoryBaseType = assembly.GetType(
                    "ASP.BrowserCapabilitiesFactory",
                    true
                );
            }
        }
...
* invalidate the cache entry and cause recompilation. */
                    if (directory != null && Directory.Exists(physicalDir))
                    {
                        ...
                        bool hasCustomCaps = AddBrowserFilesToList(
                            directory,
                            browserFileList,
                            false
                        );
                        ...
                        {
                            ApplicationBrowserCapabilitiesBuildProvider buildProvider =
                                new ApplicationBrowserCapabilitiesBuildProvider();
                            ...
                            BuildProvidersCompiler bpc = new BuildProvidersCompiler(
                                ...
                                BuildManager.GenerateRandomAssemblyName(
                                    BuildManager.AppBrowserCapAssemblyNamePrefix
                                )
                            );
                            ...
                            Type t = assembly.GetType(
                                BaseCodeDomTreeGenerator.defaultNamespace
                                    + "."
                                    + ApplicationBrowserCapabilitiesCodeGenerator.FactoryTypeName
                            );
                            ...
                            BuildManager.CacheBuildResult(
                                browerCapabilitiesCacheKey,
                                result,
                                utcStart
                            );
                        }
    ...
    internal class ApplicationBrowserCapabilitiesCodeGenerator : BrowserCapabilitiesCodeGenerator
    {
        ...
        [SuppressMessage(
            ...
            Justification = "BrowserDefinition is Internal type - okay"
        )]
        ...
        internal void GenerateCode(AssemblyBuilder assemblyBuilder)
        {
            ProcessBrowserFiles(
                true /*useVirtualPath*/
                ,
                BrowserCapabilitiesCompiler.AppBrowsersVirtualDir.VirtualPathString
            );
            ...
            {
                customTreeRoots.Add(
                    (BrowserDefinition)(((BrowserTree)CustomTreeList[i])[CustomTreeNames[i]])
                );
            }
            ...
            foreach (DictionaryEntry entry in _browserOverrides)
            {
                ...
                BrowserDefinition firstBrowserDefinition = (BrowserDefinition)
                    BrowserTree[GetFirstItemFromKey(_browserOverrides, key)];
                ...
                )
                {
                    ...
                    if (firstBrowserDefinition != null)
                    {
                        throw new ConfigurationErrorsException(
                            SR.GetString(SR.Browser_parentID_Not_Found, parentID),
                            firstBrowserDefinition.XmlNode
                        );
                    }
                    else
                    {
                ...
                foreach (string browserID in overrides)
                {
                    ...
                    else
                    {
                        if (!ignoreApplicationBrowsersVarRefGenerated)
                        {
                            ...
                            istatement.Condition = new CodeVariableReferenceExpression(
                                BrowserCapabilitiesCodeGenerator.IgnoreApplicationBrowserVariableName
                            );
                        ...
                        if (_baseInstance == null)
                        {
                            ...
                            // (Dev10 bug 795509)
                            if (
                                MultiTargetingUtil.IsTargetFramework40OrAbove
                                || baseType.Assembly
                                    == BrowserCapabilitiesCompiler.AspBrowserCapsFactoryAssembly
                            )
                            {
                        ...
                        int parentDepth = (int)
                            ((Triplet)_baseInstance.InternalGetBrowserElements()[parentName]).Third;
            ...
            foreach (DictionaryEntry entry in _defaultBrowserOverrides)
            {
                ...
                BrowserDefinition firstDefaultBrowserDefinition = (BrowserDefinition)
                    DefaultTree[GetFirstItemFromKey(_defaultBrowserOverrides, key)];
                ...
                if (baseType.GetMethod("Default" + parentName + "ProcessBrowsers", flags) == null)
                {
                    ...
                    {
                        throw new ConfigurationErrorsException(
                            SR.GetString(SR.DefaultBrowser_parentID_Not_Found, parentID),
                            firstDefaultBrowserDefinition.XmlNode
                        );
                    }
                }
                ...
                foreach (string browserID in overrides)
                {
                    ...
                    {
                        statements = GenerateTrackedSingleProcessCall(
                            statements,
                            bd,
                            cmm,
                            "Default"
            ...
            Assembly assembly = BrowserCapabilitiesCompiler
                .GetBrowserCapabilitiesFactoryBaseType()
                .Assembly;
        ...
        internal override void ProcessBrowserNode(XmlNode node, BrowserTree browserTree)
        {
            ...
            {
                throw new ConfigurationErrorsException(
                    SR.GetString(SR.Browser_Not_Allowed_InAppLevel, node.Name),
                    node
                );
            }
