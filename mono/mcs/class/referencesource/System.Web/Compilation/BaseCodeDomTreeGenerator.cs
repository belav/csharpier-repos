...
namespace System.Web.Compilation
{
    ...
    internal abstract class BaseCodeDomTreeGenerator
    {
        ...
        internal /*public*/
        CodeCompileUnit GetCodeDomTree(
            CodeDomProvider codeDomProvider,
            StringResourceBuilder stringResourceBuilder,
        ...
        protected virtual string GetGeneratedClassName()
        {
            ...
            // a compile error.
            string baseTypeName =
                Parser.BaseTypeName != null ? Parser.BaseTypeName : Parser.BaseType.Name;
        ...
        private bool BuildSourceDataTree()
        {
            ...
            if (_sourceDataClass != null)
            {
                ...
                string fullClassName = Util.MakeFullTypeName(
                    _sourceDataNamespace.Name,
                    _sourceDataClass.Name
                );
        ...
        protected virtual void BuildDefaultConstructor()
        {
            ...
            CodeMemberField initializedField = new CodeMemberField(
                typeof(bool),
        ...
        protected virtual void BuildMiscClassMembers()
        {
            ...
            foreach (ScriptBlockData script in Parser.ScriptList)
            {
                ...
                literal.LinePragma = CreateCodeLinePragma(
                    script.VirtualPath,
                    script.Line,
                    script.Column,
                    script.Column,
        ...
        protected void BuildAccessorProperty(
            string propName,
        ...
        protected void BuildFieldAndAccessorProperty(
            string propName,
            string fieldName,
            Type propType,
            bool fStatic,
        ...
        )
        {
            ...
            CodeExpression fieldAccess = new CodeFieldReferenceExpression(
                new CodeThisReferenceExpression(),
                fieldName
            );
        ...
        private void BuildObjectPropertiesHelper(IDictionary objects, bool useApplicationState)
        {
            ...
            while (en.MoveNext())
            {
                ...
                CodePropertyReferenceExpression stateObj = new CodePropertyReferenceExpression(
                ...
                CodeMethodInvokeExpression getObject = new CodeMethodInvokeExpression(
                    stateObj,
                    "GetObject"
                );
                ...
                if (useApplicationState)
                {
                    ...
                    BuildInjectedGetPropertyMethod(
                        entry.Name,
                        declaredType,
        ...
        private void BuildPageObjectProperties()
        {
            ...
            foreach (ObjectTagBuilder obj in Parser.PageObjectList)
            {
                ...
                BuildInjectedGetPropertyMethod(
                    ...
                    IsGlobalAsaxGenerator /*fPublicProp*/
                );
            }
        }
        ...
        protected CodeLinePragma CreateCodeLinePragma(ControlBuilder builder)
        {
            ...
            if (codeBlockBuilder != null)
            {
                ...
                else
                {
                    ...
                    //
                    generatedColumn =
                        BaseTemplateCodeDomTreeGenerator.tempObjectVariable.Length
        ...
        internal static int GetGeneratedColumnOffset(CodeDomProvider codeDomProvider)
        {
            ...
            if (o == null)
            {
                ...
                while ((line = reader.ReadLine()) != null)
                {
                    ...
                    {
                        offset =
                            index - BaseTemplateCodeDomTreeGenerator.tempObjectVariable.Length + 1;
                    }
                }
        ...
        internal static CodeLinePragma CreateCodeLinePragmaHelper(
            string virtualPath,
            int lineNumber
        )
        {
