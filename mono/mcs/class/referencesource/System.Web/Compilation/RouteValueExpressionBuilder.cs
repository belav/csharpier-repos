...
namespace System.Web.Compilation
{
    ...
    [ExpressionEditor(
        "System.Web.UI.Design.RouteValueExpressionEditor, " + AssemblyRef.SystemDesign
    )]
    public class RouteValueExpressionBuilder : ExpressionBuilder
    {
        ...
        internal static object ConvertRouteValue(
            object value,
            Type controlType,
            string propertyName
        )
        {
            ...
            {
                PropertyDescriptor propDesc = TypeDescriptor.GetProperties(controlType)[
                    propertyName
                ];
                if (propDesc != null)
                {
