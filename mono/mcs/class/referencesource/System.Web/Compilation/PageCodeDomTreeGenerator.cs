...
namespace System.Web.Compilation
{
    ...
    internal class PageCodeDomTreeGenerator : TemplateControlCodeDomTreeGenerator
    {
        ...
        protected override void GenerateInterfaces()
        {
            ...
            if (
                !_designerMode
                && _sourceDataClass != null
                && (Parser.AspCompatMode || Parser.AsyncMode)
            )
            {
        ...
        )
        {
            ...
            assignDependencies.Right = new CodeArrayCreateExpression(
                typeof(String),
                virtualDependencies.Count
            );
            ...
            foreach (string virtualDependency in virtualDependencies)
            {
                ...
                addFileDep.Left = new CodeArrayIndexerExpression(
        ...
        protected override void BuildDefaultConstructor()
        {
            ...
            if (Parser.OutputCacheParameters != null)
            {
                ...
                if (
                    (cacheSettings.CacheProfile != null && cacheSettings.CacheProfile.Length != 0)
                ...
                )
                {
                    ...
                    //
                    CodeMemberField outputCacheSettingsField = new CodeMemberField(
                    ...
                    CodeConditionStatement outputCacheSettingsCondition =
                    ...
                    outputCacheSettingsDeclaration.Type = new CodeTypeReference(
                        typeof(OutputCacheParameters)
                    );
                    ...
                    CodeAssignStatement setOutputCacheObject = new CodeAssignStatement(
                        outputCacheSettings,
                        cacheSettingsObject
                    );
                    ...
                    CodeAssignStatement assignOutputCacheSettings = new CodeAssignStatement(
        ...
        protected override void BuildFrameworkInitializeMethodContents(CodeMemberMethod method)
        {
            ...
            if (Parser.StyleSheetTheme != null)
            {
                ...
                CodeExpression leftExpr = new CodePropertyReferenceExpression(
                    new CodeThisReferenceExpression(),
                    _styleSheetThemePropertyName
                );
            ...
            else if (MultiTargetingUtil.TargetFrameworkVersion >= VersionUtil.Framework45)
            {
                ...
                CodeFieldReferenceExpression right = new CodeFieldReferenceExpression(
                    new CodeTypeReferenceExpression(typeof(ValidateRequestMode)),
                    "Disabled"
                );
