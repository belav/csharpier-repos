...
internal class ClientBuildManagerTypeDescriptionProviderBridge : MarshalByRefObject
{
    ...
    {
        Debug.Assert(
            _targetFrameworkProvider != null,
            "_targetFrameworkProvider should not be null"
        );
        if (type == null)
        {
            return null;
    ...
    )
    {
        ...
        {
            PropertyInfo runtimePropInfo = type.GetProperty(
                name,
                bindingAttr,
                null /* binder */
                ,
        ...
        PropertyInfo reflectionPropertyInfo = reflectionType.GetProperty(
            name,
            bindingAttr,
            null /* binder */
            ,
