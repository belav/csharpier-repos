...
namespace System.Web.Compilation
{
    internal class MultiTargetingUtil
    {
        ...
        internal static readonly FrameworkName FrameworkNameV20 = CreateFrameworkName(
        ...
        internal static FrameworkName TargetFrameworkName
        {
            ...
            set { s_targetFrameworkName = value; }
        }
                ...
                lock (s_targetFrameworkNameLock)
                {
                    if (s_targetFrameworkName == null)
                    {
                        ...
                        Debug.Assert(
                            ...
                            "s_targetFrameworkName should not be null"
                        );
                    }
                }
            }
        ...
        private static void ValidateTargetFrameworkMoniker(string targetFrameworkMoniker)
        {
            ...
            catch (ArgumentException e)
            {
                throw new ConfigurationErrorsException(
                    SR.GetString(
                        SR.Invalid_target_framework_version,
                        s_configTargetFrameworkAttributeName,
            ...
            if (ver < Version40)
            {
                throw new ConfigurationErrorsException(
                    SR.GetString(
                        SR.Invalid_lower_target_version,
                        s_configTargetFrameworkAttributeName
                    ),
                    source,
                    lineNumber
            ...
            throw new ConfigurationErrorsException(
                SR.GetString(
                    SR.Invalid_higher_target_version,
                    s_configTargetFrameworkAttributeName
                ),
                source,
                lineNumber
        ...
        private static Version GetInstalledTargetVersion(int majorVersion)
        {
            ...
            string path =
                @"HKEY_LOCAL_MACHINE\SOFTWARE\Microsoft\NET Framework Setup\NDP\v"
                + majorVersion
                + @"\Full";
            try
            {
            ...
            try
            {
                ...
                foreach (string subKey in baseKey.GetSubKeyNames())
                {
                    try
                    {
                        ...
                        var supportedName = new FrameworkName(
                            subKeyName.Identifier,
                            subKeyName.Version
                        );
                        if (
                            String.Equals(
                                name.FullName,
                                supportedName.FullName,
        ...
        private static bool WebConfigExists
        {
            get
            {
                ...
                {
                    string path = vpath
                        .SimpleCombine(HttpConfigurationSystem.WebConfigFileName)
                        .MapPath();
        ...
        private static void InitializeTargetFrameworkNameFor20Or35()
        {
            ...
            else
            {
                throw new ConfigurationErrorsException(
                    SR.GetString(
                        SR.Compiler_version_20_35_required,
                        s_configTargetFrameworkAttributeName
                    )
                );
            }
        ...
        private static void ReportInvalidCompilerVersion(string compilerVersion)
        {
            throw new ConfigurationErrorsException(
                SR.GetString(
                    SR.Invalid_attribute_value,
                    compilerVersion,
                    CompilationUtil.CodeDomProviderOptionPath + "CompilerVersion"
                )
            );
        }

        private static void InitializeTargetFrameworkNameFor40AndAbove(
            ...
            if (compilerVersion != null)
            {
                ...
                try
                {
                    ...
                    if (version < Version40)
                    {
                        throw new ConfigurationErrorsException(
                            SR.GetString(
                                SR.Compiler_version_40_required,
                                s_configTargetFrameworkAttributeName
                            )
                        );
                    }
        ...
        {
            get { return Object.Equals(TargetFrameworkName, FrameworkNameV35); }
        }
        ...
        {
            get { return GetFrameworkNameVersion(TargetFrameworkName); }
        }

        internal static bool IsTargetFramework40OrAbove
        {
            get { return MultiTargetingUtil.TargetFrameworkVersion.Major >= 4; }
        }

        internal static bool IsTargetFramework45OrAbove
        {
            get { return IsTargetFramework40OrAbove && TargetFrameworkVersion.Minor >= 5; }
        }
