...
namespace System.Web.Compilation
{
    ...
    internal sealed class SourceFileBuildProvider : InternalBuildProvider
    {
        ...
        {
            get { return CompilationUtil.GetCompilerInfoFromVirtualPath(VirtualPathObject); }
        }
        ...
        private void EnsureCodeCompileUnit()
        {
            if (_snippetCompileUnit == null)
            {
                ...
                _snippetCompileUnit.LinePragma =
                    BaseCodeDomTreeGenerator.CreateCodeLinePragmaHelper(VirtualPath, 1);
            }
        }
