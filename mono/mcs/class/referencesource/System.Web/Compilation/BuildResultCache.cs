...
namespace System.Web.Compilation
{
    ...
    internal abstract class BuildResultCache
    {
        ...
        internal abstract BuildResult GetBuildResult(
            string cacheKey,
        ...
        internal abstract void CacheBuildResult(
            string cacheKey,
            BuildResult result,
            long hashCode,
            DateTime utcStart
    ...
    internal class MemoryBuildResultCache : BuildResultCache
    {
        ...
        private void OnAssemblyLoad(object sender, AssemblyLoadEventArgs args)
        {
            ...
            foreach (AssemblyName assemblyName in a.GetReferencedAssemblies())
            {
                ...
                if (
                    !StringUtil.StringStartsWith(assemblyName.Name, BuildManager.AssemblyNamePrefix)
                )
                    continue;
        ...
        internal override BuildResult GetBuildResult(
            string cacheKey,
            VirtualPath virtualPath,
            long hashCode,
        ...
        )
        {
            ...
            if (result == null)
            {
                Debug.Trace(
                    "BuildResultCache",
                    "'" + cacheKey + "' was not found in the memory cache"
                );
                return null;
            }
        ...
        internal override void CacheBuildResult(
            string cacheKey,
            BuildResult result,
            long hashCode,
            DateTime utcStart
        )
        {
            ...
            BuildResultCompiledAssemblyBase compiledResult =
                result as BuildResultCompiledAssemblyBase;
            if (
                compiledResult != null
                && compiledResult.ResultAssembly != null
                && !compiledResult.UsesExistingAssembly
            )
            {
                ...
                CacheDependency assemblyCacheDependency = new CacheDependency(
                    0,
                    null,
                    new string[] { assemblyKey }
                );
                ...
                if (cacheDependency != null)
                {
                    ...
                    tmpDependency.Add(
                        new CacheDependency[] { cacheDependency, assemblyCacheDependency }
                    );
        ...
        private void OnCacheItemRemoved(string key, object value, CacheItemRemovedReason reason)
        {
            ...
            if (reason == CacheItemRemovedReason.DependencyChanged)
            {
                ...
                if (HostingEnvironment.ShutdownInitiated)
                {
                    ...
                    RemoveAssemblyAndCleanupDependenciesShuttingDown(
                        value as BuildResultCompiledAssembly
                    );
                }
                else
                {
                    ...
                    if (((BuildResult)value).ShutdownAppDomainOnChange)
                    {
                        ...
                        ThreadPool.QueueUserWorkItem(
                            new WaitCallback(MemoryBuildResultCache.ShutdownCallBack),
        ...
        private static void ShutdownCallBack(Object state)
        {
            ...
            if (message != null)
            {
                HttpRuntime.SetShutdownReason(
                    ApplicationShutdownReason.BuildManagerChange,
                    message
                );
            }
        ...
        internal void RemoveAssemblyAndCleanupDependencies(
            BuildResultCompiledAssemblyBase compiledResult
        )
        {
            if (compiledResult == null)
    ...
    internal abstract class DiskBuildResultCache : BuildResultCache
    {
            ...
            if (!FileUtil.DirectoryExists(_cacheDir))
            {
                ...
                catch (IOException e)
                {
                    throw new HttpException(
                        SR.GetString(
                            SR.Failed_to_create_temp_dir,
                            HttpRuntime.GetSafePath(_cacheDir)
                        ),
                        e
                    );
                }
        ...
        )
        {
            ...
            BuildResult result = pfr.ReadBuildResultFromFile(
                virtualPath,
                preservationFile,
                hashCode,
                ensureIsUpToDate
            ...
            if (result != null)
                ...
                Debug.Trace(
                    "BuildResultCache",
                    "'" + cacheKey + "' was not found in the disk cache"
                );
        ...
        )
        {
            ...
            if (HostingEnvironment.ShutdownInitiated)
            {
                ...
                if (
                    ...
                    MarkAssemblyAndRelatedFilesForDeletion(
                        compiledResult.ResultAssembly.GetName().Name
                    );
                return;
            }
        ...
        private string GetPreservedDataFileName(string cacheKey)
        {
            ...
            cacheKey = FileUtil.TruncatePathIfNeeded(
                cacheKey,
                9 /*length of ".compiled"*/
            );
        ...
        internal virtual void RemoveAssemblyAndRelatedFiles(string assemblyName)
        {
            Debug.Trace(
                "DiskBuildResultCache",
                "RemoveAssemblyAndRelatedFiles(" + assemblyName + ")"
            );
        ...
        internal static void ShutDownAppDomainIfRequired()
        {
            ...
            )
            {
                ...
                // (DevDiv 158814)
                ThreadPool.QueueUserWorkItem(
                    new WaitCallback(DiskBuildResultCache.ShutdownCallBack)
                );
            }
        }
        ...
        internal static bool CheckAndRemoveDotDeleteFile(FileInfo f)
        {
            ...
            if (FileUtil.FileExists(baseName))
            {
                try
                {
                    ...
                    Debug.Trace(
                        "DiskBuildResultCache",
                        "CheckAndRemoveDotDeleteFile deleted " + baseName
                    );
                }
                catch
                {
            ...
            try
            {
                ...
                Debug.Trace(
                    "DiskBuildResultCache",
                    "CheckAndRemoveDotDeleteFile deleted " + f.Name
                );
            }
            catch { }
        ...
        private static void CreateDotDeleteFile(FileInfo f)
        {
            ...
            if (!File.Exists(newName))
            {
                try
                {
                    ...
                    Debug.Trace(
                        "DiskBuildResultCache",
                        "CreateDotDeleteFile succeeded: " + newName
                    );
                }
                catch
                {
    ...
    internal class StandardDiskBuildResultCache : DiskBuildResultCache
    {
         ...
         */
        internal static void SavePreservedSpecialFilesCombinedHash(
            string hashFilePath,
            Tuple<long, long> hash
        )
        {
            Debug.Assert(
                hash != null && hash.Item1 != 0 && hash.Item2 != 0,
        ...
        internal void RemoveOldTempFiles()
        {
            ...
            foreach (FileData fileData in FileEnumerator.Create(codegen))
            {
                ...
                else
                {
                    ...
                    DiskBuildResultCache.CheckAndRemoveDotDeleteFile(
                        new FileInfo(fileData.FullName)
                    );
                    continue;
                }
                ...
                Debug.Trace(
                    "BuildResultCache",
                    "Deleting old temporary files: " + fileData.FullName
                );
                try
                {
        ...
        private void RemoveCodegenResourceDir()
        {
            ...
            Debug.Trace(
                "BuildResultCache",
                "Deleting codegen temporary resource directory: " + path
            );
        ...
        [SuppressMessage(
            ...
            MessageId = "System.Web.UnsafeNativeMethods.DeleteShadowCache(System.String,System.String)",
        ...
        internal void RemoveAllCodegenFiles()
        {
            ...
            foreach (FileData fileData in FileEnumerator.Create(_cacheDir))
            {
                ...
                if (fileData.IsDirectory)
                {
                    ...
                    if (
                        StringUtil.StringStartsWith(
                            fileData.Name,
                            CodeDirectoryCompiler.sourcesDirectoryPrefix
                        )
                    )
                        continue;
            ...
            UnsafeNativeMethods.DeleteShadowCache(
