...
namespace System.Web
{
    ...
    public class UnvalidatedRequestValuesWrapper : UnvalidatedRequestValuesBase
    {
        ...
        {
            get { return _requestValues.Form; }
        }

        public override NameValueCollection QueryString
        {
            get { return _requestValues.QueryString; }
        }

        public override NameValueCollection Headers
        {
            get { return _requestValues.Headers; }
        }

        public override HttpCookieCollection Cookies
        {
            get { return _requestValues.Cookies; }
        }

        public override HttpFileCollectionBase Files
        {
            get { return new HttpFileCollectionWrapper(_requestValues.Files); }
        }

        public override string RawUrl
        {
            get { return _requestValues.RawUrl; }
        }

        public override string Path
        {
            get { return _requestValues.Path; }
        }

        public override string PathInfo
        {
            get { return _requestValues.PathInfo; }
        }

        public override string this[string field]
        {
            get { return _requestValues[field]; }
        }

        public override Uri Url
        {
            get { return _requestValues.Url; }
        }
    }
}
