...
namespace System.Web.Hosting
{
    ...
    public interface IProcessHost
    {
        ...
        void EnumerateAppDomains(
            [MarshalAs(UnmanagedType.Interface)] out IAppDomainInfoEnum appDomainInfoEnum
        );
    }
            ...
            IApplicationPreloadManager
    {
                    ...
                    lock (this)
                    {
                        if (_protocolsConfig == null)
                        {
                            ...
                            else
                            {
                                ...
                                _protocolsConfig = (ProtocolsSection)
                                    c.GetSection("system.web/protocols");
                            }
                        }
                    }
                }
        ...
        [SuppressMessage(
            ...
            Justification = "Reading this particular registry value is safe."
        )]
        private ProcessHost(IProcessHostSupportFunctions functions)
        {
            try
            {
                ...
                int maxPreloadConcurrency = (int)
                    Misc.GetAspNetRegValue(null, "MaxPreloadConcurrency", 0);
                if (maxPreloadConcurrency > 0)
                {
                    _preloadingThrottle = new System.Threading.Semaphore(
        ...
        )
        {
            ...
            catch (Exception e)
            {
                ...
                throw new ConfigurationErrorsException(e.Message, e, source, lineNum);
            }
        ...
        private Type GetAppDomainProtocolHandlerType(String protocolId)
        {
            ...
            catch (Exception e)
            {
                using (new ProcessImpersonationContext())
                {
                    Misc.ReportUnhandledException(
                        e,
                        new string[] { SR.GetString(SR.Invalid_AppDomain_Prot_Type) }
                    );
                }
            }
        ...
        )
        {
            try
            {
                ...
                protocolHandlerType = ValidateAndGetType(
                    configEntry,
                ...
                lock (this)
                {
                    ...
                    if (protocolHandler == null)
                    {
                        protocolHandler = (ProcessProtocolHandler)
                            Activator.CreateInstance(protocolHandlerType);
            ...
            catch (Exception e)
            {
                using (new ProcessImpersonationContext())
                {
                    Misc.ReportUnhandledException(
                        e,
                        new string[] { SR.GetString(SR.Invalid_Process_Prot_Type) }
                    );
                }
                throw;
            }
        ...
        )
        {
            ...
            catch (Exception e)
            {
                using (new ProcessImpersonationContext())
                {
                    Misc.ReportUnhandledException(
                        e,
                        new string[] { SR.GetString(SR.Failure_Stop_Listener_Channel) }
                    );
                }
                throw;
            }
        ...
        public void StopProcessProtocol(String protocolId, bool immediate)
        {
            ...
            catch (Exception e)
            {
                using (new ProcessImpersonationContext())
                {
                    Misc.ReportUnhandledException(
                        e,
                        new string[] { SR.GetString(SR.Failure_Stop_Process_Prot) }
                    );
                }
                throw;
            }
        ...
        public void StartAppDomainProtocolListenerChannel(
            String appId,
            String protocolId,
            IListenerChannelCallback listenerChannelCallback
        )
        {
            try
            {
                ...
                lock (ac)
                {
                    HostingEnvironmentParameters hostingParameters =
                        new HostingEnvironmentParameters();
                    ...
                    ListenerAdapterDispatchShim shim = (ListenerAdapterDispatchShim)
                        _appManager.CreateObjectInternal(
                            appId,
                            typeof(ListenerAdapterDispatchShim),
                            appHost,
                            false /*failIfExists*/
                            ,
                            hostingParameters
            ...
            catch (Exception e)
            {
                using (new ProcessImpersonationContext())
                {
                    Misc.ReportUnhandledException(
                        e,
                        new string[] { SR.GetString(SR.Failure_Start_AppDomain_Listener) }
                    );
                }
                throw;
            }
        ...
        )
        {
            ...
            catch (Exception e)
            {
                using (new ProcessImpersonationContext())
                {
                    Misc.ReportUnhandledException(
                        e,
                        new string[] { SR.GetString(SR.Failure_Stop_AppDomain_Listener) }
                    );
                }
                throw;
            }
        ...
        public void StopAppDomainProtocol(String appId, String protocolId, bool immediate)
        {
            ...
            catch (Exception e)
            {
                using (new ProcessImpersonationContext())
                {
                    Misc.ReportUnhandledException(
                        e,
                        new string[] { SR.GetString(SR.Failure_Stop_AppDomain_Protocol) }
                    );
                }
                throw;
            }
        ...
        public void StartApplication(String appId, String appPath, out Object runtimeInterface)
        {
            ...
            catch (Exception e)
            {
                using (new ProcessImpersonationContext())
                {
                    Misc.ReportUnhandledException(
                        e,
                        new string[] { SR.GetString(SR.Failure_Start_Integrated_App) }
                    );
                }
                throw;
            }
        ...
        public void ShutdownApplication(String appId)
        {
            ...
            catch (Exception e)
            {
                using (new ProcessImpersonationContext())
                {
                    Misc.ReportUnhandledException(
                        e,
                        new string[] { SR.GetString(SR.Failure_Stop_Integrated_App) }
                    );
                }
                throw;
            }
        ...
        public void Shutdown()
        {
            ...
            catch (Exception e)
            {
                using (new ProcessImpersonationContext())
                {
                    Misc.ReportUnhandledException(
                        e,
                        new string[] { SR.GetString(SR.Failure_Shutdown_ProcessHost), e.ToString() }
                    );
                }
                throw;
            }
        ...
        [SuppressMessage(
            ...
            Justification = "See comment for why we're calling GC.Collect."
        )]
        ...
        public void EnumerateAppDomains(out IAppDomainInfoEnum appDomainInfoEnum)
        {
            ...
            catch (Exception e)
            {
                using (new ProcessImpersonationContext())
                {
                    Misc.ReportUnhandledException(
                        e,
                        new string[] { SR.GetString(SR.Failure_AppDomain_Enum) }
                    );
                }
                throw;
            }
        ...
        public bool IsIdle()
        {
            ...
            catch (Exception e)
            {
                using (new ProcessImpersonationContext())
                {
                    Misc.ReportUnhandledException(
                        e,
                        new string[] { SR.GetString(SR.Failure_PMH_Idle) }
                    );
                }
                throw;
            }
        ...
        public void Ping(IProcessPingCallback callback)
        {
            ...
            catch (Exception e)
            {
                using (new ProcessImpersonationContext())
                {
                    Misc.ReportUnhandledException(
                        e,
                        new string[] { SR.GetString(SR.Failure_PMH_Ping) }
                    );
                }
                throw;
            }
        ...
        public void SetApplicationPreloadUtil(IApplicationPreloadUtil applicationPreloadUtil)
        {
            ...
            if (_preloadUtil != null)
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Failure_ApplicationPreloadUtil_Already_Set)
                );
            }
        ...
        public void SetApplicationPreloadState(string context, string appId, bool enabled)
        {
            ...
            if (enabled && _preloadUtil == null)
            {
                throw new ArgumentException(
                    SR.GetString(SR.Invalid_Enabled_Preload_Parameter),
                    "enabled"
                );
            }
        ...
        internal static void PreloadApplicationIfNotShuttingdown(
            string appId,
        ...
        )
        {
            ...
            GetApplicationPreloadInfoWithAssert(
                ac.PreloadContext,
                out stillEnabled,
                out preloadObjTypeName,
                out paramsForStartupObj
            );
            ...
            try
            {
                ...
                IApplicationHost appHost =
                    (appHostParameter == null) ? CreateAppHost(appId, null) : appHostParameter;
                ...
                try
                {
                    preloadHostObj.CreateIProcessHostPreloadClientInstanceAndCallPreload(
                        preloadObjTypeName,
                        paramsForStartupObj
                    );
                }
                catch (Exception e)
                {
                    ...
                    ReportApplicationPreloadFailureWithAssert(
                        ...
                        Misc.FormatExceptionMessage(
                                e,
                                new string[] { SR.GetString(SR.Failure_Calling_Preload_Provider) }
                            )
                            .ToString()
                    );
        ...
        {
            _preloadUtil.GetApplicationPreloadInfo(
                context,
                out enabled,
                out startupObjType,
                out parametersForStartupObj
            );
        }

        [PermissionSet(SecurityAction.Assert, Unrestricted = true)]
        private void ReportApplicationPreloadFailureWithAssert(
            string context,
            int errorCode,
            string errorMessage
        )
        ...
        {
            _customLoaderStartupError = new KeyValuePair<string, ExceptionDispatchInfo>(
                appId,
                error
            );
        }

        IObjectHandle IProcessHostLite.GetCustomLoader(
            string appId,
        ...
        )
        {
            ...
            CustomLoaderHelperFunctions helperFunctions = new CustomLoaderHelperFunctions(
                _functions,
                appId
            );
            ...
            try
            {
                string customLoaderAssemblyPhysicalPath = helperFunctions.MapPath(
        ...
        void IProcessHostLite.ReportCustomLoaderError(
            string appId,
            int hr,
        ...
        string IProcessHostLite.GetFullExceptionMessage(int hr, IntPtr pErrorInfo)
        {
            ...
            Exception ex = Marshal.GetExceptionForHR(
                hr,
                (pErrorInfo != IntPtr.Zero) ? pErrorInfo : (IntPtr)(-1)
            );
        ...
        private sealed class CustomLoaderHelperFunctions : ICustomLoaderHelperFunctions
        {
            ...
            internal CustomLoaderHelperFunctions(
            ...
            )
            {
                ...
                string appVirtualPath,
                    ...
                    siteName,
                    siteId;
                _supportFunctions.GetApplicationProperties(
                    appId,
                    out appVirtualPath,
                    out appPhysicalPath,
                    out siteName,
            ...
            } // true = always enabled, false = always disabled, null = check trust level
            ...
            private static bool? GetIsEnabledValueFromRegistry()
            {
                ...
                try
                {
                    int valueInRegistry = (int)
                        Misc.GetAspNetRegValue(null, "CustomLoaderEnabled", -1);
            ...
            {
                object retVal;
                int hr = UnsafeIISMethods.MgdGetConfigProperty(
                    appConfigMetabasePath,
                    "system.web/trust",
                    "level",
                    out retVal
                );
    ...
    internal sealed class ListenerAdapterDispatchShim : MarshalByRefObject, IRegisteredObject
    {
        ...
        internal void StartListenerChannel(
            AppDomainProtocolHandler handler,
            IListenerChannelCallback listenerCallback
        )
        {
        ...
        internal IListenerChannelCallback MarshalComProxy(
            IListenerChannelCallback defaultDomainCallback
        )
        {
