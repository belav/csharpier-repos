...
namespace System.Web.Hosting
{
    ...
    public interface IAppDomainFactory
    {
        ...
        Object Create(
            [In, MarshalAs(UnmanagedType.BStr)] String module,
        ...
        Object Create(
            [In, MarshalAs(UnmanagedType.Error)] String module,
            [In, MarshalAs(UnmanagedType.Error)] String typeName,
            [In, MarshalAs(UnmanagedType.Error)] String appId,
            [In, MarshalAs(UnmanagedType.Error)] String appPath,
            [In, MarshalAs(UnmanagedType.Error)] String strUrlOfAppOrigin,
            [In, MarshalAs(UnmanagedType.I4)] int iZone
        );
        ...
        */
        ...
        public Object Create(String appId, String appPath)
        {
            try
            {
                ...
                ISAPIApplicationHost appHost = new ISAPIApplicationHost(
                    appId,
                    appPath,
            ...
            catch (Exception e)
            {
                Debug.Trace(
                    "internal",
                    "AppDomainFactory::Create failed with "
                        + e.GetType().FullName
                        + ": "
                        + e.Message
                        + "\r\n"
        ...
        {
            // devdiv 710164:	Still repro - ctrl-f5 a WAP project might show "Cannot create/shadow copy when a
            // file exists" error
            // since the hash file lists are different, IISExpress launched by VS cannot reuse the build result
            // from VS build.
            // It deletes the build files generated by CBM and starts another round of build. This causes
            // interruption between IISExpress and VS
            ...
            // We previously use HostingEnvironment to determine whether it is under dev environment and the
            // returned string. However,
            // for partial trust scenario, this method is called before HostingEnvironment has been initialized,
            // we thus may return a wrong value.
