        ...
        internal VirtualFile GetFileWithCheck(string virtualPath)
        {
            ...
            if (!StringUtil.EqualsIgnoreCase(virtualPath, virtualFile.VirtualPath))
            {
                throw new HttpException(
                    SR.GetString(
                        SR.Bad_VirtualPath_in_VirtualFileBase,
                        "VirtualFile",
...
*/
        ...
        */
        ...
        {
            string virtualPath = CombineVirtualPaths(
                basePath.VirtualPathString,
        ...
        */
        ...
        {
            VirtualPathProvider vpathProvider = HostingEnvironment.VirtualPathProvider;
            return vpathProvider.GetCacheDependency(
                virtualPath,
                new SingleObjectCollection(virtualPath.VirtualPathString),
                DateTime.MaxValue
            );
        }
        ...
        */
        internal static VirtualPath CombineVirtualPathsInternal(
