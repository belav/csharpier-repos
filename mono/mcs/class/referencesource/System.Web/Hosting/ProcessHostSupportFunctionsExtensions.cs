...
namespace System.Web.Hosting
{
    ...
    internal static class ProcessHostSupportFunctionsExtensions
    {
        ...
        public static string MapPathInternal(
            this IProcessHostSupportFunctions supportFunctions,
            string appId,
        ...
        )
        {
            ...
            StringBuilder fullVirtualPath = new StringBuilder(
                appVirtualPath.Length + relativePath.Length + 2 /* for slashes */
            );
