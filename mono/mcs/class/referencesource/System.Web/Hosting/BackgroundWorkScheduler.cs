...
namespace System.Web.Hosting
{
    ...
    {
        private readonly CancellationTokenHelper _cancellationTokenHelper =
            new CancellationTokenHelper(canceled: false);
        ...
        internal BackgroundWorkScheduler(
            Action<BackgroundWorkScheduler> unregisterCallback,
            Action<AppDomain, Exception> logCallback,
            Action workItemCompleteCallback = null
        )
        {
            ...
            catch (Exception ex)
            {
                ...
                if (
                    ...
                    && operationCanceledException.CancellationToken
                        == _cancellationTokenHelper.Token
                )
                {
                    return;
                }
