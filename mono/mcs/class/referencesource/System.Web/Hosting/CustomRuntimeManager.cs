...
namespace System.Web.Hosting
{
    ...
    internal sealed class CustomRuntimeManager : ICustomRuntimeManager
    {
        private readonly ConcurrentDictionary<
            ...
            object
        > _activeRegistrations = new ConcurrentDictionary<CustomRuntimeRegistration, object>();
        ...
        {
            CustomRuntimeRegistration registration = new CustomRuntimeRegistration(
                this,
                customRuntime
            );
        ...
        public Action SuspendAllCustomRuntimes()
        {
            ...
            List<IProcessResumeCallback> callbacks = new List<IProcessResumeCallback>(
                suspendListeners.Count
            );
        ...
        private sealed class CustomRuntimeRegistration : ICustomRuntimeRegistrationToken
        {
            ...
            public CustomRuntimeRegistration(
                CustomRuntimeManager customRuntimeManager,
            ...
            public void Unregister()
            {
                ...
                Debug.Assert(
                    removed,
                    "Entry did not exist in the dictionary; was it removed twice?"
                );
            }
        }
    }
