...
namespace System.Web.Hosting
{
    ...
    internal sealed class SuspendManager
    {
        ...
        private readonly ConcurrentDictionary<
            ...
            object
        > _registeredObjects = new ConcurrentDictionary<ISuspendibleRegisteredObject, object>();
        ...
        private static SuspendState SuspendImpl(
            ICollection<ISuspendibleRegisteredObject> allRegisteredObjects
        )
        {
            // Our behavior is:
