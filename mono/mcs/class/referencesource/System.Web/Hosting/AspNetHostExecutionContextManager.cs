namespace System.Web.Hosting
{
    ...
    internal sealed class AspNetHostExecutionContextManager : HostExecutionContextManager
    {
        ...
        {
            AspNetHostExecutionContext castHostExecutionContext =
                hostExecutionContext as AspNetHostExecutionContext;
            if (castHostExecutionContext != null)
            {
                ...
                {
                    baseRevertParameter = base.SetHostExecutionContext(
                        castHostExecutionContext.BaseContext
                    );
                }
                ...
                if (
                    currentContext != null
                    && currentContext.HttpContext.ThreadContextId
        ...
        private sealed class AspNetHostExecutionContext : HostExecutionContext
        {
            ...
            internal AspNetHostExecutionContext(
                HostExecutionContext baseContext,
                object httpContextThreadContextId
            )
            {
            ...
            private static HostExecutionContext CreateCopyHelper(
