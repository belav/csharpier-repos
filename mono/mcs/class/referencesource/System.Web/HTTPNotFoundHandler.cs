...
namespace System.Web
{
    ...
    internal class HttpNotFoundHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            throw new HttpException(404, SR.GetString(SR.Path_not_found, context.Request.Path));
        }
    ...
    internal class HttpForbiddenHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            throw new HttpException(403, SR.GetString(SR.Path_forbidden, context.Request.Path));
        }
    ...
    internal class HttpNotImplementedHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            throw new HttpException(
                501,
                SR.GetString(
                    SR.Method_for_path_not_implemented,
