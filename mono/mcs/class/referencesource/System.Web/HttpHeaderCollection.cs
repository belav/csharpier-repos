    ...
    internal class HttpHeaderCollection : HttpValueCollection
    {
        ...
        internal void SetHeader(String name, String value, bool replace)
        {
            ...
            if (_request != null)
            {
                ...
                HttpServerVarsCollection serverVars =
                    _request.ServerVariables as HttpServerVarsCollection;
                if (serverVars != null)
                {
                    serverVars.SynchronizeServerVariable(
        ...
        public override void Remove(String name)
        {
            ...
            if (_request != null)
            {
                ...
                _iis7WorkerRequest.SetRequestHeader(
                    name,
                    null /*value*/
                    ,
                    false /*replace*/
            ...
            {
                _iis7WorkerRequest.SetResponseHeader(
                    name,
                    null /*value*/
                    ,
                    false /*replace*/
