...
namespace System.Web
{
    ...
    internal class HttpBufferlessInputStream : Stream
    {
        ...
        internal HttpBufferlessInputStream(
            HttpContext context,
        ...
        )
        {
            ...
            {
                _rawContent = new HttpRawUploadedContent(
                    _fileThreshold,
                ...
                if (bytesRead <= 0)
                {
                    if (!_context.Response.IsClientConnected)
                    {
                        ...
                        throw new HttpException(
                            SR.GetString(SR.HttpBufferlessInputStream_ClientDisconnected)
                        );
                    }
                    break;
                }
