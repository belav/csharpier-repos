...
namespace System.Web.Util
{
    ...
    public class HttpEncoder
    {
        ...
        private static readonly Lazy<HttpEncoder> _customEncoderResolver = new Lazy<HttpEncoder>(
        ...
        {
            get { return !AppSettings.JavaScriptDoNotEncodeAmpersand; }
        }
        ...
        private static HttpEncoder GetCustomEncoderFromConfig()
        {
            ...
            ConfigUtil.CheckBaseType(
                typeof(HttpEncoder) /* expectedBaseType */
                ,
                encoderType,
                "encoderType",
                runtimeSection
        ...
        {
            encodedHeaderName =
                (String.IsNullOrEmpty(headerName)) ? headerName : HeaderEncodeInternal(headerName);
            encodedHeaderValue =
                (String.IsNullOrEmpty(headerValue))
                    ? headerValue
                    : HeaderEncodeInternal(headerValue);
        }
        ...
        internal String UrlEncodeNonAscii(string str, Encoding e)
        {
            ...
            byte[] encodedBytes = UrlEncodeNonAscii(
                bytes,
                0,
                bytes.Length,
        ...
        internal byte[] UrlEncodeNonAscii(
            byte[] bytes,
            int offset,
            int count,
            bool alwaysCreateNewReturnValue
        ...
        protected internal virtual string UrlPathEncode(string value)
        {
            ...
            if (BinaryCompatibility.Current.TargetsAtLeastFramework46)
            {
                ...
                bool isValidUrl = UriUtil.TrySplitUriForPathEncode(
                    value,
