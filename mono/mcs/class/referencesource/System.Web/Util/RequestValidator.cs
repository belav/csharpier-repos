...
namespace System.Web.Util
{
    ...
    public class RequestValidator
    {
        ...
        private static RequestValidator GetCustomValidatorFromConfig()
        {
            ...
            // validate the type
            Type validatorType = ConfigUtil.GetType(
                validatorTypeName,
                "requestValidationType",
                runtimeSection
            );
            ConfigUtil.CheckBaseType(
                typeof(RequestValidator) /* expectedBaseType */
                ,
                validatorType,
                "requestValidationType",
                runtimeSection
            ...
            RequestValidator validator = (RequestValidator)
                HttpRuntime.CreatePublicInstance(validatorType);
            return validator;
        }
        ...
        public bool InvokeIsValidRequestString(
            HttpContext context,
            string value,
        ...
        )
        {
            ...
            return !CrossSiteScriptingValidation.IsDangerousString(
                value,
                out validationFailureIndex
            );
        }
