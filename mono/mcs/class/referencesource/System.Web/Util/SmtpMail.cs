...
namespace System.Web.Mail
{
    ...
    public class SmtpMail
    {
        ...
        internal class LateBoundAccessHelper
        {
                    ...
                    if (_type == null)
                    {
                        ...
                        if (_type == null)
                            throw new HttpException(
                                SR.GetString(SR.SMTP_TypeCreationError, _progId)
                            );
                    }
            ...
            internal static void SetPropStatic(
                Object obj,
                String propName,
                Object propKey,
                Object propValue
        ...
        {
            private static LateBoundAccessHelper _helper = new LateBoundAccessHelper(
                "CDONTS.NewMail"
            );
            ...
            internal static void Send(MailMessage message)
            {
                ...
                if (message.BodyEncoding != null)
                    _helper.CallMethod(
                        newMail,
                        "SetLocaleIDs",
                        new Object[1] { message.BodyEncoding.CodePage }
                    );
                ...
                _helper.SetProp(
                    newMail,
                    "Body",
                    (message.Body != null) ? message.Body : String.Empty
                );
                ...
                for (IEnumerator e = message.Attachments.GetEnumerator(); e.MoveNext(); )
                {
                    ...
                    _helper.CallMethod(
                        newMail,
                        "AttachFile",
                        new Object[3] { a.Filename, null, (Object)c }
                    );
                }
        ...
        internal class CdoSysHelper
        {
            ...
            internal static void Send(MailMessage message)
            {
                ...
                {
                    MailAttachment a = (MailAttachment)e.Current;
                    Object bodyPart = _helper.CallMethod(
                        m,
                        "AddAttachment",
                        new Object[3] { a.Filename, null, null }
                    );
            ...
            lock (_lockObject)
            {
                ...
                else if (!CdoSysHelper.OsSupportsCdoSys())
                {
                    throw new PlatformNotSupportedException(
                        SR.GetString(SR.SmtpMail_not_supported_on_Win7_and_higher)
                    );
                }
