    ...
    internal sealed class Misc
    {
        ...
        internal static StringComparer CaseInsensitiveInvariantKeyComparer
        {
            get
            {
                ...
                {
                    s_caseInsensitiveInvariantKeyComparer = StringComparer.Create(
        ...
        internal static void WriteUnhandledExceptionToEventLog(
            AppDomain appDomain,
            Exception exception
        )
        {
        ...
        internal static IProcessHostSupportFunctions CreateLocalSupportFunctions(
        ...
        internal static object GetAspNetRegValue(
            string subKey,
            string valueName,
            object defaultValue
        )
