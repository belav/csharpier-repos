...
#pragma warning restore 0618
        ...
        private static bool VirtualPathStartsWithVirtualPath(
            string virtualPath1,
            string virtualPath2
        )
        {
        ...
        internal static bool VirtualPathStartsWithAppPath(string virtualPath)
        {
            ...
            return VirtualPathStartsWithVirtualPath(
                virtualPath,
        ...
        {
            Debug.Assert(HttpRuntime.AppDomainAppVirtualPathObject != null);
            return MakeVirtualPathAppRelative(
                virtualPath,
                HttpRuntime.AppDomainAppVirtualPathString,
                false /*nullIfNotInApp*/
            );
        }
        ...
        {
            Debug.Assert(HttpRuntime.AppDomainAppVirtualPathObject != null);
            return MakeVirtualPathAppAbsolute(
                virtualPath,
                HttpRuntime.AppDomainAppVirtualPathString
            );
        }
        ...
        internal static string MakeVirtualPathAppAbsolute(
            string virtualPath,
            string applicationPath
        )
        {
        ...
        internal static bool IsPathOnSameServer(string absUriOrLocalPath, Uri currentRequestUri)
        {
            ...
            if (!Uri.TryCreate(absUriOrLocalPath, UriKind.Absolute, out absUri))
            {
                ...
                return AppSettings.AllowRelaxedRelativeUrl
                    || (
                        (IsRooted(absUriOrLocalPath) || IsRelativeUrl(absUriOrLocalPath))
                        && !absUriOrLocalPath
                            .TrimStart(' ')
