...
namespace System.Web.Util
{
    ...
    internal sealed class PinnedArraySegment<T> : IDisposable
    {
        ...
        [SuppressMessage(
            ...
            Justification = @"This is a memory pointer, not a handle. The handle is in the _gcHandle field, and its lifetime is controlled by the caller."
        )]
        ...
        [SuppressMessage(
            ...
            Justification = @"We don't own native resources."
        )]
        public void Dispose()
        {
