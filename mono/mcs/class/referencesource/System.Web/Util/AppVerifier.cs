namespace System.Web.Util
{
    ...
    internal static class AppVerifier
    {
        ...
        private static readonly Dictionary<AppVerifierErrorCode, string> _errorStringMappings =
            new Dictionary<AppVerifierErrorCode, string>()
            {
                {
                    AppVerifierErrorCode.HttpApplicationInstanceWasNull,
                    SR.AppVerifier_Errors_HttpApplicationInstanceWasNull
                },
                {
                    AppVerifierErrorCode.BeginHandlerDelegateWasNull,
                    SR.AppVerifier_Errors_BeginHandlerDelegateWasNull
                },
                {
                ...
                },
                {
                    ...
                    SR.AppVerifier_Errors_AsyncCallbackInvokedWithNullParameter
                },
                {
                ...
                },
                {
                    ...
                    SR.AppVerifier_Errors_AsyncCallbackInvokedSynchronouslyButAsyncResultWasNotMarkedCompletedSynchronously
                },
                {
                ...
                },
                {
                    ...
                    SR.AppVerifier_Errors_AsyncCallbackCalledAfterHttpApplicationReassigned
                },
                {
                    AppVerifierErrorCode.BeginHandlerReturnedNull,
                    SR.AppVerifier_Errors_BeginHandlerReturnedNull
                },
                {
                ...
                },
                {
                    ...
                    SR.AppVerifier_Errors_BeginHandlerReturnedUnexpectedAsyncResultAsyncState
                },
                {
                    AppVerifierErrorCode.SyncContextSendOrPostCalledAfterRequestCompleted,
                    SR.AppVerifier_Errors_SyncContextSendOrPostCalledAfterRequestCompleted
                },
                {
                    AppVerifierErrorCode.SyncContextSendOrPostCalledBetweenNotifications,
                    SR.AppVerifier_Errors_SyncContextSendOrPostCalledBetweenNotifications
                },
                {
                    AppVerifierErrorCode.SyncContextPostCalledInNestedNotification,
                    SR.AppVerifier_Errors_SyncContextPostCalledInNestedNotification
                },
                {
                ...
                },
                {
                    ...
                    SR.AppVerifier_Errors_NotificationContextHasChangedAfterSynchronouslyProcessingNotification
                },
                {
        ...
        private static Action<AppVerifierException> DefaultAppVerifierBehavior =
        ...
        public static Func<T, AsyncCallback, object, IAsyncResult> WrapBeginMethod<T>(
            HttpApplication httpApplication,
            Func<T, AsyncCallback, object, IAsyncResult> originalDelegate
        )
        {
            ...
            return (arg, callback, state) =>
                WrapBeginMethodImpl(
                    httpApplication: httpApplication,
                    beginMethod: (innerCallback, innerState) =>
                        originalDelegate(arg, innerCallback, innerState),
        ...
        // If AppVerifier is disabled, returns the original method unmodified.
        public static BeginEventHandler WrapBeginMethod(
            HttpApplication httpApplication,
        ...
        )
        {
            ...
            return (sender, e, cb, extraData) =>
                WrapBeginMethodImpl(
                    httpApplication: httpApplication,
                    beginMethod: (innerCallback, innerState) =>
                        originalDelegate(sender, e, innerCallback, innerState),
                    originalDelegate: originalDelegate,
                    errorHandler: HandleAppVerifierException,
        ...
        internal static Func<AsyncCallback, object, IAsyncResult> WrapBeginMethodImpl(
            ...
            Action<AppVerifierException> errorHandler,
        ...
        )
        {
            return (callback, state) =>
            {
                ...
                AsyncCallbackInvocationHelper asyncCallbackInvocationHelper =
                    new AsyncCallbackInvocationHelper();
                CallStackCollectionBitMasks myBeginMask =
                    callStackMask & CallStackCollectionBitMasks.AllBeginMask;
                bool captureBeginStack =
                    (myBeginMask & (CallStackCollectionBitMasks)AppVerifierCollectCallStackMask)
                    == myBeginMask;

                InvocationInfo beginHandlerInvocationInfo = InvocationInfo.Capture(
                    captureBeginStack
                );
                ...
                AssertDelegate assert = (condition, errorCode) =>
                {
                    ...
                    if (!condition && enableAssert)
                    {
                        ...
                        bool captureStack =
                            (AppVerifierErrorCodeCollectCallStackMask & mask) == mask;
                        ...
                        errorString.AppendLine(
                            FormatErrorString(
                                SR.AppVerifier_BasicInfo_Description,
                                GetLocalizedDescriptionStringForError(errorCode)
                            )
                        );
                        errorString.AppendLine(
                            FormatErrorString(
                                SR.AppVerifier_BasicInfo_ThreadInfo,
                                assertInvocationInfo.ThreadId,
                        ...
                        errorString.AppendLine(
                            FormatErrorString(
                                SR.AppVerifier_BeginMethodInfo_EntryMethod,
                        ...
                        if (currentNotification != null)
                        {
                            errorString.AppendLine(
                                FormatErrorString(
                                    SR.AppVerifier_BeginMethodInfo_RequestNotification_Integrated,
                                    currentNotification,
                                    isPostNotification
                                )
                            );
                        ...
                        else
                        {
                            errorString.AppendLine(
                                FormatErrorString(
                                    SR.AppVerifier_BeginMethodInfo_RequestNotification_NotIntegrated
                                )
                            );
                        }
                        errorString.AppendLine(
                            FormatErrorString(
                                SR.AppVerifier_BeginMethodInfo_CurrentHandler,
                                httpHandlerType
                            )
                        );
                        errorString.AppendLine(
                            FormatErrorString(
                                SR.AppVerifier_BeginMethodInfo_ThreadInfo,
                        ...
                        InvocationInfo firstAsyncInvocation =
                            asyncCallbackInvocationHelper.GetFirstInvocationInfo(
                                out totalAsyncInvocationCount
                            );
                        errorString.AppendLine(
                            FormatErrorString(
                                SR.AppVerifier_AsyncCallbackInfo_InvocationCount,
                        ...
                        if (firstAsyncInvocation != null)
                        {
                            errorString.AppendLine(
                                FormatErrorString(
                                    SR.AppVerifier_AsyncCallbackInfo_FirstInvocation_ThreadInfo,
                                    firstAsyncInvocation.ThreadId,
                        ...
                        AppVerifierException ex = new AppVerifierException(
                            errorCode,
                ...
                try
                {
                    asyncResultReturnedByBeginHandler = beginMethod(
                        asyncResult =>
                        {
                            try
                            {
                                CallStackCollectionBitMasks myCallbackMask =
                                    callStackMask & CallStackCollectionBitMasks.AllCallbackMask;
                                bool captureEndCallStack =
                                ...
                                assert(
                                    newAsyncCallbackInvocationCount == 1,
                                    AppVerifierErrorCode.AsyncCallbackInvokedMultipleTimes
                                );
                                ...
                                else
                                {
                                    ...
                                    Holder<IAsyncResult> asyncResultHolder =
                                        tempBeginHandlerReturnValueHolder as Holder<IAsyncResult>;
                                    if (asyncResultHolder != null)
                                    {
                                        ...
                                        assert(
                                            asyncResult == asyncResultHolder.Value,
                                            AppVerifierErrorCode.AsyncCallbackInvokedWithUnexpectedAsyncResultInstance
                                        );
                                        assert(
                                ...
                                assert(
                                    assignedContextUponCallingBeginHandler
                    ...
                    assert(
                        asyncResultReturnedByBeginHandler != null,
                        AppVerifierErrorCode.BeginHandlerReturnedNull
                    );

                    lock (lockObj)
                    {
                        beginHandlerReturnValueHolder = new Holder<IAsyncResult>(
                    ...
                    if (asyncResultReturnedByBeginHandler.CompletedSynchronously)
                    {
                        ...
                        assert(
                            asyncCallbackInvocationHelper.TotalInvocations != 0,
                            AppVerifierErrorCode.BeginHandlerReturnedAsyncResultMarkedCompletedSynchronouslyButAsyncCallbackNeverCalled
                        );
                    }
                    ...
                    {
                        assert(
                            tempAsyncResultPassedToCallback == asyncResultReturnedByBeginHandler,
                            AppVerifierErrorCode.BeginHandlerReturnedUnexpectedAsyncResultInstance
                        );
                    }
                    ...
                    // AsyncState must match the 'state' parameter passed to BeginHandler
                    assert(
                        asyncResultReturnedByBeginHandler.AsyncState == state,
                        AppVerifierErrorCode.BeginHandlerReturnedUnexpectedAsyncResultAsyncState
                    );
                    ...
                    if (asyncResultReturnedByBeginHandler == null)
                    {
                        ...
                        try
                        {
                            ...
                            if (tempAsyncResultPassedToCallback != null)
                            {
                                ...
                                assert(
                                    tempAsyncResultPassedToCallback.CompletedSynchronously,
                                    AppVerifierErrorCode.AsyncCallbackInvokedAsynchronouslyThenBeginHandlerThrew
                                );
        ...
        )
        {
            ...
            HttpContext originalHttpContext =
                (syncContext != null) ? syncContext.HttpContext : null;
            ...
            AssertDelegate assert = GetAssertDelegateImpl(
                requestUrl,
                errorHandler,
                appendAdditionalInfoDelegate: null
            );
            ...
            return (checkForReEntry) =>
            {
                try
                {
                    ...
                    HttpContext currentHttpContext =
                        (syncContext != null) ? syncContext.HttpContext : null;
                    object currentThreadContextId =
                        (currentHttpContext != null) ? currentHttpContext.ThreadContextId : null;
                    assert(
                        currentThreadContextId != null
                            && ReferenceEquals(originalThreadContextId, currentThreadContextId),
                        AppVerifierErrorCode.SyncContextSendOrPostCalledAfterRequestCompleted
                    );

                    if (
                        HttpRuntime.UsingIntegratedPipeline
                        && !currentHttpContext.HasWebSocketRequestTransitionCompleted
                    )
                    {
                        var notificationContext =
                            (currentHttpContext != null)
                                ? currentHttpContext.NotificationContext
                                : null;
                        assert(
        ...
        )
        {
            ...
            return GetRequestNotificationStatusCheckDelegateImpl(
                context,
                currentNotification,
                isPostNotification,
        ...
        /// </summary>
        /// <returns>A callback which performs the verification.</returns>
        internal static Action<RequestNotificationStatus> GetRequestNotificationStatusCheckDelegateImpl(
            HttpContext context,
            RequestNotification currentNotification,
            bool isPostNotification,
            Action<AppVerifierException> errorHandler
        )
        {
            ...
            AppendAdditionalInfoDelegate appendCurrentNotificationInfo = (errorString) =>
            {
                errorString.AppendLine(
                    FormatErrorString(
                        SR.AppVerifier_BasicInfo_NotificationInfo,
                        currentNotification,
                        isPostNotification,
                        isReentry
                    )
            ...
            AssertDelegate assert = GetAssertDelegateImpl(
                requestUrl,
                errorHandler,
                appendAdditionalInfoDelegate: appendCurrentNotificationInfo
            );
                ...
                else
                {
                    ...
                    assert(
                        context.NotificationContext != null
                            && !context.NotificationContext.PendingAsyncCompletion,
                        AppVerifierErrorCode.RequestNotificationCompletedSynchronouslyWithNotificationContextPending
                    );
        ...
        [SuppressMessage(
            ...
            Justification = "Want to keep these locals on the stack to assist with debugging."
        )]
