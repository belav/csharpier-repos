    ...
    internal static class UriUtil
    {
        ...
        )
        {
            return BuildUriImpl(
                ...
                path,
                queryString,
                AppSettings.UseLegacyRequestUrlGeneration
            );
        }

        // for unit testing
        internal static Uri BuildUriImpl(
            string scheme,
            string serverName,
            string port,
            string path,
            string queryString,
            bool useLegacyRequestUrlGeneration
        )
        {
        ...
        internal static void ExtractQueryAndFragment(
            string input,
            out string path,
        ...
        )
        {
            ...
            Uri uri;
            if (
                isValidScheme && Uri.TryCreate(inputWithoutQueryFragment, UriKind.Absolute, out uri)
            )
            {
