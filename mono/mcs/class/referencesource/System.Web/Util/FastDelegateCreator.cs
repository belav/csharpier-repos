...
namespace System.Web.Util
{
    ...
    internal static class FastDelegateCreator<TDelegate>
        where TDelegate : class
    {
        ...
        private static Func<object, IntPtr, TDelegate> GetFactory()
        {
            ...
            ConstructorInfo delegateCtor = typeof(TDelegate).GetConstructor(
            ...
            return (Func<object, IntPtr, TDelegate>)
                dynamicMethod.CreateDelegate(typeof(Func<object, IntPtr, TDelegate>));
        }
    }
}
