...
namespace System.Web.Util
{
    ...
    internal static class AltSerialization
    {
        ...
        [SuppressMessage(
            ...
            Justification = "This method is safe critical (we're allowed to call the SerializationSurrogateSelector property getter)."
        )]
            ...
            else
            {
                ...
                if (SessionStateUtility.SerializationSurrogateSelector != null)
                {
                    formatter.SurrogateSelector =
                        SessionStateUtility.SerializationSurrogateSelector;
                }
                try
                {
                ...
                catch (Exception innerException)
                {
                    HttpException outerException = new HttpException(
                        SR.GetString(SR.Cant_serialize_session_state),
                        innerException
                    );
