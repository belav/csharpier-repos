...
namespace System.Web.Util
{
    ...
    internal class CalliEventHandlerDelegateProxy
    {
        ...
        internal void Callback(Object sender, EventArgs e)
        {
            if (_argless)
            {
                ParameterlessDelegate del = FastDelegateCreator<ParameterlessDelegate>.BindTo(
                    _target,
                    _functionPointer
                );
                del();
            ...
            {
                ParameterfulDelegate del = FastDelegateCreator<ParameterfulDelegate>.BindTo(
                    _target,
                    _functionPointer
                );
                del(sender, e);
    ...
    internal delegate void EventArgMethod(
        IntPtr methodPtr,
        Object target,
        Object source,
        EventArgs e
    ...
    internal class CalliHelper
    {
        ...
        [ReflectionPermission(
            SecurityAction.Assert,
            Flags = ReflectionPermissionFlag.ReflectionEmit | ReflectionPermissionFlag.MemberAccess
        )]
        static CalliHelper()
        {
    ...
    internal class CalliHelper
    {
        ...
        static CalliHelper()
        {
            ...
            MethodBuilder methb = tb.DefineMethod(
                ...
                typeof(void),
                new Type[] { typeof(IntPtr), typeof(object), typeof(object), typeof(EventArgs) }
            );
            ...
            methb = tb.DefineMethod(
                "ArglessMethod",
                MethodAttributes.Assembly | MethodAttributes.Static,
                typeof(void),
                new Type[] { typeof(IntPtr), typeof(object) }
            );
            ...
            ArglessFunctionCaller = (ArglessMethod)
                Delegate.CreateDelegate(typeof(ArglessMethod), t, "ArglessMethod", true);
            EventArgFunctionCaller = (EventArgMethod)
                Delegate.CreateDelegate(typeof(EventArgMethod), t, "EventArgMethod", true);
