...
namespace System.Web.Util
{
    internal static class AppSettings
    {
                    ...
                    if (!_settingsInitialized)
                    {
                        ...
                        finally
                        {
                            ...
                            if (
                                settings == null
                                || !Boolean.TryParse(
                                    settings["aspnet:UseHostHeaderForRequestUrl"],
                                    out _useHostHeaderForRequestUrl
                                )
                            )
                            ...
                            if (
                                settings == null
                                || !Boolean.TryParse(
                                    settings["aspnet:AllowAnonymousImpersonation"],
                                    out _allowAnonymousImpersonation
                                )
                            )
                            ...
                            if (
                                settings == null
                                || !Boolean.TryParse(
                                    settings["aspnet:ScriptResourceAllowNonJsFiles"],
                            ...
                            if (
                                settings == null
                                || !Boolean.TryParse(
                                    settings["aspnet:UseLegacyEncryption"],
                                    out _useLegacyEncryption
                                )
                            )
                            ...
                            if (
                                settings == null
                                || !Boolean.TryParse(
                                    settings["aspnet:UseLegacyMachineKeyEncryption"],
                                    out _useLegacyMachineKeyEncryption
                                )
                            )
                            ...
                            if (
                                ...
                                || !Boolean.TryParse(
                                    ...
                                    out _useLegacyFormsAuthenticationTicketCompatibility
                                )
                            )
                            ...
                            if (
                                settings == null
                                || !Boolean.TryParse(
                                    settings["aspnet:UseLegacyEventValidationCompatibility"],
                                    out _useLegacyEventValidationCompatibility
                                )
                            )
                                _useLegacyEventValidationCompatibility = false;

                            _allowInsecureDeserialization = GetNullableBooleanValue(
                                settings,
                                "aspnet:AllowInsecureDeserialization"
                            );

                            if (
                                settings == null
                                || !Boolean.TryParse(
                                    settings["aspnet:AlwaysIgnoreViewStateValidationErrors"],
                                    out _alwaysIgnoreViewStateValidationErrors
                                )
                            )
                            ...
                            if (
                                settings == null
                                || !Boolean.TryParse(
                                    settings["aspnet:AllowRelaxedHttpUserName"],
                                    out _allowRelaxedHttpUserName
                                )
                            )
                            ...
                            if (
                                settings == null
                                || !Boolean.TryParse(
                                    settings["aspnet:JavaScriptDoNotEncodeAmpersand"],
                                    out _javaScriptDoNotEncodeAmpersand
                                )
                            )
                            ...
                            if (
                                settings == null
                                || !Boolean.TryParse(
                                    settings["aspnet:UseTaskFriendlySynchronizationContext"],
                                    out _useTaskFriendlySynchronizationContext
                                )
                            )
                            ...
                            if (
                                settings == null
                                || !Boolean.TryParse(
                                    settings["aspnet:AllowAsyncDuringSyncStages"],
                                    out _allowAsyncDuringSyncStages
                                )
                            )
                            ...
                            if (
                                settings == null
                                || !int.TryParse(
                                    settings["aspnet:MaxHttpCollectionKeys"],
                                    out _maxHttpCollectionKeys
                                )
                                || _maxHttpCollectionKeys < 0
                            )
                            ...
                            if (
                                settings == null
                                || !int.TryParse(
                                    settings["aspnet:MaxJsonDeserializerMembers"],
                                    out _maxJsonDeserializerMembers
                                )
                                || _maxJsonDeserializerMembers < 0
                            )
                            ...
                            if (
                                settings == null
                                || !Boolean.TryParse(
                                    settings["aspnet:DoNotDisposeSpecialHttpApplicationInstances"],
                                    out _doNotDisposeSpecialHttpApplicationInstances
                                )
                            )
                            ...
                            if (
                                settings == null
                                || !Boolean.TryParse(
                                    settings["aspnet:RestrictXmlControls"],
                                    out _restrictXmlControls
                                )
                            )
                            ...
                            if (
                                settings == null
                                || !Boolean.TryParse(
                                    settings["aspnet:AllowRelaxedRelativeUrl"],
                                    out _allowRelaxedRelativeUrl
                                )
                            )
                            ...
                            if (
                                settings == null
                                || !Boolean.TryParse(
                                    settings["aspnet:UseLegacyRequestUrlGeneration"],
                                    out _useLegacyRequestUrlGeneration
                                )
                            )
                            ...
                            if (
                                settings == null
                                || !Boolean.TryParse(
                                    settings["aspnet:AllowUtf7RequestContentEncoding"],
                                    out _allowUtf7RequestContentEncoding
                                )
                            )
                            ...
                            if (
                                settings == null
                                || !Boolean.TryParse(
                                    settings["aspnet:AllowRelaxedUnicodeDecoding"],
                                    out _allowRelaxedUnicodeDecoding
                                )
                            )
                            ...
                            if (
                                settings == null
                                || !Boolean.TryParse(
                                    settings["aspnet:DontUsePercentUUrlEncoding"],
                            ...
                            if (
                                settings == null
                                || !int.TryParse(
                                    settings["aspnet:UpdatePanelMaxScriptLength"],
                                    out _updatePanelMaxScriptLength
                                )
                            ...
                            _maxConcurrentCompilations = GetNullableIntegerValue(
                                settings,
                            ...
                            if (
                                settings == null
                                || !int.TryParse(
                                    settings["aspnet:MaxAcceptLanguageFallbackCount"],
                                    out _maxAcceptLanguageFallbackCount
                                )
                                || _maxAcceptLanguageFallbackCount <= 0
                            )
                                _maxAcceptLanguageFallbackCount =
                                    DefaultMaxAcceptLanguageFallbackCount;

                            if (
                                settings == null
                                || !Boolean.TryParse(
                                    settings["aspnet:PortableCompilationOutput"],
                                    out _portableCompilationOutput
                                )
                            )
                            ...
                            if (
                                ...
                                || string.IsNullOrWhiteSpace(
                                    _portableCompilationOutputSnapshotType = settings[
                            ...
                            if (
                                settings == null
                                || string.IsNullOrWhiteSpace(
                                    _portableCompilationOutputSnapshotTypeOptions = settings[
                                        "aspnet:PortableCompilationOutputSnapshotTypeOptions"
                                    ]
                                )
                            )
                            ...
                            if (
                                settings == null
                                || !Boolean.TryParse(
                                    settings["aspnet:EnsureSessionStateLockedOnFlush"],
                                    out _ensureSessionStateLockedOnFlush
                                )
                            )
                            ...
                            if (
                                settings == null
                                || !Boolean.TryParse(
                                    settings["aspnet:UseRandomizedStringHashAlgorithm"],
                                    out _useRandomizedStringHashAlgorithm
                                )
                            )
                            ...
                            if (
                                settings == null
                                || !Boolean.TryParse(
                                    settings["aspnet:EnableAsyncModelBinding"],
                            ...
                            if (
                                settings == null
                                || !int.TryParse(
                                    settings["aspnet:RequestQueueLimitPerSession"],
                                    out _requestQueueLimitPerSession
                                )
                            ...
                            if (
                                settings == null
                                || !Boolean.TryParse(
                                    settings["aspnet:LogMembershipPasswordFormatWarning"],
                                    out _logMembershipPasswordFormatWarning
                                )
                            )
        ...
        [SuppressMessage(
            ...
            Justification = "This assert is safe since we control the callers; they're not leaking information."
        )]
        ...
        {
            int value;
            return (settings != null && int.TryParse(settings[key], out value))
                ? value
                : (int?)null;
        }
