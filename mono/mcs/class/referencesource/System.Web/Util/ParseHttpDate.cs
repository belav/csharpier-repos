    ...
    internal static class HttpDate
    {
        ...
        static int make_month(string s, int startIndex)
        {
            ...
            )
            {
                ...
                ((Char.ToUpper(s[0 + startIndex], CultureInfo.InvariantCulture)) == monthString[0])
                && (
                    (Char.ToLower(s[1 + startIndex], CultureInfo.InvariantCulture))
                    == monthString[1]
                )
                && (
                    (Char.ToLower(s[2 + startIndex], CultureInfo.InvariantCulture))
                    == monthString[2]
                )
            )
            {
