...
namespace System.Web.WebSockets
{
    ...
    internal sealed class UnmanagedWebSocketContext : IUnmanagedWebSocketContext
    {
        ...
        {
            return IIS.MgdWebSocketWriteFragment(
                _pWebSocketContext,
                pData,
                ref pcbSent,
                fAsync,
        ...
        {
            return IIS.MgdWebSocketReadFragment(
                _pWebSocketContext,
                pData,
                ref pcbData,
                fAsync,
        ...
        public int SendConnectionClose(
            bool fAsync,
            ushort uStatusCode,
            string szReason,
            IntPtr pfnCompletion,
        ...
        {
            return IIS.MgdWebSocketSendConnectionClose(
                _pWebSocketContext,
                fAsync,
                uStatusCode,
                szReason,
        ...
        {
            return IIS.MgdWebSocketGetCloseStatus(
                _pWebSocketContext,
                out pStatusCode,
                out ppszReason,
                out pcchReason
