...
namespace System.Web.WebSockets
{
    ...
    internal sealed class WebSocketPipe : IWebSocketPipe
    {
        ...
        private delegate void CompletionCallbackThunk(
            int hrError,
        ...
        [SuppressMessage(
            ...
            Justification = @"This is a function pointer whose lifetime lasts for the entire duration of this AppDomain. We never need to release it."
        )]
        ...
        public Task WriteFragmentAsync(
        ...
        )
        {
            ...
            _perfCounters.IncrementCounter(
                AppPerfCounter.REQUEST_BYTES_OUT_WEBSOCKETS,
                pinnedBuffer.Count
            );
            ...
            CompletionCallback callback = (hrError, cbIO, fUtf8Encoded, fFinalFragment, fClose) =>
            {
                try
                {
                    ...
                    WebSocketMessageType messageType =
                        (fUtf8Encoded) ? WebSocketMessageType.Text : WebSocketMessageType.Binary;
                    ...
                    else
                    {
                        ...
                        _perfCounters.IncrementCounter(
                            AppPerfCounter.REQUEST_BYTES_IN_WEBSOCKETS,
                            cbIO
                        );
                    }
        ...
        private void GetCloseStatus(
            out WebSocketCloseStatus closeStatus,
            out string closeStatusDescription
        )
        {
            ushort statusCode;
            IntPtr reasonPtr;
