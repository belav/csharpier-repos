...
namespace System.Web.WebSockets
{
    ...
    internal sealed class AspNetWebSocketManager
    {
        ...
        internal readonly HashSet<IAsyncAbortableWebSocket> _activeSockets =
            new HashSet<IAsyncAbortableWebSocket>(); // internal only for unit testing purposes
        ...
        public void Add(IAsyncAbortableWebSocket webSocket)
        {
            ...
            _perfCounters.SetCounter(
                AppPerfCounter.REQUESTS_EXECUTING_WEBSOCKETS,
                activeSocketCount
            );
            if (shouldAbort)
            {
