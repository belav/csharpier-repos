...
namespace System.Web
{
    ...
    internal static class EtwTrace
    {
        ...
        internal static void TraceEnableCheck(EtwTraceConfigType configType, IntPtr p)
        {
            ...
            switch (configType)
            {
                case EtwTraceConfigType.IIS7_INTEGRATED:
                    bool f;
                    UnsafeIISMethods.MgdEtwGetTraceConfig(
                        p /*pRequestContext*/
                        ,
                        out f,
                        out _traceFlags,
                ...
                case EtwTraceConfigType.IIS7_ISAPI:
                    ...
                    UnsafeNativeMethods.EcbGetTraceFlags(
                        p /*pECB*/
                        ,
                        contentInfo
                    );
        ...
        )
        {
            ...
            {
                UnsafeNativeMethods.TraceRaiseEventMgdHandler(
                    (int)traceType,
                    ((IIS7WorkerRequest)workerRequest).RequestContext,
                    data1,
                    data2,
                    data3,
                    data4
            ...
            {
                UnsafeNativeMethods.TraceRaiseEventWithEcb(
                    (int)traceType,
            ...
            {
                UnsafeNativeMethods.PMTraceRaiseEvent(
                    (int)traceType,
                    ((ISAPIWorkerRequest)workerRequest).Ecb,
                    data1,
                    data2,
