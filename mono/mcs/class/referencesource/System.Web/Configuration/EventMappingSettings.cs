...
namespace System.Web.Configuration
{
    ...
    public sealed class EventMappingSettings : ConfigurationElement
    {
        ...
        private static readonly ConfigurationProperty _propEndEventCode = new ConfigurationProperty(
            "endEventCode",
            typeof(int),
            int.MaxValue,
            null,
        ...
        {
            get { return (int)base[_propStartEventCode]; }
            set { base[_propStartEventCode] = value; }
        }
        ...
        {
            get { return (int)base[_propEndEventCode]; }
            set { base[_propEndEventCode] = value; }
        }
    }
}
