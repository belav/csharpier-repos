...
namespace System.Web.Configuration
{
    ...
    internal class RuntimeConfig
    {
        ...
        static internal RuntimeConfig GetAppLKGConfig()
        {
            ...
            if (!success)
            {
                config = GetLKGRuntimeConfig(
                    System.Web.Hosting.HostingEnvironment.ApplicationVirtualPathObject
                );
            }
        ...
        internal ConnectionStringsSection ConnectionStrings
        {
            get
            {
                return (ConnectionStringsSection)GetSection(
                    "connectionStrings",
                    typeof(ConnectionStringsSection),
                    ResultsIndex.ConnectionStrings
                );
            }
        }
        ...
        internal System.Net.Configuration.SmtpSection Smtp
        {
            get
            {
                return (System.Net.Configuration.SmtpSection)GetSection(
                    "system.net/mailSettings/smtp",
                    typeof(System.Net.Configuration.SmtpSection)
                );
            }
        }
        ...
        internal AnonymousIdentificationSection AnonymousIdentification
        {
            get
            {
                return (AnonymousIdentificationSection)GetSection(
                    "system.web/anonymousIdentification",
                    typeof(AnonymousIdentificationSection)
                );
            }
        }
        ...
        internal ProtocolsSection Protocols
        {
            get
            {
                return (ProtocolsSection)GetSection(
                    "system.web/protocols",
                    typeof(ProtocolsSection)
                );
            }
        }
        ...
        internal AuthenticationSection Authentication
        {
            get
            {
                return (AuthenticationSection)GetSection(
        ...
        internal AuthorizationSection Authorization
        {
            get
            {
                return (AuthorizationSection)GetSection(
        ...
        internal HttpCapabilitiesDefaultProvider BrowserCaps
        {
            get
            {
                return (HttpCapabilitiesDefaultProvider)GetHandlerSection(
                    "system.web/browserCaps",
                    typeof(HttpCapabilitiesDefaultProvider),
                    ResultsIndex.BrowserCaps
                );
            }
        }
        ...
        internal ClientTargetSection ClientTarget
        {
            get
            {
                return (ClientTargetSection)GetSection(
                    "system.web/clientTarget",
                    typeof(ClientTargetSection),
                    ResultsIndex.ClientTarget
                );
            }
        }
        ...
        internal CompilationSection Compilation
        {
            get
            {
                return (CompilationSection)GetSection(
                    "system.web/compilation",
                    typeof(CompilationSection),
        ...
        internal CustomErrorsSection CustomErrors
        {
            get
            {
                return (CustomErrorsSection)GetSection(
                    "system.web/customErrors",
                    typeof(CustomErrorsSection)
                );
            }
        }
        ...
        internal GlobalizationSection Globalization
        {
            get
            {
                return (GlobalizationSection)GetSection(
                    "system.web/globalization",
                    typeof(GlobalizationSection),
                    ResultsIndex.Globalization
                );
            }
        }
        ...
        internal DeploymentSection Deployment
        {
            get
            {
                return (DeploymentSection)GetSection(
                    "system.web/deployment",
                    typeof(DeploymentSection)
                );
            }
        }
        ...
        internal FullTrustAssembliesSection FullTrustAssemblies
        {
            get
            {
                return (FullTrustAssembliesSection)GetSection(
                    "system.web/fullTrustAssemblies",
                    typeof(FullTrustAssembliesSection)
                );
            }
        }
        ...
        internal HealthMonitoringSection HealthMonitoring
        {
            get
            {
                return (HealthMonitoringSection)GetSection(
                    "system.web/healthMonitoring",
                    typeof(HealthMonitoringSection)
                );
            }
        }
        ...
        internal HostingEnvironmentSection HostingEnvironment
        {
            get
            {
                return (HostingEnvironmentSection)GetSection(
                    "system.web/hostingEnvironment",
                    typeof(HostingEnvironmentSection)
                );
            }
        }
        ...
        internal HttpCookiesSection HttpCookies
        {
            get
            {
                return (HttpCookiesSection)GetSection(
                    "system.web/httpCookies",
                    typeof(HttpCookiesSection),
                    ResultsIndex.HttpCookies
                );
            }
        }
        ...
        internal HttpHandlersSection HttpHandlers
        {
            get
            {
                return (HttpHandlersSection)GetSection(
                    "system.web/httpHandlers",
                    typeof(HttpHandlersSection),
        ...
        internal HttpModulesSection HttpModules
        {
            get
            {
                return (HttpModulesSection)GetSection(
                    "system.web/httpModules",
                    typeof(HttpModulesSection),
                    ResultsIndex.HttpModules
                );
            }
        }
        ...
        internal HttpRuntimeSection HttpRuntime
        {
            get
            {
                return (HttpRuntimeSection)GetSection(
                    "system.web/httpRuntime",
                    typeof(HttpRuntimeSection),
        ...
        internal IdentitySection Identity
        {
            get
            {
                return (IdentitySection)GetSection(
                    "system.web/identity",
                    typeof(IdentitySection),
        ...
        internal MachineKeySection MachineKey
        {
            get
            {
                return (MachineKeySection)GetSection(
        ...
        internal MembershipSection Membership
        {
            get
            {
                return (MembershipSection)GetSection(
                    "system.web/membership",
                    typeof(MembershipSection),
                    ResultsIndex.Membership
                );
            }
        }
        ...
        internal PagesSection Pages
        {
            get
            {
                return (PagesSection)GetSection(
                    "system.web/pages",
                    typeof(PagesSection),
                    ResultsIndex.Pages
                );
        ...
        internal PartialTrustVisibleAssembliesSection PartialTrustVisibleAssemblies
        {
            get
            {
                return (PartialTrustVisibleAssembliesSection)GetSection(
                    "system.web/partialTrustVisibleAssemblies",
                    typeof(PartialTrustVisibleAssembliesSection)
                );
            }
        }
        ...
        internal ProcessModelSection ProcessModel
        {
            get
            {
                return (ProcessModelSection)GetSection(
                    "system.web/processModel",
                    typeof(ProcessModelSection)
                );
            }
        }
        ...
        internal ProfileSection Profile
        {
            get
            {
                return (ProfileSection)GetSection(
                    "system.web/profile",
        ...
        internal RoleManagerSection RoleManager
        {
            get
            {
                return (RoleManagerSection)GetSection(
                    "system.web/roleManager",
                    typeof(RoleManagerSection)
                );
            }
        }
        ...
        internal SecurityPolicySection SecurityPolicy
        {
            get
            {
                return (SecurityPolicySection)GetSection(
                    "system.web/securityPolicy",
                    typeof(SecurityPolicySection)
                );
            }
        }
        ...
        internal SessionPageStateSection SessionPageState
        {
            get
            {
                return (SessionPageStateSection)GetSection(
                    "system.web/sessionPageState",
                    typeof(SessionPageStateSection),
                    ResultsIndex.SessionPageState
                );
            }
        }
        ...
        internal SessionStateSection SessionState
        {
            get
            {
                return (SessionStateSection)GetSection(
                    "system.web/sessionState",
                    typeof(SessionStateSection)
                );
            }
        }
        ...
        {
            get { return (SiteMapSection)GetSection("system.web/siteMap", typeof(SiteMapSection)); }
        }

        internal TraceSection Trace
        {
            get { return (TraceSection)GetSection("system.web/trace", typeof(TraceSection)); }
        }

        internal TrustSection Trust
        {
            get { return (TrustSection)GetSection("system.web/trust", typeof(TrustSection)); }
        }
        ...
        internal UrlMappingsSection UrlMappings
        {
            get
            {
                return (UrlMappingsSection)GetSection(
                    "system.web/urlMappings",
                    typeof(UrlMappingsSection),
        ...
        internal Hashtable WebControls
        {
            get
            {
                return (Hashtable)GetSection(
                    "system.web/webControls",
                    typeof(Hashtable),
                    ResultsIndex.WebControls
                );
            }
        }
        ...
        internal WebPartsSection WebParts
        {
            get
            {
                return (WebPartsSection)GetSection(
                    "system.web/webParts",
                    typeof(WebPartsSection),
        ...
        internal XhtmlConformanceSection XhtmlConformance
        {
            get
            {
                return (XhtmlConformanceSection)GetSection(
                    "system.web/xhtmlConformance",
                    typeof(XhtmlConformanceSection),
        ...
        internal OutputCacheSection OutputCache
        {
            get
            {
                return (OutputCacheSection)GetSection(
                    "system.web/caching/outputCache",
                    typeof(OutputCacheSection),
        ...
        internal OutputCacheSettingsSection OutputCacheSettings
        {
            get
            {
                return (OutputCacheSettingsSection)GetSection(
                    "system.web/caching/outputCacheSettings",
                    typeof(OutputCacheSettingsSection),
        ...
        internal SqlCacheDependencySection SqlCacheDependency
        {
            get
            {
                return (SqlCacheDependencySection)GetSection(
                    "system.web/caching/sqlCacheDependency",
                    typeof(SqlCacheDependencySection)
                );
            }
        }
        ...
        private object GetHandlerSection(string sectionName, Type type, ResultsIndex index)
        {
            ...
            if (result != null && result.GetType() != type)
            {
                throw new ConfigurationErrorsException(
                    SR.GetString(SR.Config_unable_to_get_section, sectionName)
                );
            }
