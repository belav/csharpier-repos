...
namespace System.Web.Configuration
{
    ...
    public sealed class HttpHandlerAction : ConfigurationElement
    {
        ...
        private static readonly ConfigurationProperty _propVerb = new ConfigurationProperty(
            "verb",
            typeof(string),
            null,
            null,
        ...
        private static readonly ConfigurationProperty _propValidate = new ConfigurationProperty(
            "validate",
            typeof(bool),
            true,
        ...
        internal string Key
        {
            get { return "verb=" + Verb + " | path=" + Path; }
        }
        ...
        public string Path
        {
            ...
            set { base[_propPath] = value; }
        }

        [ConfigurationProperty("verb", IsRequired = true, IsKey = true)]
        public string Verb
        {
            get { return (string)base[_propVerb]; }
            set { base[_propVerb] = value; }
        }
        ...
        {
            get { return (bool)base[_propValidate]; }
