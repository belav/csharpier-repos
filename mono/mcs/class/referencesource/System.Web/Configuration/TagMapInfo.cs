...
namespace System.Web.Configuration
{
    ...
    public sealed class TagMapInfo : ConfigurationElement
    {
        ...
        private static readonly ConfigurationProperty _propTagTypeName = new ConfigurationProperty(
            "tagType",
            typeof(string),
            null,
            null,
        ...
        {
            get { return (string)base[_propMappedTagTypeName]; }
            set { base[_propMappedTagTypeName] = value; }
        }
        ...
        {
            get { return (string)base[_propTagTypeName]; }
            set { base[_propTagTypeName] = value; }
        }
        ...
        void Verify()
        {
            if (String.IsNullOrEmpty(TagType))
            {
                throw new ConfigurationErrorsException(
                    SR.GetString(SR.Config_base_required_attribute_missing, "tagType")
                );
            }
            ...
            {
                throw new ConfigurationErrorsException(
                    SR.GetString(SR.Config_base_required_attribute_missing, "mappedTagType")
                );
            }
        }
