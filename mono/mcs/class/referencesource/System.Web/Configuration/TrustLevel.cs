...
namespace System.Web.Configuration
{
    ...
    public sealed class TrustLevel : ConfigurationElement
    {
        ...
        private static readonly ConfigurationProperty _propPolicyFile = new ConfigurationProperty(
            "policyFile",
            typeof(string),
            "internal",
        ...
        {
            get { return (string)base[_propPolicyFile]; }
            set { base[_propPolicyFile] = value; }
        }
