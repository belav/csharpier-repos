...
namespace System.Web.Configuration
{
    ...
    [ConfigurationCollection(
        typeof(IgnoreDeviceFilterElement),
        AddItemName = "filter",
    ...
    public sealed class IgnoreDeviceFilterElementCollection : ConfigurationElementCollection
    {
        ...
        {
            get { return (IgnoreDeviceFilterElement)BaseGet(name); }
        }

        public IgnoreDeviceFilterElement this[int index]
        {
            get { return (IgnoreDeviceFilterElement)BaseGet(index); }
            set
            {
        ...
        [SuppressMessage(
            ...
            Justification = "Can't modify the base class."
        )]
