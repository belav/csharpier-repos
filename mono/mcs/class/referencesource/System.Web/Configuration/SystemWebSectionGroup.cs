...
namespace System.Web.Configuration
{
    ...
    public sealed class SystemWebSectionGroup : ConfigurationSectionGroup
    {
        ...
        {
            get { return (FullTrustAssembliesSection)Sections["fullTrustAssemblies"]; }
        }
        ...
        {
            get { return (ConfigurationSection)Sections["mobileControls"]; }
        }
        ...
        public PartialTrustVisibleAssembliesSection PartialTrustVisibleAssemblies
        {
            get
            {
                return (PartialTrustVisibleAssembliesSection)
                    Sections["partialTrustVisibleAssemblies"];
            }
        }
