...
namespace System.Web.Configuration
{
    ...
    public sealed class HttpRuntimeSection : ConfigurationSection
    {
        ...
        internal static readonly Version DefaultRequestValidationMode =
            VersionUtil.FrameworkDefault;
        internal const string DefaultRequestValidationModeString =
            VersionUtil.FrameworkDefaultString;
        ...
        private static readonly ConfigurationProperty _propEncoderType = new ConfigurationProperty(
            "encoderType",
            typeof(string),
            DefaultEncoderType,
            null,
        ...
        private static readonly ConfigurationProperty _propMaxUrlLength = new ConfigurationProperty(
            "maxUrlLength",
            typeof(int),
            DefaultMaxUrlLength,
            null,
        ...
        private static readonly ConfigurationProperty _propFcnMode = new ConfigurationProperty(
            "fcnMode",
            typeof(FcnMode),
            FcnMode.NotSet,
            ConfigurationPropertyOptions.None
...
*/
        ...
        {
            get { return (int)base[_propMaxRequestLength]; }
            set
            {
        ...
        {
            get { return (int)base[_propRequestLengthDiskThreshold]; }
            set
            {
        ...
        {
            get { return (bool)base[_propUseFullyQualifiedRedirectUrl]; }
            set { base[_propUseFullyQualifiedRedirectUrl] = value; }
        }
        ...
        {
            get { return (int)base[_propMinFreeThreads]; }
            set { base[_propMinFreeThreads] = value; }
        }
        ...
        {
            get { return (int)base[_propMinLocalRequestFreeThreads]; }
            set { base[_propMinLocalRequestFreeThreads] = value; }
        }
        ...
        {
            get { return (int)base[_propAppRequestQueueLimit]; }
            set { base[_propAppRequestQueueLimit] = value; }
        }

        [ConfigurationProperty("enableKernelOutputCache", DefaultValue = true)]
        public bool EnableKernelOutputCache
        {
            get { return (bool)base[_propEnableKernelOutputCache]; }
            set { base[_propEnableKernelOutputCache] = value; }
        }
        ...
        {
            get { return (bool)base[_propApartmentThreading]; }
            set { base[_propApartmentThreading] = value; }
        }

        [ConfigurationProperty("requireRootedSaveAsPath", DefaultValue = true)]
        public bool RequireRootedSaveAsPath
        {
            get { return (bool)base[_propRequireRootedSaveAsPath]; }
            set { base[_propRequireRootedSaveAsPath] = value; }
        }
        ...
        internal FrameworkName GetTargetFrameworkName()
        {
            ...
            else
            {
                ...
                if (!Version.TryParse(targetFramework, out version))
                {
                    ...
                    throw new ConfigurationErrorsException(
                        SR.GetString(SR.HttpRuntimeSection_TargetFramework_Invalid),
        ...
        [ConfigurationProperty(
            "sendCacheControlHeader",
            DefaultValue = DefaultSendCacheControlHeader
        )]
        ...
        {
            get { return (TimeSpan)base[_propDefaultRegexMatchTimeout]; }
            set { base[_propDefaultRegexMatchTimeout] = value; }
        }
        ...
        {
            get { return (TimeSpan)base[_propDelayNotificationTimeout]; }
            set { base[_propDelayNotificationTimeout] = value; }
        }
        ...
        {
            get { return (int)base[_propWaitChangeNotification]; }
            set { base[_propWaitChangeNotification] = value; }
        }
        ...
        {
            get { return (int)base[_propMaxWaitChangeNotification]; }
            set { base[_propMaxWaitChangeNotification] = value; }
        }

        [ConfigurationProperty("enableHeaderChecking", DefaultValue = true)]
        public bool EnableHeaderChecking
        {
            get { return (bool)base[_propEnableHeaderChecking]; }
            set { base[_propEnableHeaderChecking] = value; }
        }
        ...
        {
            get { return (string)base[_propEncoderType]; }
            set { base[_propEncoderType] = value; }
        }

        [ConfigurationProperty(
            "requestValidationMode",
            DefaultValue = DefaultRequestValidationModeString
        )]
        ...
        [ConfigurationProperty(
            "requestValidationType",
            DefaultValue = DefaultRequestValidationType
        )]
        [StringValidator(MinLength = 1)]
        public string RequestValidationType
        {
            get { return (string)base[_propRequestValidationType]; }
            set { base[_propRequestValidationType] = value; }
        }

        [ConfigurationProperty(
            "requestPathInvalidCharacters",
            DefaultValue = DefaultRequestPathInvalidCharacters
        )]
        public string RequestPathInvalidCharacters
        {
            get { return (string)base[_propRequestPathInvalidCharacters]; }
            set
            {
        ...
        [ConfigurationProperty(
            "relaxedUrlToFileSystemMapping",
            DefaultValue = DefaultRelaxedUrlToFileSystemMapping
        )]
        public bool RelaxedUrlToFileSystemMapping
        {
            get { return (bool)base[_propRelaxedUrlToFileSystemMapping]; }
            set { base[_propRelaxedUrlToFileSystemMapping] = value; }
        }

        [ConfigurationProperty(
            "allowDynamicModuleRegistration",
            DefaultValue = DefaultAllowDynamicModuleRegistration
        )]
        public bool AllowDynamicModuleRegistration
        {
            get { return (bool)base[_propAllowDynamicModuleRegistration]; }
            set { base[_propAllowDynamicModuleRegistration] = value; }
        }
        ...
        internal int RequestLengthDiskThresholdBytes
        {
            get
            {
                ...
                {
                    _RequestLengthDiskThresholdBytes = BytesFromKilobytes(
                        RequestLengthDiskThreshold
                    );
                }
        ...
        internal char[] RequestPathInvalidCharactersArray
        {
            get
            {
                ...
                _RequestPathInvalidCharactersArray = DecodeAndThenSplitString(
                    RequestPathInvalidCharacters
                );
                if (_RequestPathInvalidCharactersArray == null)
                {
                    ...
                    _RequestPathInvalidCharactersArray = SplitStringAndThenDecode(
                        RequestPathInvalidCharacters
                    );
                }
        ...
        private static char[] DecodeAndThenSplitString(string invalidCharString)
        {
            ...
            string[] stringsDecoded = HttpUtility
                .UrlDecode(invalidCharString, Encoding.UTF8)
                .Split(',');
        ...
        private static char[] SplitStringAndThenDecode(string invalidCharString)
        {
            ...
            {
                string decodedString = HttpUtility
                    .UrlDecode(stringsToDecode[iter], Encoding.UTF8)
                    .Trim();
                if (decodedString.Length == 1)
                    charsDecoded[iter] = decodedString[0];
                else
