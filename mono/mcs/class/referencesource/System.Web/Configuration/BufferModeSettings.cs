    ...
    public sealed class BufferModeSettings : ConfigurationElement
    {
        private static readonly ConfigurationElementProperty s_elemProperty =
            new ConfigurationElementProperty(
                new CallbackValidator(typeof(BufferModeSettings), Validate)
            );
        ...
        private static readonly ConfigurationProperty _propMaxFlushSize = new ConfigurationProperty(
            "maxFlushSize",
            typeof(int),
            int.MaxValue,
            new InfiniteIntConverter(),
        ...
        public BufferModeSettings(
            String name,
            int maxBufferSize,
            int maxFlushSize,
            int urgentFlushThreshold,
            TimeSpan regularFlushInterval,
            TimeSpan urgentFlushInterval,
        ...
        {
            get { return (int)base[_propMaxBufferSize]; }
            set { base[_propMaxBufferSize] = value; }
        }
        ...
        {
            get { return (int)base[_propMaxFlushSize]; }
            set { base[_propMaxFlushSize] = value; }
        }
        ...
        {
            get { return (int)base[_propUrgentFlushThreshold]; }
            set { base[_propUrgentFlushThreshold] = value; }
        }
        ...
        {
            get { return (TimeSpan)base[_propRegularFlushInterval]; }
            set { base[_propRegularFlushInterval] = value; }
        }
        ...
        {
            get { return (TimeSpan)base[_propUrgentFlushInterval]; }
            set { base[_propUrgentFlushInterval] = value; }
        }
        ...
        {
            get { return (int)base[_propMaxBufferThreads]; }
            set { base[_propMaxBufferThreads] = value; }
        }
        ...
        private static void Validate(object value)
        {
            ...
            if (!(elem.UrgentFlushThreshold <= elem.MaxBufferSize))
            {
                throw new ConfigurationErrorsException(
                    ...
                    elem.ElementInformation.Properties["urgentFlushThreshold"].Source,
                    elem.ElementInformation.Properties["urgentFlushThreshold"].LineNumber
                );
            }
            ...
            if (!(elem.MaxFlushSize <= elem.MaxBufferSize))
            {
                throw new ConfigurationErrorsException(
                    ...
                    elem.ElementInformation.Properties["maxFlushSize"].Source,
                    elem.ElementInformation.Properties["maxFlushSize"].LineNumber
                );
            }
            ...
            if (!(elem.UrgentFlushInterval < elem.RegularFlushInterval))
            {
                throw new ConfigurationErrorsException(
                    ...
                    elem.ElementInformation.Properties["urgentFlushInterval"].Source,
                    elem.ElementInformation.Properties["urgentFlushInterval"].LineNumber
                );
            }
        }
    }
