...
namespace System.Web.Configuration
{
    ...
    public sealed class HostingEnvironmentSection : ConfigurationSection
    {
        ...
        internal static readonly TimeSpan DefaultUrlMetadataSlidingExpiration =
            TimeSpan.FromMinutes(1); //default is 00:01:00

        internal const String sectionName = "system.web/hostingEnvironment";

        private static ConfigurationPropertyCollection _properties;
        private static readonly ConfigurationProperty _propIdleTimeout = new ConfigurationProperty(
            "idleTimeout",
            typeof(TimeSpan),
            DefaultIdleTimeout,
...
*/
        ...
        {
            get { return (TimeSpan)base[_propShutdownTimeout]; }
            set { base[_propShutdownTimeout] = value; }
        }
        ...
        {
            get { return (TimeSpan)base[_propIdleTimeout]; }
            set { base[_propIdleTimeout] = value; }
        }

        [ConfigurationProperty("shadowCopyBinAssemblies", DefaultValue = true)]
        public bool ShadowCopyBinAssemblies
        {
            get { return (bool)base[_propShadowCopyBinAssemblies]; }
            set { base[_propShadowCopyBinAssemblies] = value; }
        }
        ...
        {
            get { return (TimeSpan)base[_propUrlMetadataSlidingExpiration]; }
            set { base[_propUrlMetadataSlidingExpiration] = value; }
        }
    }
}
