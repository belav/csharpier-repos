...
namespace System.Web.Configuration
{
    ...
    {
        private static readonly TypeConverter s_PropConverter =
            new CommaDelimitedStringCollectionConverter();

        private static ConfigurationPropertyCollection _properties;
        private static readonly ConfigurationProperty _propVerbs = new ConfigurationProperty(
            "verbs",
        ...
        private static readonly ConfigurationProperty _propRoles = new ConfigurationProperty(
            "roles",
            typeof(CommaDelimitedStringCollection),
            null,
            s_PropConverter,
        ...
        public override bool Equals(object obj)
        {
            ...
            if (o != null)
            {
                ...
                bRet = (
                    o.Verbs.ToString() == Verbs.ToString()
        ...
        public override int GetHashCode()
        {
            ...
            int hHashCode = HashCodeCombiner.CombineHashCodes(
                __verbs.GetHashCode(),
                __roles.GetHashCode(),
                __users.GetHashCode(),
                (int)Action
        ...
        private void EvaluateData()
        {
            if (DataReady == false)
            {
                            ...
                            if (foundIndex >= 0)
                            {
                                throw new ConfigurationErrorsException(
                                    SR.GetString(
                                        ...
                                        User[foundIndex].ToString(CultureInfo.InvariantCulture)
                                    )
                                );
                            }
                        }
                ...
                {
                    throw new ConfigurationErrorsException(
                        SR.GetString(SR.Auth_rule_must_specify_users_andor_roles)
                    );
                }
                DataReady = true;
            }
