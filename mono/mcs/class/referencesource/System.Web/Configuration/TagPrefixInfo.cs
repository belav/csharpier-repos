    ...
    public sealed class TagPrefixInfo : ConfigurationElement
    {
        private static readonly ConfigurationElementProperty s_elemProperty =
            new ConfigurationElementProperty(
                new CallbackValidator(typeof(TagPrefixInfo), Validate)
            );

        private static ConfigurationPropertyCollection _properties;

        private static readonly ConfigurationProperty _propTagPrefix = new ConfigurationProperty(
            "tagPrefix",
            typeof(string),
            "/",
            null,
        ...
        private static readonly ConfigurationProperty _propTagName = new ConfigurationProperty(
            "tagName",
            typeof(string),
            String.Empty,
            null,
        ...
        private static readonly ConfigurationProperty _propNamespace = new ConfigurationProperty(
            "namespace",
            typeof(string),
            String.Empty,
            null,
        ...
        private static readonly ConfigurationProperty _propAssembly = new ConfigurationProperty(
            "assembly",
            typeof(string),
            String.Empty,
            null,
        ...
        private static readonly ConfigurationProperty _propSource = new ConfigurationProperty(
            "src",
            typeof(string),
            String.Empty,
            null,
        ...
        {
            get { return (string)base[_propTagPrefix]; }
            set { base[_propTagPrefix] = value; }
        }

        [ConfigurationProperty("tagName")]
        public string TagName
        {
            get { return (string)base[_propTagName]; }
            set { base[_propTagName] = value; }
        }

        [ConfigurationProperty("namespace")]
        public string Namespace
        {
            get { return (string)base[_propNamespace]; }
        ...
        {
            get { return (string)base[_propSource]; }
            set
            {
        ...
        private static void Validate(object value)
        {
            ...
            else if (!String.IsNullOrEmpty(elem.TagName))
            {
                ...
                if (
                    !(
                        String.IsNullOrEmpty(elem.Namespace)
