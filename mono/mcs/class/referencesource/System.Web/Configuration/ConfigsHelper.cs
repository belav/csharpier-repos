...
namespace System.Web.Configuration
{
    ...
    {
        internal static void GetRegistryStringAttribute(
            ref string val,
        ...
        )
        {
            if (HandlerBase.CheckAndReadRegistryValue(ref val, false) == false)
            {
                throw new ConfigurationErrorsException(
                    ...
                    config.ElementInformation.Properties[propName].Source,
                    config.ElementInformation.Properties[propName].LineNumber
                );
            }
        }
    }
