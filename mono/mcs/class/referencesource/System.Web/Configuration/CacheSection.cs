    ...
    */
    ...
    public sealed class CacheSection : ConfigurationSection
    {
        ...
        static CacheSection()
        {
...
#if NOT_UNTIL_LATER
            _propCacheAPIEnabled = new ConfigurationProperty(
                "cacheAPIEnabled",
                typeof(bool),
                true,
                ConfigurationPropertyOptions.None
            );
            _propDisableDependencies = new ConfigurationProperty(
                "disableDependencies",
                typeof(bool),
                false,
                ConfigurationPropertyOptions.None
            ...
            _propDisableMemoryCollection = new ConfigurationProperty(
                "disableMemoryCollection",
                typeof(bool),
                false,
                ConfigurationPropertyOptions.None
            );
            _propDisableExpiration = new ConfigurationProperty(
                "disableExpiration",
                typeof(bool),
                false,
                ConfigurationPropertyOptions.None
            );
            _propPrivateBytesLimit = new ConfigurationProperty(
                "privateBytesLimit",
                typeof(long),
                (long)0,
                null,
            ...
            _propPercentagePhysicalMemoryUsedLimit = new ConfigurationProperty(
            ...
            _propPrivateBytesPollTime = new ConfigurationProperty(
        ...
        {
            get { return (bool)base[_propCacheAPIEnabled]; }
            set { base[_propCacheAPIEnabled] = value; }
        }
#endif
        ...
        public bool DisableMemoryCollection
        {
            ...
            set { base[_propDisableMemoryCollection] = value; }
        }

        [ConfigurationProperty("disableExpiration", DefaultValue = false)]
        public bool DisableExpiration
        {
            get { return (bool)base[_propDisableExpiration]; }
            set { base[_propDisableExpiration] = value; }
        }
        ...
        {
            get { return (bool)base[_propDisableDependencies]; }
            set { base[_propDisableDependencies] = value; }
        }
#endif
        ...
        {
            get { return (long)base[_propPrivateBytesLimit]; }
            set { base[_propPrivateBytesLimit] = value; }
        }
        ...
        {
            get { return (int)base[_propPercentagePhysicalMemoryUsedLimit]; }
            set { base[_propPercentagePhysicalMemoryUsedLimit] = value; }
        }
        ...
        {
            get { return (TimeSpan)base[_propPrivateBytesPollTime]; }
            set { base[_propPrivateBytesPollTime] = value; }
        }
    }
}
