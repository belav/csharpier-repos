...
namespace System.Web.Configuration
{
    ...
    public class HttpCapabilitiesBase : IFilterResolutionService
    {
        ...
        {
            get { return _browserCapabilitiesProvider; }
            set { _browserCapabilitiesProvider = value; }
        }

        public bool UseOptimizedCacheKey
        {
            get { return _useOptimizedCacheKey; }
        }
        ...
        )
        {
            ...
            else
            {
                ...
                //
                HttpCapabilitiesDefaultProvider capsbuilder = (HttpCapabilitiesDefaultProvider)
                    request.Context.GetSection(configKey);
                if (capsbuilder != null)
                {
        ...
        internal static HttpBrowserCapabilities GetBrowserCapabilities(HttpRequest request)
        {
            ...
            HttpCapabilitiesDefaultProvider capsbuilder = request.Context.IsRuntimeErrorReported
                ? RuntimeConfig.GetLKGConfig(request.Context).BrowserCaps
                : RuntimeConfig.GetConfig(request.Context).BrowserCaps;
            if (capsbuilder != null)
            {
                if (BrowserCapabilitiesProvider != null)
                {
        ...
        public HtmlTextWriter CreateHtmlTextWriter(TextWriter w)
        {
            ...
            if (mtw != null && mtw.Length != 0)
            {
                ...
                try
                {
                    Type writerType = BuildManager.GetType(
                        mtw,
                        true /* throwOnFail */
                        ,
                        false /* ignoreCase */
        ...
        internal ControlAdapter GetAdapter(System.Web.UI.Control control)
        {
            ...
            if (adapterType == null)
            {
                ...
                {
                    throw new Exception(
                        SR.GetString(SR.ControlAdapters_TypeNotFound, adapterTypename)
                    );
                }
                ...
                lock (_controlAdapterFactoryTable.SyncRoot)
                {
                    ...
                    if (factory == null)
                    {
                        ...
                        catch
                        {
                            throw new Exception(
                                SR.GetString(
                                    SR.Could_not_create_type_instance,
        ...
        {
            get { return _htmlTextWriter; }
            set { _htmlTextWriter = value; }
        }
        ...
        public Version[] GetClrVersions()
        {
            ...
            Regex regex = RegexUtil.CreateRegex(
                "\\.NET CLR (?'clrVersion'[0-9\\.]*)",
                RegexOptions.None
            );
        ...
        Exception BuildParseError(Exception e, string capsKey)
        {
            string message = SR.GetString(
                SR.Invalid_string_from_browser_caps,
                e.Message,
                capsKey,
                this[capsKey]
            );
                ...
                try
                {
                    if (!_havetagwriter)
                    {
                        ...
                        if (String.IsNullOrEmpty(tagWriter))
                        {
                            ...
                            string.Compare(
                                tagWriter,
                                typeof(System.Web.UI.HtmlTextWriter).FullName,
                        ...
                        {
                            _tagwriter = BuildManager.GetType(
                                tagWriter,
                                true /*throwOnError*/
                            );
                        }
        ...
        public bool RequiresControlStateInSession
        {
            get
            {
                if (!_haverequiresControlStateInSession)
                {
                    ...
                    {
                        _requiresControlStateInSession = CapsParseBoolDefault(
        ...
        public virtual int GatewayMajorVersion
        {
            get
            {
                ...
                {
                    _gatewayMajorVersion = Convert.ToInt32(
            ...
            get
            {
                if (!_haveScreenCharactersWidth)
                {
                    if (this["screenCharactersWidth"] == null)
                    {
                        ...
                        {
                            screenPixelsWidthToUse = Convert.ToInt32(
                                this["screenPixelsWidth"],
                                CultureInfo.InvariantCulture
                            );
                            characterWidthToUse = Convert.ToInt32(
                                this["characterWidth"],
                                CultureInfo.InvariantCulture
                            );
                        }
                        ...
                        {
                            screenPixelsWidthToUse = Convert.ToInt32(
                                this["defaultScreenCharactersWidth"],
                                CultureInfo.InvariantCulture
                            );
                    ...
                    {
                        _screenCharactersWidth = Convert.ToInt32(
            ...
            get
            {
                if (!_haveScreenCharactersHeight)
                {
                    if (this["screenCharactersHeight"] == null)
                    {
                        ...
                        {
                            screenPixelHeightToUse = Convert.ToInt32(
                                this["screenPixelsHeight"],
                                CultureInfo.InvariantCulture
                            );
                            characterHeightToUse = Convert.ToInt32(
                        ...
                        {
                            screenPixelHeightToUse = Convert.ToInt32(
                                this["defaultScreenPixelsHeight"],
                                CultureInfo.InvariantCulture
                            );
                            characterHeightToUse = Convert.ToInt32(
                                this["characterHeight"],
                        ...
                        {
                            screenPixelHeightToUse = Convert.ToInt32(
                                this["defaultScreenCharactersHeight"],
                                CultureInfo.InvariantCulture
                            );
                    ...
                    {
                        _screenCharactersHeight = Convert.ToInt32(
            ...
            get
            {
                if (!_haveScreenPixelsWidth)
                {
                    if (this["screenPixelsWidth"] == null)
                    {
                        ...
                        {
                            screenCharactersWidthToUse = Convert.ToInt32(
                                this["screenCharactersWidth"],
                                CultureInfo.InvariantCulture
                            );
                            characterWidthToUse = Convert.ToInt32(
                    ...
                    {
                        _screenPixelsWidth = Convert.ToInt32(
                            this["screenPixelsWidth"],
                            CultureInfo.InvariantCulture
                        );
                    }
            ...
            get
            {
                if (!_haveScreenPixelsHeight)
                {
                    if (this["screenPixelsHeight"] == null)
                    {
                        ...
                        if (
                            this["screenCharactersHeight"] != null
                            && this["characterHeight"] != null
                        )
                        {
                            screenCharactersHeightToUse = Convert.ToInt32(
                                this["screenCharactersHeight"],
                                CultureInfo.InvariantCulture
                            );
                            characterHeightToUse = Convert.ToInt32(
                    ...
                    {
                        _screenPixelsHeight = Convert.ToInt32(
                            this["screenPixelsHeight"],
                            CultureInfo.InvariantCulture
                        );
                    }
        ...
        public virtual int ScreenBitDepth
        {
            get
            {
                ...
                {
                    _screenBitDepth = Convert.ToInt32(
                        this["screenBitDepth"],
                        CultureInfo.InvariantCulture
                    );
        ...
        public virtual int NumberOfSoftkeys
        {
            get
            {
                ...
                {
                    _numberOfSoftkeys = Convert.ToInt32(
        ...
        public virtual int MaximumSoftkeyLabelLength
        {
            get
            {
                ...
                {
                    _maximumSoftkeyLabelLength = Convert.ToInt32(
        ...
        public virtual bool RendersWmlDoAcceptsInline
        {
            get
            {
                ...
                {
                    _rendersWmlDoAcceptsInline = CapsParseBoolDefault(
        ...
        public virtual bool RendersWmlSelectsAsMenuCards
        {
            get
            {
                ...
                {
                    _rendersWmlSelectsAsMenuCards = CapsParseBoolDefault(
        ...
        public virtual bool RendersBreaksAfterWmlAnchor
        {
            get
            {
                ...
                {
                    _rendersBreaksAfterWmlAnchor = CapsParseBoolDefault(
        ...
        public virtual bool RendersBreaksAfterWmlInput
        {
            get
            {
                ...
                {
                    _rendersBreaksAfterWmlInput = CapsParseBoolDefault(
        ...
        public virtual bool RendersBreakBeforeWmlSelectAndInput
        {
            get
            {
                ...
                {
                    _rendersBreakBeforeWmlSelectAndInput = CapsParseBoolDefault(
        ...
        public virtual bool RequiresPhoneNumbersAsPlainText
        {
            get
            {
                ...
                {
                    _requiresPhoneNumbersAsPlainText = CapsParseBoolDefault(
        ...
        public virtual bool RequiresUrlEncodedPostfieldValues
        {
            get
            {
                ...
                {
                    _requiresUrlEncodedPostfieldValues = CapsParseBoolDefault(
        ...
        public virtual bool RendersBreaksAfterHtmlLists
        {
            get
            {
                ...
                {
                    _rendersBreaksAfterHtmlLists = CapsParseBoolDefault(
        ...
        public virtual bool RequiresUniqueHtmlInputNames
        {
            get
            {
                ...
                {
                    _requiresUniqueHtmlInputNames = CapsParseBoolDefault(
        ...
        public virtual bool RequiresUniqueHtmlCheckboxNames
        {
            get
            {
                ...
                {
                    _requiresUniqueHtmlCheckboxNames = CapsParseBoolDefault(
        ...
        public virtual bool HidesRightAlignedMultiselectScrollbars
        {
            get
            {
                ...
                {
                    _hidesRightAlignedMultiselectScrollbars = CapsParseBoolDefault(
        ...
        public virtual bool RequiresAttributeColonSubstitution
        {
            get
            {
                ...
                {
                    _requiresAttributeColonSubstitution = CapsParseBoolDefault(
        ...
        public virtual bool CanRenderOneventAndPrevElementsTogether
        {
            get
            {
                ...
                {
                    _canRenderOneventAndPrevElementsTogether = CapsParseBoolDefault(
        ...
        public virtual bool CanRenderInputAndSelectElementsTogether
        {
            get
            {
                ...
                {
                    _canRenderInputAndSelectElementsTogether = CapsParseBoolDefault(
        ...
        public virtual bool CanRenderAfterInputOrSelectElement
        {
            get
            {
                ...
                {
                    _canRenderAfterInputOrSelectElement = CapsParseBoolDefault(
        ...
        public virtual bool CanRenderSetvarZeroWithMultiSelectionList
        {
            get
            {
                ...
                {
                    _canRenderSetvarZeroWithMultiSelectionList = CapsParseBoolDefault(
        ...
        public virtual bool RequiresUniqueFilePathSuffix
        {
            get
            {
                ...
                {
                    _requiresUniqueFilePathSuffix = CapsParseBoolDefault(
        ...
        public virtual bool RequiresNoBreakInFormatting
        {
            get
            {
                ...
                {
                    _requiresNoBreakInFormatting = CapsParseBoolDefault(
        ...
        public virtual bool RequiresLeadingPageBreak
        {
            get
            {
                ...
                {
                    _requiresLeadingPageBreak = CapsParseBoolDefault(
        ...
        internal bool SupportsMaintainScrollPositionOnPostback
        {
            get
            {
                ...
                {
                    _supportsMaintainScrollPositionOnPostback = CapsParseBoolDefault(
        ...
        public virtual bool RequiresContentTypeMetaTag
        {
            get
            {
                ...
                {
                    _requiresContentTypeMetaTag = CapsParseBoolDefault(
        ...
        public virtual bool RequiresHtmlAdaptiveErrorReporting
        {
            get
            {
                ...
                {
                    _requiresHtmlAdaptiveErrorReporting = CapsParseBoolDefault(
        ...
        public virtual bool RequiresOutputOptimization
        {
            get
            {
                ...
                {
                    _requiresOutputOptimization = CapsParseBoolDefault(
        ...
        public virtual bool SupportsAccesskeyAttribute
        {
            get
            {
                ...
                {
                    _supportsAccesskeyAttribute = CapsParseBoolDefault(
        ...
        public virtual bool SupportsJPhoneMultiMediaAttributes
        {
            get
            {
                ...
                {
                    _supportsJPhoneMultiMediaAttributes = CapsParseBoolDefault(
        ...
        public virtual int MaximumRenderedPageSize
        {
            get
            {
                ...
                {
                    _maximumRenderedPageSize = Convert.ToInt32(
        ...
        public virtual bool RequiresSpecialViewStateEncoding
        {
            get
            {
                ...
                {
                    _requiresSpecialViewStateEncoding = CapsParseBoolDefault(
        ...
        public virtual bool SupportsQueryStringInFormAction
        {
            get
            {
                ...
                {
                    _supportsQueryStringInFormAction = CapsParseBoolDefault(
        ...
        public virtual bool SupportsCacheControlMetaTag
        {
            get
            {
                ...
                {
                    _supportsCacheControlMetaTag = CapsParseBoolDefault(
        ...
        public virtual bool SupportsRedirectWithCookie
        {
            get
            {
                ...
                {
                    _supportsRedirectWithCookie = CapsParseBoolDefault(
        ...
        public virtual bool SupportsEmptyStringInCookieValue
        {
            get
            {
                ...
                {
                    _supportsEmptyStringInCookieValue = CapsParseBoolDefault(
        ...
        public virtual int MaximumHrefLength
        {
            get
            {
                ...
                {
                    _maximumHrefLength = Convert.ToInt32(
                        this["maximumHrefLength"],
                        CultureInfo.InvariantCulture
                    );
        ...
        private
        //previously in System.Web.Mobile
        volatile String _mobileDeviceManufacturer;
        ...
        private volatile bool _haveSupportsEmptyStringInCookieValue = false;
