    ...
    public sealed class SqlCacheDependencyDatabase : ConfigurationElement
    {
        private static readonly ConfigurationElementProperty s_elemProperty =
            new ConfigurationElementProperty(
                new CallbackValidator(typeof(SqlCacheDependencyDatabase), Validate)
            );
        ...
        static SqlCacheDependencyDatabase()
        {
            ...
            _propConnectionStringName = new ConfigurationProperty(
        ...
        internal void CheckDefaultPollTime(int value)
        {
            ...
            // from above.
            if (
                ElementInformation.Properties["pollTime"].ValueOrigin == PropertyValueOrigin.Default
            )
            {
        ...
        public int PollTime
        {
            ...
            {
                if (
                    ElementInformation.Properties["pollTime"].ValueOrigin
