    ...
    public sealed class FolderLevelBuildProvider : ConfigurationElement
    {
        ...
        public override int GetHashCode()
        {
            return HashCodeCombiner.CombineHashCodes(
                StringUtil.GetNonRandomizedHashCode(Name.ToLower(CultureInfo.InvariantCulture)),
                Type.GetHashCode()
            );
        }
        ...
        internal FolderLevelBuildProviderAppliesTo AppliesToInternal
        {
            get
            {
                ...
                object[] attrs = TypeInternal.GetCustomAttributes(
                    typeof(FolderLevelBuildProviderAppliesToAttribute), /*inherit*/
                    true
                );
                ...
                if ((attrs != null) && (attrs.Length > 0))
                {
                    ...
                    _appliesToInternal = (
                        (FolderLevelBuildProviderAppliesToAttribute)attrs[0]
                    ).AppliesTo;
                }
                else
                {
