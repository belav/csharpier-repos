...
namespace System.Web.Configuration
{
    ...
    ******************************************************************************/
    ...
    public sealed class TrustSection : ConfigurationSection
    {
        ...
        private static readonly ConfigurationProperty _propLevel = new ConfigurationProperty(
            "level",
            typeof(string),
            "Full",
            null,
        ...
        private static readonly ConfigurationProperty _propOriginUrl = new ConfigurationProperty(
            "originUrl",
            typeof(string),
            String.Empty,
        ...
        public string Level
        {
            get { return (string)base[_propLevel]; }
            set { base[_propLevel] = value; }
        }

        [ConfigurationProperty("originUrl", DefaultValue = "")]
        public string OriginUrl
        {
            get { return (string)base[_propOriginUrl]; }
            set { base[_propOriginUrl] = value; }
        }
        ...
        public bool ProcessRequestInApplicationTrust
        {
            ...
            set { base[_propProcessRequestInApplicationTrust] = value; }
        }

        [SuppressMessage(
            "Microsoft.Naming",
            "CA1704:IdentifiersShouldBeSpelledCorrectly",
            Justification = "Cas as Identifier is already used in CLR"
        )]
        [ConfigurationProperty("legacyCasModel", DefaultValue = false)]
        public bool LegacyCasModel
        {
            get { return (bool)base[_propLegacyCasModel]; }
            set { base[_propLegacyCasModel] = value; }
        }

        [ConfigurationProperty("permissionSetName", DefaultValue = "ASP.Net")]
        public string PermissionSetName
        {
            get { return (string)base[_propPermissionSetName]; }
            set { base[_propPermissionSetName] = value; }
        }

        [ConfigurationProperty("hostSecurityPolicyResolverType", DefaultValue = "")]
        public string HostSecurityPolicyResolverType
        {
            get { return (string)base[_propHostSecurityPolicyResolverType]; }
            set { base[_propHostSecurityPolicyResolverType] = value; }
        }
    }
}
