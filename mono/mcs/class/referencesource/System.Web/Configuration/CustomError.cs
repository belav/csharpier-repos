...
namespace System.Web.Configuration
{
    ...
    public sealed class CustomError : ConfigurationElement
    {
        ...
        private static readonly ConfigurationProperty _propStatusCode = new ConfigurationProperty(
            "statusCode",
            typeof(int),
            null,
            null,
        ...
        private static readonly ConfigurationProperty _propRedirect = new ConfigurationProperty(
            "redirect",
            typeof(string),
            null,
            null,
        ...
        {
            get { return (int)base[_propStatusCode]; }
            set { base[_propStatusCode] = value; }
        }
        ...
        {
            get { return (string)base[_propRedirect]; }
            set { base[_propRedirect] = value; }
        }
    } // class CustomError
}
