 ...
 */
    public sealed class OutputCacheSection : ConfigurationSection
    {
        ...
        private static readonly ConfigurationProperty _propOmitVaryStar = new ConfigurationProperty(
            "omitVaryStar",
            typeof(bool),
            DefaultOmitVaryStar,
            ConfigurationPropertyOptions.None
        ...
        {
            get { return (bool)base[_propEnableFragmentCache]; }
            set { base[_propEnableFragmentCache] = value; }
        }

        [ConfigurationProperty(
            "sendCacheControlHeader",
            DefaultValue = HttpRuntimeSection.DefaultSendCacheControlHeader
        )]
            ...
            get
            {
                if (enableKernelCacheForVaryByStarCached == false)
                {
                    enableKernelCacheForVaryByStar = (bool)
                        base[_propEnableKernelCacheForVaryByStar];
        ...
        [ConfigurationProperty(
            "defaultProvider",
            DefaultValue = OutputCache.ASPNET_INTERNAL_PROVIDER_NAME
        )]
        [StringValidator(MinLength = 1)]
        public String DefaultProviderName
        {
            get { return (string)base[_propDefaultProviderName]; }
            set { base[_propDefaultProviderName] = value; }
        }
        ...
        internal OutputCacheProvider GetDefaultProvider(OutputCacheProviderCollection providers)
        {
            ...
            OutputCacheProvider defaultProvider =
                (providers == null) ? null : providers[defaultProviderName];
