...
internal class MTConfigUtil
{
    ...
    private static S GetAppConfig<S>()
        where S : ConfigurationSection
    {
    ...
    private static S GetConfig<S>(HttpContext context)
        where S : ConfigurationSection
    {
    ...
    private static S GetConfig<S>(string vpath)
        where S : ConfigurationSection
    {
    ...
    private static S GetConfig<S>(VirtualPath vpath)
        where S : ConfigurationSection
    {
    ...
    private static S GetConfigHelper<S>(VirtualPath vpath)
        where S : ConfigurationSection
    {
