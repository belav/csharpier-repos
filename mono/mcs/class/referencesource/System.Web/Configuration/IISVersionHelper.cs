    ...
    internal class IISVersionHelper : IDisposable
    {
        ...
        interface IIISVersion
        {
            ...
            object CreateObjectFromProgId(
                [In, MarshalAs(UnmanagedType.BStr)] string bstrObjectName
            );
        ...
        interface IIISVersionManager
        {
            ...
            IIISVersion GetVersionObject(
                [In, MarshalAs(UnmanagedType.BStr)] string bstrVersion,
                [In, MarshalAs(UnmanagedType.I4)] int productType
            );
