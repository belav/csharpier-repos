    ...
    public sealed class ProcessModelSection : ConfigurationSection
    {
        ...
        private static readonly ConfigurationElementProperty s_elemProperty =
            new ConfigurationElementProperty(
                new CallbackValidator(typeof(ProcessModelSection), Validate)
            );
        internal static TimeSpan DefaultClientConnectedCheck = new TimeSpan(0, 0, 5);

        private static ConfigurationPropertyCollection _properties;
        private static readonly ConfigurationProperty _propEnable = new ConfigurationProperty(
            "enable",
            typeof(bool),
            true,
        ...
        private static readonly ConfigurationProperty _propMemoryLimit = new ConfigurationProperty(
            "memoryLimit",
            typeof(int),
            60,
            ConfigurationPropertyOptions.None
        );
        private static readonly ConfigurationProperty _propWebGarden = new ConfigurationProperty(
            "webGarden",
            typeof(bool),
            false,
            ConfigurationPropertyOptions.None
        );
        private static readonly ConfigurationProperty _propCpuMask = new ConfigurationProperty(
            "cpuMask",
            typeof(string),
            "0xffffffff",
            ConfigurationPropertyOptions.None
        ...
        private static readonly ConfigurationProperty _propLogLevel = new ConfigurationProperty(
            "logLevel",
        ...
        private static readonly ConfigurationProperty _propAutoConfig = new ConfigurationProperty(
            "autoConfig",
            typeof(bool),
            false,
            ConfigurationPropertyOptions.None
        ...
        private static readonly ConfigurationProperty _propMaxIOThreads = new ConfigurationProperty(
            "maxIoThreads",
            typeof(int),
            DefaultMaxThreadsPerCPU,
            null,
        ...
        private static readonly ConfigurationProperty _propMinIOThreads = new ConfigurationProperty(
            "minIoThreads",
            typeof(int),
            1,
            null,
        ...
        private static readonly ConfigurationProperty _propPingTimeout = new ConfigurationProperty(
            "pingTimeout",
            typeof(TimeSpan),
            TimeSpan.MaxValue,
            StdValidatorsAndConverters.InfiniteTimeSpanConverter,
        ...
        {
            get { return (int)base[_propRequestQueueLimit]; }
            set { base[_propRequestQueueLimit] = value; }
        }
        ...
        {
            get { return (int)base[_propRestartQueueLimit]; }
            set { base[_propRestartQueueLimit] = value; }
        }

        [ConfigurationProperty("memoryLimit", DefaultValue = 60)]
        public int MemoryLimit
        {
            get { return (int)base[_propMemoryLimit]; }
            set { base[_propMemoryLimit] = value; }
        }

        [ConfigurationProperty("webGarden", DefaultValue = false)]
        public bool WebGarden
        {
            get { return (bool)base[_propWebGarden]; }
            set { base[_propWebGarden] = value; }
        }

        [ConfigurationProperty("cpuMask", DefaultValue = "0xffffffff")]
        public int CpuMask
        {
            get { return (int)Convert.ToInt32((string)base[_propCpuMask], 16); }
            set { base[_propCpuMask] = "0x" + Convert.ToString(value, 16); }
        }
        ...
        {
            get { return (ProcessModelLogLevel)base[_propLogLevel]; }
            set { base[_propLogLevel] = value; }
        }
        ...
        {
            get { return (TimeSpan)base[_propClientConnectedCheck]; }
            set { base[_propClientConnectedCheck] = value; }
        }

        [ConfigurationProperty(
            "comAuthenticationLevel",
            DefaultValue = ProcessModelComAuthenticationLevel.Connect
        )]
        public ProcessModelComAuthenticationLevel ComAuthenticationLevel
        {
            get { return (ProcessModelComAuthenticationLevel)base[_propComAuthenticationLevel]; }
            set { base[_propComAuthenticationLevel] = value; }
        }

        [ConfigurationProperty(
            "comImpersonationLevel",
            DefaultValue = ProcessModelComImpersonationLevel.Impersonate
        )]
        public ProcessModelComImpersonationLevel ComImpersonationLevel
        {
            get { return (ProcessModelComImpersonationLevel)base[_propComImpersonationLevel]; }
            set { base[_propComImpersonationLevel] = value; }
        }
        ...
        {
            get { return (TimeSpan)base[_propResponseDeadlockInterval]; }
            set { base[_propResponseDeadlockInterval] = value; }
        }
        ...
        {
            get { return (TimeSpan)base[_propResponseRestartDeadlockInterval]; }
            set { base[_propResponseRestartDeadlockInterval] = value; }
        }
        ...
        {
            get { return (bool)base[_propAutoConfig]; }
            set { base[_propAutoConfig] = value; }
        }
        ...
        {
            get { return (int)base[_propMaxWorkerThreads]; }
            set { base[_propMaxWorkerThreads] = value; }
        }
        ...
        {
            get { return (int)base[_propMaxIOThreads]; }
            set { base[_propMaxIOThreads] = value; }
        }
        ...
        {
            get { return (int)base[_propMinWorkerThreads]; }
            set { base[_propMinWorkerThreads] = value; }
        }
        ...
        {
            get { return (int)base[_propMinIOThreads]; }
            set { base[_propMinIOThreads] = value; }
        }

        [ConfigurationProperty("serverErrorMessageFile", DefaultValue = "")]
        public string ServerErrorMessageFile
        {
            get { return (string)base[_propServerErrorMessageFile]; }
            set { base[_propServerErrorMessageFile] = value; }
        }
        ...
        {
            get { return (TimeSpan)base[_propPingFrequency]; }
            set { base[_propPingFrequency] = value; }
        }
        ...
        {
            get { return (TimeSpan)base[_propPingTimeout]; }
            set { base[_propPingTimeout] = value; }
        }
        ...
        {
            get { return (int)base[_propMaxAppDomains]; }
            set { base[_propMaxAppDomains] = value; }
        }
        ...
        {
            get { return DefaultMaxThreadsPerCPU * cpuCount; }
        }
        ...
        {
            get { return MaxWorkerThreads * cpuCount; }
        }

        internal int MaxIoThreadsTimesCpuCount
        {
            get { return MaxIOThreads * cpuCount; }
        }

        internal int MinWorkerThreadsTimesCpuCount
        {
            get { return MinWorkerThreads * cpuCount; }
        }

        internal int MinIoThreadsTimesCpuCount
        {
            get { return MinIOThreads * cpuCount; }
        }
