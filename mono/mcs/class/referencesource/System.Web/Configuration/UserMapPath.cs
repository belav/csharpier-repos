...
namespace System.Web.Configuration
{
    ...
    public class UserMapPath : IConfigMapPath
    {
        ...
        internal UserMapPath(ConfigurationFileMap fileMap, bool pathsAreLocal)
        {
            ...
            {
                _rootWebConfigFilename = Path.Combine(
                    Path.GetDirectoryName(_machineConfigFilename),
                    "web.config"
                );
            }
            ...
            if (_webFileMap != null)
            {
                ...
                if (_pathsAreLocal)
                {
                    ...
                    {
                        VirtualDirectoryMapping mapping = _webFileMap.VirtualDirectories[
                            virtualDirectory
                        ];
                        mapping.Validate();
                    }
                ...
                {
                    _rootWebConfigFilename = Path.Combine(
                        rootWebMapping.PhysicalDirectory,
