...
namespace System.Web.Configuration
{
    ...
    public sealed class CodeSubDirectory : ConfigurationElement
    {
        ...
        {
            get { return (string)base[_propDirectoryName]; }
            set { base[_propDirectoryName] = value; }
        }
        ...
        internal void DoRuntimeValidation()
        {
            ...
            if (!Util.IsValidFileName(directoryName))
            {
                throw new ConfigurationErrorsException(
                    ...
                    ElementInformation.Properties[dirNameAttribName].Source,
                    ElementInformation.Properties[dirNameAttribName].LineNumber
                );
            }

            VirtualPath codeVirtualSubDir = HttpRuntime.CodeDirectoryVirtualPath
