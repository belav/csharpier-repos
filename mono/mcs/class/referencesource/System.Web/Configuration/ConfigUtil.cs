...
namespace System.Web.Configuration
{
    ...
    internal class ConfigUtil
    {
        ...
        internal static void CheckBaseType(
        ...
        )
        {
            ...
            if (!expectedBaseType.IsAssignableFrom(userBaseType))
            {
                throw new ConfigurationErrorsException(
                    SR.GetString(
                        SR.Invalid_type_to_inherit_from,
        ...
        internal static ConfigurationErrorsException MakeConfigurationErrorsException(
            string message,
            Exception innerException = null,
            PropertyInformation configProperty = null
        )
        {
            return new ConfigurationErrorsException(
                message,
                innerException,
                (configProperty != null) ? configProperty.Source : null,
                (configProperty != null) ? configProperty.LineNumber : 0
            );
        }
        ...
        {
            if (
                BinaryCompatibility.Current.TargetsAtLeastFramework45 && !configSection.IsReadOnly()
            )
            {
                PropertyInformation propInfo = configSection.ElementInformation.Properties[
                    property.Name
                ];
