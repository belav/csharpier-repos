...
namespace System.Web.Configuration
{
    ...
    public sealed class VirtualDirectoryMapping
    {
        ...
        private VirtualDirectoryMapping(
            VirtualPath virtualDirectory,
            string physicalDirectory,
            bool isAppRoot,
            string configFileBaseName
        )
        ...
        {
            return new VirtualDirectoryMapping(
                _virtualDirectory,
                _physicalDirectory,
                _isAppRoot,
                _configFileBaseName
        ...
        public string VirtualDirectory
        {
            get
            {
                return (_virtualDirectory != null)
                    ? _virtualDirectory.VirtualPathString
                    : string.Empty;
            }
        }
        ...
        public string PhysicalDirectory
        {
            ...
            set
            {
                ...
                else
                {
                    ...
                    {
                        physicalDirectory = physicalDirectory.Substring(
                            0,
                            physicalDirectory.Length - 1
                        );
                    }
        ...
        {
            get { return _isAppRoot; }
            set { _isAppRoot = value; }
        }
        ...
        {
            get { return _configFileBaseName; }
            set
            {
