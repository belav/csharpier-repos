...
namespace System.Web.Configuration
{
    ...
    internal static class HandlerBase
    {
        ...
        internal static XmlNode GetAndRemoveRequiredStringAttribute(
            XmlNode node,
            string attrib,
            ref string val
        )
        ...
        internal static XmlNode GetAndRemoveNonEmptyStringAttribute(
            XmlNode node,
            string attrib,
            ref string val
        )
        {
            return GetAndRemoveNonEmptyStringAttributeInternal(
                node,
                attrib,
                false /*fRequired*/
                ,
        ...
        internal static XmlNode GetAndRemoveRequiredNonEmptyStringAttribute(
            XmlNode node,
            string attrib,
            ref string val
        )
        ...
        private static XmlNode GetAndRemovePositiveAttributeInternal(
            XmlNode node,
            string attrib,
            bool fRequired,
            ref int val
        ...
        internal static XmlNode GetAndRemovePositiveIntegerAttribute(
            XmlNode node,
            string attrib,
            ref int val
        )
        {
            return GetAndRemovePositiveAttributeInternal(
                node,
                attrib,
                false /*fRequired*/
                ,
        ...
        private static XmlNode GetAndRemoveTypeAttributeInternal(
            XmlNode node,
            string attrib,
            bool fRequired,
            ref Type val
        ...
        {
            return GetAndRemoveTypeAttributeInternal(
                node,
                attrib,
                false /*fRequired*/
                ,
        ...
        internal static bool CheckAndReadConnectionString(
        ...
        )
        {
            ...
            if (
                ...
                && connObj.ConnectionString.Length > 0
            )
