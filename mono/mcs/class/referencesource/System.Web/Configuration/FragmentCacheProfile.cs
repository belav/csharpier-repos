...
namespace System.Web.Configuration
{
    ...
    public sealed class FragmentCacheProfile : ConfigurationElement
    {
        ...
        static FragmentCacheProfile()
        {
            ...
            _propDuration = new ConfigurationProperty(
                "duration",
                typeof(int),
                ONE_YEAR_DURATION,
                ConfigurationPropertyOptions.None
            );
            _propLocation = new ConfigurationProperty(
                "location",
                typeof(OutputCacheLocation),
                -1,
                ConfigurationPropertyOptions.None
            );
            _propShared = new ConfigurationProperty(
                "shared",
                typeof(bool),
                false,
                ConfigurationPropertyOptions.None
            );
            _propProvider = new ConfigurationProperty(
                "provider",
                typeof(string),
                null,
                ConfigurationPropertyOptions.None
            );
            _propSqlDependency = new ConfigurationProperty(
                "sqlDependency",
                typeof(string),
                null,
                ConfigurationPropertyOptions.None
            );
            _propVaryByCustom = new ConfigurationProperty(
                "varyByCustom",
                typeof(string),
                null,
                ConfigurationPropertyOptions.None
            );
            _propVaryByContentEncoding = new ConfigurationProperty(
                "varyByContentEncoding",
                typeof(string),
                null,
                ConfigurationPropertyOptions.None
            );
            _propVaryByHeader = new ConfigurationProperty(
                "varyByHeader",
                typeof(string),
                null,
                ConfigurationPropertyOptions.None
            );
            _propVaryByParam = new ConfigurationProperty(
                "varyByParam",
                typeof(string),
                null,
                ConfigurationPropertyOptions.None
        ...
        public int Duration
        {
            get { return (int)base[_propDuration]; }
        ...
        {
            get { return (OutputCacheLocation)base[_propLocation]; }
            set { base[_propLocation] = value; }
        }

        [ConfigurationProperty("shared", DefaultValue = false)]
        public bool Shared
        {
            get { return (bool)base[_propShared]; }
            set { base[_propShared] = value; }
        }

        [ConfigurationProperty("provider")]
        public string Provider
        {
            get { return (string)base[_propProvider]; }
            set { base[_propProvider] = value; }
        }

        [ConfigurationProperty("sqlDependency")]
        public string SqlDependency
        {
            get { return (string)base[_propSqlDependency]; }
            set { base[_propSqlDependency] = value; }
        }
        ...
        {
            get { return (string)base[_propVaryByContentEncoding]; }
            set { base[_propVaryByContentEncoding] = value; }
        }

        [ConfigurationProperty("varyByHeader")]
        public string VaryByHeader
        {
            get { return (string)base[_propVaryByHeader]; }
            set { base[_propVaryByHeader] = value; }
        }

        [ConfigurationProperty("varyByParam")]
        public string VaryByParam
        {
            get { return (string)base[_propVaryByParam]; }
            set { base[_propVaryByParam] = value; }
        }
    }
#endif
}
