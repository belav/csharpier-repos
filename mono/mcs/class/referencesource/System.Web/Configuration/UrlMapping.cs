...
namespace System.Web.Configuration
{
    ...
    public sealed class UrlMapping : ConfigurationElement
    {
        ...
        private static readonly ConfigurationProperty _propUrl = new ConfigurationProperty(
            "url",
            typeof(string),
            null,
        ...
        private static readonly ConfigurationProperty _propMappedUrl = new ConfigurationProperty(
            "mappedUrl",
            typeof(string),
            null,
            StdValidatorsAndConverters.WhiteSpaceTrimStringConverter,
        ...
        private static void ValidateUrl(object value)
        {
            ...
            if (!UrlPath.IsAppRelativePath(url))
            {
                throw new ConfigurationErrorsException(
                    SR.GetString(SR.UrlMappings_only_app_relative_url_allowed, url)
                );
            }
        }
    }
