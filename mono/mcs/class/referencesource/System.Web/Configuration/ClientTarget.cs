...
namespace System.Web.Configuration
{
    ...
    public sealed class ClientTarget : ConfigurationElement
    {
        ...
        private static readonly ConfigurationProperty _propAlias = new ConfigurationProperty(
            "alias",
            typeof(string),
            null,
            null,
        ...
        private static readonly ConfigurationProperty _propUserAgent = new ConfigurationProperty(
            "userAgent",
            typeof(string),
            null,
            null,
        ...
        public string Alias
        {
            get { return (string)base[_propAlias]; }
        }
