...
namespace System.Web.Configuration
{
    ...
    {
        // 2.0 SP1 mode encryption doesn't use IVs when encrypting data and is included only for legacy
        // reasons.
        Framework20SP1 = 0,
        ...
        // See: DevDiv #48244 (http://vstfdevdiv:8080/DevDiv2/web/wi.aspx?id=48244), which the overall
        // Crypto DCR is a reaction to
