    ...
    public sealed class HttpModuleAction : ConfigurationElement
    {
        private static readonly ConfigurationElementProperty s_elemProperty =
            new ConfigurationElementProperty(
                new CallbackValidator(typeof(HttpModuleAction), Validate)
            );
        ...
        {
            get { return ElementInformation.Properties["name"].Source; }
        }

        internal int LineNumber
        {
            get { return ElementInformation.Properties["name"].LineNumber; }
        }
            ...
            get
            {
                ...
                catch (Exception ex)
                {
                    throw new ConfigurationErrorsException(
                        ex.Message,
                        ElementInformation.Properties[_propType.Name].Source,
                        ElementInformation.Properties[_propType.Name].LineNumber
                    );
                }
            }
        }
        ...
        {
            return ModulesEntry.IsTypeMatch(
                typeof(System.Web.Security.DefaultAuthenticationModule),
                className
            );
        }
