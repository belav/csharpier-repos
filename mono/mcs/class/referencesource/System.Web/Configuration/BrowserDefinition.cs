...
namespace System.Web.Configuration
{
    ...
    internal class BrowserDefinition
    {
        ...
        internal BrowserDefinition(XmlNode node, bool isDefaultBrowser)
        {
            ...
            if ((refID != null) && (_id != null))
            {
                throw new ConfigurationErrorsException(
                    SR.GetString(SR.Browser_mutually_exclusive_attributes, "id", "refID"),
                    node
                );
            }
            ...
            {
                if (
                    !System.CodeDom.Compiler.CodeGenerator.IsValidLanguageIndependentIdentifier(_id)
                )
                {
                    throw new ConfigurationErrorsException(
                        SR.GetString(SR.Browser_InvalidID, "id", _id),
                        node
                    );
                }
            }
            else
            {
                if (refID == null)
                {
                    ...
                    {
                        throw new ConfigurationErrorsException(
                            SR.GetString(SR.Browser_attributes_required, "gateway", "refID", "id"),
                            node
                        );
                    }

                    throw new ConfigurationErrorsException(
                        SR.GetString(SR.Browser_attributes_required, "browser", "refID", "id"),
                        node
                    );
                }
                else
                {
                    ...
                    {
                        throw new ConfigurationErrorsException(
                            SR.GetString(SR.Browser_InvalidID, "refID", refID),
                            node
                        );
                    }
                }
                ...
                {
                    throw new ConfigurationErrorsException(
                        SR.GetString(SR.Browser_mutually_exclusive_attributes, "parentID", "refID"),
                        node
                    );
                }
            }
            ...
            if (!_isRefID)
            {
                ...
                else
                {
                    ...
                    if (_parentID != null)
                        throw new ConfigurationErrorsException(
                            SR.GetString(SR.Browser_parentID_applied_to_default),
                            node
                        );
                }
            }
            ...
            {
                throw new ConfigurationErrorsException(
                    SR.GetString(SR.Space_attribute, "id " + _id),
                    node
                );
            }
            ...
            foreach (XmlNode child in node.ChildNodes)
            {
                ...
                switch (child.Name)
                {
                    case "identification":
                        ...
                        {
                            throw new ConfigurationErrorsException(
                                SR.GetString(SR.Browser_refid_prohibits_identification),
                                node
                            );
                        }

                        this.ProcessIdentificationNode(
                            child,
                            BrowserCapsElementType.Identification
                        );
                        break;
                    ...
                    default:
                        throw new ConfigurationErrorsException(
                            SR.GetString(SR.Browser_invalid_element, child.Name),
                            node
                        );
                }
            }
        ...
        {
            get { return _refBrowsers; }
        }

        public BrowserDefinitionCollection RefGateways
        {
            get { return _refGateways; }
        }
        ...
        {
            get { return _isDeviceNode; }
            set { _isDeviceNode = value; }
        }
        ...
        {
            get { return _idHeaderChecks; }
        }

        public ArrayList CaptureHeaderChecks
        {
            get { return _captureHeaderChecks; }
        }

        public ArrayList IdCapabilityChecks
        {
            get { return _idCapabilityChecks; }
        }
        ...
        {
            get { return _htmlTextWriterString; }
        }
        ...
        private void DisallowNonMatchAttribute(XmlNode node)
        {
            ...
            {
                throw new ConfigurationErrorsException(
                    SR.GetString(SR.Browser_mutually_exclusive_attributes, "match", "nonMatch"),
                    node
                );
            }
        }
        ...
        */
        internal void ProcessIdentificationNode(XmlNode node, BrowserCapsElementType elementType)
        {
            ...
            foreach (XmlNode child in node.ChildNodes)
            {
                ...
                switch (child.Name)
                {
                    ...
                    case "header":
                        ...
                        HandlerBase.GetAndRemoveRequiredNonEmptyStringAttribute(
                            child,
                            "name",
                            ref header
                        );
                    ...
                    default:
                        throw new ConfigurationErrorsException(
                            SR.GetString(SR.Config_invalid_element, child.ToString()),
                            child
                        );
                }
            }
            ...
            {
                throw new ConfigurationErrorsException(
                    SR.GetString(SR.Browser_empty_identification),
                    node
                );
            }
        ...
        */
        ...
        internal void ProcessCapabilitiesNode(XmlNode node)
        {
            foreach (XmlNode child in node.ChildNodes)
            {
                ...
                HandlerBase.GetAndRemoveRequiredStringAttribute(
                    child,
                    "value",
                    ref capabilityValue
                );
        ...
        */
        ...
        {
            HandlerBase.GetAndRemoveStringAttribute(
                node,
                "markupTextWriterType",
                ref _htmlTextWriterString
            );
            foreach (XmlNode child in node.ChildNodes)
            {
                if (child.NodeType != XmlNodeType.Element)
        ...
        private static Type CheckType(string typeName, Type baseType, XmlNode child)
        {
            ...
            {
                throw new ConfigurationErrorsException(
                    SR.GetString(SR.Type_doesnt_inherit_from_type, typeName, baseType.FullName),
                    child
                );
            }
            ...
            {
                throw new ConfigurationErrorsException(
                    SR.GetString(SR.Type_from_untrusted_assembly, typeName),
                    child
                );
            }
