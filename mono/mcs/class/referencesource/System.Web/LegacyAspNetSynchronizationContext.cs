...
namespace System.Web
{
    ...
    internal sealed class LegacyAspNetSynchronizationContext : AspNetSynchronizationContextBase
    {
        ...
        public override SynchronizationContext CreateCopy()
        {
            ...
            CreateCopyDumpStack();
#endif
            LegacyAspNetSynchronizationContext context = new LegacyAspNetSynchronizationContext(
                _application
            );
        ...
        public override void OperationStarted()
        {
            ...
            Debug.Trace(
                "AsyncStack",
                "OperationStarted(count=" + _pendingCount + ") from:\r\n" + GetDebugStackTrace()
            );
#endif
        }
        ...
        public override void OperationCompleted()
        {
            ...
            Debug.Trace(
                "AsyncStack",
                "OperationCompleted(pendingCount="
                    + pendingCount
                    + ") from:\r\n"
                    + GetDebugStackTrace()
            );
