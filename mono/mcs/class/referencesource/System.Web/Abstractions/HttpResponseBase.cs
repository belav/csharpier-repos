...
namespace System.Web
{
    ...
    public abstract class HttpResponseBase
    {
        ...
        [SuppressMessage(
            ...
            Justification = @"The normal event pattern doesn't work between HttpResponse and HttpResponseBase since the signatures differ."
        )]
        ...
        public virtual void RedirectToRoutePermanent(
            string routeName,
