...
// </copyright>
#if USE_MEMORY_CACHE
using System;using System.Diagnostics.CodeAnalysis;using System.Runtime.Caching;using System.Web.Util;
...
namespace System.Web.Caching
{
    internal sealed class DependencyChangeMonitor : ChangeMonitor, ICacheDependencyChanged
    {
        ...
        {
            get { return _dependency.GetUniqueID(); }
        }
        ...
        [SuppressMessage(
            ...
            Justification = "suppressed because fxcop is suffering from despotism"
        )]
