...
namespace System.Web
{
    ...
    internal sealed class PipelineModuleStepContainer
    {
        ...
        internal string DebugModuleName
        {
            ...
            get { return (String.IsNullOrEmpty(_moduleName)) ? String.Empty : _moduleName; }
        }
#endif
        ...
        {
            List<HttpApplication.IExecutionStep> stepArray = GetStepArray(
                notification,
                isPostEvent
            );
            if (null == stepArray)
        ...
        private static int EventToIndex(RequestNotification notification)
        {
            ...
            switch (notification)
            {
                ...
                default:
                    Debug.Assert(
                        index != -1,
                        "invalid request notification--need to update switch table?"
                    );
                    return index;
            }
        }
