...
namespace System.Web.Management
{
    ...
    public sealed class SimpleMailWebEventProvider : MailWebEventProvider, IInternalWebEventProvider
    {
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            ProviderUtil.GetAndRemovePositiveOrInfiniteAttribute(
                config,
                "maxEventLength",
                name,
                ref _maxEventLength
        ...
        )
        {
            ...
            if (discardedSinceLastFlush != 0 && seq == MessageSequenceBase)
            {
                ...
                sb.Append(
                    SR.GetString(
                        SR.MailWebEventProvider_discard_warning,
            ...
            if (eventsToDrop > 0)
            {
                ...
                sb.Append(
                    SR.GetString(
                        SR.MailWebEventProvider_events_drop_warning,
        ...
        )
        {
            ...
            sb.Append(
                SR.GetString(
                    SR.MailWebEventProvider_summary_body,
        ...
        )
        {
            ...
            for (int i = 0; i < totalEvents; i++)
            {
                ...
                if (_maxEventLength != ProviderUtil.Infinite && details.Length > _maxEventLength)
                {
