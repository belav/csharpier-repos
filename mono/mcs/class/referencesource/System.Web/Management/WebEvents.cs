...
namespace System.Web.Management
{
    ...
    public class WebBaseEvent
    {
        ...
        static readonly SystemEventType[,] s_eventCodeToSystemEventTypeMappings =
            new SystemEventType[
                WebEventCodes.GetEventArrayDimensionSize(0),
                WebEventCodes.GetEventArrayDimensionSize(1)
            ];

        // A array that store the # of occurrence per custom event code.
        static readonly long[,] s_eventCodeOccurrence = new long[
            WebEventCodes.GetEventArrayDimensionSize(0),
            WebEventCodes.GetEventArrayDimensionSize(1)
        ];
...
#pragma warning restore 0649
        ...
        {
            get { return (_code < WebEventCodes.WebExtendedBase); }
        }
        ...
        {
            get { return _eventTimeUtc.ToLocalTime(); }
        }
        ...
        internal virtual void FormatToString(WebEventFormatter formatter, bool includeAppInfo)
        {
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_code,
                    EventCode.ToString(CultureInfo.InstalledUICulture)
                )
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(SR.Webevent_event_message, Message)
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_time,
                    EventTime.ToString(CultureInfo.InstalledUICulture)
                )
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_time_Utc,
                    EventTimeUtc.ToString(CultureInfo.InstalledUICulture)
                )
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_id,
                    EventID.ToString("N", CultureInfo.InstalledUICulture)
                )
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_sequence,
                    EventSequence.ToString(CultureInfo.InstalledUICulture)
                )
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_occurrence,
                    EventOccurrence.ToString(CultureInfo.InstalledUICulture)
                )
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_detail_code,
                    EventDetailCode.ToString(CultureInfo.InstalledUICulture)
                )
            );
            ...
            if (includeAppInfo)
            {
                ...
                formatter.AppendLine(
                    WebBaseEvent.FormatResourceStringWithCache(
                        SR.Webevent_event_application_information
                    )
                );
        ...
        public virtual string ToString(bool includeAppInfo, bool includeCustomEventDetails)
        {
            ...
            if (!IsSystemEvent && includeCustomEventDetails)
            {
                ...
                formatter.AppendLine(
                    WebBaseEvent.FormatResourceStringWithCache(
                        SR.Webevent_event_custom_event_details
                    )
                );
                formatter.IndentationLevel += 1;
        ...
        internal void DeconstructWebEvent(
            out int eventType,
            out int fieldCount,
        ...
        {
            fields.Add(
                new WebEventFieldData(
                    "EventTime",
                    EventTimeUtc.ToString(),
                    WebEventFieldType.String
                )
            );
            fields.Add(
                new WebEventFieldData("EventID", EventID.ToString(), WebEventFieldType.String)
            );
            fields.Add(new WebEventFieldData("EventMessage", Message, WebEventFieldType.String));
            fields.Add(
                new WebEventFieldData(
                    "ApplicationDomain",
                    WebBaseEvent.ApplicationInformation.ApplicationDomain,
                    WebEventFieldType.String
                )
            );
            fields.Add(
                new WebEventFieldData(
                    "TrustLevel",
                    WebBaseEvent.ApplicationInformation.TrustLevel,
                    WebEventFieldType.String
                )
            );
            fields.Add(
            ...
            fields.Add(
                new WebEventFieldData(
                    "ApplicationPath",
                    WebBaseEvent.ApplicationInformation.ApplicationPath,
                    WebEventFieldType.String
                )
            );
            fields.Add(
                new WebEventFieldData(
                    "MachineName",
                    WebBaseEvent.ApplicationInformation.MachineName,
                    WebEventFieldType.String
                )
            );
            fields.Add(
        ...
        static void FindEventCode(
            Exception e,
            ref int eventCode,
            ref int eventDetailsCode,
            ref Exception eStack
        )
        {
            ...
            else if (e is HttpException && e.InnerException is ViewStateException)
            {
                ...
                e is HttpException
                && ((HttpException)e).WebEventCode != WebEventCodes.UndefinedEventCode
            )
            {
        ...
        internal void IncrementTotalCounters(int index0, int index1)
        {
            ...
            if (index0 != -1)
            {
                _occurrenceNumber = Interlocked.Increment(
                    ref s_eventCodeOccurrence[index0, index1]
                );
            }
            else
            {
                CustomEventCodeOccurrence ceco = (CustomEventCodeOccurrence)
        ...
        public static void Raise(WebBaseEvent eventRaised)
        {
            if (eventRaised.EventCode < WebEventCodes.WebExtendedBase)
            {
                throw new HttpException(
                    SR.GetString(
                        SR.System_eventCode_not_allowed,
            ...
            {
                Debug.Trace(
                    "WebEventRaiseDetails",
                    "Can't fire event because we are disabled or we can't configure HealthMonManager"
                );
                return;
            }
        ...
        )
        {
            ...
            Debug.Trace(
                "WebEventRaiseDetails",
                "Event is raised; event class = " + eventRaised.GetType().Name
            );
            ...
            if (o != null && (bool)o)
            {
                Debug.Trace(
                    "WebEventRaiseDetails",
                    "An event is raised while we're raising an event.  Ignore it."
                );
                return;
            }
            ...
            try
            {
                ...
                {
                    foreach (
                        HealthMonitoringSectionHelper.FiringRuleInfo firingRuleInfo in firingRuleInfos
                    )
                    {
                        ...
                        if (ruleInfo._referencedProvider != null)
                        {
                            ...
                            if (firingRuleInfo._indexOfFirstRuleInfoWithSameProvider != -1)
                            {
                                ...
                                if (
                                    matchingProviderArray[
                                        firingRuleInfo._indexOfFirstRuleInfoWithSameProvider
                                    ]
                                )
                                {
                                    Debug.Trace(
                            ...
                            try
                            {
                                ...
                                Debug.Trace(
                                    "WebEventRaiseDetails",
                                    "Calling ProcessEvent under "
                                        + HttpApplication.GetCurrentWindowsIdentityWithAssert().Name
                                );
                            ...
                            finally
                            {
                                if (
                                    ...
                                    EtwTrace.Trace(
                                        EtwTraceType.ETW_TYPE_WEB_EVENT_DELIVER_END,
                                        context.WorkerRequest
                                    );
                            }
                        }
                ...
                finally
                {
                    ...
                    if (
                        ...
                        EtwTrace.Trace(
                            EtwTraceType.ETW_TYPE_WEB_EVENT_RAISE_END,
                            context.WorkerRequest
                        );
                }
            }
        ...
        internal static void RaiseSystemEvent(
            string message,
            object source,
            int eventCode,
            int eventDetailCode,
        ...
        static void RaiseSystemEventInternal(
            string message,
            object source,
            int eventCode,
            int eventDetailCode,
        ...
        )
        {
            ...
            Debug.Trace(
                "WebEventRaiseDetails",
                "RaiseSystemEventInternal called; eventCode="
                    + eventCode
                    + "; eventDetailCode="
                    + eventDetailCode
            );
        ...
        static SystemEventTypeInfo[] s_systemEventTypeInfos = new SystemEventTypeInfo[
            (int)SystemEventType.Last
        ];

        static void GetSystemEventTypeInfo(
            int eventCode,
            int index0,
            int index1,
            out SystemEventTypeInfo info,
            out SystemEventType systemEventType
        )
        {
        ...
        {
            if (
                eventCode >= WebEventCodes.ApplicationCodeBase
            ...
            if (
                eventCode >= WebEventCodes.RequestCodeBase
            ...
            if (
                eventCode >= WebEventCodes.ErrorCodeBase
            ...
            if (
                eventCode >= WebEventCodes.AuditCodeBase
            ...
            if (
                eventCode >= WebEventCodes.MiscCodeBase
            ...
            )
            {
                switch (eventCode)
                {
                    case WebEventCodes.WebEventProviderInformation:
                        Debug.Assert(
                            false,
                            "WebEventProviderInformation shouldn't be used to Raise an event"
                        );
        ...
        static WebBaseEvent NewEventFromSystemEventType(
            bool createDummy,
            SystemEventType systemEventType,
            string message,
            object source,
        ...
        )
        {
            ...
            switch (systemEventType)
            {
                case SystemEventType.WebApplicationLifetimeEvent:
                    return createDummy
                        ? new WebApplicationLifetimeEvent()
                        : new WebApplicationLifetimeEvent(
                            message,
                            source,
                            eventCode,
                ...
                case SystemEventType.WebHeartbeatEvent:
                    return createDummy
                        ? new WebHeartbeatEvent()
                        : new WebHeartbeatEvent(message, eventCode);

                case SystemEventType.WebRequestEvent:
                    return createDummy
                        ? new WebRequestEvent()
                        : new WebRequestEvent(message, source, eventCode, eventDetailCode);

                case SystemEventType.WebRequestErrorEvent:
                    return createDummy
                        ? new WebRequestErrorEvent()
                        : new WebRequestErrorEvent(
                            message,
                            source,
                            eventCode,
                ...
                case SystemEventType.WebErrorEvent:
                    return createDummy
                        ? new WebErrorEvent()
                        : new WebErrorEvent(message, source, eventCode, eventDetailCode, exception);
                ...
                case SystemEventType.WebSuccessAuditEvent:
                    return createDummy
                        ? new WebSuccessAuditEvent()
                        : new WebSuccessAuditEvent(message, source, eventCode, eventDetailCode);

                case SystemEventType.WebAuthenticationFailureAuditEvent:
                    return createDummy
                        ? new WebAuthenticationFailureAuditEvent()
                        : new WebAuthenticationFailureAuditEvent(
                            message,
                            source,
                            eventCode,
                ...
                case SystemEventType.WebFailureAuditEvent:
                    return createDummy
                        ...
                        : new WebFailureAuditEvent(message, source, eventCode, eventDetailCode);

                case SystemEventType.WebViewStateFailureAuditEvent:
                    return createDummy
                        ? new WebViewStateFailureAuditEvent()
                        : new WebViewStateFailureAuditEvent(
                            message,
                            source,
                            eventCode,
        ...
        )
        {
            ...
            WebBaseEvent.RaiseSystemEvent(
                SR.GetString(
                    SR.Webevent_msg_Property_Deserialization,
                    property.Name,
    ...
    public class WebManagementEvent : WebBaseEvent
    {
        ...
        internal override void GenerateFieldsForMarshal(List<WebEventFieldData> fields)
        {
            ...
            fields.Add(
                new WebEventFieldData(
                    "ProcessID",
                    ProcessInformation.ProcessID.ToString(CultureInfo.InstalledUICulture),
                    WebEventFieldType.Int
                )
            );
        }
        ...
        internal override void FormatToString(WebEventFormatter formatter, bool includeAppInfo)
        {
            ...
            formatter.AppendLine(String.Empty);
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(SR.Webevent_event_process_information)
            );
    ...
    public class WebHeartbeatEvent : WebManagementEvent
    {
        ...
        internal override void FormatToString(WebEventFormatter formatter, bool includeAppInfo)
        {
            ...
            formatter.AppendLine(String.Empty);
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(SR.Webevent_event_process_statistics)
            );
    ...
    public class WebRequestEvent : WebManagementEvent
    {
        ...
        internal override void GenerateFieldsForMarshal(List<WebEventFieldData> fields)
        {
            ...
            fields.Add(
                new WebEventFieldData(
                    "UserAuthenticated",
                    RequestInformation.Principal.Identity.IsAuthenticated.ToString(),
            ...
            fields.Add(
                new WebEventFieldData(
                    ...
                    RequestInformation.Principal.Identity.AuthenticationType,
                    WebEventFieldType.String
                )
            );
            fields.Add(
                new WebEventFieldData(
                    ...
                    RequestInformation.ThreadAccountName,
                    WebEventFieldType.String
                )
            );
        }
        ...
        internal override void FormatToString(WebEventFormatter formatter, bool includeAppInfo)
        {
            ...
            formatter.AppendLine(String.Empty);
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(SR.Webevent_event_request_information)
            );
    ...
    public class WebBaseErrorEvent : WebManagementEvent
    {
        ...
        internal override void FormatToString(WebEventFormatter formatter, bool includeAppInfo)
        {
            ...
            for (int level = 0; ex != null && level <= 2; ex = ex.InnerException, level++)
            {
                formatter.AppendLine(String.Empty);
                ...
                if (level == 0)
                {
                    formatter.AppendLine(
                        WebBaseEvent.FormatResourceStringWithCache(
                            SR.Webevent_event_exception_information
                        )
                    );
                }
                else
                {
                    formatter.AppendLine(
                        WebBaseEvent.FormatResourceStringWithCache(
                            SR.Webevent_event_inner_exception_information,
                ...
                formatter.AppendLine(
                    WebBaseEvent.FormatResourceStringWithCache(
                        SR.Webevent_event_exception_type,
                        ex.GetType().ToString()
                    )
                );
                formatter.AppendLine(
                    WebBaseEvent.FormatResourceStringWithCache(
                        SR.Webevent_event_exception_message,
                        ex.Message
                    )
                );
                formatter.IndentationLevel -= 1;
    ...
    public class WebErrorEvent : WebBaseErrorEvent
    {
        ...
        internal override void FormatToString(WebEventFormatter formatter, bool includeAppInfo)
        {
            ...
            formatter.AppendLine(String.Empty);
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(SR.Webevent_event_thread_information)
            );
        ...
        internal override void GenerateFieldsForMarshal(List<WebEventFieldData> fields)
        {
            ...
            fields.Add(
                new WebEventFieldData(
                    "ThreadID",
                    ThreadInformation.ThreadID.ToString(CultureInfo.InstalledUICulture),
                    WebEventFieldType.Int
                )
            );
            fields.Add(
    ...
    public class WebAuthenticationFailureAuditEvent : WebFailureAuditEvent
    {
        ...
        internal override void FormatToString(WebEventFormatter formatter, bool includeAppInfo)
        {
            ...
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_name_to_authenticate,
                    _nameToAuthenticate
                )
            );
        }
    ...
    public class WebViewStateFailureAuditEvent : WebFailureAuditEvent
    {
        ...
        protected internal WebViewStateFailureAuditEvent(
            ...
            object eventSource,
            int eventCode,
            ViewStateException viewStateException
        )
            : base(message, eventSource, eventCode)
        {
        ...
        internal override void GenerateFieldsForMarshal(List<WebEventFieldData> fields)
        {
            ...
            fields.Add(
                new WebEventFieldData(
                    "RemoteAddress",
                    ViewStateException.RemoteAddress,
                    WebEventFieldType.String
                )
            );
            fields.Add(
            ...
            fields.Add(
                new WebEventFieldData(
                    "PersistedState",
                    ViewStateException.PersistedState,
                    WebEventFieldType.String
                )
            );
            fields.Add(
                new WebEventFieldData("Path", ViewStateException.Path, WebEventFieldType.String)
            );
            fields.Add(
                new WebEventFieldData(
                    "Referer",
                    ViewStateException.Referer,
                    WebEventFieldType.String
                )
            );
        }
        ...
        internal override void FormatToString(WebEventFormatter formatter, bool includeAppInfo)
        {
            ...
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_ViewStateException_information
                )
            );
            formatter.IndentationLevel += 1;
            formatter.AppendLine(
    ...
    public sealed class WebProcessInformation
    {
        ...
        {
            get { return (_accountName != null ? _accountName : String.Empty); }
        }
        ...
        public void FormatToString(WebEventFormatter formatter)
        {
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_process_id,
                    ProcessID.ToString(CultureInfo.InstalledUICulture)
                )
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_process_name,
                    ProcessName
                )
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_account_name,
                    AccountName
                )
            );
        }
    ...
    public sealed class WebApplicationInformation
    {
        ...
        public void FormatToString(WebEventFormatter formatter)
        {
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_application_domain,
                    ApplicationDomain
                )
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_trust_level,
                    TrustLevel
                )
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_application_virtual_path,
                    ApplicationVirtualPath
                )
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_application_path,
                    ApplicationPath
                )
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_machine_name,
                    MachineName
                )
            );
        }
    ...
    public sealed class WebRequestInformation
    {
        ...
        internal WebRequestInformation()
        {
            ...
            if (context != null)
            {
                ...
                if (
                    _iprincipal is WindowsPrincipal
                ...
                )
                {
                    ...
                    if (winIdentity != null)
                    {
                        _iprincipal = new WindowsPrincipal(
        ...
        public void FormatToString(WebEventFormatter formatter)
        {
            ...
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_request_url,
                    RequestUrl
                )
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_request_path,
                    RequestPath
                )
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_user_host_address,
                    UserHostAddress
                )
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(SR.Webevent_event_user, user)
            );

            if (authed)
            {
                formatter.AppendLine(
                    WebBaseEvent.FormatResourceStringWithCache(SR.Webevent_event_is_authenticated)
                );
            }
            else
            {
                formatter.AppendLine(
                    WebBaseEvent.FormatResourceStringWithCache(
                        SR.Webevent_event_is_not_authenticated
                    )
                );
            }
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_authentication_type,
                    authType
                )
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_thread_account_name,
                    ThreadAccountName
                )
            );
        }
    ...
    public class WebProcessStatistics
    {
        ...
        void Update()
        {
            ...
            lock (s_lockObject)
            {
                ...
                s_requestsExecuting = PerfCounters.GetGlobalCounter(
                    GlobalPerfCounter.REQUESTS_CURRENT
                );
                s_requestsQueued = PerfCounters.GetGlobalCounter(GlobalPerfCounter.REQUESTS_QUEUED);
                s_requestsRejected = PerfCounters.GetGlobalCounter(
                    GlobalPerfCounter.REQUESTS_REJECTED
                );
        ...
        public virtual void FormatToString(WebEventFormatter formatter)
        {
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_process_start_time,
                    ProcessStartTime.ToString(CultureInfo.InstalledUICulture)
                )
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_thread_count,
                    ThreadCount.ToString(CultureInfo.InstalledUICulture)
                )
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_working_set,
                    WorkingSet.ToString(CultureInfo.InstalledUICulture)
                )
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_peak_working_set,
                    PeakWorkingSet.ToString(CultureInfo.InstalledUICulture)
                )
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_managed_heap_size,
                    ManagedHeapSize.ToString(CultureInfo.InstalledUICulture)
                )
            );

            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_application_domain_count,
                    AppDomainCount.ToString(CultureInfo.InstalledUICulture)
                )
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_requests_executing,
                    RequestsExecuting.ToString(CultureInfo.InstalledUICulture)
                )
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_request_queued,
                    RequestsQueued.ToString(CultureInfo.InstalledUICulture)
                )
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_request_rejected,
    ...
    public sealed class WebThreadInformation
    {
        ...
        public void FormatToString(WebEventFormatter formatter)
        {
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
                    SR.Webevent_event_thread_id,
                    ThreadID.ToString(CultureInfo.InstalledUICulture)
                )
            );
            formatter.AppendLine(
                WebBaseEvent.FormatResourceStringWithCache(
            ...
            {
                formatter.AppendLine(
                    WebBaseEvent.FormatResourceStringWithCache(SR.Webevent_event_is_impersonating)
                );
            }
            else
            {
                formatter.AppendLine(
                    WebBaseEvent.FormatResourceStringWithCache(
                        SR.Webevent_event_is_not_impersonating
                    )
                );
            }
        ...
        internal bool CheckAndUpdate(WebBaseEvent eventRaised)
        {
            ...
            if (_ruleInfo._customEvaluatorType != null)
            {
                IWebEventCustomEvaluator icustom = (IWebEventCustomEvaluator)
                    manager._sectionHelper._customEvaluatorInstances[
                        _ruleInfo._customEvaluatorType
                    ];
                ...
                catch
                {
                    Debug.Trace(
                        "RuleFiringRecord",
                        "Hit an exception when calling Custom evaluator"
                    );
            ...
            if (timesRaised < _ruleInfo._minInstances)
            {
                Debug.Trace(
                    "RuleFiringRecord",
                    "MinInterval not met; timesRaised="
                        + timesRaised
                        + "; _minInstances="
                        + _ruleInfo._minInstances
                );
                return false;
            }
            ...
            if ((now - _lastFired) <= _ruleInfo._minInterval)
            {
                Debug.Trace(
                    "RuleFiringRecord",
                    "MinInterval not met; now="
                        + now
                        + "; _lastFired="
                        + _lastFired
                        + "; _ruleInfo._minInterval="
                        + _ruleInfo._minInterval
                );
                return false;
            }
    ...
    internal class HealthMonitoringManager
    {
        ...
        {
            get { return s_isCacheDisposed; }
            set { s_isCacheDisposed = value; }
        }
        ...
        internal static void StartHealthMonitoringHeartbeat()
        {
            ...
            if (manager == null)
            {
                Debug.Trace(
                    ...
                    "Can't fire heartbeat because we cannot configure HealthMon"
                );
                return;
            }
            ...
            if (!manager._enabled)
            {
                Debug.Trace("WebEventRaiseDetails", "Can't fire heartbeat because we are disabled");
                return;
            }
...
#endif
            {
                s_heartbeatTimer = new Timer(
                    new TimerCallback(this.HeartbeatCallback),
                    null,
                    TimeSpan.Zero,
                    interval
                );
    ...
    public sealed class WebBaseEventCollection : ReadOnlyCollectionBase
    {
        ...
        {
            get { return (WebBaseEvent)InnerList[index]; }
        }
    ...
    public static class WebEventManager
    {
        ...
        {
            HealthMonitoringSectionHelper.ProviderInstances providers =
                HealthMonitoringManager.ProviderInstances;
            ...
            if (!providers.ContainsKey(providerName))
            {
                throw new ArgumentException(
                    SR.GetString(SR.Health_mon_provider_not_found, providerName)
                );
            }
