...
namespace System.Web
{
    ...
    internal sealed class DynamicModuleRegistry
    {
        ...
        private readonly List<DynamicModuleRegistryEntry> _entries =
            new List<DynamicModuleRegistryEntry>();
        ...
        public void Add(Type moduleType)
        {
            ...
            if (!typeof(IHttpModule).IsAssignableFrom(moduleType))
            {
                string message = String.Format(
                    ...
                    SR.GetString(SR.DynamicModuleRegistry_TypeIsNotIHttpModule),
                    moduleType
                );
            ...
            lock (_lockObj)
            {
                if (_entriesReadonly)
                {
                    ...
                    throw new InvalidOperationException(
                        SR.GetString(SR.DynamicModuleRegistry_ModulesAlreadyInitialized)
                    );
                }

                _entries.Add(
                    new DynamicModuleRegistryEntry(
                        MakeUniqueModuleName(moduleType),
