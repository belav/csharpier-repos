...
namespace System.Web
{
    ...
    internal static class UnsafeNativeMethods
    {
        ...
        */
        ...
        internal static extern int GetFileSecurity(
            string filename,
            int requestedInformation,
            byte[] securityDescriptor,
            int length,
            ref int lengthNeeded
        );
        ...
        */
        ...
        internal static extern void STWNDSendResponse(
            IntPtr tracker,
            StringBuilder status,
            int statusLength,
            StringBuilder headers,
            int headersLength,
            IntPtr unmanagedState
        );
        ...
        */
        ...
        internal static extern int AspCompatProcessRequest(
            AspCompatCallback callback,
            [MarshalAs(UnmanagedType.Interface)] Object context,
            bool sharedActivity,
            int activityHash
        );
        ...
        [DllImport(ModName.ENGINE_FULL_NAME)]
        internal static extern int AspCompatIsApartmentComponent(
            [MarshalAs(UnmanagedType.Interface)] Object obj
        );
#endif // !FEATURE_PAL
        ...
        [DllImport(ModName.ENGINE_FULL_NAME, CharSet = CharSet.Unicode)]
        internal static extern int ChangeAccessToKeyContainer(
        ...
        [DllImport(ModName.ENGINE_FULL_NAME, CharSet = CharSet.Unicode)]
        internal static extern int CookieAuthParseTicket(
            byte[] pData,
            int iDataLen,
            StringBuilder szName,
            int iNameLen,
        ...
        [DllImport(ModName.ENGINE_FULL_NAME, CharSet = CharSet.Unicode)]
        internal static extern int CookieAuthConstructTicket(
            byte[] pData,
            int iDataLen,
            string szName,
            string szData,
        ...
        [DllImport(ModName.ENGINE_FULL_NAME, CharSet = CharSet.Unicode)]
        internal static extern IntPtr CreateUserToken(
            string name,
            string password,
            int fImpersonationToken,
        ...
        [DllImport(ModName.ENGINE_FULL_NAME, CharSet = CharSet.Unicode)]
        internal static extern int DirMonOpen(
            string dir,
            string appId,
            bool watchSubtree,
            uint notifyFilter,
            int fcnMode,
            NativeFileChangeNotification callback,
            out IntPtr pCompletion
        );
        ...
        [DllImport(ModName.ENGINE_FULL_NAME)]
        internal static extern int EcbGetBasics(
            IntPtr pECB,
            byte[] buffer,
            int size,
            int[] contentInfo
        ...
        internal static extern int EcbGetServerVariable(
            IntPtr pECB,
            string name,
            byte[] buffer,
            int size
        ...
        [DllImport(ModName.ENGINE_FULL_NAME)]
        internal static extern int EcbGetServerVariableByIndex(
            IntPtr pECB,
            int nameIndex,
            byte[] buffer,
            int size
        ...
        [DllImport(ModName.ENGINE_FULL_NAME, CharSet = CharSet.Ansi, BestFitMapping = false)]
        internal static extern int EcbGetQueryString(
            IntPtr pECB,
            int encode,
        ...
        [DllImport(ModName.ENGINE_FULL_NAME, CharSet = CharSet.Ansi, BestFitMapping = false)]
        internal static extern int EcbGetUnicodeServerVariable(
            IntPtr pECB,
            string name,
            IntPtr buffer,
            int size
        ...
        [DllImport(ModName.ENGINE_FULL_NAME)]
        internal static extern int EcbGetUnicodeServerVariableByIndex(
            IntPtr pECB,
            int nameIndex,
            IntPtr buffer,
            int size
        ...
        [DllImport(ModName.ENGINE_FULL_NAME)]
        internal static extern int EcbGetUnicodeServerVariables(
            IntPtr pECB,
            IntPtr buffer,
            int bufferSizeInChars,
            int[] serverVarLengths,
            int serverVarCount,
            int startIndex,
        ...
        [DllImport(ModName.ENGINE_FULL_NAME)]
        internal static extern int EcbGetPreloadedPostedContent(
            IntPtr pECB,
            byte[] bytes,
            int offset,
            int bufferSize
        ...
        [DllImport(ModName.ENGINE_FULL_NAME)]
        internal static extern int EcbGetAdditionalPostedContent(
            IntPtr pECB,
            byte[] bytes,
            int offset,
            int bufferSize
        ...
        [DllImport(ModName.ENGINE_FULL_NAME)]
        internal static extern int EcbReadClientAsync(
            IntPtr pECB,
            int dwBytesToRead,
            AsyncCompletionCallback pfnCallback
        );

#if !FEATURE_PAL

        [DllImport(ModName.ENGINE_FULL_NAME)]
        internal static extern int EcbFlushCore(
            IntPtr pECB,
            byte[] status,
            byte[] header,
            int keepConnected,
        ...
        [DllImport(ModName.ENGINE_FULL_NAME, CharSet = CharSet.Ansi, BestFitMapping = false)]
        internal static extern int EcbMapUrlToPath(
            IntPtr pECB,
            string url,
            byte[] buffer,
            int size
        ...
        [DllImport(ModName.ENGINE_FULL_NAME, CharSet = CharSet.Unicode)]
        internal static extern int EcbExecuteUrlUnicode(
            IntPtr pECB,
            string url,
            string method,
            string childHeaders,
        ...
        [DllImport(ModName.ENGINE_FULL_NAME, CharSet = CharSet.Unicode)]
        internal static extern int GetGroupsForUser(
            IntPtr token,
            StringBuilder allGroups,
            int allGrpSize,
            StringBuilder error,
            int errorSize
        );
        ...
        [DllImport(ModName.ENGINE_FULL_NAME)]
        internal static extern int GetHMACSHA1Hash(
            byte[] data1,
            int dataOffset1,
            int dataSize1,
            byte[] data2,
        ...
        [DllImport(ModName.ENGINE_FULL_NAME)]
        internal static extern int GetProcessMemoryInformation(
            uint pid,
            out uint privatePageCount,
            out uint peakPagefileUsage,
            bool nocache
        );
#else // !FEATURE_PAL
        internal static int GetProcessMemoryInformation(
            uint pid,
            out uint privatePageCount,
            out uint peakPagefileUsage,
            bool nocache
        ...
        [DllImport(ModName.ENGINE_FULL_NAME)]
        internal static extern int GetSHA1Hash(
            byte[] data,
            int dataSize,
            byte[] hash,
            int hashSize
        ...
        [SuppressMessage(
            ...
            Justification = "This isn't a dangerous method."
        )]
        internal static extern void SetClrThreadPoolLimits(
        ...
        internal static extern void SetMinRequestsExecutingToDetectDeadlock(
            int minRequestsExecutingToDetectDeadlock
        );
        ...
        [DllImport(ModName.ENGINE_FULL_NAME)]
        internal static extern void InitializeHealthMonitor(
            int deadlockIntervalSeconds,
            int requestQueueLimit
        );

        [DllImport(ModName.ENGINE_FULL_NAME)]
        internal static extern int IsAccessToFileAllowed(
            IntPtr securityDesciptor,
            IntPtr iThreadToken,
            int iAccess
        );

        [DllImport(ModName.ENGINE_FULL_NAME, CharSet = CharSet.Unicode)]
        internal static extern int IsUserInRole(
            IntPtr token,
            string rolename,
            StringBuilder error,
            int errorSize
        ...
        [DllImport(ModName.ENGINE_FULL_NAME, CharSet = CharSet.Unicode, BestFitMapping = false)]
        internal static extern int GetCredentialFromRegistry(
            String strRegKey,
            StringBuilder buffer,
            int size
        );
        ...
        internal static extern int EcbGetChannelBindingToken(
            IntPtr pECB,
            out IntPtr token,
            out int tokenSize
        );
        ...
        [DllImport(ModName.ENGINE_FULL_NAME)]
        internal static extern int EcbCallISAPI(
            IntPtr pECB,
        ...
        [DllImport(ModName.ENGINE_FULL_NAME, CharSet = CharSet.Unicode)]
        internal static extern int PassportCreate(
            string szQueryStrT,
            string szQueryStrP,
            string szAuthCookie,
            string szProfCookie,
        ...
        [DllImport(ModName.ENGINE_FULL_NAME, CharSet = CharSet.Unicode, BestFitMapping = false)]
        internal static extern int IsapiAppHostMapPath(
            String appId,
            String virtualPath,
            StringBuilder buffer,
            int size
        ...
        [DllImport(ModName.ENGINE_FULL_NAME, CharSet = CharSet.Unicode, BestFitMapping = false)]
        internal static extern int IsapiAppHostGetAppPath(
            String aboPath,
            StringBuilder buffer,
            int size
        );
        ...
        [DllImport(ModName.ENGINE_FULL_NAME, CharSet = CharSet.Unicode, BestFitMapping = false)]
        internal static extern int IsapiAppHostGetUncUser(
            String appId,
        ...
        [DllImport(ModName.ENGINE_FULL_NAME, CharSet = CharSet.Unicode, BestFitMapping = false)]
        internal static extern int IsapiAppHostGetSiteName(
            String appId,
            StringBuilder buffer,
            int size
        );
        ...
        [DllImport(ModName.ENGINE_FULL_NAME, CharSet = CharSet.Unicode, BestFitMapping = false)]
        internal static extern int IsapiAppHostGetSiteId(
            String site,
            StringBuilder buffer,
            int size
        );
        ...
        [DllImport(ModName.ENGINE_FULL_NAME, CharSet = CharSet.Unicode, BestFitMapping = false)]
        internal static extern int IsapiAppHostGetNextVirtualSubdir(
            String aboPath,
            bool inApp,
            ref int index,
            StringBuilder sb,
        ...
        */
        ...
        internal static extern int PMGetHistoryTable(
            int iRows,
            int[] dwPIDArr,
            int[] dwReqExecuted,
            int[] dwReqPending,
        ...
        internal static extern int PMGetCurrentProcessInfo(
            ref int dwReqExecuted,
        ...
        internal static extern int PMGetBasics(
            IntPtr pMsg,
            byte[] buffer,
            int size,
            int[] contentInfo
        ...
        internal static extern int PMGetClientCertificate(
            IntPtr pMsg,
            byte[] buffer,
            int size,
            int[] pInts,
        ...
        [DllImport(
            ModName.WP_FULL_NAME,
            EntryPoint = "PMGetQueryString",
            CharSet = CharSet.Ansi,
            BestFitMapping = false
        )]
        internal static extern int PMGetQueryString(
            IntPtr pMsg,
            int encode,
            StringBuilder buffer,
            int size
        ...
        internal static extern int PMGetPreloadedPostedContent(
            IntPtr pMsg,
            byte[] bytes,
            int offset,
            int bufferSize
        ...
        internal static extern int PMGetAdditionalPostedContent(
            IntPtr pMsg,
            byte[] bytes,
            int offset,
            int bufferSize
        ...
        [DllImport(
            ModName.WP_FULL_NAME,
            EntryPoint = "PMAppendLogParameter",
            CharSet = CharSet.Ansi,
            BestFitMapping = false
        )]
        ...
        internal static extern int PMFlushCore(
            IntPtr pMsg,
            byte[] status,
            byte[] header,
            int keepConnected,
        ...
        [DllImport(ModName.WP_FULL_NAME)]
        internal static extern int PMCallISAPI(
            IntPtr pECB,
            UnsafeNativeMethods.CallISAPIFunc iFunction,
            byte[] bufferIn,
            int sizeIn,
        ...
        [DllImport(ModName.ENGINE_FULL_NAME)]
        internal static extern void PerfIncrementCounterEx(
            IntPtr pCounters,
            int number,
            int increment
        );
        ...
        [DllImport(ModName.ENGINE_FULL_NAME, CharSet = CharSet.Unicode)]
        internal static extern void TraceRaiseEventMgdHandler(
            int eventType,
        ...
        [DllImport(ModName.ENGINE_FULL_NAME, CharSet = CharSet.Unicode)]
        internal static extern void TraceRaiseEventWithEcb(
            int eventType,
            IntPtr ecb,
            string data1,
            string data2,
        ...
        internal static extern void PMTraceRaiseEvent(
            int eventType,
            IntPtr pMsg,
            string data1,
            string data2,
        ...
        internal static extern int TransactManagedCallback(
            TransactedExecCallback callback,
            int mode
        );
        ...
        */
        ...
        [DllImport(ModName.ENGINE_FULL_NAME, CharSet = CharSet.Unicode)]
        internal static extern int DoesKeyContainerExist(
            string containerName,
            string provider,
            int useMachineContainer
        );
        ...
        internal static extern int CoCreateInstanceEx(
            ...
            IntPtr pUnkOuter,
            int dwClsContext,
            [In, Out] COSERVERINFO srv,
            int num,
            [In, Out] MULTI_QI[] amqi
        );
        ...
        internal static extern int CoCreateInstanceEx(
            ...
            IntPtr pUnkOuter,
            int dwClsContext,
            [In, Out] COSERVERINFO_X64 srv,
            int num,
            [In, Out] MULTI_QI_X64[] amqi
        );
