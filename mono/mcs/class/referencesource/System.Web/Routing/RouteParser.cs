namespace System.Web.Routing
{
    ...
    internal static class RouteParser
    {
        ...
        public static ParsedRoute Parse(string routeUrl)
        {
            ...
            Debug.Assert(
                urlParts.Count == pathSegments.Count,
        ...
        private static IList<PathSubsegment> ParseUrlSegment(
            string segment,
        ...
        private static Exception ValidateUrlParts(IList<string> pathSegments)
        {
            Debug.Assert(
                pathSegments != null,
                "The value should always come from SplitUrl(), and that function should never return null."
            );
            ...
            foreach (string pathSegment in pathSegments)
            {
                ...
                else
                {
                    ...
                    {
                        return new ArgumentException(
                            SR.GetString(SR.Route_CannotHaveConsecutiveSeparators),
                            "routeUrl"
                        );
                    }
                    Debug.Assert(
