namespace System.Web.Routing
{
    ...
    public class RouteCollection : Collection<RouteBase>
    {
        ...
        [SuppressMessage(
            ...
            Justification = "Not worth a breaking change."
        )]
        ...
        private RequestContext GetRequestContext(RequestContext requestContext)
        {
            ...
            if (httpContext == null)
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.RouteCollection_RequiresContext)
                );
            }
        ...
        private bool IsRouteToExistingFile(HttpContextBase httpContext)
        {
            ...
            return (
                (requestPath != "~/")
                && (VPP != null)
                && (VPP.FileExists(requestPath) || VPP.DirectoryExists(requestPath))
            );
        }
        ...
        public RouteData GetRouteData(HttpContextBase httpContext)
        {
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.RouteTable_ContextMissingRequest),
                    "httpContext"
                );
            }
        ...
        [SuppressMessage(
            ...
            MessageId = "System.String.EndsWith(System.String)",
            Justification = @"okay"
        )]
