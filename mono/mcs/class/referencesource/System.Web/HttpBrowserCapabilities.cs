...
/// <devdoc>
///    <para>Returns the name of the client browser and its major version number. For example,
...
string message = SR.GetString(SR.Invalid_string_from_browser_caps, e.Message, capsKey,
this[capsKey]);
...
else if (string.Compare(tagWriter, typeof(System.Web.UI.HtmlTextWriter).FullName, false,
...
/// </devdoc>
[Obsolete("Use EcmaScriptVersion instead of Javascript.  Major versions greater than or equal to one
imply javascript support.")]
...
/// <devdoc>
///    <para>Indicates whether the client browser supports Channel Definition Format (CDF) for
webcasting.</para>
/// </devdoc>
public bool CDF {
get {
