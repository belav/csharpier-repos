    ...
    public static class VirtualPathUtility
    {
        ...
        public static bool IsAbsolute(string virtualPath)
        {
            ...
            return !virtualPathObject.IsRelative
                && virtualPathObject.VirtualPathStringIfAvailable != null;
        }
        ...
        public static string ToAppRelative(string virtualPath, string applicationPath)
        {
            ...
            return UrlPath.MakeVirtualPathAppRelative(
                virtualPathObject.VirtualPathString,
        ...
        public static string ToAbsolute(string virtualPath, string applicationPath)
        {
            ...
            return UrlPath.MakeVirtualPathAppAbsolute(
                virtualPathObject.AppRelativeVirtualPathString,
                appVirtualPath.VirtualPathString
            );
        }
        ...
        public static string Combine(string basePath, string relativePath)
        {
            VirtualPath virtualPath = VirtualPath.Combine(
                VirtualPath.CreateNonRelative(basePath),
