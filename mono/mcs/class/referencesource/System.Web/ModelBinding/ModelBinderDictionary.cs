namespace System.Web.ModelBinding
{
    ...
    public class ModelBinderDictionary : IDictionary<Type, IModelBinder>
    {
        ...
        [SuppressMessage(
            ...
            MessageId = "_innerDictionary",
            Justification = "Chances of using model binders for com interop types is pretty low."
        )]
            ...
            binder = ModelBinders.GetBinderFromAttributes(
                ...
                () =>
                    String.Format(
                        ...
                        SR.GetString(SR.ModelBinderDictionary_MultipleAttributes),
                        modelType.FullName
                    )
            );
