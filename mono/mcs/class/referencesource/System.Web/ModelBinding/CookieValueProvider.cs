namespace System.Web.ModelBinding
{
    ...
    public sealed class CookieValueProvider : IValueProvider, IUnvalidatedValueProvider
    {
        ...
        internal CookieValueProvider(
            ModelBindingExecutionContext modelBindingExecutionContext,
            UnvalidatedRequestValuesBase unvalidatedValues
        )
            : this(
                modelBindingExecutionContext.HttpContext.Request.Cookies,
                unvalidatedValues.Cookies,
                CultureInfo.CurrentCulture
            ) { }

        internal CookieValueProvider(
            HttpCookieCollection collection,
            HttpCookieCollection unvalidatedCollection,
            CultureInfo culture
        )
        {
            if (collection == null)
        ...
        private sealed class ValueProviderResultPlaceholder
        {
            ...
            private static ValueProviderResult GetResultFromCollection(
                string key,
                CookieValueProvider valueProvider,
