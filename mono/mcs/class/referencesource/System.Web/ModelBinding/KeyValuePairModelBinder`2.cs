namespace System.Web.ModelBinding
{
    ...
    public sealed class KeyValuePairModelBinder<TKey, TValue> : IModelBinder
    {
        ...
        )
        {
            ...
            TKey key;
            bool keyBindingSucceeded = KeyValuePairModelBinderUtil.TryBindStrongModel<TKey>(
            ...
            TValue value;
            bool valueBindingSucceeded = KeyValuePairModelBinderUtil.TryBindStrongModel<TValue>(
                modelBindingExecutionContext,
                bindingContext,
                "value",
                MetadataProvider,
