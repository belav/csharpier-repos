namespace System.Web.ModelBinding
{
    ...
    public class MutableObjectModelBinder : IModelBinder
    {
        ...
        )
        {
            ...
            ComplexModel complexModel = CreateAndPopulateComplexModel(
                modelBindingExecutionContext,
                bindingContext,
                propertyMetadatas
            );
        ...
        private ComplexModel CreateAndPopulateComplexModel(
            ModelBindingExecutionContext modelBindingExecutionContext,
            ModelBindingContext bindingContext,
        ...
        )
        {
            ...
            ComplexModel originalComplexModel = new ComplexModel(
        ...
        )
        {
            ...
            {
                bindingContext.ModelMetadata.Model = CreateModel(
                    modelBindingExecutionContext,
                    bindingContext
                );
            }
        ...
        internal void ProcessComplexModel(
            ModelBindingExecutionContext modelBindingExecutionContext,
            ModelBindingContext bindingContext,
        ...
        )
        {
            ...
            missingRequiredProperties.ExceptWith(
                complexModel.Results.Select(r => r.Key.PropertyName)
            );
        ...
        )
        {
            ...
            else
            {
                ...
                if (bindingContext.ModelState.IsValidField(modelStateKey))
                {
                    complexModelResult.ValidationNode.Validated += CreateNullCheckFailedHandler(
                        modelBindingExecutionContext,
                        propertyMetadata,
                        value
                    );
