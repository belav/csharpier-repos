namespace System.Web.ModelBinding
{
    ...
    public class DataAnnotationsModelValidatorProvider : AssociatedValidatorProvider
    {
            ...
            if (constructor == null)
            {
                throw new ArgumentException(
                    String.Format(
                        ...
                        SR.GetString(
                            SR.DataAnnotationsModelValidatorProvider_ConstructorRequirements
                        ),
        ...
        [SuppressMessage(
            "Microsoft.Usage",
            "CA2301:EmbeddableTypesInContainersRule",
            MessageId = "ValidatableFactories",
            Justification = "The types that go into this dictionary are specifically those which implement IValidatableObject."
        )]
            ...
            if (constructor == null)
            {
                throw new ArgumentException(
                    String.Format(
                        CultureInfo.CurrentCulture,
                        SR.GetString(
                            SR.DataAnnotationsModelValidatorProvider_ValidatableConstructorRequirements
                        ),
                        adapterType.FullName,
                        typeof(ModelMetadata).FullName,
                        typeof(ModelBindingExecutionContext).FullName
