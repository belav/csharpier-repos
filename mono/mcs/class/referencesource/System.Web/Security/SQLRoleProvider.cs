    ...
    public class SqlRoleProvider : RoleProvider
    {
            ...
            try
            {
                ...
                try
                {
                    ...
                    switch (returnValue)
                    {
                        ...
                        case 1:
                            throw new ProviderException(
                                SR.GetString(SR.Provider_role_already_exists, roleName)
                            );
            ...
            try
            {
                ...
                try
                {
                    ...
                    while (numUsersRemaing > 0)
                    {
                        ...
                        numUsersRemaing--;
                        for (
                            iter = usernames.Length - numUsersRemaing;
                        ...
                        while (numRolesRemaining > 0)
                        {
                            ...
                            numRolesRemaining--;
                            for (
                                iter = roleNames.Length - numRolesRemaining;
                                iter < roleNames.Length;
                                iter++
                            )
                            {
                            ...
                            {
                                (
                                    new SqlCommand("BEGIN TRANSACTION", holder.Connection)
                                ).ExecuteNonQuery();
                ...
                catch
                {
                    if (beginTranCalled)
                    {
                        ...
                        {
                            (
                                new SqlCommand("ROLLBACK TRANSACTION", holder.Connection)
                            ).ExecuteNonQuery();
                        }
                        catch { }
                        beginTranCalled = false;
        ...
        private void AddUsersToRolesCore(SqlConnection conn, string usernames, string roleNames)
        {
            ...
            switch (GetReturnValue(cmd))
            {
                ...
                case 3:
                    throw new ProviderException(
                        SR.GetString(SR.Provider_this_user_already_in_role, s1, s2)
                    );
            }
            throw new ProviderException(SR.GetString(SR.Provider_unknown_failure));
        }
        ...
        )
        {
            ...
            switch (GetReturnValue(cmd))
            {
                ...
                case 3:
                    throw new ProviderException(
                        SR.GetString(SR.Provider_this_user_already_not_in_role, s1, s2)
                    );
            }
            throw new ProviderException(SR.GetString(SR.Provider_unknown_failure));
        }
                ...
                try
                {
                    ...
                    if (sc.Count < 1)
                    {
                        switch (GetReturnValue(cmd))
                        {
                            ...
                            case 1:
                                throw new ProviderException(
                                    SR.GetString(SR.Provider_role_not_found, roleName)
                                );
                        }
                        throw new ProviderException(SR.GetString(SR.Provider_unknown_failure));
                    }
                ...
                try
                {
                    ...
                    if (sc.Count < 1)
                    {
                        switch (GetReturnValue(cmd))
                        {
                            ...
                            default:
                                throw new ProviderException(
                                    SR.GetString(SR.Provider_unknown_failure)
                                );
                        }
                    }
                    String[] strReturn = new String[sc.Count];
