...
namespace System.Web.Security
{
    ...
    public class SqlMembershipProvider : MembershipProvider
    {
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            _PasswordAttemptWindow = SecUtility.GetIntValue(
                config,
            ...
            _MinRequiredPasswordLength = SecUtility.GetIntValue(
                config,
            ...
            _MinRequiredNonalphanumericCharacters = SecUtility.GetIntValue(
                config,
            ...
            _passwordStrengthRegexTimeout = SecUtility.GetNullableIntValue(
                config,
            ...
            if (PasswordFormat == MembershipPasswordFormat.Hashed && EnablePasswordRetrieval)
                throw new ProviderException(
                    SR.GetString(SR.Provider_can_not_retrieve_hashed_password)
                );
            //if (_PasswordFormat == MembershipPasswordFormat.Encrypted &&
            // MachineKeySection.IsDecryptionKeyAutogenerated)
            //    throw new
            // ProviderException(SR.GetString(SR.Can_not_use_encrypted_passwords_with_autogen_keys));
        ...
        )
        {
            ...
            if (!string.IsNullOrEmpty(passwordAnswer))
            {
                ...
                encodedPasswordAnswer = EncodePassword(
        ...
        public override string GetPassword(string username, string passwordAnswer)
        {
            if (!EnablePasswordRetrieval)
            {
                throw new NotSupportedException(
                    SR.GetString(SR.Membership_PasswordRetrieval_not_supported)
                );
            }
        ...
        public override bool ChangePassword(string username, string oldPassword, string newPassword)
        {
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.Membership_password_too_long),
                    "newPassword"
                );
            }
        ...
        public override string ResetPassword(string username, string passwordAnswer)
        {
            ...
            GetPasswordWithFormat(
                ...
                out failedPasswordAnswerAttemptCount,
                out isApproved,
                out lastLoginDate,
        ...
        public override MembershipUser GetUser(object providerUserKey, bool userIsOnline)
        {
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.Membership_InvalidProviderUserKey),
                    "providerUserKey"
                );
            }
        ...
        private string UnEncodePassword(string pass, int passwordFormat)
        {
            switch (passwordFormat)
            {
                ...
                case 1: // MembershipPasswordFormat.Hashed:
                    throw new ProviderException(
                        SR.GetString(SR.Provider_can_not_decode_hashed_password)
                    );
                default:
        ...
        private HashAlgorithm GetHashAlgorithm()
        {
            ...
            if (
                _LegacyPasswordCompatibilityMode == MembershipPasswordCompatibilityMode.Framework20
