...
namespace System.Web.Security.AntiXss.CodeCharts
{
    ...
    internal static class Lower
    {
        ...
        {
            return CodeChartHelper.GetRange(0x0370, 0x03FF, i =>
                (
                    i == 0x378
                    || i == 0x379
                    || (i >= 0x37F && i <= 0x383)
        ...
        {
            return CodeChartHelper.GetRange(0x0531, 0x058A, i =>
                (i == 0x0557 || i == 0x0558 || i == 0x0560 || i == 0x0588)
            );
        }
        ...
        {
            return CodeChartHelper.GetRange(0x0591, 0x05F4, i =>
                ((i >= 0x05C8 && i <= 0x05CF) || (i >= 0x05EB && i <= 0x05EF))
            );
        }
        ...
        {
            return CodeChartHelper.GetRange(0x0600, 0x06FF, i =>
                (
                    i == 0x0604
                    || i == 0x0605
                    || i == 0x061C
        ...
        {
            return CodeChartHelper.GetRange(0x0700, 0x074F, i =>
                (i == 0x070E || i == 0x074B || i == 0x074C)
            );
        }
        ...
        {
            return CodeChartHelper.GetRange(0x0900, 0x097F, i =>
                (
                    i == 0x093A
                    || i == 0x093B
                    || i == 0x094F
        ...
        {
            return CodeChartHelper.GetRange(0x0981, 0x09FB, i =>
                (
                    i == 0x0984
                    || i == 0x098D
                    || i == 0x098E
        ...
        {
            return CodeChartHelper.GetRange(0x0A01, 0x0A75, i =>
                (
                    i == 0x0A04
                    || (i >= 0x0A0B && i <= 0x0A0E)
                    || i == 0x0A11
        ...
        {
            return CodeChartHelper.GetRange(0x0A81, 0x0AF1, i =>
                (
                    i == 0x0A84
                    || i == 0x0A8E
                    || i == 0x0A92
        ...
        {
            return CodeChartHelper.GetRange(0x0B01, 0x0B71, i =>
                (
                    i == 0x0B04
                    || i == 0x0B0D
                    || i == 0x0B0E
        ...
        {
            return CodeChartHelper.GetRange(0x0B82, 0x0BFA, i =>
                (
                    i == 0x0B84
                    || i == 0x0B8B
                    || i == 0x0B8C
        ...
        {
            return CodeChartHelper.GetRange(0x0C01, 0x0C7F, i =>
                (
                    i == 0x0C04
                    || i == 0x0C0D
                    || i == 0x0C11
        ...
        {
            return CodeChartHelper.GetRange(0x0C82, 0x0CF2, i =>
                (
                    i == 0x0C84
                    || i == 0x0C8D
                    || i == 0x0C91
        ...
        {
            return CodeChartHelper.GetRange(0x0D02, 0x0D7F, i =>
                (
                    i == 0x0D04
                    || i == 0x0D0D
                    || i == 0x0D11
        ...
        {
            return CodeChartHelper.GetRange(0x0D82, 0x0DF4, i =>
                (
                    i == 0x0D84
                    || i == 0x0D97
                    || i == 0X0D98
        ...
        {
            return CodeChartHelper.GetRange(0x0E81, 0x0EDD, i =>
                (
                    i == 0x0E83
                    || i == 0x0E85
                    || i == 0x0E86
        ...
        {
            return CodeChartHelper.GetRange(0x0F00, 0x0FD8, i =>
                (
                    i == 0x0F48
                    || (i >= 0x0F6D && i <= 0x0F70)
                    || (i >= 0x0F8C && i <= 0x0F8F)
