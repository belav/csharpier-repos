...
namespace System.Web.Security.Cryptography
{
    ...
    internal sealed class MachineKeyMasterKeyProvider : IMasterKeyProvider
    {
        ...
        private const string AUTOGEN_KEYDERIVATION_ISOLATEBYAPPID_SPECIFICPURPOSE =
            "IsolateByAppId";
        ...
        internal MachineKeyMasterKeyProvider(
            ...
            CryptographicKey autogenKeys = null,
        ...
        private static void AddSpecificPurposeString(
            IList<string> specificPurposes,
            string key,
            string value
        )
        {
        ...
        // subkey derivation.
        private CryptographicKey GenerateCryptographicKey(
            string configAttributeName,
            string configAttributeValue,
            int autogenKeyOffset,
            int autogenKeyCount,
            string errorResourceString
        )
        {
            ...
            CryptographicKey keyDerivationKey = AutogenKeys.ExtractBits(
                autogenKeyOffset,
                autogenKeyCount
            );
            ...
            if (isolateApps)
            {
                ...
                AddSpecificPurposeString(
                    specificPurposes,
                    AUTOGEN_KEYDERIVATION_ISOLATEAPPS_SPECIFICPURPOSE,
                    ApplicationName
                );
            }
            ...
            if (isolateByAppId)
            {
                ...
                AddSpecificPurposeString(
                    specificPurposes,
                    AUTOGEN_KEYDERIVATION_ISOLATEBYAPPID_SPECIFICPURPOSE,
                    ApplicationId
                );
            }
            ...
            Purpose purpose = new Purpose(
                AUTOGEN_KEYDERIVATION_PRIMARYPURPOSE,
