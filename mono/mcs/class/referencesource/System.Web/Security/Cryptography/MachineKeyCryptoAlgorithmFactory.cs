...
#pragma warning restore 618
        ...
        private Func<TResult> GetGenericAlgorithmFactory<TResult>(
            string configAttributeName,
            string configAttributeValue,
            Func<string, Func<TResult>> switchStatement,
            ...
            where TResult : class, IDisposable
        {
            ...
            if (
                ...
                && configAttributeValue.StartsWith("alg:", StringComparison.Ordinal)
            )
            {
