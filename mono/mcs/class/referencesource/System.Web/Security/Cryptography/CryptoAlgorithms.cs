...
namespace System.Web.Security.Cryptography
{
    ...
    internal static class CryptoAlgorithms
    {
        ...
        [SuppressMessage(
            ...
            Justification = @"This is only used by legacy code; new features do not use this algorithm."
        )]
        [Obsolete(
            "DES is deprecated and MUST NOT be used by new features. Consider using AES instead."
        )]
        ...
        [Obsolete(
            "MD5 is deprecated and MUST NOT be used by new features. Consider using a SHA-2 algorithm instead."
        )]
        ...
        [Obsolete(
            "SHA1 is deprecated and MUST NOT be used by new features. Consider using a SHA-2 algorithm instead."
        )]
        ...
        [Obsolete(
            "3DES is deprecated and MUST NOT be used by new features. Consider using AES instead."
        )]
