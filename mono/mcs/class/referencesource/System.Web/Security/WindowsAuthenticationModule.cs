...
namespace System.Web.Security
{
    ...
    public sealed class WindowsAuthenticationModule : IHttpModule
    {
        ...
        internal static readonly WindowsPrincipal AnonymousPrincipal = new WindowsPrincipal(
            AnonymousIdentity
        );
        ...
        void OnEnter(Object source, EventArgs eventArgs)
        {
            ...
            else
            {
                ...
                if (
                    strLogonUser.Length == 0
                    && (
                        strAuthType.Length == 0 || StringUtil.EqualsIgnoreCase(strAuthType, "basic")
                    )
                )
                {
                    ////////////////////////////////////////////////////////
