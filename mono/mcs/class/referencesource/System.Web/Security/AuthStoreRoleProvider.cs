...
namespace System.Web.Security
{
    ...
    public class AuthorizationStoreRoleProvider : RoleProvider
    {
        ...
        public override void Initialize(string name, NameValueCollection config)
        {
            ...
            _CacheRefreshInterval = SecUtility.GetIntValue(
                config,
            ...
            if (connObj == null)
                throw new ProviderException(
                    SR.GetString(SR.Connection_string_not_found, _ConnectionString)
                );
        ...
        public override void CreateRole(string roleName)
        {
            HttpRuntime.CheckAspNetHostingPermission(
                ...
                SR.API_not_supported_at_this_level
            );
            SecUtility.CheckParameter(ref roleName, true, true, true, 0, "roleName");
            InitApp();
            ...
            args[0] = roleName;
            args[1] = null;
            object role = CallMethod(
                _ObjAzScope != null ? _ObjAzScope : _ObjAzApplication,
                "CreateRole",
                args
            );
            args[0] = 0;
        ...
        {
            InitApp();
            object objAllRoles = CallProperty(
                _ObjAzScope != null ? _ObjAzScope : _ObjAzApplication,
                "Roles",
                null
            );
                    ...
                    lock (this)
                    {
                        ...
                        if (
                            _ConnectionString
                                ...
                                .StartsWith("msxml://", StringComparison.Ordinal)
                        )
                        {
                            ...
                            string fileName = _ConnectionString
                                .Substring("msxml://".Length)
                                .Replace('/', '\\');
                            ...
                            if (!FileUtil.FileExists(fileName))
                            {
                                throw new FileNotFoundException(
                                    SR.GetString(
                                        SR.AuthStore_policy_file_not_found,
                        ...
                        try
                        {
                            ...
                            typeAzAuthorizationStoreClass = Type.GetType(
                        ...
                        catch (FileNotFoundException e)
                        {
                            ...
                            {
                                throw new ProviderException(
                                    SR.GetString(SR.AuthStoreNotInstalled_Title),
                                    e
                                );
                            }
                        ...
                        _ObjAzAuthorizationStoreClass = Activator.CreateInstance(
                            typeAzAuthorizationStoreClass
                        );
                        ...
                        if (_ObjAzApplication == null)
                            throw new ProviderException(
                                SR.GetString(SR.AuthStore_Application_not_found)
                            );
                        _ObjAzScope = null;
                        if (!string.IsNullOrEmpty(_ScopeName))
                        {
                            ...
                            if (_ObjAzScope == null)
                                throw new ProviderException(
                                    SR.GetString(SR.AuthStore_Scope_not_found)
                                );
                        }
                        _LastUpdateCacheDate = DateTime.Now;
                        _InitAppDone = true;
        ...
        private IntPtr GetWindowsTokenWithAssert(string userName)
        {
            ...
            if (
                user != null
                && user.Identity != null
                && user.Identity is WindowsIdentity
        ...
        private bool IsUserInRoleCore(string username, string roleName)
        {
            ...
            if (objClientContext == null)
                return false;
            object objAllRoles = CallMethod(
                objClientContext,
                "GetRoles",
                new object[] { _ScopeName }
            );
            ...
            try
            {
                ...
                try
                {
                    ...
                    foreach (object objRoleName in allRoles)
                    {
                        ...
                        if (
                            strRoleName != null
                            && StringUtil.EqualsIgnoreCase(strRoleName, roleName)
                        )
                            return true;
                    }
                    return false;
    ...
    internal sealed class AuthStoreErrorFormatter : ErrorFormatter
    {
        ...
        {
            get { return SR.GetString(SR.AuthStoreNotInstalled_Title); }
        }

        protected override string Description
        {
            get { return SR.GetString(SR.AuthStoreNotInstalled_Description); }
        }
