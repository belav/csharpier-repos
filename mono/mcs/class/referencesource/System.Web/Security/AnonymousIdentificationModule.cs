...
namespace System.Web.Security
{
    ...
    public sealed class AnonymousIdentificationModule : IHttpModule
    {
        ...
        public static void ClearAnonymousIdentifier()
        {
            ...
            if (
                !CookielessHelperClass.UseCookieless(context, false, s_CookieMode)
        ...
        private void OnEnter(Object source, EventArgs eventArgs)
        {
            ...
            if (context.Request.AnonymousID == null)
            {
                ...
                {
                    context.Request.AnonymousID = Guid.NewGuid()
            ...
            if (createCookie)
            {
                ...
                encValue = GetEncodedValue(
                    new AnonymousIdData(context.Request.AnonymousID, dtExpireTime)
                );
        ...
        private static void Initialize()
        {
            ...
            lock (s_InitLock)
            {
                ...
                AnonymousIdentificationSection settings = RuntimeConfig
                    .GetAppConfig()
        ...
        private static string GetEncodedValue(AnonymousIdData data)
        {
            ...
            return CookieProtectionHelper.Encode(
                s_Protection,
                buffer,
                Purpose.AnonymousIdentificationModule_Ticket
            );
        }
        ...
        private static AnonymousIdData GetDecodedValue(string data)
        {
            ...
            try
            {
                byte[] bBlob = CookieProtectionHelper.Decode(
                    s_Protection,
                    data,
                    Purpose.AnonymousIdentificationModule_Ticket
                );
