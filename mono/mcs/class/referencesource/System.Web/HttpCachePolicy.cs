...
namespace System.Web
{
    ...
    sealed class HttpCachePolicySettings
    {
        ...
        private void OnSerializingMethod(StreamingContext context)
        {
            ...
            {
                Debug.Assert(
                    _validationCallbackInfo[i].data == null,
                    "_validationCallbackInfo[i].data == null"
                );
        ...
        private void OnDeserializedMethod(StreamingContext context)
        {
            ...
            ValidationCallbackInfo[] callbackInfos = new ValidationCallbackInfo[
                _validationCallbackInfoForSerialization.Length / 2
            ];
            for (int i = 0; i < _validationCallbackInfoForSerialization.Length; i += 2)
            {
                ...
                if (target == null)
                {
                    throw new SerializationException(
                        SR.GetString(SR.Type_cannot_be_resolved, targetTypeName)
                    );
                }
                HttpCacheValidateHandler handler = (HttpCacheValidateHandler)
                    Delegate.CreateDelegate(typeof(HttpCacheValidateHandler), target, methodName);
        ...
        {
            get { return _varyByParamValues != null && _varyByParamValues[0].Length == 0; }
        }
        ...
        {
            get { return (_privateFields == null) ? null : (string[])_privateFields.Clone(); }
        }

        internal String[] NoCacheFields
        {
            get { return (_noCacheFields == null) ? null : (string[])_noCacheFields.Clone(); }
        }
        ...
        {
            get { return _slidingExpiration == 1; }
        }

        internal TimeSpan SlidingDelta
        {
            get { return _slidingDelta; }
        }
        internal DateTime UtcTimestampCreated
        {
            get { return _utcTimestampCreated; }
        }

        internal int ValidUntilExpiresInternal
        {
            get { return _validUntilExpires; }
        }
        ...
        {
            get { return _allowInHistory; }
        }

        internal HttpCacheRevalidation Revalidation
        {
            get { return _revalidation; }
        }
        ...
        {
            get { return _generateLastModifiedFromFiles; }
        }
        internal bool GenerateEtagFromFiles
        {
            get { return _generateEtagFromFiles; }
        }

        internal string VaryByCustom
        {
            get { return _varyByCustom; }
        }

        internal bool HasUserProvidedDependencies
        {
            get { return _hasUserProvidedDependencies; }
        }
    ...
    public sealed class HttpCachePolicy
    {
        ...
        )
        {
            ...
            if (settings.ValidationCallbackInfo != null)
            {
                ...
                {
                    _validationCallbackInfo.Add(
                        new ValidationCallbackInfo(
        ...
        void UpdateCachedHeaders(HttpResponse response)
        {
            ...
            )
            {
                if (_isMaxAgeSet && !_noMaxAgeInCacheControl)
                {
                    AppendValueToHeader(
                        sb,
                        "max-age="
                            + ((long)_maxAge.TotalSeconds).ToString(CultureInfo.InvariantCulture)
                    );
                }
                ...
                if (_isProxyMaxAgeSet && !_noMaxAgeInCacheControl)
                {
                    AppendValueToHeader(
                        sb,
                        "s-maxage="
                            + ((long)(_proxyMaxAge).TotalSeconds).ToString(
            ...
            if (sb.Length > 0)
            {
                _headerCacheControl = new HttpResponseHeader(
                    HttpWorkerRequest.HeaderCacheControl,
                    sb.ToString()
                );
            }
            ...
            )
            {
                if (s_headerPragmaNoCache == null)
                {
                    s_headerPragmaNoCache = new HttpResponseHeader(
                        HttpWorkerRequest.HeaderPragma,
                        "no-cache"
                    );
                }
                ...
                if (_allowInHistory != 1)
                {
                    if (s_headerExpiresMinus1 == null)
                    {
                        s_headerExpiresMinus1 = new HttpResponseHeader(
                            HttpWorkerRequest.HeaderExpires,
                            "-1"
                        );
                    }
            ...
            else
            {
                ...
                if (_isLastModifiedSet)
                {
                    ...
                    _headerLastModified = new HttpResponseHeader(
                        HttpWorkerRequest.HeaderLastModified,
                        lastModifiedDate
                    );
                }
        ...
        internal void GetHeaders(ArrayList headers, HttpResponse response)
        {
            ...
            if (
                ...
                && _cacheability != HttpCacheability.ServerAndNoCache
            )
            {
                if (_slidingExpiration == 1)
                {
                        ...
                        if (_isMaxAgeSet)
                        {
                            ...
                            if (!_noMaxAgeInCacheControl)
                                AppendValueToHeader(
                                    sb,
                                    "max-age="
                                        + ((long)maxAge.TotalSeconds).ToString(
                                            CultureInfo.InvariantCulture
                                        )
                                );
                        }
                        ...
                        if (_isProxyMaxAgeSet)
                        {
                            ...
                            if (!_noMaxAgeInCacheControl)
                                AppendValueToHeader(
                                    sb,
                                    "s-maxage="
                                        + ((long)(proxyMaxAge).TotalSeconds).ToString(
                                            CultureInfo.InvariantCulture
                                        )
                                );
                        }
        ...
        */
        ...
        internal HttpCachePolicySettings GetCurrentSettings(HttpResponse response)
        {
            ...
            if (_validationCallbackInfo != null)
            {
                ...
                _validationCallbackInfo.CopyTo(
                    0,
                    validationCallbackInfo,
                    0,
                    _validationCallbackInfo.Count
                );
            }
            else
            {
        ...
        internal bool IsKernelCacheable(HttpRequest request, bool enableKernelCacheForVaryByStar)
        {
            return _cacheability == HttpCacheability.Public
                ...
                && (
                    !_varyByParams.IsModified()
                    || _varyByParams.IgnoreParams
                    || (_varyByParams.IsVaryByStar && enableKernelCacheForVaryByStar)
                )
                && !_noStore
                && _varyByCustom == null
                && _privateFields == null
        ...
        {
            get { return _varyByParams.IsVaryByStar; }
        }
        ...
        {
            get { return _varyByContentEncodings; }
        }
        ...
        {
            if (
                (int)cacheability < (int)HttpCacheabilityLimits.MinValue
        ...
        {
            if (
                (int)revalidation < (int)HttpCacheRevalidationLimits.MinValue
        ...
        */
        ...
        public void SetETag(String etag)
        {
            ...
            if (_generateEtagFromFiles)
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Cant_both_set_and_generate_Etag)
                );
            }
        ...
        {
            get { return _utcTimestampCreated; }
            set { _utcTimestampCreated = value; }
        }
    }
}
