...
namespace System.Web
{
    ...
    public class HttpException : ExternalException
    {
        ...
        [SuppressMessage(
            ...
            Justification = "Base class has demand"
        )]
    ...
    public sealed class HttpUnhandledException : HttpException
    {
        ...
        /// <internalonly/>
        internal HttpUnhandledException(
            string message,
            string postMessage,
        ...
        internal CompilerError FirstCompileError
        {
            get
            {
                ...
                foreach (CompilerError error in _results.Errors)
                {
                    ...
                    if (
                        HttpRuntime.CodegenDirInternal != null
                        && error.FileName != null
    ...
    public sealed class HttpParseException : HttpException
    {
        ...
        public HttpParseException(
            ...
            : this(
                message,
                innerException,
                System.Web.VirtualPath.CreateAllowNull(virtualPath),
                sourceCode,
                line
            ) { }

        internal HttpParseException(
            string message,
            Exception innerException,
            ...
            : base(message, innerException)
        {
            ...
            SetFormatter(
                new ParseErrorFormatter(
                    this,
                    System.Web.VirtualPath.GetVirtualPathString(virtualPath),
                    sourceCode,
                    line,
                    formatterMessage
                )
            ...
            : base(info, context)
        {
            ...
            _parserErrors = (ParserErrorCollection)
            ...
            : base(message)
        {
            SetFormatter(
                new UnhandledErrorFormatter(
                    this,
                    SR.GetString(SR.Dangerous_input_detected_descr),
                    null
                )
            );
        }
