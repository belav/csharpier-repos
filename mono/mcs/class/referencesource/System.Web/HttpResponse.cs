...
#pragma warning restore 0649
        ...
        private SubscriptionQueue<Action<HttpContext>> _onSendingHeadersSubscriptionQueue =
            new SubscriptionQueue<Action<HttpContext>>();
        ...
        internal static readonly String RedirectQueryStringAssignment =
            RedirectQueryStringVariable + "=" + RedirectQueryStringValue;
        ...
        {
            get { return (_httpWriter != null && _writer == _httpWriter); }
        }
        ...
        internal ArrayList GenerateResponseHeaders(bool forCache)
        {
            ...
            {
                headers.Add(
                    new HttpResponseHeader(HttpWorkerRequest.HeaderLocation, _redirectLocation)
                );
            }
            ...
            if (!forCache)
            {
                ...
                else
                {
                    ...
                    {
                        headers.Add(
                            new HttpResponseHeader(HttpWorkerRequest.HeaderCacheControl, "private")
                        );
                    }
                }
            }
            ...
            if (_statusCode != 204 && _contentType != null)
            {
                ...
                headers.Add(
                    new HttpResponseHeader(HttpWorkerRequest.HeaderContentType, contentType)
                );
            }
        ...
        {
            get { return _useAdaptiveError; }
            set { _useAdaptiveError = value; }
        }
        ...
        private static byte[] s_chunkEnd = new byte[5]
        {
            (byte)'0',
            (byte)'\r',
            (byte)'\n',
            ...
            try
            {
                ...
                if (!_clientDisconnected)
                {
                    ...
                    if (_chunked)
                    {
                        if (bufferedLength > 0)
                        {
                            byte[] chunkPrefix = Encoding.ASCII
        ...
        {
            get { return (_wr != null && _wr.SupportsAsyncFlush); }
        }
        ...
        internal String SetupKernelCaching(String originalCacheUrl)
        {
            ...
            string kernelCacheUrl = _wr.SetupKernelCaching(
                secondsToLive,
                originalCacheUrl,
        ...
        {
            _virtualPathDependencyList.AddDependencies(
                virtualPaths,
                "virtualPaths",
                false,
                Request.Path
        ...
        public void AddCacheDependency(params CacheDependency[] dependencies)
        {
            ...
            if (_cacheDependencyForResponse != null)
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Invalid_operation_cache_dependency)
                );
            }
            if (_userAddedDependencies == null)
            {
            ...
            {
                CacheDependency[] deps = new CacheDependency[
        ...
        public static void RemoveOutputCacheItem(string path, string providerName)
        {
            ...
            if (
                StringUtil.StringStartsWith(path, "\\\\")
                || path.IndexOf(':') >= 0
        ...
        internal CacheDependency CreateCacheDependencyForResponse()
        {
            if (_cacheDependencyForResponse == null)
            {
                ...
                // just once.
                dependency = _cacheItemDependencyList.CreateCacheDependency(
                    CacheDependencyType.CacheItems,
                    null
                );
                dependency = _fileDependencyList.CreateCacheDependency(
                    CacheDependencyType.Files,
                    dependency
                );
                dependency = _virtualPathDependencyList.CreateCacheDependency(
                    CacheDependencyType.VirtualPaths,
                    dependency
                );
        ...
        internal HttpRawResponse GetSnapshot()
        {
            ...
            if (!_suppressContent)
            {
                if (iis7WorkerRequest != null)
                {
                    buffers = _httpWriter.GetIntegratedSnapshot(
                        out hasSubstBlocks,
                        iis7WorkerRequest
                    );
                }
        ...
        private void WriteErrorMessage(Exception e, bool dontShowSensitiveErrors)
        {
            ...
            else
            {
                ...
                if ((globConfig != null) && (!String.IsNullOrEmpty(globConfig.UICulture)))
                {
                    try
                    {
                        uiculture = HttpServerUtility.CreateReadOnlyCultureInfo(
            ...
            try
            {
                try
                {
                    ...
                    {
                        _writer.Write(
                            errorFormatter.GetAdaptiveErrorMessage(Context, dontShowSensitiveErrors)
                        );
                    }
                    else
                    {
                ...
                if (!localExecute && useCustomErrors)
                {
                    String redirect =
                        (customErrorsSetting != null)
                            ? customErrorsSetting.GetRedirectString(code)
                            : null;

                    RedirectToErrorPageStatus redirectStatus = RedirectToErrorPage(
                        redirect,
                        customErrorsSetting.RedirectMode
                    );
            ...
            set
            {
                if (_headersWritten)
                {
                    ...
                    throw new HttpException(
                        SR.GetString(SR.Cannot_set_content_type_after_headers_sent)
                    );
                }
        ...
        public Encoding HeaderEncoding
        {
            ...
            set
            {
                ...
                {
                    throw new HttpException(
                        SR.GetString(SR.Invalid_header_encoding, value.WebName)
                    );
                }
                ...
                if (_headerEncoding == null || !_headerEncoding.Equals(value))
                {
                    if (_headersWritten)
                        throw new HttpException(
                            SR.GetString(SR.Cannot_set_header_encoding_after_headers_sent)
                        );
        ...
        public CancellationToken ClientDisconnectedToken
        {
            get
            {
                ...
                if (
                    wr != null
                    && wr.TryGetClientDisconnectedCancellationToken(out cancellationToken)
                )
                {
                ...
                {
                    throw new PlatformNotSupportedException(
                        SR.GetString(SR.Requires_Iis_75_Integrated)
                    );
                }
            }
        }
        ...
        public bool IsRequestBeingRedirected
        {
            ...
            internal set { _isRequestBeingRedirected = value; }
        }
        ...
        public String RedirectLocation
        {
            ...
            set
            {
                if (_headersWritten)
                    throw new HttpException(
                        SR.GetString(SR.Cannot_append_header_after_headers_sent)
                    );
        ...
        public ISubscriptionToken AddOnSendingHeaders(Action<HttpContext> callback)
        {
            ...
            {
                throw new HttpException(
                    SR.GetString(SR.Cannot_call_method_after_headers_sent_generic)
                );
            }
        ...
        )
        {
            ...
            VirtualPathData data = RouteTable.Routes
...
#pragma warning restore 0618
            ...
            Debug.Trace(
                "ClientUrl",
                "*** Redirect (" + originalUrl + ") --> " + RedirectLocation + " ***"
            );
#endif
        ...
        internal string ApplyRedirectQueryStringIfRequired(string url)
        {
            if (
                Request == null
                || (string)Request.Browser["requiresPostRedirectionHandling"] != "true"
            )
                return url;
        ...
        //
        internal RedirectToErrorPageStatus RedirectToErrorPage(
            String url,
                ...
                else
                {
                    ...
                    if (url.IndexOf('?') < 0)
                        url =
                            ...
                            + qsErrorMark
                            + "="
                            + HttpEncoderUtility.UrlEncodeSpaces(Request.Path);
        ...
        )
        {
            ...
            Debug.Trace(
                "ExecuteUrl",
                "HttpResponse.BeginExecuteUrlForEntireResponse:"
                    + " path="
                    + path
                    + " headers="
                    + headers
        ...
        public void WriteSubstitution(HttpResponseSubstitutionCallback callback)
        {
            ...
            if (callback.Target != null && callback.Target is Control)
            {
                throw new ArgumentException(
                    SR.GetString(SR.Invalid_substitution_callback),
                    "callback"
                );
            }
        ...
        public void TransmitFile(string filename, long offset, long length)
        {
            ...
            if (length > 0)
            {
                ...
                _httpWriter.TransmitFile(
                    filename,
                    offset,
                    length,
                    _context.IsClientImpersonationConfigured || HttpRuntime.IsOnUNCShareInternal,
        ...
        public void WriteFile(IntPtr fileHandle, long offset, long size)
        {
            ...
            {
                f = new FileStream(
                    new Microsoft.Win32.SafeHandles.SafeFileHandle(fileHandle, false),
                    FileAccess.Read
                );
        ...
        public string Status
        {
            get
            {
                return this.StatusCode.ToString(NumberFormatInfo.InvariantInfo)
                    + " "
        ...
        [SuppressMessage(
            ...
            Justification = "Known issue, but required for proper operation of ASP.NET."
        )]
        ...
        public string CacheControl
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentException(
                        SR.GetString(SR.Invalid_value_for_CacheControl, value)
                    );
                }
            }
        }
        ...
        internal void SetAppPathModifier(string appPathModifier)
        {
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.InvalidArgumentValue, "appPathModifier")
                );
            }
        ...
        public string ApplyAppPathModifier(string virtualPath)
        {
            ...
            if (
                _appPathModifier == null
                || virtualPath.IndexOf(_appPathModifier, StringComparison.Ordinal) >= 0
            )
            {
#if DBG
                Debug.Trace(
                    "ClientUrl",
                    "*** ApplyAppPathModifier (" + originalUrl + ") --> " + virtualPath + " ***"
                );
#endif
                return virtualPath;
            }
        ...
        internal String RemoveAppPathModifier(string virtualPath)
        {
            ...
            return virtualPath.Substring(0, pos - 1)
                + virtualPath.Substring(pos + _appPathModifier.Length);
        }

        internal bool UsePathModifier
        {
            get { return !String.IsNullOrEmpty(_appPathModifier); }
        }
        ...
        private String ConvertToFullyQualifiedRedirectUrlIfRequired(String url)
        {
            HttpRuntimeSection runtimeConfig = _context.IsRuntimeErrorReported
                ? RuntimeConfig.GetLKGConfig(_context).HttpRuntime
                : RuntimeConfig.GetConfig(_context).HttpRuntime;
            if (
                runtimeConfig.UseFullyQualifiedRedirectUrl
                || (
                    Request != null
                    && (string)Request.Browser["requiresFullyQualifiedRedirectUrl"] == "true"
                )
            )
            {
        ...
        private String UrlEncodeRedirect(String url)
        {
            ...
            if (iqs >= 0)
            {
                ...
                url =
                    UrlEncodeIDNSafe(url.Substring(0, iqs))
            ...
            if (!_headersWritten)
            {
                ...
                if (!_suppressHeaders && !_clientDisconnected)
                {
                    ...
                    bool responseBuffered =
                        bufferedLength > 0 || iis7WorkerRequest.IsResponseBuffered();

                    //
                    // Generate Content-Type
                    //
                    if (
                        _contentType != null // Valid Content-Type
                        && (
                            _contentTypeSetByManagedCaller // Explicitly set by managed caller
                            || (_contentTypeSetByManagedHandler && responseBuffered)
                        )
                    )
                    { // Implicitly set by managed handler and response is non-empty
                        HttpHeaderCollection headers = Headers as HttpHeaderCollection;
                        String contentType = AppendCharSetToContentType(_contentType);
    ...
    struct ResponseDependencyList
    {
        ...
        internal void AddDependency(string item, string argname)
        {
            ...
            _dependencies.Add(new ResponseDependencyInfo(new string[] { item }, utcNow));
        ...
        internal CacheDependency CreateCacheDependency(
            CacheDependencyType dependencyType,
            CacheDependency dependency
        )
        {
            if (_dependencies != null)
            {
                if (
                    dependencyType == CacheDependencyType.Files
                ...
                else
                {
                    ...
                    {
                        virtualDependency = vpp.GetCacheDependency(
                            _requestVirtualPath,
                            GetDependencies(),
                            _oldestDependency
                        );
