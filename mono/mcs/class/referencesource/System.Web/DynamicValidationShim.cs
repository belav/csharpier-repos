...
// This is a special class used by Microsoft.Web.Infrastructure.dll to interface with the request
// validation system.
// M.W.I was created before the existence of this class and has its own implementation of granular
// request validation,
// but it uses reflection to look for this class. If this class exists, M.W.I calls the methods
...
namespace Microsoft.Web.Infrastructure.DynamicValidationHelper
{
    ...
    internal static class DynamicValidationShim
    {
        ...
        {
            // Because .NET 4.5 is an in-place update granular request validation is disabled by default for
            // back-compat
            // reasons (request validation defaults to the 4.0 behavior).
            // We need to enable it for the current request so that MVC 3 and Web Pages 1 continue to work on
            // .NET 4.5.
        ...
        internal static void GetUnvalidatedCollections(
            HttpContext context,
