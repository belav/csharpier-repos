...
namespace System.Web
{
    ...
    {
        internal static SiteMapNodeCollection Empty = new ReadOnlySiteMapNodeCollection(
        ...
        private ArrayList List
        {
            ...
            {
                Debug.Assert(
                    !(this is ReadOnlySiteMapNodeCollection),
        ...
        private sealed class ReadOnlySiteMapNodeCollection : SiteMapNodeCollection
        {
            ...
            {
                get { return _internalCollection.IsSynchronized; }
            }

            public override object SyncRoot
            {
                get { return _internalCollection.SyncRoot; }
            }
            ...
            public override SiteMapNode this[int index]
            {
                ...
                set { throw new NotSupportedException(SR.GetString(SR.Collection_readonly)); }
            }
