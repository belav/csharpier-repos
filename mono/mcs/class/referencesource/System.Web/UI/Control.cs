...
namespace System.Web.UI
{
    ...
    [
        ...
        ToolboxItemAttribute(
            "System.Web.UI.Design.WebControlToolboxItem, " + AssemblyRef.SystemDesign
        )
    ]
...
#pragma warning restore 0649
        ...
        {
            get { return (ClientIDMode)flags[clientIDMode, clientIDModeOffset]; }
        ...
        {
            get { return (ClientIDMode)flags[effectiveClientIDMode, effectiveClientIDModeOffset]; }
        ...
        {
            get { return flags[useGeneratedID] ? String.Empty : ID ?? String.Empty; }
        }
        ...
        private string GetPredictableClientIDSuffix()
        {
            ...
            )
            {
                ...
                if (
                    ...
                    && (((IDataKeysControl)dataKeysContainer).ClientIDRowSuffix != null)
                    && (((IDataKeysControl)dataKeysContainer).ClientIDRowSuffix.Length > 0)
                )
                {
        ...
        internal string PredictableClientID
        {
            get
            {
                ...
                return String.IsNullOrEmpty(_cachedPredictableID)
                    ? String.Empty
        ...
        {
            get { return ID_RENDER_SEPARATOR; }
        }
        ...
        {
            get { return SupportsEventValidationAttribute.SupportsEventValidation(this.GetType()); }
        }
            ...
            set
            {
                if ((_controlState >= ControlState.FrameworkInitialized) && !DesignMode)
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.PropertySetBeforePreInitOrAddToControls, "EnableTheming")
                    );
                }
        ...
        {
            get { return this is INamingContainer && !(this is INonBindingContainer); }
        }

        protected internal bool IsChildControlStateCleared
        {
            get { return flags[disableChildControlState]; }
        }
        ...
        public virtual string SkinID
        {
            get
            {
                ...
                {
                    return _occasionalFields.SkinId == null
                        ? String.Empty
                        : _occasionalFields.SkinId;
                }
                return String.Empty;
            }
            set
            {
                if (!DesignMode)
                {
                    ...
                    {
                        throw new InvalidOperationException(
                            SR.GetString(SR.PropertySetBeforeStyleSheetApplied, "SkinId")
                        );
                    }
                    ...
                    {
                        throw new InvalidOperationException(
                            SR.GetString(SR.PropertySetBeforePreInitOrAddToControls, "SkinId")
                        );
                    }
                }
        ...
        {
            get { return !flags[disableViewState]; }
        ...
        {
            get { return ((EnableLegacyRendering) ? LEGACY_ID_SEPARATOR : ID_SEPARATOR); }
        }
        ...
        {
            get { return ViewStateModeByIdAttribute.IsEnabled(GetType()); }
        }
        ...
        {
            VirtualPathData data = RouteCollection.GetVirtualPath(
        ...
        public string AppRelativeTemplateSourceDirectory
        {
            get
            {
                return VirtualPath.GetAppRelativeVirtualPathStringOrEmpty(
            ...
            set
            {
                ...
                this.TemplateControlVirtualDirectory = VirtualPath.CreateNonRelativeAllowNull(
                    value
                );
            }
        }
            ...
            get
            {
                ...
                if (control == null)
                {
                    ...
                    if (context != null)
                    {
                        ...
                        {
                            EnsureOccasionalFields();
                            _occasionalFields.TemplateSourceVirtualDirectory =
                ...
                if (control != this)
                {
                    VirtualPath templateSourceVirtualDirectory =
                        control.TemplateControlVirtualDirectory;
                    if (templateSourceVirtualDirectory != null)
                    {
                        EnsureOccasionalFields();
                        _occasionalFields.TemplateSourceVirtualDirectory =
        ...
        public ISite Site
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.Substitution_SiteNotAllowed)
                    );
                }
        ...
        [SuppressMessage(
            ...
            MessageId = "ID",
            Justification = "This is consistent with UniqueID"
        )]
        [SuppressMessage(
            "Microsoft.Naming",
            "CA1706:ShortAcronymsShouldBeUppercase",
        ...
        public string GetUniqueIDRelativeTo(Control control)
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Control_NotADescendentOfNamingContainer, control.ID)
                );
            }
        ...
        public virtual void ApplyStyleSheetSkin(Page page)
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.StyleSheetAreadyAppliedOnControl)
                );
            }
        ...
        private void UpdateNamingContainer(Control namingContainer)
        {
            ...
            if (
                ...
                || (_namingContainer != null && _namingContainer != namingContainer)
            )
            {
                ClearCachedUniqueIDRecursive();
            }
        ...
        internal void ControlInvariant()
        {
            ...
            if (_controlState >= ControlState.Initialized)
            {
                if (DesignMode)
                {
                    ...
                    Debug.Assert(
                        (_namingContainer != null) || (this is Page) || (this is UserControl)
                    );
        ...
        // rare fields.
        internal void GetRareFieldStatistics(
            ref int totalControls,
            ref int withOccasionalFields,
            ref int withRareFields
        )
        {
            totalControls++;
            if (_occasionalFields != null)
            {
                ...
                for (int i = 0; i < controlCount; i++)
                {
                    ...
                    control.GetRareFieldStatistics(
                        ref totalControls,
                        ref withOccasionalFields,
                        ref withRareFields
                    );
                }
            }
        ...
        protected virtual void LoadViewState(object savedState)
        {
            if (savedState != null)
            {
                ...
                {
                    flags[validateRequestMode, validateRequestModeOffset] =
                        (int)validateRequestModeValue;
        ...
        ///
        internal void ResolvePhysicalOrVirtualPath(
            string path,
        ...
        protected internal string MapPathSecure(string virtualPath)
        {
            if (String.IsNullOrEmpty(virtualPath))
            {
                throw new ArgumentNullException(
                    "virtualPath",
                    SR.GetString(SR.VirtualPath_Length_Zero)
                );
            }
            ...
            {
                physicalPath = virtualPathObject.MapPathInternal(
                    TemplateControlVirtualDirectory,
        ...
        ///
        internal Stream OpenFileAndGetDependency(
        ...
        protected void BuildProfileTree(string parentId, bool calcViewState)
        {
            ...
            if (
                Page != null
                && Page._registeredControlsRequiringControlState != null
                && Page._registeredControlsRequiringControlState.Contains(this)
            )
            {
        ...
        {
            get { return flags[controlsCreated]; }
            set
            {
        ...
        public string ResolveClientUrl(string relativeUrl)
        {
            ...
            {
                IUrlResolutionService resolutionService = (IUrlResolutionService)
                    Page.Site.GetService(typeof(IUrlResolutionService));
            ...
            Debug.Trace(
                "ClientUrl",
                "*** ResolveClientUrl (" + relativeUrl + ") --> " + url + " ***"
            );
            return url;
        }
        ...
        private void EnsureNamedControlsTable()
        {
            ...
            _occasionalFields.NamedControls = new HybridDictionary( /*initialSize*/
                _occasionalFields.NamedControlsID, /*caseInsensitive*/
                true
            );
                ...
                if (control._id != null)
                {
                    ...
                    catch
                    {
                        throw new HttpException(
                            SR.GetString(SR.Duplicate_id_used, control._id, "FindControl")
                        );
                    }
                }
        ...
        bool IDataBindingsAccessor.HasDataBindings
        {
            get
            {
                return (
                    (RareFields != null)
                    && (RareFields.DataBindings != null)
                    && (RareFields.DataBindings.Count != 0)
                );
            }
        }
        ...
        {
            get { return RareFields != null ? RareFields.ControlBuilder : null; }
        }
