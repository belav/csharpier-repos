...
namespace System.Web.UI
{
    ...
    public abstract class TemplateControlParser : BaseTemplateParser
    {
        ...
        {
            get { return _outputCacheSettings; }
        }

        internal bool FAutoEventWireup
        {
            get { return !flags[noAutoEventWireup]; }
        }
        ...
        internal override void ProcessDirective(string directiveName, IDictionary directive)
        {
            ...
            else if (StringUtil.EqualsIgnoreCase(directiveName, "reference"))
            {
                ...
                VirtualPath virtualPath = Util.GetAndRemoveVirtualPathAttribute(
                    directive,
                    "virtualpath"
                );
        ...
        internal override void ProcessMainDirective(IDictionary mainDirective)
        {
            ...
            try
            {
                tmpObj = Util.GetAndRemoveEnumAttribute(
                    mainDirective,
        ...
        )
        {
            ...
            try
            {
                RootBuilder.PreprocessAttribute(
                    filter,
                    attribName,
                    value,
        ...
        internal Type GetDirectiveType(IDictionary directive, string directiveName)
        {
            ...
            {
                throw new HttpException(
                    SR.GetString(SR.Invalid_typeNameOrVirtualPath_directive, directiveName)
                );
            }
         ...
         */
        internal virtual void ProcessOutputCacheDirective(
        ...
        )
        {
            ...
            bool fHasDuration = Util.GetAndRemovePositiveIntegerAttribute(
                directive,
                "duration",
                ref duration
            );
            ...
            // If there are some attributes left, fail
            Util.CheckUnknownDirectiveAttributes(
                directiveName,
                directive,
