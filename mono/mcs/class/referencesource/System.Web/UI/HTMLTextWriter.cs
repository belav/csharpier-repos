...
namespace System.Web.UI
{
    ...
    public class HtmlTextWriter : TextWriter
    {
        ...
        static HtmlTextWriter()
        {
            ...
            _attrNameLookupArray = new AttributeInformation[
            ...
            RegisterAttribute(
                ...
                HtmlTextWriterAttribute.DesignerRegion,
                false
            );
        }
        ...
        private static void RegisterTag(string name, HtmlTextWriterTag key, TagType type)
        {
            ...
            if (type != TagType.NonClosing && key != HtmlTextWriterTag.Unknown)
            {
                endTag =
                    EndTagLeftChars
                    + nameLCase
                    + TagRightChar.ToString(CultureInfo.InvariantCulture);
            }
                ...
                for (int i = 0; i < _attrCount; i++)
                {
                    ...
                    else
                    {
                        ...
                        if (attr.value != null)
                        {
                            ...
                            {
                                if (
                                    attr.key != HtmlTextWriterAttribute.Href
            ...
            while (pos < length)
            {
                ...
                if (nbsp < 0)
                {
                    HttpUtility.HtmlEncode(
                        pos == 0 ? text : text.Substring(pos, length - pos),
                        this
                    );
                    pos = length;
                }
