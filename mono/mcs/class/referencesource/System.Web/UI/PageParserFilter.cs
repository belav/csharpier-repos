...
namespace System.Web.UI
{
    ...
    public abstract class PageParserFilter
    {
        ...
        protected int Line
        {
            get { return _parser._lineNumber; }
        }
        ...
        private void OnControlAdded()
        {
            ...
            if (_currentControlCount > _numberOfControlsAllowed)
            {
                throw new HttpException(
                    SR.GetString(
                        SR.Too_many_controls,
                        _numberOfControlsAllowed.ToString(CultureInfo.CurrentCulture)
                    )
                );
            }
        }
        ...
        internal void OnDirectDependencyAdded()
        {
            ...
            if (_currentDirectDependenciesCount > _directDependenciesAllowed)
            {
                throw new HttpException(
                    SR.GetString(
                        SR.Too_many_direct_dependencies,
                        VirtualPath,
