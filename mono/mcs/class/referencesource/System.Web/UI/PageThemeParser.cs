...
namespace System.Web.UI
{
    ...
    internal class PageThemeParser : BaseTemplateParser
    {
        ...
        {
            get { return _currentSkinBuilder; }
            set { _currentSkinBuilder = value; }
        }
        ...
        )
        {
            switch (name)
            {
                ...
                case "inherits":
                    ProcessError(
                        SR.GetString(SR.Attr_not_supported_in_directive, name, DefaultDirectiveName)
                    );
                    return false;
