...
namespace System.Web.UI
{
    ...
    {
        internal override void AddContentTemplate(
            object obj,
            string templateName,
            ITemplate template
        )
    ...
    [
        Designer(
            "Microsoft.VisualStudio.Web.WebForms.MasterPageWebFormDesigner, "
    ...
    public class MasterPage : UserControl
    {
        ...
        public MasterPage Master
        {
            get
            {
                ...
                {
                    _master = MasterPage.CreateMaster(
                        this,
                        Context,
                        _masterPageFile,
        ...
        {
            get { return VirtualPath.GetVirtualPathString(_masterPageFile); }
            set
            {
        ...
        internal static MasterPage CreateMaster(
            TemplateControl owner,
            HttpContext context,
            VirtualPath masterPageFile,
            IDictionary contentTemplateCollection
        )
        {
            ...
            if (owner.Controls.IsReadOnly)
            {
                throw new HttpException(
                    SR.GetString(SR.MasterPage_Cannot_ApplyTo_ReadOnly_Collection)
                );
            }
            ...
            if (contentTemplateCollection != null)
            {
                foreach (String contentName in contentTemplateCollection.Keys)
                {
                    ...
                    )
                    {
                        throw new HttpException(
                            SR.GetString(
                                SR.MasterPage_doesnt_have_contentplaceholder,
                                contentName,
                                masterPageFile
                            )
                        );
        ...
        internal static void ApplyMasterRecursive(MasterPage master, IList appliedMasterFilePaths)
        {
            ...
            if (master.Master != null)
            {
                ...
                if (appliedMasterFilePaths.Contains(pageFile))
                {
                    throw new InvalidOperationException(
                        SR.GetString(
                            SR.MasterPage_Circular_Master_Not_Allowed,
