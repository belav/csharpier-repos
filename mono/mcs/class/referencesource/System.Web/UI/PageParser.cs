...
namespace System.Web.UI
{
    ...
    public sealed class PageParser : TemplateControlParser
    {
        ...
        {
            get { return flags[requiresSessionState]; }
        }
        internal bool FReadOnlySessionState
        {
            get { return flags[readOnlySessionState]; }
        }
        ...
        private static IHttpHandler GetCompiledPageInstance(
            ...
            try
            {
                try
                {
                    ...
                    if (inputFile != null)
                    {
                        virtualPathToFileMappingState =
                            HostingEnvironment.AddVirtualPathToFileMapping(virtualPath, inputFile);
                    }

                    BuildResultCompiledType result = (BuildResultCompiledType)
                        BuildManager.GetVPathBuildResult(
                            context,
                            virtualPath,
                            false /*noBuild*/
                            ,
                ...
                finally
                {
                    if (virtualPathToFileMappingState != null)
                        HostingEnvironment.ClearVirtualPathToFileMapping(
                            virtualPathToFileMappingState
                        );
                }
            }
        ...
        {
            get { return typeof(System.Web.UI.Page); }
        }

        internal override Type DefaultFileLevelBuilderType
        {
            get { return typeof(FileLevelPageControlBuilder); }
        }
            ...
            if (_configMasterPageFile != null)
            {
                ...
                try
                {
                    if (_configMasterPageFile.Length > 0)
                    {
                        ...
                        {
                            ProcessError(
                                SR.GetString(SR.Invalid_master_base, _configMasterPageFile)
                            );
                        }
                    }
            ...
            if (PagesConfig != null)
            {
                ...
                if (PagesConfig.EnableViewStateMac != Page.EnableViewStateMacDefault)
                    _mainDirectiveConfigSettings["enableviewstatemac"] = Util.GetStringFromBool(
                        PagesConfig.EnableViewStateMac
                    );
                ...
                if (PagesConfig.EnableEventValidation != Page.EnableEventValidationDefault)
                    _mainDirectiveConfigSettings["enableEventValidation"] = Util.GetStringFromBool(
                        PagesConfig.EnableEventValidation
                    );
                ...
                if (
                    PagesConfig.StyleSheetThemeInternal != null
                    && PagesConfig.StyleSheetThemeInternal.Length != 0
                )
                    _mainDirectiveConfigSettings["stylesheettheme"] =
                        PagesConfig.StyleSheetThemeInternal;
                ...
                {
                    _mainDirectiveConfigSettings["viewStateEncryptionMode"] = Enum.Format(
                        typeof(ViewStateEncryptionMode),
                        PagesConfig.ViewStateEncryptionMode,
                        "G"
                    );
                }

                if (
                    PagesConfig.MaintainScrollPositionOnPostBack
                    != Page.MaintainScrollPositionOnPostBackDefault
                )
                {
                    _mainDirectiveConfigSettings["maintainScrollPositionOnPostBack"] =
                        Util.GetStringFromBool(PagesConfig.MaintainScrollPositionOnPostBack);
                }
                ...
                if (PagesConfig.MaxPageStateFieldLength != Page.DefaultMaxPageStateFieldLength)
                {
                    _mainDirectiveConfigSettings["maxPageStateFieldLength"] =
                        PagesConfig.MaxPageStateFieldLength;
                }

                flags[requiresSessionState] = (
                    (PagesConfig.EnableSessionState == PagesEnableSessionState.True)
                    || (PagesConfig.EnableSessionState == PagesEnableSessionState.ReadOnly)
                );
        ...
        )
        {
            switch (name)
            {
                ...
                case "enablesessionstate":
                    ...
                    {
                        ProcessError(
                            SR.GetString(SR.Enablesessionstate_must_be_true_false_or_readonly)
                        );
                    }
                ...
                case "culture":
                    ...
                    )
                    {
                        throw new HttpException(
                            SR.GetString(SR.Insufficient_trust_for_attribute, "culture")
                        );
                    }
                    ...
                    catch
                    {
                        ProcessError(
                            SR.GetString(
                                ...
                                _lcid.ToString(CultureInfo.InvariantCulture),
                                "lcid"
                            )
                        );
                    }
                ...
                case "aspcompat":
                    ...
                    {
                        throw new HttpException(
                            SR.GetString(SR.Insufficient_trust_for_attribute, "AspCompat")
                        );
                    }
                ...
                case "async":
                    ...
                    {
                        throw new HttpException(
                            SR.GetString(SR.Insufficient_trust_for_attribute, "async")
                        );
                    }
                ...
                case "clienttarget":
                    ...
                    // Check validity
                    HttpCapabilitiesDefaultProvider.GetUserAgentFromClientTarget(
                        CurrentVirtualPath,
                        value
                    );
        ...
        internal override void PostProcessMainDirectiveAttributes(IDictionary parseData)
        {
            ...
            {
                ProcessError(
                    SR.GetString(SR.Attributes_mutually_exclusive, "ResponseEncoding", "CodePage")
                );
                return;
            }
        ...
        private void ParseTransactionAttribute(string name, string value)
        {
            ...
            if (tmpObj != null)
            {
                ...
                )
                {
                    ...
                    {
                        throw new HttpException(
                            SR.GetString(SR.Insufficient_trust_for_attribute, "transaction")
                        );
                    }
        ...
        )
        {
            ...
            varyByContentEncoding = Util.GetAndRemoveNonEmptyAttribute(
                directive,
        ...
        {
            get { return s_defaultUserContorlBaseType; }
            set
            {
        ...
        {
            get { return s_defaultApplicationBaseType; }
            set
            {
        ...
        {
            get { return s_defaultPageParserFilterType; }
            set
            {
        ...
        {
            get { return s_enableLongStringsAsResources; }
            set
            {
                BuildManager.ThrowIfPreAppStartNotRunning();
