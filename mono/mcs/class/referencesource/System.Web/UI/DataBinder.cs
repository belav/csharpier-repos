...
namespace System.Web.UI
{
    ...
    public sealed class DataBinder
    {
        ...
        {
            Debug.Assert(
                (expressionParts != null) && (expressionParts.Length != 0),
        ...
        public static object GetIndexedPropertyValue(object container, string expr)
        {
            ...
            string index = expr.Substring(indexExprStart + 1, indexExprEnd - indexExprStart - 1)
                .Trim();
            ...
            if (collectionProp != null)
            {
                ...
                {
                    PropertyInfo propInfo = collectionProp
                        .GetType()
                        .GetProperty(
                            "Item",
                    ...
                    else
                    {
                        throw new ArgumentException(
                            SR.GetString(
                                SR.DataBinder_No_Indexed_Accessor,
                                collectionProp.GetType().FullName
                            )
                        );
                    }
                }
        ...
        public static object GetDataItem(object container, out bool foundDataItem)
        {
            ...
            PropertyInfo propInfo = container
                .GetType()
                .GetProperty(
