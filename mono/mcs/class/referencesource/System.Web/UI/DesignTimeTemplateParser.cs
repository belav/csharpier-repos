...
namespace System.Web.UI
{
    ...
    public static class DesignTimeTemplateParser
    {
        ...
        private static Control[] ParseControlsInternalHelper(
            DesignTimeParseData data,
            bool returnFirst
        )
        {
                    ...
                    if ((cur is ControlBuilder) && !(cur is CodeBlockBuilder))
                    {
                        ...
                        else
                        {
                            ...
                            serviceContainer.AddService(
                                ...
                                new SimpleDesignTimeFilterResolutionService(data.Filter)
                            );
                        ...
                        try
                        {
                            Control control = (Control)
                                controlBuilder.BuildObject(data.ShouldApplyTheme);
            ...
            data.SetUserControlRegisterEntries(
                parser.UserControlRegisterEntries,
                parser.TagRegisterEntries
            );
        ...
        public static ControlBuilder ParseTheme(IDesignerHost host, string theme, string themePath)
        {
            ...
            {
                throw new Exception(
                    SR.GetString(SR.DesignTimeTemplateParser_ErrorParsingTheme) + " " + e.Message
                );
            }
        }
            ...
            bool IFilterResolutionService.EvaluateFilter(string filterName)
            {
                ...
                if (
                    StringUtil.EqualsIgnoreCase(
                        ((_currentFilter == null) ? String.Empty : _currentFilter),
                        filterName
                    )
                )
                {
