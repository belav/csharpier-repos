    ...
    internal class DataSourceCache : IStateManager
    {
            ...
            set
            {
                if (value < 0)
                {
                    throw new ArgumentOutOfRangeException(
                        "value",
                        SR.GetString(SR.DataSourceCache_InvalidDuration)
                    );
                }
        ...
        public virtual DataSourceCacheExpiry ExpirationPolicy
        {
            ...
            set
            {
                ...
                {
                    throw new ArgumentOutOfRangeException(
                        SR.GetString(SR.DataSourceCache_InvalidExpiryPolicy)
                    );
                }
        ...
        public virtual string KeyDependency
        {
            ...
            set { ViewState["KeyDependency"] = value; }
        }
        ...
        public void Invalidate(string key)
        {
            ...
            Debug.Assert(
                key.StartsWith(CacheInternal.PrefixDataSourceControl, StringComparison.Ordinal),
                "All keys passed in should start with the prefix specified in CacheInternal.PrefixDataSourceControl."
            );

            if (!Enabled)
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.DataSourceCache_CacheMustBeEnabled)
                );
            }
        ...
        /// </devdoc>
        protected virtual void SaveDataToCacheInternal(
            string key,
            object data,
        ...
        )
        {
            ...
            switch (ExpirationPolicy)
            {
                case DataSourceCacheExpiry.Absolute:
                    ...
                    utcAbsoluteExpiryTime = DateTime
                        .UtcNow
            ...
            if (KeyDependency.Length > 0)
            {
                ...
                aggregateCacheDependency.Add(
                    new CacheDependency[] { new CacheDependency(null, keyDependencies) }
                );
            }
