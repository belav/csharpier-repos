...
namespace System.Web.UI
{
    ...
    internal abstract class DependencyParser : BaseParser
    {
        ...
        protected void AddDependency(VirtualPath virtualPath)
        {
            ...
            Debug.Trace(
                "Template",
                "Parsed dependency: " + _virtualPath + " depends on " + virtualPath
            );
        ...
        private void ParseFile(string physicalPath, VirtualPath virtualPath)
        {
            ...
            {
                throw new HttpException(SR.GetString(SR.Circular_include));
            }
        ...
        internal virtual void ProcessMainDirectiveAttribute(
            string deviceName,
            string name,
            string value
        )
    ...
    {
        internal override void ProcessMainDirectiveAttribute(
            string deviceName,
            string name,
            string value
        )
    ...
    internal class PageDependencyParser : TemplateControlDependencyParser
    {
        ...
        protected override void PrepareParse()
        {
            ...
            {
                if (
                    PagesConfig.MasterPageFileInternal != null
                    && PagesConfig.MasterPageFileInternal.Length != 0
                )
        ...
        internal override void ProcessDirective(string directiveName, IDictionary directive)
        {
            ...
            if (
                StringUtil.EqualsIgnoreCase(directiveName, "previousPageType")
