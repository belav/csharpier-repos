    ...
    public abstract class RenderTraceListener
    {
        ...
        internal static RenderTraceListener CurrentListeners
        {
            get
            {
                ...
                {
                    RenderTraceListener listener =
                        HttpContext.Current.Items[typeof(RenderTraceListener)]
                        as RenderTraceListener;
                    if (listener == null)
                    {
        ...
        /// </summary>
        public virtual void SetTraceData(
            object tracedObject,
            object traceDataKey,
            object traceDataValue
        ) { }
        ...
        private sealed class RenderTraceListenerList : RenderTraceListener
        {
            ...
            public override void SetTraceData(
                object tracedObject,
                object traceDataKey,
                object traceDataValue
            )
