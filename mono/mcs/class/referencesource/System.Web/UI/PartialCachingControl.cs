...
namespace System.Web.UI
{
    ...
    public abstract class BasePartialCachingControl : Control
    {
            ...
            if (tmpCacheEntry != null)
            {
                ...
                if (cachedVary != null)
                {
                    ...
                    cacheEntry = (PartialCachingCacheEntry)
                        OutputCache.GetFragment(varyCachedKey, _provider);
        ...
        protected internal override void Render(HtmlTextWriter output)
        {
            ...
            HtmlTextWriter tmpHtmlWriter = Page.CreateHtmlTextWriterFromType(
                tmpWriter,
                output.GetType()
            );
            ...
            else
            {
                ...
                cachedVary = new ControlCachedVary(
                    varyByParams,
        ...
        private string ComputeVaryCacheKey(
        ...
        private string GetCssStyleRenderString(Type htmlTextWriterType)
        {
            ...
            HtmlTextWriter cssHtmlTextWriter = Page.CreateHtmlTextWriterFromType(
                cssStringWriter,
                htmlTextWriterType
            );
        ...
        {
            RegisterClientCall(ClientAPIRegisterType.ArrayDeclaration, arrayName, arrayValue);
        }

        internal void RegisterHiddenField(string hiddenFieldName, string hiddenFieldInitialValue)
        {
            RegisterClientCall(
                ClientAPIRegisterType.HiddenField,
                hiddenFieldName,
                hiddenFieldInitialValue
            );
        }

        internal void RegisterExpandoAttribute(
            string controlID,
        ...
        {
            RegisterClientCall(
                ClientAPIRegisterType.ExpandoAttribute,
                controlID,
                attributeName,
                attributeValue
            );
    ...
    public class StaticPartialCachingControl : BasePartialCachingControl
    {
        ...
        ///    <para>[To be supplied.]</para>
        /// </devdoc>
        public StaticPartialCachingControl(
            string ctrlID,
            string guid,
            int duration,
            string varyByParams,
        ...
        internal override Control CreateCachedControl()
        {
            ...
            else
            {
                ...
                cachedControl = (Control)
                    HttpRuntime.CreatePublicInstance(_createCachedControlType, _args);
            }
    ...
    internal class ControlCachedVary
    {
        ...
        {
            get { return _cachedVaryId; }
        }

        internal ControlCachedVary(
            string[] varyByParams,
            string[] varyByControls,
            string varyByCustom
        )
