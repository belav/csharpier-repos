    ...
    public struct FontUnit
    {
        ...
        public FontUnit(string value, CultureInfo culture)
        {
            ...
            if (!String.IsNullOrEmpty(value))
            {
                ...
                {
                    if (
                        String.Equals(value, "xx-small", StringComparison.OrdinalIgnoreCase)
                    ...
                    )
                    {
                        ...
                        String.Equals(value, "x-small", StringComparison.OrdinalIgnoreCase)
                    ...
                    )
                    {
                        ...
                        String.Equals(value, "x-large", StringComparison.OrdinalIgnoreCase)
                    ...
                    )
                    {
                        ...
                        String.Equals(value, "xx-large", StringComparison.OrdinalIgnoreCase)
