...
namespace System.Web.UI.WebControls
{
    ...
    [
        ...
        Designer(
            "System.Web.UI.Design.WebControls.XmlDataSourceDesigner, " + AssemblyRef.SystemDesign
        ),
        ParseChildren(true),
    ...
    public class XmlDataSource : HierarchicalDataSourceControl, IDataSource, IListSource
    {
        ...
        {
            get { return (string)ViewState["CacheKeyContext "] ?? String.Empty; }
                ...
                if (Data != value)
                {
                    if (_disallowChanges)
                    {
                        throw new InvalidOperationException(
                            SR.GetString(SR.XmlDataSource_CannotChangeWhileLoading, "Data", ID)
                        );
                    }
                    _data = value;
                    _xmlDocument = null;
        ...
        [
            DefaultValue(""),
            Editor(
                "System.Web.UI.Design.XmlDataFileEditor, " + AssemblyRef.SystemDesign,
                typeof(UITypeEditor)
            ),
            WebCategory("Data"),
        ...
        public virtual string DataFile
        {
            ...
            set
            {
                if (DataFile != value)
                {
                    ...
                    {
                        throw new InvalidOperationException(
                            SR.GetString(SR.XmlDataSource_CannotChangeWhileLoading, "DataFile", ID)
                        );
                    }
                    _dataFile = value;
                    _xmlDocument = null;
        ...
        internal bool IsModifiable
        {
            ...
            {
                return (
                    String.IsNullOrEmpty(TransformFile)
        ...
        public virtual string Transform
        {
            ...
            set
            {
                ...
                if (Transform != value)
                {
                    ...
                    {
                        throw new InvalidOperationException(
                            SR.GetString(SR.XmlDataSource_CannotChangeWhileLoading, "Transform", ID)
                        );
                    }
                    _transform = value;
                    _xmlDocument = null;
        ...
        [
            DefaultValue(""),
            Editor(
                "System.Web.UI.Design.XslTransformFileEditor, " + AssemblyRef.SystemDesign,
                typeof(UITypeEditor)
            ),
            WebCategory("Data"),
            ...
            set
            {
                if (TransformFile != value)
                {
                    if (_disallowChanges)
                    {
                        throw new InvalidOperationException(
                            SR.GetString(
                                SR.XmlDataSource_CannotChangeWhileLoading,
                                "TransformFile",
                                ID
                            )
                        );
        ...
        public virtual string XPath
        {
            ...
            set
            {
                if (XPath != value)
                {
                    ...
                    {
                        throw new InvalidOperationException(
                            SR.GetString(SR.XmlDataSource_CannotChangeWhileLoading, "XPath", ID)
                        );
                    }
                    _xPath = value;
                    OnDataSourceChanged(EventArgs.Empty);
        ...
        [SuppressMessage(
            ...
            Justification = "This is specifically on XmlDataSource type which is not a com interop type."
        )]
        internal string CreateCacheKey()
        {
            ...
            if (includeUniqueID)
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.XmlDataSource_NeedUniqueIDForCache)
                    );
                }
                sb.Append(uniqueID);
            }
        ...
        private XmlReader GetReader(
            string path,
            string content,
            out CacheDependency cacheDependency
        )
        {
            ...
            if (path.Length != 0)
            {
                ...
                if (success)
                {
                    if (uri.Scheme == Uri.UriSchemeHttp)
                    {
                        ...
                        {
                            throw new InvalidOperationException(
                                SR.GetString(SR.XmlDataSource_NoWebPermission, uri.PathAndQuery, ID)
                            );
                        }
                ...
                if (virtualPath != null && DesignMode)
                {
                    ...
                    throw new NotSupportedException(
                        SR.GetString(SR.XmlDataSource_DesignTimeRelativePathsNotSupported, ID)
                    );
                }

                Stream dataStream = OpenFileAndGetDependency(
                    virtualPath,
                    physicalPath,
                    out cacheDependency
                );
        ...
        private string GetWriteableDataFile()
        {
            if (DataFile.Length != 0)
            {
                ...
                if (HostingEnvironment.UsingMapPathBasedVirtualPathProvider)
                {
                    ...
                    {
                        physicalPath = virtualPath.MapPathInternal(
        ...
        public XmlDocument GetXmlDocument()
        {
            ...
            if (_xmlDocument == null)
            {
                ...
                PopulateXmlDocument(
                    _xmlDocument,
                    out dataCacheDependency,
                    out transformCacheDependency
                );
                ...
                if (cacheKey != null)
                {
                    ...
                    if (dataCacheDependency != null)
                    {
                        if (transformCacheDependency != null)
                        {
                            ...
                            AggregateCacheDependency aggregateDependency =
        ...
        private void PopulateXmlDocument(
            ...
            out CacheDependency dataCacheDependency,
            out CacheDependency transformCacheDependency
        )
        {
...
#pragma warning restore 0618
                    if (transform != null)
                    {
                        ...
                        // from the compiler.
                        dataReader = transform.Transform(
                            tempDocument,
                    ...
                    else
                    {
                        ...
                        XslCompiledTransform compiledTransform =
                            XmlUtils.CreateXslCompiledTransform(transformReader);
        ...
        public void Save()
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.XmlDataSource_SaveNotAllowed, ID)
                );
            }
            ...
            Debug.Assert(
                !String.IsNullOrEmpty(writeableDataFile),
                "Did not expect WriteableDataFile to be empty in Save()"
            );
