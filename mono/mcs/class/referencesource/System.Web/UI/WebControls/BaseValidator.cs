...
namespace System.Web.UI.WebControls
{
    ...
    [
        ...
        Designer(
            "System.Web.UI.Design.WebControls.BaseValidatorDesigner, " + AssemblyRef.SystemDesign
        ),
    ]
...
function ValidatorOnSubmit() {
    if (Page_ValidationActive) {
                ...
                if (RenderUplevel)
                {
                    ...
                    if (display != ValidatorDisplay.Static)
                    {
                        AddExpandoAttribute(
                            ...
                            id,
                            "display",
                            PropertyConverter.EnumToString(typeof(ValidatorDisplay), display),
                            false
                        );
                    }
                    if (!IsValid)
        ...
        internal void AddExpandoAttribute(
        ...
        internal static void AddExpandoAttribute(
            Control control,
            HtmlTextWriter writer,
            string controlId,
            string attributeName,
        ...
        )
        {
            ...
            else
            {
                Debug.Assert(
                    ...
                    "The writer must have been passed in the Unobtrusive mode"
                );
                ...
                else
                {
                    ...
                    ValidatorCompatibilityHelper.RegisterExpandoAttribute(
                        control,
                        controlId,
                        attributeName,
                        attributeValue,
        ...
        protected virtual bool ControlPropertiesValid()
        {
            ...
            if (controlToValidate.Length == 0)
            {
                throw new HttpException(SR.GetString(SR.Validator_control_blank, ID));
            }
...
",
        ...
        public void Validate()
        {
            ...
            Debug.Trace(
                ...
                "id:" + ID + ", evaluateIsValid = " + IsValid.ToString()
            );
            if (!IsValid)
            {
                Page page = Page;
