    ...
    public abstract class HierarchicalDataBoundControl : BaseDataBoundControl
    {
        ...
        private IHierarchicalDataSource ConnectToHierarchicalDataSource()
        {
            ...
            if ((_currentHierarchicalDataSource != null) && (_currentDataSourceIsFromControl))
            {
                ...
                _currentHierarchicalDataSource.DataSourceChanged -= new EventHandler(
                    OnDataSourceChanged
                );
            }
        ...
        protected virtual HierarchicalDataSourceView GetData(string viewPath)
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.HierarchicalDataControl_ViewNotFound, ID)
                );
            }
            return view;
        }
            ...
            if (dataSourceID.Length != 0)
            {
                ...
                if (control == null)
                {
                    throw new HttpException(
                        SR.GetString(
                            SR.HierarchicalDataControl_DataSourceDoesntExist,
                            ID,
                            dataSourceID
                        )
                    );
                ...
                if (ds == null)
                {
                    throw new HttpException(
                        SR.GetString(
                            SR.HierarchicalDataControl_DataSourceIDMustBeHierarchicalDataControl,
                            ID,
                            dataSourceID
                        )
                    );
        ...
        protected override void PerformSelect()
        {
            ...
            {
                HierarchicalDataBoundControlAdapter hierarchicalAdapter =
        ...
        protected override void ValidateDataSource(object dataSource)
        {
            ...
            throw new InvalidOperationException(
                SR.GetString(SR.HierarchicalDataBoundControl_InvalidDataSource)
            );
        }
    }
}
