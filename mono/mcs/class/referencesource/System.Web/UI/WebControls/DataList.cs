...
namespace System.Web.UI.WebControls
{
    ...
    [
        ...
        Editor(
            "System.Web.UI.Design.WebControls.DataListComponentEditor, " + AssemblyRef.SystemDesign,
            ...
            IWizardSideBarListControl
    {
        ...
        /// </devdoc>
        [WebCategory("Default"), DefaultValue(-1), WebSysDescription(SR.DataList_EditItemIndex)]
        ...
        /// </devdoc>
        [WebCategory("Layout"), DefaultValue(0), WebSysDescription(SR.DataList_RepeatColumns)]
            ...
            set
            {
                if ((value == RepeatLayout.UnorderedList) || (value == RepeatLayout.OrderedList))
                {
                    throw new ArgumentOutOfRangeException(
                        "value",
                        SR.GetString(SR.DataList_LayoutNotSupported, value)
                    );
                }
            ...
            get
            {
                if (DataKeyField.Length == 0)
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.DataList_DataKeyFieldMustBeSpecified, ID)
                    );
                }
        ...
        /// </devdoc>
        [WebCategory("Action"), WebSysDescription(SR.DataList_OnItemCommand)]
        ...
        /// <devdoc>
        /// </devdoc>
        private DataListItem CreateItem(
            int itemIndex,
            ListItemType itemType,
            bool dataBind,
            object dataItem
        ...
        {
            DataListCommandEventHandler onCancelCommandHandler = (DataListCommandEventHandler)
                Events[EventCancelCommand];
            if (onCancelCommandHandler != null)
                onCancelCommandHandler(this, e);
        }
        ...
        {
            DataListCommandEventHandler onDeleteCommandHandler = (DataListCommandEventHandler)
                Events[EventDeleteCommand];
            if (onDeleteCommandHandler != null)
                onDeleteCommandHandler(this, e);
        }
        ...
        {
            DataListCommandEventHandler onEditCommandHandler = (DataListCommandEventHandler)
                Events[EventEditCommand];
            if (onEditCommandHandler != null)
                onEditCommandHandler(this, e);
        }
        ...
        {
            DataListCommandEventHandler onItemCommandHandler = (DataListCommandEventHandler)
        ...
        {
            DataListItemEventHandler onItemCreatedHandler = (DataListItemEventHandler)
        ...
        {
            DataListItemEventHandler onItemDataBoundHandler = (DataListItemEventHandler)
        ...
        {
            DataListCommandEventHandler onUpdateCommandHandler = (DataListCommandEventHandler)
                Events[EventUpdateCommand];
            if (onUpdateCommandHandler != null)
                onUpdateCommandHandler(this, e);
        }
                        ...
                        while (controlEnum.MoveNext())
                        {
                            ...
                            if (c is Table)
                            {
                                ...
                                while (rowEnum.MoveNext())
                                {
                                    ...
                                    ((TableRow)rowEnum.Current)
                                        .MergeStyle(compositeStyle);
                                }
                                break;
                            }
                        }
        ...
        protected override object SaveViewState()
        {
            ...
            object separatorStyleState =
                (separatorStyle != null) ? ((IStateManager)separatorStyle).SaveViewState() : null;
        ...
        {
            add { ItemCommand += new DataListCommandEventHandler(value); }
            remove { ItemCommand -= new DataListCommandEventHandler(value); }
        }
