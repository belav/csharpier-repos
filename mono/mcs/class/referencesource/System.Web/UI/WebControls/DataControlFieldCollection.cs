...
namespace System.Web.UI.WebControls
{
    ...
    public sealed class DataControlFieldCollection : StateManagedCollection
    {
        ...
        {
            get { return ((IList)this)[index] as DataControlField; }
        }
            ...
            switch (index)
            {
                ...
                default:
                    throw new ArgumentOutOfRangeException(
                        SR.GetString(SR.DataControlFieldCollection_InvalidTypeIndex)
                    );
            }
        }
        ...
        protected override void OnValidate(object o)
        {
            ...
            if (!(o is DataControlField))
                throw new ArgumentException(
                    SR.GetString(SR.DataControlFieldCollection_InvalidType)
                );
        }
