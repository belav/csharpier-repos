...
namespace System.Web.UI.WebControls
{
    ...
    internal class ContentBuilderInternal : TemplateBuilder
    {
        ...
        {
            get { return _contentPlaceHolderFilter; }
        }
        ...
        )
        {
            ...
            ParsedAttributeCollection parsedAttributes =
                ConvertDictionaryToParsedAttributeCollection(attribs);
            foreach (
                FilteredAttributeDictionary filteredAttributes in parsedAttributes.GetFilteredAttributeDictionaries()
            )
            {
                    ...
                    if (StringUtil.EqualsIgnoreCase(key, _contentPlaceHolderIDPropName))
                    {
                        if (_contentPlaceHolder != null)
                        {
                            throw new HttpException(
                                SR.GetString(SR.Content_only_one_contentPlaceHolderID_allowed)
                            );
                        }
