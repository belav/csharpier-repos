...
namespace System.Web.UI.WebControls
{
    ...
    public class TableCell : WebControl
    {
        ...
        /// </devdoc>
        [WebCategory("Appearance"), DefaultValue(0), WebSysDescription(SR.TableCell_ColumnSpan)]
        ...
        /// </devdoc>
        [WebCategory("Layout"), DefaultValue(0), WebSysDescription(SR.TableCell_RowSpan)]
        ...
        ///    </para>
        /// </devdoc>
        [WebCategory("Layout"), DefaultValue(true), WebSysDescription(SR.TableCell_Wrap)]
        ...
        protected override void AddAttributesToRender(HtmlTextWriter writer)
        {
            ...
            if (span > 0)
                writer.AddAttribute(
                    ...
                    span.ToString(NumberFormatInfo.InvariantInfo)
                );
                ...
                foreach (string id in arr)
                {
                    ...
                    if (headerCell == null)
                    {
                        throw new HttpException(
                            SR.GetString(SR.TableCell_AssociatedHeaderCellNotFound, id)
                        );
                    }
                    if (first)
                    {
