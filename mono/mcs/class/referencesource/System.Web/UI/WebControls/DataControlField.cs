    ...
    public abstract class DataControlField : IStateManager, IDataSourceViewSchemaAccessor
    {
        ...
        protected virtual object SaveViewState()
        {
            ...
            object itemStyleState =
                (_itemStyle != null) ? ((IStateManager)_itemStyle).SaveViewState() : null;
            ...
            object controlStyleState =
                (_controlStyle != null) ? ((IStateManager)_controlStyle).SaveViewState() : null;
        ...
        public virtual void ValidateSupportsCallback()
        {
            throw new NotSupportedException(
                SR.GetString(SR.DataControlField_CallbacksNotSupported, Control.ID)
            );
        }
        ...
        {
            get { return _dataSourceViewSchema; }
            set { _dataSourceViewSchema = value; }
        }
        #endregion
    }
}
