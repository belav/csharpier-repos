...
namespace System.Web.UI.WebControls
{
    public class DetailsViewRowsGenerator : AutoFieldsGenerator
    {
        ...
        )
        {
            ...
            //The base class ensures that the AutoGeneratedFieldProperties collection is reset before this
            // method is called.
            //However we are doing this again in here because we have another caller
            // DetailsView.CreateAutoGeneratedRows which is
            ...
            if ((generatedFields.Count == 0) && throwException)
            {
                ...
                throw new InvalidOperationException(
                    SR.GetString(SR.DetailsView_NoAutoGenFields, detailsView.ID)
                );
            }
        ...
        {
            if (
                detailsView.RenderingCompatibility < VersionUtil.Framework45
