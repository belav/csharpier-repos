...
namespace System.Web.UI.WebControls
{
    ...
    public sealed class MenuItem : IStateManager, ICloneable
    {
        ...
        internal string FormattedText
        {
            get
            {
                ...
                )
                {
                    return String.Format(
                        CultureInfo.CurrentCulture,
                        _owner.DynamicItemFormatString,
                        Text
                    );
                }
                else
        ...
        internal string InternalValuePath
        {
            get
            {
                ...
                if (_parent != null)
                {
                    ...
                    pathParts.Reverse();
                    _internalValuePath = String.Join(
                        TreeView.InternalPathSeparator.ToString(),
                        pathParts.ToArray()
                    );
                    return _internalValuePath;
                }
        ...
        {
            get { return IsEnabledNoOwner && Owner.IsEnabled; }
        }
                ...
                if (_parent != null)
                {
                    ...
                    _valuePath =
                        ((parentPath.Length == 0) && (_parent.Depth == -1))
                            ? Value
                            : parentPath + _owner.PathSeparator + Value;
                    return _valuePath;
                }
                else
                {
                ...
                else
                {
                    ...
                    for (int i = 0; i < ChildItems.Count; i++)
                    {
                        ...
                        )
                        {
                            ...
                            {
                                ChildItems[i]
                                    .RenderItem(writer, i, enabled, _owner.Orientation, staticOnly);
                            }
                        }
                        else
                        {
        ...
        )
        {
            ...
            bool staticTopSeparator =
                (depth < _owner.StaticDisplayLevels)
                && (_owner.StaticTopSeparatorImageUrl.Length != 0);
            bool dynamicTopSeparator =
                (depth >= _owner.StaticDisplayLevels)
            ...
            if (staticTopSeparator || dynamicTopSeparator)
            {
                ...
                if (staticTopSeparator)
                {
                    writer.AddAttribute(
                        ...
                        _owner.ResolveClientUrl(_owner.StaticTopSeparatorImageUrl)
                    );
                }
                else
                {
                    writer.AddAttribute(
                        HtmlTextWriterAttribute.Src,
                        _owner.ResolveClientUrl(_owner.DynamicTopSeparatorImageUrl)
                    );
                }
            ...
            if (
                (mergedStyle != null)
                && !mergedStyle.ItemSpacing.IsEmpty
                && ((depth != 0) || (position != 0))
            )
            {
            ...
            if (enabled && Selectable)
            {
                ...
                if (NavigateUrl.Length > 0)
                {
                    writer.AddAttribute(
                        ...
                        _owner.ResolveClientUrl(NavigateUrl)
                    );
            ...
            bool shouldRenderExpandImage = (
                (depthPlusOne >= _owner.StaticDisplayLevels) && (depthPlusOne < _owner.MaximumDepth)
            );
                    ...
                    while (parent != null)
                    {
                        if (
                            ...
                            || (
                                ...
                                && (
                                    parent
                                    != parent.Parent.ChildItems[parent.Parent.ChildItems.Count - 1]
                                )
                            )
                        )
                        {
            ...
            if (shouldRenderExpandImage && expandImageUrl.Length > 0)
            {
                ...
                if (depth < _owner.StaticDisplayLevels)
                {
                    writer.AddAttribute(
                        ...
                        String.Format(
                            CultureInfo.CurrentCulture,
                            _owner.StaticPopOutImageTextFormatString,
                            Text
                        )
                    );
                }
                else if (depth >= _owner.StaticDisplayLevels)
                {
                    writer.AddAttribute(
                        ...
                        String.Format(
                            CultureInfo.CurrentCulture,
                            _owner.DynamicPopOutImageTextFormatString,
                            Text
                        )
                    );
                }
            ...
            bool staticBottomSeparator =
                (depth < _owner.StaticDisplayLevels)
                && (_owner.StaticBottomSeparatorImageUrl.Length != 0);
            bool dynamicBottomSeparator =
                (depth >= _owner.StaticDisplayLevels)
            ...
            if (separator || staticBottomSeparator || dynamicBottomSeparator)
            {
                ...
                if (separator)
                {
                    writer.AddAttribute(
                        HtmlTextWriterAttribute.Src,
                        _owner.ResolveClientUrl(SeparatorImageUrl)
                    );
                }
                else if (staticBottomSeparator)
                {
                    writer.AddAttribute(
                        HtmlTextWriterAttribute.Src,
                        _owner.ResolveClientUrl(_owner.StaticBottomSeparatorImageUrl)
                    );
                }
                else
                {
                    writer.AddAttribute(
                        HtmlTextWriterAttribute.Src,
                        _owner.ResolveClientUrl(_owner.DynamicBottomSeparatorImageUrl)
                    );
                }
                writer.AddAttribute(HtmlTextWriterAttribute.Alt, String.Empty);
                writer.RenderBeginTag(HtmlTextWriterTag.Img);
