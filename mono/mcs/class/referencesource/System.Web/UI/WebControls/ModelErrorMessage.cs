...
namespace System.Web.UI.WebControls
{
    ...
    [
        ToolboxData(
            "<{0}:ModelErrorMessage runat=\"server\" Key=\"ModelStateKey\"></{0}:ModelErrorMessage>"
        ),
        DefaultProperty("Key"),
        ParseChildren(true),
    ...
    public class ModelErrorMessage : Label
    {
        ...
        public string ModelStateKey
        {
            ...
            set { ViewState["ModelStateKey"] = value; }
        }
        ...
        protected internal override void OnPreRender(EventArgs e)
        {
            ...
            {
                ModelError error = modelState.Errors.FirstOrDefault(modelError =>
