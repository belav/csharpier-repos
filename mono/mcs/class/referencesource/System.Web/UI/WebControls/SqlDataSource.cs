...
namespace System.Web.UI.WebControls
{
    ...
    [
        ...
        Designer(
            "System.Web.UI.Design.WebControls.SqlDataSourceDesigner, " + AssemblyRef.SystemDesign
        ),
        ParseChildren(true),
    ...
    public class SqlDataSource : DataSourceControl
    {
        ...
        {
            get { return GetView().CancelSelectOnNullParameter; }
            set { GetView().CancelSelectOnNullParameter = value; }
        }
        ...
        {
            get { return (_connectionString == null ? String.Empty : _connectionString); }
            set
            {
        ...
        public string DeleteCommand
        {
            ...
            set { GetView().DeleteCommand = value; }
        }
        ...
        {
            get { return GetView().DeleteCommandType; }
            set { GetView().DeleteCommandType = value; }
        }
        ...
        public string InsertCommand
        {
            ...
            set { GetView().InsertCommand = value; }
        }
        ...
        {
            get { return GetView().InsertCommandType; }
            set { GetView().InsertCommandType = value; }
        }
        ...
        {
            get { return (_providerName == null ? String.Empty : _providerName); }
            set
            {
        ...
        public string SelectCommand
        {
            ...
            set { GetView().SelectCommand = value; }
        }
        ...
        {
            get { return GetView().SelectCommandType; }
            set { GetView().SelectCommandType = value; }
        }
            ...
            get
            {
                ...
                if (sqlCache == null)
                {
                    throw new NotSupportedException(
                        SR.GetString(SR.SqlDataSource_SqlCacheDependencyNotSupported, ID)
                    );
                }
                return sqlCache;
            }
        ...
        {
            get { return SqlDataSourceCache.SqlCacheDependency; }
            set { SqlDataSourceCache.SqlCacheDependency = value; }
        }
        ...
        public string UpdateCommand
        {
            ...
            set { GetView().UpdateCommand = value; }
        }
        ...
        {
            get { return GetView().UpdateCommandType; }
            set { GetView().UpdateCommandType = value; }
        }
        ...
        [SuppressMessage(
            ...
            Justification = "This is specifically on SqlDataSource type which is not a com interop type."
        )]
            ...
            if (_providerFactory == null)
            {
                ...
                if (!HttpRuntime.DisableProcessRequestInApplicationTrust)
                {
                    ...
                    if (
                        ...
                        && !HttpRuntime.HasDbPermission(_providerFactory)
                    )
                    {
                        throw new HttpException(
                            SR.GetString(
                                SR.SqlDataSource_NoDbPermission,
                                _providerFactory.GetType().Name,
                                ID
                            )
                        );
                    }
        ...
        /// </devdoc>
        internal virtual void SaveDataToCache(
            int startRowIndex,
            int maximumRows,
            object data,
