...
namespace System.Web.UI.WebControls.Adapters
{
    ...
    public class WmlRadioButtonAdapter : WmlCheckBoxAdapter, IPostBackDataHandler
    {
        ...
        {
            get { return (RadioButton)base.Control; }
        }

        protected string GroupFormVariable
        {
            get { return _groupPrefix + Control.UniqueGroupName; }
        }
        ...
        {
            Debug.Assert(
                RadioButtonGroups.Contains(groupName),
                "Attemping to get group name without procesing group"
            );
        ...
        protected override string InputElementText
        {
            get
            {
                return Control.Checked
                    ? RadioButtonAdapter.AltSelectedText
                    : RadioButtonAdapter.AltUnselectedText;
            }
        }
        ...
        private RadioButtonGroup RenderAsGroup(RadioButton r)
        {
            ...
            foreach (Control c in r.Parent.Controls)
            {
                ...
                if (radioSibling != null && radioSibling.UniqueGroupName == r.UniqueGroupName)
                {
                    ...
                    startedSequence
                    && (literalSibling == null || !IsWhiteSpace(literalSibling.Text))
                )
                {
