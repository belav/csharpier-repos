namespace System.Web.UI.WebControls
{
    ...
    /// <summary>
    /// Used to invoke <see cref='System.Web.UI.Page.UpdateModel' />/<see
    // cref='System.Web.UI.Page.TryUpdateModel' />
    ...
    /// data binding can have a parameter of type <see
    // cref='System.Web.UI.WebControls.ModelMethodContext' />
    /// in the above methods and use it to invoke the above methods. Alternately instead of a method
    // parameter,
    ...
    public class ModelMethodContext
    {
        ...
        {
            get { return _page.ModelState; }
        }

        /// <summary>
        /// Gets the ModelMethodContext corresponding to the <see cref='System.Web.UI.Page' /> from <see
        // cref='System.Web.HttpContext.Current' />.
