...
namespace System.Web.UI.WebControls
{
    ...
    internal class ContentPlaceHolderBuilder : ControlBuilder
    {
        ...
        )
        {
            ...
            if (String.IsNullOrEmpty(ID))
            {
                throw new HttpException(
                    SR.GetString(SR.Control_Missing_Attribute, "ID", type.Name)
                );
            }
            ...
            if (masterPageParser.PlaceHolderList.Contains(Name))
                throw new HttpException(
                    SR.GetString(SR.ContentPlaceHolder_duplicate_contentPlaceHolderID, Name)
                );
        ...
        public override object BuildObject()
        {
            ...
            {
                ITemplate tpl = (
                    (System.Web.UI.ITemplate)(masterPage.ContentTemplates[_contentPlaceHolderID])
                );
        ...
        private bool PageProvidesMatchingContent(MasterPage masterPage)
        {
            if (
                masterPage != null
                && masterPage.ContentTemplates != null
    ...
    [Designer(
        "System.Web.UI.Design.WebControls.ContentPlaceHolderDesigner, " + AssemblyRef.SystemDesign
    )]
