...
namespace System.Web.UI.WebControls
{
    ...
    [
        ...
        Designer(
            "System.Web.UI.Design.WebControls.ListControlDesigner, " + AssemblyRef.SystemDesign
        )
    ]
    public abstract class ListControl : DataBoundControl, IEditableTextControl
    {
        ...
        internal bool SaveSelectedIndicesViewState
        {
            get
            {
                ...
                if (
                    (Events[EventSelectedIndexChanged] != null)
                ...
                if (value < -1)
                {
                    ...
                    else
                    {
                        throw new ArgumentOutOfRangeException(
                            "value",
                            SR.GetString(SR.ListControl_SelectionOutOfRange, ID, "SelectedIndex")
                        );
                    }
                }
            ...
            set
            {
                if (Items.Count != 0)
                {
                    ...
                    if (loaded && selectItem == null)
                    {
                        throw new ArgumentOutOfRangeException(
                            "value",
                            SR.GetString(SR.ListControl_SelectionOutOfRange, ID, "SelectedValue")
                        );
                    }
        ...
        ///    postback.
        /// </devdoc>
        [WebCategory("Action"), WebSysDescription(SR.ListControl_OnSelectedIndexChanged)]
        ...
        /// </devdoc>
        [WebCategory("Action"), WebSysDescription(SR.ListControl_TextChanged)]
        ...
        protected internal override void PerformDataBinding(IEnumerable dataSource)
        {
            ...
            if (dataSource != null)
            {
                ...
                foreach (object dataItem in dataSource)
                {
                    ...
                    if (fieldsSpecified)
                    {
                        ...
                        {
                            item.Text = DataBinder.GetPropertyValue(
                                dataItem,
                                textField,
                                textFormat
                            );
            ...
            if (cachedSelectedValue != null)
            {
                ...
                if (
                    (cachedSelectedIndex != -1) && (cachedSelectedIndex != cachedSelectedValueIndex)
                )
                {
                    throw new ArgumentException(
                        SR.GetString(
                            SR.Attributes_mutually_exclusive,
                            "SelectedIndex",
                            "SelectedValue"
                        )
                    );
