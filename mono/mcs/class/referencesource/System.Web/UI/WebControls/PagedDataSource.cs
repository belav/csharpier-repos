...
namespace System.Web.UI.WebControls
{
    ...
    public sealed class PagedDataSource : ICollection, ITypedList
    {
        ...
        {
            get { return IsPagingEnabled && allowServerPaging; }
        }
        ...
        private sealed class EnumeratorOnICollection : IEnumerator
        {
            ...
            public object Current
            {
                get { return collectionEnum.Current; }
            }
                ...
                get
                {
                    if (index < 0)
                    {
                        throw new InvalidOperationException(
                            SR.GetString(SR.Enumerator_MoveNext_Not_Called)
                        );
                    }
