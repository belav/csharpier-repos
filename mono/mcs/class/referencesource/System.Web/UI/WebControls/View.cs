...
namespace System.Web.UI.WebControls
{
    ...
    public class View : Control
    {
        ...
        /// </devdoc>
        [WebCategory("Action"), WebSysDescription(SR.View_Activate)]
        public event EventHandler Activate
        {
            add { Events.AddHandler(_eventActivate, value); }
            remove { Events.RemoveHandler(_eventActivate, value); }
        }

        /// <devdoc>
        ///    <para>Occurs when the view is deactivated.</para>
        /// </devdoc>
        [WebCategory("Action"), WebSysDescription(SR.View_Deactivate)]
        public event EventHandler Deactivate
        {
            add { Events.AddHandler(_eventDeactivate, value); }
            remove { Events.RemoveHandler(_eventDeactivate, value); }
        }
