...
namespace System.Web.UI.WebControls
{
    ...
    public partial class Menu
    {
        ...
        internal class MenuRendererStandards : MenuRenderer
        {
            ...
            public MenuRendererStandards(Menu menu)
                : base(menu) { }
            ...
            {
                get { return Menu.SpacerImageUrl; }
            }
            ...
            private StyleBlock CreateStyleBlock()
            {
                ...
                styleBlock.AddStyleDefinition("#{0}", Menu.ClientID).AddStyles(menuStyle);

                // Image styles

                styleBlock
                    .AddStyleDefinition("#{0} img.icon", Menu.ClientID)
                    .AddStyle(HtmlTextWriterStyle.BorderStyle, "none")
                    .AddStyle(HtmlTextWriterStyle.VerticalAlign, "middle");

                styleBlock
                    .AddStyleDefinition("#{0} img.separator", Menu.ClientID)
                    .AddStyle(HtmlTextWriterStyle.BorderStyle, "none")
                ...
                {
                    styleBlock
                        .AddStyleDefinition("#{0} img.horizontal-separator", Menu.ClientID)
                        .AddStyle(HtmlTextWriterStyle.BorderStyle, "none")
                        .AddStyle(HtmlTextWriterStyle.VerticalAlign, "middle");
                }
                ...
                styleBlock
                    .AddStyleDefinition("#{0} ul", Menu.ClientID)
                ...
                styleBlock
                    .AddStyleDefinition("#{0} ul.static", Menu.ClientID)
                    .AddStyles(Menu._staticMenuStyle);

                var ulDynamic = styleBlock
                    .AddStyleDefinition("#{0} ul.dynamic", Menu.ClientID)
                ...
                {
                    ulDynamic.AddStyle(
                        HtmlTextWriterStyle.MarginLeft,
                        Menu.DynamicHorizontalOffset.ToString(CultureInfo.InvariantCulture) + "px"
                    );
                }
                ...
                {
                    ulDynamic.AddStyle(
                        HtmlTextWriterStyle.MarginTop,
                        Menu.DynamicVerticalOffset.ToString(CultureInfo.InvariantCulture) + "px"
                    );
                }
                ...
                if (Menu._levelStyles != null)
                {
                    ...
                    {
                        styleBlock
                            .AddStyleDefinition("#{0} ul.level{1}", Menu.ClientID, index++)
                            .AddStyles(style);
                    }
                }
                ...
                styleBlock
                    .AddStyleDefinition("#{0} a", Menu.ClientID)
                ...
                if (
                    ...
                    && (
                        (Menu._staticItemStyle == null)
                        || (Menu._staticItemStyle.HorizontalPadding.IsEmpty)
                    )
                )
                {
                    menuItemStatic
                        .AddStyle(HtmlTextWriterStyle.PaddingLeft, "0.15em")
                ...
                {
                    styleBlock
                        .AddStyleDefinition("#{0} a.popout", Menu.ClientID)
                        .AddStyle(
                            "background-image",
                            "url(\""
                                + Menu.ResolveClientUrl(StaticPopOutUrl).Replace("\"", "\\\"")
                                + "\")"
                        )
                ...
                if (!String.IsNullOrEmpty(DynamicPopOutUrl))
                {
                    ...
                    {
                        styleBlock
                            .AddStyleDefinition("#{0} a.popout-dynamic", Menu.ClientID)
                            .AddStyle(
                                "background",
                                "url(\""
                                    + Menu.ResolveClientUrl(DynamicPopOutUrl).Replace("\"", "\\\"")
                ...
                var styleBlockStyles = styleBlock
                    .AddStyleDefinition("#{0} a.dynamic", Menu.ClientID)
                ...
                if (Menu._levelMenuItemStyles != null || Menu.StaticDisplayLevels > 1)
                {
                    ...
                    {
                        var style = styleBlock.AddStyleDefinition(
                            "#{0} a.level{1}",
                            Menu.ClientID,
                            index + 1
                        );
                        ...
                        if (index > 0 && index < Menu.StaticDisplayLevels)
                        {
                            ...
                            if (!indent.IsEmpty && indent.Value != 0)
                            {
                                ...
                                style.AddStyle(
                                    HtmlTextWriterStyle.PaddingLeft,
                        ...
                        if (
                            Menu._levelMenuItemStyles != null
                            && index < Menu._levelMenuItemStyles.Count
                        )
                        {
                            var levelItemStyle = Menu._levelMenuItemStyles[index];
                            style
                                .AddStyles(levelItemStyle)
                                .AddStyles(levelItemStyle.HyperLinkStyle);
                        }
                    }
                }

                styleBlockStyles = styleBlock
                    .AddStyleDefinition("#{0} a.static.selected", Menu.ClientID)
                ...
                styleBlockStyles = styleBlock
                    .AddStyleDefinition("#{0} a.dynamic.selected", Menu.ClientID)
                ...
                styleBlock
                    .AddStyleDefinition("#{0} a.static.highlighted", Menu.ClientID)
                    .AddStyles(Menu._staticHoverStyle);

                styleBlock
                    .AddStyleDefinition("#{0} a.dynamic.highlighted", Menu.ClientID)
                ...
                if (Menu._levelSelectedStyles != null)
                {
                    ...
                    {
                        styleBlock
                            .AddStyleDefinition("#{0} a.selected.level{1}", Menu.ClientID, index++)
                            .AddStyles(style)
                            .AddStyles(style.HyperLinkStyle);
                    }
                }
            ...
            private string GetMenuItemCssClass(MenuItem item, int level)
            {
                ...
                if (ShouldHavePopOutImage(item))
                {
                    if (level > Menu.StaticDisplayLevels)
                    {
                        ...
                        {
                            cssClass =
                                (DynamicPopOutUrl == StaticPopOutUrl) ? "popout" : "popout-dynamic";
                        }
                    }
                ...
                string levelCssClass = GetCssClass(
                    level,
                    Menu.StaticMenuItemStyle,
                    Menu.DynamicMenuItemStyle,
                    Menu._levelMenuItemStyles
                );
            ...
            public override void PreRender(bool registerScript)
            {
                ...
                if (Menu.IncludeStyleBlock && Menu.Page.Header == null)
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.NeedHeader, "Menu.IncludeStyleBlock")
                    );
                }
            ...
            public override void RenderContents(HtmlTextWriter writer, bool staticOnly)
            {
                RenderItems(
                    writer,
                    staticOnly || Menu.DesignMode || !Menu.Enabled,
                    Menu.Items,
                    1,
                    !String.IsNullOrEmpty(Menu.AccessKey)
                );
            }
            ...
            )
            {
                ...
                needsAccessKey = RenderItemLinkAttributes(
                    writer,
                    item,
                    level,
                    cssClass,
            ...
            private void RenderItemIcon(HtmlTextWriter writer, MenuItem item)
            {
                ...
                writer.AddAttribute(
                    ...
                    Menu.ResolveClientUrl(item.ImageUrl)
                );
            ...
            private bool RenderItemLinkAttributes(
                HtmlTextWriter writer,
                MenuItem item,
                int level,
                string cssClass,
            ...
            )
            {
                ...
                if (String.IsNullOrEmpty(item.NavigateUrl))
                {
                    ...
                    writer.AddAttribute(
                        ...
                        GetPostBackEventReference(item)
                    );
                }
                // ...or direct link
                else
                {
                    writer.AddAttribute(
                        ...
                        Menu.ResolveClientUrl(item.NavigateUrl)
                    );
            ...
            private void RenderItemSeparatorImage(
                HtmlTextWriter writer,
                MenuItem item,
                string separatorImageUrl
            )
            {
                ...
                writer.AddAttribute(
                    HtmlTextWriterAttribute.Class,
                    IsDepthStatic(item) && Menu.Orientation == Orientation.Horizontal
            ...
            )
            {
                ...
                foreach (MenuItem item in items)
                {
                    ...
                    needsAccessKey = RenderItem(
                        writer,
                        item,
                        level,
                        GetMenuItemCssClass(item, level),
                        needsAccessKey
                    );
            ...
            private bool ShouldHavePopOutImage(MenuItem item)
            {
                return (item.ChildItems.Count > 0)
                    && IsChildDepthDynamic(item)
                    && !IsChildPastMaximumDepth(item);
            }
        }
    }
    ...
    internal class StyleBlock : Control
    {
        ...
        {
            return AddStyleDefinition(
                String.Format(CultureInfo.InvariantCulture, selectorFormat, args)
            );
        }
