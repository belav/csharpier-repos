...
namespace System.Web.UI.WebControls
{
    ...
    internal static class DataBoundControlHelper
    {
            ...
            while (foundControl == null && currentContainer != control.Page)
            {
                ...
                if (currentContainer == null)
                {
                    throw new HttpException(
                        SR.GetString(
                            SR.DataBoundControlHelper_NoNamingContainer,
        ...
        internal static bool IsBindableType(Type type, bool enableEnums)
        {
            ...
            {
                BindableTypeAttribute bindableTypeAttribute = (BindableTypeAttribute)
                    TypeDescriptor.GetAttributes(type)[typeof(BindableTypeAttribute)];
        ...
        internal static void ExtractValuesFromBindableControls(
        ...
        internal static void EnableDynamicData(INamingContainer control, string entityTypeName)
        {
            ...
            {
                Type dataControlExtensionsType = Assembly
                    .Load(AssemblyRef.SystemWebDynamicData)
                    .GetType("System.Web.UI.DataControlExtensions");
                s_enableDynamicDataMethod = dataControlExtensionsType.GetMethod(
                    "EnableDynamicData",
            ...
            if (entityType != null)
            {
                s_enableDynamicDataMethod.Invoke(
                    obj: null,
