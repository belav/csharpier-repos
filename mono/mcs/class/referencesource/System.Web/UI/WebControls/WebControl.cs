...
#pragma warning restore 0649
            ...
            set
            {
                ...
                if ((value != null) && (value.Length > 1))
                {
                    throw new ArgumentOutOfRangeException(
                        "value",
                        SR.GetString(SR.WebControl_InvalidAccessKey)
                    );
                }
        ...
        {
            get { return _disabledCssClass ?? String.Empty; }
        ...
        {
            get { return !flags[isWebControlDisabled]; }
            set
            {
        ...
        public bool HasAttributes
        {
            ...
            {
                return (
                    ((attrColl != null) && (attrColl.Count > 0))
                    || ((attrState != null) && (attrState.Count > 0))
                );
            }
        }
        ...
        protected virtual void AddAttributesToRender(HtmlTextWriter writer)
        {
            ...
            if (!Enabled)
            {
                ...
                if (
                    ...
                    && !String.IsNullOrEmpty(DisabledCssClass)
                )
                {
        ...
        internal void AddDisplayInlineBlockIfNeeded(HtmlTextWriter writer)
        {
            ...
            if (
                (!RequiresLegacyRendering || !EnableLegacyRendering)
                && (
        ...
        protected override void LoadViewState(object savedState)
        {
            if (savedState != null)
            {
                ...
                if (
                    ControlStyleCreated
                    || (ViewState[System.Web.UI.WebControls.Style.SetBitsKey] != null)
                )
                {
