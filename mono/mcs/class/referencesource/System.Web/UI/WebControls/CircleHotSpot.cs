...
namespace System.Web.UI.WebControls
{
    ...
    public sealed class CircleHotSpot : HotSpot
    {
        ...
        /// </devdoc>
        [DefaultValue(0), WebCategory("Appearance"), WebSysDescription(SR.CircleHotSpot_Radius)]
        public int Radius
        {
            get
            {
        ...
        [DefaultValue(0), WebCategory("Appearance"), WebSysDescription(SR.CircleHotSpot_X)]
        public int X
        {
            get
            {
        ...
        [DefaultValue(0), WebCategory("Appearance"), WebSysDescription(SR.CircleHotSpot_Y)]
        public int Y
        {
            get
            {
