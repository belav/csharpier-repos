    ...
    public class HyperLinkColumn : DataGridColumn
    {
        ...
        [
            ...
            DescriptionAttribute(
                "The formatting applied to the value bound to the NavigateUrl property."
            )
        ]
        ...
        protected virtual string FormatDataNavigateUrlValue(object dataUrlValue)
        {
            ...
            if (!DataBinder.IsNull(dataUrlValue))
            {
                ...
                {
                    formattedUrlValue = String.Format(
        ...
        public override void InitializeCell(TableCell cell, int columnIndex, ListItemType itemType)
        {
            ...
            if ((itemType != ListItemType.Header) && (itemType != ListItemType.Footer))
            {
                ...
                if ((DataNavigateUrlField.Length != 0) || (DataTextField.Length != 0))
                {
        ...
        {
            Debug.Assert(
                (DataTextField.Length != 0) || (DataNavigateUrlField.Length != 0),
