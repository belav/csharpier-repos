...
namespace System.Web.UI.WebControls
{
    ...
    public abstract class BaseCompareValidator : BaseValidator
    {
                ...
                if (type != ValidationDataType.String)
                {
                    ...
                    else if (type == ValidationDataType.Currency)
                    {
                        ...
                        AddExpandoAttribute(
                            ...
                            id,
                            "digits",
                            digits.ToString(NumberFormatInfo.InvariantInfo),
                            false
                        );
                        ...
                        if (groupSize > 0)
                        {
                            AddExpandoAttribute(
                                ...
                                id,
                                "groupsize",
                                groupSize.ToString(NumberFormatInfo.InvariantInfo),
                                false
                            );
                        }
                    }
                    else if (type == ValidationDataType.Date)
                    {
                        ...
                        AddExpandoAttribute(
                            ...
                            id,
                            "cutoffyear",
                            CutoffYear.ToString(NumberFormatInfo.InvariantInfo),
                            false
                        );
                        ...
                        AddExpandoAttribute(
                            ...
                            id,
                            "century",
                            century.ToString(NumberFormatInfo.InvariantInfo),
                            false
                        );
                    }
                }
                ...
                switch (type)
                {
                    ...
                    case ValidationDataType.Date:
                    {
                        ...
                        else
                        {
                            ...
                            if (
                                !(
                                    DateTimeFormatInfo.CurrentInfo.Calendar.GetType()
        ...
        private static object ConvertDate(string text, string dateElementOrder)
        {
            ...
            string dateYearFirstExpression =
        ...
        internal string ConvertCultureInvariantToCurrentCultureFormat(
