...
namespace System.Web.UI.WebControls
{
    ...
    public class BulletedList : ListControl, IPostBackEventHandler
    {
        ...
        {
            get { return new EmptyControlCollection(this); }
        }
        ...
        public virtual BulletedListDisplayMode DisplayMode
        {
            ...
            {
                if (
                    value < BulletedListDisplayMode.Text
                    || value > BulletedListDisplayMode.LinkButton
                )
                {
                    throw new ArgumentOutOfRangeException("value");
                }
        ...
        public override int SelectedIndex
        {
            ...
            {
                throw new NotSupportedException(
                    SR.GetString(SR.BulletedList_SelectionNotSupported)
                );
            }
        }
        ...
        public override string Text
        {
            ...
            set { throw new NotSupportedException(SR.GetString(SR.BulletedList_TextNotSupported)); }
        }

        /// <devdoc>
        ///    <para>Occurs when the a link button is clicked.</para>
        /// </devdoc>
        [WebCategory("Action"), WebSysDescription(SR.BulletedList_OnClick)]
        ...
        protected override void AddAttributesToRender(HtmlTextWriter writer)
        {
            ...
            switch (BulletStyle)
            {
                ...
                case BulletStyle.CustomImage:
                    ...
                    writer.AddStyleAttribute(
                        HtmlTextWriterStyle.ListStyleImage,
            ...
            if ((addBulletNumber == true) && (firstBulletNumber != 1))
            {
                writer.AddAttribute(
                    "start",
                    firstBulletNumber.ToString(CultureInfo.InvariantCulture)
                );
            }
        ...
        private string GetPostBackEventReference(string eventArgument)
        {
            ...
            {
                return ClientScriptManager.JscriptPrefix
                    + Util.GetClientValidatedPostback(this, ValidationGroup, eventArgument);
            }
            else
            {
            ...
            switch (DisplayMode)
            {
                ...
                case BulletedListDisplayMode.LinkButton:
                    if (_cachedIsEnabled && item.Enabled)
                    {
                        writer.AddAttribute(
                            HtmlTextWriterAttribute.Href,
                            GetPostBackEventReference(index.ToString(CultureInfo.InvariantCulture))
                        );
                    }
                    else
                    {
        ...
        protected virtual void RaisePostBackEvent(string eventArgument)
        {
            ...
            OnClick(
                new BulletedListEventArgs(Int32.Parse(eventArgument, CultureInfo.InvariantCulture))
            );
        }
