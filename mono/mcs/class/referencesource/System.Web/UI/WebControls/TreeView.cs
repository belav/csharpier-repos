...
";
        ...
        internal bool CustomExpandCollapseHandlerExists
        {
            get
            {
                TreeNodeEventHandler collapseHandler = (TreeNodeEventHandler)
                    Events[TreeNodeCollapsedEvent];
                TreeNodeEventHandler expandHandler = (TreeNodeEventHandler)
                    Events[TreeNodeExpandedEvent];
        ...
        public bool PopulateNodesFromClient
        {
            get
            {
                if (!DesignMode && (Page != null && !Page.Request.Browser.SupportsCallback))
                {
                    return false;
                }
        ...
        {
            get { return _renderClientScript; }
        }
        ...
        {
            get { return DesignMode ? HtmlTextWriterTag.Table : HtmlTextWriterTag.Div; }
        }
        ...
        private void DataBindNode(TreeNode node)
        {
            if (node.PopulateOnDemand && !IsBoundUsingDataSourceID && !DesignMode)
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.TreeView_PopulateOnlyForDataSourceControls, ID)
                );
            }
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.TreeView_DataSourceReturnedNullView, ID)
                );
            }
            ...
            if (enumerable != null)
            {
                ...
                if (IsBoundUsingDataSourceID)
                {
                    ...
                    if (siteMapDataSource != null)
                    {
                        ...
                        {
                            IHierarchyData currentNodeData = (IHierarchyData)
                                siteMapDataSource.Provider.CurrentNode;
        ...
        private void DataBindRecursive(
            TreeNode node,
            IHierarchicalEnumerable enumerable,
            bool ignorePopulateOnDemand
        )
        {
            ...
            foreach (object item in enumerable)
            {
                ...
                if (level != null)
                {
                    ...
                    if (textField.Length > 0)
                    {
                        ...
                        {
                            throw new InvalidOperationException(
                                SR.GetString(SR.TreeView_InvalidDataBinding, textField, "TextField")
                            );
                        }
                    }
                    ...
                    if (valueField.Length > 0)
                    {
                        ...
                        else
                        {
                            throw new InvalidOperationException(
                                SR.GetString(
                                    SR.TreeView_InvalidDataBinding,
                                    valueField,
                                    "ValueField"
                                )
                            );
                ...
                if (newNode != null)
                {
                    ...
                    if (
                        (data.HasChildren)
                        && ((MaxDataBindDepth == -1) || (depth < MaxDataBindDepth))
                    )
                    {
        ...
        private void EnsureRenderSettings()
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.NeedHeader, "TreeView.HoverStyle")
                );
            }
            ...
            else
            {
                ...
                if (depth < LevelStyles.Count && LevelStyles[depth] != null)
                {
                    containsClassName |= AppendCssClassName(
                        builder,
                        (TreeNodeStyle)LevelStyles[depth],
                        hyperLink
                    );
                }
                if (depth == 0 && parent)
                ...
                switch (index)
                {
                    ...
                    case NoExpandImageIndex:
                        if (ShowLines)
                        {
                            ...
                            {
                                ImageUrls[index] = ResolveClientUrl(
                                    UrlPath.SimpleCombine(LineImagesFolder, "noexpand.gif")
                                );
                            }
                        }
                        else
                    ...
                    case PlusImageIndex:
                        if (ShowLines)
                        {
                            ...
                            {
                                ImageUrls[index] = ResolveClientUrl(
                                    UrlPath.SimpleCombine(LineImagesFolder, "plus.gif")
                                );
                            }
                        }
                        else
                    ...
                    case MinusImageIndex:
                        if (ShowLines)
                        {
                            ...
                            {
                                ImageUrls[index] = ResolveClientUrl(
                                    UrlPath.SimpleCombine(LineImagesFolder, "minus.gif")
                                );
                            }
                        }
                        else
                    ...
                    case IImageIndex:
                        ...
                        {
                            ImageUrls[index] = ResolveClientUrl(
                                UrlPath.SimpleCombine(LineImagesFolder, "i.gif")
                            );
                        }
                        break;
                    case RImageIndex:
                        ...
                        {
                            ImageUrls[index] = ResolveClientUrl(
                                UrlPath.SimpleCombine(LineImagesFolder, "r.gif")
                            );
                        }
                        break;
                    case RPlusImageIndex:
                        ...
                        {
                            ImageUrls[index] = ResolveClientUrl(
                                UrlPath.SimpleCombine(LineImagesFolder, "rplus.gif")
                            );
                        }
                        break;
                    case RMinusImageIndex:
                        ...
                        {
                            ImageUrls[index] = ResolveClientUrl(
                                UrlPath.SimpleCombine(LineImagesFolder, "rminus.gif")
                            );
                        }
                        break;
                    case TImageIndex:
                        ...
                        {
                            ImageUrls[index] = ResolveClientUrl(
                                UrlPath.SimpleCombine(LineImagesFolder, "t.gif")
                            );
                        }
                        break;
                    case TPlusImageIndex:
                        ...
                        {
                            ImageUrls[index] = ResolveClientUrl(
                                UrlPath.SimpleCombine(LineImagesFolder, "tplus.gif")
                            );
                        }
                        break;
                    case TMinusImageIndex:
                        ...
                        {
                            ImageUrls[index] = ResolveClientUrl(
                                UrlPath.SimpleCombine(LineImagesFolder, "tminus.gif")
                            );
                        }
                        break;
                    case LImageIndex:
                        ...
                        {
                            ImageUrls[index] = ResolveClientUrl(
                                UrlPath.SimpleCombine(LineImagesFolder, "l.gif")
                            );
                        }
                        break;
                    case LPlusImageIndex:
                        ...
                        {
                            ImageUrls[index] = ResolveClientUrl(
                                UrlPath.SimpleCombine(LineImagesFolder, "lplus.gif")
                            );
                        }
                        break;
                    case LMinusImageIndex:
                        ...
                        {
                            ImageUrls[index] = ResolveClientUrl(
                                UrlPath.SimpleCombine(LineImagesFolder, "lminus.gif")
                            );
                        }
                        break;
                    case DashImageIndex:
                        ...
                        {
                            ImageUrls[index] = ResolveClientUrl(
                                UrlPath.SimpleCombine(LineImagesFolder, "dash.gif")
                            );
                        }
                        break;
                    case DashPlusImageIndex:
                        ...
                        {
                            ImageUrls[index] = ResolveClientUrl(
                                UrlPath.SimpleCombine(LineImagesFolder, "dashplus.gif")
                            );
                        }
                        break;
                    case DashMinusImageIndex:
                        ...
                        {
                            ImageUrls[index] = ResolveClientUrl(
                                UrlPath.SimpleCombine(LineImagesFolder, "dashminus.gif")
                            );
                        }
                        break;
                }
        ...
        internal static string UnEscape(string value)
        {
            // Also used by Menu
            return value
                .Replace(EscapeSequenceForPathSeparator, InternalPathSeparator.ToString())
                .Replace(EscapeSequenceForEscapeCharacter, EscapeCharacter.ToString());
        }
        ...
        )
        {
            ...
            if (node.GetEffectiveShowCheckBox())
            {
                ...
                if (
                    (Context.Request.Form[checkBoxFieldID] != null)
            ...
            if (Page != null)
            {
                ...
                if (RenderClientScript)
                {
                    ...
                    if (PopulateNodesFromClient)
                    {
                        ...
                        if (!scriptOM.IsClientScriptBlockRegistered(GetType(), "PopulateNode"))
                        {
                            ...
                            scriptOM.RegisterClientScriptBlock(
                                ...
                                "PopulateNode",
                                populateNodeScript
                                    + scriptOM.GetCallbackEventReference(
                                        "context.data.treeViewID",
                                        "param",
                    ...
                    scriptOM.RegisterClientScriptBlock(
                        this,
                        GetType(),
                        ClientID + "_CreateDataObject1",
                        "var " + clientDataObjectID + " = null;",
                        true
                    );
                    scriptOM.RegisterStartupScript(
                        this,
                        GetType(),
                        ClientID + "_CreateDataObject2",
        ...
        protected virtual string GetCallbackResult()
        {
            ...
            int lastIndex = Int32.Parse(
                _callbackEventArgument.Substring(startIndex, endIndex - startIndex),
            ...
            endIndex = _callbackEventArgument.IndexOf('|', startIndex);
            string parentIsLast = _callbackEventArgument.Substring(
                startIndex,
                endIndex - startIndex
            );
            ...
            startIndex = endIndex + 1;
            endIndex = _callbackEventArgument.IndexOf('|', startIndex);
            int nodeTextLength = Int32.Parse(
                _callbackEventArgument.Substring(startIndex, endIndex - startIndex),
                CultureInfo.InvariantCulture
            );
            startIndex = endIndex + 1;
            ...
            startIndex = endIndex;
            endIndex = _callbackEventArgument.IndexOf('|', startIndex);
            int dataPathLength = Int32.Parse(
                _callbackEventArgument.Substring(startIndex, endIndex - startIndex),
                CultureInfo.InvariantCulture
            );
            startIndex = endIndex + 1;
            ...
            ValidateEvent(UniqueID, String.Concat(nodeIndexString, nodeText, valuePath, dataPath));
        ...
        private class TreeViewExpandDepthConverter : Int32Converter
        {
            ...
            private static object[] expandDepthValues =
            {
                -1,
                0,
                1,
