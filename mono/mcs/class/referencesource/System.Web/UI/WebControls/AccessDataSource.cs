...
namespace System.Web.UI.WebControls
{
    ...
    [
        Designer(
            "System.Web.UI.Design.WebControls.AccessDataSourceDesigner, " + AssemblyRef.SystemDesign
        ),
    ...
    public class AccessDataSource : SqlDataSource
    {
        ...
        public override string ConnectionString
        {
            ...
            set
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.AccessDataSource_CannotSetConnectionString)
                );
            }
        }
        ...
        [
            DefaultValue(""),
            Editor(
                "System.Web.UI.Design.MdbDataFileEditor, " + AssemblyRef.SystemDesign,
                typeof(UITypeEditor)
            ),
            UrlProperty(),
            WebCategory("Data"),
        ...
        {
            get { return (_dataFile == null) ? String.Empty : _dataFile; }
            set
            {
                if (DataFile != value)
                {
        ...
        public override string ProviderName
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.AccessDataSource_CannotSetProvider, ID)
                );
            }
        }
        ...
        public override string SqlCacheDependency
        {
            get
            {
                throw new NotSupportedException(
                    SR.GetString(SR.AccessDataSource_SqlCacheDependencyNotSupported, ID)
                );
            }
            set
            {
        ...
        private string GetPhysicalDataFilePath()
        {
            ...
            if (!HttpRuntime.HasPathDiscoveryPermission(filename))
            {
                throw new HttpException(
                    SR.GetString(
                        SR.AccessDataSource_NoPathDiscoveryPermission,
        ...
        /// </devdoc>
        internal override void SaveDataToCache(
            int startRowIndex,
            int maximumRows,
            object data,
