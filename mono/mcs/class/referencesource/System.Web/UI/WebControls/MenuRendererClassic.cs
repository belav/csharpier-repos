...
namespace System.Web.UI.WebControls
{
    ...
    partial public class Menu
    {
        ...
        private class MenuRendererClassic : MenuRenderer
        {
            ...
            public MenuRendererClassic(Menu menu)
                : base(menu) { }
            ...
            internal void EnsureRenderSettings()
            {
                ...
                if (Menu.Page.Header == null)
                {
                    if (Menu._staticHoverStyle != null)
                    {
                        throw new InvalidOperationException(
                            SR.GetString(SR.NeedHeader, "Menu.StaticHoverStyle")
                        );
                    }
                    if (Menu._dynamicHoverStyle != null)
                    {
                        throw new InvalidOperationException(
                            SR.GetString(SR.NeedHeader, "Menu.DynamicHoverStyle")
                        );
                    }
                    return;
                }
                ...
                if (
                    Menu.Page.SupportsStyleSheets
                    || (
                        Menu.Page.ScriptManager != null && Menu.Page.ScriptManager.IsInAsyncPostBack
                    )
                )
                {
                    ...
                    if (Menu._staticHoverStyle != null)
                    {
                        Menu._staticHoverHyperLinkStyle = new HyperLinkStyle(
                            Menu._staticHoverStyle
                        );
                    ...
                    if (Menu._dynamicHoverStyle != null)
                    {
                        Menu._dynamicHoverHyperLinkStyle = new HyperLinkStyle(
                            Menu._dynamicHoverStyle
                        );
                ...
                if (Menu.Page != null && registerScript)
                {
                    ...
                    if (Menu._dynamicHoverStyle != null)
                    {
                        ...
                        if (Menu._dynamicHoverHyperLinkStyle != null)
                        {
                            ...
                            createDataObjectScript.Append(
                                Menu._dynamicHoverHyperLinkStyle.RegisteredCssClass
                            );
                            if (!String.IsNullOrEmpty(Menu._dynamicHoverStyle.CssClass))
                            {
                                if (
                    ...
                    if (Menu._staticHoverStyle != null && Menu._staticHoverHyperLinkStyle != null)
                    {
                        ...
                        if (Menu._staticHoverHyperLinkStyle != null)
                        {
                            ...
                            createDataObjectScript.Append(
                                Menu._staticHoverHyperLinkStyle.RegisteredCssClass
                            );
                            if (!String.IsNullOrEmpty(Menu._staticHoverStyle.CssClass))
                            {
                                if (
                    ...
                    if (
                        (Menu.Page.RequestInternal != null)
                        && (
                            String.Equals(
                                Menu.Page.Request.Url.Scheme,
                                "https",
