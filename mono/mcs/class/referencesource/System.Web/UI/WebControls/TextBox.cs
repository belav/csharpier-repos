...
namespace System.Web.UI.WebControls
{
    ...
    public class TextBox : WebControl, IPostBackDataHandler, IEditableTextControl
    {
        ...
        private const string _textBoxKeyHandlerCall =
        ...
        /// </devdoc>
        [WebCategory("Appearance"), DefaultValue(0), WebSysDescription(SR.TextBox_Columns)]
            ...
            set
            {
                if (value < 0)
                {
                    throw new ArgumentOutOfRangeException(
                        "Columns",
                        SR.GetString(SR.TextBox_InvalidColumns)
                    );
                }
        ...
        public virtual int Rows
        {
            ...
            set
            {
                if (value < 0)
                {
                    throw new ArgumentOutOfRangeException(
                        "Rows",
                        SR.GetString(SR.TextBox_InvalidRows)
                    );
                }
        ...
        /// </devdoc>
        [WebCategory("Layout"), DefaultValue(true), WebSysDescription(SR.TextBox_Wrap)]
        ...
        {
            get { return Context != null && Context.Request.Browser["supportsVCard"] == "true"; }
        }
        ...
        /// </devdoc>
        [WebCategory("Action"), WebSysDescription(SR.TextBox_OnTextChanged)]
            ...
            else
            {
                ...
                if (
                    ...
                    && (
                        ...
                        || mode >= TextBoxMode.Color
                        || (SupportsVCard && mode == TextBoxMode.SingleLine)
                    )
                )
                {
                ...
                {
                    writer.AddAttribute(
                        HtmlTextWriterAttribute.Maxlength,
