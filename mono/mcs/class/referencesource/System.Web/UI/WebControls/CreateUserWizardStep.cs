...
namespace System.Web.UI.WebControls
{
    ...
    public sealed class CreateUserWizardStep : TemplatedWizardStep
    {
        ...
        {
            get { return AllowReturnInternal; }
            set
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.CreateUserWizardStep_AllowReturnCannotBeSet)
                );
            }
        }
        ...
        internal bool AllowReturnInternal
        {
            ...
            set { ViewState["AllowReturnInternal"] = value; }
        }
            ...
            set
            {
                ...
                else
                {
                    throw new HttpException(
                        SR.GetString(SR.CreateUserWizardStep_OnlyAllowedInCreateUserWizard)
                    );
                }
            }
        }
        ...
        /// </devdoc>
        [Localizable(true), WebSysDefaultValue(SR.CreateUserWizard_DefaultCreateUserTitleText)]
        public override string Title
        {
            get
            {
                ...
                return (title != null)
                    ? title
                    : SR.GetString(SR.CreateUserWizard_DefaultCreateUserTitleText);
            }
        ...
        public override WizardStepType StepType
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.CreateUserWizardStep_StepTypeCannotBeSet)
                );
            }
        }
    }
