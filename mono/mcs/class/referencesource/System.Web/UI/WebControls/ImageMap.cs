...
namespace System.Web.UI.WebControls
{
    ...
    public class ImageMap : Image, IPostBackEventHandler
    {
        ...
        [Browsable(true), EditorBrowsableAttribute(EditorBrowsableState.Always)]
        ...
        /// </devdoc>
        [Category("Action"), WebSysDescription(SR.ImageMap_Click)]
            ...
            if (_hasHotSpots)
            {
                ...
                foreach (HotSpot item in _hotSpots)
                {
                    ...
                    if (spotMode == HotSpotMode.PostBack)
                    {
                        ...
                        {
                            string eventArgument = hotSpotIndex.ToString(
