...
namespace System.Web.UI.WebControls
{
    ...
    [
        ...
        Designer(
            "System.Web.UI.Design.WebControls.PasswordRecoveryDesigner, " + AssemblyRef.SystemDesign
        )
    ]
            ...
            IRenderOuterTableControl
    {
        ...
        {
            get { return (_answer == null) ? String.Empty : _answer; }
        }
        ...
        public virtual string AnswerLabelText
        {
            get
            {
                ...
                return (obj == null)
                    ? SR.GetString(SR.PasswordRecovery_DefaultAnswerLabelText)
                    : (string)obj;
            }
        ...
        public virtual string AnswerRequiredErrorMessage
        {
            get
            {
                ...
                return (obj == null)
                    ? SR.GetString(SR.PasswordRecovery_DefaultAnswerRequiredErrorMessage)
                    : (string)obj;
            }
            ...
            set
            {
                if (value < -1)
                {
                    throw new ArgumentOutOfRangeException(
                        "value",
                        SR.GetString(SR.PasswordRecovery_InvalidBorderPadding)
                    );
                }
        ...
        public virtual string GeneralFailureText
        {
            get
            {
                ...
                return (obj == null)
                    ? SR.GetString(SR.PasswordRecovery_DefaultGeneralFailureText)
                    : (string)obj;
            }
        ...
        {
            get { return (_question != null) ? _question : String.Empty; }
        ...
        public virtual string QuestionFailureText
        {
            get
            {
                ...
                return (obj == null)
                    ? SR.GetString(SR.PasswordRecovery_DefaultQuestionFailureText)
                    : (string)obj;
            }
        ...
        public virtual string QuestionInstructionText
        {
            get
            {
                ...
                return (obj == null)
                    ? SR.GetString(SR.PasswordRecovery_DefaultQuestionInstructionText)
                    : (string)obj;
            }
        ...
        public virtual string QuestionLabelText
        {
            get
            {
                ...
                return (obj == null)
                    ? SR.GetString(SR.PasswordRecovery_DefaultQuestionLabelText)
                    : (string)obj;
            }
        ...
        public virtual string QuestionTitleText
        {
            get
            {
                ...
                return (obj == null)
                    ? SR.GetString(SR.PasswordRecovery_DefaultQuestionTitleText)
                    : (string)obj;
            }
        ...
        public virtual string SubmitButtonText
        {
            get
            {
                ...
                return (obj == null)
                    ? SR.GetString(SR.PasswordRecovery_DefaultSubmitButtonText)
                    : (string)obj;
            }
        ...
        public virtual string SuccessText
        {
            get
            {
                ...
                return (obj == null)
                    ? SR.GetString(SR.PasswordRecovery_DefaultSuccessText)
                    : (string)obj;
            }
        ...
        public virtual string UserNameFailureText
        {
            get
            {
                ...
                return (obj == null)
                    ? SR.GetString(SR.PasswordRecovery_DefaultUserNameFailureText)
                    : (string)obj;
            }
        ...
        public virtual string UserNameInstructionText
        {
            get
            {
                ...
                return (obj == null)
                    ? SR.GetString(SR.PasswordRecovery_DefaultUserNameInstructionText)
                    : (string)obj;
            }
        ...
        public virtual string UserNameLabelText
        {
            get
            {
                ...
                return (obj == null)
                    ? SR.GetString(SR.PasswordRecovery_DefaultUserNameLabelText)
                    : (string)obj;
            }
        ...
        public virtual string UserNameRequiredErrorMessage
        {
            get
            {
                ...
                return (obj == null)
                    ? SR.GetString(SR.PasswordRecovery_DefaultUserNameRequiredErrorMessage)
                    : (string)obj;
            }
        ...
        public virtual string UserNameTitleText
        {
            get
            {
                ...
                return (obj == null)
                    ? SR.GetString(SR.PasswordRecovery_DefaultUserNameTitleText)
                    : (string)obj;
            }
        ...
        /// </devdoc>
        [WebCategory("Action"), WebSysDescription(SR.PasswordRecovery_AnswerLookupError)]
        public event EventHandler AnswerLookupError
        {
            add { Events.AddHandler(EventAnswerLookupError, value); }
            remove { Events.RemoveHandler(EventAnswerLookupError, value); }
        }

        /// <devdoc>
        /// Raised before the answer is validated.
        /// </devdoc>
        [WebCategory("Action"), WebSysDescription(SR.PasswordRecovery_VerifyingAnswer)]
        public event LoginCancelEventHandler VerifyingAnswer
        {
            add { Events.AddHandler(EventVerifyingAnswer, value); }
            remove { Events.RemoveHandler(EventVerifyingAnswer, value); }
        }

        /// <devdoc>
        /// Raised before the e-mail is sent.
        /// </devdoc>
        [WebCategory("Action"), WebSysDescription(SR.PasswordRecovery_SendingMail)]
        ...
        [WebCategory("Action"), WebSysDescription(SR.CreateUserWizard_SendMailError)]
        ...
        /// </devdoc>
        [WebCategory("Action"), WebSysDescription(SR.PasswordRecovery_VerifyingUser)]
        public event LoginCancelEventHandler VerifyingUser
        {
            add { Events.AddHandler(EventVerifyingUser, value); }
            remove { Events.RemoveHandler(EventVerifyingUser, value); }
        }

        /// <devdoc>
        /// Raised when the user name is invalid.
        /// </devdoc>
        [WebCategory("Action"), WebSysDescription(SR.PasswordRecovery_UserLookupError)]
        public event EventHandler UserLookupError
        {
            add { Events.AddHandler(EventUserLookupError, value); }
            remove { Events.RemoveHandler(EventUserLookupError, value); }
        }
        ...
        private void AttemptSendPasswordUserNameView()
        {
            ...
            if (user != null)
            {
                ...
                else
                {
                    ...
                    if (provider.EnablePasswordRetrieval)
                    {
                        password = user.GetPassword( /*throwOnError*/
                            false
                        );
                    }
                    else if (provider.EnablePasswordReset)
                    {
                        password = user.ResetPassword( /*throwOnError*/
                            false
                        );
                    }
                    else
                    {
                        throw new HttpException(
                            SR.GetString(SR.PasswordRecovery_RecoveryNotSupported)
                        );
                    }
        ...
        private void CreateQuestionView()
        {
            ...
            IEditableTextControl answerTextBox =
                _questionContainer.AnswerTextBox as IEditableTextControl;
        ...
        private void CreateUserView()
        {
            ...
            IEditableTextControl userNameTextBox =
                _userNameContainer.UserNameTextBox as IEditableTextControl;
        ...
        protected override object SaveViewState()
        {
            ...
            myState[1] =
                (_submitButtonStyle != null)
                    ? ((IStateManager)_submitButtonStyle).SaveViewState()
                    : null;
            myState[2] =
        ...
        private void SetQuestionDefaultChildProperties()
        {
            ...
            if (userName is WebControl)
                ((WebControl)userName).TabIndex = TabIndex;
            ...
            Debug.Assert(
                answerTextBox != null,
                "AnswerTextBox cannot be null for the DefaultTemplate"
            );
            if (_textBoxStyle != null)
            {
        ...
        private void SetUserNameDefaultChildProperties()
        {
            ...
            if (UserNameTemplate == null)
            {
                ...
                Debug.Assert(
                    ...
                    "UserNameTextBox cannot be null for the DefaultTemplate"
                );
                if (_textBoxStyle != null)
                {
        ...
        private sealed class DefaultQuestionTemplate : ITemplate
        {
            ...
            private void CreateControls(QuestionContainer questionContainer)
            {
                ...
                answerRequired.Text = SR.GetString(
                    SR.LoginControls_DefaultRequiredFieldValidatorText
                );
                answerRequired.Enabled = enableValidation;
                answerRequired.Visible = enableValidation;
        ...
        private sealed class DefaultUserNameTemplate : ITemplate
        {
            ...
            private void CreateControls(UserNameContainer userNameContainer)
            {
                ...
                userNameRequired.Text = SR.GetString(
                    SR.LoginControls_DefaultRequiredFieldValidatorText
                );
                userNameRequired.Enabled = enableValidation;
                userNameRequired.Visible = enableValidation;
        ...
        /// </devdoc>
        internal sealed class QuestionContainer
            : LoginUtil.GenericContainer<PasswordRecovery>,
                INonBindingContainer
        {
            ...
            {
                get { return _answerLabel; }
                set { _answerLabel = value; }
            }
        ...
        ///     Internal instead of private because it must be used by PasswordRecoveryAdapter.
        /// </devdoc>
        internal sealed class UserNameContainer
            : LoginUtil.GenericContainer<PasswordRecovery>,
                INonBindingContainer
        {
            private Control _failureTextLabel;
            ...
            public Control UserNameTextBox
            {
                get
                {
                    ...
                    else
                    {
                        return FindRequiredControl<IEditableTextControl>(
                            _userNameID,
                            SR.PasswordRecovery_NoUserNameTextBox
                        );
                    }
                }
