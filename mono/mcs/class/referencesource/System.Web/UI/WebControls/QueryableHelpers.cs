...
namespace System.Web.UI.WebControls
{
    internal static class QueryableHelpers
    {
        ...
        public static IQueryable<T> SortandPageHelper<T>(
        ...
        public static int CountHelper<T>(IQueryable<T> queryable)
            where T : class
        {
            if (queryable == null)
                throw new ArgumentNullException("queryable");
        ...
        public static bool IsOrderingMethodFound<T>(IQueryable<T> queryable)
            where T : class
        {
