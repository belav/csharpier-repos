...
namespace System.Web.UI.WebControls
{
    ...
    public class SqlDataSourceView : DataSourceView, IStateManager
    {
        ...
        {
            get { return (DeleteCommand.Length != 0); }
        }
        ...
        {
            get { return (InsertCommand.Length != 0); }
        }
        ...
        public override bool CanSort
        {
            get
            {
                return (_owner.DataSourceMode == SqlDataSourceMode.DataSet)
                    || (SortParameterName.Length > 0);
            }
        }
        ...
        {
            get { return (UpdateCommand.Length != 0); }
        }
        ...
        {
            get { return _deleteCommandType; }
            set
            {
                if (
                    (value < SqlDataSourceCommandType.Text)
                    || (value > SqlDataSourceCommandType.StoredProcedure)
                )
                {
                    throw new ArgumentOutOfRangeException("value");
                }
        ...
        protected virtual string ParameterPrefix
        {
            ...
            {
                if (
                    String.IsNullOrEmpty(_owner.ProviderName)
                    || String.Equals(
                        _owner.ProviderName,
        ...
        private void AddParameters(
            ...
            IDictionary exclusionList,
            string oldValuesParameterFormatString
        )
        {
            ...
            if (parameters != null)
            {
                ...
                foreach (DictionaryEntry de in parameters)
                {
                    ...
                    if (
                        (caseInsensitiveExclusionList != null)
                        && (caseInsensitiveExclusionList.Contains(rawParamName))
                    )
                    {
        ...
        /// </devdoc>
        private Exception BuildCustomException(
            Exception ex,
            DataSourceOperation operation,
            DbCommand command,
            out bool isCustomException
        )
        {
            ...
            {
                if (
                    (sqlException.Number == MustDeclareVariableSqlExceptionNumber)
                ...
                )
                {
                    ...
                    return new InvalidOperationException(
                        SR.GetString(
                            SR.SqlDataSourceView_MissingParameters,
                            operation,
                            _owner.ID,
                            parameterNames
                        )
        ...
        private int ExecuteDbCommand(DbCommand command, DataSourceOperation operation)
        {
            ...
            try
            {
                ...
                eventRaised = true;
                SqlDataSourceStatusEventArgs eventArgs = new SqlDataSourceStatusEventArgs(
                    command,
                    rowsAffected,
                    null
                );
        ...
        protected override int ExecuteDelete(IDictionary keys, IDictionary oldValues)
        {
            if (!CanDelete)
            {
                throw new NotSupportedException(
                    SR.GetString(SR.SqlDataSourceView_DeleteNotSupported, _owner.ID)
                );
            }
            ...
            if (connection == null)
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.SqlDataSourceView_CouldNotCreateConnection, _owner.ID)
                );
            }
            ...
            if (ConflictDetection == ConflictOptions.CompareAllValues)
            {
                if (oldValues == null || oldValues.Count == 0)
                {
                    throw new InvalidOperationException(
                        SR.GetString(
                            SR.SqlDataSourceView_Pessimistic,
        ...
        protected override int ExecuteInsert(IDictionary values)
        {
            ...
            {
                throw new NotSupportedException(
                    SR.GetString(SR.SqlDataSourceView_InsertNotSupported, _owner.ID)
                );
            }
        ...
        protected internal override IEnumerable ExecuteSelect(DataSourceSelectArguments arguments)
        {
            ...
            if (cacheEnabled)
            {
                ...
                {
                    throw new NotSupportedException(
                        SR.GetString(SR.SqlDataSourceView_CacheNotSupported, _owner.ID)
                    );
                }
                ...
                if (dataSet != null)
                {
                    ...
                    {
                        SqlDataSourceFilteringEventArgs filterArgs =
                            new SqlDataSourceFilteringEventArgs(parameterValues);
            ...
            SqlDataSourceSelectingEventArgs selectingEventArgs =
                new SqlDataSourceSelectingEventArgs(command, arguments);
            ...
            if (sortParameterName.Length > 0)
            {
                if (command.CommandType != CommandType.StoredProcedure)
                {
                    throw new NotSupportedException(
                        SR.GetString(
                            SR.SqlDataSourceView_SortParameterRequiresStoredProcedure,
                            _owner.ID
                        )
                    );
                }
            ...
            switch (_owner.DataSourceMode)
            {
                case SqlDataSourceMode.DataSet:
                {
                    ...
                    if (cacheEnabled && cache is SqlDataSourceCache)
                    {
                        ...
                        if (
                            String.Equals(
                                sqlCache.SqlCacheDependency,
                                SqlDataSourceCache.Sql9CacheDependencyDirective,
                                StringComparison.OrdinalIgnoreCase
                            )
                        )
                        {
                            if (!(command is System.Data.SqlClient.SqlCommand))
                            {
                                throw new InvalidOperationException(
                                    SR.GetString(
                                        SR.SqlDataSourceView_CommandNotificationNotSupported,
                                        _owner.ID
                                    )
                                );
                            }
                            cacheDependency = new SqlCacheDependency(
                    ...
                    try
                    {
                        ...
                        eventRaised = true;
                        SqlDataSourceStatusEventArgs selectedEventArgs =
                            new SqlDataSourceStatusEventArgs(command, rowsAffected, null);
                    ...
                    catch (Exception ex)
                    {
                        if (!eventRaised)
                        {
                            // Raise the Selected event
                            SqlDataSourceStatusEventArgs selectedEventArgs =
                                new SqlDataSourceStatusEventArgs(command, rowsAffected, ex);
                            OnSelected(selectedEventArgs);
                        ...
                        {
                            bool isCustomException;
                            ex = BuildCustomException(
                                ex,
                                DataSourceOperation.Select,
                                command,
                                out isCustomException
                            );
                            if (isCustomException)
                            {
                                throw ex;
                    ...
                    if (dataTable != null)
                    {
                        ...
                        selectResult = FilteredDataSetHelper.CreateFilteredDataView(
                            dataTable,
                            sortExpression,
                            FilterExpression,
                            parameterValues
                ...
                case SqlDataSourceMode.DataReader:
                {
                    ...
                    {
                        throw new NotSupportedException(
                            SR.GetString(SR.SqlDataSourceView_FilterNotSupported, _owner.ID)
                        );
                    }
                    ...
                    {
                        throw new NotSupportedException(
                            SR.GetString(SR.SqlDataSourceView_SortNotSupported, _owner.ID)
                        );
                    }
                    ...
                    try
                    {
                        ...
                        eventRaised = true;
                        SqlDataSourceStatusEventArgs selectedEventArgs =
                            new SqlDataSourceStatusEventArgs(command, 0, null);
                        OnSelected(selectedEventArgs);
                    }
                    catch (Exception ex)
                    {
                        if (!eventRaised)
                        {
                            // Raise the Selected event
                            SqlDataSourceStatusEventArgs selectedEventArgs =
                                new SqlDataSourceStatusEventArgs(command, 0, ex);
                            OnSelected(selectedEventArgs);
                            if (!selectedEventArgs.ExceptionHandled)
                            {
                                throw;
        ...
        )
        {
            ...
            {
                throw new NotSupportedException(
                    SR.GetString(SR.SqlDataSourceView_UpdateNotSupported, _owner.ID)
                );
            }
        ...
        )
        {
            ...
            for (int i = 0; i < parameters.Count; i++)
            {
                ...
                if (
                    (caseInsensitiveExclusionList == null)
                    || (!caseInsensitiveExclusionList.Contains(parameter.Name))
                )
                {
                    DbParameter dbParameter = _owner.CreateParameter(
                    ...
                    if (
                        ...
                        || (parameter.Type != TypeCode.Empty && parameter.Type != TypeCode.DBNull)
                    )
                    {
        ...
        protected virtual void OnDeleted(SqlDataSourceStatusEventArgs e)
        {
            SqlDataSourceStatusEventHandler handler =
                Events[EventDeleted] as SqlDataSourceStatusEventHandler;
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        protected virtual void OnDeleting(SqlDataSourceCommandEventArgs e)
        {
            SqlDataSourceCommandEventHandler handler =
                Events[EventDeleting] as SqlDataSourceCommandEventHandler;
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        protected virtual void OnFiltering(SqlDataSourceFilteringEventArgs e)
        {
            SqlDataSourceFilteringEventHandler handler =
                Events[EventFiltering] as SqlDataSourceFilteringEventHandler;
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        {
            SqlDataSourceStatusEventHandler handler =
                Events[EventInserted] as SqlDataSourceStatusEventHandler;
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        {
            SqlDataSourceCommandEventHandler handler =
                Events[EventInserting] as SqlDataSourceCommandEventHandler;
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        {
            SqlDataSourceStatusEventHandler handler =
                Events[EventSelected] as SqlDataSourceStatusEventHandler;
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        protected virtual void OnSelecting(SqlDataSourceSelectingEventArgs e)
        {
            SqlDataSourceSelectingEventHandler handler =
                Events[EventSelecting] as SqlDataSourceSelectingEventHandler;
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        {
            SqlDataSourceStatusEventHandler handler =
                Events[EventUpdated] as SqlDataSourceStatusEventHandler;
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        {
            SqlDataSourceCommandEventHandler handler =
                Events[EventUpdating] as SqlDataSourceCommandEventHandler;
            if (handler != null)
            {
                handler(this, e);
            }
...
*/
        ...
        )
        {
            ...
            {
                throw new NotSupportedException(
                    SR.GetString(SR.SqlDataSourceView_NoPaging, _owner.ID)
                );
            }
            ...
            {
                throw new NotSupportedException(
                    SR.GetString(SR.SqlDataSourceView_NoSorting, _owner.ID)
                );
            }
            ...
            {
                throw new NotSupportedException(
                    SR.GetString(SR.SqlDataSourceView_NoRowCount, _owner.ID)
                );
            }
