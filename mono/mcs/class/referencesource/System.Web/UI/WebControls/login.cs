...
namespace System.Web.UI.WebControls
{
    ...
    public class Login : CompositeControl, IBorderPaddingControl, IRenderOuterTableControl
    {
            ...
            set
            {
                if (value < -1)
                {
                    throw new ArgumentOutOfRangeException(
                        "value",
                        SR.GetString(SR.Login_InvalidBorderPadding)
                    );
                }
        ...
        public virtual string DestinationPageUrl
        {
            ...
            set { ViewState["DestinationPageUrl"] = value; }
        }
        ...
        public virtual string FailureText
        {
            ...
            set { ViewState["FailureText"] = value; }
        }
        ...
        public virtual string LoginButtonImageUrl
        {
            ...
            set { ViewState["LoginButtonImageUrl"] = value; }
        }
        ...
        public virtual string LoginButtonText
        {
            ...
            set { ViewState["LoginButtonText"] = value; }
        }
        ...
        public virtual string PasswordRequiredErrorMessage
        {
            get
            {
                ...
                return (obj == null)
                    ? SR.GetString(SR.Login_DefaultPasswordRequiredErrorMessage)
                    : (string)obj;
            }
        ...
        public virtual string RememberMeText
        {
            ...
            set { ViewState["RememberMeText"] = value; }
        }
        ...
        public virtual string UserNameLabelText
        {
            get
            {
                ...
                return (obj == null)
                    ? SR.GetString(SR.Login_DefaultUserNameLabelText)
                    : (string)obj;
            }
        ...
        public virtual string UserNameRequiredErrorMessage
        {
            get
            {
                ...
                return (obj == null)
                    ? SR.GetString(SR.Login_DefaultUserNameRequiredErrorMessage)
                    : (string)obj;
            }
        ...
        /// </devdoc>
        [WebCategory("Action"), WebSysDescription(SR.Login_LoggedIn)]
        public event EventHandler LoggedIn
        {
            add { Events.AddHandler(EventLoggedIn, value); }
            remove { Events.RemoveHandler(EventLoggedIn, value); }
        }

        /// <devdoc>
        ///     Raised to authenticate the user.
        /// </devdoc>
        [WebCategory("Action"), WebSysDescription(SR.Login_Authenticate)]
        public event AuthenticateEventHandler Authenticate
        {
            add { Events.AddHandler(EventAuthenticate, value); }
            remove { Events.RemoveHandler(EventAuthenticate, value); }
        }

        /// <devdoc>
        ///     Raised before the user is authenticated.
        /// </devdoc>
        [WebCategory("Action"), WebSysDescription(SR.Login_LoggingIn)]
        public event LoginCancelEventHandler LoggingIn
        {
            add { Events.AddHandler(EventLoggingIn, value); }
        ...
        /// </devdoc>
        [WebCategory("Action"), WebSysDescription(SR.Login_LoginError)]
        public event EventHandler LoginError
        {
            add { Events.AddHandler(EventLoginError, value); }
        ...
        private string GetRedirectUrl()
        {
            ...
            else
            {
                ...
                if (
                    Page.Form != null
                    && String.Equals(Page.Form.Method, "get", StringComparison.OrdinalIgnoreCase)
                )
                {
        ...
        {
            return AuthenticationConfig.AccessingLoginPage(
                Context,
        ...
        protected internal override void OnPreRender(EventArgs e)
        {
            ...
            TemplateContainer.Visible = (
                VisibleWhenLoggedIn || !Page.Request.IsAuthenticated || OnLoginPage()
            );
        }
        ...
        protected override object SaveViewState()
        {
            ...
            myState[1] =
                (_loginButtonStyle != null)
                    ? ((IStateManager)_loginButtonStyle).SaveViewState()
                    : null;
            myState[2] =
        ...
        private void SetDefaultTemplateChildProperties()
        {
            ...
            helpPageLinkSeparator.Visible =
                helpPageLineVisible && (passwordRecoveryLineVisible || createUserLineVisible);
            ...
            createUserLinkSeparator.Visible = (
                createUserLineVisible && passwordRecoveryLineVisible
            );
        ...
        private sealed class LoginTemplate : ITemplate
        {
            ...
            private void CreateControls(LoginContainer loginContainer)
            {
                ...
                passwordRequired.Text = SR.GetString(
                    SR.LoginControls_DefaultRequiredFieldValidatorText
                );
                passwordRequired.Enabled = enableValidation;
                passwordRequired.Visible = enableValidation;
        ...
        internal sealed class LoginContainer : LoginUtil.GenericContainer<Login>
        {
            ...
            {
                get { return _passwordRecoveryLinkSeparator; }
                set { _passwordRecoveryLinkSeparator = value; }
            }
