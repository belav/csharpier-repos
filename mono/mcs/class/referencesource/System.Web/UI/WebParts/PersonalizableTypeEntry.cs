...
namespace System.Web.UI.WebControls.WebParts
{
    ...
    internal sealed class PersonalizableTypeEntry
    {
        ...
        {
            _propertyEntries = new HybridDictionary( /* caseInsensitive */
                false
            );
            ...
            if ((props != null) && (props.Length != 0))
            {
                for (int i = 0; i < props.Length; i++)
                {
                    ...
                    PersonalizableAttribute pa =
                        Attribute.GetCustomAttribute(
                            pi,
                            PersonalizableAttribute.PersonalizableAttributeType,
                            true
                    ...
                    )
                    {
                        throw new HttpException(
                            SR.GetString(
                                SR.PersonalizableTypeEntry_InvalidProperty,
                                name,
                                _type.FullName
                            )
                        );
