    ...
    public sealed class WebPartDescriptionCollection : ReadOnlyCollectionBase
    {
        ...
        public WebPartDescriptionCollection(ICollection webPartDescriptions)
        {
            ...
            foreach (object obj in webPartDescriptions)
            {
                ...
                {
                    throw new ArgumentException(
                        SR.GetString(SR.Collection_InvalidType, "WebPartDescription"),
                        "webPartDescriptions"
                    );
                }
                ...
                {
                    throw new ArgumentException(
                        SR.GetString(SR.WebPart_Collection_DuplicateID, "WebPartDescription", id),
                        "webPartDescriptions"
                    );
                }
            }
        ...
        {
            get { return (WebPartDescription)InnerList[index]; }
        }

        public WebPartDescription this[string id]
        {
            get { return ((_ids != null) ? (WebPartDescription)_ids[id] : null); }
        }
