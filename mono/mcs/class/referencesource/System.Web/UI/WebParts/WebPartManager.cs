...
<div id=""{0}___Drag"" style=""display:none; position:absolute; z-index: 32000; filter:alpha(opacity=75)""></div>";
        private const string ExportSensitiveDataWarningDeclaration =
...
if (zoneElement != null) {{
    ...
    zoneObject.AddWebPart(document.getElementById('{0}'), {1}, {2});";
        ...
        public WebPartManager()
        {
            ...
            _partAndChildControlIDs = new HybridDictionary(
                true /* caseInsensitive */
            );
            _zoneIDs = new HybridDictionary(
                true /* caseInsensitive */
            );
        }
        ...
        public virtual string CloseProviderWarning
        {
            get
            {
                ...
                return (o != null)
                    ? (string)o
                    : SR.GetString(SR.WebPartManager_DefaultCloseProviderWarning);
            }
        ...
        public virtual string DeleteWarning
        {
            get
            {
                ...
                return (o != null)
                    ? (string)o
                    : SR.GetString(SR.WebPartManager_DefaultDeleteWarning);
            }
            ...
            set
            {
                ...
                if (SupportedDisplayModes.Contains(value) == false)
                {
                    throw new ArgumentException(
                        SR.GetString(SR.WebPartManager_InvalidDisplayMode),
                        "value"
                    );
                }
                ...
                {
                    throw new ArgumentException(
                        SR.GetString(SR.WebPartManager_DisabledDisplayMode),
                        "value"
                    );
                }

                WebPartDisplayModeCancelEventArgs dmce = new WebPartDisplayModeCancelEventArgs(
                    value
                );
        ...
        public override bool EnableTheming
        {
            ...
            set
            {
                throw new NotSupportedException(
                    SR.GetString(SR.WebPartManager_CantSetEnableTheming)
                );
            }
        }
        ...
        public virtual string ExportSensitiveDataWarning
        {
            get
            {
                ...
                return (o != null)
                    ? (string)o
                    : SR.GetString(SR.WebPartChrome_ConfirmExportSensitive);
            }
        ...
        protected virtual PermissionSet MediumPermissionSet
        {
            get
            {
                if (_mediumPermissionSet == null)
                {
                    ...
                    _mediumPermissionSet.AddPermission(
        ...
        protected virtual PermissionSet MinimalPermissionSet
        {
            get
            {
                if (_minimalPermissionSet == null)
                {
                    ...
                    _minimalPermissionSet.AddPermission(
                        new SecurityPermission(SecurityPermissionFlag.Execution)
                    );
                    _minimalPermissionSet.AddPermission(
        ...
        {
            get { return _webPartZones; }
        }

        [WebCategory("Action"), WebSysDescription(SR.WebPartManager_AuthorizeWebPart)]
        public event WebPartAuthorizationEventHandler AuthorizeWebPart
        {
            add { Events.AddHandler(AuthorizeWebPartEvent, value); }
            remove { Events.RemoveHandler(AuthorizeWebPartEvent, value); }
        }

        [WebCategory("Action"), WebSysDescription(SR.WebPartManager_ConnectionsActivated)]
        public event EventHandler ConnectionsActivated
        {
            add { Events.AddHandler(ConnectionsActivatedEvent, value); }
            remove { Events.RemoveHandler(ConnectionsActivatedEvent, value); }
        }

        [WebCategory("Action"), WebSysDescription(SR.WebPartManager_ConnectionsActivating)]
        public event EventHandler ConnectionsActivating
        {
            add { Events.AddHandler(ConnectionsActivatingEvent, value); }
            remove { Events.RemoveHandler(ConnectionsActivatingEvent, value); }
        }

        [WebCategory("Action"), WebSysDescription(SR.WebPartManager_DisplayModeChanged)]
        public event WebPartDisplayModeEventHandler DisplayModeChanged
        {
            add { Events.AddHandler(DisplayModeChangedEvent, value); }
            remove { Events.RemoveHandler(DisplayModeChangedEvent, value); }
        }

        [WebCategory("Action"), WebSysDescription(SR.WebPartManager_DisplayModeChanging)]
        public event WebPartDisplayModeCancelEventHandler DisplayModeChanging
        {
            add { Events.AddHandler(DisplayModeChangingEvent, value); }
            remove { Events.RemoveHandler(DisplayModeChangingEvent, value); }
        }

        [WebCategory("Action"), WebSysDescription(SR.WebPartManager_SelectedWebPartChanged)]
        public event WebPartEventHandler SelectedWebPartChanged
        {
            add { Events.AddHandler(SelectedWebPartChangedEvent, value); }
            remove { Events.RemoveHandler(SelectedWebPartChangedEvent, value); }
        }

        [WebCategory("Action"), WebSysDescription(SR.WebPartManager_SelectedWebPartChanging)]
        public event WebPartCancelEventHandler SelectedWebPartChanging
        {
            add { Events.AddHandler(SelectedWebPartChangingEvent, value); }
            remove { Events.RemoveHandler(SelectedWebPartChangingEvent, value); }
        }

        [WebCategory("Action"), WebSysDescription(SR.WebPartManager_WebPartAdded)]
        public event WebPartEventHandler WebPartAdded
        {
            add { Events.AddHandler(WebPartAddedEvent, value); }
            remove { Events.RemoveHandler(WebPartAddedEvent, value); }
        }

        [WebCategory("Action"), WebSysDescription(SR.WebPartManager_WebPartAdding)]
        public event WebPartAddingEventHandler WebPartAdding
        {
            add { Events.AddHandler(WebPartAddingEvent, value); }
            remove { Events.RemoveHandler(WebPartAddingEvent, value); }
        }

        [WebCategory("Action"), WebSysDescription(SR.WebPartManager_WebPartClosed)]
        public event WebPartEventHandler WebPartClosed
        {
            add { Events.AddHandler(WebPartClosedEvent, value); }
            remove { Events.RemoveHandler(WebPartClosedEvent, value); }
        }

        [WebCategory("Action"), WebSysDescription(SR.WebPartManager_WebPartClosing)]
        public event WebPartCancelEventHandler WebPartClosing
        {
            add { Events.AddHandler(WebPartClosingEvent, value); }
            remove { Events.RemoveHandler(WebPartClosingEvent, value); }
        }

        [WebCategory("Action"), WebSysDescription(SR.WebPartManager_WebPartDeleted)]
        public event WebPartEventHandler WebPartDeleted
        {
            add { Events.AddHandler(WebPartDeletedEvent, value); }
            remove { Events.RemoveHandler(WebPartDeletedEvent, value); }
        }

        [WebCategory("Action"), WebSysDescription(SR.WebPartManager_WebPartDeleting)]
        public event WebPartCancelEventHandler WebPartDeleting
        {
            add { Events.AddHandler(WebPartDeletingEvent, value); }
            remove { Events.RemoveHandler(WebPartDeletingEvent, value); }
        }

        [WebCategory("Action"), WebSysDescription(SR.WebPartManager_WebPartMoved)]
        public event WebPartEventHandler WebPartMoved
        {
            add { Events.AddHandler(WebPartMovedEvent, value); }
            remove { Events.RemoveHandler(WebPartMovedEvent, value); }
        }

        [WebCategory("Action"), WebSysDescription(SR.WebPartManager_WebPartMoving)]
        public event WebPartMovingEventHandler WebPartMoving
        {
            add { Events.AddHandler(WebPartMovingEvent, value); }
            remove { Events.RemoveHandler(WebPartMovingEvent, value); }
        }

        [WebCategory("Action"), WebSysDescription(SR.WebPartManager_WebPartsConnected)]
        public event WebPartConnectionsEventHandler WebPartsConnected
        {
            add { Events.AddHandler(WebPartsConnectedEvent, value); }
            remove { Events.RemoveHandler(WebPartsConnectedEvent, value); }
        }

        [WebCategory("Action"), WebSysDescription(SR.WebPartManager_WebPartsConnecting)]
        public event WebPartConnectionsCancelEventHandler WebPartsConnecting
        {
            add { Events.AddHandler(WebPartsConnectingEvent, value); }
            remove { Events.RemoveHandler(WebPartsConnectingEvent, value); }
        }

        [WebCategory("Action"), WebSysDescription(SR.WebPartManager_WebPartsDisconnected)]
        public event WebPartConnectionsEventHandler WebPartsDisconnected
        {
            add { Events.AddHandler(WebPartsDisconnectedEvent, value); }
            remove { Events.RemoveHandler(WebPartsDisconnectedEvent, value); }
        }

        [WebCategory("Action"), WebSysDescription(SR.WebPartManager_WebPartsDisconnecting)]
        public event WebPartConnectionsCancelEventHandler WebPartsDisconnecting
        {
            add { Events.AddHandler(WebPartsDisconnectingEvent, value); }
            remove { Events.RemoveHandler(WebPartsDisconnectingEvent, value); }
        }
        ...
        private WebPart AddDynamicWebPartToZone(
            WebPart webPart,
        ...
        {
            Personalization.EnsureEnabled( /* ensureModifiable */
                true
            );
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.WebPartManager_AlreadyInZone),
                    "webPart"
                );
            }
        ...
        public virtual void BeginWebPartConnecting(WebPart webPart)
        {
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.WebPartManager_CantBeginConnectingClosed),
                    "webPart"
                );
            }
            ...
            if (DisplayMode != ConnectDisplayMode)
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.WebPartManager_MustBeInConnect)
                );
            }
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.WebPartManager_AlreadyInConnect),
                    "webPart"
                );
            }
        ...
        public virtual void BeginWebPartEditing(WebPart webPart)
        {
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.WebPartManager_CantBeginEditingClosed),
                    "webPart"
                );
            }
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.WebPartManager_AlreadyInEdit),
                    "webPart"
                );
            }
            ...
            foreach (WebPart part in parts)
            {
                if (part.ZoneIndex != index)
                {
                    ...
                    foreach (WebPart part2 in Controls)
                    {
                        ...
                        builder.Append(
                            part2.DisplayTitle + "\t" + zoneTitle + "\t" + part2.ZoneIndex
                        );
                    }
        ...
        protected virtual bool CheckRenderClientScript()
        {
            ...
            if (EnableClientScript && Page != null)
            {
                ...
                if (
                    browserCaps.Win32
                    && (browserCaps.MSDomVersion.CompareTo(new Version(5, 5)) >= 0)
                )
                {
        ...
        )
        {
            ...
            if (provider == consumer)
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.WebPartManager_CantConnectToSelf)
                    );
                }
                else
                {
            ...
            if (provider.IsClosed)
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.WebPartManager_CantConnectClosed, provider.ID)
                    );
                }
                else
                {
            ...
            if (consumer.IsClosed)
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.WebPartManager_CantConnectClosed, consumer.ID)
                    );
                }
                else
                {
            ...
            if (!providerConnectionPoint.AllowsMultipleConnections)
            {
                foreach (WebPartConnection c in Connections)
                {
                    if (
                        c.Provider == provider
                        && c.ProviderConnectionPoint == providerConnectionPoint
                    )
                    {
                        if (throwOnError)
                        {
            ...
            if (!consumerConnectionPoint.AllowsMultipleConnections)
            {
                foreach (WebPartConnection c in Connections)
                {
                    if (
                        c.Consumer == consumer
                        && c.ConsumerConnectionPoint == consumerConnectionPoint
                    )
                    {
                        if (throwOnError)
                        {
        ...
        private void CloseOrDeleteWebPart(WebPart webPart, bool delete)
        {
            ...
            if (!delete && webPart.IsClosed)
            {
                ...
                throw new ArgumentException(
                    SR.GetString(SR.WebPartManager_AlreadyClosed),
                    "webPart"
                );
            }
            ...
            if (delete)
            {
                if (webPart.IsStatic)
                {
                    ...
                    throw new ArgumentException(
                        SR.GetString(SR.WebPartManager_CantDeleteStatic),
                        "webPart"
                    );
                }
                else if (webPart.IsShared && (Personalization.Scope == PersonalizationScope.User))
                {
                    ...
                    throw new ArgumentException(
                        SR.GetString(SR.WebPartManager_CantDeleteSharedInUserScope),
                        "webPart"
                    );
                }
            }
        ...
        private WebPartConnection[] ConnectionsToActivate()
        {
            ...
            HybridDictionary connectionIDs = new HybridDictionary(
                true /* caseInsensitive */
            );

            WebPartConnection[] connections = new WebPartConnection[
                StaticConnections.Count + DynamicConnections.Count
            ];
            ...
            WebPartConnection[] connectionsToActivateArray = (WebPartConnection[])
                connectionsToActivate.ToArray(typeof(WebPartConnection));
            ...
            connectionsToActivateArray = (WebPartConnection[])
                connectionsToActivate.ToArray(typeof(WebPartConnection));
            foreach (WebPartConnection connection in connectionsToActivateArray)
            {
            ...
            return (WebPartConnection[])
                finalConnectionsToActivate.ToArray(typeof(WebPartConnection));
        }
        ...
        private void ConnectionsToActivateHelper(
            WebPartConnection connection,
            IDictionary connectionIDs,
        ...
        )
        {
            ...
            if (providerWebPart == null)
            {
                if (connection.IsStatic)
                {
                    ...
                    throw new InvalidOperationException(
                        SR.GetString(SR.WebPartConnection_NoProvider, connection.ProviderID)
                    );
                }
                else
                {
            ...
            if (consumerWebPart == null)
            {
                if (connection.IsStatic)
                {
                    // throw an exception, to alert the developer that his static connection is invalid
                    throw new InvalidOperationException(
                        SR.GetString(SR.WebPartConnection_NoConsumer, connection.ConsumerID)
                    );
                }
                else
                {
            ...
            if (providerConnectionPoint == null)
            {
                consumerWebPart.SetConnectErrorMessage(
                    SR.GetString(
                        SR.WebPartConnection_NoProviderConnectionPoint,
            ...
            if (consumerConnectionPoint == null)
            {
                consumerWebPart.SetConnectErrorMessage(
                    SR.GetString(
                        SR.WebPartConnection_NoConsumerConnectionPoint,
        ...
        {
            CanConnectWebPartsCore(
                provider,
                providerConnectionPoint,
                consumer,
                consumerConnectionPoint,
                transformer, /*throwOnError*/
                true
            );
        ...
        private static ICollection[] CreateConnectionPoints(Type type)
        {
            ...
            foreach (MethodInfo method in methods)
            {
                ...
                object[] consumerAttributes = method.GetCustomAttributes(
                    typeof(ConnectionConsumerAttribute),
                    true
                );
                ...
                if (consumerAttributes.Length == 1)
                {
                    ...
                    {
                        ConnectionConsumerAttribute attribute =
                            consumerAttributes[0] as ConnectionConsumerAttribute;
                        ...
                        {
                            connectionPoint = new ConsumerConnectionPoint(
                                method,
                                parameterType,
                                type,
                                displayName,
                    ...
                    else
                    {
                        throw new InvalidOperationException(
                            SR.GetString(
                                SR.WebPartManager_InvalidConsumerSignature,
                                method.Name,
                                type.FullName
                            )
                        );
                ...
                object[] providerAttributes = method.GetCustomAttributes(
                    typeof(ConnectionProviderAttribute),
                    true
                );
                ...
                if (providerAttributes.Length == 1)
                {
                    ...
                    {
                        ConnectionProviderAttribute attribute =
                            providerAttributes[0] as ConnectionProviderAttribute;
                        String displayName = attribute.DisplayName;
                        String id = attribute.ID;
                        Type connectionPointType = attribute.ConnectionPointType;
                        bool allowsMultipleConnections = attribute.AllowsMultipleConnections;
                        ...
                        if (connectionPointType == null)
                        {
                            connectionPoint = new ProviderConnectionPoint(
                                method,
                                returnType,
                                type,
                                displayName,
                    ...
                    else
                    {
                        throw new InvalidOperationException(
                            SR.GetString(
                                SR.WebPartManager_InvalidProviderSignature,
                                method.Name,
                                type.FullName
                            )
                        );
            ...
            {
                new ConsumerConnectionPointCollection(consumerConnectionPoints),
        ...
        {
            ErrorWebPart errorWebPart = new ErrorWebPart(
                originalID,
                originalTypeName,
                originalPath,
                genericWebPartID
        ...
        public virtual void DisconnectWebParts(WebPartConnection connection)
        {
            ...
            if (StaticConnections.Contains(connection))
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.WebPartManager_DisconnectTooLate)
                    );
                }
                if (Internals.ConnectionDeleted(connection))
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.WebPartManager_AlreadyDisconnected)
                    );
                }
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.WebPartManager_UnknownConnection),
                    "connection"
                );
            }
        }
        ...
        public virtual void EndWebPartConnecting()
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.WebPartManager_NoSelectedWebPartConnect)
                );
            }
        ...
        public virtual void EndWebPartEditing()
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.WebPartManager_NoSelectedWebPartEdit)
                );
            }
        ...
        public virtual void ExportWebPart(WebPart webPart, XmlWriter writer)
        {
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.WebPartManager_PartNotExportable),
                    "webPart"
                );
            }
            bool excludeSensitive = (
                webPart.ExportMode == WebPartExportMode.NonSensitiveData
            ...
            IDictionary propBag = PersonalizableAttribute.GetPersonalizablePropertyValues(
                webPart,
            ...
            if (genericWebPart != null)
            {
                ...
                IDictionary controlData = PersonalizableAttribute.GetPersonalizablePropertyValues(
                    control,
                    PersonalizationScope.Shared,
                    excludeSensitive
                );
        ...
        )
        {
            ...
            foreach (DictionaryEntry entry in propBag)
            {
                ...
                Type valType = (
                    (pi != null)
                        ? pi.PropertyType
                        : ((val != null) ? val.GetType() : typeof(object))
                );
        ...
        private IList GetAllWebPartsForZone(WebPartZoneBase zone)
        {
            if (_partsForZone == null)
            {
                _partsForZone = new HybridDictionary(
                    true /* caseInsensitive */
                );
                foreach (WebPart part in Controls)
                {
        ...
        private static ICollection[] GetConnectionPoints(Type type)
        {
            ...
            ConnectionPointKey connectionPointKey = new ConnectionPointKey(
                type,
            ...
            ICollection[] connectionPoints = (ICollection[])
                ConnectionPointsCache[connectionPointKey];
        ...
        internal ConsumerConnectionPoint GetConsumerConnectionPoint(
            WebPart webPart,
        ...
        public virtual ConsumerConnectionPointCollection GetConsumerConnectionPoints(
            WebPart webPart
        )
        {
            if (webPart == null)
        ...
        private static ICollection GetEnabledConnectionPoints(
        ...
        internal ConsumerConnectionPointCollection GetEnabledConsumerConnectionPoints(
            WebPart webPart
        )
        {
        ...
        internal ProviderConnectionPointCollection GetEnabledProviderConnectionPoints(
            WebPart webPart
        )
        {
            ICollection enabledPoints = GetEnabledConnectionPoints(
        ...
        internal ProviderConnectionPoint GetProviderConnectionPoint(
            WebPart webPart,
            string connectionPointID
        )
        {
        ...
        /// Else, returns null.
        /// </devdoc>
        internal WebPartConnection GetConnectionForConsumer(
            WebPart consumer,
            ConsumerConnectionPoint connectionPoint
        )
        {
            ...
            foreach (WebPartConnection connection in StaticConnections)
            {
                ...
                {
                    ConsumerConnectionPoint c = GetConsumerConnectionPoint(
                        consumer,
                        connection.ConsumerConnectionPointID
                    );
        ...
        /// Else, returns null.
        /// </devdoc>
        internal WebPartConnection GetConnectionForProvider(
            WebPart provider,
            ProviderConnectionPoint connectionPoint
        )
        {
            ...
            foreach (WebPartConnection connection in StaticConnections)
            {
                ...
                {
                    ProviderConnectionPoint c = GetProviderConnectionPoint(
                        provider,
                        connection.ProviderConnectionPointID
                    );
                    if (c == actualConnectionPoint)
        ...
        private static void ImportReadTo(
            XmlReader reader,
            string elementToFindA,
            string elementToFindB
        )
        {
                            ...
                            if (!partType.IsSubclassOf(typeof(WebPart)))
                            {
                                if (!partType.IsSubclassOf(typeof(Control)))
                                {
                                    ...
                                    errorMessage = SR.GetString(
                                        SR.WebPartManager_TypeMustDeriveFromControl
                                    );
                                    return null;
                                }
                    ...
                    if (childControl != null)
                    {
                        if (!reader.IsEmptyElement)
                        {
                            ...
                            personalizableProperties =
                                PersonalizableAttribute.GetPersonalizablePropertyEntries(partType);
            ...
            try
            {
                try
                {
                    ...
                    while (reader.Name == ExportPropertyElement)
                    {
                        ...
                        if (
                            propertyName == AuthorizationFilterName
                        ...
                        else
                        {
                            ...
                            if (personalizableProperties != null)
                            {
                                ...
                                PersonalizablePropertyEntry entry = (PersonalizablePropertyEntry)(
                                    personalizableProperties[propertyName]
                                );
                                if (entry != null)
                                {
                                    ...
                                    if (
                                        urlAttr != null
                                        && CrossSiteScriptingValidation.IsDangerousUrl(valString)
                                    )
                                    {
                                        throw new InvalidDataException(
                                            SR.GetString(SR.WebPart_BadUrl, valString)
                                        );
                                    }
                                }
                            }
                            ...
                            if ((pi != null) && ((pi.PropertyType == type) || (type == null)))
                            {
                                ...
                                if (attr != null)
                                {
                                    ...
                                    Type converterType = WebPartUtil.DeserializeType(
                                    ...
                                    if (
                                        converterType != null
                                        && converterType.IsSubclassOf(typeof(TypeConverter))
                                    )
                                    {
                                        ...
                                        if (Util.CanConvertToFrom(converter, typeof(string)))
                                        {
                                            if (!isNull)
                                            {
                                                val = converter.ConvertFromInvariantString(
                                                    valString
                                                );
                                            }
                                            valueComputed = true;
                            ...
                            if (!valueComputed && (type != null))
                            {
                                ...
                                else
                                {
                                    ...
                                    if (Util.CanConvertToFrom(typeConverter, typeof(string)))
                                    {
                                        if (!isNull)
                                        {
                                            val = typeConverter.ConvertFromInvariantString(
                                                valString
                                            );
                                        }
                                        valueComputed = true;
                            ...
                            if (valueComputed)
                            {
                                ...
                                {
                                    // Determine scope:
                                    PersonalizationScope personalizationScope = String.Equals(
                                        scope,
                                    ...
                                    properties.Add(
                                        propertyName,
                                        new PersonalizationEntry(val, personalizationScope)
                                    );
                                }
                            }
                            else
                            {
                                throw new HttpException(
                                    SR.GetString(SR.WebPartManager_ImportInvalidData, propertyName)
                                );
                            }
                        }
                        while (reader.Name != ExportPropertyElement)
                        {
                            if (
                                ...
                                || (
                                    (reader.Name == ExportIPersonalizableElement)
                    ...
                    if (personalizableProperties != null)
                    {
                        IDictionary unused = BlobPersonalizationState.SetPersonalizedProperties(
                            target,
                            properties
                        );
                        if ((unused != null) && (unused.Count > 0))
                        {
                            IVersioningPersonalizable versioningTarget =
                                target as IVersioningPersonalizable;
        ...
        )
        {
            ...
            else
            {
                ...
                {
                    throw new ArgumentException(
                        SR.GetString(SR.WebPartManager_PathMustBeEmpty, path)
                    );
                }
            }

            WebPartAuthorizationEventArgs auth = new WebPartAuthorizationEventArgs(
                type,
                path,
                authorizationFilter,
                isShared
        ...
        public bool IsAuthorized(WebPart webPart)
        {
            ...
            {
                string personalizedAuthorizationFilter = Personalization.GetAuthorizationFilter(
                    webPart.ID
                );
            ...
            if (entry != null)
            {
                ...
                if (dynamicConnectionState != null)
                {
                    ...
                    for (int i = 0; i < dynamicConnectionState.Length; i += 7)
                    {
                        ...
                        Internals.SetIsShared(
                            connection,
                            (entry.Scope == PersonalizationScope.Shared)
                        );
                        Internals.SetIsStatic(connection, false);
                        ...
                        if (type != null)
                        {
                            ...
                            if (type.IsSubclassOf(typeof(WebPartTransformer)))
                            {
                                ...
                                WebPartTransformer transformer = (WebPartTransformer)
                                    Internals.CreateObjectFromType(type);
        ...
        private void LoadDynamicWebPart(
            string id,
            string typeName,
            string path,
            string genericWebPartID,
        ...
        )
        {
            ...
            if (type == null)
            {
                ...
                dynamicWebPart = CreateErrorWebPart(
                    id,
                    typeName,
                    path,
                    genericWebPartID,
            ...
            else if (type.IsSubclassOf(typeof(WebPart)))
            {
                ...
                if (IsAuthorized(type, null, authorizationFilter, isShared))
                {
                    ...
                    catch
                    {
                        ...
                        {
                            errorMessage = SR.GetString(
                                SR.WebPartManager_CantCreateInstanceWithType,
                                typeName
                            );
                        }
                        dynamicWebPart = CreateErrorWebPart(
            ...
            {
                string authorizationFilter = Personalization.GetAuthorizationFilter(
                    genericWebPartID
                );
                if (IsAuthorized(type, path, authorizationFilter, isShared))
                {
                    ...
                    catch
                    {
                        ...
                        else if (childControl == null)
                        {
                            ...
                            {
                                errorMessage = SR.GetString(
                                    SR.WebPartManager_InvalidPathWithPath,
                                    path
                                );
                            }
                        }
            ...
            else
            {
                ...
                {
                    errorMessage = SR.GetString(
                        SR.WebPartManager_TypeMustDeriveFromControlWithType,
                        typeName
                    );
                }
                dynamicWebPart = CreateErrorWebPart(
        ...
        public virtual void MoveWebPart(WebPart webPart, WebPartZoneBase zone, int zoneIndex)
        {
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.WebPartManager_MustBeInZone),
                    "webPart"
                );
            }
        ...
        {
            WebPartAuthorizationEventHandler handler = (WebPartAuthorizationEventHandler)
                Events[AuthorizeWebPartEvent];
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        {
            WebPartDisplayModeEventHandler handler = (WebPartDisplayModeEventHandler)
                Events[DisplayModeChangedEvent];
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        {
            WebPartDisplayModeCancelEventHandler handler = (WebPartDisplayModeCancelEventHandler)
                Events[DisplayModeChangingEvent];
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        protected internal override void OnInit(EventArgs e)
        {
            ...
            if (!DesignMode)
            {
                ...
                if (page != null)
                {
                    WebPartManager existingInstance = (WebPartManager)
                        page.Items[typeof(WebPartManager)];

                    if (existingInstance != null)
                    {
                        Debug.Assert(existingInstance != this);
                        throw new InvalidOperationException(
                            SR.GetString(SR.WebPartManager_OnlyOneInstance)
                        );
                    }
        ...
        {
            WebPartCancelEventHandler handler = (WebPartCancelEventHandler)
                Events[SelectedWebPartChangingEvent];
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        {
            WebPartAddingEventHandler handler = (WebPartAddingEventHandler)
                Events[WebPartAddingEvent];
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        {
            WebPartMovingEventHandler handler = (WebPartMovingEventHandler)
                Events[WebPartMovingEvent];
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        {
            WebPartConnectionsEventHandler handler = (WebPartConnectionsEventHandler)
                Events[WebPartsConnectedEvent];
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        {
            WebPartConnectionsCancelEventHandler handler = (WebPartConnectionsCancelEventHandler)
                Events[WebPartsConnectingEvent];
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        {
            WebPartConnectionsEventHandler handler = (WebPartConnectionsEventHandler)
                Events[WebPartsDisconnectedEvent];
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        {
            WebPartConnectionsCancelEventHandler handler = (WebPartConnectionsCancelEventHandler)
                Events[WebPartsDisconnectingEvent];
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        protected virtual void RegisterClientScript()
        {
            ...
            {
                string isVertical =
                    (zone.LayoutOrientation == Orientation.Vertical) ? "true" : "false";
                ...
                foreach (WebPart webPart in webParts)
                {
                    ...
                    if (allowPageDesign)
                    {
                        titleBarElementReference =
                            "document.getElementById('" + webPart.TitleBarID + "')";
        ...
        internal void RegisterZone(WebZone zone)
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.WebPartManager_RegisterTooLate)
                );
            }
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.WebPartManager_DuplicateZoneID, zoneID)
                );
            }
            ...
            if (webPartZone != null)
            {
                ...
                {
                    throw new ArgumentException(
                        SR.GetString(SR.WebPartManager_AlreadyRegistered),
                        "zone"
                    );
                }
                ...
                ((WebPartManagerControlCollection)Controls).AddWebPartsFromZone(
                    webPartZone,
                    initialWebParts
                );
            }
            else
            {
                ...
                {
                    if (
                        allDisplayModes.Contains(displayMode)
                        && !supportedDisplayModes.Contains(displayMode)
                    )
                    {
        ...
        protected internal override void Render(HtmlTextWriter writer)
        {
            ...
            {
                string dragOverlayElementHtml = String.Format(
                    CultureInfo.InvariantCulture,
        ...
        protected virtual void SaveCustomPersonalizationState(PersonalizationDictionary state)
        {
            ...
            if (webPartsCount > 0)
            {
                ...
                {
                    state["WebPartStateShared"] = new PersonalizationEntry(
                        webPartState,
                        PersonalizationScope.Shared
                    );
                }
                ...
                {
                    state["WebPartStateUser"] = new PersonalizationEntry(
                        webPartState,
                        PersonalizationScope.User
                    );
                }
            ...
            if (dynamicWebPartsCount > 0)
            {
                ...
                if (scope == PersonalizationScope.Shared)
                {
                    state["DynamicWebPartsShared"] = new PersonalizationEntry(
                        dynamicWebPartState,
                        PersonalizationScope.Shared
                    );
                }
                ...
                {
                    state["DynamicWebPartsUser"] = new PersonalizationEntry(
                        dynamicWebPartState,
                        PersonalizationScope.User
                    );
                }
            ...
            if (deletedConnections.Count > 0)
            {
                ...
                if (scope == PersonalizationScope.Shared)
                {
                    state["DeletedConnectionsShared"] = new PersonalizationEntry(
                ...
                {
                    state["DeletedConnectionsUser"] = new PersonalizationEntry(
                        deletedConnectionsState,
                        PersonalizationScope.User
                    );
                }
            ...
            {
                if (
                    ((scope == PersonalizationScope.User) && (!connection.IsShared))
            ...
            if (dynamicConnectionsCount > 0)
            {
                ...
                for (int i = 0; i < dynamicConnectionsCount; i++)
                {
                    ...
                    if (transformer != null)
                    {
                        ...
                        dynamicConnectionState[7 * i + 6] = Internals.SaveConfigurationState(
                            transformer
                        );
                    }
                }
                ...
                if (scope == PersonalizationScope.Shared)
                {
                    state["DynamicConnectionsShared"] = new PersonalizationEntry(
                ...
                {
                    state["DynamicConnectionsUser"] = new PersonalizationEntry(
                        dynamicConnectionState,
                        PersonalizationScope.User
                    );
                }
        ...
        private bool ShouldExportProperty(
            ...
            else
            {
                ...
                if (propertyInfo != null)
                {
                    ...
                    if (attr != null)
                    {
                        ...
                        {
                            TypeConverter tempConverter = (TypeConverter)(
                                Internals.CreateObjectFromType(converterType)
                            );
        ...
        private void VerifyType(Control control)
        {
            ...
            Type loadedType = WebPartUtil.DeserializeType(
        ...
        {
            get { return IsCustomPersonalizationStateDirty; }
        }
        ...
        private sealed class WebPartManagerControlCollection : ControlCollection
        {
            ...
            private void AddWebPartHelper(WebPart webPart)
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.WebPartManager_NoWebPartID)
                    );
                }
                if (_manager._partAndChildControlIDs.Contains(partID))
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.WebPartManager_DuplicateWebPartID, partID)
                    );
                }
                ...
                if (genericWebPart != null)
                {
                    ...
                    {
                        throw new InvalidOperationException(
                            SR.GetString(SR.WebPartManager_NoChildControlID)
                        );
                    }
                    ...
                    {
                        throw new InvalidOperationException(
                            SR.GetString(SR.WebPartManager_DuplicateWebPartID, childControlID)
                        );
                    }
