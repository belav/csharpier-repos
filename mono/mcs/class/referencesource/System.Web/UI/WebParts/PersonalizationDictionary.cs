...
namespace System.Web.UI.WebControls.WebParts
{
    ...
    public class PersonalizationDictionary : IDictionary
    {
        ...
        {
            _dictionary = new HybridDictionary( /* caseInsensitive */
                true
            );
        }
        ...
        object IDictionary.this[object key]
        {
            get
            {
                if (!(key is string))
                {
                    throw new ArgumentException(
                        SR.GetString(SR.PersonalizationDictionary_MustBeTypeString),
                        "key"
                    );
                }
            ...
            set
            {
                ...
                {
                    throw new ArgumentException(
                        SR.GetString(SR.PersonalizationDictionary_MustBeTypePersonalizationEntry),
                        "value"
                    );
                }
        ...
        void ICollection.CopyTo(Array array, int index)
        {
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.PersonalizationDictionary_MustBeTypeDictionaryEntryArray),
                    "array"
                );
            }
