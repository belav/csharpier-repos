...
namespace System.Web.UI.WebControls.WebParts
{
    ...
    public class WebPartVerb : IStateManager
    {
        ...
        {
            get { return (_clientClickHandler == null) ? String.Empty : _clientClickHandler; }
        }
        ...
        {
            get { return (_eventArgument != null) ? _eventArgument : String.Empty; }
        ...
        {
            get { return _serverClickHandler; }
        }
        ...
        internal string GetEventArgument(string webPartID)
        {
            ...
            else
            {
                ...
                {
                    return _eventArgumentPrefix
                        + _id
                        + WebPartZoneBase.EventArgumentSeparator
                        + webPartID;
                }
            }
        }
