...
namespace System.Web.UI.WebControls.WebParts
{
    ...
    public sealed class WebPartDisplayModeCollection : CollectionBase
    {
        ...
        {
            get { return (WebPartDisplayMode)List[index]; }
        }
        ...
        protected override void OnClear()
        {
            throw new InvalidOperationException(
                SR.GetString(SR.WebPartDisplayModeCollection_CantRemove)
            );
        }
            ...
            foreach (WebPartDisplayMode existingDisplayMode in List)
            {
                if (displayMode.Name == existingDisplayMode.Name)
                {
                    throw new ArgumentException(
                        SR.GetString(
                            SR.WebPartDisplayModeCollection_DuplicateName,
                            displayMode.Name
                        )
                    );
                }
        ...
        {
            throw new InvalidOperationException(
                SR.GetString(SR.WebPartDisplayModeCollection_CantSet)
            );
        }
        ...
        protected override void OnValidate(object value)
        {
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.Collection_InvalidType, "WebPartDisplayMode"),
                    "value"
                );
            }
        }
