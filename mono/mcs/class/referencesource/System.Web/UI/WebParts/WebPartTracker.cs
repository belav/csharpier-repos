...
namespace System.Web.UI.WebControls.WebParts
{
    ...
    public sealed class WebPartTracker : IDisposable
    {
        ...
        public WebPartTracker(WebPart webPart, ProviderConnectionPoint providerConnectionPoint)
        {
            ...
            if (providerConnectionPoint.ControlType != webPart.GetType())
            {
                throw new ArgumentException(
                    SR.GetString(SR.WebPartManager_InvalidConnectionPoint),
            ...
            if (++Count > 1)
            {
                webPart.SetConnectErrorMessage(
                    SR.GetString(
                        SR.WebPartTracker_CircularConnection,
                        _providerConnectionPoint.DisplayName
                    )
                );
            }
        }
        ...
        private int Count
        {
            ...
            set { _webPart.TrackerCounter[_providerConnectionPoint] = value; }
        }
