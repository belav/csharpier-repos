    ...
    public class ConnectionsZone : ToolZone
    {
            ...
            get
            {
                if (_availableTransformers == null)
                {
                    ...
                    TransformerTypeCollection availableTransformerTypes =
                        WebPartManager.AvailableTransformers;
        ...
        public virtual string ConfigureConnectionTitle
        {
            get
            {
                ...
                return (
                    (s == null) ? SR.GetString(SR.ConnectionsZone_ConfigureConnectionTitle) : s
                );
            }
        ...
        public virtual string ConnectToConsumerInstructionText
        {
            get
            {
                ...
                return (
                    (s == null)
                        ? SR.GetString(SR.ConnectionsZone_ConnectToConsumerInstructionText)
                        : s
                );
            }
        ...
        public virtual string ConnectToProviderInstructionText
        {
            get
            {
                ...
                return (
                    (s == null)
                        ? SR.GetString(SR.ConnectionsZone_ConnectToProviderInstructionText)
                        : s
                );
            }
        ...
        public virtual string ConsumersInstructionText
        {
            get
            {
                ...
                return (
                    (s == null) ? SR.GetString(SR.ConnectionsZone_ConsumersInstructionText) : s
                );
            }
        ...
        public virtual string NewConnectionErrorMessage
        {
            get
            {
                ...
                return s == null
                    ? SR.GetString(SR.ConnectionsZone_ErrorCantContinueConnectionCreation)
                    : s;
            }
        ...
        public virtual string NoExistingConnectionInstructionText
        {
            get
            {
                ...
                return (
                    (s == null)
                        ? SR.GetString(SR.ConnectionsZone_NoExistingConnectionInstructionText)
                        : s
                );
            }
        ...
        public virtual string NoExistingConnectionTitle
        {
            get
            {
                ...
                return (
                    (s == null) ? SR.GetString(SR.ConnectionsZone_NoExistingConnectionTitle) : s
                );
            }
        ...
        public virtual string ProvidersInstructionText
        {
            get
            {
                ...
                return (
                    (s == null) ? SR.GetString(SR.ConnectionsZone_ProvidersInstructionText) : s
                );
            }
        ...
        private void ConnectConsumer(string consumerConnectionPointID)
        {
            ...
            if (!String.IsNullOrEmpty(selectedValue))
            {
                ...
                if (transformerType != null)
                {
                    ...
                    WebPartTransformer transformer = (WebPartTransformer)
                        WebPartUtil.CreateObjectFromType(transformerType);
                    if (GetConfigurationControl(transformer) == null)
                    {
                        if (
                            WebPartManager.CanConnectWebParts(
                                provider.WebPart,
                        ...
                        {
                            WebPartManager.ConnectWebParts(
                                provider.WebPart,
                                provider.ConnectionPoint,
                                consumer,
                                consumerConnectionPoint,
        ...
        protected internal override void CreateChildControls()
        {
            ...
            if (webPartToConnect != null && !webPartToConnect.IsClosed)
            {
                ...
                foreach (
                    ProviderConnectionPoint providerConnectionPoint in providerConnectionPoints
                )
                {
                ...
                foreach (
                    ConsumerConnectionPoint consumerConnectionPoint in consumerConnectionPoints
                )
                {
                    DropDownList list = new DropDownList();
                ...
                if (_pendingConnectionType == ConnectionType.Consumer)
                {
                    if (EnsurePendingData())
                    {
                        ...
                        {
                            IDictionary providers = (IDictionary)
                                _connectionPointInfo[_pendingConsumerConnectionPoint];
                            ProviderInfo providerInfo = (ProviderInfo)
                                providers[_pendingSelectedValue];
                ...
                else if (_pendingConnectionType == ConnectionType.Provider)
                {
                    if (EnsurePendingData())
                    {
                        ...
                        IDictionary consumers = (IDictionary)
                            _connectionPointInfo[_pendingProviderConnectionPoint];
        ...
        private bool EnsurePendingData()
        {
            ...
            if (_pendingConnectionType == ConnectionType.Provider)
            {
                ...
                _pendingProviderConnectionPoint = WebPartManager.GetProviderConnectionPoint(
                    WebPartToConnect,
            ...
            if (_pendingConnectionType == ConnectionType.Consumer)
            {
                ...
                _pendingConsumerConnectionPoint = WebPartManager.GetConsumerConnectionPoint(
                    _pendingConsumer,
                    _pendingConnectionPointID
                );
            ...
            if (connection != null)
            {
                ...
                )
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.ConnectionsZone_DisconnectInvalid)
                    );
                }
        ...
        private Control GetConfigurationControl(WebPartTransformer transformer)
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.ConnectionsZone_MustImplementITransformerConfigurationControl)
                );
            }
        }
        ...
        private IDictionary GetValidConsumers(
            WebPart provider,
            ProviderConnectionPoint providerConnectionPoint,
        ...
        )
        {
            ...
            if (
                !providerConnectionPoint.AllowsMultipleConnections
            ...
            foreach (WebPart consumer in webParts)
            {
                ...
                foreach (
                    ConsumerConnectionPoint consumerConnectionPoint in WebPartManager.GetConsumerConnectionPoints(
                        consumer
                    )
                )
                {
        ...
        private IDictionary GetValidProviders(
            WebPart consumer,
            ConsumerConnectionPoint consumerConnectionPoint,
            WebPartCollection webParts
        )
        {
            ...
            if (
                !consumerConnectionPoint.AllowsMultipleConnections
            ...
            foreach (WebPart provider in webParts)
            {
                ...
                foreach (
                    ProviderConnectionPoint providerConnectionPoint in WebPartManager.GetProviderConnectionPoints(
                        provider
                    )
                )
                {
        ...
        protected internal override void LoadControlState(object savedState)
        {
            if (savedState != null)
            {
                ...
                {
                    _pendingTransformerConfigurationControlTypeName = (string)
                        state[pendingTransformerTypeNameIndex];
                }
        ...
        private void RenderAddVerbs(HtmlTextWriter writer)
        {
            ...
            if (webPartToConnect != null || DesignMode)
            {
                ...
                {
                    ZoneLinkButton connectConsumerButton = new ZoneLinkButton(
                        this,
                        connectConsumerEventArgument
                    );
                ...
                {
                    ZoneLinkButton connectProviderButton = new ZoneLinkButton(
                        this,
                        connectProviderEventArgument
                    );
        ...
        {
            if (
                this.PartChromeType == PartChromeType.Default
        ...
        private void RenderConnectToConsumersDropDowns(HtmlTextWriter writer)
        {
            ...
            if (webPartToConnect != null)
            {
                ...
                foreach (ProviderConnectionPoint provider in providers)
                {
                    ...
                    connectVerb.EventArgument = String.Join(
                        ID_SEPARATOR.ToString(CultureInfo.InvariantCulture),
        ...
        private void RenderExistingConnection(
        ...
        private void RenderExistingConsumerConnection(
            HtmlTextWriter writer,
        ...
        )
        {
            ...
            ProviderConnectionPoint providerConnectionPoint =
                WebPartManager.GetProviderConnectionPoint(
                    webPartToConnect,
        ...
        private void RenderExistingProviderConnection(
            HtmlTextWriter writer,
            WebPartConnection connection
        )
        {
            ...
            ConsumerConnectionPoint consumerConnectionPoint =
                WebPartManager.GetConsumerConnectionPoint(
                    webPartToConnect,
        ...
        {
            if (
                this.PartChromeType == PartChromeType.None
                || this.PartChromeType == PartChromeType.BorderOnly
            )
                return;
        ...
        protected internal override object SaveControlState()
        {
            ...
            if (_mode != ConnectionsZoneMode.ExistingConnections || baseState != null)
            {
                ...
                myState[pendingTransformerTypeNameIndex] =
                    _pendingTransformerConfigurationControlTypeName;
        ...
        protected override object SaveViewState()
        {
            ...
            myState[configureVerbIndex] =
                (_configureVerb != null) ? ((IStateManager)_configureVerb).SaveViewState() : null;
            myState[connectVerbIndex] =
                (_connectVerb != null) ? ((IStateManager)_connectVerb).SaveViewState() : null;
            myState[disconnectVerbIndex] =
                (_disconnectVerb != null) ? ((IStateManager)_disconnectVerb).SaveViewState() : null;
        ...
        private void SetDropDownProperties()
        {
            ...
            if (webPartToConnect != null && !webPartToConnect.IsClosed)
            {
                ...
                )
                {
                    ...
                    IDictionary consumers = GetValidConsumers(
                        webPartToConnect,
                        providerConnectionPoint,
                        webParts
                    );
                    ...
                    else
                    {
                        ...
                        WebPartConnection currentConnection =
                            providerConnectionPoint.AllowsMultipleConnections
                                ? null
                                : WebPartManager.GetConnectionForProvider(
                                    webPartToConnect,
                                    providerConnectionPoint
                                );
                        ...
                        if (currentConnection != null)
                        {
                            ...
                            currentConsumerConnectionPoint =
                                currentConnection.ConsumerConnectionPoint;
                            list.Enabled = false;
                        }
                        else
                        {
                ...
                )
                {
                    ...
                    IDictionary providers = GetValidProviders(
                        webPartToConnect,
                        consumerConnectionPoint,
                        webParts
                    );
                    ...
                    else
                    {
                        ...
                        if (currentConnection != null)
                        {
                            ...
                            currentProviderConnectionPoint =
                                currentConnection.ProviderConnectionPoint;
                            list.Enabled = false;
                        }
                        else
                        {
        ...
        private void SetTransformerConfigurationControlProperties()
        {
            if (EnsurePendingData())
            {
                Control pendingProviderControl = _pendingProvider.ToControl();
                Control pendingConsumerControl = _pendingConsumer.ToControl();
                object dataObject = _pendingProviderConnectionPoint.GetObject(
                    pendingProviderControl
                );
                object transformedObject = _pendingTransformer.Transform(dataObject);
                _pendingConsumerConnectionPoint.SetObject(
                    pendingConsumerControl,
                    transformedObject
                );
