...
namespace System.Web.UI.WebControls.WebParts
{
    ...
    public sealed class PersonalizationStateQuery
    {
        ...
        {
            _knownPropertyTypeMappings = new Dictionary<String, Type>(
        ...
        {
            get { return (string)this["PathToMatch"]; }
            set
            {
                if (value != null)
                {
        ...
        public DateTime UserInactiveSinceDate
        {
            ...
            set { _data["UserInactiveSinceDate"] = value; }
        }

        public string UsernameToMatch
        {
            get { return (string)this["UsernameToMatch"]; }
            set
            {
                if (value != null)
                {
        ...
        public object this[string queryKey]
        {
            ...
            set
            {
                ...
                if (_knownPropertyTypeMappings.ContainsKey(queryKey))
                {
                    ...
                    if (
                        (value == null && valueType.IsValueType)
                        || (value != null && !valueType.IsAssignableFrom(value.GetType()))
                    )
                    {
                        throw new ArgumentException(
                            SR.GetString(
                                SR.PersonalizationStateQuery_IncorrectValueType,
                                queryKey,
                                valueType.FullName
                            )
                        );
