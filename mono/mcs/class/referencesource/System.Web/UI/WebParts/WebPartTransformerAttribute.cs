...
namespace System.Web.UI.WebControls.WebParts
{
    ...
    public sealed class WebPartTransformerAttribute : Attribute
    {
        ...
        private static readonly Hashtable transformerCache = Hashtable.Synchronized(
            new Hashtable()
        );
        ...
        private static Type[] GetTransformerTypes(Type transformerType)
        {
            ...
            if (!transformerType.IsSubclassOf(typeof(WebPartTransformer)))
            {
                throw new InvalidOperationException(
                    SR.GetString(
                        SR.WebPartTransformerAttribute_NotTransformer,
        ...
        private static Type[] GetTransformerTypesFromAttribute(Type transformerType)
        {
            ...
            object[] attributes = transformerType.GetCustomAttributes(
                typeof(WebPartTransformerAttribute),
                true
            );
            ...
            if (attributes.Length == 1)
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.WebPartTransformerAttribute_SameTypes)
                    );
                }
