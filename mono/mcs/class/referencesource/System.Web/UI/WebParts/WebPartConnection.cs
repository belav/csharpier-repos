...
namespace System.Web.UI.WebControls.WebParts
{
    ...
    [TypeConverter(typeof(ExpandableObjectConverter)), ParseChildren(true, "Transformers")]
    public sealed class WebPartConnection
    {
            ...
            get
            {
                ...
                if (consumerID.Length == 0)
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.WebPartConnection_ConsumerIDNotSet)
                    );
                }
        ...
        public ConsumerConnectionPoint ConsumerConnectionPoint
        {
            get
            {
                ...
                {
                    return _webPartManager.GetConsumerConnectionPoint(
                        consumer,
        ...
        {
            get { return (_consumerID != null) ? _consumerID : String.Empty; }
        ...
        public WebPart Provider
        {
            get
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.WebPartConnection_ProviderIDNotSet)
                    );
                }
        ...
        public ProviderConnectionPoint ProviderConnectionPoint
        {
            get
            {
                ...
                {
                    return _webPartManager.GetProviderConnectionPoint(
                        provider,
        ...
        {
            get { return (_providerID != null) ? _providerID : String.Empty; }
        ...
        internal void Activate()
        {
            ...
            {
                consumerWebPart.SetConnectErrorMessage(
                    SR.GetString(
                        SR.WebPartConnection_DisabledConnectionPoint,
            ...
            if (!providerWebPart.IsClosed && !consumerWebPart.IsClosed)
            {
                ...
                {
                    if (
                        providerConnectionPoint.InterfaceType
                        == consumerConnectionPoint.InterfaceType
                    )
                    {
                        ConnectionInterfaceCollection secondaryInterfaces =
                            providerConnectionPoint.GetSecondaryInterfaces(providerControl);
                        if (
                            consumerConnectionPoint.SupportsConnection(
                                consumerControl,
                                secondaryInterfaces
                            )
                        )
                        ...
                        else
                        {
                            consumerWebPart.SetConnectErrorMessage(
                                SR.GetString(
                                    SR.WebPartConnection_IncompatibleSecondaryInterfaces,
                                    new string[]
                                    {
                                        consumerConnectionPoint.DisplayName,
                                        consumerWebPart.DisplayTitle,
                    ...
                    else
                    {
                        consumerWebPart.SetConnectErrorMessage(
                            SR.GetString(
                                SR.WebPartConnection_NoCommonInterface,
                                new string[]
                                {
                                    providerConnectionPoint.DisplayName,
                                    providerWebPart.DisplayTitle,
                ...
                else
                {
                    ...
                    if (!_webPartManager.AvailableTransformers.Contains(transformerType))
                    {
                        string errorMessage;
                        if (
                            _webPartManager.Context != null
                            && _webPartManager.Context.IsCustomErrorEnabled
                        )
                        {
                            errorMessage = SR.GetString(
                                SR.WebPartConnection_TransformerNotAvailable
                            );
                        }
                        else
                        {
                            errorMessage = SR.GetString(
                                SR.WebPartConnection_TransformerNotAvailableWithType,
                    ...
                    Type transformerConsumerType = WebPartTransformerAttribute.GetConsumerType(
                        transformerType
                    );
                    Type transformerProviderType = WebPartTransformerAttribute.GetProviderType(
                        transformerType
                    );

                    if (
                        providerConnectionPoint.InterfaceType == transformerConsumerType
                    ...
                    )
                    {
                        ...
                        else
                        {
                            consumerWebPart.SetConnectErrorMessage(
                                SR.GetString(
                                    SR.WebPartConnection_ConsumerRequiresSecondaryInterfaces,
                                    consumerConnectionPoint.DisplayName,
                                    consumerWebPart.DisplayTitle
                                )
                            );
                    ...
                    else if (providerConnectionPoint.InterfaceType != transformerConsumerType)
                    {
                        ...
                        {
                            errorMessage = SR.GetString(
                                SR.WebPartConnection_IncompatibleProviderTransformer,
                                providerConnectionPoint.DisplayName,
                                providerWebPart.DisplayTitle
                            );
                        }
                        ...
                        {
                            errorMessage = SR.GetString(
                                SR.WebPartConnection_IncompatibleProviderTransformerWithType,
                                providerConnectionPoint.DisplayName,
                                providerWebPart.DisplayTitle,
                                transformerType.FullName
                            );
                    ...
                    else
                    {
                        ...
                        {
                            errorMessage = SR.GetString(
                                SR.WebPartConnection_IncompatibleConsumerTransformer,
                                consumerConnectionPoint.DisplayName,
                                consumerWebPart.DisplayTitle
                            );
                        }
                        ...
                        {
                            errorMessage = SR.GetString(
                                SR.WebPartConnection_IncompatibleConsumerTransformerWithType,
                                transformerType.FullName,
                                consumerConnectionPoint.DisplayName,
                                consumerWebPart.DisplayTitle
                            );
        ...
        {
            return (
                ConflictsWithConsumer(otherConnection) || ConflictsWithProvider(otherConnection)
            );
        }
