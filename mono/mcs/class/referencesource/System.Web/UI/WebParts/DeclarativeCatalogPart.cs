...
namespace System.Web.UI.WebControls.WebParts
{
    ...
    public sealed class DeclarativeCatalogPart : CatalogPart
    {
        ...
        [
            DefaultValue(""),
            Editor(
                "System.Web.UI.Design.UserControlFileEditor, " + AssemblyRef.SystemDesign,
                typeof(UITypeEditor)
            ),
            Themeable(false),
            UrlProperty(),
        ...
        public string WebPartsListUserControlPath
        {
            get
            {
                return (_webPartsListUserControlPath != null)
                    ? _webPartsListUserControlPath
                    : String.Empty;
            }
            set
            {
