...
namespace System.Web.UI.WebControls.WebParts
{
    ...
    public sealed class LayoutEditorPart : EditorPart
    {
        ...
        {
            get { return WebPartToEdit.Zone.AllowLayoutChange; }
        }
        ...
        public override bool ApplyChanges()
        {
            ...
            if (webPart != null)
            {
                ...
                try
                {
                    ...
                    {
                        TypeConverter chromeStateConverter = TypeDescriptor.GetConverter(
                            typeof(PartChromeState)
                        );
                        webPart.ChromeState = (PartChromeState)
                            chromeStateConverter.ConvertFromString(_chromeState.SelectedValue);
                    }
                }
                catch (Exception e)
                {
                    ...
                    )
                    {
                        if (zoneIndex < MinZoneIndex)
                        {
                            _zoneIndexErrorMessage = SR.GetString(
                                ...
                                MinZoneIndex.ToString(CultureInfo.CurrentCulture)
                            );
                        }
                    }
                    else
                ...
                if (
                    _zoneIndexErrorMessage == null
                    && oldZone.AllowLayoutChange
                    && newZone.AllowLayoutChange
        ...
        public override void SyncChanges()
        {
            ...
            if (webPart != null)
            {
                ...
                _chromeState.SelectedValue = chromeStateConverter.ConvertToString(
                    webPart.ChromeState
                );
