...
namespace System.Web.UI.WebControls.WebParts
{
    ...
    public sealed class WebPartTransformerCollection : CollectionBase
    {
        ...
        {
            get { return (WebPartTransformer)List[index]; }
        ...
        private void CheckReadOnly()
        {
            if (_readOnly)
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.WebPartTransformerCollection_ReadOnly)
                );
            }
        }
        ...
        protected override void OnInsert(int index, object value)
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.WebPartTransformerCollection_NotEmpty)
                );
            }
        ...
        protected override void OnValidate(object value)
        {
            ...
            if (!(value is WebPartTransformer))
            {
                throw new ArgumentException(
                    SR.GetString(SR.Collection_InvalidType, "WebPartTransformer"),
                    "value"
                );
            }
        }
