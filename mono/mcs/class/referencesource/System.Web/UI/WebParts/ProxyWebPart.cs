    ...
    public abstract class ProxyWebPart : WebPart
    {
        ...
        protected ProxyWebPart(WebPart webPart)
        {
            ...
            if (genericWebPart != null)
            {
                ...
                {
                    throw new ArgumentException(
                        SR.GetString(SR.PropertyCannotBeNullOrEmptyString, "ChildControl.ID"),
                        "webPart"
                    );
                }
                ...
                {
                    throw new ArgumentException(
                        SR.GetString(SR.PropertyCannotBeNullOrEmptyString, "ID"),
                        "webPart"
                    );
                }
        ...
        {
            get { return (_genericWebPartID != null) ? _genericWebPartID : String.Empty; }
        }
        ...
        {
            get { return (_originalID != null) ? _originalID : String.Empty; }
        }

        public string OriginalTypeName
        {
            get { return (_originalTypeName != null) ? _originalTypeName : String.Empty; }
        }

        public string OriginalPath
        {
            get { return (_originalPath != null) ? _originalPath : String.Empty; }
        }
