...
namespace System.Web.UI.WebControls.WebParts
{
    ...
    public class WebPartChrome
    {
        ...
        {
            get { return Zone.DragDropEnabled; }
        }
        ...
        private void RegisterStyle(Style style)
        {
            ...
            {
                string name =
                    Zone.ClientID + "_" + _cssStyleIndex++.ToString(NumberFormatInfo.InvariantInfo);
        ...
        private void RenderTitleBar(HtmlTextWriter writer, WebPart webPart)
        {
            ...
            if (hAlign != HorizontalAlign.NotSet)
            {
                ...
                writer.AddAttribute(
                    ...
                    hac.ConvertToString(hAlign).ToLower(CultureInfo.InvariantCulture)
                );
            }
            ...
            if (vAlign != VerticalAlign.NotSet)
            {
                ...
                writer.AddAttribute(
                    HtmlTextWriterAttribute.Valign,
                    vac.ConvertToString(vAlign).ToLower(CultureInfo.InvariantCulture)
                );
            }
        ...
        private void RenderTitleIcon(HtmlTextWriter writer, WebPart webPart)
        {
            ...
            writer.AddAttribute(
                ...
                Zone.ResolveClientUrl(webPart.TitleIconImageUrl)
            );
        ...
        private void RenderTitleText(HtmlTextWriter writer, WebPart webPart)
        {
            ...
            writer.AddAttribute(
                ...
                GenerateDescriptionText(webPart),
                true
            );
        ...
        private void RenderVerb(HtmlTextWriter writer, WebPart webPart, WebPartVerb verb)
        {
            ...
            else if (verb == Zone.ExportVerb)
            {
                ...
                if (verbButtonType == ButtonType.Button)
                {
                    ...
                    if (isEnabled)
                    {
                        ...
                        )
                        {
                            ...
                            {
                                button.OnClientClick =
                                    "if(__wpmExportWarning.length == 0 || "
                ...
                else
                {
                    ...
                    if (webPart.ExportMode == WebPartExportMode.All)
                    {
                        ...
                        {
                            string onclick =
                                "return (__wpmExportWarning.length == 0 || confirm(__wpmExportWarning))";
                ...
                if (_manager != null && isEnabled)
                {
                    if (verb == Zone.CloseVerb)
                    {
                        ...
                        ProviderConnectionPointCollection connectionPoints =
                            _manager.GetProviderConnectionPoints(webPart);
                        if (
                        ...
                        {
                            string onclick =
                                "if (__wpmCloseProviderWarning.length >= 0 && "
                    ...
                    {
                        string onclick =
                            "if (__wpmDeleteWarning.length >= 0 && !confirm(__wpmDeleteWarning)) { return false; }";
                        verbControl.Attributes.Add("onclick", onclick);
                    }
                }
            }
            ...
            verbControl.ToolTip = String.Format(
        ...
        )
        {
            ...
            foreach (WebPartVerb verb in verbs)
            {
                ...
                if (
                    priorVerb != null
                    && (VerbRenderedAsLinkButton(verb) || VerbRenderedAsLinkButton(priorVerb))
                )
                {
                    writer.Write("&nbsp;");
                }
        ...
        public virtual void RenderWebPart(HtmlTextWriter writer, WebPart webPart)
        {
            ...
            )
            {
                ...
                {
                    _titleStyleWithoutFontOrAlign = CreateTitleStyleWithoutFontOrAlign(
                        Zone.PartTitleStyle
                    );
                }
            ...
            writer.AddStyleAttribute(
                ...
                Zone.PartChromePadding.ToString()
            );
            writer.RenderBeginTag(HtmlTextWriterTag.Td);
        ...
        private bool ShouldRenderVerb(WebPartVerb verb, WebPart webPart)
        {
            ...
            if (verb == Zone.ConnectVerb)
            {
                if (WebPartManager != null)
                {
                    ...
                    if (
                        (consumerConnectionPoints == null || consumerConnectionPoints.Count == 0)
            ...
            {
                if (!_personalizationEnabled || webPart.ExportMode == WebPartExportMode.None)
                {
                    return false;
                }
            }
