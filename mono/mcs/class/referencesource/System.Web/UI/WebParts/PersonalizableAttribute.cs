...
namespace System.Web.UI.WebControls.WebParts
{
    ...
    public sealed class PersonalizableAttribute : Attribute
    {
        ...
        private static readonly IDictionary PersonalizableTypeTable = Hashtable.Synchronized(
            new Hashtable()
        );
        ...
        /// </devdoc>
        public static readonly PersonalizableAttribute Personalizable = new PersonalizableAttribute(
            true
        );
        ...
        public static readonly PersonalizableAttribute UserPersonalizable =
            new PersonalizableAttribute(PersonalizationScope.User);
        ...
        public static readonly PersonalizableAttribute SharedPersonalizable =
            new PersonalizableAttribute(PersonalizationScope.Shared);
        ...
        /// </devdoc>
        private PersonalizableAttribute(
        ...
        {
            Debug.Assert(
                (isPersonalizable == true || isSensitive == false),
                "Only Personalizable properties can be sensitive"
            );
        ...
        public static ICollection GetPersonalizableProperties(Type type)
        {
            ...
            PersonalizableTypeEntry typeEntry = (PersonalizableTypeEntry)
                PersonalizableTypeTable[type];
            if (typeEntry == null)
            {
        ...
        /// <devdoc>
        /// </devdoc>
        internal static IDictionary GetPersonalizablePropertyValues(
            Control control,
            PersonalizationScope scope,
        ...
        )
        {
            ...
            if (propertyEntries.Count != 0)
            {
                foreach (DictionaryEntry entry in propertyEntries)
                {
                    ...
                    PersonalizablePropertyEntry propEntry = (PersonalizablePropertyEntry)
                        entry.Value;
                    ...
                    if (propertyBag == null)
                    {
                        propertyBag = new HybridDictionary(
                            propertyEntries.Count, /* caseInsensitive */
                            false
                        );
                    }

                    object value = FastPropertyAccessor.GetProperty(
                        control,
                        name,
                        control.DesignMode
                    );
            ...
            if (propertyBag == null)
            {
                propertyBag = new HybridDictionary( /* caseInsensitive */
                    false
                );
            }
            return propertyBag;
