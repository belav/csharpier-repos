...
namespace System.Web.UI.WebControls.WebParts
{
    ...
    public static class PersonalizationAdministration
    {
        ...
        private static void Initialize()
        {
            ...
            lock (_initializationLock)
            {
                ...
                ProvidersHelper.InstantiateProviders(
                    ...
                    _providers,
                    typeof(PersonalizationProvider)
                );
        ...
        public static int ResetState(PersonalizationStateInfoCollection data)
        {
            ...
            {
                UserPersonalizationStateInfo userStateInfo =
                    stateInfo as UserPersonalizationStateInfo;
        ...
        public static bool ResetSharedState(string path)
        {
            ...
            if (count > 1)
            {
                throw new HttpException(
                    SR.GetString(
                        SR.PersonalizationAdmin_UnexpectedResetSharedStateReturnValue,
        ...
        {
            path = StringUtil.CheckAndTrimString(path, "path");
            username = PersonalizationProviderHelper.CheckAndTrimStringWithoutCommas(
                username,
                "username"
            );
            string[] paths = new string[] { path };
            ...
            if (count > 1)
            {
                throw new HttpException(
                    SR.GetString(
                        SR.PersonalizationAdmin_UnexpectedResetUserStateReturnValue,
                        count.ToString(CultureInfo.CurrentCulture)
                    )
                );
            }
        ...
        // This private method assumes input parameters have been checked
        private static int ResetInactiveUserStatePrivate(
            string path,
        ...
        {
            int totalRecords;
            return GetAllInactiveUserState(
