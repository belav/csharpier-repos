    ...
    public class SessionPageStatePersister : PageStatePersister
    {
            ...
            : base(page)
        {
            ...
            if (session == null)
            {
                throw new ArgumentException(
                    SR.GetString(SR.SessionPageStatePersister_SessionMustBeEnabled)
                );
            }
        }
        ...
        public override void Load()
        {
                ...
                if (!String.IsNullOrEmpty(combinedSerializedStateString))
                {
                    Pair combinedState = (Pair)
                        Util.DeserializeWithAssert(
                            ...
                            Purpose.WebForms_SessionPageStatePersister_ClientState
                        );
            ...
            catch (Exception e)
            {
                ...
                HttpException newException = new HttpException(
                    SR.GetString(SR.Invalid_ControlState),
                    e
                );
        ...
        public override void Save()
        {
            ...
            if (
                (ControlState != null)
                || (
                    (vsTrip == null || vsTrip.Second != null || vsTrip.Third != null)
                    && ViewState != null
                )
            )
            {
                ...
                SessionPageStateSection cfg = RuntimeConfig
                    .GetConfig(Page.Request.Context)
                    .SessionPageState;
                int queueCount = queue.Count;

                if (
                    cfg != null && queueCount > cfg.HistorySize
            ...
            if (clientData != null)
            {
                Page.ClientState = Util.SerializeWithAssert(
                    StateFormatter2,
                    new Pair(requiresControlStateInSession, clientData),
                    Purpose.WebForms_SessionPageStatePersister_ClientState
                );
            }
        }
