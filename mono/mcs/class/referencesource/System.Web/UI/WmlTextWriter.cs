...
namespace System.Web.UI
{
    ...
    public class WmlTextWriter : HtmlTextWriter
    {
        ...
        public WmlTextWriter(TextWriter writer, string tabString)
            : base(writer, tabString)
        {
            _realInnerWriter = writer;

            _numberOfSoftkeys = Convert.ToInt32(
                Browser["NumberOfSoftkeys"],
        ...
        private void OpenParagraph(Layout layout, bool writeHorizontalAlign, bool writeWrapping)
        {
            ...
            if (writeWrapping)
            {
                WriteAttribute("mode", layout.Wrap == true ? "wrap" : "nowrap");
            }
            Write(">");
            _paragraphOpen = true;
            Indent++;
        ...
        internal void OpenCurrentStyleTags()
        {
            ...
            {
                if (
                    format.Font.Size == FontUnit.Empty
        ...
        /// <para>[To be supplied.]</para>
        /// </devdoc>
        public virtual void WriteBeginSelect(
            String name,
            String value,
            String iname,
            String ivalue,
        ...
        )
        {
            ...
            if (
                !((WmlPageAdapter)CurrentForm.Page.Adapter).WrittenFormVariables
                && ivalue != null
                && ivalue.Length > 0
            )
            {
