...
namespace System.Web.UI
{
    ...
    public class FileLevelPageControlBuilder : RootBuilder
    {
        ...
        {
            get { return _contentBuilderEntries; }
        }
            ...
            if (_firstLiteralText == null)
            {
                if (!Util.IsWhiteSpaceString(text))
                {
                    ...
                    _firstLiteralLineNumber =
                        Parser._lineNumber - Util.LineCount(text, iFirstNonWhiteSpace, text.Length);
                    _firstLiteralText = text;

                    if (_containsContentPage)
                    {
                        throw new HttpException(
                            SR.GetString(SR.Only_Content_supported_on_content_page)
                        );
                    }
                }
            }
        ...
        internal override void InitObject(object obj)
        {
            ...
            foreach (TemplatePropertyEntry entry in entries)
            {
                ...
                try
                {
                    ...
                    AddContentTemplate(
                        obj,
                        contentBuilder.ContentPlaceHolder,
                        contentBuilder.BuildObject() as ITemplate
                    );
                }
                finally
                {
        ...
        internal virtual void AddContentTemplate(
            object obj,
            string templateName,
            ITemplate template
        )
    ...
    public class Page : TemplateControl, IHttpHandler
    {
        ...
        // Async related
        private static readonly TimeSpan _maxAsyncTimeout = TimeSpan.FromMilliseconds(
            Int32.MaxValue
        );
...
#pragma warning restore 0649
        ...
        {
            get { return _executingAsyncTasks; }
            set { _executingAsyncTasks = value; }
        }
        ...
        public ModelBindingExecutionContext ModelBindingExecutionContext
        {
            get
            {
                ...
                {
                    _modelBindingExecutionContext = new ModelBindingExecutionContext(
            ...
            where TModel : class
        {
            if (ActiveValueProvider == null)
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Page_InvalidUpdateModelAttempt, "TryUpdateModel")
                );
            }
            ...
            where TModel : class
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Page_InvalidUpdateModelAttempt, "UpdateModel")
                );
            }
            ...
            where TModel : class
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Page_UpdateModel_UpdateUnsuccessful, typeof(TModel).FullName)
                );
            }
        }
        ...
        internal string ClientOnSubmitEvent
        {
            ...
            {
                if (
                    ClientScript.HasSubmitStatements
            ...
            get
            {
                if (_clientQueryString == null)
                {
                    if (RequestInternal != null && Request.HasQueryString)
                    {
                        ...
                        //
                        HttpValueCollection httpValueCollection = (HttpValueCollection)(
                            (SkipFormActionValidation)
                                ? Request.Unvalidated.QueryString
                                : Request.QueryString
                        );
                        _clientQueryString = httpValueCollection.ToString(
                            urlencoded: true,
                            excludeKeys: ht
                        );
                    }
        ...
        {
            get { return _containsEncryptedViewState; }
            set { _containsEncryptedViewState = value; }
        }
        ...
        internal bool ClientSupportsFocus
        {
            get
            {
                return (_request != null)
                    && (
                        (_request.Browser.EcmaScriptVersion >= FocusMinimumEcmaVersion)
                        || (_request.Browser.JScriptVersion >= FocusMinimumJScriptVersion)
                    );
            }
        }
        ...
        public bool MaintainScrollPositionOnPostBack
        {
            get
            {
                if (
                    ...
                    && RequestInternal.Browser != null
                    && !RequestInternal.Browser.SupportsMaintainScrollPositionOnPostback
                )
                    return false;
        ...
        {
            get { return _maxPageStateFieldLength; }
            set
            {
                if (this.ControlState > ControlState.FrameworkInitialized)
                {
                    throw new InvalidOperationException(
                        SR.GetString(
                            SR.PropertySetAfterFrameworkInitialize,
                ...
                if (value == 0 || value < -1)
                {
                    throw new ArgumentException(
                        SR.GetString(SR.Page_Illegal_MaxPageStateFieldLength),
                        "MaxPageStateFieldLength"
                    );
                }
        ...
        {
            get { return _containsCrossPagePost; }
            set { _containsCrossPagePost = value; }
        }
        ...
        {
            get { return _requireFocusScript; }
        }

        internal Stack PartialCachingControlStack
        {
            get { return _partialCachingControlStack; }
        }
                ...
                if (!_cachedRequestViewState)
                {
                    ...
                    try
                    {
                        ...
                        if (requestValueCollection != null)
                        {
                            ...
                            {
                                throw new HttpException(
                                    SR.GetString(SR.ViewState_InvalidViewState)
                                );
                            }
                            ...
                            for (int i = 0; i < numViewStateFields; ++i)
                            {
                                ...
                                {
                                    throw new HttpException(
                                        SR.GetString(SR.ViewState_MissingViewStateField, key)
                                    );
                                }
        ...
        public string Title
        {
            ...
            {
                if (
                    (Page.Header == null) && (this.ControlState >= ControlState.ChildrenInitialized)
                )
                {
            ...
            set
            {
                if (Page.Header == null)
                {
                    ...
                    {
                        throw new InvalidOperationException(
                            SR.GetString(SR.Page_Title_Requires_Head)
                        );
                    }
                    else
                    {
        ...
        public string MetaDescription
        {
            get
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.Page_Description_Requires_Head)
                    );
                }
        ...
        public string MetaKeywords
        {
            get
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.Page_Keywords_Requires_Head)
                    );
                }
        ...
        internal bool ContainsTheme
        {
            ...
            {
                Debug.Assert(
                    _preInitWorkComplete || DesignMode,
                    "ContainsTheme should not be accessed before Page's PreInit."
                );
                return _theme != null;
            }
        }
        ...
        public virtual String Theme
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.PropertySetBeforePageEvent, "Theme", "Page_PreInit")
                    );
                }
                ...
                {
                    throw new ArgumentException(
                        SR.GetString(SR.Page_theme_invalid_name, value),
                        "Theme"
                    );
                }
        ...
        public virtual String StyleSheetTheme
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.SetStyleSheetThemeCannotBeSet)
                    );
                }
            ...
            else
            {
                try
                {
                    ...
                    return (HtmlTextWriter)
                        HttpRuntime.CreateNonPublicInstance(writerType, new object[] { tw });
                }
                catch
                {
                    throw new HttpException(
                        SR.GetString(SR.Invalid_HtmlTextWriter, writerType.FullName)
                    );
                }
            }
        }
        ...
        private bool HandleError(Exception e)
        {
            ...
            if (!String.IsNullOrEmpty(_errorPage))
            {
                ...
                {
                    _response.RedirectToErrorPage(
                        _errorPage,
                        CustomErrorsSection.GetSettings(Context).RedirectMode
                    );
                    return true;
                }
            }
        ...
        {
            get { return _isCrossPagePostBack; }
        }

        internal bool IsExportingWebPart
        {
            get { return _pageFlags[isExportingWebPart]; }
        }

        internal bool IsExportingWebPartShared
        {
            get { return _pageFlags[isExportingWebPartShared]; }
        }
        ...
        {
            get { return _enableEventValidation; }
            set
            {
                if (this.ControlState > ControlState.FrameworkInitialized)
                {
        ...
        {
            get { return _pageFlags[skipFormActionValidation]; }
            set
            {
...
#pragma warning disable 618 // calling obsolete methods
                    clearData = MachineKeySection.EncryptOrDecryptData(
                        fEncrypt: false,
                        buf: protectedData,
                        modifier: null,
                        start: 0,
...
#pragma warning restore 618 // calling obsolete methods
        ...
        protected internal virtual NameValueCollection DeterminePostBackMode()
        {
            ...
            if (nullValues != null)
            {
                ...
                {
                    if (
                        nullValues[i].StartsWith(ViewStateFieldPrefixID, StringComparison.Ordinal)
                        || nullValues[i] == postEventSourceID
                    )
                    {
                        isPostback = true;
                        break;
        ...
        protected internal virtual NameValueCollection DeterminePostBackModeUnvalidated()
        {
            ...
            return _request.HttpVerb == HttpVerb.POST
                ? _request.Unvalidated.Form
                : _request.Unvalidated.QueryString;
        }
        ...
        internal static string EncryptString(string s, Purpose purpose)
        {
            ...
            else
            {
                ...
                // fall back to the standard MachineKey crypto routines.
#pragma warning disable 618 // calling obsolete methods
                protectedData = MachineKeySection.EncryptOrDecryptData(
                    fEncrypt: true,
                    buf: clearData,
                    modifier: null,
                    start: 0,
    ...
    */
        ...
        internal void LoadScrollPosition()
        {
            ...
            if (_requestValueCollection != null)
            {
                ...
                if (xpos != null)
                {
                    _scrollPositionX = HttpUtility.TryParseCoordinates(xpos, out doubleValue)
                        ? (int)doubleValue
                        : 0;
                }
                ...
                if (ypos != null)
                {
                    _scrollPositionY = HttpUtility.TryParseCoordinates(ypos, out doubleValue)
                        ? (int)doubleValue
                        : 0;
                }
            }
            ...
            if (ClientState != null)
            {
                ...
                if (EnableViewStateMacRegistryHelper.WriteViewStateGeneratorField)
                {
                    ...
                    ClientScript.RegisterHiddenField(
                        ...
                        GetClientStateIdentifier().ToString("X8", CultureInfo.InvariantCulture)
                    );
                }
            }
            else
        ...
        internal void BeginFormRender(HtmlTextWriter writer, string formUniqueID)
        {
            ...
            if (ClientSupportsJavaScript)
            {
                if (MaintainScrollPositionOnPostBack && _requireScrollScript == false)
                {
                    ClientScript.RegisterHiddenField(
                        _scrollPositionXID,
                        _scrollPositionX.ToString(CultureInfo.InvariantCulture)
                    );
                    ClientScript.RegisterHiddenField(
                        _scrollPositionYID,
                        _scrollPositionY.ToString(CultureInfo.InvariantCulture)
                    );
                    ClientScript.RegisterStartupScript(
                        typeof(Page),
                        PageScrollPositionScriptKey,
                        @"
...
"
                ...
                if (
                    ...
                    && (
                        RenderFocusScript
                        || (Form.DefaultFocus.Length > 0)
                        || (Form.DefaultButton.Length > 0)
                    )
                )
                {
                    ...
                    )
                    {
                        ...
                        if (!ClientScript.IsClientScriptBlockRegistered(typeof(HtmlForm), "Focus"))
                        {
                            ...
                            ClientScript.RegisterStartupScript(
                                ...
                                "Focus",
                                "WebForm_AutoFocus('"
                                    + Util.QuoteJScriptString(focusedControlId)
                                    + "');",
                                true
                            );
                        }
        ...
        internal void EndFormRenderArrayAndExpandoAttribute(
        ...
        internal void EndFormRenderPostBackAndWebFormsScript(
            HtmlTextWriter writer,
            string formUniqueID
        )
        {
        ...
        public void SetFocus(Control control)
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Page_MustCallBeforeAndDuringPreRender, "SetFocus")
                );
            }
        ...
        private void ApplyMasterPage()
        {
            if (Master != null)
            {
                ...
                appliedMasterPages.Add(
                    _masterPageFile.VirtualPathString.ToLower(CultureInfo.InvariantCulture)
                );
    ...
    if (!theForm.onsubmit || (theForm.onsubmit() != false)) {
        ...
        public void RegisterRequiresControlState(Control control)
        {
            ...
            if (control.ControlState == ControlState.PreRendered)
            {
                throw new InvalidOperationException(
                    SR.GetString(
                        SR.Page_MustCallBeforeAndDuringPreRender,
        ...
        {
            return (
                _registeredControlsRequiringControlState != null
                && _registeredControlsRequiringControlState.Contains(control)
            );
        }
                    ...
                    if (postKey != null)
                    {
                        ...
                        if (consumer != null)
                        {
                            NameValueCollection postCollection =
                                ctrl.CalculateEffectiveValidateRequest()
            ...
            if (_controlsRequiringPostBack != null)
            {
                foreach (string controlID in _controlsRequiringPostBack)
                {
                    ...
                    if (c != null)
                    {
                        ...
                        {
                            throw new HttpException(
                                SR.GetString(SR.Postback_ctrl_not_found, controlID)
                            );
                        }
                        ...
                        if (consumer != null)
                        {
                            NameValueCollection postCollection =
                                ctrl.CalculateEffectiveValidateRequest()
                                    ? _requestValueCollection
                                    : _unvalidatedRequestValueCollection;
                            bool changed = await LoadPostDataAsync(
                                consumer,
                                postKey,
                                postCollection
                            );
        ...
        {
            get { return (_registeredControlThatRequireRaiseEvent != null); }
        }
            ...
            get
            {
                ...
                if (_previousPage == null)
                {
                    if (_previousPagePath != null)
                    {
                        ...
                        {
                            throw new InvalidOperationException(
                                SR.GetString(SR.Previous_Page_Not_Authorized)
                            );
                        }

                        ITypedWebObjectFactory result = (ITypedWebObjectFactory)
                            BuildManager.GetVPathBuildResult(Context, _previousPagePath);
    ...
    */
        ...
        protected internal virtual void InitOutputCache(OutputCacheParameters cacheSettings)
        {
            ...
            if (cacheSettings.CacheProfile != null && cacheSettings.CacheProfile.Length != 0)
            {
                ...
                profile = (OutputCacheProfile)
                    outputCacheSettings.OutputCacheProfiles[cacheSettings.CacheProfile];

                if (profile == null)
                {
                    throw new HttpException(
                        SR.GetString(SR.CacheProfile_Not_Found, cacheSettings.CacheProfile)
                    );
                }
            ...
            if ((location != OutputCacheLocation.None) && (profile == null || profile.Enabled))
            {
                // Check and see if duration is specified in the profile or in the directives
                if (
                    (profile == null || profile.Duration == -1)
                ...
                if (
                    (
                        profile == null
                        || ((profile.VaryByParam == null) && (profile.VaryByControl == null))
                    )
                    && (
                ...
                {
                    throw new HttpException(
                        SR.GetString(SR.Missing_output_cache_attr, "varyByParam")
                    );
                }
            }
            ...
            switch (location)
            {
                ...
                default:
                    throw new ArgumentOutOfRangeException(
                        "cacheSettings",
                        SR.GetString(SR.Invalid_cache_settings_location)
                    );
            }
            ...
            if (location != OutputCacheLocation.None)
            {
                ...
                if (location != OutputCacheLocation.Client)
                {
                    ...
                    if (location != OutputCacheLocation.Downstream)
                    {
                        ...
                        if (
                            String.IsNullOrEmpty(varyByParam)
                        ...
                        if (!String.IsNullOrEmpty(sqlDependency))
                        {
                            Response.AddCacheDependency(
                                SqlCacheDependency.CreateOutputCacheDependency(sqlDependency)
                            );
                        }
#endif // !FEATURE_PAL
                    }
            ...
            set
            {
                ...
                else if (StringUtil.StringStartsWithIgnoreCase(value, HttpApplication.AutoCulture))
                {
                    ...
                    else
                    {
                        try
                        {
                            newCulture = HttpServerUtility.CreateReadOnlyCultureInfo(
                                value.Substring(5)
                            );
                        }
                        catch { }
            ...
            )
            {
                try
                {
                    return CultureUtil.CreateReadOnlyCulture(
                        _context.Request.UserLanguages,
                        specific
                    );
                }
                catch { }
            ...
            set
            {
                ...
                else if (StringUtil.StringStartsWithIgnoreCase(value, HttpApplication.AutoCulture))
                {
                    ...
                    else
                    {
                        try
                        {
                            newUICulture = HttpServerUtility.CreateReadOnlyCultureInfo(
                                value.Substring(5)
                            );
                        }
                        catch { }
        ...
        public TimeSpan AsyncTimeout
        {
            set
            {
                ...
                {
                    throw new ArgumentException(
                        SR.GetString(SR.Page_Illegal_AsyncTimeout),
                        "AsyncTimeout"
                    );
                }
            ...
            get
            {
                if (!_asyncTimeoutSet)
                {
                    ...
                    if (!_asyncTimeoutSet)
                    {
                        AsyncTimeout = TimeSpan.FromSeconds(
        ...
        public bool SmartNavigation
        {
            get
            {
                ...
                if (_smartNavSupport == SmartNavigationSupport.Desired)
                {
                    ...
                    if (
                        !String.Equals(browser.Browser, "ie", StringComparison.OrdinalIgnoreCase)
        ...
        internal bool IsTransacted
        {
            ...
            {
                return (
                    _transactionMode != 0 /*TransactionOption.Disabled*/
                );
            }
        }
        ...
        {
            add { Events.AddHandler(EventLoadComplete, value); }
            remove { Events.RemoveHandler(EventLoadComplete, value); }
        }
        ...
        {
            add { Events.AddHandler(EventPreInit, value); }
            remove { Events.RemoveHandler(EventPreInit, value); }
        }
        ...
        {
            add { Events.AddHandler(EventPreLoad, value); }
            remove { Events.RemoveHandler(EventPreLoad, value); }
        }
        ...
        {
            add { Events.AddHandler(EventPreRenderComplete, value); }
            remove { Events.RemoveHandler(EventPreRenderComplete, value); }
        }
        ...
        {
            add { Events.AddHandler(EventInitComplete, value); }
            remove { Events.RemoveHandler(EventInitComplete, value); }
        }
        ...
        public void RegisterRequiresViewStateEncryption()
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Too_late_for_RegisterRequiresViewStateEncryption)
                );
            }
        ...
        {
            add { Events.AddHandler(EventSaveStateComplete, value); }
            remove { Events.RemoveHandler(EventSaveStateComplete, value); }
        }
        ...
        public virtual void ProcessRequest(HttpContext context)
        {
            ...
            if (
                ...
                && !HttpRuntime.DisableProcessRequestInApplicationTrust
            )
            {
        ...
        private void ProcessRequest()
        {
            ...
            {
                ProcessRequest(
                    true /*includeStagesBeforeAsyncPoint*/
                    ,
        ...
        )
        {
            ...
            try
            {
                try
                {
                    ...
                    {
                        // No transactions
                        await ProcessRequestMainAsync(
                                includeStagesBeforeAsyncPoint,
                                includeStagesAfterAsyncPoint
                            )
                            .WithinCancellableCallback(Context);
                    }
        ...
        {
            if (
                prevCulture != currentThread.CurrentCulture
                || prevUICulture != currentThread.CurrentUICulture
            )
            {
        ...
        private void ProcessRequestTransacted()
        {
            ...
            Transactions.InvokeTransacted(
                ...
                (TransactionOption)_transactionMode,
        ...
        )
        {
            try
            {
                ...
                if (includeStagesBeforeAsyncPoint)
                {
                    ...
                    if (PageAdapter != null)
                    {
                        ...
                        {
                            _unvalidatedRequestValueCollection =
                                PageAdapter.DeterminePostBackModeUnvalidated();
                        }
                    }
                    else
                    {
                    ...
                    if (DetermineIsExportingWebPart())
                    {
                        ...
                        {
                            throw new InvalidOperationException(
                                SR.GetString(SR.WebPartExportHandler_DisabledExportHandler)
                            );
                        }
                        ...
                        {
                            throw new InvalidOperationException(
                                SR.GetString(SR.WebPartExportHandler_InvalidArgument)
                            );
                        }
                                ...
                                if (_requestValueCollection[previousPageID] != null)
                                {
                                    try
                                    {
                                        previousPagePath = VirtualPath.CreateNonRelativeAllowNull(
                                            DecryptString(
                                                _requestValueCollection[previousPageID],
                                                Purpose.WebForms_Page_PreviousPageID
                                            )
                                        );
                                    }
                                    ...
                                    if (
                                        ...
                                        && previousPagePath
                                            != Request.CurrentExecutionFilePathObject
                                    )
                                    {
                                        _pageFlags[isCrossPagePostRequest] = true;
                    ...
                    if (EtwTrace.IsTraceEnabled(EtwTraceLevel.Verbose, EtwTraceFlags.Page))
                        EtwTrace.Trace(
                            EtwTraceType.ETW_TYPE_PAGE_PRE_INIT_ENTER,
                            _context.WorkerRequest
                        );
                    PerformPreInit();
                    if (EtwTrace.IsTraceEnabled(EtwTraceLevel.Verbose, EtwTraceFlags.Page))
                        EtwTrace.Trace(
                            EtwTraceType.ETW_TYPE_PAGE_PRE_INIT_LEAVE,
                            _context.WorkerRequest
                        );
                    if (con.TraceIsEnabled)
                    ...
                    if (EtwTrace.IsTraceEnabled(EtwTraceLevel.Verbose, EtwTraceFlags.Page))
                        EtwTrace.Trace(
                            EtwTraceType.ETW_TYPE_PAGE_INIT_ENTER,
                            _context.WorkerRequest
                        );
                    InitRecursive(null);
                    if (EtwTrace.IsTraceEnabled(EtwTraceLevel.Verbose, EtwTraceFlags.Page))
                        EtwTrace.Trace(
                            EtwTraceType.ETW_TYPE_PAGE_INIT_LEAVE,
                            _context.WorkerRequest
                        );
                    if (con.TraceIsEnabled)
                    ...
                    if (IsPostBack)
                    {
                        ...
                        if (EtwTrace.IsTraceEnabled(EtwTraceLevel.Verbose, EtwTraceFlags.Page))
                            EtwTrace.Trace(
                                EtwTraceType.ETW_TYPE_PAGE_LOAD_VIEWSTATE_ENTER,
                                _context.WorkerRequest
                            );
                        LoadAllState();
                        if (EtwTrace.IsTraceEnabled(EtwTraceLevel.Verbose, EtwTraceFlags.Page))
                            EtwTrace.Trace(
                                EtwTraceType.ETW_TYPE_PAGE_LOAD_VIEWSTATE_LEAVE,
                                _context.WorkerRequest
                            );
                        if (con.TraceIsEnabled)
                        {
                        ...
                        if (EtwTrace.IsTraceEnabled(EtwTraceLevel.Verbose, EtwTraceFlags.Page))
                            EtwTrace.Trace(
                                EtwTraceType.ETW_TYPE_PAGE_LOAD_POSTDATA_ENTER,
                                _context.WorkerRequest
                            );
                        ProcessPostData(
                            _requestValueCollection,
                        ...
                        if (EtwTrace.IsTraceEnabled(EtwTraceLevel.Verbose, EtwTraceFlags.Page))
                            EtwTrace.Trace(
                                EtwTraceType.ETW_TYPE_PAGE_LOAD_POSTDATA_LEAVE,
                                _context.WorkerRequest
                            );
                        if (con.TraceIsEnabled)
                    ...
                    if (EtwTrace.IsTraceEnabled(EtwTraceLevel.Verbose, EtwTraceFlags.Page))
                        EtwTrace.Trace(
                            EtwTraceType.ETW_TYPE_PAGE_LOAD_ENTER,
                            _context.WorkerRequest
                        );
                    LoadRecursive();
                    if (EtwTrace.IsTraceEnabled(EtwTraceLevel.Verbose, EtwTraceFlags.Page))
                        EtwTrace.Trace(
                            EtwTraceType.ETW_TYPE_PAGE_LOAD_LEAVE,
                            _context.WorkerRequest
                        );
                    if (con.TraceIsEnabled)
                    ...
                    if (IsPostBack)
                    {
                        ...
                        if (EtwTrace.IsTraceEnabled(EtwTraceLevel.Verbose, EtwTraceFlags.Page))
                            EtwTrace.Trace(
                                EtwTraceType.ETW_TYPE_PAGE_POST_DATA_CHANGED_ENTER,
                                _context.WorkerRequest
                            );
                        RaiseChangedEvents();
                        if (EtwTrace.IsTraceEnabled(EtwTraceLevel.Verbose, EtwTraceFlags.Page))
                            EtwTrace.Trace(
                                EtwTraceType.ETW_TYPE_PAGE_POST_DATA_CHANGED_LEAVE,
                                _context.WorkerRequest
                            );
                        if (con.TraceIsEnabled)
                        {
                        ...
                        if (EtwTrace.IsTraceEnabled(EtwTraceLevel.Verbose, EtwTraceFlags.Page))
                            EtwTrace.Trace(
                                EtwTraceType.ETW_TYPE_PAGE_RAISE_POSTBACK_ENTER,
                                _context.WorkerRequest
                            );
                        RaisePostBackEvent(_requestValueCollection);
                        if (EtwTrace.IsTraceEnabled(EtwTraceLevel.Verbose, EtwTraceFlags.Page))
                            EtwTrace.Trace(
                                EtwTraceType.ETW_TYPE_PAGE_RAISE_POSTBACK_LEAVE,
                                _context.WorkerRequest
                            );
                        if (con.TraceIsEnabled)
                    ...
                    else if (!IsCrossPagePostBack)
                    {
                        ...
                        if (EtwTrace.IsTraceEnabled(EtwTraceLevel.Verbose, EtwTraceFlags.Page))
                            EtwTrace.Trace(
                                EtwTraceType.ETW_TYPE_PAGE_PRE_RENDER_ENTER,
                                _context.WorkerRequest
                            );
                        PreRenderRecursiveInternal();
                        if (EtwTrace.IsTraceEnabled(EtwTraceLevel.Verbose, EtwTraceFlags.Page))
                            EtwTrace.Trace(
                                EtwTraceType.ETW_TYPE_PAGE_PRE_RENDER_LEAVE,
                                _context.WorkerRequest
                            );
                        if (con.TraceIsEnabled)
                ...
                if (includeStagesAfterAsyncPoint)
                {
                    ...
                    if (EtwTrace.IsTraceEnabled(EtwTraceLevel.Verbose, EtwTraceFlags.Page))
                        EtwTrace.Trace(
                            EtwTraceType.ETW_TYPE_PAGE_SAVE_VIEWSTATE_ENTER,
                            _context.WorkerRequest
                        );
                    ...
                    if (EtwTrace.IsTraceEnabled(EtwTraceLevel.Verbose, EtwTraceFlags.Page))
                        EtwTrace.Trace(
                            EtwTraceType.ETW_TYPE_PAGE_SAVE_VIEWSTATE_LEAVE,
                            _context.WorkerRequest
                        );
                    if (con.TraceIsEnabled)
                    {
                    ...
                    if (EtwTrace.IsTraceEnabled(EtwTraceLevel.Verbose, EtwTraceFlags.Page))
                        EtwTrace.Trace(
                            EtwTraceType.ETW_TYPE_PAGE_RENDER_ENTER,
                            _context.WorkerRequest
                        );
                    // Special-case Web Part Export so it executes in the same security context as the page itself (VSWhidbey 426574)
                    ...
                    if (EtwTrace.IsTraceEnabled(EtwTraceLevel.Verbose, EtwTraceFlags.Page))
                        EtwTrace.Trace(
                            EtwTraceType.ETW_TYPE_PAGE_RENDER_LEAVE,
                            _context.WorkerRequest
                        );
            ...
            catch (ThreadAbortException e)
            {
                ...
                HttpApplication.CancelModuleException cancelException =
                    e.ExceptionState as HttpApplication.CancelModuleException;
                if (
                    includeStagesBeforeAsyncPoint
                    && includeStagesAfterAsyncPoint
                    && // executing entire page
                    _context.Handler == this
                    && // not in server execute
                    _context.ApplicationInstance != null
                    && // application must be non-null so we can complete the request
        ...
        private async Task ProcessRequestMainAsync(
            bool includeStagesBeforeAsyncPoint,
            bool includeStagesAfterAsyncPoint
        )
        {
            try
            {
                ...
                if (includeStagesBeforeAsyncPoint)
                {
                    ...
                    if (IsPostBack && IsCallback)
                    {
                        await PrepareCallbackAsync(callbackControlId)
                            .WithinCancellableCallback(con);
                    }
                    else if (!IsCrossPagePostBack)
                    {
        ...
        internal WithinCancellableCallbackTaskAwaitable GetWaitForPreviousStepCompletionAwaitable()
        {
            AspNetSynchronizationContext syncContext =
                SynchronizationContext.Current as AspNetSynchronizationContext;
            if (syncContext != null)
            {
                return syncContext
        ...
        private void ExportWebPart(string exportedWebPartID)
        {
            ...
            if (
                webPartToExport == null
                || webPartToExport.IsClosed
                || webPartToExport is ProxyWebPart
            )
            {
            ...
            else
            {
                ...
                Response.AddHeader(
                    "content-disposition",
                    "attachment; filename=" + nonWordRegex.Replace(title, "") + ".WebPart"
                );
        ...
        private void PrepareCallback(string callbackControlID)
        {
            ...
            try
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.Page_CallBackTargetInvalid, callbackControlID)
                    );
                }
            }
            catch (Exception e)
            {
                ...
                else
                {
                    bool needsCallbackLoadScript = !String.IsNullOrEmpty(
                        _requestValueCollection[callbackLoadScriptID]
                    );
                    Response.Write(
                        needsCallbackLoadScript
        ...
        private void RenderCallback()
        {
            ...
            try
            {
                ...
                if (_callbackControl != null)
                {
                    ...
                    Response.Write(
                        needsCallbackLoadScript ? Util.QuoteJScriptString(result) : result
                    );
                }
                ...
                if (needsCallbackLoadScript)
                {
                    ...
                    Response.Write(index);
                    Response.Write(
                        "].xmlRequest.readyState=4;parent.WebForm_CallbackComplete();</script>"
                    );
                }
            }
            catch (Exception e)
        ...
        {
            return writer.RenderDivAroundHiddenInputs
                && (!EnableLegacyRendering || (RenderingCompatibility >= VersionUtil.Framework40));
        }
        ...
        private void SaveAllState()
        {
            ...
            )
            {
                ...
                controlStates = new HybridDictionary(
                    _registeredControlsRequiringControlState.Count + 1
                );
#else
            ...
            if (
                _registeredControlsThatRequirePostBack != null
                && _registeredControlsThatRequirePostBack.Count > 0
            )
            {
                if (controlStates == null)
                {
                ...
                controlStates.Add(
                    PageRegisteredControlsThatRequirePostBackKey,
            ...
            Pair allSavedViewState = new Pair(
                GetTypeHashCode().ToString(NumberFormatInfo.InvariantInfo),
                SaveViewStateRecursive(inheritedMode)
            );
            ...
            if (Context.TraceIsEnabled)
            {
                ...
                Trace.AddControlStateSize(
                    UniqueID,
                    viewStateSize,
                    controlStates == null ? 0 : EstimateStateSize(controlStates[UniqueID])
                );
            }
    ...
    */
        ...
        )
        {
            ...
            _aspCompatStep = new AspCompatApplicationStep(
                context,
                new AspCompatCallback(ProcessRequest)
            );
        ...
        public void ExecuteRegisteredAsyncTasks()
        {
            ...
            HttpAsyncResult ar = _legacyAsyncTaskManager.ExecuteTasks(
                null /*callback*/
                ,
                null /*extraData*/
            );
        ...
        private void CheckRemainingAsyncTasks(bool isThreadAbort)
        {
            ...
            if (_legacyAsyncTaskManager != null)
            {
                ...
                if (
                    !_legacyAsyncTaskManager.FailedToStartTasks
                    && _legacyAsyncTaskManager.AnyTasksRemain
                )
                {
        ...
        public void RegisterAsyncTask(PageAsyncTask task)
        {
            ...
            if (SynchronizationContextUtil.CurrentMode == SynchronizationContextMode.Legacy)
            {
                ...
                LegacyPageAsyncTask legacyTask = new LegacyPageAsyncTask(
                    task.BeginHandler,
                    task.EndHandler,
                    task.TimeoutHandler,
                    task.State,
        ...
        class LegacyPageAsyncInfo
        {
            ...
            internal LegacyPageAsyncInfo(Page page)
            {
                ...
                _callHandlersThreadpoolCallback = new WaitCallback(
                    this.CallHandlersFromThreadpoolThread
                );
            }
            ...
            internal void CallHandlers(bool onPageThread)
            {
                ...
                catch (Exception e)
                {
                    ...
                    if (
                        ...
                        && ((ThreadAbortException)e).ExceptionState
                            is HttpApplication.CancelModuleException
                    )
                    {
            ...
            private void CallHandlersPossiblyUnderLock(bool onPageThread)
            {
                ...
                try
                {
                    while (_currentHandler < _handlerCount && _error == null)
                    {
                        try
                        {
                            IAsyncResult ar = ((BeginEventHandler)_beginHandlers[_currentHandler])(
                                _page,
                                EventArgs.Empty,
                                _completionCallback,
                                _stateObjects[_currentHandler]
                            );

                            if (ar == null)
                            {
                                throw new InvalidOperationException(
                                    SR.GetString(SR.Async_null_asyncresult)
                                );
                            }
                    ...
                    Debug.Trace(
                        "Async",
                        "Page has PendingOperationsCount of " + _syncContext.PendingOperationsCount
                    );
#endif
        ...
        private void AsyncPageProcessRequestBeforeAsyncPointCancellableCallback(Object state)
        {
            ProcessRequest(
                true /*includeStagesBeforeAsyncPoint*/
                ,
                false /*includeStagesAfterAsyncPoint*/
            );
        }
        ...
        )
        {
            ...
            {
                return TaskAsyncHelper.BeginTask(
        ...
        private async Task ProcessRequestAsync(HttpContext context)
        {
            ...
            try
            {
                ...
                _context.InvokeCancellableCallback(
                    _ =>
                    {
                        preWorkTask = ProcessRequestAsync(
                            includeStagesBeforeAsyncPoint: true,
                            includeStagesAfterAsyncPoint: false
                        );
                    },
                    null
                );
                ...
                try
                {
                    ...
                    )
                    {
                        ...
                        try
                        {
                            await _asyncTaskManager.ExecuteTasksAsync(
                                this,
                                EventArgs.Empty,
                                cancellationToken,
                ...
                _context.InvokeCancellableCallback(
                    _ =>
                    {
                        postWorkTask = ProcessRequestAsync(
                            includeStagesBeforeAsyncPoint: false,
                            includeStagesAfterAsyncPoint: true
                        );
                    },
                    null
                );
        ...
        private IAsyncResult LegacyAsyncPageBeginProcessRequest(
            HttpContext context,
            AsyncCallback callback,
            Object extraData
        )
        {
            ...
            try
            {
                _context.InvokeCancellableCallback(
                    new WaitCallback(
                        this.AsyncPageProcessRequestBeforeAsyncPointCancellableCallback
                    ),
                    null
                );
            }
        ...
        public virtual void VerifyRenderingInServerForm(Control control)
        {
            ...
            if (!_inOnFormRender && !IsCallback)
            {
                throw new HttpException(
                    SR.GetString(
                        SR.ControlRenderedOutsideServerForm,
                        control.ClientID,
        ...
        public object GetDataItem()
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.Page_MissingDataBindingContext)
                );
            }
        ...
        private void ValidateRawUrlIfRequired()
        {
            ...
            bool validationRequired =
                !SkipFormActionValidation && CalculateEffectiveValidateRequest();
            ...
            get
            {
                if (!_pageFlags[isPartialRenderingSupportedSet])
                {
                    ...
                    if (scriptManagerType != null)
                    {
                        ...
                        if (scriptManager != null)
                        {
                            PropertyInfo supportsPartialRenderingProperty =
                                scriptManagerType.GetProperty("SupportsPartialRendering");
                            if (supportsPartialRenderingProperty != null)
                            {
                                object supportsPartialRenderingValue =
                                    supportsPartialRenderingProperty.GetValue(scriptManager, null);
                                _pageFlags[isPartialRenderingSupported] =
                                    (bool)supportsPartialRenderingValue;
                            }
                        }
                    }
