...
namespace System.Web.UI
{
    ...
    internal static class TargetFrameworkUtil
    {
        ...
        private static ConcurrentDictionary<Type, MemberCache> s_memberCache =
        ...
        private static ConcurrentDictionary<Type, bool> s_isFrameworkType =
        ...
        private static TypeDescriptionProvider GetTargetFrameworkProvider(object obj)
        {
            TypeDescriptionProviderService service =
                TargetFrameworkUtil.TypeDescriptionProviderService;
            if (service != null)
            {
        ...
        private static PropertyInfo GetPropertyHelper(
            Type type,
            string name,
            BindingFlags bindingAttr,
            Type returnType,
            Type[] types,
            bool throwAmbiguousMatchException
        )
        {
            try
            {
                ...
                if (s_cbmTdpBridge != null && IsFrameworkType(type))
                {
                    ...
                    hasProperty = s_cbmTdpBridge.HasProperty(
                        typeToUse,
                        name,
                        bindingAttr,
                        returnType,
                ...
                else
                {
                    ...
                    PropertyInfo propInfo = reflectionType.GetProperty(
                        name,
                        bindingAttr,
                        null /* binder */
                        ,
        ...
        )
        {
            ...
            var filteredPropertyDescriptors =
                from p in propertyNames
        ...
        )
        {
            ...
            var filteredEventDescriptors =
                from e in eventNames
        ...
        private static bool IsFrameworkType(Type type)
        {
            ...
            Debug.Assert(
                s_cbmTdpBridge != null,
                "s_cbmTdpBridge should not be null in IsFrameworkType"
            );
            bool result;
            if (!s_isFrameworkType.TryGetValue(type, out result))
            {
                ...
                ReferenceAssemblyType referenceAssemblyType =
                    AssemblyResolver.GetPathToReferenceAssembly(a, out path);
        ...
        private static PropertyInfo GetMostSpecificProperty(
            Type type,
            string name,
        ...
        )
        {
            ...
            while (currentType != null)
            {
                ...
                propInfo = GetProperty(
                    ...
                    returnType,
                    types,
                    throwAmbiguousMatchException: true
                );
                if (propInfo != null)
                {
                    return propInfo;
