...
namespace System.Web.UI
{
    ...
    internal static class Util
    {
        ...
        [SuppressMessage(
            ...
            Justification = "This is being tracked as DevDiv #21217 (http://vstfdevdiv:8080/DevDiv2/web/wi.aspx?id=21217)."
        )]
        ...
        internal static object DeserializeWithAssert(
            IStateFormatter2 formatter,
        ...
        internal static VirtualPath GetScriptLocation()
        {
            ...
            if (location.IndexOf("{0}", StringComparison.Ordinal) >= 0)
            {
                ...
                string version = VersionInfo
                    .SystemWebVersion.Substring(0, VersionInfo.SystemWebVersion.LastIndexOf('.'))
                    .Replace('.', '_');
        ...
        */
        ...
        internal static void CheckVirtualFileExists(VirtualPath virtualPath)
        {
            if (!virtualPath.FileExists())
            {
                throw new HttpException(
                    HttpStatus.NotFound,
                    SR.GetString(SR.FileName_does_not_exist, virtualPath.VirtualPathString)
                );
            }
        }
        ...
        */
        internal static bool IsMultiInstanceTemplateProperty(PropertyInfo pInfo)
        {
            object[] instanceAttrs = pInfo.GetCustomAttributes(
                typeof(TemplateInstanceAttribute), /*inherits*/
                false
            );
            ...
            return ((TemplateInstanceAttribute)instanceAttrs[0]).Instances
        ...
        */
        ...
        internal static string GetNonEmptyAttribute(string name, string value)
        {
            ...
            if (value.Length == 0)
            {
                throw new HttpException(SR.GetString(SR.Empty_attribute, name));
            }
        ...
        internal static string GetNoSpaceAttribute(string name, string value)
        {
            ...
            {
                throw new HttpException(SR.GetString(SR.Space_attribute, name));
            }
        ...
        internal static VirtualPath GetAndRemoveVirtualPathAttribute(
            IDictionary directives,
            string key
        )
        {
            return GetAndRemoveVirtualPathAttribute(
                directives,
                key,
                false /*required*/
            );
        ...
        */
        ...
        public static string ParsePropertyDeviceFilter(string input, out string propName)
        {
            ...
            else
            {
                ...
                if (tmp.Length > 2)
                {
                    throw new HttpException(SR.GetString(SR.Too_many_filters, input));
                }
        ...
        */
        ...
        {
            return GetAndRemoveNonEmptyNoSpaceAttribute(
                directives,
                key,
                false /*required*/
            );
        ...
        */
        ...
        internal static string GetNonEmptyFullClassNameAttribute(
            string name,
            string value,
            ref string ns
        )
        ...
        internal static void CheckUnknownDirectiveAttributes(
            string directiveName,
            IDictionary directive
        )
        {
            CheckUnknownDirectiveAttributes(
                directiveName,
                directive,
                SR.Attr_not_supported_in_directive
            );
        }
        ...
        )
        {
            ...
            {
                throw new HttpException(
                    SR.GetString(resourceKey, Util.FirstDictionaryKey(directive), directiveName)
                );
            }
        }
        ...
        */
        ...
        internal static bool GetBooleanAttribute(string name, string value)
        {
            ...
            {
                throw new HttpException(SR.GetString(SR.Invalid_boolean_attribute, name));
            }
        }
        ...
        */
        ...
        internal static bool GetAndRemovePositiveIntegerAttribute(
            IDictionary directives,
            string key,
            ref int val
        )
        {
            ...
            {
                throw new HttpException(SR.GetString(SR.Invalid_positive_integer_attribute, key));
            }
        ...
        internal static object GetAndRemoveEnumAttribute(
            IDictionary directives,
            Type enumType,
            string key
        )
        ...
        internal static object GetEnumAttribute(
            string name,
            string value,
            Type enumType,
            bool allowMultiple
        )
        {
            ...
            try
            {
                ...
                if (
                    ...
                    || value[0] == '-'
                    || ((!allowMultiple) && (value.IndexOf(',') >= 0))
                )
                    throw new FormatException(
                        SR.GetString(SR.EnumAttributeInvalidString, value, name, enumType.FullName)
                    );
            ...
            catch
            {
                ...
                throw new HttpException(SR.GetString(SR.Invalid_enum_attribute, name, names));
            }
        ...
        */
        internal static bool IsLateBoundComClassicType(Type t)
        {
            //
            return (
                String.Compare(t.FullName, "System.__ComObject", StringComparison.Ordinal) == 0
            );
        }
        ...
        )
        {
            ...
            else
            {
                ...
                ReferenceAssemblyType referenceAssemblyType =
                    AssemblyResolver.GetPathToReferenceAssembly(assembly, out assemblyPath);
        ...
        */
                ...
                if (type != null && t != type)
                {
                    throw new HttpException(
                        SR.GetString(
                            SR.Ambiguous_type,
                            typeName,
                            GetAssemblySafePathFromType(type),
                            GetAssemblySafePathFromType(t)
                        )
                    );
                }
        ...
        internal static string GetClientValidatedPostback(
            Control control,
        ...
        internal static void WriteOnClickAttribute(
        ...
        internal static string MergeScript(string firstScript, string secondScript)
        {
            ...
            else
            {
                if (
                    secondScript
                        .TrimStart()
                        .StartsWith(ClientScriptManager.JscriptPrefix, StringComparison.Ordinal)
                )
                {
                    return secondScript;
                }
        ...
        private static bool IsUserAllowedToPathWithAssert(
            HttpContext context,
            VirtualPath virtualPath
        )
        {
        ...
        private static bool IsUserAllowedToPathWithNoAssert(
            HttpContext context,
            VirtualPath virtualPath
        )
        {
        ...
        internal static void DumpDictionary(string tag, IDictionary d)
        {
            ...
            )
            {
                if (en.Value == null)
                    ...
                    Debug.Trace(
                        tag,
                        "Key='" + en.Key.ToString() + "' value='" + en.Value.ToString() + "'"
                    );
            }
        }
