...
namespace System.Web.UI
{
    ...
    public class Html32TextWriter : HtmlTextWriter
    {
        ...
        {
            get { return _shouldPerformDivTableSubstitution; }
            set { _shouldPerformDivTableSubstitution = value; }
        }
        ...
        {
            get { return _supportsBold; }
            set { _supportsBold = value; }
        }
        ...
        {
            get { return _supportsItalic; }
            set { _supportsItalic = value; }
        }
        ...
        private void AppendFontTag(
            string fontFace,
            string fontColor,
            string fontSize,
            StringBuilder sbBegin,
            StringBuilder sbEnd
        )
        {
