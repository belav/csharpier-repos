    ...
    public static class ValidationSettings
    {
        ...
        public static UnobtrusiveValidationMode UnobtrusiveValidationMode
        {
            get
            {
                ...
                {
                    string configValue = ConfigurationManager.AppSettings[
                        "ValidationSettings:UnobtrusiveValidationMode"
                    ];
                    object value = PropertyConverter.EnumFromString(
                        typeof(UnobtrusiveValidationMode),
                        configValue
                    );
                    ...
                    if (value == null)
                    {
                        _unobtrusiveValidationMode =
                            (BinaryCompatibility.Current.TargetsAtLeastFramework45)
            ...
            {
                if (
                    value < UnobtrusiveValidationMode.None
                    || value > UnobtrusiveValidationMode.WebForms
                )
                {
