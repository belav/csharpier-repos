...
namespace System.Web.UI
{
    ...
    public class XhtmlTextWriter : HtmlTextWriter
    {
        ...
        private Hashtable _suppressCommonAttributes = new Hashtable(
            StringComparer.CurrentCultureIgnoreCase
        );
        ...
        )
        {
            ...
            return _elementSpecificAttributes[TagName] != null
                && ((Hashtable)_elementSpecificAttributes[TagName])[name] != null;
        }
        ...
        )
        {
            ...
            if (
                TagName.ToLower(CultureInfo.InvariantCulture).Equals("div")
                && name.ToLower(CultureInfo.InvariantCulture).Equals("border-collapse")
            )
            {
                return false;
            }
        ...
        public virtual void RemoveRecognizedAttribute(string elementName, string attributeName)
        {
            ...
            if (
                _commonAttributes[attributeName] == null
                || _suppressCommonAttributes[elementName] != null
            )
            {
        ...
        {
            get { return _commonAttributes; }
        }

        protected Hashtable ElementSpecificAttributes
        {
            get { return _elementSpecificAttributes; }
        }

        protected Hashtable SuppressCommonAttributes
        {
            get { return _suppressCommonAttributes; }
        }
    }
