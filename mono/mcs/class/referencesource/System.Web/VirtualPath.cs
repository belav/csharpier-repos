...
#pragma warning restore 0649
                ...
                if (_virtualPath == null)
                {
                    ...
                    if (HttpRuntime.AppDomainAppVirtualPathObject == null)
                    {
                        throw new HttpException(
                            SR.GetString(
                                SR.VirtualPath_CantMakeAppAbsolute,
        ...
        {
            get { return UrlPath.RemoveSlashFromPathIfNeeded(VirtualPathString); }
        }
        ...
        internal string AppRelativeVirtualPathStringOrNull
        {
            get
            {
                if (_appRelativeVirtualPath == null)
                {
                    ...
                    {
                        throw new HttpException(
                            SR.GetString(SR.VirtualPath_CantMakeAppRelative, _virtualPath)
                        );
                    }

                    _appRelativeVirtualPath = UrlPath.MakeVirtualPathAppRelativeOrNull(
                        _virtualPath
                    );
        ...
        {
            get { return _virtualPath != null ? _virtualPath : _appRelativeVirtualPath; }
        }

        public string Extension
        {
            get { return UrlPath.GetExtension(VirtualPathString); }
        }

        public string FileName
        {
            get { return UrlPath.GetFileName(VirtualPathStringNoTrailingSlash); }
        }
        ...
        {
            return SimpleCombine(
                relativePath,
                false /*addTrailingSlash*/
            );
        }
        ...
        private VirtualPath SimpleCombine(string filename, bool addTrailingSlash)
        {
            ...
            combinedVirtualPath.CopyFlagsFrom(
                this,
                isWithinAppRootComputed | isWithinAppRoot | appRelativeAttempted
            );
#if DBG
        ...
        public VirtualPath MakeRelative(VirtualPath toVirtualPath)
        {
            ...
            resultVirtualPath._virtualPath = UrlPath.MakeRelative(
                this.VirtualPathString,
                toVirtualPath.VirtualPathString
            );
#if DBG
        ...
        public bool IsWithinAppRoot
        {
            get
            {
                ...
                if (!flags[isWithinAppRootComputed])
                {
                    ...
                    {
                        flags[isWithinAppRoot] = UrlPath.IsEqualOrSubpath(
                            HttpRuntime.AppDomainAppVirtualPathString,
                            VirtualPathString
                        );
                    }
        ...
        internal void FailIfNotWithinAppRoot()
        {
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.Cross_app_not_allowed, this.VirtualPathString)
                );
            }
        }
        ...
        internal void FailIfRelativePath()
        {
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.VirtualPath_AllowRelativePath, _virtualPath)
                );
            }
        }
        ...
        public static VirtualPath CreateTrailingSlash(string virtualPath)
        {
            return Create(
                virtualPath,
                VirtualPathOptions.AllowAllPath | VirtualPathOptions.EnsureTrailingSlash
            );
        }
        ...
        public static VirtualPath CreateAbsoluteTrailingSlash(string virtualPath)
        {
            return Create(
                virtualPath,
                VirtualPathOptions.AllowAbsolutePath | VirtualPathOptions.EnsureTrailingSlash
            );
        }
        ...
        public static VirtualPath Create(string virtualPath, VirtualPathOptions options)
        {
                ...
                fixed (char* p = virtualPath)
                {
                    for (int i = 0; i < len; i++)
                    {
                        switch (p[i])
                        {
                            ...
                            case '\0':
                                throw new HttpException(
                                    SR.GetString(SR.Invalid_vpath, virtualPath)
                                );
                            default:
                                break;
                        }
            ...
            if (UrlPath.IsAppRelativePath(virtualPath))
            {
                ...
                if (virtualPath[0] == UrlPath.appRelativeCharacter)
                {
                    ...
                    {
                        throw new ArgumentException(
                            SR.GetString(SR.VirtualPath_AllowAppRelativePath, virtualPath)
                        );
                    }
                ...
                else
                {
                    ...
                    {
                        throw new ArgumentException(
                            SR.GetString(SR.VirtualPath_AllowAbsolutePath, virtualPath)
                        );
                    }
            ...
            else
            {
                if (virtualPath[0] != '/')
                {
                    ...
                    {
                        throw new ArgumentException(
                            SR.GetString(SR.VirtualPath_AllowRelativePath, virtualPath)
                        );
                    }
