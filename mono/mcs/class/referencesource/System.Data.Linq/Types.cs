...
namespace System.Data.Linq
{
    ...
    [SuppressMessage(
        ...
        Justification = "Microsoft: Naming chosen to represent a different concept from a collection because it is delayed loaded."
    )]
        ...
        where TEntity : class
    {
        ...
        internal EntitySet(EntitySet<TEntity> es, bool copyNotifications)
        {
            ...
            foreach (TEntity e in es.entities)
                entities.Add(e);
            foreach (TEntity e in es.removedEntities)
        ...
        [SuppressMessage(
            ...
            MessageId = "0#",
            Justification = "Microsoft: Naming the parameter entity makes it more discoverable because it is clear what type of data should be added to this collection."
        )]
        ...
        public void Load()
        {
            if (this.HasSource)
            {
                ...
                entities = default(ItemList<TEntity>);
                foreach (TEntity e in source)
                    entities.Add(e);
                foreach (TEntity e in addedEntities)
                    entities.Include(e);
                foreach (TEntity e in removedEntities)
                    entities.Remove(e);
    ...
    [SuppressMessage(
        ...
        Justification = "Microsoft: The name clearly describes function and the namespace is under a DLinq namespace which will make the distinction clear."
    )]
    [DataContract]
    [Serializable]
