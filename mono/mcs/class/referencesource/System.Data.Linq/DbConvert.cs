    ...
    public static class DBConvert
    {
        ...
        public static object ChangeType(object value, Type type)
        {
            ...
            else if (toType == typeof(TimeSpan))
            {
                ...
                {
                    return DateTime
                        .Parse(value.ToString(), Globalization.CultureInfo.InvariantCulture)
                        .TimeOfDay;
                }
            ...
            else if (fromType == typeof(string))
            {
                ...
                else if (toType == typeof(char[]))
                {
                    ...
                    toType == typeof(System.Xml.Linq.XDocument) && (string)value == string.Empty
                )
                {
                ...
                && typeof(IEnumerable<>)
                    .MakeGenericType(toType.GetGenericArguments()[0])
