...
namespace System.Data.Linq.SqlClient
{
    ...
    internal class SqlFactory
    {
        ...
        internal SqlExpression ConvertToDateTime(SqlExpression expr)
        {
            return UnaryConvert(
                typeof(DateTime),
                typeProvider.From(typeof(DateTime)),
                expr,
        ...
        internal SqlExpression Add(SqlExpression expr, int second)
        {
            return Binary(
                SqlNodeType.Add,
                expr,
                ValueFromObject(second, false, expr.SourceExpression)
            );
        }
        ...
        internal SqlExpression DATEADD(
            string partName,
            SqlExpression value,
            SqlExpression expr,
        ...
        internal SqlExpression DATETIMEOFFSETADD(
            string partName,
            SqlExpression value,
            SqlExpression expr
        )
        ...
        internal SqlExpression AddTimeSpan(
            SqlExpression dateTime,
            SqlExpression timeSpan,
            bool asNullable
        )
        {
        ...
        internal SqlExpression StaticType(MetaType typeOf, Expression sourceExpression)
        {
            ...
            if (typeOf.InheritanceCode == null)
            {
                ...
                return new SqlValue(
                    typeof(Type),
                    this.typeProvider.From(typeof(Type)),
                    typeOf.Type,
                    false,
                    sourceExpression
                );
            ...
            SqlValue match = new SqlValue(
                type,
                this.typeProvider.From(type),
                typeOf.InheritanceCode,
                true,
                sourceExpression
            );
        ...
        internal SqlExpression DiscriminatedType(SqlExpression discriminator, MetaType targetType)
        {
            return new SqlDiscriminatedType(
                typeProvider.From(typeof(Type)),
                discriminator,
                targetType,
                discriminator.SourceExpression
            );
        }
        ...
        internal SqlTable Table(MetaTable table, MetaType rowType, Expression sourceExpression)
        {
            return new SqlTable(
                table,
                rowType,
                this.typeProvider.GetApplicationType((int)ConverterSpecialTypes.Row),
                sourceExpression
            );
        }
        ...
        internal SqlRowNumber RowNumber(
            List<SqlOrderExpression> orderBy,
            Expression sourceExpression
        )
        {
            return new SqlRowNumber(
                typeof(long),
                typeProvider.From(typeof(long)),
                orderBy,
                sourceExpression
            );
        }
        ...
        )
        {
            ...
            else
            {
                if (nodeType.IsPredicateUnaryOperator())
                {
                    ...
                    clrType = expression.ClrType.Equals(typeof(bool?))
                        ? typeof(bool?)
                        : typeof(bool);
                }
                else
        ...
        internal SqlExpression Case(
            Type clrType,
            SqlExpression discriminator,
            List<SqlExpression> matches,
        ...
        internal SqlExpression ValueFromObject(
            object value,
            bool isClientSpecified,
            Expression sourceExpression
        )
        ...
        )
        {
            ...
            ProviderType sqlType =
                (value == null) ? this.typeProvider.From(clrType) : this.typeProvider.From(value);
        ...
        internal SqlExpression TypeCase(
            Type clrType,
            MetaType rowType,
            SqlExpression discriminator,
        ...
        internal SqlNew New(
            ...
            IEnumerable<SqlMemberAssign> bindings,
            Expression sourceExpression
        )
        {
            SqlNew tb = new SqlNew(
                type,
                typeProvider.From(type.Type),
                cons,
                args,
                argMembers,
                bindings,
        ...
        internal SqlMethodCall MethodCall(
            MethodInfo method,
            SqlExpression obj,
            SqlExpression[] args,
            Expression sourceExpression
        ...
        internal SqlFunctionCall FunctionCall(
            Type clrType,
            string name,
            IEnumerable<SqlExpression> args,
            Expression source
        ...
        {
            return new SqlTableValuedFunctionCall(
                rowType,
                clrType,
                Default(clrType),
                name,
        ...
        )
        {
            ...
            if (joinType == SqlJoinType.LeftOuter)
            {
                ...
                if (
                    sel != null
                    && sel.Selection != null
                    && sel.Selection.NodeType != SqlNodeType.OptionalValue
                )
                {
