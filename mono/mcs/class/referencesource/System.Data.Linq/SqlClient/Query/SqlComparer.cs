        ...
        internal static bool AreEqual(SqlNode node1, SqlNode node2)
        {
            ...
            switch (node1.NodeType)
            {
                ...
                case SqlNodeType.Treat:
                {
                    ...
                    return sun1.ClrType == sun2.ClrType
                        && sun1.SqlType == sun2.SqlType
                ...
                case SqlNodeType.Column:
                    ...
                    return col1 == col2
                        || (
                            col1.Expression != null
                            && col2.Expression != null
                            && AreEqual(col1.Expression, col2.Expression)
                        );
                ...
                case SqlNodeType.SearchedCase:
                {
                    ...
                    {
                        if (
                            !AreEqual(c1.Whens[i].Match, c2.Whens[i].Match)
