...
namespace System.Data.Linq.SqlClient
{
    ...
    internal class SqlTypeConverter : SqlVisitor
    {
        ...
        {
            bool result =
                newSqlType.IsLargeType // we can fit into a large type
                ...
                || (
                    ...
                    && newSqlType.Size >= oldSqlType.Size
        ...
        {
            bool result =
                oldSqlType.IsSameTypeFamily(sql.TypeProvider.From(typeof(string)))
        ...
        internal override SqlExpression VisitUnaryOperator(SqlUnary uo)
        {
            ...
            if (newClrType == typeof(char))
            {
                ...
                {
                    throw Error.UnsafeStringConversion(
                        oldSqlType.ToQueryString(),
                ...
                && (oldSqlType.IsChar || oldSqlType.IsString)
                && newSqlType.IsNumeric
            )
            {
                // char --> int
                return sql.FunctionCall(
                    newClrType,
                    sql.TypeProvider.From(typeof(int)),
                    "UNICODE",
                    new SqlExpression[] { uo.Operand },
                    uo.SourceExpression
                );
