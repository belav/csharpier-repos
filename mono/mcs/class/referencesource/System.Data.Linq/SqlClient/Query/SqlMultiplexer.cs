...
namespace System.Data.Linq.SqlClient
{
    ...
    internal class SqlMultiplexer
    {
        ...
        class Visitor : SqlVisitor
        {
            ...
            internal override SqlExpression VisitMultiset(SqlSubSelect sms)
            {
                ...
                if (
                    (this.options & Options.EnableBigJoin) != 0
                    && !this.hasBigJoin
                    && this.canJoin
                    && this.isTopLevel
                    && this.outerSelect != null
                ...
                )
                {
                    ...
                    SqlJoin join = new SqlJoin(
                        ...
                        this.outerSelect.From,
                        alias,
                        null,
                        sms.SourceExpression
                    );
                    ...
                    SqlSelect countSelect = new SqlSelect(
                        sql.Unary(SqlNodeType.Count, null, sms.SourceExpression),
                        copyAlias,
                        sms.SourceExpression
                    );
                    ...
                    SqlJoinedCollection jc = new SqlJoinedCollection(
                        sms.ClrType,
                        sms.SqlType,
                        expr,
                        count,
            ...
            internal override SqlSelect VisitSelect(SqlSelect select)
            {
                ...
                this.canJoin &=
                    select.GroupBy.Count == 0 && select.Top == null && !select.IsDistinct;
    ...
    {
        internal static SqlClientQuery Extract(
