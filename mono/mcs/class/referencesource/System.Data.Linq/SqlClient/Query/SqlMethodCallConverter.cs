...
namespace System.Data.Linq.SqlClient
{
    internal static class PostBindDotNetConverter
    {
        ...
        internal static SqlNode Convert(
            SqlNode node,
            SqlFactory sql,
        ...
        {
            return uo.NodeType == SqlNodeType.Convert && uo.ClrType == typeof(char)
                || uo.Operand.ClrType == typeof(char);
        }
        ...
        {
            return snew.Args.Count == 2
                && snew.Args[0].ClrType == typeof(char)
                && snew.Args[1].ClrType == typeof(int);
        }

        private static bool IsSupportedDateTimeNew(SqlNew sox)
        {
            if (
                sox.ClrType == typeof(DateTime)
                && sox.Args.Count >= 3
            ...
            )
            {
                ...
                if (
                    sox.Args.Count >= 6
                    && sox.Args[3].ClrType == typeof(int)
                    && sox.Args[4].ClrType == typeof(int)
                    && sox.Args[5].ClrType == typeof(int)
                )
                {
                    if (sox.Args.Count == 6)
                    {
        ...
        private static MethodSupport GetComparisonMethodSupport(SqlMethodCall mc)
        {
            if (
                mc.Method.IsStatic
                && mc.Method.Name == "Compare"
                && mc.Method.ReturnType == typeof(int)
            )
            {
                return MethodSupport.Method;
            }
        ...
        {
            if (
                mc.Method.Name == "GetValueOrDefault"
        ...
        private static MethodSupport GetSqlMethodsMethodSupport(SqlMethodCall mc)
        {
            ...
            {
                if (
                    mc.Method.Name.StartsWith("DateDiff", StringComparison.Ordinal)
        ...
        private static MethodSupport GetConvertMethodSupport(SqlMethodCall mc)
        {
            if (
                mc.Method.IsStatic
                && mc.Method.DeclaringType == typeof(Convert)
                ...
                switch (mc.Method.Name)
                {
                    ...
                    case "ToDateTime":
                        if (
                            ...
                            || mc.Arguments[0].ClrType == typeof(DateTime)
                        )
                        {
                            return MethodSupport.Method;
                        }
        ...
        private static MethodSupport GetMathMethodSupport(SqlMethodCall mc)
        {
            if (mc.Method.IsStatic && mc.Method.DeclaringType == typeof(Math))
            {
                switch (mc.Method.Name)
                {
                    ...
                    case "Round":
                        if (
                            mc.Arguments[mc.Arguments.Count - 1].ClrType == typeof(MidpointRounding)
        ...
        private static bool IsVbLike(SqlMethodCall mc)
        {
            return mc.Method.IsStatic
                    && (
                        mc.Method.DeclaringType.FullName
                            == "Microsoft.VisualBasic.CompilerServices.LikeOperator"
                        && mc.Method.Name == "LikeString"
                    )
                || (
                    mc.Method.DeclaringType.FullName
                        == "Microsoft.VisualBasic.CompilerServices.Operators"
        ...
        private class Visitor : SqlVisitor
        {
            ...
            private SqlExpression TranslateNewString(SqlNew sox)
            {
                ...
                if (
                    ...
                    && sox.Args.Count == 2
                    && sox.Args[0].ClrType == typeof(char)
                    && sox.Args[1].ClrType == typeof(int)
                )
                {
                    return sql.FunctionCall(
                        typeof(string),
                        "REPLICATE",
                        new SqlExpression[] { sox.Args[0], sox.Args[1] },
            ...
            private SqlExpression TranslateNewDateTime(SqlNew sox)
            {
                ...
                {
                    SqlExpression char2 = sql.FunctionCall(
                        typeof(void),
                        "NCHAR",
                        new SqlExpression[1] { sql.ValueFromObject(2, false, source) },
                        source
                    );
                    SqlExpression char4 = sql.FunctionCall(
                        typeof(void),
                        "NCHAR",
                        new SqlExpression[1] { sql.ValueFromObject(4, false, source) },
                        source
                    );
                    SqlExpression year = sql.FunctionCall(
                        typeof(string),
                        "CONVERT",
                        new SqlExpression[2] { char4, sox.Args[0] },
                        source
                    );
                    SqlExpression month = sql.FunctionCall(
                        typeof(string),
                        "CONVERT",
                        new SqlExpression[2] { char2, sox.Args[1] },
                        source
                    );
                    SqlExpression day = sql.FunctionCall(
                        typeof(string),
                        "CONVERT",
                        new SqlExpression[2] { char2, sox.Args[2] },
                        source
                    );
                    SqlExpression datetime = new SqlVariable(
                        typeof(void),
                        null,
                        "DATETIME",
                        source
                    ...
                    if (sox.Args.Count == 3)
                    {
                        ...
                        return sql.FunctionCall(
                            ...
                            new SqlExpression[3]
                            {
                                datetime,
                                date,
                                sql.ValueFromObject(101, false, source),
                            },
                            source
                        );
                    }
                    ...
                    )
                    {
                        ...
                        SqlExpression hour = sql.FunctionCall(
                            typeof(string),
                            "CONVERT",
                            new SqlExpression[2] { char2, sox.Args[3] },
                            source
                        );
                        SqlExpression minute = sql.FunctionCall(
                            typeof(string),
                            "CONVERT",
                            new SqlExpression[2] { char2, sox.Args[4] },
                            source
                        );
                        SqlExpression second = sql.FunctionCall(
                            typeof(string),
                            "CONVERT",
                            new SqlExpression[2] { char2, sox.Args[5] },
                            source
                        );
                        SqlExpression date = sql.Concat(
                            year,
                        ...
                        SqlExpression dateAndTime = sql.Concat(
                            date,
                            sql.ValueFromObject(' ', false, source),
                            time
                        );
                        ...
                        if ((sox.Args.Count == 7) && (sox.Args[6].ClrType == typeof(int)))
                        {
                            ...
                            SqlExpression msRaw = sql.FunctionCall(
                                typeof(string),
                                "CONVERT",
                                new SqlExpression[2]
                                {
                                    char4,
                                    sql.Add(sql.ValueFromObject(1000, false, source), sox.Args[6]),
                                },
                                source
                            );
                            SqlExpression ms;
                            if (this.providerMode == SqlProvider.ProviderMode.SqlCE)
                            {
                                ...
                                SqlExpression len = sql.FunctionCall(
                                    typeof(int),
                                    "LEN",
                                    new SqlExpression[1] { msRaw },
                                    source
                                );
                                SqlExpression startIndex = sql.Binary(
                                    SqlNodeType.Sub,
                                    len,
                                    sql.ValueFromObject(2, false, source)
                                );
                                ms = sql.FunctionCall(
                                    typeof(string),
                                    "SUBSTRING",
                                    new SqlExpression[3]
                                    {
                                        msRaw,
                                        startIndex,
                                        sql.ValueFromObject(3, false, source),
                                    },
                                    source
                                );
                            }
            ...
            private SqlExpression TranslateNewDateTimeOffset(SqlNew sox)
            {
                ...
                if (sox.ClrType == typeof(DateTimeOffset))
                {
                    ...
                    if (
                        sox.Args.Count == 2
                        && sox.Args[0].ClrType == typeof(DateTime)
                        && sox.Args[1].ClrType == typeof(TimeSpan)
                    )
                    {
                        return sql.FunctionCall(
                            typeof(DateTimeOffset),
                            ...
                            new SqlExpression[2]
                            {
                                ...
                                sql.ConvertToInt(
                                    sql.ConvertToBigint(
                                        sql.Divide(
                                            sql.ConvertTimeToDouble(sox.Args[1]),
                    ...
                    )
                    {
                        ...
                        SqlExpression char5 = sql.FunctionCall(
                            typeof(void),
                            "NCHAR",
                            new SqlExpression[1] { sql.ValueFromObject(5, false, source) },
                            source
                        );

                        // add leading zeros to year by RIGHT(CONVERT(NCHAR(5),10000+@ms),4)
                        SqlExpression yyRaw = sql.FunctionCall(
                            typeof(string),
                            "CONVERT",
                            new SqlExpression[2]
                            {
                                char5,
                                sql.Add(sql.ValueFromObject(10000, false, source), sox.Args[0]),
                            },
                            source
                        );
                        SqlExpression year = sql.FunctionCall(
                            typeof(string),
                            "RIGHT",
                            new SqlExpression[2] { yyRaw, sql.ValueFromObject(4, false, source) },
                            source
                        );
                        ...
                        SqlExpression datetimeoffset = new SqlVariable(
                            typeof(void),
                            null,
                            "DATETIMEOFFSET",
                            source
                        ...
                        if (sox.Args.Count == 7 && sox.Args[6].ClrType == typeof(TimeSpan))
                        {
                            ...
                            sox.Args.Count == 8
                            && sox.Args[6].ClrType == typeof(int)
                            && sox.Args[7].ClrType == typeof(TimeSpan)
                        )
                        {
                            timeSpanIndex = 7;
                            // add leading zeros to milliseconds by RIGHT(CONVERT(NCHAR(4),1000+@ms),3)
                            ...
                            SqlExpression ms = sql.FunctionCall(
                                typeof(string),
                                "RIGHT",
                                new SqlExpression[2]
                                {
                        ...
                        return sql.FunctionCall(
                            ...
                            new SqlExpression[2]
                            {
                                ...
                                sql.ConvertToInt(
                                    sql.ConvertToBigint(
                                        sql.Divide(
                                            sql.ConvertTimeToDouble(sox.Args[timeSpanIndex]),
                                            TimeSpan.TicksPerMinute
                                        )
                                    )
                                ),
            ...
            private SqlExpression TranslateNewTimeSpan(SqlNew sox)
            {
                ...
                else if (sox.Args.Count == 3)
                {
                    ...
                    return sql.ConvertTo(
                        typeof(TimeSpan),
                        sql.Add(TicksFromHours, TicksFromMinutes, TicksFromSeconds)
                    );
                }
                else
                {
                    ...
                    SqlExpression TicksFromMinutes = sql.Multiply(minutes, TimeSpan.TicksPerMinute);
                    SqlExpression TicksFromSeconds = sql.Multiply(seconds, TimeSpan.TicksPerSecond);
                    SqlExpression totalTicks = sql.Add(
                        TicksFromDays,
                        TicksFromHours,
                        TicksFromMinutes,
                        TicksFromSeconds
                    ...
                    else if (sox.Args.Count == 5)
                    {
                        ...
                        SqlExpression ticksFromMs = sql.Multiply(
                            milliseconds,
            ...
            internal override SqlExpression VisitMethodCall(SqlMethodCall mc)
            {
                ...
                if (mc.Method.IsStatic)
                {
                    ...
                    {
                        returnValue = this.CreateComparison(
                            mc.Arguments[0],
                            mc.Arguments[1],
                            mc.SourceExpression
                        );
                ...
                )
                {
                    foreach (string datePart in dateParts)
                    {
                        if (mc.Method.Name == "DateDiff" + datePart)
                        {
                            ...
                            SqlExpression unit = new SqlVariable(
                                typeof(void),
                                null,
                                datePart,
                                source
                            ...
                            return sql.FunctionCall(
                                typeof(int),
                                "DATEDIFF",
                                new SqlExpression[] { unit, start, end },
                                source
                            );
                        }
                    }
                ...
                else if (name == "Like")
                {
                    ...
                    else if (mc.Arguments.Count == 3)
                    {
                        return sql.Like(
                            mc.Arguments[0],
                            mc.Arguments[1],
                            sql.ConvertTo(typeof(string), mc.Arguments[2]),
                            source
                        );
                    }
                }
            ...
            private SqlExpression TranslateDateTimeInstanceMethod(SqlMethodCall mc)
            {
                ...
                if (mc.Method.Name == "CompareTo")
                {
                    ...
                    (
                        mc.Method.Name == "Add"
                        && mc.Arguments.Count == 1
                        && mc.Arguments[0].ClrType == typeof(TimeSpan)
                ...
                else if (mc.Method.Name == "AddMilliseconds")
                {
                    ...
                    returnValue = this.CreateDateTimeFromDateAndMs(
                        mc.Object,
                        mc.Arguments[0],
                        source
                    );
            ...
            private SqlExpression TranslateDateTimeOffsetInstanceMethod(SqlMethodCall mc)
            {
                ...
                )
                {
                    ...
                    returnValue = this.CreateDateTimeOffsetFromDateAndTicks(
                        mc.Object,
                        ticks,
                        source
                    );
                ...
                {
                    // date + ms --> DATEADD(ms, @ms, @date)
                    returnValue = this.CreateDateTimeOffsetFromDateAndMs(
                        mc.Object,
                        mc.Arguments[0],
                        source
                    );
            ...
            private SqlExpression TranslateTimeSpanInstanceMethod(SqlMethodCall mc)
            {
                ...
                else if (mc.Method.Name == "Duration")
                {
                    ...
                    returnValue = sql.FunctionCall(
                        typeof(TimeSpan),
                        "ABS",
                        new SqlExpression[] { mc.Object },
                        source
                    );
                }
            ...
            private SqlExpression TranslateConvertStaticMethod(SqlMethodCall mc)
            {
                ...
                if (mc.Arguments.Count == 1)
                {
                    ...
                    // remains.
                    if (
                        sql.TypeProvider.From(targetType) != expr.SqlType
                    ...
                    else if (targetType != null)
                    {
                        if (sql.TypeProvider.From(targetType) != expr.SqlType)
                        {
                            ...
                            targetType != expr.ClrType
                            && (
                                TypeSystem.GetNonNullableType(targetType)
                ...
                switch (bo.NodeType)
                {
                    case SqlNodeType.Sub:
                        if (rightType == typeof(DateTime))
                        {
                            ...
                            SqlExpression day = new SqlVariable(
                                typeof(void),
                                null,
                                "DAY",
                                bo.SourceExpression
                            );
                            SqlExpression ms = new SqlVariable(
                                typeof(void),
                                null,
                                "MILLISECOND",
                                bo.SourceExpression
                            ...
                            SqlExpression intDays = sql.FunctionCall(
                                typeof(int),
                                "DATEDIFF",
                                new SqlExpression[] { day, start, end },
                                bo.SourceExpression
                            );
                            SqlExpression startPlusDays = sql.FunctionCall(
                                typeof(DateTime),
                                "DATEADD",
                                new SqlExpression[] { day, intDays, start },
                                bo.SourceExpression
                            );
                            SqlExpression intMSec = sql.FunctionCall(
                                typeof(int),
                                "DATEDIFF",
                                new SqlExpression[] { ms, startPlusDays, end },
                                bo.SourceExpression
                            );
                            SqlExpression result = sql.Multiply(
                                sql.Add(
                        ...
                        {
                            Debug.Assert(
                                TypeSystem.GetNonNullableType(bo.Left.ClrType)
                                    == typeof(DateTimeOffset)
                            );
                            // if either of the arguments is nullable, set result type to nullable.
                            Type resultType = bo.ClrType;
                            ...
                            SqlExpression us = new SqlVariable(
                                typeof(void),
                                null,
                                "MICROSECOND",
                                bo.SourceExpression
                            );
                            SqlExpression ns = new SqlVariable(
                                typeof(void),
                                null,
                                "NANOSECOND",
                                bo.SourceExpression
                            ...
                            SqlExpression startPlusDaysPlusMsec = sql.FunctionCall(
                                typeof(DateTimeOffset),
                                "DATEADD",
                                new SqlExpression[] { ms, intMSec, startPlusDays },
                                bo.SourceExpression
                            );
                            SqlExpression intUSec = sql.FunctionCall(
                                typeof(int),
                                "DATEDIFF",
                                new SqlExpression[] { us, startPlusDaysPlusMsec, end },
                                bo.SourceExpression
                            );
                            SqlExpression startPlusDaysPlusMsecPlusUSec = sql.FunctionCall(
                                typeof(DateTimeOffset),
                                "DATEADD",
                                new SqlExpression[] { us, intUSec, startPlusDaysPlusMsec },
                                bo.SourceExpression
                            );
                            SqlExpression intNSec = sql.FunctionCall(
                                typeof(int),
                                "DATEDIFF",
                                new SqlExpression[] { ns, startPlusDaysPlusMsecPlusUSec, end },
                                bo.SourceExpression
                            );
                            SqlExpression startPlusDaysPlusMsecPlusUSecPlusNSec = sql.FunctionCall(
                                typeof(DateTimeOffset),
                                "DATEADD",
                                new SqlExpression[] { ns, intNSec, startPlusDaysPlusMsecPlusUSec },
                                bo.SourceExpression
                            );
                    ...
                    case SqlNodeType.Add:
                        if (rightType == typeof(TimeSpan))
                        {
                            ...
                            {
                                return CreateDateTimeOffsetFromDateAndTicks(
                                    bo.Left,
                                    bo.Right,
                                    bo.SourceExpression,
                                    resultNullable
                            ...
                            return CreateDateTimeFromDateAndTicks(
                                bo.Left,
                                bo.Right,
                                bo.SourceExpression,
                                resultNullable
            ...
            //helper functions
            private SqlExpression CreateFunctionCallStatic1(
                Type type,
                string functionName,
            ...
            private SqlExpression CreateFunctionCallStatic2(
                Type type,
                string functionName,
                List<SqlExpression> arguments,
                Expression source
            )
            {
                return sql.FunctionCall(
                    type,
                    functionName,
                    new SqlExpression[] { arguments[0], arguments[1] },
                    source
                );
            }
                ...
                switch (mc.Method.Name)
                {
                    case "Contains":
                        if (mc.Arguments.Count == 1)
                        {
                            ...
                            if (pattern.NodeType == SqlNodeType.Value)
                            {
                                ...
                                string patternText = SqlHelpers.GetStringContainsPattern(
                                    unescapedText,
                                    '~',
                                    out needsEscape
                                );
                                pattern = sql.ValueFromObject(
                                    patternText,
                                    true,
                            ...
                            else if (pattern.NodeType == SqlNodeType.ClientParameter)
                            {
                                ...
                                Func<string, char, string> getStringContainsPatternForced =
                                    SqlHelpers.GetStringContainsPatternForced;
                                pattern = new SqlClientParameter(
                                    cp.ClrType,
                                    cp.SqlType,
                                    Expression.Lambda(
                                        Expression.Invoke(
                                            Expression.Constant(getStringContainsPatternForced),
                                            cp.Accessor.Body,
                                            Expression.Constant('~')
                                        ),
                            ...
                            {
                                throw Error.NonConstantExpressionsNotSupportedFor(
                                    "String.Contains"
                                );
                            }
                    ...
                    case "StartsWith":
                        if (mc.Arguments.Count == 1)
                        {
                            ...
                            {
                                string unescapedText = (string)((SqlValue)pattern).Value;
                                string patternText = SqlHelpers.GetStringStartsWithPattern(
                                    unescapedText,
                                    '~',
                                    out needsEscape
                                );
                            ...
                            {
                                SqlClientParameter cp = (SqlClientParameter)pattern;
                                Func<string, char, string> getStringStartsWithPatternForced =
                                    SqlHelpers.GetStringStartsWithPatternForced;
                                pattern = new SqlClientParameter(
                                    cp.ClrType,
                                    cp.SqlType,
                                    Expression.Lambda(
                                        Expression.Invoke(
                                            Expression.Constant(getStringStartsWithPatternForced),
                                            cp.Accessor.Body,
                                            Expression.Constant('~')
                                        ),
                                        cp.Accessor.Parameters[0]
                    ...
                    case "EndsWith":
                        if (mc.Arguments.Count == 1)
                        {
                            ...
                            {
                                string unescapedText = (string)((SqlValue)pattern).Value;
                                string patternText = SqlHelpers.GetStringEndsWithPattern(
                                    unescapedText,
                                    '~',
                                    out needsEscape
                                );
                            ...
                            {
                                SqlClientParameter cp = (SqlClientParameter)pattern;
                                Func<string, char, string> getStringEndsWithPatternForced =
                                    SqlHelpers.GetStringEndsWithPatternForced;
                                pattern = new SqlClientParameter(
                                    cp.ClrType,
                                    cp.SqlType,
                                    Expression.Lambda(
                                        Expression.Invoke(
                                            Expression.Constant(getStringEndsWithPatternForced),
                                            cp.Accessor.Body,
                                            Expression.Constant('~')
                                        ),
                                        cp.Accessor.Parameters[0]
                    ...
                    case "IndexOf":
                        if (mc.Arguments.Count == 1)
                        {
                            ...
                            SqlExpression lenZeroExpr = sql.Binary(
                                SqlNodeType.EQ,
                                sql.CLRLENGTH(mc.Arguments[0]),
                                sql.ValueFromObject(0, source)
                            );
                            SqlWhen when = new SqlWhen(lenZeroExpr, sql.ValueFromObject(0, source));
                            SqlExpression @else = sql.Subtract(
                                sql.FunctionCall(
                                    typeof(int),
                                    "CHARINDEX",
                                    new SqlExpression[] { mc.Arguments[0], mc.Object },
                                    source
                                ),
                                1
                            );
                    ...
                    case "LastIndexOf":
                        if (mc.Arguments.Count == 1)
                        {
                            ...
                            SqlExpression reverseS = sql.FunctionCall(
                                typeof(string),
                                "REVERSE",
                                new SqlExpression[] { exprS },
                                source
                            );
                            SqlExpression reversePart = sql.FunctionCall(
                                typeof(string),
                                "REVERSE",
                                new SqlExpression[] { exprPart },
                                source
                            );
                            SqlExpression charIndex = sql.FunctionCall(
                                typeof(int),
                                "CHARINDEX",
                                new SqlExpression[] { exprPart, exprS },
                                source
                            );
                            SqlExpression charIndexOfReverse = sql.FunctionCall(
                                typeof(int),
                                "CHARINDEX",
                                new SqlExpression[] { reversePart, reverseS },
                                source
                            );
                            ...
                            SqlExpression elseCase = sql.Add(
                                sql.ValueFromObject(1, false, source),
                                sql.Subtract(len1, sql.Add(len2, charIndexOfReverse))
                            );

                            SqlWhen whenNotContained = new SqlWhen(
                                notContained,
                                sql.ValueFromObject(-1, false, source)
                            );
                            ...
                            SqlWhen whenLenZero = new SqlWhen(
                                lenZeroExpr,
                                sql.Subtract(sql.CLRLENGTH(exprS), 1)
                            );

                            return sql.SearchedCase(
                                new SqlWhen[] { whenLenZero, whenNotContained },
                                elseCase,
                                source
                            );
                        }
                        else if (mc.Arguments.Count == 2)
                        {
                            ...
                            SqlExpression first = sql.FunctionCall(
                                typeof(string),
                                "LEFT",
                                new SqlExpression[] { s, sql.Add(i, 1) },
                                source
                            );
                            SqlExpression reverseFirst = sql.FunctionCall(
                                typeof(string),
                                "REVERSE",
                                new SqlExpression[] { first },
                                source
                            );
                            SqlExpression reversePart = sql.FunctionCall(
                                typeof(string),
                                "REVERSE",
                                new SqlExpression[] { part },
                                source
                            );
                            SqlExpression charIndex = sql.FunctionCall(
                                typeof(int),
                                "CHARINDEX",
                                new SqlExpression[] { part, first },
                                source
                            );
                            SqlExpression charIndexOfReverse = sql.FunctionCall(
                                typeof(int),
                                "CHARINDEX",
                                new SqlExpression[] { reversePart, reverseFirst },
                                source
                            );
                            SqlExpression notContained = sql.Binary(
                                SqlNodeType.EQ,
                        ...
                        else if (mc.Arguments.Count == 3)
                        {
                            ...
                            notContained = sql.OrAccumulate(
                                notContained,
                                sql.Binary(SqlNodeType.LE, elseCase, sql.Subtract(i, count))
                            );
                    ...
                    case "Insert":
                        ...
                        if (mc.Arguments.Count == 2)
                        {
                            ...
                            return sql.SearchedCase(
                                new SqlWhen[] { new SqlWhen(insertingAtEnd, stringConcat) },
                                stuffCall,
                                source
                            );
                        }
                    ...
                    case "PadLeft":
                        if (mc.Arguments.Count == 1)
                        {
                            ...
                            SqlExpression padding = sql.FunctionCall(
                                typeof(string),
                                "SPACE",
                                new SqlExpression[] { numSpaces },
                                source
                            );
                            SqlExpression elseCase = sql.Concat(padding, exprS);

                            return sql.SearchedCase(
                                new SqlWhen[] { new SqlWhen(dontChange, exprS) },
                                elseCase,
                                source
                            );
                        }
                        else if (mc.Arguments.Count == 2)
                        {
                            ...
                            SqlExpression padding = sql.FunctionCall(
                                typeof(string),
                                "REPLICATE",
                                new SqlExpression[] { exprC, numSpaces },
                                source
                            );
                            SqlExpression elseCase = sql.Concat(padding, exprS);
                    ...
                    case "Replace":
                        ...
                        return sql.FunctionCall(
                            typeof(string),
                            "REPLACE",
                            new SqlExpression[] { mc.Object, mc.Arguments[0], mc.Arguments[1] },
                            source
                        );
                    case "Substring":
                        if (mc.Arguments.Count == 1)
            ...
            private SqlExpression TranslateMathMethod(SqlMethodCall mc)
            {
                ...
                switch (mc.Method.Name)
                {
                    case "Abs":
                        ...
                        {
                            return sql.FunctionCall(
                                mc.Arguments[0].ClrType,
                                "ABS",
                                new SqlExpression[] { mc.Arguments[0] },
                                source
                            );
                        }
                        break;
                    ...
                    case "Atan2":
                        if (mc.Arguments.Count == 2)
                        {
                            return this.CreateFunctionCallStatic2(
                                typeof(double),
                                "ATN2",
                                mc.Arguments,
                                source
                    ...
                    case "BigMul":
                        ...
                        {
                            return sql.Multiply(
                                sql.ConvertToBigint(mc.Arguments[0]),
                                sql.ConvertToBigint(mc.Arguments[1])
                            );
                        }
                        break;
                    case "Ceiling":
                    ...
                    case "Cosh":
                        if (mc.Arguments.Count == 1)
                        {
                            ...
                            SqlExpression expX = sql.FunctionCall(
                                typeof(double),
                                "EXP",
                                new SqlExpression[] { x },
                                source
                            ...
                            SqlExpression expMinusX = sql.FunctionCall(
                                typeof(double),
                                "EXP",
                                new SqlExpression[] { minusX },
                                source
                            );
                    ...
                    case "Log":
                        ...
                        else if (mc.Arguments.Count == 2)
                        {
                            ...
                            SqlExpression log1 = sql.FunctionCall(
                                typeof(double),
                                "LOG",
                                new SqlExpression[] { mc.Arguments[0] },
                                source
                            );
                            SqlExpression log2 = sql.FunctionCall(
                                typeof(double),
                                "LOG",
                                new SqlExpression[] { mc.Arguments[1] },
                                source
                            );
                    ...
                    case "Max":
                        if (mc.Arguments.Count == 2)
                        {
                            ...
                            return new SqlSearchedCase(
                                mc.Method.ReturnType,
                                new SqlWhen[] { new SqlWhen(aLower, b) },
                                a,
                                source
                            );
                        }
                    ...
                    case "Min":
                        if (mc.Arguments.Count == 2)
                        {
                            ...
                            SqlExpression aLower = sql.Binary(SqlNodeType.LT, a, b);
                            return sql.SearchedCase(
                                new SqlWhen[] { new SqlWhen(aLower, a) },
                                b,
                                source
                            );
                        }
                    ...
                    case "Round":
                        ...
                        else
                        {
                            ...
                            if (
                                (MidpointRounding)this.Eval(roundingMethod)
                            ...
                            else
                            {
                                ...
                                // END
                                Type type = x.ClrType;
                                SqlExpression roundX = sql.FunctionCall(
                                    type,
                                    "round",
                                    new SqlExpression[] { x, i },
                                    source
                                ...
                                SqlExpression round2X = sql.FunctionCall(
                                    type,
                                    "round",
                                    new SqlExpression[] { twiceX, i },
                                    source
                                );
                                SqlExpression condition = sql.AndAccumulate(
                                    sql.Binary(SqlNodeType.EQ, twiceX, round2X),
                                    sql.Binary(SqlNodeType.NE, x, roundX)
                                );
                                SqlExpression specialCase = sql.Multiply(
                                    sql.FunctionCall(
                                        type,
                                        "round",
                                        new SqlExpression[] { sql.Divide(x, 2), i },
                                        source
                                    ),
                                    2
                                );
                                return sql.SearchedCase(
                                    new SqlWhen[] { new SqlWhen(condition, specialCase) },
                                    roundX,
                                    source
                                );
                            }
                    ...
                    case "Sinh":
                        ...
                        {
                            SqlExpression x = mc.Arguments[0];
                            SqlExpression exp = sql.FunctionCall(
                                typeof(double),
                                "EXP",
                                new SqlExpression[] { x },
                                source
                            ...
                            SqlExpression minusX = sql.Unary(SqlNodeType.Negate, x, source);
                            SqlExpression expMinus = sql.FunctionCall(
                                typeof(double),
                                "EXP",
                                new SqlExpression[] { minusX },
                                source
                    ...
                    case "Tanh":
                        if (mc.Arguments.Count == 1)
                        {
                            ...
                            return sql.Divide(
                                sql.Subtract(expX, expMinusX),
                                sql.Add(expX, expMinusX)
                            );
                        }
                        break;
                    case "Truncate":
            ...
            [SuppressMessage(
                ...
                Justification = "Microsoft: These issues are related to our use of if-then and case statements for node types, which adds to the complexity count however when reviewed they are easy to navigate and understand."
            )]
            internal override SqlNode VisitMember(SqlMember m)
            {
                ...
                else if (baseClrTypeOfExpr == typeof(Binary) && member.Name == "Length")
                {
                    ...
                    baseClrTypeOfExpr == typeof(DateTime)
                    || baseClrTypeOfExpr == typeof(DateTimeOffset)
                )
                {
                    ...
                    else if (member.Name == "Date")
                    {
                        ...
                        {
                            SqlExpression date = new SqlVariable(
                                typeof(void),
                                null,
                                "DATE",
                                source
                        ...
                        result = sql.DATEADD(
                            "MILLISECOND",
                            sql.Unary(SqlNodeType.Negate, ms),
                            result
                        );
                    ...
                    else if (member.Name == "DateTime")
                    {
                        Debug.Assert(
                            baseClrTypeOfExpr == typeof(DateTimeOffset),
                            "'DateTime' property supported only for instances of DateTimeOffset."
                        );
                        SqlExpression datetime = new SqlVariable(
                            typeof(void),
                            null,
                        ...
                        return sql.FunctionCall(
                            typeof(DateTime),
                            "CONVERT",
                            new SqlExpression[2] { datetime, exp },
                            source
                        );
                    }
                    else if (member.Name == "TimeOfDay")
                    {
                        ...
                        SqlExpression ticksFromHour = sql.Multiply(
                            sql.ConvertToBigint(hours),
                            TimeSpan.TicksPerHour
                        );
                        SqlExpression ticksFromMinutes = sql.Multiply(
                            sql.ConvertToBigint(minutes),
                            TimeSpan.TicksPerMinute
                        );
                        SqlExpression ticksFromSeconds = sql.Multiply(
                            sql.ConvertToBigint(seconds),
                            TimeSpan.TicksPerSecond
                        );
                        SqlExpression ticksFromMs = sql.Multiply(
                            sql.ConvertToBigint(milliseconds),
                            TimeSpan.TicksPerMillisecond
                        );
                        return sql.ConvertTo(
                            typeof(TimeSpan),
                            sql.Add(ticksFromHour, ticksFromMinutes, ticksFromSeconds, ticksFromMs)
                        );
                    }
                ...
                else if (baseClrTypeOfExpr == typeof(System.TimeSpan))
                {
                    switch (member.Name)
                    {
                        ...
                        case "Milliseconds":
                            ...
                            return sql.ConvertToInt(
                                sql.Mod(
                                    sql.ConvertToBigint(
                                        sql.Divide(exp, TimeSpan.TicksPerMillisecond)
                                    ),
                                    1000
                                )
                            );
                        case "Seconds":
                            ...
                            return sql.ConvertToInt(
                                sql.Mod(
                                    sql.ConvertToBigint(sql.Divide(exp, TimeSpan.TicksPerSecond)),
                                    60
                                )
                            );
                        case "Minutes":
                            ...
                            return sql.ConvertToInt(
                                sql.Mod(
                                    sql.ConvertToBigint(sql.Divide(exp, TimeSpan.TicksPerMinute)),
                                    60
                                )
                            );
                        case "Hours":
                            ...
                            return sql.ConvertToInt(
                                sql.Mod(
                                    sql.ConvertToBigint(sql.Divide(exp, TimeSpan.TicksPerHour)),
                                    24
                                )
                            );
                        case "Days":
            ...
            private SqlExpression CreateDateTimeFromDateAndTicks(
                SqlExpression sqlDate,
                SqlExpression sqlTicks,
                Expression source
            )
            {
            ...
            {
                SqlExpression daysAdded = sql.DATEADD(
                    "day",
                    sql.Divide(sqlTicks, TimeSpan.TicksPerDay),
                    sqlDate,
                    source,
                    asNullable
                );
                return sql.DATEADD(
                    "ms",
                    sql.Mod(sql.Divide(sqlTicks, TimeSpan.TicksPerMillisecond), 86400000),
                    daysAdded,
                    source,
                    asNullable
                );
            ...
            private SqlExpression CreateDateTimeFromDateAndMs(
                SqlExpression sqlDate,
                SqlExpression ms,
                Expression source
            )
            ...
            // date + timespan --> DATEADD( day, @timespan/864000000000, DATEADD(ms,(@timespan/1000) % 86400000 , @date))
            private SqlExpression CreateDateTimeOffsetFromDateAndTicks(
                SqlExpression sqlDate,
                SqlExpression sqlTicks,
                Expression source
            )
            ...
            {
                SqlExpression daysAdded = sql.DATETIMEOFFSETADD(
                    "day",
                    sql.Divide(sqlTicks, TimeSpan.TicksPerDay),
                    sqlDate,
                    source,
            ...
            // date + ms --> DATEADD( day, @ms/86400000, DATEADD(ms, @ms % 86400000 , @date))
            private SqlExpression CreateDateTimeOffsetFromDateAndMs(
                SqlExpression sqlDate,
                SqlExpression ms,
                Expression source
            )
            ...
            private SqlExpression TranslateVbConversionMethod(SqlMethodCall mc)
            {
                ...
                if (mc.Arguments.Count == 1)
                {
                    ...
                    {
                        if (
                            (targetType == typeof(int) || targetType == typeof(Single))
                            && expr.ClrType == typeof(bool)
                        )
                        {
            ...
            private SqlExpression TranslateVbLikeString(SqlMethodCall mc)
            {
                ...
                SqlExpression escape = needsEscape
                    ? sql.ValueFromObject("~", false, mc.SourceExpression)
                    : null;
