...
namespace System.Data.Linq.SqlClient
{
    internal class SqlFormatter : DbFormatter
    {
        ...
        internal class Visitor : SqlVisitor
        {
            ...
            internal Dictionary<SqlColumn, SqlAlias> aliasMap =
                new Dictionary<SqlColumn, SqlAlias>();
            internal int depth;
            internal bool parenthesizeTop;
            ...
            internal override SqlExpression VisitColumnRef(SqlColumnRef cref)
            {
                ...
                if (
                    !this.suppressedAliases.Contains(c.Alias)
                    && aliasName != null
                    && aliasName.Length != 0
                )
                {
            ...
            internal override SqlAlias VisitAlias(SqlAlias alias)
            {
                ...
                if (
                    !this.suppressedAliases.Contains(alias)
                    && aliasName != null
                    && name != aliasName
                )
                {
