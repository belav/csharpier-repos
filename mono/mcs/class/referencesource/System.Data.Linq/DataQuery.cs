...
namespace System.Data.Linq
{
            ...
            IListSource
    {
        ...
        {
            return (
                (IEnumerable)this.context.Provider.Execute(this.queryExpression).ReturnValue
            ).GetEnumerator();
        }
        ...
        {
            return (
                (IEnumerable<T>)this.context.Provider.Execute(this.queryExpression).ReturnValue
            ).GetEnumerator();
        }
