...
namespace LinqToSqlShared.Mapping
{
    ...
    internal class DatabaseMapping
    {
        ...
        {
            if (
                string.Compare(map.Name, type.Name, StringComparison.Ordinal) == 0
                || string.Compare(map.Name, type.FullName, StringComparison.Ordinal) == 0
                || string.Compare(map.Name, type.AssemblyQualifiedName, StringComparison.Ordinal)
                    == 0
            )
                return true;
    ...
    class XmlMappingConstant
    {
        ...
        internal const string MappingNamespace =
    ...
    internal class ParameterMapping
    {
        ...
        public string XmlDirection
        {
            get
            {
                return this.direction == MappingParameterDirection.In
                    ? null
            ...
            set
            {
                this.direction =
                    (value == null)
                        ...
                        : (MappingParameterDirection)
                            Enum.Parse(typeof(MappingParameterDirection), value, true);
            }
        }
    ...
    internal sealed class ColumnMapping : MemberMapping
    {
        ...
        internal string XmlUpdateCheck
        {
            get
            {
                return this.updateCheck != UpdateCheck.Always ? this.updateCheck.ToString() : null;
            }
            set
            {
                this.updateCheck =
        ...
        internal string XmlAutoSync
        {
            ...
            set
            {
                this.autoSync =
                    (value != null)
                        ? (AutoSync)Enum.Parse(typeof(AutoSync), value)
                        : AutoSync.Default;
            }
        }
    }
