...
namespace System.ServiceModel.Activities
{
    ...
    [ServiceContract(
        Name = XD2.WorkflowInstanceManagementService.ContractName,
        Namespace = XD2.WorkflowServices.Namespace
    )]
    public interface IWorkflowInstanceManagement
    {
        ...
        [OperationContract(
            Name = XD2.WorkflowInstanceManagementService.Abandon,
            AsyncPattern = true
        )]
        ...
        [Fx.Tag.Throws(
            ...
            "Instance with specified identifier not found or it is supended or locked under transaction"
        )]
        void Cancel(Guid instanceId);

        [OperationContract(
            Name = XD2.WorkflowInstanceManagementService.Cancel,
            AsyncPattern = true
        )]
        ...
        [Fx.Tag.Throws(
            typeof(FaultException),
            "Instance with specified identifier not found or it is locked under transaction"
        )]
        ...
        [OperationContract(
            Name = XD2.WorkflowInstanceManagementService.Suspend,
            AsyncPattern = true
        )]
        [Fx.Tag.InheritThrows(From = "Suspend")]
        IAsyncResult BeginSuspend(
            Guid instanceId,
            string reason,
            AsyncCallback callback,
            object state
        ...
        [OperationContract(
            Name = XD2.WorkflowInstanceManagementService.Terminate,
            AsyncPattern = true
        )]
        ...
        [OperationContract(
            Name = XD2.WorkflowInstanceManagementService.Unsuspend,
            AsyncPattern = true
        )]
        ...
        [OperationContract(
            Name = XD2.WorkflowInstanceManagementService.TransactedCancel,
            AsyncPattern = true
        )]
        ...
        [OperationContract(
            Name = XD2.WorkflowInstanceManagementService.TransactedRun,
            AsyncPattern = true
        )]
        ...
        [OperationContract(
            AsyncPattern = true,
            Name = XD2.WorkflowInstanceManagementService.TransactedSuspend
        )]
        [Fx.Tag.InheritThrows(From = "TransactedSuspend")]
        IAsyncResult BeginTransactedSuspend(
            Guid instanceId,
            string reason,
            AsyncCallback callback,
            object state
        ...
        [OperationContract(
            AsyncPattern = true,
            Name = XD2.WorkflowInstanceManagementService.TransactedTerminate
        )]
        [Fx.Tag.InheritThrows(From = "TransactedTerminate")]
        IAsyncResult BeginTransactedTerminate(
            Guid instanceId,
            string reason,
            AsyncCallback callback,
            object state
        ...
        [Fx.Tag.Throws(
            typeof(FaultException),
            "Instance with specified identifier not found or it is locked under a transaction"
        )]
        void TransactedUnsuspend(Guid instanceId);

        [OperationContract(
            AsyncPattern = true,
            Name = XD2.WorkflowInstanceManagementService.TransactedUnsuspend
        )]
        [Fx.Tag.InheritThrows(From = "TransactedUnsuspend")]
        IAsyncResult BeginTransactedUnsuspend(
            Guid instanceId,
            AsyncCallback callback,
            object state
        );
    ...
    public interface IWorkflowUpdateableInstanceManagement : IWorkflowInstanceManagement
    {
        ...
        [Fx.Tag.Throws(
            typeof(FaultException),
            "Instance not found, locked under transaction, or update unsuccessful"
        )]
        void Update(Guid instanceId, WorkflowIdentity updatedDefinitionIdentity);

        [OperationContract(
            AsyncPattern = true,
            Name = XD2.WorkflowInstanceManagementService.Update
        )]
        ...
        [OperationContract(
            AsyncPattern = true,
            Name = XD2.WorkflowInstanceManagementService.TransactedUpdate
        )]
        [Fx.Tag.InheritThrows(From = "TransactedUpdate")]
        IAsyncResult BeginTransactedUpdate(
            Guid instanceId,
            WorkflowIdentity updatedDefinitionIdentity,
            AsyncCallback callback,
            object state
