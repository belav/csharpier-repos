...
namespace System.ServiceModel.Activities
{
    ...
    static class ChannelCacheDefaults
    {
        ...
        internal static TimeSpan DefaultIdleTimeout = TimeSpan.Parse(
            DefaultIdleTimeoutString,
            CultureInfo.InvariantCulture
        );

        internal const string DefaultMaxItemsPerCacheString = "16";
        internal static int DefaultMaxItemsPerCache = Int32.Parse(
            DefaultMaxItemsPerCacheString,
            CultureInfo.CurrentCulture
        );

        internal const string DefaultLeaseTimeoutString = "00:10:00";
        internal static TimeSpan DefaultLeaseTimeout = TimeSpan.Parse(
            DefaultLeaseTimeoutString,
            CultureInfo.InvariantCulture
        );
        ...
        internal static TimeSpan DefaultChannelLeaseTimeout = TimeSpan.Parse(
