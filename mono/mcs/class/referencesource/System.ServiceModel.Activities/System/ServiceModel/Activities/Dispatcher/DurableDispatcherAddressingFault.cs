...
namespace System.ServiceModel.Activities.Dispatcher
{
    ...
    class DurableDispatcherAddressingFault : MessageFault
    {
        ...
        {
            this.faultCode = FaultCode.CreateSenderFaultCode(
                XD2.ContextHeader.MissingContextHeader,
                XD2.ContextHeader.Namespace
            );
            this.faultReason = new FaultReason(
                new FaultReasonText(
                    SR2.CurrentOperationCannotCreateInstance,
