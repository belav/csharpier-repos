...
namespace System.ServiceModel.Activities
{
    ...
    public abstract class WorkflowHostingEndpoint : ServiceEndpoint
    {
        ...
        protected WorkflowHostingEndpoint(
            Type contractType,
            Binding binding,
            ...
            : base(ContractDescription.GetContract(contractType), binding, address)
        {
            ...
            Fx.Assert(
                !this.Behaviors.Contains(typeof(CorrelationQueryBehavior)),
                "Must not contain correlation query!"
            );
        ...
        internal static FaultException CreateDispatchFaultException()
        {
            ...
            MessageFault dispatchFault = MessageFault.CreateFault(
                code,
                new FaultReason(
                    new FaultReasonText(SR.InternalServerError, CultureInfo.CurrentCulture)
                )
            );
        ...
        class WorkflowHostingContractBehavior : IContractBehavior
        {
            ...
            class WorkflowHostingOperationBehavior : WorkflowOperationBehavior
            {
                ...
                )
                {
                    ...
                    WorkflowHostingResponseContext responseContext =
                        new WorkflowHostingResponseContext(context);
                    Fx.Assert(
