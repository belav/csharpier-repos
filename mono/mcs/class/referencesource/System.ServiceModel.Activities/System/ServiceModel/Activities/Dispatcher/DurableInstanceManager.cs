...
namespace System.ServiceModel.Activities.Dispatcher
{
    ...
    sealed class DurableInstanceManager
    {
        ...
        void SetDefaultOwnerMetadata()
        {
            ...
            VirtualPathExtension virtualPathExtension = this.Host
                .Extensions
                ...
                : base(callback, state)
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        IAsyncResult executeResult = this.instanceManager
                            .InstanceStore
                            .BeginExecute(
                                this.handle,
        ...
        class CloseAsyncResult : AsyncResult
        {
            ...
            bool PerformClose()
            {
                ...
                IEnumerable<PersistenceContext> contexts = this.instanceManager
            ...
            bool PostProcess()
            {
                ...
                if (this.instanceManager.InstanceStore != null)
                {
                    ...
                    this.handle = this.instanceManager
                        .InstanceStore
                        .CreateInstanceHandle(this.instanceManager.owner);
                    try
                    {
                        executeResult = this.instanceManager
                            .InstanceStore
                            .BeginExecute(
                                this.handle,
        ...
        class GetInstanceAsyncResult : TransactedAsyncResult
        {
            ...
            bool GetInstance()
            {
                ...
                if (!this.loadAny && this.parameters.CanCreateInstance)
                {
                    ...
                    {
                        nextResult = this.instanceManager
                            .PersistenceProviderDirectory
                            .BeginLoadOrCreate(
                                this.instanceKey,
                                Guid.Empty,
