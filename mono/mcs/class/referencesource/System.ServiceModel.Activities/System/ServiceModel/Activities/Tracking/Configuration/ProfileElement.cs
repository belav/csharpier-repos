...
namespace System.ServiceModel.Activities.Tracking.Configuration
{
    ...
    public class ProfileElement : TrackingConfigurationElement
    {
        ...
        protected override ConfigurationPropertyCollection Properties
        {
            get
            {
                if (this.properties == null)
                {
                    ...
                    properties.Add(
                        new ConfigurationProperty(
                            TrackingConfigurationStrings.ImplementationVisibility,
                            typeof(System.Activities.Tracking.ImplementationVisibility),
                            System.Activities.Tracking.ImplementationVisibility.RootScope,
                            null,
                            new System.ServiceModel.Activities.Configuration.ServiceModelActivitiesEnumValidator(
                                typeof(System.ServiceModel.Activities.Tracking.Configuration.ImplementationVisibilityHelper)
                            ),
                    ...
                    properties.Add(
                        new ConfigurationProperty(
                            "",
                            typeof(System.ServiceModel.Activities.Tracking.Configuration.ProfileWorkflowElementCollection),
                            null,
                            null,
                            null,
        ...
        public ImplementationVisibility ImplementationVisibility
        {
            get
            {
                return (ImplementationVisibility)
                    base[TrackingConfigurationStrings.ImplementationVisibility];
            }
        ...
        {
            get { return (ProfileWorkflowElementCollection)base[""]; }
        }
    }
}
