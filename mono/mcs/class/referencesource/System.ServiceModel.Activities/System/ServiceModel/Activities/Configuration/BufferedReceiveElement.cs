...
namespace System.ServiceModel.Activities.Configuration
{
    ...
    public sealed class BufferedReceiveElement : BehaviorExtensionElement
    {
        ...
        [ConfigurationProperty(
            MaxPendingMessagesPerChannelString,
            DefaultValue = BufferedReceiveServiceBehavior.DefaultMaxPendingMessagesPerChannel
        )]
        ...
        {
            return new BufferedReceiveServiceBehavior()
            {
                MaxPendingMessagesPerChannel = this.MaxPendingMessagesPerChannel,
            };
        }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage(
            ...
            MessageId = "System.ServiceModel.Activities.Configuration.BufferedReceiveElement.BehaviorType",
                ...
                if (this.properties == null)
                {
                    ...
                    properties.Add(
                        new ConfigurationProperty(
                            MaxPendingMessagesPerChannelString,
                            typeof(Int32),
                            BufferedReceiveServiceBehavior.DefaultMaxPendingMessagesPerChannel,
                            new Int32Converter(),
