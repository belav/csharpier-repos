    ...
    public sealed class ReceiveMessageContent : ReceiveContent
    {
        ...
        )
        {
            ...
            else
            {
                ...
                Fx.Assert(
                    receiveReply != null,
                    "The owner of ReceiveMessageContent can only be Receive or ReceiveReply!"
                );
        ...
        )
        {
            ...
            if (direction == MessageDirection.Input)
            {
                ...
                Fx.Assert(
                    receive != null,
                    "The parent of a ReceiveMessageContent with in-message can only be Receive!"
                );
            ...
            else
            {
                ...
                Fx.Assert(
                    receiveReply != null,
                    "The parent of a ReceiveMessageContent with out-message can only be ReceiveReply!"
                );
                Fx.Assert(
                    receiveReply.Request != null,
                    "ReceiveReply.Request should not be null by now!"
                );
                overridingAction = receiveReply.Action;
                serializerOption = receiveReply.Request.SerializerOption;
