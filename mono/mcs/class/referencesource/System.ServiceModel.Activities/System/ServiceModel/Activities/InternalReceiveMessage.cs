...
namespace System.ServiceModel.Activities
{
    ...
    sealed class InternalReceiveMessage : NativeActivity
    {
        ...
        {
            this.CorrelatesWith = new InArgument<CorrelationHandle>(context =>
            ...
            this.onClientReceiveMessageComplete = new CompletionCallback(
                ClientScheduleOnReceiveMessageCallback
            );
        ...
        // another mechanism.
        internal bool IsReceiveReply { get; set; }
        ...
        internal string OperationBookmarkName
        {
            get
            {
                ...
                {
                    this.operationBookmarkName = BookmarkNameHelper.CreateBookmarkName(
                        this.OperationName,
        ...
        {
            InternalReceiveMessage originalInternalReceive =
                (InternalReceiveMessage)originalActivity;

            if (this.ServiceContractName != originalInternalReceive.ServiceContractName)
            {
                metadata.SaveOriginalValue(
                    ServiceContractNamePropertyName,
                    originalInternalReceive.ServiceContractName
                );
            }
            ...
            if (this.OperationName != originalInternalReceive.OperationName)
            {
                metadata.SaveOriginalValue(
                    ...
                    originalInternalReceive.OperationName
                );
            }
        }
        ...
        protected override void UpdateInstance(NativeActivityUpdateContext updateContext)
        {
            ...
            CorrelationHandle followingCorrelation =
                (this.CorrelatesWith == null)
                    ? null
                    : (CorrelationHandle)updateContext.GetValue(this.CorrelatesWith);
            if (followingCorrelation == null)
            {
                followingCorrelation =
                    updateContext.FindExecutionProperty(
            ...
            string savedOriginalOperationName = (string)
                updateContext.GetSavedOriginalValue(OperationNamePropertyName);
            XName savedOriginalServiceContractName = (XName)
                updateContext.GetSavedOriginalValue(ServiceContractNamePropertyName);
            if (
                (savedOriginalOperationName == null && savedOriginalServiceContractName == null)
                || (
                    savedOriginalOperationName == this.OperationName
                    && savedOriginalServiceContractName == this.ServiceContractName
                )
            )
            {
            ...
            string originalOperationBookmarkName = BookmarkNameHelper.CreateBookmarkName(
                savedOriginalOperationName ?? this.OperationName,
                savedOriginalServiceContractName ?? this.ServiceContractName
            );
            if (updateContext.RemoveBookmark(originalOperationBookmarkName, bookmarkScope))
            {
                ...
                updateContext.CreateBookmark(
                    this.OperationBookmarkName,
                    new BookmarkCallback(this.OnMessage),
                    bookmarkScope
                );
            }
            else
        ...
        ReceiveSettings GetReceiveSettings()
        {
            ...
            else
            {
                ...
                if (
                    this.ServiceContractName != null
                    && !string.IsNullOrWhiteSpace(this.OperationName)
                )
                {
                    actionName = NamingHelper.GetMessageAction(
                        new XmlQualifiedName(this.ServiceContractName.ToString()),
                        this.OperationName,
                        null,
                        false
                    );
        ...
        protected override void Execute(NativeActivityContext executionContext)
        {
            ...
            else
            {
                ...
                CorrelationHandle followingCorrelation =
                    (this.CorrelatesWith == null)
                        ? null
                        : this.CorrelatesWith.Get(executionContext);
                ...
                if (
                    ...
                    && followingCorrelation.TryAcquireRequestContext(
                        executionContext,
                        out requestContext
                    )
                )
                ...
                else
                {
                    ...
                    {
                        CorrelationHandle channelCorrelationHandle =
                    ...
                    BookmarkScope bookmarkScope =
                        (followingCorrelation != null)
                            ? followingCorrelation.EnsureBookmarkScope(executionContext)
                    ...
                    executionContext.CreateBookmark(
                        this.OperationBookmarkName,
                        this.onMessageBookmarkCallback,
                        bookmarkScope
                    );
                }
            }
        ...
        void OnMessage(NativeActivityContext executionContext, Bookmark bookmark, object state)
        {
            ...
            ReceiveMessageInstanceData instance = new ReceiveMessageInstanceData(
                new CorrelationResponseContext { WorkflowOperationContext = workflowContext }
            );
        ...
        )
        {
            ...
            if (workflowContext.CurrentTransaction != null)
            {
                ...
                handle =
                    executionContext.Properties.Find(runtimeTransactionHandlePropertyName)
                ...
                if (handle != null)
                {
                    ...
                    if (transactedReceiveData != null)
                    {
                        ...
                        {
                            Fx.Assert(
                                workflowContext.OperationContext != null,
                                "InternalReceiveMessage.SetupTransaction - Operation Context was null"
                            );
                            Fx.Assert(
                    ...
                    handle.RequireTransactionContext(
                        executionContext,
                        RequireContextCallback,
                        receiveMessageState
                    );
        ...
        void ProcessReceiveMessageTrace(
            NativeActivityContext executionContext,
            ReceiveMessageInstanceData instance
        )
        {
            if (TraceUtility.MessageFlowTracing)
            {
                ...
                {
                    //client side reply
                    receivedActivityId = TraceUtility.GetReceivedActivityId(
                        instance.CorrelationRequestContext.OperationContext
                    );
                }
        ...
        )
        {
            if (TraceUtility.MessageFlowTracing)
            {
                ...
                {
                    //
                    ReceiveMessageRecord messageFlowTrackingRecord = new ReceiveMessageRecord(
                        MessagingActivityHelper.MessageCorrelationReceiveRecord
                    )
                    {
                    ...
                    {
                        TD.WfMessageReceived(
                            new EventTraceActivity(receivedActivityId),
        ...
        void RequireContextCallback(
            NativeActivityTransactionContext transactionContext,
            object state
        )
        {
            ...
            Fx.Assert(
                ...
                "Failed to cast ActivityTransactionContext to NativeActivityContext"
            );
        ...
        void ServerScheduleOnReceivedMessage(
            NativeActivityContext executionContext,
            ReceiveMessageInstanceData instance
        )
        {
            Fx.Assert(
                instance.CorrelationResponseContext != null,
                "Server side receive must have CorrelationResponseContext"
            );

            // if we infer the contract as Message the first input parameter will be the requestMessage from the client
            Message request =
                instance.CorrelationResponseContext.WorkflowOperationContext.Inputs[0] as Message;
            Fx.Assert(
                request != null,
                "WorkflowOperationContext.Inputs[0] must be of type Message"
            );
            Fx.Assert(
                request.State == MessageState.Created,
                "The request message must be in Created state"
            );
            ...
            instance.CorrelationResponseContext.MessageVersion = (
                (Message)instance.CorrelationResponseContext.WorkflowOperationContext.Inputs[0]
            ).Version;
            ...
            CorrelationHandle correlatesWithHandle =
                (this.CorrelatesWith == null) ? null : this.CorrelatesWith.Get(executionContext);
            ...
            else
            {
                ...
                {
                    if (
                        !channelCorrelationHandle.TryRegisterResponseContext(
                            executionContext,
                ...
                else // if that fails, use ambient handle. we should never initialize CorrelatesWith with response context
                {
                    Fx.Assert(
                        ambientHandle != null,
                        "Ambient handle should not be null for two-way server side receive/sendReply"
                    );
                    if (
                        !ambientHandle.TryRegisterResponseContext(
                            executionContext,
                            instance.CorrelationResponseContext
                        )
                    )
                ...
                Fx.Assert(
                    this.NoPersistHandle == null,
                    "NoPersistHandle should be null in case of two-way"
                );
            }
            ...
            if (instance.CorrelationCallbackContext != null)
            {
                ...
                CorrelationHandle callbackHandle = CorrelationHandle.GetExplicitCallbackCorrelation(
                    executionContext,
                    this.correlationInitializers
                );
        ...
        void ClientScheduleOnReceivedMessage(
            NativeActivityContext executionContext,
            ReceiveMessageInstanceData instance
        )
        {
            Fx.Assert(
                instance.CorrelationRequestContext != null,
                "Client side receive must have CorrelationRequestContext"
            );
            ...
            else
            {
                ...
                VolatileReceiveMessageInstance volatileInstance = new VolatileReceiveMessageInstance
                {
                    Instance = instance,
                };
                ...
                {
                    onClientReceiveMessageComplete = new CompletionCallback(
                        ClientScheduleOnReceiveMessageCallback
                    );
                }

                executionContext.ScheduleActivity(
                    this.waitForReply,
                    onClientReceiveMessageComplete
                );
            }
        }

        void ClientScheduleOnReceiveMessageCallback(
            NativeActivityContext executionContext,
        ...
        void ClientScheduleOnReceiveMessageCore(
            NativeActivityContext executionContext,
            ReceiveMessageInstanceData instance
        )
        {
            Fx.Assert(
                instance.CorrelationRequestContext.Reply != null,
                "Reply message cannot be null!"
            );
            ...
            if (instance.CorrelationRequestContext.CorrelationKeyCalculator != null)
            {
                ...
                instance.CorrelationRequestContext.Reply =
                    MessagingActivityHelper.InitializeCorrelationHandles(
                        executionContext,
                        null,
                        ambientHandle,
                        this.correlationInitializers,
                        instance.CorrelationRequestContext.CorrelationKeyCalculator,
                        instance.CorrelationRequestContext.Reply
                    );
            }
            ...
            if (instance.CorrelationContext != null)
            {
                ...
                CorrelationHandle contextHandle = CorrelationHandle.GetExplicitContextCorrelation(
                    executionContext,
                    this.correlationInitializers
                );
        ...
        void FinalizeScheduleOnReceivedMessage(
            NativeActivityContext executionContext,
            ReceiveMessageInstanceData instance
        )
        {
            ...
            IList<IReceiveMessageCallback> receiveMessageCallbacks =
                MessagingActivityHelper.GetCallbacks<IReceiveMessageCallback>(
        ...
        protected override void CacheMetadata(NativeActivityMetadata metadata)
        {
            ...
            RuntimeArgument receiveMessageArgument = new RuntimeArgument(
                Constants.Message,
        ...
        void FinalizeReceiveMessageCore(
            NativeActivityContext executionContext,
            ReceiveMessageInstanceData instance
        )
        {
        ...
        void ResetTrace(NativeActivityContext executionContext, Guid ambientActivityId)
        {
            ...
            {
                TD.WfMessageReceived(
                    new EventTraceActivity(executionContext.WorkflowInstanceId),
                    ambientActivityId
                );
            }
        }
        ...
        {
            Fx.Assert(
                sendReceiveExtension != null,
                "SendReceiveExtension should be available here."
            );
            ...
            sendReceiveExtension.RegisterReceive(
                this.GetReceiveSettings(),
                correlatesWithValue,
                bookmark
            );
        }

        void OnReceiveMessageFromExtension(
            NativeActivityContext executionContext,
            Bookmark bookmark,
            object state
        )
        {
            ...
            this.InitializeCorrelationHandles(
                executionContext,
                messageContext.Message.Properties,
                messageContext.EndToEndTracingId
            );
        ...
        {
            CorrelationHandle ambientHandle = CorrelationHandle.GetAmbientCorrelation(
                executionContext
            );
            HostSettings hostSettings = executionContext
                .GetExtension<SendReceiveExtension>()
                .HostSettings;
            ...
            if (this.IsReceiveReply)
            {
                ...
                if (
                    this.TryGetContextCorrelationInstanceKey(
                        hostSettings,
                        messageProperties,
                        out contextCorrelationInstanceKey
                    )
                )
                {
            ...
            else
            {
                ...
                CorrelationHandle requestReplyHandle =
                    CorrelationHandle.GetExplicitRequestReplyCorrelation(
                        executionContext,
                        this.correlationInitializers
                    );
                ...
                if (!this.IsOneWay)
                {
                    ...
                    if (
                        this.TryGetRequestReplyCorrelationInstanceKey(
                            messageProperties,
                            out requestReplyCorrelationInstanceKey
                        )
                    )
                    {
                        MessagingActivityHelper.InitializeCorrelationHandles(
                ...
                if (
                    this.TryGetCallbackContextCorrelationInstanceKey(
                        hostSettings,
                        messageProperties,
                        out callbackContextCorrelationInstanceKey
                    )
                )
                {
                    CorrelationHandle callbackContextCorrelationHandle =
        ...
        void UpdateE2ETracingId(
            Guid e2eTracingId,
            CorrelationHandle correlatesWith,
            CorrelationHandle ambientHandle,
            CorrelationHandle requestReplyHandle
        )
        {
        ...
        bool TryGetCallbackContextCorrelationInstanceKey(
            HostSettings hostSettings,
            MessageProperties messageProperties,
            out InstanceKey callbackContextCorrelationInstanceKey
        )
        {
            ...
            if (CallbackContextMessageProperty.TryGet(messageProperties, out callbackContext))
            {
                if (callbackContext.Context != null)
                {
                    ...
                    if (callbackContext.Context.TryGetValue(InstanceIdKey, out instanceId))
                    {
                        ...
                        callbackContextCorrelationInstanceKey = new CorrelationKey(
                            keyData,
                            hostSettings.ScopeName,
                            null
                        );
                    }
                }
        ...
        bool TryGetContextCorrelationInstanceKey(
            HostSettings hostSettings,
            MessageProperties messageProperties,
            out InstanceKey correlationContextInstanceKey
        )
        {
            ...
            if (ContextMessageProperty.TryGet(messageProperties, out contextProperties))
            {
                if (contextProperties.Context != null)
                {
                    ...
                    if (contextProperties.Context.TryGetValue(InstanceIdKey, out instanceId))
                    {
                        ...
                        correlationContextInstanceKey = new CorrelationKey(
                            keyData,
                            hostSettings.ScopeName,
                            null
                        );
        ...
        )
        {
            ...
            if (
                messageProperties.TryGetValue<CorrelationMessageProperty>(
        ...
        internal class ReceiveMessageInstanceData
        {
            ...
            public CorrelationRequestContext CorrelationRequestContext { get; private set; }

            // For the server-receive case. The context that will be used to by the following send.
            public CorrelationResponseContext CorrelationResponseContext { get; private set; }

            public CorrelationCallbackContext CorrelationCallbackContext { get; private set; }

            public CorrelationContext CorrelationContext { get; private set; }
            ...
            {
                Fx.Assert(
                    this.CorrelationRequestContext.Reply != null,
                    "Reply message cannot be null for context and callback!"
                );
                ...
                this.CorrelationContext = MessagingActivityHelper.CreateCorrelationContext(
                    this.CorrelationRequestContext.Reply.Properties
                );
            }
        }
        ...
        class WaitForReply : AsyncCodeActivity
        {
            ...
            public InArgument<VolatileReceiveMessageInstance> Instance { get; set; }

            protected override void CacheMetadata(CodeActivityMetadata metadata)
            {
                RuntimeArgument instanceArgument = new RuntimeArgument(
                    "Instance",
                    typeof(VolatileReceiveMessageInstance),
                    ArgumentDirection.In
                );
            ...
            class WaitForReplyAsyncResult : AsyncResult
            {
                ...
                public WaitForReplyAsyncResult(
                    ReceiveMessageInstanceData instance,
                    AsyncCallback callback,
                    object state
                )
