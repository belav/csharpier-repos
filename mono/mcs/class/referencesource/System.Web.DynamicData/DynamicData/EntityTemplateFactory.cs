...
namespace System.Web.DynamicData
{
    public class EntityTemplateFactory
    {
        ...
        public EntityTemplateFactory()
            : this(
                CreateEntityTemplateInstance, /* trackChanges */
                true
            ) { }

        // for unit testing
        internal EntityTemplateFactory(
            Func<string, EntityTemplateUserControl> templateInstantiator,
            VirtualPathProvider vpp
        )
            : this(
                templateInstantiator, /* trackChanges */
                false
            )
        {
        ...
        {
            get { return _factory.TemplateFolderVirtualPath; }
            set { _factory.TemplateFolderVirtualPath = value; }
        }

        private static EntityTemplateUserControl CreateEntityTemplateInstance(string path)
        {
            return (EntityTemplateUserControl)
                BuildManager.CreateInstanceFromVirtualPath(path, typeof(EntityTemplateUserControl));
        }

        public virtual EntityTemplateUserControl CreateEntityTemplate(
            MetaTable table,
        ...
        )
        {
            ...
            string entityTemplatePath = GetEntityTemplateVirtualPathWithCaching(
                table,
                mode,
                uiHint
            );
        ...
        private string GetEntityTemplateVirtualPathWithCaching(
            MetaTable table,
            DataBoundControlMode mode,
            string uiHint
        )
        {
            ...
            return _factory.GetTemplatePath(
                cacheKey,
                delegate()
                {
        ...
        public virtual string GetEntityTemplateVirtualPath(
            MetaTable table,
            DataBoundControlMode mode,
            string uiHint
        )
        ...
        private string GetVirtualPathFallback(
            MetaTable table,
            DataBoundControlMode mode,
            string uiHint,
            DataBoundControlMode minModeToFallBack
        )
        {
        ...
        public virtual string BuildEntityTemplateVirtualPath(
            string templateName,
            DataBoundControlMode mode
        )
        {
            ...
            string modeString =
                mode == DataBoundControlMode.ReadOnly ? String.Empty : "_" + mode.ToString();
