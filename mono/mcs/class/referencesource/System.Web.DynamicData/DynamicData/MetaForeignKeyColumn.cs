...
namespace System.Web.DynamicData
{
    ...
    public class MetaForeignKeyColumn : MetaColumn, IMetaForeignKeyColumn
    {
        ...
        internal protected override void Initialize()
        {
            ...
            CreateForeignKeyFilterMapping(
                ForeignKeyNames,
                ParentTable.PrimaryKeyNames,
                (foreignKey) => Table.EntityType.GetProperty(foreignKey) != null
            );
        }

        internal void CreateForeignKeyFilterMapping(
            IList<string> foreignKeyNames,
            IList<string> primaryKeyNames,
            Func<string, bool> propertyExists
        )
        {
        ...
        {
            get { return Provider.Association.IsPrimaryKeyInThisTable; }
        }
...
/*protected*/internal override bool ScaffoldNoCache
        ...
        public string GetFilterExpression(string foreignKeyName)
        {
            ...
            if (
                _foreignKeyFilterMapping == null
                || !_foreignKeyFilterMapping.TryGetValue(foreignKeyName, out mappedforeignKey)
            )
            {
        ...
        {
            get { return Provider.Association.ForeignKeyNames; }
        }
