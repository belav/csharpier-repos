...
namespace System.Web.DynamicData
{
    public class DynamicFilter : Control, IFilterExpressionProvider
    {
        ...
        /// </summary>
        [Category("Data"), DefaultValue(""), ResourceDescription("DynamicFilter_DataField")]
        ...
        /// </summary>
        [Category("Behavior"), DefaultValue(""), ResourceDescription("DynamicFilter_FilterUIHint")]
        public string FilterUIHint
        {
            ...
            set { ViewState["FilterUIHint"] = value; }
        }
        ...
        // internal for unit testing
        internal static QueryableFilterUserControl CreateUserControl(
            MetaColumn column,
            string filterUiHint
        )
        {
