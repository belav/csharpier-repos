namespace System.Web.DynamicData
{
    ...
    public class DynamicDataManager : Control
    {
        ...
        private Dictionary<IDynamicDataSource, object> _dataSources =
            new Dictionary<IDynamicDataSource, object>();
        ...
        )
        {
            ...
            if (dataSource.ContextType == null)
            {
                ...
                {
                    linqDataSource.ContextCreating += delegate(
                        object sender,
                ...
                {
                    entityDataSource.ContextCreating += delegate(
                        object sender,
        ...
        {
            return (control as IControlParameterTarget)
                ?? new DataBoundControlParameterTarget(control);
        }
    }
}
