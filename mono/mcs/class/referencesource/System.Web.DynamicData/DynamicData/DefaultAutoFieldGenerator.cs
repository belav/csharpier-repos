namespace System.Web.DynamicData
{
    ...
    public class DefaultAutoFieldGenerator : IAutoFieldGenerator
    {
        ...
        protected virtual DynamicField CreateField(
            MetaColumn column,
        ...
        {
            string headerText = (
                containerType == ContainerType.List ? column.ShortDisplayName : column.DisplayName
            );

            var field = new DynamicField() { DataField = column.Name, HeaderText = headerText };
