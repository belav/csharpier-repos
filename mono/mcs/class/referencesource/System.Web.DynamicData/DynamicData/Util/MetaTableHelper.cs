namespace System.Web.DynamicData.Util
{
    ...
    internal static class MetaTableHelper
    {
        ...
        {
            Dictionary<object, MappingInfo> mapping =
                httpContext.Items[s_mappingKey] as Dictionary<object, MappingInfo>;
            if (mapping == null)
            {
        ...
        internal static void SetTableInMapping(
        ...
        internal static MetaTable GetTableFromDynamicDataSource(
        ...
        internal static DefaultValueMapping GetDefaultValueMapping(
            Control current,
            HttpContextBase context
        )
        {
        ...
        internal static MetaTable FindMetaTable(Control current, HttpContextBase context)
        {
            ...
            for (; current != null; current = current.NamingContainer)
            {
                ...
                IDataBoundControlInterface dataBoundControl = DataControlHelper.GetDataBoundControl(
                    current,
