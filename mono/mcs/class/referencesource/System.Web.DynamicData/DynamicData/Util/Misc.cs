...
namespace System.Web.DynamicData
{
    internal static class Misc
    {
        ...
        public static object ChangeType(object value, Type type)
        {
            ...
            throw new InvalidOperationException(
                String.Format(
                    ...
                    DynamicDataResources.Misc_CannotConvertType,
                    value.GetType(),
                    type
                )
            );
        ...
        public static IOrderedDictionary GetEnumNamesAndValues(Type enumType)
        {
            ...
            var enumEntries =
                from e in Enum.GetValues(enumType).OfType<object>()
        ...
        public static IQueryable BuildSortQueryable(IQueryable query, IMetaTable table)
        {
            ...
            if (sortColumn.IsCustomProperty)
            {
                ...
                Func<object, object> lambda = row =>
                    DataBinder.GetPropertyValue(row, sortColumn.Name);
            ...
            else
            {
                ...
                if (foreignKeyColumn != null)
                {
                    ...
                    lambda = Expression.Lambda(
                        Expression.Property(
                            Expression.Property(parameter, sortColumn.Name),
                            foreignKeySortColumn.Name
                        ),
                        parameter
                    );
                }
        ...
        {
            RequestContext requestContext = DynamicDataRouteHandler.GetRequestContext(
                HttpContext.Current
            );
            object value;
