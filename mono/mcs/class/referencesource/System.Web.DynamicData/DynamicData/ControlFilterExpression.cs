...
namespace System.Web.DynamicData
{
    ...
    public class ControlFilterExpression : DataSourceExpression
    {
        ...
        [SuppressMessage(
            ...
            MessageId = "ID",
            Justification = "The property refers to the ID property of a Control"
        )]
        ...
        private IEnumerable<Parameter> GetPrimaryKeyControlParameters(
            Control control,
            MetaTable table
        )
        {
        ...
        private IEnumerable<Parameter> GetForeignKeyControlParameters(
            Control control,
        ...
        )
        {
            ...
            Dictionary<string, MetaColumn> nameColumnMapping = CreateColumnMapping(
                column,
                otherTable.PrimaryKeyColumns
            );
            return GetControlParameters(control, nameColumnMapping);
        }
        ...
        internal static IEnumerable<Parameter> GetControlParameters(
            Control control,
            IDictionary<string, MetaColumn> nameColumnMapping
        )
        {
