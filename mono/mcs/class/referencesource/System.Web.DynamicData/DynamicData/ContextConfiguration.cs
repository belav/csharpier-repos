...
namespace System.Web.DynamicData
{
    ...
    public class ContextConfiguration
    {
        ...
        [SuppressMessage(
            ...
            Justification = "This can be set by the user to support inline dictionary intializers"
        )]
        public ContextConfiguration()
        {
            MetadataProviderFactory = type => new AssociatedMetadataTypeTypeDescriptionProvider(
                type
            );
        }
    }
