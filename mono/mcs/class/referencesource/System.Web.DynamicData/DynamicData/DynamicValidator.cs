namespace System.Web.DynamicData
{
    ...
    public class DynamicValidator : BaseValidator
    {
        ...
        {
            get { return (Column == null) ? String.Empty : Column.Name; }
        }
        ...
        protected override bool EvaluateIsValid()
        {
            ...
            {
                ErrorMessage = HttpUtility.HtmlEncode(
                    DynamicDataResources.DynamicValidator_CannotConvertValue
                );
                return false;
            }
        ...
        internal static bool TryConvertControlValue(
            string controlValue,
            Type columnType,
            out object value
        )
        ...
        private bool ValueIsValid(object value)
        {
            ...
            foreach (
                var attrib in Column.Attributes.Cast<Attribute>().OfType<ValidationAttribute>()
            )
            {
                // Ignore it if it's found in the ignore list
                if (
                    _ignoredModelValidationAttributes != null
                ...
                {
                    ErrorMessage = HttpUtility.HtmlEncode(
                        StringLocalizerUtil.GetLocalizedString(attrib, Column.DisplayName)
                    );
                    return false;
                }
            }
        ...
        internal void SetIgnoredModelValidationAttributes(
            Dictionary<Type, bool> ignoredModelValidationAttributes
        )
        {
