...
namespace System.Web.DynamicData
{
    ...
    public class DynamicDataRouteHandler : IRouteHandler
    {
        ...
        {
            get { return _context ?? new HttpContextWrapper(System.Web.HttpContext.Current); }
            set { _context = value; }
        }
        ...
        private Dictionary<long, string> GetVirtualPathCache()
        {
            ...
            Dictionary<long, string> virtualPathCache =
                (Dictionary<long, string>)httpContext.Items[_requestItemsKey];
