namespace System.Web.DynamicData
{
            ...
            IFieldFormattingOptions
    {
        ...
        internal Control CreateControl()
        {
            ...
            FieldTemplate = (Control)
                IMetaColumn.Model.FieldTemplateFactory.CreateFieldTemplate(Column, Mode, UIHint);
            if (FieldTemplate != null)
            {
                ...
                if (_attributes != null)
                {
                    ...
                    foreach (var entry in _attributes)
                    {
                        ...
                        var propInfo = ucType.GetProperty(
                            entry.Key,
                        ...
                        if (propInfo != null)
                        {
                            ...
                            var value = PropertyConverter.ObjectFromString(
            ...
            if (IMetaColumn == null)
            {
                if (String.IsNullOrEmpty(DataField))
                {
                    throw new InvalidOperationException(
                        String.Format(
                            CultureInfo.CurrentCulture,
                            DynamicDataResources.DynamicControl_ControlMustHaveDateFieldAttribute,
                            GetType().Name,
                            ID
                        )
                    );
