    ...
    public static class DynamicDataExtensions
    {
        ...
        )
        {
            ...
            SetMetaTableInternal(
                control,
                table,
                Misc.ConvertObjectToDictionary(defaultValues),
                new HttpContextWrapper(HttpContext.Current)
            );
        }
        ...
        internal static void ApplyFieldGenerator(INamingContainer control, MetaTable table)
        {
            ...
            if (
                ...
                && gridView.ColumnsGenerator == null
            )
            {
        ...
        internal static IDictionary<string, object> GetDefaultValues(
            object control,
            HttpContextBase context
        )
        {
        ...
        internal static MetaTable GetMetaTable(IDataSource dataSource, HttpContextBase context)
        {
            ...
            throw new InvalidOperationException(
                String.Format(
                    ...
                    DynamicDataResources.MetaTable_CannotGetTableFromDataSource
                )
            );
        }
        ...
        internal static MetaTable GetMetaTable(INamingContainer control, HttpContextBase context)
        {
            ...
            if (!TryGetMetaTable(control, context, out table))
            {
                throw new InvalidOperationException(
                    String.Format(
                        CultureInfo.CurrentCulture,
                        DynamicDataResources.MetaTable_CannotGetTableFromControl
                    )
                );
            }
            return table;
        ...
        [SuppressMessage(
            ...
            Justification = "This is a legacy API and cannot be changed"
        )]
        ...
        public static void LoadWithForeignKeys(this LinqDataSource dataSource, Type rowType)
        {
            dataSource.ContextCreated += delegate(object sender, LinqDataSourceStatusEventArgs e)
            {
                ...
                foreach (
                    System.Data.Linq.Mapping.MetaDataMember member in metaTable.RowType.DataMembers
                )
                {
        ...
        /// </summary>
        public static string FormatEditValue(
            this IFieldFormattingOptions formattingOptions,
            object fieldValue
        )
        {
        ...
        [SuppressMessage(
            "Microsoft.Design",
            "CA1011:ConsiderPassingBaseTypesAsParameters",
            Justification = "The interface is internal"
        )]
