...
namespace System.Web.DynamicData
{
    ...
    public class MetaColumn : IFieldFormattingOptions, IMetaColumn
    {
        ...
        {
            get { return Metadata.DataTypeAttribute; }
        }
        ...
        {
            get { return Metadata.DefaultValue; }
        }
        ...
        {
            get { return Metadata.FilterUIHint; }
        }
        ...
        {
            get { return ColumnType == typeof(byte[]); }
        }
        ...
        public bool IsFloatingPoint
        {
            get
            {
                return ColumnType == typeof(float)
        ...
        {
            get { return IsString && Provider.MaxLength >= s_longStringLengthCutoff; }
        }
        ...
        public bool AllowInitialValue
        {
            get
            {
                ...
                return Metadata.EditableAttribute.GetPropertyValue(
        ...
        {
            get { return Metadata.RequiredAttribute != null; }
        }
        ...
        {
            get { return ColumnType == typeof(string); }
        }
        ...
        public int MaxLength
        {
            get
            {
                ...
                return stringLengthAttribute != null
        ...
        public string RequiredErrorMessage
        {
            get
            {
                ...
                return requiredAttribute != null
                    ? StringLocalizerUtil.GetLocalizedString(requiredAttribute, DisplayName)
                    : String.Empty;
            }
        }
        ...
        public virtual bool Scaffold
        {
            ...
            set { _scaffoldValueManual = value; }
        }
        ...
        internal virtual bool ScaffoldNoCache
        {
            get
            {
                ...
                // Include enums
                Type enumType;
                if (this.IsEnumType(out enumType))
                    return true;

                //Include spatial types
                if (ColumnType == typeof(DbGeography))
                    return true;
                if (ColumnType == typeof(DbGeometry))
                    return true;
        ...
        {
            get { return Provider.IsSortable ? Name : string.Empty; }
        }
        ...
        {
            get { return Metadata.ApplyFormatInEditMode; }
        }
        ...
        {
            get { return Metadata.DataFormatString; }
        }
        ...
        {
            get { return Metadata.HtmlEncode; }
        }
        ...
        internal class MetaColumnMetadata : IMetaColumnMetadata
        {
            ...
            public MetaColumnMetadata(MetaColumn column)
            {
                ...
                DataTypeAttribute =
                    Attributes.FirstOrDefault<DataTypeAttribute>() ?? GetDefaultDataTypeAttribute();
                ...
                FilterUIHint = GetHint<FilterUIHintAttribute>(
                    a => a.PresentationLayer,
                    a => a.FilterUIHint
                );

                EditableAttribute = Attributes.FirstOrDefault<EditableAttribute>();
                IsReadOnly = Attributes.GetAttributePropertyValue<ReadOnlyAttribute, bool>(
                    a => a.IsReadOnly,
                    false
                );
                ...
                ConvertEmptyStringToNull = displayFormatAttribute.GetPropertyValue(
                    a => a.ConvertEmptyStringToNull,
                    true
                );
                DataFormatString = displayFormatAttribute.GetPropertyValue(
                    a => a.DataFormatString,
                    String.Empty
                );
                NullDisplayText = displayFormatAttribute.GetPropertyValue(
                    a => a.NullDisplayText,
                    String.Empty
                );
            ...
            public object DefaultValue
            {
                get { return DefaultValueAttribute.GetPropertyValue(a => a.Value, null); }
            }
            ...
            {
                get { return DisplayAttribute.GetLocalizedShortName(); }
            }
            ...
            {
                get { return DisplayAttribute.GetLocalizedPrompt(); }
            }
            ...
            private string GetHint<T>(
                Func<T, string> presentationLayerPropertyAccessor,
                Func<T, string> hintPropertyAccessor
            )
                where T : Attribute
            {
                var uiHints = Attributes.OfType<T>();
                var presentationLayerNotSpecified = uiHints.Where(a =>
                    String.IsNullOrEmpty(presentationLayerPropertyAccessor(a))
                );
                var presentationLayerSpecified = uiHints.Where(a =>
                    !String.IsNullOrEmpty(presentationLayerPropertyAccessor(a))
                );

                T uiHintAttribute =
                    presentationLayerSpecified.FirstOrDefault(a =>
                        presentationLayerPropertyAccessor(a).ToLower(CultureInfo.InvariantCulture)
                            == "webforms"
