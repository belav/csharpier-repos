...
namespace System.Web.DynamicData.ModelProviders
{
    ...
    {
        private static Regex s_varCharRegEx = new Regex(
            @"N?(?:Var)?Char\(([0-9]+)\)",
            RegexOptions.IgnoreCase
        ); // accepts char, nchar, varchar, and nvarchar
        ...
        internal static int ProcessMaxLength(Type memberType, String dbType)
        {
            ...
            if (
                ...
                || (
                    ...
                    && Misc.RemoveNullableFromType(memberType) != typeof(char)
                )
            )
                return 0;
        ...
        {
            set { base.IsForeignKeyComponent = value; }
        }
