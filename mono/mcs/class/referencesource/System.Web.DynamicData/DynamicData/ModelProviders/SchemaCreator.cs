...
namespace System.Web.DynamicData.ModelProviders
{
    internal class SchemaCreator
    {
        ...
        public virtual DataModelProvider CreateDataModel(
            object contextInstance,
            Func<object> contextFactory
        )
        {
            ...
            throw new InvalidOperationException(
                String.Format(
                    ...
                    DynamicDataResources.SchemaCreator_UnknownModel,
                    contextInstance.GetType().FullName
                )
            );
        }
        ...
        private static bool IsValidType<T>(Type contextType)
            where T : class
        {
