...
namespace System.Web.DynamicData
{
    ...
    public class FilterUserControlBase : UserControl, IControlParameterTarget
    {
        ...
        {
            get { return FilterDelegate.InitialValue; }
        }
        ...
        {
            get { return _isPostBackMock ?? base.IsPostBack; }
            set { _isPostBackMock = value; }
        }
        ...
        MetaTable IControlParameterTarget.Table
        {
            ...
            {
                EnsureInit();
                ForeignKeyFilterDelegate foreignKeyDelegate =
                    FilterDelegate as ForeignKeyFilterDelegate;
        ...
        private abstract class FilterDelegateBase
        {
            ...
            protected FilterUserControlBase FilterUserControl { get; private set; }
