...
[module: SuppressMessage(
    ...
    Scope = "member",
    Target = "System.Xml.Linq.Res.#GetObject(System.String)",
    Justification = "Build generated code."
)]
[module: SuppressMessage(
    "Microsoft.Performance",
    "CA1811:AvoidUncalledPrivateCode",
    Scope = "member",
    Target = "System.Xml.Linq.Res.#get_Resources()",
    Justification = "Build generated code."
)]
...
namespace System.Xml.Linq
{
    ...
    [SuppressMessage(
        ...
        Justification = "Deserialization handled by NameSerializer."
    )]
        ...
        public static XName Get(string expandedName)
        {
            ...
            if (expandedName.Length == 0)
                throw new ArgumentException(
                    Res.GetString(Res.Argument_InvalidExpandedName, expandedName)
                );
            if (expandedName[0] == '{')
            {
    ...
    public sealed class XNamespace
    {
        ...
        {
            get { return EnsureNamespace(ref refNone, string.Empty); }
        }
        ...
        {
            get { return EnsureNamespace(ref refXml, xmlPrefixNamespace); }
        }
        ...
        {
            get { return EnsureNamespace(ref refXmlns, xmlnsPrefixNamespace); }
        }
        ...
        [SuppressMessage(
            ...
            Justification = "Functionality available via XNamespace.Get()."
        )]
        ...
        internal static XNamespace Get(string namespaceName, int index, int count)
        {
            ...
            if (namespaces == null)
                Interlocked.CompareExchange(
                    ref namespaces,
                    new XHashtable<WeakReference>(ExtractNamespace, NamespacesCapacity),
                    null
                );
            ...
            do
            {
                ...
                if (!namespaces.TryGetValue(namespaceName, index, count, out refNamespace))
                {
                    ...
                    refNamespace = namespaces.Add(
                        new WeakReference(new XNamespace(namespaceName.Substring(index, count)))
                    );
                }
        ...
        private static XNamespace EnsureNamespace(ref WeakReference refNmsp, string namespaceName)
        {
            ...
            while (true)
            {
                ...
                Interlocked.CompareExchange(
                    ref refNmsp,
                    new WeakReference(new XNamespace(namespaceName)),
                    refOld
                );
            }
        }
    ...
    public abstract class XObject : IXmlLineInfo
    {
        ...
        [SuppressMessage(
            ...
            Justification = "Back-compat with System.Xml."
        )]
    ...
    public class XObjectChangeEventArgs : EventArgs
    {
        ...
        [SuppressMessage(
            ...
            Justification = "XObjectChangeEventArgs is in fact immutable."
        )]
    ...
    public abstract class XNode : XObject
    {
        ...
        public void AddAfterSelf(object content)
        {
            if (parent == null)
                throw new InvalidOperationException(
                    Res.GetString(Res.InvalidOperation_MissingParent)
                );
        ...
        public static int CompareDocumentOrder(XNode n1, XNode n2)
        {
            ...
            if (n1.parent != n2.parent)
            {
                ...
                if (p1 != p2)
                    throw new InvalidOperationException(
                        Res.GetString(Res.InvalidOperation_MissingAncestor)
                    );
                if (height < 0)
                {
                    do
        ...
        public static XNode ReadFrom(XmlReader reader)
        {
            ...
            if (reader.ReadState != ReadState.Interactive)
                throw new InvalidOperationException(
                    Res.GetString(Res.InvalidOperation_ExpectedInteractive)
                );
            switch (reader.NodeType)
            {
                ...
                default:
                    throw new InvalidOperationException(
                        Res.GetString(Res.InvalidOperation_UnexpectedNodeType, reader.NodeType)
                    );
            }
        }
        ...
        public void ReplaceWith(object content)
        {
            ...
            if (p != null && p.parent != c)
                throw new InvalidOperationException(
                    Res.GetString(Res.InvalidOperation_ExternalCode)
                );
            ...
            IComparer<XNode>
    {
        ...
        int IComparer.Compare(object x, object y)
        {
            ...
            if (n1 == null && x != null)
                throw new ArgumentException(
                    Res.GetString(Res.Argument_MustBeDerivedFrom, typeof(XNode)),
                    "x"
                );
            XNode n2 = y as XNode;
            if (n2 == null && y != null)
    ...
    public abstract class XContainer : XNode
    {
        ...
        internal static string GetStringValue(object value)
        {
            ...
            if (s == null)
                throw new ArgumentException(Res.GetString(Res.Argument_ConvertToString));
            return s;
        }
                ...
                switch (r.NodeType)
                {
                    ...
                    case XmlNodeType.EntityReference:
                        if (!r.CanResolveEntity)
                            throw new InvalidOperationException(
                                Res.GetString(Res.InvalidOperation_UnresolvedEntityReference)
                            );
                        r.ResolveEntity();
                        break;
                    ...
                    default:
                        throw new InvalidOperationException(
                            Res.GetString(Res.InvalidOperation_UnexpectedNodeType, r.NodeType)
                        );
                }
            } while (r.Read());
        }
            ...
            do
            {
                ...
                switch (r.NodeType)
                {
                    ...
                    case XmlNodeType.EndElement:
                    {
                        ...
                        Debug.Assert(
                            e != null,
                            "EndElement recieved but the current container is not an element."
                        );
                    ...
                    case XmlNodeType.SignificantWhitespace:
                    case XmlNodeType.Whitespace:
                        if ((baseUri != null && baseUri != uri) || (li != null && li.HasLineInfo()))
                        {
                            n = new XText(r.Value);
                        }
                        else
    ...
    internal struct NamespaceCache
    {
        ...
        {
            if ((object)namespaceName == (object)this.namespaceName)
                return this.ns;
            this.namespaceName = namespaceName;
    ...
    [System.ComponentModel.TypeDescriptionProvider(
        typeof(MS.Internal.Xml.Linq.ComponentModel.XTypeDescriptionProvider<XElement>)
    )]
#endif // !SILVERLIGHT
    public class XElement : XContainer, IXmlSerializable
    {
        ...
        public XNamespace GetNamespaceOfPrefix(string prefix)
        {
            ...
            if (prefix.Length == 0)
                throw new ArgumentException(Res.GetString(Res.Argument_InvalidPrefix, prefix));
            if (prefix == "xmlns")
        ...
        public static XElement Load(XmlReader reader, LoadOptions options)
        {
            ...
            if (reader.MoveToContent() != XmlNodeType.Element)
                throw new InvalidOperationException(
                    Res.GetString(
                        Res.InvalidOperation_ExpectedNodeType,
                        XmlNodeType.Element,
                        reader.NodeType
                    )
                );
            ...
            if (!reader.EOF)
                throw new InvalidOperationException(
                    Res.GetString(Res.InvalidOperation_ExpectedEndOfFile)
                );
            return e;
        }
        ...
        [SuppressMessage(
            "Microsoft.Usage",
            "CA2225:OperatorOverloadsHaveNamedAlternates",
            Justification = "Operator marked with CLSCompliant(false)."
        )]
        ...
        void IXmlSerializable.ReadXml(XmlReader reader)
        {
            ...
            if (parent != null || annotations != null || content != null || lastAttr != null)
                throw new InvalidOperationException(
                    Res.GetString(Res.InvalidOperation_DeserializeInstance)
                );
            if (reader.MoveToContent() != XmlNodeType.Element)
                throw new InvalidOperationException(
                    Res.GetString(
        ...
        internal override void AddAttribute(XAttribute a)
        {
            if (Attribute(a.Name) != null)
                throw new InvalidOperationException(
                    Res.GetString(Res.InvalidOperation_DuplicateAttribute)
                );
            if (a.parent != null)
                a = new XAttribute(a);
            AppendAttribute(a);
        ...
        internal override void ValidateNode(XNode node, XNode previous)
        {
            if (node is XDocument)
                throw new ArgumentException(
                    Res.GetString(Res.Argument_AddNode, XmlNodeType.Document)
                );
            if (node is XDocumentType)
                throw new ArgumentException(
                    Res.GetString(Res.Argument_AddNode, XmlNodeType.DocumentType)
                );
        }
    }
    ...
    internal struct NamespaceResolver
    {
        ...
        public string GetPrefixOfNamespace(XNamespace ns, bool allowDefaultNamespace)
        {
            if (
                rover != null
                && rover.ns == ns
                && (allowDefaultNamespace || rover.prefix.Length > 0)
            )
                return rover.prefix;
            NamespaceDeclaration d = declaration;
            if (d != null)
    ...
    public class XDocument : XContainer
    {
        ...
        public static XDocument Load(XmlReader reader, LoadOptions options)
        {
            ...
            if (d.Root == null)
                throw new InvalidOperationException(
                    Res.GetString(Res.InvalidOperation_MissingRoot)
                );
            return d;
        }
        ...
        internal override void ValidateNode(XNode node, XNode previous)
        {
            switch (node.NodeType)
            {
                ...
                case XmlNodeType.CDATA:
                    throw new ArgumentException(
                        Res.GetString(Res.Argument_AddNode, XmlNodeType.CDATA)
                    );
            ...
            if (n != null)
            {
                ...
                do
                {
                    ...
                    if (nt == XmlNodeType.Element || nt == XmlNodeType.DocumentType)
                    {
                        if (nt != allowBefore)
                            throw new InvalidOperationException(
                                Res.GetString(Res.InvalidOperation_DocumentStructure)
                            );
        ...
        {
            if (!IsWhitespace(s))
                throw new ArgumentException(Res.GetString(Res.Argument_AddNonWhitespace));
        }
    }
    ...
    public class XProcessingInstruction : XNode
    {
        ...
        static void ValidateName(string name)
        {
            ...
            if (string.Compare(name, "xml", StringComparison.OrdinalIgnoreCase) == 0)
                throw new ArgumentException(Res.GetString(Res.Argument_InvalidPIName, name));
        }
    }
...
#if !SILVERLIGHT
    [System.ComponentModel.TypeDescriptionProvider(
        typeof(MS.Internal.Xml.Linq.ComponentModel.XTypeDescriptionProvider<XAttribute>)
    )]
#endif
    [SuppressMessage(
        "Microsoft.Naming",
        ...
        static void ValidateAttribute(XName name, string value)
        {
            ...
            if ((object)namespaceName == (object)XNamespace.xmlnsPrefixNamespace)
            {
                if (value.Length == 0)
                {
                    ...
                    throw new ArgumentException(
                        Res.GetString(Res.Argument_NamespaceDeclarationPrefixed, name.LocalName)
                    );
                }
                else if (value == XNamespace.xmlPrefixNamespace)
                {
                    ...
                    if (name.LocalName != "xml")
                        throw new ArgumentException(
                            Res.GetString(Res.Argument_NamespaceDeclarationXml)
                        );
                }
                else if (value == XNamespace.xmlnsPrefixNamespace)
                {
                    ...
                    throw new ArgumentException(
                        Res.GetString(Res.Argument_NamespaceDeclarationXmlns)
                    );
                }
                else
                {
    ...
    internal struct StreamingElementWriter
    {
        ...
        void WriteAttribute(XAttribute a)
        {
            if (element == null)
                throw new InvalidOperationException(
                    Res.GetString(Res.InvalidOperation_WriteAttribute)
                );
            attributes.Add(a);
        }
    ...
    internal class XNodeReader : XmlReader, IXmlLineInfo
    {
        ...
        internal XNodeReader(XNode node, XmlNameTable nameTable, ReaderOptions options)
        {
            ...
            this.omitDuplicateNamespaces =
                (options & ReaderOptions.OmitDuplicateNamespaces) != 0 ? true : false;
        }
        ...
        public override string LookupNamespace(string prefix)
        {
            ...
            {
                XNamespace ns =
                    prefix.Length == 0 ? e.GetDefaultNamespace() : e.GetNamespaceOfPrefix(prefix);
                if (ns != null)
                {
        ...
        static void GetNameInAttributeScope(
        ...
        XAttribute GetFirstNonDuplicateNamespaceAttribute(XAttribute candidate)
        {
            Debug.Assert(
                ...
                "This method should only be caled if we're omitting duplicate namespace attribute."
    ...
    static class Res
    {
        ...
        internal const string Argument_NamespaceDeclarationPrefixed =
        ...
        internal const string Argument_NamespaceDeclarationXmlns =
        ...
        internal const string InvalidOperation_DocumentStructure =
            "InvalidOperation_DocumentStructure";
        internal const string InvalidOperation_DuplicateAttribute =
            "InvalidOperation_DuplicateAttribute";
        internal const string InvalidOperation_ExpectedEndOfFile =
            "InvalidOperation_ExpectedEndOfFile";
        internal const string InvalidOperation_ExpectedInteractive =
            "InvalidOperation_ExpectedInteractive";
        internal const string InvalidOperation_ExpectedNodeType =
            "InvalidOperation_ExpectedNodeType";
        internal const string InvalidOperation_ExternalCode = "InvalidOperation_ExternalCode";
        internal const string InvalidOperation_DeserializeInstance =
        ...
        internal const string InvalidOperation_UnexpectedEvaluation =
            "InvalidOperation_UnexpectedEvaluation";
        internal const string InvalidOperation_UnexpectedNodeType =
            "InvalidOperation_UnexpectedNodeType";
        internal const string InvalidOperation_UnresolvedEntityReference =
