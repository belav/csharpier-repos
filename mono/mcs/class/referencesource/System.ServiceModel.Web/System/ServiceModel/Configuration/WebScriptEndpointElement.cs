...
namespace System.ServiceModel.Configuration
{
    ...
    public class WebScriptEndpointElement : StandardEndpointElement
    {
        ...
        void InternalOnApplyConfiguration(ServiceEndpoint endpoint)
        {
            ...
            Fx.Assert(
                webScriptEndpoint != null,
                "The endpoint should be of type WebScriptEnablingServiceEndpoint since this is what was returned with CreateServiceEndpoint()."
            );
            ...
            {
                webScriptEndpoint.CrossDomainScriptAccessEnabled =
            ...
            {
                webScriptEndpoint.ContentTypeMapper = WebHttpBindingElement.GetContentTypeMapper(
            ...
            WebHttpBindingElement.ApplyReaderQuotasConfiguration(
                webScriptEndpoint.ReaderQuotas,
                this.ReaderQuotas
            );
        }
