...
namespace System.ServiceModel.Configuration
{
    ...
    public class WebHttpEndpointElement : StandardEndpointElement
    {
        ...
        protected override ConfigurationPropertyCollection Properties
        {
            get
            {
                if (this.properties == null)
                {
                    ...
                    properties.Add(
                        new ConfigurationProperty(
                            ConfigurationStrings.ReaderQuotas,
                    ...
                    properties.Add(
                        new ConfigurationProperty(
                            WebConfigurationStrings.ContentTypeMapper,
                            typeof(string),
                            string.Empty,
                            null,
        ...
        void InternalOnApplyConfiguration(ServiceEndpoint endpoint)
        {
            ...
            Fx.Assert(
                webHttpEndpoint != null,
                "The endpoint should be of type WebHttpServiceEndpoint since this is what was returned with CreateServiceEndpoint()."
            );
            ...
            {
                webHttpEndpoint.AutomaticFormatSelectionEnabled =
                    this.AutomaticFormatSelectionEnabled;
            }
            if (IsSet(WebConfigurationStrings.CrossDomainScriptAccessEnabled))
            {
                webHttpEndpoint.CrossDomainScriptAccessEnabled =
            ...
            {
                webHttpEndpoint.ContentTypeMapper = WebHttpBindingElement.GetContentTypeMapper(
                    this.ContentTypeMapper
                );
            }
            this.Security.ApplyConfiguration(webHttpEndpoint.Security);
            WebHttpBindingElement.ApplyReaderQuotasConfiguration(
                webHttpEndpoint.ReaderQuotas,
                this.ReaderQuotas
            );
        }
