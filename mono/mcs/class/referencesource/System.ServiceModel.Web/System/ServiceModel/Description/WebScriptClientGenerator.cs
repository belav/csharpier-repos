...
namespace System.ServiceModel.Description
{
    ...
    class WebScriptClientGenerator : ServiceMetadataExtension.IHttpGetMetadata
    {
        ...
        )
        {
            ...
            this.serviceLastModified = new DateTime(
                this.serviceLastModified.Year,
                this.serviceLastModified.Month,
                this.serviceLastModified.Day,
                this.serviceLastModified.Hour,
                this.serviceLastModified.Minute,
                this.serviceLastModified.Second,
                DateTimeKind.Utc
            );
        ...
        string GetProxyContent(Uri baseUri)
        {
            ...
            {
                proxy = WCFServiceClientProxyGenerator.GetClientProxyScript(
                    this.endpoint.Contract.ContractType,
                    baseUri.AbsoluteUri,
                    this.debugMode,
                    endpoint
                );
        ...
        string ServiceLastModifiedRfc1123String
        {
            get
            {
                if (serviceLastModifiedRfc1123String == null)
                {
                    ...
                    serviceLastModifiedRfc1123String = serviceLastModified.ToString(
                        "R",
        ...
        {
            HttpRequestMessageProperty requestMessageProperty = (HttpRequestMessageProperty)
            ...
            if (
                ...
                && IsServiceUnchanged(
                    requestMessageProperty.Headers[JsonGlobals.IfModifiedSinceString]
                )
            )
            {
            ...
            string proxyContent = this.GetProxyContent(
                UriTemplate.RewriteUri(
                    ...
                    requestMessageProperty.Headers[HttpRequestHeader.Host]
                )
            );
