...
namespace System.Web.Security
{
    ...
    public class MembershipUser
    {
            ...
            if (providerName == null || SystemWebProxy.Membership.Providers[providerName] == null)
            {
                throw new ArgumentException(
                    String.Format(
                        ...
                        ApplicationServicesStrings.Membership_provider_name_invalid
                    ),
                    "providerName"
                );
            }
        ...
        {
            return SystemWebProxy.Membership.Providers[ProviderName].GetPassword(
                UserName,
                passwordAnswer
            );
        }
        ...
        public virtual bool ChangePassword(string oldPassword, string newPassword)
        {
            ...
            if (
                !SystemWebProxy.Membership.Providers[ProviderName].ChangePassword(
                    UserName,
                    oldPassword,
                    newPassword
                )
        ...
        )
        {
            ...
            SecurityServices.CheckForEmptyOrWhiteSpaceParameter(
            ...
            if (
                !SystemWebProxy.Membership.Providers[ProviderName].ChangePasswordQuestionAndAnswer(
                    UserName,
                    password,
                    newPasswordQuestion,
                    newPasswordAnswer
        ...
        {
            string pass = SystemWebProxy.Membership.Providers[ProviderName].ResetPassword(
                UserName,
                passwordAnswer
            );
        ...
        {
            MembershipUser mu = SystemWebProxy.Membership.Providers[ProviderName].GetUser(
                UserName,
                false
            );
            if (mu != null)
