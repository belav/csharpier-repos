...
namespace System.Diagnostics
{
    ...
    public class EventSchemaTraceListener : TextWriterTraceListener
    {
        ...
        private const string s_userDataHeader =
            "<System.Diagnostics.UserData xmlns=\"http://schemas.microsoft.com/win/2006/09/System.Diagnostics/UserData/\">";
        private const string s_eventHeader =
            "<Event xmlns=\"http://schemas.microsoft.com/win/2004/08/events/event\"><System><Provider Guid=\"";
        ...
        private TraceLogRetentionOption _retention = (TraceLogRetentionOption)
            LogStream.DefaultRetention;
        ...
        public EventSchemaTraceListener(
            ...
            : this(
                ...
                logRetentionOption,
                maximumFileSize,
                LogStream.DefaultNumberOfFiles
            ) { }
        ...
        )
        {
            ...
            if (
                logRetentionOption < TraceLogRetentionOption.UnlimitedSequentialFiles
                || logRetentionOption > TraceLogRetentionOption.SingleFileBoundedSize
            )
                throw new ArgumentOutOfRangeException(
        ...
        new public TextWriter Writer
        {
            ...
            set { throw new NotSupportedException(SR.GetString(SR.NotSupported_SetTextWriter)); }
        }
        ...
        )
        {
            ...
            _InternalBuildRaw(
                writer,
                ((uint)((id < 0) ? 0 : id)).ToString(CultureInfo.InvariantCulture)
            );
            _InternalBuildRaw(writer, "</EventID>");
            ...
            if ((TraceOptions.DateTime & opts) != 0)
            {
                ...
                if (eventCache != null)
                    _InternalBuildRaw(
                        writer,
                        eventCache.DateTime.ToString("o", CultureInfo.InvariantCulture)
                    );
                else
                    _InternalBuildRaw(
                        writer,
        ...
        )
        {
            ...
            switch (eventType)
            {
                ...
                case TraceEventType.Transfer:
                    _InternalBuildRaw(
                        writer,
                        "<Level>Information</Level><Opcode>Transfer</Opcode>"
                    );
                    break;
                default:
                    break;
                ...
                lock (m_lockObject)
                {
                    if (!_initialized)
                    {
                        try
                        {
                            ...
                            {
                                long maxFileSize = Int64.Parse(
                                    Attributes[s_optionMaximumFileSize],
                                    CultureInfo.InvariantCulture
                                );
                            ...
                            {
                                int maxNumberOfFiles = Int32.Parse(
                                    Attributes[s_optionMaximumNumberOfFiles],
                                    CultureInfo.InvariantCulture
                                );
                        ...
                        catch (Exception)
                        {
                            ...
                            Debug.Assert(
                                false,
                                "Exception while populating config values for EventSchemaTraceListener!"
                            );
                        }
                        finally
                        {
                ...
                case TraceLogRetentionOption.LimitedSequentialFiles:
                    if (maximumNumberOfFiles < 1)
                    {
                        if (throwOnError)
                        {
                            throw new ArgumentOutOfRangeException(
                                s_optionMaximumNumberOfFiles,
                                SR.GetString(SR.ArgumentOutOfRange_NeedValidMaxNumFiles, 1)
                            );
                        }
                        this._maxNumberOfFiles = 1;
                    }
                ...
                case TraceLogRetentionOption.LimitedCircularFiles:
                    if (maximumNumberOfFiles < 2)
                    {
                        if (throwOnError)
                        {
                            throw new ArgumentOutOfRangeException(
                                s_optionMaximumNumberOfFiles,
                                SR.GetString(SR.ArgumentOutOfRange_NeedValidMaxNumFiles, 2)
                            );
                        }
        ...
        private sealed class TraceWriter : TextWriter
        {
            ...
            internal TraceWriter(
                string _fileName,
                int bufferSize,
                TraceLogRetentionOption retention,
                long maxFileSize,
                    ...
                    if (encNoBOMwithFallback == null)
                    {
                        lock (m_lockObject)
                        {
                            if (encNoBOMwithFallback == null)
                            {
                                ...
                                encNoBOMwithFallback = GetEncodingWithFallback(
            ...
            public override void Write(String value)
            {
                ...
                catch (Exception)
                {
                    Debug.Assert(
                        false,
                        "UnExpected exc! Possible encoding error or failure on write! DATA LOSS!!!"
                    );
