    ...
    public abstract class PipeStream : Stream
    {
        ...
        protected PipeStream(PipeDirection direction, int bufferSize)
        {
            if (direction < PipeDirection.In || direction > PipeDirection.InOut)
            {
                throw new ArgumentOutOfRangeException(
                    "direction",
                    SR.GetString(SR.ArgumentOutOfRange_DirectionModeInOutOrInOut)
                );
            }
            if (bufferSize < 0)
            {
        ...
        private unsafe int ReadCore(byte[] buffer, int offset, int count)
        {
            ...
            if (r == -1)
            {
                ...
                if (
                    hr == UnsafeNativeMethods.ERROR_BROKEN_PIPE
        ...
        public override unsafe int EndRead(IAsyncResult asyncResult)
        {
            ...
            // to stop reading
            m_isMessageComplete = m_state == PipeState.Broken || afsar._isMessageComplete;
        ...
        public override unsafe void EndWrite(IAsyncResult asyncResult)
        {
            ...
            if (wh != null)
            {
                ...
                try
                {
                    ...
                    Debug.Assert(
                        afsar._isComplete == true,
                        "PipeStream::EndWrite - AsyncPSCallback didn't set _isComplete to true!"
                    );
                }
                finally
                {
        ...
        )
        {
            ...
            Debug.Assert(buffer != null, "buffer == null");
            Debug.Assert(
                (m_isAsync && overlapped != null) || (!m_isAsync && overlapped == null),
        ...
        public bool IsConnected
        {
            ...
            protected set { m_state = (value) ? PipeState.Connected : PipeState.Disconnected; }
        }
        ...
        public bool IsMessageComplete
        {
            ...
            get
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.InvalidOperation_PipeDisconnected)
                    );
                }
                if (m_handle == null)
                {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.InvalidOperation_PipeReadModeNotMessage)
                    );
                }
        ...
        public virtual PipeTransmissionMode TransmissionMode
        {
            ...
            get
            {
                ...
                if (m_isFromExistingHandle)
                {
                    int pipeFlags;
                    if (
                        !UnsafeNativeMethods.GetNamedPipeInfo(
                            m_handle,
                            out pipeFlags,
        ...
        {
            if (
                errorCode == UnsafeNativeMethods.ERROR_BROKEN_PIPE
            ...
            )
            {
                ...
                throw new IOException(
                    SR.GetString(SR.IO_IO_PipeBroken),
