...
namespace System.Security.Cryptography
{
    ...
    public enum CngExportPolicies
    {
        ...
        AllowPlaintextArchiving =
            0x00000008 // NCRYPT_ALLOW_PLAINTEXT_ARCHIVING_FLAG
        ,
    }
    ...
    public enum CngKeyCreationOptions
    {
        ...
        OverwriteExistingKey =
            0x00000080 // NCRYPT_OVERWRITE_KEY_FLAG
        ,
    }
    ...
    [SuppressMessage(
        ...
        Justification = "Approved API exception to have an easy way to express user keys"
    )]
    ...
    internal enum CngKeyTypes
    {
        None = 0x00000000,
        MachineKey =
            0x00000020 // NCRYPT_MACHINE_KEY_FLAG
        ,
    }
    ...
    [SuppressMessage(
        ...
        Justification = "Flags are defined by the native ncrypt API"
    )]
    public enum CngKeyUsages
    {
        ...
        AllUsages =
            0x00ffffff // NCRYPT_ALLOW_ALL_USAGES
        ,
    }
    ...
    public enum CngUIProtectionLevels
    {
        ...
        ForceHighProtection =
            0x00000002 // NCRYPT_UI_FORCE_HIGH_PROTECTION_FLAG
        ,
    }
...
#pragma warning restore 618
        internal static class UnsafeNativeMethods
        {
            ...
            /// </summary>
            [DllImport("ncrypt.dll", CharSet = CharSet.Unicode)]
            internal static extern ErrorCode NCryptOpenStorageProvider(
        ...
        {
            BCryptNative.BCRYPT_PKCS1_PADDING_INFO pkcs1Info =
                new BCryptNative.BCRYPT_PKCS1_PADDING_INFO();
        ...
        )
        {
            ...
            BCryptNative.BCRYPT_OAEP_PADDING_INFO oaepInfo =
                new BCryptNative.BCRYPT_OAEP_PADDING_INFO();
        ...
        {
            Debug.Assert(
                dwFlags == AsymmetricPaddingMode.Pkcs1,
                "dwFlags == AsymmetricPaddingMode.Pkcs1"
            );
            ...
            return UnsafeNativeMethods.NCryptDecrypt(
                hKey,
                pbInput,
                cbInput,
                IntPtr.Zero,
        ...
        )
        {
            ...
            return UnsafeNativeMethods.NCryptEncrypt(
                hKey,
                pbInput,
                cbInput,
                IntPtr.Zero,
        ...
        )
        {
            ...
            BCryptNative.BCRYPT_PSS_PADDING_INFO pssInfo =
                new BCryptNative.BCRYPT_PSS_PADDING_INFO();
        ...
        private static bool VerifySignature<T>(
            ...
            ref T paddingInfo,
            AsymmetricPaddingMode paddingMode,
            NCryptSignatureVerifier<T> verifier
        )
            where T : struct
        {
            Debug.Assert(key != null, "key != null");
        ...
        internal static byte[] BuildEccPublicBlob(string algorithm, BigInteger x, BigInteger y)
        {
            ...
            Buffer.BlockCopy(
                BitConverter.GetBytes(xBytes.Length),
                0,
                blob,
                sizeof(int),
                sizeof(int)
        ...
        )
        {
            ...
            Contract.Requires(!String.IsNullOrEmpty(algorithm));
            Contract.Ensures(
                Contract.Result<SafeNCryptKeyHandle>() != null
            ...
            ErrorCode error = UnsafeNativeMethods.NCryptCreatePersistedKey(
                provider,
                out keyHandle,
                algorithm,
                name,
            ...
            try
            {
                ...
                unsafe
                {
                    ...
                    )
                    {
                        ...
                        return DeriveKeyMaterial(secretAgreement, kdf, parameters.ToArray(), flags);
                    }
                }
            }
            finally
        ...
        )
        {
            ...
            unsafe
            {
                fixed (NCryptBuffer* pParameters = parameters)
                {
                    ...
                    int keySize = 0;
                    ErrorCode error = UnsafeNativeMethods.NCryptDeriveKey(
                        secretAgreement,
                        kdf,
                        ref parameterDesc,
                        null,
                    ...
                    error = UnsafeNativeMethods.NCryptDeriveKey(
                        secretAgreement,
                        kdf,
                        ref parameterDesc,
                        keyMaterial,
        ...
        )
        {
            ...
            Contract.Ensures(
                Contract.Result<SafeNCryptSecretHandle>() != null
                    && !Contract.Result<SafeNCryptSecretHandle>().IsClosed
                    && !Contract.Result<SafeNCryptSecretHandle>().IsInvalid
            );

            SafeNCryptSecretHandle secretAgreement;
            ErrorCode error = UnsafeNativeMethods.NCryptSecretAgreement(
                privateKey,
                otherPartyPublicKey,
                out secretAgreement,
                0
        ...
        internal static byte[] ExportKey(SafeNCryptKeyHandle key, string format)
        {
            ...
            int bufferSize = 0;
            ErrorCode error = UnsafeNativeMethods.NCryptExportKey(
                key,
                IntPtr.Zero,
                format,
                IntPtr.Zero,
            ...
            error = UnsafeNativeMethods.NCryptExportKey(
                key,
                IntPtr.Zero,
                format,
                IntPtr.Zero,
        ...
        private static byte[] FillKeyParameter(byte[] key, int keySize)
        {
            ...
            Contract.Ensures(
                Contract.Result<byte[]>() != null && Contract.Result<byte[]>().Length >= keySize / 8
            );
        ...
        )
        {
            ...
            int bufferSize = 0;
            ErrorCode error = UnsafeNativeMethods.NCryptGetProperty(
                ncryptObject,
                propertyName,
                null,
                0,
            ...
            if (error != ErrorCode.NotFound && bufferSize > 0)
            {
                ...
                error = UnsafeNativeMethods.NCryptGetProperty(
                    ncryptObject,
                    propertyName,
                    value,
                    value.Length,
        ...
        )
        {
            ...
            SafeNCryptKeyHandle keyHandle = null;
            ErrorCode error = UnsafeNativeMethods.NCryptImportKey(
                provider,
                IntPtr.Zero,
                format,
                IntPtr.Zero,
        ...
        )
        {
            ...
            ErrorCode error = UnsafeNativeMethods.NCryptOpenKey(
                provider,
                out key,
                name,
                0,
        ...
        internal static SafeNCryptProviderHandle OpenStorageProvider(string providerName)
        {
            ...
            Contract.Ensures(
                Contract.Result<SafeNCryptProviderHandle>() != null
            ...
            ErrorCode error = UnsafeNativeMethods.NCryptOpenStorageProvider(
                out providerHandle,
                providerName,
                0
            );
        ...
        private static byte[] ReverseBytes(byte[] buffer)
        {
            ...
            Contract.Ensures(
                Contract.Result<byte[]>() != null
                    && Contract.Result<byte[]>().Length == buffer.Length
            );
        ...
        private static byte[] ReverseBytes(
            byte[] buffer,
            int offset,
            int count,
            bool padWithZeroByte
        )
        {
            Contract.Requires(buffer != null);
            ...
            Contract.Ensures(Contract.Result<byte[]>() != null);
            Contract.Ensures(
                Contract.Result<byte[]>().Length == (padWithZeroByte ? count + 1 : count)
            );
        ...
        )
        {
            ...
            ErrorCode error = UnsafeNativeMethods.NCryptSetProperty(
                ncryptObject,
                propertyName,
                value,
        ...
        internal static byte[] SignHash(SafeNCryptKeyHandle key, byte[] hash)
        {
            ...
            // Figure out how big the signature is
            int signatureSize = 0;
            ErrorCode error = UnsafeNativeMethods.NCryptSignHash(
                key,
                IntPtr.Zero,
                hash,
                hash.Length,
            ...
            error = UnsafeNativeMethods.NCryptSignHash(
                key,
                IntPtr.Zero,
                hash,
                hash.Length,
        ...
        internal static bool VerifySignature(SafeNCryptKeyHandle key, byte[] hash, byte[] signature)
        {
            ...
            ErrorCode error = UnsafeNativeMethods.NCryptVerifySignature(
                key,
                IntPtr.Zero,
                hash,
                hash.Length,
