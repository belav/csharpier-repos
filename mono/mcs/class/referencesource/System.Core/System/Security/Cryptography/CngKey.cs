...
namespace System.Security.Cryptography
{
    ...
    public sealed partial class CngKey : IDisposable
    {
        ...
        private CngKey(SafeNCryptProviderHandle kspHandle, SafeNCryptKeyHandle keyHandle)
        {
            ...
            Contract.Ensures(
                m_keyHandle != null && !m_keyHandle.IsInvalid && !m_keyHandle.IsClosed
            );
        ...
        [SuppressMessage(
            ...
            Justification = "The demand is based on a non-mutable value type"
        )]
        ...
        )
        {
            ...
            if (!IsEphemeral)
            {
                ...
                if (keyName != null)
                {
                    KeyContainerPermissionAccessEntry access =
                        new KeyContainerPermissionAccessEntry(keyName, flags);
        ...
        )
        {
            ...
            SafeNCryptProviderHandle kspHandle = NCryptNative.OpenStorageProvider(
                creationParameters.Provider.Provider
            );
            SafeNCryptKeyHandle keyHandle = NCryptNative.CreatePersistedKey(
                kspHandle,
                algorithm.Algorithm,
                keyName,
        ...
        public static bool Exists(string keyName, CngProvider provider, CngKeyOpenOptions options)
        {
            ...
            )
            {
                ...
                try
                {
                    NCryptNative.ErrorCode error = NCryptNative.UnsafeNativeMethods.NCryptOpenKey(
                        kspHandle,
                        out keyHandle,
                        keyName,
                        0,
                    ...
                    bool keyNotFound =
                        error == NCryptNative.ErrorCode.KeyDoesNotExist
        ...
        )
        {
            ...
            {
                IntPtr rawHandle = NCryptNative.GetPropertyAsIntPtr(
                    keyHandle,
            ...
            try
            {
                ...
                {
                    throw new ArgumentException(
                        SR.GetString(SR.Cryptography_OpenEphemeralKeyHandleWithoutEphemeralFlag),
