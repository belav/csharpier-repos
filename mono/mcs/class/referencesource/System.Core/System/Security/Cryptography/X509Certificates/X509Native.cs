...
namespace System.Security.Cryptography.X509Certificates
{
    internal static partial class X509Native
    {
        ...
        )
        {
            ...
            byte[] buffer = null;
            int bufferSize = 0;
            bool gotProperty = UnsafeNativeMethods.CertGetCertificateContextProperty(
                certificateContext,
                property,
                buffer,
                ref bufferSize
            );
            return gotProperty || (ErrorCode)Marshal.GetLastWin32Error() == ErrorCode.MoreData;
        }
        ...
        )
        {
            ...
            try
            {
                int keySpec = 0;
                if (
                    !UnsafeNativeMethods.CryptAcquireCertificatePrivateKey(
                        certificateContext,
        ...
        )
        {
            ...
            int bufferSize = 0;
            if (
                !UnsafeNativeMethods.CertGetCertificateContextProperty(
                    certificateContext,
                    property,
                    buffer,
                    ref bufferSize
            ...
            where T : struct
        {
            ...
            Debug.Assert(
                rawProperty.Length >= Marshal.SizeOf(typeof(T)),
                "Property did not return expected structure"
            );
...
#pragma warning restore 618
        public static class UnsafeNativeMethods
        {
            ...
            public static extern int CertFreeAuthenticodeSignerInfo(
                ref AXL_AUTHENTICODE_SIGNER_INFO pSignerInfo
            );
            ...
            [DllImport("clr")]
            [ReliabilityContract(Consistency.WillNotCorruptState, Cer.Success)]
            public static extern int CertFreeAuthenticodeTimestamperInfo(
                ref AXL_AUTHENTICODE_TIMESTAMPER_INFO pTimestamperInfo
            );
            ...
            /// </remarks>
            [DllImport("clr")]
            public static extern int CertVerifyAuthenticodeLicense(
                ref CapiNative.CRYPTOAPI_BLOB pLicenseBlob,
