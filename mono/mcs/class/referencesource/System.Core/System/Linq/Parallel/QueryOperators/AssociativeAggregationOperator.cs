...
namespace System.Linq.Parallel
{
        ...
        : UnaryQueryOperator<TInput, TIntermediate>
    {
            ...
            : base(child)
        {
            ...
            Contract.Assert(
                Enum.IsDefined(typeof(QueryAggregationOptions), options),
            ...
            : QueryOperatorEnumerator<TIntermediate, int>
        {
            ...
            internal override bool MoveNext(ref TIntermediate currentElement, ref int currentKey)
            {
                ...
                Contract.Assert(
                    m_reduceOperator.m_intermediateReduce != null,
                ...
                if (m_reduceOperator.m_seedIsSpecified)
                {
                    ...
                    accumulator =
                        m_reduceOperator.m_seedFactory == null
                ...
                else
                {
                    ...
                    if (!m_source.MoveNext(ref acc, ref accKeyUnused))
                        return false;
                    hadNext = true;
