...
namespace System.Linq.Parallel
{
        ...
        : BinaryQueryOperator<TInputOutput, TInputOutput, TInputOutput>
    {
        ...
        class IntersectQueryOperatorEnumerator<TLeftKey>
        ...
        class OrderedIntersectQueryOperatorEnumerator<TLeftKey>
            : QueryOperatorEnumerator<TInputOutput, TLeftKey>
        {
            private QueryOperatorEnumerator<
                Pair<TInputOutput, NoKeyMemoizationRequired>,
                ...
                if (m_hashLookup == null)
                {
                    ...
                    while (m_leftSource.MoveNext(ref leftElement, ref leftKey))
                    {
                        ...
                        )
                        {
                            ...
                            m_hashLookup[wrappedLeftElem] = new Pair<TInputOutput, TLeftKey>(
                                leftElement.First,
                                leftKey
                            );
                        }
