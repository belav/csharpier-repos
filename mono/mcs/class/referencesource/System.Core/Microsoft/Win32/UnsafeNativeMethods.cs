...
namespace Microsoft.Win32
{
    ...
    internal static class UnsafeNativeMethods
    {
        ...
        internal static String GetMessage(int errorCode)
        {
            ...
            int result = UnsafeNativeMethods.FormatMessage(
        ...
        internal static extern SafePipeHandle CreateNamedPipeClient(
            ...
            int dwDesiredAccess,
            System.IO.FileShare dwShareMode,
            UnsafeNativeMethods.SECURITY_ATTRIBUTES securityAttrs,
            System.IO.FileMode dwCreationDisposition,
            int dwFlagsAndAttributes,
            IntPtr hTemplateFile
        );
...
#pragma warning restore 618
        ...
        [DllImport(
            ADVAPI32,
            ExactSpelling = true,
            EntryPoint = "EventProviderEnabled",
            CharSet = System.Runtime.InteropServices.CharSet.Unicode
        )]
        [SecurityCritical]
        ...
        [SecurityCritical]
        internal static extern unsafe uint EventActivityIdControl(
            [In] int ControlCode,
...
#pragma warning restore 618
        ...
        [DllImport(
            ADVAPI32,
            ExactSpelling = true,
            EntryPoint = "PerfStopProvider",
            CharSet = CharSet.Unicode
        )]
        [SecurityCritical]
        internal static extern unsafe uint PerfStopProvider([In] IntPtr hProvider);

        [DllImport(
            ADVAPI32,
            ExactSpelling = true,
            EntryPoint = "PerfSetCounterSetInfo",
            CharSet = CharSet.Unicode
        )]
        [SecurityCritical]
        ...
        [DllImport(
            ADVAPI32,
            ExactSpelling = true,
            EntryPoint = "PerfSetCounterRefValue",
            CharSet = CharSet.Unicode
        )]
        [SecurityCritical]
...
#pragma warning restore 618
        ...
        [SecurityCritical]
        [return: MarshalAs(UnmanagedType.Bool)]
        private static extern bool GlobalMemoryStatusExNative(
