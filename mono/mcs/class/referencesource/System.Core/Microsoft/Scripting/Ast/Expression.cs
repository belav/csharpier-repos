...
namespace System.Linq.Expressions
{
    ...
    public abstract partial class Expression
    {
        ...
        private static readonly CacheDict<Type, MethodInfo> _LambdaDelegateCache = new CacheDict<
            Type,
            MethodInfo
        >(40);
        ...
        public virtual ExpressionType NodeType
        {
            get {
                ...
                if (
                    _legacyCtorSupportTable != null
                    && _legacyCtorSupportTable.TryGetValue(this, out extInfo)
                )
                {
        ...
        internal static ReadOnlyCollection<T> ReturnReadOnly<T>(ref IList<T> collection)
        {
            ...
            Interlocked.CompareExchange<IList<T>>(ref collection, value.ToReadOnly(), value);
                    ...
                    if (memberInfo.MemberType == MemberTypes.Property)
                    {
                        ...
                        if (!prop.CanRead)
                        {
                            throw new ArgumentException(
                                Strings.ExpressionMustBeReadable,
                                paramName
                            );
                        }
                    }
