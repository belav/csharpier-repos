...
namespace System.Linq.Expressions
{
    ...
    public enum MemberBindingType
    {
        ...
        /// <summary>
        /// A binding that represents initializing a member of type <see cref="System.Collections.IList"/>
        // or <see cref="System.Collections.Generic.ICollection{T}"/> from a list of elements.
        /// </summary>
        ListBinding,
    }

    /// <summary>
    /// Provides the base class from which the classes that represent bindings that are used to
    // initialize members of a newly created object derive.
    /// </summary>
