...
namespace System.Dynamic.Utils
{
    internal static class TypeUtils
    {
        ...
        )
        {
            ...
            if (
                !TypeUtils.AreEquivalent(nnExprType, convertFrom)
        ...
        internal static Type FindGenericType(Type definition, Type type)
        {
            ...
            {
                if (
                    type.IsGenericType && AreEquivalent(type.GetGenericTypeDefinition(), definition)
                )
                {
                    return type;
                }
        ...
        internal static MethodInfo GetBooleanOperator(Type type, string name)
        {
            do
            {
                MethodInfo result = type.GetMethodValidated(
                    name,
                    AnyStatic,
                    null,
                    new Type[] { type },
