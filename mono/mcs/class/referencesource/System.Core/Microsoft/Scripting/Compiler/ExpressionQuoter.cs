...
using System.Collections.Generic;using System.ComponentModel;using System.Diagnostics;using System.Dynamic.Utils;
...
namespace System.Runtime.CompilerServices
{
    public partial class RuntimeOps
    {
        ...
        private sealed class ExpressionQuoter : ExpressionVisitor
        {
            ...
            private readonly Stack<Set<ParameterExpression>> _shadowedVars =
                new Stack<Set<ParameterExpression>>();
            ...
            )
            {
                ...
                var boxesConst = Expression.Constant(
