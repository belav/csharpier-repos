            ...
            switch (node.NodeType)
            {
                ...
                case ExpressionType.Block:
                    Emit(
                        ...
                        UpdateEmitAsTypeFlag(flags, CompilationFlags.EmitAsVoidType)
                    );
                    break;
        ...
        private void EmitExpressionAsType(Expression node, Type type, CompilationFlags flags)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    EmitExpression(
                        node,
                        UpdateEmitExpressionStartFlag(flags, CompilationFlags.EmitExpressionStart)
                    );
                }
            }
        }
        ...
        )
        {
            Debug.Assert(
                TypeUtils.AreEquivalent(
                    ...
                    TypeUtils.GetNonNullableType(mc.Type)
                )
            );
            ...
            switch (nodeType)
            {
                ...
                case ExpressionType.GreaterThanOrEqual:
                {
                    ...
                    if (
                        TypeUtils.IsNullableType(resultType)
