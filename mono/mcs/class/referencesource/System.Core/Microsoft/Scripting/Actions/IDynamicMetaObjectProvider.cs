...
namespace System.Dynamic
{
    ...
    /// </summary>
    /// <remarks>
    /// Objects that want to participate in the binding process should implement an
    // IDynamicMetaObjectProvider interface,
    /// and implement <see cref="IDynamicMetaObjectProvider.GetMetaObject" /> to return a <see
