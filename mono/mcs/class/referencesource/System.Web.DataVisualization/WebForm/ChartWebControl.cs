...
namespace System.Web.UI.DataVisualization.Charting
{
    ...
    public class Chart : System.Web.UI.WebControls.DataBoundControl, IPostBackEventHandler
    {
            ...
            : base()
        {
            ...
            _chartTypeRegistry.Register(
                ChartTypeNames.OneHundredPercentStackedColumn,
                typeof(HundredPercentStackedColumnChart)
            );
            _chartTypeRegistry.Register(
                ChartTypeNames.OneHundredPercentStackedBar,
                typeof(HundredPercentStackedBarChart)
            );
            _chartTypeRegistry.Register(
                ChartTypeNames.OneHundredPercentStackedArea,
                typeof(HundredPercentStackedAreaChart)
            );
            ...
            _formulaRegistry.Register(
                SR.FormulaNameGeneralTechnicalIndicators,
                typeof(GeneralTechnicalIndicators)
            );
            _formulaRegistry.Register(
                SR.FormulaNameTechnicalVolumeIndicators,
            ...
            _formulaRegistry.Register(
                SR.FormulaNameTimeSeriesAndForecasting,
                typeof(TimeSeriesAndForecasting)
            );
            _formulaRegistry.Register(
                SR.FormulaNameStatisticalAnalysis,
                typeof(StatisticalAnalysis)
            );
            ...
            ChartAreas.NameReferenceChanged += new EventHandler<NameReferenceChangedEventArgs>(
                Series.ChartAreaNameReferenceChanged
            );
            ChartAreas.NameReferenceChanged += new EventHandler<NameReferenceChangedEventArgs>(
                Legends.ChartAreaNameReferenceChanged
            );
            ChartAreas.NameReferenceChanged += new EventHandler<NameReferenceChangedEventArgs>(
                Titles.ChartAreaNameReferenceChanged
            );
            ChartAreas.NameReferenceChanged += new EventHandler<NameReferenceChangedEventArgs>(
                Annotations.ChartAreaNameReferenceChanged
            );
            Legends.NameReferenceChanged += new EventHandler<NameReferenceChangedEventArgs>(
        ...
        public string CurrentImageLocation
        {
            get
            {
                ...
                if (this.RenderType == RenderType.ImageTag)
                {
                    ...
                    int indexSEQ = _currentChartImageLocation.IndexOf(
                        "#SEQ",
                    ...
                    {
                        throw (
                            new InvalidOperationException(SR.ExceptionImageUrlInvalidFormatters)
                        );
                    }
                    ...
                    if (indexUID >= 0)
                    {
                        ...
                        _currentChartImageLocation = _currentChartImageLocation.Replace(
                            "#UID",
                ...
                int indexNoGuidParam = _currentChartImageLocation.IndexOf(
                    "#NOGUIDPARAM",
                    StringComparison.Ordinal
                );
                ...
                if (
                    _currentChartImageLocation.StartsWith("~", StringComparison.Ordinal)
            ...
            get
            {
                if (_isImageRendersBorder == 0)
                {
                    using (StringWriter sw = new StringWriter(CultureInfo.InvariantCulture))
                    {
                        ...
                        _isImageRendersBorder =
                            sw.ToString().IndexOf("border", 0, StringComparison.OrdinalIgnoreCase)
                            != -1
                                ? 1
                                : -1;
                    }
        ...
        private class CustomImageControl : System.Web.UI.WebControls.Image
        {
            ...
            protected override void AddAttributesToRender(HtmlTextWriter writer)
            {
                ...
                {
                    writer.AddAttribute(
                        HtmlTextWriterAttribute.Usemap,
                        "#" + this.ClientID + "ImageMap",
                        false
                    );
                }
                if (!this.Enabled)
        ...
        private CustomImageControl BuildImageControl(string chartImageSrc, bool addGuidParameter)
        {
            ...
            htmlImage.ImageUrl =
                chartImageSrc + (addGuidParameter ? "?" + Guid.NewGuid().ToString() : "");
            ...
            if (!IsImageRendersBorder)
            {
                ...
                if (
                    String.IsNullOrEmpty(htmlImage.Style[HtmlTextWriterStyle.BorderWidth])
        ...
        protected override void Render(HtmlTextWriter writer)
        {
            ...
            if (this.DesignMode)
            {
                ...
                using (
                    CustomImageControl imageControl = this.BuildImageControl(
                        "file://" + _designTimeChart,
                        false
                    )
                )
                {
            ...
            if (this.RenderType == RenderType.ImageTag)
            {
                if (this.GetImageStorageMode() == ImageStorageMode.UseHttpHandler)
                {
                    using (MemoryStream stream = new MemoryStream())
                    {
                        ...
                        chartImage = ChartHttpHandler.GetChartImageUrl(
                            stream,
        ...
        void CheckImageURLSeqFormat(string imageURL)
        {
            ...
            string[] values = imageURL
                .Substring(indexSEQ + 1, indexClosing - indexSEQ - 1)
                .Split(',');
            ...
            foreach (String str in values)
            {
                ...
                foreach (Char c in str)
                {
                    ...
                    {
                        throw (
                            new ArgumentException(SR.ExceptionImageUrlInvalidFormat, "imageURL")
                        );
                    }
                }
            }
        ...
        private string GetNewSeqImageUrl(string imageUrl)
        {
            ...
            {
                imageSeqNumber =
                    (int)this.Page.Application[Chart.productID + "_ImageSeqNumber"] + 1;
                ...
                if (imageTimeToLive > 0)
                {
                    ...
                    if (File.Exists(fileName))
                    {
                        ...
                        if (fileTime.AddMinutes(imageTimeToLive) > DateTime.Now)
                        {
                            ...
                            eventLog.WriteEntry(
                                SR.EvenLogMessageChartImageFileTimeToLive(
                                    timeSpan.Minutes.ToString(CultureInfo.InvariantCulture)
                                ),
        ...
        /// </remarks>
        public ChartElementOutline GetChartElementOutline(
            object chartElement,
        ...
        {
            EventHandler<ChartPaintEventArgs> prePaintEventDelegate =
                (EventHandler<ChartPaintEventArgs>)Events[_prePaintEvent];
        ...
        {
            EventHandler<ChartPaintEventArgs> postPaintEventDelegate =
                (EventHandler<ChartPaintEventArgs>)Events[_postPaintEvent];
        ...
        {
            EventHandler<CustomizeMapAreasEventArgs> customizeMapAreasEventDelegate =
        ...
        {
            EventHandler<CustomizeLegendEventArgs> customizeLegendEventDelegate =
        ...
        protected override void LoadViewState(object savedState)
        {
            ...
            if (this.EnableViewState)
            {
                ...
                if (
                    this.ViewState["ViewStateData"] != null
                    && (
                ...
                )
                {
                    ...
                    StringReader stringReader = new StringReader(
                        (string)this.ViewState["ViewStateData"]
                    );
        ...
        {
            get { return (string)this.ViewState["ViewStateData"]; }
            set
            {
                // Set state data
        ...
        {
            get { return _chartImageLocation; }
            set
            {
                // Find the begginning of the "#SEQ" formatting string
        ...
        {
            get { return this.chartPicture.RightToLeft; }
        ...
        {
            get { return _dataManager.Series; }
        }
        ...
        {
            get { return _dataManager.Palette; }
            set { _dataManager.Palette = value; }
        }
        ...
        {
            set { this._dataManager.PaletteCustomColors = value; }
            get { return this._dataManager.PaletteCustomColors; }
        }
        ...
        {
            get { return chartPicture.ImageType; }
            set { chartPicture.ImageType = value; }
        }
        ...
        {
            get { return chartPicture.Compression; }
            set { chartPicture.Compression = value; }
        }
        ...
        */
        ...
        {
            get { return chartPicture.IsMapEnabled; }
            set { chartPicture.IsMapEnabled = value; }
        }
        ...
        {
            get { return chartPicture.MapAreas; }
        }
        ...
        {
            get { return chartPicture.AntiAliasing; }
            set { chartPicture.AntiAliasing = value; }
        }
        ...
        {
            get { return chartPicture.TextAntiAliasingQuality; }
            set { chartPicture.TextAntiAliasingQuality = value; }
        }
        ...
        {
            get { return chartPicture.IsSoftShadows; }
            set { chartPicture.IsSoftShadows = value; }
        }
        ...
        {
            get { return chartPicture.ChartAreas; }
        }
        ...
        {
            get { return chartPicture.BackColor; }
            set { chartPicture.BackColor = value; }
        }
        ...
        {
            get { return new Unit(chartPicture.Width); }
            set
            {
        ...
        {
            get { return chartPicture.Legends; }
        }
        ...
        {
            get { return chartPicture.Titles; }
        }
        ...
        {
            get { return chartPicture.Annotations; }
        }
        ...
        {
            get { return new Unit(chartPicture.Height); }
            set
            {
                if (value.Type != UnitType.Pixel)
                {
        ...
        {
            get { return chartPicture.BackHatchStyle; }
            set { chartPicture.BackHatchStyle = value; }
        }
        ...
        {
            get { return chartPicture.BackImage; }
            set { chartPicture.BackImage = value; }
        }
        ...
        {
            get { return chartPicture.BackImageWrapMode; }
            set { chartPicture.BackImageWrapMode = value; }
        }
        ...
        {
            get { return chartPicture.BackImageTransparentColor; }
            set { chartPicture.BackImageTransparentColor = value; }
        }
        ...
        {
            get { return chartPicture.BackImageAlignment; }
            set { chartPicture.BackImageAlignment = value; }
        }
        ...
        {
            get { return chartPicture.BackGradientStyle; }
            set { chartPicture.BackGradientStyle = value; }
        }
        ...
        {
            get { return chartPicture.BackSecondaryColor; }
            set { chartPicture.BackSecondaryColor = value; }
        }
        ...
        {
            get { return chartPicture.BorderColor; }
            set { chartPicture.BorderColor = value; }
        }
        ...
        {
            get { return chartPicture.BorderWidth; }
            set { chartPicture.BorderWidth = value; }
        }
        ...
        {
            get { return chartPicture.BorderDashStyle; }
            set { chartPicture.BorderDashStyle = value; }
        }
        ...
        {
            get { return chartPicture.BorderSkin; }
            set { chartPicture.BorderSkin = value; }
        }
        ...
        {
            if (
                ((this.Context != null) && (this.Context.Request != null))
        ...
        {
            this.chartPicture.DataBindTable(dataSource, xField);
        }
        ...
        {
            this.chartPicture.DataBindTable(dataSource, String.Empty);
        }
        ...
        {
            get { return this._imageStorageMode; }
            set { this._imageStorageMode = value; }
        }
