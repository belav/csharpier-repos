...
#else
using System.Web;using System.Web.UI;using System.Web.UI.DataVisualization.Charting;using System.Web.UI.DataVisualization.Charting.Data;using System.Web.UI.DataVisualization.Charting.Utilities;using System.Web.UI.DataVisualization.Charting.ChartTypes;
#endif
...
#endif
{
...
#endif //!Microsoft_CONTROL
    {
        ...
        {
            get { return this._seriesSymbolSize; }
            set
            {
        ...
        {
            set { this._mapAreaAttribute = value; }
            get { return this._mapAreaAttribute; }
        }
        ...
        {
            get { return this._minimumCellWidth; }
            set
            {
                if (value < -1)
                {
        ...
        {
            get { return this._maximumCellWidth; }
            set
            {
                if (value < -1)
                {
        ...
        internal LegendCell CreateNewCell()
        {
            ...
            newCell.CellType =
                (this.ColumnType == LegendCellColumnType.SeriesSymbol)
...
#endif
    {
        ...
        {
            get { return this._imageTransparentColor; }
            set
            {
        ...
        public virtual Size ImageSize
        {
            ...
            set
            {
                ...
                {
                    throw (
                        new ArgumentException(SR.ExceptionLegendCellImageSizeIsNegative, "value")
                    );
                }
                ...
                if (value.Width < 0 || value.Height < 0)
                {
                    throw (
                        new ArgumentException(
                            SR.ExceptionLegendCellSeriesSymbolSizeIsNegative,
                            "value"
                        )
                    );
                }
        ...
        public virtual string ToolTip
        {
            set
            {
                this._toolTip = value;
#if Microsoft_CONTROL
                if (this.Chart != null && this.Chart.selection != null)
                {
        ...
        )
        {
            ...
            {
                cellSize.Width = (int)(
                    Math.Abs(this.SeriesSymbolSize.Width) * singleWCharacterSize.Width / 100f
                );
                cellSize.Height = (int)(
                    Math.Abs(this.SeriesSymbolSize.Height) * singleWCharacterSize.Height / 100f
                );
            }
            else if (this.CellType == LegendCellType.Image)
            {
                ...
                {
                    cellSize.Width = (int)(
                        Math.Abs(this.ImageSize.Width) * singleWCharacterSize.Width / 100f
                    );
                    cellSize.Height = (int)(
                        Math.Abs(this.ImageSize.Height) * singleWCharacterSize.Height / 100f
                    );
                }
            }
            ...
            else
            {
                throw (
                    new InvalidOperationException(
                        SR.ExceptionLegendCellTypeUnknown(this.CellType.ToString())
                    )
                );
            }
            ...
            // Add cell margins
            cellSize.Width += (int)(
                (this.Margins.Left + this.Margins.Right) * singleWCharacterSize.Width / 100f
            );
            cellSize.Height += (int)(
                (this.Margins.Top + this.Margins.Bottom) * singleWCharacterSize.Height / 100f
            );
            ...
            if (this.BackColor.IsEmpty && this.Legend != null)
            {
                ...
                if (this.LegendItem != null)
                {
                    ...
                    if (cellIndex >= 0)
                    {
                        ...
                        if (
                            cellIndex < this.Legend.CellColumns.Count
                ...
                if (resultColor.IsEmpty && this.Legend.InterlacedRows && this._rowIndex % 2 != 0)
                {
        ...
        private Font GetCellFont(Font legendAutoFont, int fontSizeReducedBy, out bool disposeFont)
        {
            ...
            if (cellFont == null && this.Legend != null)
            {
            ...
            if (this.Legend != null)
            {
                ...
                if (recomendedTextLength > 0 && resultString.Length > recomendedTextLength)
                {
                    ...
                    for (int charIndex = 0; charIndex < resultString.Length; charIndex++)
                    {
                        ...
                        if (
                            char.IsWhiteSpace(resultString, charIndex)
                        ...
                        )
                        {
                            ...
                            lineLength = 0;
                            resultString =
                                resultString.Substring(0, charIndex)
                                + "\n"
        ...
        )
        {
            ...
            if (this.Common.ProcessModePaint)
            {
                ...
                RectangleF rectRelative = chartGraph.GetRelativeRectangle(
                    this.cellPositionWithMargins
                );
        ...
        )
        {
            ...
            using (SolidBrush fontBrush = new SolidBrush(this.GetCellForeColor()))
            {
                ...
                using (StringFormat format = new StringFormat(StringFormat.GenericDefault))
                {
                    ...
                    SizeF charSize = chartGraph.MeasureStringAbs(
                        this.GetCellText(),
                        cellFont,
                    ...
                    if (
                        charSize.Height > this.cellPosition.Height
        ...
        private void PaintCellImage(ChartGraphics chartGraph, Size singleWCharacterSize)
        {
            if (this.Image.Length > 0)
            {
                ...
                if (!this.ImageSize.IsEmpty)
                {
                    ...
                    {
                        int newWidth = (int)(
                            this.ImageSize.Width * singleWCharacterSize.Width / 100f
                        );
                    ...
                    {
                        int newHeight = (int)(
                            this.ImageSize.Height * singleWCharacterSize.Height / 100f
                        );
                ...
                if (imagePosition.Width > imageCellPosition.Width)
                {
                    scaleValue = Math.Max(
                        scaleValue,
                        (float)imagePosition.Width / (float)imageCellPosition.Width
                    );
                }
                ...
                // Get image location
                imagePosition.X = (int)(
                    (this.cellPosition.X + this.cellPosition.Width / 2f) - imagePosition.Width / 2f
                );
                imagePosition.Y = (int)(
                    (this.cellPosition.Y + this.cellPosition.Height / 2f)
                    - imagePosition.Height / 2f
                );
        ...
        private void PaintCellSeriesSymbol(ChartGraphics chartGraph, SizeF singleWCharacterSize)
        {
            ...
            {
                int newWidth = (int)(
                    this.SeriesSymbolSize.Width * singleWCharacterSize.Width / 100f
                );
                if (newWidth > this.cellPosition.Width)
                {
                    newWidth = this.cellPosition.Width;
            ...
            {
                int newHeight = (int)(
                    this.SeriesSymbolSize.Height * singleWCharacterSize.Height / 100f
                );
                if (newHeight > this.cellPosition.Height)
                {
                    newHeight = this.cellPosition.Height;
            ...
            // Get symbol location
            seriesMarkerPosition.X = (int)(
                (this.cellPosition.X + this.cellPosition.Width / 2f)
                - seriesMarkerPosition.Width / 2f
            );
            seriesMarkerPosition.Y = (int)(
                (this.cellPosition.Y + this.cellPosition.Height / 2f)
            ...
            if (legendItem.Image.Length > 0)
            {
                ...
                if (image != null)
                {
                    ...
                    if (imageScale.Width > seriesMarkerPosition.Width)
                    {
                        scaleValue = Math.Max(
                            scaleValue,
                            (float)imageScale.Width / (float)seriesMarkerPosition.Width
                        );
                    }
                    ...
                    imageScale.X = (int)(
                        (seriesMarkerPosition.X + seriesMarkerPosition.Width / 2f)
                        - imageScale.Width / 2f
                    );
                    imageScale.Y = (int)(
                        (seriesMarkerPosition.Y + seriesMarkerPosition.Height / 2f)
                        - imageScale.Height / 2f
                    );
            ...
            else
            {
                ...
                if (legendItem.ImageStyle == LegendImageStyle.Rectangle)
                {
                    ...
                    chartGraph.FillRectangleRel(
                        ...
                        (legendItem.BorderWidth > maxBorderWidthRect)
                            ? maxBorderWidthRect
                            : legendItem.BorderWidth,
                        legendItem.BorderDashStyle,
                        legendItem.ShadowColor,
                        (legendItem.ShadowOffset > maxShadowOffset)
                            ? maxShadowOffset
                            : legendItem.ShadowOffset,
                        PenAlignment.Inset
                    );
                }
                if (legendItem.ImageStyle == LegendImageStyle.Line)
                {
                    ...
                    chartGraph.DrawLineRel(
                        legendItem.Color,
                        (legendItem.borderWidth > maxBorderWidth)
                            ? maxBorderWidth
                            : legendItem.borderWidth,
                        legendItem.borderDashStyle,
                ...
                )
                {
                    ...
                    if (markerStyle != MarkerStyle.None || legendItem.markerImage.Length > 0)
                    {
                        ...
                        int markerSize = (int)
                            Math.Min(seriesMarkerPosition.Width, seriesMarkerPosition.Height);
                        markerSize = (int)
                            Math.Min(
                                legendItem.markerSize,
                        ...
                        int markerBorderWidth =
                            (legendItem.MarkerBorderWidth > maxBorderWidth)
                                ? maxBorderWidth
                                : legendItem.MarkerBorderWidth;
                        ...
                        if (legendItem.markerImage.Length > 0)
                        {
                            ...
                            ImageLoader.GetAdjustedImageSize(
                                image,
                                chartGraph.Graphics,
                                ref imageSize
                            );
                            ...
                            {
                                scaleValue =
                                    (float)imageScale.Height / (float)seriesMarkerPosition.Height;
                            }
                            if (imageScale.Width > seriesMarkerPosition.Width)
                            {
                                scaleValue = Math.Max(
                        ...
                        chartGraph.DrawMarkerRel(
                            ...
                            markerStyle,
                            markerSize,
                            (legendItem.markerColor == Color.Empty)
                                ? legendItem.Color
                                : legendItem.markerColor,
                            (legendItem.markerBorderColor == Color.Empty)
                                ? legendItem.borderColor
                                : legendItem.markerBorderColor,
                            markerBorderWidth,
                            legendItem.markerImage,
