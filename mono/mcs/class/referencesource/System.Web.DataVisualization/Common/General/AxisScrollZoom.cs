...
#endif
{
    ...
    /// </summary>
    [SRDescription("DescriptionAttributeAxisDataView_AxisDataView"), DefaultProperty("Position")]
#if ASPPERM_35
    ...
    public class AxisScaleView
    {
        ...
        public double Position
        {
            get
            {
                ...
                if (
                    ...
                    && this.axis.ChartArea.chartAreaIsCurcular
                )
                {
                    return Double.NaN;
                }
            ...
            set
            {
                ...
                if (_position != value)
                {
                    ...
                    if (
                        this.axis != null
                        && this.axis.ChartArea != null
                        && this.axis.Common != null
                        && this.axis.Common.ChartPicture != null
                    )
                    {
                        if (!this.axis.ChartArea.alignmentInProcess)
                        {
                            AreaAlignmentOrientations orientation =
                                (
                                    this.axis.axisType == AxisName.X
                                    || this.axis.axisType == AxisName.X2
                                )
        ...
        public bool IsZoomed
        {
            ...
            {
                return (
                    !double.IsNaN(this.Size) && this.Size != 0.0 && !double.IsNaN(this.Position)
                );
            }
        }
        ...
        {
            get { return _smallScrollSizeType; }
            set
            {
                if (_smallScrollSizeType != value)
                {
                    // Set size type
                    _smallScrollSizeType =
                        (value != DateTimeIntervalType.NotSet) ? value : DateTimeIntervalType.Auto;
        ...
        {
            get { return _smallScrollMinSize; }
            set
            {
        ...
        {
            get { return _smallScrollMinSizeType; }
            set
            {
                if (_smallScrollMinSizeType != value)
                {
                    // Set size type
                    _smallScrollMinSizeType =
                        (value != DateTimeIntervalType.NotSet) ? value : DateTimeIntervalType.Auto;
        ...
        public double ViewMaximum
        {
            get
            {
                ...
                if (!Double.IsNaN(this.Size))
                {
                    ...
                    {
                        // Get axis interval
                        double viewSize = ChartHelper.GetIntervalSize(
                            this.Position,
                            this.Size,
                            this.SizeType
                        );
        ...
        internal void Scroll(ScrollType scrollType, bool fireChangeEvents)
        {
            ...
            switch (scrollType)
            {
                case (ScrollType.SmallIncrement):
                    newPosition +=
                        ...
                        * ChartHelper.GetIntervalSize(
                            this._position,
                            this.GetScrollingLineSize(),
                            this.GetScrollingLineSizeType()
                        );
                    break;
                ...
                case (ScrollType.LargeIncrement):
                    newPosition +=
                        ((axis.IsReversed) ? -1 : 1)
                        * ChartHelper.GetIntervalSize(this._position, this.Size, this.SizeType);
                    break;
            ...
            if (numberOfViews < 0)
            {
                throw (
                    new ArgumentOutOfRangeException(
                        "numberOfViews",
                        SR.ExceptionScrollBarZoomResetsNumberInvalid
                    )
                );
            }
        ...
        private void GetCurrentViewSmallScrollSize()
        {
            ...
            if (double.IsNaN(_currentSmallScrollSize))
            {
                ...
                if (
                    ...
                    || this.SizeType == DateTimeIntervalType.Number
                )
                {
                    // Set line size type
                ...
                else
                {
                    ...
                    double viewEndPosition =
                        this.Position
                        + ChartHelper.GetIntervalSize(this.Position, this.Size, this.SizeType);
                ...
                if (!double.IsNaN(this.SmallScrollMinSize) && this.SmallScrollMinSize != 0.0)
                {
                    double newLineSize = ChartHelper.GetIntervalSize(
                        this.Position,
                        _currentSmallScrollSize,
                        _currentSmallScrollSizeType
                    );
                    double minLineSize = ChartHelper.GetIntervalSize(
                        this.Position,
                        this.SmallScrollMinSize,
                        this.SmallScrollMinSizeType
                    );
        ...
        private void ValidateViewPositionSize(
            ref double viewPosition,
            ref double viewSize,
            ref DateTimeIntervalType viewSizeType
        )
        {
            //****************************************************************
            ...
            {
                if (
                    viewSizeType == DateTimeIntervalType.Auto
            ...
            {
                minViewSize = ChartHelper.GetIntervalSize(
                    viewPosition,
                    this.MinSize,
                    this.MinSizeType
                );
    ...
    #region Constructors
        ...
        public ViewEventArgs(
            ...
            double newPosition,
            double newSize,
            DateTimeIntervalType newSizeType
        )
        {
            this._axis = axis;
            this._newPosition = newPosition;
...
#endif
{
    ...
    internal class DoubleDateNanValueConverter : DoubleConverter
    {
        ...
        )
        {
            ...
            {
                if (
                    axisValuesType == ChartValueType.DateTime
