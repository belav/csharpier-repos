...
#endif
    {
            ...
            set
            {
                if (value < 0)
                {
                    throw (
                        new ArgumentOutOfRangeException(
                            "value",
                            SR.ExceptionTitleBorderWidthIsNegative
                        )
                    );
                }
                _borderWidth = value;
        ...
        internal bool IsVisible()
        {
            if (this.Visible)
            {
                ...
                if (this.DockedToChartArea.Length > 0 && this.Chart != null)
                {
            ...
            if (Chart != null)
            {
                ...
                if (invalidateTitleOnly)
                {
                    ...
                    if (this.Position.Width != 0 && this.Position.Height != 0)
                    {
                        ...
                        invalRect.X = (int)(
                            this.Position.X * (Common.ChartPicture.Width - 1) / 100F
                        );
                        invalRect.Y = (int)(
                            this.Position.Y * (Common.ChartPicture.Height - 1) / 100F
                        );
                        invalRect.Width = (int)(
                            this.Position.Width * (Common.ChartPicture.Width - 1) / 100F
                        );
                        invalRect.Height = (int)(
                            this.Position.Height * (Common.ChartPicture.Height - 1) / 100F
                        );
        ...
        internal void Paint(ChartGraphics chartGraph)
        {
            ...
            else
            {
                ...
                {
                    exactTitleRect.Y =
                        titlePosition.Y + titlePosition.Height / 2f - exactTitleRect.Height / 2f;
                }
                ...
                {
                    exactTitleRect.X =
                        titlePosition.X + titlePosition.Width / 2f - exactTitleRect.Width / 2f;
                }
            ...
            using (StringFormat format = new StringFormat())
            {
                ...
                if (
                    (textStyle == TextStyle.Default || textStyle == TextStyle.Shadow)
        ...
        )
        {
            ...
            if (titleText.Length > 0)
            {
                ...
                {
                    // Draw shadow
                    RectangleF shadowPosition = new RectangleF(
                    ...
                    shadowPosition.X += 2;
                    shadowPosition.Y += 2;
                    Color texthighlightColor = ChartGraphics.GetGradientColor(
                        Color.White,
                        foreColor,
                        0.3
                    );
                    ...
                    )
                    {
                        throw (
                            new ArgumentException(
                                SR.ExceptionChartTitleDockedChartAreaIsMissing(
                    ...
                    )
                    {
                        ...
                        if (title.Docking == Docking.Top)
                        {
                            ...
                            if (!area.Position.Auto)
                            {
                                ...
                                prevChartAreasRectangle.Height +=
            ...
            if (chartPicture != null)
            {
                ...
                foreach (ChartArea area in chartPicture.ChartAreas)
                {
                    ...
                    if (area.Visible)
                    {
                        ...
                        // Get elemets spacing
                        float areaSpacing = Math.Min(
                            (titlePlottingRectangle.Height / 100F) * elementSpacing,
                            (titlePlottingRectangle.Width / 100F) * elementSpacing
                        );
