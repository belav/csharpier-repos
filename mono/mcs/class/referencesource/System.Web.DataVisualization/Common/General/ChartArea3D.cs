...
#else
using System.Web.UI.DataVisualization.Charting;using System.Web.UI.DataVisualization.Charting.ChartTypes;using System.Web.UI.DataVisualization.Charting.Utilities;using System.Web.UI;
#endif
...
#endif
{
                ...
                if (value < 0 || value > 100)
                {
                    throw (
                        new ArgumentOutOfRangeException(
                            "value",
                            SR.ExceptionChartArea3DPerspectiveInvalid
                        )
                    );
                }
            ...
            set
            {
                if (value < -90 || value > 90)
                {
                    throw (
                        new ArgumentOutOfRangeException(
                            "value",
                            SR.ExceptionChartArea3DInclinationInvalid
                        )
                    );
                }
                _inclination = value;
            ...
            set
            {
                if (value < -180 || value > 180)
                {
                    throw (
                        new ArgumentOutOfRangeException(
                            "value",
                            SR.ExceptionChartArea3DRotationInvalid
                        )
                    );
                }
                _rotation = value;
            ...
            set
            {
                if (value < 0 || value > 30)
                {
                    throw (
                        new ArgumentOutOfRangeException(
                            "value",
                            SR.ExceptionChartArea3DWallWidthInvalid
                        )
                    );
                }
            ...
            set
            {
                if (value < 0 || value > 1000)
                {
                    throw (
                        new ArgumentOutOfRangeException(
                            "value",
                            SR.ExceptionChartArea3DPointsDepthInvalid
                        )
                    );
                }
            ...
            set
            {
                if (value < 0 || value > 1000)
                {
                    throw (
                        new ArgumentOutOfRangeException(
                            "value",
                            SR.ExceptionChartArea3DPointsGapInvalid
                        )
                    );
                }
    ...
    public partial class ChartArea
    {
        ...
        internal void DrawArea3DScene(ChartGraphics graph, RectangleF position)
        {
            ...
            areaSceneWallWidth = graph.GetRelativeSize(
            ...
            //***********************************************************
            _visibleSurfaces = graph.GetVisibleSurfaces(position, 0, areaSceneDepth, this.matrix3D);
        ...
        private float GetArea3DSceneDepth()
        {
            ...
            {
                bool sameInterval;
                clusteredInterval = this.GetPointsInterval(
                    this._series,
                    xAxis.IsLogarithmic,
                    xAxis.logarithmBase,
                    false,
            ...
            if (
                smallestIntervalSeries != null
                && smallestIntervalSeries.XAxisType == AxisType.Secondary
            )
            {
                    ...
                    foreach (string seriesName in this._series)
                    {
                        ...
                        if (
                            String.Compare(
                                ...
                                smallestIntervalSeries.ChartTypeName,
                ...
                )
                {
                    ...
                    foreach (string seriesName in this._series)
                    {
                        ...
                        )
                        {
                            ...
                            {
                                seriesStackGroupName = curSeries[
        ...
        internal void GetSeriesZPositionAndDepth(
            Series series,
            out float depth,
            out float positionZ
        )
        {
            ...
            positionZ = (float)(
                _pointsGapDepth / 2.0 + (_pointsDepth + _pointsGapDepth) * seriesIndex
            );
        }
        ...
        internal int GetNumberOfClusters()
        {
            if (this.seriesClusters == null)
            {
                ...
                foreach (string seriesName in this._series)
                {
                    ...
                    {
                        // Get group name
                        string stackGroupName = StackedColumnChart.GetSeriesStackGroupName(
                            curSeries
                        );
                        ...
                        if (processedStackedGroups.Contains(stackGroupName))
                        {
                            ...
                            for (
                                int index = 0;
                                !found && index < this.seriesClusters.Count;
                                index++
                            )
                            {
        ...
        internal void Estimate3DInterval(ChartGraphics graph)
        {
            ...
            foreach (Axis axis in area.Axes)
            {
                ...
                size = Math.Sqrt(
                    (points[axisIndx].X - points[axisIndx + 1].X)
                        * (points[axisIndx].X - points[axisIndx + 1].X)
                        + (points[axisIndx].Y - points[axisIndx + 1].Y)
                            * (points[axisIndx].Y - points[axisIndx + 1].Y)
                );
                ...
                else
                {
                    if (area.switchValueAxes)
                        ...
                        axis.interval3DCorrection =
                            size / plottingRect.Height * plottingChartAreaCorrection;
                }
        ...
        internal bool DrawPointsToCenter(ref COPCoordinates coord)
        {
            ...
            if (this.Area3DStyle.Perspective != 0)
            {
                if ((coord & COPCoordinates.X) == COPCoordinates.X)
                {
                    ...
                    if (
                        (this._visibleSurfaces & SurfaceNames.Left) == 0
                ...
                if ((coord & COPCoordinates.Y) == COPCoordinates.Y)
                {
                    ...
                    if (
                        (this._visibleSurfaces & SurfaceNames.Top) == 0
                ...
                if ((coord & COPCoordinates.Z) == COPCoordinates.Z)
                {
                    ...
                    if (
                        (this._visibleSurfaces & SurfaceNames.Front) == 0
        ...
        private List<Series> GetSeriesDrawingOrder(bool reverseSeriesOrder)
        {
            ...
            if (DrawSeriesToCenter() && this.matrix3D.IsInitialized())
            {
                ...
                if (!float.IsNaN(areaProjectionCenter.Z))
                {
                    ...
                    for (int seriesIndex = 0; seriesIndex < seriesList.Count; seriesIndex++)
                    {
                        ...
                        float seriesDepth,
                            seriesZPosition;
                        this.GetSeriesZPositionAndDepth(
        ...
        )
        {
            ...
            foreach (object seriesName in seriesNamesList)
            {
                ...
                // Get column width
                double width =
                    ser.GetPointWidth(area.Common.graph, hAxis, interval, 0.8) / numOfSeries;
                ...
                foreach (DataPoint point in ser.Points)
                {
                    ...
                    double yValue = chartType.GetYValue(
                        Common,
                        area,
                        ser,
                        point,
                    ...
                    pointEx.height = vAxis.GetPosition(
                        yValue - chartType.GetYValue(Common, area, ser, point, index - 1, -1)
                    );
        ...
        internal class PointsDrawingOrderComparer : IComparer
        {
            ...
            public int Compare(object o1, object o2)
            {
                ...
                if (point1.xPosition != point2.xPosition)
                {
                    ...
                    {
                        if (
                            (point1.xPosition + point1.width / 2f) >= _areaProjectionCenter.X
        ...
        internal Point3D GetCenterOfProjection(COPCoordinates coord)
        {
            ...
            points[1] = new Point3D(
                this.PlotAreaPosition.Right,
                this.PlotAreaPosition.Y,
                this.areaSceneDepth
            );

            // Check if surfaces (points 1 & 2) has same orientation
            bool xSameOrientation,
                ySameOrientation,
                zSameOrientation;
            ...
            if (
                (((coord & COPCoordinates.X) != COPCoordinates.X) || xSameOrientation)
            ...
            interval.Height =
                interval.Height * 100F / ((float)(this.Common.Chart.Height.Value - 1));
            ...
            while (!doneFlag)
            {
                ...
                doneFlag = true;
                if (
                    (coord & COPCoordinates.X) == COPCoordinates.X
                ...
                if (
                    (coord & COPCoordinates.Y) == COPCoordinates.Y
                ...
                if (
                    (coord & COPCoordinates.Z) == COPCoordinates.Z
        ...
        )
        {
            ...
            if ((coord & COPCoordinates.X) == COPCoordinates.X)
            {
                ...
                this.matrix3D.TransformPoints(pointsSurface);
                surf2 = ChartGraphics.IsSurfaceVisible(
                    pointsSurface[0],
                    pointsSurface[1],
                    pointsSurface[2]
                );
