...
#endif
{
    ...
    public partial class ChartArea : ChartNamedElement
    {
        ...
        {
            get { return _alignWithChartArea; }
            set
            {
        ...
        public ElementPosition Position
        {
            get
            {
                ...
                if (
                    this.Chart != null
                    && this.Chart.serializationStatus == SerializationStatus.Saving
                )
                {
...
#endif
                        newPosition.SetPositionNoAuto(
                            _areaPosition.X,
                            _areaPosition.Y,
                            _areaPosition.Width,
                            _areaPosition.Height
                        );
                        return newPosition;
                    }
                }
        ...
        public ElementPosition InnerPlotPosition
        {
            get
            {
                ...
                if (
                    ...
                    && this.Common.Chart.serializationStatus == SerializationStatus.Saving
                )
                {
...
#endif
                        newPosition.SetPositionNoAuto(
                            _innerPlotPosition.X,
                            _innerPlotPosition.Y,
                            _innerPlotPosition.Width,
                            _innerPlotPosition.Height
                        );
                        return newPosition;
                    }
                }
        ...
        public int BorderWidth
        {
            ...
            set
            {
                ...
                {
                    throw (
                        new ArgumentOutOfRangeException("value", SR.ExceptionBorderWidthIsNegative)
                    );
                }
                _borderWidth = value;
                Invalidate();
        ...
        {
            get { return _isSameFontSizeForAllAxes; }
            set
            {
        ...
        internal void GetTempValues()
        {
            ...
            if (!this.originalAreaPosition.IsEmpty)
            {
                ...
                this.Position
                    .SetPositionNoAuto(
                        this.originalAreaPosition.X,
                        this.originalAreaPosition.Y,
                        this.originalAreaPosition.Width,
            ...
            if (!this.originalInnerPlotPosition.IsEmpty)
            {
                this.InnerPlotPosition
                    .SetPositionNoAuto(
                        this.originalInnerPlotPosition.X,
                        this.originalInnerPlotPosition.Y,
                        this.originalInnerPlotPosition.Width,
        ...
        internal RectangleF GetBackgroundPosition(bool withScrollBars)
        {
            ...
            RectangleF backgroundPositionWithScrollBars = new RectangleF(
            ...
            if (requireAxes)
            {
                ...
                foreach (Axis axis in this.Axes)
                {
                    ...
                    if (axis.ScrollBar.IsVisible && axis.ScrollBar.IsPositionedInside)
                    {
                        ...
                        {
                            backgroundPositionWithScrollBars.Height += (float)
                                axis.ScrollBar.GetScrollBarRelativeSize();
                        }
                        else if (axis.AxisPosition == AxisPosition.Top)
                        {
                            backgroundPositionWithScrollBars.Y -= (float)
                                axis.ScrollBar.GetScrollBarRelativeSize();
                            backgroundPositionWithScrollBars.Height += (float)
                                axis.ScrollBar.GetScrollBarRelativeSize();
                        }
                        ...
                        {
                            backgroundPositionWithScrollBars.X -= (float)
                                axis.ScrollBar.GetScrollBarRelativeSize();
                            backgroundPositionWithScrollBars.Width += (float)
                                axis.ScrollBar.GetScrollBarRelativeSize();
                        }
                        else if (axis.AxisPosition == AxisPosition.Left)
                        {
        ...
        internal void Resize(ChartGraphics chartGraph)
        {
            ...
            if (this.IsSameFontSizeForAllAxes)
            {
                ...
                foreach (Axis axis in axisArray)
                {
                    ...
                    if (axis.enabled)
                    {
                        // Resize axis
                        if (
                            axis.AxisPosition == AxisPosition.Bottom
                            || axis.AxisPosition == AxisPosition.Top
                        )
                        {
                            axis.Resize(
                                chartGraph,
            ...
            foreach (Axis axis in axisArray)
            {
                ...
                if (!axis.enabled)
                {
                    ...
                    {
                        SizeF areaWallSize = chartGraph.GetRelativeSize(
                            new SizeF(this.Area3DStyle.WallWidth, this.Area3DStyle.WallWidth)
                        );
                        if (axis.AxisPosition == AxisPosition.Bottom)
                        {
                    ...
                    if (addLabelsSideOffsets)
                    {
                        ...
                        )
                        {
                            if (axis.labelNearOffset != 0 && axis.labelNearOffset < Position.X)
                            {
                                ...
                                rectLabelSideSpacing.X = (float)
                                    Math.Max(offset, rectLabelSideSpacing.X);
                            }

                            if (axis.labelFarOffset > Position.Right)
                            {
                                if (
                                    (axis.labelFarOffset - Position.Right)
                                    < plottingRect.Width * 0.3f
                                )
                                {
                                    rectLabelSideSpacing.Width = (float)
                                        Math.Max(
                                            axis.labelFarOffset - Position.Right,
                        ...
                        else
                        {
                            if (axis.labelNearOffset != 0 && axis.labelNearOffset < Position.Y)
                            {
                                ...
                                rectLabelSideSpacing.Y = (float)
                                    Math.Max(offset, rectLabelSideSpacing.Y);
                            }

                            if (axis.labelFarOffset > Position.Bottom)
                            {
                                if (
                                    (axis.labelFarOffset - Position.Bottom)
                                    < plottingRect.Height * 0.3f
                                )
                                {
                                    rectLabelSideSpacing.Height = (float)
                                        Math.Max(
                                            axis.labelFarOffset - Position.Bottom,
                                            rectLabelSideSpacing.Height
                                        );
                                }
                                else
                                {
            ...
            {
                if (
                    rectLabelSideSpacing.Y > 0
                    && rectLabelSideSpacing.Y > plottingRect.Y - Position.Y
                )
                {
                ...
                if (
                    rectLabelSideSpacing.X > 0
                    && rectLabelSideSpacing.X > plottingRect.X - Position.X
                )
                {
                ...
                if (
                    rectLabelSideSpacing.Height > 0
                    && rectLabelSideSpacing.Height > Position.Bottom - plottingRect.Bottom
                )
                {
                    plottingRect.Height +=
                ...
                if (
                    rectLabelSideSpacing.Width > 0
                    && rectLabelSideSpacing.Width > Position.Right - plottingRect.Right
                )
                {
                    plottingRect.Width +=
            ...
            if (this.chartAreaIsCurcular)
            {
                ...
                this.circularCenter = new PointF(
                    plottingRect.X + plottingRect.Width / 2f,
                    plottingRect.Y + plottingRect.Height / 2f
                );
            ...
            if (!borderOnly)
            {
                ...
                if (!this.Area3DStyle.Enable3D || !requireAxes || chartAreaIsCurcular)
                {
                    ...
                    graph.FillRectangleRel(
                        ...
                        PenAlignment.Outset,
                        chartAreaIsCurcular,
                        (chartAreaIsCurcular && this.CircularUsePolygons)
        ...
        internal void Paint(ChartGraphics graph)
        {
            ...
            if (!requireAxes && ChartTypes.Count != 0)
            {
                ...
                {
                    IChartType chartType = Common.ChartTypeRegistry
            ...
            foreach (Axis currentAxis in this._axisArray)
            {
                ...
                currentAxis.paintAreaPositionBottom =
                    currentAxis.paintAreaPosition.Y + currentAxis.paintAreaPosition.Height;
                currentAxis.paintAreaPositionRight =
                    currentAxis.paintAreaPosition.X + currentAxis.paintAreaPosition.Width;
                if (
                    currentAxis.AxisPosition == AxisPosition.Top
                    || currentAxis.AxisPosition == AxisPosition.Bottom
                )
                ...
                {
                    currentAxis.valueMultiplier =
                        currentAxis.paintChartAreaSize / currentAxis.paintRange;
                }
            }
            ...
            if (!this.Area3DStyle.Enable3D || this.chartAreaIsCurcular)
            {
                ...
                foreach (ChartTypeAndSeriesInfo chartTypeInfo in typeAndSeries)
                {
                    ...
                    IChartType type = Common.ChartTypeRegistry
        ...
        [SuppressMessage(
            ...
            Justification = "These parameters are used when compiling for the Microsoft version of Chart"
        )]
        internal void PaintCursors(ChartGraphics graph, bool cursorOnly)
        {
            ...
            if (this.Position.Width == 0f || this.Position.Height == 0f)
            {
                return;
            }
            ...
            if (
                !double.IsNaN(_cursorX.SelectionStart)
            ...
            {
                if (!chartPicture.backgroundRestored && !chartPicture.isSelectionMode)
                {
                    chartPicture.backgroundRestored = true;

                    Rectangle chartPosition = new Rectangle(
                        0,
                        0,
                        chartPicture.Width,
                        chartPicture.Height
                    ...
                    Rectangle absAreaPlotPosition = Rectangle.Round(
                        graph.GetAbsoluteRectangle(PlotAreaPosition.ToRectangleF())
                    );
                    int maxCursorWidth =
                        (CursorY.LineWidth > CursorX.LineWidth)
                            ? CursorY.LineWidth + 1
                            : CursorX.LineWidth + 1;
                    ...
                    )
                    {
                        ...
                        {
                            areaBufferBitmap = chart.paintBufferBitmap
                    ...
                    else if (cursorOnly && chartPicture.nonTopLevelChartBuffer != null)
                    {
                        ...
                        chart.paintBufferBitmapGraphics
        ...
        )
        {
            ...
            RectangleF areaRectAbs = chartGraph.GetAbsoluteRectangle(
                chartAreaPosition.ToRectangleF()
            );

            // Get absolute markers size and spacing
            float spacing = chartGraph
                .GetAbsolutePoint(new PointF(0, this.AxisX.markSize + Axis.elementSpacing))
                .Y;
            ...
            if (this.AxisX.LabelStyle.Enabled && this.AxisX.IsLabelAutoFit)
            {
                ...
                labelsSizeEstimate = (float)
                    Math.Min(labelsSizeEstimate * 1.1f, plotAreaRectAbs.Width / 5f);
                labelsSizeEstimate += spacing;

                // Calculate auto-fit font
                this.AxisX
                    .GetCircularAxisLabelsAutoFitFont(
                        chartGraph,
                        axisList,
                        labelsStyle,
                        plotAreaRectAbs,
            ...
            // Get labels size
            float labelsSize = GetCircularLabelsSize(
                chartGraph,
                areaRectAbs,
                plotAreaRectAbs,
                titleSize
        ...
        )
        {
            ...
            SizeF areaDiff = new SizeF(
                plotAreaRectAbs.X - areaRectAbs.X,
            ...
            foreach (CircularChartAreaAxis axis in axisList)
            {
                ...
                {
                    labelsSize = (float)Math.Max(labelsSize, textSize.Height);
                }
                else if (labelsStyle == CircularAxisLabelsStyle.Radial)
                {
                    ...
                    labelsSize = (float)Math.Max(labelsSize, Math.Max(width, height));
                }
                else if (labelsStyle == CircularAxisLabelsStyle.Horizontal)
                {
                    ...
                    labelsSize = (float)Math.Max(labelsSize, Math.Max(width, textSize.Height));
                }
            }
                    ...
                    foreach (Series series in this.Common.DataManager.Series)
                    {
                        if (series.ChartArea == this.Name && series.IsVisible())
                        {
                            ...
                            if (series.IsCustomPropertySet(CustomPropertyName.AreaDrawingStyle))
                            {
                                if (
                                    String.Compare(
                                        series[CustomPropertyName.AreaDrawingStyle],
                                        "Polygon",
        ...
        internal CircularAxisLabelsStyle GetCircularAxisLabelsStyle()
        {
            ...
            foreach (Series series in this.Common.DataManager.Series)
            {
                if (
                    ...
                    && series.IsCustomPropertySet(CustomPropertyName.CircularLabelsStyle)
                )
                {
                    ...
                    if (String.Compare(styleName, "Auto", StringComparison.OrdinalIgnoreCase) == 0)
                    {
                        ...
                        String.Compare(styleName, "Circular", StringComparison.OrdinalIgnoreCase)
                        == 0
                    )
                    {
                    ...
                    )
                    {
                        ...
                        String.Compare(styleName, "Horizontal", StringComparison.OrdinalIgnoreCase)
                        == 0
                    )
                    {
        ...
        internal ArrayList GetCircularAxisList()
        {
            ...
            if (_circularAxisList == null)
            {
                ...
                for (int sectorIndex = 0; sectorIndex < sectorNumber; sectorIndex++)
                {
                    ...
                    CircularChartAreaAxis axis = new CircularChartAreaAxis(
                        sectorIndex * 360f / sectorNumber
                    );
                    ...
                    else
                    {
                        ...
                        foreach (Series series in this.Common.DataManager.Series)
                        {
                            if (
                                series.IsVisible()
                                && series.ChartArea == this.Name
                                && sectorIndex < series.Points.Count
                            )
                            {
                        ...
                        if (!processedChartType.Contains(series.ChartTypeName))
                        {
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    for (
                                        int curentSeriesIndex = seriesIndex + 1;
                                        curentSeriesIndex < this.Common.DataManager.Series.Count;
                                        curentSeriesIndex++
                                    )
                                    {
                                        if (
                                ...
                                else
                                {
                                    // Add a record to process all series of that chart type at once
                                    resultList.Add(
                                        new ChartTypeAndSeriesInfo(series.ChartTypeName)
                                    );
                                    processedChartType.Add(series.ChartTypeName);
                                }
                            }
