...
#endif
{
    ...
    internal class ChartHelper
    {
        ...
        internal static double AlignIntervalStart(
            double start,
            double intervalSize,
            ...
            else
            {
                ...
                switch (type)
                {
                    ...
                    case (DateTimeIntervalType.Minutes):
                        int minute = (int)(
                            (int)(newStartDate.Minute / intervalSize) * intervalSize
                        );
                        newStartDate = new DateTime(
                            newStartDate.Year,
                            newStartDate.Month,
                    ...
                    case (DateTimeIntervalType.Seconds):
                        int second = (int)(
                            (int)(newStartDate.Second / intervalSize) * intervalSize
                        );
                        newStartDate = new DateTime(
                            newStartDate.Year,
                            newStartDate.Month,
                    ...
                    case (DateTimeIntervalType.Milliseconds):
                        int milliseconds = (int)(
                            (int)(newStartDate.Millisecond / intervalSize) * intervalSize
                        );
                        newStartDate = new DateTime(
                            newStartDate.Year,
                            newStartDate.Month,
        ...
        )
        {
            ...
            if (series != null && series.IsXValueIndexed)
            {
                ...
                if (pointIndex == 0 && current < 0)
                {
                    ...
                    if (
                        roundedDateValue.ToOADate() == xValue
                        || roundedDateValue.ToOADate() == xEndValue
                    )
                    {
                        return -current + 1;
                    }
