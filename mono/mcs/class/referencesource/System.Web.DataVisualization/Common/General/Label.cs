...
#endif
{
        ...
        )
        {
            ...
            try
            {
                ...
                while (labelStart < toX)
                {
                    ...
                    {
                        labelEnd = DateTime
                            .FromOADate(labelStart)
                            .AddMilliseconds(labelsStep)
                            .ToOADate();
                    }
                    ...
                    else
                    {
                        ...
                        throw (
                            new ArgumentException(
                                SR.ExceptionAxisLabelsIntervalTypeUnsupported(
    ...
    /// </summary>
    [SRDescription("DescriptionAttributeCustomLabel_CustomLabel"), DefaultProperty("Text"),]
#if Microsoft_CONTROL
...
#endif
    {
        ...
        {
            set { this._imageMapAreaAttributes = value; }
            get { return this._imageMapAreaAttributes; }
        }
        ...
        {
            get { return this._imagePostbackValue; }
            set { this._imagePostbackValue = value; }
        }
#endif // !Microsoft_CONTROL
        ...
        public int RowIndex
        {
            get { return this._labelRowIndex; }
            set
            {
                if (value < 0)
                {
    ...
    /// drawing them.
    /// </summary>
    [SRDescription("DescriptionAttributeLabel_Label"), DefaultProperty("Enabled"),]
#if ASPPERM_35
    [AspNetHostingPermission(
        System.Security.Permissions.SecurityAction.InheritanceDemand,
        Level = AspNetHostingPermissionLevel.Minimal
    ...
    public class LabelStyle : ChartElement
    {
                ...
                */
                ...
                foreach (CircularChartAreaAxis circAxis in circularAxes)
                {
                    if (circAxis.Title.Length > 0)
                    {
                        ...
                        {
                            graph.GetAbsolutePoint(labelRelativePosition)
                        };
                        ...
                        newMatrix.RotateAt(
                            labelAngle,
                            graph.GetAbsolutePoint(this._axis.ChartArea.circularCenter)
                        );
                        ...
                        {
                            SizeF size = graph.MeasureString(
                                circAxis.Title.Replace("\\n", "\n"),
                                (_axis.autoLabelFont == null) ? _font : _axis.autoLabelFont
                            );
                            RectangleF labelRect = GetLabelPosition(labelPosition[0], size, format);
                ...
                foreach (CustomLabel label in this._axis.CustomLabels)
                {
                    ...
                    if (label.RowIndex == 0)
                    {
                        ...
                        if (ajaxScrollingEnabled)
                        {
                            ...
                            if (
                                (decimal)label.ToPosition < viewMin
                            ...
                            )
                            {
                                ...
                                while (currentPosition < _axis.Maximum)
                                {
                                    ...
                                    currentPosition += ChartHelper.GetIntervalSize(
                                        currentPosition,
                                        _axis.LabelStyle.GetInterval(),
                                        _axis.LabelStyle.GetIntervalType(),
                                        axisSeries,
                                        0.0,
                        ...
                        else
                        {
                            ...
                            if ((decimal)middlePoint < viewMin || (decimal)middlePoint > viewMax)
                            {
                                continue;
                            }
                        }
                        ...
                        // zooming levels.
                        if (
                            (decimal)label.FromPosition < viewMin
                    ...
                    else
                    {
                        ...
                        if (
                            label.ToPosition <= _axis.ViewMinimum
                            || label.FromPosition >= _axis.ViewMaximum
                        )
                        {
                            continue;
                        }
                        ...
                        if (!ajaxScrollingEnabled && _axis.ScaleView.IsZoomed)
                        {
                    ...
                    else if (label.RowIndex > 0)
                    {
                        if (_axis.AxisPosition == AxisPosition.Left)
                        {
                            ...
                            for (
                                int index = _axis.groupingLabelSizes.Length;
                    ...
                    using (
                        Brush brush = new SolidBrush(
                            (label.ForeColor.IsEmpty) ? _foreColor : label.ForeColor
                        )
                    )
                    {
                        graph.DrawLabelStringRel(
                            ...
                            (!this.TruncatedLabels || label.RowIndex > 0)
                                ? RectangleF.Empty
                                : boundaryRect,
                            label,
                            truncatedLeft,
        ...
        private RectangleF GetAllLabelsRect(
            ChartArea area,
        ...
        )
        {
            ...
            if (position == AxisPosition.Left)
            {
                ...
                if (labelsAxis.GetIsMarksNextToAxis())
                {
                    ...
                    rectLabels.Width = (float)
                        Math.Max(rectLabels.Width, rectLabels.X - labelsAxis.PlotAreaPosition.X);
                }
                else
                {
            ...
            else if (position == AxisPosition.Top)
            {
                ...
                if (labelsAxis.GetIsMarksNextToAxis())
                {
                    ...
                    rectLabels.Height = (float)
                        Math.Max(rectLabels.Height, rectLabels.Y - labelsAxis.PlotAreaPosition.Y);
                }
                else
                {
        ...
        internal void Paint3D(ChartGraphics graph, bool backElements)
        {
            ...
            using (StringFormat format = new StringFormat())
            {
                ...
                if (adjustForWallWidth && this._axis.ChartArea.Area3DStyle.WallWidth > 0)
                {
                    ...
                    {
                        labelsZPosition -=
                            this._axis.MajorTickMark.Size
                            + this._axis.ChartArea.areaSceneWallWidth.Width;
                    }
                    else if (this._axis.MajorTickMark.TickMarkStyle == TickMarkStyle.AcrossAxis)
                    {
                        labelsZPosition -=
                            this._axis.MajorTickMark.Size / 2f
                            + this._axis.ChartArea.areaSceneWallWidth.Width;
                    }
                }
                ...
                //** Initialize all labels position rectangle
                //********************************************************************
                RectangleF rectLabels = this.GetAllLabelsRect(
                    this._axis.ChartArea,
                    this._axis.AxisPosition,
                    format
                );
                ...
                for (
                    int selectionRow = 0;
                    selectionRow <= this._axis.GetGroupLabelLevelCount();
                    selectionRow++
                )
                {
                    //********************************************************************
                    ...
                    foreach (CustomLabel label in this._axis.CustomLabels)
                    {
                        ...
                        if (label.RowIndex == 0)
                        {
                            double middlePoint = (label.FromPosition + label.ToPosition) / 2.0;
                            if (
                                (decimal)middlePoint < (decimal)_axis.ViewMinimum
                        ...
                        else
                        {
                            throw (
                                new InvalidOperationException(
                                    SR.ExceptionAxisLabelRowIndexMustBe1Or2
                                )
                            );
                        }
                        ...
                        else if (this._axis.AxisPosition == AxisPosition.Top)
                        {
                            ...
                            {
                                RectangleF rightLabelsRect = this.GetAllLabelsRect(
                                    this._axis.ChartArea,
                                    labelsPosition,
                                    format
                                );
                        ...
                        if (labelsPosition != this._axis.AxisPosition)
                        {
                            ...
                            else if (this._axis.AxisPosition == AxisPosition.Bottom)
                            {
                                if (labelsPosition == AxisPosition.Left && labelsFontAngle > 0)
                                {
                                    ...
                                    labelsPosition == AxisPosition.Right && labelsFontAngle < 0
                                )
                                {
                                    labelsFontAngle = -labelsFontAngle;
                                }
                        ...
                        )
                        {
                            if (firstLabelsRowHeight == -1f)
                            {
                                ...
                                labelPositionPoints[0] = new Point3D(
                                    initialRect.X,
                                    initialRect.Bottom
                                        - _axis.totlaGroupingLabelsSize
                                        - _axis.totlaGroupingLabelsSizeAdjustment,
        ...
        public Font Font
        {
            ...
            set
            {
                ...
                if (
                    this._axis != null
                    && this._axis.Common != null
                    && this._axis.Common.Chart != null
                )
                {
                ...
                if (value < -90 || value > 90)
                {
                    throw (
                        new ArgumentOutOfRangeException(
                            "value",
                            SR.ExceptionAxisLabelFontAngleInvalid
                        )
                    );
                }
