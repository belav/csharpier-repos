...
namespace System.Windows.Forms.DataVisualization.Charting
{
    ...
    public class AxisScrollBar : IDisposable
    {
        ...
        {
            get { return _isPositionedInside; }
            set
            {
        ...
        {
            get { return this.axis.ChartArea; }
        }
        ...
        {
            get { return _scrollBarButtonStyle; }
            set
            {
                    ...
                    if (value < 5.0 || value > 20.0)
                    {
                        throw (
                            new ArgumentOutOfRangeException(
                                "value",
                                SR.ExceptionScrollBarSizeInvalid
                            )
                        );
                    }
        ...
        internal void Paint(ChartGraphics graph)
        {
            ...
            RectangleF scrollBarClientRect = new RectangleF(
                scrollBarRect.Location,
                scrollBarRect.Size
            );
            ...
            foreach (ScrollBarButtonType buttonType in Enum.GetValues(typeof(ScrollBarButtonType)))
            {
                ...
                RectangleF buttonRect = this.GetScrollBarButtonRect(
                    scrollBarClientRect,
                ...
                if (!buttonRect.IsEmpty)
                {
                    PaintScrollBar3DButton(
                        graph,
                        buttonRect,
                        ((ScrollBarButtonType)this._pressedButtonType)
                            == (ScrollBarButtonType)buttonType,
                        (ScrollBarButtonType)buttonType
                    );
                }
        ...
        )
        {
            ...
            {
                if (
                    a.AxisPosition == AxisPosition.Left
                    && a.ScrollBar.IsVisible
                    && a.ScrollBar.IsPositionedInside == this.axis.ScrollBar.IsPositionedInside
                )
                {
                    leftSize = (float)a.ScrollBar.GetScrollBarRelativeSize();
                }
                if (
                    a.AxisPosition == AxisPosition.Right
                    && a.ScrollBar.IsVisible
                    && a.ScrollBar.IsPositionedInside == this.axis.ScrollBar.IsPositionedInside
                )
                {
        ...
        )
        {
            ...
            if (
                buttonType == ScrollBarButtonType.LargeIncrement
                || buttonType == ScrollBarButtonType.LargeDecrement
            )
            {
                return;
            }
            ...
            Color darkerColor = ChartGraphics.GetGradientColor(
                _buttonCurrentColor,
                Color.Black,
                0.5
            );
            Color darkestColor = ChartGraphics.GetGradientColor(
                _buttonCurrentColor,
                Color.Black,
                0.8
            );
            Color lighterColor = ChartGraphics.GetGradientColor(
                _buttonCurrentColor,
                Color.White,
                0.5
            );
            ...
            if (!pressedState)
            {
                ...
                graph.DrawLineRel(
                    (singlePixelBorder) ? lighterColor : _buttonCurrentColor,
                    1,
                    ChartDashStyle.Solid,
                ...
                graph.DrawLineRel(
                    (singlePixelBorder) ? darkerColor : darkestColor,
                    1,
                    ChartDashStyle.Solid,
                ...
                if (!singlePixelBorder)
                {
                    ...
                    graph.DrawLineRel(
                        ...
                        ChartDashStyle.Solid,
                        new PointF(
                            buttonRect.Right - pixelRelativeSize.Width,
                            buttonRect.Bottom - pixelRelativeSize.Height
                        ),
                        new PointF(
                            buttonRect.Right - pixelRelativeSize.Width,
                            buttonRect.Top + pixelRelativeSize.Height
                        )
                    );
                    graph.DrawLineRel(
                        darkerColor,
                        ...
                        ChartDashStyle.Solid,
                        new PointF(
                            buttonRect.Left + pixelRelativeSize.Width,
                            buttonRect.Bottom - pixelRelativeSize.Height
                        ),
                        new PointF(
                            buttonRect.Right - pixelRelativeSize.Width,
                    ...
                    graph.DrawLineRel(
                        ...
                        ChartDashStyle.Solid,
                        new PointF(
                            buttonRect.X + pixelRelativeSize.Width,
                            buttonRect.Bottom - pixelRelativeSize.Height
                        ),
                        new PointF(
                            buttonRect.X + pixelRelativeSize.Width,
                    ...
                    graph.DrawLineRel(
                        ...
                        new PointF(
                            buttonRect.Left + pixelRelativeSize.Width,
                            buttonRect.Y + pixelRelativeSize.Height
                        ),
                        new PointF(
                            buttonRect.Right - pixelRelativeSize.Width,
                            buttonRect.Y + pixelRelativeSize.Height
            ...
            switch (buttonType)
            {
                ...
                case (ScrollBarButtonType.ZoomReset):
                {
                    ...
                    using (Pen pen = new Pen(this._lineCurrentColor, 1))
                    {
                        graph.DrawEllipse(
                            pen,
                            buttonAbsRect.X + imageOffset - 0.5f,
                            buttonAbsRect.Y + imageOffset - 0.5f,
                            buttonAbsRect.Width - 2f * imageOffset,
                            buttonAbsRect.Height - 2f * imageOffset
                        );
                        graph.DrawLine(
                            pen,
                            buttonAbsRect.X + imageOffset + 1.5f,
                            buttonAbsRect.Y + buttonAbsRect.Height / 2f - 0.5f,
                            buttonAbsRect.Right - imageOffset - 2.5f,
                            buttonAbsRect.Y + buttonAbsRect.Height / 2f - 0.5f
                        );
                    }
                    break;
        ...
        internal void ScrollBar_MouseMove(System.Windows.Forms.MouseEventArgs e, ref bool handled)
        {
            ...
            if (this._pressedButtonType != int.MaxValue)
            {
                ...
                if (
                    (ScrollBarButtonType)this._pressedButtonType == ScrollBarButtonType.ThumbTracker
                )
                {
        ...
        private void ButtonClicked(ScrollBarButtonType buttonType, int x, int y)
        {
            ...
            if (
                buttonType != ScrollBarButtonType.ZoomReset
            ...
            )
            {
                ...
                switch (buttonType)
                {
                    ...
                    {
                        if (
                            !_lastClickMousePosition.IsEmpty
                        ...
                        )
                        {
                            ...
                            scrollBarClientRect.Inflate(
                                -borderRelativeSize.Width,
                                -borderRelativeSize.Height
                            );
                            ...
                            SizeF buttonSize = new SizeF(
                                scrollBarClientRect.Width,
                                scrollBarClientRect.Height
                            );
                            ...
                            if (verticalAxis)
                            {
                                ...
                                trackingAreaSize =
                                    scrollBarClientRect.Height
                                    - this.GetButtonsNumberAll() * buttonSize.Height;
                            ...
                            else
                            {
                                trackingAreaSize =
                                    scrollBarClientRect.Width
                                    - this.GetButtonsNumberAll() * buttonSize.Width;
                            ...
                            if (
                                !double.IsNaN(axis.ScaleView.SmallScrollMinSize)
                                && axis.ScaleView.SmallScrollMinSize != 0.0
                            )
                            {
                                double minSize = ChartHelper.GetIntervalSize(
                                    0,
                                    axis.ScaleView.SmallScrollMinSize,
                                    axis.ScaleView.SmallScrollMinSizeType
                                );
        ...
        internal RectangleF GetScrollBarButtonRect(
            RectangleF scrollBarClientRect,
            ScrollBarButtonType buttonType
        )
        {
            // Initialize button rectangle
            RectangleF buttonRect = new RectangleF(
                scrollBarClientRect.Location,
                scrollBarClientRect.Size
            );
            ...
            switch (buttonType)
            {
                ...
                case (ScrollBarButtonType.ThumbTracker):
                {
                    ...
                    if (verticalAxis)
                    {
                        ...
                        double trackingAreaSize =
                            scrollBarClientRect.Height
                            - this.GetButtonsNumberAll() * buttonSize.Height;
                        buttonRect.Height = (float)(
                            this.GetDataViewPercentage() * (trackingAreaSize / 100f)
                        );
                        ...
                        {
                            buttonRect.Y =
                                scrollBarClientRect.Bottom
                                - this.GetButtonsNumberBottom() * buttonSize.Height
                                - buttonRect.Height;
                            buttonRect.Y -= (float)(
                                this.GetDataViewPositionPercentage() * (trackingAreaSize / 100f)
                            );
                            if (
                                buttonRect.Y
                                < scrollBarClientRect.Y
                                    + this.GetButtonsNumberTop() * buttonSize.Height
                                    + (
                                        (this.GetButtonsNumberTop() == 0)
                                            ? 0
                    ...
                    else
                    {
                        ...
                        if (!this.axis.IsReversed)
                        {
                            ...
                            if (
                                ...
                                > scrollBarClientRect.Right
                                    - this.GetButtonsNumberBottom() * buttonSize.Width
                                    - (
                                        (this.GetButtonsNumberBottom() == 0)
                                            ? 0
                            ...
                            {
                                buttonRect.X =
                                    (scrollBarClientRect.Right - buttonRect.Width)
                                    - this.GetButtonsNumberBottom() * buttonSize.Width
                                    - (
                                        (this.GetButtonsNumberBottom() == 0)
                                            ? 0
                ...
                case (ScrollBarButtonType.SmallDecrement):
                    if (
                        this._scrollBarButtonStyle == ScrollBarButtonStyles.All
                    ...
                    )
                    {
                        ...
                        else
                        {
                            buttonRect.X =
                                scrollBarClientRect.X
                                + (this.GetButtonsNumberTop() - 1f) * buttonSize.Width;
                            buttonRect.X +=
                                (this.GetButtonsNumberTop() == 1) ? 0 : pixelRelativeSize.Width;
                        }
                    }
                    else
                    {
                ...
                case (ScrollBarButtonType.SmallIncrement):
                    ...
                    )
                    {
                        if (verticalAxis)
                        {
                            buttonRect.Y =
                                scrollBarClientRect.Y
                                + (this.GetButtonsNumberTop() - 1f) * buttonSize.Height;
                            buttonRect.Y +=
                                (this.GetButtonsNumberTop() == 1) ? 0 : pixelRelativeSize.Height;
                        }
                        else
                        {
            ...
            if (this.axis.PlotAreaPosition != null)
            {
                switch (axis.AxisPosition)
                {
                    case AxisPosition.Left:
                        ...
                        barPosition.X =
                            (
                                (this.IsPositionedInside)
                                    ? (float)(axis.GetAxisPosition(true))
                                    : areaPosition.X
                            ) - scrollBarSize; // - axisLineSize.Width / 2f;
                    ...
                    case AxisPosition.Right:
                        ...
                        barPosition.X =
                            (this.IsPositionedInside)
                                ? (float)axis.GetAxisPosition(true)
                                : areaPosition.Right; // + axisLineSize.Width / 2f;
                        barPosition.Width = scrollBarSize;
                        break;
                    case AxisPosition.Bottom:
                        ...
                        barPosition.Y =
                            (this.IsPositionedInside)
                                ? (float)axis.GetAxisPosition(true)
                                : areaPosition.Bottom; // + axisLineSize.Height / 2f;
                        ...
                        barPosition.Y =
                            (
                                (this.IsPositionedInside)
                                    ? (float)axis.GetAxisPosition(true)
                                    : areaPosition.Y
                            ) - scrollBarSize; // - axisLineSize.Height / 2f;
                        barPosition.Height = scrollBarSize;
                        break;
                }
            }
