...
#endif
{
    ...
    public class TextAnnotation : Annotation
    {
        ...
        internal RectangleF DrawText(
            ...
            RectangleF textPosition,
            bool noSpacingForCenteredText,
            bool getTextPosition
        )
        {
            ...
            RectangleF textPositionWithSpacing = new RectangleF(
            ...
            using (Brush textBrush = new SolidBrush(this.ForeColor))
            {
                using (StringFormat format = new StringFormat(StringFormat.GenericTypographic))
                {
                    ...
                    //***************************************************************
                    Color textShadowColor = ChartGraphics.GetGradientColor(
                        this.ForeColor,
                        Color.Black,
                        0.8
                    );
                    ...
                    if (textStyle == TextStyle.Shadow)
                    {
                        textShadowColor =
                            (textShadowColor.A != 255)
                                ? textShadowColor
                                : Color.FromArgb(textShadowColor.A / 2, textShadowColor);
                    }
                    ...
                    if (getTextPosition)
                    {
                        ...
                        // Get text position
                        textActualPosition = new RectangleF(
                            textPositionWithSpacing.Location,
                            textSize
                        );
                        if (
                            this.Alignment == ContentAlignment.BottomRight
                        ...
                        {
                            textActualPosition.Y +=
                                textPositionWithSpacing.Height - textSize.Height;
                        }
                        if (
                            this.Alignment == ContentAlignment.MiddleCenter
                            || this.Alignment == ContentAlignment.MiddleLeft
                        ...
                        {
                            textActualPosition.Y +=
                                (textPositionWithSpacing.Height - textSize.Height) / 2f;
                        }
        ...
        private void OnTextBoxKeyDown(object sender, KeyEventArgs e)
        {
            ...
            else if (e.KeyCode == Keys.Enter && this.IsMultiline == false)
            {
                // Stop editing
                StopTextEditing();
            }
        ...
        public void BeginTextEditing()
        {
            if (this.Chart != null && this.AllowTextEditing)
            {
                ...
                _editTextBox.BackColor = Color.FromArgb(
                    255,
        ...
        override internal RectangleF GetContentPosition()
        {
            ...
            {
                graphicsImage = new System.Drawing.Bitmap(
                    Common.ChartPicture.Width,
    ...
    public class AnnotationSmartLabelStyle : SmartLabelStyle
    {
        ...
        {
            get { return base.CalloutLineColor; }
        ...
        {
            get { return base.CalloutLineDashStyle; }
        ...
        {
            get { return base.CalloutBackColor; }
        ...
        {
            get { return base.CalloutLineWidth; }
        ...
        {
            get { return base.CalloutLineAnchorCapStyle; }
