...
#endif
{
    ...
    public class RectangleAnnotation : TextAnnotation
    {
        ...
        override internal void Paint(Chart chart, ChartGraphics graphics)
        {
            ...
            if (this.isRectVisible && this.Common.ProcessModePaint)
            {
                // Draw rectangle
    ...
    public class Border3DAnnotation : RectangleAnnotation
    {
        ...
        override internal void Paint(Chart chart, ChartGraphics graphics)
        {
            ...
            if (this.Common.ProcessModePaint)
            {
                ...
                if (absRectanglePosition.Width > 30f && absRectanglePosition.Height > 30f)
                {
                    // Draw rectangle
        ...
        internal override RectangleF GetTextSpacing(out bool annotationRelative)
        {
            ...
            if (
                _borderSkin.SkinStyle != BorderSkinStyle.None
