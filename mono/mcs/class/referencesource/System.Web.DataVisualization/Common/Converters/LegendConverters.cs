    ...
    internal class LegendAreaNameConverter : StringConverter
    {
        ...
        public override StandardValuesCollection GetStandardValues(ITypeDescriptorContext context)
        {
            ...
            if (context != null && context.Instance != null)
            {
                ...
                {
                    if (
                        ((Array)context.Instance).Length > 0
                        && ((Array)context.Instance).GetValue(0) is Legend
                    )
                    {
                        ...
                        ((Array)context.Instance).Length > 0
                        && ((Array)context.Instance).GetValue(0) is ChartArea
                    )
                    {
                        ...
                        ((Array)context.Instance).Length > 0
                        && ((Array)context.Instance).GetValue(0) is Title
                    )
                    {
                        ...
                        ((Array)context.Instance).Length > 0
                        && ((Array)context.Instance).GetValue(0) is Annotation
                    )
                    {
                    ...
                    catch
                    {
                        throw (
                            new InvalidOperationException(
                                SR.ExceptionLegendDesignerMarginObjectInvalid(stringValue)
                            )
                        );
                    }
                }
