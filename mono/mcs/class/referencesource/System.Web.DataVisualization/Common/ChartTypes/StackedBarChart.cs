...
#else
using System.Web.UI.DataVisualization.Charting.Utilities;using System.Web.UI.DataVisualization.Charting.ChartTypes;
#endif
...
#endif
{
    ...
    internal class HundredPercentStackedBarChart : StackedBarChart
    {
        ...
        {
            get { return ChartTypeNames.OneHundredPercentStackedBar; }
        }
                ...
                foreach (object obj in dataPointDrawingOrder)
                {
                    ...
                    )
                    {
                        ...
                        foreach (string seriesName in typeSeries)
                        {
                            ...
                            if (
                                StackedColumnChart.GetSeriesStackGroupName(currentSeries)
                                == groupName
                            )
                            {
