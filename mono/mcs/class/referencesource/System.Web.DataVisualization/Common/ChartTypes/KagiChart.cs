    ...
    internal class KagiChart : StepLineChart
    {
                ...
                if (kagiSeries.IsCustomPropertySet("OldAutomaticXAxisInterval"))
                {
                    ...
                    if (kagiSeries.ChartArea.Length > 0)
                    {
                        ...
                        Axis xAxis = area.GetAxis(
                            AxisName.X,
                            kagiSeries.XAxisType,
                            kagiSeries.XSubAxisName
                        );
                    ...
                    else
                    {
                        throw (
                            new InvalidOperationException(
                                SR.ExceptionKagiAttributeFormatInvalid("ReversalAmount")
                            )
                        );
                    }
                }
        ...
        private static void FillKagiData(Series series, Series originalData)
        {
            ...
            if (series.IsCustomPropertySet(CustomPropertyName.UsedYValue))
            {
                ...
                else
                {
                    throw (
                        new InvalidOperationException(
                            SR.ExceptionKagiAttributeFormatInvalid("UsedYValue")
                        )
                    );
                }
                ...
                if (yValueIndex >= series.YValuesPerPoint)
                {
                    throw (
                        new InvalidOperationException(
                            SR.ExceptionKagiAttributeOutOfRange("UsedYValue")
                        )
                    );
                }
            }
            ...
            foreach (DataPoint dataPoint in originalData.Points)
            {
                ...
                if (direction != 0)
                {
                    ...
                    {
                        series.Points[series.Points.Count - 1].YValues[0] = dataPoint.YValues[
                            yValueIndex
                        ];
        ...
        )
        {
            ...
            if (currentKagiDirection == 0)
            {
                ...
                if (priceUpColorString != null)
                {
                    ...
                    catch
                    {
                        throw (
                            new InvalidOperationException(
                                SR.ExceptionKagiAttributeFormatInvalid("Up Brick color")
                            )
                        );
                    }
                }
            ...
            if (pointIndex >= 2)
            {
                ...
                int direction = (points[pointIndex - 1].Y > points[pointIndex].Y) ? 1 : -1;
                ...
                if (direction != currentKagiDirection)
                {
                    ...
                    if (point1.Y > prevPoint.Y && point1.Y > point3.Y && prevPoint.Y > point3.Y)
                    {
            ...
            graph.DrawLineRel(
                ...
                graph.GetRelativePoint(point1),
                graph.GetRelativePoint(point2),
                series.ShadowColor,
                series.ShadowOffset
            );
        ...
        protected override PointF[] GetPointsPosition(
            ChartGraphics graph,
            Series series,
            bool indexedSeries
        )
        ...
        )
        {
            ...
            if (currentKagiDirection == 0)
            {
                ...
                // Check direction of first line (up or down)
                currentKagiDirection = (firstPoint.yPosition > secondPoint.yPosition) ? 1 : -1;
            }
            ...
            {
                // Check current direction
                int direction = (firstPoint.yPosition > secondPoint.yPosition) ? 1 : -1;
                ...
                if (direction != currentKagiDirection)
                {
                    ...
                    bool twoVertSegments = false;
                    if (
                        firstPoint.yPosition > prevPoint.yPosition
            ...
            for (int segmentIndex = 0; segmentIndex < 2; segmentIndex++)
            {
                ...
                {
                    lineSegmentType =
                        (originalDrawOrder) ? LineSegmentType.First : LineSegmentType.Last;
                ...
                if (lineSegmentType == LineSegmentType.First || vertSplitPoint == null)
                {
