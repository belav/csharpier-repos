...
#else
using System.Web.UI.DataVisualization.Charting;using System.Web.UI.DataVisualization.Charting.Data;using System.Web.UI.DataVisualization.Charting.Utilities;
#endif
...
#endif
{
    ...
    internal class SunkenBorder : IBorderType
    {
        ...
        public virtual void AdjustAreasPosition(ChartGraphics graph, ref RectangleF areasRect)
        {
            ...
            areasRect.Width -= (float)
                Math.Min(areasRect.Width, relSizeLeftTop.Width + relSizeRightBottom.Width);
            areasRect.Y += relSizeLeftTop.Height;
            areasRect.Height -= (float)
                Math.Min(areasRect.Height, relSizeLeftTop.Height + relSizeRightBottom.Height);
        ...
        )
        {
            ...
            float colorDarkeningIndex =
                0.3f
                + (
                    0.4f
                    * (borderSkin.PageColor.R + borderSkin.PageColor.G + borderSkin.PageColor.B)
                    / 765f
                );
            ...
            innerShadowRegion.Complement(
                graph.CreateRoundedRectPath(shadowWithOffset, cornerRadius)
            );
