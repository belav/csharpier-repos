...
#endif
{
    ...
    internal class PriceIndicators : IFormula
    {
        ...
        internal void ExponentialMovingAverage(
            double[] inputValues,
            out double[] outputValues,
            int period,
            bool startFromFirst
        ...
        )
        {
            ...
            if (startFromFirst)
            {
                ...
                for (int point = 0; point < inputValues[0].Length; point++)
                {
                    ...
                    outputValues[1][point] =
                        movingAvr * (1 - exponentialPercentage)
                        + inputValues[1][point] * exponentialPercentage;
                }
            }
            else
            {
                ...
                for (int point = 0; point < outputValues[0].Length; point++)
                {
                    ...
                    outputValues[1][point] =
                        movingAvr * (1 - exponentialPercentage)
                        + inputValues[1][point + period - 1] * exponentialPercentage;
                }
            }
        }
        ...
        /// <param name="parameterList">Array of strings: 1. Period</param>
        /// <param name="extraParameterList">Array of strings: 1. Start from zero</param>
        private void TriangularMovingAverage(
            double[][] inputValues,
            out double[][] outputValues,
            string[] parameterList,
            string[] extraParameterList
        ...
        /// <param name="parameterList">Array of strings: 1. Period</param>
        /// <param name="extraParameterList">Array of strings: 1. Start from zero</param>
        private void WeightedMovingAverage(
            double[][] inputValues,
            out double[][] outputValues,
            string[] parameterList,
            string[] extraParameterList
        ...
        )
        {
            ...
            if (startFromFirst)
            {
                ...
                for (int point = 0; point < outputValues[0].Length; point++)
                {
                    ...
                    {
                        sum += (
                            (inputValues[1][pointSum] - average[point])
                            * (inputValues[1][pointSum] - average[point])
                        );
                    }
        ...
        private void WeightedClose(double[][] inputValues, out double[][] outputValues)
        {
            ...
            for (int index = 0; index < inputValues[1].Length; index++)
            {
                ...
                // Set median price
                outputValues[1][index] =
                    (inputValues[1][index] + inputValues[2][index] + inputValues[3][index] * 2)
                    / 4.0;
            }
        }
        ...
        )
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.ExceptionPriceIndicatorsShiftParameterMissing
                );
            }
            ...
            for (int index = 0; index < movingAverage[0].Length; index++)
            {
                ...
                outputValues[1][index] =
                    movingAverage[1][index] + shift * movingAverage[1][index] / 100.0;
                outputValues[2][index] =
                    movingAverage[1][index] - shift * movingAverage[1][index] / 100.0;
            }
        }
        ...
        internal void StandardDeviation(
            double[] inputValues,
            out double[] outputValues,
            int period,
            bool startFromFirst
        )
        {
            ...
            if (startFromFirst)
            {
                ...
                for (int index = 0; index < inputValues.Length; index++)
                {
                    ...
                    {
                        sum +=
                            (inputValues[indexDev] - movingOut[outIndex])
                            * (inputValues[indexDev] - movingOut[outIndex]);
                    }
