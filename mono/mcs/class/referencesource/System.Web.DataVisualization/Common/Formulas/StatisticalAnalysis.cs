...
#endif
{
    ...
    internal class StatisticalAnalysis : IFormula
    {
        ...
        )
        {
            ...
            if (alpha < 0 || alpha > 1)
            {
                throw new ArgumentOutOfRangeException(
                    SR.ExceptionStatisticalAnalysesInvalidAlphaValue
                );
            }
        ...
        )
        {
            ...
            if (lessOneF)
            {
                fDistInv = FDistributionInverse(
                    1 - alpha,
                    inputValues[1].Length - 1,
                    inputValues[2].Length - 1
                );
                fDist =
                    1 - FDistribution(valueF, inputValues[1].Length - 1, inputValues[2].Length - 1);
            }
            else
            {
                fDistInv = FDistributionInverse(
        ...
        )
        {
            ...
            try
            {
                HypothesizedMeanDifference = double.Parse(
                    parameterList[0],
                    System.Globalization.CultureInfo.InvariantCulture
                );
            }
            ...
            {
                throw new ArgumentOutOfRangeException(
                    SR.ExceptionStatisticalAnalysesNegativeMeanDifference
                );
            }
        ...
        )
        {
            ...
            if (equalVariances)
            {
                ...
                s =
                    (
                        (inputValues[1].Length - 1) * variance1
                        + (inputValues[2].Length - 1) * variance2
                    ) / (inputValues[1].Length + inputValues[2].Length - 2);

                // T value
                T =
                    (mean1 - mean2 - HypothesizedMeanDifference)
                    / (Math.Sqrt(s * (1.0 / inputValues[1].Length + 1.0 / inputValues[2].Length)));
            }
            else
            {
        ...
        )
        {
            ...
            double T =
                (Math.Sqrt(inputValues[1].Length) * (mean - HypothesizedMeanDifference)) / variance;

            freedom = inputValues[1].Length - 1;

            double TDistTwoInv = StudentsDistributionInverse(alpha, freedom);
            double TDistOneInv =
                alpha <= 0.5 ? StudentsDistributionInverse(2 * alpha, freedom) : double.NaN;
            double TDistTwo = StudentsDistribution(T, freedom, false);
            double TDistOne = StudentsDistribution(T, freedom, true);
        ...
        /// <param name="parameterList">Array of strings - Parameters</param>
        /// <param name="outLabels">Array of strings - Used for Labels. Description for output results.</param>
        private void TDistributionInverse(
            out double[][] outputValues,
            string[] parameterList,
            out string[][] outLabels
        )
        ...
        /// <param name="parameterList">Array of strings - Parameters</param>
        /// <param name="outLabels">Array of strings - Used for Labels. Description for output results.</param>
        private void FDistributionInverse(
            out double[][] outputValues,
            string[] parameterList,
            out string[][] outLabels
        )
        ...
        /// <param name="parameterList">Array of strings - Parameters</param>
        /// <param name="outLabels">Array of strings - Used for Labels. Description for output results.</param>
        private void NormalDistributionInverse(
            out double[][] outputValues,
            string[] parameterList,
            out string[][] outLabels
        )
        ...
        private double GammLn(double n)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(
                    SR.ExceptionStatisticalAnalysesGammaBetaNegativeParameters
                );
            }
        ...
        private double BetaCF(double a, double b, double x)
        {
            ...
            if (m > MAXIT)
            {
                throw new InvalidOperationException(
                    SR.ExceptionStatisticalAnalysesIncompleteBetaFunction
                );
            }
        ...
        private double BetaIncomplete(double a, double b, double x)
        {
            ...
            if (x < 0.0 || x > 1.0)
                throw new ArgumentOutOfRangeException(
                    SR.ExceptionStatisticalAnalysesInvalidInputParameter
                );
            if (x == 0.0 || x == 1.0)
            {
                bt = 0.0;
        ...
        private double Variance(double[] values, bool sampleVariance)
        {
            ...
            if (values.Length < 1)
            {
                throw new ArgumentException(
                    SR.ExceptionStatisticalAnalysesInvalidVarianceConditions
                );
            }
        ...
        private double StudentsDistribution(double tValue, int n, bool oneTailed)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(
                    SR.ExceptionStatisticalAnalysesStudentsNegativeFreedomDegree
                );
            }
        ...
        private double NormalDistribution(double zValue)
        {
            ...
            else
            {
                ...
                result =
                    1
                    - NormalDistributionFunction(zValue)
                        * (
                            result
                            * (
                                a[0]
        ...
        private double FDistribution(double x, int freedom1, int freedom2)
        {
            ...
            if (freedom1 <= 0)
                throw new ArgumentOutOfRangeException(
                    SR.ExceptionStatisticalAnalysesInvalidDegreeOfFreedom
                );
            if (freedom2 <= 0)
                throw new ArgumentOutOfRangeException(
                    SR.ExceptionStatisticalAnalysesInvalidDegreeOfFreedom
        ...
        private double StudentsDistributionInverse(double probability, int n)
        {
            ...
            if (probability == 0)
                ...
                throw new ArgumentOutOfRangeException(
                    SR.ExceptionStatisticalAnalysesInvalidProbabilityValue
                );
        ...
        private double StudentsDistributionSearch(
            double probability,
            int n,
            int step,
            double start,
        ...
        private double NormalDistributionInverse(double probability)
        {
            ...
            {
                throw new ArgumentOutOfRangeException(
                    SR.ExceptionStatisticalAnalysesNormalInvalidProbabilityValue
                );
            }
        ...
        /// <param name="end">End for numerical process</param>
        /// <returns>Returns F ditribution inverse</returns>
        private double FDistributionSearch(
            double probability,
            int m,
            int n,
            int step,
