...
#endif
{
    ...
    internal class GeneralTechnicalIndicators : PriceIndicators
    {
        ...
        {
            get { return SR.FormulaNameGeneralTechnicalIndicators; }
        }
        ...
        private void EaseOfMovement(double[][] inputValues, out double[][] outputValues)
        {
            ...
            for (int index = 1; index < inputValues[0].Length; index++)
            {
                ...
                MidPointMove =
                    (inputValues[1][index] + inputValues[2][index]) / 2
                    - (inputValues[1][index - 1] + inputValues[2][index - 1]) / 2;

                // The Box Ratio determines the ratio between height and width of the Equivolume box:
                BoxRattio =
                    (inputValues[3][index]) / ((inputValues[1][index] - inputValues[2][index]));
        ...
        )
        {
            ...
            for (int index = 2 * averagePeriod - 3 + period; index < inputValues[0].Length; index++)
            {
                ...
                {
                    sum +=
                        average[indexSum - averagePeriod + 1]
                        / secondAverage[indexSum - 2 * averagePeriod + 2];
                }
        ...
        private void Performance(double[][] inputValues, out double[][] outputValues)
        {
            ...
            for (int index = 0; index < inputValues[0].Length; index++)
            {
                ...
                outputValues[1][index] =
                    (inputValues[1][index] - inputValues[1][0]) / inputValues[1][0] * 100;
            }
        }
        ...
        )
        {
            ...
            for (int index = period; index < inputValues[0].Length; index++)
            {
                ...
                // Set Y values
                outputValues[1][index - period] =
                    (inputValues[1][index] - inputValues[1][index - period])
                    / inputValues[1][index - period]
                    * 100;
            }
        }
        ...
        )
        {
            ...
            for (int index = 0; index < averageDownward.Length; index++)
            {
                ...
                outputValues[1][index] =
                    100 - 100 / (1 + averageUpward[index] / averageDownward[index]);
            }
        }
        ...
        )
        {
            ...
            if (longPeriod <= shortPeriod)
                throw new InvalidOperationException(
                    SR.ExceptionIndicatorsLongPeriodLessThenShortPeriod
                );
            ...
            for (int index = longPeriod - 1; index < inputValues[0].Length; index++)
            {
                ...
                // set Y value
                outputValues[1][outIndex] =
                    shortAverage[outIndex + longPeriod - shortPeriod] - longAverage[outIndex];
        ...
        )
        {
            ...
            for (int index = 0; index < meanDeviation.Length; index++)
            {
                ...
                // Set Y values
                outputValues[1][index] =
                    (typicalPrice[index + period - 1] - movingAverage[index])
                    / (0.015 * meanDeviation[index]);
            }
        }
