...
#endif
{
    ...
    /// </summary>
    [SRDescription("DescriptionAttributeSeries_Series"), DefaultProperty("Points"),]
#if ASPPERM_35
    [AspNetHostingPermission(
        System.Security.Permissions.SecurityAction.InheritanceDemand,
        Level = AspNetHostingPermissionLevel.Minimal
    ...
    public class Series : DataPointCustomProperties
    {
            ...
            if (YValuesPerPoint < 1)
            {
                throw (
                    new ArgumentOutOfRangeException(
                        "yValues",
                        SR.ExceptionDataSeriesYValuesPerPointIsZero
                    )
                );
            }
        ...
        )
        {
            ...
            if (attribValue != null)
            {
                ...
                catch
                {
                    throw (
                        new InvalidOperationException(
                            SR.ExceptionCustomAttributeValueInvalid2("PixelPointDepth")
                        )
                    );
                }
                ...
                if (pointDepth <= 0)
                {
                    throw (
                        new InvalidOperationException(
                            SR.ExceptionCustomAttributeIsNotLargerThenZiro("PixelPointDepth")
                        )
                    );
                }
                ...
                SizeF relativeSize = graph.GetRelativeSize(
                    new SizeF((float)pointDepth, (float)pointDepth)
                );
            ...
            if (attribValue != null)
            {
                ...
                catch
                {
                    throw (
                        new InvalidOperationException(
                            SR.ExceptionCustomAttributeValueInvalid2("PixelPointGapDepth")
                        )
                    );
                }
                ...
                if (pointGapDepth <= 0)
                {
                    throw (
                        new InvalidOperationException(
                            SR.ExceptionCustomAttributeIsNotLargerThenZiro("PixelPointGapDepth")
                        )
                    );
                }
                ...
                SizeF relativeSize = graph.GetRelativeSize(
                    new SizeF((float)pointGapDepth, (float)pointGapDepth)
                );
        ...
        )
        {
            ...
            SizeF pointSize = graph.GetAbsoluteSize(
                new SizeF((float)pointWidth, (float)pointWidth)
            );
            ...
            if (attribValue != null)
            {
                ...
                catch
                {
                    throw (
                        new InvalidOperationException(
                            SR.ExceptionCustomAttributeValueInvalid2("MinPixelPointWidth")
                        )
                    );
                }
                if (minPixelPointWidth <= 0.0)
                {
                    throw (
                        new InvalidOperationException(
                            SR.ExceptionCustomAttributeIsNotLargerThenZiro("MinPixelPointWidth")
                        )
                    );
                }
            ...
            if (attribValue != null)
            {
                ...
                catch
                {
                    throw (
                        new InvalidOperationException(
                            SR.ExceptionCustomAttributeValueInvalid2("MaxPixelPointWidth")
                        )
                    );
                }
                if (maxPixelPointWidth <= 0)
                {
                    throw (
                        new InvalidOperationException(
                            SR.ExceptionCustomAttributeIsNotLargerThenZiro("MaxPixelPointWidth")
                        )
                    );
                }
            ...
            if (attribValue != null)
            {
                ...
                catch
                {
                    throw (
                        new InvalidOperationException(
                            SR.ExceptionCustomAttributeValueInvalid2("PixelPointWidth")
                        )
                    );
                }
                if (pixelPointWidth <= 0)
                {
                    throw (
                        new InvalidOperationException(
                            SR.ExceptionCustomAttributeIsNotLargerThenZiro("PixelPointWidth")
                        )
                    );
                }
        ...
        {
            if (
                this.YValueType == ChartValueType.Date
        ...
        {
            if (
                this.XValueType == ChartValueType.Date
        ...
        internal void CheckSupportedTypes(Type type)
        {
            ...
            throw (
                new ArgumentException(SR.ExceptionDataSeriesPointTypeUnsupported(type.ToString()))
            );
        }
        ...
        internal void ApplyPaletteColors()
        {
            ...
            ChartColorPalette currentPalette =
                (this.Palette == ChartColorPalette.None) ? dataManager.Palette : this.Palette;
            ...
            Color[] paletteColors =
                (currentPalette == ChartColorPalette.None)
                    ? dataManager.PaletteCustomColors
                    : ChartPaletteColors.GetPaletteColors(currentPalette);
            foreach (DataPoint dataPoint in _points)
            {
                // Change color of the series data points only if no color is set
                if (
                    (
                        !dataPoint.IsCustomPropertySet(CommonCustomProperties.Color)
                        || dataPoint.tempColorIsSet
                    ) && !dataPoint.IsEmpty
                )
                {
                    dataPoint.SetAttributeObject(
        ...
        internal IEnumerable GetDummyData(ChartValueType type)
        {
            ...
            if (_dummyDoubleValues == null)
            {
                ...
                Random random2 = new Random(
                    unchecked((int)DateTime.Now.Ticks + this.Color.B + this.Color.G + this.Color.R)
                );
#else
                int seed = 0;
        ...
        internal double GetTotalYValue(int yValueIndex)
        {
            ...
            if (yValueIndex >= this.YValuesPerPoint)
            {
                throw (
                    new InvalidOperationException(
                        SR.ExceptionDataSeriesYValueIndexNotExists(
                            yValueIndex.ToString(CultureInfo.InvariantCulture),
                            this.Name
                        )
                    )
                );
            ...
            if (fillTempData)
            {
                ...
                if (this.YValuesPerPoint > 1)
                {
                    foreach (DataPoint point in this.Points)
                    {
                        ...
                        {
                            point.YValues[2] =
                                point.YValues[1] + (point.YValues[0] - point.YValues[1]) / 3;
                            point.YValues[3] =
                                point.YValues[2] + (point.YValues[0] - point.YValues[1]) / 3;
                        }

                        if (this.YValuesPerPoint >= 6)
                        {
                            point.YValues[4] =
                                point.YValues[2] + (point.YValues[3] - point.YValues[2]) / 2;
                            point.YValues[5] =
                                point.YValues[2] + (point.YValues[3] - point.YValues[2]) / 3;
                        }
                    }
                }
...
#else
            TypeConverter(
                typeof(SeriesDataSourceMemberConverter)
            )
#endif
        ]
        public string XValueMember
        {
            get { return _dataSourceXMember; }
            set
            {
                if (value == "(none)")
                {
        ...
        [
            ...
            Editor(
                Editors.SeriesDataFieldValueAxisUITypeEditor.Editor,
                Editors.SeriesDataFieldValueAxisUITypeEditor.Base
            )
#else
            TypeConverter(
                typeof(SeriesDataSourceMemberConverter)
            ...
            Editor(
                Editors.SeriesDataSourceMemberValueAxisUITypeEditor.Editor,
                Editors.SeriesDataSourceMemberValueAxisUITypeEditor.Base
            )
#endif
        ]
        public string YValueMembers
        {
            get { return _dataSourceYMembers; }
            set
            {
                if (value == "(none)")
                {
            ...
            set
            {
                ...
                if (value < 1 || value > 32)
                {
                    throw (
                        new ArgumentOutOfRangeException(
                            "value",
                            SR.ExceptionDataSeriesYValueNumberInvalid
                        )
                    );
                }
...
#endif
            Editor(
                Editors.DataPointCollectionEditor.Editor,
                Editors.DataPointCollectionEditor.Base
            )
        ]
        ...
        {
            get { return _emptyPointCustomProperties; }
            set
            {
        ...
        public SeriesChartType ChartType
        {
                ...
                else
                {
                    try
                    {
                        type = (SeriesChartType)
                            Enum.Parse(typeof(SeriesChartType), this.ChartTypeName, true);
                    }
            ...
            set { this.ChartTypeName = Series.GetChartTypeName(value); }
        }
