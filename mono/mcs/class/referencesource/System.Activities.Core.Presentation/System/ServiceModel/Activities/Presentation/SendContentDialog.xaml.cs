...
namespace System.ServiceModel.Activities.Presentation
{
    ...
    partial class SendContentDialog : WorkflowElementDialog
    {
        public static readonly DependencyProperty ViewModelProperty = DependencyProperty.Register(
            "ViewModel",
            typeof(ContentDialogViewModel<SendMessageContent, SendParametersContent>),
            typeof(SendContentDialog)
        );
            ...
            : this()
        {
            ...
            this.Owner = owner;
            this.ViewModel = new ContentDialogViewModel<SendMessageContent, SendParametersContent>(
                this.ModelItem
            );
        ...
        public ContentDialogViewModel<SendMessageContent, SendParametersContent> ViewModel
        {
            get
            {
                return (ContentDialogViewModel<SendMessageContent, SendParametersContent>)
