...
namespace System.ServiceModel.Activities.Presentation
{
    ...
    partial class SendDesigner
    {
        ...
        public static readonly RoutedCommand CreateReceiveReplyCommand = new RoutedCommand(
            "CreateReceiveReply",
            typeof(SendDesigner)
        );
        ...
        static SendDesigner()
        {
            ...
            builder.AddCustomAttributes(
                sendType,
                sendType.GetProperty("CorrelatesWith"),
                categoryAttribute,
            ...
            categoryAttribute = new CategoryAttribute(
                EditorCategoryTemplateDictionary.Instance.GetCategoryTitle(EndpointCategoryLabelKey)
            );
            builder.AddCustomAttributes(
                sendType,
                sendType.GetProperty("Endpoint"),
                categoryAttribute,
            ...
            builder.AddCustomAttributes(
                sendType,
                sendType.GetProperty("EndpointAddress"),
                categoryAttribute,
                descriptionAttribute
            );
            builder.AddCustomAttributes(
                sendType,
                sendType.GetProperty("EndpointConfigurationName"),
                categoryAttribute
            );
            ...
            builder.AddCustomAttributes(
                sendType,
                sendType.GetProperty("OperationName"),
                categoryAttribute
            );
            builder.AddCustomAttributes(
                sendType,
                sendType.GetProperty("ServiceContractName"),
                categoryAttribute,
            ...
            builder.AddCustomAttributes(
                sendType,
                sendType.GetProperty("ProtectionLevel"),
                advancedAttribute,
                categoryAttribute
            );
            builder.AddCustomAttributes(
                sendType,
                sendType.GetProperty("SerializerOption"),
                advancedAttribute,
                categoryAttribute
            );
            builder.AddCustomAttributes(
                sendType,
                sendType.GetProperty("TokenImpersonationLevel"),
                advancedAttribute,
                categoryAttribute
            );
        ...
        void OnCreateReceiveReplyExecute(object sender, ExecutedRoutedEventArgs e)
        {
            ...
            CutCopyPasteHelper.PutCallbackOnClipBoard(
                callback,
                typeof(ReceiveReply),
                this.ModelItem
            );
        ...
        static ReceiveReply CreateReceiveReply(ModelItem target, object context)
        {
            ...
            if (null != send)
            {
                ...
                reply = new ReceiveReply()
                {
                    DisplayName = string.Format(
                        CultureInfo.CurrentUICulture,
                        "ReceiveReplyFor{0}",
                        send.Properties["DisplayName"].ComputedValue
                    ),
            ...
            {
                MessageBox.Show(
                    (string)StringResourceDictionary.Instance["sendActivityCreateReplyErrorLabel"]
                        ?? "Source 'Send' element not found!",
