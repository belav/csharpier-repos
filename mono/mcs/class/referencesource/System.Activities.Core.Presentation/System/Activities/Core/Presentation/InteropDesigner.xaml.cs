...
namespace System.Activities.Core.Presentation
{
    ...
    partial class InteropDesigner
    {
        ...
        protected override void OnModelItemChanged(object newItem)
        {
            ...
            this.ModelItem.PropertyChanged += new System.ComponentModel.PropertyChangedEventHandler(
                OnModelItemPropertyChanged
            );
        }

        private void OnModelItemPropertyChanged(
            object sender,
        ...
        public static void RegisterMetadata(AttributeTableBuilder builder)
        {
            Type activityType = GetTypeByQualifiedName(
                InteropDesigner.InteropTypeAssemblyQualifiedName
            );
            ...
            if (activityType != null)
            {
                builder.AddCustomAttributes(
                    activityType,
                    new DesignerAttribute(typeof(InteropDesigner))
                );
                builder.AddCustomAttributes(
                    activityType,
                    "ActivityType",
