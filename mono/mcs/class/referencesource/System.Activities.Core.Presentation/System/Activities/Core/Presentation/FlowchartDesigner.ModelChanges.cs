...
namespace System.Activities.Core.Presentation
{
    ...
    partial class FlowchartDesigner
    {
        ...
        internal IFlowSwitchLink DeleteLink(
            Connector link,
            bool isMoveOrAutoSplit = false,
        ...
        )
        {
            ...
            using (
                ...
                ).ModelTreeManager.CreateEditingScope(SR.FCDeleteLink)
            )
            {
        ...
        private IFlowSwitchLink DeleteLinkImpl(
            Connector link,
            bool isMoveOrAutoSplit = false,
            HashSet<ModelItem> referenceUpdatedModelItems = null
        )
        {
            ...
            else if (typeof(FlowDecision).IsAssignableFrom(linkModelItem.ItemType))
            {
                ...
                if (
                    srcConnectionPoint.Equals(
                        FlowchartDesigner.GetTrueConnectionPoint(srcConnectionPoint.ParentDesigner)
                    )
                )
                {
                    //True branch
            ...
            else if (typeof(IFlowSwitchLink).IsAssignableFrom(linkModelItem.ItemType))
            {
                ...
                ModelItem realFlowSwitchMI = (
                    this.ModelItem as IModelTreeItem
                ).ModelTreeManager.WrapAsModelItem(fs);
                if (
                    referenceUpdatedModelItems != null
                ...
                else
                {
                    GenericFlowSwitchHelper.RemoveCase(
                        realFlowSwitchMI.Properties["Cases"],
                        flowSwitchLink.CaseObject
                    );
                }
            }
            else // StartNode
        ...
        bool UpdateFlowChartObject(
            ...
            bool isLinkValidDueToLinkMove,
            IFlowSwitchLink caseKey
        )
        {
            ...
            else
            {
                ...
                {
                    if (
                        srcFlowElementMI.Properties["Next"].Value == null
                        || isLinkValidDueToLinkMove
                    )
                    {
                ...
                {
                    if (
                        sourceConnPoint.Equals(
                            FlowchartDesigner.GetTrueConnectionPoint(this.modelElement[linkSource])
                        )
                    )
                    {
                        ...
                        sourceConnPoint.Equals(
                            FlowchartDesigner.GetFalseConnectionPoint(this.modelElement[linkSource])
                        )
                    )
                    {
                        if (
                            linkSource.Properties["False"].Value == null || isLinkValidDueToLinkMove
                        )
                        {
                            this.StoreConnectorViewState(
                                srcFlowElementMI,
        ...
        bool CreateFlowSwitchLink(
            ConnectionPoint sourceConnPoint,
            ModelItem srcFlowElementMI,
            ModelItem destFlowElementMI,
            IFlowSwitchLink caseKey,
            PointCollection connectorViewState,
            ref string errorMessage
        )
        {
            IModelTreeItem modelTreeItem = this.ModelItem as IModelTreeItem;
            if (
                (caseKey != null && caseKey.IsDefaultCase)
            ...
            else
            {
                ...
                if (caseKey == null)
                {
                    ...
                    {
                        uniqueCaseName = GenericFlowSwitchHelper.GetCaseName(
                            casesProp,
                            typeArgument,
                            out errorMessage
                        );
                ...
                if (string.IsNullOrEmpty(errorMessage))
                {
                    ...
                    GenericFlowSwitchHelper.AddCase(
                        srcFlowElementMI.Properties["Cases"],
                        link.CaseObject,
        ...
        internal bool CreateLinkGesture(
        ...
        )
        {
            ...
            )
            {
                ...
                {
                    linkCreated = UpdateFlowChartObject(
                        sourceConnectionPoint,
                        destConnectionPoint,
                        out errorMessage,
                        isLinkValidDueToLinkMove,
        ...
        )
        {
            ...
            ConnectionPoint destConnectionPoint = FindClosestConnectionPoint(
                ...
                FlowchartDesigner
                    ...
                    .Where(p => p.PointType != ConnectionPointKind.Outgoing)
                    .ToList(),
                out minDist
            );
        ...
        {
            bool linkCreated = false;
            ConnectionPoint destConnectionPoint = ClosestDestConnectionPoint(
                sourceConnectionPoint,
                dest,
                out errorMessage
            );
        ...
        )
        {
            ...
            ConnectionPoint sourceConnectionPoint = FindClosestConnectionPoint(
                ...
                FlowchartDesigner
                    ...
                    .Where(p => p.PointType != ConnectionPointKind.Incoming)
                    .ToList(),
                out minDist
            );
