...
namespace System.Activities.Core.Presentation
{
    ...
    public class DesignerMetadata : IRegisterMetadata
    {
        ...
        public void Register()
        {
            ...
            builder.AddCustomAttributes(
                typeof(ReceiveReply),
                new FeatureAttribute(typeof(ReceiveReplyValidationFeature))
            );
            builder.AddCustomAttributes(
                typeof(ReceiveReply),
            ...
            MorphHelper.AddPropertyValueMorphHelper(
                typeof(InArgument<>),
            ...
            MorphHelper.AddPropertyValueMorphHelper(
                typeof(InOutArgument<>),
                MorphHelpers.ArgumentMorphHelper
            );
            MorphHelper.AddPropertyValueMorphHelper(
                typeof(ActivityAction<>),
                MorphHelpers.ActivityActionMorphHelper
            );
            MorphHelper.AddPropertyValueMorphHelper(
                typeof(ActivityFunc<,>),
                MorphHelpers.ActivityFuncMorphHelper
            );
            ...
            delayedWorker.RegisterMetadataDelayed(
                "System.Workflow.Runtime",
                InteropDesigner.RegisterMetadata
            );
            delayedWorker.RegisterMetadataDelayed(
                "System.ServiceModel",
                RegisterMetadataForMessagingActivitiesSearchMetadata
            );
            delayedWorker.RegisterMetadataDelayed(
                "System.ServiceModel",
                RegisterMetadataForMessagingActivitiesPropertyEditors
            );
            delayedWorker.WorkNowIfApplicable();
        }

        private static void RegisterMetadataForMessagingActivitiesPropertyEditors(
        ...
        )
        {
            ...
            builder.AddCustomAttributes(
                typeof(InArgument<CorrelationHandle>),
                new EditorReuseAttribute(false)
            );
            builder.AddCustomAttributes(typeof(InArgument<Uri>), new EditorReuseAttribute(false));
            builder.AddCustomAttributes(
                typeof(MessageQuerySet),
                PropertyValueEditor.CreateEditorAttribute(typeof(CorrelatesOnValueEditor))
            );
        }

        private static void RegisterMetadataForMessagingActivitiesSearchMetadata(
            AttributeTableBuilder builder
        )
        {
            builder.AddCustomAttributes(
                typeof(SendMessageContent),
                new SearchableStringConverterAttribute(
                    typeof(SendMessageContentSearchableStringConverter)
                )
            );
            builder.AddCustomAttributes(
                typeof(SendParametersContent),
                new SearchableStringConverterAttribute(
                    typeof(SendParametersContentSearchableStringConverter)
                )
            );
            builder.AddCustomAttributes(
                typeof(ReceiveMessageContent),
                new SearchableStringConverterAttribute(
                    typeof(ReceiveMessageContentSearchableStringConverter)
                )
            );
            builder.AddCustomAttributes(
                typeof(ReceiveParametersContent),
                new SearchableStringConverterAttribute(
                    typeof(ReceiveParametersContentSearchableStringConverter)
                )
            );
            builder.AddCustomAttributes(
                typeof(XPathMessageQuery),
                new SearchableStringConverterAttribute(
                    typeof(XPathMessageQuerySearchableStringConverter)
                )
            );
        }
    }
