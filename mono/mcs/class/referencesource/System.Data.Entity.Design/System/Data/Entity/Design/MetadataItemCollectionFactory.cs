...
namespace System.Data.Entity.Design
{
    ...
    public static class MetadataItemCollectionFactory
    {
        ...
        public static EdmItemCollection CreateEdmItemCollection(
        ...
        )
        {
            ...
            if (!errors.Any(e => e.Severity == EdmSchemaErrorSeverity.Error))
            {
                ValidateActualVersionAgainstTarget(
                    targetEntityFrameworkVersion,
                    EntityFrameworkVersionsUtil.ConvertToVersion(edmItemCollection.EdmVersion),
                    errors
                );
            }
        ...
        internal static bool ValidateActualVersionAgainstTarget(
            Version maxExpectedVersion,
        ...
        )
        {
            ...
            if (
                EntityFrameworkVersionsUtil.ConvertToVersion(edmCollection.EdmVersion)
                > targetEntityFrameworkVersion
            )
            {
            ...
            if (!errors.Any(e => e.Severity == EdmSchemaErrorSeverity.Error))
            {
                ValidateActualVersionAgainstTarget(
                    targetEntityFrameworkVersion,
                    EntityFrameworkVersionsUtil.ConvertToVersion(
                        storageMappingItemCollection.MappingVersion
                    ),
                    errors
                );
            }
