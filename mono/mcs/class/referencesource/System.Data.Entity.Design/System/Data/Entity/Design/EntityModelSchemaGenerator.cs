    ...
    public sealed class EntityModelSchemaGenerator
    {
        ...
        private IList<EdmSchemaError> InternalGenerateMetadata()
        {
            ...
            try
            {
                ...
                foreach (
                    OneToOneMappingSerializer.CollapsedEntityAssociationSet collapsed in session
                        .MappingLookups
                ...
                if (!EntityStoreSchemaGenerator.HasErrorSeverityErrors(session.Errors))
                {
                    ...
                    foreach (
                        AssociationType type in session
                            .MappingLookups
                    ...
                    foreach (
                        OneToOneMappingSerializer.CollapsedEntityAssociationSet set in session
                            .MappingLookups
                            .CollapsedEntityAssociationSets
                    )
                    {
        ...
        )
        {
            ...
            foreach (var storeFunction in interestingStoreFunctions)
            {
                ...
                var parameters = storeFunction
                    .Parameters.Select(p => CreateFunctionImportParameter(p, usedParameterNames))
                    .ToArray();
            ...
            if (storeTypeUsage.Facets.Contains(DesignXmlConstants.StoreGeneratedPattern))
            {
                ...
                annotation.Add(
                    new MetadataProperty(
                        ...
                        storeTypeUsage
                            .Facets.GetValue(DesignXmlConstants.StoreGeneratedPattern, false)
                            .Value
                    )
                );
        ...
        {
            AssociationEndMember associationEnd = session
                .MappingLookups
        ...
        )
        {
            ...
            {
                nullableColumnsImplyingOneToOneMultiplicity = storeConstraint.ToProperties.All(p =>
                    p.Nullable == false
                );
            }
            else
            {
                nullableColumnsImplyingOneToOneMultiplicity = storeConstraint.ToProperties.Any(p =>
                    p.Nullable == false
                );
            }
        ...
        )
        {
            ...
            AssociationEndMember fromRole = session
                .MappingLookups
                .StoreAssociationEndMemberToModelAssociationEndMember[
