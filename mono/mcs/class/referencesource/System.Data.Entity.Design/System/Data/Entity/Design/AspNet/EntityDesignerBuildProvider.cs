...
namespace System.Data.Entity.Design.AspNet
{
    ...
    public class EntityDesignerBuildProvider : System.Web.Compilation.BuildProvider
    {
        ...
        {
            using (
                StreamReader edmxInputStream = new StreamReader(
                    VirtualPathProvider.OpenFile(base.VirtualPath)
                )
            )
            {
                ...
                EntityDesignerUtils.ExtractConceptualMappingAndStorageNodes(
                    ...
                    out mappingElement,
                    out storageSchemaElement,
                    out embedAsResourcePropertyValue
                );
                ...
                string ssdlResourceName = BuildProviderUtils.GetResourceNameForVirtualPath(
                    virtualPathPrefix + XmlConstants.SSpaceSchemaExtension
                );
                string mslResourceName = BuildProviderUtils.GetResourceNameForVirtualPath(
                    virtualPathPrefix + XmlConstants.CSSpaceSchemaExtension
                );
        ...
        private static void SetupEmbeddedResource(
