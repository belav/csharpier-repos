...
namespace Microsoft.Win32
{
    ...
    public static class Registry
    {
        ...
        public static readonly RegistryKey CurrentUser = RegistryKey.GetBaseKey(
         ...
         */
        [ResourceExposure(ResourceScope.Machine)]
        public static readonly RegistryKey LocalMachine = RegistryKey.GetBaseKey(
         ...
         */
        [ResourceExposure(ResourceScope.Machine)]
        public static readonly RegistryKey ClassesRoot = RegistryKey.GetBaseKey(
         ...
         */
        [ResourceExposure(ResourceScope.Machine)]
        public static readonly RegistryKey PerformanceData = RegistryKey.GetBaseKey(
         ...
         */
        [ResourceExposure(ResourceScope.Machine)]
        public static readonly RegistryKey CurrentConfig = RegistryKey.GetBaseKey(
        ...
        public static readonly RegistryKey DynData = RegistryKey.GetBaseKey(
            ...
            switch (basekeyName)
            {
                ...
                default:
                    throw new ArgumentException(
                        Environment.GetResourceString("Arg_RegInvalidKeyName", "keyName")
                    );
            }
