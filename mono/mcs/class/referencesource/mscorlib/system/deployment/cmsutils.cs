...
namespace System.Deployment.Internal.Isolation.Manifest
{
    ...
    {
        internal static void GetEntryPoint(
        ...
        )
        {
            ...
            if (refEnum.Next(1, entries, ref count) == 0 && count == 1)
            {
                ...
                else
                {
                    ...
                    {
                        (
                            (ISectionWithReferenceIdentityKey)appManifest.AssemblyReferenceSection
                        ).Lookup(reference.Identity, out assemblyObj);
        ...
        internal static IAssemblyReferenceEntry[] GetDependentAssemblies(
            ActivationContext activationContext
        )
        {
        ...
        internal static bool CompareIdentities(
            ActivationContext activationContext1,
        ...
        )
        {
            ...
            switch (versionMatch)
            {
                ...
                case ApplicationVersionMatch.MatchAllVersions:
                    flags = (uint)
                        IAPPIDAUTHORITY_ARE_DEFINITIONS_EQUAL_FLAGS.IAPPIDAUTHORITY_ARE_DEFINITIONS_EQUAL_FLAG_IGNORE_VERSION;
                    break;
                default:
                    throw new ArgumentException(
                        Environment.GetResourceString("Arg_EnumIllegalVal", (int)versionMatch),
                        "versionMatch"
                    );
            }
            return IsolationInterop.AppIdAuthority.AreDefinitionsEqual(
        ...
        internal static string GetFriendlyName(ActivationContext activationContext)
        {
            ...
            IMetadataSectionEntry metadataSectionEntry = (IMetadataSectionEntry)
                deplManifest.MetadataSectionEntry;
            IDescriptionMetadataEntry descriptionMetadataEntry =
                metadataSectionEntry.DescriptionData;
            ...
            if (descriptionMetadataEntry != null)
            {
                ...
                friendlyName = (
                    entry.Publisher != null
                        ? String.Format("{0} {1}", entry.Publisher, entry.Product)
                        : entry.Product
                );
            }
            return friendlyName;
        ...
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        internal static void CreateActivationContext(
            string fullName,
            string[] manifestPaths,
            bool useFusionActivationContext,
            out ApplicationIdentity applicationIdentity,
        ...
        {
            return MergeApplicationEvidence(
                evidence,
                applicationIdentity,
                activationContext,
                activationData,
        ...
        )
        {
            ...
            ActivationArguments activationArgs = (
                activationContext == null
                    ? new ActivationArguments(applicationIdentity, activationData)
            ...
            {
                Evidence asiEvidence = new ApplicationSecurityInfo(
                    activationContext
                ).ApplicationEvidence;
                if (asiEvidence != null)
