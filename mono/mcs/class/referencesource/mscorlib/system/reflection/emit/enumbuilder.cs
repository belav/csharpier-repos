...
namespace System.Reflection.Emit
{
    ...
    public sealed class EnumBuilder : TypeInfo, _EnumBuilder
    {
        ...
        public FieldBuilder DefineLiteral(String literalName, Object literalValue)
        {
            BCLDebug.Log(
                "DYNIL",
                "## DYNIL LOGGING: EnumBuilder.DefineLiteral( " + literalName + " )"
            );
        ...
        {
            get { return m_typeBuilder.AssemblyQualifiedName; }
        }
        ...
        {
            get { return GetEnumUnderlyingType(); }
        }
        ...
        {
            get { return m_typeBuilder.MetadataTokenInternal; }
        }
        ...
        ) // module containing this type
        {
            ...
            if ((visibility & ~TypeAttributes.VisibilityMask) != 0)
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_ShouldOnlySetVisibilityFlags"),
                    "name"
                );
