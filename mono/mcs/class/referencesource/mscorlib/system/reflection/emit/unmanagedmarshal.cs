        ...
        ******************************/
        public static UnmanagedMarshal DefineUnmanagedMarshal(UnmanagedType unmanagedType)
        {
            ...
            )
            {
                ...
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_NotASimpleNativeType")
                );
            }
        ...
        public Guid IIDGuid
        {
            get
            {
                ...
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_NotACustomMarshaler")
                );
            }
        }
        ...
        public UnmanagedType BaseType
        {
            get
            {
                ...
                )
                {
                    ...
                    throw new ArgumentException(
                        Environment.GetResourceString("Argument_NoNestedMarshal")
                    );
                }
                return m_baseType;
            }
