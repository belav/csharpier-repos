    ...
    public sealed class TypeBuilder : TypeInfo, _TypeBuilder
    {
            ...
            public void Bake(ModuleBuilder module, int token)
            {
                if (m_customBuilder == null)
                {
                    TypeBuilder.DefineCustomAttribute(
                        module,
                        token,
                        module.GetConstructorToken(m_con).Token,
                        m_binaryAttribute,
                        false,
                        false
                    );
        ...
        public static MethodInfo GetMethod(Type type, MethodInfo method)
        {
            if (!(type is TypeBuilder) && !(type is TypeBuilderInstantiation))
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_MustBeTypeBuilder")
                );
            ...
            if (method.IsGenericMethod && !method.IsGenericMethodDefinition)
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_NeedGenericMethodDefinition"),
                    "method"
                );

            if (method.DeclaringType == null || !method.DeclaringType.IsGenericTypeDefinition)
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_MethodNeedGenericDeclaringType"),
                    "method"
                );

            if (type.GetGenericTypeDefinition() != method.DeclaringType)
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_InvalidMethodDeclaringType"),
                    "type"
                );
            Contract.EndContractBlock();
            ...
            if (!(type is TypeBuilderInstantiation))
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_NeedNonGenericType"),
                    "type"
                );

            return MethodOnTypeBuilderInstantiation.GetMethod(
                method,
                type as TypeBuilderInstantiation
            );
        }
        ...
        public static ConstructorInfo GetConstructor(Type type, ConstructorInfo constructor)
        {
            ...
            if (!constructor.DeclaringType.IsGenericTypeDefinition)
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_ConstructorNeedGenericDeclaringType"),
                    "constructor"
                );
            Contract.EndContractBlock();
            ...
            if (type.GetGenericTypeDefinition() != constructor.DeclaringType)
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_InvalidConstructorDeclaringType"),
                    "type"
                );
        ...
        public static FieldInfo GetField(Type type, FieldInfo field)
        {
            ...
            if (!field.DeclaringType.IsGenericTypeDefinition)
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_FieldNeedGenericDeclaringType"),
                    "field"
                );
            Contract.EndContractBlock();
            ...
            if (type.GetGenericTypeDefinition() != field.DeclaringType)
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_InvalidFieldDeclaringType"),
                    "type"
                );

            return FieldOnTypeBuilderInstantiation.GetField(
                field,
                type as TypeBuilderInstantiation
            );
        }
        ...
        )
        {
            ...
            DefineCustomAttribute(
                module.GetNativeHandle(),
                tkAssociate,
                tkConstructor,
                localAttr,
                (localAttr != null) ? localAttr.Length : 0,
                toDisk,
                updateCompilerFlags
            );
        }
            ...
            else
            {
                if (destType.IsValueType)
                {
                    ...
                    if (
                        ...
                        throw new ArgumentException(
                            Environment.GetResourceString("Argument_ConstantNull")
                        );
                }
        ...
        )
        {
            ...
            if (fullname[0] == '\0')
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_IllegalName"),
                    "fullname"
                );

            if (fullname.Length > 1023)
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_TypeNameTooLong"),
                    "fullname"
                );
            Contract.EndContractBlock();
            ...
            if (enclosingType != null)
            {
                ...
                if (
                    ...
                    throw new ArgumentException(
                        Environment.GetResourceString("Argument_BadNestedTypeFlags"),
                        "attr"
                    );
            }
            ...
            if ((m_iPackingSize != 0) || (m_iTypeSize != 0))
                SetClassLayout(
                    GetModuleBuilder().GetNativeHandle(),
                    m_tdType.Token,
                    m_iPackingSize,
                    m_iTypeSize
                );
            ...
            if (IsPublicComType(this))
            {
                ...
                if (!m_module.Equals(containingAssem.ManifestModule))
                    containingAssem.DefineExportedTypeInMemory(
                        this,
                        m_module.m_moduleData.FileToken,
                        m_tdType.Token
                    );
            }
#endif
        ...
        )
        {
            ...
            lock (SyncRoot)
            {
                return DefinePInvokeMethodHelperNoLock(
                    name,
                    dllName,
                    importName,
                    attributes,
        ...
        )
        {
            ...
            if ((attributes & MethodAttributes.Abstract) != 0)
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_BadPInvokeMethod")
                );
            Contract.EndContractBlock();

            if ((m_iAttr & TypeAttributes.ClassSemanticsMask) == TypeAttributes.Interface)
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_BadPInvokeOnInterface")
                );
            ...
            {
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_MethodRedefined")
                );
            }
        ...
        private void VerifyTypeAttributes(TypeAttributes attr)
        {
            ...
            {
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_BadTypeAttrInvalidLayout")
                );
            }
            ...
            {
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_BadTypeAttrReservedBitsSet")
                );
            }
        }
        ...
        internal void ThrowIfCreated()
        {
            if (IsCreated())
                throw new InvalidOperationException(
                    Environment.GetResourceString("InvalidOperation_TypeHasBeenCreated")
                );
        }

        internal object SyncRoot
        {
            get { return m_module.SyncRoot; }
        }
        ...
        public override String FullName
        {
            get
            {
                if (m_strFullQualName == null)
                    m_strFullQualName = TypeNameBuilder.ToString(
                        this,
                        TypeNameBuilder.Format.FullName
                    );
            ...
            get
            {
                ...
                if (IsEnum)
                {
                    if (m_enumUnderlyingType == null)
                        throw new InvalidOperationException(
                            Environment.GetResourceString("InvalidOperation_NoUnderlyingTypeOnEnum")
                        );
        ...
        {
            get { return m_genParamAttributes; }
        }
        ...
        {
            get { return m_genParamPos; }
        }
        public override MethodBase DeclaringMethod
        {
            get { return m_declMeth; }
        }
        ...
        )
        {
            ...
            if (!object.ReferenceEquals(methodInfoBody.DeclaringType, this))
                ...
                throw new ArgumentException(
                    Environment.GetResourceString("ArgumentException_BadMethodImplBody")
                );
        ...
        )
        {
            ...
            if (!m_isHiddenGlobalType)
            {
                if (
                    ...
                    throw new ArgumentException(
                        Environment.GetResourceString("Argument_BadAttributeOnInterfaceMethod")
                    );
            }
        ...
        private ConstructorBuilder DefineDefaultConstructorNoLock(MethodAttributes attributes)
        {
            ...
            if (m_typeParent is TypeBuilderInstantiation)
            {
                ...
                if (inst is TypeBuilderInstantiation)
                    con = TypeBuilder.GetConstructor(
                        inst,
        ...
        [System.Security.SecurityCritical] // auto-generated
        private TypeBuilder DefineNestedTypeNoLock(
            String name,
            TypeAttributes attr,
            Type parent,
            Type[] interfaces,
        ...
        [System.Security.SecurityCritical] // auto-generated
        private FieldBuilder DefineFieldNoLock(
            String fieldName,
            Type type,
            Type[] requiredCustomModifiers,
            Type[] optionalCustomModifiers,
        ...
        [System.Security.SecurityCritical] // auto-generated
        private PropertyBuilder DefinePropertyNoLock(
            String name,
            PropertyAttributes attributes,
            CallingConventions callingConvention,
            Type returnType,
        ...
        [System.Security.SecurityCritical] // auto-generated
        private EventBuilder DefineEventNoLock(
            String name,
            EventAttributes attributes,
            Type eventtype
        )
        {
            ...
            evToken = new EventToken(
                DefineEvent(m_module.GetNativeHandle(), m_tdType.Token, name, attributes, tkType)
            );
        ...
        private TypeInfo CreateTypeNoLock()
        {
            ...
            if (IsGenericParameter)
            {
                ...
                int declMember =
                    m_declMeth == null
                        ? m_DeclaringType.m_tdType.Token
                        : m_declMeth.GetToken().Token;
                m_tdType = new TypeToken(
                    DefineGenericParam(
                        m_module.GetNativeHandle(),
                        m_strName,
            ...
            for (int i = 0; i < size; i++)
            {
                ...
                if ((methodAttrs & MethodAttributes.Abstract) != 0)
                {
                    ...
                    if (body != null)
                        throw new InvalidOperationException(
                            Environment.GetResourceString("InvalidOperation_BadMethodBody")
                        );
                }
                ...
                if (
                    m_module.ContainingAssemblyBuilder.m_assemblyData.m_access
            ...
            TermCreateClass(
                m_module.GetNativeHandle(),
                m_tdType.Token,
                JitHelpers.GetObjectHandleOnStack(ref cls)
            );
        ...
        public void SetParent(Type parent)
        {
            ...
            if (parent != null)
            {
                ...
                if (parent.IsInterface)
                    throw new ArgumentException(
                        Environment.GetResourceString("Argument_CannotSetParentToInterface")
                    );
...
#pragma warning disable 618
            if (
                !Enum.IsDefined(typeof(SecurityAction), action)
...
#pragma warning restore 618
        ...
        void _TypeBuilder.GetIDsOfNames(
            [In] ref Guid riid,
            IntPtr rgszNames,
            uint cNames,
            uint lcid,
