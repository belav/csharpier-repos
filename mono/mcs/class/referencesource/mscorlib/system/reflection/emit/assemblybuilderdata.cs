...
namespace System.Reflection.Emit
{
    ...
    using System.IO;using System.Runtime.Versioning;using System.Diagnostics.SymbolStore;using System.Diagnostics.Contracts;
    ...
    internal class AssemblyBuilderData
    {
        ...
        internal void AddCustomAttribute(CustomAttributeBuilder customBuilder)
        {
            ...
            {
                CustomAttributeBuilder[] tempCABuilders = new CustomAttributeBuilder[
                    m_iCABuilder * 2
                ];
        ...
        internal void FillUnmanagedVersionInfo()
        {
            ...
            for (int i = 0; i < m_iCABuilder; i++)
            {
                ...
                if (
                    m_CABuilders[i].m_constructorArgs.Length == 0
                    || m_CABuilders[i].m_constructorArgs[0] == null
                )
                    continue;
                ...
                else if (conType.Equals(typeof(System.Reflection.AssemblyTitleAttribute)))
                {
                    ...
                    conType.Equals(typeof(System.Reflection.AssemblyInformationalVersionAttribute))
                )
                {
                    if (m_CABuilders[i].m_constructorArgs.Length != 1)
                    {
                ...
                else if (conType.Equals(typeof(System.Reflection.AssemblyCultureAttribute)))
                {
                    ...
                    CultureInfo culture = new CultureInfo(
                        m_CABuilders[i].m_constructorArgs[0].ToString()
                    );
#if FEATURE_USE_LCID
        ...
        internal void CheckResNameConflict(String strNewResName)
        {
            ...
            for (i = 0; i < size; i++)
            {
                ...
                if (resWriter.m_strName.Equals(strNewResName))
                {
                    ...
                    throw new ArgumentException(
                        Environment.GetResourceString("Argument_DuplicateResourceName")
                    );
                }
            }
        }
        ...
        internal void CheckNameConflict(String strNewModuleName)
        {
            ...
            for (i = 0; i < size; i++)
            {
                ...
                if (moduleBuilder.m_moduleData.m_strModuleName.Equals(strNewModuleName))
                {
                    ...
                    throw new ArgumentException(
                        Environment.GetResourceString("Argument_DuplicateModuleName")
                    );
                }
            }
        ...
        internal void CheckTypeNameConflict(String strTypeName, TypeBuilder enclosingType)
        {
            BCLDebug.Log(
                "DYNIL",
                "## DYNIL LOGGING: AssemblyBuilderData.CheckTypeNameConflict( " + strTypeName + " )"
            );
        ...
        internal void CheckFileNameConflict(String strFileName)
        {
            ...
            for (i = 0; i < size; i++)
            {
                ...
                if (moduleBuilder.m_moduleData.m_strFileName != null)
                {
                    if (
                        String.Compare(
                            moduleBuilder.m_moduleData.m_strFileName,
                            strFileName,
                    ...
                    )
                    {
                        ...
                        throw new ArgumentException(
                            Environment.GetResourceString("Argument_DuplicatedFileName")
                        );
                    }
                }
            }
        ...
        internal ModuleBuilder FindModuleWithName(String strName)
        {
            ...
            for (i = 0; i < size; i++)
            {
                ...
                if (moduleBuilder.m_moduleData.m_strModuleName != null)
                {
                    if (
                        String.Compare(
                            moduleBuilder.m_moduleData.m_strModuleName,
                            strName,
                            StringComparison.OrdinalIgnoreCase
                        ) == 0
                    )
        ...
        internal void AddPublicComType(Type type)
        {
            BCLDebug.Log(
                "DYNIL",
                "## DYNIL LOGGING: AssemblyBuilderData.AddPublicComType( " + type.FullName + " )"
            );
            if (m_isSaved == true)
            {
