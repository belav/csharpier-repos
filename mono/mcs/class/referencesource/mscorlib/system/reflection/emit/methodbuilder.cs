    ...
    public sealed class MethodBuilder : MethodInfo, _MethodBuilder
    {
        ...
        internal void CreateMethodBodyHelper(ILGenerator il)
        {
            ...
            if (m_bIsBaked)
            {
                throw new InvalidOperationException(
                    Environment.GetResourceString("InvalidOperation_MethodHasBody")
                );
            }
            ...
            if (il.m_methodBuilder != this && il.m_methodBuilder != null)
            {
                ...
                throw new InvalidOperationException(
                    Environment.GetResourceString("InvalidOperation_BadILGeneratorUsage")
                );
            }
            ...
            if (il.m_ScopeTree.m_iOpenScopeCount != 0)
            {
                ...
                throw new InvalidOperationException(
                    Environment.GetResourceString("InvalidOperation_OpenLocalVariableScope")
                );
            }
        ...
        internal SignatureHelper GetMethodSignature()
        {
            ...
            m_signature = SignatureHelper.GetMethodSigHelper(
                ...
                m_returnType == null ? typeof(void) : m_returnType,
        ...
        public override ParameterInfo[] GetParameters()
        {
            if (
                ...
                throw new NotSupportedException(
                    Environment.GetResourceString("InvalidOperation_TypeNotCreated")
                );
        ...
        public GenericTypeParameterBuilder[] DefineGenericParameters(params string[] names)
        {
            ...
            if (names.Length == 0)
                throw new ArgumentException(
                    Environment.GetResourceString("Arg_EmptyArray"),
                    "names"
                );
            Contract.EndContractBlock();
            ...
            if (m_inst != null)
                throw new InvalidOperationException(
                    Environment.GetResourceString("InvalidOperation_GenericParametersAlreadySet")
                );
            ...
            if (m_tkMethod.Token != 0)
                throw new InvalidOperationException(
                    Environment.GetResourceString("InvalidOperation_MethodBuilderBaked")
                );
        ...
        private MethodToken GetTokenNoLock()
        {
            ...
            int token = TypeBuilder.DefineMethod(
                ...
                m_containingType.MetadataTokenInternal,
                m_strName,
                sigBytes,
                sigLength,
                Attributes
...
#pragma warning restore 618
        ...
        )
        {
            ...
            {
                throw new InvalidOperationException(
                    Environment.GetResourceString("InvalidOperation_MethodBaked")
                );
            }
        ...
        )
        {
            ...
            for (int i = 0; i < exceptionHandlers.Length; i++)
            {
                ...
                if (
                    handler.m_filterOffset > maxOffset
                    || handler.m_tryEndOffset > maxOffset
                    || handler.m_handlerEndOffset > maxOffset
                )
                {
                    throw new ArgumentOutOfRangeException(
                        "exceptionHandlers[" + i + "]",
                        Environment.GetResourceString("ArgumentOutOfRange_Range", 0, maxOffset)
                    );
                }
                ...
                )
                {
                    throw new ArgumentException(
                        Environment.GetResourceString(
                            "Argument_InvalidTypeToken",
                            handler.ExceptionTypeToken
                        ),
                        "exceptionHandlers[" + i + "]"
                    );
                }
        ...
        private void ThrowIfShouldNotHaveBody()
        {
            ...
            )
            {
                ...
                //
                throw new InvalidOperationException(
                    Environment.GetResourceString("InvalidOperation_ShouldNotHaveMethodBody")
                );
            }
        }
        ...
        {
            [System.Security.SecuritySafeCritical] // auto-generated
            get { return GetMethodSignature().ToString(); }
        }
        ...
        void _MethodBuilder.GetIDsOfNames(
            [In] ref Guid riid,
            IntPtr rgszNames,
            uint cNames,
            uint lcid,
    ...
    public readonly struct ExceptionHandler : IEquatable<ExceptionHandler>
    {
        ...
        )
        {
            ...
            {
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_InvalidTypeToken", exceptionTypeToken),
                    "exceptionTypeToken"
                );
            }
