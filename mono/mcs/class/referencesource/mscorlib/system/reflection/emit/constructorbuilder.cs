...
namespace System.Reflection.Emit
{
    ...
    public sealed class ConstructorBuilder : ConstructorInfo, _ConstructorBuilder
    {
        ...
        public ILGenerator GetILGenerator()
        {
            if (m_isDefaultConstructor)
                throw new InvalidOperationException(
                    Environment.GetResourceString("InvalidOperation_DefaultConstructorILGen")
                );
        ...
        )
        {
            ...
            {
                throw new InvalidOperationException(
                    Environment.GetResourceString("InvalidOperation_DefaultConstructorDefineBody")
                );
            }

            m_methodBuilder.SetMethodBody(
                il,
                maxStack,
                localSignature,
                exceptionHandlers,
