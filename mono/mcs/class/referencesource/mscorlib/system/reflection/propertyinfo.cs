    ...
    public abstract class PropertyInfo : MemberInfo, _PropertyInfo
    {
        ...
        public static bool operator ==(PropertyInfo left, PropertyInfo right)
        {
            ...
            if (
                (object)left == null
                || (object)right == null
                || left is RuntimePropertyInfo
                || right is RuntimePropertyInfo
            )
            {
                return false;
            }
        ...
        void _PropertyInfo.GetIDsOfNames(
            [In] ref Guid riid,
            IntPtr rgszNames,
            uint cNames,
            uint lcid,
    ...
    internal sealed unsafe class RuntimePropertyInfo : PropertyInfo, ISerializable
    {
        ...
        internal bool EqualsSig(RuntimePropertyInfo target)
        {
            ...
            if (CompatibilitySwitches.IsAppEarlierThanWindowsPhone8)
                return Signature.CompareSigForAppCompat(
                    this.Signature,
                    this.m_declaringType,
                    target.Signature,
                    target.m_declaringType
                );
#endif
        ...
        private string FormatNameAndSig(bool serialization)
        {
            ...
            if (arguments.Length > 0)
            {
                sbName.Append(" [");
                sbName.Append(
                    MethodBase.ConstructParameters(
                        arguments,
        ...
        {
            get { return m_getterMethod != null; }
        }

        public override bool CanWrite
        {
            get { return m_setterMethod != null; }
        }
        #endregion
        ...
        )
        {
            ...
            if (m == null)
                throw new ArgumentException(
                    System.Environment.GetResourceString("Arg_GetMethNotFnd")
                );
        ...
        )
        {
            ...
            if (m == null)
                throw new ArgumentException(
                    System.Environment.GetResourceString("Arg_SetMethNotFnd")
                );
