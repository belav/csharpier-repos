    ...
    public abstract partial class MethodBase : MemberInfo, _MethodBase
    {
        ...
        public static bool operator ==(MethodBase left, MethodBase right)
        {
            ...
            if ((method1 = left as MethodInfo) != null && (method2 = right as MethodInfo) != null)
                ...
                (constructor1 = left as ConstructorInfo) != null
                && (constructor2 = right as ConstructorInfo) != null
            )
...
#pragma warning restore 618
        ...
        {
            get { return String.Format("{0}.{1}", DeclaringType.FullName, FormatNameAndSig()); }
        }
        ...
        void _MethodBase.GetIDsOfNames(
            [In] ref Guid riid,
            IntPtr rgszNames,
            uint cNames,
            uint lcid,
