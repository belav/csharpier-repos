...
namespace System.Reflection
{
    ...
    using System.Runtime.Serialization;using System.Security.Permissions;using System.Threading;using RuntimeTypeCache = System.RuntimeType.RuntimeTypeCache;
...
#pragma warning restore 618
            ...
            if (declaringType != null && declaringType.IsGenericType)
                throw new ArgumentException(
                    String.Format(
                        ...
                        Environment.GetResourceString("Argument_FieldDeclaringTypeGeneric"),
                        f.Name,
    ...
    internal abstract class RuntimeFieldInfo : FieldInfo, ISerializable
    {
        ...
        internal RemotingFieldCachedData RemotingCache
        {
            get
            {
                ...
                if (cache == null)
                {
                    ...
                    RemotingFieldCachedData ret = Interlocked.CompareExchange(
                        ref m_cachedData,
                        cache,
                        null
                    );
        ...
        {
            get { return m_reflectedTypeCache.IsGlobal ? null : ReflectedTypeInternal; }
        }

        public override Type DeclaringType
        {
            get { return m_reflectedTypeCache.IsGlobal ? null : m_declaringType; }
        }
    ...
    internal sealed unsafe class RtFieldInfo : RuntimeFieldInfo, IRuntimeFieldInfo
    {
            ...
            get
            {
                if ((m_invocationFlags & INVOCATION_FLAGS.INVOCATION_FLAGS_INITIALIZED) == 0)
                {
                    ...
                    if (invocationFlags == 0)
                    {
                        ...
                        bool needsTransparencySecurityCheck =
                            IsSecurityCritical && !IsSecuritySafeCritical;
                        bool needsVisibilitySecurityCheck =
                            (
                                (m_fieldAttributes & FieldAttributes.FieldAccessMask)
        ...
        RuntimeFieldHandleInternal IRuntimeFieldInfo.Value
        {
            ...
            get { return new RuntimeFieldHandleInternal(m_fieldHandle); }
        }
        ...
        )
        {
            ...
            if ((invocationFlags & INVOCATION_FLAGS.INVOCATION_FLAGS_NO_INVOKE) != 0)
            {
                if (declaringType != null && declaringType.ContainsGenericParameters)
                    throw new InvalidOperationException(
                        Environment.GetResourceString("Arg_UnboundGenField")
                    );

                if (
                    (declaringType == null && Module.Assembly.ReflectionOnly)
                    || declaringType is ReflectionOnlyType
                )
                    throw new InvalidOperationException(
                        Environment.GetResourceString("Arg_ReflectionOnlyField")
                    );
            ...
            if (
                (
                    invocationFlags
                    & (
                        INVOCATION_FLAGS.INVOCATION_FLAGS_SPECIAL_FIELD
                        | INVOCATION_FLAGS.INVOCATION_FLAGS_NEED_SECURITY
                    )
                ) != 0
            )
                PerformVisibilityCheckOnField(
                    m_fieldHandle,
                    obj,
                    m_declaringType,
                    m_fieldAttributes,
        ...
        internal Object InternalGetValue(Object obj, ref StackCrawlMark stackMark)
        {
            ...
            if ((invocationFlags & INVOCATION_FLAGS.INVOCATION_FLAGS_NEED_SECURITY) != 0)
                PerformVisibilityCheckOnField(
                    ...
                    m_declaringType,
                    m_fieldAttributes,
                    (uint)(m_invocationFlags & ~INVOCATION_FLAGS.INVOCATION_FLAGS_SPECIAL_FIELD)
                );
    ...
    internal sealed unsafe class MdFieldInfo : RuntimeFieldInfo, ISerializable
    {
        ...
        {
            get { return DeclaringType.IsSecurityCritical; }
        }
        public override bool IsSecuritySafeCritical
        {
            get { return DeclaringType.IsSecuritySafeCritical; }
        }
        public override bool IsSecurityTransparent
        {
            get { return DeclaringType.IsSecurityTransparent; }
        }
