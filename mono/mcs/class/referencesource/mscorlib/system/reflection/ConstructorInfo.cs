    ...
    public abstract class ConstructorInfo : MethodBase, _ConstructorInfo
    {
        ...
        public static bool operator ==(ConstructorInfo left, ConstructorInfo right)
        {
            ...
            if (
                (object)left == null
                || (object)right == null
                || left is RuntimeConstructorInfo
                || right is RuntimeConstructorInfo
            )
            {
                return false;
            }
        ...
        Object _ConstructorInfo.Invoke_2(
            Object obj,
            BindingFlags invokeAttr,
            Binder binder,
            Object[] parameters,
        ...
        Object _ConstructorInfo.Invoke_4(
            BindingFlags invokeAttr,
            Binder binder,
            Object[] parameters,
            CultureInfo culture
        ...
        void _ConstructorInfo.GetIDsOfNames(
            [In] ref Guid riid,
            IntPtr rgszNames,
            uint cNames,
            uint lcid,
        ...
        internal bool IsOverloaded
        {
            get
            {
                return m_reflectedTypeCache
                        .GetConstructorList(MemberListType.CaseSensitive, Name)
                        .Length > 1;
            }
        }
        #endregion
        ...
        internal static void CheckCanCreateInstance(Type declaringType, bool isVarArg)
        {
            ...
            // ctor is declared on interface class
                ...
                throw new MemberAccessException(
                    String.Format(
                        ...
                        Environment.GetResourceString("Acc_CreateInterfaceEx"),
                        declaringType
                    )
                );
            // ctor is on an abstract class
                ...
                throw new MemberAccessException(
                    String.Format(
                        CultureInfo.CurrentUICulture,
                        Environment.GetResourceString("Acc_CreateAbstEx"),
                        declaringType
                    )
                );
...
#pragma warning restore 618
        ...
        {
            get { return (DeclaringType != null && DeclaringType.ContainsGenericParameters); }
        }
        #endregion
            ...
            if (
                (
                    ...
                    & (
                        INVOCATION_FLAGS.INVOCATION_FLAGS_RISKY_METHOD
                        | INVOCATION_FLAGS.INVOCATION_FLAGS_NEED_SECURITY
                        | INVOCATION_FLAGS.INVOCATION_FLAGS_IS_DELEGATE_CTOR
                    )
                ) != 0
            )
            {
