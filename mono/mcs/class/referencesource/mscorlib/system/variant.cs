...
namespace System
{
    ...
    internal struct Variant
    {
        ...
        internal static readonly Variant Missing = new Variant(
            Variant.CV_MISSING,
            Type.Missing,
            0,
            0
        ...
        internal int CVType
        {
            get { return (m_flags & TypeCodeBitMask); }
        }
        ...
        {
#if FEATURE_REMOTING
            IConvertible ic = System.Runtime.Remoting.RemotingServices.IsTransparentProxy(o)
                ? null
                : o as IConvertible;
#else
        ...
        internal static void MarshalHelperCastVariant(Object pValue, int vt, ref Variant v)
        {
            ...
            if (iv == null)
            {
                switch (vt)
                {
                    ...
                    default:
                        throw new InvalidCastException(
                            Environment.GetResourceString("InvalidCast_CannotCoerceByRefVariant")
                        );
                }
            }
            else
