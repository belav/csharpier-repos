...
namespace System.Resources
{
    ...
    using System.Globalization;using System.Runtime.Versioning;using System.Diagnostics.Contracts;using System.Security;using System.Security.Permissions;
    ...
    public sealed class ResourceWriter : IResourceWriter
    {
        ...
        public void AddResource(String name, String value)
        {
            ...
            if (_resourceList == null)
                throw new InvalidOperationException(
                    Environment.GetResourceString("InvalidOperation_ResourceWriterSaved")
                );
        ...
        public void Generate()
        {
            ...
            // this file.
            resMgrHeaderPart.Write(
                MultitargetingHelpers.GetAssemblyQualifiedName(
            ...
            using (dataSection)
            {
                ...
                {
                    nameHashes[curNameNumber] = FastResourceComparer.HashFunction(
                        (String)items.Key
                    );
                ...
                BCLDebug.Log(
                    "RESMGRFILEFORMAT",
                    "Generate: start of DataSection: 0x"
                        + startOfDataSection.ToString("x", CultureInfo.InvariantCulture)
                        + "  nameSection length: "
                        + nameSection.Length
                );
