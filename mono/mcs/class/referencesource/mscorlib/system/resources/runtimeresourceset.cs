...
namespace System.Resources
{
    ...
    internal sealed class RuntimeResourceSet : ResourceSet, IEnumerable
    {
        ...
        internal RuntimeResourceSet(Stream stream, Assembly assembly)
            : base(false)
        {
        ...
        private IDictionaryEnumerator GetEnumeratorHelper()
        {
            ...
            if (copyOfReader == null || _resCache == null)
                throw new ObjectDisposedException(
                    null,
                    Environment.GetResourceString("ObjectDisposed_ResourceSet")
                );
            ...
            lock (Reader)
            {
                ...
                if (_defaultReader != null)
                {
                    ...
                    if (dataPos != -1 && value == null)
                    {
                        ...
                        resLocation = new ResourceLocator(
                            dataPos,
                    ...
                    if (value != null || !ignoreCase)
                    {
                        ...
                        {
                            LooselyLinkedResourceReference assRef =
                                (LooselyLinkedResourceReference)value;
                ...
                if (!_haveReadFromReader)
                {
                    ...
                    {
                        _caseInsensitiveTable = new Dictionary<String, ResourceLocator>(
                    ...
                    BCLDebug.Perf(
                        !ignoreCase,
                        "Using case-insensitive lookups is bad perf-wise.  Consider capitalizing "
                            + key
                            + " correctly in your source"
                    );
#endif
                    ...
                    else
                    {
                        ...
                        ResourceReader.ResourceEnumerator en =
        ...
        private Object ResolveResourceLocator(
            ResourceLocator resLocation,
            String key,
