...
namespace System.Resources
{
    ...
    public sealed class ResourceReader : IResourceReader
    {
        ...
        {
            "System.String[], mscorlib, Culture=neutral, PublicKeyToken="
                + AssemblyRef.MicrosoftPublicKeyToken,
            "System.DateTime[], mscorlib, Culture=neutral, PublicKeyToken="
                + AssemblyRef.MicrosoftPublicKeyToken,
            "System.Drawing.Bitmap, System.Drawing, Culture=neutral, PublicKeyToken="
                + AssemblyRef.MicrosoftPublicKeyToken,
            "System.Drawing.Imaging.Metafile, System.Drawing, Culture=neutral, PublicKeyToken="
                + AssemblyRef.MicrosoftPublicKeyToken,
            "System.Drawing.Point, System.Drawing, Culture=neutral, PublicKeyToken="
                + AssemblyRef.MicrosoftPublicKeyToken,
            "System.Drawing.PointF, System.Drawing, Culture=neutral, PublicKeyToken="
                + AssemblyRef.MicrosoftPublicKeyToken,
            "System.Drawing.Size, System.Drawing, Culture=neutral, PublicKeyToken="
                + AssemblyRef.MicrosoftPublicKeyToken,
            "System.Drawing.SizeF, System.Drawing, Culture=neutral, PublicKeyToken="
                + AssemblyRef.MicrosoftPublicKeyToken,
            "System.Drawing.Font, System.Drawing, Culture=neutral, PublicKeyToken="
                + AssemblyRef.MicrosoftPublicKeyToken,
            "System.Drawing.Icon, System.Drawing, Culture=neutral, PublicKeyToken="
                + AssemblyRef.MicrosoftPublicKeyToken,
            "System.Drawing.Color, System.Drawing, Culture=neutral, PublicKeyToken="
                + AssemblyRef.MicrosoftPublicKeyToken,
            "System.Windows.Forms.Cursor, System.Windows.Forms, Culture=neutral, PublicKeyToken="
                + AssemblyRef.EcmaPublicKeyToken,
            "System.Windows.Forms.Padding, System.Windows.Forms, Culture=neutral, PublicKeyToken="
                + AssemblyRef.EcmaPublicKeyToken,
            "System.Windows.Forms.LinkArea, System.Windows.Forms, Culture=neutral, PublicKeyToken="
                + AssemblyRef.EcmaPublicKeyToken,
            "System.Windows.Forms.ImageListStreamer, System.Windows.Forms, Culture=neutral, PublicKeyToken="
                + AssemblyRef.EcmaPublicKeyToken,
            "System.Windows.Forms.ListViewGroup, System.Windows.Forms, Culture=neutral, PublicKeyToken="
                + AssemblyRef.EcmaPublicKeyToken,
            "System.Windows.Forms.ListViewItem, System.Windows.Forms, Culture=neutral, PublicKeyToken="
                + AssemblyRef.EcmaPublicKeyToken,
            "System.Windows.Forms.ListViewItem+ListViewSubItem, System.Windows.Forms, Culture=neutral, PublicKeyToken="
                + AssemblyRef.EcmaPublicKeyToken,
            "System.Windows.Forms.ListViewItem+ListViewSubItem+SubItemStyle, System.Windows.Forms, Culture=neutral, PublicKeyToken="
                + AssemblyRef.EcmaPublicKeyToken,
            "System.Windows.Forms.OwnerDrawPropertyBag, System.Windows.Forms, Culture=neutral, PublicKeyToken="
                + AssemblyRef.EcmaPublicKeyToken,
            "System.Windows.Forms.TreeNode, System.Windows.Forms, Culture=neutral, PublicKeyToken="
                + AssemblyRef.EcmaPublicKeyToken,
        };
        ...
        public ResourceReader(String fileName)
        {
            ...
            BCLDebug.Log(
                "RESMGRFILEFORMAT",
                "ResourceReader .ctor(String).  UnmanagedMemoryStream: " + (_ums != null)
            );
        ...
        public ResourceReader(Stream stream)
        {
            ...
            BCLDebug.Log(
                "RESMGRFILEFORMAT",
                "ResourceReader .ctor(Stream).  UnmanagedMemoryStream: " + (_ums != null)
            );
            ReadResources();
        }
        ...
        internal ResourceReader(Stream stream, Dictionary<String, ResourceLocator> resCache)
        {
            ...
            BCLDebug.Log(
                "RESMGRFILEFORMAT",
                "ResourceReader .ctor(Stream, Hashtable).  UnmanagedMemoryStream: " + (_ums != null)
            );
            ReadResources();
        }
        ...
        private unsafe int GetNameHash(int index)
        {
            ...
            Contract.Assert(
                (_ums == null && _nameHashes != null && _nameHashesPtr == null)
                    || (_ums != null && _nameHashes == null && _nameHashesPtr != null),
        ...
        private unsafe int GetNamePosition(int index)
        {
            ...
            Contract.Assert(
                (_ums == null && _namePositions != null && _namePositionsPtr == null)
                    || (_ums != null && _namePositions == null && _namePositionsPtr != null),
                "Internal state mangled."
            );
            int r;
        ...
        public IDictionaryEnumerator GetEnumerator()
        {
            if (_resCache == null)
                throw new InvalidOperationException(
                    Environment.GetResourceString("ResourceReaderIsClosed")
                );
        ...
        internal int FindPosForResource(String name)
        {
            ...
            BCLDebug.Log(
                "RESMGRFILEFORMAT",
                "FindPosForResource for "
                    + name
                    + "  hash: "
                    + hash.ToString("x", CultureInfo.InvariantCulture)
            );
        ...
        internal String LoadString(int pos)
        {
            ...
            BCLDebug.Log(
                "RESMGRFILEFORMAT",
                "LoadString("
                    + pos.ToString("x", CultureInfo.InvariantCulture)
                    + " returned "
                    + (s == null ? "[a null string]" : s)
            );
            return s;
        }
        ...
        private Object _LoadObjectV1(int pos)
        {
            ...
            BCLDebug.Log(
                ...
                "LoadObject type: "
                    + type.Name
                    + "  pos: 0x"
                    + _store.BaseStream.Position.ToString("x", CultureInfo.InvariantCulture)
            );
        ...
        private Object DeserializeObject(int typeIndex)
        {
            ...
            if (graph.GetType() != type)
                throw new BadImageFormatException(
                    Environment.GetResourceString(
                        "BadImageFormat_ResType&SerBlobMismatch",
                        type.FullName,
        ...
        private void _ReadResources()
        {
            ...
            if (magicNum != ResourceManager.MagicNumber)
                throw new ArgumentException(
                    Environment.GetResourceString("Resources_StreamNotValid")
                );
            ...
            if (resMgrHeaderVersion > 1)
            {
                BCLDebug.Log(
                    "RESMGRFILEFORMAT",
                    BCLDebugLogLevel.Status,
                    "ReadResources: Unexpected ResMgr header version: {0}  Skipping ahead {1} bytes.",
                    resMgrHeaderVersion,
                    numBytesToSkip
                );
            ...
            else
            {
                ...
                if (
                    !ResourceManager.CompareNames(
                        readerType,
                        ResourceManager.ResReaderTypeName,
                        mscorlib
                    )
                )
                    throw new NotSupportedException(
            ...
            {
                Console.WriteLine(
                    "ResourceReader is looking at a debuggable .resources file, version {0}",
                    _version
                );
            }
            else
            ...
            BCLDebug.Log(
                "RESMGRFILEFORMAT",
                "ReadResources: Expecting " + _numResources + " resources."
            );
#if _DEBUG
            if (ResourceManager.DEBUG >= 4)
                Console.WriteLine(
                    "ResourceReader::ReadResources - Reading in " + _numResources + " resources"
                );
#endif
            ...
            if (ResourceManager.DEBUG >= 5)
                Console.WriteLine(
                    "ResourceReader::ReadResources - Reading in " + numTypes + " type table entries"
                );
#endif
            ...
            BCLDebug.Log(
                ...
                String.Format(
                    ...
                    "ReadResources: _nameOffset = 0x{0:x}  _dataOffset = 0x{1:x}",
                    _nameSectionOffset,
                    _dataSectionOffset
                )
            );
        ...
        )
        {
            ...
            {
                throw new ArgumentException(
                    Environment.GetResourceString("Arg_ResourceNameNotExist", resourceName)
                );
            }
            ...
            lock (this)
            {
                ...
                long nextData =
                    (index < _numResources - 1)
                        ? sortedDataPositions[index + 1] + _dataSectionOffset
                        : _store.BaseStream.Length;
                int len = (int)(nextData - (dataPos + _dataSectionOffset));
                Contract.Assert(
                    len >= 0 && len <= (int)_store.BaseStream.Length - dataPos + _dataSectionOffset,
