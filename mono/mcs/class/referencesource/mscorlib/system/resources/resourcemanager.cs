...
#pragma warning restore 618
            ...
            if (FrameworkEventSource.IsInitialized && FrameworkEventSource.Log.IsEnabled())
            {
                ...
                {
                    FrameworkEventSource.Log.ResourceManagerNeutralResourcesFound(
                        BaseNameField,
                        MainAssembly,
                        defaultResName
                    );
                ...
                {
                    FrameworkEventSource.Log.ResourceManagerNeutralResourcesNotFound(
                        BaseNameField,
                        MainAssembly,
                        defaultResName
                    );
        ...
        public ResourceManager(String baseName, Assembly assembly, Type usingResourceSet)
        {
            ...
            if (
                ...
                && (usingResourceSet != _minResourceSet)
                && !(usingResourceSet.IsSubclassOf(_minResourceSet))
            )
                throw new ArgumentException(
                    Environment.GetResourceString("Arg_ResMgrNotResSet"),
                    "usingResourceSet"
                );
            _userResourceSet = usingResourceSet;
        ...
        private void OnDeserialized(StreamingContext ctx)
        {
            ...
            if (UseManifest && this._neutralResourcesCulture == null)
            {
                _neutralResourcesCulture =
                    ManifestBasedResourceGroveler.GetNeutralResourcesLanguage(
                        MainAssembly,
                        ref _fallbackLoc
                    );
            }
...
#pragma warning restore 618
        ...
        public virtual void ReleaseAllResources()
        {
            ...
            {
                FrameworkEventSource.Log.ResourceManagerReleasingResources(
                    BaseNameField,
                    MainAssembly
                );
            }
...
#pragma warning restore 618
        ...
        )
        {
            ...
            if (UseManifest && culture.HasInvariantCultureName)
            {
                ...
                Stream stream = mainAssembly.GetManifestResourceStream(
                    _locationInfo,
                    fileName,
                    m_callingAssembly == MainAssembly,
                    ref stackMark
                );
        ...
        [ResourceExposure(ResourceScope.None)]
        [ResourceConsumption(ResourceScope.Machine, ResourceScope.Machine)]
        private ResourceSet InternalGetResourceSet(
        ...
        )
        {
            ...
            lock (localResourceSets)
            {
                if (localResourceSets.TryGetValue(requestedCulture.Name, out rs))
                {
                    ...
                    if (FrameworkEventSource.IsInitialized)
                    {
                        FrameworkEventSource.Log.ResourceManagerFoundResourceSetInCache(
                            BaseNameField,
                            MainAssembly,
            ...
            foreach (CultureInfo currentCultureInfo in mgr)
            {
                ...
                if (FrameworkEventSource.IsInitialized)
                {
                    FrameworkEventSource.Log.ResourceManagerLookingForResourceSet(
                        BaseNameField,
                        MainAssembly,
                        currentCultureInfo.Name
                    );
                }
#endif
                lock (localResourceSets)
                ...
                rs = resourceGroveler.GrovelForResourceSet(
                    currentCultureInfo,
                    localResourceSets,
                    tryParents,
                    createIfNotExists,
        ...
        protected static Version GetSatelliteContractVersion(Assembly a)
        {
            ...
            if (a == null)
            {
                throw new ArgumentNullException(
                    "a",
                    Environment.GetResourceString("ArgumentNull_Assembly")
                );
            }
            Contract.EndContractBlock();
        ...
        protected static CultureInfo GetNeutralResourcesLanguage(Assembly a)
        {
            ...
            UltimateResourceFallbackLocation ignoringUsefulData =
                UltimateResourceFallbackLocation.MainAssembly;
            CultureInfo culture = ManifestBasedResourceGroveler.GetNeutralResourcesLanguage(
                a,
        ...
        // IGNORES VERSION
        internal static bool CompareNames(
            String asmTypeName1,
            String typeName2,
        ...
        )
        {
            ...
            if (
                (an1.CultureInfo != null)
                && (asmName2.CultureInfo != null)
                &&
#if FEATURE_USE_LCID
        ...
        private string GetStringFromPRI(
            String stringName,
            String startingCulture,
            String neutralResourcesCulture
        )
        ...
        {
            Type WinRTResourceManagerType = Type.GetType(
            ...
            return (WindowsRuntimeResourceManagerBase)
                Activator.CreateInstance(WinRTResourceManagerType, true);
        }
        ...
        private bool ShouldUseSatelliteAssemblyResourceLookupUnderAppX(
            RuntimeAssembly resourcesAssembly
        )
        {
            bool fUseSatelliteAssemblyResourceLookupUnderAppX =
                resourcesAssembly.IsFrameworkAssembly();
            ...
            if (!fUseSatelliteAssemblyResourceLookupUnderAppX)
            {
                ...
                if ((platformResourceRoots != null) && (platformResourceRoots != String.Empty))
                {
                    ...
                    foreach (
                        string pathPlatformResourceRoot in platformResourceRoots.Split(
                            Path.PathSeparator
                        )
                    )
                    {
                        if (
                            resourceAssemblyPath.StartsWith(
                                pathPlatformResourceRoot,
                    ...
                    if (AppDomain.IsAppXModel() && !AppDomain.IsAppXNGen)
                    {
                        ...
                        if (AppDomain.IsAppXDesignMode())
                        {
                            ...
                            try
                            {
                                ...
                                bWRRM_Initialized = WRRM.Initialize(
                                    resourcesAssembly.Location,
                                    reswFilename,
                                    out exceptionInfo
                                );
                        ...
                        if (!bUsingSatelliteAssembliesUnderAppX)
                        {
                            ...
                            if (_bUsingModernResourceManagement)
                            {
                                ...
                                else
                                {
                                    ...
                                    try
                                    {
                                        _PRIonAppXInitialized = _WinRTResourceManager.Initialize(
                                            resourcesAssembly.Location,
                                            reswFilename,
        ...
        public virtual String GetString(String name, CultureInfo culture)
        {
            ...
            if (_bUsingModernResourceManagement)
            {
                if (_PRIonAppXInitialized == false)
                {
                    ...
                    if (
                        ...
                        && _PRIExceptionInfo._PackageSimpleName != null
                        && _PRIExceptionInfo._ResWFile != null
                    )
                        throw new MissingManifestResourceException(
                            Environment.GetResourceString(
                                "MissingManifestResource_ResWFileNotLoaded",
                                _PRIExceptionInfo._ResWFile,
                                _PRIExceptionInfo._PackageSimpleName
                            )
                        );

                    throw new MissingManifestResourceException(
                        Environment.GetResourceString("MissingManifestResource_NoPRIresources")
                    );
                }

                // Throws WinRT hresults.
                return GetStringFromPRI(
                    name,
...
#endif // FEATURE_APPX
            {
                ...
                if (FrameworkEventSource.IsInitialized)
                {
                    FrameworkEventSource.Log.ResourceManagerLookupStarted(
                        BaseNameField,
                        MainAssembly,
                        culture.Name
                    );
                    ...
                    if (rs != last)
                    {
                        ...
                        if (value != null)
                        {
                            ...
                            if (_lastUsedResourceCache != null)
                            {
                                lock (_lastUsedResourceCache)
                                {
                                    _lastUsedResourceCache.lastCultureName =
                                        currentCultureInfo.Name;
                                    _lastUsedResourceCache.lastResourceSet = rs;
                                }
                            }
                ...
                if (FrameworkEventSource.IsInitialized)
                {
                    FrameworkEventSource.Log.ResourceManagerLookupFailed(
                        BaseNameField,
                        MainAssembly,
                        culture.Name
                    );
        ...
        public UnmanagedMemoryStream GetStream(String name, CultureInfo culture)
        {
            ...
            if (ums == null && obj != null)
                throw new InvalidOperationException(
                    Environment.GetResourceString("InvalidOperation_ResourceNotStream_Name", name)
                );
            return ums;
        }
        ...
        private bool TryLookingForSatellite(CultureInfo lookForCulture)
        {
            ...
            if (FrameworkEventSource.IsInitialized && FrameworkEventSource.Log.IsEnabled())
            {
                if (pos < 0)
                {
                    FrameworkEventSource.Log.ResourceManagerCultureNotFoundInConfigFile(
                        BaseNameField,
                        MainAssembly,
                        lookForCulture.Name
                    );
                ...
                {
                    FrameworkEventSource.Log.ResourceManagerCultureFoundInConfigFile(
                        BaseNameField,
                        MainAssembly,
                        lookForCulture.Name
                    );
