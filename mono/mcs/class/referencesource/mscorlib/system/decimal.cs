...
namespace System
{
    ...
    public struct Decimal : IFormattable, IComparable, IConvertible, IDeserializationCallback
    {
        ...
        {
            Contract.Requires(
                (buffer != null && buffer.Length >= 16),
                "[GetBytes]buffer != null && buffer.Length >= 16"
            );
            buffer[0] = (byte)d.lo;
        ...
        internal static decimal ToDecimal(byte[] buffer)
        {
            Contract.Requires(
                (buffer != null && buffer.Length >= 16),
                "[ToDecimal]buffer != null && buffer.Length >= 16"
            );
            int lo =
                ((int)buffer[0])
                | ((int)buffer[1] << 8)
        ...
        private static void InternalRoundFromZero(ref Decimal d, int decimalCount)
        {
            ...
            {
                Int32 diffChunk =
                    (scaleDifference > MaxInt32Scale) ? MaxInt32Scale : scaleDifference;
        ...
        char IConvertible.ToChar(IFormatProvider provider)
        {
            throw new InvalidCastException(
                Environment.GetResourceString("InvalidCast_FromTo", "Decimal", "Char")
            );
        }
        ...
        {
            throw new InvalidCastException(
                Environment.GetResourceString("InvalidCast_FromTo", "Decimal", "DateTime")
            );
        }
