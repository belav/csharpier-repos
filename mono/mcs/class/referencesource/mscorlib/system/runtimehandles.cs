...
namespace System
{
    ...
    public unsafe struct RuntimeTypeHandle : ISerializable
    {
        ...
        internal static unsafe Type GetTypeHelper(
            Type typeStart,
            Type[] genericArgs,
            IntPtr pModifiers,
            int cModifiers
        ...
        {
            get { return new RuntimeTypeHandle(null); }
        }
        ...
        public IntPtr Value
        {
            ...
            [SecurityCritical]
#endif
            get { return m_type != null ? m_type.m_handle : IntPtr.Zero; }
        }
        ...
        internal static bool HasElementType(RuntimeType type)
        {
            ...
            return (
                (corElemType == CorElementType.Array || corElemType == CorElementType.SzArray) // IsArray
                || (corElemType == CorElementType.Ptr) // IsPointer
                || (corElemType == CorElementType.ByRef)
            ); // IsByRef
        }
        ...
        internal static extern Object CreateInstance(
            ...
            bool publicOnly,
            bool noCheck,
            ref bool canBeCached,
            ref RuntimeMethodHandleInternal ctor,
            ref bool bNeedSecurityCheck
        );
        ...
        [DllImport(JitHelpers.QCall, CharSet = CharSet.Unicode)]
        [SuppressUnmanagedCodeSecurity]
        private static extern int GetInterfaceMethodImplementationSlot(
            RuntimeTypeHandle handle,
            RuntimeTypeHandle interfaceHandle,
        ...
        {
            return GetInterfaceMethodImplementationSlot(
                GetNativeHandle(),
                interfaceHandle.GetNativeHandle(),
        ...
        internal string ConstructName(TypeNameFormatFlags formatFlags)
        {
            ...
            ConstructName(
                GetNativeHandle(),
                formatFlags,
                JitHelpers.GetStringHandleOnStack(ref name)
            );
            return name;
        }
        ...
        [DllImport(JitHelpers.QCall, CharSet = CharSet.Unicode)]
        [SuppressUnmanagedCodeSecurity]
        private static extern void GetDefaultConstructor(
            RuntimeTypeHandle handle,
            ObjectHandleOnStack method
        );
        ...
        internal Type[] GetInstantiationPublic()
        {
            ...
            GetInstantiation(
                GetNativeHandle(),
                JitHelpers.GetObjectHandleOnStack(ref types),
                false
            );
            return types;
        }
        ...
        public void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            if (m_type == null)
                throw new SerializationException(
                    Environment.GetResourceString("Serialization_InvalidFieldState")
                );
    ...
    // created when we can prove that we don't need that object. Use of this type requires code to
    // ensure
    ...
    //  2. When managed code acquires one of these from an IRuntimeMethodInfo, and ensure that the
    // IRuntimeMethodInfo is preserved
    //     across the lifetime of the RuntimeMethodHandleInternal instance
    //  3. When another object is used to keep the RuntimeMethodHandleInternal alive. See delegates,
    // CreateInstance cache, Signature structure
    ...
    internal class RuntimeMethodInfoStub : IRuntimeMethodInfo
    {
        ...
        // These unused variables are used to ensure that this class has the same layout as
        // RuntimeMethodInfo
...
#pragma warning restore 169
    ...
    public unsafe struct RuntimeMethodHandle : ISerializable
    {
        ...
        public IntPtr Value
        {
            ...
            [SecurityCritical]
#endif
            get { return m_value != null ? m_value.Value.Value : IntPtr.Zero; }
        }
        ...
        [ResourceExposure(ResourceScope.None)]
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern unsafe void CheckLinktimeDemands(
        ...
        )
        {
            ...
            ConstructInstantiation(
                EnsureNonNullMethodInfo(method),
                format,
                JitHelpers.GetStringHandleOnStack(ref name)
            );
            return name;
        ...
        [ResourceExposure(ResourceScope.None)]
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern void PerformSecurityCheck(
            Object obj,
        ...
        [System.Security.SecurityCritical]
        internal static void PerformSecurityCheck(
            Object obj,
            IRuntimeMethodInfo method,
            RuntimeType parent,
            uint invocationFlags
        ...
        [ResourceExposure(ResourceScope.None)]
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern void SerializationInvoke(
            IRuntimeMethodInfo method,
            Object target,
            SerializationInfo info,
            ref StreamingContext context
        );
        ...
        {
            return _IsTokenSecurityTransparent(
                module.ModuleHandle.GetRuntimeModule(),
                metaDataToken
            );
        }
        ...
        [DllImport(JitHelpers.QCall, CharSet = CharSet.Unicode)]
        [SuppressUnmanagedCodeSecurity]
        private static extern void GetCallerType(
            StackCrawlMarkHandle stackMark,
            ObjectHandleOnStack retType
        );
        ...
        [MethodImpl(MethodImplOptions.InternalCall)]
        [System.Security.SecuritySafeCritical] // auto-generated
        internal static extern MethodBody GetMethodBody(
            IRuntimeMethodInfo method,
            RuntimeType declaringType
        );
    ...
    // Cases in which this may be used:
    //  1. When native code calls managed code passing one of these as a parameter
    //  2. When managed code acquires one of these from an RtFieldInfo, and ensure that the RtFieldInfo
    // is preserved
    ...
    internal struct RuntimeFieldHandleInternal
    {
        ...
        {
            get { return new RuntimeFieldHandleInternal(); }
        }
...
#pragma warning restore 169
    ...
    public unsafe struct RuntimeFieldHandle : ISerializable
    {
        ...
        public IntPtr Value
        {
            ...
            [SecurityCritical]
#endif
            get { return m_ptr != null ? m_ptr.Value.Value : IntPtr.Zero; }
        }
        ...
        public void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            RuntimeFieldInfo fldInfo = (RuntimeFieldInfo)
                RuntimeType.GetFieldInfo(this.GetRuntimeFieldInfo());
    ...
    public unsafe struct ModuleHandle
    {
        ...
        private static void ValidateModulePointer(RuntimeModule module)
        {
            ...
            if (module == null)
                throw new InvalidOperationException(
                    Environment.GetResourceString("InvalidOperation_NullModuleHandle")
                );
        }
        ...
        {
            return new RuntimeTypeHandle(
                ModuleHandle.ResolveTypeHandleInternal(
                    GetRuntimeModule(),
                    typeToken,
        ...
        )
        {
            ...
            RuntimeMethodHandleInternal handle = ResolveMethodHandleInternalCore(
                module,
                methodToken,
        ...
        )
        {
            ...
            )
            {
                ...
                ResolveField(
                    ...
                    methodInstArgs,
                    methodInstCount,
                    JitHelpers.GetObjectHandleOnStack(ref field)
                );
                GC.KeepAlive(typeInstantiationContext);
                GC.KeepAlive(methodInstantiationContext);
                return field;
        ...
        [DllImport(JitHelpers.QCall, CharSet = CharSet.Unicode)]
        [SuppressUnmanagedCodeSecurity]
        private static extern bool _ContainsPropertyMatchingHash(
            RuntimeModule module,
            int propertyToken,
            uint hash
        );
        ...
        [DllImport(JitHelpers.QCall, CharSet = CharSet.Unicode)]
        [SuppressUnmanagedCodeSecurity]
        private static extern void GetAssembly(
            RuntimeModule handle,
    ...
    internal unsafe class Signature
    {
        ...
        {
            get { return (CallingConventions)(byte)m_managedCallingConventionAndArgIteratorFlags; }
        }
        ...
        {
            get { return m_returnTypeORfieldType; }
        }
        ...
        [ResourceExposure(ResourceScope.None)]
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern bool CompareSigForAppCompat(
            Signature left,
            RuntimeType typeLeft,
            Signature right,
            RuntimeType typeRight
        );
#endif
