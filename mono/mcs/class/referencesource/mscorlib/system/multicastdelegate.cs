...
namespace System
{
    ...
    public abstract class MulticastDelegate : Delegate
    {
        ...
        public override void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            if (invocationList == null)
            {
                ...
                if (!(method is RuntimeMethodInfo) || IsUnmanagedFunctionPtr())
                    throw new SerializationException(
                        Environment.GetResourceString("Serialization_InvalidDelegateType")
                    );

                // We can't deal with secure delegates either.
                if (
                    !InvocationListLogicallyNull()
                    && !_invocationCount.IsNull()
                    && !_methodPtrAux.IsNull()
                )
                    throw new SerializationException(
                        Environment.GetResourceString("Serialization_InvalidDelegateType")
                    );

                DelegateSerializationHolder.GetDelegateSerializationInfo(
                    info,
                    this.GetType(),
                    Target,
                    method,
            ...
            else
            {
                ...
                for (int i = invocationCount; --i >= 0; )
                {
                    ...
                    // We can't deal with secure delegates either.
                    if (
                        !d.InvocationListLogicallyNull()
                        && !d._invocationCount.IsNull()
                        && !d._methodPtrAux.IsNull()
                    )
                        continue;

                    DelegateSerializationHolder.DelegateEntry de =
                        DelegateSerializationHolder.GetDelegateSerializationInfo(
                            info,
                            d.GetType(),
                            d.Target,
        ...
        public sealed override bool Equals(Object obj)
        {
            ...
            if (_invocationCount != (IntPtr)0)
            {
                ...
                else
                {
                    ...
                    {
                        Contract.Assert(
                            (_invocationList as Object[]) != null,
        ...
        {
            Contract.Assert(
                d != null && (_invocationList as Object[]) != null,
        ...
        [System.Security.SecurityCritical] // auto-generated
        [System.Diagnostics.DebuggerNonUserCode]
        private void CtorSecureClosed(
            Object target,
            IntPtr methodPtr,
            IntPtr callThunk,
            IntPtr creatorMethod
        )
        {
        ...
        [System.Security.SecurityCritical] // auto-generated
        [System.Diagnostics.DebuggerNonUserCode]
        private void CtorSecureClosedStatic(
            Object target,
            IntPtr methodPtr,
            IntPtr callThunk,
            IntPtr creatorMethod
        ...
        [System.Security.SecurityCritical] // auto-generated
        [System.Diagnostics.DebuggerNonUserCode]
        private void CtorSecureRTClosed(
            Object target,
            IntPtr methodPtr,
            IntPtr callThunk,
            IntPtr creatorMethod
        ...
        [System.Security.SecurityCritical] // auto-generated
        [System.Diagnostics.DebuggerNonUserCode]
        private void CtorSecureVirtualDispatch(
            Object target,
            IntPtr methodPtr,
            IntPtr shuffleThunk,
            IntPtr callThunk,
