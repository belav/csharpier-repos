...
namespace System
{
    ...
    public class AppDomainManager
    {
        ...
        )
        {
            ...
            if (
                appDomainInfo.AppDomainManagerAssembly == null
                || appDomainInfo.AppDomainManagerType == null
            )
            {
                string inheritedDomainManagerAssembly;
                string inheritedDomainManagerType;

                AppDomain.CurrentDomain.GetAppDomainManagerType(
        ...
        {
            [System.Security.SecurityCritical] // auto-generated
            get { return AppDomain.CurrentDomain.DomainManager; }
        }
