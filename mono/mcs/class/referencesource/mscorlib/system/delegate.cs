    ...
    public abstract class Delegate : ICloneable, ISerializable
    {
        ...
        protected virtual Delegate CombineImpl(Delegate d)
        {
            throw new MulticastNotSupportedException(
                Environment.GetResourceString("Multicast_Combine")
            );
        }
        ...
        private static void CheckGetMethodInfo_Quirk(
            Type type,
            Type target,
            String method,
        ...
        {
            ParameterInfo[] parameters = type.GetMethod(
                    "Invoke",
        ...
        internal static unsafe Delegate CreateDelegateNoSecurityCheck(
            Type type,
            Object target,
        ...
        )
        {
            ...
            Delegate d = UnsafeCreateDelegate(
                type,
                rtMethod,
                firstArgument,
                DelegateBindingFlags.SkipSecurityChecks | DelegateBindingFlags.RelaxedSignature
            );
...
#if FEATURE_APPX
            bool nonW8PMethod =
                (rtMethod.InvocationFlags & INVOCATION_FLAGS.INVOCATION_FLAGS_NON_W8P_FX_API) != 0;
            bool nonW8PType =
            ...
            if (CompatibilitySwitches.IsAppEarlierThanWindowsPhone8)
                if (rtMethod.IsGenericMethodDefinition)
                    throw new MissingMethodException(
                        rtMethod.DeclaringType.FullName,
                        rtMethod.Name
                    );
#endif
