...
namespace System
{
    internal static partial class AppContextDefaultValues
    {
        ...
        static partial void PopulateOverrideValuesPartial()
        {
            ...
            string overrides = System.Runtime
                .Versioning
                .CompatibilitySwitch
            ...
            bool encounteredEquals = false,
                encounteredCharsInKey = false,
                encounteredCharsInValue = false;
            int previousSemicolonPos = -1,
                firstEqualsPos = -1;
        ...
        )
        {
            ...
            if (valueFromConfig == null)
            {
                ...
                valueFromConfig = System.Runtime
                    .Versioning
                    .CompatibilitySwitch
                    .GetValue(switchName);
            }
        ...
        private static string GetSwitchValueFromRegistry(string switchName)
        {
            ...
            {
                using (
                    SafeRegistryHandle hklm = new SafeRegistryHandle(
                        (IntPtr)RegistryHive.LocalMachine,
                        true
                    )
                )
                {
                    ...
                    if (
                        Win32Native.RegOpenKeyEx(
                            hklm,
                            REG_KEY_APPCONTEXT,
                            0,
                            Win32Native.KEY_READ,
                            out hkey
                        ) == 0
                    )
                    {
