...
namespace System
{
    ...
    internal static class ResId
    {
        ...
        internal const String Argument_BadPersistableModuleInTransientAssembly =
        ...
        internal const String InvalidOperation_EnumOpCantHappen =
            "InvalidOperation_EnumOpCantHappen";
        internal const String InvalidOperation_InternalState = "InvalidOperation_InternalState";
        internal const String InvalidOperation_ModifyRONumFmtInfo =
            "InvalidOperation_ModifyRONumFmtInfo";
        ...
        internal const String InvalidOperation_OpenLocalVariableScope =
            "InvalidOperation_OpenLocalVariableScope";
        internal const String InvalidOperation_TypeHasBeenCreated =
            "InvalidOperation_TypeHasBeenCreated";
        internal const String InvalidOperation_RefedAssemblyNotSaved =
            "InvalidOperation_RefedAssemblyNotSaved";
        internal const String InvalidOperation_AssemblyHasBeenSaved =
            "InvalidOperation_AssemblyHasBeenSaved";
        internal const String InvalidOperation_ModuleHasBeenSaved =
            "InvalidOperation_ModuleHasBeenSaved";
        internal const String InvalidOperation_CannotAlterAssembly =
            "InvalidOperation_CannotAlterAssembly";

        internal const String NotSupported_CannotSaveModuleIndividually =
            "NotSupported_CannotSaveModuleIndividually";
        ...
        internal const String NotSupported_SortedListNestedWrite =
