...
namespace System.Runtime.Hosting
{
    ...
    public sealed class ActivationArguments : EvidenceBase
    {
        ...
        {
            get { return new ApplicationIdentity(m_appFullName); }
        }
            ...
            get
            {
                ...
                if (m_appManifestPaths == null)
                    ...
                    return new ActivationContext(
                        new ApplicationIdentity(m_appFullName),
                        m_appManifestPaths
                    );
            }
        }
        ...
        public override EvidenceBase Clone()
        {
            ...
            if (m_appManifestPaths != null)
            {
                ...
                Array.Copy(
                    m_appManifestPaths,
                    clone.m_appManifestPaths,
                    clone.m_appManifestPaths.Length
                );
            }
