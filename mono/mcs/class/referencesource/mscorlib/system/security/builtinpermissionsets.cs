    ...
    internal static class BuiltInPermissionSets
    {
        ...
        private static readonly string s_everythingXml =
            ...
            + @"""
                               version = ""1""
                               Unrestricted = ""true"" />
                  <IPermission class = ""System.Security.Permissions.DataProtectionPermission, "
            ...
            + @"""
                               version = ""1""
                               Unrestricted = ""true"" />
                  <IPermission class = ""System.Security.Permissions.TypeDescriptorPermission, "
            + AssemblyRef.System
            + @"""
                               version = ""1""
                               Unrestricted = ""true"" />
        ...
        private static readonly string s_executionXml =
            @"<PermissionSet class = ""System.Security.NamedPermissionSet""
                             ...
                             Name = ""Execution""
                             Description = """
            + Environment.GetResourceString("Policy_PS_Execution")
            + @""">
                  <IPermission class = ""System.Security.Permissions.SecurityPermission, "
            + AssemblyRef.Mscorlib
            + @"""
        ...
        private static readonly string s_fullTrustXml =
            @"<PermissionSet class = ""System.Security.NamedPermissionSet"" 
                             ...
                             Name = ""FullTrust"" 
                             Description = """
            + Environment.GetResourceString("Policy_PS_FullTrust")
            + @""" />";
        ...
        private static readonly string s_internetXml =
            @"<PermissionSet class = ""System.Security.NamedPermissionSet""
                             ...
                             Name = ""Internet""
                             Description = """
            + Environment.GetResourceString("Policy_PS_Internet")
            + @""">
                  <IPermission class = ""System.Drawing.Printing.PrintingPermission, "
            + AssemblyRef.SystemDrawing
            + @"""
        ...
        private static readonly string s_localIntranetXml =
            @"<PermissionSet class = ""System.Security.NamedPermissionSet""
                             ...
                             Name = ""LocalIntranet""
                             Description = """
            + Environment.GetResourceString("Policy_PS_LocalIntranet")
            + @""" >
                  <IPermission class = ""System.Drawing.Printing.PrintingPermission, "
            + AssemblyRef.SystemDrawing
            + @"""
        ...
        private static readonly string s_nothingXml =
            @"<PermissionSet class = ""System.Security.NamedPermissionSet""
                             ...
                             Name = ""Nothing""
                             Description = """
            + Environment.GetResourceString("Policy_PS_Nothing")
            + @""" />";
        ...
        private static readonly string s_skipVerificationXml =
            @"<PermissionSet class = ""System.Security.NamedPermissionSet""
                             ...
                             Description = """
            + Environment.GetResourceString("Policy_PS_SkipVerification")
            + @""">
                  <IPermission class = ""System.Security.Permissions.SecurityPermission, "
            + AssemblyRef.Mscorlib
            + @"""
        ...
        internal static NamedPermissionSet Everything
        {
            get
            {
                return GetOrDeserializeExtendablePermissionSet(
                    ref s_everything,
                    s_everythingXml
#if FEATURE_CAS_POLICY
                    ,
        ...
        )
        {
            ...
            if (permissionSet == null)
            {
                ...
                NamedPermissionSet deserializedPermissionSet = new NamedPermissionSet(
                    securityElement
                );
        ...
        private static NamedPermissionSet GetOrDeserializePermissionSet(
            ref NamedPermissionSet permissionSet,
            string permissionSetXml
        )
        {
