...
namespace System.Security
{
    ...
    internal class SecurityRuntime
    {
        ...
        internal static extern FrameSecurityDescriptor GetSecurityObjectForFrame(
        ...
        internal static MethodInfo GetMethodInfo(RuntimeMethodHandleInternal rmh)
        {
            ...
            return (
                System.RuntimeType.GetMethodBase(RuntimeMethodHandle.GetDeclaringType(rmh), rmh)
                as MethodInfo
            );
#if _DEBUG
            }
        ...
        [System.Security.SecurityCritical] // auto-generated
        private static bool FrameDescSetHelper(
            FrameSecurityDescriptor secDesc,
        ...
        [System.Security.SecurityCritical] // auto-generated
        private static bool FrameDescHelper(
            FrameSecurityDescriptor secDesc,
        ...
        private static bool CheckDynamicMethodSetHelper(
            System.Reflection.Emit.DynamicResolver dynamicResolver,
            PermissionSet demandSet,
            out PermissionSet alteredDemandSet,
            RuntimeMethodHandleInternal rmh
        )
        {
            ...
            try
            {
                result = creationStack.CheckSetDemandWithModificationNoHalt(
                    demandSet,
        ...
        [System.Security.SecurityCritical]
        private static bool CheckDynamicMethodHelper(
            System.Reflection.Emit.DynamicResolver dynamicResolver,
            IPermission demandIn,
            PermissionToken permToken,
            RuntimeMethodHandleInternal rmh
        )
        {
            ...
            try
            {
                result = creationStack.CheckDemandNoHalt(
                    (CodeAccessPermission)demandIn,
                    permToken,
                    rmh
                );
            }
