...
namespace System.Security
{
    ...
    using System.Globalization;using System.Security.Util;using System.Diagnostics.Contracts;
...
#pragma warning disable 618
        internal static Exception MakeSecurityException(
...
#pragma warning restore 618
        {
            ...
            HostProtectionPermission hostProtectionPerm =
                permThatFailed as HostProtectionPermission;
            if (hostProtectionPerm != null)
                return new HostProtectionException(
                    GetResString("HostProtection_HostProtection"),
                    HostProtectionPermission.protectedResources,
                    hostProtectionPerm.Resources
                );
        ...
        internal SecurityException(
            String message,
            PermissionSet grantedSetObj,
            PermissionSet refusedSetObj
        )
            : base(message)
        {
            PermissionSet.s_fullTrust.Assert();
            ...
            : base(info, context)
        {
            ...
            try
            {
                ...
                m_permissionThatFailed = (String)
                    info.GetValueNoThrow(FirstPermissionThatFailedName, typeof(String));
                ...
                m_assemblyName = (AssemblyName)
                    info.GetValueNoThrow(Assembly_Name, typeof(AssemblyName));
                m_serializedMethodInfo = (byte[])
                    info.GetValueNoThrow(MethodName_Serialized, typeof(byte[]));
        ...
        public Type PermissionType
        {
            ...
            set { m_typeOfPermissionThatFailed = value; }
        }
        ...
        public IPermission FirstPermissionThatFailed
        {
            ...
            get { return (IPermission)XMLUtil.XmlStringToSecurityObject(m_permissionThatFailed); }
            set { m_permissionThatFailed = XMLUtil.SecurityObjectToXmlString(value); }
        }
        ...
        public String PermissionState
        {
            ...
            get { return m_demanded; }
            set { m_demanded = value; }
        }
        ...
        public Object Demanded
        {
            ...
            get { return XMLUtil.XmlStringToSecurityObject(m_demanded); }
            set { m_demanded = XMLUtil.SecurityObjectToXmlString(value); }
        }
        ...
        public Object DenySetInstance
        {
            ...
            get { return XMLUtil.XmlStringToSecurityObject(m_denied); }
            set { m_denied = XMLUtil.SecurityObjectToXmlString(value); }
        }
        ...
        public Object PermitOnlySetInstance
        {
            ...
            get { return XMLUtil.XmlStringToSecurityObject(m_permitOnly); }
            set { m_permitOnly = XMLUtil.SecurityObjectToXmlString(value); }
        }
