            ...
            IReportMatchMembershipCondition
    {
        ...
        bool IReportMatchMembershipCondition.Check(Evidence evidence, out object usedEvidence)
        {
            ...
            if (name != null)
            {
                ...
                bool nameMatch =
                    Name == null || (name.Name != null && StrongName.CompareNames(name.Name, Name));
                bool versionMatch =
                    (object)Version == null
                    || ((object)name.Version != null && name.Version.CompareTo(Version) == 0);
        ...
        public SecurityElement ToXml(PolicyLevel level)
        {
            ...
            if (PublicKey != null)
                root.AddAttribute(
                    s_tagPublicKeyBlob,
                    System.Security.Util.Hex.EncodeHexString(PublicKey.PublicKey)
                );
        ...
        private void ParseKeyBlob()
        {
            lock (this)
            {
                ...
                if (elBlob != null)
                    ...
                    throw new ArgumentException(
                        Environment.GetResourceString("Argument_BlobCannotBeNull")
                    );
        ...
        public override String ToString()
        {
            ...
            if (Name != null)
                sName =
                    ...
                    + String.Format(
                        ...
                        Environment.GetResourceString("StrongName_Name"),
                        Name
                    );
            ...
            if ((Object)Version != null)
                sVersion =
                    ...
                    + String.Format(
                        CultureInfo.CurrentCulture,
                        Environment.GetResourceString("StrongName_Version"),
                        Version
                    );

            return String.Format(
                CultureInfo.CurrentCulture,
                Environment.GetResourceString("StrongName_ToString"),
                System.Security.Util.Hex.EncodeHexString(PublicKey.PublicKey),
                sName,
                sVersion
            );
