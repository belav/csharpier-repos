...
namespace System.Security.Policy
{
    ...
    public abstract class CodeGroup
    {
                    ...
                    if (group == null)
                        throw new ArgumentException(
                            Environment.GetResourceString(
                                "Argument_CodeGroupChildrenMustBeCodeGroups"
                            )
                        );
        ...
        public virtual String PermissionSetName
        {
            get
            {
                ...
                NamedPermissionSet permSet =
                    m_policy.GetPermissionSetNoCopy() as NamedPermissionSet;
        ...
        internal SecurityElement ToXml(PolicyLevel level, String policyClassName)
        {
            ...
            Contract.Assert(
                this.GetType().FullName.Equals(policyClassName),
                "Incorrect class name passed in! Was: "
                    + policyClassName
                    + " Should be "
            ...
            if (m_policy != null)
            {
                ...
                if (
                    namedPermSet != null
                    && level != null
                    && level.GetNamedPermissionSetInternal(namedPermSet.Name) != null
                )
                {
                ...
                if (m_policy.Attributes != PolicyStatementAttribute.Nothing)
                    e.AddAttribute(
                        "Attributes",
                        XMLUtil.BitFieldEnumToString(
                            typeof(PolicyStatementAttribute),
                            m_policy.Attributes
                        )
                    );
            }
        ...
        private bool ParseMembershipCondition(bool safeLoad)
        {
            lock (this)
            {
                ...
                SecurityElement elMembershipCondition = m_element.SearchForChildByTag(
                        ...
                        if (elGroup.Tag.Equals("CodeGroup"))
                        {
                            ...
                            if (group != null)
                            {
                                ...
                                else
                                {
                                    ...
                                    unparsedChildren.Add(
                                        new CodeGroupPositionMarker(i, childrenList.Count, elGroup)
                                    );
                                }
                            }
                            else
                    ...
                    while (enumerator.MoveNext())
                    {
                        ...
                        else
                        {
                            throw new ArgumentException(
                                String.Format(
                                    CultureInfo.CurrentCulture,
                                    Environment.GetResourceString("Argument_FailedCodeGroup"),
            ...
            while (true)
            {
                ...
                lock (this)
                {
                    ...
                    if (m_element != null)
                    {
                        ...
                        {
                            SecurityElement elPermSet = m_element.SearchForChildByTag(
                                "PermissionSet"
                            );
