...
namespace System.Security.Policy
{
    ...
    public sealed class FileCodeGroup : CodeGroup, IUnionSemanticCodeGroup
    {
        ...
        internal PolicyStatement CalculatePolicy(Url url)
        {
            ...
            permSet.SetPermission(
                new FileIOPermission(m_access, System.IO.Path.GetFullPath(directory))
            );
        ...
        public override string PermissionSetName
        {
            get
            {
                return Environment.GetResourceString(
                    "FileCodeGroup_PermissionSet",
                    XMLUtil.BitFieldEnumToString(typeof(FileIOPermissionAccess), m_access)
                );
            }
        }
        ...
        protected override void ParseXml(SecurityElement e, PolicyLevel level)
        {
            ...
            if (access != null)
                m_access = (FileIOPermissionAccess)
                    Enum.Parse(typeof(FileIOPermissionAccess), access);
            else
