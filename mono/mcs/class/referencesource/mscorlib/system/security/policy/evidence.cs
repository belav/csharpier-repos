...
namespace System.Security.Policy
{
    ...
    using System.Security.Permissions;using System.Security.Util;using System.Threading;using Microsoft.Win32.SafeHandles;
        ...
        private EvidenceBase GenerateHostEvidence(Type type, bool hostCanGenerate)
        {
            ...
            if (hostCanGenerate)
            {
                ...
                if (hostEvidence != null)
                {
                    ...
                    {
                        string hostType = AppDomain.CurrentDomain.HostSecurityManager
                            .GetType()
                            .FullName;
