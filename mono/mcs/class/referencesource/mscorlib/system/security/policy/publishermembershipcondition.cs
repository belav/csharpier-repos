            ...
            else
            {
                ...
                if (name != null)
                    return String.Format(
                        ...
                        Environment.GetResourceString("Publisher_ToStringArg"),
                        System.Security.Util.Hex.EncodeHexString(m_certificate.GetPublicKey())
                    );
                else
                    return Environment.GetResourceString("Publisher_ToString");
            }
        ...
        private void ParseCertificate()
        {
            lock (this)
            {
                ...
                m_certificate =
                    elCert == null
                        ? null
                        : new X509Certificate(System.Security.Util.Hex.DecodeHexString(elCert));
