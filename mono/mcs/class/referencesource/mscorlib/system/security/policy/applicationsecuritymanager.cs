...
namespace System.Security.Policy
{
    ...
    public static class ApplicationSecurityManager
    {
            ...
            if (domainManager != null)
            {
                ...
                )
                {
                    appTrust = securityManager.DetermineApplicationTrust(
                        CmsUtils.MergeApplicationEvidence(
                            null,
        ...
        public static ApplicationTrustCollection UserApplicationTrusts
        {
            ...
            get { return new ApplicationTrustCollection(true); }
        }
                ...
                if (m_appTrustManager == null)
                {
                    ...
                    if (m_appTrustManager == null)
                        throw new PolicyException(
                            Environment.GetResourceString("Policy_NoTrustManager")
                        );
                }
        ...
        internal static ApplicationTrust DetermineApplicationTrustInternal(
            ActivationContext activationContext,
            TrustManagerContext context
        )
        {
        ...
        private static string s_machineConfigFile =
            Config.MachineDirectory + "applicationtrust.config";
        ...
        private static IApplicationTrustManager DecodeAppTrustManager()
        {
            ...
            using (
                FileStream contents = new FileStream(
                    s_machineConfigFile,
                    FileMode.Open,
                    FileAccess.Read
                )
            ...
            if (elPolicy == null)
                goto defaultTrustManager;
            SecurityElement elSecurityManager = elPolicy.SearchForChildByTag(
                "ApplicationSecurityManager"
            );
            if (elSecurityManager == null)
                goto defaultTrustManager;
            SecurityElement elTrustManager = elSecurityManager.SearchForChildByTag(
                "IApplicationTrustManager"
            );
            if (elTrustManager == null)
                goto defaultTrustManager;
            IApplicationTrustManager appTrustManager = DecodeAppTrustManagerFromElement(
                elTrustManager
            );
        ...
        private static SecurityElement CreateDefaultApplicationTrustManagerElement()
        {
            ...
            elTrustManager.AddAttribute(
                "class",
                "System.Security.Policy.TrustManager, System.Windows.Forms, Version="
                    + ((RuntimeAssembly)Assembly.GetExecutingAssembly()).GetVersion()
        ...
        [System.Security.SecurityCritical] // auto-generated
        private static IApplicationTrustManager DecodeAppTrustManagerFromElement(
            SecurityElement elTrustManager
        )
        {
            ...
            IApplicationTrustManager appTrustManager =
                Activator.CreateInstance(tmClass) as IApplicationTrustManager;
            if (appTrustManager != null)
