...
namespace System.Security.Policy
{
            ...
            IReportMatchMembershipCondition
    {
        ...
        public SecurityElement ToXml(PolicyLevel level)
        {
            ...
            Contract.Assert(
                this.GetType().FullName.Equals("System.Security.Policy.ZoneMembershipCondition"),
                "Class name changed!"
            );
        ...
        private void ParseZone()
        {
            lock (this)
            {
                ...
                {
                    throw new ArgumentException(
                        Environment.GetResourceString("Argument_ZoneCannotBeNull")
                    );
                }
                VerifyZone(m_zone);
        ...
        public override String ToString()
        {
            ...
            return String.Format(
                ...
                Environment.GetResourceString("Zone_ToString"),
                s_names[(int)m_zone]
            );
        }
    }
