    ...
    public abstract class CodeAccessPermission : IPermission, ISecurityEncodable, IStackWalk
    {
        ...
        public virtual IPermission Union(IPermission other)
        {
            ...
            throw new NotSupportedException(
                Environment.GetResourceString("NotSupported_SecurityPermissionUnion")
            );
        }
        ...
        static internal SecurityElement CreatePermissionElement(IPermission perm, String permname)
        {
            ...
            Contract.Assert(
                perm.GetType().FullName.Equals(permname),
                "Incorrect class name passed in! Was: "
                    + permname
                    + " Should be "
                    + perm.GetType().FullName
            );
        ...
        internal static void ValidateElement(SecurityElement elem, IPermission perm)
        {
            ...
            if (!XMLUtil.IsPermissionElement(perm, elem))
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_NotAPermissionElement")
                );
            ...
            if (version != null && !version.Equals("1"))
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_InvalidXMLBadVersion")
                );
        }
        ...
        {
            Contract.Assert(
                grant == null || grant.GetType().Equals(this.GetType()),
        ...
        {
            Contract.Assert(
                permitted == null || permitted.GetType().Equals(this.GetType()),
        ...
        {
            Contract.Assert(
                denied == null || denied.GetType().Equals(this.GetType()),
        ...
        {
            Contract.Assert(
                asserted == null || asserted.GetType().Equals(this.GetType()),
                "CheckPermitOnly not defined for permissions of different type"
            );
