    ...
    internal static class X509Utils
    {
        ...
        private static CRYPT_OID_INFO FindOidInfo(OidKeyType keyType, string key, OidGroup group)
        {
            ...
            try
            {
                ...
                if (!OidGroupWillNotUseActiveDirectory(group))
                {
                    ...
                    if (localOidInfo != IntPtr.Zero)
                    {
                        return (CRYPT_OID_INFO)
                            Marshal.PtrToStructure(localOidInfo, typeof(CRYPT_OID_INFO));
                    }
                }
                ...
                {
                    return (CRYPT_OID_INFO)
                        Marshal.PtrToStructure(fullOidInfo, typeof(CRYPT_OID_INFO));
                }
                ...
                if (group != OidGroup.AllGroups)
                {
                    ...
                    {
                        return (CRYPT_OID_INFO)
                            Marshal.PtrToStructure(allGroupOidInfo, typeof(CRYPT_OID_INFO));
                    }
                }
        ...
        internal static SafeCertStoreHandle ExportCertToMemoryStore(X509Certificate certificate)
        {
            ...
            X509Utils._OpenX509Store(
                X509Constants.CERT_STORE_PROV_MEMORY,
                X509Constants.CERT_STORE_ENUM_ARCHIVED_FLAG
        ...
        internal static extern void _AddCertificateToStore(
        ...
        [ResourceExposure(ResourceScope.None)]
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern void _DuplicateCertContext(
            IntPtr handle,
            ref SafeCertContextHandle safeCertContext
        );
        ...
        [ResourceExposure(ResourceScope.None)]
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern byte[] _ExportCertificatesToBlob(
            SafeCertStoreHandle safeCertStoreHandle,
        ...
        internal static extern void _GetDateNotAfter(
            SafeCertContextHandle safeCertContext,
            ref Win32Native.FILE_TIME fileTime
        );
        ...
        [ResourceExposure(ResourceScope.None)]
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern void _LoadCertFromBlob(
            byte[] rawData,
            IntPtr password,
            uint dwFlags,
            bool persistKeySet,
            ref SafeCertContextHandle pCertCtx
        );

        [System.Security.SecurityCritical] // auto-generated
        [ResourceExposure(ResourceScope.Machine)]
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern void _LoadCertFromFile(
            string fileName,
            IntPtr password,
            uint dwFlags,
            bool persistKeySet,
        ...
        [ResourceExposure(ResourceScope.None)]
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern void _OpenX509Store(
            uint storeType,
            uint flags,
            string storeName,
            ref SafeCertStoreHandle safeCertStoreHandle
        );
#endif // !FEATURE_CORECLR
