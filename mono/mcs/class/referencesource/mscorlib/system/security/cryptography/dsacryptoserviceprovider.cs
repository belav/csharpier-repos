...
namespace System.Security.Cryptography
{
    ...
    public sealed class DSACryptoServiceProvider : DSA, ICspAsymmetricAlgorithm
    {
        ...
        public DSACryptoServiceProvider(int dwKeySize)
            : this(
                dwKeySize,
                new CspParameters(Constants.PROV_DSS_DH, null, null, s_UseMachineKeyStore)
            ) { }
        ...
        public DSACryptoServiceProvider(int dwKeySize, CspParameters parameters)
        {
            ...
            _parameters = Utils.SaveCspParameters(
            ...
            if (
                !_randomKeyContainer
                || Environment.GetCompatibilityFlag(
                    CompatibilityFlag.EagerlyGenerateRandomAsymmKeys
                )
            )
                GetKeyPair();
        }
        ...
        public bool PublicOnly
        {
            ...
            get
            {
                GetKeyPair();
                byte[] publicKey = (byte[])
                    Utils._GetKeyParameter(_safeKeyHandle, Constants.CLR_PUBLICKEYONLY);
        ...
        public override int KeySize
        {
            ...
            get
            {
                GetKeyPair();
                byte[] keySize = (byte[])
                    Utils._GetKeyParameter(_safeKeyHandle, Constants.CLR_KEYLEN);
                _dwKeySize = (
                    keySize[0] | (keySize[1] << 8) | (keySize[2] << 16) | (keySize[3] << 24)
                );
                return _dwKeySize;
            }
        }
        ...
        public bool PersistKeyInCsp
        {
            ...
            get
            {
                if (_safeProvHandle == null)
                {
                    ...
                    {
                        if (_safeProvHandle == null)
                            _safeProvHandle = Utils.CreateProvHandle(
                                _parameters,
                                _randomKeyContainer
                            );
                    }
        ...
        public override DSAParameters ExportParameters(bool includePrivateParameters)
        {
            ...
            int blobType = includePrivateParameters
                ? Constants.PRIVATEKEYBLOB
                : Constants.PUBLICKEYBLOB;
