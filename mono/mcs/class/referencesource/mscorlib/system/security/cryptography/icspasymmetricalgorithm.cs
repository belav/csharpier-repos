...
namespace System.Security.Cryptography
{
    ...
    public sealed class CspKeyContainerInfo
    {
        ...
        internal CspKeyContainerInfo(CspParameters parameters, bool randomKeyContainer)
        {
            ...
            {
                if (
                    m_parameters.ProviderType == Constants.PROV_RSA_FULL
                    || m_parameters.ProviderType == Constants.PROV_RSA_AES
                )
        ...
        public bool MachineKeyStore
        {
            ...
            {
                return
                    (m_parameters.Flags & CspProviderFlags.UseMachineKeyStore)
        ...
        {
            get { return m_parameters.ProviderName; }
        }

        public int ProviderType
        {
            get { return m_parameters.ProviderType; }
        }

        public string KeyContainerName
        {
            get { return m_parameters.KeyContainerName; }
        }
        ...
        public string UniqueKeyContainerName
        {
            ...
            get
            {
                ...
                string uniqueContainerName = (string)
                    Utils._GetProviderParameter(
                        safeProvHandle,
                        m_parameters.KeyNumber,
                        Constants.CLR_UNIQUE_CONTAINER
                    );
        ...
        {
            get { return (KeyNumber)m_parameters.KeyNumber; }
        }
        ...
        public bool Exportable
        {
            ...
            get
            {
                ...
                byte[] isExportable = (byte[])
                    Utils._GetProviderParameter(
                        safeProvHandle,
                        m_parameters.KeyNumber,
                        Constants.CLR_EXPORTABLE
                    );
                safeProvHandle.Dispose();
        ...
        public bool HardwareDevice
        {
            ...
            get
            {
                ...
                parameters.Flags =
                    (parameters.Flags & CspProviderFlags.UseMachineKeyStore) != 0
                        ? CspProviderFlags.UseMachineKeyStore
                        : 0;
                ...
                byte[] isHardwareDevice = (byte[])
                    Utils._GetProviderParameter(
                        safeProvHandle,
                        parameters.KeyNumber,
                        Constants.CLR_HARDWARE
                    );
                safeProvHandle.Dispose();
        ...
        public bool Removable
        {
            ...
            get
            {
                ...
                byte[] isRemovable = (byte[])
                    Utils._GetProviderParameter(
                        safeProvHandle,
                        parameters.KeyNumber,
                        Constants.CLR_REMOVABLE
                    );
                safeProvHandle.Dispose();
        ...
        public bool Protected
        {
            ...
            get
            {
                ...
                byte[] isProtected = (byte[])
                    Utils._GetProviderParameter(
                        safeProvHandle,
                        m_parameters.KeyNumber,
                        Constants.CLR_PROTECTED
                    );
                safeProvHandle.Dispose();
        ...
        public CryptoKeySecurity CryptoKeySecurity
        {
            ...
            get
            {
                ...
                KeyContainerPermissionAccessEntry entry = new KeyContainerPermissionAccessEntry(
                    m_parameters,
                    KeyContainerPermissionFlags.ChangeAcl | KeyContainerPermissionFlags.ViewAcl
                );
                kp.AccessEntries.Add(entry);
                kp.Demand();
        ...
        {
            get { return m_randomKeyContainer; }
        }
    }
