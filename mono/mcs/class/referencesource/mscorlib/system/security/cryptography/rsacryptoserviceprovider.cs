...
namespace System.Security.Cryptography
{
    ...
    public sealed partial class RSACryptoServiceProvider : RSA, ICspAsymmetricAlgorithm
    {
        ...
        public RSACryptoServiceProvider()
            : this(
                0,
                new CspParameters(Utils.DefaultRsaProviderType, null, null, s_UseMachineKeyStore),
                true
            ) { }
        ...
        public byte[] Encrypt(byte[] rgb, bool fOAEP)
        {
            ...
            EncryptKey(
                ...
                rgb.Length,
                fOAEP,
                JitHelpers.GetObjectHandleOnStack(ref encryptedKey)
            );
            return encryptedKey;
        }
        ...
        public byte[] Decrypt(byte[] rgb, bool fOAEP)
        {
            ...
            DecryptKey(
                ...
                rgb.Length,
                fOAEP,
                JitHelpers.GetObjectHandleOnStack(ref decryptedKey)
            );
            return decryptedKey;
        }
...
#else
            using (
                SafeHashHandle hashHandle = Utils.CreateHash(
                    Utils.StaticProvHandle,
