...
namespace System.Security
{
    ...
    internal sealed class PermissionSetTriple
    {
        ...
        internal PermissionSetTriple UpdateAssert(PermissionSet in_a)
        {
            ...
            {
                Contract.Assert(
                    (!in_a.IsUnrestricted() || RefusedSet == null),
                ...
                if (RefusedSet != null)
                {
                    retPs = PermissionSet.RemoveRefusedPermissionSet(
                        retPs,
                        RefusedSet,
                        out bFailedToCompress
                    );
                }
                if (!bFailedToCompress)
                    bFailedToCompress = PermissionSet.IsIntersectingAssertedPermissions(
                        retPs,
                        AssertSet
                    );
                if (bFailedToCompress)
        ...
        [System.Security.SecurityCritical] // auto-generated
        internal void UpdateGrant(
            PermissionSet in_g,
            out ZoneIdentityPermission z,
            out UrlIdentityPermission u
        )
        {
            z = null;
            u = null;
        ...
        [System.Security.SecurityCritical] // auto-generated
        static bool CheckAssert(
            PermissionSet assertPset,
            PermissionSet demandSet,
            out PermissionSet newDemandSet
        )
        {
            newDemandSet = null;
            if (assertPset != null)
...
#pragma warning restore 618
        ...
        )
        {
            ...
            if (
                CheckAssert(AssertSet, demandSet, out alteredDemandset) == SecurityRuntime.StackHalt
            )
                return SecurityRuntime.StackHalt;
