...
namespace System.Security.Util
{
    ...
    internal sealed class Parser
    {
        ...
        private const short c_additionaltexttag = (short)(
            SecurityDocument.c_text << 8 | c_flag | 0x2000
        );
        ...
        private void GetRequiredSizes(TokenizerStream stream, ref int index)
        {
            ...
            do
            {
                    ...
                    switch (i & 0x00FF)
                    {
                                ...
                                if (intag)
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            index +=
                                                SecurityDocument.EncodedStringSize(strValue)
                                                + SecurityDocument.EncodedStringSize(
                                                    stream.GetNextString()
                                                )
                                                + 1;
                                            strValue = null;
                                            sawEquals = false;
                        ...
                        case Tokenizer.bra:
                            ...
                            if (i == Tokenizer.slash)
                            {
                                ...
                                if (i != Tokenizer.ket)
                                {
                                    throw new XmlSyntaxException(
                                        _t.LineNo,
                                        Environment.GetResourceString(
                                            "XMLSyntax_ExpectedCloseBracket"
                                        )
                                    );
                                }
                            ...
                            else if (i == Tokenizer.cstr)
                            {
                                ...
                                index +=
                                    SecurityDocument.EncodedStringSize(stream.GetNextString()) + 1;
                            ...
                            else
                            {
                                throw new XmlSyntaxException(
                                    _t.LineNo,
                                    Environment.GetResourceString("XMLSyntax_ExpectedSlashOrString")
                                );
                            }
                            break;
                        ...
                        case Tokenizer.ket:
                            ...
                            else
                            {
                                throw new XmlSyntaxException(
                                    _t.LineNo,
                                    Environment.GetResourceString(
                                        "XMLSyntax_UnexpectedCloseBracket"
                                    )
                                );
                            }
                        // not reachable
                        ...
                        case Tokenizer.slash:
                            ...
                            else
                            {
                                throw new XmlSyntaxException(
                                    _t.LineNo,
                                    Environment.GetResourceString("XMLSyntax_ExpectedCloseBracket")
                                );
                            }
                            break;
                ...
                else if (i == -1 && (stackDepth != 1 || !createdNode))
                {
                    ...
                    throw new XmlSyntaxException(
                        _t.LineNo,
                        Environment.GetResourceString("XMLSyntax_UnexpectedEndOfFile")
                    );
                }
            } while (stackDepth > 1);
        }
                    ...
                    )
                    {
                        switch (i)
                        {
                            case Tokenizer.cstr:
                                ...
                                {
                                    _t.ChangeFormat(
                                        System.Text.Encoding.GetEncoding(stream.GetNextString())
                                    );
                                    return 0;
                                }
                                else if (!sawEquals)
