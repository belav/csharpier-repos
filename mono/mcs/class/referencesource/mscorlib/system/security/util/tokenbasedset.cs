...
#pragma warning restore 414
        ...
        internal TokenBasedSet SpecialUnion(TokenBasedSet other)
        {
            ...
            if (other != null)
            {
                ...
                maxMax =
                    this.GetMaxUsedIndex() > other.GetMaxUsedIndex()
                        ? this.GetMaxUsedIndex()
                        : other.GetMaxUsedIndex();
            }
            else
        ...
        internal void SpecialSplit(
            ref TokenBasedSet unrestrictedPermSet,
