...
namespace System.Security.Util
{
...
#if DEBUG
            Contract.Assert(
                searchStrings.Length == replaceStrings.Length,
            ...
            switch (encoding)
            {
                ...
                default:
                    throw new ArgumentException(
                        Environment.GetResourceString("Arg_EnumIllegalVal", (int)encoding)
                    );
            }
        }
        ...
        internal void ChangeFormat(System.Text.Encoding encoding)
        {
            ...
            switch (_inTokenSource)
            {
                ...
                default:
                    ...
                    Contract.Assert(
                        reader._in.CurrentEncoding != null,
    ...
    internal sealed class TokenizerStream
    {
        ...
        {
            if (m_indexTokens == 0)
                m_lastTokens.m_block[m_lastTokens.m_block.Length - 1] = (short)(
                    (ushort)m_lastTokens.m_block[m_lastTokens.m_block.Length - 1] | (ushort)tag
                );
            else
                m_currentTokens.m_block[m_indexTokens - 1] = (short)(
                    (ushort)m_currentTokens.m_block[m_indexTokens - 1] | (ushort)tag
                );
        }
