...
namespace System.Security.Permissions
{
    ...
    [Serializable]
#if FEATURE_CORECLR
    // This needs to be in the asmmeta to enable SecAnnotate to successfully resolve and run the
    // security rules. It gets marked
    // as internal by BCLRewriter so we are simply marking it as FriendAccessAllowed so it stays in the
    // asmmeta.
...
#pragma warning restore 618
        ...
        public bool Synchronization
        {
            ...
            set
            {
                m_resources = (
                    value
                        ? m_resources | HostProtectionResource.Synchronization
                        : m_resources & ~HostProtectionResource.Synchronization
                );
            }
        }
        ...
        public bool SharedState
        {
            ...
            set
            {
                m_resources = (
                    value
                        ? m_resources | HostProtectionResource.SharedState
                        : m_resources & ~HostProtectionResource.SharedState
                );
            }
        }
        ...
        public bool ExternalProcessMgmt
        {
            ...
            set
            {
                m_resources = (
                    value
                        ? m_resources | HostProtectionResource.ExternalProcessMgmt
                        : m_resources & ~HostProtectionResource.ExternalProcessMgmt
                );
            }
        }
        ...
        public bool ExternalThreading
        {
            ...
            set
            {
                m_resources = (
                    value
                        ? m_resources | HostProtectionResource.ExternalThreading
                        : m_resources & ~HostProtectionResource.ExternalThreading
                );
            }
        }
        ...
        public bool SelfAffectingThreading
        {
            ...
            set
            {
                m_resources = (
                    value
                        ? m_resources | HostProtectionResource.SelfAffectingThreading
                        : m_resources & ~HostProtectionResource.SelfAffectingThreading
                );
            }
        }
        ...
        public bool SecurityInfrastructure
        {
            ...
            set
            {
                m_resources = (
                    value
                        ? m_resources | HostProtectionResource.SecurityInfrastructure
                        : m_resources & ~HostProtectionResource.SecurityInfrastructure
                );
            }
        }
        ...
        public bool UI
        {
            ...
            set
            {
                m_resources = (
                    value
                        ? m_resources | HostProtectionResource.UI
                        : m_resources & ~HostProtectionResource.UI
                );
            }
        }
        ...
        public bool MayLeakOnAbort
        {
            ...
            set
            {
                m_resources = (
                    value
                        ? m_resources | HostProtectionResource.MayLeakOnAbort
                        : m_resources & ~HostProtectionResource.MayLeakOnAbort
                );
            }
        }
    ...
    [Serializable]
    internal sealed class HostProtectionPermission
            ...
            IBuiltInPermission
    {
        ...
        public override bool IsSubsetOf(IPermission target)
        {
            ...
            return ((uint)this.m_resources & (uint)((HostProtectionPermission)target).m_resources)
                == (uint)this.m_resources;
        }
        ...
        public override IPermission Union(IPermission target)
        {
            ...
            HostProtectionResource newResources = (HostProtectionResource)(
        ...
        public override SecurityElement ToXml()
        {
            ...
            if (IsUnrestricted())
                ...
                esd.AddAttribute(
                    "Resources",
                    XMLUtil.BitFieldEnumToString(typeof(HostProtectionResource), Resources)
                );
            return esd;
        }
            ...
            else
            {
                ...
                if (resources == null)
                    ...
                    Resources = (HostProtectionResource)
                        Enum.Parse(typeof(HostProtectionResource), resources);
            }
        }
