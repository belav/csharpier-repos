            ...
            IBuiltInPermission
    {
        ...
        public override IPermission Union(IPermission target)
        {
            ...
            else
            {
                ...
                union.m_allowed = (IsolatedStorageContainment)max(
                    (long)m_allowed,
                    (long)operand.m_allowed
                );
                return union;
            }
        }
        ...
        public override bool IsSubsetOf(IPermission target)
        {
            ...
            try
            {
                ...
                return (
                    (operand.m_userQuota >= m_userQuota)
        ...
        public override IPermission Intersect(IPermission target)
        {
            ...
            intersection.m_allowed = (IsolatedStorageContainment)min(
                (long)m_allowed,
                (long)operand.m_allowed
            );

            if (
                (intersection.m_userQuota == 0)
