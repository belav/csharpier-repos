...
namespace System.Security.Permissions
{
            ...
            IBuiltInPermission
    {
        ...
        public override IPermission Intersect(IPermission target)
        {
            ...
            StringExpressionSet intersectCreate =
                this.m_create == null ? null : this.m_create.Intersect(operand.m_create);
            StringExpressionSet intersectViewAcl =
                this.m_viewAcl == null ? null : this.m_viewAcl.Intersect(operand.m_viewAcl);
            StringExpressionSet intersectChangeAcl =
        ...
        public override IPermission Union(IPermission other)
        {
            ...
            StringExpressionSet unionCreate =
                this.m_create == null ? operand.m_create : this.m_create.Union(operand.m_create);
            StringExpressionSet unionViewAcl =
                this.m_viewAcl == null
                    ? operand.m_viewAcl
                    : this.m_viewAcl.Union(operand.m_viewAcl);
            StringExpressionSet unionChangeAcl =
        ...
        public override SecurityElement ToXml()
        {
            ...
            if (!IsUnrestricted())
            {
                ...
                if (this.m_viewAcl != null && !this.m_viewAcl.IsEmpty())
                {
                    esd.AddAttribute(
                        "ViewAccessControl",
                        SecurityElement.Escape(m_viewAcl.UnsafeToString())
                    );
                }
