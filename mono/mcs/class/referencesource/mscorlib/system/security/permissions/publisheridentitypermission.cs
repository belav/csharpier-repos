...
namespace System.Security.Permissions
{
    ...
    public sealed class PublisherIdentityPermission : CodeAccessPermission, IBuiltInPermission
    {
        ...
        private static void CheckCertificate(X509Certificate certificate)
        {
            ...
            {
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_UninitializedCertificate")
                );
            }
        }
        ...
        {
            PublisherIdentityPermission perm = new PublisherIdentityPermission(
        ...
        public override IPermission Intersect(IPermission target)
        {
            ...
            {
                PublisherIdentityPermission res = new PublisherIdentityPermission(
                    PermissionState.None
                );
            ...
            if (
                this.m_certs == null
                || that.m_certs == null
                || this.m_certs.Length == 0
                || that.m_certs.Length == 0
            )
                return null;
            ...
            if (alCerts.Count == 0)
                return null;
            PublisherIdentityPermission result = new PublisherIdentityPermission(
                PermissionState.None
            );
