...
namespace System.Security.Permissions
{
            ...
            IBuiltInPermission
    {
        ...
        private bool IsEmpty()
        {
            ...
            {
                if (
                    (m_array[i].m_id == null || !m_array[i].m_id.Equals(""))
                        ...
                        for (int j = 0; j < operand.m_array.Length; ++j)
                        {
                            if (
                                operand.m_array[j].m_authenticated
                                    == this.m_array[i].m_authenticated
                                && (
        ...
        private void ThrowSecurityException()
        {
            ...
            throw new SecurityException(
                Environment.GetResourceString("Security_PrincipalPermission"),
                name,
                null,
                null,
                null,
        ...
        public SecurityElement ToXml()
        {
            ...
            Contract.Assert(
                this.GetType().FullName.Equals("System.Security.Permissions.PrincipalPermission"),
                "Class name changed!"
            );
