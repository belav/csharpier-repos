...
#pragma warning restore 618
        ...
        public override IPermission Union(IPermission other)
        {
            ...
            {
                ReflectionPermissionFlag flag_union = (ReflectionPermissionFlag)(
        ...
        public override SecurityElement ToXml()
        {
            ...
            if (!IsUnrestricted())
            {
                esd.AddAttribute(
                    "Flags",
                    XMLUtil.BitFieldEnumToString(typeof(ReflectionPermissionFlag), m_flags)
                );
            }
            else
            {
        ...
        public override void FromXml(SecurityElement esd)
        {
            ...
            if (flags != null)
                m_flags = (ReflectionPermissionFlag)
                    Enum.Parse(typeof(ReflectionPermissionFlag), flags);
        }
