...
namespace System.Security
{
    ...
    using System.Text;using Microsoft.Win32;using System.Runtime.CompilerServices;using System.Security.Permissions;using System.Runtime.ConstrainedExecution;using System.Runtime.Versioning;using Microsoft.Win32.SafeHandles;using System.Diagnostics.Contracts;
    ...
    public sealed class SecureString : IDisposable
    {
        ...
        public unsafe SecureString(char* value, int length)
        {
            ...
            if (length > MaxLength)
            {
                throw new ArgumentOutOfRangeException(
                    "length",
                    Environment.GetResourceString("ArgumentOutOfRange_Length")
                );
            }
        ...
        public void InsertAt(int index, char c)
        {
            if (index < 0 || index > m_length)
            {
                throw new ArgumentOutOfRangeException(
                    "index",
                    Environment.GetResourceString("ArgumentOutOfRange_IndexString")
                );
            }
            Contract.EndContractBlock();
        ...
        private void CheckSupportedOnCurrentPlatform()
        {
            if (!supportedOnCurrentPlatform)
            {
                throw new NotSupportedException(
                    Environment.GetResourceString("Arg_PlatformSecureString")
                );
            }
            Contract.EndContractBlock();
        }
        ...
        private static uint GetAlignedSize(int size)
        {
            ...
            { // if size is 0, set allocated size to blocksize
    ...
    internal sealed class SafeBSTRHandle : SafeBuffer
    {
        ...
        internal unsafe void ClearBuffer()
        {
            ...
            try
            {
                ...
                Win32Native.ZeroMemory(
                    (IntPtr)bufferPtr,
                    (UIntPtr)(Win32Native.SysStringLen((IntPtr)bufferPtr) * 2)
                );
            }
            finally
            {
        ...
        internal static unsafe void Copy(SafeBSTRHandle source, SafeBSTRHandle target)
        {
            ...
            try
            {
                ...
                Contract.Assert(
                    Win32Native.SysStringLen((IntPtr)targetPtr)
                        >= Win32Native.SysStringLen((IntPtr)sourcePtr),
                ...
                Buffer.Memcpy(
                    targetPtr,
                    sourcePtr,
                    (int)Win32Native.SysStringLen((IntPtr)sourcePtr) * 2
                );
            }
            finally
            {
