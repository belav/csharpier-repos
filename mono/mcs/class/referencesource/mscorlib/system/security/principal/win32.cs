...
namespace System.Security.Principal
{
    ...
    internal static class Win32
    {
        ...
        {
            get { return _LsaLookupNames2Supported; }
        }

        internal static bool WellKnownSidApisSupported
        {
            get { return _WellKnownSidApisSupported; }
        }
        ...
        internal static SafeLsaPolicyHandle LsaOpenPolicy(string systemName, PolicyRights rights)
        {
            ...
            if (
                0
                == (
                    ReturnCode = Win32Native.LsaOpenPolicy(
                        systemName,
                        ref Loa,
                        (int)rights,
                        out Result
        ...
        )
        {
            ...
            if (
                ...
                != Win32Native.CreateWellKnownSid(
                    (int)sidType,
                    domainSid == null ? null : domainSid.BinaryForm,
                    resultSid,
                    ref length
                )
            )
        ...
        internal static bool IsEqualDomainSid(SecurityIdentifier sid1, SecurityIdentifier sid2)
        {
            ...
            else
            {
                ...
                return (
                    Win32Native.IsEqualDomainSid(BinaryForm1, BinaryForm2, out result) == FALSE
                        ? false
                        : result
                );
            }
        ...
        )
        {
            ...
            referencedDomains.Initialize(
                (uint)Marshal.SizeOf(typeof(Win32Native.LSA_REFERENCED_DOMAIN_LIST))
            );
            Win32Native.LSA_REFERENCED_DOMAIN_LIST domainList =
                referencedDomains.Read<Win32Native.LSA_REFERENCED_DOMAIN_LIST>(0);
            ...
            unsafe
            {
                ...
                try
                {
                    ...
                    {
                        Win32Native.LSA_TRUST_INFORMATION* pTrustInformation =
                            (Win32Native.LSA_TRUST_INFORMATION*)domainList.Domains;
        ...
        )
        {
            ...
            if (
                FALSE
                != Win32Native.GetWindowsAccountDomainSid(
                    BinaryForm,
                    resultSidBinary,
                    ref sidLength
                )
