...
#if !FEATURE_PAL
    using Microsoft.Win32.SafeHandles;using System.Security.Principal;
#endif
...
#pragma warning restore 169
        ...
        internal void SetDeny(IPermission perm)
        {
            ...
            BCLDebug.Assert(
                ...
                "Deny is only valid in legacy CAS mode"
            );
        ...
        internal void SetTokenHandles(
            SafeAccessTokenHandle callerToken,
            SafeAccessTokenHandle impToken
        )
        {
        ...
        )
        {
            ...
            Contract.Assert(
                demand != null && !demand.CheckDemand(null),
                    ...
                    if (perm == null)
                    {
                        if (!permSet.IsUnrestricted())
                            throw new SecurityException(
                                ...
                                null,
                                permSet,
                                SecurityRuntime.GetMethodInfo(rmh),
                                demand,
                                demand
                            );
                    }
        ...
        )
        {
            ...
            try
            {
                ...
                if (permSet != null)
                {
                    ...
                    if (bNeedToThrow)
                        throw new SecurityException(
                            Environment.GetResourceString("Security_GenericNoType"),
                            null,
                            permSet,
                            SecurityRuntime.GetMethodInfo(rmh),
                            demandSet,
                ...
                if (permSet != null)
                {
                    ...
                    if (!permSet.IsUnrestricted())
                    {
                        PermissionSet.RemoveAssertedPermissionSet(
                            demandSet,
                            permSet,
