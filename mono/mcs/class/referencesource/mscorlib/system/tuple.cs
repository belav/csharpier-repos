...
namespace System
{
    ...
    public static class Tuple
    {
        ...
        public static Tuple<T1, T2, T3, T4, T5, T6, T7, Tuple<T8>> Create<
            T1,
            T2,
            T3,
            T4,
            ...
            ITuple
    {
        ...
        )
        {
            ...
            {
                throw new ArgumentException(
                    Environment.GetResourceString("ArgumentException_TupleLastArgumentNotATuple")
                );
            }
        ...
        int ITuple.Length
        {
            get { return 7 + ((ITupleInternal)Rest).Length; }
        }
