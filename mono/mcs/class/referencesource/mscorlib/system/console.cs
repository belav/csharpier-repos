...
#if !FEATURE_CORECLR
        private static readonly UnicodeEncoding StdConUnicodeEncoding = new UnicodeEncoding(
            false,
            false
        );
...
#pragma warning restore 0420
        ...
        private static void InitializeStdOutError(bool stdout)
        {
            ...
            lock (InternalSyncObject)
            {
...
#if _DEBUG
                    if (CheckOutputDebug())
                        writer = MakeDebugOutputTextWriter(
                            (stdout) ? "Console.Out: " : "Console.Error: "
                        );
                    else
#endif // _DEBUG
...
#endif // FEATURE_CORECLR
                    StreamWriter stdxxx = new StreamWriter(
                        s,
                        encoding,
                ...
                if (stdout)
                    ...
                    _error = writer;
                Contract.Assert(
                    (stdout && _out != null) || (!stdout && _error != null),
        ...
        public static void Clear()
        {
            ...
            success = Win32Native.FillConsoleOutputCharacter(
                hConsole,
                ' ',
                conSize,
                coordScreen,
            ...
            numCellsWritten = 0;
            success = Win32Native.FillConsoleOutputAttribute(
                hConsole,
                csbi.wAttributes,
                conSize,
                coordScreen,
        ...
        [System.Security.SecurityCritical] // auto-generated
        private static Win32Native.Color ConsoleColorToColorAttribute(
            ConsoleColor color,
            bool isBackground
        )
        {
            if ((((int)color) & ~0xf) != 0)
                throw new ArgumentException(
                    Environment.GetResourceString("Arg_InvalidConsoleColor")
                );
            Contract.EndContractBlock();
        ...
        public static ConsoleColor BackgroundColor
        {
            ...
            get
            {
                ...
                Win32Native.Color c =
                    (Win32Native.Color)csbi.wAttributes & Win32Native.Color.BackgroundMask;
        ...
        public static ConsoleColor ForegroundColor
        {
            ...
            get
            {
                ...
                Win32Native.Color c =
                    (Win32Native.Color)csbi.wAttributes & Win32Native.Color.ForegroundMask;
                return ColorAttributeToConsoleColor(c);
            }
            [System.Security.SecuritySafeCritical] // auto-generated
            [ResourceExposure(ResourceScope.Process)]
        ...
        )
        {
            ...
            fixed (Win32Native.CHAR_INFO* pCharInfo = data)
                r = Win32Native.ReadConsoleOutput(
                    ConsoleOutputHandle,
                    pCharInfo,
                    bufferSize,
                    bufferCoord,
            ...
            for (int i = sourceTop; i < sourceTop + sourceHeight; i++)
            {
                ...
                r = Win32Native.FillConsoleOutputCharacter(
                    ConsoleOutputHandle,
                    sourceChar,
                    sourceWidth,
                    writeCoord,
                ...
                r = Win32Native.FillConsoleOutputAttribute(
                    ConsoleOutputHandle,
                    attr,
                    sourceWidth,
                    writeCoord,
            ...
            fixed (Win32Native.CHAR_INFO* pCharInfo = data)
                r = Win32Native.WriteConsoleOutput(
                    ConsoleOutputHandle,
                    pCharInfo,
                    bufferSize,
                    bufferCoord,
        ...
        )
        {
            ...
            if (!success)
            {
                success = Win32Native.GetConsoleScreenBufferInfo(
                    Win32Native.GetStdHandle(Win32Native.STD_ERROR_HANDLE),
                    out csbi
                );
                if (!success)
                    success = Win32Native.GetConsoleScreenBufferInfo(
                        Win32Native.GetStdHandle(Win32Native.STD_INPUT_HANDLE),
                        out csbi
                    );
            ...
            if (!_haveReadDefaultColors)
            {
                ...
                // ResetColor method.
                Contract.Assert(
                    (int)Win32Native.Color.ColorMask == 0xff,
        ...
        public static unsafe void SetWindowSize(int width, int height)
        {
            ...
            if (csbi.dwSize.X < csbi.srWindow.Left + width)
            {
                if (csbi.srWindow.Left >= Int16.MaxValue - width)
                    throw new ArgumentOutOfRangeException(
                        "width",
                        Environment.GetResourceString("ArgumentOutOfRange_ConsoleWindowBufferSize")
                    );
            ...
            if (!r)
            {
                ...
                Win32Native.COORD bounds = Win32Native.GetLargestConsoleWindowSize(
                    ConsoleOutputHandle
                );
                if (width > bounds.X)
                    throw new ArgumentOutOfRangeException(
        ...
        public static unsafe void SetWindowPosition(int left, int top)
        {
            ...
            if (left < 0 || newRight > csbi.dwSize.X || newRight < 0)
                throw new ArgumentOutOfRangeException(
                    "left",
                    left,
                    Environment.GetResourceString("ArgumentOutOfRange_ConsoleWindowPos")
                );
        ...
        private static extern Int32 GetTitleNative(
            StringHandleOnStack outTitle,
            out Int32 outTitleLength
        );
        ...
        public static String Title
        {
            ...
            get
            {
                string title = null;
                int titleLength = -1;
                Int32 r = GetTitleNative(
                    JitHelpers.GetStringHandleOnStack(ref title),
                    out titleLength
                );
        ...
        {
            return (
                    ((ControlKeyState)ir.keyEvent.controlKeyState)
        ...
        public static ConsoleKeyInfo ReadKey(bool intercept)
        {
            ...
            lock (ReadKeySyncObject)
            {
                ...
                { // We did NOT have a previous keystroke with repeated characters:
                    while (true)
                    {
                        r = Win32Native.ReadConsoleInput(
                            ConsoleInputHandle,
                            out ir,
                            1,
                            out numEventsRead
            ...
            ConsoleKeyInfo info = new ConsoleKeyInfo(
                (char)ir.keyEvent.uChar,
                (ConsoleKey)ir.keyEvent.virtualKeyCode,
                shift,
                alt,
                control
            );
        ...
        public static bool KeyAvailable
        {
            ...
            get
            {
                ...
                while (true)
                {
                    bool r = Win32Native.PeekConsoleInput(
                        ConsoleInputHandle,
                        out ir,
                        1,
                        out numEventsRead
        ...
        private sealed class ControlCDelegateData
        {
            ...
            internal ControlCDelegateData(
                ConsoleSpecialKey controlKey,
                ConsoleCancelEventHandler cancelCallbacks
            )
            {
        ...
        private static bool BreakEvent(int controlType)
        {
            ...
            if (
                controlType == Win32Native.CTRL_C_EVENT
            ...
            )
            {
                ...
                ControlCDelegateData delegateData = new ControlCDelegateData(
                    controlKey,
                    cancelCallbacks
                );
        ...
        public static event ConsoleCancelEventHandler CancelKeyPress
        {
            ...
            remove
            {
                ...
                lock (InternalSyncObject)
                {
                    ...
                    _cancelCallbacks -= value;
                    Contract.Assert(
                        _cancelCallbacks == null || _cancelCallbacks.GetInvocationList().Length > 0,
