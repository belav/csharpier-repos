    ...
    public static class Environment
    {
        ...
        internal sealed class ResourceHelper
        {
            ...
            internal class GetResourceStringUserData
            {
                ...
                public GetResourceStringUserData(
            ...
            internal String GetResourceString(String key, CultureInfo culture)
            {
                ...
                GetResourceStringUserData userData = new GetResourceStringUserData(
                    this,
                    key,
                    culture
                );
            ...
            private void GetResourceStringCode(Object userDataIn)
            {
                ...
                if (
                    ...
                    && rh.currentlyLoading.Count > 0
                    && rh.currentlyLoading.Contains(key)
                )
                {
                    ...
                    String message =
                        "Infinite recursion during resource lookup within mscorlib.  This may be a bug in mscorlib, or potentially in certain extensibility points such as assembly resolve events or CultureInfo names.  Resource name: "
                        + key;
                    Assert.Fail(
                        "[mscorlib recursive resource lookup bug]",
                        message,
                        Assert.COR_E_FAILFAST,
                ...
                Contract.Assert(
                    s != null,
                    "Managed resource string lookup failed.  Was your resource name misspelled?  Did you rebuild mscorlib after adding a resource to resources.txt?  Debug this w/ cordbg and bug whoever owns the code that called Environment.GetResourceString.  Resource name was: \""
                        + key
                        + "\""
                );
...
#pragma warning restore 618
        ...
        [SuppressUnmanagedCodeSecurity]
        [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
        internal static extern void TriggerCodeContractFailure(
            ...
            get
            {
                ...
                if (Win32Native.GetComputerName(buf, ref len) == 0)
                    throw new InvalidOperationException(
                        Environment.GetResourceString("InvalidOperation_ComputerName")
                    );
                return buf.ToString();
            }
        }
        ...
        )
        {
...
#endif // FEATURE_WIN32_REGISTRY
            {
                throw new ArgumentException(
                    Environment.GetResourceString("Arg_EnumIllegalVal", (int)target)
                );
            }
        }
#endif
        ...
        **Exceptions: None.
        ...
        public static void SetEnvironmentVariable(string variable, string value)
        {
            ...
            else
            {
                ...
                {
                    throw new ArgumentException(
                        Environment.GetResourceString("Argument_LongEnvVarValue")
                    );
                }
            }
        ...
        private static void CheckEnvironmentVariableName(string variable)
        {
            ...
            {
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_StringFirstCharIsZero"),
                    "variable"
                );
            }
            ...
            {
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_IllegalEnvVarName")
                );
            }
            Contract.EndContractBlock();
        }
        ...
        )
        {
            ...
            {
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_LongEnvVarName")
                );
            }
            ...
            if (r == IntPtr.Zero)
                BCLDebug.Assert(
                    false,
                    "SetEnvironmentVariable failed: " + Marshal.GetLastWin32Error()
                );
        ...
        public static OperatingSystem OSVersion
        {
            ...
            get
            {
                ...
                { // We avoid the lock since we don't care if two threads will set this at the same time.
                    Microsoft.Win32.Win32Native.OSVERSIONINFO osvi =
                        new Microsoft.Win32.Win32Native.OSVERSIONINFO();
                    if (!GetVersion(osvi))
                    {
                        throw new InvalidOperationException(
                    ...
                    Microsoft.Win32.Win32Native.OSVERSIONINFOEX osviEx =
                        new Microsoft.Win32.Win32Native.OSVERSIONINFOEX();
                    ...
                    Version v = new Version(
                        ...
                        osvi.MinorVersion,
                        osvi.BuildNumber,
                        (osviEx.ServicePackMajor << 16) | osviEx.ServicePackMinor
                    );
        ...
        **Exceptions:
        ...
        public static bool UserInteractive
        {
            ...
            get
            {
                ...
                if (hwinsta != IntPtr.Zero && processWinStation != hwinsta)
                {
                    ...
                    if (
                        Win32Native.GetUserObjectInformation(
                            hwinsta,
                            Win32Native.UOI_FLAGS,
                            flags,
        ...
        public static string GetFolderPath(SpecialFolder folder)
        {
            if (!Enum.IsDefined(typeof(SpecialFolder), folder))
                throw new ArgumentException(
                    Environment.GetResourceString("Arg_EnumIllegalVal", (int)folder)
                );
            Contract.EndContractBlock();
        ...
        public static string GetFolderPath(SpecialFolder folder, SpecialFolderOption option)
        {
            ...
            if (!Enum.IsDefined(typeof(SpecialFolderOption), option))
                throw new ArgumentException(
                    Environment.GetResourceString("Arg_EnumIllegalVal", (int)option)
                );
            Contract.EndContractBlock();
        ...
        )
        {
            ...
            StringBuilder sb = new StringBuilder(Path.MAX_PATH);
            int hresult = Win32Native.SHGetFolderPath(
        ...
        public static string UserDomainName
        {
            ...
            get
            {
                ...
                byte ret = Win32Native.GetUserNameEx(
                    Win32Native.NameSamCompatible,
                    domainName,
                    ref domainNameLen
                );
                if (ret == 1)
                ...
                bool success = Win32Native.LookupAccountName(
                    null,
                    UserName,
                    sid,
                    ref sidLen,
