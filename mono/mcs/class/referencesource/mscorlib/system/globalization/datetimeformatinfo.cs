    ...
    public sealed class DateTimeFormatInfo : ICloneable, IFormatProvider
    {
        ...
        private String[] internalGetAbbreviatedDayOfWeekNames()
        {
            if (this.abbreviatedDayNames == null)
            {
                ...
                Contract.Assert(
                    this.abbreviatedDayNames.Length == 7,
        ...
        private String[] internalGetSuperShortDayNames()
        {
            if (this.m_superShortDayNames == null)
            {
                ...
                Contract.Assert(
                    this.m_superShortDayNames.Length == 7,
        ...
        private String[] internalGetAbbreviatedMonthNames()
        {
            if (this.abbreviatedMonthNames == null)
            {
                ...
                Contract.Assert(
                    this.abbreviatedMonthNames.Length == 12
                        || this.abbreviatedMonthNames.Length == 13,
        ...
        private String[] internalGetMonthNames()
        {
            if (this.monthNames == null)
            {
                ...
                Contract.Assert(
                    this.monthNames.Length == 12 || this.monthNames.Length == 13,
        ...
        public DateTimeFormatInfo()
            : this(
                CultureInfo.InvariantCulture.m_cultureData,
...
#pragma warning restore
            ...
            if (this.m_name != null)
            {
                ...
                if (this.m_cultureData == null)
                    throw new CultureNotFoundException(
                        "m_name",
                        m_name,
                        Environment.GetResourceString("Argument_CultureNotSupported")
                    );
            }
        ...
        public Calendar Calendar
        {
            ...
            set
            {
                ...
                throw new ArgumentOutOfRangeException(
                    "value",
                    Environment.GetResourceString("Argument_InvalidCalendar")
                );
            }
        }
        ...
        **      concatation every time somebody uses this form
        ...
        {
            get { return ((String[])internalGetAbbreviatedDayOfWeekNames().Clone()); }
            set
            {
                if (IsReadOnly)
                    throw new InvalidOperationException(
                ...
                if (value.Length != 7)
                {
                    throw new ArgumentException(
                        Environment.GetResourceString("Argument_InvalidArrayLength", 7),
                        "value"
                    );
                }
                Contract.EndContractBlock();
        ...
        {
            get { return ((String[])internalGetDayOfWeekNames().Clone()); }
            set
            {
                if (IsReadOnly)
                    throw new InvalidOperationException(
        ...
        {
            get { return ((String[])internalGetAbbreviatedMonthNames().Clone()); }
            set
            {
                if (IsReadOnly)
                    throw new InvalidOperationException(
                ...
                {
                    throw new ArgumentException(
                        Environment.GetResourceString("Argument_InvalidArrayLength", 13),
                        "value"
                    );
                }
                Contract.EndContractBlock();
        ...
        {
            get { return ((String[])internalGetMonthNames().Clone()); }
            set
            {
                if (IsReadOnly)
                    throw new InvalidOperationException(
        ...
        internal String internalGetMonthName(int month, MonthNameStyles style, bool abbreviated)
        {
            ...
            switch (style)
            {
                ...
                default:
                    monthNamesArray = (
                        abbreviated ? internalGetAbbreviatedMonthNames() : internalGetMonthNames()
                    );
                    break;
            }
        ...
        private String[] internalGetGenitiveMonthNames(bool abbreviated)
        {
            ...
            if (this.genitiveMonthNames == null)
            {
                ...
                Contract.Assert(
                    this.genitiveMonthNames.Length == 13,
        ...
        )
        {
            if (this.leapYearMonthNames == null)
            {
                ...
                Contract.Assert(
                    this.leapYearMonthNames.Length == 13,
        ...
        private static String[] GetCombinedPatterns(
            String[] patterns1,
            String[] patterns2,
        ...
        public String GetAbbreviatedMonthName(int month)
        {
            if (month < 1 || month > 13)
            {
                throw new ArgumentOutOfRangeException(
                    "month",
                    Environment.GetResourceString("ArgumentOutOfRange_Range", 1, 13)
                );
            }
            Contract.EndContractBlock();
        ...
        {
            get { return GetMergedPatterns(this.UnclonedYearMonthPatterns, this.YearMonthPattern); }
        }

        private String[] AllShortDatePatterns
        {
            get { return GetMergedPatterns(this.UnclonedShortDatePatterns, this.ShortDatePattern); }
        }

        private String[] AllShortTimePatterns
        {
            get { return GetMergedPatterns(this.UnclonedShortTimePatterns, this.ShortTimePattern); }
        }

        private String[] AllLongDatePatterns
        {
            get { return GetMergedPatterns(this.UnclonedLongDatePatterns, this.LongDatePattern); }
        }
        ...
        {
            get { return m_cultureData.CalendarName(Calendar.ID); }
        }
            ...
            get
            {
                if (m_fullTimeSpanPositivePattern == null)
                {
                    ...
                    if (m_cultureData.UseUserOverride)
                        cultureDataWithoutUserOverrides = CultureData.GetCultureData(
                            m_cultureData.CultureName,
                            false
                        );
                    else
                        cultureDataWithoutUserOverrides = m_cultureData;
                    String decimalSeparator = new NumberFormatInfo(
                        cultureDataWithoutUserOverrides
                    ).NumberDecimalSeparator;

                    m_fullTimeSpanPositivePattern =
                        "d':'h':'mm':'ss'" + decimalSeparator + "'FFFFFFF";
                }
        ...
        internal static void ValidateStyles(DateTimeStyles style, String parameterName)
        {
            ...
            {
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_InvalidDateTimeStyles"),
                    parameterName
                );
            }
            if (
            ...
            {
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_ConflictingDateTimeStyles"),
                    parameterName
                );
            }
            Contract.EndContractBlock();
            if (
                ((style & DateTimeStyles.RoundtripKind) != 0)
                && (
                    (
                        style
                        & (
            ...
            {
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_ConflictingDateTimeRoundtripStyles"),
                    parameterName
                );
            }
        }
        ...
        internal TokenHashValue[] CreateTokenHashTable()
        {
            ...
            if (temp == null)
            {
                ...
                if (LanguageName.Equals("sq"))
                {
                    ...
                    InsertHash(
                        temp,
                        IgnorablePeriod + this.AMDesignator,
                        TokenType.SEP_Am | TokenType.Am,
                        0
                    );
                    InsertHash(
                        temp,
                        IgnorablePeriod + this.PMDesignator,
                        TokenType.SEP_Pm | TokenType.Pm,
                        1
                    );
                }
                ...
                if (LanguageName.Equals(JapaneseLangName))
                {
                    ...
                    if (this.Calendar.GetType() != typeof(JapaneseCalendar))
                    {
                        ...
                        for (int i = 1; i <= jaDtfi.Calendar.Eras.Length; i++)
                        {
                            ...
                            InsertHash(
                                temp,
                                jaDtfi.GetAbbreviatedEraName(i),
                            ...
                            InsertHash(
                                temp,
                                jaDtfi.AbbreviatedEnglishEraNames[i - 1],
                                TokenType.JapaneseEraToken,
                                i
                            );
                        }
        ...
        )
        {
            ...
            do
            {
                ...
                i < str.Value.Length && (state != HebrewNumberParsingState.FoundEndOfHebrewNumber)
            );

            // When we are here, we are either at the end of the string, or we find a valid Hebrew number.
            Contract.Assert(
                state == HebrewNumberParsingState.ContinueParsing
                    || state == HebrewNumberParsingState.FoundEndOfHebrewNumber,
                            ...
                            else
                            {
                                ...
                                )
                                {
                                    if (
                                        (
                                            (
                                                nCurrentTokenTypeInHash
                                                & (int)TokenType.RegularTokenMask
                                            ) == 0
                                        ) && ((nTokenType & (int)TokenType.RegularTokenMask) != 0)
                                        || (
                                            (
                                                nCurrentTokenTypeInHash
                                ...
                                else
                                {
                                    ...
                                    if (
                                        (
                                            (
                                                (nTokenType | nCurrentTokenTypeInHash)
                                                & (int)TokenType.RegularTokenMask
                                            ) == nTokenType
                                        )
                                        || (
