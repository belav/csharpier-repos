...
namespace System.Globalization
{
    ...
    internal static class TimeSpanParse
    {
        ...
        struct TimeSpanTokenizer
        {
            ...
            {
                get { return m_pos >= (m_value.Length - 1); }
            }
        ...
        struct TimeSpanRawInfo
        {
            ...
            {
                get { return TimeSpanFormat.PositiveInvariantFormatLiterals; }
            }
            internal TimeSpanFormat.FormatLiterals NegativeInvariant
            {
                get { return TimeSpanFormat.NegativeInvariantFormatLiterals; }
            }
        ...
        {
            if (
                days.IsInvalidNumber(maxDays, unlimitedDigits)
            ...
            Int64 ticks =
                (
                    (Int64)days.num * 3600 * 24
                    + (Int64)hours.num * 3600
                    + (Int64)minutes.num * 60
                    + seconds.num
                ) * 1000;
        ...
        internal static Boolean TryParse(
            String input,
        ...
        internal static Boolean TryParseExact(
            String input,
            String format,
            IFormatProvider formatProvider,
            TimeSpanStyles styles,
        ...
        internal static Boolean TryParseExactMultiple(
            String input,
            String[] formats,
            IFormatProvider formatProvider,
            TimeSpanStyles styles,
        ...
        //
        private static Boolean TryParseTimeSpan(
            String input,
        ...
        //    4 numbers => h:m:s.f | d.h:m:s | d.h:m:.f
        //    5 numbers => d.h:m:s.f
        private static Boolean ProcessTerminalState(
        ...
        //           Sets result.parsedTimeSpan on success.
        //
        private static Boolean ProcessTerminal_DHMSF(
            ref TimeSpanRawInfo raw,
            TimeSpanStandardStyles style,
            ref TimeSpanResult result
        )
        ...
        //           Sets result.parsedTimeSpan on success.
        //
        private static Boolean ProcessTerminal_HMS_F_D(
            ref TimeSpanRawInfo raw,
            TimeSpanStandardStyles style,
            ref TimeSpanResult result
        )
        {
            if (
                raw.SepCount != 5
                || raw.NumCount != 4
                || (style & TimeSpanStandardStyles.RequireFull) != 0
            )
            {
                result.SetFailure(ParseFailureKind.Format, "Format_BadTimeSpan");
                return false;
        ...
        //
        private static Boolean ProcessTerminal_HM_S_D(
            ref TimeSpanRawInfo raw,
            TimeSpanStandardStyles style,
            ref TimeSpanResult result
        )
        ...
        //
        private static Boolean ProcessTerminal_HM(
            ref TimeSpanRawInfo raw,
            TimeSpanStandardStyles style,
            ref TimeSpanResult result
        )
        ...
        //
        private static Boolean ProcessTerminal_D(
            ref TimeSpanRawInfo raw,
            TimeSpanStandardStyles style,
            ref TimeSpanResult result
        )
        ...
        //
        private static Boolean TryParseExactTimeSpan(
            String input,
            String format,
            IFormatProvider formatProvider,
            TimeSpanStyles styles,
        ...
        //
        private static Boolean TryParseByFormat(
            String input,
            String format,
            TimeSpanStyles styles,
            ref TimeSpanResult result
        ...
        private static Boolean ParseExactDigits(
        ...
        private static Boolean ParseExactLiteral(
            ref TimeSpanTokenizer tokenizer,
        ...
        //
        private static Boolean TryParseExactMultipleTimeSpan(
            String input,
            String[] formats,
            IFormatProvider formatProvider,
            TimeSpanStyles styles,
