...
namespace System.Globalization
{
    ...
    public sealed class NumberFormatInfo : ICloneable, IFormatProvider
    {
        ...
        static private void VerifyDecimalSeparator(String decSep, String propertyName)
        {
            ...
            if (decSep.Length == 0)
            {
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_EmptyDecString")
                );
            }
        ...
        private static void VerifyNativeDigits(String[] nativeDig, String propertyName)
        {
            ...
            {
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_InvalidNativeDigitCount"),
                    propertyName
                );
            }
            Contract.EndContractBlock();
            ...
            for (int i = 0; i < nativeDig.Length; i++)
            {
                ...
                if (nativeDig[i].Length != 1)
                {
                    if (nativeDig[i].Length != 2)
                    {
                        ...
                        throw new ArgumentException(
                            Environment.GetResourceString("Argument_InvalidNativeDigitValue"),
                            propertyName
                        );
                    }
        ...
        static private void VerifyDigitSubstitution(DigitShapes digitSub, String propertyName)
        {
            switch (digitSub)
            {
                ...
                default:
                    throw new ArgumentException(
                        Environment.GetResourceString("Argument_InvalidDigitSubstitution"),
                        propertyName
                    );
            }
        }
            ...
            for (int i = 0; i < groupSize.Length; i++)
            {
                if (groupSize[i] < 1)
                {
                    if (i == groupSize.Length - 1 && groupSize[i] == 0)
                        return;
                    throw new ArgumentException(
                        Environment.GetResourceString("Argument_InvalidGroupSize"),
                        propName
                    );
                }
        ...
        {
            get { return ((int[])currencyGroupSizes.Clone()); }
            set
            {
                if (value == null)
                {
        ...
        {
            get { return ((int[])numberGroupSizes.Clone()); }
            set
            {
                if (value == null)
                {
        ...
        {
            get { return ((int[])percentGroupSizes.Clone()); }
            set
            {
                if (value == null)
                {
        ...
        internal static void ValidateParseStyleInteger(NumberStyles style)
        {
            ...
            {
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_InvalidNumberStyles"),
                    "style"
                );
            }
            Contract.EndContractBlock();
        ...
        internal static void ValidateParseStyleFloatingPoint(NumberStyles style)
        {
            ...
            { // Check for hex number
                throw new ArgumentException(
                    Environment.GetResourceString("Arg_HexStyleNotSupported")
                );
            }
        }
    } // NumberFormatInfo
