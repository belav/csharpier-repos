...
namespace System.Globalization
{
    ...
    internal static class EncodingTable
    {
        ...
        //
        private static Hashtable hashByName = Hashtable.Synchronized(
        ...
        private static unsafe int internalGetCodePageFromName(String name)
        {
            ...
            while ((right - left) > 3)
            {
                ...
                result = String.nativeCompareOrdinalIgnoreCaseWC(
                    name,
            ...
            {
                if (
                    String.nativeCompareOrdinalIgnoreCaseWC(name, encodingDataPtr[left].webName)
                    == 0
                )
                {
