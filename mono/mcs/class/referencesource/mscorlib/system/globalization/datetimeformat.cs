        ...
        */
        ...
        )
        {
            ...
            if (dtfi.Calendar.IsLeapYear(dtfi.Calendar.GetYear(time)))
            {
                ...
                return (
                    dtfi.internalGetMonthName(month, MonthNameStyles.LeapYear, (repeatCount == 3))
                );
            }
            ...
            if (!foundQuote)
            {
                ...
                throw new FormatException(
                    String.Format(
                        ...
                        Environment.GetResourceString("Format_BadQuote"),
                        quoteChar
                    )
                );
            }
        ...
        internal static int ParseQuoteString(
            ...
            while (i < format.Length)
            {
                ...
                switch (ch)
                {
                    ...
                    case 't':
                        ...
                        {
                            result.Append(
                                (dateTime.Hour < 12 ? dtfi.AMDesignator : dtfi.PMDesignator)
                            );
                        }
                        break;
                    case 'd':
                    ...
                    case 'M':
                        ...
                        else
                        {
                            ...
                            {
                                result.Append(
                                    FormatHebrewMonthName(dateTime, month, tokenLen, dtfi)
                                );
                            }
                            else
                            {
                    ...
                    case 'y':
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                result.Append(
                                    year.ToString(fmtPattern, CultureInfo.InvariantCulture)
                                );
                            }
                        }
                        bTimeOnly = false;
        ...
        private static void FormatCustomizedRoundripTimeZone(
            DateTime dateTime,
            TimeSpan offset,
            StringBuilder result
        )
        ...
        internal static String[] GetAllDateTimes(
            DateTime dateTime,
            char format,
            DateTimeFormatInfo dtfi
        )
        {
            ...
            switch (format)
            {
                ...
                case 'u':
                    results = new String[]
                    {
                        Format(dateTime, new String(new char[] { format }), dtfi),
                    };
                    break;
                default:
                    throw new FormatException(
