...
namespace System
{
    ...
    internal static class DateTimeParse
    {
        ...
        internal static MatchNumberDelegate m_hebrewNumberParser = new MatchNumberDelegate(
            DateTimeParse.MatchHebrewDigits
        );
        ...
        **      FormatException if invalid timezone format is found.
                            ...
                            )
                            {
                                ...
                                case TokenType.SEP_DateOrOffset:
                                    ...
                                    if (
                                        ...
                                        && (
                                            dateParsingStates[(int)dps][(int)DTT.YearSpace]
                                            > DS.ERROR
                                        )
                                    )
                                    {
                ...
                case TokenType.UnknownToken:
                    ...
                    if (
                        Environment.GetCompatibilityFlag(
                            CompatibilityFlag.DateTimeParseIgnorePunctuation
                        ) && ((result.flags & ParseFlags.CaptureOffset) == 0)
                    )
                    {
                        str.GetNext();
        ...
        //
        private static Boolean GetYearMonthDayOrder(
            String datePattern,
            DateTimeFormatInfo dtfi,
            out int order
        )
        ...
        //
        private static Boolean GetYearMonthOrder(
            String pattern,
            DateTimeFormatInfo dtfi,
            out int order
        )
        ...
        //
        private static Boolean GetMonthDayOrder(
            String pattern,
            DateTimeFormatInfo dtfi,
            out int order
        )
        ...
        private static Boolean GetDayOfNN(
            ref DateTimeResult result,
        ...
        private static Boolean GetDayOfNNN(
            ref DateTimeResult result,
            ref DateTimeRawInfo raw,
            DateTimeFormatInfo dtfi
        )
        ...
        private static Boolean GetDayOfMN(
            ref DateTimeResult result,
            ref DateTimeStyles styles,
            ref DateTimeRawInfo raw,
            DateTimeFormatInfo dtfi
        ...
        private static Boolean GetHebrewDayOfNM(
            ref DateTimeResult result,
            ref DateTimeRawInfo raw,
            DateTimeFormatInfo dtfi
        )
        ...
        private static Boolean GetDayOfNM(
            ref DateTimeResult result,
            ref DateTimeStyles styles,
            ref DateTimeRawInfo raw,
            DateTimeFormatInfo dtfi
        ...
        private static Boolean GetDayOfMNN(
            ref DateTimeResult result,
            ref DateTimeRawInfo raw,
            DateTimeFormatInfo dtfi
        )
        ...
        private static Boolean GetDayOfYNN(
            ref DateTimeResult result,
            ref DateTimeRawInfo raw,
            DateTimeFormatInfo dtfi
        )
        ...
        private static Boolean GetDayOfNNY(
            ref DateTimeResult result,
            ref DateTimeRawInfo raw,
            DateTimeFormatInfo dtfi
        )
        ...
        private static Boolean GetDayOfYMN(
            ref DateTimeResult result,
            ref DateTimeRawInfo raw,
            DateTimeFormatInfo dtfi
        )
        ...
        private static Boolean GetDayOfYN(
            ref DateTimeResult result,
            ref DateTimeRawInfo raw,
            DateTimeFormatInfo dtfi
        )
        ...
        private static Boolean GetDateOfNNDS(
            ref DateTimeResult result,
            ref DateTimeRawInfo raw,
            DateTimeFormatInfo dtfi
        )
        ...
        internal static Boolean ProcessHebrewTerminalState(
            DS dps,
            ref DateTimeResult result,
            ref DateTimeStyles styles,
            ref DateTimeRawInfo raw,
        ...
        //
        internal static Boolean ProcessTerminaltState(
            DS dps,
            ref DateTimeResult result,
            ref DateTimeStyles styles,
            ref DateTimeRawInfo raw,
        ...
        private static Boolean DetermineTimeZoneAdjustments(
            ref DateTimeResult result,
            DateTimeStyles styles,
            Boolean bTimeOnly
        )
        ...
        private static Boolean DateTimeOffsetTimeZonePostProcessing(
            ref DateTimeResult result,
            DateTimeStyles styles
        )
        {
        ...
        **  Only support GMT timezone.
        ...
        )
        {
            ...
            if (result.fraction > 0)
            {
                result.parsedDate = result.parsedDate.AddTicks(
        ...
        internal static void PTSTraceExit(DS dps, bool passed)
        {
            ...
            BCLDebug.Trace(
                "DATETIME",
                "[DATETIME] ProcessTerminalState {0} @ DS.{1}",
        ...
        internal static string Hex(string str)
        {
            ...
            for (int i = 0; i < str.Length; i++)
            {
                if (str[i] <= '\x007f')
                    ...
                    buffer.Append(
                        "\\u" + ((int)str[i]).ToString("x4", CultureInfo.InvariantCulture)
                    );
            }
            buffer.Append("\"");
            return buffer.ToString();
    ...
    internal struct __DTString
    {
        ...
        internal bool MatchSpecifiedWord(String target, int endIndex)
        {
            ...
            return (
                m_info.Compare(Value, Index, count, target, 0, count, CompareOptions.IgnoreCase)
                == 0
            );
        }
        ...
        internal bool Match(String str)
        {
            ...
            if (
                m_info.Compare(Value, Index, str.Length, str, 0, str.Length, CompareOptions.Ordinal)
                == 0
            )
            {
    ...
    internal struct DTSubString
    {
        ...
        {
            get { return s[index + relativeIndex]; }
        }
    }
