...
namespace System.Globalization
{
    ...
    public partial class TextInfo : ICloneable, IDeserializationCallback
    {
...
#if !MONO
        [NonSerialized]
        private IntPtr m_dataHandle; // Sort handle
        ...
        internal TextInfo(CultureData cultureData)
        {
            ...
            IntPtr handleOrigin;
            this.m_dataHandle = CompareInfo.InternalInitSortHandle(
                m_textInfoName,
                out handleOrigin
            );
        ...
        [ResourceExposure(ResourceScope.None)]
        [ResourceConsumption(ResourceScope.Process, ResourceScope.Process)]
        internal static int GetHashCodeOrdinalIgnoreCase(
            String s,
        ...
        )
        {
            ...
            return (
                Invariant.GetCaseInsensitiveHashCode(s, forceRandomizedHashing, additionalEntropy)
            );
        }
        ...
        [ResourceExposure(ResourceScope.None)]
        [ResourceConsumption(ResourceScope.Process, ResourceScope.Process)]
        internal static unsafe bool TryFastFindStringOrdinalIgnoreCase(
            int searchFlags,
            String source,
            int startIndex,
            String value,
        ...
        {
            return InternalTryFindStringOrdinalIgnoreCase(
                searchFlags,
                source,
                count,
                startIndex,
        ...
        internal static unsafe int CompareOrdinalIgnoreCase(String str1, String str2)
        {
            ...
            return InternalCompareStringOrdinalIgnoreCase(
                str1,
                0,
                str2,
                0,
        ...
        [ResourceExposure(ResourceScope.None)]
        [ResourceConsumption(ResourceScope.Process, ResourceScope.Process)]
        internal static unsafe int CompareOrdinalIgnoreCaseEx(
            String strA,
            int indexA,
            String strB,
            int indexB,
        ...
        [ResourceExposure(ResourceScope.None)]
        [ResourceConsumption(ResourceScope.Process, ResourceScope.Process)]
        internal static int IndexOfStringOrdinalIgnoreCase(
            String source,
            String value,
            int startIndex,
            int count
        )
        {
            ...
            int ret = -1;
            if (
                TryFastFindStringOrdinalIgnoreCase(
                    Microsoft.Win32.Win32Native.FIND_FROMSTART,
                    source,
                    startIndex,
                    value,
                    count,
        ...
        [ResourceExposure(ResourceScope.None)]
        [ResourceConsumption(ResourceScope.Process, ResourceScope.Process)]
        internal static int LastIndexOfStringOrdinalIgnoreCase(
            String source,
            String value,
            int startIndex,
            int count
        )
        {
            ...
            if (
                TryFastFindStringOrdinalIgnoreCase(
                    Microsoft.Win32.Win32Native.FIND_FROMEND,
                    source,
                    startIndex,
                    value,
                    count,
        ...
        {
            get { return (this.m_cultureData.IDEFAULTANSICODEPAGE); }
        }

        public virtual int OEMCodePage
        {
            get { return (this.m_cultureData.IDEFAULTOEMCODEPAGE); }
        }

        public virtual int MacCodePage
        {
            get { return (this.m_cultureData.IDEFAULTMACCODEPAGE); }
        }

        public virtual int EBCDICCodePage
        {
            get { return (this.m_cultureData.IDEFAULTEBCDICCODEPAGE); }
        }
#endif
        ...
        {
            get { return (this.m_textInfoName); }
        }
...
#else
            return InternalChangeCaseString(
                this.m_dataHandle,
                this.m_handleOrigin,
                this.m_textInfoName,
                str,
            ...
            get
            {
                if (m_IsAsciiCasingSameAsInvariant == null)
                {
                    ...
                    m_IsAsciiCasingSameAsInvariant = !(
                        m_cultureData.SISO639LANGNAME == "az"
                        || m_cultureData.SISO639LANGNAME == "tr"
                    );
#else
                    m_IsAsciiCasingSameAsInvariant =
                        CultureInfo
        ...
        {
            get { return this.m_cultureData.IsRightToLeft; }
        }
...
#if MONO
            return this == s_Invariant
                ? GetInvariantCaseInsensitiveHashCode(str)
