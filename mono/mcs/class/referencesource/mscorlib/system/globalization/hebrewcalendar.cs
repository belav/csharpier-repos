    ...
    */
    ...
    public class HebrewCalendar : Calendar
    {
        ...
        */
        ...
        internal static readonly DateTime calendarMaxValue = new DateTime(
        ...
        **Exceptions:
        ...
        public override DateTime AddMonths(DateTime time, int months)
        {
            try
            {
                ...
                return (
                    new DateTime(ToDateTime(y, i, d, 0, 0, 0, 0).Ticks + (time.Ticks % TicksPerDay))
                );
            }
