...
#pragma warning restore
        ...
        internal static int GetNativeCompareFlags(CompareOptions options)
        {
            ...
            Contract.Assert(
                (nativeCompareFlags & RESERVED_FIND_ASCII_STRING) == 0,
        ...
        public virtual unsafe int Compare(String string1, String string2, CompareOptions options)
        {
            ...
            if ((options & CompareOptions.Ordinal) != 0)
            {
                ...
                {
                    throw new ArgumentException(
                        Environment.GetResourceString("Argument_CompareOptionOrdinal"),
                        "options"
                    );
                }
...
#if MONO
            return internal_compare_switch(
                string1,
                0,
                string1.Length,
                string2,
        ...
        public virtual unsafe int Compare(String string1, int offset1, String string2, int offset2)
        {
        ...
        )
        {
            ...
            if (offset1 > (string1 == null ? 0 : string1.Length) - length1)
            {
                throw new ArgumentOutOfRangeException(
                    "string1",
                    Environment.GetResourceString("ArgumentOutOfRange_OffsetLength")
                );
            }
        ...
        {
            int result = String.nativeCompareOrdinalEx(
                string1,
                offset1,
                string2,
                offset2,
        ...
        public virtual unsafe bool IsPrefix(String source, String prefix, CompareOptions options)
        {
            ...
            return (
                InternalFindNLSStringEx(
                    ...
                    m_sortName,
                    GetNativeCompareFlags(options)
                        | Win32Native.FIND_STARTSWITH
                        | ((source.IsAscii() && prefix.IsAscii()) ? RESERVED_FIND_ASCII_STRING : 0),
                    source,
                    source.Length,
                    0,
                    prefix,
        ...
        public virtual unsafe bool IsSuffix(String source, String suffix, CompareOptions options)
        {
            ...
            return InternalFindNLSStringEx(
                    ...
                    m_sortName,
                    GetNativeCompareFlags(options)
                        | Win32Native.FIND_ENDSWITH
                        | ((source.IsAscii() && suffix.IsAscii()) ? RESERVED_FIND_ASCII_STRING : 0),
                    source,
                    source.Length,
                    source.Length - 1,
                    suffix,
        ...
        public virtual unsafe int IndexOf(String source, char value)
        {
            if (source == null)
        ...
        public virtual unsafe int IndexOf(String source, String value)
        {
            if (source == null)
                throw new ArgumentNullException("source");
            Contract.EndContractBlock();
        ...
        public virtual unsafe int IndexOf(String source, char value, CompareOptions options)
        {
            if (source == null)
                throw new ArgumentNullException("source");
            Contract.EndContractBlock();
        ...
        public virtual unsafe int IndexOf(String source, String value, CompareOptions options)
        {
            if (source == null)
                throw new ArgumentNullException("source");
            Contract.EndContractBlock();
        ...
        public virtual unsafe int IndexOf(String source, char value, int startIndex)
        {
            if (source == null)
                throw new ArgumentNullException("source");
            Contract.EndContractBlock();
        ...
        public virtual unsafe int IndexOf(String source, String value, int startIndex)
        {
            if (source == null)
                throw new ArgumentNullException("source");
            Contract.EndContractBlock();
        ...
        public virtual unsafe int IndexOf(
            String source,
            char value,
            int startIndex,
            CompareOptions options
        ...
        public virtual unsafe int IndexOf(String source, char value, int startIndex, int count)
        {
            return IndexOf(source, value, startIndex, count, CompareOptions.None);
        }

        public virtual unsafe int IndexOf(String source, String value, int startIndex, int count)
        {
            return IndexOf(source, value, startIndex, count, CompareOptions.None);
        }
        ...
        )
        {
            ...
            return InternalFindNLSStringEx(
                ...
                m_sortName,
                GetNativeCompareFlags(options)
                    | Win32Native.FIND_FROMSTART
                    | ((source.IsAscii() && (value <= '\x007f')) ? RESERVED_FIND_ASCII_STRING : 0),
                source,
                count,
                startIndex,
                new String(value, 1),
        ...
        )
        {
            ...
            return InternalFindNLSStringEx(
                ...
                GetNativeCompareFlags(options)
                    | Win32Native.FIND_FROMSTART
                    | ((source.IsAscii() && value.IsAscii()) ? RESERVED_FIND_ASCII_STRING : 0),
                source,
                count,
                startIndex,
                value,
        ...
        public virtual unsafe int LastIndexOf(String source, char value)
        {
            if (source == null)
                throw new ArgumentNullException("source");
            Contract.EndContractBlock();
        ...
        public virtual unsafe int LastIndexOf(String source, String value, CompareOptions options)
        {
            if (source == null)
                throw new ArgumentNullException("source");
            Contract.EndContractBlock();
        ...
        public virtual unsafe int LastIndexOf(String source, char value, int startIndex)
        {
            return LastIndexOf(source, value, startIndex, startIndex + 1, CompareOptions.None);
        }

        public virtual unsafe int LastIndexOf(String source, String value, int startIndex)
        {
            return LastIndexOf(source, value, startIndex, startIndex + 1, CompareOptions.None);
        }

        public virtual unsafe int LastIndexOf(
            String source,
            char value,
            int startIndex,
            CompareOptions options
        ...
        public virtual unsafe int LastIndexOf(String source, char value, int startIndex, int count)
        {
        ...
        [System.Security.SecuritySafeCritical] // auto-generated
        internal int GetHashCodeOfString(
            string source,
            CompareOptions options,
        ...
        public int LCID
        {
            get { return CultureInfo.GetCultureInfo(this.Name).LCID; }
        }
#endif
        ...
        {
            get { return InternalSortVersion == SORT_VERSION_WHIDBEY; }
        }
            ...
            get
            {
                if (m_SortVersion == null)
                {
                    ...
                    m_SortVersion = new SortVersion(
                        SORT_VERSION_V4,
                        new Guid("00000001-57ee-1e5c-00b4-d0000bb1e11e")
                    ); // Guid returned by corefx and .NET 4.6
#else
                    ...
                    m_SortVersion = new SortVersion(
                        v.dwNLSVersion,
                        (v.dwEffectiveId != 0) ? v.dwEffectiveId : LCID,
                        v.guidCustomVersion
                    );
#endif
                }
        ...
        private static extern bool InternalGetNlsVersionEx(
            IntPtr handle,
            IntPtr handleOrigin,
            String localeName,
            ref Win32Native.NlsVersionInfoEx lpNlsVersionInformation
        );
        ...
        [DllImport(JitHelpers.QCall, CharSet = CharSet.Unicode)]
        [SuppressUnmanagedCodeSecurity]
        private static extern IntPtr NativeInternalInitSortHandle(
            String localeName,
        ...
        [DllImport(JitHelpers.QCall, CharSet = CharSet.Unicode)]
        [SuppressUnmanagedCodeSecurity]
        private static extern int InternalGetGlobalizedHashCode(
            IntPtr handle,
            IntPtr handleOrigin,
            string localeName,
            string source,
        ...
        [SuppressUnmanagedCodeSecurity]
        [return: MarshalAs(UnmanagedType.Bool)]
        private static extern bool InternalIsSortable(
            IntPtr handle,
            IntPtr handleOrigin,
            String localeName,
            String source,
        ...
        [DllImport(JitHelpers.QCall, CharSet = CharSet.Unicode)]
        [SuppressUnmanagedCodeSecurity]
        private static extern int InternalCompareString(
            IntPtr handle,
            IntPtr handleOrigin,
            String localeName,
            String string1,
        ...
        [DllImport(JitHelpers.QCall, CharSet = CharSet.Unicode)]
        [SuppressUnmanagedCodeSecurity]
        private static extern int InternalFindNLSStringEx(
            IntPtr handle,
            IntPtr handleOrigin,
            String localeName,
            int flags,
        ...
        [DllImport(JitHelpers.QCall, CharSet = CharSet.Unicode)]
        [SuppressUnmanagedCodeSecurity]
        private static extern int InternalGetSortKey(
            IntPtr handle,
            IntPtr handleOrigin,
            String localeName,
            int flags,
