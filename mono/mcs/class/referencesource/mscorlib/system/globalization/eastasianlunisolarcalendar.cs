...
namespace System.Globalization
{
    ...
    public abstract class EastAsianLunisolarCalendar : Calendar
    {
        ...
        //
        internal void GregorianToLunar(
            int nSYear,
            int nSMonth,
            int nSDate,
            ref int nLYear,
...
*/
        ...
        internal DateTime LunarToTime(DateTime time, int year, int month, int day)
        {
            ...
            return (
                GregorianCalendar
                    .GetDefaultInstance()
                    .ToDateTime(gy, gm, gd, time.Hour, time.Minute, time.Second, time.Millisecond)
            );
        }
        ...
        public override int TwoDigitYearMax
        {
            get
            {
                ...
                {
                    twoDigitYearMax = GetSystemTwoDigitYearSetting(
                        BaseCalendarID,
                        GetYear(new DateTime(DEFAULT_GREGORIAN_TWO_DIGIT_YEAR_MAX, 1, 1))
                    );
                }
