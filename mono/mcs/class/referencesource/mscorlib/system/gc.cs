...
namespace System
{
    ...
    public static partial class GC
    {
        ...
        internal static void GetMemoryInfo(
            out uint highMemLoadThreshold,
        ...
        )
        {
            ...
            if (!_RegisterForFullGCNotification(maxGenerationThreshold, largeObjectHeapThreshold))
            {
                throw new InvalidOperationException(
                    Environment.GetResourceString("InvalidOperation_NotWithConcurrentGC")
                );
            }
        }
        ...
        [SecurityCritical]
        static bool StartNoGCRegionWorker(
            long totalSize,
            bool hasLohSize,
            long lohSize,
            bool disallowFullBlockingGC
...
#pragma warning disable 420
        ...
        public Int64 ApproximateSize
        {
            ...
            get
            {
                ...
                {
                    throw new InvalidOperationException(
                        Environment.GetResourceString("InvalidOperation_HandleIsNotInitialized")
                    );
                }
