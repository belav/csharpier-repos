...
namespace System.Runtime.InteropServices.TCEAdapterGen
{
    ...
    internal class EventProviderWriter
    {
        ...
        public EventProviderWriter(
            ModuleBuilder OutputModule,
            String strDestTypeName,
            Type EventItfType,
            Type SrcItfType,
            Type SinkHelperType
        )
        ...
        public Type Perform()
        {
            ...
            MethodBuilder InitSrcItfMethodBuilder = DefineInitSrcItfMethod(
                OutputTypeBuilder,
                m_SrcItfType,
                fbSinkHelper,
                fbEventCP,
            ...
            MethodBuilder FinalizeMethod = DefineFinalizeMethod(
                OutputTypeBuilder,
                m_SinkHelperType,
                fbSinkHelper,
                fbEventCP
        ...
        private MethodBuilder DefineAddEventMethod(
            ...
            MethodInfo SrcItfMethod,
            Type SinkHelperClass,
            FieldBuilder fbSinkHelperArray,
            FieldBuilder fbEventCP,
            MethodBuilder mbInitSrcItf
        )
        {
            Type[] aParamTypes;

            // Find the delegate on the event sink helper.
            FieldInfo DelegateField = SinkHelperClass.GetField(
                "m_" + SrcItfMethod.Name + "Delegate"
            );
            Contract.Assert(
                DelegateField != null,
                "Unable to find the field m_" + SrcItfMethod.Name + "Delegate on the sink helper"
            );
            ...
            ConstructorInfo SinkHelperCons = SinkHelperClass.GetConstructor(
                EventProviderWriter.DefaultLookup | BindingFlags.NonPublic,
                null,
                new Type[0],
                null
            );
            ...
            MethodInfo MonitorEnterMethod = typeof(Monitor).GetMethod(
                "Enter",
                MonitorEnterParamTypes,
                null
            );
            Contract.Assert(
                MonitorEnterMethod != null,
        ...
        )
        {
            ...
            MethodInfo ArrayListRemoveMethod = typeof(ArrayList).GetMethod(
                "RemoveAt",
                aParamTypes,
                null
            );
            Contract.Assert(
                ArrayListRemoveMethod != null,
            ...
            MethodInfo DelegateEqualsMethod = typeof(Delegate).GetMethod(
                "Equals",
                aParamTypes,
                null
            );
            Contract.Assert(
                DelegateEqualsMethod != null,
        ...
        )
        {
            ...
            ConstructorInfo DefaultArrayListCons = typeof(ArrayList).GetConstructor(
                EventProviderWriter.DefaultLookup,
                null,
                new Type[0],
                null
            );
            Contract.Assert(
                DefaultArrayListCons != null,
            ...
            ConstructorInfo ByteArrayGUIDCons = typeof(Guid).GetConstructor(
                EventProviderWriter.DefaultLookup,
                null,
                aParamTypes,
                null
            ...
            MethodInfo CPCFindCPMethod = typeof(IConnectionPointContainer).GetMethod(
                "FindConnectionPoint"
            );
            Contract.Assert(
                CPCFindCPMethod != null,
        ...
        private void DefineConstructor(TypeBuilder OutputTypeBuilder, FieldBuilder fbCPC)
        {
            ...
            MethodAttributes ctorAttributes =
                ...
                | (DefaultBaseClsCons.Attributes & MethodAttributes.MemberAccessMask);
