...
namespace System.Runtime.InteropServices.TCEAdapterGen
{
    ...
    internal class EventSinkHelperWriter
    {
        ...
        private void DefineEventMethod(
            TypeBuilder OutputTypeBuilder,
            MethodInfo Method,
            Type DelegateCls,
            FieldBuilder fbDelegate
        )
        {
        ...
        private void DefineConstructor(
            TypeBuilder OutputTypeBuilder,
            FieldBuilder fbCookie,
            FieldBuilder[] afbDelegates
        )
        {
            // Retrieve the constructor info for the base classe's constructor.
            ConstructorInfo DefaultBaseClsCons = typeof(Object).GetConstructor(
            ...
            Contract.Assert(
                DefaultBaseClsCons != null,
                "Unable to find the constructor for class " + m_InputType.Name
            );
