    ...
    internal class TypeInfo : IRemotingTypeInfo
    {
        ...
        public virtual bool CanCastTo(Type castType, Object o)
        {
            if (null != castType)
            {
                ...
                //   heirarchy
                if ((castType == typeof(MarshalByRefObject)) || (castType == typeof(System.Object)))
                {
                    return true;
                }
        ...
        internal static bool ParseTypeAndAssembly(
            ...
            if (null != serverID)
            {
                ...
                if (serverID.EnvoyChain == null)
                {
                    ...
                    serverID.RaceSetEnvoyChain(
                        serverID.ServerContext.CreateEnvoyChain(serverID.TPOrObject)
                    );
                }
    ...
    public class ObjRef : IObjectReference, ISerializable
    {
        ...
        internal bool CanSmuggle()
        {
            ...
            if (
                ...
                && (envoyInfo == null)
                && ((typeOfChannelInfo == null) || (typeOfChannelInfo == typeof(ChannelInfo)))
            )
            {
                if (channelInfo != null)
                {
            ...
            for (int co = 0; co < oldChannelData.Length; co++)
            {
                ...
                if (channelDataStore != null)
                {
                    ...
                    if ((urls != null) && (urls.Length == 1) && urls[0].Equals(urlToBash))
                    {
                        ...
                        ChannelDataStore newChannelDataStore =
                            channelDataStore.InternalShallowCopy();
                ...
                if (IsFromThisProcess() && !IsFromThisAppDomain())
                {
                    try
                    {
                        ...
                        if (pUnk != IntPtr.Zero && !fIsURTAggregated)
                        {
                            ...
                            Assembly asm = FormatterServices.LoadAssemblyFromStringNoThrow(
                                assemName
                            );
                            if (asm == null)
                            {
                                BCLDebug.Trace(
                                    "REMOTE",
                                    "ObjRef.GetCustomMarshaledCOMObject. AssemblyName is: ",
                                    assemName,
                                    " but we can't load it."
                                );
            ...
            )
            {
                throw new RemotingException(
                    String.Format(
                        ...
                        Environment.GetResourceString("Remoting_InvalidRequestedType"),
