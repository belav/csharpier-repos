...
namespace System.Runtime.Remoting
{
    ...
    {
        private const BindingFlags LookupAll =
            ...
            if (rTypeToProxy == null)
                throw new ArgumentException(
                    String.Format(
                        ...
                        Environment.GetResourceString("Argument_WrongType"),
                        "typeToProxy"
                    )
                );
        ...
        internal static MarshalByRefObject AllocateUninitializedObject(Type objectType)
        {
            ...
            return AllocateUninitializedObject(rObjectType);
        }
        ...
        internal static MarshalByRefObject AllocateInitializedObject(Type objectType)
        {
            ...
            return AllocateInitializedObject(rObjectType);
        }
        ...
        internal static bool RegisterWellKnownChannels()
        {
            ...
            if (!s_bRegisteredWellKnownChannels)
            {
                ...
                try
                {
                    ...
                    if (
                        !s_bRegisteredWellKnownChannels
        ...
        public static void SetObjectUriForMarshal(MarshalByRefObject obj, String uri)
        {
            ...
            if ((idObj != null) && (srvIdObj == null)) // <-- means idObj is not a ServerIdentity
            {
        ...
        )
        {
            ...
            if (null == objectRef)
            {
                ...
                if (idObj == null || objectRef == null)
                    throw new ArgumentException(
                        Environment.GetResourceString("Argument_InvalidMarshalByRefObject"),
                        "Obj"
                    );
...
*/
        ...
        )
        {
            ...
            if (IsTransparentProxy(Obj))
            {
                ...
                if (null == idObj)
                {
                    ...
                    idObj = IdentityHolder.FindOrCreateServerIdentity(Obj, ObjURI, idOpsFlags);
                ...
                if (srvID != null)
                {
                    ...
                    Contract.Assert(
                        srvID != null && Obj is ContextBoundObject,
                    ...
                    if (
                        (null != ObjURI)
                        && (ObjURI != Identity.RemoveAppNameOrAppGuidIfNecessary(idObj.ObjURI))
                    )
                    {
                        throw new RemotingException(
                            Environment.GetResourceString("Remoting_URIExists")
                        );
                    }
                ...
                else
                {
                    ...
                    {
                        throw new RemotingException(
                            Environment.GetResourceString("Remoting_URIToProxy")
                        );
                    }
                }
            ...
            else
            {
                ...
                // timed out.
#if _DEBUG
                ServerIdentity idTmp = (ServerIdentity)MarshalByRefObject.GetIdentity(Obj);
#endif
                idObj = IdentityHolder.FindOrCreateServerIdentity(Obj, ObjURI, idOpsFlags);
        ...
        )
        {
            ...
            ObjRef or = RemotingServices.MarshalInternal((MarshalByRefObject)obj, null, null);
        ...
        public static ObjRef GetObjRefForProxy(MarshalByRefObject obj)
        {
            ...
            {
                throw new RemotingException(
                    Environment.GetResourceString("Remoting_Proxy_BadType")
                );
            }
            RealProxy rp = GetRealProxy(obj);
            Identity id = rp.IdentityObject;
        ...
        internal static Object Unmarshal(Type classToProxy, String url, Object data)
        {
            ...
            {
                throw new RemotingException(
                    Environment.GetResourceString("Remoting_NotRemotableByReference")
                );
            }

            BCLDebug.Trace(
                "REMOTE",
                "RemotingService::Unmarshal for URL" + url + "and for Type" + classToProxy
            );
            ...
            if (idObj == null || idObj.ChannelSink == null || idObj.EnvoyChain == null)
            {
                ...
                if (chnlSink == null)
                {
                    throw new RemotingException(
                        String.Format(
                            CultureInfo.CurrentCulture,
                            Environment.GetResourceString("Remoting_Connect_CantCreateChannelSink"),
                            url
                        )
                    );
                }
        ...
        internal static Object Wrap(ContextBoundObject obj, Object proxy, bool fCreateSinks)
        {
            ...
            if ((null != obj) && (!IsTransparentProxy(obj)))
            {
                ...
                else
                {
                    ...
                    idObj = IdentityHolder.FindOrCreateServerIdentity(obj, null, IdOps.None);
                }
        ...
        internal static Object InternalUnmarshal(ObjRef objectRef, Object proxy, bool fRefine)
        {
            ...
            if (!ObjRef.IsWellFormed(objectRef))
            {
                throw new ArgumentException(
                    String.Format(
                        CultureInfo.CurrentCulture,
                        Environment.GetResourceString("Argument_BadObjRef"),
                        "Unmarshal"
                    )
                );
            }
            ...
            {
                obj = Unmarshal(typeof(System.MarshalByRefObject), objectRef.URI);
            ...
            if (serverID != null)
            {
                ...
                {
                    BCLDebug.Assert(
                        serverID.ServerType.IsMarshalByRef,
        ...
        private static Object GetOrCreateProxy(Identity idObj, Object proxy, bool fRefine)
        {
            ...
            if (null == proxy)
            {
                ...
                else
                {
                    ...
                    serverType = null;
                    if (((serverTypeInfo is TypeInfo) && !fRefine) || (serverTypeInfo == null))
                    {
                    ...
                    else
                    {
                        ...
                        if (typeName != null)
                        {
                            ...
                            TypeInfo.ParseTypeAndAssembly(
                                typeName,
                                out typeNamespace,
                                out assemNamespace
                            );

                            Assembly assem = FormatterServices.LoadAssemblyFromStringNoThrow(
                                assemNamespace
                            );
        ...
        )
        {
            ...
            if (null == proxy)
            {
                ...
                Message.DebugOut(
                    "SetOrCreateProxy::Creating Proxy for " + classToProxy.FullName + "\n"
                );
                ...
                if (null == realProxy)
                {
                    ...
                    realProxy = defaultProxyAttribute.CreateProxy(
                        idObj.ObjectRef,
                        classToProxy,
                        null,
                        (null == srvID ? null : srvID.ServerContext)
                    );
                }
            }
            else
        ...
        )
        {
            ...
            else
            {
                ...
                if ((null != objectRef.EnvoyInfo) && (null != objectRef.EnvoyInfo.EnvoySinks))
                {
        ...
        private static String CreateChannelSink(String url, Object data, out IMessageSink chnlSink)
        {
            ...
            if (null == chnlSink)
            {
                lock (s_delayLoadChannelLock)
                {
                    ...
                    if (null == chnlSink)
                    {
                        chnlSink = RemotingConfigHandler.FindDelayLoadChannelForCreateMessageSink(
                            url,
                            data,
                            out objectURI
                        );
            ...
            if (null == idObj.EnvoyChain)
            {
                ...
                else
                {
                    throw new RemotingException(
                        String.Format(
                            CultureInfo.CurrentCulture,
                            Environment.GetResourceString("Remoting_BadInternalState_FailEnvoySink")
                        )
                    );
                }
            }
        ...
        */
        ...
        internal static Object CreateDataForDomainCallback(Object[] args)
        {
            ...
            ObjRef objref = MarshalInternal(Thread.CurrentContext.AppDomain, null, null, false);

            ServerIdentity si = (ServerIdentity)
                MarshalByRefObject.GetIdentity(Thread.CurrentContext.AppDomain);
            si.SetHandle();
        ...
        {
            RemotingMethodCachedData cache = InternalRemotingServices.GetReflectionCachedData(
                msg.MethodBase
            );
        ...
        private static MethodBase GetMethodBase(IMethodMessage msg, Type t, Type[] signature)
        {
            ...
            if ((msg is IConstructionCallMessage) || (msg is IConstructionReturnMessage))
            {
                if ((null == signature))
                {
                    BCLDebug.Trace(
                        "REMOTE",
                        "RemotingServices.MethodBaseFromMethodCallMessage with null sig ",
                        msg.MethodName
                    );
                    ConstructorInfo[] ci;
                    ...
                    if (1 != ci.Length)
                    {
                        ...
                        throw new AmbiguousMatchException(
                            Environment.GetResourceString("Remoting_AmbiguousCTOR")
                        );
                    }
                    mb = ci[0];
                }
                else
                {
                    BCLDebug.Trace(
                        "REMOTE",
                        "RemotingServices.MethodBaseFromMethodCallMessage with non-null sig ",
                        msg.MethodName,
                        " ",
                        signature.Length
                    );
        ...
        internal static bool IsMethodAllowedRemotely(MethodBase method)
        {
            ...
            )
            {
                ...
                if (s_FieldGetterMB == null)
                    s_FieldGetterMB = typeof(Object).GetMethod(
                        FieldGetterName,
                        RemotingServices.LookupAll
                    );

                if (s_FieldSetterMB == null)
                    s_FieldSetterMB = typeof(Object).GetMethod(
                        FieldSetterName,
                        RemotingServices.LookupAll
                    );
                ...
                {
                    s_IsInstanceOfTypeMB = typeof(MarshalByRefObject).GetMethod(
                        IsInstanceOfTypeName,
                        RemotingServices.LookupAll
                    );
                }
                ...
                {
                    s_CanCastToXmlTypeMB = typeof(MarshalByRefObject).GetMethod(
                        CanCastToXmlTypeName,
                        RemotingServices.LookupAll
                    );
                }
                ...
                {
                    s_InvokeMemberMB = typeof(MarshalByRefObject).GetMethod(
                        InvokeMemberName,
                        RemotingServices.LookupAll
                    );
                }
        ...
        private static bool CompareParameterList(ArrayList params1, ParameterInfo[] params2)
        {
            ...
            foreach (Object obj in params1)
            {
                ...
                {
                    if (
                        (pi.ParameterType != param.ParameterType)
                        || (pi.IsIn != param.IsIn)
                ...
                else if (((Type)obj != param.ParameterType) && param.IsIn)
                    return false;
                co++;
            }
        ...
        )
        {
            ObjRef objRef;
            bool bSameDomain;
            contextId = GetServerContextForProxy(tp, out objRef, out bSameDomain, out domainId);
        ...
        )
        {
            ...
            if (IsTransparentProxy(tp))
            {
                ...
                else
                {
                    ...
                    Contract.Assert(!(rp is RemotingProxy), "!(rp is RemotingProxy)");
        ...
        private static Object GetType(Object tp)
        {
            ...
            if ((null != id) && (null != id.ObjectRef) && (null != id.ObjectRef.TypeInfo))
            {
        ...
        internal static byte[] MarshalToBuffer(Object o, bool crossRuntime)
        {
            if (crossRuntime)
            {
                ...
                else
                {
                    ...
                    if (mbro != null)
                    {
                        ProxyAttribute proxyAttr = ActivationServices.GetProxyAttribute(
                            mbro.GetType()
                        );
        ...
        )
        {
            ...
            if (rp is RemotingProxy && !rp.DoContextsMatch())
            {
                throw new RemotingException(
            ...
            IMethodReturnMessage retMsg = (IMethodReturnMessage)
                dispatcher.SyncProcessMessage(reqMsg);
        ...
        internal static String InternalGetTypeNameFromQualifiedTypeName(String qualifiedTypeName)
        {
            ...
            if (index != -1)
            {
                ...
                String xmlTypeNamespace = qualifiedTypeName.Substring(
                    index + 2,
                    qualifiedTypeName.Length - (index + 2)
                );

                decodedName = InternalGetSoapTypeNameFromQualifiedTypeName(
                    xmlTypeName,
                    xmlTypeNamespace
                );
                if (decodedName != null)
        ...
        [System.Security.SecurityCritical] // auto-generated
        internal static RuntimeType InternalGetTypeFromQualifiedTypeName(
        ...
        [ResourceExposure(ResourceScope.None)]
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern void CORProfilerRemotingClientSendingMessage(
            out Guid id,
            bool fIsAsync
        );
        ...
        [ResourceExposure(ResourceScope.None)]
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern void CORProfilerRemotingServerReceivingMessage(
            Guid id,
            bool fIsAsync
        );
        ...
        [ResourceExposure(ResourceScope.None)]
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern void CORProfilerRemotingServerSendingReply(
            out Guid id,
            bool fIsAsync
        );
    ...
    public class InternalRemotingServices
    {
        ...
        internal static RemotingMethodCachedData GetReflectionCachedData(MethodBase mi)
        {
            ...
            else if ((rci = mi as RuntimeConstructorInfo) != null)
            {
                ...
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_MustBeRuntimeReflectionObject")
                );
        }
        ...
        internal static RemotingCachedData GetReflectionCachedData(
            RuntimeParameterInfo reflectionObject
        )
        {
