...
namespace System.Runtime.Remoting
{
    ...
    public class SoapServices
    {
        ...
        private class XmlToFieldTypeMap
        {
            ...
            {
                _elements[CreateKey(xmlElement, xmlNamespace)] = new FieldEntry(
                    fieldType,
                    fieldName
                );
            }
            ...
            {
                _attributes[CreateKey(xmlAttribute, xmlNamespace)] = new FieldEntry(
                    fieldType,
                    fieldName
                );
            }
        ...
        )
        {
            ...
            if (map != null)
            {
                map.GetFieldTypeAndNameFromXmlAttribute(
                    xmlAttribute,
                    xmlNamespace,
                    out type,
                    out name
    ...
    internal static class XmlNamespaceEncoder
    {
        ...
        [System.Security.SecurityCritical] // auto-generated
        internal static String GetTypeNameForSoapActionNamespace(
            String uri,
            out bool assemblyIncluded
        )
        {
            ...
            {
                String assemName = ((RuntimeAssembly)typeof(String).Module.Assembly)
                    .GetSimpleName();
                assemblyIncluded = true;
