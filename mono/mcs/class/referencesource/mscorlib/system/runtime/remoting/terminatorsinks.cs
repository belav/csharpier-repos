...
*/
            ...
            if (null == id)
            {
                ...
                if (id == null)
                {
                    throw new ArgumentException(
                        Environment.GetResourceString("Remoting_ServerObjectNotFound", objURI)
                    );
                }
            }
        ...
        internal static ServerIdentity GetServerIdentity(IMessage reqMsg)
        {
            ...
            if (null == srvID)
            {
                ...
                Identity id = IdentityHolder.ResolveIdentity(objURI);
...
/* package scope */
    internal class ClientContextTerminatorSink : InternalSink, IMessageSink
    {
        ...
        public virtual IMessage SyncProcessMessage(IMessage reqMsg)
        {
            ...
            bool bHasDynamicSinks = ctx.NotifyDynamicSinks(
                reqMsg,
                true, // bCliSide
                true, // bStart
                false, // bAsync
    ...
    internal class ServerContextTerminatorSink : InternalSink, IMessageSink
    {
        ...
        public virtual IMessageCtrl AsyncProcessMessage(IMessage reqMsg, IMessageSink replySink)
        {
            ...
            else
            {
                ...
                msgCtrl = nextChain.AsyncProcessMessage(reqMsg, replySink);
            }
            return msgCtrl;
        }
