...
namespace System.Runtime.Remoting.Channels
{
            ...
            if ((null != url) && (data == null))
            {
                if (url.StartsWith(_channelName, StringComparison.Ordinal))
                {
                    throw new RemotingException(
                        Environment.GetResourceString("Remoting_AppDomains_NYI")
                    );
                }
            }
            else
    ...
    internal class CrossAppDomainSink : InternalSink, IMessageSink
    {
        ...
        [System.Security.SecurityCritical] // auto-generated
        internal static byte[] DoDispatch(
            byte[] reqStmBuff,
...
#if !FEATURE_CORECLR
                Message.DebugOut(
                    "#### : changed to Server Domain :: "
                        + (Thread.CurrentContext.InternalContextID).ToString("X")
                );
#endif
        ...
        public virtual IMessage SyncProcessMessage(IMessage reqMsg)
        {
            ...
            try
            {
                ...
                SmuggledMethodCallMessage smuggledMcm = SmuggledMethodCallMessage.SmuggleIfPossible(
                    reqMsg
                );
                ...
                try
                {
                    if (smuggledMcm != null)
                        ...
                        responseBytes = DoTransitionDispatch(
                            reqStm.GetBuffer(),
                            null,
                            out smuggledMrm
                        );
                ...
                else
                {
                    if (responseBytes != null)
                    {
                        ...
                        //*********************** DESERIALIZE RET-MSG **************
                        desRetMsg = CrossAppDomainSerializer.DeserializeMessage(
                            retStm,
        ...
        public virtual IMessageCtrl AsyncProcessMessage(IMessage reqMsg, IMessageSink replySink)
        {
            ...
            ADAsyncWorkItem workItem = new ADAsyncWorkItem(
                reqMsg,
