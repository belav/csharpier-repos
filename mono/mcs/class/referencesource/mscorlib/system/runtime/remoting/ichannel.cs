...
namespace System.Runtime.Remoting.Channels
{
    ...
    [System.Runtime.InteropServices.ComVisible(true)]
    public interface IClientFormatterSinkProvider : IClientChannelSinkProvider { } // interface IClientFormatterSinkProvider
    ...
    // one.
    [System.Runtime.InteropServices.ComVisible(true)]
    public interface IServerFormatterSinkProvider : IServerChannelSinkProvider { } // interface IServerFormatterSinkProvider
    ...
    [System.Runtime.InteropServices.ComVisible(true)]
    public interface IClientFormatterSink : IMessageSink, IClientChannelSink { } // interface IClientFormatterSink
            ...
            foreach (Object someKey in keySet)
            {
                if (keyStr != null)
                {
                    ...
                    if (someKeyStr != null)
                    {
                        ...
                        if (
                            String.Compare(keyStr, someKeyStr, StringComparison.OrdinalIgnoreCase)
                            == 0
                        )
                            return true;
