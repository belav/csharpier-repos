...
namespace System.Runtime.Remoting.Proxies
{
    ...
    internal class RemotingProxy : RealProxy, IRemotingTypeInfo
    {
        ...
        private static MethodInfo _getHashCodeMethod = typeof(System.Object).GetMethod(
            "GetHashCode"
        );

        private static RuntimeType s_typeofObject = (RuntimeType)typeof(System.Object);
        private static RuntimeType s_typeofMarshalByRefObject = (RuntimeType)
        ...
        )
        {
            ...
            if (bSkippingContextChain)
            {
                ...
                bHasDynamicSinks = currentContext.NotifyDynamicSinks(
                    reqMsg,
                    true, // bCliSide
                    true, // bStart
                    false, // bAsync
            ...
            else
            {
                ...
                if (!Initialized)
                {
                    ...
                    if (CtorThread == Thread.CurrentThread.GetHashCode())
                    {
                        ...
                        BCLDebug.Assert(
                            srvId != null && ((ServerIdentity)IdentityObject).ServerContext != null,
        ...
        )
        {
            ...
            {
                Message.DebugOut("RemotingProxy.Invoke: Calling AsyncDispatchMessage\n");

                BCLDebug.Assert(ar != null, "ar != null");
                BCLDebug.Assert((callType & Message.BeginAsync) != 0, "BeginAsync flag not set!");
        ...
        private static void Invoke(Object NotUsed, ref MessageData msgData)
        {
            ...
            if ((d = thisPtr as Delegate) != null)
            {
                ...
                RemotingProxy rp = (RemotingProxy)RemotingServices.GetRealProxy(d.Target);
                    ...
                    switch (callType)
                    {
                        ...
                        case Message.BeginAsync | Message.OneWay:
                            ...
                            ThreadPool.QueueUserWorkItem(
                                new WaitCallback(AgileAsyncWorkerItem.ThreadPoolCallBack),
                                workItem
                            );
        ...
        public bool CanCastTo(Type castType, Object o)
        {
            ...
            if ((rtType == s_typeofObject) || (rtType == s_typeofMarshalByRefObject))
            {
                return true;
            }
            ...
            if (null != oRef)
            {
                ...
                else
                {
                    if (oRef.IsObjRefLite())
                    {
                        ...
                        fCastOK = MarshalByRefObject.CanCastToXmlTypeHelper(
                            rtType,
        ...
        bool CanCastToWK(Type castType)
        {
            ...
            else
            {
                ...
                {
                    BCLDebug.Assert(IdentityObject.URI != null, "Bad WellKnown ID");
