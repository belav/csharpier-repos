...
namespace System.Runtime.Remoting.Channels
{
    ...
    internal class CrossContextChannel : InternalSink, IMessageSink
    {
        ...
        private static InternalCrossContextDelegate s_xctxDel = new InternalCrossContextDelegate(
        ...
        internal static Object AsyncProcessMessageCallback(Object[] args)
        {
            ...
            msgCtrl = srvCtx
                ...
                .AsyncProcessMessage(reqMsg, (IMessageSink)workItem);
            ...
            else
            {
                ...
                if (srvCtx.IsThreadPoolAware)
                {
                    ...
                    msgCtrl = (IMessageCtrl)
                        Thread.CurrentThread.InternalCrossContextCallback(srvCtx, xctxDel, args);
                }
                else
                {
                    AsyncWorkItem workItem = null;
    ...
    internal class AsyncWorkItem : IMessageSink
    {
        ...
        public virtual IMessage SyncProcessMessage(IMessage msg)
        {
            ...
            if (_replySink != null)
            {
                ...
                BCLDebug.Assert(
                    (_srvID == null) || (_srvID.ServerContext == Thread.CurrentContext),
        ...
        internal static Object FinishAsyncWorkCallback(Object[] args)
        {
            ...
            IMessageCtrl ctrl = srvCtx
                .GetServerContextChain()
                .AsyncProcessMessage(This._reqMsg, (IMessageSink)This);
