...
namespace System.Runtime.Remoting.Contexts
{
            ...
            IContributeClientContextSink
    {
        ...
        internal String SyncCallOutLCID
        {
            get
            {
                Contract.Assert(!_bReEntrant, "Should not use this for the reentrant case");
        ...
        */
        ...
        public override bool IsContextOK(Context ctx, IConstructionCallMessage msg)
        {
            ...
            {
                SynchronizationAttribute syncProp = (SynchronizationAttribute)
                    ctx.GetProperty(PROPERTY_NAME);
                if (
                    ((_flavor == NOT_SUPPORTED) && (syncProp != null))
        ...
        internal virtual void InitIfNecessary()
        {
            lock (this)
            {
                if (_asyncWorkEvent == null)
                {
                    ...
                    WaitOrTimerCallback callBackDelegate = new WaitOrTimerCallback(
                        this.DispatcherCallBack
                    );
        ...
        */
        ...
        public virtual IMessageSink GetServerContextSink(IMessageSink nextSink)
        {
            ...
            SynchronizedServerContextSink propertySink = new SynchronizedServerContextSink(
                this,
                nextSink
            );
        ...
        */
        ...
        public virtual IMessageSink GetClientContextSink(IMessageSink nextSink)
        {
            ...
            SynchronizedClientContextSink propertySink = new SynchronizedClientContextSink(
                this,
                nextSink
            );
    ...
    */
    internal class WorkItem
    {
        ...
        internal static InternalCrossContextDelegate _xctxDel = new InternalCrossContextDelegate(
            ExecuteCallback
        );
        ...
        */
        ...
        public virtual IMessage SyncProcessMessage(IMessage reqMsg)
        {
            ...
            else
            {
                ...
                LogicalCallContext cctx = (LogicalCallContext)
                    reqMsg.Properties[Message.CallContextKey];
                ...
                Contract.Assert(
                    lcid.Equals(_property.SyncCallOutLCID),
                ...
                if (bTopLevel)
                {
                    ...
                    if (bClear)
                    {
                        ...
                        // the proxy.
                        LogicalCallContext cctxRet = (LogicalCallContext)
                            replyMsg.Properties[Message.CallContextKey];
                        Contract.Assert(cctxRet != null, "CallContext should be non-null");
