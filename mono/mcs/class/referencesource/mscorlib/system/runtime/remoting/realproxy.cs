...
namespace System.Runtime.Remoting.Proxies
{
    ...
    public abstract class RealProxy
    {
        ...
        public IConstructionReturnMessage InitializeServerObject(IConstructionCallMessage ctorMsg)
        {
            ...
            if (_serverObject == null)
            {
                ...
                if (null == e)
                {
                    ...
                    retMsg = new ConstructorReturnMessage(
                        proxy,
                        outArgs,
                        outLength,
                        callCtx,
        ...
        internal void AttachServerHelper(MarshalByRefObject s)
        {
            ...
            {
                throw new ArgumentException(
                    Environment.GetResourceString("ArgumentNull_Generic"),
                    "s"
                );
            }
            _serverObject = s;
        ...
        )
        {
            ...
            RemotingMethodCachedData cache = InternalRemotingServices.GetReflectionCachedData(mb);
        ...
        internal static IMessage EndInvokeHelper(Message reqMsg, bool bProxyCase)
        {
            ...
            {
                throw new RemotingException(
                    Environment.GetResourceString("Remoting_Message_BadAsyncResult")
                );
            }
            if (ar.AsyncDelegate != reqMsg.GetThisPtr())
            {
                throw new InvalidOperationException(
                    Environment.GetResourceString("InvalidOperation_MismatchedAsyncResult")
                );
            }
            if (!ar.IsCompleted)
            {
            ...
            lock (ar)
            {
                if (ar.EndInvokeCalled)
                    throw new InvalidOperationException(
                        Environment.GetResourceString("InvalidOperation_EndInvokeCalledMultiple")
                    );

                ar.EndInvokeCalled = true;

                IMethodReturnMessage mrm = (IMethodReturnMessage)ar.GetReplyMessage();
                ...
                if (!bProxyCase)
                {
                    ...
                    {
                        reqMsg.PropagateOutParameters(mrm.Args, mrm.ReturnValue);
                    }
                }
                else
                {
        ...
        private void PrivateInvoke(ref MessageData msgData, int type)
        {
            ...
            else if (CallType.ConstructorCall == (CallType)callType)
            {
                ...
                if (!IsRemotingProxy())
                {
                    ...
                    ctorMsg = new ConstructorCallMessage(
                        null,
                        null,
                        null,
                        (RuntimeType)GetProxiedType()
                    );
                }
                else
                {
                ...
                if ((null == ctorMsg) || bIsWellKnown)
                {
                    ...
                    if (bIsWellKnown)
                    {
                        ...
                        {
                            throw new RemotingException(
                                Environment.GetResourceString("Remoting_Activation_WellKnownCTOR")
                            );
                        }
                    }
            ...
            if (!IsRemotingProxy() && ((msgFlags & Message.EndAsync) == Message.EndAsync))
            {
            ...
            if (CallType.ConstructorCall == callType)
            {
                ...
                {
                    throw new RemotingException(
                        Environment.GetResourceString("Remoting_Activation_InconsistentState")
                    );
                }
        ...
        void SetCallContextInMessage(IMessage reqMsg, int msgFlags, LogicalCallContext cctx)
        {
        ...
        [System.Security.SecurityCritical] // auto-generated
        void ReturnCallContextToThread(
