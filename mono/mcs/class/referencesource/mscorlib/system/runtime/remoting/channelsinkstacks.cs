...
namespace System.Runtime.Remoting.Channels
{
    ...
    public class ClientChannelSinkStack : IClientChannelSinkStack
    {
        ...
        public void AsyncProcessResponse(ITransportHeaders headers, Stream stream)
        {
            ...
            if (_replySink != null)
            {
                ...
                {
                    throw new RemotingException(
                        Environment.GetResourceString("Remoting_Channel_CantCallAPRWhenStackEmpty")
                    );
                }
    ...
    public class ServerChannelSinkStack : IServerChannelSinkStack
    {
        ...
        public void Store(IServerChannelSink sink, Object state)
        {
            ...
            {
                throw new RemotingException(
                    Environment.GetResourceString("Remoting_Channel_StoreOnEmptySinkStack")
                );
            }
        ...
        private void FlipRememberedStack()
        {
            if (_stack != null)
                throw new RemotingException(
                    Environment.GetResourceString("Remoting_Channel_CantCallFRSWhenStackEmtpy")
                );
    ...
    {
        internal static void GetOutArgs(
            ParameterInfo[] syncParams,
            Object[] syncArgs,
            Object[] endArgs
        )
        {
