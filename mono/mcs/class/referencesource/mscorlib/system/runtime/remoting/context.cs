    ...
    public class Context
    {
        ...
        public virtual void Freeze()
        {
            lock (this)
            {
                ...
                {
                    throw new InvalidOperationException(
                        Environment.GetResourceString("InvalidOperation_ContextAlreadyFrozen")
                    );
                }
                InternalFreeze();
            }
        ...
        [System.Security.SecurityCritical] // auto-generated
        internal static void CheckPropertyNameClash(
            String name,
            IContextProperty[] props,
            int count
        )
        {
            for (int i = 0; i < count; i++)
            {
                ...
                {
                    throw new InvalidOperationException(
                        Environment.GetResourceString("InvalidOperation_DuplicatePropertyName")
                    );
                }
            }
        }
                    ...
                    if (null != sink)
                    {
                        ...
                        if (newServerContextChain == null)
                        {
                            throw new RemotingException(
                                Environment.GetResourceString("Remoting_Contexts_BadProperty")
                            );
                        }
                    }
                }
        ...
        internal virtual IMessageSink GetClientContextChain()
        {
            ...
            {
                Message.DebugOut(
                    "Context::GetClientContextChain: _clientContextChain == null, creating chain"
                        + Environment.NewLine
                );
                // a bare chain would have just this one sink.
        ...
        {
            Contract.Assert(
                (msg is IConstructionCallMessage) || (msg is IConstructionReturnMessage),
            ...
            Contract.Assert(
                (_ctxFlags & CTX_FROZEN) == CTX_FROZEN,
                    ...
                    if (null != activator)
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                // <
                                activator.DeliverServerContextToClientContext(
        ...
        public void DoCallBack(CrossContextDelegate deleg)
        {
            ...
            {
                throw new RemotingException(
                    Environment.GetResourceString("Remoting_Contexts_ContextNotFrozenForCallBack")
                );
            }
        ...
        )
        {
            ...
            else
            {
                ...
                TransitionCall msgCall = new TransitionCall(
                    targetCtxID,
                    privateData,
                    targetDomainID
                );
                ...
                IMessage retMsg = Thread.CurrentContext
        ...
        )
        {
            ...
            if (obj != null && ctx != null)
            {
                ...
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_NonNullObjAndCtx")
                );
            }
            if (obj != null)
            {
        ...
        {
            [System.Security.SecurityCritical] // auto-generated
            get { return _dphGlobal.DynamicSinks; }
        }
