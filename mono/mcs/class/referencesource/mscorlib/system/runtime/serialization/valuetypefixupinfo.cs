        ...
        public ValueTypeFixupInfo(long containerID, FieldInfo member, int[] parentIndex)
        {
            ...
            if (member == null && parentIndex == null)
            {
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_MustSupplyParent")
                );
            }
            ...
            BCLDebug.Trace(
                "SER",
                "[ValueTypeFixupInfo.ctor]Creating a VTFI with Container ID: ",
                containerID,
                " and MemberInfo ",
                member
            );
            ...
            if (member != null)
            {
                ...
                {
                    throw new ArgumentException(
                        Environment.GetResourceString("Argument_MemberAndArray")
                    );
                }
                ...
                {
                    throw new ArgumentException(
                        Environment.GetResourceString("Argument_MustSupplyContainer")
                    );
                }
            }
