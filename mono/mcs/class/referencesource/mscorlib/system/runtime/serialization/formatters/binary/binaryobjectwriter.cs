...
namespace System.Runtime.Serialization.Formatters.Binary
{
    ...
    internal sealed class ObjectWriter
    {
        ...
        )
        {
            ...
            SerTrace.InfoLog(
                formatterEnums.FEtypeFormat + " " + ((Enum)formatterEnums.FEserializerTypeEnum)
            );
        }
        ...
        )
        {
            if (graph == null)
                throw new ArgumentNullException(
                    "graph",
                    Environment.GetResourceString("ArgumentNull_Graph")
                );

            if (serWriter == null)
                throw new ArgumentNullException(
                    "serWriter",
                    Environment.GetResourceString("ArgumentNull_WithParamName", "serWriter")
                );
            ...
            SerTrace.Log(
                ...
                "Serialize Entry 2 ",
                graph,
                ((headers == null) ? " no headers " : "headers ")
            );
#if !MONO
            if (fCheck)
            {
            ...
            while ((obj = GetNext(out objectId)) != null)
            {
                ...
                {
                    objectInfo = WriteObjectInfo.Serialize(
                        obj,
                        m_surrogates,
                        m_context,
                        serObjectInfoInit,
        ...
        private Object[] WriteMethodCall(IMethodCallMessage mcm)
        {
            ...
            return serWriter.WriteCallArray(
                uri,
                methodName,
                typeName,
                instArgs,
        ...
        private Object[] WriteMethodReturn(IMethodReturnMessage mrm)
        {
            ...
            return serWriter.WriteReturnArray(
                returnValue,
                args,
                exception,
                callContext,
        ...
        )
        {
            SerTrace.Log(
                this,
                "WriteMembers Entry memberType: ",
                memberTypeNameInfo.NIname,
                " memberName: ",
                memberNameInfo.NIname,
                " data: ",
                memberData,
            ...
            if (Object.ReferenceEquals(memberType, Converter.typeofObject))
            {
                ...
                SerTrace.Log(
                    this,
                    "WriteMembers memberType Object, actual memberType ",
                    memberType
                );
            }
            ...
            if (!WriteKnownValueClass(memberNameInfo, memberTypeNameInfo, memberData))
            {
                ...
                */
#endif
                {
                    ...
                    if ((object)outType == null)
                        outType = GetType(outObj);
                    long memberObjectId = Schedule(
                        outObj,
                        assignUniqueIdToValueType,
                        outType,
                        memberObjectInfo
                    );
                    if (memberObjectId < 0)
        ...
        )
        {
            ...
            {
                arrayElemObjectInfo = WriteObjectInfo.Serialize(
                    arrayElemType,
                    m_surrogates,
                    m_context,
                    serObjectInfoInit,
            ...
            // Byte array
            if (
                (Object.ReferenceEquals(arrayElemType, Converter.typeofByte))
                && (rank == 1)
                && (lowerBoundA[0] == 0)
            )
            {
                serWriter.WriteObjectByteArray(
                    memberNameInfo,
                    arrayNameInfo,
                    arrayElemObjectInfo,
            ...
            if (
                Object.ReferenceEquals(arrayElemType, Converter.typeofObject)
            ...
            if (arrayEnum == InternalArrayTypeE.Single)
            {
                ...
                if (
                    !(
                        Converter.IsWriteAsByteArray(arrayElemTypeNameInfo.NIprimitiveTypeEnum)
                        && (lowerBoundA[0] == 0)
                    )
                )
                {
        ...
        )
        {
            ...
            if (!WriteKnownValueClass(arrayElemTypeNameInfo, actualTypeInfo, data))
            {
                ...
                if (arrayId < 1)
                {
                    WriteObjectInfo newObjectInfo = WriteObjectInfo.Serialize(
                        obj,
                        m_surrogates,
                        m_context,
                        serObjectInfoInit,
        ...
        private Object GetNext(out long objID)
        {
            ...
            if (isNew)
            {
                ...
                throw new SerializationException(
                    Environment.GetResourceString("Serialization_ObjNoID", realObj)
                );
            }
        ...
        )
        {
            ...
            SerTrace.Log(
                this,
                "CheckForNull Entry data ",
                Util.PString(data),
                ", memberType ",
                Util.PString(typeNameInfo.NItype)
            );
#endif
            bool isNull = false;
        ...
        {
            return TypeToNameInfo(
                objectInfo.objectType,
                objectInfo,
                ToCode(objectInfo.objectType),
                null
            );
        }
        ...
        private long GetAssemblyId(WriteObjectInfo objectInfo)
        {
            ...
            else
            {
                ...
                {
                    assemId = InternalGetId(
                        "___AssemblyString___" + assemblyString,
                        false,
                        null,
                        out isNew
                    );
                ...
                serWriter.WriteAssembly(
                    objectInfo.objectType,
                    serializedAssemblyString,
                    (int)assemId,
                    isNew
                );
            }
