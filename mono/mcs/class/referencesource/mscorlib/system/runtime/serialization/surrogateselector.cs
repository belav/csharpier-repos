        ...
        public virtual void ChainSelector(ISurrogateSelector selector)
        {
            ...
            if (selector == this)
            {
                throw new SerializationException(
                    Environment.GetResourceString("Serialization_DuplicateSelector")
                );
            }
            ...
            if (!HasCycle(selector))
            {
                throw new ArgumentException(
                    Environment.GetResourceString("Serialization_SurrogateCycleInArgument"),
                    "selector"
                );
            }
            ...
            {
                throw new ArgumentException(
                    Environment.GetResourceString("Serialization_SurrogateCycle"),
                    "selector"
                );
            }
    ...
    class SurrogateHashtable : Hashtable
    {
        ...
        protected override bool KeyEquals(Object key, Object item)
        {
            ...
            return presentValue.m_type == givenValue.m_type
                && (presentValue.m_context.m_state & givenValue.m_context.m_state)
                    == givenValue.m_context.m_state
