    ...
    public static class FormatterServices
    {
                ...
                if (parentTypeCount > 0)
                {
                    ...
                    for (int i = 0; i < parentTypeCount; i++)
                    {
                        ...
                        foreach (FieldInfo field in typeFields)
                        {
                            ...
                            {
                                allMembers.Add(
                                    new SerializationFieldInfo((RuntimeFieldInfo)field, typeName)
                                );
                            }
                        }
                    }
        ...
        )
        {
            ...
            for (RuntimeType t1 = parentType; t1 != objectType; t1 = (RuntimeType)t1.BaseType)
            {
                ...
                {
                    RuntimeType[] tempParentTypes = new RuntimeType[
        ...
        public static MemberInfo[] GetSerializableMembers(Type type, StreamingContext context)
        {
            ...
            {
                throw new SerializationException(
                    Environment.GetResourceString("Serialization_InvalidType", type.ToString())
                );
            }
                ...
                for (int i = 0; i < advancedTypes.Length; i++)
                {
                    if (advancedTypes[i].IsAssignableFrom(t))
                        throw new SecurityException(
                            Environment.GetResourceString(
                                "Serialization_TypeSecurity",
                                advancedTypes[i].FullName,
                                t.FullName
                            )
                        );
                }
        ...
        public static Object GetSafeUninitializedObject(Type type)
        {
            ...
            if (
                Object.ReferenceEquals(
                    type,
                    typeof(System.Runtime.Remoting.Messaging.ConstructionCall)
                )
                || Object.ReferenceEquals(
                    type,
                ...
                || Object.ReferenceEquals(
                    type,
                    typeof(System.Runtime.Remoting.Contexts.SynchronizationAttribute)
                )
            )
                return nativeGetUninitializedObject((RuntimeType)type);
#endif
            ...
            {
                throw new SerializationException(
                    Environment.GetResourceString("Serialization_Security", type.FullName),
                    e
                );
            }
        }
        ...
        public static Object PopulateObjectMembers(Object obj, MemberInfo[] members, Object[] data)
        {
            ...
            if (members.Length != data.Length)
            {
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_DataLengthDifferent")
                );
            }
            Contract.EndContractBlock();
            ...
            for (int i = 0; i < members.Length; i++)
            {
                ...
                if (mi == null)
                {
                    throw new ArgumentNullException(
                        "members",
                        Environment.GetResourceString("ArgumentNull_NullMember", i)
                    );
                }
        ...
        public static Object[] GetObjectData(Object obj, MemberInfo[] members)
        {
            ...
            for (int i = 0; i < numberOfMembers; i++)
            {
                ...
                {
                    Contract.Assert(
                        mi is RuntimeFieldInfo || mi is SerializationFieldInfo,
        ...
        static string GetClrTypeFullNameForArray(Type type)
        {
            ...
            if (rank == 1)
            {
                return String.Format(
                    ...
                    "{0}{1}",
                    GetClrTypeFullName(type.GetElementType()),
                    "[]"
                );
            }
            else
