...
namespace System.Runtime.Serialization
{
    ...
    public class ObjectManager
    {
        ...
        **            not null.
        ...
        private void AddObjectHolder(ObjectHolder holder)
        {
            ...
            BCLDebug.Trace(
                "SER",
                "[AddObjectHolder]Adding ObjectHolder with id: ",
                holder.m_id,
                " Current Bins: ",
                m_objects.Length
            );
            ...
            if (holder.m_id >= m_objects.Length && m_objects.Length != MaxArraySize)
            {
                ...
                BCLDebug.Trace(
                    "SER",
                    "[AddObjectHolder]Reallocating m_objects to have ",
                    newSize,
                    " bins"
                );
        ...
        )
        {
            ...
            BCLDebug.Trace(
                "SER",
                "[ObjectManager.GetCompletionInfo]Getting fixup info for: ",
                fixup.m_id
            );
            ...
            if (!holder.CompletelyFixed)
            {
                if (holder.ObjectValue != null && holder.ObjectValue is ValueType)
                {
                    BCLDebug.Trace(
                        "SER",
                        "[ObjectManager.GetCompletionInfo]ValueType implementing ISerializable.  Delaying fixup."
                    );
            ...
            if (holder == null || holder.CanObjectValueChange || holder.ObjectValue == null)
            {
                if (bThrowIfMissing)
                {
                    BCLDebug.Trace(
                        "SER",
                        "[GetCompletionInfo]Unable to find fixup for: ",
                        fixup.m_id
                    );
                    BCLDebug.Trace(
                        "SER",
                        "[GetCompletionInfo]Holder: ",
                        ((holder == null) ? "<null>" : "Non Null")
                    );
                    BCLDebug.Trace(
                        "SER",
                        "[GetCompletionInfo]IsIncomplete: ",
                        (holder.IsIncompleteObjectReference)
                    );
                    BCLDebug.Trace(
                        "SER",
                        "[GetCompletionInfo]Object: ",
                        ((holder.ObjectValue == null) ? "<null>" : "Non Null")
                    );
                    if (holder == null)
                    {
                        throw new SerializationException(
                            Environment.GetResourceString("Serialization_NeverSeen", fixup.m_id)
                        );
                    }
                    if (holder.IsIncompleteObjectReference)
                    {
                        throw new SerializationException(
                            Environment.GetResourceString("Serialization_IORIncomplete", fixup.m_id)
                        );
                    }
                    throw new SerializationException(
                        Environment.GetResourceString("Serialization_ObjectNotSupplied", fixup.m_id)
                    );
                }
                return false;
            }
        ...
        private void FixupSpecialObject(ObjectHolder holder)
        {
            ...
            if (holder.HasSurrogate)
            {
                ...
                object returnValue = surrogate.SetObjectData(
                    holder.ObjectValue,
                    holder.SerializationInfo,
                    m_context,
                    uselessSelector
                );
                if (returnValue != null)
                        ...
                        throw new SerializationException(
                            String.Format(
                                ...
                                Environment.GetResourceString(
                                    "Serialization_NotCyclicallyReferenceableSurrogate"
                                ),
            ...
            else
            {
                //Set the object data
                Contract.Assert(
                    holder.ObjectValue is ISerializable,
                    "holder.m_object is ISerializable"
                );
                BCLDebug.Trace(
                    "SER",
                    "[ObjectManager.FixupSpecialObject]Fixing up ISerializable object ",
                    holder.ObjectValue,
                    " with id ",
                    holder.m_id
                );
        ...
        private bool ResolveObjectReference(ObjectHolder holder)
        {
            ...
            try
            {
                do
                {
                    ...
                    BCLDebug.Trace(
                        "SER",
                        "[ResolveObjectReference]HasISerializable: ",
                        holder.HasISerializable
                    );
                    holder.SetObjectValue(
                        ((IObjectReference)(holder.ObjectValue)).GetRealObject(m_context),
                        this
                    );
                    ...
                    if (holder.ObjectValue == null)
                    {
                        ...
                        BCLDebug.Trace(
                            ...
                            "Object: ",
                            holder.m_id,
                            " did NOT have enough information to resolve the IObjectReference."
                        );
                        return false;
                    }
                    ...
                    {
                        throw new SerializationException(
                            Environment.GetResourceString("Serialization_TooManyReferences")
                        );
                    }
                } while (
                    (holder.ObjectValue is IObjectReference) && (tempObject != holder.ObjectValue)
                );
            }
            catch (NullReferenceException)
            {
                BCLDebug.Trace(
                    "SER",
                    "[ResolveObjectReference]Caught exception trying to call GetRealObject."
                );
                return false;
            }
        ...
        **Exceptions:
        ...
        private bool DoValueTypeFixup(FieldInfo memberToFix, ObjectHolder holder, Object value)
        {
            ...
            while (holder.RequiresValueTypeFixup)
            {
                BCLDebug.Trace(
                    "SER",
                    "[DoValueTypeFixup] valueType fixsite = ",
                    holder.ObjectValue,
                    " fixobj=",
                    value
                );
                ...
                if (currFixup.ParentField != null)
                {
                    ...
                    {
                        fieldsTemp[currentFieldIndex] = parentField.FieldType.GetField(
                            "value",
        ...
        void DumpValueTypeFixup(
            object obj,
            FieldInfo[] intermediateFields,
            FieldInfo memberToFix,
            object value
        )
        {
        ...
        **Exceptions:
        ...
        internal void CompleteObject(ObjectHolder holder, bool bObjectFullyComplete)
        {
            ...
            {
                throw new SerializationException(
                    Environment.GetResourceString("Serialization_MissingObject", holder.m_id)
                );
            }
            ...
            if (holder.HasSurrogate || holder.HasISerializable)
            {
                ...
                {
                    throw new SerializationException(
                        Environment.GetResourceString("Serialization_InvalidFixupDiscovered")
                    );
                }

                BCLDebug.Trace(
                    "SER",
                    "[ObjectManager.CompleteObject]Complete object ",
                    holder.m_id,
                    " of SI Type: ",
                    si.FullTypeName
                );
                ...
                if (fixups != null)
                {
                    for (int i = 0; i < fixups.m_count; i++)
                    {
                        ...
                        )
                        {
                            ...
                            BCLDebug.Trace(
                                "SER",
                                "[ObjectManager.CompleteObject]Updating object ",
                                holder.m_id,
                                " with object ",
                                tempObjectHolder.m_id
                            );
            ...
            else
            {
                BCLDebug.Trace(
                    "SER",
                    "[ObjectManager.CompleteObject]Non-ISerializableObject: ",
                    holder.m_id
                );
                for (int i = 0; i < fixups.m_count; i++)
                {
                    ...
                    BCLDebug.Trace(
                        "SER",
                        "[ObjectManager.CompleteObject]Getting fixup info for object: ",
                        currentFixup.m_id
                    );
                    if (
                        GetCompletionInfo(
                    ...
                    )
                    {
                        BCLDebug.Trace(
                            "SER",
                            "[ObjectManager.CompleteObject]Fixing up: ",
                            currentFixup.m_id
                        );
                        ...
                        switch (currentFixup.m_fixupType)
                        {
                            ...
                            case FixupHolder.MemberFixup:
                                ...
                                if (tempMember.MemberType == MemberTypes.Field)
                                {
                                    BCLDebug.Trace(
                                        "SER",
                                        "[ObjectManager.CompleteObject]Fixing member: ",
                                        tempMember.Name,
                                        " in object ",
                                        holder.m_id,
                                        " with object ",
                                ...
                                {
                                    throw new SerializationException(
                                        Environment.GetResourceString("Serialization_UnableToFixup")
                                    );
                                }
                                break;
                            default:
        ...
        **Exceptions: None.
        ...
        private void DoNewlyRegisteredObjectFixups(ObjectHolder holder)
        {
            ...
            if (holder.CanObjectValueChange)
            {
                BCLDebug.Trace(
                    "SER",
                    "[ObjectManager.DoNewlyRegisteredObjectFixups]Object is an Incomplete Object Reference.  Exiting."
                );
                return;
            }
            ...
            BCLDebug.Trace(
                "SER",
                "[ObjectManager.DoNewlyRegisteredObjectFixups]Object has ",
                dependencies.Count,
                " fixups registered"
            );
            ...
            while (dependencies.MoveNext())
            {
                ...
                BCLDebug.Trace(
                    "SER",
                    "[ObjectManager.DoNewlyRegisteredObjectFixups]Doing a fixup on object: ",
                    temp.m_id
                );
                Contract.Assert(
                    temp.DirectlyDependentObjects > 0,
                ...
                if (((temp.DirectlyDependentObjects)) == 0)
                {
                    BCLDebug.Trace(
                        "SER",
                        "[DoNewlyRegisteredObjectFixups]Doing fixup for object ",
                        temp.m_id
                    );
                    BCLDebug.Trace(
                        "SER",
                        "[DoNewlyRegisteredObjectFixups]ObjectValue ",
                        ((temp.ObjectValue == null) ? "<null>" : temp.ObjectValue)
                    );
        ...
        public virtual Object GetObject(long objectID)
        {
            if (objectID <= 0)
            {
                throw new ArgumentOutOfRangeException(
                    "objectID",
                    Environment.GetResourceString("ArgumentOutOfRange_ObjectID")
                );
            }
            ...
            BCLDebug.Trace(
                "SER",
                "GetObject. holder contains: ",
                ((holder.ObjectValue == null) ? "<null>" : holder.ObjectValue)
            );
        ...
        )
        {
            ...
            Contract.Assert(
                (FindObjectHolder(objectID) == null),
                "RegisterString - FindObjectHolder(objectID) == null"
            );

            temp = new ObjectHolder(
                obj,
                objectID,
                info,
                null,
        ...
        )
        {
            ...
            if (
                member != null
                && !(member is RuntimeFieldInfo)
                && !(member is SerializationFieldInfo)
            )
            {
                throw new SerializationException(
                    Environment.GetResourceString("Serialization_UnknownMemberInfo")
                );
            }
            ...
            if (m_selector != null)
            {
                ...
                BCLDebug.Trace(
                    "SER",
                    "[ObjectManager.RegisterObject]ID: ",
                    objectID,
                    "\tType: ",
                    selectorType,
                    "\tValue: ",
            ...
            if (obj is IDeserializationCallback)
            {
                DeserializationEventHandler d = new DeserializationEventHandler(
                    ((IDeserializationCallback)obj).OnDeserialization
                );
            ...
            if (temp == null)
            {
                BCLDebug.Trace(
                    "SER",
                    "[ObjectManager.RegisterObject]Adding a new object holder for ",
                    objectID,
                    "\tValueType: ",
                    obj.GetType()
                );
            ...
            {
                throw new SerializationException(
                    Environment.GetResourceString("Serialization_RegisterTwice")
                );
            }
            ...
            if (temp.RequiresDelayedFixup)
            {
                BCLDebug.Trace(
                    "SER",
                    "[ObjectManager.RegisterObject]Tracking incomplete objref for element: ",
                    temp.m_id
                );
                SpecialFixupObjects.Add(temp);
            }
            ...
            if (temp.CompletelyFixed)
            {
                ...
                BCLDebug.Trace(
                    "SER",
                    "[ObjectManager.RegisterObject]Calling DoNewlyRegisteredObjectFixups for element: ",
                    temp.m_id
                );
        ...
        **            ArgumentException if obj does not implement ISerializable.
        ...
        )
        {
            ...
            catch (Exception e)
            {
                BCLDebug.Trace(
                    "SER",
                    "[CompleteISerializableObject]Unable to get constructor for: ",
                    t
                );
                BCLDebug.Trace("SER", "[CompleteISerializableObject]Stack trace was: ", e);
                throw new SerializationException(
                    Environment.GetResourceString("Serialization_ConstructorNotFound", t),
                    e
                );
            }
        ...
        **Exceptions:
        ...
        internal static RuntimeConstructorInfo GetConstructor(RuntimeType t)
        {
            ...
            if (ci == null)
                throw new SerializationException(
                    Environment.GetResourceString("Serialization_ConstructorNotFound", t.FullName)
                );
        ...
        public virtual void DoFixups()
        {
            ...
            while (fixupCount != 0)
            {
                ...
                ObjectHolderListEnumerator fixupObjectsEnum =
                    SpecialFixupObjects.GetFixupEnumerator();
                while (fixupObjectsEnum.MoveNext())
                {
                    ...
                    if (temp.ObjectValue == null)
                    {
                        BCLDebug.Trace(
                            "SER",
                            "[ObjectManager.DoFixups]Object with id: ",
                            temp.m_id,
                            " not found."
                        );
                        throw new SerializationException(
                    ...
                    BCLDebug.Trace(
                        "SER",
                        "[ObjectManager.DoFixups]Looking at object with id: ",
                        temp.m_id,
                        " which has ",
                        temp.TotalDependentObjects,
                        " Total Dependent Fixups, but only ",
                        (temp.DependentObjects == null) ? 0 : temp.DependentObjects.Count,
                        " directly dependent objects. Has it been fixed? ",
                        temp.CompletelyFixed
                    );
                    if (temp.TotalDependentObjects == 0)
                    {
            ...
            if (m_fixupCount == 0)
            {
                ...
                if (TopObject is TypeLoadExceptionHolder)
                    throw new SerializationException(
                        Environment.GetResourceString(
                            "Serialization_TypeLoadFailure",
                            ((TypeLoadExceptionHolder)TopObject).TypeName
                        )
                    );
                return;
            }
            ...
            BCLDebug.Trace(
                "SER",
                "[ObjectManager.DoFixups]Remaining object length is: ",
                m_objects.Length
            );
            for (int i = 0; i < m_objects.Length; i++)
            {
                ...
                while (temp != null)
                {
                    ...
                    )
                    {
                        BCLDebug.Trace(
                            "SER",
                            "[ObjectManager.DoFixups]Doing a delayed fixup on object ",
                            temp.m_id
                        );
                        CompleteObject(temp, true);
                    }
            ...
            throw new SerializationException(
                Environment.GetResourceString("Serialization_IncorrectNumberOfFixups")
            );
        }
        ...
        **Exceptions: None.  This is internal-only, so all checking should have been done by this time.
        ...
        private void RegisterFixup(FixupHolder fixup, long objectToBeFixed, long objectRequired)
        {
            ...
            {
                throw new SerializationException(
                    Environment.GetResourceString("Serialization_InvalidFixupType")
                );
            }
        ...
        )
        {
            ...
            {
                throw new ArgumentOutOfRangeException(
                    ((objectToBeFixed <= 0) ? "objectToBeFixed" : "objectRequired"),
        ...
        **Exceptions:
        ...
        )
        {
            ...
            BCLDebug.Trace(
                "SER",
                "RecordDelayedFixup.  ObjectToBeFixed: ",
                objectToBeFixed,
                "\tMember: ",
                memberName,
                "\tRequiredObject: ",
            ...
            //Create a new fixup holder
            FixupHolder fixup = new FixupHolder(
                objectRequired,
                memberName,
                FixupHolder.DelayedFixup
            );
        ...
        **Exceptions:
        ...
        )
        {
            ...
            BCLDebug.Trace(
                "SER",
                "RecordArrayElementFixup.  ObjectToBeFixed: ",
                arrayToBeFixed,
                "\tIndex: ",
                index,
                "\tRequiredObject: ",
        ...
        )
        {
            ...
            {
                throw new ArgumentOutOfRangeException(
                    ((arrayToBeFixed <= 0) ? "objectToBeFixed" : "objectRequired"),
                    Environment.GetResourceString("Serialization_IdTooSmall")
                );
            }
            ...
            BCLDebug.Trace(
                "SER",
                "RecordArrayElementFixup.  ArrayToBeFixed: ",
                arrayToBeFixed,
                "\tRequiredObject: ",
                objectRequired
            );
        ...
        **Exceptions: None
        ...
        internal virtual void AddOnDeserialization(DeserializationEventHandler handler)
        {
            m_onDeserializationHandler = (DeserializationEventHandler)
                Delegate.Combine(m_onDeserializationHandler, handler);
        }

        internal virtual void RemoveOnDeserialization(DeserializationEventHandler handler)
        {
            m_onDeserializationHandler = (DeserializationEventHandler)
                Delegate.Remove(m_onDeserializationHandler, handler);
        }
    ...
    internal sealed class ObjectHolder
    {
        ...
        internal const int REQUIRES_DELAYED_FIXUP =
            HAS_ISERIALIZABLE | HAS_SURROGATE | INCOMPLETE_OBJECT_REFERENCE;
        ...
        )
        {
            ...
            )
            {
                ...
                {
                    throw new SerializationException(
                        Environment.GetResourceString("Serialization_ParentChildIdentical")
                    );
                }
        ...
        **Exceptions: None.  Asserts only.
        ...
        private void UpdateDescendentDependencyChain(int amount, ObjectManager manager)
        {
            ...
            do
            {
                ...
                BCLDebug.Trace(
                    "SER",
                    "[ObjectManager.UpdateDescendentDependencyChain]Looking for holder with id: ",
                    holder.ContainerID
                );
                Contract.Assert(
                    holder != null,
        ...
        **Exceptions: None
        ...
        internal bool IsIncompleteObjectReference
        {
            get
            {
                return (
                        m_flags
                        & (
                            INCOMPLETE_OBJECT_REFERENCE /*| HAS_SURROGATE*/
                        )
                    ) != 0;
            }
            set
        ...
        internal bool ValueTypeFixupPerformed
        {
            get
            {
                BCLDebug.Trace(
                    "SER",
                    "[ObjectManager.ValueTypeFixupPerformed]Flags: ",
                    m_flags & VALUETYPE_FIXUP_PERFORMED
                );
                BCLDebug.Trace(
                    "SER",
                    "[ObjectManager.ValueTypeFixupPerformed]DependentObjects: ",
                    (m_dependentObjects == null) ? "<null>" : m_dependentObjects.Count.ToString()
                );
                return (
                    ((m_flags & VALUETYPE_FIXUP_PERFORMED) != 0)
                    || (
                        m_object != null
                        && ((m_dependentObjects == null) || m_dependentObjects.Count == 0)
                    )
                );
            }
            set
        ...
        {
            get { return (m_flags & HAS_ISERIALIZABLE) != 0; }
        }
        ...
        internal bool CanSurrogatedObjectValueChange
        {
            get
            {
                return (
                    m_surrogate == null
                    || m_surrogate.GetType() != typeof(SurrogateForCyclicalReference)
                );
            }
        }
        ...
        {
            get { return m_missingElementsRemaining; }
        }

        internal int TotalDependentObjects
        {
            get { return m_missingElementsRemaining + m_missingDecendents; }
        }
        ...
        {
            get { return m_dependentObjects; }
            set { m_dependentObjects = value; }
        }
        ...
        {
            get { return m_valueFixup; }
        }

        internal bool CompletelyFixed
        {
            get { return (!RequiresSerInfoFixup && !IsIncompleteObjectReference); }
        }
    ...
    internal class FixupHolderList
    {
        ...
        private void EnlargeArray()
        {
            ...
            if (newLength < 0)
            {
                ...
                {
                    throw new SerializationException(
                        Environment.GetResourceString("Serialization_TooManyElements")
                    );
                }
    ...
    internal class LongList
    {
        ...
        private void EnlargeArray()
        {
            BCLDebug.Trace(
                "SER",
                "[LongList.EnlargeArray]Enlarging array of size ",
                m_values.Length
            );
            int newLength = m_values.Length * 2;
            if (newLength < 0)
    ...
    internal class ObjectHolderList
    {
        ...
        private void EnlargeArray()
        {
            BCLDebug.Trace(
                "SER",
                "[ObjectHolderList.EnlargeArray]Enlarging array of size ",
                m_values.Length
            );
            int newLength = m_values.Length * 2;
            if (newLength < 0)
