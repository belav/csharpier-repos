...
namespace System
{
    ...
    public abstract class Array : ICloneable, IList, IStructuralComparable, IStructuralEquatable
    {
        ...
        public static void Resize<T>(ref T[] array, int newSize)
        {
            ...
            if (larray.Length != newSize)
            {
                ...
                Array.Copy(
                    ...
                    newArray,
                    0,
                    larray.Length > newSize ? newSize : larray.Length
                );
                array = newArray;
            }
        }
        ...
        Int32 IStructuralComparable.CompareTo(Object other, IComparer comparer)
        {
            ...
            {
                throw new ArgumentException(
                    Environment.GetResourceString("ArgumentException_OtherNotArrayOfCorrectLength"),
                    "other"
                );
            }
        ...
        public static int BinarySearch(Array array, Object value)
        {
            ...
            Contract.Ensures(
                (
                    Contract.Result<int>() >= array.GetLowerBound(0)
                    && Contract.Result<int>() <= array.GetUpperBound(0)
                )
                    || (
                        Contract.Result<int>() < array.GetLowerBound(0)
                        && ~Contract.Result<int>() <= array.GetUpperBound(0) + 1
                    )
            );
            Contract.EndContractBlock();
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
        private static extern bool TrySZBinarySearch(
            Array sourceArray,
            int sourceIndex,
            int count,
            Object value,
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
        private static extern bool TrySZIndexOf(
            Array sourceArray,
            int sourceIndex,
            int count,
            Object value,
        ...
        public static int LastIndexOf(Array array, Object value, int startIndex, int count)
        {
            ...
            if (count > startIndex - lb + 1)
                throw new ArgumentOutOfRangeException(
                    "endIndex",
                    Environment.GetResourceString("ArgumentOutOfRange_EndIndexStartIndex")
                );
            if (array.Rank != 1)
                throw new RankException(Environment.GetResourceString("Rank_MultiDimNotSupported"));
        ...
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        [ReliabilityContract(Consistency.WillNotCorruptState, Cer.MayFail)]
        private static extern bool TrySZLastIndexOf(
            Array sourceArray,
            int sourceIndex,
            int count,
            Object value,
        ...
        public static void Sort(Array keys, Array items, int index, int length, IComparer comparer)
        {
            ...
            if (items != null && keys.GetLowerBound(0) != items.GetLowerBound(0))
                throw new ArgumentException(
                    Environment.GetResourceString("Arg_LowerBoundsMustMatch")
                );
        ...
        )
        {
            ...
            if (length > 1)
            {
                ...
                ArraySortHelper<
                    TKey,
                    TValue
                >.Default.Sort(keys, items, index, length, comparer);
#endif
            }
        }
#endif
    ...
    sealed class SZArrayHelper
    {
        ...
        internal IEnumerator<T> GetEnumerator<T>()
        {
            ...
            return length == 0
                ...
                : new SZGenericArrayEnumerator<T>(_this, length);
        }
    ...
    internal abstract class ArrayContracts : Array
    {
        ...
        )
        {
            ...
            Contract.Requires(length >= 0);
            Contract.Requires(
                sourceIndex + length <= sourceArray.GetLowerBound(0) + sourceArray.Length
            );
            Contract.Requires(
