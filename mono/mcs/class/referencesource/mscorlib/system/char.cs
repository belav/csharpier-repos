...
#endif
    {
        ...
        **alphabetic, nothing happens.                                                **
        ...
        bool IConvertible.ToBoolean(IFormatProvider provider)
        {
            throw new InvalidCastException(
                Environment.GetResourceString("InvalidCast_FromTo", "Char", "Boolean")
            );
        }
        ...
        {
            throw new InvalidCastException(
                Environment.GetResourceString("InvalidCast_FromTo", "Char", "Single")
            );
        }
        ...
        {
            throw new InvalidCastException(
                Environment.GetResourceString("InvalidCast_FromTo", "Char", "Double")
            );
        }
        ...
        {
            throw new InvalidCastException(
                Environment.GetResourceString("InvalidCast_FromTo", "Char", "Decimal")
            );
        }
        ...
        {
            throw new InvalidCastException(
                Environment.GetResourceString("InvalidCast_FromTo", "Char", "DateTime")
            );
        }
        ...
        public static bool IsDigit(String s, int index)
        {
            ...
            return (
                CharUnicodeInfo.GetUnicodeCategory(s, index) == UnicodeCategory.DecimalDigitNumber
            );
        }
        ...
        public static bool IsLower(String s, int index)
        {
            ...
            return (
                CharUnicodeInfo.GetUnicodeCategory(s, index) == UnicodeCategory.LowercaseLetter
            );
        }
        ...
        ** Check if the specified UnicodeCategory belongs to the symbol categories.
        ...
        public static bool IsUpper(String s, int index)
        {
            ...
            return (
                CharUnicodeInfo.GetUnicodeCategory(s, index) == UnicodeCategory.UppercaseLetter
            );
        }
        ...
        ** Check if a char is a high surrogate.
        ...
        {
            return (
                (c >= CharUnicodeInfo.HIGH_SURROGATE_START)
        ...
        ** Check if a char is a low surrogate.
        ...
        {
            return (
                (c >= CharUnicodeInfo.LOW_SURROGATE_START)
        ...
        ** Check if the string specified by the index starts with a surrogate pair.
        ...
        public static bool IsSurrogatePair(char highSurrogate, char lowSurrogate)
        {
            return (
                (
                    highSurrogate >= CharUnicodeInfo.HIGH_SURROGATE_START
        ...
        ** Convert an UTF32 value into a surrogate pair.
        ...
        public static String ConvertFromUtf32(int utf32)
        {
            ...
            if (
                (utf32 < 0 || utf32 > UNICODE_PLANE16_END)
                || (utf32 >= HIGH_SURROGATE_START && utf32 <= LOW_SURROGATE_END)
            )
            {
                throw new ArgumentOutOfRangeException(
                    "utf32",
                    Environment.GetResourceString("ArgumentOutOfRange_InvalidUTF32")
                );
            }
            Contract.EndContractBlock();
        ...
        ** Convert a surrogate pair to UTF32 value
        ...
        public static int ConvertToUtf32(char highSurrogate, char lowSurrogate)
        {
            if (!IsHighSurrogate(highSurrogate))
            {
                throw new ArgumentOutOfRangeException(
                    "highSurrogate",
                    Environment.GetResourceString("ArgumentOutOfRange_InvalidHighSurrogate")
                );
            }
            if (!IsLowSurrogate(lowSurrogate))
            {
                throw new ArgumentOutOfRangeException(
                    "lowSurrogate",
                    Environment.GetResourceString("ArgumentOutOfRange_InvalidLowSurrogate")
                );
            }
            Contract.EndContractBlock();
            return (
                ((highSurrogate - CharUnicodeInfo.HIGH_SURROGATE_START) * 0x400)
                + (lowSurrogate - CharUnicodeInfo.LOW_SURROGATE_START)
            ...
            if (temp1 >= 0 && temp1 <= 0x7ff)
            {
                ...
                if (temp1 <= 0x3ff)
                {
                    ...
                    else
                    {
                        ...
                        throw new ArgumentException(
                            Environment.GetResourceString("Argument_InvalidHighSurrogate", index),
                            "s"
                        );
                    }
                }
                else
                {
                    ...
                    throw new ArgumentException(
                        Environment.GetResourceString("Argument_InvalidLowSurrogate", index),
                        "s"
                    );
                }
            }
