...
namespace System.Threading
{
    ...
    internal class HostExecutionContextSwitcher
    {
        ...
        public static void Undo(Object switcherObject)
        {
            ...
            HostExecutionContextManager hostMgr =
                HostExecutionContextManager.GetCurrentHostExecutionContextManager();
            if (hostMgr != null)
            {
    ...
    public class HostExecutionContextManager
    {
        ...
        public virtual Object SetHostExecutionContext(HostExecutionContext hostExecutionContext)
        {
            ...
            if (CheckIfHosted())
            {
                if (hostExecutionContext.State is IUnknownSafeHandle)
                {
                    ...
                    IUnknownSafeHandle unkSafeHandle = (IUnknownSafeHandle)
                        hostExecutionContext.State;
        ...
        {
            HostExecutionContextSwitcher hostContextSwitcher =
                previousState as HostExecutionContextSwitcher;
            if (hostContextSwitcher == null)
            {
                throw new InvalidOperationException(
                    Environment.GetResourceString("InvalidOperation_CannotOverrideSetWithoutRevert")
                );
            }
            ...
            {
                throw new InvalidOperationException(
                    Environment.GetResourceString("InvalidOperation_CannotUseSwitcherOtherThread")
                );
            }
            ...
            if (CheckIfHosted())
            {
                ...
                {
                    IUnknownSafeHandle unkprevSafeHandle = (IUnknownSafeHandle)
                        revertToHostContext.State;
                    // call into the Hosting API to set the host context
        ...
        internal static HostExecutionContextManager GetInternalHostExecutionContextManager()
        {
            if (_hostExecutionContextManager == null)
            {
                ...
                Contract.Assert(
                    _hostExecutionContextManager == null,
