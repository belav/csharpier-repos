...
namespace System.Threading.Tasks
{
    ...
    public class ConcurrentExclusiveSchedulerPair
    {
        ...
        {
            get { return m_threadProcessingMapping; }
        }
        ...
        private bool CompletionRequested
        {
            ...
            get
            {
                return m_completionState != null
                    && Volatile.Read(ref m_completionState.m_completionRequested);
            }
        }
        ...
        {
            get { return m_concurrentTaskScheduler; }
        }
        ...
        {
            get { return m_exclusiveTaskScheduler; }
        }
        ...
        {
            get { return m_concurrentTaskScheduler.m_tasks.Count; }
        }
        ...
        {
            get { return m_exclusiveTaskScheduler.m_tasks.Count; }
        }
        ...
        private void ProcessExclusiveTasks()
        {
            ...
            try
            {
                ...
                Contract.Assert(
                    !m_threadProcessingMapping.ContainsKey(Thread.CurrentThread.ManagedThreadId),
                    "This thread should not yet be involved in this pair's processing."
                );
                m_threadProcessingMapping[Thread.CurrentThread.ManagedThreadId] =
                    ProcessingMode.ProcessingExclusiveTask;
            ...
            finally
            {
                ...
                m_threadProcessingMapping.TryRemove(
                    Thread.CurrentThread.ManagedThreadId,
                    out currentMode
                );
                Contract.Assert(
                    currentMode == ProcessingMode.ProcessingExclusiveTask,
        ...
        private void ProcessConcurrentTasks()
        {
            ...
            finally
            {
                ...
                Contract.Assert(
                    currentMode == ProcessingMode.ProcessingConcurrentTasks,
        ...
        private sealed class ConcurrentExclusiveTaskScheduler : TaskScheduler
        {
            ...
            private static readonly Func<object, bool> s_tryExecuteTaskShim = new Func<
                object,
                bool
            >(TryExecuteTaskShim);
            ...
            {
                get { return m_maxConcurrencyLevel; }
            }
            ...
            protected override bool TryExecuteTaskInline(Task task, bool taskWasPreviouslyQueued)
            {
                ...
                else
                {
                    ...
                    if (
                        m_pair.m_threadProcessingMapping
                            .TryGetValue(
                                Thread.CurrentThread.ManagedThreadId,
            ...
            private sealed class DebugView
            {
                ...
                {
                    get { return m_taskScheduler.m_maxConcurrencyLevel; }
                }

                /// <summary>Gets the tasks scheduled to this scheduler.</summary>
                public IEnumerable<Task> ScheduledTasks
                {
                    get { return m_taskScheduler.m_tasks; }
                }
                ...
                {
                    get { return m_taskScheduler.m_pair; }
                }
            }
        }
        ...
        private sealed class DebugView
        {
            ...
            public DebugView(ConcurrentExclusiveSchedulerPair pair)
            {
                Contract.Requires(
                    pair != null,
                    "Need a pair with which to construct the debug view."
                );
                m_pair = pair;
            }
            ...
            {
                get { return m_pair.ModeForDebugger; }
            }

            /// <summary>Gets the number of tasks waiting to run exclusively.</summary>
            public IEnumerable<Task> ScheduledExclusive
            {
                get { return m_pair.m_exclusiveTaskScheduler.m_tasks; }
            }

            /// <summary>Gets the number of tasks waiting to run concurrently.</summary>
            public IEnumerable<Task> ScheduledConcurrent
            {
                get { return m_pair.m_concurrentTaskScheduler.m_tasks; }
            }
            ...
            public int CurrentlyExecutingTaskCount
            {
                get
                {
                    return (m_pair.m_processingCount == EXCLUSIVE_PROCESSING_SENTINEL)
                        ? 1
            ...
            {
                get { return m_pair.m_underlyingTaskScheduler; }
            }
        }
