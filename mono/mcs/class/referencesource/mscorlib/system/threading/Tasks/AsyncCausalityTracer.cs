...
namespace System.Threading.Tasks
{
    ...
    internal static class AsyncCausalityTracer
    {
        ...
        private static readonly Guid s_PlatformId = new Guid(
            0x4B0171A6,
            0xF3D0,
            0x41A0,
            0x9B,
        ...
        static AsyncCausalityTracer()
        {
            ...
            try
            {
                ...
                EventRegistrationToken token = s_TracerFactory.add_TracingStatusChanged(
                    new EventHandler<WFD.TracingStatusChangedEventArgs>(TracingStatusChangedHandler)
                );
                Contract.Assert(
                    token != default(EventRegistrationToken),
        ...
        private static void TracingStatusChangedHandler(
            Object sender,
            WFD.TracingStatusChangedEventArgs args
        )
        {
            if (args.Enabled)
        ...
        internal static void TraceOperationCreation(
        ...
        )
        {
            ...
            try
            {
                ...
                if ((f_LoggingOn & Loggers.CausalityTracer) != 0)
                    s_TracerFactory.TraceOperationCompletion(
                        (WFD.CausalityTraceLevel)traceLevel,
                        s_CausalitySource,
                        s_PlatformId,
                        GetOperationId((uint)taskId),
                        (WFD.AsyncCausalityStatus)status
                    );
            }
            catch (Exception ex)
            {
        ...
        [MethodImplAttribute(MethodImplOptions.NoInlining)]
        internal static void TraceOperationRelation(
            CausalityTraceLevel traceLevel,
            int taskId,
        ...
        )
        {
            ...
            try
            {
                ...
                if ((f_LoggingOn & Loggers.CausalityTracer) != 0)
                    s_TracerFactory.TraceOperationRelation(
                        (WFD.CausalityTraceLevel)traceLevel,
                        s_CausalitySource,
                        s_PlatformId,
                        GetOperationId((uint)taskId),
                        (WFD.CausalityRelation)relation
                    );
            }
            catch (Exception ex)
            {
        ...
        )
        {
            ...
            try
            {
                ...
                if ((f_LoggingOn & Loggers.CausalityTracer) != 0)
                    s_TracerFactory.TraceSynchronousWorkStart(
                        (WFD.CausalityTraceLevel)traceLevel,
                        s_CausalitySource,
                        s_PlatformId,
                        GetOperationId((uint)taskId),
                        (WFD.CausalitySynchronousWork)work
                    );
            }
            catch (Exception ex)
            {
        ...
        )
        {
            ...
            try
            {
                ...
                if ((f_LoggingOn & Loggers.CausalityTracer) != 0)
                    s_TracerFactory.TraceSynchronousWorkCompletion(
                        (WFD.CausalityTraceLevel)traceLevel,
                        s_CausalitySource,
                        (WFD.CausalitySynchronousWork)work
                    );
