...
namespace System.Threading.Tasks
{
    ...
    internal sealed class TplEtwProvider : EventSource
    {
        ...
        [Event(
            ...
            Task = TplEtwProvider.Tasks.Loop,
        ...
        [Event(
            ...
            Level = EventLevel.Informational,
            ActivityOptions = EventActivityOptions.Recursive,
            Task = TplEtwProvider.Tasks.Invoke,
            Opcode = EventOpcode.Start
        )]
        ...
        [Event(
            ...
            ActivityOptions = EventActivityOptions.Recursive,
            Task = TplEtwProvider.Tasks.ForkJoin,
            Opcode = EventOpcode.Start
        )]
        ...
        [Event(
            TASKWAITBEGIN_ID,
            Version = 3,
            Task = TplEtwProvider.Tasks.TaskWait,
            Opcode = EventOpcode.Send,
            Level = EventLevel.Informational,
            Keywords = Keywords.TaskTransfer | Keywords.Tasks
        )]
        ...
        public unsafe void RunningContinuation(int TaskID, object Object)
        {
            RunningContinuation(
                TaskID,
                (long)*((void**)JitHelpers.UnsafeCastToStackPointer(ref Object))
            );
        }
