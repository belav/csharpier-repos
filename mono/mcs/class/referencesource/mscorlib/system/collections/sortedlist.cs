...
namespace System.Collections
{
...
#if FEATURE_CORECLR
    [Obsolete(
        "Non-generic collections have been deprecated. Please use collections in System.Collections.Generic."
    )]
#endif
    [Serializable]
    public class SortedList : IDictionary, ICloneable
    {
        ...
        public virtual void Add(Object key, Object value)
        {
            ...
            if (i >= 0)
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_AddingDuplicate__", GetKey(i), key)
                );
            Insert(~i, key, value);
        }
        ...
        internal class SortedListDebugView
        {
            ...
            {
                get { return sortedList.ToKeyValuePairsArray(); }
            }
        }
    }
}
