...
namespace System.Collections.Generic
{
            ...
            IDeserializationCallback
    {
        ...
        public Dictionary(int capacity, IEqualityComparer<TKey> comparer)
        {
            ...
            {
                this.comparer =
                    (IEqualityComparer<TKey>)NonRandomizedStringEqualityComparer.Default;
            }
        ...
        )
        {
            ...
            if (
                i >= 0
                && EqualityComparer<TValue>.Default.Equals(entries[i].value, keyValuePair.Value)
            )
            {
                return true;
            }
        ...
        public virtual void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue(
                ComparerName,
                HashHelpers.GetEqualityComparerForSerialization(comparer),
        ...
        public virtual void OnDeserialization(Object sender)
        {
            ...
            comparer =
                (IEqualityComparer<TKey>)
                    siInfo.GetValue(ComparerName, typeof(IEqualityComparer<TKey>));
