...
namespace System.Collections.Concurrent
{
    ...
    public static class Partitioner
    {
        ...
        )
        {
            ...
            if (rangeSize == 0)
                rangeSize = 1;
            return Partitioner.Create(
                CreateRanges(fromInclusive, toExclusive, rangeSize),
                EnumerablePartitionerOptions.NoBuffering
            ); // chunk one range at a time
        }
        ...
        private static IEnumerable<Tuple<long, long>> CreateRanges(
            long fromInclusive,
            long toExclusive,
            long rangeSize
        )
        ...
        private abstract class DynamicPartitionEnumerator_Abstract<TSource, TSourceReader>
            : IEnumerator<KeyValuePair<long, TSource>>
        {
            ...
            public bool MoveNext()
            {
                ...
                //grab a new chunk from the source enumerator
                {
                    ...
                    Contract.Assert(
                        m_localOffset.Value == m_currentChunkSize.Value - 1
                            || m_currentChunkSize.Value == 0
                    );
                    ...
                    {
                        Contract.Assert(
                            m_currentChunkSize.Value <= requestedChunkSize
                                && m_currentChunkSize.Value > 0
                        );
        ...
        private class DynamicPartitionerForIEnumerable<TSource> : OrderablePartitioner<TSource>
        {
                ...
                : base(true, false, true)
            {
                m_source = source;
                m_useSingleChunking = (
                    (partitionerOptions & EnumerablePartitionerOptions.NoBuffering) != 0
                );
            }
            ...
            override public IList<IEnumerator<KeyValuePair<long, TSource>>> GetOrderablePartitions(
                int partitionCount
            )
            {
                if (partitionCount <= 0)
                ...
                IEnumerator<KeyValuePair<long, TSource>>[] partitions = new IEnumerator<
                    KeyValuePair<long, TSource>
                >[partitionCount];

                IEnumerable<KeyValuePair<long, TSource>> partitionEnumerable =
                    new InternalPartitionEnumerable(
                        m_source.GetEnumerator(),
                        m_useSingleChunking,
                        true
                    );
            ...
            /// </summary>
            private class InternalPartitionEnumerable
                    ...
                    IDisposable
            {
                ...
                internal InternalPartitionEnumerable(
                ...
                )
                {
                    ...
                    if (!m_useSingleChunking)
                    {
                        ...
                        m_FillBuffer = new KeyValuePair<long, TSource>[
                            fillBufferMultiplier * Partitioner.GetDefaultChunkSize<TSource>()
                        ];
                    }
                ...
                private void TryCopyFromFillBuffer(
                ...
                )
                {
                    ...
                    int endPos = Interlocked.Add(
                        ref m_FillBufferCurrentPosition,
                        requestedChunkSize
                    );
                    ...
                    if (beginPos < m_FillBufferSize)
                    {
                        ...
                        actualNumElementsGrabbed =
                            (endPos < m_FillBufferSize) ? endPos : m_FillBufferSize - beginPos;
                        Array.Copy(
                            fillBufferLocalRef,
                            beginPos,
                            destArray,
                ...
                )
                {
                    ...
                    if (m_useSingleChunking)
                    {
                        return GrabChunk_Single(
                            destArray,
                            requestedChunkSize,
                            ref actualNumElementsGrabbed
                        );
                    }
                    else
                    {
                        return GrabChunk_Buffered(
                            destArray,
                            requestedChunkSize,
                            ref actualNumElementsGrabbed
                        );
                ...
                /// false if all elements in the source collection have been reserved.
                /// </returns>
                internal bool GrabChunk_Single(
                    KeyValuePair<long, TSource>[] destArray,
                    int requestedChunkSize,
                    ref int actualNumElementsGrabbed
                )
                    ...
                    lock (m_sharedLock)
                    {
                        ...
                        try
                        {
                            if (m_sharedReader.MoveNext())
                            {
                                ...
                                destArray[0] = new KeyValuePair<long, TSource>(
                                    m_sharedIndex.Value,
                ...
                /// false if all elements in the source collection have been reserved.
                /// </returns>
                internal bool GrabChunk_Buffered(
                    KeyValuePair<long, TSource>[] destArray,
                    int requestedChunkSize,
                    ref int actualNumElementsGrabbed
                )
                {
                    ...
                    lock (m_sharedLock)
                    {
                        ...
                        try
                        {
                            ...
                            for (
                                ;
                                actualNumElementsGrabbed < requestedChunkSize;
                                actualNumElementsGrabbed++
                            )
                            {
                                if (m_sharedReader.MoveNext())
                                {
                                    m_sharedIndex.Value = checked(m_sharedIndex.Value + 1);
                                    destArray[actualNumElementsGrabbed] = new KeyValuePair<
                                        long,
                                        TSource
                                    >(m_sharedIndex.Value, m_sharedReader.Current);
                                }
                                else
                                {
                                    //if MoveNext() return false, we set the flag to inform other partitions
                            ...
                            if (
                                m_sourceDepleted.Value == false
                                && localFillBufferRef != null
                            ...
                            )
                            {
                                for (int i = 0; i < localFillBufferRef.Length; i++)
                                {
                                    ...
                                    {
                                        m_sharedIndex.Value = checked(m_sharedIndex.Value + 1);
                                        localFillBufferRef[i] = new KeyValuePair<long, TSource>(
                                            m_sharedIndex.Value,
                                            m_sharedReader.Current
                                        );
                                    }
            ...
            private class InternalPartitionEnumerator
                : DynamicPartitionEnumerator_Abstract<TSource, IEnumerator<TSource>>
            {
                //---- fields ----
...
#pragma warning restore 414
                ...
                override protected bool GrabNextChunk(int requestedChunkSize)
                {
                    ...
                    return m_enumerable.GrabChunk(
                        m_localList,
                        requestedChunkSize,
                        ref m_currentChunkSize.Value
                    );
                }
                ...
                override public KeyValuePair<long, TSource> Current
                {
                    get
                    {
                        ...
                        Contract.Assert(
                            m_localOffset.Value >= 0
                                && m_localOffset.Value < m_currentChunkSize.Value
                        );
                ...
                override public void Dispose()
                {
                    ...
                    if (
                        m_activePartitionCount != null
                        && Interlocked.Decrement(ref m_activePartitionCount.Value) == 0
                    )
                    {
            ...
            : OrderablePartitioner<TSource>
        {
            ...
            protected abstract IEnumerable<
                KeyValuePair<long, TSource>
            > GetOrderableDynamicPartitions_Factory(TCollection data);
            ...
            )
            {
                ...
                >[partitionCount];
                IEnumerable<KeyValuePair<long, TSource>> partitionEnumerable =
                    GetOrderableDynamicPartitions_Factory(m_data);
                for (int i = 0; i < partitionCount; i++)
                {
                    partitions[i] = partitionEnumerable.GetEnumerator();
                }
        ...
        private abstract class DynamicPartitionEnumeratorForIndexRange_Abstract<
            TSource,
            TSourceReader
        > : DynamicPartitionEnumerator_Abstract<TSource, TSourceReader>
        {
            //fields
            ...
            override protected bool GrabNextChunk(int requestedChunkSize)
            {
                ...
                while (!HasNoElementsLeft)
                {
                    ...
                    long newSharedIndex = Math.Min(
                        SourceCount - 1,
                        oldSharedIndex + requestedChunkSize
                    );
        ...
        /// </summary>
        /// <typeparam name="TSource">Type of elements in the source data</typeparam>
        private class DynamicPartitionerForIList<TSource>
            : DynamicPartitionerForIndexRange_Abstract<TSource, IList<TSource>>
        {
            ...
            //override methods
            override protected IEnumerable<
                KeyValuePair<long, TSource>
            > GetOrderableDynamicPartitions_Factory(IList<TSource> m_data)
            {
            ...
            /// </summary>
            private class InternalPartitionEnumerator
                : DynamicPartitionEnumeratorForIndexRange_Abstract<TSource, IList<TSource>>
            {
                //constructor
                internal InternalPartitionEnumerator(
                ...
                override public KeyValuePair<long, TSource> Current
                {
                    get
                    {
                        ...
                        return new KeyValuePair<long, TSource>(
                            m_startIndex + m_localOffset.Value,
        ...
        /// </summary>
        /// <typeparam name="TSource">Type of elements in the source data</typeparam>
        private class DynamicPartitionerForArray<TSource>
            : DynamicPartitionerForIndexRange_Abstract<TSource, TSource[]>
        {
            ...
            override protected IEnumerable<
                KeyValuePair<long, TSource>
            > GetOrderableDynamicPartitions_Factory(TSource[] m_data)
            {
                return new InternalPartitionEnumerable(m_data);
            }
            ...
            /// </summary>
            private class InternalPartitionEnumerator
                : DynamicPartitionEnumeratorForIndexRange_Abstract<TSource, TSource[]>
            {
                //constructor
            ...
            : OrderablePartitioner<TSource>
        {
            ...
            protected abstract IEnumerator<KeyValuePair<long, TSource>> CreatePartition(
                int startIndex,
                int endIndex
            );
        ...
        private abstract class StaticIndexRangePartition<TSource>
            : IEnumerator<KeyValuePair<long, TSource>>
        {
        ...
        private class StaticIndexRangePartitionerForIList<TSource>
            : StaticIndexRangePartitioner<TSource, IList<TSource>>
        {
            ...
            override protected IEnumerator<KeyValuePair<long, TSource>> CreatePartition(
                int startIndex,
                int endIndex
            )
            {
        ...
        /// </summary>
        /// <typeparam name="TSource"></typeparam>
        private class StaticIndexRangePartitionForIList<TSource>
            : StaticIndexRangePartition<TSource>
        {
            //the source collection shared by all partitions
            private volatile IList<TSource> m_list;

            internal StaticIndexRangePartitionForIList(
                IList<TSource> list,
                int startIndex,
                int endIndex
            )
        ...
        /// </summary>
        private class StaticIndexRangePartitionerForArray<TSource>
        ...
        /// Provides customized implementation of SourceCount and CreatePartition
        /// </summary>
        private class StaticIndexRangePartitionForArray<TSource>
            : StaticIndexRangePartition<TSource>
        {
            //the source collection shared by all partitions
            private volatile TSource[] m_array;

            internal StaticIndexRangePartitionForArray(
                TSource[] array,
                int startIndex,
                int endIndex
            )
        ...
        private static int GetDefaultChunkSize<TSource>()
        {
            ...
            if (typeof(TSource).IsValueType)
            {
                ...
                if (typeof(TSource).StructLayoutAttribute.Value == LayoutKind.Explicit)
                {
                    chunkSize = Math.Max(
                        1,
                        DEFAULT_BYTES_PER_CHUNK / Marshal.SizeOf(typeof(TSource))
                    );
                }
                else
                {
