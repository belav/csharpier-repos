        ...
        public BitArray(byte[] bytes)
        {
            ...
            if (bytes.Length > Int32.MaxValue / BitsPerByte)
            {
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_ArrayTooLarge", BitsPerByte),
                    "bytes"
                );
            }
...
=========================================================================*/
        public BitArray(int[] values)
        {
            ...
            {
                throw new ArgumentException(
                    Environment.GetResourceString("Argument_ArrayTooLarge", BitsPerInt32),
                    "values"
                );
            }
...
=========================================================================*/
            ...
            set
            {
                ...
                if (newints > m_array.Length || newints + _ShrinkThreshold < m_array.Length)
                {
                    ...
                    Array.Copy(
                        m_array,
                        newarray,
                        newints > m_array.Length ? m_array.Length : newints
                    );
                    m_array = newarray;
                }
        ...
        public void CopyTo(Array array, int index)
        {
            ...
            else if (array is bool[])
            {
                ...
                throw new ArgumentException(
                    Environment.GetResourceString("Arg_BitArrayTypeUnsupported")
                );
        }
