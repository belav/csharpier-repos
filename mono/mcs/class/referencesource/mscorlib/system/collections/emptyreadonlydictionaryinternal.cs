...
namespace System.Collections
{
    ...
    internal sealed class EmptyReadOnlyDictionaryInternal : IDictionary
    {
        ...
        public Object this[Object key]
        {
            ...
            set
            {
                ...
                if (!key.GetType().IsSerializable)
                    throw new ArgumentException(
                        Environment.GetResourceString("Argument_NotSerializable"),
                        "key"
                    );
        ...
        {
            get { return EmptyArray<Object>.Value; }
        }
        ...
        private sealed class NodeEnumerator : IDictionaryEnumerator
        {
            ...
            public Object Current
            {
                ...
                {
                    throw new InvalidOperationException(
                        Environment.GetResourceString("InvalidOperation_EnumOpCantHappen")
                    );
                }
            }
