        ...
        */
            ...
            get
            {
                ...
                else
                {
                    throw new ArgumentException(
                        Environment.GetResourceString("Arg_CannotMixComparisonInfrastructure")
                    );
                }
            }
            set
            ...
            : this((d != null ? d.Count : 0), loadFactor, hcp, comparer)
        {
            if (d == null)
                throw new ArgumentNullException(
                    "d",
                    Environment.GetResourceString("ArgumentNull_Dictionary")
                );
            Contract.EndContractBlock();
        ...
        public virtual void CopyTo(Array array, int arrayIndex)
        {
            ...
            if (array.Length - arrayIndex < Count)
                throw new ArgumentException(
                    Environment.GetResourceString("Arg_ArrayPlusOffTooSmall")
                );
            Contract.EndContractBlock();
        ...
        private void rehash(int newsize, bool forceNewHashCode)
        {
            ...
            for (nb = 0; nb < buckets.Length; nb++)
            {
                ...
                {
                    int hashcode = (
                        (forceNewHashCode ? GetHash(oldb.key) : oldb.hash_coll) & 0x7FFFFFFF
                    );
        ...
        private void Insert(Object key, Object nvalue, bool add)
        {
            ...
            do
            {
                ...
                )
                {
                    ...
                    if (
                        ntry > HashHelpers.HashCollisionThreshold
                        && HashHelpers.IsWellKnownEqualityComparer(_keycomparer)
                    )
                    {
...
#if !FEATURE_CORECLR
                if (
                    buckets.Length > HashHelpers.HashCollisionThreshold
                    && HashHelpers.IsWellKnownEqualityComparer(_keycomparer)
                )
                {
                    // PERF: We don't want to rehash if _keycomparer is already a RandomizedObjectEqualityComparer since in some
        ...
        private void putEntry(bucket[] newBuckets, Object key, Object nvalue, int hashcode)
        {
            ...
            do
            {
                if (
                    ...
                    || (newBuckets[bucketNumber].key == buckets)
                )
                {
...
#pragma warning disable 618
                ...
                IEqualityComparer keyComparerForSerilization = (IEqualityComparer)
                    HashHelpers.GetEqualityComparerForSerialization(_keycomparer);
#else
        ...
        public virtual void OnDeserialization(Object sender)
        {
            ...
            if (siInfo == null)
            {
                throw new SerializationException(
                    Environment.GetResourceString("Serialization_InvalidOnDeser")
                );
            }
...
#pragma warning restore 618
            ...
            {
                throw new SerializationException(
                    Environment.GetResourceString("Serialization_MissingKeys")
                );
            }
            if (serValues == null)
            {
                throw new SerializationException(
                    Environment.GetResourceString("Serialization_MissingValues")
                );
            }
            if (serKeys.Length != serValues.Length)
            {
                throw new SerializationException(
                    Environment.GetResourceString("Serialization_KeyValueDifferentSizes")
                );
            }
            for (int i = 0; i < serKeys.Length; i++)
            {
                ...
                {
                    throw new SerializationException(
                        Environment.GetResourceString("Serialization_NullKey")
                    );
                }
        ...
        private class HashtableEnumerator : IDictionaryEnumerator, ICloneable
        {
            ...
            public virtual DictionaryEntry Entry
            {
                get
                {
                    if (current == false)
                        throw new InvalidOperationException(
                            Environment.GetResourceString(ResId.InvalidOperation_EnumOpCantHappen)
                        );
        ...
        internal class HashtableDebugView
        {
            ...
            {
                get { return hashtable.ToKeyValuePairsArray(); }
            }
        }
    }
    ...
    internal static class HashHelpers
    {
        ...
        internal static ConditionalWeakTable<object, SerializationInfo> SerializationInfoTable
        {
            get
            {
                ...
                {
                    ConditionalWeakTable<object, SerializationInfo> newTable =
        ...
        public static bool IsWellKnownEqualityComparer(object comparer)
        {
            return (
                comparer == null
                || comparer == System.Collections.Generic.EqualityComparer<string>.Default
                || comparer is IWellKnownStringEqualityComparer
            );
        }
