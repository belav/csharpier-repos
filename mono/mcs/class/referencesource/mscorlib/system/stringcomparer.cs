...
namespace System
{
    ...
    {
        private static readonly StringComparer _invariantCulture = new CultureAwareComparer(
            CultureInfo.InvariantCulture,
            false
        );
        private static readonly StringComparer _invariantCultureIgnoreCase =
            new CultureAwareComparer(CultureInfo.InvariantCulture, true);
        ...
        public int Compare(object x, object y)
        {
            ...
            throw new ArgumentException(
                Environment.GetResourceString("Argument_ImplementIComparable")
            );
        }
    ...
    [Serializable]
    internal sealed class CultureAwareComparer
        : StringComparer
...
#endif
    {
        ...
        internal CultureAwareComparer(CompareInfo compareInfo, CompareOptions options)
        {
            ...
            _ignoreCase = (
                (options & CompareOptions.IgnoreCase) == CompareOptions.IgnoreCase
        ...
        public override bool Equals(Object obj)
        {
            ...
            return (this._ignoreCase == comparer._ignoreCase)
                && (
                    this._compareInfo.Equals(comparer._compareInfo)
...
#if FEATURE_RANDOMIZED_STRING_HASHING
    internal sealed class CultureAwareRandomizedComparer
        : StringComparer,
            IWellKnownStringEqualityComparer
    {
        private CompareInfo _compareInfo;
        ...
        public override bool Equals(Object obj)
        {
            ...
            return (this._ignoreCase == comparer._ignoreCase)
                && (this._compareInfo.Equals(comparer._compareInfo))
                && (this._entropy == comparer._entropy);
        }
    ...
    [Serializable]
    internal sealed class OrdinalComparer
        : StringComparer
#if FEATURE_RANDOMIZED_STRING_HASHING
            ,
            IWellKnownStringEqualityComparer
...
#if FEATURE_RANDOMIZED_STRING_HASHING
    internal sealed class OrdinalRandomizedComparer
        : StringComparer,
            IWellKnownStringEqualityComparer
    {
        private bool _ignoreCase;
