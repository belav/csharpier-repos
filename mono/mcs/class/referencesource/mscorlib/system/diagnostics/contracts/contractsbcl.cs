        ...
        )
        {
            if (
                ...
                throw new ArgumentException(
                    Environment.GetResourceString("Arg_EnumIllegalVal", failureKind),
                    "failureKind"
                );
...
#endif
#endif
            add { System.Runtime.CompilerServices.ContractHelper.InternalContractFailed += value; }
#if FEATURE_UNTRUSTED_CALLERS
            [SecurityCritical]
#if FEATURE_LINK_DEMAND
            [SecurityPermission(SecurityAction.LinkDemand, Unrestricted = true)]
...
namespace System.Runtime.CompilerServices
{
    public static partial class ContractHelper
    {
                ...
                if (contractFailedEventLocal != null)
                {
                    ...
                    if (eventArgs.Unwind)
                    {
                        ...
                        if (Environment.IsCLRHosted)
                            TriggerCodeContractEscalationPolicy(
                                failureKind,
                                displayMessage,
                                conditionText,
                                innerException
        ...
        {
            String resourceName = GetResourceNameForFailure(
                failureKind,
        ...
        )
        {
            ...
            Environment.TriggerCodeContractFailure(
                failureKind,
                message,
                conditionText,
                exceptionAsString
