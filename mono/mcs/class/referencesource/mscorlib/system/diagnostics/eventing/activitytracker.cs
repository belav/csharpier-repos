...
#endif
{
    ...
    internal class ActivityTracker
    {
        ...
        {
            get { return s_activityTrackerInstance; }
        }
        ...
        {
            get { return m_current.Value.ActivityId; }
        }
        ...
        private class ActivityInfo
        {
            ...
            readonly string m_name; // The name used in the 'start' and 'stop' APIs to help match up
    ...
    internal class TplEtwProvider : EventSource
    {
        ...
        public bool Debug
        {
            get { return IsEnabled(EventLevel.Verbose, Keywords.Debug); }
        }
