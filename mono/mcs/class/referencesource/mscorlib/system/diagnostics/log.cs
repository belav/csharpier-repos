...
namespace System.Diagnostics
{
    ...
    internal delegate void LogMessageEventHandler(
        LoggingLevels level,
        LogSwitch category,
        String message,
        StackTrace location
    ...
    internal static class Log
    {
        ...
        {
            lock (locker)
                _LogMessageEventHandler = (LogMessageEventHandler)
                    MulticastDelegate.Combine(_LogMessageEventHandler, handler);
        }
        ...
        public static void RemoveOnLogMessage(LogMessageEventHandler handler)
        {
            lock (locker)
                _LogMessageEventHandler = (LogMessageEventHandler)
                    MulticastDelegate.Remove(_LogMessageEventHandler, handler);
        }

        public static void AddOnLogSwitchLevel(LogSwitchLevelHandler handler)
        {
            lock (locker)
                _LogSwitchLevelHandler = (LogSwitchLevelHandler)
                    MulticastDelegate.Combine(_LogSwitchLevelHandler, handler);
        }
        ...
        public static void RemoveOnLogSwitchLevel(LogSwitchLevelHandler handler)
        {
            lock (locker)
                _LogSwitchLevelHandler = (LogSwitchLevelHandler)
                    MulticastDelegate.Remove(_LogSwitchLevelHandler, handler);
        }
        ...
        */
        ...
        [ResourceExposure(ResourceScope.None)]
        [MethodImplAttribute(MethodImplOptions.InternalCall)]
        internal static extern void ModifyLogSwitch(
            int iNewLevel,
