...
namespace System.Diagnostics
{
    ...
    internal abstract class AssertFilter
    {
        ...
        public abstract AssertFilters AssertFailure(
            String condition,
            String message,
            StackTrace location,
    ...
    internal class DefaultFilter : AssertFilter
    {
        ...
        public override AssertFilters AssertFailure(
            String condition,
            String message,
            StackTrace location,
            StackTrace.TraceFormat stackTraceFormat,
        ...
        )
        {
            return (AssertFilters)
                Assert.ShowDefaultAssertDialog(
                    condition,
                    message,
                    location.ToString(stackTraceFormat),
                    windowTitle
                );
        }
    }
