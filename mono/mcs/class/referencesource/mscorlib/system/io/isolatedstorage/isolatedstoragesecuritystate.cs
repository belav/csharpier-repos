...
namespace System.IO.IsolatedStorage
{
    ...
    public class IsolatedStorageSecurityState : SecurityState
    {
        ...
        internal static IsolatedStorageSecurityState CreateStateToIncreaseQuotaForGroup(
            String group,
            Int64 newQuota,
            Int64 usedSize
        )
...
#endif // FEATURE_CORECLR
#if !FEATURE_LEGACYNETCF
        internal static IsolatedStorageSecurityState CreateStateToIncreaseQuotaForApplication(
            Int64 newQuota,
            Int64 usedSize
        )
        {
        ...
        {
            get { return m_RootUserDirectory; }
            set { m_RootUserDirectory = value; }
        }
#endif // FEATURE_CORECLR
