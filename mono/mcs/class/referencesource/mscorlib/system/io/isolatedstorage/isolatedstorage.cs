...
namespace System.IO.IsolatedStorage
{
    ...
    using System.Runtime.InteropServices;using System.Runtime.Versioning;using Microsoft.Win32;using System.Diagnostics.Contracts;
        ...
        internal static String GetHash(Stream s)
        {
            ...
            if (Win32Native.CryptAcquireContext(out hProv, null, null, 0, 0) == false)
                throw new IsolatedStorageException(
                    Environment.GetResourceString("IsolatedStorage_Exception")
                );

            if (
                Win32Native.CryptCreateHash(hProv, Win32Native.CALG_SHA1, (IntPtr)0, 0, out hHash)
                == false
            )
                throw new IsolatedStorageException(
                    Environment.GetResourceString("IsolatedStorage_Exception")
            ...
            int fourBytes = 4;
            if (
                Win32Native.CryptGetHashParam(
                    hHash,
                    Win32Native.HP_HASHSIZE,
                    out digestLength,
                    ref fourBytes,
                    0
                ) == false
    ...
    // This is not used.
        ...
        public virtual ulong MaximumSize
        {
            get
            {
                ...
                throw new InvalidOperationException(
                    Environment.GetResourceString("IsolatedStorage_QuotaIsUndefined", "MaximumSize")
                );
            }
        }
        ...
        public virtual long Quota
        {
            get
            {
                ...
                throw new InvalidOperationException(
                    Environment.GetResourceString("IsolatedStorage_QuotaIsUndefined", "Quota")
                );
            }
            internal set
            {
        ...
        public Object DomainIdentity
        {
            ...
            get
            {
                ...
                throw new InvalidOperationException(
                    Environment.GetResourceString("IsolatedStorage_DomainUndefined")
                );
            }
        }
        ...
        public Object ApplicationIdentity
        {
            ...
            get
            {
                ...
                throw new InvalidOperationException(
                    Environment.GetResourceString("IsolatedStorage_ApplicationUndefined")
                );
            }
        }
        ...
        public Object AssemblyIdentity
        {
            ...
            get
            {
                ...
                throw new InvalidOperationException(
                    Environment.GetResourceString("IsolatedStorage_AssemblyUndefined")
                );
            }
        }
        ...
        )
        {
            ...
            else
            {
                ...
                _InitStore(scope, null, null, assem.Evidence, assemblyEvidenceType, null, null);
            }
        ...
        protected void InitStore(IsolatedStorageScope scope, Type appEvidenceType)
        {
            ...
            if (IsApp(scope))
            {
                ...
                _InitStore(scope, null, null, null, null, asi.ApplicationEvidence, appEvidenceType);
#else
                throw new IsolatedStorageException(
                    Environment.GetResourceString("IsolatedStorage_ApplicationMissingIdentity")
                );
        ...
        [System.Security.SecurityCritical] // auto-generated
        internal void InitStore(
            IsolatedStorageScope scope,
            Evidence domainEv,
            Type domainEvidenceType,
            Evidence assemEv,
            Type assemEvidenceType,
            Evidence appEv,
        ...
        )
        {
            ...
            else
            {
                if (assemEv == null)
                    throw new IsolatedStorageException(
                        Environment.GetResourceString("IsolatedStorage_AssemblyMissingIdentity")
                    );
            ...
            if (IsApp(scope))
            {
                m_AppIdentity = GetAccountingInfo(
                    appEv,
                    appEvidenceType,
                    IsolatedStorageScope.Application,
                    out typeHash,
            ...
            else
            {
                ...
                if (IsDomain(scope))
                {
                    m_DomainIdentity = GetAccountingInfo(
                        domainEv,
                        domainEvidenceType,
                        IsolatedStorageScope.Domain,
                        out typeHash,
        ...
        private static Object GetAccountingInfo(
            Evidence evidence,
            Type evidenceType,
            IsolatedStorageScope fAssmDomApp,
            out String typeName,
        ...
        )
        {
            ...
            o = _GetAccountingInfo(evidence, evidenceType, fAssmDomApp, out oNormalized);
            ...
            if (evidenceType == null)
            {
                ...
                if (o == null)
                {
                    ...
                    if (fAssmDomApp == IsolatedStorageScope.Domain)
                        ...
                        throw new IsolatedStorageException(
                            Environment.GetResourceString("IsolatedStorage_ApplicationNoEvidence")
                        );
                    else
                        throw new IsolatedStorageException(
                            Environment.GetResourceString("IsolatedStorage_AssemblyNoEvidence")
                        );
                }
            }
            else
        ...
        internal static void VerifyScope(IsolatedStorageScope scope)
        {
            ...
            if (
                (scope == c_Domain)
                || (scope == c_Assembly)
                || (scope == c_DomainRoaming)
                || (scope == c_AssemblyRoaming)
                || (scope == c_MachineDomain)
                || (scope == c_MachineAssembly)
                || (scope == c_AppUser)
                || (scope == c_AppMachine)
            ...
            throw new ArgumentException(
                Environment.GetResourceString("IsolatedStorage_Scope_Invalid")
            );
        }
        ...
        {
            IsolatedStoragePermission ispAllowed,
                ispDenied;
