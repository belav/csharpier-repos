    ...
    internal static class __Error
    {
        ...
        internal static void FileNotOpen()
        {
            throw new ObjectDisposedException(
                null,
                Environment.GetResourceString("ObjectDisposed_FileClosed")
            );
        }
        ...
        internal static void ReaderClosed()
        {
            throw new ObjectDisposedException(
                null,
                Environment.GetResourceString("ObjectDisposed_ReaderClosed")
            );
        }
        ...
        internal static void WinIOError(int errorCode, String maybeFullPath)
        {
            ...
            bool isInvalidPath =
                errorCode == Win32Native.ERROR_INVALID_NAME
            ...
            switch (errorCode)
            {
                case Win32Native.ERROR_FILE_NOT_FOUND:
                    if (str.Length == 0)
                        ...
                        throw new FileNotFoundException(
                            Environment.GetResourceString("IO.FileNotFound_FileName", str),
                            str
                        );
                ...
                case Win32Native.ERROR_ALREADY_EXISTS:
                    ...
                    throw new IOException(
                        Environment.GetResourceString("IO.IO_AlreadyExists_Name", str),
                ...
                case Win32Native.ERROR_SHARING_VIOLATION:
                    if (str.Length == 0)
                        throw new IOException(
                            Environment.GetResourceString("IO.IO_SharingViolation_NoFileName"),
                            Win32Native.MakeHRFromErrorCode(errorCode)
                        );
                    else
                        throw new IOException(
                            Environment.GetResourceString("IO.IO_SharingViolation_File", str),
                            Win32Native.MakeHRFromErrorCode(errorCode)
                        );
                ...
                case Win32Native.ERROR_FILE_EXISTS:
                    if (str.Length == 0)
                        goto default;
                    throw new IOException(
                        Environment.GetResourceString("IO.IO_FileExists_Name", str),
                        Win32Native.MakeHRFromErrorCode(errorCode)
                    );
        ...
        internal static void WriterClosed()
        {
            throw new ObjectDisposedException(
                null,
                Environment.GetResourceString("ObjectDisposed_WriterClosed")
            );
        }
#if !MONO
        // From WinError.h
