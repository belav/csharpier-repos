    ...
    public class MemoryStream : Stream
    {
        ...
        private bool EnsureCapacity(int value)
        {
            ...
            if (value > _capacity)
            {
                ...
                if ((uint)(_capacity * 2) > Array_ReferenceSources.MaxByteArrayLength)
                    newCapacity =
                        value > Array_ReferenceSources.MaxByteArrayLength
                            ? value
                            : Array_ReferenceSources.MaxByteArrayLength;
        ...
        public override long Position
        {
            ...
            set
            {
                ...
                if (value > MemStreamMaxLength)
                    throw new ArgumentOutOfRangeException(
                        "value",
                        Environment.GetResourceString("ArgumentOutOfRange_StreamLength")
                    );
        ...
        )
        {
            ...
            if (!CanRead && !CanWrite)
                throw new ObjectDisposedException(
                    null,
                    Environment.GetResourceString("ObjectDisposed_StreamClosed")
                );
        ...
        public override long Seek(long offset, SeekOrigin loc)
        {
            ...
            switch (loc)
            {
                ...
                default:
                    throw new ArgumentException(
                        Environment.GetResourceString("Argument_InvalidSeekOrigin")
                    );
            }
        ...
        public virtual void WriteTo(Stream stream)
        {
            if (stream == null)
                throw new ArgumentNullException(
                    "stream",
                    Environment.GetResourceString("ArgumentNull_Stream")
                );
            Contract.EndContractBlock();
