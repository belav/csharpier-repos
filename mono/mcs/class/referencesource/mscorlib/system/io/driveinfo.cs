    ...
    public sealed class DriveInfo : ISerializable
    {
        ...
        public DriveInfo(String driveName)
        {
            ...
            else
            {
                ...
                if (
                    _name == null
                    || _name.Length == 0
                    || _name.StartsWith("\\\\", StringComparison.Ordinal)
                )
                    throw new ArgumentException(
                        Environment.GetResourceString("Arg_MustBeDriveLetterOrRootDir")
                    );
            }
        ...
        public String DriveFormat
        {
            ...
            get
            {
                ...
                try
                {
                    bool r = Win32Native.GetVolumeInformation(
                        Name,
                        volumeName,
                        volNameLen,
                        out serialNumber,
        ...
        public bool IsReady
        {
            ...
            get { return Directory.InternalExists(Name); }
        }
        ...
        public long AvailableFreeSpace
        {
            ...
            get
            {
                ...
                try
                {
                    bool r = Win32Native.GetDiskFreeSpaceEx(
                        Name,
                        out userBytes,
                        out totalBytes,
                        out freeBytes
