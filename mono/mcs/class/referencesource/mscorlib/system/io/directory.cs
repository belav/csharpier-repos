...
namespace System.IO
{
    ...
    public static partial class Directory
    {
        ...
        internal static string GetFullPathAndCheckPermissions(
            string path,
            bool checkHost,
            FileSecurityStateAccess access = FileSecurityStateAccess.Read
        )
        {
            String fullPath = Path.GetFullPathInternal(path);
        ...
        internal static void CheckPermissions(
            string displayPath,
            string fullPath,
            bool checkHost,
            FileSecurityStateAccess access = FileSecurityStateAccess.Read
        ...
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        internal static void InternalCreateDirectory(
            String fullPath,
            String path,
        ...
        internal static bool InternalExistsHelper(String path, bool checkHost)
        {
            ...
            catch (UnauthorizedAccessException)
            {
                ...
                Contract.Assert(
                    false,
                    "Ignore this assert and send a repro to Microsoft. This assert was tracking purposes only."
                );
#endif //!FEATURE_PAL
            }
            return false;
        ...
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        private static String[] InternalGetFiles(
            String path,
            String searchPattern,
            SearchOption searchOption
        )
        {
            ...
            return InternalGetFileDirectoryNames(
                path,
                path,
                searchPattern,
                true,
        ...
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        internal static String[] UnsafeGetFiles(
            String path,
            String searchPattern,
            SearchOption searchOption
        )
        ...
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        private static String[] InternalGetDirectories(
            String path,
            String searchPattern,
            SearchOption searchOption
        )
        ...
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        internal static String[] UnsafeGetDirectories(
            String path,
            String searchPattern,
            SearchOption searchOption
        )
        ...
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        private static String[] InternalGetFileSystemEntries(
            String path,
            String searchPattern,
            SearchOption searchOption
        )
        ...
        [ResourceExposure(ResourceScope.Machine)]
        [ResourceConsumption(ResourceScope.Machine)]
        internal static String[] InternalGetFileDirectoryNames(
            String path,
        ...
        )
        {
            ...
            return InternalEnumerateFileSystemEntries(
                path,
                searchPattern,
        ...
        )
        {
            ...
            return FileSystemEnumerableFactory.CreateFileNameIterator(
                path,
                path,
                searchPattern,
                includeFiles,
...
#pragma warning restore 618
       ...
       **Exceptions:
       ==============================================================================*/
        ...
        {
            string currentDirectory = AppContextSwitches.UseLegacyPathHandling
                ? LegacyGetCurrentDirectory()
            ...
            if (currentDirectory.IndexOf('~') >= 0)
            {
                ...
                if (r == 0 || r >= PathInternal.MaxShortPath)
                {
                    ...
                    if (
                        ...
                        && errorCode != Win32Native.ERROR_INVALID_FUNCTION
                        && // by design - enough said.
        ...
        private static string NewGetCurrentDirectory()
        {
            using (StringBuffer buffer = new StringBuffer(PathInternal.MaxShortPath))
            {
                ...
                while (
                    (
                        result = Win32Native.GetCurrentDirectoryW(
                            buffer.CharCapacity,
                            buffer.GetHandle()
                        )
                    ) > buffer.CharCapacity
            ...
            if (recursive)
            {
                ...
                using (
                    SafeFindHandle hnd = Win32Native.FindFirstFile(
                        fullPath + Path.DirectorySeparatorCharAsString + "*",
                        data
                    )
                )
                {
                        ...
                        if (isDir)
                        {
                            ...
                            else
                            {
                                ...
                                if (data.dwReserved0 == Win32Native.IO_REPARSE_TAG_MOUNT_POINT)
                                {
                                    ...
                                    String mountPoint = Path.InternalCombine(
                                        fullPath,
                                ...
                                String reparsePoint = Path.InternalCombine(
                                    fullPath,
                                    data.cFileName
                                );
