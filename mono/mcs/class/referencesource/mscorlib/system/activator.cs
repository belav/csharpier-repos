...
namespace System
{
    ...
    public sealed class Activator : _Activator
    {
        ...
        internal const BindingFlags ConLookup = (BindingFlags)(
            BindingFlags.Instance | BindingFlags.Public
        );
        internal const BindingFlags ConstructorDefault =
        ...
        )
        {
            ...
            if (RuntimeFeature.IsDynamicCodeSupported && type is System.Reflection.Emit.TypeBuilder)
                throw new NotSupportedException(
                    Environment.GetResourceString("NotSupported_CreateInstanceWithTypeBuilder")
                );
#endif
            ...
            if (activationAttributes != null && activationAttributes.Length > 0)
            {
                ...
                if (type.IsMarshalByRef)
                {
                    ...
                    {
                        if (
                            activationAttributes.Length > 1
                            || !(activationAttributes[0] is UrlAttribute)
                        )
                            throw new NotSupportedException(
                                Environment.GetResourceString("NotSupported_NonUrlAttrOnMBR")
                            );
                    }
                }
                else
        ...
        )
        {
            ...
            Log(
                o != null,
                "CreateInstance:: ",
                "Created Instance of class " + typeName,
                "Failed to create instance of class " + typeName
            );
            if (o == null)
                return null;
            else
        ...
        )
        {
            ...
            return CreateInstanceFromInternal(
                assemblyFile,
                typeName,
                ignoreCase,
                bindingAttr,
...
#pragma warning restore 618
        ...
        )
        {
            ...
            return domain.InternalCreateInstanceFromWithNoSecurity(
                assemblyFile,
                typeName,
                ignoreCase,
                bindingAttr,
...
#else
        [Obsolete(
            "Activator.CreateInstance (ActivationContext) is not supported on this platform.",
            true
        )]
        public static ObjectHandle CreateInstance(ActivationContext activationContext)
        {
        ...
        [Obsolete(
            "Activator.CreateInstance (ActivationContext, string[]) is not supported on this platform.",
            true
        )]
        public static ObjectHandle CreateInstance(
            ActivationContext activationContext,
            ...
            if (Attr.Length > 0)
            {
                if (((ComVisibleAttribute)Attr[0]).Value == false)
                    throw new TypeLoadException(
                        Environment.GetResourceString("Argument_TypeMustBeVisibleFromCom")
                    );
            }
