...
namespace System
{
...
#endif
    {
        ...
        internal static double NegativeZero = BitConverter.Int64BitsToDouble(
        ...
        char IConvertible.ToChar(IFormatProvider provider)
        {
            throw new InvalidCastException(
                Environment.GetResourceString("InvalidCast_FromTo", "Double", "Char")
            );
        }
        ...
        {
            throw new InvalidCastException(
                Environment.GetResourceString("InvalidCast_FromTo", "Double", "DateTime")
            );
        }
