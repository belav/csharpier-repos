...
namespace System
{
            ...
            IComparable<UriTemplateLiteralPathSegment>
    {
        ...
        public static new UriTemplateLiteralPathSegment CreateFromUriTemplate(
            string segment,
        ...
        public override bool Equals(object obj)
        {
            ...
            {
                return (
                    (this.EndsWithSlash == lps.EndsWithSlash)
        ...
        {
            Fx.Assert(
                StringComparer.OrdinalIgnoreCase.Compare(AsUnescapedString(), segment) == 0,
