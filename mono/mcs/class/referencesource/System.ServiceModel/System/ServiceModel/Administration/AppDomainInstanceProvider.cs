    ...
    class AppDomainInstanceProvider : ProviderBase, IWmiProvider
    {
        ...
        bool IWmiProvider.GetInstance(IWmiInstance instance)
        {
            ...
            if (
                ...
                && String.Equals(
                    (string)instance.GetProperty(AdministrationStrings.Name),
        ...
        internal static void FillAppDomainInfo(IWmiInstance instance)
        {
            ...
            instance.SetProperty(
                AdministrationStrings.PerformanceCounters,
                PerformanceCounters.Scope.ToString()
            );
            ...
            instance.SetProperty(
                AdministrationStrings.TraceLevel,
                DiagnosticUtility.Level.ToString()
            );
            instance.SetProperty(
                AdministrationStrings.LogMalformedMessages,
                MessageLogger.LogMalformedMessages
            );
            instance.SetProperty(
                AdministrationStrings.LogMessagesAtServiceLevel,
            ...
            instance.SetProperty(
                AdministrationStrings.ServiceConfigPath,
                AspNetEnvironment.Current.ConfigurationPath
            );
        ...
        static IWmiInstance[] CreateListenersInfo(TraceSource traceSource, IWmiInstance instance)
        {
            ...
            for (int i = 0; i < traceSource.Listeners.Count; i++)
            {
                ...
                IWmiInstance traceListenerWmiInstance = instance.NewInstance(
                    AdministrationStrings.TraceListener
                );
                ...
                string initializeData = (string)
                    type.InvokeMember(
                        AdministrationStrings.InitializeData,
                ...
                string[] supportedAttributes = (string[])
                    type.InvokeMember(
                        AdministrationStrings.GetSupportedAttributes,
                ...
                IWmiInstance argumentWmiInstance = instance.NewInstance(
                    AdministrationStrings.TraceListenerArgument
                );
                ...
                if (null != supportedAttributes)
                {
                    foreach (string attribute in supportedAttributes)
                    {
                        ...
                        argumentWmiInstance.SetProperty(
                            AdministrationStrings.Value,
                            traceListener.Attributes[attribute]
                        );
                        traceListenerArguments.Add(argumentWmiInstance);
                    }
                }
                traceListenerWmiInstance.SetProperty(
                    AdministrationStrings.TraceListenerArguments,
                    traceListenerArguments.ToArray()
                );
        ...
        static void FillListenersInfo(IWmiInstance instance)
        {
            ...
            {
                instance.SetProperty(
                    AdministrationStrings.ServiceModelTraceListeners,
                    CreateListenersInfo(traceSource, instance)
                );
            }
            ...
            {
                instance.SetProperty(
                    AdministrationStrings.MessageLoggingTraceListeners,
                    CreateListenersInfo(traceSource, instance)
                );
            }
        }
        ...
        [Fx.Tag.SecurityNote(
            Critical = "Critical because we are setting DiagnosticUtility.Level.",
        ...
        bool IWmiProvider.PutInstance(IWmiInstance instance)
        {
            ...
            )
            {
                try
                {
                    SourceLevels newLevel = (SourceLevels)
                        Enum.Parse(
                            typeof(SourceLevels),
                    ...
                    if (DiagnosticUtility.Level != newLevel)
                    {
                        if (DiagnosticUtility.ShouldTraceVerbose)
                        {
                            TraceUtility.TraceEvent(
                                ...
                                TraceCode.WmiPut,
                                SR.GetString(SR.TraceCodeWmiPut),
                                new WmiPutTraceRecord(
                                    "DiagnosticTrace.Level",
                    ...
                    bool logMalformedMessages = (bool)
                        instance.GetProperty(AdministrationStrings.LogMalformedMessages);
                    ...
                    bool logMessagesAtServiceLevel = (bool)
                        instance.GetProperty(AdministrationStrings.LogMessagesAtServiceLevel);
                    ...
                    bool logMessagesAtTransportLevel = (bool)
                        instance.GetProperty(AdministrationStrings.LogMessagesAtTransportLevel);
