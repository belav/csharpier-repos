...
namespace System.ServiceModel
{
    ...
    {
        internal const TcpClientCredentialType DefaultClientCredentialType =
        ...
        )
        {
            ...
            SslProtocols sslProtocols;
            return IsSslBindingElement(
                transport,
                transportSecurity,
                out requireClientCertificate,
                out sslProtocols
            );
        }
        ...
        {
            if (
                this.clientCredentialType == TcpClientCredentialType.Certificate
                || this.clientCredentialType == TcpClientCredentialType.None
            )
            {
                return this.CreateSslBindingElement(
                    this.clientCredentialType == TcpClientCredentialType.Certificate
                );
            }
            else
            {
                WindowsStreamSecurityBindingElement result =
