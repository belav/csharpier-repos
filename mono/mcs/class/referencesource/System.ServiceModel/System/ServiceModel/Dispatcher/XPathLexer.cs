...
namespace System.ServiceModel.Dispatcher
{
    ...
    internal static class XPathCharTypes
    {
        ...
        // The definition of NCName is taken from "Namespaces in XML" (http://www.w3.org/TR/REC-xml-names/)
        // Section 2
        // The definition of Whitespace is taken from: "XML 1.0 (Second Edition)"
        // (http://www.w3.org/TR/REC-xml) Section 2.3
        ...
        // |
        // #x03DE | #x03E0 | [#x03E2-#x03F3] | [#x0401-#x040C] | [#x040E-#x044F] | [#x0451-#x045C] |
        // [#x045E-#x0481] | [#x0490-#x04C4] | [#x04C7-#x04C8] | [#x04CB-#x04CC] | [#x04D0-#x04EB] |
        // [#x04EE-#x04F5] | [#x04F8-#x04F9] | [#x0531-#x0556] | #x0559 | [#x0561-#x0586] | [#x05D0-#x05EA]
        // |
        // [#x05F0-#x05F2] | [#x0621-#x063A] | [#x0641-#x064A] | [#x0671-#x06B7] | [#x06BA-#x06BE] |
        // [#x06C0-#x06CE] | [#x06D0-#x06D3] | #x06D5 | [#x06E5-#x06E6] | [#x0905-#x0939] | #x093D |
        // [#x0958-#x0961] | [#x0985-#x098C] | [#x098F-#x0990] | [#x0993-#x09A8] | [#x09AA-#x09B0] | #x09B2
        // |
        ...
        // [#x0A8F-#x0A91] | [#x0A93-#x0AA8] | [#x0AAA-#x0AB0] | [#x0AB2-#x0AB3] | [#x0AB5-#x0AB9] | #x0ABD
        // |
        // #x0AE0 | [#x0B05-#x0B0C] | [#x0B0F-#x0B10] | [#x0B13-#x0B28] | [#x0B2A-#x0B30] | [#x0B32-#x0B33]
        // |
        // [#x0B36-#x0B39] | #x0B3D | [#x0B5C-#x0B5D] | [#x0B5F-#x0B61] | [#x0B85-#x0B8A] | [#x0B8E-#x0B90]
        // |
        // [#x0B92-#x0B95] | [#x0B99-#x0B9A] | #x0B9C | [#x0B9E-#x0B9F] | [#x0BA3-#x0BA4] | [#x0BA8-#x0BAA]
        // |
        // [#x0BAE-#x0BB5] | [#x0BB7-#x0BB9] | [#x0C05-#x0C0C] | [#x0C0E-#x0C10] | [#x0C12-#x0C28] |
        // [#x0C2A-#x0C33] | [#x0C35-#x0C39] | [#x0C60-#x0C61] | [#x0C85-#x0C8C] | [#x0C8E-#x0C90] |
        ...
        // [#x0E81-#x0E82] | #x0E84 | [#x0E87-#x0E88] | #x0E8A | #x0E8D | [#x0E94-#x0E97] | [#x0E99-#x0E9F]
        ...
        // [#x1F48-#x1F4D] | [#x1F50-#x1F57] | #x1F59 | #x1F5B | #x1F5D | [#x1F5F-#x1F7D] | [#x1F80-#x1FB4]
        // |
        // [#x1FB6-#x1FBC] | #x1FBE | [#x1FC2-#x1FC4] | [#x1FC6-#x1FCC] | [#x1FD0-#x1FD3] | [#x1FD6-#x1FDB]
        // |
        ...
        const string IdeogramicChars = "\u4E00\u9FA5\u3007\u3007\u3021\u3029";

        // CombiningChars
        // Taken from: "XML 1.0 (Second Edition)" (http://www.w3.org/TR/REC-xml) Appendix B
        // [#x0300-#x0345] | [#x0360-#x0361] | [#x0483-#x0486] | [#x0591-#x05A1] | [#x05A3-#x05B9] |
        // [#x05BB-#x05BD] | #x05BF | [#x05C1-#x05C2] | #x05C4 | [#x064B-#x0652] | #x0670 | [#x06D6-#x06DC]
        // |
        // [#x06DD-#x06DF] | [#x06E0-#x06E4] | [#x06E7-#x06E8] | [#x06EA-#x06ED] | [#x0901-#x0903] | #x093C
        // |
        // [#x093E-#x094C] | #x094D | [#x0951-#x0954] | [#x0962-#x0963] | [#x0981-#x0983] | #x09BC | #x09BE
        // |
        // #x09BF | [#x09C0-#x09C4] | [#x09C7-#x09C8] | [#x09CB-#x09CD] | #x09D7 | [#x09E2-#x09E3] | #x0A02
        // |
        // #x0A3C | #x0A3E | #x0A3F | [#x0A40-#x0A42] | [#x0A47-#x0A48] | [#x0A4B-#x0A4D] | [#x0A70-#x0A71]
        // |
        // [#x0A81-#x0A83] | #x0ABC | [#x0ABE-#x0AC5] | [#x0AC7-#x0AC9] | [#x0ACB-#x0ACD] | [#x0B01-#x0B03]
        // |
        // #x0B3C | [#x0B3E-#x0B43] | [#x0B47-#x0B48] | [#x0B4B-#x0B4D] | [#x0B56-#x0B57] | [#x0B82-#x0B83]
        // |
        // [#x0BBE-#x0BC2] | [#x0BC6-#x0BC8] | [#x0BCA-#x0BCD] | #x0BD7 | [#x0C01-#x0C03] | [#x0C3E-#x0C44]
        // |
        // [#x0C46-#x0C48] | [#x0C4A-#x0C4D] | [#x0C55-#x0C56] | [#x0C82-#x0C83] | [#x0CBE-#x0CC4] |
        // [#x0CC6-#x0CC8] | [#x0CCA-#x0CCD] | [#x0CD5-#x0CD6] | [#x0D02-#x0D03] | [#x0D3E-#x0D43] |
        // [#x0D46-#x0D48] | [#x0D4A-#x0D4D] | #x0D57 | #x0E31 | [#x0E34-#x0E3A] | [#x0E47-#x0E4E] | #x0EB1
        // |
        // [#x0EB4-#x0EB9] | [#x0EBB-#x0EBC] | [#x0EC8-#x0ECD] | [#x0F18-#x0F19] | #x0F35 | #x0F37 | #x0F39
        // |
        // #x0F3E | #x0F3F | [#x0F71-#x0F84] | [#x0F86-#x0F8B] | [#x0F90-#x0F95] | #x0F97 | [#x0F99-#x0FAD]
        // |
        ...
        const string OtherNCNameStartChars = "__";

        // Other NCName chars
        // Taken from: "Namespaces in XML" (http://www.w3.org/TR/REC-xml-names/) Section 2
        const string OtherNCNameChars = "..--__";
        #endregion
        ...
        static XPathCharTypes()
        {
            ...
            // PERF: precompute the classes of each character set so SetProperties only needs to be run once per
            // set.
    ...
    internal class XPathLexer
    {
        ...
        internal XPathLexer(string xpath, bool resolveKeywords)
        {
            ...
            // The 'next token' data can be more quickly communicated to the parser if they both hold a
            ...
            else
            {
                ...
                switch (this.ch)
                {
                    ...
                    case '*':
                        ...
                        {
                            token.Set(
                                XPathTokenID.Wildcard,
                                new XPathParser.QName(string.Empty, QueryDataModel.Wildcard)
                            );
                        }
                        break;
                    ...
                    case '$':
                        ...
                        if (qname.Prefix.Length == 0 && qname.Name.Length == 0)
                        {
                            AdvanceChar();
                            ThrowError(
                                QueryCompileError.InvalidVariable,
                                this.ch == char.MinValue ? string.Empty : CurrentSubstring()
                            );
                        }
        ...
        private void TokenizeQName()
        {
            ...
            if (PeekChar() == ':' && PeekChar(2) != ':')
            {
                ...
                {
                    ThrowError(
                        QueryCompileError.InvalidNCName,
                        this.ch == char.MinValue ? "" : CurrentSubstring()
                    );
                }
            }
            else
        ...
        private XPathTokenID GetNamedOperator(XPathParser.QName qname)
        {
            ...
            {
                ThrowError(
                    QueryCompileError.UnsupportedOperator,
                    this.previousID.ToString() + "->" + qname.Name
                );
            }
