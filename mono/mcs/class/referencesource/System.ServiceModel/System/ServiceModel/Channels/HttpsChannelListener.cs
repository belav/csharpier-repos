...
namespace System.ServiceModel.Channels
{
        ...
        where TChannel : class, IChannel
    {
            ...
            : base(httpsBindingElement, context)
        {
            ...
            this.shouldValidateClientCertificate = ShouldValidateClientCertificate(
            ...
            this.certificateAuthenticator =
                TransportSecurityHelpers.GetCertificateTokenAuthenticator(
                    ...
                    TransportSecurityHelpers.GetListenUri(
            ...
            else
            {
                ...
                X509SecurityTokenAuthenticator authenticator =
                    this.certificateAuthenticator as X509SecurityTokenAuthenticator;

                if (authenticator != null)
                {
                    this.certificateAuthenticator = new X509SecurityTokenAuthenticator(
                        X509CertificateValidator.None,
                        authenticator.MapCertificateToWindowsAccount,
        ...
        {
            get { return SharedHttpsTransportManager.StaticTransportManagerTable; }
        }
        ...
        SecurityMessageProperty CreateSecurityProperty(
        ...
        )
        {
            if (this.shouldValidateClientCertificate)
            {
                ...
                try
                {
                    ...
                    certificate = authenticationContext.GetClientCertificate(
                        out isCertificateValid
                    );
                    Fx.Assert(
                        !this.requireClientCertificate || certificate != null,
                        "ClientCertificate must be present"
                    );
                    ...
                    if (certificate != null)
                    {
                        ...
                        if (this.useHostedClientCertificateMapping)
                        {
                            ...
                            else
                            {
                                ...
                                identity = SecurityUtils.CloneWindowsIdentityIfNecessary(
                                    identity,
            ...
            if (this.shouldValidateClientCertificate)
            {
                ...
                try
                {
                    ...
                    if (certificate != null)
                    {
                        ...
                        {
                            Fx.Assert(
                                listenerContext.Request.ClientCertificateError == 0,
...
#pragma warning suppress 56500 // covered by FXCop
                catch (Exception exception)
                {
                    ...
                    if (
                        ...
                        WriteAuditEvent(
                            AuditLevel.Failure,
                            (certificateEx != null)
                                ? SecurityUtils.GetCertificateId(certificateEx)
                                : String.Empty,
                            exception
                        );
        ...
        )
        {
            ...
            if (result == HttpStatusCode.OK)
            {
                if (this.shouldValidateClientCertificate)
                {
                    ...
                    X509Certificate2 clientCertificate = authenticationContext.GetClientCertificate(
                        ...
                        if (this.RequireClientCertificate)
                        {
                            if (DiagnosticUtility.ShouldTraceError)
                            {
                                TraceUtility.TraceEvent(
                                    TraceEventType.Error,
                                    TraceCode.HttpsClientCertificateNotPresent,
                                    SR.GetString(SR.TraceCodeHttpsClientCertificateNotPresent),
                                    authenticationContext.CreateTraceRecord(),
                                    this,
                                    null
                                );
                            }
                    ...
                    else if (!isValidCertificate && !this.useCustomClientCertificateVerification)
                    {
                        if (DiagnosticUtility.ShouldTraceError)
                        {
                            TraceUtility.TraceEvent(
                                TraceEventType.Error,
                                TraceCode.HttpsClientCertificateInvalid,
                                SR.GetString(SR.TraceCodeHttpsClientCertificateInvalid),
                                authenticationContext.CreateTraceRecord(),
                                this,
                                null
                            );
                    ...
                    if (
                        ...
                        && (
                            AuditLevel.Failure
                            == (
                                this.AuditBehavior.MessageAuthenticationAuditLevel
                                & AuditLevel.Failure
                            )
                        )
                    )
                    {
                        ...
                        WriteAuditEvent(
                            ...
                            (clientCertificate != null)
                                ? SecurityUtils.GetCertificateId(clientCertificate)
                                : String.Empty,
                            exception
                        );
                    }
                        ...
                        if (this.RequireClientCertificate)
                        {
                            if (DiagnosticUtility.ShouldTraceWarning)
                            {
                                TraceUtility.TraceEvent(
                                    ...
                                    TraceCode.HttpsClientCertificateNotPresent,
                                    SR.GetString(SR.TraceCodeHttpsClientCertificateNotPresent),
                                    new HttpListenerRequestTraceRecord(listenerContext.Request),
                                    this,
                                    null
                                );
                            }
                    ...
                    )
                    {
                        if (DiagnosticUtility.ShouldTraceWarning)
                        {
                            TraceUtility.TraceEvent(
                                ...
                                TraceCode.HttpsClientCertificateInvalid,
                                SR.GetString(
                                    SR.TraceCodeHttpsClientCertificateInvalid1,
                                    "0x"
                                        + (request.ClientCertificateError & 65535).ToString(
                                            "X",
        ...
        private static bool ShouldValidateClientCertificate(
            bool requireClientCertificateValidation,
            BindingContext context
        )
        {
            ...
            return EndpointSettings.GetValue<bool>(
                context,
                EndpointSettings.ValidateOptionalClientCertificates,
                false
            );
        }
    }
