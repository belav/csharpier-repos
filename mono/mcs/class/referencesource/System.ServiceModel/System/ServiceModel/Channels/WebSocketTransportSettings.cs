...
namespace System.ServiceModel.Channels
{
    ...
    {
        public const string ConnectionOpenedAction =
        ...
        {
            get { return this.transportUsage; }
            set
            {
        ...
        {
            get { return this.createNotificationOnConnection; }
            set { this.createNotificationOnConnection = value; }
        }
        ...
        {
            get { return this.disablePayloadMasking; }
            set { this.disablePayloadMasking = value; }
        }
        ...
        public bool Equals(WebSocketTransportSettings other)
        {
            ...
            return this.TransportUsage == other.TransportUsage
                ...
                && StringComparer.OrdinalIgnoreCase.Compare(this.SubProtocol, other.SubProtocol)
                    == 0
        ...
        {
            int hashcode =
                this.TransportUsage.GetHashCode()
