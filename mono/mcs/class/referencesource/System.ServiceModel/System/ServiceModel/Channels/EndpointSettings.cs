...
namespace System.ServiceModel.Channels
{
    ...
    {
        internal const string ValidateOptionalClientCertificates =
            "wcf:HttpTransport:ValidateOptionalClientCertificates";
        ...
        )
        {
            ...
            IDictionary<string, object> endpointSettings = bindingParameters.Find<
