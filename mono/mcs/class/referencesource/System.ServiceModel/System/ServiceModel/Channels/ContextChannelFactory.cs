    ...
    class ContextChannelFactory<TChannel> : LayeredChannelFactory<TChannel>
    {
        ...
        public ContextChannelFactory(
            ...
            : base(
                ...
                context == null ? null : context.BuildInnerChannelFactory<TChannel>()
            )
        {
        ...
        protected override TChannel OnCreateChannel(EndpointAddress address, Uri via)
        {
            if (DiagnosticUtility.ShouldTraceInformation)
            {
                string traceText = SR.GetString(
                    SR.ContextChannelFactoryChannelCreatedDetail,
                    address,
                    via
                );
                TraceUtility.TraceEvent(
                    ...
                    SR.GetString(SR.TraceCodeContextChannelFactoryChannelCreated),
