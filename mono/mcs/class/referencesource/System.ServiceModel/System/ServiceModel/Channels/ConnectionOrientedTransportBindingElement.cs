            ...
            ITransportPolicyImport
    {
            ...
            : base()
        {
            ...
            this.hostNameComparisonMode =
                ConnectionOrientedTransportDefaults.HostNameComparisonMode;
            this.channelInitializationTimeout =
                ConnectionOrientedTransportDefaults.ChannelInitializationTimeout;
        ...
        internal ConnectionOrientedTransportBindingElement(
            ConnectionOrientedTransportBindingElement elementToBeCloned
        )
        ...
        internal bool ExposeConnectionProperty
        {
            ...
            set { this.exposeConnectionProperty = value; }
        }
        ...
        [DefaultValue(
            typeof(TimeSpan),
            ConnectionOrientedTransportDefaults.ChannelInitializationTimeoutString
        )]
        ...
        {
            get { return this.maxOutputDelay; }
            set
            {
                if (value < TimeSpan.Zero)
                {
        ...
        )
        {
            ...
            if (
                TransferModeHelper.IsRequestStreamed(this.TransferMode)
            ...
            )
            {
                policyAssertions.Add(
                    new XmlDocument().CreateElement(
                        ...
                        TransportPolicyConstants.StreamedName,
        ...
        internal override bool IsMatch(BindingElement b)
        {
            ...
            ConnectionOrientedTransportBindingElement connection =
                b as ConnectionOrientedTransportBindingElement;
            if (connection == null)
                return false;
