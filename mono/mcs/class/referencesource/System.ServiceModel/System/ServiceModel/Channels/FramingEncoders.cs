...
namespace System.ServiceModel.Channels
{
    ...
    abstract class EncodedFramingRecord
    {
        ...
        internal EncodedFramingRecord(FramingRecordType recordType, string value)
        {
            ...
            encodedBytes = DiagnosticUtility.Utility
    ...
    abstract class SessionEncoder
    {
        ...
        public static byte[] PreambleEndBytes = new byte[] { (byte)FramingRecordType.PreambleEnd };

        public static byte[] EndBytes = new byte[] { (Byte)FramingRecordType.End };
        ...
        )
        {
            ...
            Buffer.BlockCopy(
                contentType.EncodedBytes,
                0,
                buffer,
                offset + via.EncodedBytes.Length,
                contentType.EncodedBytes.Length
            );
        }
        ...
        public static ArraySegment<byte> EncodeMessageFrame(ArraySegment<byte> messageFrame)
        {
            ...
            return new ArraySegment<byte>(
                buffer,
                messageFrame.Offset - spaceNeeded,
                messageFrame.Count + spaceNeeded
            );
        }
    }
    ...
    abstract class ServerSessionEncoder : SessionEncoder
    {
        ...
        public static byte[] AckResponseBytes = new byte[] { (byte)FramingRecordType.PreambleAck };
    ...
    abstract class SingletonEncoder
    {
        ...
        public static byte[] EnvelopeEndBytes = new byte[] { (byte)0 };
