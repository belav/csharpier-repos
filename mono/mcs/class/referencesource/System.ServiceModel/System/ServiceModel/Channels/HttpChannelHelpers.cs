...
namespace System.ServiceModel.Channels
{
    ...
    abstract class HttpInput
    {
        ...
        internal static HttpInput CreateHttpInput(
        ...
        void ThrowMaxReceivedMessageSizeExceeded()
        {
            ...
            {
                TD.MaxReceivedMessageSizeExceeded(
                    SR.GetString(SR.MaxReceivedMessageSizeExceeded, settings.MaxReceivedMessageSize)
                );
            }

            if (isRequest)
            {
                ThrowHttpProtocolException(
                    SR.GetString(
        ...
        Message ReadChunkedBufferedMessage(Stream inputStream)
        {
            try
            {
                return messageEncoder.ReadMessage(
                    inputStream,
                    bufferManager,
        ...
        {
            MaxMessageSizeStream maxMessageSizeStream = new MaxMessageSizeStream(
                inputStream,
                settings.MaxReceivedMessageSize
            );
        ...
        Exception ProcessHttpAddressing(Message message)
        {
            ...
            if (message.Version.Addressing == AddressingVersion.None)
            {
                ...
                if (!actionAbsent)
                {
                    result = new ProtocolException(
                        SR.GetString(
                            SR.HttpAddressingNoneHeaderOnWire,
            ...
            if (isRequest)
            {
                ...
                if (message.Version.Envelope == EnvelopeVersion.Soap11)
                {
                    ...
                    message.Version.Envelope == EnvelopeVersion.Soap12
                ...
                )
                {
                    ...
                    if (
                        parsedContentType.MediaType == multipartRelatedMediaType
                        && parsedContentType.Parameters.ContainsKey(startInfoHeaderParam)
                    )
                    {
                        // fix to grab action from start-info as stated in RFC2387
                        action = new ContentType(
                            parsedContentType.Parameters[startInfoHeaderParam]
                        ).Parameters["action"];
                    }
                    if (action == null)
                    {
                ...
                if (action != null)
                {
                    ...
                    try
                    {
                        ...
                        {
                            result = new ActionMismatchAddressingException(
                                SR.GetString(
                                    SR.HttpSoapActionMismatchFault,
                                    message.Headers.Action,
                                    action
                                ),
                                message.Headers.Action,
            ...
            )
            {
                MessageLogger.LogMessage(
                    ref message,
                    MessageLoggingSource.TransportReceive | MessageLoggingSource.LastChance
                );
            }
        ...
        void ValidateContentType()
        {
            ...
            if (!messageEncoder.IsContentTypeSupported(ContentType))
            {
                ...
                string statusDescription = string.Format(
                    ...
                    HttpChannelUtilities.StatusDescriptionStrings.HttpContentTypeMismatch,
                    ContentType,
                    messageEncoder.ContentType
                );
                ThrowHttpProtocolException(
                    SR.GetString(SR.ContentTypeMismatch, ContentType, messageEncoder.ContentType),
                    HttpStatusCode.UnsupportedMediaType,
                    statusDescription
                );
            }
        ...
        public IAsyncResult BeginParseIncomingMessage(
        ...
        )
        {
            ...
            try
            {
                IAsyncResult result = new ParseMessageAsyncResult(
                    httpRequestMessage,
                    this,
                    callback,
                    state
        ...
        public HttpRequestMessageHttpInput CreateHttpRequestMessageInput()
        {
            ...
            if (this.HasContent)
            {
                message.Content = new StreamContent(
            ...
            return new HttpRequestMessageHttpInput(
                message,
                this.settings,
        ...
        void ThrowHttpProtocolException(
            string message,
        ...
        class ParseMessageAsyncResult : TraceAsyncResult
        {
            ...
            AsyncCompletionResult DecodeBufferedMessageAsync()
            {
                ...
                IAsyncResult result = inputStream.BeginRead(
                    buffer.Array,
                    offset,
                    count,
                    onRead,
            ...
            bool ContinueReading(int bytesRead)
            {
                ...
                )
                {
                    ...
                    )
                    {
                        ...
                        this.message = this.httpInput
                            .DecodeBufferedMessage(
                                new ArraySegment<byte>(buffer.Array, 0, offset),
                                inputStream
                            );
...
#pragma warning suppress 56500 // Microsoft, transferring exception to another thread
        ...
        class WebResponseHttpInput : HttpInput
        {
            ...
            {
                get { return httpWebResponse.Headers["SOAPAction"]; }
            }
            ...
            public override void ConfigureHttpRequestMessage(HttpRequestMessage message)
            {
                ...
                Fx.Assert(
                    false,
                    "HTTP pipeline for client is not implemented yet. This method should not be called."
                );
            ...
            class WebResponseInputStream : DetectEofStream
            {
                ...
                )
                {
                    try
                    {
                        return BaseStream.BeginRead(
                            buffer,
                            offset,
                            Math.Min(count, maxSocketRead),
                            callback,
                            state
                        );
                    }
                ...
                {
                    TimeSpan timeSpan = this.CanTimeout
    ...
    abstract class HttpOutput
    {
        ...
        )
        {
            ...
            ICompressedMessageEncoder compressedMessageEncoder =
                this.messageEncoder as ICompressedMessageEncoder;
            this.canSendCompressedResponses =
                compressedMessageEncoder != null && compressedMessageEncoder.CompressionEnabled;
            if (isRequest)
            {
                this.streamed = TransferModeHelper.IsRequestStreamed(settings.TransferMode);
            }
        ...
        private void TraceRequestResponseAborted(HttpAbortReason reason)
        {
            ...
            if (DiagnosticUtility.ShouldTraceWarning)
            {
                TraceUtility.TraceEvent(
                    ...
                    isRequest
                        ? TraceCode.HttpChannelRequestAborted
                        : TraceCode.HttpChannelResponseAborted,
                    isRequest
                        ? SR.GetString(SR.TraceCodeHttpChannelRequestAborted)
                        : SR.GetString(SR.TraceCodeHttpChannelResponseAborted),
                    this.message
                );
            }
        }
        ...
        void CleanupBuffer()
        {
            byte[] bufferToRecycleSnapshot = Interlocked.Exchange<byte[]>(
                ref this.bufferToRecycle,
                null
            );
        ...
        public void ConfigureHttpResponseMessage(
            Message message,
        ...
        )
        {
            ...
            if (
                message.Version == MessageVersion.None
                && httpResponseMessagePropertyFound
                && !string.IsNullOrEmpty(responseProperty.Headers[HttpResponseHeader.ContentType])
            )
            {
            ...
            bool httpMethodIsHead =
                string.Compare(this.HttpMethod, "HEAD", StringComparison.OrdinalIgnoreCase) == 0;
            ...
            if (!message.IsEmpty)
            {
                using (HttpContent content = httpResponseMessage.Content)
                {
                    if (this.streamed)
                    {
                        IStreamedMessageEncoder streamedMessageEncoder =
                            this.messageEncoder as IStreamedMessageEncoder;
                        Stream stream = null;
                        ...
                        {
                            httpResponseMessage.Content = new OpaqueContent(
                                this.messageEncoder,
                                message,
                                this.mtomBoundary
                            );
                    ...
                    else
                    {
                        ...
                        ArraySegment<byte> messageBytes = this.SerializeBufferedMessage(
                            message,
                            false
                        );
                        httpResponseMessage.Content = new HttpOutputByteArrayContent(
                            messageBytes.Array,
                            messageBytes.Offset,
                            messageBytes.Count,
                            this.bufferManager
        ...
        ArraySegment<byte> SerializeBufferedMessage(Message message, bool shouldRecycleBuffer)
        {
            ...
            {
                result = mtomMessageEncoder.WriteMessage(
                    message,
                    int.MaxValue,
                    bufferManager,
                    0,
        ...
        Stream GetWrappedOutputStream()
        {
            ...
            // small ones.
            return this.supportsConcurrentIO
                ? (Stream)new BufferedOutputAsyncStream(this.outputStream, BufferSize, BufferCount)
                : new BufferedStream(this.outputStream, ChunkSize);
        }
        ...
        void WriteStreamedMessage(TimeSpan timeout)
        {
            ...
            try
            {
                ...
                {
                    mtomMessageEncoder.WriteMessage(
                        this.message,
                        this.outputStream,
                        this.mtomBoundary
                    );
        ...
        IAsyncResult BeginWriteStreamedMessage(
            HttpResponseMessage httpResponseMessage,
            TimeSpan timeout,
            AsyncCallback callback,
            object state
        ...
        {
            return new WriteStreamedMessageAsyncResult(
                timeout,
                this,
                httpResponseMessage,
                callback,
        ...
        class HttpOutputByteArrayContent : ByteArrayContent
        {
            ...
            public HttpOutputByteArrayContent(
                byte[] content,
                int offset,
                int count,
                BufferManager bufferManager
            ...
            protected override Task<Stream> CreateContentReadStreamAsync()
            {
                return base.CreateContentReadStreamAsync()
                    .ContinueWith<Stream>(t => new HttpOutputByteArrayContentStream(
                        t.Result,
                        this
                    ));
            }
            ...
            class HttpOutputByteArrayContentStream : DelegatingStream
            {
                ...
                public HttpOutputByteArrayContentStream(
                    Stream innerStream,
                    HttpOutputByteArrayContent content
                )
                    : base(innerStream)
        ...
        class WriteStreamedMessageAsyncResult : AsyncResult
        {
            ...
            public WriteStreamedMessageAsyncResult(
                TimeSpan timeout,
                HttpOutput httpOutput,
                HttpResponseMessage httpResponseMessage,
                AsyncCallback callback,
            ...
            bool HandleWriteStreamedMessage(IAsyncResult result)
            {
                if (this.httpResponseMessage == null)
                {
                    if (result == null)
                    {
                        MtomMessageEncoder mtomMessageEncoder =
                            httpOutput.messageEncoder as MtomMessageEncoder;
                        if (mtomMessageEncoder == null)
                        {
                            result = httpOutput.messageEncoder
                                .BeginWriteMessage(
                                    httpOutput.message,
                        ...
                        {
                            result = mtomMessageEncoder.BeginWriteMessage(
                                httpOutput.message,
                                httpOutput.outputStream,
                                httpOutput.mtomBoundary,
                                onWriteStreamedMessage,
                                this
                            );
                        }
                ...
                else
                {
                    ...
                    if (result == null)
                    {
                        Fx.Assert(
                            ...
                            "httpOutput.httpResponseMessage.Content should not be null."
                        );

                        if (content != null)
                        {
                            result = content.BeginWriteToStream(
                                httpOutput.outputStream,
                                onWriteStreamedMessage,
                                this
                            );
            ...
            static void OnWriteStreamedMessage(IAsyncResult result)
            {
                ...
                WriteStreamedMessageAsyncResult thisPtr = (WriteStreamedMessageAsyncResult)
                    result.AsyncState;
                Exception completionException = null;
                bool completeSelf = false;
        ...
        )
        {
            ...
            try
            {
                ...
                IAsyncResult result = new SendAsyncResult(
                    this,
                    httpResponseMessage,
                    suppressEntityBody,
                    timeout,
        ...
        public void Send(HttpResponseMessage httpResponseMessage, TimeSpan timeout)
        {
            ...
            else
            {
                if (this.IsChannelBindingSupportEnabled)
                {
                    ...
                    Fx.Assert(
                        buffer.Count != 0,
                        "We should always have an entity body in this case..."
                    );
        ...
        {
            HttpOutputByteArrayContent content =
                httpResponseMessage.Content as HttpOutputByteArrayContent;
            if (content == null)
            {
        ...
        void TraceSend()
        {
            if (DiagnosticUtility.ShouldTraceInformation)
            {
                TraceUtility.TraceEvent(
                    ...
                    new MessageTraceRecord(this.message),
                    this,
                    null
                );
            }
        ...
        class SendAsyncResult : AsyncResult
        {
            ...
            bool WriteMessage(bool isStillSynchronous)
            {
                ...
                if (httpOutput.streamed)
                {
                    if (isStillSynchronous)
                    {
                        ...
                        {
                            onWriteStreamedMessageLater = new Action<object>(
                                OnWriteStreamedMessageLater
                            );
                        }
                ...
                else
                {
                    ...
                    IAsyncResult writeResult = httpOutput.outputStream
            ...
            bool HandleWriteStreamedMessage(IAsyncResult result)
            {
                if (result == null)
                {
                    result = httpOutput.BeginWriteStreamedMessage(
            ...
            static void OnGetOutputStream(IAsyncResult result)
            {
                ...
                try
                {
                    ...
                    if (
                        !thisPtr.httpOutput.streamed
                        && thisPtr.httpOutput.IsChannelBindingSupportEnabled
                    )
                    {
                        thisPtr.buffer = thisPtr.httpOutput
...
#pragma warning suppress 56500 // Microsoft, transferring exception to another thread
        ...
        {
            return new WebRequestHttpOutput(
                httpWebRequest,
                settings,
                message,
        ...
        {
            return new ListenerResponseHttpOutput(
        ...
        class WebRequestHttpOutput : HttpOutput
        {
            ...
            {
                if (
                    contentLength == 0 // work around whidbey issue with setting ContentLength - (see MB36881)
                    && !this.enableChannelBindingSupport
                ) //When ChannelBinding is enabled, content length isn't supported
                {
            ...
            protected override IAsyncResult BeginGetOutputStream(
                AsyncCallback callback,
                object state
            )
            {
            ...
            protected override bool PrepareHttpSend(Message message)
            {
                ...
                if (action != null)
                {
                    ...
                    action = string.Format(
                        CultureInfo.InvariantCulture,
                        "\"{0}\"",
                        UrlUtility.UrlPathEncode(action)
                    );
                }
                ...
                if (message.Properties.TryGetValue(HttpRequestMessageProperty.Name, out property))
                {
                    ...
                    for (int i = 0; i < requestHeaders.Count; i++)
                    {
                        ...
                        if (string.Compare(name, "accept", StringComparison.OrdinalIgnoreCase) == 0)
                        {
                            ...
                            string.Compare(name, "connection", StringComparison.OrdinalIgnoreCase)
                            == 0
                        )
                        {
                            if (
                                value.IndexOf("keep-alive", StringComparison.OrdinalIgnoreCase)
                                != -1
                            )
                            {
                            ...
                            string.Compare(name, "SOAPAction", StringComparison.OrdinalIgnoreCase)
                            == 0
                        )
                        {
                            if (action == null)
                        ...
                        )
                        {
                            ...
                            string.Compare(name, "expect", StringComparison.OrdinalIgnoreCase) == 0
                        )
                        {
                            if (
                                value
                                    .ToUpperInvariant()
                                    .IndexOf("100-CONTINUE", StringComparison.OrdinalIgnoreCase)
                                != -1
                            )
                            {
                            ...
                            string.Compare(name, "host", StringComparison.OrdinalIgnoreCase) == 0
                        )
                        {
                            // this should be controlled through Via
                        }
                        else if (
                            string.Compare(name, "referer", StringComparison.OrdinalIgnoreCase) == 0
                        )
                        {
                        ...
                        )
                        {
                            ...
                            string.Compare(name, "user-agent", StringComparison.OrdinalIgnoreCase)
                            == 0
                        )
                        {
                        ...
                        )
                        {
                            ...
                            string.Compare(name, "date", StringComparison.OrdinalIgnoreCase) == 0
                        )
                        {
                        ...
                        )
                        {
                            ...
                            string.Compare(name, "range", StringComparison.OrdinalIgnoreCase) == 0
                        )
                        {
                        ...
                        if (message.Version.Addressing == AddressingVersion.None)
                        {
                            ...
                            if (wasContentTypeSet)
                            {
                                ...
                                )
                                {
                                    try
                                    {
                                        ContentType parsedContentType = new ContentType(
                                            httpWebRequest.ContentType
                                        );
                                        if (parsedContentType.Parameters.ContainsKey("action"))
                                        {
                                            string value = string.Format(
                                                CultureInfo.InvariantCulture,
                                                "\"{0}\"",
                                                parsedContentType.Parameters["action"]
                                            );
                                            if (
                                                string.Compare(
                                                    value,
                            ...
                            {
                                httpWebRequest.ContentType = string.Format(
                                    CultureInfo.InvariantCulture,
                                    "{0}; action={1}",
                                    httpWebRequest.ContentType,
                                    action
            ...
            {
                static AsyncCallback onGetRequestStream = Fx.ThunkCallback(
                    new AsyncCallback(OnGetRequestStream)
                );
                HttpOutput httpOutput;
                HttpWebRequest httpWebRequest;
                Stream outputStream;
                ...
                void CompleteGetRequestStream(IAsyncResult result)
                {
                    try
                    {
                        ...
                        this.outputStream = new WebRequestOutputStream(
                            httpWebRequest.EndGetRequestStream(result, out context),
                            httpWebRequest,
                            this.httpOutput
                        );
                        this.channelBindingToken = ChannelBindingUtility.GetToken(context);
                ...
                public static Stream End(
                    IAsyncResult result,
                    out ChannelBinding channelBindingToken
                )
                {
                    GetOutputStreamAsyncResult thisPtr =
                        AsyncResult.End<GetOutputStreamAsyncResult>(result);
                ...
                static void OnGetRequestStream(IAsyncResult result)
                {
                    ...
                    GetOutputStreamAsyncResult thisPtr = (GetOutputStreamAsyncResult)
                        result.AsyncState;
...
#pragma warning suppress 56500 // Microsoft, transferring exception to another thread
        ...
        class ListenerResponseHttpOutput : HttpOutput
        {
            ...
            [System.Diagnostics.CodeAnalysis.SuppressMessage(
                ...
                "CA2214",
                Justification = "No one else is inhiriting from this class."
            )]
            ...
            protected override bool PrepareHttpSend(Message message)
            {
                ...
                HttpResponseMessageProperty responseProperty = message.Properties
                ...
                if (httpResponseMessagePropertyFound)
                {
                    ...
                    for (int i = 0; i < responseHeaders.Count; i++)
                    {
                        ...
                        {
                            if (httpMethodIsHead || !responseProperty.SuppressEntityBody)
                            {
            ...
            {
                if (
                    string.Compare(name, "WWW-Authenticate", StringComparison.OrdinalIgnoreCase)
                    == 0
                )
                {
    ...
    static class HttpChannelUtilities
    {
        internal static class StatusDescriptionStrings
        {
            ...
            internal const string HttpStatusServiceActivationException =
                "System.ServiceModel.ServiceActivationException";
        }

        internal static class ObsoleteDescriptionStrings
        {
            internal const string PropertyObsoleteUseAllowCookies =
                "This property is obsolete. To enable Http CookieContainer, use the AllowCookies property instead.";
            internal const string TypeObsoleteUseAllowCookies =
        ...
        internal const string HttpStatusCodeExceptionKey =
            "System.ServiceModel.Channels.HttpInput.HttpStatusCode";
        internal const string HttpStatusDescriptionExceptionKey =
            "System.ServiceModel.Channels.HttpInput.HttpStatusDescription";
            ...
            switch (listenerException.NativeErrorCode)
            {
                case UnsafeNativeMethods.ERROR_NO_TRACKING_SERVICE:
                    return new CommunicationException(
                        SR.GetString(SR.HttpNoTrackingService, listenerException.Message),
                        listenerException
                    );

                case UnsafeNativeMethods.ERROR_NETNAME_DELETED:
                    return new CommunicationException(
                        SR.GetString(SR.HttpNetnameDeleted, listenerException.Message),
                        listenerException
                    );
        ...
        public static void EnsureHttpRequestMessageContentNotNull(
            HttpRequestMessage httpRequestMessage
        )
        {
        ...
        public static void EnsureHttpResponseMessageContentNotNull(
            HttpResponseMessage httpResponseMessage
        )
        {
        ...
        public static bool IsEmpty(HttpResponseMessage httpResponseMessage)
        {
            return httpResponseMessage.Content == null
                || (
                    httpResponseMessage.Content.Headers.ContentLength.HasValue
                    && httpResponseMessage.Content.Headers.ContentLength.Value == 0
                );
        }
        ...
        {
            SecurityMessageProperty securityProperty = factory.CreateReplySecurityProperty(
                webRequest,
                webResponse
            );
        ...
        public static void CopyHeadersToNameValueCollection(
            NameValueCollection headers,
            NameValueCollection destination
        )
        {
        ...
        static NetworkCredential GetCredentialCore(
            AuthenticationSchemes authenticationScheme,
            SecurityTokenProviderContainer credentialProvider,
            TimeSpan timeout,
            out TokenImpersonationLevel impersonationLevel,
        ...
        )
        {
            ...
            switch (authenticationScheme)
            {
                case AuthenticationSchemes.Basic:
                    result = TransportSecurityHelpers.GetUserNameCredential(
                        credentialProvider,
                        timeout
                    );
                ...
                case AuthenticationSchemes.Digest:
                    result = TransportSecurityHelpers.GetSspiCredential(
                        credentialProvider,
                        timeout,
                        out impersonationLevel,
                        out authenticationLevel
        ...
        )
        {
            ...
            if (
                webException.Status == WebExceptionStatus.Success
            ...
            if (response == null)
            {
                Exception convertedException = ConvertWebException(
                    webException,
                    request,
                    abortReason
                );
            ...
            {
                const string httpSysRequestQueueNotFound =
                ...
                if (notFoundTestString != null)
                {
                    ...
                    if (
                        bytesRead == notFoundTestString.Length
            ...
            switch (webException.Status)
            {
                ...
                case WebExceptionStatus.SecureChannelFailure:
                    return new SecurityNegotiationException(
                        SR.GetString(SR.SecureChannelFailure, request.RequestUri.Authority),
                        webException
                    );
                case WebExceptionStatus.TrustFailure:
                    return new SecurityNegotiationException(
                        SR.GetString(SR.TrustFailure, request.RequestUri.Authority),
                        webException
                    );
                case WebExceptionStatus.Timeout:
                    return new TimeoutException(
                        CreateRequestTimedOutMessage(request),
                        webException
                    );
                case WebExceptionStatus.ReceiveFailure:
                    return new CommunicationException(
                        SR.GetString(SR.HttpReceiveFailure, request.RequestUri),
                        webException
                    );
                case WebExceptionStatus.SendFailure:
                    return new CommunicationException(
                        SR.GetString(SR.HttpSendFailure, request.RequestUri),
                        webException
                    );
                ...
                case WebExceptionStatus.ProtocolError:
                    ...
                    Fx.Assert(
                        response != null,
                        "'response' MUST NOT be NULL for WebExceptionStatus=='ProtocolError'."
                    );
                    if (
        ...
        )
        {
            ...
            {
                return SocketConnection.ConvertTransferException(
                    (SocketException)ioException.InnerException,
                    receiveTimeout,
                    ioException
                );
            }
            ...
            return new CommunicationException(
                SR.GetString(SR.HttpTransferError, ioException.Message),
                ioException
            );
        }
            ...
            switch (webException.Status)
            {
                case WebExceptionStatus.RequestCanceled:
                    return TraceResponseException(
                        new CommunicationObjectAbortedException(
                            SR.GetString(SR.HttpRequestAborted, response.ResponseUri),
                            webException
                        )
                    );
                ...
                case WebExceptionStatus.Timeout:
                    return TraceResponseException(
                        new TimeoutException(
                            SR.GetString(
                                SR.HttpResponseTimedOut,
                                response.ResponseUri,
                                TimeSpan.FromMilliseconds(response.GetResponseStream().ReadTimeout)
                            ),
                            webException
                        )
                    );
        ...
        )
        {
            switch (abortReason)
            {
                case HttpAbortReason.Aborted:
                    return new CommunicationObjectAbortedException(
                        SR.GetString(SR.HttpRequestAborted, request.RequestUri),
                        webException
                    );
                ...
                default:
                    return new CommunicationException(
                        SR.GetString(SR.HttpTransferError, webException.Message),
                        webException
                    );
            }
        }
        ...
        )
        {
            ...
            return new CommunicationException(
                SR.GetString(SR.HttpTransferError, exception.Message),
                exception
            );
        }
        ...
        )
        {
            ...
            if (webException.InnerException is IOException)
            {
                return CreateRequestIOException(
                    (IOException)webException.InnerException,
                    request,
                    webException
                );
            }
            ...
            if (webException.InnerException is SocketException)
            {
                return SocketConnectionInitiator.ConvertConnectException(
                    (SocketException)webException.InnerException,
                    request.RequestUri,
                    TimeSpan.MaxValue,
                    webException
                );
        ...
        public static Exception CreateNullReferenceResponseException(
            NullReferenceException nullReferenceException
        )
        {
            return TraceResponseException(
                new ProtocolException(
                    SR.GetString(SR.NullReferenceOnHttpResponse),
        ...
        static string GetResponseStreamString(HttpWebResponse webResponse, out int bytesRead)
        {
            ...
            byte[] responseBuffer = DiagnosticUtility.Utility
        ...
        static Exception TraceResponseException(Exception exception)
        {
            if (DiagnosticUtility.ShouldTraceError)
            {
                TraceUtility.TraceEvent(
                    ...
                    TraceCode.HttpChannelUnexpectedResponse,
                    SR.GetString(SR.TraceCodeHttpChannelUnexpectedResponse),
                    (object)null,
                    exception
                );
            }
        ...
        public static void ValidateDigestCredential(
            ref NetworkCredential credential,
        ...
        )
        {
            ...
            if (
                (200 <= (int)response.StatusCode && (int)response.StatusCode < 300)
                || response.StatusCode == HttpStatusCode.InternalServerError
            )
            {
                if (
                ...
                else
                {
                    ...
                    try
                    {
                        ...
                        else if (response.ContentLength != 0)
                        {
                            ...
                            {
                                int bytesRead;
                                String responseExcerpt = GetResponseStreamString(
                                    response,
                                    out bytesRead
                                );
        ...
        public static bool GetHttpResponseTypeAndEncodingForCompression(
        ...
        )
        {
            ...
            if (
                ...
                || (
                    isSession = string.Equals(
                        BinaryVersion.GZipVersion1.SessionContentType,
                        contentType,
                        StringComparison.OrdinalIgnoreCase
                    )
                )
                || (
                    isDeflate = (
                        ...
                        || (
                            isSession = string.Equals(
                                BinaryVersion.DeflateVersion1.SessionContentType,
                                contentType,
                                StringComparison.OrdinalIgnoreCase
                            )
                        )
            ...
            {
                contentType = isSession
                    ? BinaryVersion.Version1.SessionContentType
                    : BinaryVersion.Version1.ContentType;
                contentEncoding = isDeflate
                    ? MessageEncoderCompressionHandler.DeflateContentEncoding
                    : MessageEncoderCompressionHandler.GZipContentEncoding;
                return true;
            }
            return false;
        }
    ...
    class HttpRequestMessageHttpInput : HttpInput, HttpRequestMessageProperty.IHttpHeaderProvider
    {
        ...
        public HttpRequestMessageHttpInput(
            HttpRequestMessage httpRequestMessage,
            IHttpTransportFactorySettings settings,
            bool enableChannelBinding,
            ChannelBinding channelBinding
        ...
        protected override bool HasContent
        {
            get
            {
                ...
                return this.httpRequestMessage.Content.Headers.ContentLength == null
                    || this.httpRequestMessage.Content.Headers.ContentLength.Value > 0;
            }
        }
        ...
        protected override string ContentTypeCore
        {
            get
            {
                ...
                return this.httpRequestMessage.Content.Headers.ContentType == null
                    ? null
                    : this.httpRequestMessage.Content.Headers.ContentType.MediaType;
            }
        }
