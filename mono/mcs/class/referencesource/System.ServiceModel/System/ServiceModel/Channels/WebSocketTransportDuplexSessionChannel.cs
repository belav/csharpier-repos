...
namespace System.ServiceModel.Channels
{
    ...
    abstract class WebSocketTransportDuplexSessionChannel : TransportDuplexSessionChannel
    {
        ...
        {
            Fx.Assert(
                channelListener.WebSocketSettings != null,
                "channelListener.WebSocketTransportSettings should not be null."
            );
        ...
        public WebSocketTransportDuplexSessionChannel(
            ...
            : base(
                ...
                channelFactory,
                EndpointAddress.AnonymousAddress,
                channelFactory.MessageVersion.Addressing.AnonymousUri,
                remoteAddresss,
                via
            )
        {
            Fx.Assert(
                channelFactory.WebSocketSettings != null,
                "channelFactory.WebSocketTransportSettings should not be null."
            );
        ...
        protected WebSocket WebSocket
        {
            ...
            set
            {
                ...
                Fx.Assert(
                    this.webSocket == null,
                    "webSocket should not be set before this set call."
                );
        ...
        {
            get { return this.transportFactorySettings; }
        }
        ...
        {
            set { this.shouldDisposeWebSocketAfterClosed = value; }
        }
        ...
        protected override void CompleteClose(TimeSpan timeout)
        {
            ...
            closeTask.Wait(
                ...
                WebSocketHelper.CloseOperation
            );
        ...
        protected override AsyncCompletionResult StartWritingBufferedMessage(
            ...
            TimeSpan timeout,
            Threading.WaitCallback callback,
            object state
        )
        {
            ...
            IOThreadCancellationTokenSource cancellationTokenSource =
                new IOThreadCancellationTokenSource(helper.RemainingTime());
        ...
        )
        {
            ...
            IOThreadCancellationTokenSource cancellationTokenSource =
                new IOThreadCancellationTokenSource(timeout);
        ...
        {
            Fx.Assert(
                this.cleanupStatus == WebSocketHelper.OperationFinished,
        ...
        static WebSocketMessageType GetWebSocketMessageType(Message message)
        {
            ...
            if (
                message.Properties.TryGetValue<WebSocketMessageProperty>(
        ...
        static void StreamWriteCallback(IAsyncResult ar)
        {
            ...
            WebSocketTransportDuplexSessionChannel thisPtr =
                (WebSocketTransportDuplexSessionChannel)ar.AsyncState;
        ...
        {
            static readonly Action<object> onAsyncReceiveCancelled = Fx.ThunkCallback<object>(
            ...
            )
            {
                ...
                this.properties =
                    requestMessage == null
                        ? null
                        : new ReadOnlyDictionary<string, object>(requestMessage.Properties);
            ...
            public AsyncReceiveResult BeginReceive(
                TimeSpan timeout,
                WaitCallback callback,
                object state
            )
            ...
            public Message EndReceive()
            {
                ...
                else
                {
                    ...
                    Fx.Assert(
                        this.asyncReceiveState == AsyncReceiveState.Finished,
                        "this.asyncReceiveState is not AsyncReceiveState.Finished: "
            ...
            async Task ReadBufferedMessageAsync()
            {
                ...
                try
                {
                    ...
                    do
                    {
                        try
                        {
                            ...
                            if (receivedByteCount >= internalBuffer.Length && !result.EndOfMessage)
                            {
                                ...
                                {
                                    this.pendingException = FxTrace.Exception.AsError(
                                ...
                                int newSize = (int)
                                    Math.Min(
                                        ((double)internalBuffer.Length) * 2,
                                        this.maxBufferSize
                                    );
                            ...
                            if (TD.WebSocketAsyncReadStopIsEnabled())
                            {
                                TD.WebSocketAsyncReadStop(
                                    this.webSocket.GetHashCode(),
                                    receivedByteCount,
                                    TraceUtility.GetRemoteEndpointAddressPort(
                    ...
                    try
                    {
                        ...
                        this.pendingMessage = this.PrepareMessage(
                            result,
                            buffer,
                            receivedByteCount
                        );
                ...
                catch (Exception ex)
                {
                    ...
                    this.pendingException = WebSocketHelper.ConvertAndTraceException(
                        ex,
                        TimeSpan.MaxValue,
                        WebSocketHelper.ReceiveOperation
                    );
            ...
            public AsyncReceiveResult BeginWaitForMessage(
                TimeSpan timeout,
                Threading.WaitCallback callback,
                object state
            )
            ...
            {
                Fx.Assert(
                    this.receiveTask == null || this.receiveTask.Task.IsCompleted,
                ...
                Fx.Assert(
                    currentState == AsyncReceiveState.Finished,
                    "currentState is not AsyncReceiveState.Finished: " + currentState
                );
            ...
            )
            {
                ...
                if (this.handshakeSecurityMessageProperty != null)
                {
                    messageProperties.Security = (SecurityMessageProperty)
                        this.handshakeSecurityMessageProperty.CreateCopy();
                }
            }
                    ...
                    )
                    {
                        if (result.MessageType == WebSocketMessageType.Binary)
                        {
                            message.Headers.Action =
                                WebSocketTransportSettings.BinaryMessageReceivedAction;
                        }
                        else
                        {
                            ...
                            Fx.Assert(
                                ...
                                "result.MessageType must be WebSocketMessageType.Text."
                            );
                            message.Headers.Action =
                                WebSocketTransportSettings.TextMessageReceivedAction;
                        }
                    }
        ...
        class WebSocketStream : Stream
        {
            ...
            )
            {
                Fx.Assert(
                    ...
                    "messageSource should not be null in read case."
                );
                        ...
                        t =>
                        {
                            ...
                            if (TD.WebSocketAsyncReadStopIsEnabled())
                            {
                                TD.WebSocketAsyncReadStop(
                                    ...
                                    this.messageSource != null
                                        ? TraceUtility.GetRemoteEndpointAddressPort(
                                            this.messageSource.RemoteEndpointMessageProperty
                                        )
                                        : string.Empty
                                );
                            }
            ...
            )
            {
                ...
                IOThreadCancellationTokenSource cancellationTokenSource =
                    new IOThreadCancellationTokenSource(this.WriteTimeout);
            ...
            public async void WriteEndOfMessageAsync(
                TimeSpan timeout,
                WaitCallback callback,
                object state
            )
            ...
            )
            {
                ...
                {
                    throw FxTrace.Exception.AsError(
                        new ProtocolException(SR.GetString(SR.WebSocketUnexpectedCloseMessageError))
                    );
                }
            }
            ...
            {
                int bytesToCopy =
                    this.initialReadBuffer.Count > count ? count : this.initialReadBuffer.Count;
                Buffer.BlockCopy(
                    this.initialReadBuffer.Array,
                    this.initialReadBuffer.Offset,
                    buffer,
                    offset,
                    bytesToCopy
                );
                this.initialReadBuffer = new ArraySegment<byte>(
                    this.initialReadBuffer.Array,
                    this.initialReadBuffer.Offset + bytesToCopy,
                    this.initialReadBuffer.Count - bytesToCopy
                );
                return bytesToCopy;
            }
            ...
            void Cleanup(TimeSpan timeout)
            {
                if (this.isForRead)
                {
                    if (
                        Interlocked.CompareExchange(
                            ref this.messageSourceCleanState,
                            WebSocketHelper.OperationFinished,
                            WebSocketHelper.OperationNotStarted
                        ) == WebSocketHelper.OperationNotStarted
                    )
                    {
                        ...
                        catch (Exception ex)
                        {
                            ...
                            // WebSocket object.
                            pendingException = WebSocketHelper.ConvertAndTraceException(
                                ex,
                                timeout,
                                WebSocketHelper.CloseOperation
                            );
        ...
        class WebSocketCloseDetails : IWebSocketCloseDetails
        {
            ...
            {
                get { return this.inputCloseStatus; }
                internal set { this.inputCloseStatus = value; }
            }

            public string InputCloseStatusDescription
            {
                get { return this.inputCloseStatusDescription; }
                internal set { this.inputCloseStatusDescription = value; }
            }

            internal WebSocketCloseStatus OutputCloseStatus
            {
                get { return this.outputCloseStatus; }
            }

            internal string OutputCloseStatusDescription
            {
                get { return this.outputCloseStatusDescription; }
            }
