    ...
    public static class HttpRequestMessageExtensionMethods
    {
        ...
        )
        {
            ...
            Fx.Assert(
                ...
                "The 'header' parameter should never be null or whitespace."
            );
        ...
        internal static IEnumerable<string> GetHeader(
            this HttpRequestMessage httpRequestMessage,
            string header
        )
        {
        ...
        internal static HttpRequestMessage CreateBufferedCopy(
            this HttpRequestMessage httpRequestMessage
        )
        {
            Fx.Assert(
            ...
            bufferedHttpRequestMessage.RequestUri =
                httpRequestMessage.RequestUri != null
                    ? new Uri(httpRequestMessage.RequestUri, string.Empty)
                    : null;
            bufferedHttpRequestMessage.Method =
                httpRequestMessage.Method != null
                    ? new HttpMethod(httpRequestMessage.Method.Method)
                    : null;
            bufferedHttpRequestMessage.Version = (Version)(
                httpRequestMessage.Version != null ? httpRequestMessage.Version.Clone() : null
            );
            ...
            foreach (KeyValuePair<string, object> header in httpRequestMessage.Properties)
            {
                ...
                object value =
                    messageProperty != null ? messageProperty.CreateCopy() : header.Value;

                bufferedHttpRequestMessage.Properties.Add(header.Key, value);
            }

            bufferedHttpRequestMessage.Content = CreateBufferedCopyOfContent(
        ...
        internal static void CopyPropertiesFromMessage(
            this HttpRequestMessage httpRequestMessage,
            Message message
        )
        {
        ...
        internal static void AddHeaderWithoutValidation(
        ...
        )
        {
            Fx.Assert(
                ...
                "The 'messageProperties' parameter should not be null."
            );
            ...
            foreach (KeyValuePair<string, object> property in messageProperties)
            {
                ...
                if (
                    (
                        value is HttpRequestMessageProperty
                        && string.Equals(
                            key,
        ...
        )
        {
            ...
            Fx.Assert(
                headerInfo.IsRequestHeader || headerInfo.IsContentHeader,
                "The 'headerInfo' parameter should be either a request or content header."
            );
            ...
            if (values == null && headerInfo.IsContentHeader && httpRequestMessage.Content != null)
            {
