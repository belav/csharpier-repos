...
namespace System.ServiceModel.Channels
{
    ...
    static class TransactionPolicyStrings
    {
        ...
        public const string OptionalNamespaceLegacy =
            "http://schemas.xmlsoap.org/ws/2002/12/policy";
        public const string WsatTransactionsPrefix = AtomicTransactionExternalStrings.Prefix;
        public const string WsatTransactionsNamespace10 =
            AtomicTransactionExternal10Strings.Namespace;
        public const string WsatTransactionsNamespace11 =
    ...
    public sealed class TransactionFlowBindingElementImporter : IPolicyImportExtension
    {
        ...
        )
        {
            ...
            TransactionProtocol agreedTransactionProtocol =
                TransactionFlowDefaults.TransactionProtocol;
            ...
            {
                ICollection<XmlElement> operationAssertions = context.GetOperationBindingAssertions(
                    operation
                );
                foreach (XmlElement element in operationAssertions)
                {
                    if (
                        element.NamespaceURI == TransactionPolicyStrings.OleTxTransactionsNamespace
                    ...
                    )
                    {
                        ...
                        TrackAgreement(
                            ref everyoneAgreesAboutTransactions,
                            txFlow,
                            ref agreedTransactions,
                            ref anOperationCaresAboutTransactions
                        );
                        TrackAgreementTransactionProtocol(
                            ref everyoneAgreesAboutTransactionProtocol,
                        ...
                        element.NamespaceURI == TransactionPolicyStrings.WsatTransactionsNamespace10
                    ...
                    )
                    {
                        ...
                        element.NamespaceURI == TransactionPolicyStrings.WsatTransactionsNamespace11
                        && element.LocalName == TransactionPolicyStrings.WsatTransactionsLocal
                    )
                    {
                        wsatTransactionsAssertion = element;
            ...
            if (anOperationCaresAboutTransactions)
            {
                ...
                if (
                    anOperationCaresAboutTransactionProtocol
                    && everyoneAgreesAboutTransactionProtocol
                )
        ...
        void UpdateTransactionFlowAtribute(
        ...
        static void TrackAgreement(
            ref bool everyoneAgrees,
            TransactionFlowOption option,
            ref TransactionFlowOption agreedOption,
            ref bool anOperationCares
        )
        {
            if (!anOperationCares)
            {
        ...
        static void TrackAgreementTransactionProtocol(
            ref bool everyoneAgrees,
            TransactionProtocol option,
            ref TransactionProtocol agreedOption,
            ref bool anOperationCares
        )
        {
            if (!anOperationCares)
        ...
        {
            string value12 = elem.GetAttribute(
                TransactionPolicyStrings.OptionalLocal,
                MetadataStrings.WSPolicy.NamespaceUri
            );
            string value15 = elem.GetAttribute(
                TransactionPolicyStrings.OptionalLocal,
        ...
        {
            string valueLegacy = elem.GetAttribute(
                TransactionPolicyStrings.OptionalLocal,
