...
namespace System.ServiceModel.Channels
{
    ...
    static class PrivacyNoticePolicyStrings
    {
        ...
        public const string PrivacyNoticeNamespace =
    ...
    public sealed class PrivacyNoticeBindingElementImporter : IPolicyImportExtension
    {
        ...
        )
        {
            ...
            XmlElement privacyNoticeAssertion = PolicyConversionContext.FindAssertion(
            ...
            if (privacyNoticeAssertion != null)
            {
                ...
                string versionString = privacyNoticeAssertion.GetAttribute(
