...
namespace System.ServiceModel.Configuration
{
    ...
    public partial class HttpTransportElement : TransportElement
    {
        ...
        [ConfigurationProperty(
            ConfigurationStrings.RequestInitializationTimeout,
            DefaultValue = HttpTransportDefaults.RequestInitializationTimeoutString
        )]
        ...
        [ConfigurationProperty(
            ConfigurationStrings.AuthenticationScheme,
        ...
        [ConfigurationProperty(
            ConfigurationStrings.DecompressionEnabled,
        ...
        [ConfigurationProperty(
            ConfigurationStrings.KeepAliveEnabled,
        ...
        [IntegerValidator(
            MinValue = 0,
            MaxValue = HttpTransportDefaults.MaxPendingAcceptsUpperLimit
        )]
        ...
        [ConfigurationProperty(
            ...
            DefaultValue = HttpTransportDefaults.MessageHandlerFactory
        )]
        ...
        public HttpMessageHandlerFactoryElement MessageHandlerFactory
        {
            get
            {
                return (HttpMessageHandlerFactoryElement)
        ...
        [ConfigurationProperty(
            ConfigurationStrings.ProxyAuthenticationScheme,
        ...
        public AuthenticationSchemes ProxyAuthenticationScheme
        {
            get
            {
                return (AuthenticationSchemes)base[ConfigurationStrings.ProxyAuthenticationScheme];
            }
        ...
        [ConfigurationProperty(
            ConfigurationStrings.UnsafeConnectionNtlmAuthentication,
        ...
        public WebSocketTransportSettingsElement WebSocketSettings
        {
            get
            {
                return (WebSocketTransportSettingsElement)
        ...
        public override void ApplyConfiguration(BindingElement bindingElement)
        {
            ...
            if (this.MessageHandlerFactory != null)
            {
                binding.MessageHandlerFactory =
                    HttpMessageHandlerFactory.CreateFromConfigurationElement(
...
#pragma warning suppress 56506 // Microsoft, base.CopyFrom() validates the argument
        ...
        protected internal override void InitializeFrom(BindingElement bindingElement)
        {
            ...
            SetPropertyValueIfNotDefaultValue(
                ConfigurationStrings.RequestInitializationTimeout,
                source.RequestInitializationTimeout
            );
            SetPropertyValueIfNotDefaultValue(
                ConfigurationStrings.TransferMode,
                source.TransferMode
