...
namespace System.ServiceModel.Configuration
{
    ...
    public partial class BehaviorsSection : ConfigurationSection
    {
        ...
        public EndpointBehaviorElementCollection EndpointBehaviors
        {
            get
            {
                return (EndpointBehaviorElementCollection)
                    base[ConfigurationStrings.EndpointBehaviors];
            }
        }
        ...
        public ServiceBehaviorElementCollection ServiceBehaviors
        {
            get
            {
                return (ServiceBehaviorElementCollection)
                    base[ConfigurationStrings.ServiceBehaviors];
            }
        }
        ...
        {
            return (BehaviorsSection)
                ConfigurationHelpers.UnsafeGetAssociatedSection(
                    evalContext,
                    ConfigurationStrings.BehaviorsSectionPath
                );
        }
        ...
        internal static void ValidateEndpointBehaviorReference(
        ...
        )
        {
            ...
            {
                Fx.Assert(
                    "ValidateBehaviorReference() should only called with valid ContextInformation"
                );
            ...
            {
                BehaviorsSection behaviors = (BehaviorsSection)
                    ConfigurationHelpers.UnsafeGetAssociatedSection(
                        evaluationContext,
                        ConfigurationStrings.BehaviorsSectionPath
                    );
        ...
        [SecuritySafeCritical]
        internal static void ValidateServiceBehaviorReference(
            string behaviorConfiguration,
            ContextInformation evaluationContext,
            ConfigurationElement configurationElement
        )
