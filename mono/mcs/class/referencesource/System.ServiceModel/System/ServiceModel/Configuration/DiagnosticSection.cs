...
namespace System.ServiceModel.Configuration
{
    ...
    public sealed partial class DiagnosticSection : ConfigurationSection
    {
        ...
        [ConfigurationProperty(
            ConfigurationStrings.MessageLogging,
        ...
        [ConfigurationProperty(
            ConfigurationStrings.EndToEndTracing,
            Options = ConfigurationPropertyOptions.None
        )]
        ...
        [ConfigurationProperty(
            ...
            DefaultValue = PerformanceCounterScope.Default
        )]
        ...
        [ConfigurationProperty(
            ...
            DefaultValue = "{c651f5f6-1c0d-492e-8ae1-b4efd7c9d503}"
        )]
        ...
        internal static DiagnosticSection GetSection()
        {
            return (DiagnosticSection)
                ConfigurationHelpers.GetSection(ConfigurationStrings.DiagnosticSectionPath);
        }
        ...
        {
            return (DiagnosticSection)
                ConfigurationHelpers.UnsafeGetSection(ConfigurationStrings.DiagnosticSectionPath);
        }
        ...
        {
            return (DiagnosticSection)
                ConfigurationHelpers.UnsafeGetSectionNoTrace(
                    ConfigurationStrings.DiagnosticSectionPath
                );
        }
