...
namespace System.ServiceModel.Configuration
{
    ...
    public partial class SecurityElementBase : BindingElementExtensionElement
    {
        ...
        {
            get { return this.failedSecurityBindingElement != null; }
        }
        ...
        [ConfigurationProperty(
            ...
            DefaultValue = SecurityBindingElement.defaultAlgorithmSuiteString
        )]
        ...
        [ConfigurationProperty(
            ...
            DefaultValue = AsymmetricSecurityBindingElement.defaultAllowSerializedSigningTokenOnReply
        )]
        ...
        [ConfigurationProperty(
            ...
            DefaultValue = SecurityBindingElement.defaultEnableUnsecuredResponse
        )]
        ...
        [ConfigurationProperty(
            ConfigurationStrings.AuthenticationMode,
        ...
        [ConfigurationProperty(
            ...
            DefaultValue = SecurityTokenParameters.defaultRequireDerivedKeys
        )]
        ...
        [ConfigurationProperty(
            ...
            DefaultValue = SecurityProtocolFactory.defaultSecurityHeaderLayout
        )]
        ...
        [ConfigurationProperty(
            ...
            DefaultValue = SecurityBindingElement.defaultIncludeTimestamp
        )]
        ...
        public IssuedTokenParametersElement IssuedTokenParameters
        {
            get
            {
                return (IssuedTokenParametersElement)
                    base[ConfigurationStrings.IssuedTokenParameters];
            }
        }
        ...
        public LocalClientSecuritySettingsElement LocalClientSettings
        {
            get
            {
                return (LocalClientSecuritySettingsElement)
                    base[ConfigurationStrings.LocalClientSettings];
            }
        }
        ...
        public LocalServiceSecuritySettingsElement LocalServiceSettings
        {
            get
            {
                return (LocalServiceSecuritySettingsElement)
                    base[ConfigurationStrings.LocalServiceSettings];
            }
        }

        [ConfigurationProperty(
            ConfigurationStrings.MessageProtectionOrder,
            DefaultValue = SecurityBindingElement.defaultMessageProtectionOrder
        )]
        ...
        public MessageProtectionOrder MessageProtectionOrder
        {
            get
            {
                return (MessageProtectionOrder)base[ConfigurationStrings.MessageProtectionOrder];
            }
        ...
        public MessageSecurityVersion MessageSecurityVersion
        {
            get
            {
                return (MessageSecurityVersion)base[ConfigurationStrings.MessageSecurityVersion];
            }
        ...
        [ConfigurationProperty(
            ...
            DefaultValue = SecureConversationSecurityTokenParameters.defaultRequireCancellation
        )]
        ...
        [ConfigurationProperty(
            ...
            DefaultValue = SecurityBindingElement.defaultRequireSignatureConfirmation
        )]
        ...
        [ConfigurationProperty(
            ...
            DefaultValue = SecureConversationSecurityTokenParameters.defaultCanRenewSession
        )]
...
#pragma warning restore
            ...
            if (tsbe != null)
            {
                ...
                {
                    SecureConversationSecurityTokenParameters scParameters =
                        tsbe.EndpointSupportingTokenParameters.Endorsing[0]
        ...
        public override void CopyFrom(ServiceModelExtensionElement from)
        {
            ...
            this.willX509IssuerReferenceAssertionBeWritten =
                source.willX509IssuerReferenceAssertionBeWritten;
        }
        ...
        protected internal virtual BindingElement CreateBindingElement(bool createTemplateOnly)
        {
            ...
            switch (this.AuthenticationMode)
            {
                ...
                case AuthenticationMode.AnonymousForSslNegotiated:
                    result = SecurityBindingElement.CreateSslNegotiationBindingElement(
                        false,
                        this.RequireSecurityContextCancellation
                    );
                    break;
                case AuthenticationMode.CertificateOverTransport:
                    result = SecurityBindingElement.CreateCertificateOverTransportBindingElement(
                        this.MessageSecurityVersion
                    );
                    break;
                case AuthenticationMode.IssuedToken:
                    result = SecurityBindingElement.CreateIssuedTokenBindingElement(
                        this.IssuedTokenParameters.Create(createTemplateOnly, this.templateKeyType)
                    );
                    break;
                ...
                case AuthenticationMode.IssuedTokenForSslNegotiated:
                    result = SecurityBindingElement.CreateIssuedTokenForSslBindingElement(
                        this.IssuedTokenParameters.Create(createTemplateOnly, this.templateKeyType),
                        this.RequireSecurityContextCancellation
                    );
                    break;
                case AuthenticationMode.IssuedTokenOverTransport:
                    result = SecurityBindingElement.CreateIssuedTokenOverTransportBindingElement(
                        this.IssuedTokenParameters.Create(createTemplateOnly, this.templateKeyType)
                    );
                    break;
                ...
                case AuthenticationMode.MutualCertificateDuplex:
                    result = SecurityBindingElement.CreateMutualCertificateDuplexBindingElement(
                        this.MessageSecurityVersion
                    );
                    break;
                ...
                case AuthenticationMode.SspiNegotiated:
                    result = SecurityBindingElement.CreateSspiNegotiationBindingElement(
                        this.RequireSecurityContextCancellation
                    );
                    break;
                ...
                case AuthenticationMode.UserNameForSslNegotiated:
                    result = SecurityBindingElement.CreateUserNameForSslBindingElement(
                        this.RequireSecurityContextCancellation
                    );
                    break;
        ...
        protected void AddBindingTemplate(
...
#pragma warning suppress 56500 // covered by FxCOP
        ...
        static bool AreTokenParametersMatching(
            SecurityTokenParameters p1,
            SecurityTokenParameters p2,
            bool skipRequireDerivedKeysComparison,
            bool exactMessageSecurityVersion
        )
        {
            if (p1 == null || p2 == null)
                return false;
            ...
            if (
                skipRequireDerivedKeysComparison == false
                && p1.RequireDerivedKeys != p2.RequireDerivedKeys
            )
                return false;
            ...
            {
                if (
                    ((SslSecurityTokenParameters)p1).RequireClientCertificate
                    != ((SslSecurityTokenParameters)p2).RequireClientCertificate
                )
                    return false;
            }
            else if (p1 is SecureConversationSecurityTokenParameters)
            {
                SecureConversationSecurityTokenParameters sc1 =
                    (SecureConversationSecurityTokenParameters)p1;
                SecureConversationSecurityTokenParameters sc2 =
                    (SecureConversationSecurityTokenParameters)p2;
            ...
            {
                if (
                    ((IssuedSecurityTokenParameters)p1).KeyType
                    != ((IssuedSecurityTokenParameters)p2).KeyType
                )
                    return false;
            }
        ...
        static bool AreTokenParameterCollectionsMatching(
            Collection<SecurityTokenParameters> c1,
            Collection<SecurityTokenParameters> c2,
            bool exactMessageSecurityVersion
        )
        {
        ...
        internal static bool AreBindingsMatching(
            SecurityBindingElement b1,
            SecurityBindingElement b2
        )
        {
        ...
        )
        {
            ...
            if (b1.MessageSecurityVersion != b2.MessageSecurityVersion)
            {
                ...
                if (
                    b1.MessageSecurityVersion.SecurityVersion
                        != b2.MessageSecurityVersion.SecurityVersion
                    || b1.MessageSecurityVersion.TrustVersion
                        != b2.MessageSecurityVersion.TrustVersion
                    || b1.MessageSecurityVersion.SecureConversationVersion
                        != b2.MessageSecurityVersion.SecureConversationVersion
                    || b1.MessageSecurityVersion.SecurityPolicyVersion
                        != b2.MessageSecurityVersion.SecurityPolicyVersion
                )
                {
                    return false;
                }
            ...
            if (
                !AreTokenParameterCollectionsMatching(
                    b1.EndpointSupportingTokenParameters.Endorsing,
                    b2.EndpointSupportingTokenParameters.Endorsing,
                    exactMessageSecurityVersion
                )
            )
                return false;
            ...
            if (
                !AreTokenParameterCollectionsMatching(
                    b1.EndpointSupportingTokenParameters.SignedEncrypted,
                    b2.EndpointSupportingTokenParameters.SignedEncrypted,
                    exactMessageSecurityVersion
                )
            )
                return false;
            ...
            if (
                !AreTokenParameterCollectionsMatching(
                    b1.EndpointSupportingTokenParameters.SignedEndorsing,
                    b2.EndpointSupportingTokenParameters.SignedEndorsing,
                    exactMessageSecurityVersion
                )
            )
                return false;
            ...
            if (
                b1.OperationSupportingTokenParameters.Count
                != b2.OperationSupportingTokenParameters.Count
            )
                return false;
            ...
            foreach (
                ...
                > operation1 in b1.OperationSupportingTokenParameters
            )
            {
                if (!b2.OperationSupportingTokenParameters.ContainsKey(operation1.Key))
                    return false;

                SupportingTokenParameters stp2 = b2.OperationSupportingTokenParameters[
                    operation1.Key
                ];

                if (
                    !AreTokenParameterCollectionsMatching(
                        operation1.Value.Endorsing,
                        stp2.Endorsing,
                        exactMessageSecurityVersion
                    )
                )
                ...
                if (
                    !AreTokenParameterCollectionsMatching(
                        operation1.Value.SignedEndorsing,
                        stp2.SignedEndorsing,
                        exactMessageSecurityVersion
                    )
                )
                    return false;
            ...
            if (ssbe1 != null)
            {
                ...
                if (
                    !AreTokenParametersMatching(
                        ssbe1.ProtectionTokenParameters,
                        ssbe2.ProtectionTokenParameters,
                        false,
                        exactMessageSecurityVersion
                    )
                )
            ...
            if (asbe1 != null)
            {
                ...
                if (
                    !AreTokenParametersMatching(
                        asbe1.InitiatorTokenParameters,
                        asbe2.InitiatorTokenParameters,
                        true,
                        exactMessageSecurityVersion
                    )
                    || !AreTokenParametersMatching(
                        asbe1.RecipientTokenParameters,
                        asbe2.RecipientTokenParameters,
                        true,
                        exactMessageSecurityVersion
                    )
                )
        ...
        protected virtual void AddBindingTemplates(
            Dictionary<AuthenticationMode, SecurityBindingElement> bindingTemplates
        )
        {
        ...
        bool TryInitializeAuthenticationMode(SecurityBindingElement sbe)
        {
            ...
            else
            {
                ...
                Dictionary<AuthenticationMode, SecurityBindingElement> bindingTemplates =
                    new Dictionary<AuthenticationMode, SecurityBindingElement>();
        ...
        void SetIssuedTokenKeyType(SecurityBindingElement sbe)
        {
            ...
            if (
                sbe.EndpointSupportingTokenParameters.Endorsing.Count > 0
        ...
        protected virtual void InitializeNestedTokenParameterSettings(
        ...
        )
        {
            if (sp is SspiSecurityTokenParameters)
                SetPropertyValueIfNotDefaultValue(
                    ConfigurationStrings.RequireSecurityContextCancellation,
                    ((SspiSecurityTokenParameters)sp).RequireCancellation
                );
        ...
        internal void InitializeFrom(BindingElement bindingElement, bool initializeNestedBindings)
        {
            ...
            {
                this.InitializeNestedTokenParameterSettings(
                    sbe.EndpointSupportingTokenParameters.Endorsing[0],
                    initializeNestedBindings
                );
            }
            ...
            {
                this.InitializeNestedTokenParameterSettings(
                    sbe.EndpointSupportingTokenParameters.Signed[0],
                    initializeNestedBindings
                );
            }
            ...
            foreach (SecurityTokenParameters t in sbe.EndpointSupportingTokenParameters.Endorsing)
            {
                ...
                {
                    if (
                        requireDerivedKeys.HasValue
                        && requireDerivedKeys.Value != t.RequireDerivedKeys
                    )
                ...
                if (ssbe.ProtectionTokenParameters != null)
                {
                    ...
                    if (
                        ...
                        && requireDerivedKeys.Value
                            != ssbe.ProtectionTokenParameters.RequireDerivedKeys
                    )
                        initializationFailure = true;
                    else
                ...
                if (asbe != null)
                {
                    ...
                    if (asbe.InitiatorTokenParameters != null)
                    {
                        ...
                        if (
                            requireDerivedKeys.HasValue
                            && requireDerivedKeys.Value
                                != asbe.InitiatorTokenParameters.RequireDerivedKeys
                        )
                            initializationFailure = true;
                        else
            ...
            this.willX509IssuerReferenceAssertionBeWritten =
                DoesSecurityBindingElementContainClauseTypeofIssuerSerial(sbe);
            this.RequireDerivedKeys = requireDerivedKeys.GetValueOrDefault(
        ...
        bool DoesSecurityBindingElementContainClauseTypeofIssuerSerial(SecurityBindingElement sbe)
        {
            ...
            {
                X509SecurityTokenParameters tokenParamameters =
                    ((SymmetricSecurityBindingElement)sbe).ProtectionTokenParameters
                    as X509SecurityTokenParameters;
                if (
                    tokenParamameters != null
                    && tokenParamameters.X509ReferenceStyle
            ...
            {
                X509SecurityTokenParameters initiatorParamameters =
                    ((AsymmetricSecurityBindingElement)sbe).InitiatorTokenParameters
                    as X509SecurityTokenParameters;
                if (
                    initiatorParamameters != null
                    && initiatorParamameters.X509ReferenceStyle
                        == X509KeyIdentifierClauseType.IssuerSerial
                )
                    return true;

                X509SecurityTokenParameters recepientParamameters =
                    ((AsymmetricSecurityBindingElement)sbe).RecipientTokenParameters
                    as X509SecurityTokenParameters;
                if (
                    recepientParamameters != null
                    && recepientParamameters.X509ReferenceStyle
                        == X509KeyIdentifierClauseType.IssuerSerial
                )
                    return true;
            }
            ...
            if (
                DoesX509TokenParametersContainClauseTypeofIssuerSerial(
            ...
            if (
                DoesX509TokenParametersContainClauseTypeofIssuerSerial(
                    sbe.EndpointSupportingTokenParameters.SignedEncrypted
                )
            )
                return true;
            ...
            if (
                DoesX509TokenParametersContainClauseTypeofIssuerSerial(
                    sbe.EndpointSupportingTokenParameters.SignedEndorsing
                )
            )
                return true;
            ...
            if (
                DoesX509TokenParametersContainClauseTypeofIssuerSerial(
                    sbe.OptionalEndpointSupportingTokenParameters.Endorsing
                )
            )
                return true;
            ...
            if (
                DoesX509TokenParametersContainClauseTypeofIssuerSerial(
                    sbe.OptionalEndpointSupportingTokenParameters.Signed
                )
            )
                return true;
            ...
            if (
                DoesX509TokenParametersContainClauseTypeofIssuerSerial(
                    sbe.OptionalEndpointSupportingTokenParameters.SignedEncrypted
                )
            )
                return true;
            ...
            if (
                DoesX509TokenParametersContainClauseTypeofIssuerSerial(
                    sbe.OptionalEndpointSupportingTokenParameters.SignedEndorsing
                )
            )
                return true;
        ...
        bool DoesX509TokenParametersContainClauseTypeofIssuerSerial(
            Collection<SecurityTokenParameters> tokenParameters
        )
        {
            foreach (SecurityTokenParameters tokenParameter in tokenParameters)
            {
                X509SecurityTokenParameters x509TokenParameter =
                    tokenParameter as X509SecurityTokenParameters;
                if (x509TokenParameter != null)
                {
                    if (
                        x509TokenParameter.X509ReferenceStyle
                        == X509KeyIdentifierClauseType.IssuerSerial
                    )
                        return true;
                }
        ...
        protected override bool SerializeToXmlElement(XmlWriter writer, String elementName)
        {
            ...
            {
                writer.WriteComment(
                    SR.GetString(SR.ConfigurationSchemaInsuffientForSecurityBindingElementInstance)
                );
            ...
            else
            {
                if (writer != null && this.willX509IssuerReferenceAssertionBeWritten)
                    writer.WriteComment(
                        SR.GetString(SR.ConfigurationSchemaContainsX509IssuerSerialReference)
                    );
