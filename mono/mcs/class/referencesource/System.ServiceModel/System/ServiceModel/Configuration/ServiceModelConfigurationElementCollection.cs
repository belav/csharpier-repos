        ...
        where ConfigurationElementType : ConfigurationElement, new()
    {
        ...
        public virtual bool ContainsKey(object key)
        {
            if (key == null)
            {
                ...
                foreach (
                    PropertyInformation propertyInfo in dummyElement.ElementInformation.Properties
                )
                {
                ...
                else
                {
                    ...
                    elementKeysString = elementKeysString.Append(
        ...
        public virtual ConfigurationElementType this[object key]
        {
            ...
            set
            {
                ...
                if (
                    this.GetElementKey(value)
                        .ToString()
                        .Equals((string)key, StringComparison.Ordinal)
                )
                {
...
#pragma warning restore
        ...
        {
            get { return (ConfigurationElementType)this.BaseGet(index); }
            set
            {
                if (!this.IsReadOnly() && !this.ThrowOnDuplicate)
                {
