...
namespace System.ServiceModel.Configuration
{
            ...
            IConfigurationContextProviderInternal
    {
        ...
        public ChannelEndpointElementCollection Endpoints
        {
            get
            {
                return (ChannelEndpointElementCollection)
        ...
        internal static ClientSection GetSection()
        {
            return (ClientSection)
                ConfigurationHelpers.GetSection(ConfigurationStrings.ClientSectionPath);
        }
        ...
        {
            return (ClientSection)
                ConfigurationHelpers.UnsafeGetSection(ConfigurationStrings.ClientSectionPath);
        }
        ...
        {
            return (ClientSection)
                ConfigurationHelpers.UnsafeGetSectionFromContext(
                    contextInformation,
                    ConfigurationStrings.ClientSectionPath
                );
        }
