...
namespace System.ServiceModel.Configuration
{
    ...
    public class WSHttpContextBindingCollectionElement
        : StandardBindingCollectionElement<WSHttpContextBinding, WSHttpContextBindingElement>
    {
        ...
        {
            return (WSHttpContextBindingCollectionElement)
                ConfigurationHelpers.GetBindingCollectionElement(wsHttpContextBindingName);
        }
    }
}
