...
namespace System.ServiceModel.Configuration
{
    ...
    public sealed partial class IssuedTokenServiceElement : ConfigurationElement
    {
        ...
        public AllowedAudienceUriElementCollection AllowedAudienceUris
        {
            get
            {
                return (AllowedAudienceUriElementCollection)
                    base[ConfigurationStrings.AllowedAudienceUris];
            }
        }

        [ConfigurationProperty(
            ConfigurationStrings.AudienceUriMode,
            DefaultValue = IssuedTokenServiceCredential.DefaultAudienceUriMode
        )]
        ...
        [ConfigurationProperty(
            ...
            DefaultValue = IssuedTokenServiceCredential.DefaultCertificateValidationMode
        )]
        ...
        [ConfigurationProperty(
            ...
            DefaultValue = IssuedTokenServiceCredential.DefaultRevocationMode
        )]
        ...
        public X509CertificateTrustedIssuerElementCollection KnownCertificates
        {
            get
            {
                return (X509CertificateTrustedIssuerElementCollection)
                    base[ConfigurationStrings.KnownCertificates];
            }
        }

        [ConfigurationProperty(
            ConfigurationStrings.AllowUntrustedRsaIssuers,
...
#pragma warning suppress 56506 // Microsoft; ElementInformation is never null.
            ...
            if (
                propertyInfo[ConfigurationStrings.KnownCertificates].ValueOrigin
            ...
            )
            {
                ...
                {
                    X509CertificateTrustedIssuerElement copy =
                        new X509CertificateTrustedIssuerElement();
                    copy.Copy(src);
            ...
            if (
                propertyInfo[ConfigurationStrings.AllowedAudienceUris].ValueOrigin
                != PropertyValueOrigin.Default
            )
            {
