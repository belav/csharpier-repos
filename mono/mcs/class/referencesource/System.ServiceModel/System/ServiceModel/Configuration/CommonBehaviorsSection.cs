...
namespace System.ServiceModel.Configuration
{
    ...
    public partial class CommonBehaviorsSection : ConfigurationSection
    {
        ...
        public CommonEndpointBehaviorElement EndpointBehaviors
        {
            get
            {
                return (CommonEndpointBehaviorElement)base[ConfigurationStrings.EndpointBehaviors];
            }
        }
        ...
        public CommonServiceBehaviorElement ServiceBehaviors
        {
            get
            {
                return (CommonServiceBehaviorElement)base[ConfigurationStrings.ServiceBehaviors];
            }
        }
        ...
        internal static CommonBehaviorsSection UnsafeGetSection()
        {
            return (CommonBehaviorsSection)
                ConfigurationHelpers.UnsafeGetSection(
                    ConfigurationStrings.CommonBehaviorsSectionPath
                );
        }
        ...
        [SecurityCritical]
        internal static CommonBehaviorsSection UnsafeGetAssociatedSection(
            ContextInformation contextEval
        )
        {
            return (CommonBehaviorsSection)
