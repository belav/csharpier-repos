...
namespace System.ServiceModel.Configuration
{
    ...
    public sealed partial class PeerCustomResolverElement : ServiceModelConfigurationElement
    {
        ...
        internal void ApplyConfiguration(PeerCustomResolverSettings settings)
        {
            ...
            {
                settings.Address = new EndpointAddress(
                    this.Address,
                    ConfigLoader.LoadIdentity(this.Identity),
            ...
            if (
                !String.IsNullOrEmpty(this.Binding)
                && !String.IsNullOrEmpty(this.BindingConfiguration)
            )
                settings.Binding = ConfigLoader.LookupBinding(
                    this.Binding,
        ...
        internal void InitializeFrom(PeerCustomResolverSettings settings)
        {
            ...
            {
                SetPropertyValueIfNotDefaultValue(
                    ConfigurationStrings.PeerResolverType,
                    settings.Resolver.GetType().AssemblyQualifiedName
                );
            }
            if (settings.Binding != null)
            {
                SetPropertyValueIfNotDefaultValue(
                    ...
                    PeerStrings.PeerCustomResolver + Guid.NewGuid().ToString()
                );
                string sectionName;
