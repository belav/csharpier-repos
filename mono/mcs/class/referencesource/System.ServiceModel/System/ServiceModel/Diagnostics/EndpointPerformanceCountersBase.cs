...
namespace System.ServiceModel.Diagnostics
{
    ...
    abstract class EndpointPerformanceCountersBase : PerformanceCountersBase
    {
        ...
        protected static readonly string[] perfCounterNames =
        {
            ...
            PerformanceCounterStrings.SERVICEMODELENDPOINT
                .ESecurityValidationAuthenticationFailures,
            PerformanceCounterStrings.SERVICEMODELENDPOINT
                .ESecurityValidationAuthenticationFailuresPerSecond,
        ...
        private static truncOptions GetCompressionTasks(
            int totalLen,
            int serviceLen,
            int contractLen,
            int uriLen
