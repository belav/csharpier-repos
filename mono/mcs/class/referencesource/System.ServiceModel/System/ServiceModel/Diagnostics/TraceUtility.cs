...
namespace System.ServiceModel.Diagnostics
{
    ...
    static class TraceUtility
    {
        ...
        static SortedList<int, string> traceCodes = new SortedList<int, string>(382)
        {
            ...
            {
                TraceCode.IncompatibleExistingTransportManager,
            ...
            {
                TraceCode.PeerReceiveMessageAuthenticationFailure,
            ...
            {
                TraceCode.ComIntegrationServiceHostStartingService,
            ...
            {
                TraceCode.ComIntegrationServiceHostStartedServiceDetails,
            ...
            {
                TraceCode.ComIntegrationServiceHostStoppingService,
                "ComIntegrationServiceHostStoppingService"
            },
            {
                TraceCode.ComIntegrationServiceHostStoppedService,
            ...
            {
                TraceCode.ComIntegrationWsdlChannelBuilderLoaded,
            ...
            {
                TraceCode.ElementTypeDoesntMatchConfiguredType,
            ...
            {
                TraceCode.ServiceHostErrorOnReleasePerformanceCounter,
            ...
            {
                TraceCode.ContextChannelFactoryChannelCreated,
            ...
            {
                TraceCode.SyndicationProtocolElementIgnoredOnRead,
            ...
            {
                TraceCode.SyndicationReadServiceDocumentBegin,
            ...
            {
                TraceCode.SyndicationWriteServiceDocumentBegin,
        ...
        public static InputQueue<T> CreateInputQueue<T>()
            where T : class
        {
            if (asyncCallbackGenerator == null)
            {
                asyncCallbackGenerator = new Func<Action<AsyncCallback, IAsyncResult>>(
                    CallbackGenerator
                );
            }
        ...
        internal static void AddActivityHeader(Message message)
        {
            try
            {
                ActivityIdHeader activityIdHeader = new ActivityIdHeader(
                    TraceUtility.ExtractActivityId(message)
                );
...
#pragma warning suppress 56500 // covered by FxCOP
            catch (Exception e)
            {
                ...
                TraceUtility.TraceEvent(
                    ...
                    SR.GetString(SR.TraceCodeFailedToAddAnActivityIdHeader),
                    e,
                    message
                );
            }
...
#pragma warning suppress 56500 // covered by FxCOP
        ...
        internal static ServiceModelActivity ExtractActivity(Message message)
        {
            ...
            if (
                (DiagnosticUtility.ShouldUseActivity || TraceUtility.ShouldPropagateActivityGlobal)
                && (message != null)
        ...
        internal static void ProcessIncomingMessage(
            Message message,
        ...
        internal static void ProcessOutgoingMessage(
            Message message,
            EventTraceActivity eventTraceActivity
        )
        {
            ...
            if (MessageLogger.LogMessagesAtServiceLevel)
            {
                MessageLogger.LogMessage(
                    ref message,
                    MessageLoggingSource.ServiceLevelSendRequest | MessageLoggingSource.LastChance
                );
            }
        }
        ...
        internal static void TraceDroppedMessage(Message message, EndpointDispatcher dispatcher)
        {
            if (DiagnosticUtility.ShouldTraceInformation)
            {
                ...
                TraceUtility.TraceEvent(
                    ...
                    TraceCode.DroppedAMessage,
                    SR.GetString(SR.TraceCodeDroppedAMessage),
        ...
        )
        {
            ...
            if (DiagnosticUtility.ShouldTrace(severity))
            {
                DiagnosticUtility.DiagnosticTrace.TraceEvent(
                    severity,
                    traceCode,
                    GenerateMsdnTraceCode(traceCode),
                    traceDescription,
                    new MessageTraceRecord(message),
                    null,
                    activityId,
                    message
                );
        ...
        internal static void TraceEventNoCheck(
            TraceEventType severity,
            int traceCode,
            string traceDescription,
            TraceRecord extendedData,
        ...
        static string GenerateMsdnTraceCode(int traceCode)
        {
            ...
            Fx.Assert(
                ...
                string.Format(
                    ...
                    "Unsupported trace code: Please add trace code 0x{0} to the SortedList TraceUtility.traceCodes in {1}",
        ...
        internal static Exception ThrowHelperError(Exception exception, Message message)
        {
            ...
            if (DiagnosticUtility.ShouldTraceError)
            {
                DiagnosticUtility.DiagnosticTrace.TraceEvent(
                    ...
                    GenerateMsdnTraceCode(TraceCode.ThrowingException),
        ...
        internal static Exception ThrowHelperError(
            Exception exception,
            Guid activityId,
            object source
        )
        ...
        internal static ArgumentException ThrowHelperArgument(
            string paramName,
            string message,
            Message msg
        )
        {
            return (ArgumentException)
                TraceUtility.ThrowHelperError(new ArgumentException(message, paramName), msg);
        }

        internal static ArgumentNullException ThrowHelperArgumentNull(
            string paramName,
            Message message
        )
        {
            return (ArgumentNullException)
                TraceUtility.ThrowHelperError(new ArgumentNullException(paramName), message);
        }
        ...
        internal static void TraceHttpConnectionInformation(
        ...
        )
        {
            if (DiagnosticUtility.ShouldTraceInformation)
            {
                ...
                TraceUtility.TraceEvent(
                    TraceEventType.Information,
                    TraceCode.ConnectToIPEndpoint,
                    SR.GetString(SR.TraceCodeConnectToIPEndpoint),
        ...
        internal static void TraceUserCodeException(Exception e, MethodInfo method)
        {
            if (DiagnosticUtility.ShouldTraceWarning)
            {
                ...
                DiagnosticUtility.DiagnosticTrace.TraceEvent(
                    ...
                    GenerateMsdnTraceCode(TraceCode.UnhandledExceptionInUserOperation),
                    SR.GetString(
                        SR.TraceCodeUnhandledExceptionInUserOperation,
                        method.DeclaringType.FullName,
                        method.Name
                    ),
                    record,
        ...
        static TraceUtility()
        {
            ...
            {
                DiagnosticTraceSource ts = (DiagnosticTraceSource)
                    DiagnosticUtility.DiagnosticTrace.TraceSource;
                TraceUtility.shouldPropagateActivity = (
                    ts.PropagateActivity || TraceUtility.shouldPropagateActivityGlobal
                );
            }
        }
        ...
        static void SetEndToEndTracingFlags()
        {
            ...
            TraceUtility.shouldPropagateActivity =
                TraceUtility.shouldPropagateActivityGlobal || TraceUtility.shouldPropagateActivity;

            //Activity tracing is enabled by either of the flags (Sys.Diag trace source or E2E config element)
            DiagnosticUtility.ShouldUseActivity = (
                DiagnosticUtility.ShouldUseActivity || element.ActivityTracing
            );
            TraceUtility.activityTracing = DiagnosticUtility.ShouldUseActivity;

            TraceUtility.messageFlowTracing =
                element.MessageFlowTracing || TraceUtility.activityTracing;
            TraceUtility.messageFlowTracingOnly =
                element.MessageFlowTracing && !element.ActivityTracing;

            //Set the flag if activity tracing is enabled through the E2E config element as well
            DiagnosticUtility.TracingEnabled = (
                DiagnosticUtility.TracingEnabled || TraceUtility.activityTracing
            );
        }
        ...
        internal static string GetCallerInfo(OperationContext context)
        {
            if (context != null && context.IncomingMessageProperties != null)
            {
                ...
                if (
                    context.IncomingMessageProperties.TryGetValue(
                ...
                )
                {
                    RemoteEndpointMessageProperty endpoint =
                        endpointMessageProperty as RemoteEndpointMessageProperty;
                    if (endpoint != null)
                    {
        ...
        internal static void SetEtwProviderId()
        {
            ...
            if (
                PartialTrustHelpers.HasEtwPermissions()
                || diagnostics.IsEtwProviderIdFromConfigFile()
            )
            {
        ...
        internal static void SetActivityId(MessageProperties properties)
        {
            ...
            if (
                (null != properties)
                && properties.TryGetValue(TraceUtility.E2EActivityId, out activityId)
            )
            {
        ...
        )
        {
            if (TraceUtility.MessageFlowTracing)
            {
                Guid activityId;
                Guid correlationId;
                bool activityIdFound = ActivityIdHeader.ExtractActivityAndCorrelationId(
                    message,
                    out activityId,
                    out correlationId
                );
        ...
        )
        {
            if (TraceUtility.MessageFlowTracing)
            {
                ...
                if (TD.MessageReceivedFromTransportIsEnabled())
                {
                    ...
                    TD.MessageReceivedFromTransport(
                        eventTraceActivity,
                        correlationId,
                        TraceUtility.GetAnnotation(context)
                    );
                }
            }
        }
        ...
        internal static string GetAnnotation(OperationContext context)
        {
            ...
            if (
                context != null
                && null != context.IncomingMessage
                && (MessageState.Closed != context.IncomingMessage.State)
            )
            {
                if (
                    !context.IncomingMessageProperties.TryGetValue(
        ...
        internal static void TransferFromTransport(Message message)
        {
            if (message != null && DiagnosticUtility.ShouldUseActivity)
            {
                ...
                {
                    if (
                        (ServiceModelActivity.Current.Id == guid)
                ...
                if (DiagnosticUtility.ShouldUseActivity)
                {
                    if (emitStart)
                    {
                        ...
                        ServiceModelActivity.Start(
                            activity,
                            SR.GetString(SR.ActivityProcessAction, message.Headers.Action),
        ...
        internal static void UpdateAsyncOperationContextWithActivity(object activity)
        {
            if (OperationContext.Current != null && activity != null)
            {
                OperationContext.Current.OutgoingMessageProperties[
                    TraceUtility.AsyncOperationActivityKey
                ] = activity;
            }
        }
        ...
        internal static object ExtractAsyncOperationContextActivity()
        {
            ...
            {
                OperationContext.Current.OutgoingMessageProperties.Remove(
                    TraceUtility.AsyncOperationActivityKey
                );
            }
            return data;
        ...
        )
        {
            ...
            if (
                OperationContext.Current != null
                && OperationContext.Current.OutgoingMessageProperties.TryGetValue<EventTraceActivityTimeProperty>(
                    TraceUtility.AsyncOperationStartTimeKey,
                    out data
                )
            )
        ...
        sealed class ExecuteUserCodeAsync
        {
            ...
            {
                get { return Fx.ThunkCallback(new AsyncCallback(this.ExecuteUserCode)); }
            }
            ...
            void ExecuteUserCode(IAsyncResult result)
            {
                using (ServiceModelActivity activity = ServiceModelActivity.CreateBoundedActivity())
                {
                    ServiceModelActivity.Start(
                        activity,
                        SR.GetString(SR.ActivityCallback),
        ...
        class EventTraceActivityTimeProperty
        {
            ...
            public EventTraceActivityTimeProperty(
                EventTraceActivity eventTraceActivity,
                long startTime
            )
            {
        ...
        internal static string GetRemoteEndpointAddressPort(
