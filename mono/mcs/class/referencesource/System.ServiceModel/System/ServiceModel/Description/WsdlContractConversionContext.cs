...
namespace System.ServiceModel.Description
{
    ...
    public class WsdlContractConversionContext
    {
        ...
        )
        {
            ...
            this.wsdlOperationMessages =
                new Dictionary<MessageDescription, WsdlNS.OperationMessage>();
            this.messageDescriptions =
                new Dictionary<WsdlNS.OperationMessage, MessageDescription>();
            ...
            this.operationBindings =
                new Dictionary<WsdlNS.Operation, Collection<WsdlNS.OperationBinding>>();
        }
        ...
        public WsdlNS.PortType WsdlPortType
        {
            get { return wsdlPortType; }
        }
        ...
        internal Collection<WsdlNS.OperationBinding> GetOperationBindings(
            WsdlNS.Operation operation
        )
        {
            ...
            if (!this.operationBindings.TryGetValue(operation, out bindings))
            {
                ...
                foreach (WsdlNS.ServiceDescription wsdl in wsdlDocuments)
                {
                    ...
                    {
                        if (
                            wsdlBinding.Type.Name == WsdlPortType.Name
                            && wsdlBinding.Type.Namespace
                                == WsdlPortType.ServiceDescription.TargetNamespace
                        )
                        {
                            foreach (
                                WsdlNS.OperationBinding operationBinding in wsdlBinding.Operations
                            )
                            {
                                if (
