...
namespace System.ServiceModel.Description
{
            ...
            IOperationContractGenerationExtension
    {
        Dictionary<OperationDescription, DataContractFormatAttribute> operationAttributes =
            new Dictionary<OperationDescription, DataContractFormatAttribute>();
        ...
        public DataContractSerializerOperationGenerator()
        ...
        internal void Add(
            ...
            bool isNonNillableReferenceType
        )
        {
        ...
        )
        {
            DataContractSerializerOperationBehavior DataContractSerializerOperationBehavior =
                context.Operation.Behaviors.Find<DataContractSerializerOperationBehavior>()
            ...
            operationGenerator.GenerateOperation(
                ...
                false /*isEncoded*/
                ,
                new WrappedBodyTypeGenerator(this, context),
                knownTypes
            );
        ...
        internal static void UpdateTargetCompileUnit(
            OperationContractGenerationContext context,
            CodeCompileUnit codeCompileUnit
        )
        {
        ...
        {
            static CodeTypeReference dataContractAttributeTypeRef = new CodeTypeReference(
            ...
            void ValidateForParameterMode(MessagePartDescription part)
            {
                ...
                )
                {
                    ParameterModeException parameterModeException = new ParameterModeException(
                        SR.GetString(
                            SR.SFxCannotImportAsParameters_ElementIsNotNillable,
                            part.Name,
                            part.Namespace
                        )
                    );
            ...
            public WrappedBodyTypeGenerator(
                DataContractSerializerOperationGenerator dataContractSerializerOperationGenerator,
                OperationContractGenerationContext context
            )
            {
