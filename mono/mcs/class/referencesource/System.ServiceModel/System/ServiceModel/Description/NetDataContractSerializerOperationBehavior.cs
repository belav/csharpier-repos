...
namespace System.ServiceModel.Description
{
    ...
    internal class NetDataContractSerializerOperationBehavior
        : DataContractSerializerOperationBehavior
    {
        ...
        internal static NetDataContractSerializerOperationBehavior ApplyTo(
        ...
        )
        {
            ...
            if (dataContractSerializerOperationBehavior != null)
            {
                netDataContractSerializerOperationBehavior =
                    new NetDataContractSerializerOperationBehavior(operation);
