...
namespace System.ServiceModel.Description
{
    ...
    interface IWrappedBodyTypeGenerator
    {
        ...
        void AddMemberAttributes(
            ...
            CodeAttributeDeclarationCollection attributesImported,
    ...
    class OperationGenerator //: IOperationBehavior, IOperationContractGenerationExtension
    {
        ...
        internal void GenerateOperation(
            OperationContractGenerationContext context,
            ref OperationFormatStyle style,
            bool isEncoded,
            IWrappedBodyTypeGenerator wrappedBodyTypeGenerator,
        ...
        class MethodSignatureGenerator
        {
            ...
            internal MethodSignatureGenerator(
                OperationGenerator parent,
                OperationContractGenerationContext context,
            ...
            )
            {
                ...
                this.IsTaskWithOutputParameters =
                    context.IsTask && context.Operation.HasOutputParameters;

                Fx.Assert(
                    this.Oneway == (this.Response == null),
                    "OperationContractGenerationContext.Operation cannot contain a null response message when the operation is not one-way"
                );
            }
            ...
            {
                if (
                    this.MessageContractType != MessageContractType.None
                    || this.GenerateTypedMessageForTaskWithOutputParameters()
                )
                {
                    CheckAndSetMessageContractTypeToBare();
                    this.GenerateTypedMessageOperation(
                        false /*hideFromEditor*/
                        ,
                        ref style
                    );
                }
            ...
            {
                CodeParameterDeclarationExpressionCollection methodParameters,
                    endMethodParameters = null;
                methodParameters = new CodeParameterDeclarationExpressionCollection(
            ...
            void GenerateParameterizedOperation()
            {
                ...
                else
                {
                    ...
                    ParameterizedMethodGenerator generator = new ParameterizedMethodGenerator(
                        this.Method,
                        this.EndMethod
                    );
                    ...
                    {
                        this.EndMethod.ReturnType = GetParameterType(
                            this.Response.Body.ReturnValue
                        );
                        ParameterizedMessageHelper.GenerateMessageParameterAttribute(
                            this.Response.Body.ReturnValue,
                            this.EndMethod.ReturnTypeCustomAttributes,
                            TypeLoader.GetReturnValueName(this.DefaultName),
                            this.DefaultNS
                        );
            ...
            void GenerateTypedMessageOperation(bool hideFromEditor, ref OperationFormatStyle style)
            {
                ...
                {
                    CodeTypeReference typedReqMessageRef =
                        GenerateTypedMessageHeaderAndReturnValueParts(
                            ns,
                ...
                {
                    CodeTypeReference typedRespMessageRef =
                        GenerateTypedMessageHeaderAndReturnValueParts(
                            ns,
            ...
            CodeTypeReference GenerateTypedMessageHeaderAndReturnValueParts(
                CodeNamespace ns,
                string defaultName,
                MessageDescription message,
                bool isReply,
                bool hideFromEditor,
                ref bool isNewMessage,
                out IPartCodeGenerator partCodeGenerator
            )
            {
                CodeTypeReference typedMessageRef;
                if (
                    TypedMessageHelper.FindGeneratedTypedMessage(
                ...
                else
                {
                    ...
                    typedMessageRef = namespaceScope.AddUnique(
                        typedMessageDecl,
                        messageName,
                        defaultName
                    );

                    TypedMessageHelper.AddGeneratedTypedMessage(
                        this.Context.Contract,
                        message,
                        typedMessageRef
                    );
                    ...
                    if (
                        this.MessageContractType == MessageContractType.BareMessageContract
                        && message.Body.WrapperName != null
                    )
                        WrapTypedMessage(
                            ns,
                            typedMessageDecl.Name,
                            message,
                            isReply,
                            this.Context.IsInherited,
                            hideFromEditor
                        );
                    ...
                    if (hideFromEditor)
                    {
                        TypedMessageHelper.AddEditorBrowsableAttribute(
                            typedMessageDecl.CustomAttributes
                        );
                    }
            ...
            bool IsCompletelyUntyped
            {
                get
                {
                    ...
                    bool isResponseMessage =
                        this.Response != null && this.Response.IsUntypedMessage;
            ...
            void CreateOrOverrideActionProperties()
            {
                if (this.Request != null)
                {
                    CustomAttributeHelper.CreateOrOverridePropertyDeclaration(
                        CustomAttributeHelper.FindOrCreateAttributeDeclaration<OperationContractAttribute>(
                            this.Method.CustomAttributes
                        ),
                        OperationContractAttribute.ActionPropertyName,
                        this.Request.Action
                    );
                }
                if (this.Response != null)
                {
                    CustomAttributeHelper.CreateOrOverridePropertyDeclaration(
                        ...
                        OperationContractAttribute.ReplyActionPropertyName,
            ...
            class ParameterizedMethodGenerator
            {
                ...
                internal ParameterizedMethodGenerator(
                    CodeMemberMethod beginMethod,
                    CodeMemberMethod endMethod
                )
                {
                    this.ins = new ParametersPartCodeGenerator(
                        this,
                        beginMethod.Name,
                    ...
                    this.outs = new ParametersPartCodeGenerator(
                        this,
                        beginMethod.Name,
                ...
                )
                {
                    ...
                    ParametersPartCodeGenerator existingParams =
                        direction != FieldDirection.In ? ins : outs;
                    int i = index;
                    CodeParameterDeclarationExpression existing = existingParams.GetParameter(
                        name,
                        ref i
                    );
                ...
                class ParametersPartCodeGenerator : IPartCodeGenerator
                {
                    ...
                    {
                        if (
                            String.Compare(name, methodName, StringComparison.OrdinalIgnoreCase)
                            == 0
                        )
                            return true;
                        int index = 0;
                    ...
                    )
                    {
                        ...
                        CodeParameterDeclarationExpression paramDecl = parent.GetOrCreateParameter(
                            type,
                            name,
                            this.direction,
                            ref index,
                    ...
                    internal CodeParameterDeclarationExpression GetParameter(
                        string name,
                        ref int index
                    )
                    {
                    ...
                    {
                        get { return messageAttrs; }
                    }

                    void IPartCodeGenerator.EndCodeGeneration() { }

                    static string GetUniqueParameterName(
                        string name,
                        ParametersPartCodeGenerator parameters
                    )
                    {
            ...
            class TypedMessagePartCodeGenerator : IPartCodeGenerator
            {
                ...
                CodeAttributeDeclarationCollection IPartCodeGenerator.MessageLevelAttributes
                {
                    get { return typeDecl.CustomAttributes; }
                }
            ...
            )
            {
                ...
                if (messageDescription.Body.ReturnValue != null)
                {
                    ...
                    protectionLevel = ProtectionLevelHelper.Max(
                        protectionLevel,
                        messageDescription.Body.ReturnValue.ProtectionLevel
                    );
                ...
                foreach (MessagePartDescription part in messageDescription.Body.Parts)
                {
                    ...
                    if (
                        ...
                        && this.KnownTypes.TryGetValue(part, out knownTypesForPart)
                    )
                    {
                ...
                MessagePartDescription wrapperPart = new MessagePartDescription(
            ...
            void AddWrapperPart(
                XmlName messageName,
                IWrappedBodyTypeGenerator wrappedBodyTypeGenerator,
                IPartCodeGenerator partGenerator,
                MessagePartDescription part,
                CodeAttributeDeclarationCollection typeAttributes
            )
            {
                ...
                CodeAttributeDeclarationCollection fieldAttributes = partGenerator.AddPart(
                    type,
                    ref fieldName
                );
            ...
            void GenerateBodyPart(
                int order,
                MessagePartDescription messagePart,
                IPartCodeGenerator partCodeGenerator,
                bool generateTypedMessage,
                bool isEncoded,
                string defaultNS
            )
            {
                ...
                CodeAttributeDeclarationCollection partAttributes = partCodeGenerator.AddPart(
                    partType,
                    ref partName
                );
                ...
                if (generateTypedMessage)
                    TypedMessageHelper.GenerateMessageBodyMemberAttribute(
                        order,
                        messagePart,
                        partAttributes,
                        xmlPartName
                ...
                AddAdditionalAttributes(
                    messagePart,
                    partAttributes,
                    generateTypedMessage || isEncoded
                );
            }
            ...
            void GenerateHeaderPart(MessageHeaderDescription setting, IPartCodeGenerator parts)
            {
                ...
                CodeAttributeDeclarationCollection partAttributes = parts.AddPart(
                    partType,
                    ref partName
                );
                TypedMessageHelper.GenerateMessageHeaderAttribute(
                    setting,
                    partAttributes,
                    new XmlName(partName)
                );
                AddAdditionalAttributes(
                    setting,
                    partAttributes,
                    true /*isAdditionalAttributesAllowed*/
                );
            }
            ...
            void AddAdditionalAttributes(
                MessagePartDescription setting,
                CodeAttributeDeclarationCollection attributes,
                bool isAdditionalAttributesAllowed
            )
            {
                if (
                    this.Parent.parameterAttributes != null
            ...
            {
                internal static void GenerateProtectionLevelAttribute(
                    MessageDescription message,
                    IPartCodeGenerator partCodeGenerator
                )
                {
                    CodeAttributeDeclaration messageContractAttr =
                        CustomAttributeHelper.FindOrCreateAttributeDeclaration<MessageContractAttribute>(
                            partCodeGenerator.MessageLevelAttributes
                        );
                ...
                internal static void GenerateWrapperAttribute(
                    MessageDescription message,
                    IPartCodeGenerator partCodeGenerator
                )
                {
                ...
                {
                    attributes.Add(
                        ClientClassGenerator.CreateEditorBrowsableAttribute(
                ...
                internal static void GenerateMessageBodyMemberAttribute(
                    int order,
                    MessagePartDescription setting,
                    CodeAttributeDeclarationCollection attributes,
                    XmlName defaultName
                ...
                {
                    GenerateMessageContractMemberAttribute<MessageBodyMemberAttribute>(
                        order,
                        setting,
                        attributes,
                        defaultName
                ...
                internal static void GenerateMessageHeaderAttribute(
                    MessageHeaderDescription setting,
                    CodeAttributeDeclarationCollection attributes,
                    XmlName defaultName
                )
                {
                    if (setting.Multiple)
                        GenerateMessageContractMemberAttribute<MessageHeaderArrayAttribute>(
                            -1,
                            setting,
                            attributes,
                            defaultName
                        ...
                        GenerateMessageContractMemberAttribute<MessageHeaderAttribute>(
                            -1,
                            setting,
                            attributes,
                            defaultName
                ...
                static void GenerateMessageContractMemberAttribute<T>(
                    int order,
                    MessagePartDescription setting,
                    ...
                    where T : Attribute
                {
                    CodeAttributeDeclaration decl =
                        CustomAttributeHelper.FindOrCreateAttributeDeclaration<T>(attrs);
                    ...
                    if (setting.Name != defaultName.EncodedName)
                        ...
                        CustomAttributeHelper.CreateOrOverridePropertyDeclaration(
                            decl,
                            MessageContractMemberAttribute.NamePropertyName,
                            setting.Name
                        );

                    CustomAttributeHelper.CreateOrOverridePropertyDeclaration(
                        decl,
                        MessageContractMemberAttribute.NamespacePropertyName,
                        setting.Namespace
                    );
                    ...
                    if (setting.HasProtectionLevel)
                        CustomAttributeHelper.CreateOrOverridePropertyDeclaration(
                            decl,
                            MessageContractMemberAttribute.ProtectionLevelPropertyName,
                    ...
                    if (order >= 0)
                        CustomAttributeHelper.CreateOrOverridePropertyDeclaration(
                            decl,
                            MessageBodyMemberAttribute.OrderPropertyName,
                            order
                        );
                }
            }
            ...
            static class ParameterizedMessageHelper
            {
                ...
                )
                {
                    if (setting.Name != defaultName.EncodedName)
                    {
                        ...
                        // our Encoding algorithm will leave alredy encoded names untouched
                        CustomAttributeHelper.CreateOrOverridePropertyDeclaration(
                            CustomAttributeHelper.FindOrCreateAttributeDeclaration<MessageParameterAttribute>(
                                attributes
                            ),
                            MessageParameterAttribute.NamePropertyName,
                            setting.Name
                        );
                    }
                    ...
                    if (parent.Response != null)
                    {
                        ...
                        if (
                            !String.Equals(
                                ...
                                TypeLoader.GetBodyWrapperResponseName(defaultName).EncodedName,
                                StringComparison.Ordinal
                            )
                        )
                            throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
            ...
            internal void GenerateTaskSignature(ref OperationFormatStyle style)
            {
                ...
                else
                {
                    taskReturnType = new CodeTypeReference(
                        this.Context.ServiceContractGenerator.GetCodeTypeReference(
                            ServiceReflector.taskTResultType
                        ).BaseType,
                        resultType
                    );
                }
        ...
        {
            internal static void CreateOrOverridePropertyDeclaration<V>(
                CodeAttributeDeclaration attribute,
                string propertyName,
                V value
            )
            {
                SecurityAttributeGenerationHelper.CreateOrOverridePropertyDeclaration<V>(
                    attribute,
                    propertyName,
                    value
                );
            ...
            internal static CodeAttributeDeclaration FindOrCreateAttributeDeclaration<T>(
                CodeAttributeDeclarationCollection attributes
            )
                where T : Attribute
            {
                return SecurityAttributeGenerationHelper.FindOrCreateAttributeDeclaration<T>(
                    attributes
                );
            }
            ...
            )
            {
                ...
                MemberInfo[] publicMembers = attributeType.GetMembers(
            ...
            static CodeExpression GetArgValue(object val)
            {
                ...
                if (type.IsEnum)
                    return new CodeFieldReferenceExpression(
                        ...
                        Enum.Format(type, val, "G")
                    );

                Fx.Assert(
                    String.Format(
                        System.Globalization.CultureInfo.InvariantCulture,
                        "Attribute generation is not supported for argument type {0}",
                        type
                    )
                );
                return null;
