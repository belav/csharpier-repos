                ...
                case ".NETFramework":
                {
                    ...
                    if (version <= 40602)
                    {
                        ...
                        LocalAppContext.DefineSwitchDefault(
                            LocalAppContextSwitches.DisableUsingServicePointManagerSecurityProtocolsString,
                            true
                        );
                    }
                    ...
                    if (version <= 40700)
                    {
                        ...
                        LocalAppContext.DefineSwitchDefault(
                            LocalAppContextSwitches.UseSha1InPipeConnectionGetHashAlgorithmString,
                            true
                        );
                        LocalAppContext.DefineSwitchDefault(
                            LocalAppContextSwitches.DisableAddressHeaderCollectionValidationString,
                            true
                        );
                        LocalAppContext.DefineSwitchDefault(
                            LocalAppContextSwitches.UseSha1InMsmqEncryptionAlgorithmString,
                            true
                        );
                        LocalAppContext.DefineSwitchDefault(
                            LocalAppContextSwitches.DontEnableSystemDefaultTlsVersionsString,
                            true
                        );
                    }
