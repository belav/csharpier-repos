    ...
    abstract class ComPlusServiceHost : ServiceHostBase
    {
        ...
        protected override void InitializeRuntime()
        {
            ComPlusServiceHostTrace.Trace(
                ...
                SR.TraceCodeComIntegrationServiceHostStartingService,
                this.info
            );
            try
            {
            ...
            ComPlusServiceHostTrace.Trace(
                ...
                SR.TraceCodeComIntegrationServiceHostStartedServiceDetails,
                this.info,
                this.Description
            );
            ComPlusServiceHostTrace.Trace(
        ...
        protected override void OnClose(TimeSpan timeout)
        {
            ComPlusServiceHostTrace.Trace(
                ...
                SR.TraceCodeComIntegrationServiceHostStoppingService,
                this.info
            );
            ...
            ComPlusServiceHostTrace.Trace(
                ...
                SR.TraceCodeComIntegrationServiceHostStoppedService,
                this.info
            );
        }
