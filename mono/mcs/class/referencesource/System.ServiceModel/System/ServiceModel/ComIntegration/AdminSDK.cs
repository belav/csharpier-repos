...
namespace System.ServiceModel.ComIntegration
{
    ...
    internal interface ICatalog2
    {
        ...
        [DispId(0x00000005)]
        [return: MarshalAs(UnmanagedType.Interface)]
        Object GetCollectionByQuery(
            [In, MarshalAs(UnmanagedType.BStr)] String collName,
            [In, MarshalAs(UnmanagedType.SafeArray)] ref Object[] aQuery
        );

        [DispId(0x00000006)]
        void ImportComponent(
            [In, MarshalAs(UnmanagedType.BStr)] String bstrApplIdOrName,
        ...
        String GetApplicationInstanceIDFromProcessID(
            [In, MarshalAs(UnmanagedType.I4)] int lProcessID
        );

        [DispId(0x0000001d)]
        void ShutdownApplicationInstances(
            [In, MarshalAs(UnmanagedType.LPStruct)] Object pVarApplicationInstanceID
        );

        [DispId(0x0000001e)]
        void PauseApplicationInstances(
            [In, MarshalAs(UnmanagedType.LPStruct)] Object pVarApplicationInstanceID
        );

        [DispId(0x0000001f)]
        void ResumeApplicationInstances(
            [In, MarshalAs(UnmanagedType.LPStruct)] Object pVarApplicationInstanceID
        );
        ...
        bool AreApplicationInstancesPaused(
            [In, MarshalAs(UnmanagedType.LPStruct)] Object pVarApplicationInstanceID
        );
        ...
        [DispId(0x00000025)]
        void DeleteServiceForApplication(
            [In, MarshalAs(UnmanagedType.BStr)] String bstrApplicationIDOrName
        );
    ...
    internal interface ICatalogCollection
    {
        ...
        Object GetCollection(
            [In, MarshalAs(UnmanagedType.BStr)] String bstrCollName,
        ...
        [DispId(0x0000000d)]
        void PopulateByQuery(
            [In, MarshalAs(UnmanagedType.BStr)] String bstrQueryString,
            [In] int lQueryType
        );
    }
