...
namespace System.ServiceModel.Security
{
    ...
    {
        public WSSecurityOneDotOneSendSecurityHeader(
            Message message,
            string actor,
            bool mustUnderstand,
            bool relay,
        ...
        protected override ISignatureValueSecurityElement[] CreateSignatureConfirmationElements(
        ...
        )
        {
            ...
            ISignatureValueSecurityElement[] result = new ISignatureValueSecurityElement[
                signatureConfirmations.Count
            ];
            for (int i = 0; i < signatureConfirmations.Count; ++i)
            {
                ...
                result[i] = new SignatureConfirmationElement(
                    this.GenerateId(),
                    sigValue,
        ...
        )
        {
            ...
            return new EncryptedHeader(
                plainTextHeader,
                encryptedHeaderXml,
                EncryptedHeaderXml.ElementName.Value,
                EncryptedHeaderXml.NamespaceUri.Value,
                version
            );
        }
    }
