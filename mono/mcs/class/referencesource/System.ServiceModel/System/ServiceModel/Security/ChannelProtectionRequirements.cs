...
namespace System.ServiceModel.Security
{
    ...
    public class ChannelProtectionRequirements
    {
        ...
        internal ChannelProtectionRequirements(
            ...
            ProtectionLevel newBodyProtectionLevel
        )
        {
            if (other == null)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
        ...
        public void Add(ChannelProtectionRequirements protectionRequirements, bool channelScopeOnly)
        {
            if (protectionRequirements == null)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                    new ArgumentNullException("protectionRequirements")
                );
        ...
        static void AddActionParts(
            ScopedMessagePartSpecification to,
            ScopedMessagePartSpecification from
        )
        {
        ...
        public ChannelProtectionRequirements CreateInverse()
        {
            ...
            result.incomingSignatureParts = new ScopedMessagePartSpecification(
                this.OutgoingSignatureParts
            );
            result.outgoingSignatureParts = new ScopedMessagePartSpecification(
                this.IncomingSignatureParts
            );
            result.incomingEncryptionParts = new ScopedMessagePartSpecification(
                this.OutgoingEncryptionParts
            );
            result.outgoingEncryptionParts = new ScopedMessagePartSpecification(
                this.IncomingEncryptionParts
            );
        ...
        internal static ChannelProtectionRequirements CreateFromContract(
            ...
            ISecurityCapabilities bindingElement,
            bool isForClient
        )
        {
            return CreateFromContract(
                contract,
                bindingElement.SupportedRequestProtectionLevel,
                bindingElement.SupportedResponseProtectionLevel,
                isForClient
            );
        }

        static MessagePartSpecification UnionMessagePartSpecifications(
            ScopedMessagePartSpecification actionParts
        )
        {
        ...
        {
            ChannelProtectionRequirements contractRequirements = CreateFromContract(
                contract,
                bindingElement.SupportedRequestProtectionLevel,
                bindingElement.SupportedResponseProtectionLevel,
                isForClient
        ...
        )
        {
            ...
            foreach (OperationDescription operation in contract.Operations)
            {
                ...
                foreach (MessageDescription message in operation.Messages)
                {
                    ...
                    {
                        AddHeaderProtectionRequirements(
                            header,
                            signedParts,
                            encryptedParts,
                            messageScopeDefaultProtectionLevel
                    ...
                    else if (message.Body.ReturnValue != null)
                    {
                        ...
                        bodyProtectionLevel = desc.HasProtectionLevel
                            ? desc.ProtectionLevel
                            : messageScopeDefaultProtectionLevel;
                    }
                    else
                    {
                    ...
                    if (message.Body.Parts.Count > 0)
                    {
                        ...
                        {
                            ProtectionLevel partProtectionLevel = body.HasProtectionLevel
                                ? body.ProtectionLevel
                                : messageScopeDefaultProtectionLevel;
                            bodyProtectionLevel = ProtectionLevelHelper.Max(
                                bodyProtectionLevel,
                                partProtectionLevel
                            );
                    ...
                    if (message.Direction == MessageDirection.Input)
                    {
                        ...
                        requirements.IncomingEncryptionParts.AddParts(
                            encryptedParts,
                            message.Action
                        );
                    }
                ...
                if (operation.Faults != null)
                {
                    ...
                    {
                        AddFaultProtectionRequirements(
                            operation.Faults,
                            requirements,
                            operationScopeDefaultRequestProtectionLevel,
                            true
        ...
        static void AddHeaderProtectionRequirements(
            MessageHeaderDescription header,
            MessagePartSpecification signedParts,
            MessagePartSpecification encryptedParts,
            ProtectionLevel defaultProtectionLevel
        )
        {
            ProtectionLevel p = header.HasProtectionLevel
                ? header.ProtectionLevel
        ...
        static void AddFaultProtectionRequirements(
        ...
        )
        {
            if (faults == null)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                    new ArgumentNullException("faults")
                );
            if (requirements == null)
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                    new ArgumentNullException("requirements")
                );
            ...
            foreach (FaultDescription fault in faults)
            {
                MessagePartSpecification signedParts = new MessagePartSpecification();
                MessagePartSpecification encryptedParts = new MessagePartSpecification();
                ProtectionLevel p = fault.HasProtectionLevel
                    ? fault.ProtectionLevel
                    : defaultProtectionLevel;
                if (p != ProtectionLevel.None)
                {
                    signedParts.IsBodyIncluded = true;
