...
namespace System.ServiceModel.Security
{
            ...
            IInitiatorSecuritySessionProtocol
    {
        ...
        public InitiatorSessionSymmetricTransportSecurityProtocol(
        ...
        protected override void SecureOutgoingMessageAtInitiator(
            ref Message message,
            string actor,
            TimeSpan timeout
        )
        ...
        protected override IAsyncResult BeginSecureOutgoingMessageAtInitiatorCore(
            Message message,
            string actor,
            TimeSpan timeout,
