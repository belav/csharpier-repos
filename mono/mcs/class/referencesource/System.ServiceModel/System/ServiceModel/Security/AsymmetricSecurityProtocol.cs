...
namespace System.ServiceModel.Security
{
    ...
    sealed class AsymmetricSecurityProtocol : MessageSecurityProtocol
    {
        ...
        public AsymmetricSecurityProtocol(
        ...
        )
        {
            ...
            else
            {
                ...
                SecurityTokenProvider encProvider = factory.ApplyConfidentiality
                    ? this.initiatorAsymmetricTokenProvider
                    : null;
                SecurityTokenProvider sigProvider = factory.ApplyIntegrity
                    ? this.initiatorCryptoTokenProvider
                    : null;
        ...
        )
        {
            ...
            SecurityTokenParameters signingTokenParameters =
                (this.Factory.ActAsInitiator)
                    ? this.Factory.CryptoTokenParameters
        ...
        void AttachRecipientSecurityProperty(
            Message message,
            SecurityToken initiatorToken,
            SecurityToken recipientToken,
        ...
        )
        {
            ...
            security.InitiatorToken =
                (initiatorToken != null)
                    ? new SecurityTokenSpecification(
                        initiatorToken,
                        tokenPoliciesMapping[initiatorToken]
                    )
                    : null;
            security.RecipientToken =
                (recipientToken != null)
                    ? new SecurityTokenSpecification(
                        recipientToken,
        ...
        void DoIdentityCheckAndAttachInitiatorSecurityProperty(
            Message message,
            SecurityToken initiatorToken,
            SecurityToken recipientToken,
            ReadOnlyCollection<IAuthorizationPolicy> recipientTokenPolicies
        )
        {
            AuthorizationContext recipientAuthorizationContext = base.EnsureIncomingIdentity(
                message,
                recipientToken,
                recipientTokenPolicies
            );
            SecurityMessageProperty security = SecurityMessageProperty.GetOrCreate(message);
            security.InitiatorToken =
                (initiatorToken != null)
                    ...
                    : null;
            security.RecipientToken = new SecurityTokenSpecification(
                recipientToken,
                recipientTokenPolicies
            );
            security.ServiceSecurityContext = new ServiceSecurityContext(
                recipientAuthorizationContext,
                recipientTokenPolicies ?? EmptyReadOnlyCollection<IAuthorizationPolicy>.Instance
            );
        }
        ...
        )
        {
            ...
            if (factory.ActAsInitiator)
            {
                ...
                securityHeader.ConfigureAsymmetricBindingClientReceiveHeader(
                    receiverToken,
                    factory.AsymmetricTokenParameters,
                    encryptionToken,
                    factory.CryptoTokenParameters,
            ...
            else
            {
                ...
                if (
                    this.Factory.RecipientAsymmetricTokenProvider != null
                    && this.Factory.RequireConfidentiality
                )
                {
                    wrappingToken = GetToken(
                        factory.RecipientAsymmetricTokenProvider,
                        null,
                        timeoutHelper.RemainingTime()
                    );
                }
                ...
                securityHeader.ConfigureAsymmetricBindingServerReceiveHeader(
                    this.Factory.RecipientCryptoTokenAuthenticator,
                    this.Factory.CryptoTokenParameters,
                    wrappingToken,
                    this.Factory.AsymmetricTokenParameters,
            ...
            if (factory.RequireIntegrity)
            {
                if (factory.ActAsInitiator)
                {
                    ReadOnlyCollection<IAuthorizationPolicy> signingTokenPolicies =
                        this.initiatorAsymmetricTokenAuthenticator.ValidateToken(signingToken);
        ...
        bool TryGetTokenSynchronouslyForOutgoingSecurity(
            ...
            bool isBlockingCall,
            TimeSpan timeout,
            out SecurityToken encryptingToken,
        ...
        )
        {
            ...
            if (factory.ActAsInitiator)
            {
                ...
                {
                    encryptingToken = GetTokenAndEnsureOutgoingIdentity(
                        this.initiatorAsymmetricTokenProvider,
                        true,
                        timeoutHelper.RemainingTime(),
                        this.initiatorAsymmetricTokenAuthenticator
        ...
        sealed class SecureOutgoingMessageAsyncResult : GetTwoTokensAndSetUpSecurityAsyncResult
        {
            public SecureOutgoingMessageAsyncResult(
                Message m,
                AsymmetricSecurityProtocol binding,
            ...
            protected override void OnBothGetTokenCallsDone(
                ref Message message,
            ...
            )
            {
                ...
                binding.SetUpDelayedSecurityExecution(
                    ref message,
                    primaryToken,
                    secondaryToken,
