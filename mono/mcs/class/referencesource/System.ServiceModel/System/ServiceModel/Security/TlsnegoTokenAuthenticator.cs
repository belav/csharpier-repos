...
namespace System.ServiceModel.Security
{
    ...
    sealed class TlsnegoTokenAuthenticator : SspiNegotiationTokenAuthenticator
    {
        ...
        {
            get { return this.clientTokenAuthenticator; }
            set
            {
        ...
        {
            get { return this.serverTokenProvider; }
            set
            {
                this.CommunicationObject.ThrowIfDisposedOrImmutable();
        ...
        {
            get { return this.mapCertificateToWindowsAccount; }
            set
            {
                this.CommunicationObject.ThrowIfDisposedOrImmutable();
        ...
        )
        {
            ...
            if (LocalAppContextSwitches.DisableUsingServicePointManagerSecurityProtocols)
            {
                tlsNegotiation = new TlsSspiNegotiation(
                    SchProtocols.TlsServer | SchProtocols.Ssl3Server,
                    this.serverToken.Certificate,
                    this.ClientTokenAuthenticator != null
                );
            }
            else
        ...
        protected override BinaryNegotiation GetOutgoingBinaryNegotiation(
        ...
        )
        {
            ...
            if (this.ClientTokenAuthenticator != null)
            {
                ...
                if (
                    !this.MapCertificateToWindowsAccount
                    || !tlsNegotiation.TryGetContextIdentity(out preMappedIdentity)
                )
                {
                ...
                {
                    clientToken = new X509WindowsSecurityToken(
                        clientCertificate,
                        preMappedIdentity,
                        preMappedIdentity.AuthenticationType,
                        true
                    );
