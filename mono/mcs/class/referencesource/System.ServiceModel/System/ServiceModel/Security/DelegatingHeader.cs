...
namespace System.ServiceModel.Security
{
    ...
    abstract class DelegatingHeader : MessageHeader
    {
        ...
        {
            get { return this.innerHeader.MustUnderstand; }
        }

        public override string Name
        {
            get { return this.innerHeader.Name; }
        }

        public override string Namespace
        {
            get { return this.innerHeader.Namespace; }
        }

        public override bool Relay
        {
            get { return this.innerHeader.Relay; }
        }

        public override string Actor
        {
            get { return this.innerHeader.Actor; }
        }
