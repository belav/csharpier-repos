...
namespace System.ServiceModel.Security
{
    ...
    {
        public WSSecurityOneDotOneReceiveSecurityHeader(
            Message message,
            string actor,
            bool mustUnderstand,
            bool relay,
        ...
        protected override DecryptedHeader DecryptHeader(
        ...
        )
        {
            ...
            )
            {
                ...
                return new DecryptedHeader(
                    ...
                    this.Version,
                    this.StandardsManager.IdManager,
                    this.ReaderQuotas
                );
            }
        }
