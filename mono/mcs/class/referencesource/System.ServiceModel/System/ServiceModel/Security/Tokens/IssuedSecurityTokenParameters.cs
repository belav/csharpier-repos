...
namespace System.ServiceModel.Security.Tokens
{
    ...
    public class IssuedSecurityTokenParameters : SecurityTokenParameters
    {
        ...
        static readonly string wsidPPIClaim = String.Format(
        ...
        Collection<AlternativeIssuerEndpoint> alternativeIssuerEndpoints =
            new Collection<AlternativeIssuerEndpoint>();
        ...
        {
            get { return this.additionalRequestParameters; }
        }

        public MessageSecurityVersion DefaultMessageSecurityVersion
        {
            get { return this.defaultMessageSecurityVersion; }
            set { defaultMessageSecurityVersion = value; }
        }

        internal Collection<AlternativeIssuerEndpoint> AlternativeIssuerEndpoints
        {
            get { return this.alternativeIssuerEndpoints; }
        }
        ...
        {
            get { return this.useStrTransform; }
            set { this.useStrTransform = value; }
        }
        ...
        internal void SetRequestParameters(
        ...
        )
        {
            ...
            foreach (XmlElement element in requestParameters)
            {
                ...
                else if (trustDriver.StandardsManager.TrustVersion == TrustVersion.WSTrustFeb2005)
                {
                    ...
                    {
                        Collection<XmlElement> unrecognizedRequiredClaims =
                            new Collection<XmlElement>();
                        foreach (XmlElement claimRequirement in requiredClaims)
                        {
                            if (
                                claimRequirement.LocalName == "ClaimType"
                                && claimRequirement.NamespaceURI == wsidNamespace
                            )
                            {
                                string claimValue = claimRequirement.GetAttribute(
                                    "Uri",
                                    string.Empty
                                );
                                if (!string.IsNullOrEmpty(claimValue))
                                {
                                    ...
                                    string optional = claimRequirement.GetAttribute(
                                        "Optional",
                                        string.Empty
                                    );
                                    ...
                                    {
                                        claimTypeRequirement = new ClaimTypeRequirement(
                                            claimValue,
                                            XmlConvert.ToBoolean(optional)
                                        );
                                    }
                        ...
                        if (unrecognizedRequiredClaims.Count > 0)
                            unknownRequestParameters.Add(
                                trustDriver.CreateRequiredClaimsElement(unrecognizedRequiredClaims)
                            );
                    }
                    else
                    {
            ...
            unknownRequestParameters = trustDriver.ProcessUnknownRequestParameters(
                unknownRequestParameters,
                requestParameters
            );
        ...
        internal Collection<XmlElement> CreateRequestParameters(TrustDriver driver)
        {
            ...
            {
                Collection<XmlElement> trustNormalizedParameters = NormalizeAdditionalParameters(
        ...
        private Collection<XmlElement> NormalizeAdditionalParameters(
            Collection<XmlElement> additionalParameters,
            TrustDriver driver,
        ...
        )
        {
            ...
            Fx.Assert(
                (
                    (driver.StandardsManager.TrustVersion == TrustVersion.WSTrustFeb2005)
            ...
            {
                Fx.Assert(
                    driver.GetType() == typeof(WSTrustDec2005.DriverDec2005),
                    "Invalid Trust Driver specified for Trust 1.3."
                );
                ...
                for (int i = 0; i < tmpCollection.Count; ++i)
                {
                    ...
                    if (driver.IsEncryptionAlgorithmElement(tmpCollection[i], out algorithm))
                    {
                        ...
                        driver.IsCanonicalizationAlgorithmElement(tmpCollection[i], out algorithm)
                    )
                    {
                    ...
                    else if (driver.IsKeyWrapAlgorithmElement(tmpCollection[i], out algorithm))
                    {
                        ...
                        ((WSTrustDec2005.DriverDec2005)driver).IsSecondaryParametersElement(
                            tmpCollection[i]
                        )
                    )
                    {
                ...
                if (secondaryParameter != null)
                {
                    foreach (XmlNode node in secondaryParameter.ChildNodes)
                    {
                        ...
                        if (child != null)
                        {
                            ...
                            if (
                                driver.IsEncryptionAlgorithmElement(child, out algorithm)
                            ...
                            )
                            {
                                ...
                                driver.IsCanonicalizationAlgorithmElement(child, out algorithm)
                            ...
                            )
                            {
                                ...
                                driver.IsKeyWrapAlgorithmElement(child, out algorithm)
            ...
            bool mismatch = (
                (
                    (driver.StandardsManager.TrustVersion == TrustVersion.WSTrustFeb2005)
                    && !CollectionContainsElementsWithTrustNamespace(
            ...
            if (driver.StandardsManager.TrustVersion == TrustVersion.WSTrust13)
            {
                SecurityStandardsManager trustFeb2005StandardsManager =
                    SecurityStandardsManager.DefaultInstance;
                // the following cast is guaranteed to succeed
                WSTrustFeb2005.DriverFeb2005 trustFeb2005Driver = (WSTrustFeb2005.DriverFeb2005)
                ...
                for (int i = 0; i < tmpCollection.Count; i++)
                {
                    ...
                    if (
                        trustFeb2005Driver.IsSignWithElement(
                            tmpCollection[i],
                            out algorithmParameter
                        )
                    )
                    {
                        ...
                        trustFeb2005Driver.IsEncryptWithElement(
                            tmpCollection[i],
                            out algorithmParameter
                        )
                    )
                    {
                        ...
                        trustFeb2005Driver.IsEncryptionAlgorithmElement(
                            tmpCollection[i],
                            out algorithmParameter
                        )
                    )
                    {
                        tmpCollection[i] = driver.CreateEncryptionAlgorithmElement(
                            algorithmParameter
                        );
                    }
                    else if (
                        trustFeb2005Driver.IsCanonicalizationAlgorithmElement(
                            tmpCollection[i],
                            out algorithmParameter
                        )
                    )
                    {
                        tmpCollection[i] = driver.CreateCanonicalizationAlgorithmElement(
                            algorithmParameter
                        );
                    }
                }
            ...
            else
            {
                ...
                WSSecurityTokenSerializer trust13Serializer = new WSSecurityTokenSerializer(
                ...
                SecurityStandardsManager trust13StandardsManager = new SecurityStandardsManager(
                    MessageSecurityVersion.WSSecurity11WSTrust13WSSecureConversation13WSSecurityPolicy12,
                    trust13Serializer
                );
                // the following cast is guaranteed to succeed
                WSTrustDec2005.DriverDec2005 trust13Driver = (WSTrustDec2005.DriverDec2005)
                    trust13StandardsManager.TrustDriver;
                        ...
                        foreach (XmlNode innerNode in parameter.ChildNodes)
                        {
                            ...
                            if (
                                ...
                                && CanPromoteToRoot(
                                    innerElement,
                                    trust13Driver,
                                    clientSideClaimTypeRequirementsSpecified
                                )
                            )
                            {
                ...
                if ((childrenToPromote != null) && (childrenToPromote.Count > 0))
                {
                    ...
                    foreach (XmlElement e in childrenToPromote)
                    {
                        if (
                            ...
                            && trust13Driver.IsEncryptionAlgorithmElement(
                                e,
                                out encryptionAlgorithm
                            )
                        )
                        {
                            encryptionElement = driver.CreateEncryptionAlgorithmElement(
                                encryptionAlgorithm
                            );
                            ...
                            && trust13Driver.IsCanonicalizationAlgorithmElement(
                                e,
                                out canonicalizationAlgoritm
                            )
                        )
                        {
                            canonicalizationElement = driver.CreateCanonicalizationAlgorithmElement(
                                canonicalizationAlgoritm
                            );
                            processedElements.Add(e);
                        }
                        else if (
                            (requiredClaimsElement == null)
                            && trust13Driver.TryParseRequiredClaimsElement(e, out requiredClaims)
                        )
                        {
                            requiredClaimsElement = driver.CreateRequiredClaimsElement(
                                requiredClaims
                            );
                            processedElements.Add(e);
                        }
                    ...
                    for (int i = 0; i < tmpCollection.Count; ++i)
                    {
                        ...
                        if (
                            trust13Driver.IsSignWithElement(
                                tmpCollection[i],
                                out algorithmParameter
                            )
                        )
                        {
                            ...
                            trust13Driver.IsEncryptWithElement(
                                tmpCollection[i],
                                out algorithmParameter
                            )
                        )
                        ...
                        )
                        {
                            ...
                            trust13Driver.IsKeyWrapAlgorithmElement(
                                tmpCollection[i],
                                out algorithmParameter
                            ) && (keyWrapAlgorithmElement == null)
                        )
                        {
                            ...
                            trust13Driver.TryParseRequiredClaimsElement(
                                tmpCollection[i],
                                out reqClaims
                            ) && (requiredClaimsElement != null)
                        )
        ...
        private bool CollectionContainsElementsWithTrustNamespace(
        ...
        private bool CanPromoteToRoot(
            ...
            WSTrustDec2005.DriverDec2005 trust13Driver,
            bool clientSideClaimTypeRequirementsSpecified
        )
        {
            ...
            if (
                trust13Driver.TryParseRequiredClaimsElement(
                    innerElement,
                    out dummyOutParamForRequiredClaims
                )
            )
            {
            ...
            return (
                !trust13Driver.TryParseKeyTypeElement(innerElement, out dummyOutParamForKeyType)
        ...
        internal bool DoAlgorithmsMatch(
            SecurityAlgorithmSuite algorithmSuite,
            SecurityStandardsManager standardsManager,
            out Collection<XmlElement> otherRequestParameters
        )
        {
            ...
            if (
                (standardsManager.TrustVersion == TrustVersion.WSTrust13)
                && (this.AdditionalRequestParameters.Count == 1)
                && (
                    (
                        (WSTrustDec2005.DriverDec2005)standardsManager.TrustDriver
                    ).IsSecondaryParametersElement(this.AdditionalRequestParameters[0])
                )
            )
            {
            ...
            for (int i = 0; i < trustVersionNormalizedParameterCollection.Count; i++)
            {
                ...
                else if (standardsManager.TrustDriver.IsSignWithElement(element, out algorithm))
                {
                    if (
                        (
                            this.keyType == SecurityKeyType.SymmetricKey
                            && algorithm != algorithmSuite.DefaultSymmetricSignatureAlgorithm
                        )
                        || (
                            this.keyType == SecurityKeyType.AsymmetricKey
                ...
                else if (standardsManager.TrustDriver.IsEncryptWithElement(element, out algorithm))
                {
                    if (
                        (
                            this.keyType == SecurityKeyType.SymmetricKey
                            && algorithm != algorithmSuite.DefaultEncryptionAlgorithm
                        )
                        || (
                            this.keyType == SecurityKeyType.AsymmetricKey
                ...
                )
                {
                    ...
                    standardsManager.TrustDriver.IsKeyWrapAlgorithmElement(element, out algorithm)
                )
                {
            ...
            if (standardsManager.TrustVersion == TrustVersion.WSTrustFeb2005)
            {
                ...
                return (
                    doesSignWithAlgorithmMatch
                    && doesCanonicalizationAlgorithmMatch
                    && doesEncryptionAlgorithmMatch
                    && doesEncryptWithAlgorithmMatch
                );
            }
            else
            {
                return (
                    ...
                    && doesEncryptionAlgorithmMatch
                    && doesEncryptWithAlgorithmMatch
                    && doesKeyWrapAlgorithmMatch
                );
            }
        }

        internal static IssuedSecurityTokenParameters CreateInfoCardParameters(
            SecurityStandardsManager standardsManager,
            SecurityAlgorithmSuite algorithm
        )
        {
            IssuedSecurityTokenParameters result = new IssuedSecurityTokenParameters(
                SecurityXXX2005Strings.SamlTokenType
            );
        ...
        )
        {
            ...
            {
                ClaimTypeRequirement claimTypeRequirement =
                    parameters.ClaimTypeRequirements[0] as ClaimTypeRequirement;
                ...
                (parameters.AdditionalRequestParameters != null)
                && (parameters.AdditionalRequestParameters.Count > 0)
            )
            {
                ...
                XmlElement claimTypeRequirement = GetClaimTypeRequirement(
            ...
            if (parameters.IssuerAddress != null)
                return false;
            if (
                parameters.AlternativeIssuerEndpoints != null
        ...
        internal static XmlElement GetClaimTypeRequirement(
        ...
        public override string ToString()
        {
            ...
            sb.AppendLine(
                String.Format(
                    CultureInfo.InvariantCulture,
                    "IssuerMetadataAddress: {0}",
                    this.issuerMetadataAddress == null
                        ? "null"
                        : this.issuerMetadataAddress.ToString()
                )
            );
            sb.AppendLine(
                String.Format(
                    CultureInfo.InvariantCulture,
                    "DefaultMessgeSecurityVersion: {0}",
                    this.defaultMessageSecurityVersion == null
                        ? "null"
                        : this.defaultMessageSecurityVersion.ToString()
                )
            );
            sb.AppendLine(
                String.Format(
                ...
                for (int i = 0; i < this.claimTypeRequirements.Count; i++)
                {
                    sb.AppendLine(
                        String.Format(
                            CultureInfo.InvariantCulture,
                            "  {0}, optional={1}",
                            this.claimTypeRequirements[i].ClaimType,
                            this.claimTypeRequirements[i].IsOptional
                        )
                    );
                }
            }
        ...
        )
        {
            ...
            ServiceModelSecurityTokenRequirement serviceModelSecurityTokenRequirement =
                requirement as ServiceModelSecurityTokenRequirement;
            if (serviceModelSecurityTokenRequirement != null)
            {
                serviceModelSecurityTokenRequirement.DefaultMessageSecurityVersion =
                    this.DefaultMessageSecurityVersion;
            }
            else
            {
                requirement.Properties[
                    ServiceModelSecurityTokenRequirement.DefaultMessageSecurityVersionProperty
                ] = this.DefaultMessageSecurityVersion;
            }
            ...
            requirement.Properties[ServiceModelSecurityTokenRequirement.IssuerAddressProperty] =
                this.IssuerAddress;
            if (this.IssuerBinding != null)
            {
                requirement.Properties[ServiceModelSecurityTokenRequirement.IssuerBindingProperty] =
                    this.IssuerBinding;
            }
            requirement.Properties[
