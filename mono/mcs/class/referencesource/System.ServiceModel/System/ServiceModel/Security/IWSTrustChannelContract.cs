...
namespace System.ServiceModel.Security
{
    ...
    public interface IWSTrustChannelContract : IWSTrustContract
    {
        ...
        System.IdentityModel.Protocols.WSTrust.RequestSecurityTokenResponse Cancel(
        ...
        void EndCancel(
            IAsyncResult result,
            out System.IdentityModel.Protocols.WSTrust.RequestSecurityTokenResponse response
        );
        ...
        /// <param name="request">The <see cref="System.IdentityModel.Protocols.WSTrust.RequestSecurityToken" /> that represents the request to the STS.</param>
        /// <returns>The <see cref="System.IdentityModel.Protocols.WSTrust.RequestSecurityTokenResponse" /> representing the STS response.</returns>
        System.IdentityModel.Protocols.WSTrust.RequestSecurityTokenResponse Renew(
            System.IdentityModel.Protocols.WSTrust.RequestSecurityToken request
        );
        ...
        /// <param name="request">The <see cref="System.IdentityModel.Protocols.WSTrust.RequestSecurityToken" /> that represents the request to the STS.</param>
        /// <returns>The <see cref="System.IdentityModel.Protocols.WSTrust.RequestSecurityTokenResponse" /> representing the STS response.</returns>
        System.IdentityModel.Protocols.WSTrust.RequestSecurityTokenResponse Validate(
            System.IdentityModel.Protocols.WSTrust.RequestSecurityToken request
        );
