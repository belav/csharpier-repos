...
namespace System.ServiceModel.Security
{
    ...
    {
        static string ListenUriProperty =
        ...
        )
        {
            ...
            {
                return CreateSamlSecurityTokenAuthenticator(
                    tokenRequirement,
            ...
            if ((securityTokenHandler != null) && (securityTokenHandler.CanValidateToken))
            {
                ...
                {
                    UserNameSecurityTokenHandler upSecurityTokenHandler =
                ...
                {
                    RsaSecurityTokenHandler rsaSecurityTokenHandler =
                    ...
                    StringComparer.Ordinal.Equals(tokenType, SecurityTokenTypes.X509Certificate)
                )
                {
                    X509SecurityTokenHandler x509SecurityTokenHandler =
                ...
                {
                    securityTokenAuthenticator = new SecurityTokenAuthenticatorAdapter(
            ...
            {
                if (
                    tokenType == ServiceModelSecurityTokenTypes.SecureConversation
        ...
        )
        {
            ...
            {
                sessionTokenHandler = new SessionSecurityTokenHandler(
                    _cookieTransforms,
            ...
            WrappedSessionSecurityTokenAuthenticator wssta =
                new WrappedSessionSecurityTokenAuthenticator(
                    sessionTokenHandler,
                    sta,
                    claimsHandler,
                    _exceptionMapper
        ...
        )
        {
            ...
            {
                (sta as SecuritySessionSecurityTokenAuthenticator).IssuedTokenCache =
                    wrappedTokenCache;
            }
            ...
            if (issuanceTokenAuthenticator != null)
            {
                ...
                issuanceTokenAuthenticator.RenewedSecurityTokenHandler =
                    claimsHandler.OnTokenRenewed;
            }
        }
        ...
        )
        {
            ...
            WsSecurityTokenSerializerAdapter adapter = new WsSecurityTokenSerializerAdapter(
                _securityTokenHandlerCollection,
                GetSecurityVersion(version),
                trustVersion,
                scVersion,
                false,
                this.ServiceCredentials.IssuedTokenAuthentication.SamlSerializer,
            ...
            if (_defaultTokenResolver == null)
            {
                lock (_syncObject)
                {
                    if (_defaultTokenResolver == null)
                    {
                        ...
                        if (base.ServiceCredentials.ServiceCertificate.Certificate != null)
                        {
                            outOfBandTokens.Add(
                                new X509SecurityToken(
                                    base.ServiceCredentials.ServiceCertificate.Certificate
                                )
                            );
                        }
                        ...
                        if (
                            (
                                base.ServiceCredentials.IssuedTokenAuthentication.KnownCertificates
                                != null
                            )
                            && (
            ...
            else
            {
                if (
                    tokenVersion
                        ...
                        .Contains(WSSecurity11Constants.Namespace)
                )
                {
                    ...
                    tokenVersion
                        .GetSecuritySpecifications()
                        .Contains(WSSecurity10Constants.Namespace)
                )
                {
        ...
        )
        {
            ...
            SetWrappedTokenCache(
                new WrappedTokenCache(_tokenCache, claimsHandler),
        ...
        )
        {
            ...
            SamlSecurityTokenHandler saml11SecurityTokenHandler =
                _securityTokenHandlerCollection[SecurityTokenTypes.SamlTokenProfile11]
                as SamlSecurityTokenHandler;
            Saml2SecurityTokenHandler saml2SecurityTokenHandler =
                _securityTokenHandlerCollection[SecurityTokenTypes.Saml2TokenProfile11]
                as Saml2SecurityTokenHandler;

            if (
                saml11SecurityTokenHandler != null
            ...
            if (saml11SecurityTokenHandler != null && saml2SecurityTokenHandler != null)
            {
                ...
                WrappedSaml11SecurityTokenAuthenticator wrappedSaml11SecurityTokenAuthenticator =
                    new WrappedSaml11SecurityTokenAuthenticator(
                        saml11SecurityTokenHandler,
                        _exceptionMapper
                    );
                ...
                securityTokenAuthenticator = new WrappedSamlSecurityTokenAuthenticator(
