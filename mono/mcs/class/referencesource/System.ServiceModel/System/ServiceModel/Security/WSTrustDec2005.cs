    ...
    class WSTrustDec2005 : WSTrustFeb2005
    {
        ...
        public class DriverDec2005 : WSTrustFeb2005.DriverFeb2005
        {
            ...
            )
            {
                ...
                if (
                    element.LocalName == this.DriverDictionary.KeyType.Value
            ...
            public override XmlElement CreateRequiredClaimsElement(
                IEnumerable<XmlElement> claimsList
            )
            {
            ...
            )
            {
                ...
                if (
                    ...
                    && originalRequestParameters[0] != null
                    && originalRequestParameters[0].OwnerDocument != null
                )
                {
                    XmlElement secondaryParamElement = originalRequestParameters[
                        0
            ...
            {
                return (
                    (element.LocalName == DXD.TrustDec2005Dictionary.SecondaryParameters.Value)
            ...
            public virtual XmlElement CreateKeyWrapAlgorithmElement(string keyWrapAlgorithm)
            {
                ...
                XmlElement result = doc.CreateElement(
                    DXD.TrustDec2005Dictionary.Prefix.Value,
                    DXD.TrustDec2005Dictionary.KeyWrapAlgorithm.Value,
                    DXD.TrustDec2005Dictionary.Namespace.Value
                );
