...
namespace System.ServiceModel.Security
{
    ...
    public sealed class X509CertificateRecipientClientCredential
    {
        ...
        internal X509CertificateRecipientClientCredential(
            X509CertificateRecipientClientCredential other
        )
        {
            ...
            {
                this.sslCertificateAuthentication = new X509ServiceCertificateAuthentication(
        ...
        {
            get { return this.sslCertificateAuthentication; }
            set
            {
                ThrowIfImmutable();
        ...
        )
        {
            ...
            ThrowIfImmutable();
            this.defaultCertificate = SecurityUtils.GetCertificateFromStore(
                storeName,
                storeLocation,
                findType,
                findValue,
        ...
        )
        {
            ...
            ThrowIfImmutable();
            X509Certificate2 certificate = SecurityUtils.GetCertificateFromStore(
                storeName,
                storeLocation,
                findType,
                findValue,
