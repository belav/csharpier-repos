...
namespace System.ServiceModel.Security
{
    ...
    sealed class SecuritySessionServerSettings
        : IListenerSecureConversationSessionSettings,
            ISecurityCommunicationObject
    {
        ...
        internal static readonly TimeSpan defaultInactivityTimeout = TimeSpan.Parse(
            defaultInactivityTimeoutString,
            CultureInfo.InvariantCulture
        );
        ...
        {
            get { return this.settingsLifetimeManager; }
            set
            {
                this.communicationObject.ThrowIfDisposedOrImmutable();
        ...
        {
            get { return this.securityChannelListener; }
            set
            {
                this.communicationObject.ThrowIfDisposedOrImmutable();
        ...
        {
            get { return this.sessionTokenAuthenticator; }
        }

        public ISecurityContextSecurityTokenCache SessionTokenCache
        {
            get { return this.sessionTokenCache; }
        }

        public SecurityTokenResolver SessionTokenResolver
        {
            get { return this.sessionTokenResolver; }
        }
        ...
        {
            get { return this.maximumPendingSessions; }
            set
            {
                if (value <= 0)
                {
        ...
        {
            get { return this.maximumKeyRenewalInterval; }
            set
            {
                if (value <= TimeSpan.Zero)
                {
        ...
        {
            get { return this.maximumPendingKeysPerSession; }
            set
            {
                if (value <= 0)
                {
        ...
        void SetupSessionTokenAuthenticator()
        {
            ...
            requirement.MessageSecurityVersion = sessionProtocolFactory
            ...
            requirement.MessageAuthenticationAuditLevel =
                sessionProtocolFactory.MessageAuthenticationAuditLevel;
            ...
            if (sessionProtocolFactory.EndpointFilterTable != null)
            {
                ...
                ] = sessionProtocolFactory.EndpointFilterTable;
            }
            this.sessionTokenAuthenticator =
                this.sessionProtocolFactory.SecurityTokenManager.CreateSecurityTokenAuthenticator(
                    requirement,
                    out this.sessionTokenResolver
                );
            if (!(this.sessionTokenAuthenticator is IIssuanceSecurityTokenAuthenticator))
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                    new InvalidOperationException(
                        SR.GetString(
                            SR.SecuritySessionRequiresIssuanceAuthenticator,
            ...
            if (
                ...
                || (!(sessionTokenResolver is ISecurityContextSecurityTokenCache))
            )
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                    new InvalidOperationException(
                        SR.GetString(
                            SR.SecuritySessionRequiresSecurityContextTokenCache,
        ...
        public void OnOpen(TimeSpan timeout)
        {
            ...
            if (this.standardsManager == null)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                    new InvalidOperationException(
                        SR.GetString(SR.SecurityStandardsManagerNotSet, this.GetType())
                    )
                );
            }
            ...
            if (this.securityChannelListener == null)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                    new InvalidOperationException(
                        SR.GetString(SR.SecurityChannelListenerNotSet, this.GetType())
                    )
                );
            }
            if (this.settingsLifetimeManager == null)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                    new InvalidOperationException(
                        SR.GetString(SR.SecuritySettingsLifetimeManagerNotSet, this.GetType())
                    )
                );
            }
            ...
            {
                this.inactivityTimer = new IOThreadTimer(
                    new Action<object>(this.OnTimer),
                    this,
                    false
                );
        ...
        {
            return this.pendingSessions1.Count
                + this.pendingSessions2.Count
        ...
        void AbortPendingChannels()
        {
            lock (ThisLock)
            {
                ...
                {
                    foreach (
                        IServerReliableChannelBinder pendingChannelBinder in pendingSessions1.Values
                    )
                    {
                ...
                {
                    foreach (
                        IServerReliableChannelBinder pendingChannelBinder in pendingSessions2.Values
                    )
                    {
                        pendingChannelBinder.Abort();
                    }
        ...
        void ConfigureSessionSecurityProtocolFactory()
        {
            if (this.sessionProtocolFactory is SessionSymmetricMessageSecurityProtocolFactory)
            {
                ...
                SessionSymmetricMessageSecurityProtocolFactory messagePf =
                ...
                messagePf.ProtectionRequirements.IncomingSignatureParts.AddParts(
                    bodyPart,
                ...
                messagePf.ProtectionRequirements.OutgoingSignatureParts.AddParts(
                    bodyPart,
                    this.SecurityStandardsManager.SecureConversationDriver.CloseResponseAction
                );
                messagePf.ProtectionRequirements.OutgoingSignatureParts.AddParts(
                ...
                {
                    messagePf.ProtectionRequirements.OutgoingEncryptionParts.AddParts(
                ...
                {
                    messagePf.ProtectionRequirements.IncomingEncryptionParts.AddParts(
                        MessagePartSpecification.NoParts,
                        this.SecurityStandardsManager.SecureConversationDriver.CloseAction
                    );
                    messagePf.ProtectionRequirements.IncomingEncryptionParts.AddParts(
            ...
            {
                SessionSymmetricTransportSecurityProtocolFactory transportPf =
            ...
            where TChannel : class, IChannel
        {
            ...
            {
                Fx.Assert(
                    "SecuritySessionServerSettings.CreateAcceptor (this.channelAcceptor != null)"
                );
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
            ...
            {
                this.channelAcceptor = new SecuritySessionChannelAcceptor<IDuplexSessionChannel>(
                    this.SecurityChannelListener,
                    listenerSecurityState
                );
            }
        ...
        internal IChannelListener CreateInnerChannelListener()
        {
            ...
            {
                return this.ChannelBuilder.BuildChannelListener<IDuplexSessionChannel>(
            ...
            {
                return this.ChannelBuilder.BuildChannelListener<IDuplexChannel>(
                    new MatchNoneMessageFilter(),
                    int.MinValue
                );
            }
            ...
            {
                return this.ChannelBuilder.BuildChannelListener<IReplyChannel>(
                    new MatchNoneMessageFilter(),
                    int.MinValue
                );
            }
        ...
        void OnTokenRenewed(SecurityToken newToken, SecurityToken oldToken)
        {
            ...
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                    new EndpointNotFoundException(SR.GetString(SR.SecurityListenerClosing))
                );
            }
            SecurityContextSecurityToken newSecurityContextToken =
                newToken as SecurityContextSecurityToken;
            if (newSecurityContextToken == null)
            {
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                    new ArgumentException(
                        SR.GetString(
                            SR.SessionTokenIsNotSecurityContextToken,
                            newToken.GetType(),
            ...
            SecurityContextSecurityToken oldSecurityContextToken =
            ...
            IServerSecuritySessionChannel sessionChannel = this.FindSessionChannel(
                newSecurityContextToken.ContextId
            );
        ...
        IServerReliableChannelBinder CreateChannelBinder(
            SecurityContextSecurityToken sessionToken,
            EndpointAddress remoteAddress
        )
        {
            IServerReliableChannelBinder result = null;
            MessageFilter sctFilter = new SecuritySessionFilter(
                sessionToken.ContextId,
                this.sessionProtocolFactory.StandardsManager,
                (this.sessionProtocolFactory.SecurityHeaderLayout == SecurityHeaderLayout.Strict),
            ...
            TolerateFaultsMode faultMode = this.TolerateTransportFailures
            ...
            lock (ThisLock)
            {
                if (this.ChannelBuilder.CanBuildChannelListener<IDuplexSessionChannel>())
                {
                    result = ServerReliableChannelBinder<IDuplexSessionChannel>.CreateBinder(
                        this.ChannelBuilder,
                        remoteAddress,
                        sctFilter,
                        sctPriority,
                ...
                {
                    result = ServerReliableChannelBinder<IDuplexChannel>.CreateBinder(
                        this.ChannelBuilder,
                        remoteAddress,
                        sctFilter,
                        sctPriority,
                ...
                {
                    result = ServerReliableChannelBinder<IReplyChannel>.CreateBinder(
                        this.ChannelBuilder,
                        remoteAddress,
                        sctFilter,
                        sctPriority,
            ...
            SessionInitiationMessageHandler handler = new SessionInitiationMessageHandler(
                result,
                this,
                sessionToken
            );
        ...
        void OnTokenIssued(SecurityToken issuedToken, EndpointAddress tokenRequestor)
        {
            ...
            SecurityContextSecurityToken issuedSecurityContextToken =
            ...
            IServerReliableChannelBinder channelBinder = CreateChannelBinder(
                issuedSecurityContextToken,
                tokenRequestor ?? EndpointAddress.AnonymousAddress
            );
        ...
        {
            if (
                this.communicationObject.State == CommunicationState.Closed
        ...
        void AddPendingSession(UniqueId sessionId, IServerReliableChannelBinder channelBinder)
        {
            lock (ThisLock)
            {
                ...
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                        new QuotaExceededException(SR.GetString(SR.SecuritySessionLimitReached))
                    );
                }
                if (
                    this.pendingSessions1.ContainsKey(sessionId)
                    || this.pendingSessions2.ContainsKey(sessionId)
                )
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperWarning(
                        new MessageSecurityException(
                            SR.GetString(SR.SecuritySessionAlreadyPending, sessionId)
                        )
                    );
                }
        ...
        {
            static AsyncCallback receiveCallback = Fx.ThunkCallback(
            ...
            public SessionInitiationMessageHandler(
                IServerReliableChannelBinder channelBinder,
                SecuritySessionServerSettings settings,
                SecurityContextSecurityToken sessionToken
            )
            ...
            public void ProcessMessage(IAsyncResult result)
            {
                ...
                try
                {
                    ...
                    {
                        SecuritySessionChannelAcceptor<IReplySessionChannel> replyAcceptor = (
                            (SecuritySessionChannelAcceptor<IReplySessionChannel>)
                                this.settings.channelAcceptor
                        );
                        SecurityReplySessionChannel replySessionChannel =
                            new SecurityReplySessionChannel(
                                this.settings,
                                this.channelBinder,
                                sessionToken,
                    ...
                    {
                        SecuritySessionChannelAcceptor<IDuplexSessionChannel> duplexAcceptor = (
                            (SecuritySessionChannelAcceptor<IDuplexSessionChannel>)
                                this.settings.channelAcceptor
                        );
                        ServerSecurityDuplexSessionChannel duplexSessionChannel =
                            new ServerSecurityDuplexSessionChannel(
                                this.settings,
                                this.channelBinder,
                                sessionToken,
                    ...
                    else
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperWarning(
                            new EndpointNotFoundException(
                                SR.GetString(
                                    SR.SecuritySessionListenerNotFound,
...
#pragma warning suppress 56500 // covered by FxCOP
        ...
        class SecuritySessionChannelAcceptor<T>
            : InputQueueChannelAcceptor<T>,
                IInputQueueChannelAcceptor
        ...
        abstract class ServerSecuritySessionChannel : ChannelBase, IServerSecuritySessionChannel
        {
            ...
            protected ServerSecuritySessionChannel(
                SecuritySessionServerSettings settings,
                IServerReliableChannelBinder channelBinder,
                SecurityContextSecurityToken sessionToken,
            ...
            protected virtual void AbortCore()
            {
                ...
                this.Settings.SessionTokenCache.RemoveAllContexts(
            ...
            protected abstract void OnCloseMessageReceived(
                RequestContext requestContext,
                Message message,
            ...
            protected abstract void OnCloseResponseMessageReceived(
                RequestContext requestContext,
                Message message,
                SecurityProtocolCorrelationState correlationState,
                TimeSpan timeout
            ...
            )
            {
                ...
                {
                    if (
                        supportingToken.ContextId != this.currentSessionToken.ContextId
                    ...
                    )
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperWarning(
                            new MessageSecurityException(
                                SR.GetString(
                                    SR.CurrentSessionTokenNotRenewed,
                    ...
                    if (
                        this.futureSessionTokens.Count == this.Settings.MaximumPendingKeysPerSession
                    )
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperWarning(
                            new MessageSecurityException(SR.GetString(SR.TooManyPendingSessionKeys))
                        );
                    }
                    this.futureSessionTokens.Add(newToken);
                }
                SecurityTraceRecordHelper.TraceNewServerSessionKeyIssued(
                    newToken,
                    supportingToken,
                    GetLocalUri()
                );
            ...
            SecurityContextSecurityToken GetSessionToken(SecurityMessageProperty securityProperty)
            {
                SecurityContextSecurityToken sct =
                    (securityProperty.ProtectionToken != null)
                        ? securityProperty.ProtectionToken.SecurityToken
                ...
                if (securityProperty.HasIncomingSupportingTokens)
                {
                    ...
                    {
                        if (
                            securityProperty.IncomingSupportingTokens[i].SecurityTokenAttachmentMode
                            == SecurityTokenAttachmentMode.Endorsing
                        )
                        {
                            sct = (
                                securityProperty.IncomingSupportingTokens[i].SecurityToken
                                as SecurityContextSecurityToken
                            );
                            if (sct != null && sct.ContextId == this.sessionId)
                            {
            ...
            )
            {
                ...
                {
                    if (
                        this.futureSessionTokens.Count > 0
                        && incomingToken.KeyGeneration != this.currentSessionToken.KeyGeneration
                    )
                    {
                        ...
                        for (int i = 0; i < this.futureSessionTokens.Count; ++i)
                        {
                            if (futureSessionTokens[i].KeyGeneration == incomingToken.KeyGeneration)
                            {
                                ...
                                DateTime keyRolloverTime = TimeoutHelper.Add(
                                    DateTime.UtcNow,
                                    this.settings.KeyRolloverInterval
                                );
                                this.settings.SessionTokenCache.UpdateContextCachingTime(
                        ...
                        {
                            SecurityTraceRecordHelper.TraceServerSessionKeyUpdated(
                                this.currentSessionToken,
                                GetLocalUri()
                            );
                            ...
                            {
                                this.Settings.SessionTokenCache.RemoveContext(
                                    futureSessionTokens[i].ContextId,
            ...
            public void StartReceiving(RequestContext initialRequestContext)
            {
                if (this.initialRequestContext != null)
                {
                    ...
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                        new InvalidOperationException(
                            SR.GetString(SR.AttemptToCreateMultipleRequestContext)
                        )
                    );
                }
            ...
            public bool TryReceiveRequest(TimeSpan timeout, out RequestContext requestContext)
            {
                ...
                try
                {
                    while (true)
                    {
                        ...
                        {
                            if (
                                !channelBinder.TryReceive(
                                    timeoutHelper.RemainingTime(),
                                    out innerRequestContext
                                )
                            )
                            {
                                requestContext = null;
                        ...
                        Message requestMessage = ProcessRequestContext(
                            innerRequestContext,
                            timeoutHelper.RemainingTime(),
                            out correlationState,
                            out isSecurityProcessingFailure
                        );
                        if (requestMessage != null)
                        {
                            requestContext = new SecuritySessionRequestContext(
                                innerRequestContext,
                                requestMessage,
                                correlationState,
                                this
            ...
            )
            {
                try
                {
                    ...
                    if (
                        !(this.channelBinder.Channel is IReplyChannel)
                        && !(this.channelBinder.Channel is IDuplexSessionChannel)
                    )
                    {
                        return;
                    }
            ...
            Message ProcessRequestContext(
                RequestContext requestContext,
                TimeSpan timeout,
                out SecurityProtocolCorrelationState correlationState,
                out bool isSecurityProcessingFailure
            )
            {
                ...
                try
                {
                    ...
                    try
                    {
                        correlationState = VerifyIncomingMessage(
                            ref message,
                            timeoutHelper.RemainingTime()
                        );
                    }
                    ...
                    )
                    {
                        ...
                        {
                            SecurityTraceRecordHelper.TraceServerSessionCloseResponseReceived(
                                this.currentSessionToken,
                                GetLocalUri()
                            );
                            this.isInputClosed = true;
...
#pragma warning suppress 56500 // covered by FxCOP
            ...
            internal void CheckOutgoingToken()
            {
                lock (ThisLock)
                {
                    if (this.currentSessionToken.KeyExpirationTime < DateTime.UtcNow)
                    {
                        throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                            new SessionKeyExpiredException(
                                SR.GetString(SR.SecuritySessionKeyIsStale)
                            )
                        );
                    }
                }
            ...
            internal void SecureApplicationMessage(
                ref Message message,
                TimeSpan timeout,
                SecurityProtocolCorrelationState correlationState
            )
                ...
                if (!areFaultCodesInitialized)
                {
                    lock (ThisLock)
                    {
                        if (!areFaultCodesInitialized)
                        {
                            ...
                            renewFaultCode = FaultCode.CreateSenderFaultCode(
                                scDriver.RenewNeededFaultCode.Value,
                                scDriver.Namespace.Value
                            );
                            renewFaultReason = new FaultReason(
                                SR.GetString(SR.SecurityRenewFaultReason),
                                System.Globalization.CultureInfo.InvariantCulture
                            );
                            sessionAbortedFaultCode = FaultCode.CreateSenderFaultCode(
                                DotNetSecurityStrings.SecuritySessionAbortedFault,
                                DotNetSecurityStrings.Namespace
                            );
                            sessionAbortedFaultReason = new FaultReason(
                                SR.GetString(SR.SecuritySessionAbortedFaultReason),
                                System.Globalization.CultureInfo.InvariantCulture
                            );
            ...
            )
            {
                ...
                try
                {
                    ...
                    MessageFault renewFault = MessageFault.CreateFault(
                        renewFaultCode,
                        renewFaultReason
                    );
                    Message response;
                    ...
                    SecurityTraceRecordHelper.TraceSessionRenewalFaultSent(
                        this.currentSessionToken,
                        GetLocalUri(),
                        message
                    );
                ...
                {
                    SecurityTraceRecordHelper.TraceRenewFaultSendFailure(
                        this.currentSessionToken,
                        GetLocalUri(),
                        e
                    );
            ...
            Message ProcessCloseRequest(Message request)
            {
                ...
                if (
                    sctSkiClause == null
                    || !SecuritySessionSecurityTokenAuthenticator.DoesSkiClauseMatchSigningToken(
                        sctSkiClause,
                        request
                    )
                )
            ...
            internal Message CreateCloseResponse(
                Message message,
                SecurityProtocolCorrelationState correlationState,
                TimeSpan timeout
            )
            ...
            {
                SecurityTraceRecordHelper.TraceSessionClosedResponseSent(
                    this.currentSessionToken,
                    GetLocalUri()
                );
            }
            ...
            {
                SecurityTraceRecordHelper.TraceSessionClosedResponseSendFailure(
                    this.currentSessionToken,
                    GetLocalUri(),
                    e
                );
            ...
            {
                SecurityTraceRecordHelper.TraceSessionClosedSent(
                    this.currentSessionToken,
                    GetLocalUri()
                );
            }
            ...
            {
                SecurityTraceRecordHelper.TraceSessionCloseSendFailure(
                    this.currentSessionToken,
                    GetLocalUri(),
                    e
                );
            ...
            internal IAsyncResult BeginSendClose(
                TimeSpan timeout,
                AsyncCallback callback,
                object state
            )
            ...
            {
                static AsyncCallback sendCallback = Fx.ThunkCallback(
                ...
                IAsyncResult BeginSend(Message response)
                {
                    ...
                    {
                        return this.sessionChannel.channelBinder.BeginSend(
                            response,
                            timeoutHelper.RemainingTime(),
                            sendCallback,
                            this
...
#pragma warning suppress 56500 // covered by FxCOP
            ...
            {
                static AsyncCallback channelBinderCloseCallback = Fx.ThunkCallback(
                    new AsyncCallback(ChannelBinderCloseCallback)
                );
                static AsyncCallback settingsLifetimeManagerCloseCallback = Fx.ThunkCallback(
                    new AsyncCallback(SettingsLifetimeManagerCloseCallback)
                );
                ...
                {
                    this.channel.Settings.SessionTokenCache.RemoveAllContexts(
...
#pragma warning suppress 56500 // covered by FxCOP
                ...
                bool OnChannelBinderClosed()
                {
                    try
                    {
                        ...
                        {
                            this.channel.securityProtocol.Close(
                                false,
                                timeoutHelper.RemainingTime()
                            );
                        }
                        ...
                        IAsyncResult result = this.channel.settingsLifetimeManager.BeginClose(
                            timeoutHelper.RemainingTime(),
                            settingsLifetimeManagerCloseCallback,
                            this
                        );
                        if (!result.CompletedSynchronously)
                        {
...
#pragma warning suppress 56500 // covered by FxCOP
            ...
            protected class SoapSecurityInputSession : ISecureConversationSession, IInputSession
            {
                ...
                public SoapSecurityInputSession(
                    SecurityContextSecurityToken sessionToken,
                    SecuritySessionServerSettings settings,
                    ServerSecuritySessionChannel channel
                )
                {
                    ...
                    Claim identityClaim = SecurityUtils.GetPrimaryIdentityClaim(
                        sessionToken.AuthorizationPolicies
                    );
                ...
                public string Id
                {
                    get { return this.securityContextTokenId.ToString(); }
                }
                ...
                public bool TryReadSessionTokenIdentifier(XmlReader reader)
                {
                    ...
                    return incomingTokenIdentifier != null
                        && incomingTokenIdentifier.Matches(this.securityContextTokenId, null);
                }
            }
            ...
            class ReceiveRequestAsyncResult : AsyncResult
            {
                ...
                public ReceiveRequestAsyncResult(
                    ServerSecuritySessionChannel channel,
                    TimeSpan timeout,
                    AsyncCallback callback,
                    object state
                    ...
                    : base(callback, state)
                {
                    ...
                    this.channel = channel;
                    if (
                        !channel.receiveLock.EnterAsync(
...
#pragma warning suppress 56500 // covered by FxCOP
                ...
                bool WaitComplete()
                {
                    ...
                    ServiceModelActivity activity =
                        DiagnosticUtility.ShouldUseActivity && channel.initialRequestContext != null
                            ? TraceUtility.ExtractActivity(
                                channel.initialRequestContext.RequestMessage
                            )
                            : null;
                    ...
                    using (ServiceModelActivity.BoundOperation(activity))
                    {
                        if (channel.initialRequestContext != null)
                        {
                            ...
                            bool isSecurityProcessingFailure;
                            requestMessage = channel.ProcessRequestContext(
                                innerRequestContext,
                                timeoutHelper.RemainingTime(),
                ...
                bool CompleteReceive(IAsyncResult result)
                {
                    while (true)
                    {
                        this.expired = !channel.ChannelBinder.EndTryReceive(
                            result,
                            out this.innerRequestContext
                        );
                        ...
                        if (requestMessage != null)
                        {
                            ...
                            {
                                ProtocolException error =
                                    ProtocolException.ReceiveShutdownReturnedNonNull(
                                        requestMessage
                                    );
                                try
                                {
                    ...
                    catch (Exception e)
                    {
                        ...
                        if (DiagnosticUtility.ShouldTraceWarning)
                        {
                            TraceUtility.TraceEvent(
                                ...
                                TraceCode.AsyncCallbackThrewException,
                                SR.GetString(SR.TraceCodeAsyncCallbackThrewException),
                                e.ToString()
                            );
                        }
                    }
...
#pragma warning suppress 56500 // covered by FxCOP
                ...
                public static bool EndAsMessage(IAsyncResult result, out Message message)
                {
                    ...
                    if (message != null)
                    {
                        if (receiveResult.innerRequestContext != null)
                        {
                            try
                            {
                                receiveResult.innerRequestContext.Close(
                                    receiveResult.timeoutHelper.RemainingTime()
                                );
                            }
                            catch (TimeoutException e)
                            {
                ...
                public static bool EndAsRequestContext(
                    IAsyncResult result,
                ...
                )
                {
                    ...
                    {
                        requestContext = new SecuritySessionRequestContext(
                            receiveResult.innerRequestContext,
                            receiveResult.requestMessage,
                            receiveResult.correlationState,
                            receiveResult.channel
                        );
                    }
...
#pragma warning suppress 56500 // covered by FxCOP
        ...
        abstract class ServerSecuritySimplexSessionChannel : ServerSecuritySessionChannel
        {
            ...
            bool ShouldSendCloseResponseOnClose(
                out RequestContext pendingCloseRequestContext,
                out Message pendingCloseResponse
            )
            {
            ...
            bool SendCloseResponseOnCloseIfRequired(TimeSpan timeout)
            {
                ...
                bool sendCloseResponse = ShouldSendCloseResponseOnClose(
                    out pendingCloseRequestContext,
                    out pendingCloseResponse
                );
                TimeoutHelper timeoutHelper = new TimeoutHelper(timeout);
            ...
            protected override void OnClose(TimeSpan timeout)
            {
                ...
                bool wasInputSessionClosed = this.WaitForInputSessionClose(
                    timeoutHelper.RemainingTime(),
                    out wasAborted
                );
                if (wasAborted)
                ...
                if (!wasInputSessionClosed)
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperWarning(
                        new TimeoutException(
                            SR.GetString(
                                SR.ServiceSecurityCloseTimeout,
            ...
            protected override void OnCloseResponseMessageReceived(
                RequestContext requestContext,
                Message message,
                SecurityProtocolCorrelationState correlationState,
                TimeSpan timeout
            ...
            protected override void OnCloseMessageReceived(
                RequestContext requestContext,
                Message message,
                SecurityProtocolCorrelationState correlationState,
                TimeSpan timeout
            )
            {
                ...
                {
                    Fx.Assert(
                        "ServerSecuritySimplexSessionChannel.OnCloseMessageReceived (this.State == Created)"
                    );
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                        new InvalidOperationException(
                            SR.GetString(
                                SR.ServerReceivedCloseMessageStateIsCreated,
                                this.GetType().ToString()
                            )
                        )
                    );
                ...
                if (
                    SendCloseResponseOnCloseReceivedIfRequired(
                        requestContext,
                        message,
                        correlationState,
                        timeout
            ...
            bool SendCloseResponseOnCloseReceivedIfRequired(
                RequestContext requestContext,
                Message message,
                SecurityProtocolCorrelationState correlationState,
                TimeSpan timeout
                ...
                try
                {
                    ...
                    lock (ThisLock)
                    {
                        if (!this.receivedClose)
                        {
                            ...
                            localCloseResponse = CreateCloseResponse(
                                message,
                                correlationState,
                                timeoutHelper.RemainingTime()
                            );
            ...
            {
                static readonly AsyncCallback sendCloseResponseCallback = Fx.ThunkCallback(
                    new AsyncCallback(SendCloseResponseCallback)
                );
                static readonly AsyncCallback receiveCallback = Fx.ThunkCallback(
                    new AsyncCallback(ReceiveCallback)
                );
                static readonly AsyncCallback waitCallback = Fx.ThunkCallback(
                    new AsyncCallback(WaitForInputSessionCloseCallback)
                );
                    ...
                    : base(callback, state)
                {
                    ...
                    bool completeSelf = this.OnSendCloseResponse(
                        sendCloseResponse,
                        out wasChannelAborted
                    );
...
#pragma warning suppress 56500 // covered by FxCOP
                ...
                bool OnReceiveNullMessage(out bool wasChannelAborted)
                {
                    ...
                    try
                    {
                        IAsyncResult result = this.sessionChannel.BeginTryReceive(
                            this.timeoutHelper.RemainingTime(),
                            receiveCallback,
                            this
                        );
                ...
                static void ReceiveCallback(IAsyncResult result)
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            receivedMessage = thisResult.sessionChannel.EndTryReceive(
                                result,
                                out message
                            );
                        }
...
#pragma warning suppress 56500 // covered by FxCOP
        ...
        class SecuritySessionRequestContext : RequestContextBase
        {
            ...
            public SecuritySessionRequestContext(
                RequestContext requestContext,
                Message requestMessage,
                SecurityProtocolCorrelationState correlationState,
                ServerSecuritySessionChannel channel
            ...
            protected override void OnReply(Message message, TimeSpan timeout)
            {
                ...
                if (message != null)
                {
                    this.channel.SecureApplicationMessage(
                        ref message,
                        timeoutHelper.RemainingTime(),
                        correlationState
                    );
            ...
            )
            {
                ...
                return this.requestContext.BeginReply(
                    message,
                    timeoutHelper.RemainingTime(),
                    callback,
                    state
        ...
        class ServerSecurityDuplexSessionChannel
            : ServerSecuritySessionChannel,
                IDuplexSessionChannel
        {
            ...
            )
            {
                ...
                TimeoutHelper timeoutHelper = new TimeoutHelper(timeout);
                this.SecureApplicationMessage(ref message, timeoutHelper.RemainingTime(), null);
                return this.ChannelBinder.BeginSend(
                    message,
                    timeoutHelper.RemainingTime(),
                    callback,
                    state
            ...
            protected override void OnClose(TimeSpan timeout)
            {
                ...
                bool wasAborted;
                bool didInputSessionClose = this.WaitForInputSessionClose(
                    timeoutHelper.RemainingTime(),
                    out wasAborted
                );
                if (wasAborted)
                ...
                bool didOutputSessionClose = this.WaitForOutputSessionClose(
                    timeoutHelper.RemainingTime(),
                    out wasAborted
                );
                if (wasAborted)
                ...
                if (!didOutputSessionClose)
                {
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperWarning(
                        new TimeoutException(
                            SR.GetString(
                                SR.ServiceSecurityCloseOutputSessionTimeout,
                                timeoutHelper.OriginalTimeout
                            )
                        )
                    );
                    ...
                    else
                    {
                        lock (ThisLock)
                        {
                            if (!(this.isInputClosed))
                            {
                                ...
                                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                                    new InvalidOperationException(
                                        SR.GetString(SR.ShutdownRequestWasNotReceived)
                                    )
                                );
                            }
                        }
            ...
            )
            {
                ...
                {
                    Fx.Assert(
                        "ServerSecurityDuplexSessionChannel.OnCloseMessageReceived (this.State == Created)"
                    );
                    throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                        new InvalidOperationException(
                            SR.GetString(
                    ...
                    lock (ThisLock)
                    {
                        ...
                        if (!this.isInputClosed)
                        {
                            ...
                            if (!this.isOutputClosed)
                            {
                                ...
                                this.closeResponseMessage = CreateCloseResponse(
                                    message,
                                    null,
                                    timeoutHelper.RemainingTime()
                                );
            ...
            void DetermineCloseOutputSessionMessage(
                out bool sendClose,
                out bool sendCloseResponse,
                out Message pendingCloseResponseMessage,
                out RequestContext pendingCloseRequestContext
            )
            {
                sendClose = false;
            ...
            void CloseOutputSession(TimeSpan timeout)
            {
                ...
                try
                {
                    DetermineCloseOutputSessionMessage(
                        out sendClose,
                        out sendCloseResponse,
                        out pendingCloseResponseMessage,
                        out pendingCloseRequestContext
                    );
                    if (sendCloseResponse)
                    {
            ...
            class CloseOutputSessionAsyncResult : AsyncResult
            {
                    ...
                    : base(callback, state)
                {
                    this.sessionChannel = sessionChannel;
                    this.timeoutHelper = new TimeoutHelper(timeout);
                    this.sessionChannel.DetermineCloseOutputSessionMessage(
                        out sendClose,
                        out sendCloseResponse,
                        out closeResponseMessage,
                ...
                static void SendCallback(IAsyncResult result)
                {
                    ...
                    CloseOutputSessionAsyncResult self = (CloseOutputSessionAsyncResult)(
                        result.AsyncState
                    );
                    Exception completionException = null;
                    try
...
#pragma warning suppress 56500 // covered by FxCOP
                ...
                IAsyncResult BeginSend(AsyncCallback callback, object state)
                {
                    if (this.sendClose)
                    {
                        return this.sessionChannel.BeginSendClose(
                            timeoutHelper.RemainingTime(),
                            callback,
                            state
                        );
                    ...
                    {
                        return this.sessionChannel.BeginSendCloseResponse(
            ...
            class CloseAsyncResult : AsyncResult
            {
                ...
                static readonly AsyncCallback inputSessionWaitCallback = Fx.ThunkCallback(
                    new AsyncCallback(WaitForInputSessionCloseCallback)
                );
                static readonly AsyncCallback closeOutputSessionCallback = Fx.ThunkCallback(
                    new AsyncCallback(CloseOutputSessionCallback)
                );
                static readonly AsyncCallback outputSessionWaitCallback = Fx.ThunkCallback(
                    new AsyncCallback(WaitForOutputSessionCloseCallback)
                );
                static readonly AsyncCallback closeCoreCallback = Fx.ThunkCallback(
                    new AsyncCallback(CloseCoreCallback)
                );
...
#pragma warning suppress 56500 // covered by FxCOP
                ...
                static void ReceiveCallback(IAsyncResult result)
                {
                    ...
                    try
                    {
                        ...
                        try
                        {
                            receivedRequest = thisResult.sessionChannel.EndTryReceive(
                                result,
                                out message
                            );
                        }
...
#pragma warning suppress 56500 // covered by FxCOP
                ...
                bool OnMessageReceived(Message message)
                {
                    ...
                    try
                    {
                        IAsyncResult result = this.sessionChannel.inputSessionCloseHandle.BeginWait(
                            this.timeoutHelper.RemainingTime(),
                            inputSessionWaitCallback,
                            this
                        );
                        if (!result.CompletedSynchronously)
                        {
...
#pragma warning suppress 56500 // covered by FxCOP
            ...
            class SoapSecurityServerDuplexSession : SoapSecurityInputSession, IDuplexSession
            {
                ...
                public SoapSecurityServerDuplexSession(
                    SecurityContextSecurityToken sessionToken,
                    SecuritySessionServerSettings settings,
                    ServerSecurityDuplexSessionChannel channel
                )
        ...
        internal class SecuritySessionDemuxFailureHandler : IChannelDemuxFailureHandler
        {
            ...
            public void HandleDemuxFailure(Message message)
            {
                ...
                if (DiagnosticUtility.ShouldTraceWarning)
                {
                    TraceUtility.TraceEvent(
                        TraceEventType.Warning,
                        TraceCode.SecuritySessionDemuxFailure,
                        SR.GetString(SR.TraceCodeSecuritySessionDemuxFailure),
                        message
                    );
                }
            }
            ...
            {
                MessageFault fault = SecurityUtils.CreateSecurityContextNotFoundFault(
            ...
            IAsyncResult BeginHandleDemuxFailure<TFaultContext>(
                Message message,
            ...
            )
            {
                ...
                return new SendFaultAsyncResult<TFaultContext>(
                    fault,
                    faultContext,
                    callback,
                    state
            ...
            public IAsyncResult BeginHandleDemuxFailure(
                Message message,
            ...
            {
                return BeginHandleDemuxFailure<RequestContext>(
                    message,
                    faultContext,
                    callback,
                    state
            ...
            {
                return BeginHandleDemuxFailure<IOutputChannel>(
                    message,
                    faultContext,
                    callback,
                    state
            ...
            class SendFaultAsyncResult<TFaultContext> : AsyncResult
            {
                ...
                static void SendCallback(IAsyncResult result)
                {
                    ...
                    SendFaultAsyncResult<TFaultContext> self =
                        (SendFaultAsyncResult<TFaultContext>)result.AsyncState;
                    Exception completionException = null;
                    try
                    {
                        self.EndSend(result);
