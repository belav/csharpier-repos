...
namespace System.ServiceModel.Security
{
    ...
    {
        internal static void AddNamespaceDeclaration(
        ...
        internal static string EnsureNamespaceDefined(
            XmlDictionaryWriter writer,
            XmlDictionaryString ns,
        ...
        internal static XmlQualifiedName GetAttributeValueAsQName(
            XmlReader reader,
        ...
        internal static XmlElement GetChildElement(
            XmlElement parent,
        ...
        internal static string GetRequiredNonEmptyAttribute(
            XmlDictionaryReader reader,
            XmlDictionaryString name,
            XmlDictionaryString ns
        )
        ...
        internal static byte[] GetRequiredBase64Attribute(
            XmlDictionaryReader reader,
            XmlDictionaryString name,
            XmlDictionaryString ns
        )
        ...
        internal static void SplitIntoPrefixAndName(
            string qName,
            out string prefix,
            out string name
        )
        ...
        internal static UniqueId GetAttributeAsUniqueId(
            XmlDictionaryReader reader,
