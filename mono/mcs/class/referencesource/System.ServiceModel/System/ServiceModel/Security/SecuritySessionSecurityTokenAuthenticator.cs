            ...
            ILogonTokenCacheManager
    {
            ...
            : base()
        {
            ...
            this.negotiationTimeout =
                AcceleratedTokenAuthenticator.defaultServerMaxNegotiationLifetime;
        }
        ...
        {
            get { return this.sessionTokenLifetime; }
            set
            {
                this.CommunicationObject.ThrowIfDisposedOrImmutable();
        ...
        {
            get { return standardsManager.SecureConversationDriver.IssueAction; }
        }

        public virtual XmlDictionaryString IssueResponseAction
        {
            get { return standardsManager.SecureConversationDriver.IssueResponseAction; }
        }
        ...
        {
            get { return standardsManager.SecureConversationDriver.RenewAction; }
        }

        public virtual XmlDictionaryString RenewResponseAction
        {
            get { return standardsManager.SecureConversationDriver.RenewResponseAction; }
        }
        ...
        {
            if (
                this.RequestSecurityTokenListener != null
                && this.RequestSecurityTokenListener.ChannelDispatchers.Count > 0
            )
            {
                //
                // this is the SCT case, delegate to the RST's listener list
        ...
        Message HandleOperationException(
            SecuritySessionOperation operation,
            Message request,
            Exception e
        )
        {
            SecurityTraceRecordHelper.TraceServerSessionOperationException(
                operation,
                e,
                this.ListenUri
            );
        ...
        Message CreateFault(Message request, Exception e)
        {
            ...
            if (e is QuotaExceededException)
            {
                ...
                reason = new FaultReason(
                    SR.GetString(SR.PendingSessionsExceededFaultReason),
            ...
            else if (e is EndpointNotFoundException)
            {
                ...
                subCode = new FaultCode(
                    ...
                    request.Version.Addressing.Namespace
                );
                reason = new FaultReason(
                    SR.GetString(SR.SecurityListenerClosingFaultReason),
                    CultureInfo.CurrentCulture
                );
                isSenderFault = false;
            }
        ...
        void NotifyOperationCompletion(
            SecuritySessionOperation operation,
            SecurityContextSecurityToken newSessionToken,
            SecurityContextSecurityToken previousSessionToken,
            ...
            if (operation == SecuritySessionOperation.Issue)
            {
                ...
                else
                {
                    throw DiagnosticUtility
                        .ExceptionUtility
                        .ThrowHelperWarning(
                            new SecurityNegotiationException(SR.IssueSessionTokenHandlerNotSet)
                        );
                }
            }
            else if (operation == SecuritySessionOperation.Renew)
            {
                ...
                else
                {
                    throw DiagnosticUtility
                        .ExceptionUtility
                        .ThrowHelperWarning(
                            new SecurityNegotiationException(SR.RenewSessionTokenHandlerNotSet)
                        );
                }
            }
            else
        ...
        static bool IsSameIdentity(
            ...
            ServiceSecurityContext incomingContext
        )
        {
        ...
        {
            DateTime keyExpirationTime = TimeoutHelper.Add(
                keyEffectiveTime,
                this.keyRenewalInterval
            );
            DateTime tokenExpirationTime =
                (currentToken != null)
                    ? currentToken.ValidTo
                    : TimeoutHelper.Add(keyEffectiveTime, this.sessionTokenLifetime);
        ...
        internal static ReadOnlyCollection<IAuthorizationPolicy> CreateSecureConversationPolicies(
        ...
        static ReadOnlyCollection<IAuthorizationPolicy> CreateSecureConversationPolicies(
            SecurityMessageProperty security,
            ReadOnlyCollection<IAuthorizationPolicy> currentTokenPolicies,
            DateTime expirationTime
        )
        {
            if (security == null)
            ...
            {
                authorizationPolicies.AddRange(
                ...
                if (
                    (security.TransportToken != null)
                    && (security.TransportToken.SecurityTokenPolicies != null)
                    && (security.TransportToken.SecurityTokenPolicies.Count > 0)
                )
                {
                    foreach (
                        IAuthorizationPolicy policy in security.TransportToken.SecurityTokenPolicies
                    )
                    {
                ...
                for (int i = 0; i < authorizationPolicies.Count; i++)
                {
                    ...
                    {
                        UnconditionalPolicy bootstrapPolicy = (UnconditionalPolicy)
                            authorizationPolicies[i];
                        sctPolicy = new UnconditionalPolicy(
                            bootstrapPolicy.PrimaryIdentity,
                            bootstrapPolicy.Issuances,
                            expirationTime
                        );
        ...
        SecurityContextSecurityToken IssueToken(
            RequestSecurityToken rst,
            Message request,
            SecurityContextSecurityToken currentToken,
            ReadOnlyCollection<IAuthorizationPolicy> currentTokenPolicies,
        ...
        )
        {
            if (rst.TokenType != null && rst.TokenType != this.sctUri)
            {
                throw TraceUtility.ThrowHelperWarning(
                    new InvalidOperationException(
                        SR.GetString(SR.CannotIssueRstTokenType, rst.TokenType)
                    ),
                    request
                );
            }
            ...
            if (clientContext == null)
            {
                throw TraceUtility.ThrowHelperWarning(
                    new InvalidOperationException(
                        SR.GetString(SR.SecurityContextMissing, request.Headers.Action)
                    ),
                    request
                );
            }
                ...
                if (!IsSameIdentity(currentToken.AuthorizationPolicies, clientContext))
                {
                    throw TraceUtility.ThrowHelperWarning(
                        new SecurityNegotiationException(
                            SR.GetString(SR.WrongIdentityRenewingToken)
                        ),
                        request
                    );
                }
            ...
            ReadOnlyCollection<IAuthorizationPolicy> authorizationPolicies =
                (securityProperty != null)
                    ? CreateSecureConversationPolicies(
                        securityProperty,
                        currentTokenPolicies,
                        keyExpirationTime
                    )
                    : EmptyReadOnlyCollection<IAuthorizationPolicy>.Instance;
            if (currentToken != null)
            {
                newToken = new SecurityContextSecurityToken(
                    currentToken,
            ...
            else
            {
                ...
                DateTime tokenExpirationTime = TimeoutHelper.Add(
                    tokenEffectiveTime,
                ...
                {
                    newToken.BootstrapMessageProperty =
                        (securityProperty == null)
                            ? null
        ...
        static SecurityTokenSpecification GetMatchingEndorsingSct(
            SecurityContextKeyIdentifierClause sctSkiClause,
            SecurityMessageProperty supportingTokenProperty
        )
        {
            ...
            for (int i = 0; i < supportingTokenProperty.IncomingSupportingTokens.Count; ++i)
            {
                ...
                SecurityContextSecurityToken sct =
                    supportingTokenProperty.IncomingSupportingTokens[i].SecurityToken
        ...
        protected virtual Message ProcessRenewRequest(Message request)
        {
            ...
            try
            {
                ...
                if (
                    supportingTokenProperty == null
                    || !supportingTokenProperty.HasIncomingSupportingTokens
                )
                {
                    throw TraceUtility.ThrowHelperWarning(
                        new SecurityNegotiationException(
                            SR.GetString(SR.RenewSessionMissingSupportingToken)
                        ),
                        request
                    );
                }
                ...
                {
                    throw TraceUtility.ThrowHelperWarning(
                        new SecurityNegotiationException(SR.GetString(SR.NoRenewTargetSpecified)),
                        request
                    );
                }
                SecurityContextKeyIdentifierClause sctSkiClause =
                    rst.RenewTarget as SecurityContextKeyIdentifierClause;
                SecurityTokenSpecification sessionToken = GetMatchingEndorsingSct(
                    sctSkiClause,
                    supportingTokenProperty
                );
                if (sctSkiClause == null || sessionToken == null)
                {
                    throw TraceUtility.ThrowHelperWarning(
                        new SecurityNegotiationException(
                            SR.GetString(SR.BadRenewTarget, rst.RenewTarget)
                        ),
                        request
                    );
                }
                RequestSecurityTokenResponse rstr;
                SecurityContextSecurityToken newToken = this.IssueToken(
                    rst,
                    request,
                    (SecurityContextSecurityToken)sessionToken.SecurityToken,
                    sessionToken.SecurityTokenPolicies,
                    out rstr
                );
                rstr.MakeReadOnly();
                ...
                this.NotifyOperationCompletion(
        ...
        static void AddTokenToRemoveIfRequired(
            SecurityToken token,
            Collection<SecurityContextSecurityToken> sctsToRemove
        )
        {
        ...
        internal static void RemoveCachedTokensIfRequired(SecurityMessageProperty security)
        {
            ...
            ILogonTokenCacheManager logonManager = OperationContext
                .Current
                .EndpointDispatcher
                .ChannelDispatcher
                .Listener
                .GetProperty<ILogonTokenCacheManager>();
            Collection<ISecurityContextSecurityTokenCache> sctCaches = OperationContext
                .Current
                .EndpointDispatcher
                .ChannelDispatcher
                .Listener
            ...
            Collection<SecurityContextSecurityToken> securityContextTokensToRemove =
                new Collection<SecurityContextSecurityToken>();
            if (security.ProtectionToken != null)
            {
                AddTokenToRemoveIfRequired(
                    security.ProtectionToken.SecurityToken,
                    securityContextTokensToRemove
                );
            }
            if (security.InitiatorToken != null)
            {
                AddTokenToRemoveIfRequired(
                    security.InitiatorToken.SecurityToken,
                    securityContextTokensToRemove
                );
            }
            if (security.HasIncomingSupportingTokens)
            {
                for (int i = 0; i < security.IncomingSupportingTokens.Count; ++i)
                {
                    ...
                    {
                        AddTokenToRemoveIfRequired(
                            security.IncomingSupportingTokens[i].SecurityToken,
                            securityContextTokensToRemove
                        );
                    }
                }
            ...
            try
            {
                ...
                )
                {
                    if (request.Version.Addressing == AddressingVersion.WSAddressing10)
                    {
                        ...
                        appliesTo = rst.GetAppliesTo<EndpointAddress10>(appliesToSerializer)
                            .ToEndpointAddress();
                    }
                    else if (request.Version.Addressing == AddressingVersion.WSAddressingAugust2004)
                    {
                        ...
                        appliesTo = rst.GetAppliesTo<EndpointAddressAugust2004>(appliesToSerializer)
                            .ToEndpointAddress();
                    }
                    else
                    {
                ...
                RequestSecurityTokenResponse rstr;
                SecurityContextSecurityToken issuedToken = this.IssueToken(
                    rst,
                    request,
                    null,
                    null,
        ...
        internal static bool DoesSkiClauseMatchSigningToken(
        ...
        void SetupSessionListener()
        {
            ...
            channelBuilder
                .Binding
                .Elements
                .Insert(0, new SecuritySessionAuthenticatorBindingElement(this));
            ...
            SecurityBindingElement securityBindingElement = this.IssuerBindingContext
                .Binding
                .Elements
            ...
            MessageFilter issueAndRenewFilter = new SessionActionFilter(
                ...
                supportedMessageActions.ToArray()
            );
            SecuritySessionHost sessionListener = new SecuritySessionHost(
                this,
                issueAndRenewFilter,
                this.ListenUri,
                channelBuilder
        ...
        internal IChannelListener<TChannel> BuildResponderChannelListener<TChannel>(
            ...
            where TChannel : class, IChannel
        {
            ...
            SecurityProtocolFactory bootstrapSecurityProtocolFactory =
            ...
            if (bootstrapSecurityProtocolFactory is MessageSecurityProtocolFactory)
            {
                MessageSecurityProtocolFactory soapBindingFactory =
                    (MessageSecurityProtocolFactory)bootstrapSecurityProtocolFactory;
                ...
                soapBindingFactory
                    .ProtectionRequirements
                    .IncomingSignatureParts
                    .AddParts(bodyPart, this.IssueAction);
                soapBindingFactory
                    .ProtectionRequirements
                ...
                soapBindingFactory
                    .ProtectionRequirements
                    .IncomingSignatureParts
                    .AddParts(bodyPart, this.RenewAction);
                soapBindingFactory
                    .ProtectionRequirements
                    .IncomingEncryptionParts
                    .AddParts(bodyPart, this.RenewAction);
            ...
            SupportingTokenParameters renewSupportingTokenParameters =
                new SupportingTokenParameters();
            SecurityContextSecurityTokenParameters sctParameters =
                new SecurityContextSecurityTokenParameters();
            sctParameters.RequireDerivedKeys =
                this.IssuedSecurityTokenParameters.RequireDerivedKeys;
            renewSupportingTokenParameters.Endorsing.Add(sctParameters);
            bootstrapSecurityProtocolFactory
                .SecurityBindingElement
                .OperationSupportingTokenParameters
                .Add(this.RenewAction.Value, renewSupportingTokenParameters);
            bootstrapSecurityProtocolFactory.SecurityTokenManager =
                new SessionRenewSecurityTokenManager(
                    bootstrapSecurityProtocolFactory.SecurityTokenManager,
                    this.sessionTokenAuthenticator,
                    (SecurityTokenResolver)this.IssuedTokenCache
                );
        ...
        class SecuritySessionHost : ServiceHostBase
        {
            ...
            protected override void InitializeRuntime()
            {
                ...
                if (
                    this.authenticator.IssuerBindingContext != null
                    && this.authenticator.IssuerBindingContext.BindingParameters != null
                )
                {
                    ServiceAuthenticationManager serviceAuthenticationManager = this.authenticator
                        .IssuerBindingContext
                        .BindingParameters
                        .Find<ServiceAuthenticationManager>();
                    if (serviceAuthenticationManager != null)
                    {
                        endpointDispatcher.DispatchRuntime.ServiceAuthenticationManager =
                            new SCTServiceAuthenticationManagerWrapper(
            ...
            class SecuritySessionAuthenticatorInvoker : IOperationInvoker
            {
                ...
                internal SecuritySessionAuthenticatorInvoker(
                    SecuritySessionSecurityTokenAuthenticator parent
                )
                {
                    this.parent = parent;
        ...
        class SecuritySessionAuthenticatorBindingElement : BindingElement
        {
            ...
            public SecuritySessionAuthenticatorBindingElement(
                SecuritySessionSecurityTokenAuthenticator authenticator
            )
            {
                this.authenticator = authenticator;
        ...
        public class SessionRenewSecurityTokenManager : SecurityTokenManager
        {
            ...
            )
            {
                ...
                {
                    return this.innerTokenManager.CreateSecurityTokenAuthenticator(
                        tokenRequirement,
