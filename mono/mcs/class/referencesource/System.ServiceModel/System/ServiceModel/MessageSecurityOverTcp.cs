    ...
    public sealed class MessageSecurityOverTcp
    {
        ...
        )
        {
            ...
            else
            {
                ...
                {
                    case MessageCredentialType.None:
                        oneShotSecurity = SecurityBindingElement.CreateSslNegotiationBindingElement(
                            false,
                            true
                        );
                        break;
                    case MessageCredentialType.UserName:
                        ...
                        oneShotSecurity = SecurityBindingElement.CreateUserNameForSslBindingElement(
                            true
                        );
                        break;
                    case MessageCredentialType.Certificate:
            ...
            oneShotSecurity.MessageSecurityVersion =
                MessageSecurityVersion.WSSecurity11WSTrustFebruary2005WSSecureConversationFebruary2005WSSecurityPolicy11;
        ...
        )
        {
            ...
            else
            {
                ...
                )
                {
                    ...
                    SecurityBindingElement.IsSslNegotiationBinding(bootstrapSecurity, false, true)
                )
