...
namespace System.ServiceModel.WasHosting
{
    ...
    class TcpAppDomainProtocolHandler : BaseAppDomainProtocolHandler
    {
        ...
        {
            TcpHostedTransportConfiguration configuration =
                HostedTransportConfigurationManager.GetConfiguration(Uri.UriSchemeNetTcp)
                as TcpHostedTransportConfiguration;
