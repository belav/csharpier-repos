...
namespace System.Runtime.DurableInstancing
{
    ...
    public sealed class InstanceOwnerQueryResult : InstanceStoreQueryResult
    {
        ...
        > EmptyQueryResult = new ReadOnlyDictionaryInternal<
            Guid,
            IDictionary<XName, InstanceValue>
        >(new Dictionary<Guid, IDictionary<XName, InstanceValue>>(0));
        static readonly ReadOnlyDictionaryInternal<XName, InstanceValue> EmptyMetadata =
        ...
        {
            Dictionary<Guid, IDictionary<XName, InstanceValue>> owners = new Dictionary<
                Guid,
                IDictionary<XName, InstanceValue>
            >(1);
            ...
            else
            {
                ...
                IDictionary<XName, InstanceValue> copy = new Dictionary<XName, InstanceValue>(
                    metadata
                );
            ...
            InstanceOwners = new ReadOnlyDictionaryInternal<
                Guid,
                IDictionary<XName, InstanceValue>
            >(owners);
        }
        ...
        // N
        public InstanceOwnerQueryResult(
            IDictionary<Guid, IDictionary<XName, InstanceValue>> instanceOwners
        )
        {
            Dictionary<Guid, IDictionary<XName, InstanceValue>> owners = new Dictionary<
                Guid,
            ...
            foreach (
                KeyValuePair<Guid, IDictionary<XName, InstanceValue>> metadata in instanceOwners
            )
            {
                IDictionary<XName, InstanceValue> safeMetadata; // if metadata is not readonly, copy it.
