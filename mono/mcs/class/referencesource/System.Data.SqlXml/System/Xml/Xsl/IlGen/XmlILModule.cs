...
namespace System.Xml.Xsl.IlGen
{
    ...
    internal class XmlILModule
    {
        ...
        private static readonly Guid LanguageGuid = new Guid(
            0x462d4a3e,
            0xb257,
            0x4aee,
            0x97,
        ...
        private static readonly Guid VendorGuid = new Guid(
            0x994b45c4,
            0xe6e9,
            0x11d2,
            0x90,
        ...
        public XmlILModule(bool useLRE, bool emitSymbols)
        {
            ...
            if (!useLRE)
            {
                ...
                if (this.persistAsm)
                    modBldr = asmBldr.DefineDynamicModule(
                ...
                this.typeBldr = modBldr.DefineType(
        ...
        )
        {
            ...
            if (!this.useLRE)
            {
                ...
                if (emitSymbols && (xmlAttrs & XmlILMethodAttributes.NonUser) != 0)
                {
                    ...
                    methBldr.SetCustomAttribute(
                        new CustomAttributeBuilder(XmlILConstructors.NonUserCode, new object[] { })
                    );
                }
