...
namespace System.Xml.Xsl.Xslt
{
    ...
    internal class XsltQilFactory : XPathQilFactory
    {
        ...
        public QilNode InvokeSystemProperty(QilNode n)
        {
            CheckQName(n);
            return XsltInvokeEarlyBound(
                QName("system-property"),
                XsltMethods.SystemProperty,
                T.Choice(T.DoubleX, T.StringX),
                new QilNode[] { n }
            );
        }
        ...
        {
            return XsltInvokeEarlyBound(
                QName("register-script-namespace"),
                XsltMethods.CheckScriptNamespace,
                T.IntX,
                new QilNode[] { String(nsUri) }
            );
        }
        ...
        public QilNode InvokeLangToLcid(QilNode n, bool fwdCompat)
        {
            ...
            return XsltInvokeEarlyBound(
                ...
                T.IntX,
                new QilNode[] { n, Boolean(fwdCompat) }
            );
        }
        ...
        )
        {
            Debug.Assert(
                value != null
                    && (value.XmlType.IsSubtypeOf(T.IntXS) || value.XmlType.IsSubtypeOf(T.DoubleX)),
        ...
        )
        {
            ...
            Debug.Assert(format != null);
            return XsltInvokeEarlyBound(
                QName("register-decimal-formatter"),
        ...
        public QilNode InvokeFormatNumberDynamic(
            QilNode value,
            QilNode formatPicture,
        ...
        public QilNode InvokeMsFormatDateTime(
            QilNode datetime,
            QilNode format,
            QilNode lang,
            QilNode isDate
