...
namespace System.Xml.Xsl.XsltOld
{
    ...
    internal abstract class SequentialOutput : RecordOutput
    {
        ...
        static string[] s_TextValueReplace = new string[]
        {
            s_EnAmpersand,
            s_EnGreaterThan,
            s_EnLessThan,
        ...
        static char[] s_XmlAttributeValueFind = new char[]
        {
            s_Ampersand,
            s_GreaterThan,
            s_LessThan,
        ...
        static string[] s_XmlAttributeValueReplace = new string[]
        {
            s_EnAmpersand,
            s_EnGreaterThan,
            s_EnLessThan,
        ...
        private void CacheOuptutProps(XsltOutput output)
        {
            ...
            this.outputDoctype =
                this.output.DoctypeSystem != null
                || (this.isHtmlOutput && this.output.DoctypePublic != null);
            this.outputXmlDecl =
        ...
        void WriteStartElement(RecordBuilder record)
        {
            ...
            {
                Debug.Assert(
                    !this.isHtmlOutput || mainNode.Prefix != null,
                    "Html can't have abreviated elements"
                );
        ...
        {
            Debug.Assert(
                this.outputXmlDecl == true,
                "It supposed to check this condition before actual call"
            );
            Debug.Assert(
                this.isXmlOutput && !this.output.OmitXmlDeclaration,
                    ...
                    default:
                        if (127 < ch)
                        {
                            ...
                            for (int j = 0; j < bytes; j++)
                            {
                                Write("%");
                                Write(
                                    ((uint)this.byteBuffer[j]).ToString(
                                        "X2",
