...
namespace System.Xml.Xsl.XsltOld
{
    ...
    internal class DbgCompiler : Compiler
    {
        ...
        // We keepping two different sets of wariables because global and local variables have different
        // rules of visibility.
        ...
        public virtual VariableAction[] GlobalVariables
        {
            get
            {
                ...
                {
                    this.globalVarsCache = (VariableAction[])
                        this.globalVars.ToArray(typeof(VariableAction));
                }
        ...
        public virtual VariableAction[] LocalVariables
        {
            get
            {
                ...
                {
                    this.localVarsCache = (VariableAction[])
                        this.localVars.ToArray(typeof(VariableAction));
                }
