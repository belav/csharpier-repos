    ...
    internal class ReaderOutput : XmlReader, RecordOutput
    {
                ...
                if (this.haveRecord)
                {
                    ...
                    switch (this.NodeType)
                    {
                        case XmlNodeType.Text:
                            ...
                            Debug.Assert(
                                this.Value.Length != 0,
                                "It whould be Whitespace in this case"
                            );
                            break;
        ...
        private void CheckCurrentInfo()
        {
            ...
            Debug.Assert(
                (this.currentIndex == -1)
                    || (
                        this.currentInfo == this.attributeValue
                        || this.attributeList[this.currentIndex] is BuilderInfo
        ...
        private class XmlEncoder
        {
            ...
            private void Init()
            {
                ...
                encoder = new XmlTextEncoder(
                    new StringWriter(buffer, CultureInfo.InvariantCulture)
                );
            }
