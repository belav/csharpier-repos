...
namespace System.Xml.Xsl.Xslt
{
    ...
    internal class XPathPatternBuilder : XPathPatternParser.IPatternBuilder
    {
        ...
        public QilNode JoinStep(QilNode left, QilNode right)
        {
            ...
            FixupFilterBinding(
                parentFilter,
                ancestor ? f.Ancestor(lastParent.Variable) : f.Parent(lastParent.Variable)
            );
        ...
        public QilNode BuildPredicates(QilNode nodeset, List<QilNode> predicates)
        {
            ...
            foreach (var predicate in predicates)
            {
                convertedPredicates.Add(
                    XPathBuilder.PredicateToBoolean(predicate, f, predicateEnvironment)
                );
            }
            ...
            )
            {
                ...
                nodeFilter.Body = predicateEnvironment
                    .fixupVisitor
            ...
            else
            {
                ...
                foreach (var predicate in convertedPredicates)
                {
                    matchingSet = XPathBuilder.BuildOnePredicate(
                        ...
                        ref predicateEnvironment.numFixupCurrent,
                        ref predicateEnvironment.numFixupPosition,
                        ref predicateEnvironment.numFixupLast
                    );
                }
        ...
        private QilNode UnexpectedToken(string tokenName)
        {
            string prompt = string.Format(
                ...
                "Internal Error: {0} is not allowed in XSLT pattern outside of predicate.",
                tokenName
            );
