...
namespace System.Xml.Xsl.XPath
{
    ...
    internal class XPathQilFactory : QilPatternFactory
    {
        ...
        public QilNode InvokeEqualityOperator(QilNodeType op, QilNode left, QilNode right)
        {
            ...
            {
                case QilNodeType.Eq:
                    opCode = (double)XsltLibrary.ComparisonOperator.Eq;
                    break;
                default:
                    opCode = (double)XsltLibrary.ComparisonOperator.Ne;
                    break;
            }
            return XsltInvokeEarlyBound(
        ...
        public QilNode InvokeRelationalOperator(QilNodeType op, QilNode left, QilNode right)
        {
            ...
            {
                case QilNodeType.Lt:
                    opCode = (double)XsltLibrary.ComparisonOperator.Lt;
                    break;
                case QilNodeType.Le:
                    opCode = (double)XsltLibrary.ComparisonOperator.Le;
                    break;
                case QilNodeType.Gt:
                    opCode = (double)XsltLibrary.ComparisonOperator.Gt;
                    break;
                default:
                    opCode = (double)XsltLibrary.ComparisonOperator.Ge;
                    break;
            }
            return XsltInvokeEarlyBound(
