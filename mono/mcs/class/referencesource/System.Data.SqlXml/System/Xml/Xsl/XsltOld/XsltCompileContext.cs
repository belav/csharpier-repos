    ...
    internal class XsltCompileContext : XsltContext
    {
        ...
        internal object EvaluateVariable(VariableAction variable)
        {
            ...
            if (result == null && !variable.IsGlobal)
            {
                ...
                VariableAction global = this.manager.VariableScope.ResolveGlobalVariable(
                    variable.Name
                );
                if (global != null)
                {
        ...
        private DecimalFormat ResolveFormatName(string formatName)
        {
            ...
            DecimalFormat formatInfo = this.processor.RootAction.GetDecimalFormat(
        ...
        private abstract class XsltFunctionImpl : IXsltContextFunction
        {
            ...
            public static object ConvertToXPathType(
                object val,
                XPathResultType xt,
                TypeCode typeCode
            )
        ...
        {
            public FuncCurrent()
                : base(0, 0, XPathResultType.NodeSet, new XPathResultType[] { }) { }
