        ...
        */
        private struct BigNumber
        {
            ...
            private void Round(uint uExtra)
            {
                ...
                // Round up.
                if (
                    0 != AddU(ref this.u0, 1)
                    && 0 != AddU(ref this.u1, 1)
                    && 0 != AddU(ref this.u2, 1)
                )
                {
            ...
            private bool IsZero
            {
                get { return (0 == this.u2) && (0 == this.u1) && (0 == this.u0); }
            }
            ...
            */
            ...
            public void MakeLowerBound()
            {
                ...
                if (
                    0 != uT
                    && 0 == AddU(ref this.u0, (uint)-(int)uT)
                    && 0 == AddU(ref this.u1, 0xFFFFFFFF)
                )
                {
        ...
        private class FloatingDecimal
        {
            ...
            private bool Equals(FloatingDecimal other)
            {
                if (
                    ...
                    || sign != other.sign
                    || mantissaSize != other.mantissaSize
                )
                {
                    return false;
                }
