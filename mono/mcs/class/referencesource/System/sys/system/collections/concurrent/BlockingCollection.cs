...
namespace System.Collections.Concurrent
{
    ...
    /// </summary>
    /// <remarks>
    /// <see cref="T:System.Collections.Concurrent.IProducerConsumerCollection{T}"/> represents a
    // collection
    ...
    /// for an <see cref="T:System.Collections.Concurrent.IProducerConsumerCollection{T}"/> instance,
    // allowing
    ...
    /// <see cref="T:System.Collections.Concurrent.IProducerConsumerCollection{T}"/>; addition attempts
    // to the
...
#pragma warning restore 0618
            ...
            IReadOnlyCollection<T>
    {
        ...
        #region Properties
        /// <summary>Gets the bounded capacity of this <see
        // cref="T:System.Collections.Concurrent.BlockingCollection{T}"/> instance.</summary>
        /// <value>The bounded capacity of this collection, or int.MaxValue if no bound was
        // supplied.</value>
        ...
        /// <summary>Gets whether this <see cref="T:System.Collections.Concurrent.BlockingCollection{T}"/>
        // has been marked as complete for adding.</summary>
        ...
        /// <summary>Gets whether this <see cref="T:System.Collections.Concurrent.BlockingCollection{T}"/>
        // has been marked as complete for adding and is empty.</summary>
        ...
        /// <summary>Gets the number of items contained in the <see
        // cref="T:System.Collections.Concurrent.BlockingCollection{T}"/>.</summary>
        /// <value>The number of items contained in the <see
        // cref="T:System.Collections.Concurrent.BlockingCollection{T}"/>.</value>
        /// <exception cref="T:System.ObjectDisposedException">The <see
        /// cref="T:System.Collections.Concurrent.BlockingCollection{T}"/> has been disposed.</exception>
        public int Count
        {
        ...
        /// </summary>
        /// <remarks>
        /// The default underlying collection is a <see
        // cref="System.Collections.Concurrent.ConcurrentQueue{T}">ConcurrentQueue&lt;T&gt;</see>.
        /// </remarks>
        ...
        /// <see cref="T:System.Collections.Concurrent.IProducerConsumerCollection{T}"/> as its underlying
        // data store.</summary>
        ...
        /// <exception cref="T:System.ArgumentOutOfRangeException">The <paramref name="boundedCapacity"/> is
        // not a positive value.</exception>
        /// <exception cref="System.ArgumentException">The supplied <paramref name="collection"/> contains
        // more values
        ...
        public BlockingCollection(IProducerConsumerCollection<T> collection, int boundedCapacity)
        {
            ...
            if (count > boundedCapacity)
            {
                throw new ArgumentException(
                    SR.GetString(SR.BlockingCollection_ctor_CountMoreThanCapacity)
                );
            }
        ...
        /// <param name="collection">The collection to use as the underlying data store.</param>
        /// <param name="boundedCapacity">The bounded size of the collection.</param>
        /// <param name="collectionCount">The number of items currently in the underlying
        // collection.</param>
        ...
        /// </summary>
        /// <param name="item">The item to be added to the collection. The value can be a null
        // reference.</param>
        ...
        /// <exception cref="T:System.ObjectDisposedException">The <see
        /// cref="T:System.Collections.Concurrent.BlockingCollection{T}"/> has been disposed.</exception>
        /// <exception cref="T:System.InvalidOperationException">The underlying collection didn't accept the
        // item.</exception>
        /// <remarks>
        ...
        /// <summary>
        /// Adds the item to the <see cref="T:System.Collections.Concurrent.BlockingCollection{T}"/>.
        /// A <see cref="System.OperationCanceledException"/> is thrown if the <see
        // cref="CancellationToken"/> is
        /// canceled.
        /// </summary>
        /// <param name="item">The item to be added to the collection. The value can be a null
        // reference.</param>
        ...
        /// If a bounded capacity was specified when this instance of
        /// <see cref="T:System.Collections.Concurrent.BlockingCollection{T}"/> was initialized,
        /// a call to <see cref="Add(T,System.Threading.CancellationToken)"/> may block until space is
        // available to store the provided item.
        /// </remarks>
        ...
        /// <summary>
        /// Attempts to add the specified item to the <see
        // cref="T:System.Collections.Concurrent.BlockingCollection{T}"/>.
        /// </summary>
        ...
        /// <summary>Adds an item into the underlying data store using its
        ...
        /// <param name="item">The item to be added to the collection.</param>
        /// <param name="millisecondsTimeout">The number of milliseconds to wait for the collection to
        // accept the item,
        /// or Timeout.Infinite to wait indefinitely.</param>
        /// <param name="cancellationToken">A cancellation token to observe.</param>
        /// <returns>False if the collection remained full till the timeout period was exhausted.True
        // otherwise.</returns>
        /// <exception cref="OperationCanceledException">If the <see cref="CancellationToken"/> is
        // canceled.</exception>
        /// <exception cref="System.InvalidOperationException">the collection has already been marked
        /// as complete with regards to additions.</exception>
        /// <exception cref="System.ObjectDisposedException">If the collection has been
        // disposed.</exception>
        /// <exception cref="T:System.InvalidOperationException">The underlying collection didn't accept the
        // item.</exception>
        ...
        )
        {
            ...
            if (m_freeNodes != null)
            {
                //If the m_freeNodes semaphore threw OperationCanceledException then this means that
                // CompleteAdding()
                ...
                try
                {
                    ...
                    if (waitForSemaphoreWasSuccessful == false && millisecondsTimeout != 0)
                    {
                        linkedTokenSource = CancellationTokenSource.CreateLinkedTokenSource(
                            cancellationToken,
                            m_ProducersCancellationTokenSource.Token
                        );
                        waitForSemaphoreWasSuccessful = m_freeNodes.Wait(
                            millisecondsTimeout,
            ...
            if (waitForSemaphoreWasSuccessful)
            {
                ...
                // The idea behind to spin untill all adders finish, is to avoid to return to the caller with IOE
                // while there are still some adders have
                ...
                while (true)
                {
                    ...
                    if ((observedAdders & COMPLETE_ADDING_ON_MASK) != 0)
                    {
                        ...
                        while (m_currentAdders != COMPLETE_ADDING_ON_MASK)
                            spinner.SpinOnce();
                        throw new InvalidOperationException(
                            SR.GetString(SR.BlockingCollection_Completed)
                        );
                    }
                    if (
                ...
                // This outer try/finally to workaround of repeating the decrement adders code 3 times, because we
                // should decrement the adders if:
                ...
                try
                {
                    ...
                    try
                    {
                        //The token may have been canceled before the collection had space available, so we need a check
                    ...
                    {
                        throw new InvalidOperationException(
                            SR.GetString(SR.BlockingCollection_Add_Failed)
                        );
                    }
                }
                finally
        ...
        /// <summary>Takes an item from the <see
        // cref="T:System.Collections.Concurrent.BlockingCollection{T}"/>.</summary>
        ...
        /// <remarks>A call to <see cref="Take()"/> may block until an item is available to be
        // removed.</remarks>
        public T Take()
        {
            T item;
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.BlockingCollection_CantTakeWhenDone)
                );
            }
        ...
        /// outside of this <see
        /// cref="T:System.Collections.Concurrent.BlockingCollection{T}"/> instance.</exception>
        /// <remarks>A call to <see cref="Take(CancellationToken)"/> may block until an item is available to
        // be removed.</remarks>
        ...
        /// <summary>
        /// Attempts to remove an item from the <see
        // cref="T:System.Collections.Concurrent.BlockingCollection{T}"/>.
        /// </summary>
        ...
        /// <summary>Takes an item from the underlying data store using its
        // IProducerConsumerCollection&lt;T&gt;.Take
        /// method. If the collection was empty, this method will wait for, at most, the timeout period (if
        // AddingIsCompleted is false)
        /// trying to remove an item. If the timeout period was exhaused before successfully removing an
        // item
        ...
        /// </summary>
        /// <param name="item">The item removed from the collection.</param>
        /// <param name="millisecondsTimeout">The number of milliseconds to wait for the collection to have
        // an item available
        /// for removal, or Timeout.Infinite to wait indefinitely.</param>
        /// <param name="cancellationToken">A cancellation token to observe.</param>
        /// <param name="combinedTokenSource">A combined cancellation token if created, it is only created
        // by GetConsumingEnumerable to avoid creating the linked token
        /// multiple times.</param>
        /// <returns>False if the collection remained empty till the timeout period was exhausted. True
        // otherwise.</returns>
        /// <exception cref="OperationCanceledException">If the <see cref="CancellationToken"/> is
        // canceled.</exception>
        /// <exception cref="System.ObjectDisposedException">If the collection has been
        ...
        )
        {
            ...
            // set the combined token source to the combinedToken paramater if it is not null (came from
            ...
            try
            {
                ...
                if (waitForSemaphoreWasSuccessful == false && millisecondsTimeout != 0)
                {
                    ...
                    waitForSemaphoreWasSuccessful = m_occupiedNodes.Wait(
                        millisecondsTimeout,
                        linkedTokenSource.Token
                    );
                }
            ...
            {
                // only dispose the combined token source if we created it here, otherwise the caller
                // (GetConsumingEnumerable) is responsible for disposing it
            ...
            if (waitForSemaphoreWasSuccessful)
            {
                ...
                try
                {
                    //The token may have been canceled before an item arrived, so we need a check after the wait has
                    // completed.
                    ...
                    if (!removeSucceeded)
                    {
                        // Check if the collection is empty which means that the collection was modified outside
                        // BlockingCollection
                        throw new InvalidOperationException(
        ...
        /// <returns>The index of the collection in the <paramref name="collections"/> array to which the
        ...
        /// cref="T:System.Collections.Concurrent.BlockingCollection{T}"/> instances has been
        // disposed.</exception>
        /// <exception cref="T:System.InvalidOperationException">At least one underlying collection didn't
        // accept the item.</exception>
        /// <exception cref="T:System.ArgumentOutOfRangeException">The count of <paramref
        // name="collections"/> is greater than the maximum size of
        ...
        /// <param name="millisecondsTimeout">The number of milliseconds to wait for a collection to accept
        // the
        ...
        /// <exception cref="System.ArgumentException">If the collections argument is a 0-length array or
        // contains a
        /// null element. Also, if atleast one of the collections has been marked complete for
        // adds.</exception>
        /// <exception cref="System.ObjectDisposedException">If atleast one of the collections has been
        // disposed.</exception>
        ...
        )
        {
            ...
            // After WaitAny returns check if the token is cancelled and that caused the WaitAny to return or
            // not
            // If the combined token is cancelled, this mean either the external token is cancelled then throw
            // OCE
                ...
                )
                {
                    ...
                    if (linkedTokenSource.IsCancellationRequested)
                    {
                        if (externalCancellationToken.IsCancellationRequested) //case#3
                            ...
                            throw new ArgumentException(
                                SR.GetString(SR.BlockingCollection_CantAddAnyWhenCompleted),
                                "collections"
                            );
                    }
                }
        ...
        /// <summary>
        /// Local static method, used by TryAddTakeAny to get the wait handles for the collection, with
        // exclude option to exclude the Compeleted collections
        /// </summary>
        ...
        /// <param name="originalWaitMillisecondsTimeout">The orginal wait timeoutout in
        // milliseconds</param>
        ...
        /// cref="T:System.Collections.Concurrent.BlockingCollection{T}"/> instances has been
        // disposed.</exception>
        /// <exception cref="T:System.InvalidOperationException">At least one of the underlying collections
        // was modified
        /// outside of its <see
        /// cref="T:System.Collections.Concurrent.BlockingCollection{T}"/> instance.</exception>
        /// <exception cref="T:System.ArgumentOutOfRangeException">The count of <paramref
        ...
        )
        {
            ...
            for (int i = 0; i < collections.Length; i++)
            {
                // Check if the collection is not completed, and potentially has at least one element by checking
                // the semaphore count
                if (
                    !collections[i].IsCompleted
                    && collections[i].m_occupiedNodes.CurrentCount > 0
        ...
        )
        {
            ...
            while (millisecondsTimeout == Timeout.Infinite || timeout >= 0)
            {
                ...
                if (handles.Count == 0 && isTakeOperation) //case#5
                    throw new ArgumentException(
                        SR.GetString(SR.BlockingCollection_CantTakeAnyWhenAllDone),
                        "collections"
                    );
                ...
                )
                {
                    ...
                    else if (!linkedTokenSource.IsCancellationRequested) // if no eiter internal or external cancellation trquested
                    {
                        ...
                        if (collections.Length != handles.Count - 1) // -1 because of the combined token handle
                        {
                            ...
                            {
                                if (
                                    collections[i].m_occupiedNodes.AvailableWaitHandle
                                    == handles[index]
                                )
                                {
                                    index = i;
        ...
        /// </summary>
        /// <remarks>
        /// After a collection has been marked as complete for adding, adding to the collection is not
        // permitted
        ...
        public void CompleteAdding()
        {
            ...
            while (true)
            {
                ...
                {
                    spinner.Reset();
                    // If there is another COmpleteAdding in progress waiting the current adders, then spin until it
                    // finishes
                    while (m_currentAdders != COMPLETE_ADDING_ON_MASK)
                        spinner.SpinOnce();
                    return;
        ...
        // cref="T:System.Collections.Concurrent.BlockingCollection{T}"/> instance.
        /// </summary>
        public void Dispose()
        {
            Dispose(true);
        ...
        // cref="T:System.Collections.Concurrent.BlockingCollection{T}"/> instance.
        /// </summary>
        /// <param name="disposing">Whether being disposed explicitly (true) or due to a finalizer
        // (false).</param>
        ...
        // cref="T:System.Collections.Concurrent.BlockingCollection{T}"/> instance into a new
        // array.</summary>
        ...
        /// <summary>Copies all of the items in the <see
        // cref="T:System.Collections.Concurrent.BlockingCollection{T}"/> instance
        /// to a compatible one-dimensional array, starting at the specified index of the target array.
        /// </summary>
        /// <param name="array">The one-dimensional array that is the destination of the elements copied
        // from
        /// the <see cref="T:System.Collections.Concurrent.BlockingCollection{T}"/> instance. The array must
        // have zero-based indexing.</param>
        /// <param name="index">The zero-based index in <paramref name="array"/> at which copying
        // begins.</param>
        /// <exception cref="T:System.ArgumentNullException">The <paramref name="array"/> argument is
        /// null.</exception>
        /// <exception cref="System.ArgumentOutOfRangeException">The <paramref name="index"/> argument is
        // less than zero.</exception>
        /// <exception cref="System.ArgumentException">The <paramref name="index"/> argument is equal to or
        // greater
        ...
        /// <exception cref="System.ArgumentException">The <paramref name="index"/> argument is equal to or
        // greater
        /// than the length of the <paramref name="array"/>, the array is multidimensional, or the type
        // parameter for the collection
        ...
        void ICollection.CopyTo(Array array, int index)
        {
            ...
            catch (ArgumentOutOfRangeException)
            {
                throw new ArgumentOutOfRangeException(
                    "index",
                    index,
                    SR.GetString(SR.BlockingCollection_CopyTo_NonNegative)
                );
            }
            catch (ArgumentException)
            {
                throw new ArgumentException(
                    SR.GetString(SR.BlockingCollection_CopyTo_TooManyElems),
                    "index"
                );
            }
            catch (RankException)
            {
                throw new ArgumentException(
                    SR.GetString(SR.BlockingCollection_CopyTo_MultiDim),
                    "array"
                );
            }
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.BlockingCollection_CopyTo_IncorrectType),
                    "array"
                );
            }
        ...
        /// <summary>Provides a consuming <see cref="T:System.Collections.Generics.IEnumerable{T}"/> for
        // items in the collection.</summary>
        /// <returns>An <see cref="T:System.Collections.Generics.IEnumerable{T}"/> that removes and returns
        // items from the collection.</returns>
        /// <exception cref="T:System.ObjectDisposedException">The <see
        /// cref="T:System.Collections.Concurrent.BlockingCollection{T}"/> has been disposed.</exception>
        ...
        /// throw an <see cref="System.OperationCanceledException"/> if the <see cref="CancellationToken"/>
        // is canceled.
        /// </summary>
        /// <param name="cancellationToken">A cancellation token to observe.</param>
        /// <returns>An <see cref="T:System.Collections.Generics.IEnumerable{T}"/> that removes and returns
        ...
        /// <summary>Centralizes the logic for validating the BlockingCollections array passed to
        // TryAddToAny()
        ...
        /// <exception cref="System.ArgumentException">If the collections argument is a 0-length array or
        // contains a
        /// null element. Also, if at least one of the collections has been marked complete for
        // adds.</exception>
        /// <exception cref="System.ObjectDisposedException">If at least one of the collections has been
        // disposed.</exception>
        ...
        )
        {
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.BlockingCollection_ValidateCollectionsArray_ZeroSize),
                    "collections"
                );
            }
            else if (
                (!IsSTAThread && collections.Length > 63)
                || (IsSTAThread && collections.Length > 62)
            )
            //The number of WaitHandles must be <= 64 for MTA, and <=63 for STA, and we reserve one for
            // CancellationToken
            {
                throw new ArgumentOutOfRangeException(
                    "collections",
                    SR.GetString(SR.BlockingCollection_ValidateCollectionsArray_LargeSize)
                );
            }
            ...
            for (int i = 0; i < collections.Length; ++i)
            {
                ...
                {
                    throw new ArgumentException(
                        SR.GetString(SR.BlockingCollection_ValidateCollectionsArray_NullElems),
                        "collections"
                    );
                }
                ...
                if (collections[i].m_isDisposed)
                    throw new ObjectDisposedException(
                        "collections",
                        SR.GetString(SR.BlockingCollection_ValidateCollectionsArray_DispElems)
                    );
        ...
        /// <param name="timeout">The TimeSpan to wait for to successfully complete an operation on the
        // collection.</param>
        /// <exception cref="System.ArgumentOutOfRangeException">If the number of millseconds represented by
        // the timeout
        ...
        private static void ValidateTimeout(TimeSpan timeout)
        {
            ...
            if (
                (totalMilliseconds < 0 || totalMilliseconds > Int32.MaxValue)
        ...
        /// <param name="millisecondsTimeout">The number of milliseconds to wait for to successfully
        // complete an
        /// operation on the collection.</param>
        /// <exception cref="System.ArgumentOutOfRangeException">If the number of millseconds is less than 0
        // and not
        ...
        private void CheckDisposed()
        {
            if (m_isDisposed)
            {
                throw new ObjectDisposedException(
                    "BlockingCollection",
                    SR.GetString(SR.BlockingCollection_Disposed)
                );
            }
        }
    }
    ...
    internal sealed class SystemThreadingCollections_BlockingCollectionDebugView<T>
    {
        ...
        /// <summary>Constructs a new debugger view object for the provided blocking collection
        // object.</summary>
        /// <param name="collection">A blocking collection to browse in the debugger.</param>
        public SystemThreadingCollections_BlockingCollectionDebugView(
        ...
        public T[] Items
        {
            get { return m_blockingCollection.ToArray(); }
        }
    }
}
