...
namespace System.Runtime.Versioning
{
    ...
    public sealed class FrameworkName : IEquatable<FrameworkName>
    {
        ...
        public FrameworkName(String identifier, Version version, String profile)
        {
            ...
            if (identifier.Trim().Length == 0)
            {
                throw new ArgumentException(
                    SR.GetString(SR.net_emptystringcall, "identifier"),
                    "identifier"
                );
            }
            if (version == null)
        ...
        public FrameworkName(String frameworkName)
        {
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.net_emptystringcall, "frameworkName"),
                    "frameworkName"
                );
            }
            Contract.EndContractBlock();
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.Argument_FrameworkNameTooShort),
                    "frameworkName"
                );
            }
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.Argument_FrameworkNameInvalid),
                    "frameworkName"
                );
            }
            ...
            for (int i = 1; i < components.Length; i++)
            {
                ...
                if (key.Equals(c_versionKey, StringComparison.OrdinalIgnoreCase))
                {
                    ...
                    {
                        throw new ArgumentException(
                            SR.GetString(SR.Argument_FrameworkNameInvalidVersion),
                            "frameworkName",
                            e
                        );
                    }
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.Argument_FrameworkNameMissingVersion),
                    "frameworkName"
                );
            }
        }
