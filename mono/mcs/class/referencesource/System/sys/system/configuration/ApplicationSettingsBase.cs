...
[assembly: SuppressMessage(
    ...
    Scope = "member",
    Target = "System.Configuration.ApplicationSettingsBase.add_PropertyChanged(System.ComponentModel.PropertyChangedEventHandler):System.Void"
)]
[assembly: SuppressMessage(
    "Microsoft.Security",
    "CA2123:OverrideLinkDemandsShouldBeIdenticalToBase",
    Scope = "member",
    Target = "System.Configuration.ApplicationSettingsBase.remove_PropertyChanged(System.ComponentModel.PropertyChangedEventHandler):System.Void"
)]
[assembly: SuppressMessage(
    "Microsoft.Security",
    "CA2122:DoNotIndirectlyExposeMethodsWithLinkDemands",
    Scope = "member",
    Target = "System.ComponentModel.TypeDescriptor.GetConverter(System.Type):System.ComponentModel.TypeConverter"
)]
...
[assembly: SuppressMessage(
    ...
    "CA2122:DoNotIndirectlyExposeMethodsWithLinkDemands",
    Scope = "member",
    Target = "System.Configuration.LocalFileSettingsProvider..ctor()"
)]
...
namespace System.Configuration
{
    ...
    public abstract class ApplicationSettingsBase : SettingsBase, INotifyPropertyChanged
    {
            ...
            : this(settingsKey)
        {
            ...
            if (owner.Site != null)
            {
                ISettingsProviderService provSvc =
            ...
            for (int i = 0; i < attributes.Length; i++)
            {
                ...
                if (attr != null)
                {
                    ...
                    else if (attr is SettingsProviderAttribute)
                    {
                        ...
                        if (providerType != null)
                        {
                            ...
                            else
                            {
                                throw new ConfigurationErrorsException(
                                    SR.GetString(SR.ProviderInstantiationFailed, providerTypeName)
                                );
                            }
                        }
                        else
                        {
                            throw new ConfigurationErrorsException(
                                SR.GetString(SR.ProviderTypeLoadFailed, providerTypeName)
                            );
                        }
                    }
