...
namespace System.IO.Compression
{
    public class DeflateStream : Stream
    {
        ...
        internal delegate void AsyncWriteDelegate(
            byte[] array,
            int offset,
            int count,
            bool isAsync
        ...
        public override int Read(byte[] array, int offset, int count)
        {
            ...
            while (true)
            {
                ...
                Debug.Assert(
                    inflater.NeedsInput(),
                    "We can only run into this case if we are short of input"
                );
        ...
        {
            DeflateStreamAsyncResult outerResult = (DeflateStreamAsyncResult)
                baseStreamResult.AsyncState;
        ...
        )
        {
            ...
            try
            {
                ...
                m_AsyncWriterDelegate.BeginInvoke(
                    array,
                    offset,
                    count,
                    true,
