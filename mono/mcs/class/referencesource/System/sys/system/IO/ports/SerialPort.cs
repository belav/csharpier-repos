...
namespace System.IO.Ports
{
    ...
    public class SerialPort : System.ComponentModel.Component
    {
            ...
            get
            {
                if (!IsOpen)
                    throw new InvalidOperationException(
                        SR.GetString(SR.BaseStream_Invalid_Not_Open)
                    );
        ...
        [Browsable(true), DefaultValue(defaultBaudRate), MonitoringDescription(SR.BaudRate)]
        public int BaudRate
        {
            get { return baudRate; }
            set
        ...
        [Browsable(true), DefaultValue(defaultDataBits), MonitoringDescription(SR.DataBits)]
        public int DataBits
        {
            get { return dataBits; }
            set
        ...
        [Browsable(true), DefaultValue(defaultDiscardNull), MonitoringDescription(SR.DiscardNull)]
        ...
        [Browsable(true), DefaultValue(defaultDtrEnable), MonitoringDescription(SR.DtrEnable)]
                ...
                if (
                    !(
                        ...
                        || (
                            ...
                            && value.GetType().Assembly == typeof(String).Assembly
                        )
                    )
                )
                {
                    throw new ArgumentException(
                        SR.GetString(SR.NotSupportedEncoding, value.WebName),
                        "value"
                    );
                }
        ...
        [Browsable(true), DefaultValue(defaultHandshake), MonitoringDescription(SR.Handshake)]
        public Handshake Handshake
        {
            ...
            set
            {
                if (value < Handshake.None || value > Handshake.RequestToSendXOnXOff)
                    throw new ArgumentOutOfRangeException(
                        "Handshake",
                        SR.GetString(SR.ArgumentOutOfRange_Enum)
                    );
        ...
        [Browsable(false), DefaultValue(defaultNewLine), MonitoringDescription(SR.NewLine)]
        public string NewLine
        {
            ...
            set
            {
                ...
                if (value.Length == 0)
                    throw new ArgumentException(
                        SR.GetString(SR.InvalidNullEmptyArgument, "NewLine")
                    );
        ...
        [Browsable(true), DefaultValue(defaultParity), MonitoringDescription(SR.Parity)]
        ...
        [Browsable(true), DefaultValue(defaultPortName), MonitoringDescription(SR.PortName)]
        public string PortName
        {
            ...
            set
            {
                ...
                if (IsOpen)
                    throw new InvalidOperationException(
                        SR.GetString(SR.Cant_be_set_when_open, "PortName")
                    );
                portName = value;
            }
        }
        ...
        public int ReadBufferSize
        {
            ...
            set
            {
                ...
                if (IsOpen)
                    throw new InvalidOperationException(
                        SR.GetString(SR.Cant_be_set_when_open, "value")
                    );
        ...
        public int ReadTimeout
        {
            ...
            set
            {
                if (value < 0 && value != SerialPort.InfiniteTimeout)
                    throw new ArgumentOutOfRangeException(
                        "ReadTimeout",
                        SR.GetString(SR.ArgumentOutOfRange_Timeout)
                    );
        ...
        [Browsable(true), DefaultValue(defaultRtsEnable), MonitoringDescription(SR.RtsEnable)]
        ...
        [Browsable(true), DefaultValue(defaultStopBits), MonitoringDescription(SR.StopBits)]
        ...
        public int WriteTimeout
        {
            ...
            set
            {
                if (value <= 0 && value != SerialPort.InfiniteTimeout)
                    throw new ArgumentOutOfRangeException(
                        "WriteTimeout",
                        SR.GetString(SR.ArgumentOutOfRange_WriteTimeout)
                    );
            ...
            while (i < dataSize)
            {
                ...
                if (i != start)
                {
                    ...
                    if (nameSize > 0)
                    {
                        ...
                        if (
                            internalName.StartsWith(SERIAL_NAME)
                            || portNames.ContainsKey(internalName)
                        )
                        {
            ...
            fixed (char* bufferPtr = buffer)
            {
                ...
                while (dataSize <= 0)
                {
                    ...
                    if (
                        ...
                        || lastError == NativeMethods.ERROR_MORE_DATA
                    )
                    {
        ...
        public void Open()
        {
            ...
            internalSerialStream.ErrorReceived += new SerialErrorReceivedEventHandler(
                CatchErrorEvents
            );
            internalSerialStream.PinChanged += new SerialPinChangedEventHandler(
                CatchPinChangedEvents
            );
            internalSerialStream.DataReceived += new SerialDataReceivedEventHandler(
                CatchReceivedEvents
            );
        }
        ...
        public int Read(byte[] buffer, int offset, int count)
        {
            ...
            bytesReadToBuffer += internalSerialStream.Read(
                buffer,
        ...
        )
        {
            ...
            DecoderReplacementFallback fallback =
                encoding.DecoderFallback as DecoderReplacementFallback;
            if (
            ...
            else
            {
                ...
                do
                {
                    currentBytesToExamine = Math.Min(
                        ...
                        readLen - readPos - totalBytesExamined
                    );
                    ...
                    Debug.Assert(
                        (lastFullCharPos + currentBytesToExamine) <= readLen,
                    ...
                    if (currentCharsFound > 0)
                    {
                        ...
                        do
                        {
                            ...
                            decoder.GetCharCount(inBuffer, lastFullCharPos, foundCharsByteLength)
                            == currentCharsFound
                        );
                ...
                while (true)
                {
                    ...
                    if (numCharsRead > 1)
                    {
                        for (int i = 0; i < numCharsRead; i++)
                            Debug.Assert(
                                (Char.IsSurrogate(singleCharBuffer[i])),
                    ...
                    if (
                        lastValueChar == (char)singleCharBuffer[numCharsRead - 1]
                    ...
                    try
                    {
                        raiseEvent =
                            ...
                            && (
                                ...
                                || BytesToRead >= receivedBytesThreshold
                            );
                    }
                    catch
                    {
