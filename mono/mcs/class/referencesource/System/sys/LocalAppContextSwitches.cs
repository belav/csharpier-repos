...
namespace System
{
    internal static class LocalAppContextSwitches
    {
        ...
        internal const string MemberDescriptorEqualsReturnsFalseIfEquivalentName =
        ...
        public static bool MemberDescriptorEqualsReturnsFalseIfEquivalent
        {
            ...
            get
            {
                return LocalAppContext.GetCachedSwitchValue(
                    MemberDescriptorEqualsReturnsFalseIfEquivalentName,
                    ref _memberDescriptorEqualsReturnsFalseIfEquivalent
                );
            }
        }
        #endregion
        ...
        internal const string DontEnableSchUseStrongCryptoName =
        ...
        internal const string AllocateOverlappedOnDemandName =
            @"Switch.System.Net.WebSockets.HttpListenerAsyncEventArgs.AllocateOverlappedOnDemand";
        ...
        public static bool AllocateOverlappedOnDemand
        {
            ...
            {
                return LocalAppContext.GetCachedSwitchValue(
                    AllocateOverlappedOnDemandName,
                    ref _allocateOverlappedOnDemand
                );
            }
        }

        private static int _dontEnableSchSendAuxRecord;
        internal const string DontEnableSchSendAuxRecordName =
        ...
        public static bool DontEnableSchSendAuxRecord
        {
            ...
            {
                return LocalAppContext.GetCachedSwitchValue(
                    DontEnableSchSendAuxRecordName,
                    ref _dontEnableSchSendAuxRecord
                );
            }
        }

        private static int _dontEnableSystemSystemDefaultTlsVersions;
        internal const string DontEnableSystemDefaultTlsVersionsName =
        ...
        public static bool DontEnableSystemDefaultTlsVersions
        {
            ...
            {
                return LocalAppContext.GetCachedSwitchValue(
                    DontEnableSystemDefaultTlsVersionsName,
                    ref _dontEnableSystemSystemDefaultTlsVersions
                );
            }
        }
