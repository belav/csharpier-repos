...
namespace System.IO.Compression
{
    ...
    internal static class ZLibNative
    {
        ...
        [SecurityCritical]
        private delegate ErrorCode DeflateInit2_Delegate(
            ref ZStream stream,
        ...
        [SuppressUnmanagedCodeSecurity]
        [SecurityCritical]
        private delegate ErrorCode InflateInit2_Delegate(
            ref ZStream stream,
            int windowBits,
            [MarshalAs(UnmanagedType.LPStr)] string version,
            int streamSize
        ...
        public sealed class ZLibStreamHandle : SafeHandleMinusOneIsInvalid
        {
            ...
            private static class NativeZLibDLLStub
            {
                ...
                {
                    IntPtr entryPoint = ZLibNative.NativeMethods.GetProcAddress(
                        ZLibStreamHandle.zlibLibraryHandle,
                        entryPointName
                    );
                    ...
                    return (DT)
                        (Object)Marshal.GetDelegateForFunctionPointer(entryPoint, typeof(DT));
                }
                ...
                private static void InitDelegates()
                {
                    ...
                    zlibCompileFlagsDelegate = CreateDelegate<ZlibCompileFlagsDelegate>(
                        "zlibCompileFlags"
                    );
            ...
            protected override bool ReleaseHandle()
            {
                ...
                switch (InitializationState)
                {
                    ...
                    case State.InitializedForDeflate:
                        return (DeflateEnd() == ZLibNative.ErrorCode.Ok);
                    case State.InitializedForInflate:
                        return (InflateEnd() == ZLibNative.ErrorCode.Ok);
                    case State.Disposed:
                        return true;
                    default:
            ...
            {
                [SecurityCritical]
                get { return zStream.nextIn; }
                [SecurityCritical]
                set { zStream.nextIn = value; }
            }

            public UInt32 AvailIn
            {
                [SecurityCritical]
                get { return zStream.availIn; }
                [SecurityCritical]
                set { zStream.availIn = value; }
            }

            public UInt32 TotalIn
            {
                [SecurityCritical]
                get { return zStream.totalIn; }
            }

            public IntPtr NextOut
            {
                [SecurityCritical]
                get { return zStream.nextOut; }
                [SecurityCritical]
                set { zStream.nextOut = value; }
            }

            public UInt32 AvailOut
            {
                [SecurityCritical]
                get { return zStream.availOut; }
                [SecurityCritical]
                set { zStream.availOut = value; }
            }

            public UInt32 TotalOut
            {
                [SecurityCritical]
                get { return zStream.totalOut; }
            }

            public Int32 DataType
            {
                [SecurityCritical]
                get { return zStream.dataType; }
            }
            ...
            [SecurityCritical]
            public ErrorCode DeflateInit2_(
                CompressionLevel level,
                int windowBits,
                int memLevel,
                CompressionStrategy strategy
            )
            {
                ...
                {
                    errC = NativeZLibDLLStub.deflateInit2_Delegate(
                        ref zStream,
                        level,
            ...
            public ErrorCode InflateInit2_(int windowBits)
            {
                ...
                {
                    errC = NativeZLibDLLStub.inflateInit2_Delegate(
                        ref zStream,
                        windowBits,
                        ZLibVersion,
                        Marshal.SizeOf(zStream)
        ...
        {
            return CreateZLibStreamForDeflate(
                out zLibStreamHandle,
