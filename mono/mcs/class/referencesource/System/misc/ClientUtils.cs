...
#pragma warning restore 618
...
#if DEBUG
            Debug_NonSequentialEnumIsDefinedCheck(
                enumValue,
                minValue,
                maxValue,
                maxNumberOfBitsOn,
        ...
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        [SuppressMessage("Microsoft.Performance", "CA1808:AvoidCallsThatBoxValueTypes")]
        private static void Debug_SequentialEnumIsDefinedCheck(
            System.Enum value,
            int minVal,
            int maxVal
        )
        ...
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        [SuppressMessage("Microsoft.Performance", "CA1808:AvoidCallsThatBoxValueTypes")]
        private static void Debug_NonSequentialEnumIsDefinedCheck(
            System.Enum value,
            int minVal,
            int maxVal,
            int maxBitsOn,
                ...
                for (int i = 0; i < Count; i++)
                {
                    if (this.InnerList[i] != other.InnerList[i])
                    {
                        if (
                            ...
                            || !this.InnerList[i].Equals(other.InnerList[i])
                        )
                        {
                            return false;
                        }
