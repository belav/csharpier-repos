    ...
    internal sealed class RegexInterpreter : RegexRunner
    {
        ...
        private bool Refmatch(int index, int len)
        {
            ...
            else
            {
                while (c-- != 0)
                    if (
                        Char.ToLower(runtext[--cmpos], runculture)
        ...
        protected override bool FindFirstChar()
        {
            ...
            )
            {
                ...
                {
                    if (
                        (0 != (runanchors & RegexFCD.Beginning) && runtextpos > runtextbeg)
                ...
                {
                    if (
                        (0 != (runanchors & RegexFCD.End) && runtextpos < runtextend)
                        || (
        ...
        internal override void DumpState()
        {
            ...
            Debug.WriteLine(
                "       "
                    + runcode.OpcodeDescription(runcodepos)
