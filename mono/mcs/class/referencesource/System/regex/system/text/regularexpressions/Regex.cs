...
namespace System.Text.RegularExpressions
{
...
#endif
    using System.Globalization;using System.Security.Permissions;using System.Runtime.CompilerServices;using System.Collections.Generic;using System.Diagnostics.CodeAnalysis;
#if !SILVERLIGHT
    using System.Runtime.Serialization;using System.Runtime.Versioning;
#endif
...
#endif
    {
        ...
        [NonSerialized()]
#endif
        private static readonly TimeSpan MaximumMatchTimeout = TimeSpan.FromMilliseconds(
            Int32.MaxValue - 1
        );
...
#endif
#else
        internal static readonly TimeSpan InfiniteMatchTimeout = new TimeSpan(
            0,
            0,
            0,
            0,
        ...
        private Regex(String pattern, RegexOptions options, TimeSpan matchTimeout, bool useCache)
        {
            ...
            String key =
                ((int)options).ToString(NumberFormatInfo.InvariantInfo)
                + ":"
                + cultureKey
                + ":"
                + pattern;
        ...
        */
        ...
        [SuppressMessage(
            ...
            MessageId = "Unescape",
            Justification = "Microsoft: already shipped since v1 - can't fix without causing a breaking change"
        )]
        ...
        [ResourceConsumption(ResourceScope.Machine)]
        private static void CompileToAssemblyInternal(
            RegexCompilationInfo[] regexinfos,
            AssemblyName assemblyname,
            CustomAttributeBuilder[] attributes,
            String resourceFile
        ...
        private static CachedCodeEntry LookupCachedAndUpdate(String key)
        {
            ...
            {
                for (
                    LinkedListNode<CachedCodeEntry> current = livecode.First;
                    current != null;
        ...
        internal bool Debug
        {
            get { return (roptions & RegexOptions.Debug) != 0; }
        }
    ...
    internal sealed class CachedCodeEntry
    {
        ...
        internal CachedCodeEntry(
            ...
            int capsize,
            ExclusiveReference runner,
            SharedReference repl
        )
#else
        internal CachedCodeEntry(
            string key,
