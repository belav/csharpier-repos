...
namespace Microsoft.Win32
{
    ...
    internal static class UnsafeNativeMethods
    {
        ...
        public static extern bool GetClassInfo(
            HandleRef hInst,
            string lpszClass,
            [In, Out] NativeMethods.WNDCLASS_I wc
        );
        ...
        public static extern bool PeekMessage(
            [In, Out] ref NativeMethods.MSG msg,
            HandleRef hwnd,
            int msgMin,
            int msgMax,
            int remove
        ...
        private static bool _IsPackagedProcess()
        {
            ...
            if (
                ...
                && DoesWin32MethodExist(ExternDll.Kernel32, "AppPolicyGetClrCompat")
            )
            {
                ...
                osSupportsPackagedProcesses
                && DoesWin32MethodExist(ExternDll.Kernel32, "GetCurrentPackageId")
            )
            {
                Int32 bufLen = 0;
        ...
        public static extern bool ClearEventLog(
            SafeHandle hEventLog,
            HandleRef lpctstrBackupFileName
        );
        ...
        [SuppressMessage(
            "Microsoft.Security",
            "CA2118:ReviewSuppressUnmanagedCodeSecurityUsage",
            Justification = "Microsoft: EventLog is protected by EventLogPermission"
        )]
