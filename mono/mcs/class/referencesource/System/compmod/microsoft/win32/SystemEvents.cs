...
namespace Microsoft.Win32
{
    ...
    public sealed class SystemEvents
    {
        ...
        private const string everettThreadAffinityValue =
            ...
            get
            {
                if (Environment.OSVersion.Platform == System.PlatformID.Win32NT)
                {
                    ...
                    if (hwinsta != IntPtr.Zero && processWinStation != hwinsta)
                    {
                        ...
                        if (
                            UnsafeNativeMethods.GetUserObjectInformation(
                                new HandleRef(null, hwinsta),
                                NativeMethods.UOI_FLAGS,
                                flags,
                                Marshal.SizeOf(flags),
                                ref lengthNeeded
                            )
                        )
                        {
        ...
        {
            add { AddEventHandler(OnDisplaySettingsChangingEvent, value); }
            remove { RemoveEventHandler(OnDisplaySettingsChangingEvent, value); }
        }
        ...
        {
            add { AddEventHandler(OnDisplaySettingsChangedEvent, value); }
            remove { RemoveEventHandler(OnDisplaySettingsChangedEvent, value); }
        }
        ...
        public static event EventHandler EventsThreadShutdown
        {
            ...
            add { AddEventHandler(OnEventsThreadShutdownEvent, value); }
            remove { RemoveEventHandler(OnEventsThreadShutdownEvent, value); }
        }
        ...
        {
            add { AddEventHandler(OnInstalledFontsChangedEvent, value); }
            remove { RemoveEventHandler(OnInstalledFontsChangedEvent, value); }
        }
        ...
        public static event EventHandler LowMemory
        {
            ...
            remove { RemoveEventHandler(OnLowMemoryEvent, value); }
        }
        ...
        {
            add { AddEventHandler(OnPaletteChangedEvent, value); }
            remove { RemoveEventHandler(OnPaletteChangedEvent, value); }
        }
        ...
        public static event PowerModeChangedEventHandler PowerModeChanged
        {
            ...
            remove { RemoveEventHandler(OnPowerModeChangedEvent, value); }
        }
        ...
        public static event SessionEndedEventHandler SessionEnded
        {
            ...
            remove { RemoveEventHandler(OnSessionEndedEvent, value); }
        }
        ...
        public static event SessionEndingEventHandler SessionEnding
        {
            ...
            remove { RemoveEventHandler(OnSessionEndingEvent, value); }
        }
        ...
        public static event SessionSwitchEventHandler SessionSwitch
        {
            ...
            remove { RemoveEventHandler(OnSessionSwitchEvent, value); }
        }
        ...
        public static event EventHandler TimeChanged
        {
            ...
            remove { RemoveEventHandler(OnTimeChangedEvent, value); }
        }
        ...
        public static event TimerElapsedEventHandler TimerElapsed
        {
            ...
            remove { RemoveEventHandler(OnTimerElapsedEvent, value); }
        }
        ...
        {
            add { AddEventHandler(OnUserPreferenceChangedEvent, value); }
            remove { RemoveEventHandler(OnUserPreferenceChangedEvent, value); }
        }
        ...
        {
            add { AddEventHandler(OnUserPreferenceChangingEvent, value); }
            remove { RemoveEventHandler(OnUserPreferenceChangingEvent, value); }
        }
        ...
        private IntPtr DefWndProc
        {
            ...
            get
            {
                ...
                {
                    string defproc = (
                        Marshal.SystemDefaultCharSize == 1 ? "DefWindowProcA" : "DefWindowProcW"
                    );

                    defWindowProc = UnsafeNativeMethods.GetProcAddress(
                        new HandleRef(this, UnsafeNativeMethods.GetModuleHandle("user32.dll")),
                        defproc
                    );
                }
        ...
        [SuppressMessage(
            ...
            "CA8001",
            Justification = "Only called on a single thread"
        )]
        ...
        private IntPtr CreateBroadcastWindow()
        {
            ...
            if (
                !UnsafeNativeMethods.GetClassInfo(
                    new HandleRef(this, hInstance),
        ...
        public static IntPtr CreateTimer(int interval)
        {
            ...
            EnsureSystemEvents(true, true);
            IntPtr timerId = UnsafeNativeMethods.SendMessage(
                new HandleRef(systemEvents, systemEvents.windowHandle),
                NativeMethods.WM_CREATETIMER,
                (IntPtr)interval,
                IntPtr.Zero
            );
                        ...
                        if (Thread.GetDomain().GetData(".appDomain") != null)
                        {
                            if (throwOnRefusal)
                            {
                                throw new InvalidOperationException(
                                    SR.GetString(SR.ErrorSystemEventsNotSupported)
                                );
                            }
                            return;
                        }
        ...
        private static void EnsureRegisteredSessionNotification()
        {
            if (!registeredSessionNotification)
            {
                ...
                {
                    UnsafeNativeMethods.WTSRegisterSessionNotification(
                        new HandleRef(systemEvents, systemEvents.windowHandle),
        ...
        public static void InvokeOnEventsThread(Delegate method)
        {
            ...
            Debug.Assert(
                windowThread == null || thread != SafeNativeMethods.GetCurrentThreadId(),
            ...
            if (threadCallbackList == null)
            {
                lock (eventLockObject)
                {
                    if (threadCallbackList == null)
                    {
                        threadCallbackMessage = SafeNativeMethods.RegisterWindowMessage(
        ...
        private IntPtr OnCreateTimer(IntPtr wParam)
        {
            ...
            IntPtr res = UnsafeNativeMethods.SetTimer(
                new HandleRef(this, windowHandle),
                new HandleRef(this, timerId),
                (int)wParam,
                NativeMethods.NullHandleRef
            );
        ...
        {
            bool res = UnsafeNativeMethods.KillTimer(
                new HandleRef(this, windowHandle),
                new HandleRef(this, wParam)
            );
            return res;
        }
        ...
        private static string CompanyNameInternal
        {
            ...
            get
            {
                ...
                {
                    object[] attrs = entryAssembly.GetCustomAttributes(
        ...
        private static void RemoveEventHandler(object key, Delegate value)
        {
            lock (eventLockObject)
            {
                ...
                {
                    List<SystemEventInvokeInfo> invokeItems =
                        (List<SystemEventInvokeInfo>)_handlers[key];
                ...
                lock (procLockObject)
                {
                    if (systemEvents != null)
                    {
                        ...
                        if (windowThread != null)
                        {
                            ...
                            Debug.Assert(
                                thread != SafeNativeMethods.GetCurrentThreadId(),
                ...
                case NativeMethods.WM_REFLECT + NativeMethods.WM_SETTINGCHANGE:
                    ...
                    finally
                    {
                        ...
                        catch (Exception e)
                        {
                            Debug.Assert(
                                false,
                                "Exception occurred while freeing memory: " + e.ToString()
                            );
                        }
                    }
                    break;
        ...
        private void WindowThreadProc()
        {
            try
            {
                ...
                if (windowHandle != IntPtr.Zero)
                {
                    ...
                    while (keepRunning)
                    {
                        int ret = UnsafeNativeMethods.MsgWaitForMultipleObjectsEx(
                            0,
                            IntPtr.Zero,
                            100,
                        ...
                        {
                            while (
                                UnsafeNativeMethods.PeekMessage(
                                    ref msg,
                                    NativeMethods.NullHandleRef,
                                    0,
                                    0,
