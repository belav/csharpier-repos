...
namespace Microsoft.VisualBasic
{
    ...
    internal class VBCodeGenerator : CodeCompiler
    {
        ...
        {
            get { return (IsCurrentClass && GetUserData(CurrentClass, "Module", false)); }
        }
        ...
        protected override void ProcessCompilerOutputLine(CompilerResults results, string line)
        {
            ...
            if (m.Success)
            {
                ...
                if (
                    string.Compare(m.Groups[3].Value, "warning", StringComparison.OrdinalIgnoreCase)
                    == 0
                )
                {
                    ce.IsWarning = true;
        ...
        protected override string CmdArgsFromParameters(CompilerParameters options)
        {
            ...
            foreach (string s in options.ReferencedAssemblies)
            {
                if (String.IsNullOrEmpty(s))
                {
                    throw new ArgumentException(
                        SR.GetString(SR.NullOrEmpty_Value_in_Property, "ReferencedAssemblies"),
                        "options"
                    );
                }
            }
            ...
            foreach (string s in options.ReferencedAssemblies)
            {
                ...
                if (
                    string.Compare(fileName, "mscorlib.dll", StringComparison.OrdinalIgnoreCase)
                    == 0
                )
                    continue;
        ...
        private string GetBaseTypeOutput(CodeTypeReference typeRef)
        {
            ...
            if (baseType.Length == 0)
            {
                ...
                string.Compare(baseType, "System.Byte", StringComparison.OrdinalIgnoreCase) == 0
            )
            {
                return "Byte";
            }
            else if (
                string.Compare(baseType, "System.SByte", StringComparison.OrdinalIgnoreCase) == 0
            )
            {
                return "SByte";
            }
            else if (
                string.Compare(baseType, "System.Int16", StringComparison.OrdinalIgnoreCase) == 0
            )
            {
                return "Short";
            }
            else if (
                string.Compare(baseType, "System.Int32", StringComparison.OrdinalIgnoreCase) == 0
            )
            {
                return "Integer";
            }
            else if (
                string.Compare(baseType, "System.Int64", StringComparison.OrdinalIgnoreCase) == 0
            )
            {
                return "Long";
            }
            else if (
                string.Compare(baseType, "System.UInt16", StringComparison.OrdinalIgnoreCase) == 0
            )
            {
                return "UShort";
            }
            else if (
                string.Compare(baseType, "System.UInt32", StringComparison.OrdinalIgnoreCase) == 0
            )
            {
                return "UInteger";
            }
            else if (
                string.Compare(baseType, "System.UInt64", StringComparison.OrdinalIgnoreCase) == 0
            )
            {
                return "ULong";
            }
            else if (
                string.Compare(baseType, "System.String", StringComparison.OrdinalIgnoreCase) == 0
            )
            {
                return "String";
            }
            else if (
                string.Compare(baseType, "System.DateTime", StringComparison.OrdinalIgnoreCase) == 0
            )
            {
                return "Date";
            }
            else if (
                string.Compare(baseType, "System.Decimal", StringComparison.OrdinalIgnoreCase) == 0
            )
            {
                return "Decimal";
            }
            else if (
                string.Compare(baseType, "System.Single", StringComparison.OrdinalIgnoreCase) == 0
            )
            {
                return "Single";
            }
            else if (
                string.Compare(baseType, "System.Double", StringComparison.OrdinalIgnoreCase) == 0
            )
            {
                return "Double";
            }
            else if (
                string.Compare(baseType, "System.Boolean", StringComparison.OrdinalIgnoreCase) == 0
            )
            {
                return "Boolean";
            }
            else if (
                string.Compare(baseType, "System.Char", StringComparison.OrdinalIgnoreCase) == 0
            )
            {
                return "Char";
            }
            else if (
                string.Compare(baseType, "System.Object", StringComparison.OrdinalIgnoreCase) == 0
            )
            {
                return "Object";
            }
...
#pragma warning restore 618
            ...
            if (
                !Path.GetExtension(outputAssemblyFile)
                    .Equals(extensionWithDot, StringComparison.OrdinalIgnoreCase)
            )
            {
