...
#pragma warning restore 618
        ...
        {
            get { return (!isUnrestricted && rootTable.Count == 0); }
        }
        ...
        {
            get { return this.permissionAccessType; }
            set
            {
                if (value == null)
                ...
                if (!value.IsEnum)
                    throw new ArgumentException(
                        SR.GetString(SR.PermissionBadParameterEnum),
                        "value"
                    );
        ...
        protected string[] TagNames
        {
            ...
            set
            {
                ...
                if (value.Length == 0)
                    throw new ArgumentException(
                        SR.GetString(SR.PermissionInvalidLength, "0"),
                        "value"
                    );
        ...
        private Hashtable CopyChildren(object currentContent, int tagIndex)
        {
            ...
            while (contentEnumerator.MoveNext())
            {
                if (tagIndex < (this.TagNames.Length - 1))
                    newTable[contentEnumerator.Key] = CopyChildren(
        ...
        private ResourcePermissionBaseEntry[] GetChildrenAccess(object currentContent, int tagIndex)
        {
            ...
            while (contentEnumerator.MoveNext())
            {
                if (tagIndex < (this.TagNames.Length - 1))
                {
                    ResourcePermissionBaseEntry[] currentEntries = GetChildrenAccess(
                        contentEnumerator.Value,
                        tagIndex + 1
                    );
                    for (int index = 0; index < currentEntries.Length; ++index)
                        currentEntries[index].PermissionAccessPath[tagIndex] = (string)
                            contentEnumerator.Key;

                    list.AddRange(currentEntries);
                }
                else
                {
                    ResourcePermissionBaseEntry entry = new ResourcePermissionBaseEntry(
                        (int)contentEnumerator.Value,
                        new string[this.TagNames.Length]
                    );
        ...
        public override void FromXml(SecurityElement securityElement)
        {
            ...
            if (
                !securityElement.Tag.Equals("Permission")
                && !securityElement.Tag.Equals("IPermission")
            )
            ...
            if (
                ...
                && (
                    string.Compare(unrestrictedValue, "true", StringComparison.OrdinalIgnoreCase)
                    == 0
                )
            )
            {
        ...
        public override IPermission Intersect(IPermission target)
        {
            ...
            Hashtable newPermissionRootTable = (Hashtable)IntersectContents(
                this.rootTable,
                targetPermission.rootTable
            );
            ...
            else
            {
                ...
                if (currentLocalContent != null || currentComputerNameContent != null)
                {
                    ...
                    if (targetLocalContent != null || targetComputerNameContent != null)
                    {
                        ...
                        if (currentLocalContent != null && currentComputerNameContent != null)
                            currentLocalMergedContent = UnionOfContents(
                                currentLocalContent,
                                currentComputerNameContent
                            );
                        ...
                        if (targetLocalContent != null && targetComputerNameContent != null)
                            targetLocalMergedContent = UnionOfContents(
                                targetLocalContent,
                        ...
                        object computerNameValue = IntersectContents(
                        ...
                        if (HasContent(computerNameValue))
                        {
                            ...
                            if (
                                currentComputerNameContent != null
                                || targetComputerNameContent != null
                            )
                            {
                ...
                while (contentEnumerator.MoveNext())
                {
                    ...
                    if (
                        contentsTable.ContainsKey(currentKey)
                        && currentKey != Local
        ...
        private bool IsContentSubset(object currentContent, object targetContent)
        {
            ...
            else
            {
                ...
                object currentLocalMergedContent = MergeContents(
                    currentContentTable[Local],
                    currentContentTable[ComputerName]
                );
                if (currentLocalMergedContent != null)
                {
                    object targetLocalMergedContent = MergeContents(
                        targetContentTable[Local],
                        targetContentTable[ComputerName]
                    );
        ...
        private object ReadChildren(SecurityElement securityElement, int tagIndex)
        {
            ...
            if (securityElement.Children != null)
            {
                ...
                {
                    SecurityElement currentElement = (SecurityElement)
                    ...
                    if (currentElement.Tag == this.TagNames[tagIndex])
                    {
                        ...
                        else
                        {
                            ...
                            {
                                permissionAccess = (int)
                                    Enum.Parse(PermissionAccessType, accessString);
                            }
        ...
        public override SecurityElement ToXml()
        {
            ...
            root.AddAttribute(
                "class",
                type.FullName + ", " + type.Module.Assembly.FullName.Replace('\"', '\'')
            );
        ...
        public override IPermission Union(IPermission target)
        {
            ...
            {
                Hashtable newPermissionRootTable = (Hashtable)UnionOfContents(
                    this.rootTable,
                    targetPermission.rootTable
                );
                if (newPermissionRootTable != null)
            ...
            else
            {
                ...
                while (targetContentEnumerator.MoveNext())
                {
                    ...
                    else
                    {
                        ...
                        newContents[targetContentEnumerator.Key] = UnionOfContents(
                            currentValue,
                            targetValue
                        );
                    }
        ...
        private void WriteChildren(
            SecurityElement currentElement,
