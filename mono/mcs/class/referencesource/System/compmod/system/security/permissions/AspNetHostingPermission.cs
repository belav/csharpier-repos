...
namespace System.Web
{
    ...
    public sealed class AspNetHostingPermission : CodeAccessPermission, IUnrestrictedPermission
    {
            ...
            switch (state)
            {
                ...
                default:
                    throw new ArgumentException(
                        SR.GetString(SR.InvalidArgument, state.ToString(), "state")
                    );
            }
        }
        ...
        public override void FromXml(SecurityElement securityElement)
        {
            if (securityElement == null)
            {
                throw new ArgumentNullException(
                    SR.GetString(SR.AspNetHostingPermissionBadXml, "securityElement")
                );
            }
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.AspNetHostingPermissionBadXml, "version")
                );
            }
        ...
        public override SecurityElement ToXml()
        {
            ...
            securityElement.AddAttribute(
                "Level",
                Enum.GetName(typeof(AspNetHostingPermissionLevel), _level)
            );
            if (IsUnrestricted())
            {
