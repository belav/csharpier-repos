...
namespace System.Collections.Specialized
{
    ...
    public struct BitVector32
    {
        ...
        {
            get { return (int)((data & (uint)(section.Mask << section.Offset)) >> section.Offset); }
            set
            {
#if DEBUG
        ...
        )
        {
            if (maxValue < 1)
            {
                throw new ArgumentException(
                    SR.GetString(SR.Argument_InvalidValue, "maxValue", 0),
                    "maxValue"
                );
            }
#if DEBUG
            ...
            Debug.Assert(
                maskCheck <= short.MaxValue && offsetCheck < 32,
                "Overflow on BitVector32"
            );
#endif
        ...
        {
            StringBuilder sb = new StringBuilder( /*"BitVector32{".Length*/
                12
                    + /*32 bits*/
                    32
                    + /*"}".Length"*/
