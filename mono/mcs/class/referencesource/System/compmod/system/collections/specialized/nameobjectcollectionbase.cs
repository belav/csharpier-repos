...
namespace System.Collections.Specialized
{
    ...
    // <see cref='System.String' qualify='true'/> keys
    ///    and <see cref='System.Object' qualify='true'/> values that can be accessed either with the
    // hash code of
            ...
            IDeserializationCallback
    {
        ...
        protected NameObjectCollectionBase(Int32 capacity, IEqualityComparer equalityComparer)
        ...
        /// <para>Creates an empty <see cref='System.Collections.Specialized.NameObjectCollectionBase'/>
        // instance with
        ///    the default initial capacity and using the specified case-insensitive hash code provider and
        // the
...
#pragma warning disable 618
            ...
            if (_keyComparer == defaultComparer)
            {
                info.AddValue(
                    ...
                    CompatibleComparer.DefaultHashCodeProvider,
...
#pragma warning disable 618
                        hashProvider = (IHashCodeProvider)
                            info.GetValue(HashCodeProviderName, typeof(IHashCodeProvider));
                        ;
#pragma warning restore 618
                        break;
                    case ComparerName:
                    ...
                    case KeyComparerName:
                        _keyComparer = (IEqualityComparer)
                            info.GetValue(KeyComparerName, typeof(IEqualityComparer));
                        break;
                    case CountName:
        ...
        /// <devdoc>
        /// <para>Returns an <see cref='System.Object' qualify='true'/> array containing all the values in
        // the
        /// <see cref='System.Collections.Specialized.NameObjectCollectionBase'/> instance.</para>
        /// </devdoc>
        ...
        /// <devdoc>
        /// <para>Represents a collection of the <see cref='System.String' qualify='true'/> keys of a
        // collection.</para>
        /// </devdoc>
        [Serializable()]
...
#pragma warning disable 618
        public static IHashCodeProvider DefaultHashCodeProvider
        {
            get
            {
                ...
                {
                    defaultHashProvider = new CaseInsensitiveHashCodeProvider(
