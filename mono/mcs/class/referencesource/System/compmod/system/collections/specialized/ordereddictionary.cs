...
namespace System.Collections.Specialized
{
    ...
    public class OrderedDictionary : IOrderedDictionary, ISerializable, IDeserializationCallback
    {
        ...
        {
            get { return new OrderedDictionaryKeyValueCollection(objectsArray, true); }
        }
        ...
        {
            get { return new OrderedDictionaryKeyValueCollection(objectsArray, false); }
        }
                ...
                foreach (object o in serArray)
                {
                    ...
                    catch
                    {
                        throw new SerializationException(
                            SR.GetString(SR.OrderedDictionary_SerializationMismatch)
                        );
                    }
        ...
        private class OrderedDictionaryEnumerator : IDictionaryEnumerator
        {
            ...
            public DictionaryEntry Entry
            {
                get
                {
                    return new DictionaryEntry(
                        ((DictionaryEntry)arrayEnumerator.Current).Key,
            ...
            public object Key
            {
                get { return ((DictionaryEntry)arrayEnumerator.Current).Key; }
            }
            ...
            public object Value
            {
                get { return ((DictionaryEntry)arrayEnumerator.Current).Value; }
            }
