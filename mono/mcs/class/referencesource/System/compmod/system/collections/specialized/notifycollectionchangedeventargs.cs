    ...
    public class NotifyCollectionChangedEventArgs : EventArgs
    {
        ...
        public NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction action)
        {
            if (action != NotifyCollectionChangedAction.Reset)
                throw new ArgumentException(
                    SR.GetString(SR.WrongActionForCtor, NotifyCollectionChangedAction.Reset),
                    "action"
                );
        ...
        )
        {
            if (
                ...
                throw new ArgumentException(
                    SR.GetString(SR.MustBeResetAddOrRemoveActionForCtor),
                    "action"
                );
            ...
            if (action == NotifyCollectionChangedAction.Reset)
            {
                if (changedItem != null)
                    throw new ArgumentException(
                        SR.GetString(SR.ResetActionRequiresNullItem),
                        "action"
                    );
        ...
        )
        {
            ...
            if (action == NotifyCollectionChangedAction.Reset)
            {
                ...
                if (index != -1)
                    throw new ArgumentException(
                        SR.GetString(SR.ResetActionRequiresIndexMinus1),
                        "action"
                    );
        ...
        )
        {
            ...
            else
            {
                ...
                if (startingIndex < -1)
                    throw new ArgumentException(
                        SR.GetString(SR.IndexCannotBeNegative),
                        "startingIndex"
                    );
        ...
        )
        {
            if (action != NotifyCollectionChangedAction.Replace)
                throw new ArgumentException(
                    SR.GetString(SR.WrongActionForCtor, NotifyCollectionChangedAction.Replace),
                    "action"
                );
        ...
        )
        {
            if (action != NotifyCollectionChangedAction.Move)
                throw new ArgumentException(
                    SR.GetString(SR.WrongActionForCtor, NotifyCollectionChangedAction.Move),
                    "action"
                );
            if (index < 0)
