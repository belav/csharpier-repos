...
namespace System.Collections.Specialized
{
    ...
    [Serializable]
    [DesignerSerializer(
        "System.Diagnostics.Design.StringDictionaryCodeDomSerializer, " + AssemblyRef.SystemDesign,
        ...
        class GenericAdapter : IDictionary<string, string>
        {
            ...
            public ICollection<string> Keys
            {
                get
                {
                    if (_keys == null)
                    {
                        _keys = new ICollectionToGenericCollectionAdapter(
                            m_stringDictionary,
                            KeyOrValue.Key
                        );
                    }
            ...
            public ICollection<string> Values
            {
                get
                {
                    if (_values == null)
                    {
                        _values = new ICollectionToGenericCollectionAdapter(
                            m_stringDictionary,
                            KeyOrValue.Value
                        );
                    }
            ...
            )
            {
                ...
                {
                    array[index++] = new KeyValuePair<string, string>(
                        (string)entry.Key,
                        (string)entry.Value
                    );
                }
                ...
                public void ThrowNotSupportedException()
                {
                    if (_keyOrValue == KeyOrValue.Key)
                    {
                        throw new NotSupportedException(
                            SR.GetString(SR.NotSupported_KeyCollectionSet)
                        ); //Same as KeyCollection/ValueCollection
                    }
                    throw new NotSupportedException(
                        SR.GetString(SR.NotSupported_ValueCollectionSet)
                    ); //Same as KeyCollection/ValueCollection
                }
