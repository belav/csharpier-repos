...
namespace System.CodeDom.Compiler
{
    ...
    public abstract class CodeDomProvider : Component
    {
        ...
        private static CodeDomCompilationConfiguration Config
        {
            get
            {
                CodeDomCompilationConfiguration _configuration = (CodeDomCompilationConfiguration)
                    PrivilegedConfigurationManager.GetSection(
                        CodeDomCompilationConfiguration.sectionName
                    );
...
#pragma warning restore 618
        ...
        )
        {
            ...
            string referenceAssemblyFolderPrefix = Path.Combine(
            ...
            foreach (string s in parameters.ReferencedAssemblies)
            {
                ...
                if (
                    s.IndexOf(referenceAssemblyFolderPrefix, StringComparison.OrdinalIgnoreCase)
                    >= 0
                )
                {
