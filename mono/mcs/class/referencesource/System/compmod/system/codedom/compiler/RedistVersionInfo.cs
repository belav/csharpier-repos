...
namespace System.CodeDom.Compiler
{
    ...
    internal static class RedistVersionInfo
    {
        ...
        public static string GetCompilerPath(
            IDictionary<string, string> provOptions,
        ...
        )
        {
            ...
            if (provOptions != null)
            {
                ...
                if (directoryPathPresent && versionValPresent)
                {
                    throw new InvalidOperationException(
                        SR.GetString(
                            SR.Cannot_Specify_Both_Compiler_Path_And_Version,
                            DirectoryPath,
                            NameTag
                        )
                    );
            ...
            if (compPath == null)
                throw new InvalidOperationException(
                    SR.GetString(SR.CompilerNotFound, compilerExecutable)
                );
        ...
        private static string GetCompilerPathFromRegistry(String versionVal)
        {
            ...
            if (
                !string.IsNullOrEmpty(comPlus_InstallRoot) && !string.IsNullOrEmpty(comPlus_Version)
            )
            {
