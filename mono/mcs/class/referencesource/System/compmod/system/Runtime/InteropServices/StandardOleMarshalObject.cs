...
namespace System.Runtime.InteropServices
{
    ...
    public class StandardOleMarshalObject : MarshalByRefObject, UnsafeNativeMethods.IMarshal
    {
        ...
        private delegate int GetMarshalSizeMax_Delegate(
            IntPtr _this,
            ref Guid riid,
            IntPtr pv,
            int dwDestContext,
        ...
        [SuppressUnmanagedCodeSecurity]
        [UnmanagedFunctionPointer(CallingConvention.StdCall)]
        private delegate int MarshalInterface_Delegate(
            IntPtr _this,
            IntPtr pStm,
            ref Guid riid,
            IntPtr pv,
        ...
        private IntPtr GetStdMarshaler(ref Guid riid, int dwDestContext, int mshlflags)
        {
            ...
            if (pUnk != IntPtr.Zero)
            {
                try
                {
                    if (
                        NativeMethods.S_OK
                        == UnsafeNativeMethods.CoGetStandardMarshal(
                            ref riid,
                            pUnk,
                            dwDestContext,
                            IntPtr.Zero,
                    ...
                    {
                        Debug.Assert(
                            pStandardMarshal != null,
                            "Failed to get marshaler for interface '"
                                + riid.ToString()
                                + "', CoGetStandardMarshal returned S_OK"
                        );
            ...
            throw new InvalidOperationException(
                SR.GetString(SR.StandardOleMarshalObjectGetMarshalerFailed, riid.ToString())
            );
        }
        ...
        unsafe int UnsafeNativeMethods.IMarshal.GetMarshalSizeMax(
            ref Guid riid,
            IntPtr pv,
            int dwDestContext,
            IntPtr pvDestContext,
        ...
        )
        {
            ...
            try
            {
                ...
                GetMarshalSizeMax_Delegate del = (GetMarshalSizeMax_Delegate)
                    Marshal.GetDelegateForFunctionPointer(
                        method,
                        typeof(GetMarshalSizeMax_Delegate)
                    );
                return del(
                    pStandardMarshal,
                    ref riid,
        ...
        unsafe int UnsafeNativeMethods.IMarshal.MarshalInterface(
            IntPtr pStm,
            ref Guid riid,
            IntPtr pv,
            int dwDestContext,
        ...
        )
        {
            ...
            try
            {
                ...
                MarshalInterface_Delegate del = (MarshalInterface_Delegate)
                    Marshal.GetDelegateForFunctionPointer(
                        method,
                        typeof(MarshalInterface_Delegate)
                    );
                return del(
                    pStandardMarshal,
                    pStm,
