...
namespace System.ComponentModel.Design
{
    ...
    public class ServiceContainer : IServiceContainer, IDisposable
    {
        ...
        private static TraceSwitch TRACESERVICE = new TraceSwitch(
            "TRACESERVICE",
            "ServiceProvider: Trace service provider requests."
        );
        ...
        public virtual void AddService(Type serviceType, object serviceInstance, bool promote)
        {
            ...
            )
            {
                throw new ArgumentException(
                    SR.GetString(SR.ErrorInvalidServiceInstance, serviceType.FullName)
                );
            }
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.ErrorServiceExists, serviceType.FullName),
                    "serviceType"
                );
            }
                ...
                )
                {
                    ...
                    Debug.Fail(
                        "Object "
                            ...
                            + " was returned from a service creator callback but it does not implement the registered type of "
                            + serviceType.Name
                    );
                    Debug.WriteLineIf(
                        TRACESERVICE.TraceVerbose,
        ...
        {
            static EmbeddedTypeAwareTypeComparer serviceTypeComparer =
