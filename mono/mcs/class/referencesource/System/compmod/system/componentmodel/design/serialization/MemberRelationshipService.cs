...
namespace System.ComponentModel.Design.Serialization
{
    ...
    {
        private Dictionary<RelationshipEntry, RelationshipEntry> _relationships =
        ...
        protected virtual MemberRelationship GetRelationship(MemberRelationship source)
        {
            ...
            if (
                _relationships != null
                && _relationships.TryGetValue(new RelationshipEntry(source), out retVal)
                && retVal.Owner.IsAlive
            )
            {
