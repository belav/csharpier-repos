...
[assembly: System.Diagnostics.CodeAnalysis.SuppressMessage(
    ...
    Scope = "member",
    Target = "System.ComponentModel.PropertyTabAttribute.get_TabClasses():System.Type[]"
)]
    ...
    public class PropertyTabAttribute : Attribute
    {
        ...
        public PropertyTabAttribute(Type tabClass, PropertyTabScope tabScope)
        {
            ...
            if (tabScope < PropertyTabScope.Document)
            {
                throw new ArgumentException(
                    SR.GetString(SR.PropertyTabAttributeBadPropertyTabScope),
                    "tabScope"
                );
            }
                        ...
                        if (tabClasses[i] == null)
                        {
                            ...
                            else
                            {
                                throw new TypeLoadException(
                                    SR.GetString(
                                        SR.PropertyTabAttributeTypeLoadException,
                                        className
                                    )
                                );
                            }
        ...
        )
        {
            if (tabClasses != null)
            {
                ...
                {
                    throw new ArgumentException(
                        SR.GetString(SR.PropertyTabAttributeArrayLengthMismatch)
                    );
                }
