...
namespace System.ComponentModel
{
    ...
    public class CultureInfoConverter : TypeConverter
    {
        ...
        {
            get { return SR.GetString(SR.CultureInfoConverterDefaultCultureString); }
        }
            ...
            if (value is string)
            {
                ...
                try
                {
                    ...
                    if (
                        text == null
                        || text.Length == 0
                        || string.Compare(text, DefaultCultureString, StringComparison.Ordinal) == 0
                    )
                    {
                ...
                if (retVal == null)
                {
                    throw new ArgumentException(
                        SR.GetString(SR.CultureInfoConverterInvalidCulture, (string)value)
                    );
                }
                return retVal;
            }
        ...
        )
        {
            ...
            if (destinationType == typeof(InstanceDescriptor) && value is CultureInfo)
            {
                ...
                ConstructorInfo ctor = typeof(CultureInfo).GetConstructor(
