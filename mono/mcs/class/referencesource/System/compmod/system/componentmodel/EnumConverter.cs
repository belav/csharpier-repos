...
namespace System.ComponentModel
{
    ...
    public class EnumConverter : TypeConverter
    {
        ...
        {
            get { return InvariantComparer.Default; }
        }
            ...
            if (value is string)
            {
                try
                {
                    ...
                    if (strValue.IndexOf(',') != -1)
                    {
                        ...
                        {
                            convertedValue |= Convert.ToInt64(
                                (Enum)Enum.Parse(type, v, true),
                                culture
                            );
                        }
                ...
                catch (Exception e)
                {
                    throw new FormatException(
                        SR.GetString(SR.ConvertInvalidPrimitive, (string)value, type.Name),
                        e
                    );
                }
            }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage(
            ...
            "CA1803:AvoidCostlyCallsWherePossible"
        )] // Keep call to Enum.IsDefined
            ...
            if (destinationType == typeof(string) && value != null)
            {
                ...
                if (!type.IsDefined(typeof(FlagsAttribute), false) && !Enum.IsDefined(type, value))
                {
                    throw new ArgumentException(
                        SR.GetString(SR.EnumConverterInvalidValue, value.ToString(), type.Name)
                    );
                }
