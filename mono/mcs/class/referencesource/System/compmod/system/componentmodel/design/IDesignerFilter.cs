...
namespace System.ComponentModel.Design
{
    ...
    ///       an interface for filtering, the dictionaries that store the properties, attributes, or
    // events of a component.</para>
    /// </devdoc>
    public interface IDesignerFilter
    {
        /// <devdoc>
        ///    <para> Allows a designer to filter the set of
        ///       attributes the component being designed will expose through the <see
        // cref='System.ComponentModel.TypeDescriptor'/> object.</para>
        /// </devdoc>
        void PostFilterAttributes(IDictionary attributes);

        /// <devdoc>
        ///    <para> Allows a designer to filter the set of events
        ///       the component being designed will expose through the <see
        // cref='System.ComponentModel.TypeDescriptor'/>
        ///       object.</para>
        /// </devdoc>
