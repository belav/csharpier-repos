            ...
            if (value is string)
            {
                ...
                catch (FormatException e)
                {
                    throw new FormatException(
                        SR.GetString(SR.ConvertInvalidPrimitive, (string)value, "DateTime"),
                        e
                    );
                }
            }
        ...
        )
        {
            ...
            if (destinationType == typeof(InstanceDescriptor) && value is DateTime)
            {
                ...
                if (dt.Ticks == 0)
                {
                    ...
                    //
                    ConstructorInfo ctr = typeof(DateTime).GetConstructor(
                        new Type[] { typeof(Int64) }
                    );

                    if (ctr != null)
                    {
                        return new InstanceDescriptor(ctr, new object[] { dt.Ticks });
                    }
                }
