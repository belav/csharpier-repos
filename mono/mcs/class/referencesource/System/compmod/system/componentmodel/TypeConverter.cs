            ...
            get
            {
                ...
                if (firstLoadAppSetting)
                {
                    lock (loadAppSettingLock)
                    {
                        if (firstLoadAppSetting)
                        {
                            string useCompatibleConfig = ConfigurationManager.AppSettings[
                                s_UseCompatibleTypeConverterBehavior
                            ];
                            ...
                            try
                            {
                                ...
                                {
                                    useCompatibleTypeConversion = bool.Parse(
                                        useCompatibleConfig.Trim()
                                    );
                                }
                            }
                            catch
