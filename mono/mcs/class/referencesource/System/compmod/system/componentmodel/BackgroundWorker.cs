...
namespace System.ComponentModel
{
    ...
    public class BackgroundWorker : Component
    {
        ...
        [Browsable(false), SRDescription(SR.BackgroundWorker_CancellationPending)]
        ...
        public void CancelAsync()
        {
            if (!WorkerSupportsCancellation)
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.BackgroundWorker_WorkerDoesntSupportCancellation)
                );
            }
        ...
        [SRCategory(SR.PropertyCategoryAsynchronous), SRDescription(SR.BackgroundWorker_DoWork)]
        ...
        [Browsable(false), SRDescription(SR.BackgroundWorker_IsBusy)]
        public bool IsBusy
        {
        ...
        public void ReportProgress(int percentProgress, object userState)
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.BackgroundWorker_WorkerDoesntReportProgress)
                );
            }
        ...
        public void RunWorkerAsync(object argument)
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.BackgroundWorker_WorkerAlreadyRunning)
                );
            }
        ...
        private void WorkerThreadStart(object argument)
        {
            ...
            RunWorkerCompletedEventArgs e = new RunWorkerCompletedEventArgs(
                workerResult,
                error,
                cancelled
            );
