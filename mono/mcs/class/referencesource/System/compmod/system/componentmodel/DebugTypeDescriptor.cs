...
#pragma warning restore 618
        private static TraceSwitch CompDescrSwitch = new TraceSwitch(
            "CompDescr",
            "Debug DebugTypeDescriptor."
        );
...
#pragma warning disable 618
        public static IComNativeDescriptorHandler ComNativeDescriptorHandler
        {
            ...
            get { return comNativeDescriptorHandler; }
            [PermissionSetAttribute(SecurityAction.LinkDemand, Name = "FullTrust")]
...
#pragma warning restore 618
            ...
            for (int i = 0; i < attributes.Count; i++)
            {
                if (attributes[i] is DesignerAttribute)
                {
                    ...
                    if (attributeBaseType != null && attributeBaseType == designerBaseType)
                    {
                        ...
                        Debug.Assert(
                            designerType != null,
                            "It may be okay for the designer not to load, but we failed to load designer for component of type '"
                                + component.GetType().FullName
                                + "' because designer of type '"
                                + da.DesignerTypeName
                                + "'"
                        );
        ...
        )
        {
            ...
            if (componentType == oldPropertyDescriptor.ComponentType)
            {
                ...
                {
                    return new DebugExtendedPropertyDescriptor(
                        (DebugReflectPropertyDescriptor)attr.ExtenderProperty,
                        attr.ReceiverType,
                        attr.Provider,
                        attributes
                    );
            ...
            //
            return new DebugReflectPropertyDescriptor(
                componentType,
...
#pragma warning restore 618
            ...
            if (editor == null)
            {
                editor = GetEntry(component, component.GetType())
                    .GetEditor(component, editorBaseType);
            }
...
#pragma warning restore 618
            ...
            if (!noCustomTypeDesc && component is ICustomTypeDescriptor)
            {
                ...
                return GetEntry(component, component.GetType())
                    .FilterEvents(component, null, events);
            }
...
#pragma warning restore 618
            ...
            return GetEntry(component, component.GetType())
                .GetEvents(component, attributes, (component is ICustomTypeDescriptor));
        }
...
#pragma warning restore 618
            ...
            return GetEntry(component, component.GetType())
                .GetProperties(component, attributes, (component is ICustomTypeDescriptor));
        }
        ...
        private class ComponentEntry
        {
            ...
            public void Dispose(object component)
            {
                if (component is IComponent)
                {
                    IDictionaryService ds = (IDictionaryService)GetService(
                ...
                if (attributes != null && attributes.Length > 0 && infos.Count > 0)
                {
                    switch (attributes.Length)
                    {
                        ...
                        case 2:
                        {
                            ...
                            {
                                if (
                                    ShouldHideMember((MemberDescriptor)infos[i], filterAttribute1)
                                    || ShouldHideMember(
                                        (MemberDescriptor)infos[i],
                                        filterAttribute2
                                    )
                                )
                                {
            ...
            public AttributeCollection GetAttributes(object component)
            {
                ...
                if (component is IComponent)
                {
                    ITypeDescriptorFilterService tf = (ITypeDescriptorFilterService)GetService(
                        component,
                    ...
                    if (tf != null)
                    {
                        ...
                        if (ds != null)
                        {
                            ...
                            lock (ds)
                            {
                                savedAttributes = (AttributeCollection)
                                    ds.GetValue(typeof(AttributeCollection));
                            }
                            if (savedAttributes != null)
                            {
                                ...
                                //
                                object savedFilter = ds.GetValue(
                                    typeof(ITypeDescriptorFilterService)
                                );
            ...
            */
            ...
            public TypeConverter GetConverter()
            {
                if (converter == null)
                {
                    TypeConverterAttribute attr = (TypeConverterAttribute)
                        GetAttributes(null)[typeof(TypeConverterAttribute)];
                    if (attr != null)
                    {
            ...
            public TypeConverter GetConverter(object component)
            {
                ...
                //
                TypeConverterAttribute attr = (TypeConverterAttribute)
                    GetAttributes(component)[typeof(TypeConverterAttribute)];

                if (attr != null)
                {
                    TypeConverterAttribute baseAttr = (TypeConverterAttribute)
                        GetAttributes(null)[typeof(TypeConverterAttribute)];
                    if (baseAttr != attr)
                    {
                        Type converterType = GetTypeFromName(attr.ConverterTypeName);
            ...
            public object GetEditor(Type editorBaseType)
            {
                ...
                if (editor == null)
                {
                    ...
                    if (editor == null)
                    {
                        Hashtable intrinsicEditors = DebugTypeDescriptor.GetEditorTable(
                            editorBaseType
                        );
                    ...
                    if (editor != null && !editorBaseType.IsInstanceOfType(editor))
                    {
                        Debug.Fail(
                            "Editor "
                                ...
                                + editorBaseType.FullName
                                + " but it is in that base types table."
                        );
                        editor = null;
                    }
                ...
                if (component is IComponent)
                {
                    ...
                    if (!noFilter && tf != null)
                    {
                        ...
                        if (ds != null)
                        {
                            ...
                            lock (ds)
                            {
                                savedEvents = (EventDescriptorCollection)
                                    ds.GetValue(typeof(EventDescriptorCollection));
                            }
            ...
            internal EventDescriptorCollection FilterEvents(
                object component,
                Attribute[] attributes,
            ...
            /// </devdoc>
            private ICollection GetExtendedProperties(
                IComponent comp,
            ...
            )
            {
                ...
                Debug.WriteLineIf(
                    CompDescrSwitch.TraceVerbose,
                    "\tFound "
                        + providers.Length.ToString(CultureInfo.InvariantCulture)
                        + " providers"
                );
                ...
                for (int i = 0; i < providers.Length; i++)
                {
                    ...
                    ComponentEntry providerCompInfo = DebugTypeDescriptor.GetEntry(
                        comp,
                        providerType
                    );
                    ...
                    Debug.WriteLineIf(
                        CompDescrSwitch.TraceVerbose,
                        "\twrapped extenders: "
                            + providerWrappedExtenders.Count.ToString(CultureInfo.InvariantCulture)
                    );

                    for (int j = 0; j < providerWrappedExtenders.Count; j++)
                    {
                        PropertyDescriptor currentWrappedExtender = (PropertyDescriptor)
                            providerWrappedExtenders[j];
                        Type receiverType = null;

                        ExtenderProvidedPropertyAttribute eppa = (ExtenderProvidedPropertyAttribute)
                            currentWrappedExtender.Attributes[
            ...
            private string GetExtenderCollisionSuffix(PropertyDescriptor prop)
            {
                ...
                ExtenderProvidedPropertyAttribute exAttr = (ExtenderProvidedPropertyAttribute)
            ...
            private IExtenderProvider[] GetExtenderProviders(ISite site)
            {
                ...
                //
                IExtenderListService listService = (IExtenderListService)
                    site.GetService(typeof(IExtenderListService));
            ...
            )
            {
                ...
                {
                    this.properties = new PropertyDescriptorCollection(
                        new MemberList(this).GetProperties(),
                        true
                    );
                }
                ...
                if (component is IComponent)
                {
                    ...
                    if (!noFilter)
                        tf = (ITypeDescriptorFilterService)GetService(
                            component,
                            typeof(ITypeDescriptorFilterService)
                        );
                    ...
                    if (ds != null)
                    {
                        ...
                        //
                        if (
                            (filterStash == null || filterStash == tf)
                            && propStash != null
                            && propStash.ExtendersMatch(providers, component)
                        )
                        {
                    ...
                    if (!inDictionary)
                    {
                        ...
                        {
                            ICollection extendedProperties = GetExtendedProperties(
                                (IComponent)component,
                                providers
                            );
                            ...
                            if (extendedProperties != null && extendedProperties.Count > 0)
                            {
                                allProps = new ArrayList(
                                    properties.Count + extendedProperties.Count
                                );
                        ...
                        if (tf != null)
                        {
                            ...
                            foreach (PropertyDescriptor p in allProps)
                            {
                                ...
                                if (filterTable.Contains(p.Name))
                                {
                                    ...
                                    //
                                    PropertyDescriptor origProp = (PropertyDescriptor)
                                        filterTable[p.Name];
            ...
            internal PropertyDescriptorCollection FilterProperties(
                object component,
                Attribute[] attributes,
                PropertyDescriptorCollection properties
            )
                ...
                if (component is IComponent)
                {
                    ...
                    if (tf != null)
                    {
                        ...
                        foreach (PropertyDescriptor p in properties)
                        {
                            ...
                            Debug.Assert(
                                !filterTable.Contains(p.Name + suffix),
                                "Overwriting PropertyDescriptor during filtering!!! "
                                    + p.Name
                                    + suffix
                            );
                            filterTable[p.Name + suffix] = p;
                ...
                lock (this)
                {
                    ...
                    if (wrappedExtenders == null)
                    {
                        ...
                        Debug.WriteLineIf(
                            CompDescrSwitch.TraceVerbose,
                            "\tfound "
                                + extenders.Count.ToString(CultureInfo.InvariantCulture)
                                + " extenders"
                        );
                        wrappedExtenders = new ArrayList(extenders.Count);
                        for (int i = 0; i < extenders.Count; i++)
                        {
                            DebugReflectPropertyDescriptor ex = (DebugReflectPropertyDescriptor)
                                extenders[i];
                            ...
                            wrappedExtenders.Add(
                                new DebugExtendedPropertyDescriptor(
                                    ex,
                                    ex.ExtenderGetReceiverType(),
                                    provider,
                                    attrs
                                )
                            );
            ...
            private sealed class MemberList
            {
                ...
                private void ReflectGetEvents(Type classToReflect)
                {
                    ...
                    //
                    EventInfo[] events = classToReflect.GetEvents(
                    ...
                    foreach (EventInfo eventInfo in events)
                    {
                        if (
                            (
                                !(
                                    eventInfo.DeclaringType.IsPublic
                                    || eventInfo.DeclaringType.IsNestedPublic
                                )
                            )
                            && (
                                eventInfo.DeclaringType.Assembly
                                == typeof(DebugTypeDescriptor).Assembly
                            )
                        )
                        {
                            continue;
                        ...
                        if (eventHash != null)
                        {
                            ...
                            if (!allGood)
                            {
                                if (eventHash.Contains(eventInfo.Name))
                                {
                                    ...
                                    // getter.
                                    //
                                    EventDescriptor basePd = (EventDescriptor)
                                        eventHash[eventInfo.Name];
                                    Type declaringType = basePd.ComponentType;
                                    if (declaringType != null)
                                    {
                                        EventInfo baseEvent = declaringType.GetEvent(
                                            eventInfo.Name
                                        );
                                        if (
                                            baseEvent != null
                                            && baseEvent.GetAddMethod() != null
                                            && baseEvent.GetRemoveMethod() != null
                                        )
                                        {
                            ...
                            //
                            eventHash[eventInfo.Name] = new DebugReflectEventDescriptor(
                                classToReflect,
                                currentEvent
                            );
                        }
                ...
                private void ReflectGetExtenders(Type classToReflect)
                {
                    foreach (Attribute attr in DebugTypeDescriptor.GetAttributes(classToReflect))
                    {
                        if (attr is ProvidePropertyAttribute)
                        {
                            ...
                            {
                                MethodInfo getMethod = classToReflect.GetMethod(
                                    "Get" + provided.PropertyName,
                                    new Type[] { receiverType }
                                );
                                if (getMethod != null && !getMethod.IsStatic && getMethod.IsPublic)
                                {
                                    MethodInfo setMethod = classToReflect.GetMethod(
                                        "Set" + provided.PropertyName,
                                        new Type[] { receiverType, getMethod.ReturnType }
                                    );

                                    if (
                                        setMethod != null
                                        && (setMethod.IsStatic || !setMethod.IsPublic)
                                    )
                                    {
                                        setMethod = null;
                                    }
                                    AddMember(
                                        new DebugReflectPropertyDescriptor(
                                            classToReflect,
                ...
                private void ReflectGetProperties(Type classToReflect)
                {
                    ...
                    // declared on that type
                    //
                    PropertyInfo[] props = classToReflect.GetProperties(
                        BindingFlags.DeclaredOnly | BindingFlags.Public | BindingFlags.Instance
                    );
                    ...
                    {
                        if (
                            (!(pi.DeclaringType.IsPublic || pi.DeclaringType.IsNestedPublic))
                            && (pi.DeclaringType.Assembly == typeof(DebugTypeDescriptor).Assembly)
                        )
                        {
                            continue;
                        }
                            ...
                            if (propertyHash != null)
                            {
                                ...
                                if (getMethod == null)
                                {
                                    if (propertyHash.Contains(pi.Name))
                                    {
                                        ...
                                        // getter.
                                        //
                                        PropertyDescriptor basePd = (PropertyDescriptor)
                                            propertyHash[pi.Name];
                                        Type declaringType = basePd.ComponentType;
                                        if (declaringType != null)
                                        {
                                            PropertyInfo baseProp = declaringType.GetProperty(
                                                pi.Name,
                                                pi.PropertyType
                                            );
                                            if (baseProp != null)
                                ...
                                // push the new info into the hash table.
                                //
                                propertyHash[pi.Name] = new DebugReflectPropertyDescriptor(
                                    classToReflect,
                                    pi.Name,
                                    pi.PropertyType,
                                    pi,
        ...
        class MemberDescriptorComparer : IComparer
        {
            ...
            public int Compare(object left, object right)
            {
                return string.Compare(
                    ((MemberDescriptor)left).Name,
                    ((MemberDescriptor)right).Name,
                    false,
