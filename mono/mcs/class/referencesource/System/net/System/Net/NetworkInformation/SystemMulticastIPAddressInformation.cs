...
namespace System.Net.NetworkInformation
{
    ...
    internal class SystemMulticastIPAddressInformation : MulticastIPAddressInformation
    {
        ...
        /// <include file='doc\NetworkInterface.uex'
        // path='docs/doc[@for="IPAddressInformation.Transient"]/*' />
        /// <summary>The address is a cluster address and shouldn't be used by most applications.</summary>
        public override bool IsTransient
        {
            get { return (innerInfo.IsTransient); }
        }

        /// <include file='doc\NetworkInterface.uex'
        // path='docs/doc[@for="IPAddressInformation.DnsEligible"]/*' />
        /// <summary>This address can be used for DNS.</summary>
        public override bool IsDnsEligible
        {
            get { return (innerInfo.IsDnsEligible); }
        }

        /// <include file='doc\NetworkInterface.uex'
        // path='docs/doc[@for="IPMulticastAddressInformation.PrefixOrigin"]/*' />
        ...
        /// <include file='doc\NetworkInterface.uex'
        // path='docs/doc[@for="IPMulticastAddressInformation.SuffixOrigin"]/*' />
        ...
        /// <include file='doc\NetworkInterface.uex'
        // path='docs/doc[@for="IPMulticastAddressInformation.DuplicateAddressDetectionState"]/*' />
        ...
        /// <include file='doc\NetworkInterface.uex'
        // path='docs/doc[@for="IPMulticastAddressInformation.ValidLifetime"]/*' />
        ...
        /// <include file='doc\NetworkInterface.uex'
        // path='docs/doc[@for="IPMulticastAddressInformation.PreferredLifetime"]/*' />
        ...
        /// <include file='doc\NetworkInterface.uex'
        // path='docs/doc[@for="IPMulticastAddressInformation.DhcpLeaseLifetime"]/*' />
        /// <summary>Specifies the prefered lifetime of the address in seconds.</summary>
