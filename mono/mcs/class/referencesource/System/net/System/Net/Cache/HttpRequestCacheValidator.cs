...
namespace System.Net.Cache
{
    ...
    internal class HttpRequestCacheValidator : RequestCacheValidator
    {
        ...
        {
            get { return m_SystemMeta; }
            set { m_SystemMeta = value; }
        }
        internal HttpMethod RequestMethod
        {
            get { return m_RequestVars.Method; }
            set { m_RequestVars.Method = value; }
        }
        internal bool RequestRangeCache
        {
            get { return m_RequestVars.IsCacheRange; }
            set { m_RequestVars.IsCacheRange = value; }
        }
        internal bool RequestRangeUser
        {
            get { return m_RequestVars.IsUserRange; }
            set { m_RequestVars.IsUserRange = value; }
        }
        internal string RequestIfHeader1
        {
            get { return m_RequestVars.IfHeader1; }
            set { m_RequestVars.IfHeader1 = value; }
        }
        internal string RequestValidator1
        {
            get { return m_RequestVars.Validator1; }
            set { m_RequestVars.Validator1 = value; }
        }
        internal string RequestIfHeader2
        {
            get { return m_RequestVars.IfHeader2; }
            set { m_RequestVars.IfHeader2 = value; }
        }
        internal string RequestValidator2
        {
            get { return m_RequestVars.Validator2; }
            set { m_RequestVars.Validator2 = value; }
        }

        internal bool CacheDontUpdateHeaders
        {
            get { return m_DontUpdateHeaders; }
            set { m_DontUpdateHeaders = value; }
        }

        internal DateTime CacheDate
        {
            get { return m_CacheVars.Date; }
            set { m_CacheVars.Date = value; }
        }
        internal DateTime CacheExpires
        {
            get { return m_CacheVars.Expires; }
            set { m_CacheVars.Expires = value; }
        }
        internal DateTime CacheLastModified
        {
            get { return m_CacheVars.LastModified; }
            set { m_CacheVars.LastModified = value; }
        }
        internal long CacheEntityLength
        {
            get { return m_CacheVars.EntityLength; }
            set { m_CacheVars.EntityLength = value; }
        }
        internal TimeSpan CacheAge
        {
            get { return m_CacheVars.Age; }
            set { m_CacheVars.Age = value; }
        }
        internal TimeSpan CacheMaxAge
        {
            get { return m_CacheVars.MaxAge; }
            set { m_CacheVars.MaxAge = value; }
        }
        internal bool HeuristicExpiration
        {
            get { return m_HeuristicExpiration; }
            set { m_HeuristicExpiration = value; }
        }

        internal ResponseCacheControl CacheCacheControl
        {
            get { return m_CacheVars.CacheControl; }
            set { m_CacheVars.CacheControl = value; }
        }

        internal DateTime ResponseDate
        {
            get { return m_ResponseVars.Date; }
            set { m_ResponseVars.Date = value; }
        }
        internal DateTime ResponseExpires
        {
            get { return m_ResponseVars.Expires; }
            set { m_ResponseVars.Expires = value; }
        }
        internal DateTime ResponseLastModified
        {
            get { return m_ResponseVars.LastModified; }
            set { m_ResponseVars.LastModified = value; }
        }
        internal long ResponseEntityLength
        {
            get { return m_ResponseVars.EntityLength; }
            set { m_ResponseVars.EntityLength = value; }
        }
        internal long ResponseRangeStart
        {
            get { return m_ResponseVars.RangeStart; }
            set { m_ResponseVars.RangeStart = value; }
        }
        internal long ResponseRangeEnd
        {
            get { return m_ResponseVars.RangeEnd; }
            set { m_ResponseVars.RangeEnd = value; }
        }
        internal TimeSpan ResponseAge
        {
            get { return m_ResponseVars.Age; }
            set { m_ResponseVars.Age = value; }
        }
        internal ResponseCacheControl ResponseCacheControl
        {
            get { return m_ResponseVars.CacheControl; }
        ...
        */
            ...
            if (Logging.On)
            {
                if ((int)CacheStatusCode == 0)
                {
                    Logging.PrintError(
                        Logging.RequestCache,
                        SR.GetString(
                            SR.net_log_cache_http_status_parse_failure,
                            (s == null ? "null" : s)
                        )
                    );
                }
                else
                {
                    Logging.PrintInfo(
                        Logging.RequestCache,
                        SR.GetString(
                            SR.net_log_cache_http_status_line,
                            (CacheHttpVersion != null ? CacheHttpVersion.ToString() : "null"),
                            (int)CacheStatusCode,
        ...
        protected internal override CacheValidationStatus ValidateCache()
        {
            if (
                ...
                && base.Policy.Level >= RequestCacheLevel.Reload
            )
            {
            ...
            if (
                ...
                || CacheStatusCode == HttpStatusCode.NotModified
            )
            {
            ...
            if (
                ...
                && this.Policy.Level == HttpRequestCacheLevel.CacheOnly
            )
            {
                // Throw because entry was not found and it's cache-only policy
                FailRequest(WebExceptionStatus.CacheEntryNotFound);
            ...
            if (result == CacheValidationStatus.ReturnCachedResponse)
            {
                if (CacheFreshnessStatus == CacheFreshnessStatus.Stale)
                {
                    CacheHeaders.Add(
                        ...
                        HttpRequestCacheValidator.Warning_110
                    );
                }
                if (base.Policy.Level == RequestCacheLevel.CacheOnly)
                {
                    CacheHeaders.Add(
                        HttpKnownHeaderNames.Warning,
                        HttpRequestCacheValidator.Warning_112
                    );
                }
            ...
            {
                CacheHeaders[HttpKnownHeaderNames.Age] = ((int)(CacheAge.TotalSeconds)).ToString(
        ...
        protected internal override CacheValidationStatus RevalidateCache()
        {
            ...
            if (resp.StatusCode >= HttpStatusCode.InternalServerError)
            {
                ...
                if (
                    Rfc2616.Common.ValidateCacheOn5XXResponse(this)
        ...
        {
            if (
                this.Policy.Level != HttpRequestCacheLevel.CacheOrNextCacheOnly
                    ...
                    "StatusCode="
                        ...
                        + (
                            resp.StatusCode == HttpStatusCode.PartialContent
                                ? ", Content-Range: "
                                    + resp.Headers[HttpKnownHeaderNames.ContentRange]
                                : string.Empty
                        )
                );
        ...
        protected internal override CacheValidationStatus UpdateCache()
        {
            ...
            if (
                ...
                || result == CacheValidationStatus.CacheResponse
            )
            {
        ...
        private void FinallyUpdateCacheEntry()
        {
            ...
            System.Text.StringBuilder sb = new System.Text.StringBuilder(
                CacheStatusDescription.Length + 20
            );
            sb.Append("HTTP/");
        ...
        private string ParseStatusLine()
        {
            ...
            if (status < 0 || (idx <= s.Length && (ch != ' ' && ch != '\t')))
            {
                return s;
            }
        ...
        private void CreateSystemMeta()
        {
            if (SystemMeta == null)
            {
                SystemMeta = new NameValueCollection(
                    (
                        CacheEntry.EntryMetadata == null || CacheEntry.EntryMetadata.Count == 0
                            ? 2
                            : CacheEntry.EntryMetadata.Count
                    ),
                ...
                )
                {
                    if (Logging.On)
                        Logging.PrintError(
                            Logging.RequestCache,
                            SR.GetString(
                                SR.net_log_cache_content_range_error,
                                (s == null ? "<null>" : s)
                            )
                        );
                    ...
                    for (int i = 0; i < len - 4; ++i)
                    {
                        ...
                        if (IntPtr.Size == 4)
                        {
                            ...
                            switch (*mask | LO)
                            {
                                ...
                                case _priv:
                                    ...
                                    System.Collections.ArrayList privateList =
                                    ...
                                    {
                                        control.PrivateHeaders = (string[])
                                            privateList.ToArray(typeof(string));
                                    }
                                    break;
                                ...
                                case _no_c:
                                    ...
                                    System.Collections.ArrayList nocacheList =
                                        new System.Collections.ArrayList();
                                    ++i;
                                    while (i < len && sp[i] != '\"')
                                    {
                                    ...
                                    {
                                        control.NoCacheHeaders = (string[])
                                            nocacheList.ToArray(typeof(string));
                                    }
                                    break;
                        ...
                        else
                        {
                            ...
                            )
                            {
                                ...
                                Rfc2616.Common.UnsafeAsciiLettersNoCaseEqual(sp, i, len, "public")
                            )
                            {
                                control.Public = true;
                                i += 5;
                                ...
                                Rfc2616.Common.UnsafeAsciiLettersNoCaseEqual(sp, i, len, "private")
                            )
                            {
                                control.Private = true;
                                i += 6;
                                ...
                                Rfc2616.Common.UnsafeAsciiLettersNoCaseEqual(sp, i, len, "no-cache")
                            )
                            {
                                control.NoCache = true;
                                i += 7;
                                ...
                                Rfc2616.Common.UnsafeAsciiLettersNoCaseEqual(sp, i, len, "no-store")
                            )
                            {
                                control.NoStore = true;
                                i += 7;
                            ...
                            )
                            {
                                ...
                                Rfc2616.Common.UnsafeAsciiLettersNoCaseEqual(sp, i, len, "max-age")
                            )
                            {
                                i += 7;
                                while (i < len && sp[i] == ' ')
                                ...
                                Rfc2616.Common.UnsafeAsciiLettersNoCaseEqual(sp, i, len, "smax-age")
                            )
                            {
                                i += 8;
                                while (i < len && sp[i] == ' ')
        ...
        */
        ...
        private static readonly ParseCallback ParseWarningsCallback = new ParseCallback(
            ParseWarningsCallbackMethod
        );
