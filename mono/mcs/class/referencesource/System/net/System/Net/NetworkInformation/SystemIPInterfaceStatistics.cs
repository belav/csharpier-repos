...
namespace System.Net.NetworkInformation
{
    internal class SystemIPInterfaceStatistics : IPInterfaceStatistics
    {
        ...
        {
            get { return (long)ifRow.inOctets; }
        }
        public override long UnicastPacketsSent
        {
            get { return (long)ifRow.outUcastPkts; }
        }
        ...
        {
            get { return (long)ifRow.outNUcastPkts; }
        }
        public override long NonUnicastPacketsReceived
        {
            get { return (long)ifRow.inNUcastPkts; }
        }
        public override long IncomingPacketsDiscarded
        {
            get { return (long)ifRow.inDiscards; }
        }
        public override long OutgoingPacketsDiscarded
        {
            get { return (long)ifRow.outDiscards; }
        }
        public override long IncomingPacketsWithErrors
        {
            get { return (long)ifRow.inErrors; }
        }
        public override long OutgoingPacketsWithErrors
        {
            get { return (long)ifRow.outErrors; }
        }
        public override long IncomingUnknownProtocolPackets
        {
            get { return (long)ifRow.inUnknownProtos; }
        }
