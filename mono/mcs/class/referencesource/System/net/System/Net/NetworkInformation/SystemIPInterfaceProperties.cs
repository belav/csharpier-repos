...
namespace System.Net.NetworkInformation
{
    ...
    internal class SystemIPInterfaceProperties : IPInterfaceProperties
    {
        ...
        )
        {
            ...
            multicastAddresses =
                SystemMulticastIPAddressInformation.ToMulticastIpAddressInformationCollection(
                    IpAdapterAddress.MarshalIpAddressInformationCollection(
                        ipAdapterAddresses.firstMulticastAddress
                    )
                );
            dnsAddresses = IpAdapterAddress.MarshalIpAddressCollection(
            ...
            gatewayAddresses =
                SystemGatewayIPAddressInformation.ToGatewayIpAddressInformationCollection(
                    IpAdapterAddress.MarshalIpAddressCollection(
            ...
            {
                ipv6Properties = new SystemIPv6InterfaceProperties(
        ...
        {
            get { return dnsEnabled; }
        }

        public override bool IsDynamicDnsEnabled
        {
            get { return dynamicDnsEnabled; }
        }
        ...
        {
            get { return winsServersAddresses; }
        }
    }
}
