...
namespace System.Net
{
    ...
    internal class HeaderInfoTable
    {
        ...
        private static HeaderInfo UnknownHeaderInfo = new HeaderInfo(
            string.Empty,
            false,
            false,
            false,
        ...
        static HeaderInfoTable()
        {
            HeaderInfo[] InfoArray = new HeaderInfo[]
            {
                ...
                new HeaderInfo(
                    HttpKnownHeaderNames.AcceptLanguage,
                    false,
                    false,
                    true,
                    MultiParser
                ...
                new HeaderInfo(
                    HttpKnownHeaderNames.IfModifiedSince,
                    true,
                    false,
                    false,
                    SingleParser
                ...
                new HeaderInfo(
                    HttpKnownHeaderNames.IfUnmodifiedSince,
                    false,
                    false,
                    false,
                    SingleParser
                ...
                new HeaderInfo(
                    HttpKnownHeaderNames.ProxyAuthenticate,
                    false,
                    false,
                    true,
                    MultiParser
