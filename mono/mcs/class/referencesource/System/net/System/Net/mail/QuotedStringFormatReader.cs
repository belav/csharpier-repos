...
namespace System.Net.Mail
{
    ...
    // delineator such as
    // a comma: (abc@x.com, billy bob bob@bob.com), where the display name 'billy bob' should have been
    // quoted.
    //
    ...
    internal static class QuotedStringFormatReader
    {
        ...
        internal static int ReadReverseQuoted(string data, int index, bool permitUnicode)
        {
            ...
            Debug.Assert(
                data[index] == MailBnfHelper.Quote,
            ...
            throw new FormatException(
                SR.GetString(SR.MailHeaderFieldInvalidCharacter, MailBnfHelper.Quote)
            );
        }
