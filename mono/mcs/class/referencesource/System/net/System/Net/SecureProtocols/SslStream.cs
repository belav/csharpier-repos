...
namespace System.Net.Security
{
    ...
    public partial class SslStream : AuthenticatedStream
    {
            ...
            : base(innerStream, leaveInnerStreamOpen)
        {
            if (
                ...
                throw new ArgumentException(
                    SR.GetString(SR.net_invalid_enum, "EncryptionPolicy"),
                    "encryptionPolicy"
                );

            _userCertificateValidationCallback = userCertificateValidationCallback;
            _userCertificateSelectionCallback = userCertificateSelectionCallback;
            RemoteCertValidationCallback _userCertValidationCallbackWrapper =
                new RemoteCertValidationCallback(userCertValidationCallbackWrapper);
            LocalCertSelectionCallback _userCertSelectionCallbackWrapper =
                userCertificateSelectionCallback == null
                    ? null
                    : new LocalCertSelectionCallback(userCertSelectionCallbackWrapper);
            _SslState = new SslState(
                innerStream,
                _userCertValidationCallbackWrapper,
                _userCertSelectionCallbackWrapper,
                encryptionPolicy
            );
        }

        private bool userCertValidationCallbackWrapper(
            string hostName,
            X509Certificate certificate,
            X509Chain chain,
            SslPolicyErrors sslPolicyErrors
        ...
        private X509Certificate userCertSelectionCallbackWrapper(
            string targetHost,
            X509CertificateCollection localCertificates,
            X509Certificate remoteCertificate,
            string[] acceptableIssuers
        ...
        public virtual void AuthenticateAsClient(string targetHost)
        {
            AuthenticateAsClient(
                ...
                ServicePointManager.DefaultSslProtocols,
                false
            );
        }
        ...
        {
            _SslState.ValidateCreateContext(
                false,
                targetHost,
                enabledSslProtocols,
                null,
        ...
        {
            return AuthenticateAsClientAsync(
                targetHost,
                clientCertificates,
                ServicePointManager.DefaultSslProtocols,
                checkCertificateRevocation
        ...
        {
            get { return _SslState.IsAuthenticated; }
        }

        //
        public override bool IsMutuallyAuthenticated
        {
            get { return _SslState.IsMutuallyAuthenticated; }
        }
        ...
        {
            get { return _SslState.SslProtocol; }
        }

        //
        public virtual bool CheckCertRevocationStatus
        {
            get { return _SslState.CheckCertRevocationStatus; }
        }

        //
        public virtual X509Certificate LocalCertificate
        {
            get { return _SslState.LocalCertificate; }
        }
        ...
        public virtual X509Certificate RemoteCertificate
        {
            get
            {
                ...
                if (
                    chkCertificateOrBytes != null
                    && chkCertificateOrBytes.GetType() == typeof(byte[])
                )
                    return (X509Certificate)(
                        m_RemoteCertificateOrBytes = new X509Certificate(
        ...
        {
            get { return _SslState.CipherAlgorithm; }
        }

        //
        public virtual int CipherStrength
        {
            get { return _SslState.CipherStrength; }
        }

        //
        public virtual HashAlgorithmType HashAlgorithm
        {
            get { return _SslState.HashAlgorithm; }
        }

        //
        public virtual int HashStrength
        {
            get { return _SslState.HashStrength; }
        }

        //
        public virtual ExchangeAlgorithmType KeyExchangeAlgorithm
        {
            get { return _SslState.KeyExchangeAlgorithm; }
        }

        //
        public virtual int KeyExchangeStrength
        {
            get { return _SslState.KeyExchangeStrength; }
        }
        ...
        {
            get { return _SslState.IsAuthenticated && InnerStream.CanRead; }
        }
