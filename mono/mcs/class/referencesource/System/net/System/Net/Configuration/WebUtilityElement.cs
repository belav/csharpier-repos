    ...
    public sealed class WebUtilityElement : ConfigurationElement
    {
        private readonly ConfigurationProperty unicodeDecodingConformance =
            new ConfigurationProperty(
                ConfigurationStrings.UnicodeDecodingConformance,
                typeof(UnicodeDecodingConformance),
        ...
        private readonly ConfigurationProperty unicodeEncodingConformance =
            new ConfigurationProperty(
                ConfigurationStrings.UnicodeEncodingConformance,
                typeof(UnicodeEncodingConformance),
        ...
        {
            get { return (UnicodeDecodingConformance)this[this.unicodeDecodingConformance]; }
            set { this[this.unicodeDecodingConformance] = value; }
        }

        [ConfigurationProperty(
            ConfigurationStrings.UnicodeEncodingConformance,
            DefaultValue = UnicodeEncodingConformance.Auto
        )]
        public UnicodeEncodingConformance UnicodeEncodingConformance
        {
            get { return (UnicodeEncodingConformance)this[this.unicodeEncodingConformance]; }
            set { this[this.unicodeEncodingConformance] = value; }
        }
        ...
        private class EnumTypeConverter<TEnum> : TypeConverter
            where TEnum : struct
        {
