namespace System.Net.NetworkInformation
{
    ...
    internal struct IpSocketAddress
    {
        ...
        internal IPAddress MarshalIPAddress()
        {
            ...
            AddressFamily family =
                (addressLength > SocketAddress.IPv4AddressSize)
    ...
    internal struct IpAdapterAddress
    {
        ...
        internal static IPAddressCollection MarshalIpAddressCollection(IntPtr ptr)
        {
            ...
            {
                IpAdapterAddress addressStructure = (IpAdapterAddress)
                    Marshal.PtrToStructure(ptr, typeof(IpAdapterAddress));
    ...
    internal static class UnsafeNetInfoNativeMethods
    {
        ...
        internal static extern uint IcmpSendEcho2(
            ...
            IntPtr apcContext,
            uint ipAddress,
            [In] SafeLocalFree data,
            ushort dataSize,
            ref IPOptions options,
            SafeLocalFree replyBuffer,
            uint replySize,
            uint timeout
        );
