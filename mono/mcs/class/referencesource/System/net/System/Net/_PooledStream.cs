...
namespace System.Net
{
    ...
    internal class PooledStream : Stream
    {
        ...
        internal bool CanBePooled
        {
            ...
            set { m_ConnectionIsDoomed |= !value; }
        }
        ...
        {
            GlobalLog.Assert(
                owningObject == Owner || Owner == null,
                "PooledStream::Activate|Owner is not the same as expected."
            );
            try
            {
                if (m_Initalizing)
                {
                    ...
                    Socket socket = ServicePoint.GetConnection(
                        this,
                        owningObject,
                        async,
                        out address,
        ...
        internal virtual void ConnectionCallback(
            object owningObject,
            Exception e,
            Socket socket,
            IPAddress address
        )
        {
            GlobalLog.Assert(
                owningObject == Owner || Owner == null,
                "PooledStream::ConnectionCallback|Owner is not the same as expected."
            );
            object result = null;
            if (e != null)
            {
        ...
        {
            get { return m_NetworkStream.InternalSocket; }
        }
        ...
        {
            get { return m_NetworkStream.CanSeek; }
        }
        ...
        {
            get { return m_NetworkStream.CanWrite; }
        }
        ...
        {
            get { return m_NetworkStream.CanTimeout; }
        }
        ...
        {
            get { return m_NetworkStream.ReadTimeout; }
            set { m_NetworkStream.ReadTimeout = value; }
        }
        ...
        {
            get { return m_NetworkStream.WriteTimeout; }
            set { m_NetworkStream.WriteTimeout = value; }
        }
        ...
        {
            get { return m_NetworkStream.Length; }
        }
        ...
        {
            get { return m_NetworkStream.Position; }
            set { m_NetworkStream.Position = value; }
        }
