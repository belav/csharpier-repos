    ...
    internal static class NclUtilities
    {
        ...
        internal static bool IsThreadPoolLow()
        {
            ...
            GlobalLog.Assert(
                ...
                "completionPortThreads should be zero on the PAL"
            );
        ...
        internal static bool GuessWhetherHostIsLoopback(string host)
        {
            ...
            return hostLower == hostnameLower
                || hostLower == hostnameLower + "." + ip.DomainName.ToLowerInvariant();
#else
            return false;
#endif
        }
        ...
        private static IPAddress[] GetLocalAddresses()
        {
            ...
            GetAdaptersAddressesFlags gaaFlags =
                GetAdaptersAddressesFlags.SkipAnycast
                | GetAdaptersAddressesFlags.SkipMulticast
                | GetAdaptersAddressesFlags.SkipFriendlyName
                | GetAdaptersAddressesFlags.SkipDnsServer;
            uint size = 0;
                    ...
                    if (result == IpHelperErrors.Success)
                    {
                        ...
                        while (nextAdapter != IntPtr.Zero)
                        {
                            IpAdapterAddresses adapterAddresses = (IpAdapterAddresses)
                                Marshal.PtrToStructure(nextAdapter, typeof(IpAdapterAddresses));
...
#pragma warning restore
    ...
    internal class NetworkAddressChangePolled : IDisposable
    {
        ...
        internal unsafe NetworkAddressChangePolled()
        {
            ...
            {
                blocking = -1;
                ipv4Socket = SafeCloseSocketAndEvent.CreateWSASocketWithEvent(
            ...
            {
                blocking = -1;
                ipv6Socket = SafeCloseSocketAndEvent.CreateWSASocketWithEvent(
    ...
    internal static class ComNetOS
    {
        ...
        static ComNetOS()
        {
            ...
            Debug.Assert(
                operatingSystem.Platform != PlatformID.Win32Windows,
            ...
            catch (UnauthorizedAccessException e)
            {
                if (Logging.On)
                    Logging.PrintWarning(
                        Logging.Web,
                        SR.GetString(
                            SR.net_cant_determine_osinstalltype,
                            OSInstallTypeRegKey,
                            e.Message
                        )
                    );
    ...
    {
#if MONO_FEATURE_CAS
        internal static readonly KeyContainerPermission KeyContainerPermissionOpen =
            new KeyContainerPermission(KeyContainerPermissionFlags.Open);
        internal static readonly WebPermission WebPermissionUnrestricted = new WebPermission(
            NetworkAccess.Connect
        );
        internal static readonly SecurityPermission UnmanagedPermission = new SecurityPermission(
            SecurityPermissionFlag.UnmanagedCode
        );
        internal static readonly SocketPermission UnrestrictedSocketPermission =
            new SocketPermission(PermissionState.Unrestricted);
        internal static readonly SecurityPermission InfrastructurePermission =
            new SecurityPermission(SecurityPermissionFlag.Infrastructure);
        internal static readonly SecurityPermission ControlPolicyPermission =
            new SecurityPermission(SecurityPermissionFlag.ControlPolicy);
        internal static readonly SecurityPermission ControlPrincipalPermission =
        ...
        internal static NotImplementedException MethodNotImplementedException
        {
            get
            {
                return new NotImplementedException(
                    SR.GetString(SR.net_MethodNotImplementedException)
                );
            }
        }
        ...
        internal static NotImplementedException PropertyNotImplementedException
        {
            ...
            {
                return new NotImplementedException(
                    SR.GetString(SR.net_PropertyNotImplementedException)
                );
            }
        }
        ...
        internal static NotSupportedException PropertyNotSupportedException
        {
            get
            {
                return new NotSupportedException(
                    SR.GetString(SR.net_PropertyNotSupportedException)
                );
            }
        }
    ...
    internal enum IgnoreCertProblem
    {
        ...
        all_not_time_valid = not_time_valid | ctl_not_time_valid | not_time_nested,
        ...
        all_rev_unknown =
            end_rev_unknown | ctl_signer_rev_unknown | ca_rev_unknown | root_rev_unknown,
        none =
            not_time_valid
            | ctl_not_time_valid
            | not_time_nested
    ...
    internal unsafe struct SSL_EXTRA_CERT_CHAIN_POLICY_PARA
    {
        ...
        static readonly uint StructSize = (uint)
            Marshal.SizeOf(typeof(SSL_EXTRA_CERT_CHAIN_POLICY_PARA));
    }
    ...
    internal unsafe struct CertEnhKeyUse
    {
        ...
        {
            return "cUsageIdentifier="
                + cUsageIdentifier.ToString()
                + " rgpszUsageIdentifier="
                + new IntPtr(rgpszUsageIdentifier).ToString("x");
        }
#endif
    };
    ...
    internal struct SecureCredential
    {
        ...
        */
        ...
        internal void DebugDump()
        {
            ...
            GlobalLog.Print(
                "    certContextArray        = " + String.Format("0x{0:x}", certContextArray)
            );
            ...
            GlobalLog.Print(
                "    palgSupportedAlgs       = " + String.Format("0x{0:x}", palgSupportedAlgs)
            );
            GlobalLog.Print(
                "    grbitEnabledProtocols   = " + String.Format("0x{0:x}", grbitEnabledProtocols)
            );
            ...
            GlobalLog.Print(
                "    dwSessionLifespan       = " + String.Format("0x{0:x}", dwSessionLifespan)
            );
    ...
    */
    ...
    class KnownHttpVerb
    {
        ...
        {
            return this == verb
                || string.Compare(Name, verb.Name, StringComparison.OrdinalIgnoreCase) == 0;
        }
    ...
    internal class PolicyWrapper
    {
        ...
        {
            return fwdPolicy.CheckValidationResult(
                srvPoint,
                Certificate,
                request,
                CertificateProblem
        ...
        internal static uint VerifyChainPolicy(
            SafeFreeCertChain chainContext,
            ref ChainPolicyParameter cpp
        )
        {
            GlobalLog.Enter(
                "PolicyWrapper::VerifyChainPolicy",
                "chainContext="
                    + chainContext
                    + ", options="
                    + String.Format("0x{0:x}", cpp.dwFlags)
            );
...
#if TRAVE
            GlobalLog.Print(
                "PolicyWrapper::VerifyChainPolicy() error code: "
                    + status.dwError
                    + String.Format(" [0x{0:x8}", status.dwError)
                    + " "
                    + SecureChannel.MapSecurityStatus(status.dwError)
                    + "]"
            );
#endif
        ...
        private uint[] GetChainErrors(string hostName, X509Chain chain, ref bool fatalError)
        {
            ...
            unsafe
            {
                ...
                SSL_EXTRA_CERT_CHAIN_POLICY_PARA eppStruct = new SSL_EXTRA_CERT_CHAIN_POLICY_PARA(
                    false
                );
    ...
    internal class SplitWritesState
    {
        ...
        internal BufferOffsetSize[] GetNextBuffers()
        {
            ...
            {
                _RealBuffers[j++] = new BufferOffsetSize(
                    _UserBuffers[curIndex].Buffer,
                    _UserBuffers[curIndex].Offset + firstBufferConsumed,
                    _UserBuffers[curIndex].Size - firstBufferConsumed,
                    false
                );
            ...
            if (lastChunkSize != 0)
            {
                _RealBuffers[j] = new BufferOffsetSize(
                    _UserBuffers[curIndex].Buffer,
                    _UserBuffers[curIndex].Offset + _LastBufferConsumed,
                    lastChunkSize,
                    false
                );
