    ...
    public class HttpRequestCachePolicy : RequestCachePolicy
    {
            ...
            switch (cacheAgeControl)
            {
                ...
                default:
                    throw new ArgumentException(
                        SR.GetString(SR.net_invalid_enum, "HttpCacheAgeControl"),
                        "cacheAgeControl"
                    );
            }
        }
        ...
        public override string ToString()
        {
            return "Level:"
                ...
                + (
                    m_MinFresh == TimeSpan.MinValue
                        ? string.Empty
                        : " MinFresh:" + m_MinFresh.ToString()
                )
                + (
                    m_MaxStale == TimeSpan.MinValue
                        ? string.Empty
                        : " MaxStale:" + m_MaxStale.ToString()
                )
                + (
