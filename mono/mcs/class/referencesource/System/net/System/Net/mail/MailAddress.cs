...
namespace System.Net.Mail
{
    ...
    public class MailAddress
    {
        ...
        internal MailAddress(string displayName, string userName, string domain)
        {
            ...
            Debug.Assert(host != null, "host was null in internal constructor");

            Debug.Assert(userName != null, "userName was null in internal constructor");
        ...
        public MailAddress(string address, string displayName, Encoding displayNameEncoding)
        {
            ...
            if (address == String.Empty)
            {
                throw new ArgumentException(
                    SR.GetString(SR.net_emptystringcall, "address"),
                    "address"
                );
            }

            this.displayNameEncoding =
        ...
        {
            get { return String.Format(CultureInfo.InvariantCulture, "{0}@{1}", userName, host); }
        }
        ...
        {
            get { return String.Format(CultureInfo.InvariantCulture, "<{0}>", Address); }
        }
        ...
        internal string Encode(int charsConsumed, bool allowUnicode)
        {
            ...
            if (!String.IsNullOrEmpty(this.displayName))
            {
                ...
                else
                {
                    ...
                    encoder = encoderFactory.GetEncoderForHeader(
                        this.displayNameEncoding,
                        false,
                        charsConsumed
                    );
