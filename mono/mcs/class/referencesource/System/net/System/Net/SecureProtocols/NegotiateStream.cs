...
namespace System.Net.Security
{
    ...
    public partial class NegotiateStream : AuthenticatedStream
    {
        ...
        ) //this OR LOWER will be ultimate result in auth context
        {
            AuthenticateAsClient(
                credential,
                null,
        ...
        )
        {
            ...
            {
#endif
                _NegoState.ValidateCreateContext(
                    _Package,
                    false,
                    credential,
                    targetName,
        ...
        ) //throw if the result is below than this
        {
            AuthenticateAsServer(
                credential,
                null,
        ...
        )
        {
            ...
            using (GlobalLog.SetThreadKind(ThreadKinds.User | ThreadKinds.Async))
            {
                ...
                BufferAsyncResult bufferResult = new BufferAsyncResult(
                    this,
                    buffer,
                    offset,
                    count,
            ...
            using (GlobalLog.SetThreadKind(ThreadKinds.User))
            {
                ...
                if (bufferResult == null)
                {
                    throw new ArgumentException(
                        SR.GetString(SR.net_io_async_result, asyncResult.GetType().FullName),
                        "asyncResult"
                    );
                }
                ...
                if (bufferResult.Result is Exception)
                {
                    ...
                    throw new IOException(
                        SR.GetString(SR.net_io_read),
                        (Exception)bufferResult.Result
                    );
                }
