...
namespace System.Net.Sockets
{
    ...
    public partial class Socket : IDisposable
    {
...
#if MONO
            int error;
            m_Handle = new SafeSocketHandle(
                Socket_icall(addressFamily, socketType, protocolType, out error),
                true
            );
#else
        ...
        public Socket(SocketInformation socketInformation)
        {
            ...
            if (
                ...
                || socketInformation.ProtocolInformation.Length < protocolInformationSize
            )
            {
                throw new ArgumentException(
                    SR.GetString(SR.net_sockets_invalid_socketinformation),
            ...
            unsafe
            {
                fixed (byte* pinnedBuffer = socketInformation.ProtocolInformation)
                {
                    ...
                    UnsafeNclNativeMethods.OSSOCK.WSAPROTOCOL_INFO protocolInfo =
                        (UnsafeNclNativeMethods.OSSOCK.WSAPROTOCOL_INFO)
            ...
            get
            {
                ...
                GlobalLog.Print(
                    "Socket#"
                        ...
                        + "::Available_get() UnsafeNclNativeMethods.OSSOCK.ioctlsocket returns errorCode:"
                        + errorCode
                );
            ...
            set
            {
                ...
                if (m_BoundToThreadPool)
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.net_io_completionportwasbound)
                    );
                }
#endif
        ...
        public bool IsBound
        {
            get { return (m_RightEndPoint != null); }
        }
#endif // !MONO
        ...
        public bool ExclusiveAddressUse
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.net_sockets_mustnotbebound)
                    );
                }
                SetSocketOption(
                    SocketOptionLevel.Socket,
        ...
        public short Ttl
        {
            get
            {
                ...
                {
                    return (short)
                        (int)GetSocketOption(SocketOptionLevel.IPv6, SocketOptionName.IpTimeToLive);
                }
                else
                {
                    throw new NotSupportedException(SR.GetString(SR.net_invalidversion));
        ...
        internal void InternalBind(EndPoint localEP)
        {
            ...
            GlobalLog.Assert(
                !(localEP is DnsEndPoint),
                "Calling InternalBind with a DnsEndPoint, about to get NotImplementedException"
            );
            ...
            try
            {
                GlobalLog.Print(
                    "Socket#"
                        + ValidationHelper.HashString(this)
                        + "::Bind() SRC:"
                        + ValidationHelper.ToString(LocalEndPoint)
                        + " UnsafeNclNativeMethods.OSSOCK.bind returns errorCode:"
                        + errorCode
                );
            }
            catch (ObjectDisposedException) { }
        ...
        public void Connect(EndPoint remoteEP)
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.net_sockets_disconnectedConnect)
                );
            }
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::Connect() DST:"
                    + ValidationHelper.ToString(remoteEP)
            );
        ...
        public void Connect(IPAddress[] addresses, int port)
        {
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.net_sockets_invalid_ipaddress_length),
                    "addresses"
                );
            }
            if (!ValidationHelper.ValidateTcpPort(port))
        ...
        public void Listen(int backlog)
        {
            ...
            // This may throw ObjectDisposedException.
            SocketError errorCode = UnsafeNclNativeMethods.OSSOCK.listen(m_Handle, backlog);
            ...
            try
            {
                GlobalLog.Print(
                    "Socket#"
                        ...
                        + "::Listen() SRC:"
                        + ValidationHelper.ToString(LocalEndPoint)
                        + " UnsafeNclNativeMethods.OSSOCK.listen returns errorCode:"
                        + errorCode
                );
            }
            catch (ObjectDisposedException) { }
        ...
        public Socket Accept()
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.net_sockets_disconnectedAccept)
                );
            }
        ...
        )
        {
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.net_sockets_zerolist, "buffers"),
                    "buffers"
                );
            }
            ...
            GlobalLog.Print(
                "Socket#"
                    ...
                    + ValidationHelper.ToString(LocalEndPoint)
                    + " DST:"
                    + ValidationHelper.ToString(RemoteEndPoint)
            );
                ...
                try
                {
                    GlobalLog.Print(
                        "Socket#"
                            ...
                            + " DST:"
                            + ValidationHelper.ToString(RemoteEndPoint)
                            + " UnsafeNclNativeMethods.OSSOCK.send returns errorCode:"
                            + errorCode
                            + " bytesTransferred:"
                            + bytesTransferred
                    );
            ...
            if (s_PerfCountersEnabled)
            {
                if (bytesTransferred > 0)
                {
                    NetworkingPerfCounters.Instance.Increment(
                        NetworkingPerfCounterName.SocketBytesSent,
                        bytesTransferred
                    );
                    if (Transport == TransportType.Udp)
                    {
                        NetworkingPerfCounters.Instance.Increment(
                            NetworkingPerfCounterName.SocketDatagramsSent
                        );
                    }
                }
            }
        ...
        )
        {
            ...
            TransmitFileOverlappedAsyncResult asyncResult = new TransmitFileOverlappedAsyncResult(
                this
            );
            ...
            try
            {
                GlobalLog.Print(
                    "Socket#"
                        ...
                        + " DST:"
                        + ValidationHelper.ToString(RemoteEndPoint)
                        + " UnsafeNclNativeMethods.OSSOCK.TransmitFile returns errorCode:"
                        + errorCode
                );
            }
            catch (ObjectDisposedException) { }
        ...
        )
        {
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::Send() UnsafeNclNativeMethods.OSSOCK.send returns:"
        ...
        )
        {
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::SendTo() returning bytesTransferred:"
                    + bytesTransferred.ToString()
            );
            GlobalLog.Dump(buffer, offset, bytesTransferred);
            if (s_LoggingEnabled)
        ...
        )
        {
            ...
            if (s_PerfCountersEnabled)
            {
                ...
                {
                    NetworkingPerfCounters.Instance.Increment(
                        NetworkingPerfCounterName.SocketBytesReceived,
                        bytesTransferred
                    );
                    if (Transport == TransportType.Udp)
                    {
                        NetworkingPerfCounters.Instance.Increment(
                            NetworkingPerfCounterName.SocketDatagramsReceived
                        );
                    }
                }
            }
        ...
        )
        {
            ...
            ReceiveMessageOverlappedAsyncResult asyncResult =
                new ReceiveMessageOverlappedAsyncResult(this, null, null);
        ...
        public int IOControl(int ioControlCode, byte[] optionInValue, byte[] optionOutValue)
        {
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::IOControl() UnsafeNclNativeMethods.OSSOCK.WSAIoctl returns errorCode:"
                    + errorCode
            );
        ...
        )
        {
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::SetSocketOption() UnsafeNclNativeMethods.OSSOCK.setsockopt returns errorCode:"
                    + errorCode
            );
        ...
        )
        {
            ...
            if (optionLevel == SocketOptionLevel.Socket && optionName == SocketOptionName.Linger)
            {
                ...
                {
                    throw new ArgumentException(
                        SR.GetString(SR.net_sockets_invalid_optionValue, "LingerOption"),
                        "optionValue"
                    );
                }
            ...
            )
            {
                ...
                {
                    throw new ArgumentException(
                        SR.GetString(SR.net_sockets_invalid_optionValue, "MulticastOption"),
                        "optionValue"
                    );
                }
            ...
            )
            {
                ...
                {
                    throw new ArgumentException(
                        SR.GetString(SR.net_sockets_invalid_optionValue, "IPv6MulticastOption"),
                        "optionValue"
                    );
                }
        ...
        public object GetSocketOption(SocketOptionLevel optionLevel, SocketOptionName optionName)
        {
            ...
            else
            {
                ...
                GlobalLog.Print(
                    "Socket#"
                        + ValidationHelper.HashString(this)
                        + "::GetSocketOption() UnsafeNclNativeMethods.OSSOCK.getsockopt returns errorCode:"
                        + errorCode
                );
        ...
        public bool Poll(int microSeconds, SelectMode mode)
        {
            ...
            if (microSeconds != -1)
            {
                ...
                socketCount = UnsafeNclNativeMethods.OSSOCK.select(
                    0,
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::Poll() UnsafeNclNativeMethods.OSSOCK.select returns socketCount:"
                    + socketCount
            );
        ...
        )
        {
            ...
            if (checkRead != null && checkRead.Count > MaxSelect)
            {
                throw new ArgumentOutOfRangeException(
                    ...
                    SR.GetString(
                        ...
                        "checkRead",
                        MaxSelect.ToString(NumberFormatInfo.CurrentInfo)
                    )
                );
            }
            ...
            GlobalLog.Print(
                "Socket::Select() UnsafeNclNativeMethods.OSSOCK.select returns socketCount:"
                    + socketCount
            );
        ...
        public IAsyncResult BeginConnect(EndPoint remoteEP, AsyncCallback callback, object state)
        {
            ...
            ConnectAsyncResult asyncResult = new ConnectAsyncResult(
                this,
                endPointSnapshot,
                state,
                callback
            ...
            unsafe
            {
                fixed (byte* pinnedBuffer = info.ProtocolInformation)
                {
                    errorCode = (SocketError)
                        UnsafeNclNativeMethods.OSSOCK.WSADuplicateSocket(
                            m_Handle,
        ...
        )
        {
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::DoBeginConnect() endPointSnapshot:"
                    + endPointSnapshot.ToString()
            );
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.net_sockets_no_duplicate_async)
                );
            }
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::DoBeginConnect() UnsafeNclNativeMethods.OSSOCK.WSAConnect returns errorCode:"
                    + errorCode
            );
        ...
        private bool CanUseConnectEx(EndPoint remoteEP)
        {
            ...
            return socketType == SocketType.Stream
                ...
                && (
                    ...
                    || SettingsSectionInternal.Section.AlwaysUseCompletionPortsForConnect
                    || m_IsDisconnected
                );
#else
            return false;
        ...
        private void ConnectCallback()
        {
            ...
            if (asyncResult.InternalPeekCompleted)
            {
                GlobalLog.Assert(
                    CleanedUp,
                    "Socket#{0}::ConnectCallback()|asyncResult is compelted but the socket does not have CleanedUp set.",
                    ValidationHelper.HashString(this)
                );
                GlobalLog.Leave(
                    "Socket#" + ValidationHelper.HashString(this) + "::ConnectCallback",
                    "Already completed, socket must be closed"
                );
                return;
            }
            ...
            */
                    ...
                    try
                    {
                        ...
                        if (errorCode != SocketError.Success)
                        {
                            ...
                            GlobalLog.Print(
                                "Socket#"
                                    + ValidationHelper.HashString(this)
                                    + "::ConnectCallback() WSAEnumNetworkEvents() failed with errorCode:"
                                    + errorCode.ToString()
                            );
                        }
                        else
                        {
                            ...
                            GlobalLog.Print(
                                "Socket#"
                                    + ValidationHelper.HashString(this)
                                    + "::ConnectCallback() ErrorCodes(FdConnect) got errorCode:"
                                    + errorCode.ToString()
                            );
                        }
                        //
            ...
            catch (Exception exception)
            {
                ...
                GlobalLog.Print(
                    "Socket#"
                        + ValidationHelper.HashString(this)
                        + "::ConnectCallback() caught exception:"
                        + exception.Message
                        + ", CleanedUp:"
                        + CleanedUp
                );
        ...
        )
        {
            ...
            MultipleAddressConnectAsyncResult result = new MultipleAddressConnectAsyncResult(
                null,
                port,
                this,
                state,
            ...
            IAsyncResult dnsResult = Dns.UnsafeBeginGetHostAddresses(
                host,
        ...
        )
        {
            ...
            IAsyncResult result = BeginConnect(
        ...
        )
        {
            ...
            GlobalLog.Print(
                "Socket#" + ValidationHelper.HashString(this) + "::DoBeginDisconnect() "
            );
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::DoBeginDisconnect() UnsafeNclNativeMethods.OSSOCK.DisConnectEx returns:"
                    + errorCode.ToString()
            );
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::DoBeginDisconnect() returning AsyncResult:"
                    + ValidationHelper.HashString(asyncResult)
            );
            if (s_LoggingEnabled)
        ...
        public void Disconnect(bool reuseSocket)
        {
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::Disconnect() UnsafeNclNativeMethods.OSSOCK.DisConnectEx returns:"
                    + errorCode.ToString()
            );
        ...
        public void EndConnect(IAsyncResult asyncResult)
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.net_io_invalidendcall, "EndConnect")
                );
            }
            ...
            if (castedAsyncResult.Result is Exception)
            {
                if (s_LoggingEnabled)
                    Logging.Exception(
                        ...
                        this,
                        "EndConnect",
                        (Exception)castedAsyncResult.Result
                    );
            ...
            if (s_LoggingEnabled)
            {
                Logging.PrintInfo(
                    Logging.Sockets,
                    this,
                    SR.GetString(SR.net_log_socket_connected, LocalEndPoint, RemoteEndPoint)
                );
        ...
        public void EndDisconnect(IAsyncResult asyncResult)
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.net_io_invalidendcall, "EndDisconnect")
                );
            }
        ...
        private SocketError DoBeginSend(
            byte[] buffer,
            int offset,
            int size,
            SocketFlags socketFlags,
        ...
        )
        {
            ...
            try
            {
                ...
                asyncResult.SetUnmanagedStructures(
                    ...
                    ,
                    ref Caches.SendOverlappedCache
                );
                ...
                GlobalLog.Print(
                    "Socket#"
                        + ValidationHelper.HashString(this)
                        + "::BeginSend() UnsafeNclNativeMethods.OSSOCK.WSASend returns:"
                        + errorCode.ToString()
                        + " size:"
                        + size.ToString()
                        + " returning AsyncResult:"
        ...
        )
        {
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::DoBeginSendFile() UnsafeNclNativeMethods.OSSOCK.send returns:"
                    + errorCode.ToString()
            );
        ...
        )
        {
            ...
            try
            {
                ...
                GlobalLog.Print(
                    "BeginSend: asyncResult:" + ValidationHelper.HashString(asyncResult)
                );
        ...
        public void EndSendFile(IAsyncResult asyncResult)
        {
            ...
            TransmitFileOverlappedAsyncResult castedAsyncResult =
                asyncResult as TransmitFileOverlappedAsyncResult;
            if (castedAsyncResult == null || castedAsyncResult.AsyncObject != this)
            {
                throw new ArgumentException(
                    SR.GetString(SR.net_io_invalidasyncresult),
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.net_io_invalidendcall, "EndSendFile")
                );
            }
        ...
        )
        {
            ...
            try
            {
                ...
                GlobalLog.Print(
                    "Socket#"
                        + ValidationHelper.HashString(this)
                        + "::DoBeginSendTo() UnsafeNclNativeMethods.OSSOCK.WSASend returns:"
                        + errorCode.ToString()
                        + " size:"
                        + size
                        + " returning AsyncResult:"
        ...
        public int EndSendTo(IAsyncResult asyncResult)
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.net_io_invalidendcall, "EndSendTo")
                );
            }
        ...
        private SocketError DoBeginReceive(
            byte[] buffer,
            int offset,
            int size,
            SocketFlags socketFlags,
        ...
        )
        {
            ...
            try
            {
                ...
                if (errorCode != SocketError.Success)
                {
                    ...
                    GlobalLog.Assert(
                        errorCode != SocketError.Success,
                        "Socket#{0}::DoBeginReceive()|GetLastWin32Error() returned zero.",
                        ValidationHelper.HashString(this)
                    );
                }
                GlobalLog.Print(
                    "Socket#"
                        + ValidationHelper.HashString(this)
                        + "::BeginReceive() UnsafeNclNativeMethods.OSSOCK.WSARecv returns:"
                        + errorCode.ToString()
                        + " bytesTransferred:"
                        + bytesTransferred.ToString()
                        + " returning AsyncResult:"
        ...
        )
        {
            ...
            try
            {
                ...
                GlobalLog.Print(
                    "Socket#"
                        + ValidationHelper.HashString(this)
                        + "::DoBeginReceive() UnsafeNclNativeMethods.OSSOCK.WSARecv returns:"
                        + errorCode.ToString()
                        + " returning AsyncResult:"
                        + ValidationHelper.HashString(asyncResult)
                );
        ...
        public int EndReceive(IAsyncResult asyncResult, out SocketError errorCode)
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.net_io_invalidendcall, "EndReceive")
                );
            }
        ...
        )
        {
            ...
            try
            {
                ...
                if (errorCode != SocketError.Success)
                {
                    ...
                    if (errorCode == SocketError.MessageSize)
                    {
                        GlobalLog.Assert(
                            "Socket#"
                                + ValidationHelper.HashString(this)
                                + "::BeginReceiveMessageFrom()|Returned WSAEMSGSIZE!"
                        );
                ...
                GlobalLog.Print(
                    "Socket#"
                        + ValidationHelper.HashString(this)
                        + "::BeginReceiveMessageFrom() UnsafeNclNativeMethods.OSSOCK.WSARecvMsg returns:"
                        + errorCode.ToString()
                        + " size:"
                        + size.ToString()
                        + " returning AsyncResult:"
        ...
        )
        {
            ...
            ReceiveMessageOverlappedAsyncResult castedAsyncResult =
                asyncResult as ReceiveMessageOverlappedAsyncResult;
            if (castedAsyncResult == null || castedAsyncResult.AsyncObject != this)
            {
                throw new ArgumentException(
                    SR.GetString(SR.net_io_invalidasyncresult),
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.net_io_invalidendcall, "EndReceiveMessageFrom")
                );
            }
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::EndReceiveMessageFrom() bytesTransferred:"
                    + bytesTransferred.ToString()
            );
            ...
            //
            if (
                (SocketError)castedAsyncResult.ErrorCode != SocketError.Success
                && (SocketError)castedAsyncResult.ErrorCode != SocketError.MessageSize
            )
            {
                //
                // update our internal state after this socket error and throw
        ...
        private void DoBeginReceiveFrom(
            byte[] buffer,
            int offset,
            int size,
            SocketFlags socketFlags,
        ...
        )
        {
            ...
            try
            {
                ...
                GlobalLog.Print(
                    "Socket#"
                        + ValidationHelper.HashString(this)
                        + "::DoBeginReceiveFrom() UnsafeNclNativeMethods.OSSOCK.WSARecvFrom returns:"
                        + errorCode.ToString()
                        + " size:"
                        + size.ToString()
                        + " returning AsyncResult:"
        ...
        public int EndReceiveFrom(IAsyncResult asyncResult, ref EndPoint endPoint)
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.net_io_invalidendcall, "EndReceiveFrom")
                );
            }
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::EndReceiveFrom() bytesTransferred:"
                    + bytesTransferred.ToString()
            );
        ...
        private void DoBeginAccept(LazyAsyncResult asyncResult)
        {
            ...
            lock (this)
            {
                if (acceptQueue.Count == 0)
                {
                    ...
                    GlobalLog.Print(
                        "Socket#"
                            + ValidationHelper.HashString(this)
                            + "::BeginAccept() queue is empty calling UnsafeNclNativeMethods.OSSOCK.accept"
                    );
                    ...
                    GlobalLog.Print(
                        "Socket#"
                            + ValidationHelper.HashString(this)
                            + "::BeginAccept() UnsafeNclNativeMethods.OSSOCK.accept returns:"
                            + errorCode.ToString()
                    );
                    ...
                    if (errorCode != SocketError.WouldBlock)
                    {
                        if (errorCode == SocketError.Success)
                        {
                            asyncResult.Result = CreateAcceptSocket(
                                acceptedSocketHandle,
                                m_RightEndPoint.Create(socketAddress),
                                false
                            );
                ...
                else
                {
                    ...
                    GlobalLog.Print(
                        "Socket#"
                            + ValidationHelper.HashString(this)
                            + "::DoBeginAccept() queue is not empty Count:"
                            + acceptQueue.Count.ToString()
                    );
                }
            }
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::DoBeginAccept() returning AsyncResult:"
                    + ValidationHelper.HashString(asyncResult)
            );
        }
                ...
                catch
                {
                    ...
                    if (acceptNeeded)
                        ThreadPool.UnsafeQueueUserWorkItem(
                            new WaitCallback(CompleteAcceptResults),
                            null
                        );
                ...
                lock (this)
                {
                    ...
                    if (!CleanedUp)
                    {
                        ...
                        try
                        {
                            ...
                            GlobalLog.Assert(
                                !willBlockInternal,
                                "Socket#{0}::AcceptCallback|Socket should be in non-blocking state.",
                                ValidationHelper.HashString(this)
                            );
                            ...
                            GlobalLog.Print(
                                "Socket#"
                                    + ValidationHelper.HashString(this)
                                    + "::AcceptCallback() UnsafeNclNativeMethods.OSSOCK.accept returns:"
                                    + errorCode.ToString()
                            );
                        }
                        catch (ObjectDisposedException)
                        ...
                        catch (Exception exception)
                        {
                            ...
                            GlobalLog.Print(
                                "Socket#"
                                    + ValidationHelper.HashString(this)
                                    + "::AcceptCallback() caught exception:"
                                    + exception.Message
                                    + " CleanedUp:"
                                    + CleanedUp
                            );
        ...
        private bool CanUseAcceptEx
        {
            get
            {
                return (
                    Thread.CurrentThread.IsThreadPoolThread
                    || SettingsSectionInternal.Section.AlwaysUseCompletionPortsForAccept
                    || m_IsDisconnected
                );
            }
        }
        ...
        )
        {
            ...
            else
            {
                ...
                {
                    throw new InvalidOperationException(
                        SR.GetString(SR.net_sockets_namedmustnotbebound, "acceptSocket")
                    );
                }
            }
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::DoBeginAccept() AcceptSocket:"
                    + ValidationHelper.HashString(acceptSocket)
            );
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::DoBeginAccept() UnsafeNclNativeMethods.OSSOCK.AcceptEx returns:"
                    + errorCode.ToString()
                    + ValidationHelper.HashString(asyncResult)
            );
        ...
        public Socket EndAccept(IAsyncResult asyncResult)
        {
            ...
            {
                throw new InvalidOperationException(
                    SR.GetString(SR.net_io_invalidendcall, "EndAccept")
                );
            }
            ...
            try
            {
                GlobalLog.Print(
                    "Socket#"
                        ...
                        + ValidationHelper.ToString(LocalEndPoint)
                        + " acceptedSocket:"
                        + ValidationHelper.HashString(socket)
                        + " acceptedSocket.SRC:"
                        + ValidationHelper.ToString(socket.LocalEndPoint)
                        + " acceptedSocket.DST:"
                        + ValidationHelper.ToString(socket.RemoteEndPoint)
                        + " bytesTransferred:"
                        + bytesTransferred.ToString()
                );
            }
        ...
        public void Shutdown(SocketShutdown how)
        {
            ...
            GlobalLog.Print(
                "Socket#" + ValidationHelper.HashString(this) + "::Shutdown() how:" + how.ToString()
            );
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::Shutdown() UnsafeNclNativeMethods.OSSOCK.shutdown returns errorCode:"
                    + errorCode
            );
        ...
        private void EnsureDynamicWinsockMethods()
        {
            ...
            {
                m_DynamicWinsockMethods = DynamicWinsockMethods.GetMethods(
                    addressFamily,
                    socketType,
                    protocolType
                );
        ...
        )
        {
            ...
            AcceptExDelegate acceptEx = m_DynamicWinsockMethods.GetDelegate<AcceptExDelegate>(
                listenSocketHandle
            );
        ...
        {
            EnsureDynamicWinsockMethods();
            GetAcceptExSockaddrsDelegate getAcceptExSockaddrs =
                m_DynamicWinsockMethods.GetDelegate<GetAcceptExSockaddrsDelegate>(m_Handle);
        ...
        {
            EnsureDynamicWinsockMethods();
            DisconnectExDelegate disconnectEx =
                m_DynamicWinsockMethods.GetDelegate<DisconnectExDelegate>(socketHandle);

            return disconnectEx(socketHandle, overlapped, flags, reserved);
        }

        private bool DisconnectEx_Blocking(
            IntPtr socketHandle,
            IntPtr overlapped,
            int flags,
            int reserved
        ...
        {
            EnsureDynamicWinsockMethods();
            DisconnectExDelegate_Blocking disconnectEx_Blocking =
                m_DynamicWinsockMethods.GetDelegate<DisconnectExDelegate_Blocking>(m_Handle);
        ...
        {
            EnsureDynamicWinsockMethods();
            ConnectExDelegate connectEx = m_DynamicWinsockMethods.GetDelegate<ConnectExDelegate>(
                socketHandle
            );
        ...
        {
            EnsureDynamicWinsockMethods();
            WSARecvMsgDelegate recvMsg = m_DynamicWinsockMethods.GetDelegate<WSARecvMsgDelegate>(
                socketHandle
            );
        ...
        private SocketError WSARecvMsg_Blocking(
            IntPtr socketHandle,
            IntPtr msg,
            out int bytesTransferred,
            IntPtr overlapped,
        ...
        {
            EnsureDynamicWinsockMethods();
            WSARecvMsgDelegate_Blocking recvMsg_Blocking =
                m_DynamicWinsockMethods.GetDelegate<WSARecvMsgDelegate_Blocking>(m_Handle);

            return recvMsg_Blocking(
                socketHandle,
                msg,
                out bytesTransferred,
                overlapped,
        ...
        {
            EnsureDynamicWinsockMethods();
            TransmitPacketsDelegate transmitPackets =
                m_DynamicWinsockMethods.GetDelegate<TransmitPacketsDelegate>(socketHandle);
        ...
        internal TransportType Transport
        {
            get
            {
                return protocolType == Sockets.ProtocolType.Tcp ? TransportType.Tcp
                    : protocolType == Sockets.ProtocolType.Udp ? TransportType.Udp
                    : TransportType.All;
            }
        }
        ...
        )
        {
            ...
            if (
                ...
                !(optionLevel == SocketOptionLevel.IPv6 && optionName == (SocketOptionName)23)
            )
            {
                ExceptionHelper.UnmanagedPermission.Demand();
            }
        ...
        private SocketAddress CallSerializeCheckDnsEndPoint(EndPoint remoteEP)
        {
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.net_sockets_invalid_dnsendpoint, "remoteEP"),
                    "remoteEP"
                );
            }
            ...
            if (!s_Initialized)
            {
                lock (InternalSyncObject)
                {
                    if (!s_Initialized)
                    {
                        ...
                        SocketError errorCode = UnsafeNclNativeMethods.OSSOCK.WSAStartup(
...
#if DEBUG
                        BooleanSwitch disableCompletionPortSwitch = new BooleanSwitch(
                            "DisableNetCompletionPort",
                            "System.Net disabling of Completion Port"
                        );
...
#if MONO
                        ipv4 = IsProtocolSupported(
                            System.Net.NetworkInformation.NetworkInterfaceComponent.IPv4
                        );
                        ipv6 = IsProtocolSupported(
            ...
            try
            {
                GlobalLog.Print(
                    "Socket#"
                        ...
                        + " DST:"
                        + ValidationHelper.ToString(RemoteEndPoint)
                        + " UnsafeNclNativeMethods.OSSOCK.WSAConnect returns errorCode:"
                        + errorCode
                );
            }
            catch (ObjectDisposedException) { }
        ...
        protected virtual void Dispose(bool disposing)
        {
            ...
            try
            {
                GlobalLog.Print(
                    "Socket#"
                        + ValidationHelper.HashString(this)
                        + "::Dispose() disposing:true CleanedUp:"
                        + CleanedUp.ToString()
                );
                if (s_LoggingEnabled)
            ...
            if (m_BlockEventBits != AsyncEventBits.FdNone)
            {
                GlobalLog.Print(
                    "Socket#"
                        + ValidationHelper.HashString(this)
                        + "::Dispose() Pending nonblocking operations!  m_BlockEventBits:"
                        + m_BlockEventBits.ToString()
                );
                UnsetAsyncEventSelect();
...
#if SOCKETTHREADPOOL
            if (m_BoundToThreadPool)
                SocketThreadPool.UnBindHandle(m_Handle);
#endif
            ...
            try
            {
                ...
                if (timeout == 0)
                {
                    ...
                    GlobalLog.Print(
                        "Socket#"
                            + ValidationHelper.HashString(this)
                            + "::Dispose() Calling m_Handle.Dispose()"
                    );
                    m_Handle.Dispose();
                }
                else
                {
                    ...
                    if (!willBlock || !willBlockInternal)
                    {
                        ...
                        GlobalLog.Print(
                            "SafeCloseSocket::Dispose(handle:"
                                + m_Handle.DangerousGetHandle().ToString("x")
                                + ") ioctlsocket(FIONBIO):"
                                + (
                                    errorCode == SocketError.SocketError
                                        ? (SocketError)Marshal.GetLastWin32Error()
                    ...
                    if (timeout < 0)
                    {
                        ...
                        GlobalLog.Print(
                            "Socket#"
                                + ValidationHelper.HashString(this)
                                + "::Dispose() Calling m_Handle.CloseAsIs()"
                        );
                        m_Handle.CloseAsIs();
                    }
                    else
            ...
            catch (ObjectDisposedException)
            {
                GlobalLog.Assert(
                    "SafeCloseSocket::Dispose(handle:"
                        + m_Handle.DangerousGetHandle().ToString("x")
                        + ")",
                    "Closing the handle threw ObjectDisposedException."
                );
            }
            ...
            if (pendingAsync == AsyncEventBits.FdConnect)
            {
                GlobalLog.Print(
                    "Socket#"
                        + ValidationHelper.HashString(this)
                        + "::Dispose() QueueUserWorkItem for ConnectCallback"
                );
                // This will try to complete connectResult on a different thread
                ThreadPool.UnsafeQueueUserWorkItem(
                    new WaitCallback(
                        ((LazyAsyncResult)m_AcceptQueueOrConnectResult).InvokeCallback
                    ),
                    new SocketException(SocketError.OperationAborted)
                );
            }
            else if (pendingAsync == AsyncEventBits.FdAccept)
            {
                ...
                GlobalLog.Print(
                    "Socket#"
                        + ValidationHelper.HashString(this)
                        + "::Dispose() QueueUserWorkItem for AcceptCallback"
                );
        ...
        )
        {
            ...
            if (silent && (CleanedUp || m_Handle.IsInvalid))
            {
                GlobalLog.Print(
                    "Socket#"
                        + ValidationHelper.HashString(this)
                        + "::SetSocketOption() skipping the call"
                );
                return;
            }
            SocketError errorCode = SocketError.Success;
        ...
        private void setMulticastOption(SocketOptionName optionName, MulticastOption MR)
        {
            ...
            GlobalLog.Print(
                "Socket#"
                    ...
                    + IPMulticastRequest.Size.ToString()
            );
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::setMulticastOption() UnsafeNclNativeMethods.OSSOCK.setsockopt returns errorCode:"
                    + errorCode
            );
        ...
        private void setIPv6MulticastOption(SocketOptionName optionName, IPv6MulticastOption MR)
        {
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::setIPv6MulticastOption(): optionName:"
                    + optionName.ToString()
                    + " MR:"
                    + MR.ToString()
                    + " ipmr:"
                    ...
                    + IPv6MulticastRequest.Size.ToString()
            );
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::setIPv6MulticastOption() UnsafeNclNativeMethods.OSSOCK.setsockopt returns errorCode:"
                    + errorCode
            );
        ...
        private void setLingerOption(LingerOption lref)
        {
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::setLingerOption() UnsafeNclNativeMethods.OSSOCK.setsockopt returns errorCode:"
                    + errorCode
            );
        ...
        private LingerOption getLingerOpt()
        {
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::getLingerOpt() UnsafeNclNativeMethods.OSSOCK.getsockopt returns errorCode:"
                    + errorCode
            );
        ...
        private MulticastOption getMulticastOpt(SocketOptionName optionName)
        {
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::getMulticastOpt() UnsafeNclNativeMethods.OSSOCK.getsockopt returns errorCode:"
                    + errorCode
            );
        ...
        private IPv6MulticastOption getIPv6MulticastOpt(SocketOptionName optionName)
        {
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::getIPv6MulticastOpt() UnsafeNclNativeMethods.OSSOCK.getsockopt returns errorCode:"
                    + errorCode
            );
            ...
            IPv6MulticastOption multicastOption = new IPv6MulticastOption(
        ...
        {
            GlobalLog.Enter(
                "Socket#" + ValidationHelper.HashString(this) + "::InternalSetBlocking",
                "desired:"
                    + desired.ToString()
                    + " willBlock:"
                    + willBlock.ToString()
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::InternalSetBlocking() UnsafeNclNativeMethods.OSSOCK.ioctlsocket returns errorCode:"
                    + errorCode
            );
        ...
        private static IntPtr[] SocketListToFileDescriptorSet(IList socketList)
        {
            ...
            for (int current = 0; current < socketList.Count; current++)
            {
                ...
                fileDescriptorSet[current + 1] = (
                    (Socket)socketList[current]
                ).m_Handle.DangerousGetHandle();
            }
            ...
            lock (socketList)
            {
                for (int currentSocket = 0; currentSocket < socketList.Count; currentSocket++)
                {
                    ...
                    for (
                        ...
                        currentFileDescriptor < (int)fileDescriptorSet[0];
                        currentFileDescriptor++
                    )
                    {
                        if (
                            fileDescriptorSet[currentFileDescriptor + 1]
                            == socket.m_Handle.DangerousGetHandle()
                        )
                        {
                            break;
                        }
        ...
        )
        {
            ...
            // This will check the permissions for connect.
            EndPoint endPointSnapshot = remoteEP;
            SocketAddress socketAddress = flowContext
                ? CheckCacheRemote(ref endPointSnapshot, true)
                : SnapshotAndSerialize(ref endPointSnapshot);
            ...
            {
                GlobalLog.Assert(
                    endPointSnapshot.GetType() == typeof(IPEndPoint),
                    "Socket#{0}::BeginConnectEx()|Socket not bound and endpoint not IPEndPoint.",
                    ValidationHelper.HashString(this)
                );
            ...
            // thread pool.
            //
            ConnectOverlappedAsyncResult asyncResult = new ConnectOverlappedAsyncResult(
                this,
                endPointSnapshot,
                state,
                callback
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::BeginConnectEx() UnsafeNclNativeMethods.OSSOCK.connect returns:"
                    + errorCode.ToString()
            );
        ...
        internal void MultipleSend(BufferOffsetSize[] buffers, SocketFlags socketFlags)
        {
            ...
            GlobalLog.Assert(
                buffers != null,
                "Socket#{0}::MultipleSend()|buffers == null",
                ValidationHelper.HashString(this)
            );
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::MultipleSend() buffers.Length:"
                    + buffers.Length.ToString()
            );
            ...
            try
            {
                ...
                GlobalLog.Print(
                    "Socket#"
                        + ValidationHelper.HashString(this)
                        + "::MultipleSend() UnsafeNclNativeMethods.OSSOCK.WSASend returns:"
                        + errorCode.ToString()
                        + " size:"
                        + buffers.Length.ToString()
                );
        ...
        private static void DnsCallback(IAsyncResult result)
        {
            ...
            MultipleAddressConnectAsyncResult context = (MultipleAddressConnectAsyncResult)
                result.AsyncState;
            try
            {
        ...
        private static bool DoDnsCallback(
            IAsyncResult result,
            MultipleAddressConnectAsyncResult context
        )
        {
        ...
        {
            internal MultipleAddressConnectAsyncResult(
                IPAddress[] addresses,
                int port,
                Socket socket,
                object myState,
        ...
        private static object PostOneBeginConnect(MultipleAddressConnectAsyncResult context)
        {
            ...
            {
                return context.lastException != null
                    ? context.lastException
                    : new ArgumentException(SR.GetString(SR.net_invalidAddressList), "context");
            }
            ...
            try
            {
                ...
                IAsyncResult connectResult = context.socket.UnsafeBeginConnect(
                    endPoint,
        ...
        private static bool DoMultipleAddressConnectCallback(
            object result,
            MultipleAddressConnectAsyncResult context
        )
        {
        ...
        )
        {
            ...
            GlobalLog.Assert(
                buffers != null,
                "Socket#{0}::DoBeginMultipleSend()|buffers == null",
                ValidationHelper.HashString(this)
            );
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::DoBeginMultipleSend() buffers.Length:"
                    + buffers.Length.ToString()
            );
            ...
            try
            {
                ...
                GlobalLog.Print(
                    "Socket#"
                        + ValidationHelper.HashString(this)
                        + "::BeginMultipleSend() UnsafeNclNativeMethods.OSSOCK.WSASend returns:"
                        + errorCode.ToString()
                        + " size:"
                        + buffers.Length.ToString()
                        + " returning AsyncResult:"
        ...
        internal int EndMultipleSend(IAsyncResult asyncResult)
        {
            ...
            GlobalLog.Assert(
                asyncResult != null,
                "Socket#{0}::EndMultipleSend()|asyncResult == null",
                ValidationHelper.HashString(this)
            );
            ...
            GlobalLog.Assert(
                ...
                "Socket#{0}::EndMultipleSend()|castedAsyncResult == null",
                ValidationHelper.HashString(this)
            );
            GlobalLog.Assert(
                castedAsyncResult.AsyncObject == this,
                "Socket#{0}::EndMultipleSend()|castedAsyncResult.AsyncObject != this",
                ValidationHelper.HashString(this)
            );
            GlobalLog.Assert(
                !castedAsyncResult.EndCalled,
                "Socket#{0}::EndMultipleSend()|castedAsyncResult.EndCalled",
                ValidationHelper.HashString(this)
            );
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::EndMultipleSend() bytesTransferred:"
                    + bytesTransferred.ToString()
            );
        ...
        internal void SetToConnected()
        {
            ...
            GlobalLog.Print(
                "Socket#"
                    + ValidationHelper.HashString(this)
                    + "::SetToConnected() now connected SRC:"
                    + ValidationHelper.ToString(LocalEndPoint)
                    + " DST:"
                    + ValidationHelper.ToString(RemoteEndPoint)
            );
            ...
            {
                NetworkingPerfCounters.Instance.Increment(
                    NetworkingPerfCounterName.SocketConnectionsEstablished
                );
            }
#endif //!FEATURE_PAL
        }
        ...
        {
            GlobalLog.Print(
                "Socket#" + ValidationHelper.HashString(this) + "::SetToDisconnected()"
            );
            if (!m_IsConnected)
            {
                //
        ...
        internal void UpdateStatusAfterSocketError(SocketError errorCode)
        {
            ...
            )
            {
                ...
                GlobalLog.Print(
                    "Socket#"
                        + ValidationHelper.HashString(this)
                        + "::UpdateStatusAfterSocketError(socketException) Invalidating socket."
                );
                SetToDisconnected();
            }
        }
        ...
        {
            GlobalLog.Enter(
                "Socket#" + ValidationHelper.HashString(this) + "::UnsetAsyncEventSelect",
                "m_BlockEventBits:"
                    + m_BlockEventBits.ToString()
                    + " willBlockInternal:"
                    + willBlockInternal.ToString()
            ...
            catch (Exception e)
            {
                ...
                GlobalLog.Print(
                    "Socket#"
                        + ValidationHelper.HashString(this)
                        + "::UnsetAsyncEventSelect() !!! (ignoring) Exception: "
                        + e.ToString()
                );
                GlobalLog.Assert(
                    CleanedUp,
                    "Socket#{0}::UnsetAsyncEventSelect|Got exception and CleanedUp not set.",
                    ValidationHelper.HashString(this)
                );
            }
        ...
        {
            GlobalLog.Enter(
                "Socket#" + ValidationHelper.HashString(this) + "::SetAsyncEventSelect",
                "blockEventBits:"
                    + blockEventBits.ToString()
                    + " m_BlockEventBits:"
                    + m_BlockEventBits.ToString()
                    + " willBlockInternal:"
                    + willBlockInternal.ToString()
            ...
            GlobalLog.Assert(
                blockEventBits != AsyncEventBits.FdNone,
                "Socket#{0}::SetAsyncEventSelect|Use UnsetAsyncEventSelect for FdNone.",
                ValidationHelper.HashString(this)
            );
            GlobalLog.Assert(
                m_BlockEventBits == AsyncEventBits.FdNone || m_BlockEventBits == blockEventBits,
                "Socket#{0}::SetAsyncEventSelect|Can't change from one active wait to another.",
                ValidationHelper.HashString(this)
            );
            GlobalLog.Assert(
                m_RegisteredWait == null,
                "Socket#{0}::SetAsyncEventSelect|Already actively waiting on an op.",
                ValidationHelper.HashString(this)
            );
            ...
            if (Interlocked.CompareExchange(ref m_IntCleanedUp, 2, 0) != 0)
            {
                GlobalLog.Leave(
                    "Socket#"
                        + ValidationHelper.HashString(this)
                        + "::SetAsyncEventSelect() Already Cleaned up, returning ... ",
                    string.Empty
                );
                return false;
            }
            ...
            try
            {
                ...
                m_RegisteredWait = ThreadPool.UnsafeRegisterWaitForSingleObject(
                    m_AsyncEvent,
                    s_RegisteredWaitCallback,
                    this,
                    Timeout.Infinite,
                    true
                );
            ...
            catch (Exception e)
            {
                ...
                GlobalLog.Print(
                    "Socket#"
                        + ValidationHelper.HashString(this)
                        + "::SetAsyncEventSelect() !!! (converting to ObjectDisposed) Exception :"
                        + e.ToString()
                );
                GlobalLog.Assert(
                    CleanedUp,
                    "Socket#{0}::SetAsyncEventSelect|WSAEventSelect got exception and CleanedUp not set.",
                    ValidationHelper.HashString(this)
                );
            }
        ...
        {
            GlobalLog.Enter(
                "Socket#" + ValidationHelper.HashString(state) + "::RegisteredWaitCallback",
                "m_BlockEventBits:" + ((Socket)state).m_BlockEventBits.ToString()
            );
#if DEBUG
                ...
                lock (this)
                {
                    if (!m_BoundToThreadPool)
                    {
                        ...
                        GlobalLog.Print(
                            "Socket#"
                                + ValidationHelper.HashString(this)
                                + "::BindToCompletionPort() calling SocketThreadPool.BindHandle()"
                        );
                        ...
                        GlobalLog.Print(
                            "Socket#"
                                + ValidationHelper.HashString(this)
                                + "::BindToCompletionPort() calling ThreadPool.BindHandle()"
                        );
        ...
        public bool AcceptAsync(SocketAsyncEventArgs e)
        {
            ...
            {
                throw new ArgumentException(
                    SR.GetString(SR.net_multibuffernotsupported),
                    "BufferList"
                );
            }
            ...
            try
            {
                if (
                    !AcceptEx(
                        ...
                        (e.m_PtrSingleBuffer != IntPtr.Zero)
                            ? e.m_PtrSingleBuffer
                            : e.m_PtrAcceptBuffer,
                        (e.m_PtrSingleBuffer != IntPtr.Zero)
                            ? e.Count - e.m_AcceptAddressBufferCount
                            : 0,
        ...
        public bool ConnectAsync(SocketAsyncEventArgs e)
        {
            ...
            if (dnsEP != null)
            {
                if (s_LoggingEnabled)
                    Logging.PrintInfo(
                        ...
                        "Socket#"
                            + ValidationHelper.HashString(this)
                            + "::ConnectAsync "
                            + SR.GetString(SR.net_log_socket_connect_dnsendpoint)
                    );
                ...
                MultipleConnectAsync multipleConnectAsync = new SingleSocketMultipleConnectAsync(
                    this,
                    true
                );
        ...
        )
        {
            ...
            if (dnsEP != null)
            {
                ...
                {
                    multipleConnectAsync = new DualSocketMultipleConnectAsync(
                        socketType,
                        protocolType
                    );
                }
                else
                {
                    ...
                    multipleConnectAsync = new SingleSocketMultipleConnectAsync(
                        attemptSocket,
                        false
                    );
                }
    ...
    public class SendPacketsElement
    {
        ...
        public SendPacketsElement(string filepath, int offset, int count, bool endOfPacket)
        {
            ...
            Initialize(
                ...
                null,
                offset,
                count, /*UnsafeNclNativeMethods.OSSOCK.TransmitPacketsElementFlags.File,*/
                endOfPacket
            );
#else
            Initialize(
                ...
                offset,
                count,
                UnsafeNclNativeMethods.OSSOCK.TransmitPacketsElementFlags.File,
                endOfPacket
            );
#endif
        }
        ...
        public SendPacketsElement(byte[] buffer, int offset, int count, bool endOfPacket)
        {
            ...
            Initialize(
                ...
                buffer,
                offset,
                count, /*UnsafeNclNativeMethods.OSSOCK.TransmitPacketsElementFlags.Memory,*/
                endOfPacket
            );
#else
            Initialize(
                ...
                offset,
                count,
                UnsafeNclNativeMethods.OSSOCK.TransmitPacketsElementFlags.Memory,
                endOfPacket
            );
#endif
        }
    ...
    public class SocketAsyncEventArgs : EventArgs, IDisposable
    {
        ...
        internal static readonly int s_ControlDataSize = Marshal.SizeOf(
            typeof(UnsafeNclNativeMethods.OSSOCK.ControlData)
        );
        internal static readonly int s_ControlDataIPv6Size = Marshal.SizeOf(
            typeof(UnsafeNclNativeMethods.OSSOCK.ControlDataIPv6)
        );
        internal static readonly int s_WSAMsgSize = Marshal.SizeOf(
        ...
        public IList<ArraySegment<byte>> BufferList
        {
            ...
            set
            {
                ...
                try
                {
                    ...
                    {
                        throw new ArgumentException(
                            SR.GetString(SR.net_ambiguousbuffers, "Buffer")
                        );
                    }
                    m_BufferList = value;
        ...
        private void SetBufferInternal(byte[] buffer, int offset, int count)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        throw new ArgumentException(
                            SR.GetString(SR.net_ambiguousbuffers, "BufferList")
                        );
                    }
        ...
        internal void StartOperationAccept()
        {
            ...
            m_AcceptAddressBufferCount =
                2 * (m_CurrentSocket.m_RightEndPoint.Serialize().Size + 16);
            ...
            if (m_Operating == InProgress && m_CompletedOperation == SocketAsyncOperation.Connect)
            {
                ...
                else
                {
                    ...
                    GlobalLog.Assert(
                        ...
                        "SocketAsyncEventArgs::CancelConnectAsync - CurrentSocket and MultipleConnect both null!"
                    );
        ...
        internal void StartOperationReceiveMessageFrom()
        {
            ...
            if (m_WSAMessageBuffer == null)
            {
                ...
                m_WSAMessageBufferGCHandle = GCHandle.Alloc(
                    m_WSAMessageBuffer,
                    GCHandleType.Pinned
                );
                m_PtrWSAMessageBuffer = Marshal.UnsafeAddrOfPinnedArrayElement(
                    m_WSAMessageBuffer,
                    0
                );
            }
            ...
            IPAddress ipAddress = (
                m_SocketAddress.Family == AddressFamily.InterNetworkV6
                    ? m_SocketAddress.GetIPAddress()
                    : null
            );
            bool ipv4 = (
                m_CurrentSocket.AddressFamily == AddressFamily.InterNetwork
            ...
            if (ipv4 && (m_ControlBuffer == null || m_ControlBuffer.Length != s_ControlDataSize))
            {
                ...
                ipv6 && (m_ControlBuffer == null || m_ControlBuffer.Length != s_ControlDataIPv6Size)
            )
            {
                if (m_ControlBufferGCHandle.IsAllocated)
                {
            ...
            if (m_Buffer != null)
            {
                ...
                m_WSARecvMsgWSABufferArrayGCHandle = GCHandle.Alloc(
                    m_WSARecvMsgWSABufferArray,
                    GCHandleType.Pinned
                );
                m_PtrWSARecvMsgWSABufferArray = Marshal.UnsafeAddrOfPinnedArrayElement(
                    m_WSARecvMsgWSABufferArray,
                    0
                );
            }
            ...
            unsafe
            {
                UnsafeNclNativeMethods.OSSOCK.WSAMsg* pMessage =
                    (UnsafeNclNativeMethods.OSSOCK.WSAMsg*)m_PtrWSAMessageBuffer;
                ;
                ...
                foreach (SendPacketsElement spe in m_SendPacketsElementsInternal)
                {
                    if (spe != null && spe.m_FilePath != null)
                    {
                        ...
                        try
                        {
                            ...
                            m_SendPacketsFileStreams[index] = new FileStream(
                                spe.m_FilePath,
                                FileMode.Open,
                                FileAccess.Read,
                                FileShare.Read
                        ...
                        try
                        {
                            m_SendPacketsFileHandles[index] = m_SendPacketsFileStreams[
                                index
                            ].SafeFileHandle;
                        }
                        finally
        ...
        private void CheckPinSingleBuffer(bool pinUsersBuffer)
        {
                ...
                else
                {
                    if (m_PinState == PinState.SingleBuffer && m_PinnedSingleBuffer == m_Buffer)
                    {
                        ...
                        if (m_Offset != m_PinnedSingleBufferOffset)
                        {
                            ...
                            m_PtrSingleBuffer = Marshal.UnsafeAddrOfPinnedArrayElement(
                                m_Buffer,
                                m_Offset
                            );
            ...
            else
            {
                ...
                if (
                    ...
                    || !(m_PinnedSingleBuffer == m_AcceptBuffer)
                )
                {
        ...
        private void PinSocketAddressBuffer()
        {
            ...
            m_PtrSocketAddressBuffer = Marshal.UnsafeAddrOfPinnedArrayElement(
                m_SocketAddress.m_Buffer,
                0
            );
            m_PtrSocketAddressBufferSize = Marshal.UnsafeAddrOfPinnedArrayElement(
                m_SocketAddress.m_Buffer,
        ...
        unsafe private void SetupOverlappedSingle(bool pinSingleBuffer)
        {
            ...
            if (pinSingleBuffer)
            {
                if (m_Buffer != null)
                {
                    ...
                    m_PtrNativeOverlapped = new SafeNativeOverlapped(
                        m_Overlapped.UnsafePack(null, m_Buffer)
                    );
#else
                    m_PtrNativeOverlapped = new SafeNativeOverlapped(
                        m_Overlapped.UnsafePack(CompletionPortCallback, m_Buffer)
                    );
#endif
                ...
                else
                {
                    ...
                    m_Overlapped.AsyncResult = new DummyAsyncResult(CompletionPortCallback);
                    m_PtrNativeOverlapped = new SafeNativeOverlapped(
                        m_Overlapped.UnsafePack(null, null)
                    );
#else
                    m_PtrNativeOverlapped = new SafeNativeOverlapped(
            ...
            else
            {
                ...
                m_Overlapped.AsyncResult = new DummyAsyncResult(CompletionPortCallback);
                m_PtrNativeOverlapped = new SafeNativeOverlapped(
                    m_Overlapped.UnsafePack(null, m_AcceptBuffer)
                );
#else
                m_PtrNativeOverlapped = new SafeNativeOverlapped(
                    m_Overlapped.UnsafePack(CompletionPortCallback, m_AcceptBuffer)
                );
#endif
        ...
        unsafe private void SetupOverlappedMultiple()
        {
            ...
            m_Overlapped.AsyncResult = new DummyAsyncResult(CompletionPortCallback);
            m_PtrNativeOverlapped = new SafeNativeOverlapped(
                m_Overlapped.UnsafePack(null, m_ObjectsToPin)
            );
#else
            m_PtrNativeOverlapped = new SafeNativeOverlapped(
                m_Overlapped.UnsafePack(CompletionPortCallback, m_ObjectsToPin)
            );
#endif
            for (int i = 0; i < tempList.Length; i++)
            {
                ...
                m_WSABufferArray[i].Pointer = Marshal.UnsafeAddrOfPinnedArrayElement(
                    localCopy.Array,
                    localCopy.Offset
                );
        ...
        unsafe private void SetupOverlappedSendPackets()
        {
            ...
            m_SendPacketsDescriptor = new UnsafeNclNativeMethods.OSSOCK.TransmitPacketsElement[
                m_SendPacketsElementsFileCount + m_SendPacketsElementsBufferCount
            ];
            ...
            if (
                m_ObjectsToPin == null
                || (m_ObjectsToPin.Length != m_SendPacketsElementsBufferCount + 1)
            )
            {
            ...
            m_PtrSendPacketsDescriptor = Marshal.UnsafeAddrOfPinnedArrayElement(
            ...
            foreach (SendPacketsElement spe in m_SendPacketsElementsInternal)
            {
                if (spe != null)
                {
                    ...
                    {
                        // a buffer
                        m_SendPacketsDescriptor[descriptorIndex].buffer =
                            Marshal.UnsafeAddrOfPinnedArrayElement(spe.m_Buffer, spe.m_Offset);
                    ...
                    {
                        // a file
                        m_SendPacketsDescriptor[descriptorIndex].fileHandle =
                            m_SendPacketsFileHandles[fileIndex].DangerousGetHandle();
            ...
            switch (m_PinState)
            {
                case PinState.SingleAcceptBuffer:
                    Logging.Dump(
                        Logging.Sockets,
                        m_CurrentSocket,
                        "FinishOperation(" + m_CompletedOperation + "Async)",
                        m_AcceptBuffer,
                        0,
                        size
                    );
                ...
                if (spe != null)
                {
                    if (spe.m_Buffer != null && spe.m_Count > 0)
                    {
                        ...
                        Logging.Dump(
                            Logging.Sockets,
                            m_CurrentSocket,
                            "FinishOperation(" + m_CompletedOperation + "Async)Buffer",
                            spe.m_Buffer,
                            spe.m_Offset,
                            Math.Min(spe.m_Count, size)
                        );
                    }
                    else if (spe.m_FilePath != null)
                    {
                        ...
                        Logging.PrintInfo(
                            ...
                            m_CurrentSocket,
                            "FinishOperation(" + m_CompletedOperation + "Async)",
                            SR.GetString(SR.net_log_socket_not_logged_file, spe.m_FilePath)
                        );
                    }
                }
            }
        ...
        )
        {
            ...
            switch (m_CompletedOperation)
            {
                case SocketAsyncOperation.Accept:
                    ...
                    if (socketError == SocketError.Success)
                    {
                        m_AcceptSocket = m_CurrentSocket.UpdateAcceptSocket(
                            m_AcceptSocket,
                            m_CurrentSocket.m_RightEndPoint.Create(remoteSocketAddress),
                            false
                        );
                    ...
                    if (socketError == SocketError.Success)
                    {
                        if (s_LoggingEnabled)
                            Logging.PrintInfo(
                                ...
                                m_CurrentSocket,
                                SR.GetString(
                                    SR.net_log_socket_connected,
                                    m_CurrentSocket.LocalEndPoint,
                                    m_CurrentSocket.RemoteEndPoint
                                )
                            );
                ...
                case SocketAsyncOperation.ReceiveMessageFrom:
                    ...
                    unsafe
                    {
                        ...
                        UnsafeNclNativeMethods.OSSOCK.WSAMsg* PtrMessage =
                            (UnsafeNclNativeMethods.OSSOCK.WSAMsg*)
                                Marshal.UnsafeAddrOfPinnedArrayElement(m_WSAMessageBuffer, 0);

                        //ipv4
                        if (m_ControlBuffer.Length == s_ControlDataSize)
                        {
                            UnsafeNclNativeMethods.OSSOCK.ControlData controlData =
                                (UnsafeNclNativeMethods.OSSOCK.ControlData)
                                    Marshal.PtrToStructure(
                                        PtrMessage->controlBuffer.Pointer,
                                        typeof(UnsafeNclNativeMethods.OSSOCK.ControlData)
                                    );
                            ...
                            m_ReceiveMessageFromPacketInfo = new IPPacketInformation(
                                ...
                                (int)controlData.index
                            );
                        }
                        //ipv6
                        else if (m_ControlBuffer.Length == s_ControlDataIPv6Size)
                        {
                            UnsafeNclNativeMethods.OSSOCK.ControlDataIPv6 controlData =
                                (UnsafeNclNativeMethods.OSSOCK.ControlDataIPv6)
                                    Marshal.PtrToStructure(
                                        PtrMessage->controlBuffer.Pointer,
                                        typeof(UnsafeNclNativeMethods.OSSOCK.ControlDataIPv6)
                                    );
                            ...
                            m_ReceiveMessageFromPacketInfo = new IPPacketInformation(
                                ((address != null) ? address : IPAddress.IPv6None),
                                (int)controlData.index
                            );
                        }
                        //other
                        ...
                        try
                        {
                            ...
                            Debug.Assert(
                                (IntPtr)nativeOverlapped
                                    == m_PtrNativeOverlapped.DangerousGetHandle(),
                                "Handle mismatch"
                            );
    ...
    internal static class SocketThreadPool
    {
        ...
        public static bool BindHandle(SafeHandle osHandle)
        {
            ...
            IntPtr handle = UnsafeNclNativeMethods.OSSOCK.CreateIoCompletionPort(
                osHandle,
                m_hIOCP,
                1111,
                0
            ...
            if (handle == IntPtr.Zero)
            {
                throw new Exception(
                    string.Format(
                        "CreateIoCompletionPort failed with Win32 error {0}.",
            ...
            if (!initialized)
            {
                lock (InternalSyncObject)
                {
                    if (!initialized)
                    {
                        ...
                        m_hIOCP = UnsafeNclNativeMethods.OSSOCK.CreateIoCompletionPort(
                            c_InvalidHandleValue,
                            IntPtr.Zero,
                            1111,
                            0
                        );
            ...
            try
            {
                ...
                )
                {
                    ...
                    if (ar == null)
                    {
                        ...
                        // call the callback
                        BaseOverlappedAsyncResult.s_IOCallback(
                            status,
                            bytesTransferred,
                            nativeOverlappedPtr
                        );
