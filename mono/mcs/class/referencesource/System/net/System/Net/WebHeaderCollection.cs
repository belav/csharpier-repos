...
namespace System.Net
{
    ...
    public class WebHeaderCollection : NameValueCollection, ISerializable
    {
        ...
        internal string ContentLength
        {
            get
            {
                return m_CommonHeaders != null
                    ? m_CommonHeaders[c_ContentLength]
                    : Get(s_CommonHeaderNames[c_ContentLength]);
            }
        }
        ...
        internal string CacheControl
        {
            ...
            {
                return m_CommonHeaders != null
                    ? m_CommonHeaders[c_CacheControl]
                    : Get(s_CommonHeaderNames[c_CacheControl]);
            }
        }
        ...
        internal string ContentType
        {
            ...
            {
                return m_CommonHeaders != null
                    ? m_CommonHeaders[c_ContentType]
                    : Get(s_CommonHeaderNames[c_ContentType]);
            }
        }
        ...
        internal string Date
        {
            ...
            {
                return m_CommonHeaders != null
                    ? m_CommonHeaders[c_Date]
                    : Get(s_CommonHeaderNames[c_Date]);
            }
        }
        ...
        internal string Expires
        {
            ...
            {
                return m_CommonHeaders != null
                    ? m_CommonHeaders[c_Expires]
                    : Get(s_CommonHeaderNames[c_Expires]);
            }
        }
        ...
        internal string ETag
        {
            ...
            {
                return m_CommonHeaders != null
                    ? m_CommonHeaders[c_ETag]
                    : Get(s_CommonHeaderNames[c_ETag]);
            }
        }
        ...
        internal string LastModified
        {
            ...
            {
                return m_CommonHeaders != null
                    ? m_CommonHeaders[c_LastModified]
                    : Get(s_CommonHeaderNames[c_LastModified]);
            }
        }
            ...
            get
            {
                string location =
                    m_CommonHeaders != null
                        ...
                        : Get(s_CommonHeaderNames[c_Location]);
        ...
        internal string ProxyAuthenticate
        {
            ...
            {
                return m_CommonHeaders != null
                    ? m_CommonHeaders[c_ProxyAuthenticate]
                    : Get(s_CommonHeaderNames[c_ProxyAuthenticate]);
            }
        }
        ...
        internal string SetCookie2
        {
            ...
            {
                return m_CommonHeaders != null
                    ? m_CommonHeaders[c_SetCookie2]
                    : Get(s_CommonHeaderNames[c_SetCookie2]);
            }
        }
        ...
        internal string SetCookie
        {
            ...
            {
                return m_CommonHeaders != null
                    ? m_CommonHeaders[c_SetCookie]
                    : Get(s_CommonHeaderNames[c_SetCookie]);
            }
        }
        ...
        internal string Server
        {
            ...
            {
                return m_CommonHeaders != null
                    ? m_CommonHeaders[c_Server]
                    : Get(s_CommonHeaderNames[c_Server]);
            }
        }
        ...
        internal string Via
        {
            ...
            {
                return m_CommonHeaders != null
                    ? m_CommonHeaders[c_Via]
                    : Get(s_CommonHeaderNames[c_Via]);
            }
        }
        ...
        private NameValueCollection InnerCollection
        {
            get
            {
                if (m_InnerCollection == null)
                    m_InnerCollection = new NameValueCollection(
        ...
        private bool AllowHttpRequestHeader
        {
            get
            {
                ...
                return m_Type == WebHeaderCollectionType.WebRequest
                    || m_Type == WebHeaderCollectionType.HttpWebRequest
                    || m_Type == WebHeaderCollectionType.HttpListenerRequest;
            }
        }
        ...
        internal bool AllowHttpResponseHeader
        {
            get
            {
                ...
                return m_Type == WebHeaderCollectionType.WebResponse
                    || m_Type == WebHeaderCollectionType.HttpWebResponse
        ...
        public string this[HttpRequestHeader header]
        {
            get
            {
                ...
                return this[
                    UnsafeNclNativeMethods.HttpApi.HTTP_REQUEST_HEADER_ID.ToString((int)header)
                ];
            }
            set
            {
                ...
                this[UnsafeNclNativeMethods.HttpApi.HTTP_REQUEST_HEADER_ID.ToString((int)header)] =
                    value;
            }
        }
        public string this[HttpResponseHeader header]
        {
            get
            {
                ...
                return this[
                    UnsafeNclNativeMethods.HttpApi.HTTP_RESPONSE_HEADER_ID.ToString((int)header)
                ];
            }
            set
            {
                ...
                if (m_Type == WebHeaderCollectionType.HttpListenerResponse)
                {
                    if (value != null && value.Length > ushort.MaxValue)
                    {
                        throw new ArgumentOutOfRangeException(
                            "value",
                            value,
                            SR.GetString(SR.net_headers_toolong, ushort.MaxValue)
                        );
                    }
                }
                this[UnsafeNclNativeMethods.HttpApi.HTTP_RESPONSE_HEADER_ID.ToString((int)header)] =
                    value;
            }
        }
        ...
        protected void AddWithoutValidate(string headerName, string headerValue)
        {
            ...
            GlobalLog.Print(
                "WebHeaderCollection::AddWithoutValidate() calling InnerCollection.Add() key:["
                    + headerName
                    + "], value:["
                    + headerValue
                    + "]"
        ...
        internal void SetAddVerified(string name, string value)
        {
            ...
            {
                GlobalLog.Print(
                    "WebHeaderCollection::SetAddVerified() calling InnerCollection.Add() key:["
                        + name
                        + "], value:["
                        + value
                        + "]"
            ...
            {
                GlobalLog.Print(
                    "WebHeaderCollection::SetAddVerified() calling InnerCollection.Set() key:["
                        + name
                        + "], value:["
                        + value
                        + "]"
        ...
        {
            GlobalLog.Print(
                "WebHeaderCollection::AddInternal() calling InnerCollection.Add() key:["
                    + name
                    + "], value:["
                    + value
                    + "]"
        ...
        {
            GlobalLog.Print(
                "WebHeaderCollection::ChangeInternal() calling InnerCollection.Set() key:["
                    + name
                    + "], value:["
                    + value
                    + "]"
        ...
        {
            GlobalLog.Print(
                "WebHeaderCollection::RemoveInternal() calling InnerCollection.Remove() key:["
                    + name
                    + "]"
            );
            NormalizeCommonHeaders();
        ...
        {
            GlobalLog.Print(
                "WebHeaderCollection::AddInternalNotCommon() calling InnerCollection.Add() key:["
                    + name
                    + "], value:["
                    + value
                    + "]"
        ...
        internal static string CheckBadChars(string name, bool isHeaderValue)
        {
                ...
                if (!isHeaderValue)
                {
                    throw name == null
                        ...
                        : new ArgumentException(
                            SR.GetString(SR.net_emptystringcall, "name"),
                            "name"
                        );
                }
                //empty value is OK
                ...
                for (int i = 0; i < name.Length; ++i)
                {
                    ...
                    switch (crlf)
                    {
                        ...
                        case 1:
                            ...
                            throw new ArgumentException(
                                SR.GetString(SR.net_WebHeaderInvalidCRLFChars),
                                "value"
                            );
            ...
            else
            {
                ...
                {
                    throw new ArgumentException(
                        SR.GetString(SR.net_WebHeaderInvalidHeaderChars),
                        "name"
                    );
                }
                ...
                {
                    throw new ArgumentException(
                        SR.GetString(SR.net_WebHeaderInvalidNonAsciiChars),
                        "name"
                    );
                }
            }
        ...
        internal void ThrowOnRestrictedHeader(string headerName)
        {
            if (m_Type == WebHeaderCollectionType.HttpWebRequest)
            {
                ...
                {
                    throw new ArgumentException(
                        SR.GetString(SR.net_headerrestrict, headerName),
                        "name"
                    );
                }
            }
        ...
        public override void Add(string name, string value)
        {
            ...
            value = CheckBadChars(value, true);
            GlobalLog.Print(
                "WebHeaderCollection::Add() calling InnerCollection.Add() key:["
                    + name
                    + "], value:["
                    + value
                    + "]"
        ...
        public void Add(string header)
        {
            ...
            GlobalLog.Print(
                "WebHeaderCollection::Add("
                    + header
                    + ") calling InnerCollection.Add() key:["
                    + name
                    + "], value:["
                    + value
                    + "]"
        ...
        public override void Set(string name, string value)
        {
            ...
            value = CheckBadChars(value, true);
            GlobalLog.Print(
                "WebHeaderCollection::Set() calling InnerCollection.Set() key:["
                    + name
                    + "], value:["
                    + value
                    + "]"
        ...
        public override void Remove(string name)
        {
            ...
            name = CheckBadChars(name, false);
            GlobalLog.Print(
                "WebHeaderCollection::Remove() calling InnerCollection.Remove() key:[" + name + "]"
            );
            NormalizeCommonHeaders();
            if (m_InnerCollection != null)
            {
        ...
        {
            return response
                ? HInfo[CheckBadChars(headerName, false)].IsResponseRestricted
            ...
            : base(DBNull.Value)
        {
            ...
            {
                string headerName = serializationInfo.GetString(
                    i.ToString(NumberFormatInfo.InvariantInfo)
                );
                string headerValue = serializationInfo.GetString(
                    (i + count).ToString(NumberFormatInfo.InvariantInfo)
                );
                GlobalLog.Print(
                    "WebHeaderCollection::.ctor(ISerializable) calling InnerCollection.Add() key:["
                        + headerName
                        + "], value:["
                        + headerValue
                        + "]"
        ...
        )
        {
            fixed (byte* byteBuffer = buffer)
            {
...
#if TRAVE
                GlobalLog.Enter(
                    "WebHeaderCollection::ParseHeaders(): ANSI size:"
                        + size.ToString()
                        + ", unparsed:"
                        + unparsed.ToString()
                        + " buffer:["
                        + Encoding.ASCII.GetString(buffer, unparsed, Math.Min(256, size - unparsed))
                        + "]"
                );
#endif
                ...
                for (; ; )
                {
                    ...
                    if (Count == 0)
                    {
                        ...
                        while (index < size)
                        {
                            ...
                            if (ch == ' ' || ch == '\t')
                            {
                                ++index;
                                if (
                                    maximumResponseHeadersLength >= 0
                                    && ++localTotalResponseHeadersLength
                    ...
                    while (index < size)
                    {
                        ...
                        if (ch != ':' && ch != '\n')
                        {
                            ...
                            if (
                                maximumResponseHeadersLength >= 0
                                && ++localTotalResponseHeadersLength >= maximumResponseHeadersLength
                            )
                            {
                                parseStatus = DataParseStatus.DataTooBig;
                                goto quit;
                    ...
                    addHeader:
                    if (
                        headerValueStartOffset >= 0
                        && headerValueStartOffset > headerNameEndOffset
                        && headerValueEndOffset >= headerValueStartOffset
                    )
                    {
                        //
                        ...
                        headerValue = HeaderEncoding.GetString(
                            byteBuffer + headerValueStartOffset,
                            headerValueEndOffset - headerValueStartOffset + 1
                        );
                    }
                    ...
                    //
                    headerMultiLineValue = (
                        headerMultiLineValue == null
                            ? headerValue
                            : headerMultiLineValue + " " + headerValue
                    );
                    ...
                    if (headerNameStartOffset >= 0 && headerNameEndOffset >= headerNameStartOffset)
                    {
                        ...
                        //
                        headerName = HeaderEncoding.GetString(
                            byteBuffer + headerNameStartOffset,
                            headerNameEndOffset - headerNameStartOffset + 1
                        );
                    }
                    ...
                    if (headerName.Length > 0)
                    {
                        ...
                        //
                        GlobalLog.Print(
                            "WebHeaderCollection::ParseHeaders() calling AddInternal() key:["
                                + headerName
                                + "], value:["
                                + headerMultiLineValue
                                + "]"
                ...
                quit:
                GlobalLog.Leave(
                    "WebHeaderCollection::ParseHeaders() returning parseStatus:"
        ...
        {
            GlobalLog.Enter(
                "WebHeaderCollection::ParseHeadersStrict(): size:"
                    + size.ToString()
                    + ", unparsed:"
                    + unparsed.ToString()
                    + " buffer:["
            ...
            int effectiveSize =
                maximumResponseHeadersLength <= 0
                    ? Int32.MaxValue
                    : maximumResponseHeadersLength - totalResponseHeadersLength + i;
            ...
            fixed (byte* byteBuffer = buffer)
            {
                while (true)
                {
                    ...
                    for (
                        ;
                        i < effectiveSize
                            && (ch = byteBuffer[i] > 127 ? RfcChar.High : RfcCharMap[byteBuffer[i]])
                                == RfcChar.Reg;
                        i++
                    )
                        ;
                        ...
                        switch (ch)
                        {
                            ...
                            case RfcChar.Reg:
                                ...
                                if (crlf == 3)
                                {
                                    ...
                                    if (iBeginValue != -1)
                                    {
                                        string s = HeaderEncoding.GetString(
                                            byteBuffer + iBeginValue,
                                            iEndValue - iBeginValue + 1
                                        );
                    ...
                    if (m_CommonHeaders != null)
                    {
                        ...
                        if (iHeader >= 0)
                        {
                            while (true)
                            {
                                ...
                                if (
                                    s.Length < headerNameLength
                                    || CaseInsensitiveAscii.AsciiToLower[byteBuffer[iBeginName]]
                                        != CaseInsensitiveAscii.AsciiToLower[s[0]]
                                )
                                    break;
                                ...
                                for (j = 1; j < s.Length; j++)
                                {
                                    ...
                                    if (
                                        *(pBuffer++) != s[j]
                                        && CaseInsensitiveAscii.AsciiToLower[*(pBuffer - 1)]
                                            != CaseInsensitiveAscii.AsciiToLower[s[j]]
                                    )
                                        break;
                                }
                                if (j == s.Length)
            ...
            quit:
            GlobalLog.Leave(
                "WebHeaderCollection::ParseHeadersStrict() returning parseStatus:"
                    + parseStatus.ToString()
            );
                ...
                if (iHeader >= 0)
                {
                    while (true)
                    {
                        ...
                        if (
                            ...
                            || CaseInsensitiveAscii.AsciiToLower[name[0]]
                                != CaseInsensitiveAscii.AsciiToLower[s[0]]
                        )
                            break;
                        ...
                        for (j = 1; j < s.Length; j++)
                        {
                            ...
                            if (
                                ...
                                && (
                                    name[j] > 255
                                    || CaseInsensitiveAscii.AsciiToLower[name[j]]
                                        != CaseInsensitiveAscii.AsciiToLower[s[j]]
                                )
                            )
                                break;
        ...
        public override int Count
        {
            get
            {
                return (m_InnerCollection == null ? 0 : m_InnerCollection.Count)
                    + m_NumCommonHeaders;
            }
        }
    ...
    internal class CaseInsensitiveAscii : IEqualityComparer, IComparer
    {
        ...
        internal static readonly byte[] AsciiToLower = new byte[]
        {
            ...
            99,
            100,
            101, //  60, 61, 62, 63, 64, 65, 66, 67, 68, 69,
            102,
            103,
            104,
            105,
