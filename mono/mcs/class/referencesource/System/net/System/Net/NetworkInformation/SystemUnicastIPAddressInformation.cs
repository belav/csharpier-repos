...
namespace System.Net.NetworkInformation
{
    ...
    internal class SystemUnicastIPAddressInformation : UnicastIPAddressInformation
    {
        ...
        )
        {
            ...
            {
                // Get the address
                IpAdapterUnicastAddress addr = (IpAdapterUnicastAddress)
                    Marshal.PtrToStructure(ptr, typeof(IpAdapterUnicastAddress));
