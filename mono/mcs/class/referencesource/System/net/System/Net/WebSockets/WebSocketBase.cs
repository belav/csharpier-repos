        ...
        private abstract class WebSocketOperation
        {
                        ...
                        while (!completed)
                        {
                            ...
                            switch (action)
                            {
                                ...
                                case WebSocketProtocolComponent.Action.ReceiveFromNetwork:
                                    ...
                                    try
                                    {
                                        ArraySegment<byte> payload = m_WebSocket
                                            .m_InternalBuffer
                                            .ConvertNativeBuffer(
                                                action,
                                                dataBuffers[0],
                                ...
                                case WebSocketProtocolComponent.Action.SendToNetwork:
                                    ...
                                    try
                                    {
                                        ...
                                        )
                                        {
                                            ...
                                            ArraySegment<byte> framingBuffer = m_WebSocket
                                                .m_InternalBuffer
                                                .ConvertNativeBuffer(
                                                    action,
                                                    dataBuffers[0],
            ...
            public class SendOperation : WebSocketOperation
            {
                ...
                )
                {
                    ...
                    payloadBuffer.Data.BufferData = m_WebSocket
                        .m_InternalBuffer
            ...
            public class CloseOutputOperation : SendOperation
            {
                ...
                )
                {
                    ...
                    if (CloseReason != null)
                    {
                        ...
                        payloadBuffer.CloseStatus.ReasonData = m_WebSocket
                            .m_InternalBuffer
