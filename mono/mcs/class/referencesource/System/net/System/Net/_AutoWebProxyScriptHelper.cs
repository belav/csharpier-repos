...
namespace System.Net
{
    ...
    internal class WebProxyScriptHelper : IReflect
    {
        private class MyMethodInfo : MethodInfo
        {
            ...
            public override Type ReturnType
            {
                get
                {
                    ...
                    else if (string.Compare(name, "dnsDomainIs", StringComparison.Ordinal) == 0)
                    {
                        ...
                        string.Compare(name, "localHostOrDomainIs", StringComparison.Ordinal) == 0
                    )
                    {
                        type = typeof(bool);
                    }
                    ...
                    else if (Socket.OSSupportsIPv6)
                    {
                        ...
                        if (string.Compare(name, "dnsResolveEx", StringComparison.Ordinal) == 0)
                        {
                            ...
                            string.Compare(name, "isResolvableEx", StringComparison.Ordinal) == 0
                        )
                        {
                            type = typeof(bool);
                        }
                        else if (
                            string.Compare(name, "myIpAddressEx", StringComparison.Ordinal) == 0
                        )
                        {
                            type = typeof(string);
                        }
                        else if (string.Compare(name, "isInNetEx", StringComparison.Ordinal) == 0)
                        {
                            ...
                            string.Compare(name, "sortIpAddressList", StringComparison.Ordinal) == 0
                        )
                        {
                            type = typeof(string);
                        }
                        else if (
                            string.Compare(name, "getClientVersion", StringComparison.Ordinal) == 0
                        )
                        {
                            type = typeof(string);
                        }
                    ...
                    GlobalLog.Print(
                        "MyMethodInfo::ReturnType() name:" + name + " type:" + type.FullName
                    );
                    return type;
                }
            }
            ...
            {
                GlobalLog.Print(
                    "MyMethodInfo::IsDefined() type:" + type.FullName + " inherit:" + inherit
                );
            ...
            )
            {
                ...
                return typeof(WebProxyScriptHelper)
                    .GetMethod(name, (BindingFlags)unchecked(-1))
                    .Invoke(target, (BindingFlags)unchecked(-1), binder, args, culture);
            }

            public override ParameterInfo[] GetParameters()
            {
                GlobalLog.Print("MyMethodInfo::GetParameters() name:" + name);
                ParameterInfo[] pars = typeof(WebProxyScriptHelper)
                    .GetMethod(name, (BindingFlags)unchecked(-1))
                    .GetParameters();
                GlobalLog.Print(
                    "MyMethodInfo::GetParameters() returning pars.Length:" + pars.Length
                );
                return pars;
            }
        ...
        {
            GlobalLog.Print(
                "WebProxyScriptHelper::IReflect() GetMethod(1) name:"
                    + ValidationHelper.ToString(name)
                    + " bindingAttr:"
                    + bindingAttr
            );
            return null;
        ...
        {
            GlobalLog.Print(
                "WebProxyScriptHelper::IReflect() GetMethod(2) name:"
                    + ValidationHelper.ToString(name)
                    + " bindingAttr:"
                    + bindingAttr
            );
        ...
        {
            GlobalLog.Print(
                "WebProxyScriptHelper::IReflect() GetMethods() bindingAttr:" + bindingAttr
            );
        ...
        {
            GlobalLog.Print(
                "WebProxyScriptHelper::IReflect() GetField() name:"
                    + ValidationHelper.ToString(name)
                    + " bindingAttr:"
                    + bindingAttr
            );
        ...
        {
            GlobalLog.Print(
                "WebProxyScriptHelper::IReflect() GetFields() bindingAttr:" + bindingAttr
            );
        ...
        {
            GlobalLog.Print(
                "WebProxyScriptHelper::IReflect() GetProperty(1) name:"
                    + ValidationHelper.ToString(name)
                    + " bindingAttr:"
                    + bindingAttr
            );
        ...
        {
            GlobalLog.Print(
                "WebProxyScriptHelper::IReflect() GetProperty(2) name:"
                    + ValidationHelper.ToString(name)
                    + " bindingAttr:"
                    + bindingAttr
            );
        ...
        {
            GlobalLog.Print(
                "WebProxyScriptHelper::IReflect() GetProperties() bindingAttr:" + bindingAttr
            );
        ...
        {
            GlobalLog.Print(
                "WebProxyScriptHelper::IReflect() GetMember() name:"
                    + ValidationHelper.ToString(name)
                    + " bindingAttr:"
                    + bindingAttr
            );
        ...
        {
            GlobalLog.Print(
                "WebProxyScriptHelper::IReflect() GetMembers() bindingAttr:" + bindingAttr
            );
        ...
        {
            GlobalLog.Print(
                "WebProxyScriptHelper::IReflect() InvokeMember() name:"
                    + ValidationHelper.ToString(name)
                    + " bindingAttr:"
                    + bindingAttr
            );
        ...
        {
            GlobalLog.Print(
                "WebProxyScriptHelper::isPlainHostName() hostName:"
                    + ValidationHelper.ToString(hostName)
            );
            if (hostName == null)
            {
                if (Logging.On)
                    Logging.PrintWarning(
                        Logging.Web,
                        SR.GetString(
                            SR.net_log_proxy_called_with_null_parameter,
        ...
        {
            GlobalLog.Print(
                "WebProxyScriptHelper::dnsDomainIs() host:"
                    + ValidationHelper.ToString(host)
                    + " domain:"
                    + ValidationHelper.ToString(domain)
            );
            if (host == null)
            {
                if (Logging.On)
        ...
        {
            GlobalLog.Print(
                "WebProxyScriptHelper::localHostOrDomainIs() host:"
                    + ValidationHelper.ToString(host)
                    + " hostDom:"
                    + ValidationHelper.ToString(hostDom)
            );
            if (host == null)
            {
                if (Logging.On)
        ...
        {
            GlobalLog.Print(
                "WebProxyScriptHelper::isResolvable() host:" + ValidationHelper.ToString(host)
            );
            if (host == null)
            {
                if (Logging.On)
        ...
        {
            GlobalLog.Print(
                "WebProxyScriptHelper::dnsResolve() host:" + ValidationHelper.ToString(host)
            );
            if (host == null)
            {
                if (Logging.On)
        ...
        public string myIpAddress()
        {
            ...
            {
                if (
                    !IPAddress.IsLoopback(ipAddresses[i])
                    && ipAddresses[i].AddressFamily == AddressFamily.InterNetwork
                )
                {
        ...
        {
            GlobalLog.Print(
                "WebProxyScriptHelper::dnsDomainLevels() host:" + ValidationHelper.ToString(host)
            );
            if (host == null)
            {
                if (Logging.On)
        ...
        {
            GlobalLog.Print(
                "WebProxyScriptHelper::isInNet() host:"
                    + ValidationHelper.ToString(host)
                    + " pattern:"
                    + ValidationHelper.ToString(pattern)
                    + " mask:"
                    + ValidationHelper.ToString(mask)
            );
            if (host == null)
            {
                if (Logging.On)
            ...
            try
            {
                ...
                if (
                    maskAddressBytes.Length != hostAddressBytes.Length
                    || maskAddressBytes.Length != patternAddressBytes.Length
                )
                {
                    return false;
                }
                ...
                {
                    if (
                        (patternAddressBytes[i] & maskAddressBytes[i])
                        != (hostAddressBytes[i] & maskAddressBytes[i])
                    )
                    {
                        return false;
                    }
        ...
        {
            GlobalLog.Print(
                "WebProxyScriptHelper::shExpMatch() host:"
                    + ValidationHelper.ToString(host)
                    + " pattern:"
                    + ValidationHelper.ToString(pattern)
            );
        ...
        {
            GlobalLog.Print(
                "WebProxyScriptHelper::weekdayRange() wd1:"
                    + ValidationHelper.ToString(wd1)
                    + " wd2:"
                    + ValidationHelper.ToString(wd2)
                    + " gmt:"
                    + ValidationHelper.ToString(gmt)
            );
            if (wd1 == null)
            {
                if (Logging.On)
            ...
            if (gmt != null && gmt != DBNull.Value && gmt != Missing.Value)
            {
                ...
                if (_gmt == null)
                {
                    throw new ArgumentException(
                        SR.GetString(SR.net_param_not_string, gmt.GetType().FullName),
                        "gmt"
                    );
                }
            }
            if (wd2 != null && wd2 != DBNull.Value && gmt != Missing.Value)
            {
                ...
                {
                    throw new ArgumentException(
                        SR.GetString(SR.net_param_not_string, wd2.GetType().FullName),
                        "wd2"
                    );
                }
            }
        ...
        private static DayOfWeek dayOfWeek(string weekDay)
        {
            if (weekDay != null && weekDay.Length == 3)
            {
                ...
                {
                    if (
                        (weekDay[1] == 'U' || weekDay[1] == 'u')
                        && (weekDay[2] == 'E' || weekDay[2] == 'e')
                    )
                    {
                        return DayOfWeek.Tuesday;
                    }
                    if (
                        (weekDay[1] == 'H' || weekDay[1] == 'h')
                        && (weekDay[2] == 'U' || weekDay[2] == 'u')
                    )
                    {
                ...
                if (weekDay[0] == 'S' || weekDay[0] == 's')
                {
                    if (
                        (weekDay[1] == 'U' || weekDay[1] == 'u')
                        && (weekDay[2] == 'N' || weekDay[2] == 'n')
                    )
                    {
                        return DayOfWeek.Sunday;
                    }
                    if (
                        (weekDay[1] == 'A' || weekDay[1] == 'a')
                        && (weekDay[2] == 'T' || weekDay[2] == 't')
                    )
                    {
                ...
                if (
                    (weekDay[0] == 'M' || weekDay[0] == 'm')
                    && (weekDay[1] == 'O' || weekDay[1] == 'o')
                    && (weekDay[2] == 'N' || weekDay[2] == 'n')
                )
                {
                ...
                if (
                    (weekDay[0] == 'W' || weekDay[0] == 'w')
                    && (weekDay[1] == 'E' || weekDay[1] == 'e')
                    && (weekDay[2] == 'D' || weekDay[2] == 'd')
                )
                {
                    return DayOfWeek.Wednesday;
                }
                if (
                    (weekDay[0] == 'F' || weekDay[0] == 'f')
                    && (weekDay[1] == 'R' || weekDay[1] == 'r')
                    && (weekDay[2] == 'I' || weekDay[2] == 'i')
                )
                {
            ...
            if (wd1 < 0 || wd2 < 0)
            {
                if (Logging.On)
                    Logging.PrintWarning(
                        Logging.Web,
                        SR.GetString(
                            SR.net_log_proxy_called_with_invalid_parameter,
                            "WebProxyScriptHelper.weekdayRange()"
                        )
                    );
                throw new ArgumentException(
                    SR.GetString(SR.net_proxy_invalid_dayofweek),
                    wd1 < 0 ? "wd1" : "wd2"
                );
            }
            if (wd1 <= wd2)
        ...
        public string sortIpAddressList(string IPAddressList)
        {
            ...
            for (int i = 0; i < IPAddressStrings.Length; i++)
            {
                ...
                if (IPAddressStrings[i].Length == 0)
                    throw new ArgumentException(
                        SR.GetString(SR.dns_bad_ip_address),
                        "IPAddressList"
                    );
                SocketAddress saddrv6 = new SocketAddress(
                ...
                if (errorCode != SocketError.Success)
                {
                    ...
                    SocketAddress saddrv4 = new SocketAddress(
            ...
            //----------------------------------------------------------------
            int cbRequiredBytes =
                Marshal.SizeOf(typeof(UnsafeNclNativeMethods.OSSOCK.SOCKET_ADDRESS_LIST))
                + (SockAddrIn6List.Length - 1)
                    * Marshal.SizeOf(typeof(UnsafeNclNativeMethods.OSSOCK.SOCKET_ADDRESS));
            Dictionary<IntPtr, KeyValuePair<SocketAddress, string>> UnmanagedToManagedMapping =
                new Dictionary<IntPtr, KeyValuePair<SocketAddress, string>>();
                ...
                unsafe
                {
                    ...
                    for (int i = 0; i < pList->iAddressCount; i++)
                    {
                        ...
                        UnmanagedToManagedMapping[pSocketAddresses[i].lpSockAddr] =
                            new KeyValuePair<SocketAddress, string>(
                                SockAddrIn6List[i],
                                IPAddressStrings[i]
                            );
                    }
                    ...
                    for (int i = 0; i < pList->iAddressCount; i++)
                    {
                        ...
                        KeyValuePair<SocketAddress, string> kv = UnmanagedToManagedMapping[
                            lpSockAddr
                        ];
                        sb.Append(kv.Value);
        ...
        public bool isInNetEx(string ipAddress, string ipPrefix)
        {
            ...
            //-----------------------------------------------
            int MaxBytes =
                (prefixAddress.AddressFamily == AddressFamily.InterNetworkV6)
                    ? IPAddress.IPv6AddressBytes
                    : IPAddress.IPv4AddressBytes;
            while (i < MaxBytes)
            {
        ...
        {
            GlobalLog.Print(
                "WebProxyScriptHelper::dnsResolveEx() host:" + ValidationHelper.ToString(host)
            );
            if (host == null)
            {
                if (Logging.On)
