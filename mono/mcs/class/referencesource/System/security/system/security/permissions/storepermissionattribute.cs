...
namespace System.Security.Permissions
{
    ...
    public sealed class StorePermissionAttribute : CodeAccessSecurityAttribute
    {
        ...
        public bool CreateStore
        {
            ...
            {
                m_flags = value
                    ? m_flags | StorePermissionFlags.CreateStore
                    : m_flags & ~StorePermissionFlags.CreateStore;
            }
        }
        ...
        public bool DeleteStore
        {
            ...
            {
                m_flags = value
                    ? m_flags | StorePermissionFlags.DeleteStore
                    : m_flags & ~StorePermissionFlags.DeleteStore;
            }
        }
        ...
        public bool EnumerateStores
        {
            ...
            {
                m_flags = value
                    ? m_flags | StorePermissionFlags.EnumerateStores
                    : m_flags & ~StorePermissionFlags.EnumerateStores;
            }
        }
        ...
        public bool OpenStore
        {
            ...
            {
                m_flags = value
                    ? m_flags | StorePermissionFlags.OpenStore
                    : m_flags & ~StorePermissionFlags.OpenStore;
            }
        }
        ...
        public bool AddToStore
        {
            ...
            {
                m_flags = value
                    ? m_flags | StorePermissionFlags.AddToStore
                    : m_flags & ~StorePermissionFlags.AddToStore;
            }
        }
