...
namespace System.Security.Cryptography.X509Certificates
{
    ...
    public class X509Chain : IDisposable
    {
        ...
        public X509Chain(IntPtr chainContext)
        {
            ...
            if (
                m_safeCertChainHandle == null
                || m_safeCertChainHandle == SafeX509ChainHandle.InvalidHandle
            )
                throw new CryptographicException(
                    SR.GetString(SR.Cryptography_InvalidContextHandle),
                    "chainContext"
                );
        ...
        public IntPtr ChainContext
        {
            ...
            get { return m_safeCertChainHandle.DangerousGetHandle(); }
        }
        ...
        public SafeX509ChainHandle SafeHandle
        {
            ...
            get { return m_safeCertChainHandle; }
        }
        ...
        public bool Build(X509Certificate2 certificate)
        {
            lock (m_syncRoot)
            {
                ...
                StorePermission sp = new StorePermission(
                    StorePermissionFlags.OpenStore | StorePermissionFlags.EnumerateCertificates
                );
                sp.Demand();
#endif
        ...
        {
            using (
                SafeX509ChainHandle safeCertChainHandle = CAPI.CertDuplicateCertificateChain(
                    m_safeCertChainHandle
                )
            )
            {
                CAPI.CERT_CHAIN_CONTEXT pChain = new CAPI.CERT_CHAIN_CONTEXT(
                    Marshal.SizeOf(typeof(CAPI.CERT_CHAIN_CONTEXT))
                );
                ...
                X509Utils.memcpy(
                    m_safeCertChainHandle.DangerousGetHandle(),
                    new IntPtr(&pChain),
                    cbSize
                );
                ...
                m_chainElementCollection = new X509ChainElementCollection(
                    Marshal.ReadIntPtr(pChain.rgpChain)
                );
            }
        }
        ...
        internal static X509ChainStatus[] GetChainStatusInformation(uint dwStatus)
        {
            ...
            foreach (X509ChainErrorMapping mapping in s_x509ChainErrorMappings)
            {
                if ((dwStatus & mapping.Win32Flag) != 0)
                {
                    ...
                    chainStatus[index].StatusInformation = X509Utils.GetSystemErrorString(
                        mapping.Win32ErrorCode
                    );
        ...
        )
        {
            ...
            try
            {
                ...
                if (applicationPolicy != null && applicationPolicy.Count > 0)
                {
                    ...
                    applicationPolicyHandle = X509Utils.CopyOidsToUnmanagedMemory(
                        applicationPolicy
                    );
                ...
                if (certificatePolicy != null && certificatePolicy.Count > 0)
                {
                    ...
                    certificatePolicyHandle = X509Utils.CopyOidsToUnmanagedMemory(
                        certificatePolicy
                    );
        ...
        private static readonly X509ChainErrorMapping[] s_x509ChainErrorMappings = new[]
        {
            new X509ChainErrorMapping(
                CAPI.CERT_TRUST_IS_NOT_SIGNATURE_VALID,
                CAPI.TRUST_E_CERT_SIGNATURE,
                X509ChainStatusFlags.NotSignatureValid
            ),
            new X509ChainErrorMapping(
                CAPI.CERT_TRUST_CTL_IS_NOT_SIGNATURE_VALID,
                CAPI.TRUST_E_CERT_SIGNATURE,
                X509ChainStatusFlags.CtlNotSignatureValid
            ),
            new X509ChainErrorMapping(
                CAPI.CERT_TRUST_IS_UNTRUSTED_ROOT,
                CAPI.CERT_E_UNTRUSTEDROOT,
                X509ChainStatusFlags.UntrustedRoot
            ),
            new X509ChainErrorMapping(
                CAPI.CERT_TRUST_IS_PARTIAL_CHAIN,
                CAPI.CERT_E_CHAINING,
                X509ChainStatusFlags.PartialChain
            ),
            new X509ChainErrorMapping(
                CAPI.CERT_TRUST_IS_REVOKED,
                CAPI.CRYPT_E_REVOKED,
            ...
            new X509ChainErrorMapping(
                CAPI.CERT_TRUST_INVALID_NAME_CONSTRAINTS,
            ...
            new X509ChainErrorMapping(
                CAPI.CERT_TRUST_HAS_NOT_DEFINED_NAME_CONSTRAINT,
                CAPI.CERT_E_INVALID_NAME,
            ...
            new X509ChainErrorMapping(
                CAPI.CERT_TRUST_INVALID_POLICY_CONSTRAINTS,
                CAPI.CERT_E_INVALID_POLICY,
            ...
            new X509ChainErrorMapping(
                CAPI.CERT_TRUST_INVALID_BASIC_CONSTRAINTS,
                CAPI.TRUST_E_BASIC_CONSTRAINTS,
                X509ChainStatusFlags.InvalidBasicConstraints
            ),
            new X509ChainErrorMapping(
                CAPI.CERT_TRUST_IS_NOT_TIME_NESTED,
                CAPI.CERT_E_VALIDITYPERIODNESTING,
            ...
            new X509ChainErrorMapping(
                CAPI.CERT_TRUST_IS_OFFLINE_REVOCATION,
                CAPI.CRYPT_E_REVOCATION_OFFLINE,
                X509ChainStatusFlags.OfflineRevocation
            ),
            new X509ChainErrorMapping(
                CAPI.CERT_TRUST_IS_EXPLICIT_DISTRUST,
                CAPI.TRUST_E_EXPLICIT_DISTRUST,
