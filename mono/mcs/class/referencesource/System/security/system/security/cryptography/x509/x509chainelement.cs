...
namespace System.Security.Cryptography.X509Certificates
{
    ...
    public class X509ChainElement
    {
        ...
        {
            CAPI.CERT_CHAIN_ELEMENT chainElement = new CAPI.CERT_CHAIN_ELEMENT(
                Marshal.SizeOf(typeof(CAPI.CERT_CHAIN_ELEMENT))
            );
    ...
    public sealed class X509ChainElementCollection : ICollection
    {
        ...
        {
            CAPI.CERT_SIMPLE_CHAIN simpleChain = new CAPI.CERT_SIMPLE_CHAIN(
                Marshal.SizeOf(typeof(CAPI.CERT_SIMPLE_CHAIN))
            );
            ...
            {
                m_elements[index] = new X509ChainElement(
                    Marshal.ReadIntPtr(
                        new IntPtr(
    ...
    public sealed class X509ChainElementEnumerator : IEnumerator
    {
        ...
        {
            get { return (X509ChainElement)m_chainElements[m_current]; }
        }

        /// <internalonly/>
        Object IEnumerator.Current
        {
            get { return (Object)m_chainElements[m_current]; }
        }
