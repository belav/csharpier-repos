...
namespace System.Security.Cryptography.X509Certificates
{
    ...
    public sealed class X500DistinguishedName : AsnEncodedData
    {
        ...
        internal X500DistinguishedName(CAPI.CRYPTOAPI_BLOB encodedDistinguishedNameBlob)
        ...
        public X500DistinguishedName(X500DistinguishedName distinguishedName)
            : base((AsnEncodedData)distinguishedName)
        {
        ...
        public string Decode(X500DistinguishedNameFlags flag)
        {
            ...
            unsafe
            {
                ...
                fixed (byte* pbEncoded = encodedDistinguishedName)
                {
                    ...
                    uint cchDecoded = CAPI.CertNameToStrW(
                    ...
                    using (
                        SafeLocalAllocHandle pwszDecodeName = CAPI.LocalAlloc(
                            CAPI.LPTR,
