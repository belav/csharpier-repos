...
namespace System.Security.Cryptography.X509Certificates
{
    ...
    public sealed class X509Store : IDisposable
    {
        ...
        public X509Store(IntPtr storeHandle)
        {
            ...
            if (m_safeCertStoreHandle == null || m_safeCertStoreHandle.IsInvalid)
                throw new CryptographicException(
                    SR.GetString(SR.Cryptography_InvalidStoreHandle),
                    "storeHandle"
                );
        }
        ...
        public IntPtr StoreHandle
        {
            ...
            {
                if (
                    m_safeCertStoreHandle == null
                    || m_safeCertStoreHandle.IsInvalid
                    || m_safeCertStoreHandle.IsClosed
                )
                    throw new CryptographicException(
                        SR.GetString(SR.Cryptography_X509_StoreNotOpen)
                    );
        ...
        public void Open(OpenFlags flags)
        {
            ...
            m_safeCertStoreHandle = CAPI.CertOpenStore(
        ...
        public void Add(X509Certificate2 certificate)
        {
            ...
            if (
                !CAPI.CertAddCertificateContextToStore(
                    m_safeCertStoreHandle,
        ...
        )
        {
            ...
            if (
                safeCertStoreHandle == null
                || safeCertStoreHandle.IsInvalid
                || safeCertStoreHandle.IsClosed
            )
                throw new CryptographicException(SR.GetString(SR.Cryptography_X509_StoreNotOpen));

            // Find the certificate in the store.
            SafeCertContextHandle safeCertContext2 = CAPI.CertFindCertificateInStore(
                safeCertStoreHandle,
                CAPI.X509_ASN_ENCODING | CAPI.PKCS_7_ASN_ENCODING,
                0,
