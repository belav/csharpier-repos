...
namespace System.Security.Cryptography.X509Certificates
{
    ...
    public class X509Certificate2Collection : X509CertificateCollection
    {
        ...
        {
            get { return (X509Certificate2)List[index]; }
            set
            {
                if (value == null)
        ...
        )
        {
            ...
            SafeCertStoreHandle safeTargetStoreHandle = FindCertInStore(
                safeSourceStoreHandle,
                findType,
                findValue,
                validOnly
            );
            X509Certificate2Collection collection = X509Utils.GetCertificates(
        ...
        public void Import(byte[] rawData, string password, X509KeyStorageFlags keyStorageFlags)
        {
            ...
            safeCertStoreHandle = LoadStoreFromBlob(
                rawData,
                password,
                dwFlags,
                (keyStorageFlags & X509KeyStorageFlags.PersistKeySet) != 0
            );
        ...
        public void Import(string fileName, string password, X509KeyStorageFlags keyStorageFlags)
        {
            ...
            safeCertStoreHandle = LoadStoreFromFile(
                fileName,
                password,
                dwFlags,
                (keyStorageFlags & X509KeyStorageFlags.PersistKeySet) != 0
        ...
        )
        {
            ...
            switch (contentType)
            {
                case X509ContentType.Cert:
                    safeCertContextHandle = CAPI.CertEnumCertificatesInStore(
                        safeCertStoreHandle,
                ...
                case X509ContentType.SerializedCert:
                    ...
                    {
                        if (
                            !CAPI.CertSerializeCertificateStoreElement(
                                safeCertContextHandle,
                                0,
                                pbEncoded,
                ...
                default:
                    throw new CryptographicException(
                        SR.GetString(SR.Cryptography_X509_InvalidContentType)
                    );
            }
        ...
        [SecurityCritical]
#endif
        internal delegate int FindProcDelegate(
            SafeCertContextHandle safeCertContextHandle,
            object pvCallbackData
        );
        ...
        )
        {
            ...
            switch (findType)
            {
                case X509FindType.FindByThumbprint:
                    if (findValue.GetType() != typeof(string))
                        throw new CryptographicException(
                            SR.GetString(SR.Cryptography_X509_InvalidFindValue)
                        );
                    ...
                    if (findValue.GetType() == typeof(string))
                    {
                        CAPI.KEY_USAGE_STRUCT[] KeyUsages = new CAPI.KEY_USAGE_STRUCT[]
                        {
                            new CAPI.KEY_USAGE_STRUCT(
                                "DigitalSignature",
                                CAPI.CERT_DIGITAL_SIGNATURE_KEY_USAGE
                            ),
                            new CAPI.KEY_USAGE_STRUCT(
                                "NonRepudiation",
                                CAPI.CERT_NON_REPUDIATION_KEY_USAGE
                            ),
                            new CAPI.KEY_USAGE_STRUCT(
                                "KeyEncipherment",
                                CAPI.CERT_KEY_ENCIPHERMENT_KEY_USAGE
                            ),
                            new CAPI.KEY_USAGE_STRUCT(
                                "DataEncipherment",
                                CAPI.CERT_DATA_ENCIPHERMENT_KEY_USAGE
                            ),
                            new CAPI.KEY_USAGE_STRUCT(
                                "KeyAgreement",
                                CAPI.CERT_KEY_AGREEMENT_KEY_USAGE
                            ),
                            new CAPI.KEY_USAGE_STRUCT(
                                "KeyCertSign",
                                CAPI.CERT_KEY_CERT_SIGN_KEY_USAGE
                            ),
                            new CAPI.KEY_USAGE_STRUCT("CrlSign", CAPI.CERT_CRL_SIGN_KEY_USAGE),
                            new CAPI.KEY_USAGE_STRUCT(
                                "EncipherOnly",
                                CAPI.CERT_ENCIPHER_ONLY_KEY_USAGE
                            ),
                            new CAPI.KEY_USAGE_STRUCT(
                                "DecipherOnly",
                        ...
                        if (pvCallbackData1 == null)
                            throw new CryptographicException(
                                SR.GetString(SR.Cryptography_X509_InvalidFindType)
                            );
                    }
            ...
            SafeCertStoreHandle safeTargetStoreHandle = CAPI.CertOpenStore(
        ...
        [SecuritySafeCritical]
#endif
        private static void FindByCert(
            SafeCertStoreHandle safeSourceStoreHandle,
            uint dwFindType,
            IntPtr pvFindPara,
            bool validOnly,
        ...
        )
        {
            ...
            pEnumContext = CAPI.CertFindCertificateInStore(
                safeSourceStoreHandle,
                CAPI.X509_ASN_ENCODING | CAPI.PKCS_7_ASN_ENCODING,
                0,
                dwFindType,
            ...
            while (pEnumContext != null && !pEnumContext.IsInvalid)
            {
                ...
                if (validOnly)
                {
                    hr = X509Utils.VerifyCertificate(
                        pEnumContext,
                        null,
                        null,
        ...
        [SecurityCritical]
#endif
        private static unsafe int FindSubjectDistinguishedNameCallback(
            SafeCertContextHandle safeCertContextHandle,
            object pvCallbackData
        )
        {
            ...
            if (
                String.Compare(rdn, (string)pvCallbackData, StringComparison.OrdinalIgnoreCase) != 0
            )
                return CAPI.S_FALSE;
            return CAPI.S_OK;
        }
        ...
        [SecurityCritical]
#endif
        private static unsafe int FindIssuerDistinguishedNameCallback(
            SafeCertContextHandle safeCertContextHandle,
            object pvCallbackData
        )
        {
            string rdn = CAPI.GetCertNameInfo(
                safeCertContextHandle,
                CAPI.CERT_NAME_ISSUER_FLAG,
                CAPI.CERT_NAME_RDN_TYPE
            );
            if (
                String.Compare(rdn, (string)pvCallbackData, StringComparison.OrdinalIgnoreCase) != 0
            )
        ...
        [SecurityCritical]
#endif
        private static unsafe int FindSerialNumberCallback(
            SafeCertContextHandle safeCertContextHandle,
            object pvCallbackData
        )
        {
        ...
        [SecurityCritical]
#endif
        private static unsafe int FindTimeValidCallback(
            SafeCertContextHandle safeCertContextHandle,
            object pvCallbackData
        )
        {
        ...
        [SecurityCritical]
#endif
        private static unsafe int FindTimeNotAfterCallback(
            SafeCertContextHandle safeCertContextHandle,
            object pvCallbackData
        )
        {
        ...
        [SecurityCritical]
#endif
        private static unsafe int FindTimeNotBeforeCallback(
            SafeCertContextHandle safeCertContextHandle,
            object pvCallbackData
        )
        {
        ...
        [SecurityCritical]
#endif
        private static unsafe int FindTemplateNameCallback(
            SafeCertContextHandle safeCertContextHandle,
            object pvCallbackData
        )
        {
            ...
            pV1Template = CAPI.CertFindExtension(
                CAPI.szOID_ENROLL_CERTTYPE_EXTENSION,
                pCertInfo.cExtension,
                pCertInfo.rgExtension
            );
            pV2Template = CAPI.CertFindExtension(
                CAPI.szOID_CERTIFICATE_TEMPLATE,
                pCertInfo.cExtension,
                pCertInfo.rgExtension
            );
            ...
            if (pV1Template != IntPtr.Zero)
            {
                CAPI.CERT_EXTENSION extension = (CAPI.CERT_EXTENSION)
                    Marshal.PtrToStructure(pV1Template, typeof(CAPI.CERT_EXTENSION));
                ...
                if (result)
                {
                    CAPI.CERT_NAME_VALUE pNameValue = (CAPI.CERT_NAME_VALUE)
            ...
            {
                CAPI.CERT_EXTENSION extension = (CAPI.CERT_EXTENSION)
                    Marshal.PtrToStructure(pV2Template, typeof(CAPI.CERT_EXTENSION));
                byte[] rawData = new byte[extension.Value.cbData];
                Marshal.Copy(extension.Value.pbData, rawData, 0, rawData.Length);
                ...
                if (result)
                {
                    CAPI.CERT_TEMPLATE_EXT pTemplate = (CAPI.CERT_TEMPLATE_EXT)
                        Marshal.PtrToStructure(
                            decoded.DangerousGetHandle(),
        ...
        )
        {
            ...
            if (
                !CAPI.CertGetValidUsages(
                    1,
                    new IntPtr(&pCertContext),
                    new IntPtr(&cNumOIDs),
                    rghOIDs,
                    new IntPtr(&cbOIDs)
                )
        ...
        [SecurityCritical]
#endif
        private static unsafe int FindCertificatePolicyCallback(
            SafeCertContextHandle safeCertContextHandle,
            object pvCallbackData
        )
        {
            ...
            IntPtr pExtension = CAPI.CertFindExtension(
                CAPI.szOID_CERT_POLICIES,
                pCertInfo.cExtension,
                pCertInfo.rgExtension
            );
            ...
            if (result)
            {
                CAPI.CERT_POLICIES_INFO pInfo = (CAPI.CERT_POLICIES_INFO)
                    Marshal.PtrToStructure(
                        decoded.DangerousGetHandle(),
                ...
                {
                    IntPtr pPolicyInfoPtr = new IntPtr(
                        (long)pInfo.rgPolicyInfo
                            + index * Marshal.SizeOf(typeof(CAPI.CERT_POLICY_INFO))
                    );
                    CAPI.CERT_POLICY_INFO pPolicyInfo = (CAPI.CERT_POLICY_INFO)
                        Marshal.PtrToStructure(pPolicyInfoPtr, typeof(CAPI.CERT_POLICY_INFO));
                    if (
                        String.Compare(
                            certPolicy,
        ...
        [SecurityCritical]
#endif
        private static unsafe int FindExtensionCallback(
            SafeCertContextHandle safeCertContextHandle,
            object pvCallbackData
        )
        {
        ...
        [SecurityCritical]
#endif
        private static unsafe int FindSubjectKeyIdentifierCallback(
            SafeCertContextHandle safeCertContextHandle,
            object pvCallbackData
        )
        {
        ...
        )
        {
            ...
            {
                safeCertStoreHandle.Dispose();
                safeCertStoreHandle = CAPI.PFXImportCertStore(
                    CAPI.CERT_QUERY_OBJECT_BLOB,
                    rawData,
                    password,
                    dwFlags,
    ...
    public sealed class X509Certificate2Enumerator : IEnumerator
    {
        ...
        {
            get { return ((X509Certificate2)(baseEnumerator.Current)); }
        }
