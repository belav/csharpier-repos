...
namespace System.Security.Cryptography
{
    ...
    public class AsnEncodedData
    {
        ...
        internal AsnEncodedData(string oid, CAPI.CRYPTOAPI_BLOB encodedBlob)
            : this(oid, CAPI.BlobToByteArray(encodedBlob)) { }

        internal AsnEncodedData(Oid oid, CAPI.CRYPTOAPI_BLOB encodedBlob)
            : this(oid, CAPI.BlobToByteArray(encodedBlob)) { }
    ...
    public sealed class AsnEncodedDataCollection : ICollection
    {
                ...
                if (szOid1 != null && szOid2 != null)
                {
                    ...
                    if (String.Compare(szOid1, szOid2, StringComparison.OrdinalIgnoreCase) != 0)
                        throw new CryptographicException(
                            SR.GetString(SR.Cryptography_Asn_MismatchedOidInCollection)
                        );
                }
        ...
        {
            get { return (AsnEncodedData)m_list[index]; }
        }
    ...
    public sealed class AsnEncodedDataEnumerator : IEnumerator
    {
        ...
        {
            get { return m_asnEncodedDatas[m_current]; }
        }

        /// <internalonly/>
        Object IEnumerator.Current
        {
            get { return (Object)m_asnEncodedDatas[m_current]; }
        }
