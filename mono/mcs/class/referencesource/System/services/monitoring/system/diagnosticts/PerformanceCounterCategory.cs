    ...
    public sealed class PerformanceCounterCategory
    {
        ...
        public PerformanceCounterCategory(string categoryName, string machineName)
        {
            ...
            if (categoryName.Length == 0)
                throw new ArgumentException(
                    SR.GetString(SR.InvalidParameter, "categoryName", categoryName)
                );
        ...
        public string CategoryName
        {
            ...
            set
            {
                ...
                if (value.Length == 0)
                    throw new ArgumentException(
                        SR.GetString(SR.InvalidProperty, "CategoryName", value)
                    );
        ...
        public string CategoryHelp
        {
            get
            {
                ...
                if (categoryHelp == null)
                    categoryHelp = PerformanceCounterLib.GetCategoryHelp(
                        this.machineName,
                        this.categoryName
                    );
            ...
            try
            {
                ...
                if (
                    ...
                    throw new InvalidOperationException(
                        SR.GetString(SR.PerformanceCategoryExists, categoryName)
                    );
        ...
        internal static void CheckValidCategory(string categoryName)
        {
            ...
            if (!CheckValidId(categoryName, MaxCategoryNameLength))
                throw new ArgumentException(
                    SR.GetString(SR.PerfInvalidCategoryName, 1, MaxCategoryNameLength)
                );
        ...
        internal static void CheckValidCounter(string counterName)
        {
            ...
            if (!CheckValidId(counterName, MaxCounterNameLength))
                throw new ArgumentException(
                    SR.GetString(SR.PerfInvalidCounterName, 1, MaxCounterNameLength)
                );
        }
        ...
        internal static void CheckValidCounterLayout(CounterCreationDataCollection counterData)
        {
            ...
            for (int i = 0; i < counterData.Count; i++)
            {
                ...
                {
                    throw new ArgumentException(
                        SR.GetString(SR.DuplicateCounterName, counterData[i].CounterName)
                    );
                }
                else
                {
        ...
        internal static string[] GetCounterInstances(string categoryName, string machineName)
        {
            ...
            if (
                ...
                && instanceNames[0].CompareTo(PerformanceCounterLib.SingleInstanceName) == 0
            )
                return new string[0];
        ...
        public PerformanceCounter[] GetCounters(string instanceName)
        {
            ...
            if (instanceName.Length != 0 && !InstanceExists(instanceName))
                throw new InvalidOperationException(
                    SR.GetString(SR.MissingInstance, instanceName, categoryName)
                );
