...
namespace System.Diagnostics
{
    ...
    public class ProcessThreadCollection : ReadOnlyCollectionBase
    {
        ...
        public int BinarySearch(
            ...
            int count,
            ProcessThread item,
            System.Collections.Generic.IComparer<ProcessThread> comparer
        )
        {
            throw new NotSupportedException();
        }
        ...
        public System.Collections.Generic.List<TOutput> ConvertAll<TOutput>(
            Converter<ProcessThread, TOutput> converter
        )
        {
            throw new NotSupportedException();
        }
        ...
        [Obsolete("This API is no longer available", true)]
        public System.Collections.Generic.List<ProcessThread> FindAll(
            Predicate<ProcessThread> match
        )
        {
            throw new NotSupportedException();
        }
        ...
        public void InsertRange(
            int index,
            System.Collections.Generic.IEnumerable<ProcessThread> collection
        )
        {
            throw new NotSupportedException();
        }
