...
namespace System.Diagnostics
{
    ...
    public class ProcessModuleCollection : ReadOnlyCollectionBase
    {
        ...
        public int BinarySearch(
            ...
            int count,
            ProcessModule item,
            System.Collections.Generic.IComparer<ProcessModule> comparer
        )
        {
            throw new NotSupportedException();
        }
        ...
        public System.Collections.Generic.List<TOutput> ConvertAll<TOutput>(
            Converter<ProcessModule, TOutput> converter
        )
        {
            throw new NotSupportedException();
        }
        ...
        [Obsolete("This API is no longer available", true)]
        public System.Collections.Generic.List<ProcessModule> FindAll(
            Predicate<ProcessModule> match
        )
        {
            throw new NotSupportedException();
        }
        ...
        public void InsertRange(
            int index,
            System.Collections.Generic.IEnumerable<ProcessModule> collection
        )
        {
            throw new NotSupportedException();
        }
