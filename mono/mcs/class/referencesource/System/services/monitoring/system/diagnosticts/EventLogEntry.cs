...
namespace System.Diagnostics
{
    ...
    public sealed class EventLogEntry : Component, ISerializable
    {
        ...
        */
                ...
                if (message == null)
                {
                    ...
                    if (msg == null)
                    {
                        StringBuilder msgBuf = new StringBuilder(
                            SR.GetString(SR.MessageNotFormatted, msgId, Source)
                        );
        ...
        [MonitoringDescription(SR.LogEntryResourceId), ComVisible(false)]
        public Int64 InstanceId
        {
            get { return (UInt32)IntFrom(dataBuf, bufOffset + FieldOffsets.EVENTID); }
        }
