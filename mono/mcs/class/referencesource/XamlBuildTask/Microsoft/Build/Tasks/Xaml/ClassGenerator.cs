...
namespace Microsoft.Build.Tasks.Xaml
{
    ...
    class ClassGenerator
    {
        ...
        )
        {
            ...
            CodeVariableReferenceExpression resourceNameVar = initializeMethod
                .Statements
                .DeclareVar(
                    typeof(string),
                    "resourceName",
            ...
            //
            CodeVariableReferenceExpression initializeXamlVar = initializeMethod
                .Statements
                .DeclareVar(
                    typeof(Stream),
                    "initializeXaml",
        ...
        CodeMemberMethod GenerateFindResourceMethod(ClassData classData)
        {
            ...
            //
            CodeVariableReferenceExpression resourcesVar = findResourceMethod
                .Statements
                .DeclareVar(
                    typeof(string[]),
                    "resources",
        ...
        CodeTypeMember[] GenerateAssemblyListProperty()
        {
            ...
            CodeConditionStatement assemblyListNull = new CodeConditionStatement(
                ...
                new CodeAssignStatement(
                    ...
                    new CodeMethodInvokeExpression
                    {
                        Method = new CodeMethodReferenceExpression { MethodName = "LoadAssemblies" }
                    }
                )
            );
        ...
        CodeMemberMethod GenerateLoadMethod()
        {
            ...
            CodeVariableReferenceExpression shortName = catchClause
                .Statements
                .DeclareVar(
                    typeof(AssemblyName),
                    "shortName",
