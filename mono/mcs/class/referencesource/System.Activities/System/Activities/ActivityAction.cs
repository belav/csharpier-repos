...
namespace System.Activities
{
    ...
    {
        static readonly IList<RuntimeDelegateArgument> EmptyDelegateParameters =
            new List<RuntimeDelegateArgument>(0);
    ...
    public sealed class ActivityAction<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11>
        : ActivityDelegate
    {
        public ActivityAction() { }
    ...
    public sealed class ActivityAction<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12>
        : ActivityDelegate
    {
        public ActivityAction() { }
    ...
    public sealed class ActivityAction<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13>
        : ActivityDelegate
    {
        public ActivityAction() { }
    ...
    public sealed class ActivityAction<T1, T2, T3, T4, T5, T6, T7, T8, T9, T10, T11, T12, T13, T14>
        : ActivityDelegate
    {
        public ActivityAction() { }
