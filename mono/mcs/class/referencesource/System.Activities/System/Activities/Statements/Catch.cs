...
namespace System.Activities.Statements
{
    ...
    [SuppressMessage(
        ...
        Justification = "Optimizing for XAML naming. VB imperative users will [] qualify (e.g. New [Catch](Of Exception))"
    )]
    public abstract class Catch
    {
        ...
        internal abstract void ScheduleAction(
        ...
        where TException : Exception
    {
        ...
        internal override void ScheduleAction(
            NativeActivityContext context,
            Exception exception,
            CompletionCallback completionCallback,
            FaultCallback faultCallback
