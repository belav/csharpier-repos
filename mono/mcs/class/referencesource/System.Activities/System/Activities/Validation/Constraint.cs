...
namespace System.Activities.Validation
{
    ...
    {
        public const string ValidationErrorListPropertyName =
        ...
        internal Constraint()
        {
            this.toValidate = new RuntimeArgument(
                ToValidateArgumentName,
                typeof(object),
                ArgumentDirection.In
            );
            this.toValidateContext = new RuntimeArgument(
                ToValidateContextArgumentName,
                typeof(ValidationContext),
                ArgumentDirection.In
            );
            this.violationList = new RuntimeArgument(
                ValidationErrorListArgumentName,
        ...
        public static void AddValidationError(NativeActivityContext context, ValidationError error)
        {
            List<ValidationError> validationErrorList =
                context.Properties.Find(ValidationErrorListPropertyName) as List<ValidationError>;
        ...
        [SuppressMessage(
            ...
            FxCop.Rule.IdentifiersShouldNotContainTypeNames,
