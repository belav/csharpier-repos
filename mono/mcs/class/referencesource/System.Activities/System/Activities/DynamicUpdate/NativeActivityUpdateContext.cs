...
namespace System.Activities.DynamicUpdate
{
    ...
    public class NativeActivityUpdateContext
    {
        ...
        )
        {
            ...
            this.innerContext = new NativeActivityContext(
                this.currentInstance,
                this.activityExecutor,
                this.activityExecutor.RawBookmarkManager
            );
        ...
        {
            ThrowIfDisposed();
            ExecutionProperties exeProperties = new ExecutionProperties(
                this.innerContext,
                this.currentInstance,
                this.currentInstance.PropertyManager
            );
        ...
        public object GetSavedOriginalValue(Activity childActivity)
        {
            ...
            NativeActivityUpdateMapMetadata.ValidateOriginalValueAccess(
        ...
        public bool IsNewlyAdded(Activity childActivity)
        {
            ...
            return !mapContainingChild.TryGetUpdateEntryByNewId(
                childActivity.InternalId,
                out entry
            );
        }
        ...
        public void ScheduleAction<T1, T2>(
            ActivityAction<T1, T2> activityAction,
            T1 argument1,
            T2 argument2,
            CompletionCallback onCompleted = null,
            FaultCallback onFaulted = null
        ...
        public void ScheduleAction<T1, T2, T3>(
        ...
        public void ScheduleFunc<TResult>(
            ActivityFunc<TResult> activityFunc,
            CompletionCallback<TResult> onCompleted = null,
            FaultCallback onFaulted = null
        )
        {
        ...
        public void ScheduleFunc<T, TResult>(
        ...
        public void ScheduleFunc<T1, T2, TResult>(
            ActivityFunc<T1, T2, TResult> activityFunc,
            T1 argument1,
            T2 argument2,
            CompletionCallback<TResult> onCompleted = null,
            FaultCallback onFaulted = null
        ...
        public void ScheduleDelegate(
            ActivityDelegate activityDelegate,
            IDictionary<string, object> inputParameters,
            DelegateCompletionCallback onCompleted = null,
            FaultCallback onFaulted = null
        )
        {
            ThrowIfDisposed();
