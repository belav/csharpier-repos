...
namespace System.Activities.Expressions
{
    ...
    [SuppressMessage(
        ...
        Justification = "Optimizing for XAML naming. VB imperative users will [] qualify (e.g. New [AndAlso])"
    )]
        ...
        protected override void CacheMetadata(ActivityMetadata metadata)
        {
            ...
            if (this.Left == null)
            {
                metadata.AddValidationError(
                    SR.BinaryExpressionActivityRequiresArgument("Left", "AndAlso", this.DisplayName)
                );
            }
