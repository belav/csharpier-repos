...
namespace System.Activities.Expressions
{
    ...
    public static class ExpressionServices
    {
        ...
        static MethodInfo TryConvertBinaryExpressionHandle = typeof(ExpressionServices).GetMethod(
            "TryConvertBinaryExpressionWorker",
            BindingFlags.NonPublic | BindingFlags.Static
        );
        static MethodInfo TryConvertUnaryExpressionHandle = typeof(ExpressionServices).GetMethod(
            "TryConvertUnaryExpressionWorker",
            BindingFlags.NonPublic | BindingFlags.Static
        );
        static MethodInfo TryConvertMemberExpressionHandle = typeof(ExpressionServices).GetMethod(
            "TryConvertMemberExpressionWorker",
            BindingFlags.NonPublic | BindingFlags.Static
        );
        static MethodInfo TryConvertArgumentExpressionHandle = typeof(ExpressionServices).GetMethod(
            "TryConvertArgumentExpressionWorker",
            BindingFlags.NonPublic | BindingFlags.Static
        );
        static MethodInfo TryConvertReferenceMemberExpressionHandle =
            typeof(ExpressionServices).GetMethod(
                "TryConvertReferenceMemberExpressionWorker",
                BindingFlags.NonPublic | BindingFlags.Static
            );
        static MethodInfo TryConvertIndexerReferenceHandle = typeof(ExpressionServices).GetMethod(
            "TryConvertIndexerReferenceWorker",
            BindingFlags.NonPublic | BindingFlags.Static
        );
        ...
        public static Activity<TResult> Convert<TResult>(
            Expression<Func<ActivityContext, TResult>> expression
        )
        {
        ...
        )
        {
            ...
            if (unaryExpressionBody != null)
            {
                ...
                return TryConvertUnaryExpression<TResult>(
                    unaryExpressionBody,
                    operandType,
                    throwOnError,
                    out result
            ...
            if (binaryExpressionBody != null)
            {
                ...
                {
                    return TryConvertArrayItemValue<TResult>(
                ...
                return TryConvertBinaryExpression<TResult>(
                    binaryExpressionBody,
                    leftType,
                    rightType,
                    throwOnError,
            ...
            {
                Type memberType =
                    memberExpressionBody.Expression == null
                        ? memberExpressionBody.Member.DeclaringType
                        : memberExpressionBody.Expression.Type;
                return TryConvertMemberExpression<TResult>(
                    memberExpressionBody,
                    memberType,
                    throwOnError,
                    out result
                );
            ...
            if (methodCallExpressionBody != null)
            {
                ...
                if (
                    TypeHelper.AreTypesCompatible(declaringType, typeof(Variable))
                    && calledMethod.Name == "Get"
                    && parameters.Length == 1
                ...
                {
                    return TryConvertVariableValue<TResult>(
                        methodCallExpressionBody,
                        throwOnError,
                        out result
                    );
                }
                else if (
                    TypeHelper.AreTypesCompatible(declaringType, typeof(Argument))
                    && calledMethod.Name == "Get"
                    && parameters.Length == 1
                    && TypeHelper.AreTypesCompatible(
                        parameters[0].ParameterType,
                ...
                {
                    return TryConvertArgumentValue<TResult>(
                        methodCallExpressionBody.Object as MemberExpression,
                        throwOnError,
                        out result
                    );
                }
                else if (
                    TypeHelper.AreTypesCompatible(declaringType, typeof(DelegateArgument))
                    && calledMethod.Name == "Get"
                    && parameters.Length == 1
                    && TypeHelper.AreTypesCompatible(
                        parameters[0].ParameterType,
                ...
                {
                    return TryConvertDelegateArgumentValue<TResult>(
                        methodCallExpressionBody,
                        throwOnError,
                        out result
                    );
                    ...
                    TypeHelper.AreTypesCompatible(declaringType, typeof(ActivityContext))
                    && calledMethod.Name == "GetValue"
                    && parameters.Length == 1
                    && (
                        TypeHelper.AreTypesCompatible(parameters[0].ParameterType, typeof(Argument))
                        || TypeHelper.AreTypesCompatible(
                            parameters[0].ParameterType,
                ...
                {
                    return TryConvertLocationReference<TResult>(
                        methodCallExpressionBody,
                        throwOnError,
                        out result
                    );
                ...
                {
                    return TryConvertMethodCallExpression<TResult>(
                        methodCallExpressionBody,
                        throwOnError,
                        out result
                    );
            ...
            {
                return TryConvertInvocationExpression<TResult>(
            ...
            {
                return TryConvertNewArrayExpression<TResult>(
                    newArrayExpression,
                    throwOnError,
                    out result
                );
        ...
        public static bool TryConvertReference<TResult>(
            Expression<Func<ActivityContext, TResult>> expression,
            out Activity<Location<TResult>> result
        )
        {
            if (expression == null)
            {
        ...
        )
        {
            ...
            if (memberExpressionBody != null)
            {
                Type memberType =
                    memberExpressionBody.Expression == null
                        ? memberExpressionBody.Member.DeclaringType
                        : memberExpressionBody.Expression.Type;
                return TryConvertReferenceMemberExpression<TResult>(
                    memberExpressionBody,
                    memberType,
                    throwOnError,
                    out result
            ...
            if (binaryExpressionBody != null)
            {
                ...
                if (binaryExpressionBody.NodeType == ExpressionType.ArrayIndex)
                {
                    return TryConvertArrayItemReference<TResult>(
                        binaryExpressionBody,
                        leftType,
                        rightType,
                        throwOnError,
            ...
            if (methodCallExpressionBody != null)
            {
                ...
                {
                    return TryConvertMultiDimensionalArrayItemReference<TResult>(
                        methodCallExpressionBody,
                        throwOnError,
                        out result
                    );
                ...
                {
                    return TryConvertIndexerReference(
                        methodCallExpressionBody,
                        throwOnError,
                        out result
                    );
                ...
                {
                    return TryConvertVariableReference<TResult>(
                        methodCallExpressionBody,
                        throwOnError,
                        out result
                    );
                ...
                {
                    return TryConvertArgumentReference<TResult>(
                        methodCallExpressionBody,
                        throwOnError,
                        out result
                    );
                ...
                {
                    return TryConvertDelegateArgumentReference<TResult>(
                        methodCallExpressionBody,
                        throwOnError,
                        out result
                    );
                ...
                {
                    return TryConvertReferenceLocationReference<TResult>(
                        methodCallExpressionBody,
                        throwOnError,
                        out result
                    );
        ...
        static string TryConvertIndexerReference<TResult>(
            MethodCallExpression methodCallExpressionBody,
            bool throwOnError,
            out Activity<Location<TResult>> result
        )
        {
            ...
            try
            {
                ...
                MethodInfo specializedHandle = TryConvertIndexerReferenceHandle.MakeGenericMethod(
                    methodCallExpressionBody.Object.Type,
                    typeof(TResult)
                );
        ...
        )
        {
            ...
            if (!typeof(TOperand).IsValueType)
            {
                ...
                string operandError = TryConvert<TOperand>(
                    methodCallExpressionBody.Object,
                    throwOnError,
                    out operand
                );
                ...
                IndexerReference<TOperand, TResult> indexerReference = new IndexerReference<
                    TOperand,
                    TResult
                >
                {
                ...
                string argumentError = TryConvertArguments(
                    methodCallExpressionBody.Arguments,
                    indexerReference.Indices,
                    methodCallExpressionBody.GetType(),
                    1,
                    null,
                    throwOnError
                );
            ...
            else
            {
                ...
                string operandError = TryConvertReference<TOperand>(
                    methodCallExpressionBody.Object,
                    throwOnError,
                    out operandReference
                );
                if (operandError != null)
                {
                    return operandError;
                }
                ValueTypeIndexerReference<TOperand, TResult> indexerReference =
                    new ValueTypeIndexerReference<TOperand, TResult>
                    {
        ...
        )
        {
            ...
            string errorString = TryConvert<Array>(
            ...
            MultidimensionalArrayItemReference<TResult> reference =
                new MultidimensionalArrayItemReference<TResult>
                {
        ...
        )
        {
            ...
            if (methodCallExpression.Object is MemberExpression)
            {
                ...
                if (member.Expression is ConstantExpression)
                {
                    ...
                    if (member.Member is FieldInfo)
                    {
                        ...
                        Fx.Assert(
                            variableObject != null,
                            "Linq generated expression tree should be correct"
                        );
            ...
            Fx.Assert(
                variableObject is Variable<TResult>,
                "Linq generated expression tree should be correct"
            );
            result = new VariableReference<TResult> { Variable = variableObject };
            return null;
        ...
        )
        {
            ...
            if (leftType.GetElementType() != typeof(TResult))
            {
                ...
                {
                    return SR.DoNotSupportArrayIndexerReferenceWithDifferentArrayTypeAndResultType(
                        leftType,
                        typeof(TResult)
                    );
                }
            ...
            string arrayError = TryConvert<TResult[]>(
        ...
        )
        {
            ...
            try
            {
                Expression<Func<DelegateArgument>> funcExpression = Expression.Lambda<
                    Func<DelegateArgument>
                >(methodCallExpression.Object);
        ...
        static string TryConvertArgumentValue<TResult>(
            MemberExpression memberExpression,
            bool throwOnError,
            out Activity<TResult> result
        )
        {
            ...
            if (
                ...
                && TypeHelper.AreTypesCompatible(memberExpression.Type, typeof(RuntimeArgument))
            )
            {
                RuntimeArgument ra = null;
                try
                {
                    Expression<Func<RuntimeArgument>> expr = Expression.Lambda<
                        Func<RuntimeArgument>
                    >(memberExpression, null);
        ...
        static string TryConvertBinaryExpression<TResult>(
            BinaryExpression binaryExpressionBody,
            Type leftType,
            Type rightType,
            bool throwOnError,
            out Activity<TResult> result
        )
        {
            try
            {
                MethodInfo specializedHandle = TryConvertBinaryExpressionHandle.MakeGenericMethod(
                    leftType,
                    rightType,
                    typeof(TResult)
                );
        ...
        )
        {
            ...
            if (!TypeHelper.AreTypesCompatible(leftType.GetElementType(), typeof(TResult)))
            {
                ...
                {
                    return SR.DoNotSupportArrayIndexerValueWithIncompatibleArrayTypeAndResultType(
                        leftType,
                        typeof(TResult)
                    );
                }
        ...
        )
        {
            ...
            string rightError = TryConvert<TRight>(
                binaryExpressionBody.Right,
                throwOnError,
                out right
            );
            if (rightError != null)
            ...
            {
                return TryConvertOverloadingBinaryOperator<TLeft, TRight, TResult>(
                    binaryExpressionBody,
                    left,
                    right,
                    throwOnError,
            ...
            switch (binaryExpressionBody.NodeType)
            {
                case ExpressionType.Add:
                    result = new Add<TLeft, TRight, TResult>()
                    {
                        Left = leftArgument,
                        Right = rightArgument,
                        Checked = false,
                ...
                case ExpressionType.Subtract:
                    result = new Subtract<TLeft, TRight, TResult>()
                    {
                        Left = leftArgument,
                        Right = rightArgument,
                        Checked = false,
                ...
                case ExpressionType.Multiply:
                    result = new Multiply<TLeft, TRight, TResult>()
                    {
                        Left = leftArgument,
                        Right = rightArgument,
                        Checked = false,
        ...
        static string TryConvertUnaryExpression<TResult>(
            UnaryExpression unaryExpressionBody,
            Type operandType,
            bool throwOnError,
            out Activity<TResult> result
        )
        {
            try
            {
                MethodInfo specializedHandle = TryConvertUnaryExpressionHandle.MakeGenericMethod(
                    operandType,
                    typeof(TResult)
                );
        ...
        )
        {
            ...
            {
                return TryConvertOverloadingUnaryOperator<TOperand, TResult>(
                    unaryExpressionBody,
                    operand,
                    throwOnError,
                    out result
        ...
        static string TryConvertMemberExpression<TResult>(
            MemberExpression memberExpressionBody,
            Type operandType,
            bool throwOnError,
            out Activity<TResult> result
        )
        {
            try
            {
                MethodInfo specializedHandle = TryConvertMemberExpressionHandle.MakeGenericMethod(
                    operandType,
                    typeof(TResult)
                );
        ...
        static string TryConvertMemberExpressionWorker<TOperand, TResult>(
            MemberExpression memberExpressionBody,
            bool throwOnError,
            out Activity<TResult> result
        )
        {
            ...
            if (memberExpressionBody.Expression != null)
            {
                ...
                string operandError = TryConvert<TOperand>(
                    memberExpressionBody.Expression,
                    throwOnError,
                    out operand
                );
                if (operandError != null)
            ...
            {
                return SR.UnsupportedMemberExpressionWithType(
                    memberExpressionBody.Member.GetType().Name
                );
            }
        }

        static string TryConvertReferenceMemberExpression<TResult>(
            MemberExpression memberExpressionBody,
            Type operandType,
            bool throwOnError,
            out Activity<Location<TResult>> result
        )
        {
            try
            {
                MethodInfo specializedHandle =
                    TryConvertReferenceMemberExpressionHandle.MakeGenericMethod(
                        operandType,
                        typeof(TResult)
                    );
                object[] parameters = new object[] { memberExpressionBody, throwOnError, null };
        ...
        static string TryConvertReferenceMemberExpressionWorker<TOperand, TResult>(
            MemberExpression memberExpressionBody,
            bool throwOnError,
            out Activity<Location<TResult>> result
        )
        ...
        )
        {
            ...
            if (methodCallExpression.Arguments.Count != parameterInfoArray.Length) //no optional argument call for LINQ expression
            {
                ...
                {
                    return SR.ArgumentNumberRequiresTheSameAsParameterNumber(
                        methodCallExpression.GetType().Name
                    );
                }
            }

            string error = TryConvertArguments(
                methodCallExpression.Arguments,
            ...
            else
            {
                ...
                error =
                    TryConvertArgumentExpressionHandle
                        .MakeGenericMethod(methodCallExpression.Object.Type)
        ...
        static string TryConvertInvocationExpression<TResult>(
        ...
        )
        {
            ...
            if (
                ...
                || invocationExpression.Expression.Type == null
            )
            {
                if (throwOnError)
                {
            ...
            string error =
                TryConvertArgumentExpressionHandle
                    .MakeGenericMethod(invocationExpression.Expression.Type)
                    .Invoke(null, parameters) as string;
            if (error != null)
            {
                return error;
        ...
        static string TryConvertArgumentExpressionWorker<TArgument>(
            ...
            bool isByRef,
            bool throwOnError,
            out System.Activities.Argument result
        )
        {
            result = null;
        ...
        static string TryConvertArguments(
            ReadOnlyCollection<Expression> source,
            IList target,
            Type expressionType,
            int baseEvaluationOrder,
        ...
        )
        {
            ...
            if (expression.NodeType != ExpressionType.Constant)
            {
                ...
                {
                    return SR.UnexpectedExpressionNodeType(
                        ExpressionType.Constant.ToString(),
                        expression.NodeType.ToString()
                    );
                }
            ...
            else if (typeof(DelegateArgument).IsAssignableFrom(valueType))
            {
                ...
                result = new DelegateArgumentValue<TResult> { DelegateArgument = delegateArgument };
            }
