    ...
    public abstract class CodeActivity<TResult> : Activity<TResult>
    {
        ...
        internal sealed override void OnInternalCacheMetadataExceptResult(bool createEmptyBindings)
        {
            ...
            if (
                ...
                (
                    this.RuntimeArguments.Count == 1
                    && this.RuntimeArguments[0].Name == Argument.ResultValue
                )
            )
            {
                this.SkipArgumentResolution = true;
        ...
        {
            Fx.Assert(
                this.SkipArgumentResolution,
                "This method should only be called if SkipArgumentResolution is true"
            );
