...
namespace System.Xaml.Hosting
{
    ...
    sealed class XamlHttpHandlerFactory : IHttpHandlerFactory
    {
        ...
        )
        {
            ...
            PathInfo pathInfo = PathCache.EnsurePathInfo(
        ...
        class PathInfo
        {
            ...
            IHttpHandler GetHandlerFirstTime(
                HttpContext context,
                string requestType,
                string url,
                string pathTranslated
            )
            {
                ...
                {
                    this.hostedXamlType = GetCompiledCustomString(
                        context.Request.AppRelativeCurrentExecutionFilePath
                    );
                }
                ...
                )
                {
                    ...
                    {
                        TD.HttpHandlerPickedForUrl(
                            url,
                            hostedXamlType.FullName,
                    ...
                    {
                        IHttpHandlerFactory factory = (IHttpHandlerFactory)CreateInstance(
                            httpHandlerType
                        );
                        this.cachedResult = factory;
                        IHttpHandler handler = factory.GetHandler(
                            context,
                            requestType,
                            url,
                            pathTranslated
                    ...
                    {
                        configException = new ConfigurationErrorsException(
                            SR.NotHttpHandlerType(
                                url,
                                this.hostedXamlType,
                                httpHandlerType.FullName
                            )
                ...
                configException = new ConfigurationErrorsException(
                    SR.HttpHandlerForXamlTypeNotFound(
                        url,
                        this.hostedXamlType,
            ...
            IHttpHandler GetHandlerSubSequent(
                HttpContext context,
                string requestType,
                string url,
                string pathTranslated
