    ...
    class SchemaExporter
    {
        ...
        void ExportISerializableDataContract(ClassDataContract dataContract, XmlSchema schema)
        {
            ...
            if (dataContract.BaseContract != null)
            {
                XmlSchemaComplexContentExtension extension = CreateTypeContent(
                    type,
                    dataContract.BaseContract.StableName,
                    schema
                );
            }
            else
            ...
            if (hasRoot)
            {
                ...
                else if (DiagnosticUtility.ShouldTraceVerbose)
                {
                    TraceUtility.Trace(
                        ...
                        TraceCode.XsdExportAnnotationFailed,
                        SR.GetString(SR.TraceCodeXsdExportAnnotationFailed),
                        new StringTraceRecord("Type", typeQName.Namespace + ":" + typeQName.Name)
                    );
                }
            }
        }
                    ...
                    if (otherItem != null)
                    {
                        if (DiagnosticUtility.ShouldTraceWarning)
                        {
                            ...
                            TraceUtility.Trace(
                                ...
                                TraceCode.XsdExportDupItems,
                                SR.GetString(SR.TraceCodeXsdExportDupItems),
        ...
        static bool InvokeSchemaProviderMethod(
            Type clrType,
            XmlSchemaSet schemas,
            out XmlQualifiedName stableName,
            out XmlSchemaType xsdType,
        ...
        static void InvokeGetSchemaMethod(
            Type clrType,
            XmlSchemaSet schemas,
        ...
        XmlSchemaAnnotation GetSchemaAnnotation(
        ...
        XmlElement GetAnnotationMarkup(
            XmlQualifiedName annotationQualifiedName,
            string innerText,
            XmlSchema schema
        )
        ...
        {
            [Fx.Tag.SecurityNote(
                Critical = "Fetches the critical anytypeQualifiedName field.",
        ...
        {
            [Fx.Tag.SecurityNote(
                Critical = "Fetches the critical stringQualifiedName field.",
                Safe = "Get-only properties only needs to be protected for write; initialized in getter if null."
            )]
            [SecuritySafeCritical]
            get
        ...
        {
            [Fx.Tag.SecurityNote(
                Critical = "Fetches the critical defaultEnumBaseTypeName field.",
                Safe = "Get-only properties only needs to be protected for write; initialized in getter if null."
            )]
            [SecuritySafeCritical]
            get
        ...
        {
            [Fx.Tag.SecurityNote(
                Critical = "Fetches the critical enumerationValueAnnotationName field.",
                Safe = "Get-only properties only needs to be protected for write; initialized in getter if null."
            )]
            [SecuritySafeCritical]
            get
        ...
        {
            [Fx.Tag.SecurityNote(
                Critical = "Fetches the critical surrogateDataAnnotationName field.",
                Safe = "Get-only properties only needs to be protected for write; initialized in getter if null."
            )]
            [SecuritySafeCritical]
            get
        ...
        {
            [Fx.Tag.SecurityNote(
                Critical = "Fetches the critical defaultValueAnnotation field.",
                Safe = "Get-only properties only needs to be protected for write; initialized in getter if null."
            )]
            [SecuritySafeCritical]
            get
        ...
        {
            [Fx.Tag.SecurityNote(
                Critical = "Fetches the critical actualTypeAnnotationName field.",
                Safe = "Get-only properties only needs to be protected for write; initialized in getter if null."
            )]
            [SecuritySafeCritical]
            get
        ...
        {
            [Fx.Tag.SecurityNote(
                Critical = "Fetches the critical isDictionaryAnnotationName field.",
                Safe = "Get-only properties only needs to be protected for write; initialized in getter if null."
            )]
            [SecuritySafeCritical]
            get
        ...
        {
            [Fx.Tag.SecurityNote(
                Critical = "Fetches the critical isValueTypeName field.",
                Safe = "Get-only properties only needs to be protected for write; initialized in getter if null."
            )]
            [SecuritySafeCritical]
            get
