...
namespace System.Runtime.Serialization.Json
{
    ...
    // ASSUMPTION (Microsoft): This class will only be used for EITHER reading OR writing.  It can be
    // done, it would just mean more buffers.
...
#pragma warning suppress 56503 // The contract for non seekable stream is to throw exception
        ...
        static SupportedEncoding ReadEncoding(byte b1, byte b2)
        {
            ...
            else if (b1 == 0x00 && b2 == 0x00)
            {
                ...
                throw DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                    new XmlException(SR.GetString(SR.JsonInvalidBytes))
                );
            }
            else
            {
