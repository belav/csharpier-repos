    ...
    public class XsdDataContractImporter
    {
        ...
        public XmlQualifiedName Import(XmlSchemaSet schemas, XmlSchemaElement element)
        {
            ...
            InternalImport(
                ...
                emptyTypeNameArray,
                SingleElementArray,
                SingleTypeNameArray /*filled on return*/
            );
...
#pragma warning suppress 56506 // Code Exporter will never be null
        ...
        [Fx.Tag.SecurityNote(
            Critical = "Critical because it calls the security critical method CodeExporter.Export(..).",
        ...
        void InternalImport(
            ...
            XmlQualifiedName[] elementTypeNames /*filled on return*/
        )
        {
            if (DiagnosticUtility.ShouldTraceInformation)
            {
                TraceUtility.Trace(
                    ...
                    TraceCode.XsdImportBegin,
                    SR.GetString(SR.TraceCodeXsdImportBegin)
                );
            }
            ...
            try
            {
                SchemaImporter schemaImporter = new SchemaImporter(
                    ...
                    typeNames,
                    elements,
                    elementTypeNames /*filled on return*/
                    ,
                    DataContractSet,
                    ImportXmlDataType
                );
            ...
            if (DiagnosticUtility.ShouldTraceInformation)
            {
                TraceUtility.Trace(
                    TraceEventType.Information,
                    TraceCode.XsdImportEnd,
                    SR.GetString(SR.TraceCodeXsdImportEnd)
                );
            }
        }
        ...
        {
            get { return this.Options == null ? false : this.Options.ImportXmlType; }
        }
        ...
        void TraceImportError(Exception exception)
        {
            if (DiagnosticUtility.ShouldTraceError)
            {
                TraceUtility.Trace(
                    ...
                    TraceCode.XsdImportError,
                    SR.GetString(SR.TraceCodeXsdImportError),
                    null,
                    exception
                );
            }
