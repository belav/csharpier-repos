...
namespace System.Runtime.Serialization.Json
{
...
#else
    internal class XmlObjectSerializerWriteContextComplexJson
...
#endif
    {
            ...
            if (!string.IsNullOrEmpty(dataContractNamespace))
            {
                ...
                )
                {
                    return string.Concat(
                        "#",
                        dataContractNamespace.Substring(
        ...
        )
        {
            ...
            if (
                emitXsiType == EmitTypeInformation.Always
                && !perCallXsiTypeAlreadyEmitted
...
#if USE_REFEMIT
        public static void WriteJsonNameWithMapping(
            XmlWriterDelegator xmlWriter,
        ...
        void HandleCollectionAssignedToObject(
            Type declaredType,
        ...
        )
        {
            ...
            )
            {
                ...
                if (((CollectionDataContract)dataContract).Kind == CollectionKind.Dictionary)
                {
                    ...
                    Dictionary<object, object> genericDictionaryObj =
