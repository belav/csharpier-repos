...
namespace System.Runtime.Serialization
{
    ...
    public delegate void XmlFormatCollectionWriterDelegate(
        XmlWriterDelegator xmlWriter,
        object obj,
        XmlObjectSerializerWriteContext context,
        ...
        partial class CriticalHelper
        {
            ...
            void WriteClass(ClassDataContract classContract)
            {
                ...
                else
                {
                    ...
                    {
                        contractNamespacesLocal = ilg.DeclareLocal(
                    ...
                    memberNamesLocal = ilg.DeclareLocal(
                        typeof(XmlDictionaryString[]),
                        "memberNames"
                    );
                    ilg.Load(dataContractArg);
                    ...
                    for (int i = 0; i < classContract.ChildElementNamespaces.Length; i++)
                    {
                        ...
                        {
                            childElementNamespacesLocal = ilg.DeclareLocal(
                                typeof(XmlDictionaryString[]),
            ...
            {
                LocalBuilder itemNamespace = ilg.DeclareLocal(
                    typeof(XmlDictionaryString),
                    "itemNamespace"
                );
                ilg.Load(dataContractArg);
