...
namespace System.Runtime.Serialization
{
...
#endif
    {
        ...
        void InitCollectionDataContract(DataContract sharedTypeContract)
        {
            ...
            if (
                helper.Kind == CollectionKind.Dictionary
                || helper.Kind == CollectionKind.GenericDictionary
            )
            {
                    ...
                    lock (this)
                    {
                        if (helper.XmlFormatWriterDelegate == null)
                        {
                            XmlFormatCollectionWriterDelegate tempDelegate =
                                new XmlFormatWriterGenerator().GenerateCollectionWriter(this);
                            Thread.MemoryBarrier();
                    ...
                    lock (this)
                    {
                        if (helper.XmlFormatReaderDelegate == null)
                        {
                            ...
                            XmlFormatCollectionReaderDelegate tempDelegate =
                                new XmlFormatReaderGenerator().GenerateCollectionReader(this);
                            Thread.MemoryBarrier();
        ...
        {
            [Fx.Tag.SecurityNote(
                Critical = "Fetches the critical xmlFormatGetOnlyCollectionReaderDelegate property.",
            ...
            get
            {
                if (helper.XmlFormatGetOnlyCollectionReaderDelegate == null)
                {
                    lock (this)
                    {
                        ...
                        {
                            if (
                                this.UnderlyingType.IsInterface
                                && (
                                    this.Kind == CollectionKind.Enumerable
                                    || this.Kind == CollectionKind.Collection
                                    || this.Kind == CollectionKind.GenericEnumerable
                                )
                            )
                            {
                            ...
                            Fx.Assert(
                                this.AddMethod != null || this.Kind == CollectionKind.Array,
                                "Add method cannot be null if the collection is being used as a get-only property"
                            );
                            XmlFormatGetOnlyCollectionReaderDelegate tempDelegate =
                                new XmlFormatReaderGenerator().GenerateGetOnlyCollectionReader(
                                    this
                                );
                            Thread.MemoryBarrier();
        ...
        [Fx.Tag.SecurityNote(
            Critical = "Holds all state used for (de)serializing collections. Since the data is cached statically, we lock down access to it."
        )]
        ...
        class CollectionDataContractCriticalHelper : DataContract.DataContractCriticalHelper
        {
            ...
            CollectionKind kind;
            readonly MethodInfo getEnumeratorMethod,
                addMethod;
            readonly ConstructorInfo constructor;
            readonly string serializationExceptionMessage,
                deserializationExceptionMessage;
            DataContract itemContract;
                ...
                if (type.GetArrayRank() > 1)
                    throw System.Runtime.Serialization.DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                        new NotSupportedException(
                            SR.GetString(SR.SupportForMultidimensionalArraysNotPresent)
                        )
                    );
                ...
                get
                {
                    if (itemContract == null && UnderlyingType != null)
                    {
                        if (IsDictionary)
                        {
                            ...
                            itemContract = ClassDataContract.CreateClassDataContractForKeyValue(
                                ItemType,
                                Namespace,
        ...
        static bool IsCollectionHelper(
            Type type,
            out Type itemType,
            bool constructorRequired,
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage(
            ...
            Justification = "Private code."
        )]
        static bool IsCollectionOrTryCreate(
            Type type,
            bool tryCreate,
            out DataContract dataContract,
            out Type itemType,
        ...
        )
        {
            ...
            string serializationExceptionMessage = null,
                deserializationExceptionMessage = null;
                    ...
                    if (knownInterfaces[i] == interfaceTypeToCheck)
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    addMethod = Globals.TypeOfIList.GetMethod(
        ...
        static bool HandleIfInvalidCollection(
            Type type,
            bool tryCreate,
        ...
        static void GetReadOnlyCollectionExceptionMessages(
            Type type,
            bool hasCollectionDataContract,
            string message,
            string param,
        ...
        )
        {
            ...
            deserializationExceptionMessage = GetInvalidCollectionMessage(
                message,
                SR.GetString(
                    SR.ReadOnlyCollectionDeserialization,
                    DataContract.GetClrTypeFullName(type)
                ),
                param
            );
        ...
        static string GetInvalidCollectionMessage(
            string message,
        ...
        {
            return (param == null)
                ? SR.GetString(message, nestedMessage)
                : SR.GetString(message, nestedMessage, param);
        }
        ...
        )
        {
            ...
            boundCollectionContract.StableName = CreateQualifiedName(
                DataContract.ExpandGenericParameters(
                    XmlConvert.DecodeName(this.StableName.Name),
                ...
                IsCollectionDataContract(UnderlyingType)
                    ...
                    : DataContract.GetCollectionNamespace(
                        boundCollectionContract.ItemContract.StableName.Namespace
                    )
            );
        ...
        [Fx.Tag.SecurityNote(
            Miscellaneous = "RequiresReview - Calculates whether this collection requires MemberAccessPermission for deserialization."
        ...
        [Fx.Tag.SecurityNote(
            Miscellaneous = "RequiresReview - Calculates whether this collection requires MemberAccessPermission for serialization."
                + " Since this information is used to determine whether to give the generated code access"
                + " permissions to private members, any changes to the logic should be reviewed."
        )]
