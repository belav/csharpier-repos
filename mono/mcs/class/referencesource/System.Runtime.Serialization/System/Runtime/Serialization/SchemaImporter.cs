...
namespace System.Runtime.Serialization
{
    ...
    class SchemaImporter
    {
        ...
        [Fx.Tag.SecurityNote(
            Critical = "Static field used to store serialization schema elements from future versions."
...
#pragma warning suppress 56500 // covered by FxCOP
            catch (Exception ex)
            {
                ...
                throw System.Runtime.Serialization.DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                    new ArgumentException(SR.GetString(SR.CannotImportInvalidSchemas), ex)
                );
            }
            ...
            if (typeNames == null)
            {
                ...
                foreach (object schemaObj in schemaList)
                {
                    if (schemaObj == null)
                        throw System.Runtime.Serialization.DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                            new ArgumentException(SR.GetString(SR.CannotImportNullSchema))
                        );

                    XmlSchema schema = (XmlSchema)schemaObj;
                    if (
                        schema.TargetNamespace != Globals.SerializationNamespace
            ...
            else
            {
                foreach (XmlQualifiedName typeName in typeNames)
                {
                    if (typeName == null)
                        throw System.Runtime.Serialization.DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                            new ArgumentException(SR.GetString(SR.CannotImportNullDataContractName))
                        );
                    ImportType(typeName);
                }
                ...
                if (elements != null)
                {
                    ...
                    foreach (XmlSchemaElement element in elements)
                    {
                        ...
                        {
                            XmlSchema schema = SchemaHelper.GetSchemaWithGlobalElementDeclaration(
                                element,
                                schemaSet
                            );
                            if (schema == null)
                            {
                                elementTypeNames[i++] = ImportAnonymousElement(
                                    element,
                                    element.QualifiedName
                                ).StableName;
                            }
                            ...
                            {
                                elementTypeNames[i++] = ImportAnonymousGlobalElement(
                                    element,
                                    element.QualifiedName,
                                    schema.TargetNamespace
                                ).StableName;
        ...
        internal static bool IsObjectContract(DataContract dataContract)
        {
            ...
            while (dataContract is CollectionDataContract)
            {
                ...
                {
                    previousCollectionTypes.Add(
                        dataContract.OriginalUnderlyingType,
                        dataContract.OriginalUnderlyingType
                    );
                    dataContract = ((CollectionDataContract)dataContract).ItemContract;
                }
            ...
            return dataContract is PrimitiveDataContract
                && ((PrimitiveDataContract)dataContract).UnderlyingType == Globals.TypeOfObject;
        }
        ...
        void ImportKnownTypesForObject()
        {
            ...
            if (dataContractSet.KnownTypesForObject == null)
            {
                SchemaObjectInfo schemaObjectInfo;
                if (
                    SchemaObjects.TryGetValue(
                        SchemaExporter.AnytypeQualifiedName,
                        out schemaObjectInfo
                    )
                )
                {
                    List<XmlSchemaType> knownTypes = schemaObjectInfo.knownTypes;
                    if (knownTypes != null)
                    {
                        ...
                        foreach (XmlSchemaType knownType in knownTypes)
                        {
                            ...
                            if (
                                !knownDataContracts.TryGetValue(
        ...
        internal SchemaObjectDictionary CreateSchemaObjects()
        {
            ...
            schemaObjects.Add(
                SchemaExporter.AnytypeQualifiedName,
                new SchemaObjectInfo(null, null, null, knownTypesForObject)
            );
                ...
                if (schema.TargetNamespace != Globals.SerializationNamespace)
                {
                    foreach (XmlSchemaObject schemaObj in schema.SchemaTypes.Values)
                    {
                        ...
                        if (schemaType != null)
                        {
                            ...
                            XmlQualifiedName currentTypeName = new XmlQualifiedName(
                                schemaType.Name,
                                schema.TargetNamespace
                            );
                            SchemaObjectInfo schemaObjectInfo;
                            ...
                            else
                            {
                                schemaObjects.Add(
                                    currentTypeName,
                                    new SchemaObjectInfo(schemaType, null, schema, null)
                                );
                            }
                            ...
                            if (baseTypeName != null)
                            {
                                ...
                                {
                                    baseTypeInfo = new SchemaObjectInfo(
                                        null,
                                        null,
                                        null,
                                        new List<XmlSchemaType>()
                                    );
                    ...
                    foreach (XmlSchemaObject schemaObj in schema.Elements.Values)
                    {
                        ...
                        {
                            XmlQualifiedName currentElementName = new XmlQualifiedName(
                                schemaElement.Name,
                                schema.TargetNamespace
                            );
                            SchemaObjectInfo schemaObjectInfo;
                            ...
                            else
                            {
                                schemaObjects.Add(
                                    currentElementName,
                                    new SchemaObjectInfo(null, schemaElement, schema, null)
                                );
                            }
                        }
                    }
        ...
        DataContract ImportAnonymousElement(XmlSchemaElement element, XmlQualifiedName typeQName)
        {
            if (SchemaHelper.GetSchemaType(SchemaObjects, typeQName) != null)
            {
                for (int i = 1; ; i++)
                {
                    typeQName = new XmlQualifiedName(
                        typeQName.Name + i.ToString(NumberFormatInfo.InvariantInfo),
                        typeQName.Namespace
                    );
                    if (SchemaHelper.GetSchemaType(SchemaObjects, typeQName) == null)
                        break;
        ...
        DataContract ImportType(XmlSchemaType type, XmlQualifiedName typeName, bool isAnonymous)
        {
                ...
                foreach (XmlSchemaRedefine redefine in RedefineList)
                {
                    if (redefine.SchemaTypes[typeName] != null)
                        ThrowTypeCannotBeImportedException(
                            typeName.Name,
                            typeName.Namespace,
                            SR.GetString(SR.RedefineNotSupported)
                        );
                }
                ...
                if (type is XmlSchemaSimpleType)
                {
                    ...
                    if (content is XmlSchemaSimpleTypeUnion)
                        ThrowTypeCannotBeImportedException(
                            typeName.Name,
                            typeName.Namespace,
                            SR.GetString(SR.SimpleTypeUnionNotSupported)
                        );
                    else if (content is XmlSchemaSimpleTypeList)
                        dataContract = ImportFlagsEnum(
                            typeName,
                            (XmlSchemaSimpleTypeList)content,
                    ...
                    else
                    {
                        ...
                        if (contentModel is XmlSchemaSimpleContent)
                            ThrowTypeCannotBeImportedException(
                                typeName.Name,
                                typeName.Namespace,
                                SR.GetString(SR.SimpleContentNotSupported)
                            );
                        else if (contentModel is XmlSchemaComplexContent)
                        {
                            ...
                            if (complexContent.IsMixed)
                                ThrowTypeCannotBeImportedException(
                                    typeName.Name,
                                    typeName.Namespace,
                                    SR.GetString(SR.MixedContentNotSupported)
                                );

                            if (complexContent.Content is XmlSchemaComplexContentExtension)
                            {
                                XmlSchemaComplexContentExtension extension =
                                    (XmlSchemaComplexContentExtension)complexContent.Content;
                                dataContract = ImportType(
                                    typeName,
                                    extension.Particle,
                            ...
                            else if (complexContent.Content is XmlSchemaComplexContentRestriction)
                            {
                                XmlSchemaComplexContentRestriction restriction =
                                    (XmlSchemaComplexContentRestriction)complexContent.Content;
                                ...
                                if (baseTypeName == SchemaExporter.AnytypeQualifiedName)
                                    ...
                                    ThrowTypeCannotBeImportedException(
                                        typeName.Name,
                                        typeName.Namespace,
                                        SR.GetString(SR.ComplexTypeRestrictionNotSupported)
                                    );
                            }
                        }
                    }
            ...
            Type referencedType;
            if (
                dataContractSet.TryGetReferencedType(typeName, dataContract, out referencedType)
                || (
                    string.IsNullOrEmpty(type.Name)
                    && dataContractSet.TryGetReferencedType(
                        ImportActualType(type.Annotation, typeName, typeName),
                        dataContract,
                        out referencedType
                    )
                )
        ...
        bool CheckIfEnum(XmlSchemaSimpleTypeRestriction restriction)
        {
            ...
            {
                return (
                    (restriction.BaseTypeName == expectedBase && restriction.Facets.Count > 0)
                    || ImportType(restriction.BaseTypeName) is EnumDataContract
                );
            }
            else if (restriction.BaseType != null)
            {
                ...
                return (
                    baseContract.StableName == expectedBase || baseContract is EnumDataContract
                );
            }
        ...
        bool CheckIfCollection(XmlSchemaSequence rootSequence)
        {
            ...
            return (
                localElement.MaxOccursString == Globals.OccursUnbounded
                || localElement.MaxOccurs > 1
            );
        }

        bool CheckIfISerializable(
            XmlSchemaSequence rootSequence,
        ...
        void RemoveOptionalUnknownSerializationElements(XmlSchemaObjectCollection items)
        {
            for (int i = 0; i < items.Count; i++)
            {
                ...
                )
                {
                    ...
                    {
                        XmlSchema serializationSchema = XmlSchema.Read(
                            XmlReader.Create(new StringReader(Globals.SerializationSchema)),
                            null
                        );
        ...
        DataContract ImportType(
            ...
            XmlSchemaParticle rootParticle,
            XmlSchemaObjectCollection attributes,
        ...
        )
        {
            ...
            if (rootParticle == null)
                ...
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.GetString(SR.RootParticleMustBeSequence)
                );
            else
            {
                ...
                if (rootSequence.MinOccurs != 1)
                    ThrowTypeCannotBeImportedException(
                        typeName.Name,
                        typeName.Namespace,
                        SR.GetString(SR.RootSequenceMustBeRequired)
                    );
                if (rootSequence.MaxOccurs != 1)
                    ThrowTypeCannotBeImportedException(
                        typeName.Name,
                        typeName.Namespace,
                        SR.GetString(SR.RootSequenceMaxOccursMustBe)
                    );

                if (!isDerived && CheckIfCollection(rootSequence))
                    dataContract = ImportCollection(
                        typeName,
                        rootSequence,
                        attributes,
                        annotation,
                    ...
                    dataContract = ImportISerializable(
                        typeName,
                        rootSequence,
                        baseTypeName,
                        attributes,
                ...
                if (dataContract.BaseContract.IsISerializable)
                {
                    if (IsISerializableDerived(typeName, rootSequence))
                        ...
                        ThrowTypeCannotBeImportedException(
                            ...
                            SR.GetString(
                                SR.DerivedTypeNotISerializable,
                                baseTypeName.Name,
                ...
                for (int memberIndex = 0; memberIndex < rootSequence.Items.Count; memberIndex++)
                {
                    ...
                    if (element == null)
                        ThrowTypeCannotBeImportedException(
                            typeName.Name,
                            typeName.Namespace,
                            SR.GetString(SR.MustContainOnlyLocalElements)
                        );
        ...
        [SecuritySafeCritical]
        DataContract ImportXmlDataType(
            XmlQualifiedName typeName,
        ...
        )
        {
            ...
            else
            {
                ...
                if (DiagnosticUtility.ShouldTraceVerbose)
                {
                    TraceUtility.Trace(
                        ...
                        TraceCode.XsdImportAnnotationFailed,
                        SR.GetString(SR.TraceCodeXsdImportAnnotationFailed),
                        new StringTraceRecord("Type", typeName.Namespace + ":" + typeName.Name)
                    );
                }
            }
            if (!isAnonymous)
            {
                ...
                xmlDataContract.SetTopLevelElementName(
                    SchemaHelper.GetGlobalElementDeclaration(schemaSet, typeName, out isNullable)
                );
        ...
        private XmlDataContract ImportSpecialXmlDataType(XmlSchemaType xsdType, bool isAnonymous)
        {
            ...
            if (IsXmlAnyElementType(complexType))
            {
                ...
                XmlQualifiedName xlinqTypeName = new XmlQualifiedName(
                    "XElement",
                    "http://schemas.datacontract.org/2004/07/System.Xml.Linq"
                );
                Type referencedType;
                if (
                    dataContractSet.TryGetReferencedType(xlinqTypeName, null, out referencedType)
        ...
        bool IsXmlAnyElementType(XmlSchemaComplexType xsdType)
        {
            ...
            if (
                xsdType.AnyAttribute != null
                || (xsdType.Attributes != null && xsdType.Attributes.Count > 0)
            )
                return false;
        ...
        {
            string isValueTypeInnerText = GetInnerText(
                typeName,
                ImportAnnotation(annotation, SchemaExporter.IsValueTypeName)
            );
            if (isValueTypeInnerText != null)
            {
                ...
                catch (FormatException fe)
                {
                    ThrowTypeCannotBeImportedException(
                        ...
                        typeName.Namespace,
                        SR.GetString(
                            SR.IsValueTypeFormattedIncorrectly,
        ...
        [SecuritySafeCritical]
        ClassDataContract ImportISerializable(
            XmlQualifiedName typeName,
            XmlSchemaSequence rootSequence,
            XmlQualifiedName baseTypeName,
            XmlSchemaObjectCollection attributes,
            ...
            else
            {
                ...
                if (!IsISerializableDerived(typeName, rootSequence))
                    ThrowISerializableTypeCannotBeImportedException(
                        typeName.Name,
                        typeName.Namespace,
                        SR.GetString(SR.ISerializableDerivedContainsOneOrMoreItems)
                    );
            }
        ...
        )
        {
            if (rootSequence == null)
                ThrowISerializableTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.GetString(SR.ISerializableDoesNotContainAny)
                );
            ...
            if (rootSequence.Items == null || rootSequence.Items.Count < 1)
                ...
                ThrowISerializableTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.GetString(SR.ISerializableContainsMoreThanOneItems)
                );
            ...
            if (wildcard.MinOccurs != iSerializableWildcardElement.MinOccurs)
                ThrowISerializableTypeCannotBeImportedException(
                    ...
                    typeName.Namespace,
                    SR.GetString(
                        SR.ISerializableWildcardMinOccursMustBe,
            ...
            if (wildcard.MaxOccursString != iSerializableWildcardElement.MaxOccursString)
                ThrowISerializableTypeCannotBeImportedException(
                    ...
                    typeName.Namespace,
                    SR.GetString(
                        SR.ISerializableWildcardMaxOccursMustBe,
            ...
            if (wildcard.Namespace != iSerializableWildcardElement.Namespace)
                ThrowISerializableTypeCannotBeImportedException(
                    ...
                    typeName.Namespace,
                    SR.GetString(
                        SR.ISerializableWildcardNamespaceInvalid,
            ...
            if (wildcard.ProcessContents != iSerializableWildcardElement.ProcessContents)
                ThrowISerializableTypeCannotBeImportedException(
                    ...
                    typeName.Namespace,
                    SR.GetString(
                        SR.ISerializableWildcardProcessContentsInvalid,
            ...
            if (!containsFactoryTypeAttribute)
                ThrowISerializableTypeCannotBeImportedException(
                    ...
                    typeName.Namespace,
                    SR.GetString(
                        SR.ISerializableMustRefFactoryTypeAttribute,
                        factoryTypeAttributeRefName.Name,
                        factoryTypeAttributeRefName.Namespace
                    )
                );
        }
        ...
        {
            return (
                rootSequence == null || rootSequence.Items == null || rootSequence.Items.Count == 0
            );
        }

        [Fx.Tag.SecurityNote(
            Critical = "Sets critical BaseContract property on ClassDataContract.",
            Safe = "Called during schema import/code generation."
        )]
        [SecuritySafeCritical]
        void ImportBaseContract(XmlQualifiedName baseTypeName, ClassDataContract dataContract)
        {
            ...
            if (baseContract == null)
                ThrowTypeCannotBeImportedException(
                    ...
                    dataContract.StableName.Namespace,
                    SR.GetString(
                        dataContract.IsISerializable
                            ? SR.InvalidISerializableDerivation
                            : SR.InvalidClassDerivation,
                        baseTypeName.Name,
                        baseTypeName.Namespace
                    )
                );
        ...
        {
            XmlSchemaElement topLevelElement = SchemaHelper.GetSchemaElement(
                SchemaObjects,
                typeName
            );
            ...
            else
            {
                ...
                if (elementTypeName != typeName)
                    ThrowTypeCannotBeImportedException(
                        ...
                        typeName.Namespace,
                        SR.GetString(
                            SR.TopLevelElementRepresentsDifferentType,
                            topLevelElement.SchemaTypeName.Name,
                            topLevelElement.SchemaTypeName.Namespace
                        )
                    );
        ...
        void ImportClassMember(XmlSchemaElement element, ClassDataContract dataContract)
        {
            ...
            if (element.MinOccurs > 1)
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.GetString(SR.ElementMinOccursMustBe, element.Name)
                );
            if (element.MaxOccurs != 1)
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.GetString(SR.ElementMaxOccursMustBe, element.Name)
                );
            ...
            XmlSchemaForm elementForm =
                (element.Form == XmlSchemaForm.None)
                    ? SchemaHelper
                        .GetSchemaWithType(SchemaObjects, schemaSet, typeName)
                        .ElementFormDefault
                    : element.Form;
            if (elementForm != XmlSchemaForm.Qualified)
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.GetString(SR.FormMustBeQualified, element.Name)
                );
            ...
            {
                if (element.SchemaType != null)
                    memberTypeContract = ImportAnonymousElement(
                        element,
                    ...
                    ThrowTypeCannotBeImportedException(
                        ...
                        typeName.Namespace,
                        SR.GetString(
                            SR.ElementRefOnLocalElementNotSupported,
            ...
            {
                XmlQualifiedName memberTypeName = ImportActualType(
                    element.Annotation,
            ...
            bool? emitDefaultValueFromAnnotation = ImportEmitDefaultValue(
                element.Annotation,
                typeName
            );
            if (!memberTypeContract.IsValueType && !memberIsNullable)
            {
                ...
                memberEmitDefaultValue =
                    emitDefaultValueFromAnnotation != null
                        ? emitDefaultValueFromAnnotation.Value
            ...
            if (prevMemberIndex >= 0)
            {
                ...
                DataMember currentMember = new DataMember(
                    memberTypeContract,
                    memberName,
                    memberIsNullable,
                    memberIsRequired,
                ...
                if (compare == 0)
                    ThrowTypeCannotBeImportedException(
                        typeName.Name,
                        typeName.Namespace,
                        SR.GetString(SR.CannotHaveDuplicateElementNames, memberName)
                    );
                else if (compare > 0)
                    memberOrder = dataContract.Members.Count;
            }
            ...
            XmlQualifiedName surrogateDataAnnotationName =
                SchemaExporter.SurrogateDataAnnotationName;
            dataContractSet.SetSurrogateData(
                dataMember,
                ImportSurrogateData(
                    ImportAnnotation(element.Annotation, surrogateDataAnnotationName),
                    surrogateDataAnnotationName.Name,
                    surrogateDataAnnotationName.Namespace
                )
            );
        ...
        {
            XmlElement defaultValueElement = ImportAnnotation(
                annotation,
        ...
        {
            XmlElement actualTypeElement = ImportAnnotation(
                annotation,
                SchemaExporter.ActualTypeAnnotationName
            );
        ...
        [SecuritySafeCritical]
        CollectionDataContract ImportCollection(
            XmlQualifiedName typeName,
            XmlSchemaSequence rootSequence,
            XmlSchemaObjectCollection attributes,
            XmlSchemaAnnotation annotation,
        ...
        )
        {
            ...
            XmlSchemaForm elementForm =
                (element.Form == XmlSchemaForm.None)
                    ...
                    : element.Form;
            if (elementForm != XmlSchemaForm.Qualified)
                ThrowArrayTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.GetString(SR.ArrayItemFormMustBe, element.Name)
                );
            CheckIfElementUsesUnsupportedConstructs(typeName, element);
            ...
            if (element.SchemaTypeName.IsEmpty)
            {
                if (element.SchemaType != null)
                {
                    XmlQualifiedName shortName = new XmlQualifiedName(
                        element.Name,
                        typeName.Namespace
                    );
                    ...
                    {
                        XmlQualifiedName fullName = new XmlQualifiedName(
                            String.Format(
                                CultureInfo.InvariantCulture,
                                "{0}.{1}Type",
                                typeName.Name,
            ...
            if (IsDictionary(typeName, annotation))
            {
                ...
                DataMember key = null,
                    value = null;
                if (
                    keyValueContract == null
                    || keyValueContract.Members == null
                    || keyValueContract.Members.Count != 2
                    || !(key = keyValueContract.Members[0]).IsRequired
                    || !(value = keyValueContract.Members[1]).IsRequired
                )
                {
                    ThrowArrayTypeCannotBeImportedException(
                        typeName.Name,
                        typeName.Namespace,
                        SR.GetString(SR.InvalidKeyValueType, element.Name)
                    );
                }
                if (keyValueContract.Namespace != dataContract.Namespace)
                {
                    ThrowArrayTypeCannotBeImportedException(
                        ...
                        typeName.Namespace,
                        SR.GetString(
                            SR.InvalidKeyValueTypeNamespace,
                            element.Name,
                ...
                if (element.SchemaType != null)
                {
                    ...
                    GenericInfo genericInfo = new GenericInfo(
                        DataContract.GetStableName(Globals.TypeOfKeyValue),
                        Globals.TypeOfKeyValue.FullName
                    );
                    ...
                    dataContract.ItemContract.StableName = new XmlQualifiedName(
                        genericInfo.GetExpandedStableName().Name,
                        typeName.Namespace
                    );
                }
            }
        ...
        {
            string isDictionaryInnerText = GetInnerText(
                typeName,
                ImportAnnotation(annotation, SchemaExporter.IsDictionaryAnnotationName)
            );
            if (isDictionaryInnerText != null)
            {
                ...
                catch (FormatException fe)
                {
                    ThrowTypeCannotBeImportedException(
                        ...
                        typeName.Namespace,
                        SR.GetString(
                            SR.IsDictionaryFormattedIncorrectly,
        ...
        EnumDataContract ImportFlagsEnum(
            XmlQualifiedName typeName,
        ...
        )
        {
            ...
            if (anonymousType == null)
                ThrowEnumTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.GetString(SR.EnumListMustContainAnonymousType)
                );
            ...
            if (content is XmlSchemaSimpleTypeUnion)
                ThrowEnumTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.GetString(SR.EnumUnionInAnonymousTypeNotSupported)
                );
            else if (content is XmlSchemaSimpleTypeList)
                ThrowEnumTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.GetString(SR.EnumListInAnonymousTypeNotSupported)
                );
            else if (content is XmlSchemaSimpleTypeRestriction)
            {
                XmlSchemaSimpleTypeRestriction restriction =
                ...
                if (CheckIfEnum(restriction))
                    ...
                    ThrowEnumTypeCannotBeImportedException(
                        typeName.Name,
                        typeName.Namespace,
                        SR.GetString(SR.EnumRestrictionInvalid)
                    );
            }
            return null;
        }
        ...
        [Fx.Tag.SecurityNote(
            Critical = "Sets critical properties on EnumDataContract.",
            Safe = "Called during schema import/code generation."
        )]
        [SecuritySafeCritical]
        ...
        )
        {
            ...
            dataContract.StableName = typeName;
            dataContract.BaseContractName = ImportActualType(
                annotation,
                SchemaExporter.DefaultEnumBaseTypeName,
                typeName
            );
            ...
            foreach (XmlSchemaFacet facet in restriction.Facets)
            {
                ...
                if (enumFacet == null)
                    ThrowEnumTypeCannotBeImportedException(
                        typeName.Name,
                        typeName.Namespace,
                        SR.GetString(SR.EnumOnlyEnumerationFacetsSupported)
                    );
                if (enumFacet.Value == null)
                    ThrowEnumTypeCannotBeImportedException(
                        typeName.Name,
                        typeName.Namespace,
                        SR.GetString(SR.EnumEnumerationFacetsMustHaveValue)
                    );

                string valueInnerText = GetInnerText(
                    typeName,
                    ImportAnnotation(
                        enumFacet.Annotation,
        ...
        DataContract ImportSimpleTypeRestriction(
            XmlQualifiedName typeName,
            XmlSchemaSimpleTypeRestriction restriction
        )
        {
            ...
            if (!restriction.BaseTypeName.IsEmpty)
                ...
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.GetString(SR.SimpleTypeRestrictionDoesNotSpecifyBase)
                );
            ...
            foreach (XmlSchemaObject schemaObject in type.Annotation.Items)
            {
                ...
                if (appInfo.Markup != null)
                {
                    foreach (XmlNode xmlNode in appInfo.Markup)
                    {
                        ...
                        if (
                            typeElement != null
                            && typeElement.NamespaceURI == surrogateDataAnnotationName.Namespace
                            && typeElement.LocalName == surrogateDataAnnotationName.Name
                        )
                        {
                            object surrogateData = ImportSurrogateData(
                                typeElement,
                                surrogateDataAnnotationName.Name,
                                surrogateDataAnnotationName.Namespace
                            );
        ...
        [Fx.Tag.SecurityNote(
            Critical = "Sets critical properties on DataContract.",
            Safe = "Called during schema import/code generation."
        )]
        [SecuritySafeCritical]
            ...
            foreach (XmlSchemaObject schemaObject in type.Annotation.Items)
            {
                ...
                if (appInfo.Markup != null)
                {
                    foreach (XmlNode xmlNode in appInfo.Markup)
                    {
                        ...
                        if (
                            typeElement != null
                            && typeElement.NamespaceURI == Globals.SerializationNamespace
                        )
                        {
        ...
        object ImportSurrogateData(XmlElement typeElement, string name, string ns)
        {
            if (dataContractSet.DataContractSurrogate != null && typeElement != null)
            {
                ...
                DataContractSurrogateCaller.GetKnownCustomDataTypes(
        ...
        void CheckComplexType(XmlQualifiedName typeName, XmlSchemaComplexType type)
        {
            if (type.IsAbstract)
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.GetString(SR.AbstractTypeNotSupported)
                );
            if (type.IsMixed)
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
        ...
        void CheckIfElementUsesUnsupportedConstructs(
            XmlQualifiedName typeName,
            XmlSchemaElement element
        )
        {
            if (element.IsAbstract)
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.GetString(SR.AbstractElementNotSupported, element.Name)
                );
            if (element.DefaultValue != null)
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.GetString(SR.DefaultOnElementNotSupported, element.Name)
                );
            if (element.FixedValue != null)
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.GetString(SR.FixedOnElementNotSupported, element.Name)
                );
            if (!element.SubstitutionGroup.IsEmpty)
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.GetString(SR.SubstitutionGroupOnElementNotSupported, element.Name)
                );
        }
        ...
        )
        {
            if (anyAttribute != null)
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.GetString(SR.AnyAttributeNotSupported)
                );
                ...
                for (int i = 0; i < attributes.Count; i++)
                {
                    ...
                    if (o is XmlSchemaAttribute)
                    {
                        ...
                        if (
                            ...
                            continue;
                        if (
                            attribute.RefName.IsEmpty
                            || attribute.RefName.Namespace != Globals.SerializationNamespace
                            ...
                            ThrowTypeCannotBeImportedException(
                                ...
                                typeName.Namespace,
                                SR.GetString(
                                    SR.TypeShouldNotContainAttributes,
                                    Globals.SerializationNamespace
                                )
                            );
                    }
        ...
        )
        {
            ...
            if (foundAttribute)
                ThrowTypeCannotBeImportedException(
                    typeName.Name,
                    typeName.Namespace,
                    SR.GetString(SR.CannotHaveDuplicateAttributeNames, refName.Name)
                );
            foundAttribute = true;
            return true;
        }
                ...
                while (child != null)
                {
                    if (child.NodeType == XmlNodeType.Element)
                        ThrowTypeCannotBeImportedException(
                            ...
                            typeName.Namespace,
                            SR.GetString(
                                SR.InvalidAnnotationExpectingText,
        ...
        {
            ThrowTypeCannotBeImportedException(
                SR.GetString(SR.TypeCannotBeImported, name, ns, message)
            );
        }
        ...
        {
            ThrowTypeCannotBeImportedException(
                SR.GetString(SR.ArrayTypeCannotBeImported, name, ns, message)
            );
        }
        ...
        {
            ThrowTypeCannotBeImportedException(
                SR.GetString(SR.EnumTypeCannotBeImported, name, ns, message)
            );
        }

        static void ThrowISerializableTypeCannotBeImportedException(
            string name,
            string ns,
            string message
        )
        {
            ThrowTypeCannotBeImportedException(
                SR.GetString(SR.ISerializableTypeCannotBeImported, name, ns, message)
            );
        }
        ...
        static void ThrowTypeCannotBeImportedException(string message)
        {
            throw System.Runtime.Serialization.DiagnosticUtility.ExceptionUtility.ThrowHelperError(
                new InvalidDataContractException(
                    SR.GetString(SR.TypeCannotBeImportedHowToFix, message)
                )
            );
        }
    }
