...
namespace System.Runtime.Serialization
{
    ...
    {
        [Fx.Tag.SecurityNote(
            Miscellaneous = "RequiresReview - XmlDictionaryString(s) representing the XML namespaces for class members."
        ...
        [Fx.Tag.SecurityNote(
            Miscellaneous = "RequiresReview - XmlDictionaryString(s) representing the XML element names for class members."
                + "statically cached and used from IL generated code. should ideally be Critical."
                + "marked SecurityNode to be callable from transparent IL generated code."
                + "not changed to property to avoid regressing performance; any changes to initalization should be reviewed."
        )]
        ...
        {
            [Fx.Tag.SecurityNote(
                Critical = "Sets the critical childElementNamespaces property.",
                ...
                if (this.childElementNamespaces == null)
                {
                    lock (this)
                    {
                        if (this.childElementNamespaces == null)
                        {
                            ...
                            {
                                XmlDictionaryString[] tempChildElementamespaces =
        ...
        {
            [Fx.Tag.SecurityNote(
                Critical = "Fetches the critical serializationExceptionMessage property.",
        ...
        {
            [Fx.Tag.SecurityNote(
                Critical = "Fetches the critical deserializationExceptionMessage property.",
            ...
            get
            {
                if (helper.XmlFormatWriterDelegate == null)
                {
                    lock (this)
                    {
                        if (helper.XmlFormatWriterDelegate == null)
                        {
                            XmlFormatClassWriterDelegate tempDelegate =
                                new XmlFormatWriterGenerator().GenerateClassWriter(this);
                            Thread.MemoryBarrier();
                ...
                if (helper.XmlFormatReaderDelegate == null)
                {
                    lock (this)
                    {
                        if (helper.XmlFormatReaderDelegate == null)
                        {
                            ...
                            XmlFormatClassReaderDelegate tempDelegate =
                                new XmlFormatReaderGenerator().GenerateClassReader(this);
                            Thread.MemoryBarrier();
        ...
        internal static ClassDataContract CreateClassDataContractForKeyValue(
            Type type,
        ...
        )
        {
            ...
            if (
                !childType.IsEnum
                && !Globals.TypeOfIXmlSerializable.IsAssignableFrom(childType)
                && DataContract.GetBuiltInDataContract(childType) == null
                && childType != Globals.TypeOfDBNull
            )
            {
        ...
        [Fx.Tag.SecurityNote(
            Miscellaneous = "RequiresReview - callers may need to depend on isNonAttributedType for a security decision."
        ...
        XmlDictionaryString[] CreateChildElementNamespaces()
        {
            ...
            int baseChildElementNamespaceCount =
                (baseChildElementNamespaces != null) ? baseChildElementNamespaces.Length : 0;
            XmlDictionaryString[] childElementNamespaces = new XmlDictionaryString[
                Members.Count + baseChildElementNamespaceCount
            ];
            if (baseChildElementNamespaceCount > 0)
                Array.Copy(
                    ...
                    0,
                    baseChildElementNamespaces.Length
                );
            ...
            for (int i = 0; i < this.Members.Count; i++)
            {
                childElementNamespaces[i + baseChildElementNamespaceCount] =
                    GetChildNamespaceToDeclare(this, this.Members[i].MemberType, dictionary);
            }
        ...
        [Fx.Tag.SecurityNote(
            Miscellaneous = "RequiresReview - calculates whether this class requires MemberAccessPermission for deserialization."
        ...
        internal bool RequiresMemberAccessForRead(SecurityException securityException)
        {
            ...
            if (
                ...
                && this.BaseContract.RequiresMemberAccessForRead(securityException)
            )
                return true;
        ...
        [Fx.Tag.SecurityNote(
            Miscellaneous = "RequiresReview - calculates whether this class requires MemberAccessPermission for serialization."
                + " Since this information is used to determine whether to give the generated code access"
                + " permissions to private members, any changes to the logic should be reviewed."
        )]
        internal bool RequiresMemberAccessForWrite(SecurityException securityException)
        {
            ...
            if (
                this.BaseContract != null
                && this.BaseContract.RequiresMemberAccessForWrite(securityException)
            )
                return true;
        ...
        class ClassDataContractCriticalHelper : DataContract.DataContractCriticalHelper
        {
            ...
            [Fx.Tag.SecurityNote(
                Miscellaneous = "in serialization/deserialization we base the decision whether to Demand SerializationFormatter permission on this value and hasDataContract."
            )]
            bool isNonAttributedType;

            [Fx.Tag.SecurityNote(
                Miscellaneous = "in serialization/deserialization we base the decision whether to Demand SerializationFormatter permission on this value and isNonAttributedType."
            )]
                ...
                : base(type)
            {
                ...
                )
                {
                    ...
                    if (
                        this.BaseContract != null
                        && this.BaseContract.IsNonAttributedType
                    ...
                    else
                    {
                        if (BaseContract.IsReadOnlyContract)
                        {
                            this.serializationExceptionMessage =
                                BaseContract.SerializationExceptionMessage;
                        }
                        ...
                        Array.Copy(
                            BaseContract.ContractNamespaces,
                            ContractNamespaces,
                            baseContractCount
                        );
                    }
                ...
                : base(type)
            {
                this.StableName = new XmlQualifiedName(
                    GetStableNameAndSetHasDataContract(type).Name,
                    ns.Value
                );
                ImportDataMembers();
                        ...
                        if (memberAttributes != null && memberAttributes.Length > 0)
                        {
                            ...
                            if (member.MemberType == MemberTypes.Property)
                            {
                                ...
                                if (setMethod == null)
                                {
                                    if (
                                        !SetIfGetOnlyCollection(
                                            memberContract,
                                            skipIfReadOnlyContract: false
                                        )
                                    )
                                    {
                                        this.serializationExceptionMessage = SR.GetString(
                                ...
                                if (getMethod.GetParameters().Length > 0)
                                    ThrowInvalidDataContractException(
                                        SR.GetString(
                                            SR.IndexedPropertyCannotBeSerialized,
                                            property.DeclaringType,
                                            property.Name
                                        )
                                    );
                            ...
                            memberContract.IsNullable = DataContract.IsTypeNullable(
                    ...
                    else if (this.isNonAttributedType)
                    {
                        ...
                        if (memberAttributes != null && memberAttributes.Length > 0)
                        {
                            if (memberAttributes.Length > 1)
                                ThrowInvalidDataContractException(
                                    SR.GetString(
                                        SR.TooManyIgnoreDataMemberAttributes,
                                        DataContract.GetClrTypeFullName(member.DeclaringType),
                                        member.Name
                                    )
                                );
            ...
            void SetIfMembersHaveConflict(List<DataMember> members)
            {
                ...
                {
                    membersInHierarchy.Add(
                        new Member(member, this.StableName.Namespace, baseTypeIndex)
                    );
                }
                ...
                while (currContract != null)
                {
                    ...
                    {
                        membersInHierarchy.Add(
                            new Member(member, currContract.StableName.Namespace, baseTypeIndex)
                        );
                    }
                ...
                for (int i = 0; i < membersInHierarchy.Count - 1; i++)
                {
                    ...
                    while (
                        endIndex < membersInHierarchy.Count - 1
                        && String.CompareOrdinal(
                            membersInHierarchy[endIndex].member.Name,
                            membersInHierarchy[endIndex + 1].member.Name
                        ) == 0
                        && String.CompareOrdinal(
                            membersInHierarchy[endIndex].ns,
                            membersInHierarchy[endIndex + 1].ns
                        ) == 0
                    )
                    {
                        membersInHierarchy[endIndex].member.ConflictingMember = membersInHierarchy[
                            endIndex + 1
                        ].member;
                        if (!hasConflictingType)
                        {
                            ...
                            {
                                hasConflictingType = (
                                    membersInHierarchy[endIndex].member.MemberType
                                    != membersInHierarchy[endIndex + 1].member.MemberType
                                );
                            }
                        }
                        endIndex++;
                    ...
                    lock (this)
                    {
                        if (!isMethodChecked)
                        {
                            ...
                            for (int i = 0; i < methods.Length; i++)
                            {
                                ...
                                if (
                                    HasExtensionData
                                    && IsValidExtensionDataSetMethod(method, parameters)
                                )
                                {
                                    if (
                                        method.Name == Globals.ExtensionDataSetExplicitMethod
                                        || !method.IsPublic
                                    )
                                ...
                                if (
                                    IsValidCallback(
                                        method,
                                        parameters,
                                        Globals.TypeOfOnSerializedAttribute,
                                        onSerialized,
                                        ref prevAttributeType
                                    )
                                )
                                ...
                                if (
                                    IsValidCallback(
                                        method,
                                        parameters,
                                        Globals.TypeOfOnDeserializingAttribute,
                                        onDeserializing,
                                        ref prevAttributeType
                                    )
                                )
                                ...
                                if (
                                    IsValidCallback(
                                        method,
                                        parameters,
                                        Globals.TypeOfOnDeserializedAttribute,
                                        onDeserialized,
                                        ref prevAttributeType
                                    )
                                )
            ...
            bool IsValidExtensionDataSetMethod(MethodInfo method, ParameterInfo[] parameters)
            {
                if (
                    method.Name == Globals.ExtensionDataSetExplicitMethod
                    || method.Name == Globals.ExtensionDataSetMethod
                )
                {
                    if (extensionDataSetMethod != null)
                        ThrowInvalidDataContractException(
                            SR.GetString(
                                SR.DuplicateExtensionDataSetMethod,
                                method,
                                extensionDataSetMethod,
                    ...
                    if (method.ReturnType != Globals.TypeOfVoid)
                        DataContract.ThrowInvalidDataContractException(
                            SR.GetString(
                                SR.ExtensionDataSetMustReturnVoid,
                                DataContract.GetClrTypeFullName(method.DeclaringType),
                                method
                            ),
                    ...
                    if (
                        parameters == null
                        || parameters.Length != 1
                        || parameters[0].ParameterType != Globals.TypeOfExtensionDataObject
                    )
                        DataContract.ThrowInvalidDataContractException(
                            SR.GetString(
                                SR.ExtensionDataSetParameterInvalid,
                                DataContract.GetClrTypeFullName(method.DeclaringType),
                                method,
            ...
            )
            {
                if (method.IsDefined(attributeType, false))
                {
                    if (currentCallback != null)
                        ...
                        DataContract.ThrowInvalidDataContractException(
                            SR.GetString(
                                SR.CallbacksCannotBeVirtualMethods,
                                method,
                                DataContract.GetClrTypeFullName(method.DeclaringType),
                                attributeType
                            ),
                    ...
                    else
                    {
                        ...
                        if (
                            parameters == null
                            || parameters.Length != 1
                            || parameters[0].ParameterType != Globals.TypeOfStreamingContext
                        )
                            DataContract.ThrowInvalidDataContractException(
                                SR.GetString(
            ...
            internal ClassDataContract BaseContract
            {
                ...
                set
                {
                    ...
                    if (baseContract != null && IsValueType)
                        ThrowInvalidDataContractException(
                            SR.GetString(
                                SR.ValueTypeCannotHaveBaseType,
                                StableName.Name,
                                StableName.Namespace,
                                baseContract.StableName.Name,
                                baseContract.StableName.Namespace
                            )
                        );
                }
            }
                ...
                get
                {
                    if (!isKnownTypeAttributeChecked && UnderlyingType != null)
                    {
                        lock (this)
                        {
                            ...
                            {
                                knownDataContracts = DataContract.ImportKnownTypeAttributes(
                                    this.UnderlyingType
                                );
                                Thread.MemoryBarrier();
            ...
            internal string DeserializationExceptionMessage
            {
                get
                {
                    ...
                    {
                        return SR.GetString(
                            SR.ReadOnlyClassDeserialization,
                            this.serializationExceptionMessage
                        );
                    }
                }
            ...
            internal class DataMemberConflictComparer : IComparer<Member>
            {
                ...
                internal static DataMemberConflictComparer Singleton =
                    new DataMemberConflictComparer();
            }
        }
            ...
            if (base.Equals(other, checkedContracts))
            {
                ...
                if (dataContract != null)
                {
                    ...
                    else
                    {
                        ...
                        {
                            Dictionary<string, DataMember> membersDictionary = new Dictionary<
                                string,
                                DataMember
                            >(Members.Count);
                            ...
                            for (int i = 0; i < dataContract.Members.Count; i++)
                            {
                                ...
                                if (
                                    membersDictionary.TryGetValue(
                                        dataContract.Members[i].Name,
                                        out dataMember
                                    )
                                )
                                {
                                    if (
                                        dataMember.Equals(dataContract.Members[i], checkedContracts)
                                    )
                                    {
