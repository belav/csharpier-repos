...
namespace System.Runtime.Serialization
{
    ...
    public delegate object XmlFormatCollectionReaderDelegate(
        XmlReaderDelegator xmlReader,
        XmlObjectSerializerReadContext context,
    ...
    public delegate void XmlFormatGetOnlyCollectionReaderDelegate(
        XmlReaderDelegator xmlReader,
        XmlObjectSerializerReadContext context,
        XmlDictionaryString itemName,
        XmlDictionaryString itemNamespace,
...
#endif
    {
        ...
        partial class CriticalHelper
        {
            ...
            public XmlFormatClassReaderDelegate GenerateClassReader(ClassDataContract classContract)
            {
                ...
                {
                    ilg.BeginMethod(
                        "Read" + classContract.StableName.Name + "FromXml",
                        Globals.TypeOfXmlFormatClassReaderDelegate,
                        memberAccessFlag
                    );
                }
            ...
            {
                ilg = GenerateCollectionReaderHelper(
                    collectionContract,
            ...
            )
            {
                ...
                try
                {
                    ...
                    {
                        ilg.BeginMethod(
                            "Read" + collectionContract.StableName.Name + "FromXml" + "IsGetOnly",
                            Globals.TypeOfXmlFormatGetOnlyCollectionReaderDelegate,
                            memberAccessFlag
                        );
                    }
                    else
                    {
                        ilg.BeginMethod(
                            "Read" + collectionContract.StableName.Name + "FromXml" + string.Empty,
                            Globals.TypeOfXmlFormatCollectionReaderDelegate,
                            memberAccessFlag
                        );
                    }
                }
            ...
            void CreateObject(ClassDataContract classContract)
            {
                ...
                else
                {
                    ilg.Call(
                        null,
                        XmlFormatGeneratorStatics.GetUninitializedObjectMethod,
            ...
            void ReadMembers(ClassDataContract classContract, LocalBuilder extensionDataLocal)
            {
                ...
                LocalBuilder requiredIndexLocal = hasRequiredMembers
                    ? ilg.DeclareLocal(Globals.TypeOfInt, "requiredIndex", firstRequiredMember)
                    : null;
                ...
                if (hasRequiredMembers)
                    ilg.Call(
                        contextArg,
                        XmlFormatGeneratorStatics.GetMemberIndexWithRequiredMembersMethod,
                        xmlReaderArg,
                        memberNamesArg,
                        memberNamespacesArg,
                        memberIndexLocal,
                ...
                if (hasRequiredMembers)
                {
                    ...
                    ilg.Call(
                        null,
                        XmlFormatGeneratorStatics.ThrowRequiredMemberMissingExceptionMethod,
                        xmlReaderArg,
                        memberIndexLocal,
                        requiredIndexLocal,
                        memberNamesArg
            ...
            int ReadMembers(
                ...
                LocalBuilder requiredIndexLocal
            )
            {
                int memberCount =
            ...
            bool[] GetRequiredMembers(ClassDataContract contract, out int firstRequiredMember)
            {
                ...
                for (
                    ...
                    firstRequiredMember < memberCount;
                    firstRequiredMember++
                )
            ...
            void ReadCollection(CollectionDataContract collectionContract)
            {
                ...
                LocalBuilder value = ReadCollectionItem(
                    collectionContract,
                    itemType,
                    itemName,
                    itemNs
                ...
                IsStartElement(memberNamesArg, memberNamespacesArg);
                ilg.If();
                LocalBuilder itemValue = ReadCollectionItem(
                    collectionContract,
                    itemType,
                    itemName,
                    itemNs
            ...
            )
            {
                ...
                )
                {
                    ...
                    LocalBuilder pairValue = ilg.DeclareLocal(
            ...
            void IsStartElement(ArgBuilder nameArg, ArgBuilder nsArg)
            {
                ilg.Call(
                    xmlReaderArg,
                    XmlFormatGeneratorStatics.IsStartElementMethod2,
                    nameArg,
                    nsArg
                );
            }
...
#endif
        {
            return FormatterServices.GetUninitializedObject(
                DataContract.GetDataContractForInitialization(id).TypeForInitialization
            );
        }
    }
}
