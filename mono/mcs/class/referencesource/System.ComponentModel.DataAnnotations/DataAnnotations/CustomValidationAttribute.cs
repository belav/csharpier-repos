...
namespace System.ComponentModel.DataAnnotations
{
    ...
    public sealed class CustomValidationAttribute : ValidationAttribute
    {
        ...
        {
            get { return this._validatorType; }
        }
        ...
        private string ValidateValidatorTypeParameter()
        {
            ...
            if (!this._validatorType.IsVisible)
            {
                return String.Format(
                    CultureInfo.CurrentCulture,
                    DataAnnotationsResources.CustomValidationAttribute_Type_Must_Be_Public,
        ...
        private string ValidateMethodParameter()
        {
            ...
            if (methodInfo == null)
            {
                return String.Format(
                    CultureInfo.CurrentCulture,
                    DataAnnotationsResources.CustomValidationAttribute_Method_Not_Found,
                    this._method,
                    this._validatorType.Name
                );
            }
            ...
            if (methodInfo.ReturnType != typeof(ValidationResult))
            {
                return String.Format(
                    CultureInfo.CurrentCulture,
                    DataAnnotationsResources.CustomValidationAttribute_Method_Must_Return_ValidationResult,
                    this._method,
                    this._validatorType.Name
                );
            }
            ...
            if (parameterInfos.Length == 0 || parameterInfos[0].ParameterType.IsByRef)
            {
                return String.Format(
                    CultureInfo.CurrentCulture,
                    DataAnnotationsResources.CustomValidationAttribute_Method_Signature,
                    this._method,
                    this._validatorType.Name
                );
            }
