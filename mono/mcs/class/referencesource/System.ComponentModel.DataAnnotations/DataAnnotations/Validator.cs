...
namespace System.ComponentModel.DataAnnotations
{
    ...
    public static class Validator
    {
        ...
        )
        {
            ...
            IEnumerable<ValidationAttribute> attributes = _store.GetPropertyValidationAttributes(
                validationContext
            );

            foreach (
                ValidationError err in GetValidationErrors(
                    value,
                    validationContext,
                    attributes,
                    breakOnFirstError
        ...
        public static void ValidateProperty(object value, ValidationContext validationContext)
        {
            ...
            ValidationError err = GetValidationErrors(value, validationContext, attributes, false)
                .FirstOrDefault();
            if (err != null)
            {
        ...
        )
        {
            ...
            ValidationError err = GetObjectValidationErrors(
                    instance,
                    validationContext,
                    validateAllProperties,
                    false
        ...
        )
        {
            ...
            ValidationError err = GetValidationErrors(
                    value,
                    validationContext,
                    validationAttributes,
                    false
            ...
            if (!CanBeAssigned(propertyType, value))
            {
                throw new ArgumentException(
                    String.Format(
                        ...
                        DataAnnotationsResources.Validator_Property_Value_Wrong_Type,
                        propertyName,
                        propertyType
                    ),
                    "value"
        ...
        )
        {
            ...
            IEnumerable<ValidationAttribute> attributes = _store.GetTypeValidationAttributes(
                validationContext
            );
            errors.AddRange(
            ...
            if (validatable != null)
            {
                ...
                foreach (
                    ValidationResult result in results.Where(r => r != ValidationResult.Success)
                )
                {
        ...
        {
            ICollection<KeyValuePair<ValidationContext, object>> properties = GetPropertyValues(
                instance,
                validationContext
            );
            List<ValidationError> errors = new List<ValidationError>();
            ...
            foreach (KeyValuePair<ValidationContext, object> property in properties)
            {
                ...
                IEnumerable<ValidationAttribute> attributes =
                    _store.GetPropertyValidationAttributes(property.Key);
                ...
                else
                {
                    ...
                    RequiredAttribute reqAttr =
                        attributes.FirstOrDefault(a => a is RequiredAttribute) as RequiredAttribute;
                    if (reqAttr != null)
                    {
                        ...
                        ValidationResult validationResult = reqAttr.GetValidationResult(
                            property.Value,
                            property.Key
                        );
        ...
        )
        {
            ...
            List<KeyValuePair<ValidationContext, object>> items = new List<
                KeyValuePair<ValidationContext, object>
            >(properties.Count());
