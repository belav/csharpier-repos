...
namespace System.ComponentModel.DataAnnotations
{
    ...
    [SuppressMessage(
        ...
        Justification = "We want it to be accessible via method on parent."
    )]
    [SuppressMessage(
    ...
    public class RangeAttribute : ValidationAttribute
    {
        ...
        private void SetupConversion()
        {
            if (this.Conversion == null)
            {
                ...
                {
                    throw new InvalidOperationException(
                        DataAnnotationsResources.RangeAttribute_Must_Set_Min_And_Max
                    );
                }
                ...
                else
                {
                    ...
                    {
                        throw new InvalidOperationException(
                            DataAnnotationsResources.RangeAttribute_Must_Set_Operand_Type
                        );
                    }
