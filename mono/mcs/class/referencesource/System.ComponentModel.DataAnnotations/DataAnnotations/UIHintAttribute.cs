...
namespace System.ComponentModel.DataAnnotations
{
    ...
    public class UIHintAttribute : Attribute
    {
        ...
        {
            this._implementation = new UIHintImplementation(
                uiHint,
                presentationLayer,
                controlParameters
            );
        ...
        internal class UIHintImplementation
        {
            ...
            public override bool Equals(object obj)
            {
                ...
                if (
                    this.UIHint != otherImplementation.UIHint
                ...
                if (inputControlParameters.Length % 2 != 0)
                {
                    throw new InvalidOperationException(
                        String.Format(
                            ...
                            DataAnnotationsResources.UIHintImplementation_NeedEvenNumberOfControlParameters
                        )
                    );
                }
