namespace System.Workflow.ComponentModel.Design
{
    ...
    internal sealed class CustomActivityDesignerAdapter : IDisposable
    {
        ...
        public CustomActivityDesignerAdapter(IServiceProvider serviceProvider)
        {
            ...
            {
                componentChangeService.ComponentAdding += new ComponentEventHandler(
                    OnComponentAdding
                );
            ...
            if (designerHost != null)
            {
                if (designerHost.RootComponent == null)
                {
                    ...
                    if (rootActivity != null)
                    {
                        ...
                        DesignerAttribute rootDesignerAttrib = GetDesignerAttribute(
                            rootActivity,
                            typeof(IRootDesigner)
                        );
                        if (
                            rootDesignerAttrib.DesignerTypeName
                            == typeof(ActivityDesigner).AssemblyQualifiedName
                        )
                        {
                            DesignerAttribute designerAttrib = GetDesignerAttribute(
                                rootActivity,
                                typeof(IDesigner)
                            );
                            if (designerAttrib != null)
                                TypeDescriptor.AddAttributes(
                                    ...
                                    new Attribute[]
                                    {
                                        new DesignerAttribute(
                                            designerAttrib.DesignerTypeName,
                                            typeof(IRootDesigner)
                                        ),
                                    }
                                );
        ...
        private void OnComponentAdded(object sender, ComponentEventArgs eventArgs)
        {
            ...
            if (designerHost != null)
            {
                if (designerHost.RootComponent == eventArgs.Component)
                {
                    ...
                    if (rootActivity != null)
                    {
                        ...
                        if (compositeActivity != null)
                        {
                            if (this.ensureChildHierarchyHandler == null)
                            {
                                this.ensureChildHierarchyHandler = new EventHandler(
                                    OnEnsureChildHierarchy
                                );
                                Application.Idle += this.ensureChildHierarchyHandler;
                            }
                        }
                ...
                {
                    if (
                        (eventArgs.Component is CompositeActivity)
                        && Helpers.IsCustomActivity(eventArgs.Component as CompositeActivity)
                    )
                        (eventArgs.Component as Activity).UserData[UserDataKeys.CustomActivity] =
                            true;
                    else
                        (eventArgs.Component as Activity).UserData[UserDataKeys.CustomActivity] =
                            false;
        ...
        private static DesignerAttribute GetDesignerAttribute(
            object component,
        ...
        private static void EnsureDefaultChildHierarchy(IDesignerHost designerHost)
        {
            ...
            {
                object[] attribs = rootActivity
                    .GetType()
                    .GetCustomAttributes(typeof(ToolboxItemAttribute), false);
                ...
                if (toolboxItemAttrib != null && toolboxItemAttrib.ToolboxItemType != null)
                {
                    ToolboxItem item =
                        Activator.CreateInstance(
                            ...
                            new object[] { rootActivity.GetType() }
                        ) as ToolboxItem;
                    ...
                    if (compositeActivity != null && compositeActivity.Activities.Count > 0)
                    {
                        IIdentifierCreationService identifierCreationService =
                            designerHost.GetService(typeof(IIdentifierCreationService))
    ...
    internal sealed class CustomActivityPropertyExtender : IExtenderProvider
    {
        ...
        bool IExtenderProvider.CanExtend(object extendee)
        {
            ...
            if (
                activity != null
                && activity.Site != null
                && activity == Helpers.GetRootActivity(activity)
            )
            {
    ...
    internal static class CustomActivityDesignerHelper
    {
        ...
        public static void SetBaseTypeName(string typeName, IServiceProvider serviceProvider)
        {
            ...
            IMemberCreationService memberCreationService =
                serviceProvider.GetService(typeof(IMemberCreationService))
                as IMemberCreationService;
            if (memberCreationService == null)
                throw new InvalidOperationException(
                    SR.GetString("General_MissingService", typeof(IMemberCreationService).FullName)
                );
            ...
            {
                PropertyDescriptor supportsEventsPropDesc = TypeDescriptor.GetProperties(
                    host.RootComponent
                )["SupportsEvents"];
                if (
                    supportsEventsPropDesc != null
                    && ((bool)supportsEventsPropDesc.GetValue(host.RootComponent)) == true
                )
                    supportsEventsPropDesc.SetValue(host.RootComponent, false);

                PropertyDescriptor supportsExceptionsPropDesc = TypeDescriptor.GetProperties(
                    host.RootComponent
                )["SupportsExceptions"];
                if (
                    supportsExceptionsPropDesc != null
                    && ((bool)supportsExceptionsPropDesc.GetValue(host.RootComponent)) == true
                )
            ...
            if (
                host.RootComponent is CompositeActivity
                && ((CompositeActivity)host.RootComponent).Activities.Count > 0
            )
            {
                ...
                if (uiService != null)
                {
                    if (
                        ...
                        != uiService.ShowMessage(
                            SR.GetString(SR.NoChildActivities_Message),
                            SR.GetString(SR.NoChildActivities_Caption),
                ...
                List<Activity> activitiesToRemove = new List<Activity>(
                    ((CompositeActivity)host.RootComponent).Activities
                );
                CompositeActivityDesigner rootDesigner =
                    host.GetDesigner(host.RootComponent) as CompositeActivityDesigner;
            ...
            {
                if (
                    !propertyDescriptor.Name.Equals("BaseActivityType", StringComparison.Ordinal)
            ...
            PropertyDescriptor baseActivityTypePropertyDescriptor = TypeDescriptor.CreateProperty(
                realBaseActivityTypePropertyDescriptor.ComponentType,
                realBaseActivityTypePropertyDescriptor,
        ...
        private static Type ValidateBaseType(string typeName, IServiceProvider serviceProvider)
        {
            if (typeName != null && typeName.Length > 0)
            {
                ...
                if (
                    type is DesignTimeType
                    && rootComponentType != null
                    && rootComponentType.Assembly == type.Assembly
                )
                    throw new InvalidOperationException(
                        SR.GetString(SR.Error_CantUseCurrentProjectTypeAsBase)
                    );

                if (!TypeProvider.IsAssignable(typeof(Activity), type))
                    throw new InvalidOperationException(
                        SR.GetString(SR.Error_BaseTypeMustBeActivity)
                    );
        ...
        internal static List<CustomProperty> GetCustomProperties(IServiceProvider serviceProvider)
        {
            ...
            WorkflowDesignerLoader loader =
                serviceProvider.GetService(typeof(IDesignerLoaderService))
            ...
            PropertyInfo[] properties = customActivityType.GetProperties(
            ...
            EventInfo[] events = customActivityType.GetEvents(
                BindingFlags.DeclaredOnly | BindingFlags.Public | BindingFlags.Instance
            );
            foreach (EventInfo evt in events)
            {
                if (evt.EventHandlerType == null)
                    continue;
                CustomProperty eventProperty = CreateCustomProperty(
                    serviceProvider,
                    customActivityType,
                    evt,
        ...
        private static CustomProperty CreateCustomProperty(
        ...
        )
        {
            ...
            else
            {
                ...
                FieldInfo fieldInfo = customActivityType.GetField(
                    member.Name + fieldSuffix,
            ...
            object[] hiddenCodeAttributes = member.GetCustomAttributes(
            ...
            foreach (object attributeObj in member.GetCustomAttributes(false))
            {
                ...
                if (attributeInfo != null)
                {
                    ...
                    {
                        if (
                            attributeInfo.AttributeType == typeof(BrowsableAttribute)
                            && attributeInfo.ArgumentValues.Count > 0
                        )
                        {
                            customProperty.Browseable = (bool)
                                attributeInfo.GetArgumentValueAs(serviceProvider, 0, typeof(bool));
                        }
                        else if (
                            attributeInfo.AttributeType == typeof(CategoryAttribute)
                            && attributeInfo.ArgumentValues.Count > 0
                        )
                        {
                            customProperty.Category =
                                attributeInfo.GetArgumentValueAs(serviceProvider, 0, typeof(string))
                                as string;
                        }
                        else if (
                            attributeInfo.AttributeType == typeof(DescriptionAttribute)
                            && attributeInfo.ArgumentValues.Count > 0
                        )
                        {
                        ...
                        {
                            customProperty.DesignerSerializationVisibility =
                                (DesignerSerializationVisibility)
                                    attributeInfo.GetArgumentValueAs(
                                        serviceProvider,
                                        0,
                            ...
                            attributeInfo.AttributeType == typeof(EditorAttribute)
                            && attributeInfo.ArgumentValues.Count > 1
                        )
                        {
                            Type editorType =
                                attributeInfo.GetArgumentValueAs(serviceProvider, 1, typeof(Type))
                                as Type;
                            if (editorType == typeof(UITypeEditor))
                            {
                                Type uiTypeEditorType =
                                    attributeInfo.GetArgumentValueAs(
                                        serviceProvider,
                                        0,
                                        typeof(Type)
        ...
        internal static void SetCustomProperties(
        ...
        private static void RemoveDeletedProperties(
            List<CustomProperty> propCollection,
            Type customActivityType,
            IServiceProvider serviceProvider
        )
        {
            ...
            if (memberCreationService == null)
                throw new Exception(
                    SR.GetString(SR.General_MissingService, typeof(IMemberCreationService).FullName)
                );
            ...
            foreach (PropertyInfo property in properties)
            {
                ...
                {
                    if (
                        property.Name == customProperty.oldPropertyName
                ...
                if (!found)
                    memberCreationService.RemoveProperty(
                        customActivityType.FullName,
                        property.Name,
                        property.PropertyType
                    );
            }
            ...
            foreach (EventInfo evtInfo in events)
            {
                ...
                {
                    if (
                        evtInfo.Name == customProperty.oldPropertyName
                ...
                if (!found && evtInfo.Name != null && evtInfo.EventHandlerType != null)
                    memberCreationService.RemoveEvent(
                        customActivityType.FullName,
                        evtInfo.Name,
        ...
        private static void AddNewProperties(
            List<CustomProperty> propCollection,
            Type customActivityType,
            IServiceProvider serviceProvider,
            List<CustomProperty> existingProps
        )
        {
            IMemberCreationService memberCreationService =
                serviceProvider.GetService(typeof(IMemberCreationService))
            ...
            try
            {
                ...
                {
                    bool createNew = (
                        property.oldPropertyName == null || property.oldPropertyType == null
                    );
                    if (!createNew)
                    {
                        if (!property.IsEvent)
                            createNew = (
                                customActivityType.GetProperty(
                                    property.oldPropertyName,
                                    typeProvider.GetType(property.oldPropertyType)
                                ) == null
                            );
                        else
                            createNew = (
                                customActivityType.GetEvent(property.oldPropertyName) == null
                            );
                    }

                    if (createNew)
                    {
                        AttributeInfo[] attributes = CreateCustomPropertyAttributeArray(
                            property,
                            serviceProvider
                        );
                        if (property.IsEvent)
                            memberCreationService.CreateEvent(
                                customActivityType.FullName,
                                property.Name,
                                typeProvider.GetType(property.Type),
                                attributes,
                                property.GenerateDependencyProperty
                            );
                        else
                    ...
                    else
                    {
                        ...
                        {
                            if (
                                existingProperty.Name == property.oldPropertyName
                                && existingProperty.Type == property.oldPropertyType
                            )
                        ...
                        if (oldProperty == null || ArePropertiesDifferent(property, oldProperty))
                        {
                            ...
                            AttributeInfo[] oldAttributes = CreateCustomPropertyAttributeArray(
                                oldProperty,
                                serviceProvider
                            );

                            Type propertyType = typeProvider.GetType(property.Type, false);
                            Type oldPropertyType = typeProvider.GetType(
                            ...
                            {
                                if (property.IsEvent)
                                    memberCreationService.UpdateEvent(
                                        customActivityType.FullName,
                                        property.oldPropertyName,
                                        oldPropertyType,
                                        property.Name,
                                    ...
                                    memberCreationService.UpdateProperty(
                                        customActivityType.FullName,
                                        property.oldPropertyName,
                                        oldPropertyType,
                                        property.Name,
        ...
        )
        {
            ...
            if (property.Category != null)
                attributeList.Add(
                    new AttributeInfo(
                        ...
                        new string[] { },
                        new object[] { new CodePrimitiveExpression(property.Category) }
                    )
                );
            ...
            if (property.Description != null)
                attributeList.Add(
                    new AttributeInfo(
                        ...
                        new string[] { },
                        new object[] { new CodePrimitiveExpression(property.Description) }
                    )
                );
            ...
            attributeList.Add(
                new AttributeInfo(
                    ...
                    new string[] { },
                    new object[] { new CodePrimitiveExpression(property.Browseable) }
                )
            );
            attributeList.Add(
                new AttributeInfo(
                    ...
                    new object[]
                    {
                        new CodeSnippetExpression(
                            typeof(DesignerSerializationVisibility).Name
                                + "."
                                + property.DesignerSerializationVisibility.ToString()
                        ),
                    }
                )
            );
    ...
    internal sealed class BaseClassTypeFilterProvider : ITypeFilterProvider
    {
        ...
        {
            get { return SR.GetString(SR.CustomActivityBaseClassTypeFilterProviderDesc); }
        }
        #endregion
    }
    #endregion
    ...
    internal sealed class CustomProperty
    {
        ...
        private DesignerSerializationVisibility designerSerializationVisibility =
        ...
        {
            get { return this.browseable; }
            set { this.browseable = value; }
        }

        public DesignerSerializationVisibility DesignerSerializationVisibility
        {
            get { return this.designerSerializationVisibility; }
            set { this.designerSerializationVisibility = value; }
        }
        ...
        public bool IsEvent
        {
            get { return this.isEvent; }
            set { this.isEvent = value; }
        }
        ...
        {
            get { return this.generateDependencyProperty; }
            set { this.generateDependencyProperty = value; }
        }

        #region Private Helpers
        public static CustomProperty CreateCustomProperty(
            IServiceProvider serviceProvider,
        ...
        )
        {
            ...
            {
                Type baseType = PropertyDescriptorUtils.GetBaseType(
                    propertyDescriptor,
                    propertyOwner,
                    serviceProvider
                );
                if (baseType == null)
                    throw new InvalidOperationException(
                        SR.GetString(
                            SR.Error_CantDeterminePropertyBaseType,
            ...
            if (propertyDescriptor is ActivityBindPropertyDescriptor)
            {
                ...
                newCustomProperty.IsEvent = (
                    dependencyProperty != null && dependencyProperty.IsEvent
                );
            }
