...
namespace System.Workflow.ComponentModel.Design
{
    ...
    internal static class SecondaryViewProvider
    {
        ...
        )
        {
            ...
            string displayName = ActivityToolboxItem.GetToolboxDisplayName(
            ...
            viewTypes.Add(
                ...
                {
                    designer.Activity.GetType(),
                    DR.GetString(DR.ViewActivity, displayName),
                }
            );
            ...
            if (designer.Activity.Site != null)
            {
                WorkflowDesignerLoader loader =
                    designer.Activity.Site.GetService(typeof(WorkflowDesignerLoader))
                ...
                if (
                    ...
                    || (
                        ...
                        && (
                            !locked
                            || FindActivity(designer, typeof(CancellationHandlerActivity)) != null
                        )
                    )
                )
                    viewTypes.Add(
                        new object[]
                        {
                            ...
                            DR.GetString(DR.ViewCancelHandler),
                        }
                    );
                ...
                if (
                    ...
                    viewTypes.Add(
                        new object[]
                        {
                            ...
                            DR.GetString(DR.ViewExceptions),
                        }
                    );
                ...
                if (
                    loader == null
                    || (
                        designer.Activity is ICompensatableActivity
                        && typeof(CompositeActivity).IsAssignableFrom(activityType)
                        && (
                            !locked
                            || FindActivity(designer, typeof(CompensationHandlerActivity)) != null
                        )
                    )
                )
                    viewTypes.Add(
                        new object[]
                        {
                            ...
                            DR.GetString(DR.ViewCompensation),
                        }
                    );
                ...
                if (
                    ...
                    || (
                        ...
                        && (
                            !locked
                            || FindActivity(designer, Type.GetType(EventHandlersRef)) != null
                        )
                    )
                )
                    viewTypes.Add(
                        new object[] { Type.GetType(EventHandlersRef), DR.GetString(DR.ViewEvents) }
                    );
            }
            ...
            for (int i = 0; i < viewTypes.Count; i++)
            {
                ...
                DesignerView view = new SecondaryView(
                    designer,
                    i + 1,
                    viewTypes[i][1] as string,
                    viewType
                );
                views.Add(view);
            }
        ...
        internal static IList<Type> GetActivityTypes(StructuredCompositeActivityDesigner designer)
        {
            ...
            {
                Type activityType =
                    views[i].UserData[SecondaryView.UserDataKey_ActivityType] as Type;
    ...
    {
        internal static readonly Guid UserDataKey_ActivityType = new Guid(
            "03C4103A-D6E9-46e9-B98E-149E145EC2C9"
        );
        internal static readonly Guid UserDataKey_Designer = new Guid(
            "2B72C7F7-DE4A-4e32-8EB4-9E1ED1C5E84E"
        );

        private StructuredCompositeActivityDesigner parentDesigner;

        internal SecondaryView(
            StructuredCompositeActivityDesigner parentDesigner,
            int id,
            string text,
            Type activityType
        )
        ...
        public override ActivityDesigner AssociatedDesigner
        {
            get
            {
                ActivityDesigner mappedDesigner =
                    UserData[UserDataKey_Designer] as ActivityDesigner;
                if (mappedDesigner == null)
                {
                    ...
                    if (activityType != null)
                    {
                        ...
                        {
                            Activity activity = SecondaryViewProvider.FindActivity(
                                this.parentDesigner,
                                activityType
                            );
                            if (activity != null)
        ...
        public override void OnActivate()
        {
            ...
            try
            {
                CompositeActivityDesigner.InsertActivities(
                    this.parentDesigner,
                    new HitTestInfo(this.parentDesigner, HitTestLocations.Designer),
                    new List<Activity>(new Activity[] { activity }).AsReadOnly(),
                    SR.GetString(SR.AddingImplicitActivity)
                );
            }
            catch (Exception e)
            {
                if (e != CheckoutException.Canceled)
                {
                    IUIService uiService =
                        this.parentDesigner.Activity.Site.GetService(typeof(IUIService))
                        as IUIService;
                    if (uiService != null)
