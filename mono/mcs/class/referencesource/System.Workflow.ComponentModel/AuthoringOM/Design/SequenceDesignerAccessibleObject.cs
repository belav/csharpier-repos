    ...
    public class SequenceDesignerAccessibleObject : CompositeDesignerAccessibleObject
    {
        ...
        public override int GetChildCount()
        {
            ...
            if (sequentialActivityDesigner != null)
                return sequentialActivityDesigner.ContainedDesigners.Count
                    + sequentialActivityDesigner.ContainedDesigners.Count
                    + 1;
            else
                return -1;
        }
        ...
        public override AccessibleObject Navigate(AccessibleNavigation navdir)
        {
            ...
            )
            {
                ...
                {
                    object nextSelectableObj = compositeDesigner.GetNextSelectableObject(
        ...
        private sealed class SequentialConnectorAccessibleObject : AccessibleObject
        {
            ...
            internal SequentialConnectorAccessibleObject(
                SequentialActivityDesigner activityDesigner,
                int connectorIndex
            )
            {
                ...
                this.connectorHitInfo = new ConnectorHitTestInfo(
                    activityDesigner,
            ...
            public override string Description
            {
                ...
                {
                    return DR.GetString(
                        DR.ConnectorAccessibleDescription,
                        this.connectorHitInfo.GetType().Name
                    );
                }
            }
            ...
            {
                get { return this.connectorHitInfo.AssociatedDesigner.AccessibilityObject; }
            }
            ...
            public override AccessibleStates State
            {
                get
                {
                    ...
                    if (selectionService != null)
                    {
                        state |=
                            (
                                selectionService.GetComponentSelected(
                                    this.connectorHitInfo.SelectableObject
                                )
                            )
            ...
            public override AccessibleObject Navigate(AccessibleNavigation navdir)
            {
                ...
                if (nextSelectableObj is ConnectorHitTestInfo)
                {
                    ...
                    return new SequentialConnectorAccessibleObject(
                        nextConnector.AssociatedDesigner as SequentialActivityDesigner,
                        nextConnector.MapToIndex()
                    );
                }
                else if (nextSelectableObj is Activity)
                {
                    ActivityDesigner activityDesigner = ActivityDesigner.GetDesigner(
                        nextSelectableObj as Activity
                    );
                    if (activityDesigner != null)
