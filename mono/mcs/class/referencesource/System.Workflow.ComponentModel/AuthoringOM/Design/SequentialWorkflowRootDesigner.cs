...
namespace System.Workflow.ComponentModel.Design
{
    ...
    public class SequentialWorkflowRootDesigner : SequentialActivityDesigner
    {
        ...
        public override Size MinimumSize
        {
            get
            {
                ...
                minimumSize.Width = Math.Max(
                    minimumSize.Width,
                    SequentialWorkflowRootDesigner.MinSize.Width
                );
                ...
                if (IsRootDesigner && InvokingDesigner == null)
                {
                    minimumSize.Width = Math.Max(
                        minimumSize.Width,
                        ParentView.ViewPortSize.Width - 2 * WorkflowRootLayout.Separator.Width
                    );
                    minimumSize.Height = Math.Max(
                        minimumSize.Height,
                        ParentView.ViewPortSize.Height - 2 * WorkflowRootLayout.Separator.Height
                    );
                }
        ...
        {
            get { return base.InvokingDesigner; }
            set { base.InvokingDesigner = value; }
        }
        ...
        protected override ReadOnlyCollection<Point> GetInnerConnections(DesignerEdges edges)
        {
            ...
            if (connectionPoints.Count > 0 && Footer != null && (edges & DesignerEdges.Bottom) > 0)
                connectionPoints[connectionPoints.Count - 1] = new Point(
                    connectionPoints[connectionPoints.Count - 1].X,
        ...
        protected override Size OnLayoutSize(ActivityDesignerLayoutEventArgs e)
        {
            ...
            if (footer != null)
                size.Height +=
                    footer.ImageRectangle.Height
                    + 2 * e.AmbientTheme.Margin.Height
                    + footer.FooterBarRectangle.Size.Height;
        ...
        protected override void OnPaint(ActivityDesignerPaintEventArgs e)
        {
            ...
            if (compositeDesignerTheme.WatermarkImage != null)
            {
                ...
                watermarkRectangle = ActivityDesignerPaint.GetRectangleFromAlignment(
                    compositeDesignerTheme.WatermarkAlignment,
                    bounds,
                    compositeDesignerTheme.WatermarkImage.Size
                );
            }
        ...
        private sealed class WorkflowHeader : SequentialWorkflowHeaderFooter
        {
            ...
            {
                get { return 2 * WorkflowTheme.CurrentTheme.AmbientTheme.Margin.Height; }
            }
        }
        #endregion
            ...
            public override Rectangle Bounds
            {
                get
                {
                    ...
                    SequentialWorkflowRootDesigner rootDesigner =
                        AssociatedDesigner as SequentialWorkflowRootDesigner;
                    bounds.Height = Math.Max(
                        bounds.Height,
                        rootDesigner.Size.Height
                            - rootDesigner.TitleHeight
                            - rootDesigner.OptimalHeight
                    );
                    bounds.Y =
                        rootDesigner.Location.Y
                        + rootDesigner.TitleHeight
                        + rootDesigner.OptimalHeight;
