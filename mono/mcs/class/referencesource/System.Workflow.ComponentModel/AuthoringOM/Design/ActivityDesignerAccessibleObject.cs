...
namespace System.Workflow.ComponentModel.Design
{
    ...
    public class ActivityDesignerAccessibleObject : AccessibleObject
    {
        ...
        public ActivityDesignerAccessibleObject(ActivityDesigner activityDesigner)
        {
            ...
            if (activityDesigner.Activity == null)
                throw new ArgumentException(
                    DR.GetString(DR.DesignerNotInitialized),
                    "activityDesigner"
                );
            ...
            get
            {
                ...
                if (activity != null)
                {
                    if (TypeDescriptor.GetProperties(activity)["TypeName"] != null)
                        return TypeDescriptor.GetProperties(activity)["TypeName"].GetValue(activity)
                            as string;
        ...
        public override void DoDefaultAction()
        {
            ...
            if (selectionService != null)
                selectionService.SetSelectedComponents(
                    new object[] { this.activityDesigner.Activity },
            ...
            else
            {
                ...
                if (compositeDesigner != null)
                {
                    ...
                    ActivityDesigner activityDesigner = ActivityDesigner.GetDesigner(
                        compositeDesigner.GetNextSelectableObject(
        ...
        protected object GetService(Type serviceType)
        {
            ...
            if (
                this.ActivityDesigner.Activity != null
                && this.ActivityDesigner.Activity.Site != null
            )
