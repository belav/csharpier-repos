namespace System.Workflow.ComponentModel.Design
{
    ...
    public abstract class SelectionGlyph : DesignerGlyph
    {
        public override Rectangle GetBounds(ActivityDesigner designer, bool activated)
        {
            ...
            rectangle.Inflate(
                WorkflowTheme.CurrentTheme.AmbientTheme.SelectionSize.Width / 2,
                WorkflowTheme.CurrentTheme.AmbientTheme.SelectionSize.Height / 2
            );
            return rectangle;
        }
        ...
        {
            ActivityDesignerPaint.DrawSelection(
                graphics,
                GetBounds(designer, activated),
                IsPrimarySelection,
        ...
        {
            get { return DesignerGlyph.SelectionPriority; }
        }
        ...
        public virtual Rectangle[] GetGrabHandles(ActivityDesigner designer)
        {
            ...
            if (parentDesigner != null && parentDesigner is FreeformActivityDesigner)
            {
                ...
                grabHandles[1] = new Rectangle(
                    new Point(
                        selectionRect.Left + (selectionRect.Width - grabHandleSize.Width) / 2,
                        selectionRect.Top
                    ),
                    grabHandleSize
                );
                grabHandles[2] = new Rectangle(
                    selectionRect.Right - grabHandleSize.Width,
                    selectionRect.Top,
                    grabHandleSize.Width,
                    grabHandleSize.Height
                );
                grabHandles[3] = new Rectangle(
                    new Point(
                        selectionRect.Right - grabHandleSize.Width,
                        selectionRect.Top + (selectionRect.Height - grabHandleSize.Height) / 2
                    ),
                    grabHandleSize
                );
                grabHandles[4] = new Rectangle(
                    selectionRect.Right - grabHandleSize.Width,
                    selectionRect.Bottom - grabHandleSize.Height,
                    grabHandleSize.Width,
                    grabHandleSize.Height
                );
                grabHandles[5] = new Rectangle(
                    new Point(
                        selectionRect.Left + (selectionRect.Width - grabHandleSize.Width) / 2,
                        selectionRect.Bottom - grabHandleSize.Height
                    ),
                ...
                grabHandles[6] = new Rectangle(
                    selectionRect.Left,
                    selectionRect.Bottom - grabHandleSize.Height,
                    grabHandleSize.Width,
                    grabHandleSize.Height
                );
                grabHandles[7] = new Rectangle(
                    new Point(
                        selectionRect.Left,
                        selectionRect.Top + (selectionRect.Height - grabHandleSize.Height) / 2
                    ),
