namespace System.Workflow.ComponentModel.Design
{
    ...
    internal sealed class ConnectorDragDropGlyph : DesignerGlyph
    {
        ...
        public ConnectorDragDropGlyph(int connectorIndex, Point connectorCenter)
        {
            ...
            this.glyphPoint = new Point(
                connectorCenter.X - ambientTheme.DropIndicatorSize.Width / 2,
                connectorCenter.Y - ambientTheme.DropIndicatorSize.Height / 2
            );
        }
        ...
        public override Rectangle GetBounds(ActivityDesigner designer, bool activated)
        {
            return new Rectangle(
                this.glyphPoint,
                WorkflowTheme.CurrentTheme.AmbientTheme.DropIndicatorSize
            );
        }
        ...
        )
        {
            ActivityDesignerPaint.DrawImage(
                graphics,
                AmbientTheme.DropIndicatorImage,
        ...
        {
            get { return DesignerGlyph.ConnectorDragDropPriority; }
        }
    }
    #endregion
