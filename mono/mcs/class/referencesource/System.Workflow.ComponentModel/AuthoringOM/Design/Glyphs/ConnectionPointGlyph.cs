    ...
    internal sealed class ConnectionPointGlyph : DesignerGlyph
    {
        ...
        )
        {
            ...
            )
            {
                ...
                Rectangle viewPort =
                    (workflowView != null) ? workflowView.ViewPortRectangle : Rectangle.Empty;
                Rectangle clipRectangle =
                    (designer.ParentDesigner != null)
                        ? designer.ParentDesigner.Bounds
                        : designer.Bounds;
                ConnectionManager connectionManager =
                    designer.Activity.Site.GetService(typeof(ConnectionManager))
                    as ConnectionManager;

                ActivityDesignerPaintEventArgs e = new ActivityDesignerPaintEventArgs(
                    graphics,
                    clipRectangle,
                    viewPort,
                ...
                bool drawHilited = (
                    ...
                    && this.connectionPoint.Equals(connectionManager.SnappedConnectionPoint)
                );
        ...
        {
            get { return DesignerGlyph.ConnectionPointPriority; }
        }
    }
    #endregion
