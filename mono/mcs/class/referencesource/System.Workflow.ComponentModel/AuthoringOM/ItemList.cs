namespace System.Workflow.ComponentModel
{
    ...
    internal class ItemListChangeEventArgs<T> : EventArgs
    {
        ...
        public ItemListChangeEventArgs(
            int index,
            ICollection<T> removedItems,
            ICollection<T> addedItems,
            object owner,
            ItemListChangeAction action
        )
        {
            this.index = index;
        ...
        public IList<T> RemovedItems
        {
            get
            {
                return (this.removedItems != null)
                    ? new List<T>(this.removedItems).AsReadOnly()
        ...
        public IList<T> AddedItems
        {
            get
            {
                return (this.addedItems != null)
                    ? new List<T>(this.addedItems).AsReadOnly()
                    : new List<T>().AsReadOnly();
            }
        }
    ...
    internal delegate void ItemListChangeEventHandler<T>(
        object sender,
        ItemListChangeEventArgs<T> e
    );
    ...
    internal class ItemList<T> : List<T>, IList<T>, IList
    {
        ...
        {
            get { return ((IList<T>)this).IsReadOnly; }
        }
