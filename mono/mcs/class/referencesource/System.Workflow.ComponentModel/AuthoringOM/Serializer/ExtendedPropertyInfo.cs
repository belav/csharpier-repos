namespace System.Workflow.ComponentModel.Serialization
{
    ...
    internal delegate void SetValueHandler(
        ExtendedPropertyInfo extendedProperty,
        object extendee,
        object value
    );
    internal delegate XmlQualifiedName GetQualifiedNameHandler(
        ExtendedPropertyInfo extendedProperty,
    ...
    internal sealed class ExtendedPropertyInfo : PropertyInfo
    {
        ...
        internal ExtendedPropertyInfo(
            PropertyInfo propertyInfo,
            GetValueHandler getValueHandler,
            SetValueHandler setValueHandler,
            GetQualifiedNameHandler qualifiedNameHandler
        )
        {
        ...
        public XmlQualifiedName GetXmlQualifiedName(
            WorkflowMarkupSerializationManager manager,
            out string prefix
        )
        {
        ...
        )
        {
            ...
            {
                foreach (
                    ExtendedPropertyInfo extendedProperty in manager.GetExtendedProperties(extendee)
                )
                {
                    string prefix = String.Empty;
                    XmlQualifiedName qualifiedPropertyName = extendedProperty.GetXmlQualifiedName(
                        manager,
                        out prefix
                    );
                    if (
