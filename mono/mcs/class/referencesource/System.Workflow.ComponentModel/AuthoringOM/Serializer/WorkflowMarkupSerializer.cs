namespace System.Workflow.ComponentModel.Serialization
{
    ...
    public class WorkflowMarkupSerializer
    {
        ...
        public static readonly DependencyProperty XCodeProperty =
            DependencyProperty.RegisterAttached(
                "XCode",
                typeof(CodeTypeMemberCollection),
                typeof(WorkflowMarkupSerializer),
                new PropertyMetadata(
                    DependencyPropertyOptions.Metadata,
                    new Attribute[]
        ...
        )
        {
            ...
            WorkflowMarkupSerializationManager markupSerializationManager =
                serializationManager as WorkflowMarkupSerializationManager;
            if (markupSerializationManager == null)
                markupSerializationManager = new WorkflowMarkupSerializationManager(
            ...
            markupSerializationManager.FoundDefTag += delegate(
                object sender,
            ...
            )
            {
                if (
                    ...
                    WorkflowMarkupSerializationHelpers.ProcessDefTag(
                        ...
                        eventArgs.XmlReader,
                        markupSerializationManager.Context.Current as Activity,
                        false,
                        fileName
                    );
            };
            ...
            if (rootActivity != null)
            {
                ...
                if (clrMappings == null)
                {
                    ...
                    rootActivity.SetValue(
                        WorkflowMarkupSerializer.ClrNamespacesProperty,
                        clrMappings
                    );
                }
                ...
                if (
                    (
                        string.IsNullOrEmpty(rootActivity.Name)
                        || rootActivity.Name == rootActivity.GetType().Name
                    )
        ...
        private object DeserializeXoml(
            ...
            try
            {
                ...
                if (reader.NodeType != XmlNodeType.Element)
                {
                    serializationManager.ReportError(
                        CreateSerializationError(SR.GetString(SR.Error_InvalidDataFound), reader)
                    );
                }
                else
                {
                    ...
                    XmlQualifiedName xmlQualifiedName = new XmlQualifiedName(
                        decodedName,
                    ...
                    )
                    {
                        ...
                        serializationManager.FireFoundDefTag(
                            new WorkflowMarkupElementEventArgs(reader)
                        );
                    ...
                    else
                    {
                        ...
                        if (obj != null)
                        {
                            ...
                            {
                                Debug.Assert(
                                    serializationManager.Context.Current == obj,
        ...
        )
        {
            ...
            WorkflowMarkupSerializer serializer =
                serializationManager.GetSerializer(obj.GetType(), typeof(WorkflowMarkupSerializer))
                as WorkflowMarkupSerializer;
            if (serializer == null)
            {
                serializationManager.ReportError(
                    CreateSerializationError(
                        SR.GetString(SR.Error_SerializerNotAvailable, obj.GetType().FullName),
                        reader
                    )
                );
                return;
            ...
            if (reader.HasAttributes)
            {
                while (reader.MoveToNextAttribute())
                {
                    //
                    if (
                        reader.LocalName.Equals("xmlns", StringComparison.Ordinal)
                    ...
                    DependencyProperty dependencyProperty = ResolveDependencyProperty(
                        serializationManager,
                        reader,
                        obj,
                        propName
                    ...
                    if (dependencyProperty != null)
                    {
                        ...
                        {
                            Debug.Assert(
                                serializationManager.Context.Current == dependencyProperty,
                                "Serializer did not remove an object it pushed into stack."
                            );
                            serializationManager.Context.Pop();
                        }
                    ...
                    else
                    {
                        ...
                        if (property != null)
                        {
                            ...
                            {
                                Debug.Assert(
                                    (PropertyInfo)serializationManager.Context.Current == property,
                                    "Serializer did not remove an object it pushed into stack."
                                );
                                serializationManager.Context.Pop();
                            }
                        ...
                        else
                        {
                            ...
                            if (events != null && evt != null)
                            {
                                ...
                                {
                                    Debug.Assert(
                                        (EventInfo)serializationManager.Context.Current == evt,
                                        "Serializer did not remove an object it pushed into stack."
                                    );
                                    serializationManager.Context.Pop();
                                }
                                ...
                                serializationManager.ReportError(
                                    CreateSerializationError(
                                        SR.GetString(
                                            SR.Error_SerializerNoMemberFound,
                                            new object[] { propName, obj.GetType().FullName }
                                        ),
                                        reader
                                    )
                                );
            ...
            catch (Exception e)
            {
                serializationManager.ReportError(
                    CreateSerializationError(
                        SR.GetString(SR.Error_SerializerThrewException, obj.GetType(), e.Message),
                        e,
                        reader
                    )
                );
            ...
            )
            {
                ...
                if (!isEmptyElement)
                {
                    reader.MoveToElement();
                    int initialDepth = reader.Depth;
                    XmlQualifiedName extendedPropertyQualifiedName = new XmlQualifiedName(
                        reader.LocalName,
                        reader.LookupNamespace(reader.Prefix)
                    );
                    do
                    {
                            ...
                            while (reader.Read() && ((initialDepth + 1) < reader.Depth))
                            {
                                ...
                                )
                                {
                                    serializationManager.ReportError(
                                        CreateSerializationError(
                                            SR.GetString(
                                                SR.Error_InvalidDataFoundForType,
                                                obj.GetType().FullName
                                            ),
                                            reader
                                        )
                        ...
                        if (reader.NodeType == XmlNodeType.Element)
                        {
                            ...
                            )
                            {
                                ...
                                if (dependencyProperty == null && property == null)
                                    serializationManager.ReportError(
                                        CreateSerializationError(
                                            SR.GetString(
                                                SR.Error_InvalidElementFoundForType,
                                                reader.LocalName,
                                                obj.GetType().FullName
                                            ),
                                            reader
                                ...
                                {
                                    PropertyInfo prop = WorkflowMarkupSerializer.LookupProperty(
                                        props,
                            ...
                            else
                            {
                                ...
                                if (obj2 != null)
                                {
                                    ...
                                    if (
                                        ...
                                        && ((string)obj2).StartsWith("{}", StringComparison.Ordinal)
                                    )
                            ...
                            reader.NodeType == XmlNodeType.Text && contentProperty.Property != null
                        )
                        {
                            ...
                            contents.Add(
                                new ContentInfo(reader.ReadString(), lineNumber, linePosition)
                            );
                ...
                using (new SafeXmlNodeWriter(serializationManager, obj, null, XmlNodeType.Element))
                {
                    ...
                    if (serializationManager.WorkflowMarkupStack[typeof(DictionaryEntry)] != null)
                        entry = (DictionaryEntry)
                            serializationManager.WorkflowMarkupStack[typeof(DictionaryEntry)];
                    ...
                    bool key =
                        ...
                        && (
                            (
                                !entry.Value.GetType().IsValueType
                                && entry.Value.Key == entry.Value.Value
                                && entry.Value.Value == obj
                            )
                            || (
                                entry.Value.GetType().IsValueType
                                && entry.Value.Key.Equals(entry.Value.Value)
                                && entry.Value.Value.Equals(obj)
                            )
                        )
                    ...
                    if (key || !serializationManager.SerializationStack.Contains(obj))
                    {
                        ...
                        throw new WorkflowMarkupSerializationException(
                            SR.GetString(
                                SR.Error_SerializerStackOverflow,
                                obj.ToString(),
                                obj.GetType().FullName
                            ),
                            0,
        ...
        internal void SerializeContents(
            WorkflowMarkupSerializationManager serializationManager,
            object obj,
            XmlWriter writer,
            bool dictionaryKey
        )
        {
            ...
            )
            {
                if (
                    ...
                    || obj.GetType() == typeof(System.Int16)
                    || obj.GetType() == typeof(decimal)
                    || obj.GetType() == typeof(DateTime)
                    || obj.GetType() == typeof(TimeSpan)
                    || obj.GetType().IsEnum
                ...
                else if (obj.GetType() == typeof(string))
                {
                    ...
                    if (
                        !(
                            attribValue.StartsWith("{", StringComparison.Ordinal)
                            && attribValue.EndsWith("}", StringComparison.Ordinal)
                        )
                    )
                ...
                try
                {
                    if (
                        ...
                        designTimeTypeNames =
                            ...
                            as Hashtable;
                    dependencyProperties = serializer.GetDependencyProperties(
                        serializationManager,
                        obj
                    );
                ...
                if (designTimeTypeNames != null)
                {
                    foreach (object key in designTimeTypeNames.Keys)
                    {
                        ...
                        if (
                            ...
                            && !dependencyProperties.ContainsKey(dependencyProperty)
                        )
                            dependencyProperties.Add(
                                dependencyProperty,
                                designTimeTypeNames[dependencyProperty]
                            );
                    }
                }
                ...
                foreach (object propertyObj in allProperties.Values)
                {
                    ...
                    try
                    {
                        if (propertyObj is PropertyInfo)
                        {
                            ...
                            if (property.CanRead)
                            {
                                ...
                                )
                                {
                                    ...
                                    if (dependencyProperty != null)
                                        propertyValue = Helpers.GetDesignTimeTypeName(
                                            obj,
                                            dependencyProperty
                                        );
                        ...
                        else if (propertyObj is EventInfo)
                        {
                            ...
                            propertyValue = WorkflowMarkupSerializationHelpers.GetEventHandlerName(
                                obj,
                                evt.Name
                            );
                            if (
                            ...
                            )
                            {
                                ...
                                {
                                    Activity activity =
                                        serializationManager.Context[typeof(Activity)] as Activity;
                                    Delegate handler =
                                        ((DependencyObject)obj).GetHandler(dependencyProperty)
                                        as Delegate;
                                    if (
                                        handler != null
                                        && activity != null
                                        && TypeProvider.Equals(
                                            ...
                                            Helpers.GetRootActivity(activity).GetType()
                                        )
                                    )
                        ...
                        {
                            DependencyProperty dependencyProperty =
                                propertyObj as DependencyProperty;
                            propertyName = dependencyProperty.Name;
                    ...
                    catch (Exception e)
                    {
                        ...
                        serializationManager.ReportError(
                            new WorkflowMarkupSerializationException(
                                SR.GetString(
                                    SR.Error_SerializerPropertyGetFailed,
                                    new object[] { propertyName, obj.GetType().FullName, e.Message }
                                )
                            )
                        );
                        continue;
                    ...
                    if (
                        propertyObj is PropertyInfo
                        && contentProperty.Property == (PropertyInfo)propertyObj
                    )
                        continue;
                    ...
                    {
                        if (
                            propValueSerializer.ShouldSerializeValue(
                                serializationManager,
                                propertyValue
                            )
                        )
                        {
                            ...
                            if (
                                ...
                                && propertyInfoType != typeof(object)
                            )
                            {
                                using (
                                    new SafeXmlNodeWriter(
                                        serializationManager,
                                        obj,
                                        propertyObj,
                                ...
                                )
                                {
                                    ...
                                    {
                                        string stringValue = propValueSerializer.SerializeToString(
                                            serializationManager,
                                            propertyValue
                                        );
                                        if (!string.IsNullOrEmpty(stringValue))
                                        {
                                            ...
                                            if (
                                                propertyValue is MarkupExtension
                                                || !(
                        ...
                        serializationManager.ReportError(
                            new WorkflowMarkupSerializationException(
                                SR.GetString(
                                    ...
                                    new object[] { propertyName, obj.GetType().FullName }
                                ),
                                e
                            )
                        );
                    ...
                    {
                        Debug.Assert(
                            serializationManager.Context.Current == propertyObj,
                            "Serializer did not remove an object it pushed into stack."
                        );
                        serializationManager.Context.Pop();
                    }
                ...
                foreach (object propertyObj in complexProperties)
                {
                    ...
                    try
                    {
                        ...
                        else if (propertyObj is DependencyProperty)
                        {
                            ...
                            isReadOnly = (
                                (
                                    dependencyProperty.DefaultMetadata.Options
                    ...
                    if (
                        propertyObj is PropertyInfo
                        && (PropertyInfo)propertyObj == contentProperty.Property
                    )
                        continue;
                    ...
                    if (propertyValue != null)
                    {
                        ...
                        if (propValueSerializer != null)
                        {
                            ...
                            {
                                if (isReadOnly)
                                    propValueSerializer.SerializeContents(
                                        serializationManager,
                                        propertyValue,
                                        writer,
                                        false
                                    ...
                                    propValueSerializer.SerializeObject(
                                        serializationManager,
                                        propertyValue,
                                        writer
                                    );
                        ...
                        else
                        {
                            ...
                            if (
                                ...
                                && (
                                    ...
                                    || contentProperty.Property.PropertyType != typeof(object)
                                )
                            )
                            {
                                string stringValue = propValueSerializer.SerializeToString(
                                ...
                                CollectionMarkupSerializer.IsValidCollectionType(contents.GetType())
                            )
                            {
                                    ...
                                    foreach (object childObj in enumerableContents)
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            try
                                            {
                                                ...
                                                WorkflowMarkupSerializer childObjectSerializer =
                                                    serializationManager.GetSerializer(
                                                        childObj2.GetType(),
                                                        typeof(WorkflowMarkupSerializer)
                                                    ) as WorkflowMarkupSerializer;
                                                if (childObjectSerializer != null)
                                                    childObjectSerializer.SerializeObject(
                                                        serializationManager,
                                                        childObj2,
                                                        writer
                                                    );
        ...
        internal virtual void OnBeforeSerializeContents(
            WorkflowMarkupSerializationManager serializationManager,
            object obj
        ) { }
        ...
        internal virtual void OnBeforeDeserializeContents(
            WorkflowMarkupSerializationManager serializationManager,
            object obj
        ) { }
        ...
        protected internal virtual bool CanSerializeToString(
            WorkflowMarkupSerializationManager serializationManager,
            object value
        )
        {
        ...
        protected internal virtual string SerializeToString(
            WorkflowMarkupSerializationManager serializationManager,
            object value
        )
        {
        ...
        protected internal virtual object DeserializeFromString(
            WorkflowMarkupSerializationManager serializationManager,
            Type propertyType,
            string value
        )
        ...
        private object InternalDeserializeFromString(
            WorkflowMarkupSerializationManager serializationManager,
            Type propertyType,
            string value
        )
            ...
            else
            {
                ...
                else if (typeof(Type).IsAssignableFrom(propertyType))
                {
                    ...
                    ITypeProvider typeProvider =
                        serializationManager.GetService(typeof(ITypeProvider)) as ITypeProvider;
                ...
                else
                {
                    throw CreateSerializationError(
                        SR.GetString(
                            SR.Error_SerializerPrimitivePropertyNoLogic,
        ...
        protected internal virtual void AddChild(
            WorkflowMarkupSerializationManager serializationManager,
            object parentObject,
            object childObj
        )
        {
            ...
            throw new Exception(
                SR.GetString(
                    SR.Error_SerializerNoChildNotion,
                    new object[] { parentObject.GetType().FullName }
                )
            );
        }
        ...
        protected internal virtual PropertyInfo[] GetProperties(
            WorkflowMarkupSerializationManager serializationManager,
            object obj
        )
        {
            ...
            object[] attributes = obj.GetType()
                .GetCustomAttributes(typeof(RuntimeNamePropertyAttribute), true);
            string name = null;
            if (attributes.Length > 0)
                ...
                if (name == null || !name.Equals(property.Name))
                    ...
                    properties.Add(
                        new ExtendedPropertyInfo(
                            property,
                            OnGetRuntimeNameValue,
                            OnSetRuntimeNameValue,
                            OnGetRuntimeQualifiedName
                        )
                    );
            }
        ...
        protected internal virtual EventInfo[] GetEvents(
            WorkflowMarkupSerializationManager serializationManager,
            object obj
        )
        {
            ...
            {
                if (
                    Helpers.GetSerializationVisibility(evt)
                    == DesignerSerializationVisibility.Hidden
                )
                    continue;
        ...
        internal virtual ExtendedPropertyInfo[] GetExtendedProperties(
        ...
        private void OnSetRuntimeNameValue(
        ...
        private XmlQualifiedName OnGetRuntimeQualifiedName(
            ExtendedPropertyInfo extendedProperty,
            WorkflowMarkupSerializationManager manager,
            out string prefix
        )
        ...
        private IDictionary<DependencyProperty, object> GetDependencyProperties(
            WorkflowMarkupSerializationManager serializationManager,
            object obj
        )
        {
            ...
            if (dependencyObject != null)
            {
                ...
                )
                {
                    ...
                    if (dependencyObject.IsBindingSet(dependencyProperty))
                    {
                        dependencyProperties.Add(
                            dependencyProperty,
                            dependencyObject.GetBinding(dependencyProperty)
                        );
                    }
                    else if (!dependencyProperty.IsEvent)
                    {
                        ...
                        )
                        {
                            ...
                            if (
                                propValue != null
                                && propertyInfo.PropertyType.IsAssignableFrom(propValue.GetType())
                            )
                    ...
                    else
                    {
                        dependencyProperties.Add(
                            dependencyProperty,
                            dependencyObject.GetHandler(dependencyProperty)
                        );
                    }
                }
                foreach (
        ...
        private void SetDependencyPropertyValue(
            WorkflowMarkupSerializationManager serializationManager,
            object obj,
            DependencyProperty dependencyProperty,
            object value
        )
        {
            ...
            if (dependencyProperty.IsEvent)
            {
                ...
                else if (dependencyProperty.IsAttached)
                {
                    ...
                    if (methodInfo != null)
                        WorkflowMarkupSerializationHelpers.SetEventHandlerName(
                            dependencyObject,
                            dependencyProperty.Name,
                            value as string
                        );
            ...
            else
            {
                if (value is ActivityBind)
                    ...
                    value is string
                    && TypeProvider.IsAssignable(typeof(Type), dependencyProperty.PropertyType)
                )
                ...
                else
                {
                    ...
                    )
                    {
                        ...
                        {
                            ICollection<string> propVal =
                                pi.GetValue(obj, null) as ICollection<string>;
        ...
        internal static WorkflowMarkupSerializationException CreateSerializationError(
            Exception e,
            XmlReader reader
        )
        {
        ...
        )
        {
            ...
            if (xmlLineInfo != null)
                return new WorkflowMarkupSerializationException(
                    errorMsg,
        ...
        private static string GetClrFullName(
            WorkflowMarkupSerializationManager serializationManager,
        ...
        )
        {
            ...
            catch (Exception e)
            {
                serializationManager.ReportError(
                    CreateSerializationError(
                        SR.GetString(
                            SR.Error_SerializerTypeNotResolvedWithInnerError,
                            new object[]
                            {
            ...
            if (
                type == null
                && !xmlQualifiedName.Name.EndsWith("Extension", StringComparison.Ordinal)
            )
            {
                string typename = xmlQualifiedName.Name + "Extension";
                try
                {
                    type = serializationManager.GetType(
                        new XmlQualifiedName(typename, xmlQualifiedName.Namespace)
                    );
                }
                catch (Exception e)
                {
            ...
            if (type == null)
            {
                serializationManager.ReportError(
                    CreateSerializationError(
                        SR.GetString(
                            SR.Error_SerializerTypeNotResolved,
                            new object[] { GetClrFullName(serializationManager, xmlQualifiedName) }
                        ),
                        reader
                    )
                );
            ...
            )
            {
                try
                {
                    ...
                    )
                    {
                        ...
                        if (typeConverter != null && typeConverter.CanConvertFrom(typeof(string)))
                            obj = typeConverter.ConvertFrom(
                                null,
                                CultureInfo.InvariantCulture,
                                stringValue
                            );
                        else if (typeof(IConvertible).IsAssignableFrom(type))
                            obj = Convert.ChangeType(
                                stringValue,
                                type,
                                CultureInfo.InvariantCulture
                            );
                ...
                catch (Exception e)
                {
                    serializationManager.ReportError(
                        CreateSerializationError(
                            SR.GetString(SR.Error_SerializerCreateInstanceFailed, e.Message),
                            reader
                        )
                    );
                    return null;
            ...
            else
            {
                // get the serializer
                WorkflowMarkupSerializer serializer =
                    serializationManager.GetSerializer(type, typeof(WorkflowMarkupSerializer))
                    as WorkflowMarkupSerializer;
                if (serializer == null)
                {
                    serializationManager.ReportError(
                        CreateSerializationError(
                            SR.GetString(SR.Error_SerializerNotAvailable, type.FullName),
                            reader
                        )
                    );
                    return null;
                ...
                catch (Exception e)
                {
                    serializationManager.ReportError(
                        CreateSerializationError(
                            SR.GetString(
                                SR.Error_SerializerCreateInstanceFailed,
                                type.FullName,
                                e.Message
                            ),
                            reader
        ...
        private void DeserializeCompoundProperty(
            WorkflowMarkupSerializationManager serializationManager,
            XmlReader reader,
            object obj
        )
        {
            ...
            DependencyProperty dependencyProperty =
                serializationManager.Context.Current as DependencyProperty;
            PropertyInfo property = serializationManager.Context.Current as PropertyInfo;
            if (dependencyProperty != null)
                isReadOnly = (
                    (
            ...
            if (isReadOnly)
            {
                ...
                if (propValue != null)
                    ...
                    serializationManager.ReportError(
                        CreateSerializationError(
                            SR.GetString(
                                SR.Error_SerializerReadOnlyPropertyAndValueIsNull,
                                propertyName,
                                obj.GetType().FullName
                            ),
                            reader
            ...
            else if (!reader.IsEmptyElement)
            {
                ...
                if (reader.HasAttributes)
                {
                    ...
                    while (reader.MoveToNextAttribute())
                    {
                        ...
                        if (
                            ...
                            || string.Equals(reader.Prefix, "xmlns", StringComparison.Ordinal)
                        )
                            continue;
                        else
                            serializationManager.ReportError(
                                CreateSerializationError(
                                    SR.GetString(
                                        SR.Error_SerializerAttributesFoundInComplexProperty,
                                        propertyName,
                                        obj.GetType().FullName
                                    ),
                                    reader
                ...
                else
                {
                    ...
                    if (reader.NodeType == XmlNodeType.Element)
                    {
                        ...
                        if (propValue != null)
                        {
                            propValue = GetValueFromMarkupExtension(
                                serializationManager,
                                propValue
                            );
                            ...
                            if (
                                ...
                                && ((string)propValue).StartsWith("{}", StringComparison.Ordinal)
                            )
                            ...
                            if (dependencyProperty != null)
                            {
                                ...
                                WorkflowMarkupSerializer objSerializer =
                                    serializationManager.GetSerializer(
                                        obj.GetType(),
                                        typeof(WorkflowMarkupSerializer)
                                    ) as WorkflowMarkupSerializer;
                                ...
                                try
                                {
                                    objSerializer.SetDependencyPropertyValue(
                                        serializationManager,
                                        obj,
                                        dependencyProperty,
                                        propValue
                            ...
                            else if (property != null)
                            {
                                ...
                                catch
                                {
                                    serializationManager.ReportError(
                                        new WorkflowMarkupSerializationException(
                                            SR.GetString(
                                                SR.Error_SerializerComplexPropertySetFailed,
                                                new object[]
                                                {
                                                    propertyName,
                                                    propertyName,
        ...
        private void DeserializeSimpleProperty(
            WorkflowMarkupSerializationManager serializationManager,
            XmlReader reader,
            object obj,
            string value
        )
        {
            ...
            if (isReadOnly && !typeof(ICollection<string>).IsAssignableFrom(propertyType))
            {
                serializationManager.ReportError(
                    CreateSerializationError(
                        SR.GetString(
                            SR.Error_SerializerPrimitivePropertyReadOnly,
                            new object[] { property.Name, property.Name, obj.GetType().FullName }
                        ),
                        reader
                    )
                );
        ...
        private void DeserializeSimpleMember(
            WorkflowMarkupSerializationManager serializationManager,
            Type memberType,
            XmlReader reader,
            object obj,
        ...
        )
        {
            ...
            WorkflowMarkupSerializer memberSerializer =
                serializationManager.GetSerializer(memberType, typeof(WorkflowMarkupSerializer))
                as WorkflowMarkupSerializer;
            if (memberSerializer == null)
            {
                serializationManager.ReportError(
                    CreateSerializationError(
                        SR.GetString(SR.Error_SerializerNotAvailable, memberType.FullName),
                        reader
                    )
                );
                return;
            ...
            try
            {
                memberValue = memberSerializer.DeserializeFromString(
                    serializationManager,
                    memberType,
                    value
                );
                ...
                else
                {
                    ...
                    if (evt != null)
                    {
                        ...
                        catch (Exception e)
                        {
                            ...
                            serializationManager.ReportError(
                                CreateSerializationError(
                                    SR.GetString(
                                        SR.Error_SerializerMemberSetFailed,
                                        new object[]
                                        {
                                            reader.LocalName,
                                            reader.Value,
                    ...
                    else
                    {
                        PropertyInfo property =
                            serializationManager.Context.Current as PropertyInfo;
                        if (property != null)
                        {
                            try
                            {
                                ...
                                else if (property.CanWrite)
                                {
                                    ...
                                    typeof(ICollection<string>).IsAssignableFrom(
                                        memberValue.GetType()
                                    )
                                )
                                {
                                    ICollection<string> propVal =
                                        property.GetValue(obj, null) as ICollection<string>;
                                    ICollection<string> deserializedValue =
                                        memberValue as ICollection<string>;
                                    if (propVal != null && deserializedValue != null)
                                    {
                                        foreach (string content in deserializedValue)
                                            propVal.Add(content);
        ...
        [SuppressMessage(
            ...
            Justification = "string comparisons are just used to lookup method/property names from compiled system.type which should not cause any issue irrespective of comparisons mode used"
        )]
        private DependencyProperty ResolveDependencyProperty(
            WorkflowMarkupSerializationManager serializationManager,
            XmlReader reader,
            object attachedObj,
        ...
        )
        {
            ...
            if (separatorIndex != -1)
            {
                ...
                if (!String.IsNullOrEmpty(ownerTypeName) && !String.IsNullOrEmpty(propertyName))
                    ownerType = serializationManager.GetType(
                        new XmlQualifiedName(ownerTypeName, reader.LookupNamespace(reader.Prefix))
                    );
            }
            else
            {
            ...
            FieldInfo fieldInfo = ownerType.GetField(
                ...
                if (dependencyProperty != null)
                {
                    ...
                    if (attributes.Length > 0)
                    {
                        DesignerSerializationVisibilityAttribute serializationVisibilityAttribute =
                            attributes[0] as DesignerSerializationVisibilityAttribute;
                        if (
                            serializationVisibilityAttribute.Visibility
                            == DesignerSerializationVisibility.Hidden
                        )
                            dependencyProperty = null;
                    }
        ...
        private sealed class SafeXmlNodeWriter : IDisposable
        {
            ...
            )
            {
                ...
                if (writer == null)
                    throw new InvalidOperationException(
                        SR.GetString(SR.Error_InternalSerializerError)
                    );
                ...
                else if (property is MemberInfo)
                {
                    ...
                    {
                        XmlQualifiedName qualifiedName = extendedProperty.GetXmlQualifiedName(
            ...
            {
                XmlWriter writer =
                    this.serializationManager.WorkflowMarkupStack[typeof(XmlWriter)] as XmlWriter;
        ...
        private static PropertyInfo LookupProperty(
        ...
        internal bool IsValidCompactAttributeFormat(string attributeValue)
        {
            return (
                ...
                && attributeValue.StartsWith("{", StringComparison.Ordinal)
                && !attributeValue.StartsWith("{}", StringComparison.Ordinal)
                && attributeValue.EndsWith("}", StringComparison.Ordinal)
            );
        }
        ...
        )
        {
            if (
                attrValue.Length == 0
                || !attrValue.StartsWith("{", StringComparison.Ordinal)
                || !attrValue.EndsWith("}", StringComparison.Ordinal)
            )
            {
                serializationManager.ReportError(
                    CreateSerializationError(SR.GetString(SR.IncorrectSyntax, attrValue), reader)
                );
                return null;
            }
            ...
            Type type = serializationManager.GetType(
            ...
            if (type == null)
            {
                serializationManager.ReportError(
                    CreateSerializationError(
                        SR.GetString(SR.Error_MarkupSerializerTypeNotResolved, typename),
                        reader
                    )
                );
                return null;
            ...
            catch (Exception error)
            {
                serializationManager.ReportError(
                    CreateSerializationError(
                        SR.GetString(
                            SR.Error_MarkupExtensionDeserializeFailed,
                            attrValue,
                            error.Message
                        ),
                        reader
                ...
                if (positionalArgs.Count > 0)
                {
                    ...
                    if (matchConstructor != null)
                    {
                        for (int i = 0; i < positionalArgs.Count; i++)
                        {
                            ...
                            positionalArgs[i] = InternalDeserializeFromString(
                                serializationManager,
                                matchParameters[i].ParameterType,
                                argVal
                            );
                            positionalArgs[i] = GetValueFromMarkupExtension(
                                serializationManager,
                                positionalArgs[i]
                            );
                        }
            ...
            if (obj == null)
            {
                serializationManager.ReportError(
                    CreateSerializationError(
                        SR.GetString(SR.Error_CantCreateInstanceOfBaseType, type.FullName),
                        reader
                    )
                );
                return null;
                    ...
                    else
                    {
                        serializationManager.ReportError(
                            CreateSerializationError(
                                SR.GetString(
                                    SR.Error_SerializerPrimitivePropertyNoLogic,
                                    new object[] { argName, argName, obj.GetType().FullName }
                                ),
                                reader
                            )
                        );
        ...
        )
        {
            ...
            if (stringBuilder != null && stringBuilder.Length > 0)
                throw new Exception(
                    SR.GetString(SR.Error_MarkupExtensionMissingTerminatingCharacter)
                );
            else if (i < length)
            {
        ...
        private class ContentProperty : IDisposable
        {
            ...
            )
            {
                ...
                this.contentProperty = GetContentProperty(
                    this.serializationManager,
                    this.parentObject
                );
                if (this.contentProperty != null)
                {
                    ...
                    if (this.contentPropertySerializer != null)
                    {
                        ...
                        {
                            XmlReader reader =
                                this.serializationManager.WorkflowMarkupStack[typeof(XmlReader)]
                                as XmlReader;
                            ...
                            )
                            {
                                ...
                                try
                                {
                                    contentPropertyValue = serializer.CreateInstance(
                                        serializationManager,
                                        this.contentProperty.PropertyType
                                    );
                                }
            ...
            {
                XmlReader reader =
                    this.serializationManager.WorkflowMarkupStack[typeof(XmlReader)] as XmlReader;
                if (
                    reader != null
                    && this.contentProperty != null
                    && this.contentPropertySerializer != null
                )
                {
                    try
                    {
            ...
            {
                get { return this.contentProperty; }
            }
            ...
            internal void SetContents(IList<ContentInfo> contents)
            {
                ...
                else if (this.contentPropertySerializer != null)
                {
                    ...
                    if (
                        CollectionMarkupSerializer.IsValidCollectionType(
                            this.contentProperty.PropertyType
                        )
                    )
                    {
                    ...
                    else
                    {
                        ...
                        if (
                            !this.contentProperty.PropertyType.IsAssignableFrom(content.GetType())
                            && typeof(string).IsAssignableFrom(content.GetType())
                        )
                        {
                            try
                            {
                        ...
                        else
                        {
                            try
                            {
                                ...
                                {
                                    content = new WorkflowMarkupSerializer().DeserializeFromString(
                                        this.serializationManager,
                                        this.contentProperty.PropertyType,
                                        content as string
                                    );
            ...
            private PropertyInfo GetContentProperty(
                WorkflowMarkupSerializationManager serializationManager,
                object parentObject
            )
            {
                ...
                object[] contentPropertyAttributes = parentObject
                    .GetType()
                ...
                if (!String.IsNullOrEmpty(contentPropertyName))
                {
                    ...
                    if (contentProperty == null)
                        serializationManager.ReportError(
                            new WorkflowMarkupSerializationException(
                                SR.GetString(
                                    SR.Error_ContentPropertyCouldNotBeFound,
                                    contentPropertyName,
        ...
        internal static string EnsureMarkupExtensionTypeName(Type type)
        {
            ...
            if (
                extensionName.EndsWith(
                    StandardXomlKeys.MarkupExtensionSuffix,
                    StringComparison.OrdinalIgnoreCase
                )
            )
                extensionName = extensionName.Substring(
                    0,
                    extensionName.Length - StandardXomlKeys.MarkupExtensionSuffix.Length
                );
        ...
        private static bool IsMarkupExtension(XmlQualifiedName xmlQualifiedName)
        {
            ...
            {
                if (
                    xmlQualifiedName.Name.Equals(typeof(Array).Name)
                    || string.Equals(xmlQualifiedName.Name, "Null", StringComparison.Ordinal)
                    || string.Equals(
                        xmlQualifiedName.Name,
                        typeof(NullExtension).Name,
                        StringComparison.Ordinal
                    )
                    || string.Equals(xmlQualifiedName.Name, "Type", StringComparison.Ordinal)
                    || string.Equals(
                        xmlQualifiedName.Name,
                        typeof(TypeExtension).Name,
                        StringComparison.Ordinal
                    )
                )
        ...
        private static object GetValueFromMarkupExtension(
            WorkflowMarkupSerializationManager manager,
            object extension
        )
        {
