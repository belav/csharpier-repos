    ...
    internal sealed class PropertySegmentSerializer : WorkflowMarkupSerializer
    {
        ...
        )
        {
            if (typeof(PropertySegment) == type)
                return Activator.CreateInstance(
                    ...
                    new object[]
                    {
                        serializationManager as IServiceProvider,
                        serializationManager.Context.Current,
                    }
                );
            else
        ...
        )
        {
            ...
            if (value != null)
            {
                ...
                TypeConverter converter = GetTypeConversionInfoForPropertySegment(
        ...
        private TypeConverter GetTypeConversionInfoForPropertySegment(
            WorkflowMarkupSerializationManager serializationManager,
            Type propertyType,
            out ITypeDescriptorContext context
        )
        {
            TypeConverter converter = null;
            context = null;
            PropertySegmentPropertyInfo propertyInfo =
                serializationManager.Context[typeof(PropertySegmentPropertyInfo)]
                as PropertySegmentPropertyInfo;
            if (propertyInfo.PropertySegment != null)
            {
                if (propertyInfo.PropertySegment.PropertyDescriptor != null)
                {
                    context = new TypeDescriptorContext(
                        propertyInfo.PropertySegment.ServiceProvider,
                        propertyInfo.PropertySegment.PropertyDescriptor,
                        propertyInfo.PropertySegment.Object
                    );
