    ...
    public class ActivityMarkupSerializer : WorkflowMarkupSerializer
    {
        ...
        public static readonly DependencyProperty StartLineProperty =
            DependencyProperty.RegisterAttached(
                "StartLine",
                typeof(int),
                typeof(ActivityMarkupSerializer),
        ...
        [SuppressMessage(
            ...
            MessageId = "System.String.IndexOf(System.String,System.Int32)",
            Justification = "This is not a security threat since it is called in design time (compile) scenarios"
        )]
        ...
        )
        {
            ...
            StringWriter stringWriter =
                serializationManager.WorkflowMarkupStack[typeof(StringWriter)] as StringWriter;
            if (stringWriter != null)
            {
                ...
                while (true)
                {
                    int nextNewLineIndex = currentXoml.IndexOf(
                        newLine,
                        currentIndex,
                ...
                activity.SetValue(
                    ActivityMarkupSerializer.StartColumnProperty,
                    (currentXoml.IndexOf('<', currentIndex) - currentIndex + 1)
                );
            }
            ...
            if (className != null)
                writer.WriteAttributeString(
                    ...
                    StandardXomlKeys.Definitions_Class_LocalName,
        ...
        )
        {
            ...
            if (
                ...
                && (
                    serializationManager.Context[typeof(Activity)] == null
                    && serializationManager.Context[typeof(WorkflowCompilerParameters)] != null
                )
            )
        ...
        )
        {
            ...
            {
                string currentXoml = stringWriter.ToString();
                int lineStartIndex = (int)
                    activity.GetValue(ActivityMarkupSerializer.EndColumnProperty);

                int lastNewLine = currentXoml.IndexOf(
                ...
                if (lastNewLine == -1)
                    activity.SetValue(
                        ...
                        (currentXoml.Length - lineStartIndex - 1)
                    );
                else
                    activity.SetValue(
                        ActivityMarkupSerializer.EndColumnProperty,
                        lastNewLine - lineStartIndex
                    );
            }
            ...
            if (codeSegments != null)
            {
                foreach (CodeSnippetTypeMember cs in codeSegments)
                {
                    ...
                    writer.WriteStartElement(
                        StandardXomlKeys.Definitions_XmlNs_Prefix,
                        StandardXomlKeys.Definitions_Code_LocalName,
                        StandardXomlKeys.Definitions_XmlNs
                    );
        ...
        internal static void ReplaceChildActivities(
            CompositeActivity instanceActivity,
            CompositeActivity xomlActivity
        )
        {
            ...
            if (!instanceActivity.UserData.Contains(UserDataKeys.CustomActivity))
                instanceActivity.UserData[UserDataKeys.CustomActivity] = (
                    instanceActivity.Activities.Count > 0
                );
        }
    }
