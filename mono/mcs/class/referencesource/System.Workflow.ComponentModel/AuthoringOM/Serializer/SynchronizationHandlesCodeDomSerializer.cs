    ...
    internal sealed class SynchronizationHandlesCodeDomSerializer : CodeDomSerializer
    {
        public override object Serialize(IDesignerSerializationManager manager, object obj)
        {
            ...
            CodeStatementCollection statements =
                manager.Context[typeof(CodeStatementCollection)] as CodeStatementCollection;
            ...
            if (statements != null)
            {
                ...
                if (handles == null)
                    throw new ArgumentException(
                        SR.GetString(
                            ...
                            typeof(StringCollection).FullName
                        ),
                        "obj"
                    );
                ...
                statements.Add(
                    new CodeVariableDeclarationStatement(
                        obj.GetType(),
                        variableName,
                        new CodeObjectCreateExpression(obj.GetType())
                    )
                );
                ...
                foreach (string handle in handles)
                    statements.Add(
                        new CodeMethodInvokeExpression(
                            ...
                            new CodeExpression[] { new CodePrimitiveExpression(handle) }
                        )
                    );
