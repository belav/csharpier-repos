namespace System.Workflow.ComponentModel
{
    ...
    internal class CompensationHandlingFilter
            ...
            IActivityEventListener<ActivityExecutionStatusChangedEventArgs>
    {
        ...
        public override ActivityExecutionStatus Compensate(
            Activity activity,
        ...
        )
        {
            ...
            if (e.Activity == context.Activity)
            {
                if (
                    ...
                    && !(bool)context.Activity.GetValue(CompensateProcessedProperty)
                )
                {
                ...
                e.Activity is CompensationHandlerActivity
    ...
    internal static class CompensationUtils
    {
        internal static bool TryCompensateLastCompletedChildActivity(
            ...
            IActivityEventListener<ActivityExecutionStatusChangedEventArgs> statusChangeHandler
        )
        {
            try
            {
                return TryCompensateLastCompletedChildActivity(
                    context,
                    targetActivity,
                    statusChangeHandler,
                    true
        ...
        private static bool TryCompensateLastCompletedChildActivity(
            ...
            Activity targetActivity,
            IActivityEventListener<ActivityExecutionStatusChangedEventArgs> statusChangeHandler,
            bool isimmediateCompensation
        )
        {
            SortedDictionary<int, CompensationInfo> sortedListOfCompensatableTargets =
                new SortedDictionary<int, CompensationInfo>();
            ...
            if (
                CollectCompensatableTargetActivities(
                    targetActivity as CompositeActivity,
            ...
            if (
                CollectCompensatableActiveContexts(
                    context,
                    targetActivity,
                    sortedListOfCompensatableTargets,
                    isimmediateCompensation
            ...
            CollectCompensatableCompletedContexts(
                context,
                targetActivity,
                sortedListOfCompensatableTargets,
                isimmediateCompensation
            ...
            int? lastCompletedOrderId =
                targetActivity.GetValue(CompensationHandlingFilter.LastCompensatedOrderIdProperty)
                as Nullable<int>;
            ...
            )
            {
                ...
                lastCompensatableTarget.TargetExecutionInfo != null
            ...
            )
            {
                ...
                else if (revokedExecutionContext.Activity is CompositeActivity)
                {
                    ...
                    Activity compensatableChild = GetLastCompensatableChild(
                        revokedExecutionContext.Activity as CompositeActivity
                    );
                    if (compensatableChild != null)
                    {
                        compensatableChild.RegisterForStatusChange(
                            Activity.StatusChangedEvent,
                            statusChangeHandler
                        );
            ...
            else if (lastCompensatableTarget.TargetExecutionContext != null) //or get the last compensatable "active" context
            {
                if (lastCompensatableTarget.TargetExecutionContext.Activity is CompositeActivity)
                {
                    ...
                    Activity compensatableChild = GetLastCompensatableChild(
                        lastCompensatableTarget.TargetExecutionContext.Activity as CompositeActivity
                    );
                    if (compensatableChild != null)
                    {
                        compensatableChild.RegisterForStatusChange(
                        ...
                        return TryCompensateLastCompletedChildActivity(
                            ...
                            lastCompensatableTarget.TargetExecutionContext.Activity,
                            statusChangeHandler,
                            false
                        );
                }
        ...
        private static void CompleteRevokedExecutionContext(
            Activity targetActivity,
            ActivityExecutionContext context
        )
        {
            ActivityExecutionContext[] activeContextsClone = new ActivityExecutionContext[
            ...
            {
                if (
                    targetActivity.GetActivityByName(childContext.Activity.QualifiedName, true)
                    != null
                )
                {
        ...
        private sealed class CompensationInfo
        {
            ...
            internal CompensationInfo(
                ActivityExecutionContextInfo targetExecutionInfo,
        ...
        )
        {
            ...
            Queue<Activity> completedActivities = new Queue<Activity>(
                Helpers.GetAllEnabledActivities(compositeActivity)
            );
            while (completedActivities.Count > 0)
            {
                Activity completedChild = completedActivities.Dequeue();
                if (
                    completedChild.ExecutionStatus == ActivityExecutionStatus.Compensating
                    || completedChild.ExecutionStatus == ActivityExecutionStatus.Faulting
                    || completedChild.ExecutionStatus == ActivityExecutionStatus.Canceling
                )
                    return true;
                ...
                if (
                    ...
                    && IsActivityInBackWorkBranch(compositeActivity, completedChild)
                )
                    continue;
                ...
                if (
                    ...
                    sortedListOfCompensatableTargets.Add(
                        (int)completedChild.GetValue(Activity.CompletedOrderIdProperty),
                        new CompensationInfo(completedChild)
                    );
                else if (completedChild is CompositeActivity)
                {
                    foreach (
                        Activity nestedCompletedActivity in Helpers.GetAllEnabledActivities(
        ...
        )
        {
            ...
            foreach (ActivityExecutionContext activeContext in contextManager.ExecutionContexts)
            {
                ...
                )
                {
                    ...
                    if (
                        immediateCompensation
                        && IsActivityInBackWorkBranch(targetActivity, activeContext.Activity)
                    )
                        continue;

                    if (
                        activeContext.Activity is ICompensatableActivity
                        && (
                    ...
                    {
                        Activity[] activities = GetCompensatableChildren(
                            activeContext.Activity as CompositeActivity
                        );
                        if (activities != null)
                        {
                            ...
                            foreach (Activity childActivity in activities)
                            {
                                int completedOrderId = (int)
                                    childActivity.GetValue(Activity.CompletedOrderIdProperty);
                            ...
                            if (lastcompletedContextOrderId != 0)
                                sortedListOfCompensatableTargets.Add(
                                    ...
                                    new CompensationInfo(activeContext)
                                );
                        }
                        CollectCompensatableActiveContexts(
                            activeContext,
        ...
        private static bool IsActivityInBackWorkBranch(
            Activity targetParent,
        ...
        )
        {
            ...
            )
            {
                ...
                Activity completedActivity = targetActivity.GetActivityByName(
                ...
                if (
                    ...
                    && !(
                        immediateCompensation
                        && IsActivityInBackWorkBranch(targetActivity, completedActivity)
                    )
                )
                    sortedListOfCompensatableTargets.Add(
                        completedActivityInfo.CompletedOrderId,
                        new CompensationInfo(completedActivityInfo, contextManager)
                    );
            }
        }
        ...
        {
            SortedDictionary<int, Activity> sortedListOfCompensatableTargets =
                new SortedDictionary<int, Activity>();
            Queue<Activity> completedActivities = new Queue<Activity>(
                Helpers.GetAllEnabledActivities(compositeActivity)
            );
            while (completedActivities.Count > 0)
