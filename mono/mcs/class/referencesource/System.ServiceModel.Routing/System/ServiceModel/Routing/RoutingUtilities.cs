...
namespace System.ServiceModel.Routing
{
    ...
    {
        internal const string RoutingNamespace =
        ...
        internal static void Abort(ICommunicationObject commObj, object identifier)
        {
            ...
            {
                TD.RoutingServiceAbortingChannel(
                    identifier != null ? identifier.ToString() : string.Empty
                );
            }
        ...
        internal static bool IsRoutingServiceNamespace(string contractNamespace)
        {
            return string.Equals(
                contractNamespace,
                RoutingUtilities.RoutingNamespace,
                StringComparison.Ordinal
            );
        }
        ...
        {
            // New school
            ITransactedBindingElement transactedBindingElement =
                binding.GetProperty<ITransactedBindingElement>(bindingParameters);
            ...
            foreach (BindingElement element in binding.CreateBindingElements())
            {
                ...
                if (
                    transactedBindingElement != null
                    && transactedBindingElement.TransactedReceiveEnabled
                )
                {
                    return true;
                }
