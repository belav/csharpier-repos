...
namespace System.ServiceModel.Routing.Configuration
{
    ...
    public class RoutingSection : ConfigurationSection
    {
        ...
        [ConfigurationProperty(
            ConfigurationStrings.FilterTables,
            Options = ConfigurationPropertyOptions.None
        )]
        ...
        [ConfigurationProperty(
            ConfigurationStrings.BackupLists,
            Options = ConfigurationPropertyOptions.None
        )]
        ...
        [ConfigurationProperty(
            ConfigurationStrings.NamespaceTable,
            Options = ConfigurationPropertyOptions.None
        )]
        ...
        public static MessageFilterTable<IEnumerable<ServiceEndpoint>> CreateFilterTable(
            string name
        )
        {
            ...
            RoutingSection routingSection = (RoutingSection)
            ...
            MessageFilterTable<IEnumerable<ServiceEndpoint>> routingTable =
            ...
            foreach (FilterTableEntryElement entry in routingTableElement)
            {
                ...
                {
                    BackupEndpointCollection alternateEndpointListElement =
    ...
    [SuppressMessage(
        ...
        FxCop.Rule.CollectionsShouldImplementGenericInterface,
        Justification = "generic interface not needed for config"
    )]
    [ConfigurationCollection(
        typeof(FilterTableEntryCollection),
        AddItemName = ConfigurationStrings.FilterTable
    )]
    ...
    [ConfigurationCollection(
        typeof(BackupEndpointCollection),
    ...
    public class BackupEndpointCollection : ConfigurationElementCollection
    {
        ...
        internal IList<ServiceEndpoint> CreateAlternateEndpoints()
        {
            ...
            {
                ServiceEndpoint serviceEnpoint = ClientEndpointLoader.LoadEndpoint(
                    entryElement.EndpointName
                );
    ...
    public class FilterElement : ConfigurationElement
    {
        ...
        [SuppressMessage(
            FxCop.Category.Configuration,
            FxCop.Rule.ConfigurationValidatorAttributeRule,
            Justification = "fxcop didn't like validator"
        )]
        [ConfigurationProperty(
            ConfigurationStrings.FilterType,
            DefaultValue = null,
            Options = ConfigurationPropertyOptions.IsRequired
        )]
        public FilterType FilterType
        {
            get { return (FilterType)this[ConfigurationStrings.FilterType]; }
            set
            {
        ...
        [ConfigurationProperty(
            ConfigurationStrings.FilterData,
            DefaultValue = null,
            Options = ConfigurationPropertyOptions.None
        )]
        public string FilterData
        {
            get { return (string)this[ConfigurationStrings.FilterData]; }
            set { this[ConfigurationStrings.FilterData] = value; }
        }
        ...
        [ConfigurationProperty(
            ConfigurationStrings.Filter1,
            DefaultValue = null,
            Options = ConfigurationPropertyOptions.None
        )]
        public string Filter1
        {
            get { return (string)this[ConfigurationStrings.Filter1]; }
            set { this[ConfigurationStrings.Filter1] = value; }
        }
        ...
        [ConfigurationProperty(
            ConfigurationStrings.Filter2,
            DefaultValue = null,
            Options = ConfigurationPropertyOptions.None
        )]
        public string Filter2
        {
            get { return (string)this[ConfigurationStrings.Filter2]; }
            set { this[ConfigurationStrings.Filter2] = value; }
        }
        ...
        [ConfigurationProperty(
            ConfigurationStrings.CustomType,
            DefaultValue = null,
            Options = ConfigurationPropertyOptions.None
        )]
        public string CustomType
        {
            get { return (string)this[ConfigurationStrings.CustomType]; }
            set { this[ConfigurationStrings.CustomType] = value; }
        }

        internal MessageFilter CreateFilter(
        ...
        )
        {
            ...
            switch (this.FilterType)
            {
                ...
                case FilterType.EndpointAddress:
                    filter = new EndpointAddressMessageFilter(
                        new EndpointAddress(this.FilterData),
                        false
                    );
                    break;
                case FilterType.PrefixEndpointAddress:
                    filter = new PrefixEndpointAddressMessageFilter(
                        new EndpointAddress(this.FilterData),
                        false
                    );
                    break;
    ...
    public class NamespaceElement : ConfigurationElement
    {
        ...
        {
            get { return (string)this[ConfigurationStrings.Prefix]; }
            set { this[ConfigurationStrings.Prefix] = value; }
        }
        ...
        {
            get { return (string)this[ConfigurationStrings.Namespace]; }
            set { this[ConfigurationStrings.Namespace] = value; }
        }
    }
    ...
    public class FilterTableEntryElement : ConfigurationElement
    {
        ...
        [ConfigurationProperty(
            ConfigurationStrings.FilterName,
            DefaultValue = null,
            Options = ConfigurationPropertyOptions.IsRequired | ConfigurationPropertyOptions.IsKey
        )]
        public string FilterName
        {
            get { return (string)this[ConfigurationStrings.FilterName]; }
            set { this[ConfigurationStrings.FilterName] = value; }
        }

        [SuppressMessage(
            FxCop.Category.Configuration,
            FxCop.Rule.ConfigurationPropertyNameRule,
            Justification = "fxcop rule throws null ref if fixed"
        )]
        [SuppressMessage(
            FxCop.Category.Configuration,
            FxCop.Rule.ConfigurationValidatorAttributeRule,
        ...
        [ConfigurationProperty(
            ConfigurationStrings.EndpointName,
            DefaultValue = null,
            Options = ConfigurationPropertyOptions.IsRequired | ConfigurationPropertyOptions.IsKey
        )]
        public string EndpointName
        {
            get { return (string)this[ConfigurationStrings.EndpointName]; }
            set { this[ConfigurationStrings.EndpointName] = value; }
        }

        [SuppressMessage(
            FxCop.Category.Configuration,
            FxCop.Rule.ConfigurationValidatorAttributeRule,
            Justification = "fxcop didn't like IntegerValidator"
        )]
        [ConfigurationProperty(
            ConfigurationStrings.Priority,
            DefaultValue = 0,
            Options = ConfigurationPropertyOptions.None
        )]
        public int Priority
        {
            get { return (int)this[ConfigurationStrings.Priority]; }
            set { this[ConfigurationStrings.Priority] = value; }
        }
        ...
        [ConfigurationProperty(
            ConfigurationStrings.BackupList,
            DefaultValue = null,
            Options = ConfigurationPropertyOptions.None
        )]
        public string BackupList
        {
            get { return (string)this[ConfigurationStrings.BackupList]; }
            set { this[ConfigurationStrings.BackupList] = value; }
        }
    }
