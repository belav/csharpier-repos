...
namespace System.ServiceModel.Configuration
{
    ...
    public sealed partial class UdpTransportElement : TransportElement
    {
        ...
        public override void ApplyConfiguration(BindingElement bindingElement)
        {
            ...
            udpTransportBindingElement.MaxPendingMessagesTotalSize =
        ...
        protected internal override void InitializeFrom(BindingElement bindingElement)
        {
            ...
            this.SetPropertyValueIfNotDefaultValue(
                UdpTransportConfigurationStrings.SocketReceiveBufferSize,
                udpTransportBindingElement.SocketReceiveBufferSize
            );
            this.SetPropertyValueIfNotDefaultValue(
        ...
        [SuppressMessage(
            ...
            Justification = "there's no validator for UdpRetransmissionSettingsElement"
        )]
        public UdpRetransmissionSettingsElement RetransmissionSettings
        {
            get
            {
                return (UdpRetransmissionSettingsElement)
                    base[UdpTransportConfigurationStrings.RetransmissionSettings];
            }
