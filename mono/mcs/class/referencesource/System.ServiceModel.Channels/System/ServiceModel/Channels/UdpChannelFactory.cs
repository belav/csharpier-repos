...
namespace System.ServiceModel.Channels
{
    ...
    class UdpChannelFactory<TChannel> : ChannelFactoryBase<TChannel>
    {
        ...
        internal UdpChannelFactory(
            UdpTransportBindingElement transportBindingElement,
            ...
            : base(context.Binding)
        {
            ...
            Fx.Assert(
                ...
                "this channel factory only supports IOutputChannel and IDuplexChannel"
            );
            ...
            bool retransmissionEnabled = this.udpTransportBindingElement
            ...
            this.BufferManager = BufferManager.CreateBufferManager(
                transportBindingElement.MaxBufferPoolSize,
                maxBufferSize
            );
        }

        BufferManager BufferManager { get; set; }
        ...
        protected override TChannel OnCreateChannel(EndpointAddress to, Uri via)
        {
            Fx.Assert(
                to != null,
                "To address should have been validated as non-null by ChannelFactoryBase"
            );
            Fx.Assert(
                via != null,
                "Via address should have been validated as non-null by ChannelFactoryBase"
            );
            ...
            lock (this.ThisLock)
            {
                ...
                {
                    UdpChannelFactory<IDuplexChannel> duplexChannelFactory =
                        (UdpChannelFactory<IDuplexChannel>)(object)this;
                    channel = (TChannel)
                        (object)
                            new ClientUdpDuplexChannel(
                ...
                {
                    UdpChannelFactory<IOutputChannel> outputChannelFactory =
                        (UdpChannelFactory<IOutputChannel>)(object)this;
                    channel = (TChannel)
                        (object)
                            new ClientUdpOutputChannel(
                                outputChannelFactory,
                                remoteEndPoint,
                                outputChannelFactory.messageEncoderFactory.Encoder,
                                this.BufferManager,
                                sockets,
                                outputChannelFactory.udpTransportBindingElement
                                    .RetransmissionSettings,
                                to,
                                via,
                                isMulticast
        ...
        UdpSocket[] GetSockets(Uri via, out IPEndPoint remoteEndPoint, out bool isMulticast)
        {
            ...
            {
                UdpSocket socket = UdpUtility.CreateUnicastListenSocket(
                    localAddress,
                    ref port,
                    this.udpTransportBindingElement.SocketReceiveBufferSize,
                    this.udpTransportBindingElement.TimeToLive
            ...
            Fx.Assert(
                results != null,
                "GetSockets(...) return results should never be null. An exception should have been thrown but wasn't."
            );
            return results;
        }
        ...
        sealed class ClientUdpDuplexChannel : UdpDuplexChannel
        {
            ...
            internal ClientUdpDuplexChannel(
                UdpChannelFactory<IDuplexChannel> factory,
                UdpSocket[] sockets,
                ...
                )
            {
                ...
                UdpOutputChannel udpOutputChannel = new ClientUdpOutputChannel(
                    factory,
                    remoteEndPoint,
                    factory.messageEncoderFactory.Encoder,
                    factory.BufferManager,
            ...
            {
                this.ReceiveManager = new UdpSocketReceiveManager(
                    this.Sockets,
