...
namespace System.ServiceModel.Channels
{
    ...
    public sealed class UdpRetransmissionSettings
    {
        ...
        )
        {
            ...
            this.maxDelayMilliseconds = TimeoutHelper.ToMilliseconds(
        ...
        UdpRetransmissionSettings(UdpRetransmissionSettings other)
            : this(
                other.maxUnicastRetransmitCount,
                other.maxMulticastRetransmitCount,
                other.delayLowerBound,
                other.delayUpperBound,
        ...
        {
            get { return this.maxUnicastRetransmitCount; }
            set
            {
                const int min = 0;
                if (value < min)
        ...
        {
            get { return this.maxMulticastRetransmitCount; }
            set
            {
                const int min = 0;
                if (value < min)
        ...
        {
            get { return this.delayLowerBound; }
            set
            {
                ...
                this.delayLowerBoundMilliseconds = TimeoutHelper.ToMilliseconds(
        ...
        {
            get { return this.delayUpperBound; }
            set
            {
                if (value < TimeSpan.Zero)
                {
                ...
                this.delayUpperBoundMilliseconds = TimeoutHelper.ToMilliseconds(
        ...
        {
            get { return this.maxDelayPerRetransmission; }
            set
            {
                if (value < TimeSpan.Zero)
                {
        ...
        internal bool IsMatch(UdpRetransmissionSettings udpRetransmissionSettings)
        {
            ...
            if (
                this.MaxUnicastRetransmitCount
        ...
        bool TimeSpansEqual(TimeSpan ts1, TimeSpan ts2)
        {
            ...
            return diff < TimeSpan.FromMilliseconds(1).Ticks
