...
namespace System.ServiceModel.Discovery.Version11
{
    ...
    class ProbeMatches11 : Collection<EndpointDiscoveryMetadata11>
    {
        ...
        public static ProbeMatches11 Create(EndpointDiscoveryMetadata endpointDiscoveryMetadata)
        {
            ...
            {
                EndpointDiscoveryMetadata11.FromEndpointDiscoveryMetadata(
                    endpointDiscoveryMetadata
                ),
            };
        }

        public static ProbeMatches11 Create(
        ...
        )
        {
            ...
            {
                foreach (
                    EndpointDiscoveryMetadata endpointDiscoveryMetadata in endpointDiscoveryMetadatas
                )
                {
                    probeMatches.Add(
                        EndpointDiscoveryMetadata11.FromEndpointDiscoveryMetadata(
