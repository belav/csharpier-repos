...
namespace System.ServiceModel.Discovery.VersionApril2005
{
    ...
    class DiscoveryInnerClientApril2005<TChannel>
        : IDiscoveryInnerClient,
            IDiscoveryResponseContractApril2005
        where TChannel : class, IDiscoveryContractApril2005
    {
        ...
        public DiscoveryInnerClientApril2005(
        ...
        public IAsyncResult BeginProbeMatchOperation(
            ProbeMatchesMessageApril2005 response,
            AsyncCallback callback,
            object state
        )
        {
        ...
        public IAsyncResult BeginResolveMatchOperation(
            ResolveMatchesMessageApril2005 response,
            AsyncCallback callback,
            object state
        )
        {
