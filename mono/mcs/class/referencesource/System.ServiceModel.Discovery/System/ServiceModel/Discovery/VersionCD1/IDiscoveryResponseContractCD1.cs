...
namespace System.ServiceModel.Discovery.VersionCD1
{
    ...
    {
        [OperationContract(
            Action = ProtocolStrings.VersionCD1.ProbeMatchesAction,
            IsOneWay = true,
            AsyncPattern = true
        )]
        IAsyncResult BeginProbeMatchOperation(
            ProbeMatchesMessageCD1 response,
        ...
        IAsyncResult BeginResolveMatchOperation(
            ResolveMatchesMessageCD1 response,
            AsyncCallback callback,
            object state
        );
        ...
        [OperationContract(
            Action = ProtocolStrings.VersionCD1.HelloAction,
            IsOneWay = true,
            AsyncPattern = true
        )]
