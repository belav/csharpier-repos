...
namespace System.ServiceModel.Discovery
{
    ...
    class DiscoveryClientChannelFactory<TChannel> : ChannelFactoryBase<TChannel>
    {
        ...
        )
        {
            ...
            Fx.Assert(
                discoveryEndpointProvider != null,
                "The discoveryEndpointProvider must be non null."
            );
        ...
        protected override TChannel OnCreateChannel(EndpointAddress address, Uri via)
        {
            ...
            if (typeof(TChannel) == typeof(IOutputChannel))
            {
                return (TChannel)
                    (object)
                        new DiscoveryClientOutputChannel<IOutputChannel>(
                            this,
            ...
            else if (typeof(TChannel) == typeof(IRequestChannel))
            {
                return (TChannel)
                    (object)
                        new DiscoveryClientRequestChannel<IRequestChannel>(
                            this,
            ...
            else if (typeof(TChannel) == typeof(IDuplexChannel))
            {
                return (TChannel)
                    (object)
                        new DiscoveryClientDuplexChannel<IDuplexChannel>(
                            this,
            ...
            else if (typeof(TChannel) == typeof(IOutputSessionChannel))
            {
                return (TChannel)
                    (object)
                        new DiscoveryClientOutputSessionChannel(
                            this,
            ...
            else if (typeof(TChannel) == typeof(IRequestSessionChannel))
            {
                return (TChannel)
                    (object)
                        new DiscoveryClientRequestSessionChannel(
                            this,
            ...
            else if (typeof(TChannel) == typeof(IDuplexSessionChannel))
            {
                return (TChannel)
                    (object)
                        new DiscoveryClientDuplexSessionChannel(
                            this,
