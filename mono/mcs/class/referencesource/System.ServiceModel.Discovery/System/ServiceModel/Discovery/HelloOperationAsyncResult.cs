...
namespace System.ServiceModel.Discovery
{
    ...
    {
        static AsyncCompletion onOnOnlineAnnoucementCompletedCallback = new AsyncCompletion(
            OnOnOnlineAnnouncementCompleted
        );
            ...
            : base(callback, state)
        {
            ...
            IAsyncResult innerAsyncResult = this.announcementServiceImpl.OnBeginOnlineAnnouncement(
        ...
        {
            HelloOperationAsyncResult<TMessage> thisPtr =
                (HelloOperationAsyncResult<TMessage>)result.AsyncState;
