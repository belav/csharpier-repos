...
namespace System.ServiceModel.Discovery
{
            ...
            IDiscoveryServiceImplementation
    {
        ...
        {
            get { return this.messageSequenceGenerator; }
        }
            ...
            if (context.IncomingMessageHeaders.ReplyTo == null)
            {
                if (TD.DiscoveryMessageWithNullReplyToIsEnabled())
                {
                    EventTraceActivity eventTraceActivity =
                        EventTraceActivityHelper.TryExtractActivity(context.IncomingMessage);
                    TD.DiscoveryMessageWithNullReplyTo(
                        eventTraceActivity,
                        context.IncomingMessageHeaders.MessageId.ToString()
                    );
                }
