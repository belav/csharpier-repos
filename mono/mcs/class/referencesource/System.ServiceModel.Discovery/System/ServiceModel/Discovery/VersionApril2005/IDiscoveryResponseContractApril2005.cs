...
namespace System.ServiceModel.Discovery.VersionApril2005
{
    ...
    {
        [OperationContract(
            Action = ProtocolStrings.VersionApril2005.ProbeMatchesAction,
            IsOneWay = true,
            AsyncPattern = true
        )]
        ...
        [OperationContract(
            Action = ProtocolStrings.VersionApril2005.ResolveMatchesAction,
            IsOneWay = true,
            AsyncPattern = true
        )]
        ...
        [OperationContract(
            Action = ProtocolStrings.VersionApril2005.HelloAction,
            IsOneWay = true,
            AsyncPattern = true
        )]
