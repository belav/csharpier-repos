...
namespace System.ServiceModel.Discovery
{
    ...
    class UdpReplyToBehavior : IEndpointBehavior, IDispatchMessageInspector, IClientMessageInspector
    {
        ...
        )
        {
            ...
            endpointDispatcher.AddressFilter = new UdpDiscoveryMessageFilter(
        ...
        )
        {
            ...
            )
            {
                RemoteEndpointMessageProperty remoteEndpointProperty =
                    messageProperty as RemoteEndpointMessageProperty;
            ...
            if (addressingState != null)
            {
                DiscoveryMessageProperty discoveryMessageProperty = new DiscoveryMessageProperty(
                    addressingState
                );
                OperationContext.Current.IncomingMessageProperties[DiscoveryMessageProperty.Name] =
        ...
        )
        {
            ...
            )
            {
                DiscoveryMessageProperty discoveryMessageProperty =
                    messageProperty as DiscoveryMessageProperty;
                if (discoveryMessageProperty != null)
                {
                    UdpAddressingState state =
                        discoveryMessageProperty.CorrelationState as UdpAddressingState;
                    if (state != null)
                    {
        ...
        class UdpAddressingState
        {
            ...
            {
                get { return remoteEndpontAddress; }
                set { remoteEndpontAddress = value; }
            }

            public NetworkInterfaceMessageProperty NetworkInterfaceMessageProperty
            {
                get { return networkInterfaceMessageProperty; }
                set { networkInterfaceMessageProperty = value; }
            }
        }
    }
}
