...
namespace System.Web.ClientServices.Providers
{
    ...
    internal static class SqlHelper
    {
        ...
        internal static int IsSpecialConnectionString(string connectionString)
        {
            ...
            if (
                string.Compare(connectionString, _SQL_FILES_Tag, StringComparison.OrdinalIgnoreCase)
                == 0
            )
                return 1;
        ...
        {
            if (
                connectionString.Contains(_SQL_CE_Tag)
                || (sqlProvider != null && sqlProvider.Contains(".SqlServerCe"))
            )
            {
                try
                {
        ...
        /////////////////////////////////////////////////////////////////////////////////
        /////////////////////////////////////////////////////////////////////////////////
        internal static string GetCookieFromDB(
            string name,
            string username,
            string connectionString,
            string sqlProvider
        ...
        /////////////////////////////////////////////////////////////////////////////////
        /////////////////////////////////////////////////////////////////////////////////
        internal static string StoreCookieInDB(
            string cookieName,
            string cookieValue,
            string username,
            string connectionString,
        ...
        /////////////////////////////////////////////////////////////////////////////////
        /////////////////////////////////////////////////////////////////////////////////
        internal static void DeleteAllCookies(
            string username,
            string connectionString,
            string sqlProvider
        )
        {
            ...
            {
                ClientDataManager.DeleteAllCookies(
                    username,
                    connectionString == _Isolated_Storage_Tag
                );
                return;
            }
        ...
        private static DbConnection CreateDBIfRequired(string username, string connectionString)
        {
            ...
            {
                using (
                    IDisposable engine = (IDisposable)
                        Activator.CreateInstance(
                            GetSqlCeType("SqlCeEngine"),
        ...
        private static Type GetSqlCeType(string typeName)
        {
            // Try versionless
            Type t = Type.GetType(
                "System.Data.SqlServerCe." + typeName + ", System.Data.SqlServerCe",
                false,
                true
            );
            if (t != null)
        ...
        private static DbConnection CreateNewSqlCeConnection(string connectionString, bool openConn)
        {
            ...
            DbConnection conn = (DbConnection)
                Activator.CreateInstance(_SqlCeConnectionType, new object[] { connectionString });
            if (openConn)
                conn.Open();
            return conn;
        }
        ...
        internal static string GetFullDBFileName(string username, string extension)
        {
            return Path.Combine(
                ...
                GetPartialDBFileName(username, extension)
            );
        }
