...
namespace System.Web.ClientServices.Providers
{
    ...
    internal static class ProxyHelper
    {
        /////////////////////////////////////////////////////////////////////////////////
        /////////////////////////////////////////////////////////////////////////////////
        internal static object CreateWebRequestAndGetResponse(
            string serverUri,
        ...
        )
        {
            ...
            if (cookies == null)
                cookies = ConstructCookieContainer(
                    serverUri,
                    username,
                    connectionString,
            ...
            try
            {
                using (HttpWebResponse response = (HttpWebResponse)request.GetResponse())
                {
                    ...
                    Dictionary<string, object> wrapperObject =
                        js.DeserializeObject(responseJson) as Dictionary<string, object>;
            ...
            catch (WebException we)
            {
                ...
                throw new WebException(
                    String.Format(
                        ...
                        AtlasWeb.ProxyHelper_BadStatusCode,
        ...
        /////////////////////////////////////////////////////////////////////////////////
        /////////////////////////////////////////////////////////////////////////////////
        private static void GetCookiesFromResponse(
        ...
        private static byte[] GetSerializedParameters(string[] paramNames, object[] paramValues)
        {
            ...
            for (int iter = 1; iter < len; iter++)
                sb.Append(
                    "," + js.Serialize(paramNames[iter]) + ":" + js.Serialize(paramValues[iter])
                );
            sb.Append("}");
        ...
        internal static CustomBinding GetBinding()
        {
            ...
            if (
                ...
                && Thread.CurrentPrincipal.Identity is WindowsIdentity
            )
                be.AuthenticationScheme = AuthenticationSchemes.Negotiate;
            TextMessageEncodingBindingElement tmbe = new TextMessageEncodingBindingElement(
        ...
        internal static void GetCookiesFromWCF(
        ...
        )
        {
            ...
            if (
                httpResponseProperty == null
                || httpResponseProperty.Headers == null
                || httpResponseProperty.Headers.Count < 1
            )
                return;
            ...
            for (int iter = 0; iter < count; iter++)
            {
                ...
                StoreCookie(
                    serverUri,
                    httpResponseProperty.Headers[iter],
                    username,
                    connectionString,
                    connectionStringProvider
                );
        ...
        internal static void AddCookiesToWCF(
            CookieContainer authenticationCookies,
            string serverUri,
            string username,
            string connectionString,
        ...
        )
        {
            ...
            else
            {
                ...
                string[] cookies = GetCookiesFromIECache(
                    serverUri,
                    username,
                    connectionString,
                    connectionStringProvider
        ...
        /////////////////////////////////////////////////////////////////////////////////
        /////////////////////////////////////////////////////////////////////////////////
        internal static CookieContainer ConstructCookieContainer(
            string serverUri,
            string username,
            string connectionString,
            string connectionStringProvider
        )
        {
            ...
            string[] allCookies = GetCookiesFromIECache(
                serverUri,
                username,
                connectionString,
                connectionStringProvider
        ...
        /////////////////////////////////////////////////////////////////////////////////
        /////////////////////////////////////////////////////////////////////////////////
        internal static bool DoAnyCookiesExist(
            string serverUri,
            string username,
            string connectionString,
            string connectionStringProvider
        ...
        )
        {
            ...
            {
                StringBuilder cookieHeaderStrBuilder = new StringBuilder(
                    cookieHeaderSplits[iter++]
                );
                ...
                string cookieName = (
                    (posEquals < 0) ? cookieHeader : cookieHeader.Substring(0, posEquals)
                ).Trim();
                string cookieValue = (
                    (posEquals < 0) ? string.Empty : cookieHeader.Substring(posEquals + 1)
                ).Trim();
                ...
                if (
                    UnsafeNativeMethods.InternetSetCookieW(
                        serverUri,
                        null,
        ...
        /////////////////////////////////////////////////////////////////////////////////
        /////////////////////////////////////////////////////////////////////////////////
        private static string GetCookieFromDB(
            string cookieHeader,
            string username,
            string connectionString,
            string connectionStringProvider
        )
        {
            ...
            if (
                cookieHeader.Length != 34
                || cookieHeader[33] != 'Q'
                || cookieHeader.IndexOf('=') != 32
            )
                return cookieHeader; // not of the correct form

            return SqlHelper.GetCookieFromDB(
                cookieHeader.Substring(0, 32),
                username,
                connectionString,
                connectionStringProvider
            );
        ...
        /////////////////////////////////////////////////////////////////////////////////
        /////////////////////////////////////////////////////////////////////////////////
        private static void ChangeCookieAndStoreInDB(
            ref string cookieName,
        ...
        )
        {
            ...
            StringBuilder sb = new StringBuilder(
                (connectionString == null) ? actualCookieValue : "Q",
                cookieValue.Length
            );
            ...
            if (connectionString != null)
            {
                string newCookieName = SqlHelper.StoreCookieInDB(
                    cookieName,
                    actualCookieValue,
                    username,
                    connectionString,
    ...
    internal static class UnsafeNativeMethods
    {
        ...
        internal static extern int InternetSetCookieW(
            string uri,
            string cookieName,
            string cookieValue
        );
        ...
        // [PermissionSet(SecurityAction.Assert, Unrestricted = true)]
        [DllImport("wininet.dll", SetLastError = true, CharSet = CharSet.Unicode)]
        internal static extern int InternetGetCookieW(
            string uri,
            string cookieName,
    ...
    internal interface LoginService
    {
        [System.ServiceModel.OperationContractAttribute(
            Action = "http://tempuri.org/LoginService/Login",
            ReplyAction = "http://tempuri.org/LoginService/LoginResponse"
        )]
        bool Login(string username, string password, string customCredential, bool isPersistent);

        [System.ServiceModel.OperationContractAttribute(
            Action = "http://tempuri.org/LoginService/IsLoggedIn",
            ReplyAction = "http://tempuri.org/LoginService/IsLoggedInResponse"
        )]
        bool IsLoggedIn();

        [System.ServiceModel.OperationContractAttribute(
            Action = "http://tempuri.org/LoginService/Logout",
            ReplyAction = "http://tempuri.org/LoginService/LogoutResponse"
        )]
        void Logout();
    }
    ...
    {
        [System.ServiceModel.OperationContractAttribute(
            Action = "http://tempuri.org/RolesService/GetRolesForCurrentUser",
            ReplyAction = "http://tempuri.org/RolesService/GetRolesForCurrentUserResponse"
        )]
    ...
    internal interface ProfileService
    {
        [
            System.ServiceModel.OperationContractAttribute(
                Action = "http://tempuri.org/ProfileService/GetPropertiesForCurrentUser",
                ReplyAction = "http://tempuri.org/ProfileService/GetPropertiesForCurrentUserResponse"
            ),
            SuppressMessage(
                "Microsoft.Security",
                "CA2116:AptcaMethodsShouldOnlyCallAptcaMethods",
        ...
        System.Collections.Generic.Dictionary<string, object> GetPropertiesForCurrentUser(
            string[] properties,
        ...
        [
            System.ServiceModel.OperationContractAttribute(
                Action = "http://tempuri.org/ProfileService/SetPropertiesForCurrentUser",
                ReplyAction = "http://tempuri.org/ProfileService/SetPropertiesForCurrentUserResponse"
            ),
            SuppressMessage(
                "Microsoft.Security",
                "CA2116:AptcaMethodsShouldOnlyCallAptcaMethods",
        ...
        //[NetDataContractFormat]
        Collection<string> SetPropertiesForCurrentUser(
        ...
        [
            System.ServiceModel.OperationContractAttribute(
                ...
                ReplyAction = "http://tempuri.org/ProfileService/GetPropertiesMetadataResponse"
            ),
            SuppressMessage(
                "Microsoft.Security",
                "CA2116:AptcaMethodsShouldOnlyCallAptcaMethods",
    ...
    /////////////////////////////////////////////////////////////////////////////
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "3.0.0.0")]
    internal interface ProfileServiceChannel
        : ProfileService,
            ...
            ProfileService
    {
        ...
        public System.Collections.Generic.Dictionary<string, object> GetPropertiesForCurrentUser(
