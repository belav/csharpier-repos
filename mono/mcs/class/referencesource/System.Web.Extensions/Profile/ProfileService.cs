...
namespace System.Web.Profile
{
    ...
    internal sealed class ProfileService
    {
        ...
        private static Dictionary<string, object> GetProfile(
            HttpContext context,
            ...
            foreach (KeyValuePair<string, object> entry in values)
            {
                ...
                if (profile != null && allowedSet != null && allowedSet.ContainsKey(propertyName))
                {
                    ...
                    )
                    {
                        ...
                        if (
                            ObjectConverter.TryConvertObjectToType(
                                entry.Value,
                                propertyType,
        ...
        [WebMethod]
        public Dictionary<string, object> GetPropertiesForCurrentUser(
            IEnumerable<string> properties,
        ...
        [WebMethod]
        public Collection<string> SetPropertiesForCurrentUser(
            IDictionary<string, object> values,
            bool authenticatedUserOnly
        )
        {
