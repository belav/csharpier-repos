...
namespace System.Web.UI
{
    ...
    internal static class WebResourceUtil
    {
        ...
        private static readonly Hashtable _assemblyContainsWebResourceCache =
            Hashtable.Synchronized(new Hashtable());
        private static readonly FastStringLookupTable _systemWebExtensionsCache =
        ...
        private static FastStringLookupTable CreateSystemWebExtensionsCache()
        {
            ...
            var resourceNames = from WebResourceAttribute attr in attrs select attr.WebResource;
        ...
        public static void VerifyAssemblyContainsReleaseWebResource(
            Assembly assembly,
        ...
        // Throws exception if the assembly does not contain a Web resource and an embedded resource
        // with the specified name.
        public static void VerifyAssemblyContainsDebugWebResource(
            Assembly assembly,
            string debugResourceName
        )
        {
        ...
        private class FastStringLookupTable
        {
            ...
            public FastStringLookupTable(IEnumerable<string> strings)
            {
                ...
                var groups = from s in strings group s by s.Length into g select g;
