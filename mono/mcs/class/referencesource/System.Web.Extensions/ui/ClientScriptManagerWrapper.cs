...
namespace System.Web.UI
{
    ...
    internal sealed class ClientScriptManagerWrapper : IClientScriptManager
    {
        ...
        > IClientScriptManager.RegisteredResourcesToSuppress
        {
            get { return _clientScriptManager.RegisteredResourcesToSuppress; }
        }
        ...
        void IClientScriptManager.RegisterClientScriptBlock(
            Type type,
            string key,
            string script,
            bool addScriptTags
        ...
        void IClientScriptManager.RegisterStartupScript(
            Type type,
            string key,
            string script,
            bool addScriptTags
