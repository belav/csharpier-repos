...
namespace System.Web.UI
{
    ...
    public abstract class ScriptReferenceBase
    {
        ...
        {
            get { return _alwaysLoadBeforeUI; }
            set { _alwaysLoadBeforeUI = value; }
        }
        ...
        {
            get { return _clientUrlResolver; }
            set { _clientUrlResolver = value; }
        }
        ...
        {
            get { return _isStaticReference; }
            set { _isStaticReference = value; }
        }
        ...
        {
            get { return _notifyScriptLoaded; }
            set { _notifyScriptLoaded = value; }
        }
        ...
        {
            get { return _resourceUICultures; }
            set { _resourceUICultures = value; }
        }
            ...
            if (!pathWithoutQuery.EndsWith(".js", StringComparison.Ordinal))
            {
                throw new InvalidOperationException(
                    String.Format(
                        ...
                        AtlasWeb.ScriptReference_InvalidReleaseScriptPath,
                        pathWithoutQuery
                    )
                );
            }
