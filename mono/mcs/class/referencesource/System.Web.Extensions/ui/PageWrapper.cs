...
namespace System.Web.UI
{
    ...
    internal sealed class PageWrapper : IPage
    {
        ...
        {
            get { return _page._hiddenFieldsToRender; }
        }
        ...
        {
            get { return new HttpRequestWrapper(_page.Request); }
        }

        HttpResponseInternalBase IPage.Response
        {
            get { return new HttpResponseInternalWrapper(_page.Response); }
        }

        HttpServerUtilityBase IPage.Server
        {
            get { return new HttpServerUtilityWrapper(_page.Server); }
        }
