...
namespace System.Web.UI.WebControls
{
    ...
    public class ListViewPagedDataSource : ICollection, ITypedList
    {
        ...
        {
            get { return _allowServerPaging; }
            set { _allowServerPaging = value; }
        }
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        throw new InvalidOperationException(
                            AtlasWeb.ListViewPagedDataSource_CannotGetCount
                        );
                    }
                }
            }
        ...
        private sealed class EnumeratorOnIList : IEnumerator
        {
            ...
            public object Current
            {
                get
                {
                    ...
                    {
                        throw new InvalidOperationException(
                            AtlasWeb.ListViewPagedDataSource_EnumeratorMoveNextNotCalled
                        );
                    }
