...
namespace System.Web.UI.WebControls
{
    ...
    public partial class LinqDataSourceView : ContextDataSourceView
    {
        ...
        public override Type ContextType
        {
            ...
            get
            {
                if (_contextType == null)
                {
                    ...
                    if (String.IsNullOrEmpty(typeName))
                    {
                        throw new InvalidOperationException(
                            String.Format(
                                ...
                                AtlasWeb.LinqDataSourceView_ContextTypeNameNotSpecified,
                                _owner.ID
                            )
                        );
                    }
                    try
                    {
                        _contextType = BuildManager.GetType(
                    ...
                    catch (Exception e)
                    {
                        throw new InvalidOperationException(
                            String.Format(
                                CultureInfo.InvariantCulture,
                                AtlasWeb.LinqDataSourceView_ContextTypeNameNotFound,
                                _owner.ID
                            ),
                            e
                        );
                ...
                if (_contextTypeName != value)
                {
                    if (_reuseSelectContext)
                    {
                        throw new InvalidOperationException(
                            String.Format(
                                CultureInfo.InvariantCulture,
                                AtlasWeb.LinqDataSourceView_ContextTypeNameChanged,
                                _owner.ID
                            )
                        );
                    }
        ...
        {
            get { return _enableObjectTracking; }
            set
            {
                if (_enableObjectTracking != value)
                {
                    if (_reuseSelectContext)
                    {
                        throw new InvalidOperationException(
                            String.Format(
                                CultureInfo.InvariantCulture,
                                AtlasWeb.LinqDataSourceView_EnableObjectTrackingChanged,
                                _owner.ID
                            )
                        );
                    }
                ...
                if (EntitySetName != value)
                {
                    if (_reuseSelectContext)
                    {
                        throw new InvalidOperationException(
                            String.Format(
                                CultureInfo.InvariantCulture,
                                AtlasWeb.LinqDataSourceView_TableNameChanged,
                                _owner.ID
                            )
                        );
                    }
        ...
        private ContextDataSourceContextData CreateContextAndTable(DataSourceOperation operation)
        {
            ...
            try
            {
                LinqDataSourceContextEventArgs contextEventArgs =
                    new LinqDataSourceContextEventArgs(operation);
            ...
            {
                eventFired = true;
                LinqDataSourceStatusEventArgs createdEventArgs = new LinqDataSourceStatusEventArgs(
                    e
                );
                OnContextCreated(createdEventArgs);
                OnException(
                    new DynamicValidatorEventArgs(e, DynamicDataSourceOperation.ContextCreate)
                );
            ...
            finally
            {
                if (!eventFired)
                {
                    ...
                    LinqDataSourceStatusEventArgs createdEventArgs =
                        new LinqDataSourceStatusEventArgs(context);
                    OnContextCreated(createdEventArgs);
                }
            }
            return contextData;
        ...
        {
            LinqDataSourceDeleteEventArgs deleteEventArgs = new LinqDataSourceDeleteEventArgs(
                oldEntity
            );
        ...
        protected override void DisposeContext(object dataContext)
        {
            if (dataContext != null)
            {
                LinqDataSourceDisposeEventArgs disposingEventArgs =
                    new LinqDataSourceDisposeEventArgs(dataContext);
        ...
        protected internal override IEnumerable ExecuteSelect(DataSourceSelectArguments arguments)
        {
            ...
            if (_selectResult != null)
            {
                ...
                {
                    result = null;
                    LinqDataSourceStatusEventArgs selectedEventArgs =
                        new LinqDataSourceStatusEventArgs(e);
                    OnSelected(selectedEventArgs);
                    OnException(
                        new DynamicValidatorEventArgs(e, DynamicDataSourceOperation.Select)
                    );
                ...
                finally
                {
                    if (result != null)
                    {
                        ...
                        LinqDataSourceStatusEventArgs selectedEventArgs =
                            new LinqDataSourceStatusEventArgs(result, totalRowCount);
                        OnSelected(selectedEventArgs);
                    }
                }
        ...
        protected override object GetSource(QueryContext context)
        {
            ...
            _storeOriginalValues =
                ...
                && String.IsNullOrEmpty(SelectNew);
        ...
        protected virtual MemberInfo GetTableMemberInfo(Type contextType)
        {
            ...
            if (String.IsNullOrEmpty(tableName))
            {
                throw new InvalidOperationException(
                    String.Format(
                        CultureInfo.InvariantCulture,
                        AtlasWeb.LinqDataSourceView_TableNameNotSpecified,
                        _owner.ID
                    )
                );
            }
        ...
        {
            LinqDataSourceValidationException exception = new LinqDataSourceValidationException(
                String.Format(
                    CultureInfo.InvariantCulture,
            ...
            switch (operation)
            {
                case DataSourceOperation.Delete:
                    LinqDataSourceDeleteEventArgs deleteEventArgs =
                        new LinqDataSourceDeleteEventArgs(exception);
                    OnDeleting(deleteEventArgs);
                    OnException(
                        new DynamicValidatorEventArgs(exception, DynamicDataSourceOperation.Delete)
                    );
                    exceptionHandled = deleteEventArgs.ExceptionHandled;
                    break;

                case DataSourceOperation.Insert:
                    LinqDataSourceInsertEventArgs insertEventArgs =
                        new LinqDataSourceInsertEventArgs(exception);
                    OnInserting(insertEventArgs);
                    OnException(
                        new DynamicValidatorEventArgs(exception, DynamicDataSourceOperation.Insert)
                    );
                ...
                case DataSourceOperation.Update:
                    ...
                    LinqDataSourceUpdateEventArgs updateEventArgs =
                        new LinqDataSourceUpdateEventArgs(exception);
                    OnUpdating(updateEventArgs);
                    OnException(
                        new DynamicValidatorEventArgs(exception, DynamicDataSourceOperation.Update)
                    );
        ...
        {
            LinqDataSourceInsertEventArgs insertEventArgs = new LinqDataSourceInsertEventArgs(
                newEntity
            );
            OnInserting(insertEventArgs);
        ...
        protected virtual void OnContextCreated(LinqDataSourceStatusEventArgs e)
        {
            EventHandler<LinqDataSourceStatusEventArgs> handler =
                (EventHandler<LinqDataSourceStatusEventArgs>)Events[EventContextCreated];
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        {
            EventHandler<LinqDataSourceContextEventArgs> handler =
        ...
        {
            EventHandler<LinqDataSourceDisposeEventArgs> handler =
                (EventHandler<LinqDataSourceDisposeEventArgs>)Events[EventContextDisposing];
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        {
            EventHandler<DynamicValidatorEventArgs> handler =
                (EventHandler<DynamicValidatorEventArgs>)Events[EventException];
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        private Dictionary<string, Exception> SetDataObjectProperties(
            object oldDataObject,
            object newDataObject
        )
        {
            ...
            foreach (PropertyDescriptor property in properties)
            {
                if (property.PropertyType.IsSerializable && !property.IsReadOnly)
                {
                    ...
                    catch (Exception e)
                    {
                        ...
                        {
                            validateExceptions = new Dictionary<string, Exception>(
        ...
        {
            _linqToSql.Attach((ITable)table, oldDataObject);
            Dictionary<string, Exception> validateExceptions = SetDataObjectProperties(
                oldDataObject,
                newDataObject
            );
            ...
            if (validateExceptions != null)
            {
                throw new LinqDataSourceValidationException(
                    String.Format(
                        CultureInfo.InvariantCulture,
                        AtlasWeb.LinqDataSourceView_ValidationFailed,
                        oldDataObject.GetType(),
                        validateExceptions.Values.First().Message
                    ),
                    validateExceptions
                );
            }
        ...
        {
            LinqDataSourceUpdateEventArgs updateEventArgs = new LinqDataSourceUpdateEventArgs(
                oldEntity,
                newEntity
            );
            OnUpdating(updateEventArgs);
        ...
        protected virtual void ValidateContextType(Type contextType, bool selecting)
        {
            if (!selecting && !typeof(DataContext).IsAssignableFrom(contextType))
            {
                throw new InvalidOperationException(
                    String.Format(
                        CultureInfo.InvariantCulture,
                        AtlasWeb.LinqDataSourceView_InvalidContextType,
                        _owner.ID
                    )
                );
            }
        ...
        protected virtual void ValidateDeleteSupported(IDictionary keys, IDictionary oldValues)
        {
            if (!CanDelete)
            {
                throw new NotSupportedException(
                    String.Format(
                        CultureInfo.InvariantCulture,
                        AtlasWeb.LinqDataSourceView_DeleteNotSupported,
                        _owner.ID
                    )
                );
            }
        ...
        protected virtual void ValidateEditSupported()
        {
            ...
            if (!String.IsNullOrEmpty(SelectNew))
            {
                throw new InvalidOperationException(
                    String.Format(
                        CultureInfo.InvariantCulture,
                        AtlasWeb.LinqDataSourceView_SelectNewNotSupportedOnEdit,
                        _owner.ID
                    )
                );
            }
        ...
        protected virtual void ValidateInsertSupported(IDictionary values)
        {
            if (!CanInsert)
            {
                throw new NotSupportedException(
                    String.Format(
                        CultureInfo.InvariantCulture,
                        AtlasWeb.LinqDataSourceView_InsertNotSupported,
                        _owner.ID
                    )
                );
            }
            ...
            if ((values == null) || (values.Count == 0))
            {
                throw new InvalidOperationException(
                    String.Format(
                        CultureInfo.InvariantCulture,
                        AtlasWeb.LinqDataSourceView_InsertRequiresValues,
                        _owner.ID
                    )
                );
            }
        ...
        protected virtual void ValidateTableType(Type tableType, bool selecting)
        {
            if (!selecting)
            {
                if (
                    !(
                        tableType.IsGenericType
                        && tableType.GetGenericArguments().Length == 1
                        && typeof(ITable).IsAssignableFrom(tableType)
                    )
                )
                {
                    throw new InvalidOperationException(
                        String.Format(
                            CultureInfo.InvariantCulture,
                            AtlasWeb.LinqDataSourceView_InvalidTablePropertyType,
                            _owner.ID
                        )
                    );
                }
        ...
        )
        {
            if (!CanUpdate)
            {
                throw new NotSupportedException(
                    String.Format(
                        CultureInfo.InvariantCulture,
                        AtlasWeb.LinqDataSourceView_UpdateNotSupported,
                        _owner.ID
                    )
                );
            }
