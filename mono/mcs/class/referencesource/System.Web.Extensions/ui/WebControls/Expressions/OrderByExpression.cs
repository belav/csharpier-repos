namespace System.Web.UI.WebControls.Expressions
{
    ...
    [PersistChildren(false), ParseChildren(true, "ThenByExpressions")]
    public class OrderByExpression : DataSourceExpression
    {
        ...
        private static IQueryable CreateSortQueryable(
            IQueryable source,
        ...
        )
        {
            string methodName = isThenBy
                ? GetThenBySortMethod(direction)
                : GetSortMethod(direction);
            Expression propertyExpression = ExpressionHelper.CreatePropertyExpression(
                parameterExpression,
                dataField
            );
