namespace System.Web.UI.WebControls.Expressions
{
    ...
    public class SearchExpression : ParameterDataSourceExpression
    {
        ...
        {
            get { return (string)ViewState["DataFields"] ?? String.Empty; }
        ...
        public override IQueryable GetQueryable(IQueryable source)
        {
            ...
            string[] properties = DataFields.Split(
                new[] { ',' },
            ...
            {
                Expression property = ExpressionHelper.CreatePropertyExpression(
                    parameterExpression,
                    p.Trim()
                );
            ...
            return ExpressionHelper.Where(
                source,
                Expression.Lambda(ExpressionHelper.Or(searchExpressions), parameterExpression)
            );
        }
