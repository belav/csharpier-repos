...
namespace System.Web.UI.WebControls
{
    public class TemplatePagerField : DataPagerField
    {
        ...
        [Category("Action"), ResourceDescription("TemplatePagerField_OnPagerCommand")]
        public event EventHandler<DataPagerCommandEventArgs> PagerCommand
        {
            add { Events.AddHandler(EventPagerCommand, value); }
            remove { Events.RemoveHandler(EventPagerCommand, value); }
        }
        ...
        public override void HandleEvent(CommandEventArgs e)
        {
            ...
            DataPagerCommandEventArgs pagerEventArgs = new DataPagerCommandEventArgs(
                this,
                _totalRowCount,
                e,
                item
            ...
            if (pagerEventArgs.NewStartRowIndex != -1)
            {
                DataPager.SetPageProperties(
                    pagerEventArgs.NewStartRowIndex,
                    pagerEventArgs.NewMaximumRows,
                    true
                );
            }
        }
        ...
        {
            EventHandler<DataPagerCommandEventArgs> handler =
                (EventHandler<DataPagerCommandEventArgs>)Events[EventPagerCommand];
            if (handler != null)
            {
                handler(this, e);
            }
            else
            {
                throw new InvalidOperationException(
                    String.Format(
                        ...
                        AtlasWeb.TemplatePagerField_UnhandledEvent,
                        "PagerCommand"
                    )
                );
            }
