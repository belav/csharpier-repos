...
namespace System.Web.UI.WebControls
{
            ...
            ISerializable
    {
        ...
        public LinqDataSourceValidationException()
            : base(AtlasWeb.LinqDataSourceValidationException_ValidationFailed) { }
        ...
        public LinqDataSourceValidationException(
            string message,
            IDictionary<string, Exception> innerExceptions
        )
            : this(message)
        {
        ...
        protected LinqDataSourceValidationException(
        ...
        public IDictionary<string, Exception> InnerExceptions
        {
            get
            {
                ...
                {
                    _innerExceptions = new Dictionary<string, Exception>(
        ...
        public override void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            info.AddValue(
                "InnerExceptions",
                InnerExceptions,
                typeof(IDictionary<string, Exception>)
            );
        }
    }
}
