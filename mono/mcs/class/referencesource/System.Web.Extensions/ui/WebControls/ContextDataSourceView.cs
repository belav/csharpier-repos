namespace System.Web.UI.WebControls
{
    ...
    public abstract class ContextDataSourceView : QueryableDataSourceView
    {
        ...
        internal ContextDataSourceView(
            DataSourceControl owner,
            string viewName,
            HttpContext context,
            IDynamicQueryable queryable
        )
            : base(owner, viewName, context, queryable) { }

        public string EntitySetName
        {
            get { return _entitySetName ?? String.Empty; }
            set
            {
        ...
        {
            get { return _entityTypeName ?? String.Empty; }
            set
            {
        ...
        protected override Type EntityType
        {
            get
            {
                ...
                {
                    _entityType =
                        GetDataObjectTypeByName(typeName) ?? GetDataObjectType(EntitySetType);
                }
                return _entityType;
            }
        }
        ...
        private MemberInfo GetEntitySetMember(Type contextType)
        {
            ...
            MemberInfo[] members = contextType.FindMembers(
                ...
                BindingFlags.Public | BindingFlags.Instance | BindingFlags.Static, /*filter*/
                null, /*filterCriteria*/
                null
            );
        ...
        private static Type GetDataObjectTypeByName(string typeName)
        {
            ...
            {
                entityType = BuildManager.GetType(
                    typeName, /*throwOnFail*/
                    false, /*ignoreCase*/
                    true
                );
            }
