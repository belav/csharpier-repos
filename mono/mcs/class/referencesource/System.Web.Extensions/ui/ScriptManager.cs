...
namespace System.Web.UI
{
    ...
    [
        ...
        Designer(
            "System.Web.UI.Design.ScriptManagerDesigner, " + AssemblyRef.SystemWebExtensionsDesign
        ),
        NonVisualControl(),
        ParseChildren(true),
            ...
            IScriptManagerInternal
    {
        ...
        private HashSet<String> _scriptPathsDefiningSys = new HashSet<String>(
        ...
        [ResourceDescription("ScriptManager_AjaxFrameworkAssembly"), Browsable(false)]
        ...
        {
            get { return PageRequestManager.AsyncPostBackSourceElementID; }
        }
        ...
        internal BundleReflectionHelper BundleReflectionHelper
        {
            ...
            set { _bundleReflectionHelper = value; }
        }

        public static ScriptResourceMapping ScriptResourceMapping
        {
            get { return (ScriptResourceMapping)ClientScriptManager._scriptResourceMapping; }
        }
        ...
        {
            get { return _clientNavigateHandler ?? String.Empty; }
            set { _clientNavigateHandler = value; }
        }
        ...
        internal static Assembly DefaultAjaxFrameworkAssembly
        {
            ...
            {
                if (
                    (_defaultAjaxFrameworkAssembly == null)
                    && !_ajaxFrameworkAssemblyConfigChecked
                    && AssemblyCache._useCompilationSection
                )
                {
                    ...
                    {
                        referencedAssemblies = BuildManager
                        ...
                        if (assembly != AssemblyCache.SystemWebExtensions)
                        {
                            ...
                            if (attribute != null)
                            {
                                _defaultAjaxFrameworkAssembly =
                                    attribute.GetDefaultAjaxFrameworkAssembly(assembly);
                                break;
                            }
                        }
        ...
        {
            get { return DeploymentSection.Retail; }
        }
        ...
        {
            get { return ViewState["EmptyPageUrl"] as string ?? string.Empty; }
            set { ViewState["EmptyPageUrl"] = value; }
        }

        [ResourceDescription("ScriptManager_EnableCdn"), Category("Behavior"), DefaultValue(false)]
        public bool EnableCdn
        {
            get { return _enableCdn; }
            set
            {
                if (_preRenderCompleted)
                {
                    throw new InvalidOperationException(
                        AtlasWeb.ScriptManager_CannotChangeEnableCdn
                    );
                }
                _enableCdn = value;
            }
        ...
        {
            get { return _enableCdnFallback; }
            set
            {
                if (_preRenderCompleted)
                {
                    throw new InvalidOperationException(
                        AtlasWeb.ScriptManager_CannotChangeEnableCdnFallback
                    );
                }
        ...
        public bool EnableHistory
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(
                        AtlasWeb.ScriptManager_CannotChangeEnableHistory
                    );
                }
        ...
        public AjaxFrameworkMode AjaxFrameworkMode
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(
                        AtlasWeb.ScriptManager_CannotChangeAjaxFrameworkMode
                    );
                }
        ...
        public bool EnablePartialRendering
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(
                        AtlasWeb.ScriptManager_CannotChangeEnablePartialRendering
                    );
                }
        ...
        public bool EnableScriptGlobalization
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(
                        AtlasWeb.ScriptManager_CannotChangeEnableScriptGlobalization
                    );
                }
        ...
        {
            get { return _enableSecureHistoryState; }
            set { _enableSecureHistoryState = value; }
        }
        ...
        internal bool IsRestMethodCall
        {
            get
            {
                ...
                {
                    _isRestMethodCall =
                        (Context != null) && RestHandlerFactory.IsRestMethodCall(Context.Request);
                }
        ...
        {
            get { return (_scriptPath == null) ? String.Empty : _scriptPath; }
        ...
        public bool SupportsPartialRendering
        {
            ...
            set
            {
                ...
                {
                    throw new InvalidOperationException(
                        AtlasWeb.ScriptManager_CannotSetSupportsPartialRenderingWhenDisabled
                    );
                }
                if (_initCompleted)
                {
                    throw new InvalidOperationException(
                        AtlasWeb.ScriptManager_CannotChangeSupportsPartialRendering
                    );
                }
        ...
        internal bool Zip
        {
            get
            {
                if (!_zipSet)
                {
                    _zip = HeaderUtility.IsEncodingInAcceptList(
                        IPage.Request.Headers["Accept-encoding"],
                        "gzip"
                    );
                    _zipSet = true;
                }
        ...
        {
            add { Events.AddHandler(AsyncPostBackErrorEvent, value); }
            remove { Events.RemoveHandler(AsyncPostBackErrorEvent, value); }
        }
        ...
        {
            add { Events.AddHandler(ResolveCompositeScriptReferenceEvent, value); }
            remove { Events.RemoveHandler(ResolveCompositeScriptReferenceEvent, value); }
        }

        [Category("Action"), ResourceDescription("ScriptManager_ResolveScriptReference")]
        public event EventHandler<ScriptReferenceEventArgs> ResolveScriptReference
        {
            add { Events.AddHandler(ResolveScriptReferenceEvent, value); }
            remove { Events.RemoveHandler(ResolveScriptReferenceEvent, value); }
        }
        ...
        private ScriptReferenceBase AddFrameworkScript(
            ScriptReference frameworkScript,
            List<ScriptReferenceBase> scripts,
            bool webFormsWithoutAjax
        )
        {
            int scriptIndex = 0;
                                ...
                                if (
                                    (
                                        (
                                            !String.IsNullOrEmpty(frameworkScriptName)
                                            && (
                                                scriptReference.EffectiveResourceName
                                                == frameworkScriptName
                                            )
                                        )
                                            && (
                                                scriptReference.GetAssembly(this)
                                                == frameworkAssembly
                                            )
                                        || (
                                            !String.IsNullOrEmpty(frameworkScriptPath)
                                            && scriptReference.ScriptInfo.Path
                                                == frameworkScriptPath
                                        )
                                    )
                                )
        ...
        internal void AddFrameworkScripts(List<ScriptReferenceBase> scripts)
        {
            ...
            if (mode != AjaxFrameworkMode.Disabled)
            {
                ...
                // explicitly.
                if (
                    (mode == AjaxFrameworkMode.Enabled)
                    && !String.IsNullOrEmpty(_appServicesInitializationScript)
                )
                {
                    ScriptReference appServices = new ScriptReference(
            ...
            {
                ScriptReference atlasWebForms = new ScriptReference(
        ...
        // Called by ScriptManagerDesigner.GetScriptReferences().
        internal void AddScriptCollections(
            List<ScriptReferenceBase> scripts,
        ...
        private string GetApplicationServicesInitializationScript()
        {
            ...
            AuthenticationServiceManager.ConfigureAuthenticationService(
                ref sb,
                Context,
                this,
                _proxies
        ...
        [ConfigurationPermission(SecurityAction.Assert, Unrestricted = true), SecurityCritical()]
        ...
        [SuppressMessage(
            ...
            Justification = "Depends on registered resources so order of execution is important."
        )]
        public ReadOnlyCollection<RegisteredArrayDeclaration> GetRegisteredArrayDeclarations()
        {
            return new ReadOnlyCollection<RegisteredArrayDeclaration>(
                ScriptRegistration.ScriptArrays
            );
        }
        ...
        {
            return new ReadOnlyCollection<RegisteredDisposeScript>(
                ScriptRegistration.ScriptDisposes
            );
        }
        ...
        {
            return new ReadOnlyCollection<RegisteredExpandoAttribute>(
                ScriptRegistration.ScriptExpandos
            );
        }
        ...
        {
            return new ReadOnlyCollection<RegisteredHiddenField>(
                ScriptRegistration.ScriptHiddenFields
            );
        }
        ...
        {
            return new ReadOnlyCollection<RegisteredScript>(
                ScriptRegistration.ScriptSubmitStatements
            );
        }
        ...
        private bool NeedToLoadBeforeUI(ScriptReference script, AjaxFrameworkMode ajaxMode)
        {
            return script.IsFromSystemWeb()
                || (
                    ...
                    && (
                        script.IsAjaxFrameworkScript(this)
                        && SplitFrameworkScripts.Contains(script.EffectiveResourceName)
                    )
                );
        }
        ...
        protected internal override void OnInit(EventArgs e)
        {
            ...
            if (!DesignMode)
            {
                ...
                if (
                    (ajaxFrameworkAssembly != null)
                    && (ajaxFrameworkAssembly != AssemblyCache.SystemWebExtensions)
                )
                {
                    if (
                        AssemblyCache.GetVersion(ajaxFrameworkAssembly)
                    ...
                    )
                    {
                        ...
                        throw new InvalidOperationException(
                            String.Format(
                                CultureInfo.CurrentUICulture,
                                AtlasWeb.ScriptManager_MustHaveGreaterVersion,
                ...
                {
                    throw new InvalidOperationException(
                        AtlasWeb.ScriptManager_OnlyOneScriptManager
                    );
                }
        ...
        {
            EventHandler<HistoryEventArgs> handler =
                (EventHandler<HistoryEventArgs>)Events[NavigateEvent];
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        private void OnPageInitComplete(object sender, EventArgs e)
        {
            if (IPage.IsPostBack)
            {
                ...
                {
                    throw new InvalidOperationException(
                        AtlasWeb.ScriptManager_AsyncPostBackNotInPartialRenderingMode
                    );
                }
            }
            ...
            if (EnableHistory && (AjaxFrameworkMode != AjaxFrameworkMode.Disabled))
            {
                ...
                if (IPage.IsPostBack)
                {
                    ...
                    // we're navigating.
                    _isNavigating =
                        IPage.Request[System.Web.UI.Page.postEventSourceID] == this.UniqueID;
                }
            }
        }
        ...
        )
        {
            EventHandler<CompositeScriptReferenceEventArgs> handler =
                (EventHandler<CompositeScriptReferenceEventArgs>)
                    Events[ResolveCompositeScriptReferenceEvent];
            if (handler != null)
            {
                handler(this, e);
            }
        ...
        private void PrepareNewHistoryPoint()
        {
            ...
            {
                throw new InvalidOperationException(
                    AtlasWeb.ScriptManager_CannotAddHistoryPointWithHistoryDisabled
                );
            }
            if (!IsInAsyncPostBack)
            {
                throw new InvalidOperationException(
                    AtlasWeb.ScriptManager_CannotAddHistoryPointOutsideOfAsyncPostBack
                );
            }
        ...
        [SuppressMessage(
            ...
            Justification = "The overload specifically exists to strengthen the support for passing in a Page parameter."
        )]
        ...
        internal virtual void RegisterClientScriptBlockInternal(
            Control control,
            Type type,
            string key,
            string script,
        ...
        {
            ScriptRegistrationManager.RegisterClientScriptBlock(
                page,
                type,
                key,
                script,
        ...
        private static bool TryRegisterNamedClientScriptResourceUsingScriptReference(
            Page page,
            string resourceName
        )
        {
        ...
        {
            ScriptRegistrationManager.RegisterExpandoAttribute(
                control,
                controlId,
                attributeName,
                attributeValue,
        ...
        private void RegisterGlobalizationScriptBlock()
        {
            ...
            {
                Tuple<String, String> entry = ClientCultureInfo.GetClientCultureScriptBlock(
                ...
                if ((entry != null) && !String.IsNullOrEmpty(entry.Item1))
                {
                    if (IsDebuggingEnabled && (AjaxFrameworkMode == AjaxFrameworkMode.Explicit))
                    {
                        ...
                        ScriptRegistrationManager.RegisterStartupScript(
                            this,
                            typeof(ScriptManager),
...
#pragma warning restore 618
        ...
        {
            ScriptRegistrationManager.RegisterHiddenField(
                page,
                hiddenFieldName,
        ...
        internal List<ScriptReferenceBase> ProcessBundleReferences(
            List<ScriptReferenceBase> scripts
        )
        {
            ...
            if (resolver != null)
            {
                HashSet<string> virtualPathsInBundles = new HashSet<string>(
                    StringComparer.OrdinalIgnoreCase
                );
                ...
                foreach (ScriptReferenceBase scriptRef in scripts)
                {
                    ...
                    if (BundleReflectionHelper.IsBundleVirtualPath(effectivePath))
                    {
                        ...
                        IEnumerable<string> bundleContents =
                            BundleReflectionHelper.GetBundleContents(effectivePath);
                ...
                else
                {
                    ...
                    if (csr != null)
                    {
                        OnResolveCompositeScriptReference(
                            new CompositeScriptReferenceEventArgs(csr)
                        );
                    }
                }
            }
            // Remove duplicate Name+Assembly references
            List<ScriptReferenceBase> uniqueScripts = RemoveDuplicates(
                scripts,
                AjaxFrameworkMode,
                LoadScriptsBeforeUI,
                (IsInAsyncPostBack ? null : IPage.ClientScript),
        ...
        private void RegisterUniqueScripts(List<ScriptReferenceBase> uniqueScripts)
        {
            ...
            foreach (ScriptReferenceBase script in uniqueScripts)
            {
                ...
                if (
                    (!loadCheckRegistered || hasAppServicesScript)
                    && script.IsAjaxFrameworkScript(this)
                    && (mode != AjaxFrameworkMode.Disabled)
                )
                {
        ...
        private void RegisterFallbackScript(ScriptReferenceBase script, string key)
        {
            ...
            if (scriptReference != null)
            {
                ...
                {
                    string fallbackPath = scriptReference.GetUrlInternal(
                        this,
                        Zip,
                        useCdnPath: false
                    );
                    ...
                    if (_isInAsyncPostBack)
                    {
                        ...
                        ScriptRegistrationManager.RegisterFallbackScriptForAjaxPostbacks(
                            script.ContainingControl,
                            typeof(ScriptManager),
                            key,
        ...
        private void RegisterServices()
        {
            ...
            {
                string pageMethods = PageClientProxyGenerator.GetClientProxyScript(
                    Context,
                    IPage,
                    IsDebuggingEnabled
                );
        ...
        private static void RegisterResourceWithClientScriptManager(
            IClientScriptManager clientScriptManager,
            Assembly assembly,
            String key
        )
        {
            ...
            Dictionary<Assembly, Dictionary<String, Object>> suppressedResources =
                clientScriptManager.RegisteredResourcesToSuppress;
            Debug.Assert(
                suppressedResources != null,
                "ClientScriptManager.RegisteredResourcesToSuppress is not expected to return null."
            );
        ...
        // Called by ScriptManagerDesigner.GetScriptReferences().
        internal List<ScriptReferenceBase> RemoveDuplicates(
            List<ScriptReferenceBase> scripts,
            AjaxFrameworkMode ajaxFrameworkMode,
        ...
        )
        {
            ...
            if (ajaxFrameworkMode == AjaxFrameworkMode.Enabled)
            {
                        ...
                        if (clientScriptManager != null)
                        {
                            if (!String.IsNullOrEmpty(script1.EffectiveResourceName))
                            {
                                RegisterResourceWithClientScriptManager(
                                    clientScriptManager,
                                    script1.GetAssembly(this),
                                    script1.EffectiveResourceName
                                );
                            }
                        }
                        return scripts;
                ...
                else if (numScripts == 2)
                {
                    ...
                    if (
                        ...
                        && (script2 != null)
                        && (
                            (script1.EffectiveResourceName != script2.EffectiveResourceName)
                            || (script1.Assembly != script2.Assembly)
                        )
                    )
                    {
                        if (clientScriptManager != null)
                        {
                            ...
                            if (!String.IsNullOrEmpty(script2.EffectiveResourceName))
                            {
                                RegisterResourceWithClientScriptManager(
                                    clientScriptManager,
                                    script2.GetAssembly(this),
                                    script2.EffectiveResourceName
                                );
                            }
                        }
                        return scripts;
            ...
            List<ScriptReferenceBase> filteredScriptList = new List<ScriptReferenceBase>(
                numScripts
            );
            ...
            foreach (ScriptReferenceBase script in scripts)
            {
                ...
                if (csr != null)
                {
                    ...
                    foreach (ScriptReference sr in csr.Scripts)
                    {
                        ...
                        Tuple<string, Assembly> key =
                            (String.IsNullOrEmpty(sr.EffectiveResourceName))
                        ...
                        else
                        {
                            ...
                            if (
                                !loadScriptsBeforeUI
                                && !loadBeforeUI
                                && NeedToLoadBeforeUI(sr, ajaxFrameworkMode)
                            )
                            {
        ...
        internal virtual void RegisterStartupScriptInternal(
            Control control,
            Type type,
            string key,
            string script,
        ...
        protected internal override void Render(HtmlTextWriter writer)
        {
            if (!IsInAsyncPostBack && (AjaxFrameworkMode != AjaxFrameworkMode.Disabled))
            {
                ...
                if (EnableHistory && !DesignMode && (IPage != null))
                {
                    ...
                    {
                        string script =
                            "Sys.Application.add_navigate(" + ClientNavigateHandler + ");";
        ...
        void IScriptManager.RegisterArrayDeclaration(
            Control control,
            string arrayName,
            string arrayValue
        )
        ...
        void IScriptManager.RegisterClientScriptBlock(
            Control control,
            Type type,
            string key,
            string script,
        ...
        void IScriptManager.RegisterClientScriptInclude(
            Control control,
            Type type,
            string key,
            string url
        ...
        void IScriptManager.RegisterClientScriptResource(
            Control control,
            Type type,
            string resourceName
        )
        ...
        void IScriptManager.RegisterExpandoAttribute(
            Control control,
            string controlId,
            string attributeName,
            string attributeValue,
        ...
        void IScriptManager.RegisterHiddenField(
            Control control,
            string hiddenFieldName,
        ...
        void IScriptManager.RegisterOnSubmitStatement(
            Control control,
            Type type,
            string key,
            string script
        ...
        void IScriptManager.RegisterStartupScript(
            Control control,
            Type type,
            string key,
            string script,
        ...
        {
            public StatePersister(Page page)
                : base(page) { }
            ...
            {
                return StateFormatter2.Serialize(
                    state,
                    Purpose.WebForms_ScriptManager_HistoryState
                );
            }

            public object Deserialize(string serialized)
            {
                return StateFormatter2.Deserialize(
                    serialized,
                    Purpose.WebForms_ScriptManager_HistoryState
                );
            }
