...
namespace System.Web.UI
{
    ...
    public class ScriptManagerProxy : Control, IControl
    {
        ...
        {
            get { return this._profileServiceManager != null; }
        }
        internal bool HasAuthenticationServiceManager
        {
            get { return this._authenticationServiceManager != null; }
        }

        internal bool HasRoleServiceManager
        {
            get { return this._roleServiceManager != null; }
        }

        internal EventHandler<HistoryEventArgs> NavigateEvent
        {
            get { return (EventHandler<HistoryEventArgs>)Events[_navigateEvent]; }
        }
        ...
        [
            ...
            DefaultValue(null),
            Editor(
                "System.Web.UI.Design.ServiceReferenceCollectionEditor, "
                    + AssemblyRef.SystemWebExtensionsDesign,
                typeof(UITypeEditor)
            ),
            PersistenceMode(PersistenceMode.InnerProperty),
        ...
        public event EventHandler<HistoryEventArgs> Navigate
        {
            ...
            remove { Events.RemoveHandler(_navigateEvent, value); }
        }
        ...
        {
            get { return new System.Web.HttpContextWrapper(Context); }
        }
