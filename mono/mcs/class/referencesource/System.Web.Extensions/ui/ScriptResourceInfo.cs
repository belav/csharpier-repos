...
namespace System.Web.UI
{
    ...
    internal class ScriptResourceInfo
    {
        ...
        private static readonly IDictionary _duplicateScriptAttributesChecked =
            ...
            : this()
        {
            ...
            _isDebug =
                !String.IsNullOrEmpty(_scriptName)
                && _scriptName.EndsWith(".debug.js", StringComparison.OrdinalIgnoreCase);
            if (sra != null)
            {
            ...
            if (!String.IsNullOrEmpty(_cdnPath))
            {
                ...
                _cdnPathSecureConnection = AssemblyResourceLoader.FormatCdnUrl(
                    assembly,
                    wra.CdnPathSecureConnection
                );
            }
        }
        ...
        {
            get { return _cdnPathSecureConnection; }
        }

        public string LoadSuccessExpression
        {
            get { return _loadSuccessExpression; }
        }
        ...
        public static ScriptResourceInfo GetInstance(Assembly assembly, string resourceName)
        {
            ...
            if (!_duplicateScriptAttributesChecked.Contains(assembly))
            {
                ...
                foreach (
                    ScriptResourceAttribute attr in assembly.GetCustomAttributes(
