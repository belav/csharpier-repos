...
namespace System.Web.UI
{
    ...
    internal static class AssemblyCache
    {
        ...
        public static AjaxFrameworkAssemblyAttribute GetAjaxFrameworkAssemblyAttribute(
            Assembly assembly
        )
        {
            Debug.Assert(assembly != null);
            ...
            if (
                !_ajaxAssemblyAttributeCache.TryGetValue(
                    assembly,
                    out ajaxFrameworkAssemblyAttribute
                )
            )
            {
        ...
        [SuppressMessage(
            ...
            Justification = "We do not want to throw from this method."
        )]
        internal static AjaxFrameworkAssemblyAttribute SafeGetAjaxFrameworkAssemblyAttribute(
        ...
        )
        {
            ...
            {
                foreach (
                    Attribute attribute in attributeProvider.GetCustomAttributes(inherit: false)
                )
                {
                    AjaxFrameworkAssemblyAttribute ajaxFrameworkAttribute =
                        attribute as AjaxFrameworkAssemblyAttribute;
