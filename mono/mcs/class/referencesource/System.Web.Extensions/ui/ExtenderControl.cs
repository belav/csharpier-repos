...
namespace System.Web.UI
{
    ...
    [
        ...
        Designer(
            "System.Web.UI.Design.ExtenderControlDesigner, " + AssemblyRef.SystemWebExtensionsDesign
        ),
        NonVisualControl(),
        ParseChildren(true),
        ...
        private void RegisterWithScriptManager()
        {
            ...
            if (targetControl == null)
            {
                throw new InvalidOperationException(
                    String.Format(
                        CultureInfo.InvariantCulture,
                        AtlasWeb.ExtenderControl_TargetControlIDInvalid,
                        ID,
                        TargetControlID
                    )
                );
            ...
            {
                throw new InvalidOperationException(
                    AtlasWeb.ExtenderControl_TargetControlDifferentUpdatePanel
                );
            }
