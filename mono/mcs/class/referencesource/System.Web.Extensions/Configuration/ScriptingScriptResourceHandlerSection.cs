...
namespace System.Web.Configuration
{
    ...
    public sealed class ScriptingScriptResourceHandlerSection : ConfigurationSection
    {
        ...
        {
            get { return (bool)base[_propEnableCaching]; }
            set { base[_propEnableCaching] = value; }
        }

        [ConfigurationProperty("enableCompression", DefaultValue = true)]
        public bool EnableCompression
        {
            get { return (bool)base[_propEnableCompression]; }
            set { base[_propEnableCompression] = value; }
        }
        ...
        internal static class ApplicationSettings
        {
            ...
            private static void EnsureSectionLoaded()
            {
                if (!s_sectionLoaded)
                {
                    ScriptingScriptResourceHandlerSection section =
