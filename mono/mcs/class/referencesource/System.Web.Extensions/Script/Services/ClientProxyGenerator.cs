...
";
        ...
        protected void GenerateRegisterClass(WebServiceData webServiceData)
        {
            ...
            _builder
                ...
                .Append(typeName)
                .Append("',Sys.Net.WebServiceProxy);\r\n");
        }
        ...
        protected virtual void GeneratePrototype(WebServiceData webServiceData)
        {
            ...
            _builder
                .Append(GetProxyTypeName(webServiceData))
                .Append("._staticInstance.get_path();},\r\n");
            bool first = true;
        ...
        protected virtual void GenerateTypeDeclaration(WebServiceData webServiceData, bool genClass)
        {
            AppendClientTypeDeclaration(
                webServiceData.TypeData.TypeNamespace,
                webServiceData.TypeData.TypeName,
                genClass,
                true
            );
        }
        ...
        protected void GenerateStaticInstance(WebServiceData data)
        {
            ...
            if (_debugMode)
            {
                ...
                _builder
                    .Append(typeName)
                    .Append(".set_defaultUserContext = function(value) { \r\n");
                _builder
                    .Append(typeName)
                    .Append("._staticInstance.set_defaultUserContext(value); }\r\n");
                _builder
                    .Append(typeName)
                    .Append(
                ...
                _builder
                    .Append(typeName)
                    .Append("._staticInstance.get_defaultUserContext(); }\r\n");

                _builder
                    .Append(typeName)
                    .Append(".set_defaultSucceededCallback = function(value) { \r\n ");
                _builder
                    .Append(typeName)
                    .Append("._staticInstance.set_defaultSucceededCallback(value); }\r\n");
                _builder
                    .Append(typeName)
                    .Append(
                ...
                _builder
                    .Append(typeName)
                    .Append("._staticInstance.get_defaultSucceededCallback(); }\r\n");

                _builder
                    .Append(typeName)
                    .Append(".set_defaultFailedCallback = function(value) { \r\n");
                _builder
                    .Append(typeName)
                    .Append("._staticInstance.set_defaultFailedCallback(value); }\r\n");
                _builder
                    .Append(typeName)
                    .Append(
                ...
                _builder
                    .Append(typeName)
                    .Append("._staticInstance.get_defaultFailedCallback(); }\r\n");
                ...
                _builder
                    .Append(typeName)
                    .Append(".set_jsonpCallbackParameter = function(value) { ");
                _builder
                    .Append(typeName)
                    .Append("._staticInstance.set_jsonpCallbackParameter(value); }\r\n");
                _builder
                    .Append(typeName)
                    .Append(
                ...
                _builder
                    .Append(typeName)
                    .Append("._staticInstance.get_jsonpCallbackParameter(); }\r\n");
            }
            else
            {
                _builder.Append(typeName).Append(".set_path = function(value) { ");
                ...
                _builder
                    .Append(typeName)
                    .Append(".get_defaultSucceededCallback = function() { return ");
                _builder
                    .Append(typeName)
                    .Append("._staticInstance.get_defaultSucceededCallback(); }\r\n");
                ...
                _builder
                    .Append(typeName)
                    .Append(".get_defaultFailedCallback = function() { return ");
                _builder
                    .Append(typeName)
                    .Append("._staticInstance.get_defaultFailedCallback(); }\r\n");
                ...
                _builder
                    .Append(typeName)
                    .Append(".get_jsonpCallbackParameter = function() { return ");
                _builder
                    .Append(typeName)
                    .Append("._staticInstance.get_jsonpCallbackParameter(); }\r\n");
            }
            ...
            if (
                !String.IsNullOrEmpty(proxyPath)
                && (
                    proxyPath.StartsWith("http://", StringComparison.OrdinalIgnoreCase)
                    || proxyPath.StartsWith("https://", StringComparison.OrdinalIgnoreCase)
                )
            )
            {
                ...
                int domainStart =
                    proxyPath.IndexOf("://", StringComparison.OrdinalIgnoreCase) + "://".Length;
                int domainEnd = proxyPath.IndexOf(
                    "/",
                    domainStart,
                ...
                {
                    proxyPath =
                        proxyPath.Substring(0, domainEnd)
                        + HttpUtility.UrlPathEncode(proxyPath.Substring(domainEnd));
                }
            }
            else
            {
            ...
            if (GetSupportsJsonp())
            {
                ...
                if (
                    !String.IsNullOrEmpty(jsonpParameterName)
                    && !jsonpParameterName.Equals("callback", StringComparison.Ordinal)
                )
                {
                    _builder
                        .Append(typeName)
                        .Append(".set_jsonpCallbackParameter(")
                        .Append(JavaScriptSerializer.SerializeInternal(jsonpParameterName))
                        .Append(");\r\n");
                }
            }
        }

        private void BuildArgsDictionary(
            WebServiceMethodData methodData,
            StringBuilder args,
            StringBuilder argsDict,
            StringBuilder docComments
        )
        {
            argsDict.Append('{');
            foreach (WebServiceParameterData paramData in methodData.ParameterDatas)
            {
                ...
                if (docComments != null)
                {
                    ...
                    string clientType = GetClientTypeNamespace(
        ...
        private void GenerateEnumTypeProxies(IEnumerable<WebServiceEnumData> enumTypes)
        {
            foreach (WebServiceEnumData t in enumTypes)
            {
                ...
                _builder
                    .Append(typeName)
                    .Append(" = function() { throw Error.invalidOperation(); }\r\n");
        ...
        private void AppendClientTypeDeclaration(
            string ns,
            string typeName,
            bool genClass,
            bool ensureNS
        ...
        private void EnsureObjectGraph(string namespacePart, string typeName)
        {
            ...
            while (dotIndex > -1)
            {
                ...
                if (
                    !_registeredNamespaces.Contains(fullPath)
                    && !_ensuredObjectParts.Contains(fullPath)
                )
                {
