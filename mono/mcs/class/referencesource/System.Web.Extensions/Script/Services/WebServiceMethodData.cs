...
namespace System.Web.Script.Services
{
    internal class WebServiceMethodData
    {
        ...
        internal WebServiceMethodData(
            WebServiceData owner,
            MethodInfo methodInfo,
            WebMethodAttribute webMethodAttribute,
            ScriptMethodAttribute scriptMethodAttribute
        )
        {
            _owner = owner;
        ...
        internal WebServiceMethodData(
            WebServiceData owner,
            string methodName,
            Dictionary<string, WebServiceParameterData> parameterData,
            bool useHttpGet
        )
        {
            _owner = owner;
        ...
        {
            get { return ParameterDataDictionary.Values; }
        }
        ...
        internal object CallMethodFromRawParams(
            object target,
                ...
                else
                {
                    throw new InvalidOperationException(
                        String.Format(
                            ...
                            AtlasWeb.WebService_MissingArg,
                            paramData.ParameterInfo.Name
                        )
                    );
                }
            }
        ...
        private IDictionary<string, object> StrongTypeParameters(
            IDictionary<string, object> rawParams
        )
        {
            Debug.Assert(ParameterDataDictionary != null);
            IDictionary<string, WebServiceParameterData> paramDataDictionary =
            ...
            foreach (KeyValuePair<string, object> pair in rawParams)
            {
                ...
                if (paramDataDictionary.ContainsKey(memberName))
                {
                    ...
                    result[memberName] = ObjectConverter.ConvertObjectToType(
                        pair.Value,
                        paramType,
                        Owner.Serializer
                    );
