...
namespace System.Web.Script.Serialization
{
    ...
    public class JavaScriptSerializer
    {
        ...
        [SuppressMessage(
            ...
            MessageId = "Converters",
            Justification = "This is for managed types which need to have custom type converters for JSon serialization, I don't think there will be any com interop types for this scenario."
        )]
        ...
        private static void SerializeDateTime(
            DateTime datetime,
            StringBuilder sb,
            SerializationFormat serializationFormat
        )
        {
            Debug.Assert(
                serializationFormat == SerializationFormat.JSON
                    || serializationFormat == SerializationFormat.JavaScript
            );
        ...
        private void SerializeCustomObject(
            object o,
            StringBuilder sb,
            int depth,
        ...
        )
        {
            ...
            foreach (FieldInfo fieldInfo in fields)
            {
                ...
                sb.Append(':');
                SerializeValue(
                    SecurityUtils.FieldInfoGetValue(fieldInfo, o),
                    sb,
                    depth,
                    objectsInUse,
                    serializationFormat,
                    currentMember: fieldInfo
                );
                first = false;
            }
            ...
            foreach (PropertyInfo propInfo in props)
            {
                ...
                sb.Append(':');
                SerializeValue(
                    SecurityUtils.MethodInfoInvoke(getMethodInfo, o, null),
                    sb,
                    depth,
                    objectsInUse,
                    serializationFormat,
                    currentMember: propInfo
                );
                first = false;
            }
        ...
        private bool CheckScriptIgnoreAttribute(MemberInfo memberInfo)
        {
            ...
            ScriptIgnoreAttribute scriptIgnoreAttr = (ScriptIgnoreAttribute)
        ...
        )
        {
            ...
            foreach (DictionaryEntry entry in (IDictionary)o)
            {
                ...
                if (
                    isTypeEntrySet
                    && String.Equals(key, ServerTypeFieldName, StringComparison.Ordinal)
                )
                {
        ...
        private void SerializeDictionaryKeyValue(
            string key,
            object value,
            StringBuilder sb,
            int depth,
        ...
        private void SerializeEnumerable(
        ...
        private void SerializeValueInternal(
            object o,
            StringBuilder sb,
            int depth,
            Hashtable objectsInUse,
                    ...
                    string errorMessage =
                        (currentMember != null)
                            ? String.Format(
                                ...
                                AtlasWeb.JSON_CannotSerializeMemberGeneric,
                                currentMember.Name,
            ...
            try
            {
                ...
                else if (objectsInUse.ContainsKey(o))
                {
                    ...
                    throw new InvalidOperationException(
                        String.Format(
                            CultureInfo.CurrentCulture,
                            AtlasWeb.JSON_CircularReference,
                            type.FullName
                        )
                    );
                }
