...
namespace System.Workflow.Activities.Rules
{
    internal class Tracer
    {
        ...
        internal Tracer(string name, ActivityExecutionContext activityExecutionContext)
        {
            if (activityExecutionContext != null)
                tracePrefix = string.Format(
                    ...
                    traceRuleIdentifier,
                    name,
                    activityExecutionContext.ContextGuid.ToString()
                );
            else
        ...
        {
            WorkflowActivityTrace.Rules.TraceEvent(
                TraceEventType.Information,
                0,
                traceRuleSetEvaluate,
                tracePrefix
            );
        }
        ...
        internal void TraceThenTriggers(
            string currentRuleName,
            ICollection<int> triggeredRules,
        ...
        internal void TraceElseTriggers(
            string currentRuleName,
            ICollection<int> triggeredRules,
            List<RuleState> ruleStates
        )
        ...
        private void TraceRuleTriggers(
            string thenOrElse,
            string currentRuleName,
            ICollection<int> triggeredRules,
            List<RuleState> ruleStates
