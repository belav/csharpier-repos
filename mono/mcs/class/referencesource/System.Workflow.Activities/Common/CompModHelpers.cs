...
namespace System.Workflow.Activities.Common
{
    ...
    {
        private static readonly string VSExtensionProductRegistrySubKey =
            "Visual Studio Ext for Windows Workflow";

        //

        internal static readonly string ProductRootRegKey =
            @"SOFTWARE\Microsoft\Net Framework Setup\NDP\v4.0\Setup\Windows Workflow Foundation";
        ...
        private static readonly string ProductRootRegKey30 =
        ...
        [SuppressMessage(
            ...
            Justification = "LastIndexOf(\"\\\") not a security issue."
        )]
            ...
            get
            {
                ...
                using (RegistryKey userRegistryKey = Application.UserAppDataRegistry)
                {
                    keyPath = userRegistryKey
                        .ToString()
                        .Substring(Registry.CurrentUser.ToString().Length + 1);
        ...
        {
            get { return PerUserRegistryKey + "\\TypeProvider"; }
        }
        ...
        internal static Activity[] GetAllNestedActivities(CompositeActivity compositeActivity)
        {
            ...
            while (compositeActivities.Count > 0)
            {
                CompositeActivity compositeActivity2 = (CompositeActivity)
                    compositeActivities.Dequeue();
                if (
                    compositeActivity2 == compositeActivity
                    || !Helpers.IsCustomActivity(compositeActivity2)
                )
                {
            ...
            while (serializedComponents.Count > 0)
            {
                ...
                if (component != null && component.Site != null)
                {
                    ...
                    ActivityDesigner activityDesigner =
                        designerHost.GetDesigner(component) as ActivityDesigner;
        ...
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        internal static void DeserializeDesignersFromStream(
        ...
        internal static string GetBaseIdentifier(Activity activity)
        {
            ...
            {
                if (
                    Char.IsUpper(baseIdentifier[i])
                    && (
                        i == 0
                        || i == baseIdentifier.Length - 1
                        || Char.IsUpper(baseIdentifier[i + 1])
                    )
                )
                {
        ...
        internal static string GetRootNamespace(IServiceProvider serviceProvider)
        {
            ...
            IWorkflowCompilerOptionsService compilerOptionsService =
        ...
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        internal static Activity GetDataSourceActivity(
            Activity activity,
            string inputName,
            out string name
        )
        ...
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        internal static void GetNamespaceAndClassName(
        ...
        internal static CodeTypeDeclaration GetCodeNamespaceAndClass(
            ...
            string className,
            out CodeNamespace codeNamespace
        )
        {
            codeNamespace = null;
        ...
        private static extern int MsiGetProductInfoW(
            string szProduct,
            string szProperty,
        ...
        private static string GetInstallDirectory(bool getSDKDir)
        {
            ...
            try
            {
                ...
                int hr = MsiGetProductInfoW(
                    getSDKDir ? ProductSDKCode : ProductCode,
                ...
                else
                {
                    Debug.WriteLine(
                        "Error loading install directory: "
                            + error.ToString(CultureInfo.CurrentCulture)
                    );
                }
            }
            catch { }
            ...
            if (string.IsNullOrEmpty(path))
            {
                try
                {
                    ...
                    {
                        using (
                            RegistryKey key = Registry.LocalMachine.OpenSubKey(ProductRootRegKey)
                        )
                        {
                            if (key != null)
        ...
        private static string GetInstallDirectory30()
        {
            ...
            try
            {
                ...
                {
                    Debug.WriteLine(
                        "Error loading 3.0 install directory: "
                            + error.ToString(CultureInfo.CurrentCulture)
                    );
                }
            }
        ...
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        internal static DesignerSerializationVisibility GetSerializationVisibility(
        ...
        )
        {
            ...
            if (attributes.Length > 0)
                ...
                Attribute.IsDefined(memberInfo, typeof(DesignerSerializationVisibilityAttribute))
            )
                designerSerializationVisibility = (
        ...
        //
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        internal static MethodInfo GetMethodExactMatch(
            Type type,
            string name,
                        ...
                        if (parameters.GetLength(0) == types.Length)
                        {
                            for (int index = 0; !mismatch && index < parameters.Length; index++)
                                mismatch =
                                    ...
                                    || (
                                        !parameters[index]
                                            .ParameterType.IsAssignableFrom(types[index])
                                    );
                        }
                        else
                            mismatch = true;
        ...
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        internal static T GetAttributeFromObject<T>(object attributeObject)
            where T : Attribute
        {
        ...
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        internal static void AddTypeProviderAssembliesFromRegistry(
            ...
            if (referenceKey != null)
            {
                ...
                foreach (
                    string assemblyName in (
                        (string[])referenceKey.GetValue(TypeProviderAssemblyRegValueName)
                    )
                )
                {
                    try
        ...
        public static IList<Activity> GetAllEnabledActivities(CompositeActivity compositeActivity)
        {
            ...
            {
                if (childActivity.Enabled && IsFrameworkActivity(childActivity))
        ...
        internal static XmlWriter CreateXmlWriter(object output)
        {
            ...
            else
            {
                Debug.Assert(
                    false,
                    "Invalid argument type.  'output' must either be string or TextWriter."
                );
                return null;
            }
        }
        ...
        internal static string GetDesignTimeTypeName(object owner, object key)
        {
            ...
            if (dependencyObject != null && key != null)
            {
                ...
                {
                    Hashtable typeNames =
                        dependencyObject.UserData[UserDataKeys.DesignTimeTypeNames] as Hashtable;
            ...
            else
            {
                try
                {
                    CompositeActivity activity =
                        Activator.CreateInstance(compositeActivity.GetType()) as CompositeActivity;
                    if (activity != null && activity.Activities.Count > 0)
                    {
                        compositeActivity.UserData[UserDataKeys.CustomActivityDefaultName] =
                            activity.Name;
        ...
        internal static Activity ParseActivityForBind(Activity context, string activityName)
        {
            ...
            else if (activityName.StartsWith("/Parent", StringComparison.OrdinalIgnoreCase))
            {
                ...
                string[] paths = activityName.Split(
                    new char[] { '/' },
                ...
                for (int i = 0; i < paths.Length && activity != null; i++)
                {
                    ...
                    activity =
                        (string.Equals(parent, "Parent", StringComparison.OrdinalIgnoreCase))
                            ? activity.Parent
                            : null;
                }
                return activity;
            ...
            else if (Helpers.IsActivityLocked(context))
            {
                ...
                {
                    if (
                        !declaringActivity.UserData.Contains(UserDataKeys.CustomActivityDefaultName)
                    )
                    {
                        ...
                        Activity newCustomActivity =
                            Activator.CreateInstance(declaringActivity.GetType()) as Activity;
                        declaringActivity.UserData[UserDataKeys.CustomActivityDefaultName] =
                            newCustomActivity.Name;
                    }

                    if (
                        ((string)declaringActivity.UserData[UserDataKeys.CustomActivityDefaultName])
                        == activityName
                    )
            ...
            if (
                compositeParentActivity != null
                && parentActivity.Parent != null
                && IsCustomActivity(compositeParentActivity)
            )
            {
                mayLookInside = true;
                parentActivity = parentActivity.Parent;
            ...
            return (targetActivity == null)
                ? Helpers.ParseActivity(Helpers.GetRootActivity(context), activityName)
                : targetActivity;
        }
        ...
        [SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
        private static bool IsDeclaringActivityMatchesContext(
        ...
        )
        {
            ...
            CompositeActivity declaringActivityOfCurrent = Helpers.GetDeclaringActivity(
                currentActivity
            );
            ...
            // custom activity.
            if (
                Helpers.IsActivityLocked(context)
        ...
        internal static bool IsAlternateFlowActivity(Activity activity)
        {
            ...
            if (!activity.UserData.Contains(typeof(AlternateFlowActivityAttribute)))
            {
                isAlternateFlowActivityAttribute =
                    activity
                        .GetType()
                        .GetCustomAttributes(typeof(AlternateFlowActivityAttribute), true)
                        .Length != 0;
                activity.UserData[typeof(AlternateFlowActivityAttribute)] =
                    isAlternateFlowActivityAttribute;
            }
            else
            {
                isAlternateFlowActivityAttribute = (bool)
                    activity.UserData[typeof(AlternateFlowActivityAttribute)];
            }
    ...
    internal static class DebuggerHelpers
    {
        ...
        internal static Activity ParseActivity(Activity parsingContext, string activityName)
        {
            ...
            if (
                ...
                && (parsingContext is CompositeActivity)
                && parsingContext.Parent != null
                && Helpers.IsCustomActivity(parsingContext as CompositeActivity)
            )
                currentActivity = GetActivity(
                    parsingContext,
                    parsingContext.QualifiedName + "." + currentAtivityName
                );
            ...
            if (currentActivity != null)
            {
                if (nextActivityName.Length > 0)
                {
                    if (
                        !(currentActivity is CompositeActivity)
                        || !Helpers.IsCustomActivity(currentActivity as CompositeActivity)
                    )
                        // current activity must be a custom activity, otherwise there should be no dots in the name.
                        return null;
                    ...
                    for (int i = 0; i < names.Length; i++)
                    {
                        Activity nextActivity = GetActivity(
                            currentActivity,
                            currentActivity.QualifiedName + "." + names[i]
                        );
                        if (nextActivity == null || !Helpers.IsActivityLocked(nextActivity))
                            return null;

                        CompositeActivity declaringActivity = Helpers.GetDeclaringActivity(
                            nextActivity
                        );
                        if (currentActivity != declaringActivity)
                            return null;
