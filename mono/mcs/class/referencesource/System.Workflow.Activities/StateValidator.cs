    ...
    public class StateActivityValidator : CompositeActivityValidator
    {
            ...
            if (state.Parent != null)
            {
                if (StateMachineHelpers.IsStateMachine(state))
                {
                    validationErrors.Add(
                        new ValidationError(
                            SR.GetError_StateMachineWorkflowMustBeARootActivity(),
                            ErrorNumbers.Error_StateMachineWorkflowMustBeARootActivity
                        )
                    );
                ...
                else
                {
                    ...
                    if (!(state.Parent is StateActivity))
                    {
                        validationErrors.Add(
                            new ValidationError(
                                SR.GetError_InvalidStateActivityParent(),
                                ErrorNumbers.Error_InvalidStateActivityParent
                            )
                        );
                        return validationErrors;
                    }
        ...
        )
        {
            if (state.Activities.Count > 0)
            {
                validationErrors.Add(
                    new ValidationError(
                        SR.GetError_BlackBoxCustomStateNotSupported(),
                        ErrorNumbers.Error_BlackBoxCustomStateNotSupported
                    )
                );
            }
        }
        ...
        )
        {
            ...
            if (remove != null)
            {
                ...
                {
                    EventDrivenActivity removedEventDriven =
                        remove.OriginalRemovedActivity as EventDrivenActivity;
                    if (removedEventDriven != null)
                    {
                        return new ValidationError(
                            SR.GetError_CantRemoveEventDrivenFromExecutingState(
                                removedEventDriven.QualifiedName,
                                activity.QualifiedName
                            ),
        ...
        )
        {
            ...
            foreach (Activity activity in state.Activities)
            {
                ...
                if (
                    activity is EventDrivenActivity
        ...
        )
        {
            ...
            foreach (Activity activity in state.Activities)
            {
                ...
                if (activity is EventDrivenActivity || activity is StateActivity)
                {
                    continue;
                }
                else
        ...
        private static bool ValidateMultipleIEventActivity(
        ...
        )
        {
            ...
            return ValidateMultipleIEventActivityInCompositeActivity(
                eventDriven,
                firstEventActivity,
                eventDriven,
                validationErrors
        ...
        private static bool ValidateMultipleIEventActivityInCompositeActivity(
            EventDrivenActivity eventDriven,
            IEventActivity firstEventActivity,
            ...
            foreach (Activity activity in parent.Activities)
            {
                ...
                if (activity is IEventActivity)
                {
                    validationErrors.Add(
                        new ValidationError(
                            SR.GetString(
                                SR.Error_EventDrivenMultipleEventActivity,
                                eventDriven.Name,
                ...
                else
                {
                    ...
                    {
                        bool result = ValidateMultipleIEventActivityInCompositeActivity(
                            eventDriven,
                            firstEventActivity,
                            compositeActivity,
                            validationErrors
