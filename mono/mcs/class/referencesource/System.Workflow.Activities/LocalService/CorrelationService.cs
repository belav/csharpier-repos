    ...
    internal static class CorrelationService
    {
        ...
        )
        {
            ...
            while (initializerValues.MoveNext() && followerValues.MoveNext())
            {
                ...
                // Bug DevDiv2\DevDiv 552322 -
                // http://vstfdevdiv.redmond.corp.microsoft.com:8080/DevDiv2/DevDiv/_workitems#_a=edit&id=552322
                ...
                // The collections MIGHT be in the same order. Before searching the followerProperties collection
                // for an element with a matching
                // name, see if the current element in the initializerValues and followerValues enumerators have a
                // matching name.
                // If they do match, just fall thru because followerValue is already set to
                // followerValues.Current.Value;
                if (
