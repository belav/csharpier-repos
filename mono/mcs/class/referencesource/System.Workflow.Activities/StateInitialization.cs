namespace System.Workflow.Activities
{
    ...
    [ToolboxBitmap(
        ...
        "Resources.StateInitializationActivity.png"
    )]
    ...
    internal sealed class StateInitializationValidator : CompositeActivityValidator
    {
        public override ValidationErrorCollection Validate(ValidationManager manager, object obj)
        {
            ...
            if (stateInitialization == null)
                throw new ArgumentException(
                    SR.GetString(
                        ...
                        typeof(StateInitializationActivity).FullName
                    ),
                    "obj"
                );
            ...
            {
                StateInitializationActivity childStateInitialization =
                    activity as StateInitializationActivity;
                if (childStateInitialization != null)
                {
                    ...
                    validationErrors.Add(
                        new ValidationError(
                            ...
                            ErrorNumbers.Error_MultipleStateInitializationActivities
                        )
                    );
                    break;
                }
        ...
        private void ValidateSetStateInsideStateInitialization(
            StateInitializationActivity stateInitialization,
            StateActivity state,
            ValidationErrorCollection validationErrors
        )
        {
            ValidateSetStateInsideStateInitializationCore(
                stateInitialization,
                state,
                validationErrors
            );
