...
partial class SR
{
    public const string ArgumentOutOfRange_BatchSizeMustBeNoGreaterThanBoundedCapacity =
    ...
    public const string Argument_BoundedCapacityNotSupported =
        "BoundedCapacity must be Unbounded or -1 for this dataflow block.";
    public const string Argument_CantConsumeFromANullSource =
        "The argument must be false if no source from which to consume is specified.";
    public const string Argument_InvalidMessageHeader =
        "The DataflowMessageHeader instance does not represent a valid message header.";
    public const string Argument_InvalidMessageId =
        "To construct a DataflowMessageHeader instance, either pass a non-zero value or use the parameterless constructor.";
    public const string Argument_NonGreedyNotSupported =
        "Greedy must be true for this dataflow block.";
    public const string InvalidOperation_DataNotAvailableForReceive =
        "The source completed without providing data to receive.";
    public const string InvalidOperation_FailedToConsumeReservedMessage =
        "The target block failed to consume a message it had successfully reserved.";
    public const string InvalidOperation_MessageNotReservedByTarget =
        "The target does not have the message reserved.";
    public const string NotSupported_MemberNotNeeded =
    ...
    public const string InvalidOperation_ErrorDuringCleanup =
        "An error occurred while linking up the target or during the cleanup after completion.";
}
