...
public static class SRCore
{
    ...
    public static string CannotAcquireLockSpecific(object arg1)
    {
        return "CannotAcquireLockSpecific";
    }

    public static string CannotAcquireLockSpecificWithOwner(object arg1, object arg2)
    {
        return "CannotAcquireLockSpecificWithOwner";
    }
    ...
    public const string CannotInvokeTransactionalFromNonTransactional =
    ...
    public const string DoNotCompleteTryCommandWithPendingReclaim =
        "DoNotCompleteTryCommandWithPendingReclaim";
    public const string ExecuteMustBeNested = "ExecuteMustBeNested";

    public static string GenericInstanceCommand(object arg1)
    {
        return "GenericInstanceCommand";
    }
    ...
    public static string InitialMetadataCannotBeDeleted(object arg1)
    {
        return "InitialMetadataCannotBeDeleted";
    }

    public const string InstanceCollisionDefault = "InstanceCollisionDefault";

    public static string InstanceCollisionSpecific(Guid arg1)
    {
        return "InstanceCollisionSpecific";
    }

    public const string InstanceCompleteDefault = "InstanceCompleteDefault";

    public static string InstanceCompleteSpecific(Guid arg1)
    {
        return "InstanceCompleteSpecific";
    }

    public const string InstanceHandleConflictDefault = "InstanceHandleConflictDefault";

    public static string InstanceHandleConflictSpecific(Guid arg1)
    {
        return "InstanceHandleConflictSpecific";
    }
    ...
    public static string InstanceLockLostSpecific(Guid arg1)
    {
        return "InstanceLockLostSpecific";
    }

    public const string InstanceNotReadyDefault = "InstanceNotReadyDefault";

    public static string InstanceNotReadySpecific(Guid arg1)
    {
        return "InstanceNotReadySpecific";
    }
    ...
    public const string InstanceOperationRequiresNotCompleted =
        "InstanceOperationRequiresNotCompleted";
    public const string InstanceOperationRequiresNotUninitialized =
    ...
    public static string InstanceOwnerSpecific(Guid arg1)
    {
        return "InstanceOwnerSpecific";
    }
    ...
    public static string KeyCollisionSpecific(object arg1)
    {
        return "KeyCollisionSpecific";
    }

    public static string KeyCollisionSpecific(object arg1, object arg2, object arg3)
    {
        return "KeyCollisionSpecific";
    }

    public static string KeyCollisionSpecificKeyOnly(object arg1)
    {
        return "KeyCollisionSpecificKeyOnly";
    }

    public const string KeyCompleteDefault = "KeyCompleteDefault";

    public static string KeyCompleteSpecific(object arg1)
    {
        return "KeyCompleteSpecific";
    }
    ...
    public static string KeyNotReadySpecific(object arg1)
    {
        return "KeyNotReadySpecific";
    }

    public const string LoadedWriteOnlyValue = "LoadedWriteOnlyValue";
    public const string MayBindLockCommandShouldValidateOwner =
        "MayBindLockCommandShouldValidateOwner";
    public const string MetadataCannotContainNullKey = "MetadataCannotContainNullKey";

    public static string MetadataCannotContainNullValue(object arg1)
    {
        return "MetadataCannotContainNullValue";
    }

    public const string MustSetTransactionOnFirstCall = "MustSetTransactionOnFirstCall";

    public static string NameCollisionOnCollect(XName arg1, object arg2)
    {
        return "NameCollisionOnCollect";
    }

    public static string NameCollisionOnMap(XName arg1, object arg2)
    {
        return "NameCollisionOnMap";
    }
    ...
    public static string OutsideInstanceExecutionScope(object arg1)
    {
        return "OutsideInstanceExecutionScope";
    }

    public static string OutsideTransactionalCommand(object arg1)
    {
        return "OutsideTransactionalCommand";
    }

    public const string OwnerBelongsToWrongStore = "OwnerBelongsToWrongStore";

    public static string PersistencePipelineAbortThrew(object arg1)
    {
        return "PersistencePipelineAbortThrew";
    }

    public static string ProviderDoesNotSupportCommand(object arg1)
    {
        return "ProviderDoesNotSupportCommand";
    }
    ...
    public static string WaitForEventsTimedOut(TimeSpan arg1)
    {
        return "WaitForEventsTimedOut";
    }
}
