...
namespace MonoTests.I18N.CJK
{
    ...
    public class TestCJK
    {
        ...
        {
            AssertEncode(
                TestResourceHelper.GetFullPathOfResource("Test/texts/chinese-utf8.txt"),
                TestResourceHelper.GetFullPathOfResource("Test/texts/chinese-936.txt"),
                936
            );
        }
        ...
        {
            AssertEncode(
                TestResourceHelper.GetFullPathOfResource("Test/texts/chinese3-utf8.txt"),
                TestResourceHelper.GetFullPathOfResource("Test/texts/chinese3-936.txt"),
                936
            );
        }
        ...
        {
            AssertEncode(
                TestResourceHelper.GetFullPathOfResource("Test/texts/chinese2-utf8.txt"),
                TestResourceHelper.GetFullPathOfResource("Test/texts/chinese2-950.txt"),
                950
            );
        }
        ...
        {
            AssertEncode(
                TestResourceHelper.GetFullPathOfResource("Test/texts/chinese4-utf8.txt"),
                TestResourceHelper.GetFullPathOfResource("Test/texts/chinese4-950.txt"),
                950
            );
        }
        ...
        public void CP54936_Encode()
        {
            AssertEncode(
                TestResourceHelper.GetFullPathOfResource("Test/texts/chinese-utf8.txt"),
                TestResourceHelper.GetFullPathOfResource("Test/texts/chinese-54936.txt"),
                54936
            );
        }
        ...
        {
            AssertEncode(
                TestResourceHelper.GetFullPathOfResource("Test/texts/japanese-utf8.txt"),
                TestResourceHelper.GetFullPathOfResource("Test/texts/japanese-932.txt"),
                932
            );
        }
        ...
        public void Bug28321()
        {
            ...
            var text = Manager
                ...
                .GetString(Convert.FromBase64String("gX6BTIF9gYCB94GLgU6BmA=="));
        ...
        public void CP51932_Encode()
        {
            AssertEncode(
                TestResourceHelper.GetFullPathOfResource("Test/texts/japanese-utf8.txt"),
                TestResourceHelper.GetFullPathOfResource("Test/texts/japanese-51932.txt"),
                51932
            );
        }
        ...
        {
            AssertEncode(
                TestResourceHelper.GetFullPathOfResource("Test/texts/japanese2-utf8.txt"),
                TestResourceHelper.GetFullPathOfResource("Test/texts/japanese2-50220.txt"),
                50220
            );
        }
        ...
        {
            AssertEncode(
                TestResourceHelper.GetFullPathOfResource("Test/texts/japanese3-utf8.txt"),
                TestResourceHelper.GetFullPathOfResource("Test/texts/japanese3-50220.txt"),
                50220
            );
        }
        ...
        public void CP50221_Encode()
        {
            AssertEncode(
                TestResourceHelper.GetFullPathOfResource("Test/texts/japanese-utf8.txt"),
                TestResourceHelper.GetFullPathOfResource("Test/texts/japanese-50221.txt"),
                50221
            );
        }
        ...
        public void CP50221_Encode_3()
        {
            AssertEncode(
                TestResourceHelper.GetFullPathOfResource("Test/texts/japanese3-utf8.txt"),
                TestResourceHelper.GetFullPathOfResource("Test/texts/japanese3-50221.txt"),
                50221
            );
        }
        ...
        public void CP50222_Encode()
        {
            AssertEncode(
                TestResourceHelper.GetFullPathOfResource("Test/texts/japanese-utf8.txt"),
                TestResourceHelper.GetFullPathOfResource("Test/texts/japanese-50222.txt"),
                50222
            );
        }
        ...
        public void CP50220BrokenESC()
        {
            Assert.AreEqual(
                "\u001B$0",
                Manager.GetEncoding(50220).GetString(new byte[] { 0x1B, 0x24, 0x30 }),
                "#1"
            );
        }
        ...
        public void CP50220BrokenESC2()
        {
            ...
            Assert.AreEqual(
                ...
                Encoding
                    ...
                    .GetString(new byte[] { 0x1B, 0x24, 0x30 }),
                "#1"
            );
        }
        ...
        public void Encoder54936Refresh()
        {
            ...
            Assert.AreEqual(new byte[] { 00, 00, 00, 00 }, bytes, "#2");

            bytes = new byte[4];
            Assert.AreEqual(4, d.GetBytes(new char[] { '\uDC00' }, 0, 1, bytes, 0, true), "#3");
            Assert.AreEqual(new byte[] { 0x90, 0x30, 0x81, 0x30 }, bytes, "#4");

            bytes = new byte[4];
            Assert.AreEqual(1, d.GetBytes(new char[] { '\uD800' }, 0, 1, bytes, 0, true), "#5");
            Assert.AreEqual(new byte[] { 0x3F, 00, 00, 00 }, bytes, "#6");
        }

        [Test]
        public void Bug491799()
        {
            Assert.AreEqual(new byte[] { 0xEE, 0xFC }, Manager.GetEncoding(932).GetBytes("\uFF02"));
        }
        ...
        {
            AssertEncode(
                TestResourceHelper.GetFullPathOfResource("Test/texts/korean-utf8.txt"),
                TestResourceHelper.GetFullPathOfResource("Test/texts/korean-949.txt"),
                949
            );
        }
