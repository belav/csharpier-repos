...
namespace MonoTests.I18N.MidEast
{
    ...
    public class TestMidEast
    {
        ...
        void AssertEncode(string utf8file, string decfile, int codepage, string fallbackString)
        {
            string decoded = null;
            byte[] encoded = null;
        ...
        public void HandleFallback_Encode_Generic(int cp)
        {
            AssertEncode(
                TestResourceHelper.GetFullPathOfResource(
                    "Test/texts/encoder-handlefallback-generic-utf8.txt"
                ),
                TestResourceHelper.GetFullPathOfResource(
                    "Test/texts/encoder-handlefallback-generic-output.txt"
                ),
                cp,
                "error_foobar"
            );
        ...
        {
            AssertEncode(
                TestResourceHelper.GetFullPathOfResource("Test/texts/turkish-utf8.txt"),
                TestResourceHelper.GetFullPathOfResource("Test/texts/turkish-1254.txt"),
                1254
            );
        }
    }
