...
namespace MonoTests
{
    ...
    public class DebuggerTests
    {
...
#if !MONODROID_TOOLS
        Diag.ProcessStartInfo CreateStartInfo(
            string app,
            string method = null,
        ...
        public static void ss_recursive_chaotic_trap(
            int n,
            List<RecursiveChaoticPoint> trace,
            ref bool didLast,
            ref bool didAny
        )
        {
        ...
        public static void ss_recursive_chaotic_at(
            string at,
            int n,
            List<RecursiveChaoticPoint> trace,
            ref bool didLast,
        ...
        public void MetadataAndPdbTest()
        {
            ...
            foreach (var assemblyMirror in assemblyMirrors)
            {
                ...
                Assert.AreEqual(
                    metadata.MainModule.Mvid,
                    assemblyMirror.ManifestModule.ModuleVersionId
                );
                ...
                foreach (var type in metadata.Modules.SelectMany(x => x.GetTypes()))
                {
                    ...
                    {
                        var methodMirror = assemblyMirror.GetMethod(
        ...
        public void ClassLocalReflection()
        {
            ...
            MethodMirror m = entry_point.DeclaringType.Assembly
        ...
        public void Arrays()
        {
            ...
            arr.SetValues(
                0,
                new Value[] { vm.RootDomain.CreateString("D1"), vm.RootDomain.CreateString("D2") }
            );
        ...
        public void Object_GetValues()
        {
            ...
            object[] vals = o.GetValues(
                new FieldInfoMirror[] { t.GetField("field_i"), t.GetField("field_s") }
            );
            object f = vals[0];
            AssertValue(42, f);
            f = vals[1];
        ...
        public void Object_SetValues()
        {
            ...
            AssertThrows<ArgumentException>(
                ...
                {
                    o.SetValue(
                        o.Type.GetField("field_struct"),
                        o.GetValue(o.Type.GetField("field_enum"))
                    );
                }
            );
            ...
            foreach (var attr in attrs)
            {
                if (attr.Constructor.DeclaringType.Name == "DebuggerDisplayAttribute")
                {
                    ...
                    Assert.IsInstanceOfType(
                        typeof(TypeMirror),
                        attr.NamedArguments[1].TypedValue.Value
                    );
                    Assert.AreEqual(
                        "Int32",
                        (attr.NamedArguments[1].TypedValue.Value as TypeMirror).Name
                    );
                }
                else if (attr.Constructor.DeclaringType.Name == "DebuggerTypeProxyAttribute")
                {
                    ...
                    Assert.AreEqual(
                        "Tests",
                        (attr.ConstructorArguments[0].Value as TypeMirror).Name
                    );
                }
        ...
        public void FieldInfo()
        {
            ...
            Assert.AreEqual(
                (int)System.Diagnostics.DebuggerBrowsableState.Collapsed,
                (attr.ConstructorArguments[0].Value as EnumMirror).Value
            );
        }
        ...
        public void Type_GetValues()
        {
            ...
            object[] vals = t.GetValues(
                new FieldInfoMirror[] { t.GetField("static_i"), t.GetField("static_s") }
            );
            object f = vals[0];
            AssertValue(55, f);
        ...
        public void AssemblyInfo()
        {
            ...
            Assert.AreEqual(
                "dtest-app, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null",
                aname.ToString()
            );
            ...
            TypeMirror t = vm.RootDomain.Corlib.GetType(
        ...
        public void Locals()
        {
            ...
            AssertThrows<InvalidStackFrameException>(
                delegate()
                {
        ...
        public void Exit()
        {
            ...
            if (p != null)
            {
                ...
                // error handling
                AssertThrows<VMDisconnectedException>(
                    delegate()
                    {
                        vm.Resume();
                    }
        ...
        public void Crash()
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                ...
                catch (VMDisconnectedException vmDisconnect)
                { //expected behavior because of unreliability of the crash reporter.
                    success = false;
                }
                finally
                {
        ...
        public void Invoke()
        {
            ...
            AssertValue(
                (int)Byte.MaxValue + (int)SByte.MaxValue + 1 + 1 + 1 + 1 + 1 + 1 + 'A' + 1 + 3 + 3,
                v
            );

            // pass ref
            m = t.GetMethod("invoke_pass_ref");
            v = this_obj.InvokeMethod(
                e.Thread,
                m,
                new Value[] { vm.RootDomain.CreateString("ABC") }
            );
            AssertValue("ABC", v);
            ...
            var out_task = this_obj.InvokeMethodAsyncWithResult(
                e.Thread,
                m,
                new Value[] { vm.CreateValue(1), vm.CreateValue(null) },
            ...
            out_task = this_obj.InvokeMethodAsyncWithResult(
                e.Thread,
                m,
                new Value[] { vm.CreateValue(1), vm.CreateValue(null) }
            );
            ...
            // instance
            m = t.GetMethod("invoke_pass_ref");
            var task = this_obj.InvokeMethodAsync(
                e.Thread,
                m,
                new Value[] { vm.RootDomain.CreateString("ABC") }
            );
            ...
            var str = stringType.NewInstance(
                e.Thread,
                stringConstructor,
                new Value[] { vm.CreateValue('a'), vm.CreateValue(3) }
            );
        ...
        public void InvokeVType()
        {
            ...
            t = s.Type;
            m = t.GetMethods()
                .First(method => method.Name == ".ctor" && method.GetParameters().Length == 1);
            ...
            var task = s.InvokeMethodAsyncWithResult(
                e.Thread,
                m,
                null,
        ...
        public void InvokeMultiple()
        {
            ...
            var r = this_obj.BeginInvokeMultiple(
                e.Thread,
                methods,
                null,
                InvokeOptions.SingleThreaded,
        ...
        public void InvokeAbort()
        {
            ...
            var res = (IInvokeAsyncResult)
                obj.BeginInvokeMultiple(
                    e.Thread,
                    new MethodMirror[] { m, m, m, m },
                    null,
                    InvokeOptions.None,
                    delegate { },
                    null
        ...
        public void Exceptions()
        {
            ...
            req = vm.CreateExceptionRequest(
                vm.RootDomain.Corlib.GetType("System.ArgumentException")
            );
            req.Enable();
        ...
        public void EventSets()
        {
            ...
            var req2 = vm.CreateExceptionRequest(
        ...
        public void NullRefExceptionAndSingleThreadedInvoke()
        {
            ...
            var req = vm.CreateExceptionRequest(
                vm.RootDomain.Corlib.GetType("System.NullReferenceException")
            );
            req.Enable();
            ...
            var tostring_method = vm.RootDomain.Corlib
        ...
        public void MemberInOtherDomain()
        {
            ...
            var crossDomainField = (ObjectMirror)
                inOtherDomain.GetValue(inOtherDomain.Type.GetField("printMe"));
        ...
        public void Domains()
        {
            ...
            var anenum = vm.CreateEnumMirror(
                d_method.DeclaringType.Assembly.GetType("AnEnum"),
                vm.CreateValue(1)
            );
        ...
        public void GCWhileSuspended()
        {
            ...
            var o =
                entry_point.DeclaringType.GetValue(
                    entry_point.DeclaringType.GetField("gc_suspend_field")
                ) as ObjectMirror;
            //Console.WriteLine (o);
        ...
        public void Attach()
        {
            ...
            var pi = CreateStartInfo(
                dtest_app_path,
                "attach",
                $"--debugger-agent=transport=dt_socket,address=127.0.0.1:{port},server=y,suspend=n"
            );
            ...
            while (true)
            {
                ...
                if (e is AssemblyLoadEvent)
                {
                    ...
                    if (amirror.GetName().Name == "dtest-app")
                        ...
                        vm.SetBreakpoint(
                            amirror.EntryPoint.DeclaringType.GetMethod("attach_break"),
                            0
                        );
                }
        ...
        public void Pointer_GetValue()
        {
            ...
            var pointerValue2 = new PointerValue(
                pointerValue.VirtualMachine,
                pointerValue.Type,
                pointerValue.Address + pointerValue.Type.GetElementType().GetValueSize()
            );
        ...
        public void IfPropertyStepping()
        {
            ...
            e = step_into();
            Assert.IsTrue(
                (e as StepEvent).Method.Name == "op_Equality"
                    || (e as StepEvent).Method.Name == "if_property_stepping"
            );
        }
            ...
            while (true)
            {
                ...
                foreach (var e in nextEventSet.Events)
                {
                    if (e.EventType == EventType.AssemblyLoad)
                    {
                        ...
                        {
                            var methodMirror = amirror.EntryPoint.DeclaringType.GetMethod(
                                "attach_break"
                            );
        ...
        public void TestExceptionFilterWin()
        {
            ...
            var req2 = vm.CreateExceptionRequest(
                vm.RootDomain.Corlib.GetType("System.Exception"),
                true,
                true,
                false
            );
            ...
            var req3 = vm.CreateExceptionRequest(
                vm.RootDomain.Corlib.GetType("System.ArgumentException"),
                false,
                true,
                false
            ...
            req2 = vm.CreateExceptionRequest(null, true, true, true);
            req2.Enable();
            req2 = vm.CreateExceptionRequest(
                vm.RootDomain.Corlib.GetType("System.ArgumentException"),
                false,
                true,
                false
        ...
        public void TestAsyncDebugGenericsValueType()
        {
            ...
            MethodMirror async_method = entry_point.DeclaringType.GetMethod(
        ...
        public void InvalidArgumentAssemblyGetType()
        {
            ...
            try
            {
                var type = assembly.GetType(
                    "System.Collections.Generic.Dictionary<double, float>.Main"
                );
            }
            catch (CommandException ex)
            {
                Assert.AreEqual(
                    ex.ErrorMessage,
                    "Unexpected assembly-qualified type \"System.Collections.Generic.Dictionary<double, float>.Main\" was provided"
                );
            }
        }
        ...
        public void InvokeSingleStepMultiThread()
        {
            ...
            while (line_first_counter > 0 || line_second_counter > 0 || line_third_counter > 0)
            {
                ...
                try
                {
                    if (
                        (
                            e.Thread.GetFrames()[0].Location.LineNumber == firstLineFound + 1
                            && (
                                e.Thread.Name.Equals("Thread_0") || e.Thread.Name.Equals("Thread_1")
                            )
                        )
                        || l.LineNumber == firstLineFound + 2
                    )
                    {
                        vm.Resume();
                        e = GetNextEvent();
