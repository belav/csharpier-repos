...
#pragma warning restore 0414
    ...
    {
        ss_nested_with_two_args(
            ss_nested_arg1(),
            ss_nested_with_two_args(ss_nested_arg2(), ss_nested_arg3())
        );
    }
    ...
    {
        TestEnumeratorInsideGenericStruct<String, String> generic_struct =
            new TestEnumeratorInsideGenericStruct<String, String>(
                new KeyValuePair<string, string>("0", "f1")
            );
    }
    ...
    */
    ...
    public static void arguments()
    {
        arg1(
            ...
            1.2345f,
            6.78910,
            new IntPtr(Int32.MaxValue - 5),
            new UIntPtr(UInt32.MaxValue - 5)
        );
        int i = 42;
        arg2(
            "FOO",
    ...
    public static void objects()
    {
        Tests t = new Tests()
        {
            ...
            field_byte = 129,
            field_sbyte = -33,
            field_short = Int16.MaxValue - 5,
            field_ushort = UInt16.MaxValue - 5,
            field_long = Int64.MaxValue - 5,
            field_ulong = UInt64.MaxValue - 5,
            field_float = 3.14f,
            field_double = 3.14f,
            field_s = "S",
            base_field_i = 43,
            ...
            field_enum = AnEnum.B,
            field_class = null,
            field_intptr = new IntPtr(Int32.MaxValue - 5),
            field_nullable = null,
        };
        t.o1(
            new Tests2() { field_j = 43 },
            new GClass<int> { field = 42 },
            new GClass<string> { field = "FOO" }
        );
        o2(
            new string[] { "BAR", "BAZ" },
            new int[] { 42, 43 },
    ...
    public static void vtypes()
    {
        Tests t = new Tests()
        {
            ...
            generic_field_struct = new GStruct<int>() { i = 42 },
            field_boxed_struct = new AStruct() { i = 42 },
    ...
    [MethodImplAttribute(MethodImplOptions.NoInlining)]
    public static unsafe string ti2(
        string[] s2,
        int[] s3,
        int[,] s4,
        ref int ri,
    ...
    public static void invoke()
    {
        new Tests().invoke1(
            new Tests2(),
            new AStruct() { i = 42, j = (IntPtr)43 },
            new GStruct<int> { j = 42 }
        );
        new Tests().invoke_ex();
    }
    ...
    public long invoke_pass_primitive(
        byte ub,
        sbyte sb,
        short ss,
        ushort us,
    ...
    public static void domains()
    {
        ...
        CrossDomain o = (CrossDomain)
            domain.CreateInstanceAndUnwrap(typeof(CrossDomain).Assembly.FullName, "CrossDomain");
    ...
    [MethodImplAttribute(MethodImplOptions.NoInlining)]
    public static void generic_method<T>()
        where T : class { }
