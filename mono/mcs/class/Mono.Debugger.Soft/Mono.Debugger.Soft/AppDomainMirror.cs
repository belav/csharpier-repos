        ...
        public ObjectMirror CreateBoxedValue(Value value)
        {
            ...
            if (!(value is PrimitiveValue) && !(value is StructMirror))
                throw new ArgumentException(
                    "Value must be a PrimitiveValue or a StructMirror",
                    "value"
                );
            ...
            return vm.GetObject<ObjectMirror>(
                vm.conn.Domain_CreateBoxedValue(id, t.Id, vm.EncodeValue(value))
            );
        }
