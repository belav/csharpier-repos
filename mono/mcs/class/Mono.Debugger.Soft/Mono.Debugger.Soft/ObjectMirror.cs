...
namespace Mono.Debugger.Soft
{
    ...
    public interface IInvokable
    {
        ...
        Value InvokeMethod(
            ThreadMirror thread,
            MethodMirror method,
            IList<Value> arguments,
            InvokeOptions options
        );
        IAsyncResult BeginInvokeMethod(
            ThreadMirror thread,
            MethodMirror method,
            IList<Value> arguments,
            InvokeOptions options,
        ...
        Task<Value> InvokeMethodAsync(
            ThreadMirror thread,
            MethodMirror method,
            IList<Value> arguments,
            InvokeOptions options = InvokeOptions.None
        );
        Task<InvokeResult> InvokeMethodAsyncWithResult(
            ThreadMirror thread,
            MethodMirror method,
            IList<Value> arguments,
            InvokeOptions options = InvokeOptions.None
    ...
    public class ObjectMirror : Value, IInvokable
    {
        ...
        internal ObjectMirror(VirtualMachine vm, long id)
            : base(vm, id) { }

        internal ObjectMirror(VirtualMachine vm, long id, TypeMirror type, AppDomainMirror domain)
            : base(vm, id)
        {
            this.type = type;
            this.domain = domain;
        ...
        {
            get { return vm.conn.Object_IsCollected(id); }
        }
                ...
                if (ex.ErrorCode == ErrorCode.INVALID_FIELDID)
                {
                    if (fields.Count == 1)
                        throw new ArgumentException(
                            string.Format(
                                "The field '{0}' is not valid for this type.",
                                fields[0].Name
                            )
                        );
                    throw new ArgumentException(
                        "One of the fields is not valid for this type.",
                        "fields"
                    );
                }
                else
        ...
        public void SetValues(IList<FieldInfoMirror> fields, Value[] values)
        {
            ...
            catch (CommandException ex)
            {
                if (ex.ErrorCode == ErrorCode.INVALID_FIELDID)
                    ...
                    throw new ArgumentException(
                        "One of the values is not valid for its field.",
                        "values"
                    );
                else
                    throw;
        ...
        public long Address
        {
            get { return vm.conn.Object_GetAddress(id); }
        }
        ...
        public IAsyncResult BeginInvokeMethod(
            VirtualMachine vm,
            ThreadMirror thread,
            MethodMirror method,
            IList<Value> arguments,
        ...
        public Task<Value> InvokeMethodAsync(
            ThreadMirror thread,
            MethodMirror method,
            IList<Value> arguments,
            InvokeOptions options = InvokeOptions.None
        ...
        internal static Task<Value> InvokeMethodAsync(
            VirtualMachine vm,
            ThreadMirror thread,
            MethodMirror method,
            Value this_obj,
        ...
        )
        {
            return InvokeMethodAsync(
                ...
                arguments,
                options,
                EndInvokeMethodInternal
            );
        }

        public Task<InvokeResult> InvokeMethodAsyncWithResult(
            ThreadMirror thread,
            MethodMirror method,
            IList<Value> arguments,
            InvokeOptions options = InvokeOptions.None
        ...
        internal static Task<InvokeResult> InvokeMethodAsyncWithResult(
            VirtualMachine vm,
            ThreadMirror thread,
            MethodMirror method,
            Value this_obj,
        ...
        )
        {
            return InvokeMethodAsync(
                ...
                arguments,
                options,
                EndInvokeMethodInternalWithResult
            );
        }

        internal static Task<TResult> InvokeMethodAsync<TResult>(
            VirtualMachine vm,
            ThreadMirror thread,
            MethodMirror method,
            Value this_obj,
            IList<Value> arguments,
            InvokeOptions options,
            Func<IAsyncResult, TResult> callback
        )
        {
        ...
        //
        public IAsyncResult BeginInvokeMultiple(
            ThreadMirror thread,
            MethodMirror[] methods,
            IList<IList<Value>> arguments,
            InvokeOptions options,
            AsyncCallback callback,
            object state
        )
        {
            return BeginInvokeMultiple(
                vm,
                thread,
                methods,
                this,
        ...
        class InvokeAsyncResult : IInvokeAsyncResult
        {
            ...
            public ValueImpl Value { get; set; }

            public ValueImpl OutThis { get; set; }

            public ValueImpl[] OutArgs { get; set; }

            public ValueImpl Exception { get; set; }
        ...
        internal static IInvokeAsyncResult BeginInvokeMethod(
            VirtualMachine vm,
            ThreadMirror thread,
            MethodMirror method,
            Value this_obj,
        ...
        internal static InvokeResult EndInvokeMethodInternalWithResult(IAsyncResult asyncResult)
        {
            ...
            else
            {
                ...
                {
                    Result = r.VM.DecodeValue(r.Value),
                    OutThis = out_this,
                    OutArgs = out_args,
                };
            }
        ...
        internal static Value InvokeMethod(
            VirtualMachine vm,
            ThreadMirror thread,
            MethodMirror method,
            Value this_obj,
        ...
        {
            return EndInvokeMethodInternal(
                BeginInvokeMethod(vm, thread, method, this_obj, arguments, options, null, null)
            );
        }
        ...
        internal static IInvokeAsyncResult BeginInvokeMultiple(
            VirtualMachine vm,
            ThreadMirror thread,
            MethodMirror[] methods,
            Value this_obj,
        ...
        )
        {
            ...
            if (callback == null)
                throw new ArgumentException(
                    "A callback argument is required for this method.",
                    "callback"
                );
