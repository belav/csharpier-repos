            ...
            while (ins != null)
            {
                ...
                else if (op == OpCodes.Conv_I)
                {
                    ...
                    try
                    {
                        ...
                        stack[sp++] = new PrimitiveValue(
                            method.VirtualMachine,
                            Convert.ToInt32(primitive.Value)
                        );
                    }
                    catch
                    {
                ...
                else if (op == OpCodes.Conv_I1)
                {
                    ...
                    try
                    {
                        ...
                        stack[sp++] = new PrimitiveValue(
                            method.VirtualMachine,
                            Convert.ToSByte(primitive.Value)
                        );
                    }
                    catch
                    {
                ...
                else if (op == OpCodes.Conv_U1)
                {
                    ...
                    try
                    {
                        ...
                        stack[sp++] = new PrimitiveValue(
                            method.VirtualMachine,
                            Convert.ToByte(primitive.Value)
                        );
                    }
                    catch
                    {
                ...
                else if (op == OpCodes.Conv_I2)
                {
                    ...
                    try
                    {
                        ...
                        stack[sp++] = new PrimitiveValue(
                            method.VirtualMachine,
                            Convert.ToInt16(primitive.Value)
                        );
                    }
                    catch
                    {
                ...
                else if (op == OpCodes.Conv_U2)
                {
                    ...
                    try
                    {
                        ...
                        stack[sp++] = new PrimitiveValue(
                            method.VirtualMachine,
                            Convert.ToUInt16(primitive.Value)
                        );
                    }
                    catch
                    {
                ...
                else if (op == OpCodes.Conv_U4)
                {
                    ...
                    try
                    {
                        ...
                        stack[sp++] = new PrimitiveValue(
                            method.VirtualMachine,
                            Convert.ToUInt32(primitive.Value)
                        );
                    }
                    catch
                    {
                ...
                else if (op == OpCodes.Conv_I8)
                {
                    ...
                    try
                    {
                        ...
                        stack[sp++] = new PrimitiveValue(
                            method.VirtualMachine,
                            Convert.ToInt64(primitive.Value)
                        );
                    }
                    catch
                    {
                ...
                else if (op == OpCodes.Conv_U8)
                {
                    ...
                    try
                    {
                        ...
                        stack[sp++] = new PrimitiveValue(
                            method.VirtualMachine,
                            Convert.ToUInt64(primitive.Value)
                        );
                    }
                    catch
                    {
                ...
                else if (op == OpCodes.Conv_R4)
                {
                    ...
                    try
                    {
                        ...
                        stack[sp++] = new PrimitiveValue(
                            method.VirtualMachine,
                            Convert.ToSingle(primitive.Value)
                        );
                    }
                    catch
                    {
                ...
                else if (op == OpCodes.Conv_R8)
                {
                    ...
                    try
                    {
                        ...
                        stack[sp++] = new PrimitiveValue(
                            method.VirtualMachine,
                            Convert.ToDouble(primitive.Value)
                        );
                    }
                    catch
                    {
                            ...
                            try
                            {
                                switch (method.ReturnType.CSharpName)
                                {
                                    ...
                                    case "char":
                                        res = new PrimitiveValue(
                                            method.VirtualMachine,
                                            Convert.ToChar(primitive.Value)
                                        );
                                        break;
                                    case "bool":
                                        res = new PrimitiveValue(
                                            method.VirtualMachine,
                                            Convert.ToBoolean(primitive.Value)
                                        );
                                        break;
                                }
                            }
