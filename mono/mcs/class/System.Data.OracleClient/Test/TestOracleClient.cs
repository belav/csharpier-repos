...
namespace Test.OracleClient
{
    public class OracleTest
    {
        ...
        static void MonoTest(OracleConnection con)
        {
            ...
            string varchar2_value = (string)ReadScalar(
                con,
                "SELECT MAX(varchar2_value) FROM MONO_ORACLE_TEST"
            );
            Console.WriteLine("     String Value: " + varchar2_value);

            Console.WriteLine("  Read Scalar: number_whole_value");
            decimal number_whole_value = (decimal)ReadScalar(
                con,
                "SELECT MAX(number_whole_value) FROM MONO_ORACLE_TEST"
            );
            Console.WriteLine("     Int32 Value: " + number_whole_value.ToString());

            Console.WriteLine("  Read Scalar: number_scaled_value");
            decimal number_scaled_value = (decimal)ReadScalar(
                con,
            ...
            DateTime date_value = (DateTime)ReadScalar(
                con,
        ...
        public static void DataAdapterTest2_Setup(OracleConnection con)
        {
            ...
            cmd.Connection = con;
            cmd.CommandText =
                "CREATE TABLE mono_adapter_test ( "
                + " varchar2_value VarChar2(32),  "
        ...
        static void TestNonQueryUsingExecuteReader(OracleConnection con)
        {
            ...
            try
            {
                reader = cmd.ExecuteReader();
                Console.WriteLine(
                    "   RowsAffected before read: " + reader.RecordsAffected.ToString()
                );
                reader.Read();
                Console.WriteLine(
                    "   RowsAffected after read: " + reader.RecordsAffected.ToString()
                );
                reader.Close();
                Console.WriteLine(
                    "   RowsAffected after close: " + reader.RecordsAffected.ToString()
                );
                trans.Commit();
            }
        ...
        static void RollbackTest(OracleConnection connection)
        {
            ...
            insert.CommandText =
                "INSERT INTO SCOTT.EMP (EMPNO, ENAME, JOB) VALUES (8787, 'T Coleman', 'Monoist')";
        ...
        static void StoredProcedureTest1(OracleConnection con)
        {
            ...
            cmd2.CommandText =
                "CREATE TABLE MONO_TEST_TABLE1 (" + " COL1 VARCHAR2(8), " + " COL2 VARCHAR2(32))";
            cmd2.ExecuteNonQuery();
        ...
        static void StoredProcedureTest2(OracleConnection con)
        {
            ...
            cmd2.CommandText =
                "CREATE TABLE MONO_TEST_TABLE2 (" + " COL1 VARCHAR2(8), " + " COL2 VARCHAR2(32))";
            cmd2.ExecuteNonQuery();
        ...
        static void OutParmTest1(OracleConnection con)
        {
            ...
            Console.WriteLine(
                "  Create stored function SP_OUTPUTPARMTEST1 for testing VARCHAR2 Input, Output, InputOutput, Return parameters..."
            );
            ...
            cmd3.CommandText =
                "BEGIN " + "	:ReturnValue := SF_TESTOUTPARM1(:p1, :p2, :p3); " + "END;";
        ...
        static void OutParmTest2(OracleConnection con)
        {
            ...
            Console.WriteLine(
                "  Create stored function SF_TESTOUTPARM2 to test NUMBER parameters..."
            );
            ...
            cmd3.CommandType = CommandType.Text;
            cmd3.CommandText =
                "BEGIN " + "	:returnValue := SF_TESTOUTPARM2(:p1, :p2, :p3);" + "END;";
        ...
        static void OutParmTest3(OracleConnection con)
        {
            ...
            Console.WriteLine(
                "  Create stored function SF_TESTOUTPARM3 to test Date parameters..."
            );
            ...
            cmd3.CommandType = CommandType.Text;
            cmd3.CommandText =
                "BEGIN " + "	:returnValue := SF_TESTOUTPARM3(:p1, :p2, :p3);" + "END;";
            ...
            Console.WriteLine(
                "    1Return Value: {0}",
                returnValue.ToString("yyyy-MM-dd HH:mm:ss")
            );
            Console.WriteLine();
        ...
        static void OutParmTest4(OracleConnection con)
        {
            ...
            Console.WriteLine(
                "  Create stored function SP_OUTPUTPARMTEST4 for testing LONG VARCHAR Input, Output, InputOutput, Return parameters..."
            );
            ...
            cmd3.CommandType = CommandType.Text;
            cmd3.CommandText =
                "BEGIN " + "	:ReturnValue := SP_OUTPUTPARMTEST4(:p1, :p2, :p3); " + "END;";
            ...
            OracleParameter myParameter4 = new OracleParameter(
                "ReturnValue",
            ...
            Console.WriteLine("    1InOut Value: " + inOutValue);
            Console.WriteLine(
                "    1Return Value should be: A very, very, very long value in a far away memory space."
            );
            Console.WriteLine("    1Return Value: " + returnValue);
            Console.WriteLine();
            ...
            Console.WriteLine("    4InOut Value: " + inOutValue);
            Console.WriteLine(
                "    4Return Value should be: A very, very, very long value in a far away memory space."
            );
            Console.WriteLine("    4Return Value: " + returnValue);
            Console.WriteLine();
        }
        ...
        static void OutParmTest5(OracleConnection con)
        {
            ...
            Console.WriteLine(
                "  Create stored function SP_OUTPUTPARMTEST5 for testing CLOB Input, Output, InputOutput, Return parameters..."
            );
        ...
        static void OutParmTest6(OracleConnection con)
        {
            ...
            Console.WriteLine(
                "  Create stored function SF_TESTOUTPARM6 to test Date parameters..."
            );
            ...
            cmd3.CommandType = CommandType.Text;
            cmd3.CommandText =
                "BEGIN " + "	:returnValue := SF_TESTOUTPARM6(:p1, :p2, :p3);" + "END;";
        ...
        static void NullAggregateTest(OracleConnection con)
        {
            ...
            cmd2.CommandText =
                "CREATE TABLE MONO_TEST_TABLE3 (" + " COL1 VARCHAR2(8), " + " COL2 VARCHAR2(32))";
            ...
            cmd2.CommandText =
                "SELECT COL1, COUNT(COL2) AS MAX_COL1 FROM MONO_TEST_TABLE3 GROUP BY COL1";
        ...
        static void ExternalAuthenticationTest()
        {
            ...
            OracleConnection con = new OracleConnection(
                "Data Source=palis;Integrated Security=true"
            );
            try
            {
                con.Open();
        ...
        public static void TestPersistSucurityInfo1()
        {
            ...
            OracleConnection con = new OracleConnection(
                "data source=palis;user id=scott;password=PLACEHOLDER;persist security info=false"
            );
        ...
        public static void TestPersistSucurityInfo2()
        {
            ...
            OracleConnection con = new OracleConnection(
                "data source=palis;user id=scott;password=PLACEHOLDER;persist security info=true"
            );
            Console.WriteLine("ConnectionString before open: " + con.ConnectionString);
            con.Open();
            Console.WriteLine("ConnectionString after open: " + con.ConnectionString);
        ...
        public static void TestPersistSucurityInfo3()
        {
            ...
            OracleConnection con = new OracleConnection(
                "data source=palis;user id=scott;password=PLACEHOLDER"
            );
            Console.WriteLine("ConnectionString before open: " + con.ConnectionString);
            con.Open();
            Console.WriteLine("ConnectionString after open: " + con.ConnectionString);
        ...
        public static void TestPersistSucurityInfo4()
        {
            ...
            OracleConnection con = new OracleConnection(
                ";password=PLACEHOLDER;data source=palis;user id=scott;persist security info=false"
            );
            Console.WriteLine("ConnectionString before open: " + con.ConnectionString);
            con.Open();
            Console.WriteLine("ConnectionString after open: " + con.ConnectionString);
        ...
        static void Main(string[] args)
        {
            ...
            conStr =
                conStr
                + ";pooling=true;min pool size=4;max pool size="
