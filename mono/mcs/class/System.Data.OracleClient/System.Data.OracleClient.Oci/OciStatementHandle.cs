...
namespace System.Data.OracleClient.Oci
{
    internal sealed class OciStatementHandle : OciHandle, IDisposable
    {
        ...
        public bool Execute(bool nonQuery, bool useAutoCommit, bool schemaOnly)
        {
            ...
            status = OciCalls.OCIStmtExecute(
                Service,
                Handle,
                ErrorHandle,
                nonQuery,
        ...
        {
            return (OciStatementType)GetAttributeUInt16(
        ...
        public bool Fetch()
        {
            ...
            status = OciCalls.OCIStmtFetch(Handle, ErrorHandle.Handle, 1, 2, 0);
        ...
        public void Prepare(string commandText)
        {
            ...
            // Execute statement
            status = OciCalls.OCIStmtPrepare(
                this,
                ErrorHandle,
                buffer,
                buffer.Length,
