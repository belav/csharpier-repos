...
namespace System.Data.OracleClient
{
    ...
    public sealed class OracleParameter : DbParameter, IDbDataParameter, ICloneable, IDisposable
    {
        ...
        )
        {
            ...
            if (
                ((value != null && value != DBNull.Value) || Direction == ParameterDirection.Output)
                && size > 0
            )
                this.sizeSet = true;
        ...
        internal void Bind(OciStatementHandle statement, OracleConnection con, uint pos)
        {
            ...
            if (
                direction == ParameterDirection.Input || direction == ParameterDirection.InputOutput
            )
            {
                if (v == null)
                    isnull = true;
                ...
                switch (ociType)
                {
                    ...
                    case OciDataType.OciString:
                        ...
                        )
                        {
                            ...
                            rsize = 0;
                            // Get size of buffer
                            status = OciCalls.OCIUnicodeToCharSet(
                                statement.Parent,
                                null,
                                svalue,
                                out rsize
                            ...
                            else
                            {
                                ...
                                else if (v is OracleDateTime)
                                {
                                    ...
                                    throw new NotImplementedException(
                                        "For OracleType.DateTime, data type not implemented: "
                                            + v.GetType().ToString()
                                            + "."
                                    );
                    ...
                    case OciDataType.TimeStamp:
                        ...
                        )
                        {
                            ...
                            else if (v is OracleDateTime)
                            {
                                ...
                                throw new NotImplementedException(
                                    "For OracleType.Timestamp, data type not implemented: "
                                        + v.GetType().ToString()
                                ); // ?
                    ...
                    case OciDataType.Number:
                        ...
                        )
                        {
                            ...
                            if (v is IFormattable)
                                svalue = ((IFormattable)v).ToString(
                                    null,
                                    con.SessionFormatProvider
                                );
                    ...
                    case OciDataType.Clob:
                        ...
                        else if (direction == ParameterDirection.InputOutput)
                        {
                            ...
                            throw new NotImplementedException(
                                "Parameters of OracleType.Clob with direction of InputOutput are not supported."
                            );
                        }
                        else
                        {
                            ...
                            bindSize = -1;
                            lobLocator = (OciLobLocator)
                                connection.Environment.Allocate(OciHandleType.LobLocator);
                            if (lobLocator == null)
                            {
                                OciErrorInfo info = connection.ErrorHandle.HandleError();
                                throw new OracleException(info.ErrorCode, info.ErrorMessage);
                    ...
                    case OciDataType.Blob:
                        if (direction == ParameterDirection.Input)
                        {
                            ...
                            else if (v is OracleLob)
                            {
                                ...
                                if (lob.LobType == OracleType.Blob)
                                {
                                    ...
                                    throw new NotImplementedException(
                                        "For OracleType.Blob, data type OracleLob of LobType Clob/NClob is not implemented."
                                    );
                            }
                            else
                                throw new NotImplementedException(
                                    "For OracleType.Blob, data type not implemented: "
                                        + v.GetType().ToString()
                                ); // ?
                        }
                        else if (direction == ParameterDirection.InputOutput)
                        {
                            // not the exact error that .net 2.0 throws, but this is better
                            throw new NotImplementedException(
                                "Parameters of OracleType.Blob with direction of InputOutput are not supported."
                            );
                        }
                        else
                        {
                    ...
                    case OciDataType.RowIdDescriptor:
                        ...
                        )
                        {
                            ...
                            throw new NotImplementedException(
                                "data type RowIdDescriptor as Intput parameters"
                            );
                        break;
                    case OciDataType.RSet: // REF CURSOR
                        ...
                        )
                        {
                            ...
                            {
                                OciCalls.OCIHandleFree(cursor, OciHandleType.Statement);
                                cursor = IntPtr.Zero;
                            }
                            OciCalls.OCIHandleAlloc(
                            ...
                            throw new NotImplementedException(
                                "data type Ref Cursor not implemented for Input parameters"
                            );
                        break;
                    default:
                        throw new NotImplementedException(
                            "Data Type not implemented: " + ociType.ToString() + "."
                        );
                }
            }
            ...
            if (useRef == true)
            {
                ...
                {
                    bindValue = dateTimeDesc.Handle;
                    status = OciCalls.OCIBindByNameRef(
                        statement,
                        out tmpHandle,
                        connection.ErrorHandle,
                        ParameterName,
            ...
            {
                status = OciCalls.OCIBindByNameBytes(
                    statement,
                    out tmpHandle,
                    connection.ErrorHandle,
                    ParameterName,
        ...
        {
            string exception = String.Format(
                "No mapping exists from DbType {0} to a known OracleType.",
                type
            );
            switch (type)
            {
        ...
        private void SetOracleType(OracleType type, bool inferring)
        {
            ...
            string exception = String.Format(
                "No mapping exists from OracleType {0} to a known DbType.",
                type
            );
            switch (type)
            {
        ...
        private void GetOutValue(OracleCommand cmd)
        {
            ...
            switch (ociType)
            {
                ...
                case OciDataType.Float:
                    ...
                    if (ret.Length > 0)
                    {
                        switch (dbType)
                        {
                            case DbType.UInt16:
                                value = UInt16.Parse(
                                    ret.ToString(),
                                    cmd.Connection.SessionFormatProvider
                                );
                                break;
                            case DbType.UInt32:
                                value = UInt32.Parse(
                    ...
                    break;
                case OciDataType.TimeStamp:
                    value = dateTimeDesc.GetDateTime(
                        connection.Environment,
                        dateTimeDesc.ErrorHandle
                    );
                    break;
                case OciDataType.Date:
                ...
                case OciDataType.RSet: // REF CURSOR
                    ...
                    value = new OracleDataReader(
                        cursorStatement.Command,
                        cursorStatement,
                        true,
        ...
        {
            OciStatementHandle cursorStatement = new OciStatementHandle(
                cmd.Connection.ServiceContext,
                cursor
            );
