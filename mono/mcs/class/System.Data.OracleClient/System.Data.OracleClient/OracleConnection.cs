...
//#endif
{
    ...
    public sealed class OracleConnection : Common.DbConnection, ICloneable
    {
        ...
        [Editor(
            "Microsoft.VSDesigner.Data.Oracle.Design.OracleConnectionStringEditor, "
        ...
        public override string ConnectionString
        {
            ...
            set { SetConnectionString(value, false); }
        }
        ...
        internal string GetNlsInfo(OciHandle handle, uint bufflen, OciNlsServiceType item)
        {
            ...
            OciCalls.OCINlsGetInfo(handle, ErrorHandle, ref buffer, bufflen, (ushort)item);
        ...
        internal IFormatProvider SessionFormatProvider
        {
            get
            {
                if (format_info == null && state == ConnectionState.Open)
                {
                    ...
                    numberFormatInfo.NumberGroupSeparator = GetNlsInfo(
                        Session,
                        (uint)OciNlsServiceType.MAXBUFSZ,
                        OciNlsServiceType.GROUP
                    );
                    numberFormatInfo.NumberDecimalSeparator = GetNlsInfo(
                        Session,
                        (uint)OciNlsServiceType.MAXBUFSZ,
                        OciNlsServiceType.DECIMAL
                    );
                    numberFormatInfo.CurrencyGroupSeparator = GetNlsInfo(
                        Session,
                        (uint)OciNlsServiceType.MAXBUFSZ,
                        OciNlsServiceType.MONGROUP
                    );
                    numberFormatInfo.CurrencyDecimalSeparator = GetNlsInfo(
                        Session,
                        (uint)OciNlsServiceType.MAXBUFSZ,
                        OciNlsServiceType.MONDECIMAL
                    );
                        ...
                        if (!inDQuote && !inQuote)
                        {
                            if (name != String.Empty && name != null)
                            {
                                ...
                                if (name.Equals("PASSWORD") || name.Equals("PWD"))
                                {
                                    ...
                                    {
                                        part3 = conString.Substring(
                                            nFinish,
                                            conString.Length - nFinish
                                        );
                                        if (part3[0] == ';')
                ...
                switch (name)
                {
                    ...
                    default:
                        throw new ArgumentException(
                            "Connection parameter not supported: '" + name + "'"
                        );
                }
            }
        }
        ...
        DataTable GetSchemaRestrictions()
        {
            ...
            dt.LoadDataRow(
                new object[] { "Columns", "Column", "COLUMNNAME", "COLUMN_NAME", 3 },
                true
            );
            ...
            dt.LoadDataRow(
                new object[] { "Synonyms", "Synonym", "SYNONYMNAME", "SYNONYM_NAME", 2 },
                true
            );
            dt.LoadDataRow(
                new object[] { "Sequences", "Owner", "OWNER", "SEQUENCE_OWNER", 1 },
                true
            );
            dt.LoadDataRow(
                new object[] { "Sequences", "Sequence", "SEQUENCE", "SEQUENCE_NAME", 2 },
                true
            );
            dt.LoadDataRow(
                new object[] { "ProcedureParameters", "Owner", "OWNER", "OWNER", 1 },
                true
            );
            dt.LoadDataRow(
                new object[]
            ...
            dt.LoadDataRow(
                new object[] { "IndexColumns", "Owner", "OWNER", "INDEX_OWNER", 1 },
                true
            );
            dt.LoadDataRow(new object[] { "IndexColumns", "Name", "NAME", "INDEX_NAME", 2 }, true);
            dt.LoadDataRow(
                new object[] { "IndexColumns", "TableOwner", "TABLEOWNER", "TABLE_OWNER", 3 },
                true
            );
            dt.LoadDataRow(
                new object[] { "IndexColumns", "TableName", "TABLENAME", "TABLE_NAME", 4 },
                true
            );
            dt.LoadDataRow(
                new object[] { "IndexColumns", "Column", "COLUMNNAME", "COLUMN_NAME", 5 },
                true
            );
            dt.LoadDataRow(new object[] { "Indexes", "Owner", "OWNER", "OWNER", 1 }, true);
            dt.LoadDataRow(new object[] { "Indexes", "Name", "NAME", "INDEX_NAME", 2 }, true);
            dt.LoadDataRow(
                new object[] { "Indexes", "TableOwner", "TABLEOWNER", "TABLE_OWNER", 3 },
                true
            );
            dt.LoadDataRow(
                new object[] { "Indexes", "TableName", "TABLENAME", "TABLE_NAME", 4 },
                true
            );
            dt.LoadDataRow(new object[] { "Packages", "Owner", "OWNER", "OWNER", 1 }, true);
            dt.LoadDataRow(
                new object[] { "Packages", "Name", "PACKAGENAME", "OBJECT_NAME", 2 },
                true
            );
            dt.LoadDataRow(new object[] { "PackageBodies", "Owner", "OWNER", "OWNER", 1 }, true);
            dt.LoadDataRow(
                new object[] { "PackageBodies", "Name", "NAME", "OBJECT_NAME", 2 },
                true
            );
            dt.LoadDataRow(new object[] { "Arguments", "Owner", "OWNER", "OWNER", 1 }, true);
            dt.LoadDataRow(
                new object[] { "Arguments", "PackageName", "PACKAGENAME", "PACKAGE_NAME", 2 },
                true
            );
            dt.LoadDataRow(
                new object[] { "Arguments", "ObjectName", "OBJECTNAME", "OBJECT_NAME", 3 },
                true
            );
            dt.LoadDataRow(
                new object[] { "Arguments", "ArgumentName", "ARGUMENTNAME", "ARGUMENT_NAME", 4 },
                true
            );
            ...
            dt.LoadDataRow(
                new object[] { "UniqueKeys", "Table_Name", "TABLENAME", "TABLE_NAME", 2 },
                true
            );
            dt.LoadDataRow(
                new object[]
            ...
            dt.LoadDataRow(
                new object[] { "PrimaryKeys", "Table_Name", "TABLENAME", "TABLE_NAME", 2 },
                true
            );
            dt.LoadDataRow(
                new object[]
            ...
            dt.LoadDataRow(
                new object[] { "ForeignKeys", "Foreign_Key_Owner", "OWNER", "FKCON.OWNER", 1 },
                true
            );
            dt.LoadDataRow(
                new object[]
            ...
            dt.LoadDataRow(
                new object[] { "ForeignKeyColumns", "Owner", "OWNER", "FKCOLS.OWNER", 1 },
                true
            );
            dt.LoadDataRow(
                new object[]
        ...
        DataTable GetSchemaTables(string[] restrictionValues)
        {
            ...
            cmd.CommandText =
                "SELECT OWNER, TABLE_NAME, DECODE(OWNER, 'SYS', 'System', 'User') AS TYPE "
                + " FROM SYS.ALL_TABLES "
        ...
        DataTable GetSchemaColumns(string[] restrictionValues)
        {
            ...
            cmd.CommandText =
                "SELECT OWNER, TABLE_NAME, COLUMN_NAME, COLUMN_ID AS ID, DATA_TYPE AS DATATYPE, "
        ...
        DataTable GetSchemaUsers(string[] restrictionValues)
        {
            ...
            cmd.CommandText =
                "SELECT USERNAME AS NAME, USER_ID AS ID, CREATED AS CREATEDATE "
                + " FROM SYS.ALL_USERS "
