...
namespace System.Data.OracleClient.Oci
{
    internal sealed class OciGlue
    {
        ...
        {
            environment = new OciEnvironmentHandle(
                OciEnvironmentMode.Threaded | OciEnvironmentMode.NoUserCallback
            );
        ...
        {
            OciStatementHandle statement = (OciStatementHandle)
                environment.Allocate(OciHandleType.Statement);
            if (statement == null)
            {
                OciErrorInfo info = environment.HandleError();
                throw new OracleException(info.ErrorCode, info.ErrorMessage);
        ...
        {
            OciTransactionHandle transaction = (OciTransactionHandle)
                environment.Allocate(OciHandleType.Transaction);
            if (transaction == null)
            {
                OciErrorInfo info = environment.HandleError();
                throw new OracleException(info.ErrorCode, info.ErrorMessage);
