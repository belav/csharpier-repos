...
namespace Client.EvalServiceReference
{
            ...
            System.ComponentModel.INotifyPropertyChanged
    {
        ...
        private System.Collections.Generic.Dictionary<
            string,
            Client.EvalServiceReference.EvalItem
        > itemsMapField;
        ...
        {
            get { return this.itemsListField; }
            set
            {
    ...
    public interface IEvalServiceChannel
        : Client.EvalServiceReference.IEvalService,
            System.ServiceModel.IClientChannel { }

    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    partial public class EvalServiceClient
        : System.ServiceModel.ClientBase<Client.EvalServiceReference.IEvalService>,
            Client.EvalServiceReference.IEvalService
    {
...
namespace MonoTests.System.Runtime.Serialization
{
    ...
    public class SerializeNullableWithDictionaryTest
    {
        ...
        public void TestNullableWithDictionary()
        {
            ...
            Assert.AreEqual(
                evalItem.ItemTime,
                DateTime.Parse("2012-03-04T04:04:00"),
                "evalItem.ItemTime missmatch"
            );
            Assert.AreEqual(
                evalItem.etype,
                Client.EvalServiceReference.EvalType.COMPLEX,
                "evalItem.etype missmatch"
            );
            ...
            Assert.AreEqual(
                evalItem3.etype,
                Client.EvalServiceReference.EvalType.NONE,
                "evalItem3.etype missmatch"
            );
            ...
            Assert.AreEqual(
                eval2Item.ItemTime,
                DateTime.Parse("2012-03-04T04:04:00"),
                "eval2Item.ItemTime missmatch"
            );
            Assert.AreEqual(
                eval2Item.etype,
                Client.EvalServiceReference.EvalType.COMPLEX,
                "eval2Item.etype missmatch"
            );
