...
namespace System.Runtime.Serialization
{
    partial class SR
    {
        public const string ArrayExceededSize =
        ...
        public const string CannotSerializeObjectWithCycles =
        ...
        public const string DcTypeNotFoundOnSerialize =
        ...
        public const string DcTypeNotResolvedOnDeserialize =
        ...
        public const string DeserializedObjectWithIdNotFound =
            "Deserialized object with reference id '{0}' not found in stream.";
        public const string DupContractInKnownTypes =
        ...
        public const string DupKeyValueName =
        ...
        public const string DupEnumMemberValue =
        ...
        public const string DupMemberName =
        ...
        public const string ErrorWriteEndObject =
            "There was an error writing end element of object {0}. {1}";
        public const string ErrorWriteStartObject =
            "There was an error writing start element of object {0}. {1}";
        public const string ExceededMaxItemsQuota =
        ...
        public const string ExpectingElementAtDeserialize =
        ...
        public const string GenericNameBraceMismatch =
        ...
        public const string GenericParameterNotValid =
        ...
        public const string InconsistentIsReference =
        ...
        public const string InvalidCollectionDataContract =
        ...
        public const string InvalidEnumValueOnWrite =
        ...
        public const string InvalidNonNullReturnValueByIsAny =
            "Method '{0}.{1}()' returns a non-null value. The return value must be null since IsAny=true.";
        public const string InvalidPrimitiveType = "Type '{0}' is not a valid serializable type.";
        public const string InvalidReturnTypeOnGetSchemaMethod =
            "Method '{0}.{1}()' returns '{2}'. The return type must be compatible with '{3}'.";
        public const string InvalidSizeDefinition =
            "Invalid Size '{0}'. Must be non-negative integer.";
        public const string InvalidXmlDataContractName =
        ...
        public const string InvalidXsRefDefinition =
            "Invalid Ref '{0}'. Must not be null or empty.";
        public const string IsAnyCannotBeNull =
        ...
        public const string IsAnyCannotHaveXmlRoot =
        ...
        public const string IsNotAssignableFrom =
            "An internal error has occurred. '{0}' is not assignable from '{1}' - error generating code for serialization.";
        public const string IsRequiredDataMemberOnIsReferenceDataContractType =
        ...
        public const string IXmlSerializableCannotHaveCollectionDataContract =
            "Type '{0}' cannot be IXmlSerializable and have CollectionDataContractAttribute attribute.";
        public const string IXmlSerializableCannotHaveDataContract =
            "Type '{0}' cannot be IXmlSerializable and have DataContractAttribute attribute.";
        public const string IXmlSerializableIllegalOperation =
            "This method cannot be called from IXmlSerializable implementations.";
        public const string IXmlSerializableMissingEndElements =
        ...
        public const string IXmlSerializableMustHaveDefaultConstructor =
            "IXmlSerializable Type '{0}' must have default constructor.";
        public const string IXmlSerializableWritePastSubTree =
        ...
        public const string KnownTypeAttributeEmptyString =
            "Method name specified by KnownTypeAttribute attribute on type '{0}' cannot be the empty string.";
        public const string KnownTypeAttributeUnknownMethod =
        ...
        public const string KnownTypeAttributeReturnType =
        ...
        public const string KnownTypeAttributeOneScheme =
        ...
        public const string KnownTypeAttributeNoType =
            "KnownTypeAttribute attribute on type '{0}' contains no Type.";
        public const string KnownTypeConfigClosedGenericDeclared =
            "Declared type '{0}' in config cannot be a closed or partial generic type.";
        public const string KnownTypeAttributeValidMethodTypes =
            "Method specified by KnownTypeAttribute attribute on type '{0}' does not expose valid types.";
        public const string KnownTypeAttributeNoData =
            "KnownTypeAttribute attribute on type '{0}' contains no data.";
        public const string KnownTypeAttributeMethodNull =
            "Method specified by KnownTypeAttribute attribute on type '{0}' returned null.";
        public const string MaxArrayLengthExceeded =
            "The maximum array length ({0}) has been exceeded while reading XML data for array of type '{1}'.";
        public const string MissingGetSchemaMethod =
        ...
        public const string MultipleIdDefinition =
        ...
        public const string NoGetMethodForProperty =
            "No get method for property '{1}' in type '{0}'.";
        public const string NoSetMethodForProperty =
            "No set method for property '{1}' in type '{0}'.";
        public const string NullKnownType =
        ...
        public const string NullValueReturnedForGetOnlyCollection =
            "The get-only collection of type '{0}' returned a null value.  The input stream contains collection items which cannot be added if the instance is null.  Consider initializing the collection either in the constructor of the the object or in the getter.";
        public const string ObjectTableOverflow =
        ...
        public const string PartialTrustCollectionContractNoPublicConstructor =
        ...
        public const string PartialTrustCollectionContractTypeNotPublic =
            "The collection data contract type '{0}' cannot be deserialized because it does not have a public parameterless constructor. Adding a public parameterless constructor will fix this error. Alternatively, you can make it internal, and use the InternalsVisibleToAttribute attribute on your assembly in order to enable serialization of internal members - see documentation for more details. Be aware that doing so has certain security implications.";
        public const string PartialTrustDataContractOnSerializingNotPublic =
        ...
        public const string PartialTrustDataContractOnDeserializingNotPublic =
        ...
        public const string PartialTrustDataContractFieldGetNotPublic =
            "The data contract type '{0}' cannot be serialized because the member '{1}' is not public. Making the member public will fix this error. Alternatively, you can make it internal, and use the InternalsVisibleToAttribute attribute on your assembly in order to enable serialization of internal members - see documentation for more details. Be aware that doing so has certain security implications.";
        public const string PartialTrustDataContractFieldSetNotPublic =
        ...
        public const string PartialTrustDataContractTypeNotPublic =
        ...
        public const string PartialTrustIXmlSerialzableNoPublicConstructor =
        ...
        public const string NonAttributedSerializableTypesMustHaveDefaultConstructor =
        ...
        public const string GetOnlyCollectionsNotSupported =
            "Get-only collection properties are not supported.  Consider adding a public setter to property '{0}.{1}' or marking the it with the IgnoreDataMemberAttribute.";
        ...
        public const string QuotaCopyReadOnly =
            "Cannot copy XmlDictionaryReaderQuotas. Target is readonly.";
        public const string RequiredMemberMustBeEmitted =
        ...
        public const string SupportForMultidimensionalArraysNotPresent =
            "Multi-dimensional arrays are not supported.";
        public const string TooManyCollectionContracts =
            "Type '{0}' has more than one CollectionDataContractAttribute attribute.";
        public const string TooManyDataContracts =
            "Type '{0}' has more than one DataContractAttribute attribute.";
        public const string TooManyDataMembers =
            "Member '{0}.{1}' has more than one DataMemberAttribute attribute.";
        public const string TooManyEnumMembers =
            "Member '{0}.{1}' has more than one EnumMemberAttribute attribute.";
        public const string TooManyIgnoreDataMemberAttributes =
            "Member '{0}.{1}' has more than one IgnoreDataMemberAttribute attribute.";
        public const string TypeMustBeConcrete =
            "Error while getting known types for Type '{0}'. The type must not be an open or partial generic class.";
        public const string TypeNotSerializable =
        ...
        public const string UnexpectedContractType =
            "An internal error has occurred. Unexpected contract type '{0}' for type '{1}' encountered.";
        public const string UnexpectedElementExpectingElements =
        ...
        public const string UnsupportedIDictionaryAsDataMemberType =
            "Cannot deserialize one of the DataMember because it is an IDictionary. Use IDictionary<K,V> instead.";
        public const string ValueMustBeNonNegative =
            "The value of this argument must be non-negative.";
        public const string ValueTypeCannotBeNull = "ValueType '{0}' cannot be null.";
        public const string ValueTypeCannotHaveBaseType =
        ...
        public const string XmlArrayTooSmallInput =
        ...
        public const string XmlEndElementExpected =
        ...
        public const string XmlExpectedEncoding =
        ...
        public const string XmlInvalidCommentChars =
            "XML comments cannot contain '--' or end with '-'.";
        public const string XmlInvalidDeclaration =
        ...
        public const string XmlInvalidFFFE =
        ...
        public const string XmlInvalidPrefixState =
        ...
        public const string XmlInvalidStandalone =
        ...
        public const string XmlInvalidWriteState =
        ...
        public const string XmlInvalidXmlSpace =
        ...
        public const string XmlMaxArrayLengthExceeded =
        ...
        public const string XmlMaxNameTableCharCountExceeded =
        ...
        public const string XmlMethodNotSupported =
            "This XmlWriter implementation does not support the '{0}' method.";
        public const string XmlMissingLowSurrogate =
        ...
        public const string XmlOnlyWhitespace =
            "Only white space characters can be written with this method.";
        public const string XmlOnlySingleValue =
            "Only a single typed value may be written inside an attribute or content.";
        public const string XmlPrefixBoundToNamespace =
            "The prefix '{0}' is bound to the namespace '{1}' and cannot be changed to '{2}'.";
        public const string XmlProcessingInstructionNotSupported =
            "Processing instructions (other than the XML declaration) and DTDs are not supported.";
        public const string XmlReservedPrefix =
            "Prefixes beginning with \"xml\" (regardless of casing) are reserved for use by XML.";
        public const string XmlSpaceBetweenAttributes =
            "Whitespace must appear between attributes.";
        public const string XmlSpecificBindingNamespace =
            "The namespace '{1}' can only be bound to the prefix '{0}'.";
        public const string XmlSpecificBindingPrefix =
            "The prefix '{0}' can only be bound to the namespace '{1}'.";
        public const string XmlStartElementLocalNameNsExpected =
            "Start element '{0}' from namespace '{1}' expected. Found {2}.";
        public const string XmlStartElementNameExpected =
            "Start element '{0}' expected. Found {1}.";
        public const string XmlTagMismatch =
        ...
        public const string XmlUnexpectedEndOfFile =
