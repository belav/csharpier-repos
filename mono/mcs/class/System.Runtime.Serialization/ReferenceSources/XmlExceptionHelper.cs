...
namespace System.Xml
{
    static class XmlExceptionHelper
    {
        ...
        public static void ThrowStartElementExpected(XmlDictionaryReader reader, string name)
        {
            ThrowXmlException(
                reader,
                SR_.XmlStartElementNameExpected,
                name,
        ...
        )
        {
            ThrowXmlException(
                reader,
                SR_.XmlStartElementLocalNameNsExpected,
                localName,
                ns,
                GetWhatWasFound(reader)
            );
        ...
        public static void ThrowFullStartElementExpected(XmlDictionaryReader reader, string name)
        {
            ThrowXmlException(
                reader,
                SR_.XmlFullStartElementNameExpected,
                name,
                GetWhatWasFound(reader)
            );
        }
        ...
        )
        {
            ThrowXmlException(
                reader,
                SR_.XmlFullStartElementLocalNameNsExpected,
                localName,
                ns,
                GetWhatWasFound(reader)
            );
        ...
        )
        {
            ThrowXmlException(
                reader,
                SR_.XmlMaxStringContentLengthExceeded,
        ...
        )
        {
            ThrowXmlException(
                reader,
                SR_.XmlMaxArrayLengthOrMaxItemsQuotaExceeded,
        ...
        )
        {
            ThrowXmlException(
                reader,
                SR_.XmlMaxBytesPerReadExceeded,
        ...
        )
        {
            ThrowXmlException(
                reader,
                SR_.XmlMaxNameTableCharCountExceeded,
        ...
        public static void ThrowXmlDictionaryStringIDOutOfRange(XmlDictionaryReader reader)
        {
            ThrowXmlException(
                reader,
                SR_.XmlDictionaryStringIDRange,
        ...
        )
        {
            ThrowXmlException(
                reader,
                SR_.XmlDictionaryStringIDUndefinedStatic,
        ...
        )
        {
            ThrowXmlException(
                reader,
                SR_.XmlDictionaryStringIDUndefinedSession,
                key.ToString(NumberFormatInfo.CurrentInfo)
            );
        }
        ...
        )
        {
            return new XmlException(
                SR_.GetString(SR_.XmlInvalidConversion, value, type),
                exception
            );
        }
