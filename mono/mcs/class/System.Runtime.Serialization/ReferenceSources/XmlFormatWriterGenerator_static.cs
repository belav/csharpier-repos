...
namespace System.Runtime.Serialization
{
    internal partial class XmlFormatWriterGenerator
    {
        partial class CriticalHelper
        {
            ...
            {
                return (
                    XmlWriterDelegator xw,
                    object obj,
                    XmlObjectSerializerWriteContext ctx,
            ...
            )
            {
                return (
                    ...
                    new XmlFormatWriterInterpreter(collectionContract).WriteCollectionToXml(
                        xw,
                        obj,
                        ctx,
                        ctr
    ...
    class XmlFormatWriterInterpreter
    {
        ...
        void WriteCollection(CollectionDataContract collectionContract)
        {
            ...
            else
            {
                ...
                if (isDictionary)
                {
                    enumerator = new CollectionDataContract.DictionaryEnumerator(
                ...
                if (doWrite)
                {
                    ...
                    )
                    {
                        ...
                        if (classContract.ChildElementNamespaces[i + childElementIndex] != null)
                            writer.WriteNamespaceDecl(
                                childElementNamespaces[i + childElementIndex]
                            );
                        if (memberValue == null)
                            memberValue = LoadMemberValue(member);
        ...
        void WriteStartElement(
            Type type,
            XmlDictionaryString ns,
            XmlDictionaryString namespaceLocal,
            XmlDictionaryString nameLocal,
            int nameIndex
        )
        {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            {
                                var dataContract = DataContract.GetDataContract(
                                    memberValue.GetType()
                                );
                                ...
                                ctx.InternalSerializeReference(
                                    writer,
                                    memberValue,
                                    false,
                                    false,
        ...
        )
        {
            ...
            if (writeArrayMethod != null)
            {
                typeof(XmlWriterDelegator)
                    ...
                    .Invoke(writer, new object[] { value(), itemName, itemNamespace });
                return true;
            }
            return false;
        }
