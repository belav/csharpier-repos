...
namespace System.Runtime.Serialization.Json
{
        ...
        partial class CriticalHelper
        {
            ...
            )
            {
                return (
                    ...
                    new JsonFormatWriterInterpreter(classContract).WriteToJson(
                        xmlWriter,
                        obj,
                        context,
                        dataContract,
            ...
            )
            {
                return (
                    ...
                    new JsonFormatWriterInterpreter(collectionContract).WriteCollectionToJson(
                        xmlWriter,
                        obj,
                        context,
                        dataContract
    ...
    class JsonFormatWriterInterpreter
    {
        ...
        )
        {
            ...
            if (classContract.IsReadOnlyContract)
            {
                DataContract.ThrowInvalidDataContractException(
                    classContract.SerializationExceptionMessage,
                    null
                );
            }
        ...
        public void WriteCollectionToJson(
            XmlWriterDelegator xmlWriter,
            object obj,
            XmlObjectSerializerWriteContextComplexJson context,
            CollectionDataContract dataContract
        )
        {
            ...
            {
                DataContract.ThrowInvalidDataContractException(
                    collectionContract.SerializationExceptionMessage,
                    null
                );
            }
        ...
        )
        {
            ...
            if (classContract.OnSerializing != null)
            {
                classContract
                    .OnSerializing
                    .Invoke(objSerialized, new object[] { context.GetStreamingContext() });
            }
        }
        ...
        void WriteCollection(CollectionDataContract collectionContract)
        {
            ...
            if (collectionContract.Kind == CollectionKind.Array)
            {
                ...
                if (objLocal.GetType().GetElementType() != itemType)
                    throw new InvalidCastException(
                        string.Format(
                            "Cannot cast array of {0} to array of {1}",
                            objLocal.GetType().GetElementType(),
                            itemType
                        )
                    );
            ...
            else
            {
                ...
                switch (collectionContract.Kind)
                {
                    ...
                    case CollectionKind.Dictionary:
                        incrementCollectionCountMethod =
                            XmlFormatGeneratorStatics.IncrementCollectionCountMethod;
                        break;
                ...
                if (incrementCollectionCountMethod != null)
                    incrementCollectionCountMethod.Invoke(
                        context,
                        new object[] { writer, objLocal }
                    );
                ...
                var enumerator = (IEnumerator)
                    collectionContract.GetEnumeratorMethod.Invoke(objLocal, new object[0]);
                if (isDictionary)
                {
                ...
                else if (isGenericDictionary)
                {
                    ...
                    enumerator = (IEnumerator)
                        Activator.CreateInstance(enumeratorType, new object[] { enumerator });
                }

                bool canWriteSimpleDictionary = isDictionary || isGenericDictionary;

                bool writeSimpleDictionary =
                    canWriteSimpleDictionary && context.UseSimpleDictionaryFormat;
                PropertyInfo genericDictionaryKeyProperty = null,
                    genericDictionaryValueProperty = null;
                ...
                if (canWriteSimpleDictionary)
                {
                    Type genericDictionaryKeyValueType = Globals
                        .TypeOfKeyValue
                        .MakeGenericType(keyValueTypes);
                    genericDictionaryKeyProperty = genericDictionaryKeyValueType.GetProperty(
                        JsonGlobals.KeyString
                    );
                    genericDictionaryValueProperty = genericDictionaryKeyValueType.GetProperty(
                        JsonGlobals.ValueString
                    );
                }
                ...
                if (writeSimpleDictionary)
                {
                    ...
                    while ((bool)moveNextMethod.Invoke(enumerator, empty_args))
                    {
                        ...
                        value = CodeInterpreter.GetMember(
                            genericDictionaryValueProperty,
                            currentValue
                        );
                ...
                else
                {
                    ...
                    while (enumerator != null && enumerator.MoveNext())
                    {
                        ...
                        )
                        {
                            ...
                            {
                                var jc = JsonDataContract.GetJsonDataContract(
                                    XmlObjectSerializerWriteContextComplexJson.GetRevisedItemContract(
                                ...
                                DataContractJsonSerializer.WriteJsonValue(
                                    ...
                                    currentValue,
                                    context,
                                    currentValue.GetType().TypeHandle
                                );
                            }
                            else
                ...
                if (doWrite)
                {
                    bool requiresNameAttribute =
                        DataContractJsonSerializer.CheckIfXmlNameRequiresMapping(
                            classContract.MemberNames[i]
                        );

                    if (
                        requiresNameAttribute
                        || !TryWritePrimitive(
                            memberType,
                            hasMemberValue ? () => memberValue : (Func<object>)null,
                            member.MemberInfo,
                            null /*arrayItemIndex*/
                            ,
                            null /*nameLocal*/
                    ...
                    )
                    {
                        ...
                        if (requiresNameAttribute)
                            XmlObjectSerializerWriteContextComplexJson.WriteJsonNameWithMapping(
                                writer,
                                memberNames,
                                i + childElementIndex
                            );
        ...
        void WriteValue(Type memberType, object memberValue)
        {
            ...
            if (memberType.IsValueType && !isNullableOfT)
            {
                ...
                if (primitiveContract != null)
                    ...
                    InternalSerialize(
                        XmlFormatGeneratorStatics.InternalSerializeMethod,
                        () => memberValue,
                        memberType,
                        false
                    );
            ...
            else
            {
                bool isNull;
                if (isNullableOfT)
                    memberValue = UnwrapNullableObject(
                        () => memberValue,
                        ref memberType,
                        out isNull
                    ); //Leaves !HasValue on stack
                else
                ...
                else
                {
                    ...
                    )
                    {
                        if (isNullableOfT)
                            ...
                            primitiveContract
                                .XmlFormatContentWriterMethod
                                .Invoke(context, new object[] { writer, memberValue });
                    }
                    else
                    {
                        bool isNull2 = false;
                        ...
                        {
                            var unwrappedMemberValue = CodeInterpreter.ConvertValue(
                                memberValue,
                                memberType.GetType(),
                        ...
                        else
                        {
                            InternalSerialize(
                                (
                                    isNullableOfT
                                        ? XmlFormatGeneratorStatics.InternalSerializeMethod
                                        : XmlFormatGeneratorStatics.InternalSerializeReferenceMethod
                                ),
                                () => memberValue,
                                memberType,
                                false
        ...
        )
        {
            ...
            var isDeclaredType = typeHandleValue.Equals(
                CodeInterpreter.ConvertValue(v, memberType, Globals.TypeOfObject)
            );
            try
            {
                methodInfo.Invoke(
        ...
        )
        {
            ...
            if (writeArrayMethod != null)
            {
                ...
                typeof(JsonWriterDelegator)
                    ...
                    .Invoke(writer, new object[] { value(), itemName, null });
                return true;
            }
            return false;
        }
