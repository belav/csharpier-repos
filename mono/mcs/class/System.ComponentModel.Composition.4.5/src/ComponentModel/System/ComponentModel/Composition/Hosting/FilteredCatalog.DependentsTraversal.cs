...
namespace System.ComponentModel.Composition.Hosting
{
    public partial class FilteredCatalog
    {
        ...
        /// The implementation is optimized for a situation when the traversal is expected to be rather
        // short-lived - that is,
        /// if the chains of dependecies are rather small. To achieve that we do a very minimal structure
        // prep upfront - merely creating a contract-based
        /// index of imports - and the verify the full match of imports during the traversal. Given that
        // most parts have a very few imports this should perform well.
        /// </summary>
