...
namespace System.ComponentModel.Composition.Hosting
{
    public partial class CompositionContainer : ExportProvider, ICompositionService, IDisposable
    {
        ...
        private static ReadOnlyCollection<ExportProvider> EmptyProviders =
            new ReadOnlyCollection<ExportProvider>(new ExportProvider[] { });
        ...
        )
        {
            ...
            if (multiProvider)
            {
                if (catalog != null)
                {
                    this._catalogExportProvider = new CatalogExportProvider(
                        catalog,
                        compositionOptions
                    );
                ...
                if (providers != null && providers.Length > 0)
                {
                    ...
                    this._rootProvider = new AggregateExportProvider(
            ...
            this._providers =
                (providers != null)
                    ? new ReadOnlyCollection<ExportProvider>((ExportProvider[])providers.Clone())
                    : EmptyProviders;
        }
        ...
        public ComposablePartCatalog Catalog
        {
            get
            {
                ...
                return (this._catalogExportProvider != null)
                    ? this._catalogExportProvider.Catalog
                    : null;
            }
        }
