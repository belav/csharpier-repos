    ...
    internal static class InternalSR
    {
        ...
        public static string BufferedOutputStreamQuotaExceeded(int maxSizeQuota)
        {
            return string.Format(
                "Buffered output stream quota exceeded (maxSizeQuota={0})",
                maxSizeQuota
            );
        }
        ...
        public const string BufferIsNotRightSizeForBufferManager =
            "Buffer Is Not Right Size For Buffer Manager";
        ...
        public const string InvalidAsyncResultImplementationGeneric =
            "Invalid Async Result Implementation Generic";
        ...
        public const string ValueCollectionUpdatesNotAllowed =
            "Value Collection Updates Not Allowed";
