...
partial class SR
{
    public const string ADP_CollectionIndexString =
        "An {0} with {1} '{2}' is not contained by this {3}.";
    public const string ADP_CollectionInvalidType =
    ...
    public const string ADP_CollectionRemoveInvalidObject =
        "Attempted to remove an {0} that is not contained by this {1}.";
    public const string ADP_CollectionUniqueValue =
    ...
    public const string ADP_ConnectionStateMsg_Connecting =
    ...
    public const string ADP_ConnectionStateMsg_OpenExecuting =
        "The connection's current state is executing.";
    public const string ADP_ConnectionStateMsg_OpenFetching =
    ...
    public const string ADP_InvalidKey =
    ...
    public const string Xml_InvalidField =
    ...
    public const string Xml_DuplicateConstraint =
    ...
    public const string Xml_MissingTable =
        "Cannot load diffGram. Table '{0}' is missing in the destination dataset.";
    public const string Xml_MissingSQL = "Cannot load diffGram. The 'sql' node is missing.";
    public const string Xml_ColumnConflict =
    ...
    public const string Expr_InvalidString =
        "The expression contains an invalid string constant: {0}.";
    public const string Expr_UndefinedFunction =
    ...
    public const string Expr_MissingRightParen =
    ...
    public const string Expr_UnknownToken1 =
    ...
    public const string Expr_AmbiguousBinop =
    ...
    public const string Expr_InWithoutList =
    ...
    public const string Expr_UnsupportedOperator =
    ...
    public const string Expr_IsSyntax =
    ...
    public const string DataColumn_CannotChangeNamespace =
        "Cannot change the Column '{0}' property Namespace. The Column is SimpleContent.";
    public const string DataColumn_AutoIncrementCannotSetIfHasData =
        "Cannot change AutoIncrement of a DataColumn with type '{0}' once it has data.";
    public const string DataColumn_NotInTheUnderlyingTable =
        "Column '{0}' does not belong to underlying table '{1}'.";
    public const string DataColumn_InvalidDataColumnMapping =
        "DataColumn with type '{0}' is a complexType. Can not serialize value of a complex type as Attribute";
    public const string DataColumn_CannotSetDateTimeModeForNonDateTimeColumns =
        "The DateTimeMode can be set only on DataColumns of type DateTime.";
    public const string DataColumn_DateTimeMode =
        "Cannot change DateTimeMode from '{0}' to '{1}' once the table has data.";
    public const string DataColumn_INullableUDTwithoutStaticNull =
        "Type '{0}' does not contain static Null property or field.";
    public const string DataColumn_UDTImplementsIChangeTrackingButnotIRevertible =
        "Type '{0}' does not implement IRevertibleChangeTracking; therefore can not proceed with RejectChanges().";
    public const string DataColumn_SetAddedAndModifiedCalledOnNonUnchanged =
        "SetAdded and SetModified can only be called on DataRows with Unchanged DataRowState.";
    public const string DataColumn_OrdinalExceedMaximun =
        "Ordinal '{0}' exceeds the maximum number.";
    public const string DataColumn_NullableTypesNotSupported =
        "DataSet does not support System.Nullable<>.";
    public const string DataConstraint_NoName =
    ...
    public const string DataRelation_KeyLengthMismatch =
        "ParentColumns and ChildColumns should be the same length.";
    public const string DataRelation_KeyZeroLength =
        "ParentColumns and ChildColumns must not be zero length.";
    public const string DataRelation_ForeignRow =
        "The row doesn't belong to the same DataSet as this relation.";
    public const string DataRelation_NoName =
    ...
    public const string DataRow_RemovedFromTheTable =
        "This row has been removed from a table and does not have any data.  BeginEdit() will allow creation of new data in this row.";
    public const string DataRow_DeletedRowInaccessible =
    ...
    public const string DataTable_ForeignPrimaryKey =
        "PrimaryKey columns do not belong to this table.";
    public const string DataTable_CannotAddToSimpleContent =
    ...
    public const string DataTable_MultipleSimpleContentColumns =
    ...
    public const string DataTable_CanNotSerializeDataTableHierarchy =
    ...
    public const string DataStorage_ProblematicChars =
        "The DataSet Xml persistency does not support the value '{0}' as Char value, please use Byte storage instead.";
    public const string DataStorage_SetInvalidDataType =
        "Type of value has a mismatch with column type";
    public const string DataStorage_IComparableNotDefined =
    ...
    public const string DataView_InsertExternalObject =
    ...
    public const string DataROWView_PropertyNotFound =
        "{0} is neither a DataColumn nor a DataRelation for table {1}.";
    public const string Range_Argument =
    ...
    public const string SqlConvert_ConvertFailed =
    ...
    public const string DataSet_DefaultDeletedRowInaccessibleException =
        "Deleted rows inaccessible.";
    public const string DataSet_DefaultDuplicateNameException = "Duplicate name not allowed.";
    public const string DataSet_DefaultInRowChangingEventException =
    ...
    public const string DataTableReader_InvalidDataTableReader =
        "DataTableReader is invalid for current DataTable '{0}'.";
    public const string DataTableReader_SchemaInvalidDataTableReader =
        "Schema of current DataTable '{0}' in DataTableReader has changed, DataTableReader is invalid.";
    public const string DataTableReader_CannotCreateDataReaderOnEmptyDataSet =
        "DataTableReader Cannot be created. There is no DataTable in DataSet.";
    public const string DataTableReader_DataTableReaderArgumentIsEmpty =
        "Cannot create DataTableReader. Argument is Empty.";
    public const string DataTableReader_ArgumentContainsNullValue =
        "Cannot create DataTableReader. Arguments contain null value.";
    public const string DataTableReader_InvalidRowInDataTableReader =
        "Current DataRow is either in Deleted or Detached state.";
    public const string DataTableReader_DataTableCleared =
    ...
    public const string DataDom_NotSupport_GetElementById =
        "GetElementById() is not supported on DataDocument.";
    public const string DataDom_NotSupport_EntRef =
        "Cannot create entity references on DataDocument.";
    public const string DataDom_NotSupport_Clear =
    ...
    public const string ADP_NotSupportedEnumerationValue =
        "The {0} enumeration value, {1}, is not supported by the {2} method.";
    public const string ADP_MissingTableSchema =
    ...
    public const string ADP_ConnectionRequired_Insert =
    ...
    public const string ADP_ConnectionRequired_Update =
    ...
    public const string ADP_ConnectionRequired_Delete =
    ...
    public const string ADP_ConnectionRequired_Batch =
        "Update requires a connection object.  The Connection property has not been initialized.";
    public const string ADP_ConnectionRequired_Clone =
    ...
    public const string ADP_OpenConnectionRequired_Insert =
        "Update requires the {0}Command to have an open connection object. {1}";
    public const string ADP_OpenConnectionRequired_Update =
        "Update requires the {0}Command to have an open connection object. {1}";
    public const string ADP_OpenConnectionRequired_Delete =
        "Update requires the {0}Command to have an open connection object. {1}";
    public const string ADP_OpenConnectionRequired_Clone =
        "Update requires the updating command to have an open connection object. {1}";
    public const string ADP_MissingSelectCommand =
    ...
    public const string ADP_FillSchemaRequiresSourceTableName =
        "FillSchema: expected a non-empty string for the SourceTable name.";
    public const string ADP_FillRequiresSourceTableName =
        "Fill: expected a non-empty string for the SourceTable name.";
    public const string ADP_FillChapterAutoIncrement =
        "Hierarchical chapter columns must map to an AutoIncrement DataColumn.";
    public const string ADP_MissingDataReaderFieldType =
        "DataReader.GetFieldType({0}) returned null.";
    public const string ADP_OnlyOneTableForStartRecordOrMaxRecords =
        "Only specify one item in the dataTables array when using non-zero values for startRecords or maxRecords.";
    public const string ADP_UpdateRequiresSourceTable =
        "Update unable to find TableMapping['{0}'] or DataTable '{0}'.";
    public const string ADP_UpdateRequiresSourceTableName =
        "Update: expected a non-empty SourceTable name.";
    public const string ADP_UpdateRequiresCommandClone =
        "Update requires the command clone to be valid.";
    public const string ADP_UpdateRequiresCommandSelect =
    ...
    public const string ADP_UpdateConcurrencyViolation_Update =
        "Concurrency violation: the UpdateCommand affected {0} of the expected {1} records.";
    public const string ADP_UpdateConcurrencyViolation_Delete =
        "Concurrency violation: the DeleteCommand affected {0} of the expected {1} records.";
    public const string ADP_UpdateConcurrencyViolation_Batch =
    ...
    public const string ADP_DynamicSQLJoinUnsupported =
        "Dynamic SQL generation is not supported against multiple base tables.";
    public const string ADP_DynamicSQLNoTableInfo =
        "Dynamic SQL generation is not supported against a SelectCommand that does not return any base table information.";
    public const string ADP_DynamicSQLNoKeyInfoDelete =
        "Dynamic SQL generation for the DeleteCommand is not supported against a SelectCommand that does not return any key column information.";
    public const string ADP_DynamicSQLNoKeyInfoUpdate =
        "Dynamic SQL generation for the UpdateCommand is not supported against a SelectCommand that does not return any key column information.";
    public const string ADP_DynamicSQLNoKeyInfoRowVersionDelete =
    ...
    public const string ADP_DynamicSQLNoKeyInfoRowVersionUpdate =
    ...
    public const string SqlMisc_TimeZoneSpecifiedMessage =
    ...
    public const string SqlMisc_NoBufferMessage =
        "There is no buffer. Read or write operation failed.";
    public const string SqlMisc_BufferInsufficientMessage =
        "The buffer is insufficient. Read or write operation failed.";
    public const string SqlMisc_WriteNonZeroOffsetOnNullMessage =
        "Cannot write to non-zero offset, because current value is Null.";
    public const string SqlMisc_WriteOffsetLargerThanLenMessage =
    ...
    public const string SqlMisc_AlreadyFilledMessage =
        "SQL Type has already been loaded with data.";
    public const string SqlMisc_ClosedXmlReaderMessage =
        "Invalid attempt to access a closed XmlReader.";
    public const string SqlMisc_InvalidOpStreamClosed =
        "Invalid attempt to call {0} when the stream is closed.";
    public const string SqlMisc_InvalidOpStreamNonWritable =
        "Invalid attempt to call {0} when the stream non-writable.";
    public const string SqlMisc_InvalidOpStreamNonReadable =
        "Invalid attempt to call {0} when the stream non-readable.";
    public const string SqlMisc_InvalidOpStreamNonSeekable =
    ...
    public const string ADP_InvalidMaxRecords =
    ...
    public const string ADP_DbProviderFactories_InvariantNameNotFound =
        "The specified invariant name '{0}' wasn't found in the list of registered .NET Data Providers.";
    public const string ADP_DbProviderFactories_NoInstance =
    ...
    public const string ADP_DbProviderFactories_FactoryNotLoadable =
        "The registered .NET Data Provider's DbProviderFactory implementation type '{0}' couldn't be loaded.";
    public const string ADP_DbProviderFactories_NoAssemblyQualifiedName =
        "The missing .NET Data Provider's assembly qualified name is required.";
    public const string ADP_DbProviderFactories_NotAFactoryType =
    ...
    public const string ADP_NoConnectionString =
        "The ConnectionString property has not been initialized.";
    public const string ADP_OpenConnectionPropertySet =
        "Not allowed to change the '{0}' property. {1}";
    public const string ADP_PendingAsyncOperation =
        "Can not start another operation while there is an asynchronous operation pending.";
    public const string ADP_PooledOpenTimeout =
        "Timeout expired.  The timeout period elapsed prior to obtaining a connection from the pool.  This may have occurred because all pooled connections were in use and max pool size was reached.";
    public const string ADP_NonPooledOpenTimeout =
    ...
    public const string ADP_SingleValuedProperty =
        "The only acceptable value for the property '{0}' is '{1}'.";
    public const string ADP_DoubleValuedProperty =
        "The acceptable values for the property '{0}' are '{1}' or '{2}'.";
    public const string ADP_InvalidPrefixSuffix =
    ...
    public const string Arg_RemoveArgNotFound =
        "Cannot remove the specified item because it was not found in the specified Collection.";
    public const string ArgumentOutOfRange_NeedNonNegNum = "Non-negative number required.";
    public const string ADP_DeriveParametersNotSupported =
    ...
    public const string ADP_EmptyDatabaseName =
    ...
    public const string ADP_UnknownDataType =
    ...
    public const string ADP_DbTypeNotSupported =
        "No mapping exists from DbType {0} to a known {1}.";
    public const string ADP_VersionDoesNotSupportDataType =
    ...
    public const string ADP_NegativeParameter =
    ...
    public const string ADP_ParameterConversionFailed =
        "Failed to convert parameter value from a {0} to a {1}.";
    public const string ADP_ParallelTransactionsNotSupported =
    ...
    public const string SQL_InvalidTDSVersion =
    ...
    public const string SQL_SqlServerBrowserNotAccessible =
    ...
    public const string SQL_Timeout =
        "Timeout expired.  The timeout period elapsed prior to completion of the operation or the server is not responding.";
    public const string SQL_Timeout_PreLogin_Begin =
    ...
    public const string SQL_Timeout_PreLogin_InitializeConnection =
    ...
    public const string SQL_Timeout_PreLogin_SendHandshake =
    ...
    public const string SQL_Timeout_PreLogin_ConsumeHandshake =
    ...
    public const string SQL_Timeout_Login_Begin =
    ...
    public const string SQL_Timeout_Login_ProcessConnectionAuth =
    ...
    public const string SQL_Timeout_PostLogin =
    ...
    public const string SQL_Timeout_FailoverInfo =
        "This failure occurred while attempting to connect to the {0} server.";
    public const string SQL_Timeout_RoutingDestinationInfo =
        "This failure occurred while attempting to connect to the routing destination. The duration spent while attempting to connect to the original server was - [Pre-Login] initialization={0}; handshake={1}; [Login] initialization={2}; authentication={3}; [Post-Login] complete={4};  ";
    public const string SQL_Duration_PreLogin_Begin =
        "The duration spent while attempting to connect to this server was - [Pre-Login] initialization={0};";
    public const string SQL_Duration_PreLoginHandshake =
        "The duration spent while attempting to connect to this server was - [Pre-Login] initialization={0}; handshake={1}; ";
    public const string SQL_Duration_Login_Begin =
    ...
    public const string SQL_Duration_Login_ProcessConnectionAuth =
    ...
    public const string SQL_Duration_PostLogin =
    ...
    public const string SQL_UserInstanceFailure =
    ...
    public const string SQL_StreamNotSupportOnColumnType =
    ...
    public const string SQL_TextReaderNotSupportOnColumnType =
    ...
    public const string SQL_BulkLoadInvalidVariantValue =
    ...
    public const string SQL_BulkLoadNoCollation =
    ...
    public const string SQL_ConnectionDoomed =
    ...
    public const string SQL_UnsupportedSysTxVersion =
    ...
    public const string ADP_OperationAbortedExceptionMessage =
        "Operation aborted due to an exception (see InnerException for details).";
    public const string ADP_TransactionCompletedButNotDisposed =
        "The transaction associated with the current connection has completed but has not been disposed.  The transaction must be disposed before the connection can be used to execute SQL statements.";
    public const string SqlParameter_UnsupportedTVPOutputParameter =
    ...
    public const string SqlDependency_NoMatchingServerStart =
    ...
    public const string SqlDependency_NoMatchingServerDatabaseStart =
    ...
    public const string SqlDependency_EventNoDuplicate =
    ...
    public const string SqlDependency_InvalidTimeout =
        "Timeout specified is invalid. Timeout cannot be < 0.";
    public const string SqlDependency_DuplicateStart =
    ...
    public const string SqlMetaData_InvalidSqlDbTypeForConstructorFormat =
        "The dbType {0} is invalid for this constructor.";
    public const string SqlMetaData_NameTooLong = "The name is too long.";
    public const string SqlMetaData_SpecifyBothSortOrderAndOrdinal =
    ...
    public const string SqlProvider_InvalidDataColumnType =
        "The type of column '{0}' is not supported.  The type is '{1}'";
    public const string SqlProvider_NotEnoughColumnsInStructuredType =
        "There are not enough fields in the Structured type.  Structured types must have at least one field.";
    public const string SqlProvider_DuplicateSortOrdinal =
    ...
    public const string SQL_InvalidUdt3PartNameFormat =
        "Invalid 3 part name format for UdtTypeName.";
    public const string IEnumerableOfSqlDataRecordHasNoRows =
    ...
    public const string SNI_ERROR_7 =
    ...
    public const string SNI_ERROR_29 =
    ...
    public const string SNI_ERROR_39 =
    ...
    public const string SNI_ERROR_44 =
    ...
    public const string SNI_ERROR_47 =
    ...
    public const string SNI_ERROR_52 =
    ...
    public const string SNI_ERROR_55 =
    ...
    public const string SNI_ERROR_56 =
    ...
    public const string SNI_ERROR_57 =
    ...
    public const string Snix_Connect =
    ...
    public const string Snix_PreLogin =
        "A connection was successfully established with the server, but then an error occurred during the pre-login handshake.";
    public const string Snix_LoginSspi =
    ...
    public const string SQLCR_AllAttemptsFailed =
    ...
    public const string net_nego_channel_binding_not_supported =
        "No support for channel binding on operating systems other than Windows.";
    public const string net_gssapi_operation_failed_detailed =
        "GSSAPI operation failed with error - {0} ({1}).";
    public const string net_gssapi_operation_failed =
        "GSSAPI operation failed with status: {0} (Minor status: {1}).";
    public const string net_ntlm_not_possible_default_cred =
        "NTLM authentication is not possible with default credentials on this platform.";
    public const string net_nego_not_supported_empty_target_with_defaultcreds =
    ...
    public const string net_nego_protection_level_not_supported =
        "Requested protection level is not supported with the GSSAPI implementation currently installed.";
    public const string net_context_buffer_too_small =
    ...
    public const string PlatformNotSupported_DataSqlClient =
        "System.Data.SqlClient is not supported on this platform.";
    public const string SqlParameter_InvalidTableDerivedPrecisionForTvp =
    ...
    public const string SqlProvider_InvalidDataColumnMaxLength =
        "The size of column '{0}' is not supported. The size is {1}.";
    public const string MDF_InvalidXmlInvalidValue =
        "The metadata XML is invalid. The {1} column of the {0} collection must contain a non-empty string.";
    public const string MDF_CollectionNameISNotUnique =
        "There are multiple collections named '{0}'.";
    public const string MDF_InvalidXmlMissingColumn =
    ...
    public const string MDF_UnsupportedVersion =
        " requested collection ({0}) is not supported by this version of the provider.";
    public const string MDF_MissingRestrictionColumn =
        "One or more of the required columns of the restrictions collection is missing.";
    public const string MDF_MissingRestrictionRow =
        "A restriction exists for which there is no matching row in the restrictions collection.";
    public const string MDF_IncorrectNumberOfDataSourceInformationRows =
        "The DataSourceInformation table must contain exactly one row.";
    public const string MDF_MissingDataSourceInformationColumn =
        "One of the required DataSourceInformation tables columns is missing.";
    public const string MDF_AmbigousCollectionName =
    ...
    public const string MDF_InvalidRestrictionValue =
        "'{2}' is not a valid value for the '{1}' restriction of the '{0}' schema collection.";
    public const string MDF_UndefinedPopulationMechanism =
        "The population mechanism '{0}' is not defined.";
    public const string ODBC_ODBCCommandText =
    ...
    public const string ODBC_NotSupportedEnumerationValue =
    ...
    public const string ADP_NumericToDecimalOverflow =
        "The numerical value is too large to fit into a 96 bit decimal.";
    public const string ADP_DbRecordReadOnly =
        "'{0}' cannot be called when the record is read only.";
    public const string ADP_OffsetOutOfRangeException =
        "Offset must refer to a location within the value.";
    public const string ODBC_GetSchemaRestrictionRequired =
    ...
    public const string ADP_OdbcNoTypesFromProvider =
        "The ODBC provider did not return results from SQLGETTYPEINFO.";
    public const string OdbcConnection_ConnectionStringTooLong =
    ...
    public const string Odbc_CantSetPropertyOnOpenConnection =
        "Can't set property on an open connection.";
    public const string Odbc_NoMappingForSqlTransactionLevel =
        "No valid mapping for a SQL_TRANSACTION '{0}' to a System.Data.IsolationLevel enumeration value.";
    public const string Odbc_CantEnableConnectionpooling =
        "{0} - unable to enable connection pooling...";
    public const string Odbc_CantAllocateEnvironmentHandle =
    ...
    public const string Odbc_OpenConnectionNoOwner =
        "An internal connection does not have an owner.";
    public const string Odbc_PlatformNotSupported =
        "System.Data.ODBC is not supported on this platform.";
    public const string Odbc_UnixOdbcNotFound =
