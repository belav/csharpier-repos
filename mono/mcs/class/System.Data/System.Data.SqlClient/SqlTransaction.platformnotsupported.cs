...
namespace System.Data.SqlClient
{
    public sealed class SqlTransaction : DbTransaction
    {
        const string EXCEPTION_MESSAGE =
            "System.Data.SqlClient.SqlTransaction is not supported on the current platform.";
        ...
        internal void Zombie() => throw new PlatformNotSupportedException(EXCEPTION_MESSAGE);
    }
}
