...
namespace System.Data.SqlClient
{
    public class SqlCommandBuilder : DbCommandBuilder
    {
        const string EXCEPTION_MESSAGE =
            "System.Data.SqlClient.SqlCommandBuilder is not supported on the current platform.";

        public SqlCommandBuilder() => throw new PlatformNotSupportedException(EXCEPTION_MESSAGE);
