...
namespace System.Data.SqlClient
{
    public sealed partial class SqlConnection : DbConnection, ICloneable
    {
        ...
        public string WorkstationId => throw new PlatformNotSupportedException(EXCEPTION_MESSAGE);
        ...
        internal bool IsKatmaiOrNewer => throw new PlatformNotSupportedException(EXCEPTION_MESSAGE);
        ...
        internal int CloseCount => throw new PlatformNotSupportedException(EXCEPTION_MESSAGE);
