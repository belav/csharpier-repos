...
{
    partial public sealed class SqlCommand : DbCommand, ICloneable
    {
        const string EXCEPTION_MESSAGE =
            "System.Data.SqlClient.SqlCommand is not supported on the current platform.";

        internal SqlDependency _sqlDep;
        internal int _rowsAffected = -1;
        internal bool InPrepare => throw new PlatformNotSupportedException(EXCEPTION_MESSAGE);

        public SqlCommand()
            : base() => throw new PlatformNotSupportedException(EXCEPTION_MESSAGE);
        ...
        internal IAsyncResult BeginExecuteReader(
        ...
        internal void OnDoneProc() => throw new PlatformNotSupportedException(EXCEPTION_MESSAGE);
        ...
        internal void CompletePendingReadWithFailure(
            int errorCode,
            bool resetForcePendingReadsToWait
        ) => throw new PlatformNotSupportedException(EXCEPTION_MESSAGE);
#endif
