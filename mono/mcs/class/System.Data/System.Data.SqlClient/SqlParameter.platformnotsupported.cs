...
namespace System.Data.SqlClient
{
    public sealed partial class SqlParameter : DbParameter, IDbDataParameter, ICloneable
    {
        ...
        internal bool IsNull => throw new PlatformNotSupportedException(EXCEPTION_MESSAGE);

        internal int GetActualSize() => throw new PlatformNotSupportedException(EXCEPTION_MESSAGE);
