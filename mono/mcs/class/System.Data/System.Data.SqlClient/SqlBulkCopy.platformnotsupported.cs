...
namespace System.Data.SqlClient
{
    public sealed class SqlBulkCopy : IDisposable
    {
        const string EXCEPTION_MESSAGE =
            "System.Data.SqlClient.SqlBulkCopy is not supported on the current platform.";
        ...
        public SqlBulkCopy(
            ...
            : this(connection) => throw new PlatformNotSupportedException(EXCEPTION_MESSAGE);
        ...
        public SqlBulkCopy(string connectionString, SqlBulkCopyOptions copyOptions)
            : this(connectionString) => throw new PlatformNotSupportedException(EXCEPTION_MESSAGE);
        ...
        public void Close() => throw new PlatformNotSupportedException(EXCEPTION_MESSAGE);
