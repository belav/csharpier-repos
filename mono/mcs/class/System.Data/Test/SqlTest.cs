...
namespace Test.Mono.Data.SqlClient
{
    class SqlTest
    {
        ...
        static void DropTable(IDbConnection cnc)
        {
            ...
            dropCommand.CommandText = "drop table mono_sql_test";
        ...
        static object CallStoredProcedure(IDbConnection cnc)
        {
            ...
            callStoredProcCommand.CommandText = "sp_server_info";
        ...
        static void InsertEdgeCaseData(IDbConnection cnc)
        {
            ...
            insertCommand.CommandText =
                "insert into mono_sql_test (" + "varbinary_value " + ") values (" + "@p20 " + ")";
        ...
        static IDataReader SelectDataUsingCommand(IDbConnection cnc)
        {
            ...
            selectCommand.CommandText = "SET FMTONLY OFF";
        ...
        static object SelectAggregate(IDbConnection cnc, String agg)
        {
            ...
            selectCommand.CommandText = "select " + agg + "from mono_sql_test";
        ...
        static void DoSqlTest(IDbConnection cnc)
        {
            ...
            try
            {
                ...
                Console.WriteLine("Database Server Version: " + ((SqlConnection)cnc).ServerVersion);
