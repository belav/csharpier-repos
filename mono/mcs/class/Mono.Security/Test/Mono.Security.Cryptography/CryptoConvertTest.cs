...
namespace MonoTests.Mono.Security.Cryptography
{
    ...
    public class CryptoConvertTest
    {
        ...
        static string strongNamePublicKeyString =
            "<RSAKeyValue><Modulus>4BJuBsSD00ITyjZPp/wnTeCGa8s0o8/bq8mnSJNJgC1Ey5dhgXykESWP1ynEq2wmSeuxNk1qGi4DvszoQ7YTicQwJQDb/bkIjYF1+uS3mDIHYpnzwYUrchY0HclBk5DFPcSSWnKCpWTnT/VITARpPQ0wuxGRhpCGPNgzKErqfH8=</Modulus><Exponent>AQAB</Exponent></RSAKeyValue>";
        ...
        public void ToCapiKeyBlob_AsymmetricAlgorithm()
        {
            ...
            Assert.AreEqual(
                BitConverter.ToString(strongNamePublicKey, 12),
            ...
            Assert.AreEqual(
                BitConverter.ToString(dsaPubBlob),
                BitConverter.ToString(CryptoConvert.ToCapiKeyBlob(dsa, false)),
                "DSA-PublicKey"
            );
        }
