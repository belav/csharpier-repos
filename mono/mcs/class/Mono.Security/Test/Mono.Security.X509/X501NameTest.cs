    ...
    public class X501NameTest
    {
        ...
        public void FromString_EscapingComma()
        {
            ...
            Assert.AreEqual(
                ...
                Encoding.ASCII.GetString(asn[1][0][1].Value),
                "Value-1"
            );
        ...
        public void FromString_EscapingCarriageReturn()
        {
            ...
            Assert.AreEqual(
                "Before\rAfter",
                Encoding.ASCII.GetString(asn[0][0][1].Value),
                "Value-0"
            );
        ...
        public void T61String()
        {
            ...
            Assert.AreEqual(
                "C=DK, O=Hedeby's Møbelhandel // CVR:13471967, CN=Hedeby's Møbelhandel - Salgsafdelingen, E=vhm@use.test.dk, SERIALNUMBER=CVR:13471967-UID:121212121212",
                X501.ToString(asn),
                "ToString-1"
            );
            Assert.AreEqual(
        ...
        public void ToString_BMPQuoting()
        {
            ...
            ASN1 asn = new ASN1(sn);
            Assert.AreEqual(
                "CN=\"Managed PKCS#7 Test Root Authority\"",
                X501.ToString(asn),
                "ToString-1"
            );
        }
