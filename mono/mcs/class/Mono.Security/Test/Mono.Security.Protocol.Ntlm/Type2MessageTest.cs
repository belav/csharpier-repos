...
namespace MonoTests.Mono.Security.Protocol.Ntlm
{
    ...
    public class Type2MessageTest
    {
        ...
        public void Encode1()
        {
            ...
            msg.Nonce = nonce;
            Assert.AreEqual(
                "4E-54-4C-4D-53-53-50-00-02-00-00-00-00-00-00-00-28-00-00-00-01-82-00-00-53-72-76-4E-6F-6E-63-65-00-00-00-00-00-00-00-00",
        ...
        public void Decode1()
        {
            ...
            Assert.AreEqual(
                BitConverter.ToString(nonce),
                BitConverter.ToString(msg.Nonce),
                "Nonce"
            );
            Assert.AreEqual(2, msg.Type, "Type");
        }
