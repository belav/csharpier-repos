...
public class NpgsqlSslTest
{
    ...
    public static bool Connect(int protocol, bool ssl, int verbose)
    {
        ...
        string cs =
            "Server=127.0.0.1;Port=5432;Protocol={0};User Id=npgsql_tests;Password=npgsql_tests;Database=npgsql_tests;ssl={1}";
    ...
    public static int Main(string[] args)
    {
        ...
        {
            Console.WriteLine(
                "{0} {1}connection established and closed.",
                i,
                (ssl ? "SSL " : String.Empty)
            );
        }
        return err;
    }
