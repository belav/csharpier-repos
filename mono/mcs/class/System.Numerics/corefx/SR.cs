...
partial class SR
{
    ...
    public const string Argument_InvalidHexStyle =
    ...
    public const string Format_TooLarge =
        "The value is too large to be represented by this format specifier.";
    public const string ArgumentOutOfRange_MustBeNonNeg =
    ...
    public const string Arg_ElementsInSourceIsGreaterThanDestination =
        "Number of elements in source vector is greater than the destination array";
    public const string Arg_NullArgumentNullRef =
    ...
    public const string Overflow_Negative_Unsigned =
