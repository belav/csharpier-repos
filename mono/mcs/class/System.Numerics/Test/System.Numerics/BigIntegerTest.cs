...
namespace MonoTests.System.Numerics
{
    ...
    public class BigIntegerTest
    {
        ...
        static byte[][] add_a = new byte[][] { new byte[] { 1 }, new byte[] { 0xFF }, huge_a };

        static byte[][] add_b = new byte[][] { new byte[] { 1 }, new byte[] { 1 }, huge_b };

        static byte[][] add_c = new byte[][] { new byte[] { 2 }, new byte[] { 0 }, huge_add };
        ...
        public void TestLeftShift()
        {
            ...
            Assert.AreEqual(
                new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x0A },
                (new BigInteger(0x0A) << 80).ToByteArray(),
                "#4"
            );
            Assert.AreEqual(
                new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xF6 },
                (new BigInteger(-10) << 80).ToByteArray(),
                "#5"
            );
            Assert.AreEqual(
                new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xFF },
                (new BigInteger(-1) << 80).ToByteArray(),
                "#6"
            );
            Assert.AreEqual(
                new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x70, 0xD9 },
        ...
        {
            Assert.AreEqual(
                new byte[] { 0x16, 0xB0, 0x4C, 0x02 },
                (new BigInteger(1234567899L) >> 5).ToByteArray(),
                "#1"
            );

            Assert.AreEqual(
                new byte[] { 0x2C, 0x93, 0x00 },
            ...
            Assert.AreEqual(
                new byte[] { 0xE9, 0x4F, 0xB3, 0xFD },
                (new BigInteger(-1234567899L) >> 5).ToByteArray(),
                "#4"
            );

            Assert.AreEqual(
                new byte[] { 0xD3, 0x6C, 0xFF },
                (new BigInteger(-1234567899L) >> 15).ToByteArray(),
                "#5"
            );
        ...
        public void TestToStringFmt()
        {
            Assert.AreEqual(
                "123456789123456",
                new BigInteger(123456789123456).ToString("D2"),
                "#1"
            );
            ...
            Assert.AreEqual(
                ...
                BigInteger.Pow(10, 55).ToString("G"),
                "#8"
            );

            Assert.AreEqual(
                "10000000000000000000000000000000000000000000000000000000",
                BigInteger.Pow(10, 55).ToString("R"),
                "#9"
            );
        ...
        public void TestToLongOperator()
        {
            ...
            try
            {
                long v = (long)
                    new BigInteger(
                        new byte[] { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x80, 0x00 }
                    );
                Assert.Fail("#2");
            }
            catch (OverflowException) { }
            ...
            try
            {
                long v = (long)
                    new BigInteger(
                        new byte[] { 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F, 0xFF }
                    );
                Assert.Fail("#3");
            }
            catch (OverflowException) { }
        ...
        public void TestLongCtorToByteArray()
        {
            ...
            Assert.AreEqual(
                new byte[] { 0x04, 0x03, 0x2, 0x01 },
                new BigInteger(0x01020304L).ToByteArray(),
                "#4"
            );
            Assert.AreEqual(
                new byte[] { 0x05, 0x04, 0x03, 0x2, 0x01 },
                new BigInteger(0x0102030405L).ToByteArray(),
                "#5"
            );
            Assert.AreEqual(
                new byte[] { 0x06, 0x05, 0x04, 0x03, 0x2, 0x01 },
                new BigInteger(0x010203040506L).ToByteArray(),
                "#6"
            );
            Assert.AreEqual(
                new byte[] { 0x07, 0x06, 0x05, 0x04, 0x03, 0x2, 0x01 },
                new BigInteger(0x01020304050607L).ToByteArray(),
                "#7"
            );
            Assert.AreEqual(
                new byte[] { 0x08, 0x07, 0x06, 0x05, 0x04, 0x03, 0x2, 0x01 },
            ...
            Assert.AreEqual(
                new byte[] { 0xFD, 0xFD, 0xFE },
                new BigInteger(-0x010203L).ToByteArray(),
                "#3m"
            );
            Assert.AreEqual(
                new byte[] { 0xFC, 0xFC, 0xFD, 0xFE },
                new BigInteger(-0x01020304L).ToByteArray(),
                "#4m"
            );
            Assert.AreEqual(
                new byte[] { 0xFB, 0xFB, 0xFC, 0xFD, 0xFE },
                new BigInteger(-0x0102030405L).ToByteArray(),
                "#5m"
            );
            Assert.AreEqual(
                new byte[] { 0xFA, 0xFA, 0xFB, 0xFC, 0xFD, 0xFE },
                new BigInteger(-0x010203040506L).ToByteArray(),
                "#6m"
            );
            Assert.AreEqual(
                new byte[] { 0xF9, 0xF9, 0xFA, 0xFB, 0xFC, 0xFD, 0xFE },
                new BigInteger(-0x01020304050607L).ToByteArray(),
                "#7m"
            );
            Assert.AreEqual(
                new byte[] { 0xF8, 0xF8, 0xF9, 0xFA, 0xFB, 0xFC, 0xFD, 0xFE },
                new BigInteger(-0x0102030405060708L).ToByteArray(),
                "#8m"
            );
            ...
            Assert.AreEqual(
                new byte[] { 0xFF, 0xFF, 0xFF, 0x7F, 0xFF },
        ...
        public void DoubleConversion()
        {
            ...
            Assert.AreEqual(
                result1,
                (double)new BigInteger(new byte[] { 53, 152, 137, 177, 240, 81, 75, 198 }),
                "#7"
            );
            var result2 = BitConverter.Int64BitsToDouble(4893382453283402035);
            Assert.AreEqual(
                result2,
                (double)new BigInteger(new byte[] { 53, 152, 137, 177, 240, 81, 75, 198, 0 }),
                "#8"
            );
            ...
            Assert.AreEqual(
                result3,
                (double)new BigInteger(new byte[] { 0, 0, 0, 0, 16, 128, 208, 159, 60, 46, 59, 3 }),
                "#9"
            );
            Assert.AreEqual(
                result3,
                (double)new BigInteger(new byte[] { 0, 0, 0, 0, 17, 128, 208, 159, 60, 46, 59, 3 }),
                "#10"
            );
            Assert.AreEqual(
                result3,
                (double)new BigInteger(new byte[] { 0, 0, 0, 0, 24, 128, 208, 159, 60, 46, 59, 3 }),
                "#11"
            );
            Assert.AreEqual(
                result4,
                (double)new BigInteger(new byte[] { 0, 0, 0, 0, 32, 128, 208, 159, 60, 46, 59, 3 }),
                "#12"
            );
            Assert.AreEqual(
                result4,
                (double)new BigInteger(new byte[] { 0, 0, 0, 0, 48, 128, 208, 159, 60, 46, 59, 3 }),
                "#13"
            );
            Assert.AreEqual(
                result5,
                (double)new BigInteger(new byte[] { 0, 0, 0, 0, 64, 128, 208, 159, 60, 46, 59, 3 }),
                "#14"
            );

            Assert.AreEqual(
                BitConverter.Int64BitsToDouble(-2748107935317889142),
                (double)new BigInteger(huge_a),
                "#15"
            );
            Assert.AreEqual(
                BitConverter.Int64BitsToDouble(-2354774254443231289),
                (double)new BigInteger(huge_b),
                "#16"
            );
            Assert.AreEqual(
                BitConverter.Int64BitsToDouble(8737073938546854790),
                (double)new BigInteger(huge_mul),
                "#17"
            );

            Assert.AreEqual(
                BitConverter.Int64BitsToDouble(6912920136897069886),
                (double)(2278888483353476799 * BigInteger.Pow(2, 451)),
                "#18"
            );
            Assert.AreEqual(
                double.PositiveInfinity,
                (double)(843942696292817306 * BigInteger.Pow(2, 965)),
                "#19"
            );
        }
        ...
        public void DecimalConversion()
        {
            ...
            Assert.AreEqual(
                ...
                (decimal)new BigInteger(9999999999999999999999999999m),
                "#7"
            );
        ...
        public void Parse()
        {
            ...
            Assert.AreEqual(
                255,
                (int)BigInteger.Parse("0FF", NumberStyles.AllowHexSpecifier),
                "#17"
            );
            ...
            Assert.AreEqual(
                300000,
                (int)BigInteger.Parse("3E5", NumberStyles.AllowExponent),
                "#20"
            );
            ...
            Assert.AreEqual(
                25,
                (int)BigInteger.Parse("2500E-2", NumberStyles.AllowExponent),
                "#22"
            );

            Assert.AreEqual(
                "136236974127783066520110477975349088954559032721408",
                BigInteger
                    .Parse("136236974127783066520110477975349088954559032721408", NumberStyles.None)
                    .ToString(),
                "#23"
            );
            Assert.AreEqual(
                "136236974127783066520110477975349088954559032721408",
                BigInteger.Parse("136236974127783066520110477975349088954559032721408").ToString(),
                "#24"
            );
        ...
        public void TryParse()
        {
            ...
            Assert.IsTrue(
                BigInteger.TryParse("-10", NumberStyles.AllowLeadingSign, null, out x),
                "#19"
            );
            Assert.AreEqual(-10, (int)x, "#20");
            Assert.IsTrue(
                BigInteger.TryParse("(10)", NumberStyles.AllowParentheses, null, out x),
                "#21"
            );
            Assert.AreEqual(-10, (int)x, "#22");
            Assert.IsTrue(
                BigInteger.TryParse(" 10", NumberStyles.AllowLeadingWhite, null, out x),
                "#23"
            );
            Assert.AreEqual(10, (int)x, "#24");
            Assert.IsTrue(
                BigInteger.TryParse("10 ", NumberStyles.AllowTrailingWhite, null, out x),
                "#25"
            );
            ...
            Assert.IsFalse(
                BigInteger.TryParse("%10", NumberStyles.AllowCurrencySymbol, Nfi, out x),
                "#34"
            );
        }
        ...
        public void LeftShiftByInt()
        {
            ...
            Assert.AreEqual(
                "1982508898476707203664561936971572707328",
                (v << 33).ToString(),
                "#33"
            );
            Assert.AreEqual(
                "3965017796953414407329123873943145414656",
                (v << 34).ToString(),
                "#34"
            );
            Assert.AreEqual(
                "7930035593906828814658247747886290829312",
                (v << 35).ToString(),
                "#35"
            );
            Assert.AreEqual(
                "15860071187813657629316495495772581658624",
                (v << 36).ToString(),
                "#36"
            );
            Assert.AreEqual(
                "31720142375627315258632990991545163317248",
                (v << 37).ToString(),
                "#37"
            );
            Assert.AreEqual(
                "63440284751254630517265981983090326634496",
                (v << 38).ToString(),
                "#38"
            );
            Assert.AreEqual(
                "126880569502509261034531963966180653268992",
                (v << 39).ToString(),
                "#39"
            );
            Assert.AreEqual(
                "253761139005018522069063927932361306537984",
                (v << 40).ToString(),
                "#40"
            );
            Assert.AreEqual(
                "507522278010037044138127855864722613075968",
                (v << 41).ToString(),
                "#41"
            );
            Assert.AreEqual(
                "1015044556020074088276255711729445226151936",
                (v << 42).ToString(),
                "#42"
            );
            Assert.AreEqual(
                "2030089112040148176552511423458890452303872",
                (v << 43).ToString(),
                "#43"
            );
            Assert.AreEqual(
                "4060178224080296353105022846917780904607744",
                (v << 44).ToString(),
                "#44"
            );
            Assert.AreEqual(
                "8120356448160592706210045693835561809215488",
                (v << 45).ToString(),
                "#45"
            );
            Assert.AreEqual(
                "16240712896321185412420091387671123618430976",
                (v << 46).ToString(),
                "#46"
            );
            Assert.AreEqual(
                "32481425792642370824840182775342247236861952",
                (v << 47).ToString(),
                "#47"
            );
            Assert.AreEqual(
                "64962851585284741649680365550684494473723904",
                (v << 48).ToString(),
                "#48"
            );
            Assert.AreEqual(
                "129925703170569483299360731101368988947447808",
                (v << 49).ToString(),
                "#49"
            );
            Assert.AreEqual(
                "259851406341138966598721462202737977894895616",
                (v << 50).ToString(),
                "#50"
            );
            Assert.AreEqual(
                "519702812682277933197442924405475955789791232",
                (v << 51).ToString(),
                "#51"
            );
            Assert.AreEqual(
                "1039405625364555866394885848810951911579582464",
                (v << 52).ToString(),
                "#52"
            );
            Assert.AreEqual(
                "2078811250729111732789771697621903823159164928",
                (v << 53).ToString(),
                "#53"
            );
            Assert.AreEqual(
                "4157622501458223465579543395243807646318329856",
                (v << 54).ToString(),
                "#54"
            );
            Assert.AreEqual(
                "8315245002916446931159086790487615292636659712",
                (v << 55).ToString(),
                "#55"
            );
            Assert.AreEqual(
                "16630490005832893862318173580975230585273319424",
                (v << 56).ToString(),
                "#56"
            );
            Assert.AreEqual(
                "33260980011665787724636347161950461170546638848",
                (v << 57).ToString(),
                "#57"
            );
            Assert.AreEqual(
                "66521960023331575449272694323900922341093277696",
                (v << 58).ToString(),
                "#58"
            );
            Assert.AreEqual(
                "133043920046663150898545388647801844682186555392",
                (v << 59).ToString(),
                "#59"
            );
            Assert.AreEqual(
                "266087840093326301797090777295603689364373110784",
                (v << 60).ToString(),
                "#60"
            );
            Assert.AreEqual(
                "532175680186652603594181554591207378728746221568",
                (v << 61).ToString(),
                "#61"
            );
            Assert.AreEqual(
                "1064351360373305207188363109182414757457492443136",
                (v << 62).ToString(),
                "#62"
            );
            Assert.AreEqual(
                "2128702720746610414376726218364829514914984886272",
                (v << 63).ToString(),
                "#63"
            );
            Assert.AreEqual(
                "4257405441493220828753452436729659029829969772544",
                (v << 64).ToString(),
                "#64"
            );
            Assert.AreEqual(
                "8514810882986441657506904873459318059659939545088",
                (v << 65).ToString(),
                "#65"
            );
            Assert.AreEqual(
                "17029621765972883315013809746918636119319879090176",
                (v << 66).ToString(),
                "#66"
            );
            Assert.AreEqual(
                "34059243531945766630027619493837272238639758180352",
                (v << 67).ToString(),
                "#67"
            );
            Assert.AreEqual(
                "68118487063891533260055238987674544477279516360704",
                (v << 68).ToString(),
                "#68"
            );
            Assert.AreEqual(
        ...
        public void RightShiftByInt()
        {
            ...
            Assert.AreEqual(
                "272473948255566133040220955950698177909118065442816",
                (v >> 0).ToString(),
                "#0"
            );
            Assert.AreEqual(
