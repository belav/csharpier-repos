...
namespace Helper
{
    public class HtmlWriter : HtmlTextWriter
    {
            ...
            : base(writer, tabString)
        {
            ...
            if (file != null && file != "")
            {
                output = new StreamWriter(
                    new FileStream(file, FileMode.OpenOrCreate | FileMode.Append)
                );
        ...
        protected override void AddStyleAttribute(
            string name,
            string value,
        ...
        protected override string EncodeAttributeValue(
            HtmlTextWriterAttribute attrKey,
            string value
        )
        {
            output.WriteLine(
                "{0:###0} EncodeAttributeValue ({1}, {2})",
                NextIndex(),
                attrKey,
                value
            );
        ...
        {
            output.WriteLine(
                "{0:###0} OnStyleAttributeRender ({1}, {2}, {3})",
                NextIndex(),
                name,
                value,
                key
