...
namespace MonoTests.System.Web.Compilation
{
	...
	<option value=""strvalue"">str</option>
        ...
        public void ServerSideControlsInScriptBlock()
        {
            ...
            string renderedHtml = HtmlDiff.GetControlFromPageHtml(pageHtml);
            string originalHtml =
                @"<script type=""text/javascript"">alert (escape(""reporting/location?report=ViewsByDate&minDate=minDate&maxDate=maxDate""));</script>";
            HtmlDiff.AssertAreEqual(originalHtml, renderedHtml, "#A1");
        }
	...
	<![endif]-->";
        ...
        public void EnumConverter_Bug578586()
        {
            ...
            string renderedHtml = HtmlDiff.GetControlFromPageHtml(pageHtml);
            string originalHtml =
                @"<input type=""text"" value=""FlagOne"" name=""test"" id=""test"" />";
...
comment end -->";
        ...
        public void ChildTemplatesTest()
        {
            try
            {
                WebTest.Host.AppDomain.AssemblyResolve += new ResolveEventHandler(
