...
namespace MonoTests.System.Web.Security
{
    ...
    public class MembershipPasswordAttributeTest
    {
        ...
        public void IsValid()
        {
            ...
            Assert.IsTrue(
                passwordAttribute.IsValid(""),
                "sending an empty password password should should be treated as valid"
            );
        }
        ...
        public void IsValid_with_ValidationContext()
        {
            ...
            Assert.IsNull(
                result,
                "sending an empty password password should return a null response"
            );
            ...
            Assert.AreEqual(
                ...
                result,
                "Should suceed with a 7 character length and a single nonalphanumeric"
            );
            ...
            Assert.AreEqual(
                "The 'testDisplay' field is an invalid password. Password must have 4 or more characters.",
                result.ErrorMessage
            );
        }
        ...
        public void MinRequiredPasswordLength()
        {
            ...
            Assert.AreEqual(
                "The 'testDisplay' field is an invalid password. Password must have 7 or more characters.",
                result.ErrorMessage,
                "Error message not correct for lower Min characters"
            );
            Assert.AreEqual(
                _validationContext.MemberName,
                result.MemberNames.FirstOrDefault(),
                "Member name not correct"
            );
            ...
            Assert.AreEqual(
                ValidationResult.Success,
                result,
                "Should suceed with a 6 character length after it's reset"
            );

            result = passwordAttribute.TestValidation("a!123", _validationContext);
            Assert.AreEqual(
                "The 'testDisplay' field is an invalid password. Password must have 6 or more characters.",
                result.ErrorMessage,
                "Error message not correct for Min characters of 6"
            );
            ...
            Assert.AreEqual(
                "There was an error",
                result.ErrorMessage,
                "Error Message wasn't correct without parameters."
            );

            passwordAttribute.MinPasswordLengthError = "There was an error parameter1: {0}";
            result = passwordAttribute.TestValidation("a!13", _validationContext);
            Assert.AreEqual(
                "There was an error parameter1: testDisplay",
                result.ErrorMessage,
                "Error Message wasn't correct with 1 parameter."
            );

            passwordAttribute.MinPasswordLengthError =
                "There was an error parameter1: {0} parameter2: {1}";
            result = passwordAttribute.TestValidation("a!13", _validationContext);
            Assert.AreEqual(
                "There was an error parameter1: testDisplay parameter2: 5",
                result.ErrorMessage,
                "Error Message wasn't correct with 2 parameters."
            );
        }
        ...
        public void MinRequiredNonAlphanumericCharacters()
        {
            ...
            Assert.AreEqual(
                ValidationResult.Success,
                result,
                "Should succeed with the default 1 non alpha numeric"
            );

            result = passwordAttribute.TestValidation("a123456", _validationContext);
            Assert.AreEqual(
                "The 'testDisplay' field is an invalid password. Password must have 1 or more non-alphanumeric characters.",
                result.ErrorMessage,
                "Expected validation to fail without non-alphanumerics"
            );

            passwordAttribute.MinRequiredNonAlphanumericCharacters = 3;
            result = passwordAttribute.TestValidation("a!&12345", _validationContext);
            Assert.AreEqual(
                "The 'testDisplay' field is an invalid password. Password must have 3 or more non-alphanumeric characters.",
                result.ErrorMessage,
                "Expected validation to fail without 3 non-alphanumerics"
            );
            ...
            Assert.AreEqual(
                ValidationResult.Success,
                result,
                "Should succeed with 3 non alpha numerics"
            );
            ...
            Assert.AreEqual(
                ValidationResult.Success,
                result,
                "Should succeed with 0 non alpha numerics"
            );
            ...
            passwordAttribute.MinNonAlphanumericCharactersError =
                "There was an error parameter1: {0}";
            result = passwordAttribute.TestValidation("a123456", _validationContext);
            Assert.AreEqual(
                "There was an error parameter1: testDisplay",
                result.ErrorMessage,
            ...
            result = passwordAttribute.TestValidation("a123456", _validationContext);
            Assert.AreEqual(
                "There was an error parameter1: testDisplay parameter2: 1",
                result.ErrorMessage,
                "Error Message wasn't correct with 2 parameters."
            );
        }
        ...
        public void FormatErrorMessage()
        {
            ...
            Assert.AreEqual(
                "The field testDisplay2 is invalid.",
                passwordAttribute.FormatErrorMessage("testDisplay2")
            );
        }
