...
namespace Test1
{
    ...
    public class Class1
    {
        ...
        {
            string res = new WebTest(PageInvoker.CreateOnLoad(new PageDelegate(_TestStyle))).Run();
        ...
        {
            string str = new WebTest(
                PageInvoker.CreateOnLoad(new PageDelegate(_TestDefaultRender))
            ).Run();
        ...
        public void TestSkin()
        {
            ...
            WebTest.CopyResource(
                GetType(),
                "Test1.Resources.Default.skin",
                "App_Themes/Black/Default.skin"
            );
            WebTest.CopyResource(
                GetType(),
                "Test1.Resources.MyPageWithTheme.aspx",
        ...
        {
            WebTest t = new WebTest(PageInvoker.CreateOnLoad(new PageDelegate(CheckPostRequest)));
