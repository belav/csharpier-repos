...
namespace MonoTests.System.Web.UI
{
    ...
    public class DataBinderTests
    {
        ...
        {
            get { return new TestSuite(typeof(PathTest)); }
        }

        public DataBinderTests()
            : base("MonoTests.System.Web.UI.DataBinderTests testcase") { }

        public DataBinderTests(string name)
            : base(name) { }
        ...
        public void TestEval2()
        {
            ...
            AssertEquals(
                "Eval2 #5",
                DataBinder.Eval(instance, "Another[\"hi there!\"] MS ignores this]"),
                o
            );
    ...
    class ClassInstance
    {
        ...
        public object Prop1
        {
            get { return prefix + "This is Prop1"; }
        }

        public object Prop2
        {
            get { return prefix + "This is Prop2"; }
        }

        public object this[int index]
        {
            get { return prefix + "This is the indexer for int. Index: " + index; }
        }

        public object this[string index]
        {
            get { return prefix + "This is the indexer for string. Index: " + index; }
        }
