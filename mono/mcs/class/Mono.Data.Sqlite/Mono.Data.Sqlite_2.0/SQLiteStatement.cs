            ...
            for (int n = 0; n < x; n++)
            {
                if (
                    String.Compare(
                        ...
                        s,
                        0,
                        Math.Max(_paramNames[n].Length - startAt, s.Length),
                        true,
            ...
            switch (objType)
            {
                ...
                case DbType.DateTime:
                    _sql.Bind_DateTime(
                        this,
                        index,
                        Convert.ToDateTime(obj, CultureInfo.CurrentCulture)
                    );
                    break;
                case DbType.UInt32:
                case DbType.Int64:
                ...
                case DbType.Currency:
                    ...
                    _sql.Bind_Double(
                        this,
                        index,
                        Convert.ToDouble(obj, CultureInfo.CurrentCulture)
                    );
                    break;
                case DbType.Binary:
                ...
                case DbType.Decimal: // Dont store decimal as double ... loses precision
                    _sql.Bind_Text(
                        ...
                        index,
                        Convert
                            .ToDecimal(obj, CultureInfo.CurrentCulture)
