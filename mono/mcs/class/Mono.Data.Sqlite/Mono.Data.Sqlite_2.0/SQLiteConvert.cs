...
namespace Mono.Data.Sqlite
{
    ...
    public abstract class SqliteConvert
    {
        ...
        /// </summary>
        protected static readonly DateTime UnixEpoch = new DateTime(
            1970,
            1,
            1,
            0,
        ...
        public static bool ToBoolean(string source)
        {
            if (String.Compare(source, bool.TrueString, StringComparison.OrdinalIgnoreCase) == 0)
                ...
                String.Compare(source, bool.FalseString, StringComparison.OrdinalIgnoreCase) == 0
            )
                return false;
...
*/
            ...
            )
            {
                ...
                Name.IndexOf("BLOB", StringComparison.OrdinalIgnoreCase) >= 0 /* || Name == string.Empty // handled at the top of this functin */
            )
            {
                return DbType.Object;
            }
            else if (
                Name.IndexOf("REAL", StringComparison.OrdinalIgnoreCase) >= 0
