...
namespace Mono.Data.Sqlite
{
    ...
    public sealed class SqliteCommandBuilder : DbCommandBuilder
    {
        ...
        protected override void SetRowUpdatingHandler(DbDataAdapter adapter)
        {
            ...
            {
                ((SqliteDataAdapter)adapter).RowUpdating -= new EventHandler<RowUpdatingEventArgs>(
        ...
        public override string QuoteIdentifier(string unquotedIdentifier)
        {
            ...
            return QuotePrefix
                + unquotedIdentifier.Replace(QuoteSuffix, QuoteSuffix + QuoteSuffix)
                + QuoteSuffix;
        }
        ...
        public override string UnquoteIdentifier(string quotedIdentifier)
        {
            ...
            if (
                quotedIdentifier.StartsWith(
                    QuotePrefix,
                    StringComparison.InvariantCultureIgnoreCase
                ) == false
                || quotedIdentifier.EndsWith(
                    QuoteSuffix,
                    StringComparison.InvariantCultureIgnoreCase
                ) == false
            )
        ...
        {
            using (
                IDataReader reader = sourceCommand.ExecuteReader(
