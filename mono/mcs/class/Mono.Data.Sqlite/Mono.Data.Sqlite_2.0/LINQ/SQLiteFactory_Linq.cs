...
namespace Mono.Data.Sqlite
{
    ...
    /// </summary>
    public sealed class SqliteFactory : IServiceProvider
    {
        ...
        {
            _dbProviderServicesType = Type.GetType(
        ...
        {
            if (
                serviceType == typeof(ISQLiteSchemaExtensions)
        ...
        private object GetSQLiteProviderServicesInstance()
        {
            if (_sqliteServices == null)
            {
                Type type = Type.GetType(
                    "Mono.Data.Sqlite.SQLiteProviderServices, Mono.Data.Sqlite.Linq, Version=2.0.38.0, Culture=neutral, PublicKeyToken=db937bc2d44ff139",
                    false
                );
                if (type != null)
                {
