    ...
    public sealed class SqliteConnectionStringBuilder : DbConnectionStringBuilder
    {
            ...
            get
            {
                ...
                if (value is string)
                    return (SynchronizationModes)
                        TypeDescriptor
                            .GetConverter(typeof(SynchronizationModes))
                            .ConvertFrom(value);
                else
        ...
        public SQLiteDateFormats DateTimeFormat
        {
            get
            {
                ...
                if (value is string)
                    return (SQLiteDateFormats)
                        TypeDescriptor.GetConverter(typeof(SQLiteDateFormats)).ConvertFrom(value);
                else
        ...
        public SQLiteJournalModeEnum JournalMode
        {
            get
            {
                ...
                if (value is string)
                    return (SQLiteJournalModeEnum)
                        TypeDescriptor
                            .GetConverter(typeof(SQLiteJournalModeEnum))
                            .ConvertFrom(value);
                else
            ...
            get
            {
                ...
                if (value is string)
                    return (IsolationLevel)
                        TypeDescriptor.GetConverter(typeof(IsolationLevel)).ConvertFrom(value);
                else
        ...
        public override bool TryGetValue(string keyword, out object value)
        {
            ...
            {
                DefaultValueAttribute att =
                    pd.Attributes[typeof(DefaultValueAttribute)] as DefaultValueAttribute;
                if (att != null)
                {
                    value = att.Value;
                    b = true;
        ...
        private void FallbackGetProperties(Hashtable propertyList)
        {
            ...
            {
                if (
                    descriptor.Name != "ConnectionString"
                    && propertyList.ContainsKey(descriptor.DisplayName) == false
                )
                {
