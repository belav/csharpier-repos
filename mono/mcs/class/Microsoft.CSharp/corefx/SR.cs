...
partial class SR
{
    public const string InternalCompilerError =
        "An unexpected exception occurred while binding a dynamic operation";
    public const string BindPropertyFailedMethodGroup =
        "The name '{0}' is bound to a method and cannot be used like a property";
    public const string BindPropertyFailedEvent =
    ...
    public const string NullReferenceOnMemberException =
        "Cannot perform runtime binding on a null reference";
    public const string BindCallToConditionalMethod =
        "Cannot dynamically invoke method '{0}' because it has a Conditional attribute";
    public const string BindToVoidMethodButExpectResult =
        "Cannot implicitly convert type 'void' to 'object'";
    public const string BadBinaryOps =
        "Operator '{0}' cannot be applied to operands of type '{1}' and '{2}'";
    public const string BadIndexLHS =
    ...
    public const string AmbigBinaryOps =
    ...
    public const string ValueCantBeNull =
        "Cannot convert null to '{0}' because it is a non-nullable value type";
    public const string WrongNestedThis =
    ...
    public const string ConstOutOfRangeChecked =
    ...
    public const string HasNoTypeVars =
        "The non-generic {1} '{0}' cannot be used with type arguments";
    public const string NewConstraintNotSatisfied =
    ...
    public const string GenericConstraintNotSatisfiedRefType =
    ...
    public const string GenericConstraintNotSatisfiedNullableEnum =
    ...
    public const string GenericConstraintNotSatisfiedNullableInterface =
