...
namespace PEAPI
{
    ...
    internal class FileImage : BinaryWriter
    {
        ...
        private static byte[] PEHeader =
        {
            ...
            0x00,
            0x0E,
            0x01, // PE Header Standard Fields
            0x0B,
            0x01,
            0x06,
            0x00,
        ...
        MetaData metaData;
        char[] runtimeEngine = runtimeEngineName.ToCharArray(),
            hintNameTable;
        bool doDLL,
            largeStrings,
            largeGUID,
        ...
        internal FileImage(bool makeDLL, string fileName)
        ...
        internal FileImage(bool makeDLL, Stream str)
            : base(str)
        {
            InitFileImage(makeDLL);
    ...
    public class PEFile
    {
        ...
        {
            if (assemName.CompareTo(mscorlibName) == 0)
                return metaData.mscorlib;
        ...
        public ClassRef AddExternClass(
            string ns,
            string name,
            TypeAttr attrs,
        ...
        public MethodRef AddMethodToTypeSpec(
            Type item,
            string name,
            Type retType,
            Type[] pars,
        ...
        {
            MethodRef meth = new MethodRef(
                item.GetTypeSpec(metaData),
                name,
                retType,
                pars,
                false,
        ...
        public MethodRef AddVarArgMethodToTypeSpec(
            Type item,
            string name,
            Type retType,
            Type[] pars,
