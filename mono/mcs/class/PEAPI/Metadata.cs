...
namespace PEAPI
{
    ...
    public class CustomAttribute : MetaDataElement
    {
        ...
        internal CustomAttribute(MetaDataElement paren, Method constrType, Constant val)
        {
            parent = paren;
            type = constrType;
            cVal = val;
        ...
        internal sealed override uint Size(MetaData md)
        {
            return md.CodedIndexSize(CIx.HasCustomAttr)
                + md.CodedIndexSize(CIx.CustomAttributeType)
                + md.BlobIndexSize();
        }
    ...
    public class FileRef : MetaDataElement
    {
        ...
        internal FileRef(string name, byte[] hashBytes, bool metaData, bool entryPoint, MetaData md)
        {
            if (!metaData)
                flags = NoMetaData;
            if (entryPoint)
        ...
        internal FileRef(uint nameIx, byte[] hashBytes, bool metaData, bool entryPoint, MetaData md)
        {
            if (!metaData)
                flags = NoMetaData;
            if (entryPoint)
    ...
    public class ImplMap : MetaDataElement
    {
        ...
        {
            return 2
                + md.CodedIndexSize(CIx.MemberForwarded)
                + md.StringsIndexSize()
                + md.TableIndexSize(MDTable.ModuleRef);
        }
    ...
    public class GenericParameter : MetaDataElement
    {
        ...
        internal GenericParameter(
            ...
            : this(owner, metadata, index, name, attr, true) { }
        ...
        {
            metadata.AddToTable(
                MDTable.GenericParamConstraint,
        ...
        internal sealed override uint Size(MetaData md)
        {
            return (uint)(4 + md.CodedIndexSize(CIx.TypeOrMethodDef) + md.StringsIndexSize());
        }
    ...
    internal class GenericParamConstraint : MetaDataElement
    {
        ...
        {
            return (uint)(
                md.TableIndexSize(MDTable.GenericParam) + md.CodedIndexSize(CIx.TypeDefOrRef)
            );
        }
    ...
    internal class MethodSpec : Method
    {
        ...
        internal sealed override uint Size(MetaData md)
        {
            return (uint)(md.CodedIndexSize(CIx.MethodDefOrRef) + md.BlobIndexSize());
        }
    ...
    public class InterfaceImpl : MetaDataElement
    {
        ...
        internal sealed override uint Size(MetaData md)
        {
            return md.TableIndexSize(MDTable.TypeDef) + md.CodedIndexSize(CIx.TypeDefOrRef);
        }
    ...
    public class ManifestResource : MetaDataElement
    {
        ...
        public ManifestResource(string name, uint flags, FileRef fileRef, uint fileIx)
        {
            InitResource(name, flags);
            rRef = fileRef;
            fileOffset = fileIx;
            ...
            if (resourceBytes != null)
            {
                if (rRef != null)
                    throw new PEFileException(
                        "Manifest Resource has byte value and file reference"
                    );
        ...
        internal sealed override uint Size(MetaData md)
        {
            return 8 + md.StringsIndexSize() + md.CodedIndexSize(CIx.Implementation);
        }
    ...
    public abstract class Type : MetaDataElement
    {
        ...
        internal void SetTypeIndex(byte b)
        {
            typeIndex = b;
        }
        ...
        {
            throw (
                new TypeSignatureException(
                    this.GetType().AssemblyQualifiedName + " doesn't have a type signature!!"
                )
            );
        }
    }
    ...
    public class ClassRefInst : Type
    {
        ...
        public ClassRefInst(Type type, bool is_value)
    ...
    public abstract class Class : Type
    {
        ...
        internal Class(uint nsIx, uint nIx)
            : base(PrimitiveType.Class.GetTypeIndex())
        {
            nameSpaceIx = nsIx;
            nameIx = nIx;
    ...
    public class ClassDef : Class
    {
        ...
        internal ClassDef(TypeAttr attrSet, string nsName, string name, MetaData md)
            : base(nsName, name, md)
        {
            metaData = md;
            flags = (uint)attrSet;
        ...
        /// </summary>
        public GenericParameter AddGenericParameter(
            short index,
            string name,
            GenericParamAttributes attr
        )
        ...
        public ClassDef AddNestedClass(TypeAttr attrSet, string nsName, string name)
        {
        ...
        /// <returns>a descriptor for this new nested class</returns>
        public ClassDef AddNestedClass(TypeAttr attrSet, string nsName, string name, Class sType)
        {
        ...
        internal sealed override void BuildTables(MetaData md)
        {
            ...
            if (layout != null)
                md.AddToTable(MDTable.ClassLayout, layout);
            ...
            if (properties != null)
            {
                ...
                md.AddToTable(
                    MDTable.PropertyMap,
                    new MapElem(this, ((Property)properties[0]).Row, MDTable.Property)
                );
            }
    ...
    public class ClassRef : Class, IExternRef, IResolutionScope
    {
        ...
        internal ClassRef(string nsName, string name, MetaData md)
            : base(nsName, name, md)
        {
            metaData = md;
    ...
    public class ExternClassRef : ClassRef
    {
        ...
        internal ExternClassRef(string name, MetaData md)
            : base(null, name, md) { }
    ...
    internal class ExternClass : Class
    {
        ...
        internal ExternClass(TypeAttr attr, uint nsIx, uint nIx, MetaDataElement paren)
            : base(nsIx, nIx)
        {
            flags = (uint)attr;
            parent = paren;
    ...
    public class GenParam : Class
    {
        ...
        public GenParam(int index, string name, GenParamType ptype)
            : base((byte)ptype)
        {
            this.index = index;
        ...
        internal sealed override void TypeSig(MemoryStream str)
        {
            if (index < 0)
                throw new PEFileException(
                    String.Format("Unresolved {0} - {1}", (GenParamType)GetTypeIndex(), param_name)
                );
    ...
    public class MethPtrType : Type
    {
            ...
            : base(0x1B)
        {
            ...
            if (varArgMeth)
            {
                optParList = optPars;
                if (optParList != null)
                    numOptPars = (uint)optParList.Length;
    ...
    public class ZeroBasedArray : Array
    {
        ...
        public ZeroBasedArray(Type elementType)
            : base(elementType, PrimitiveType.SZArray.GetTypeIndex()) { }
    ...
    public class BoundArray : Array
    {
        ...
        public BoundArray(Type elementType, uint dimensions, int[] loBounds, int[] sizes)
    ...
    public class Assembly : ResolutionScope
    {
        ...
        internal Assembly(string name, MetaData md)
            : base(name, md)
        {
    ...
    public class Module : ResolutionScope, IExternRef
    {
        ...
        internal Module(string name, MetaData md)
            : base(name, md)
        {
            mvid = Guid.NewGuid();
    ...
    {
        internal ModuleRef(MetaData md, string name)
            : base(name, md)
        {
        ...
        )
        {
            ...
            cRef.SetParent(this);
            if (isValueClass)
                cRef.MakeValueClass(ValueClass.ValueType);
            return cRef;
        }
    ...
    public abstract class Constant
    {
        ...
        internal virtual uint GetBlobIndex(MetaData md)
        {
            return 0;
        }
    ...
    public class BoolConst : DataConstant
    {
        ...
        internal sealed override uint GetBlobIndex(MetaData md)
        {
            ...
            {
                if (val)
                    blobIndex = md.AddToBlobHeap((sbyte)1);
                else
                    blobIndex = md.AddToBlobHeap((sbyte)0);
    ...
    public class IntConst : DataConstant
    {
        ...
        internal sealed override uint GetBlobIndex(MetaData md)
        {
            if (!addedToBlobHeap)
            {
                ...
                {
                    case (1):
                        blobIndex = md.AddToBlobHeap((sbyte)val);
                        break;
                    case (2):
                        blobIndex = md.AddToBlobHeap((short)val);
                        break;
                    case (4):
                        blobIndex = md.AddToBlobHeap((int)val);
                        break;
                    default:
                        blobIndex = md.AddToBlobHeap(val);
                        break;
    ...
    public class UIntConst : DataConstant
    {
        ...
        internal sealed override uint GetBlobIndex(MetaData md)
        {
            if (!addedToBlobHeap)
            {
                ...
                {
                    case (1):
                        blobIndex = md.AddToBlobHeap((byte)val);
                        break;
                    case (2):
                        blobIndex = md.AddToBlobHeap((ushort)val);
                        break;
                    case (4):
                        blobIndex = md.AddToBlobHeap((uint)val);
                        break;
                    default:
                        blobIndex = md.AddToBlobHeap(val);
                        break;
    ...
    public abstract class Field : Member
    {
        ...
        internal Field(string pfName, Type pfType)
            : base(pfName)
        {
            type = pfType;
        }
    ...
    public class FieldDef : Field
    {
        ...
        internal FieldDef(string name, Type fType)
            : base(name, fType)
        {
            tabIx = MDTable.Field;
        }

        internal FieldDef(FieldAttr attrSet, string name, Type fType)
            : base(name, fType)
        {
        ...
        internal sealed override void BuildTables(MetaData md)
        {
            ...
            if (layout != null)
                md.AddToTable(MDTable.FieldLayout, layout);
            if (marshalInfo != null)
            {
                md.AddToTable(MDTable.FieldMarshal, marshalInfo);
                marshalInfo.BuildTables(md);
    ...
    public class FieldRef : Field
    {
        ...
        internal FieldRef(MetaDataElement paren, string name, Type fType)
            : base(name, fType)
        {
            parent = paren;
        }
        ...
        internal sealed override uint Size(MetaData md)
        {
            return md.CodedIndexSize(CIx.MemberRefParent)
                + md.StringsIndexSize()
                + md.BlobIndexSize();
        }
    ...
    public class MethodDef : Method
    {
        ...
        public void AddPInvokeInfo(ModuleRef scope, string methName, PInvokeAttr callAttr)
        {
        ...
        internal sealed override uint Size(MetaData md)
        {
            return 8
                + md.StringsIndexSize()
                + md.BlobIndexSize()
                + md.TableIndexSize(MDTable.Param);
        }
        ...
        {
            return (
                ((methFlags & (ushort)MethAttr.Abstract) != 0)
                || ((implFlags & (ushort)ImplAttr.Runtime) != 0)
                || ((implFlags & (ushort)ImplAttr.InternalCall) != 0)
                || (pinvokeImpl != null)
            ); // TODO: Not entirely true but works for now
        }
    ...
    public class FixedSysString : NativeType
    {
        ...
        public FixedSysString(uint size)
            : base(NativeType.FixedSysString.GetTypeIndex())
        {
            this.size = size;
        }
    ...
    public class SafeArray : NativeType
    {
        ...
        public SafeArray(SafeArrayType elemType)
            : base(0x1D)
        {
            this.elemType = elemType;
            hasElemType = true;
    ...
    public class PrimitiveType : Type
    {
        ...
        public static readonly PrimitiveType TypedRef = new PrimitiveType(
            0x16,
            "TypedReference",
            14
        );
    ...
    public class AssemblyRef : ResolutionScope, IExternRef
    {
        ...
        internal AssemblyRef(MetaData md, string name)
            : base(name, md)
        {
        ...
        internal string TypeName()
        {
            string result = name;
            if (hasVersion)
                result = result + ", Version=" + major + "." + minor + "." + build + "." + revision;
            if (keyBytes != null)
            {
                string tokenStr = "=";
                if (isKeyToken)
    ...
    public sealed class MSCorLib : AssemblyRef
    {
            ...
            for (int i = 0; i < specialNames.Length; i++)
            {
                ...
                if (systemClasses[i] == null)
                {
                    if (i < valueTypeIx)
                    {
                        ...
                        if (
                            (systemTypes[i] != PrimitiveType.Object)
        ...
        public override ClassRef AddValueClass(string nsName, string name)
        {
            ...
            {
                int hash = name.GetHashCode();
                if ((hash == specialNames[valueTypeIx]) || (hash == specialNames[valueTypeIx + 1]))
                {
    ...
    public class MetaData
    {
        ...
        private static readonly char[] stringsName =
        {
            '#',
            'S',
            't',
        ...
        {
            get { return _mscorlib ?? (_mscorlib = new MSCorLib(this)); }
        }
        ...
        {
            if (metaDataTables[(int)tableIx] == null)
                return 1;
        ...
        internal void BuildMetaData(uint codeStartOffset)
        {
            ...
            if (entryPoint != null)
                file.SetEntryPoint(entryPoint.Token());
        ...
        internal bool LargeStringsIndex()
        {
            return strings.LargeIx();
        }

        internal bool LargeGUIDIndex()
        {
            return guid.LargeIx();
        }

        internal bool LargeUSIndex()
        {
            return us.LargeIx();
        }

        internal bool LargeBlobIndex()
        {
            return blob.LargeIx();
        }
