...
partial class SR
{
    public const string CantTellPrinterName =
        "(printer name protected due to security restrictions)";
    public const string CantChangeImmutableObjects =
        "Changes cannot be made to {0} because permissions are not valid.";
    public const string CantMakeIconTransparent =
    ...
    public const string GdiplusCannotCreateGraphicsFromIndexedPixelFormat =
        "A Graphics object cannot be created from an image that has an indexed pixel format.";
    public const string GdiplusCannotSetPixelFromIndexedPixelFormat =
        "SetPixel is not supported for images with indexed pixel formats.";
    public const string GdiplusDestPointsInvalidParallelogram =
    ...
    public const string GdiplusDestPointsInvalidLength =
    ...
    public const string GdiplusInvalidRectangle =
        "Rectangle '{0}' cannot have a width or height equal to 0.";
    public const string GdiplusInvalidSize =
    ...
    public const string GdiplusNotInitialized =
        "GDI+ is not properly initialized (internal GDI+ error).";
    public const string GdiplusNotTrueTypeFont =
        "Only TrueType fonts are supported. '{0}' is not a TrueType font.";
    public const string GdiplusNotTrueTypeFont_NoName =
    ...
    public const string GdiplusUnsupportedGdiplusVersion =
    ...
    public const string ToolboxItemInvalidPropertyType =
        "Property {0} requires an argument of type {1}.";
    public const string ToolboxItemValueNotSerializable =
    ...
    public const string InterpolationColorsColorBlendNotSet =
        "Property must be set to a valid ColorBlend object to use interpolation colors.";
    public const string InterpolationColorsCommon =
    ...
    public const string InterpolationColorsInvalidColorBlendObject =
        "ColorBlend object that was set is not valid.";
    public const string InterpolationColorsInvalidStartPosition =
        "Position's first element must be equal to 0.";
    public const string InterpolationColorsInvalidEndPosition =
        "Position's last element must be equal to 1.0.";
    public const string InterpolationColorsLength =
        "Array of colors and positions must contain at least two elements.";
    public const string InterpolationColorsLengthsDiffer =
    ...
    public const string InvalidBoundArgument =
    ...
    public const string InvalidLowBoundArgumentEx =
    ...
    public const string InvalidPictureType =
        "Argument '{0}' must be a picture that can be used as a {1}.";
    public const string InvalidPrinterException_InvalidPrinter =
    ...
    public const string PDOCdocumentPageSettingsDescr =
    ...
    public const string PDOCoriginAtMarginsDescr =
        "Indicates that the graphics origin is located at the user-specified page margins.";
    public const string PDOCprintControllerDescr =
    ...
    public const string PDOCprinterSettingsDescr =
        "Retrieves the settings for the printer the document is currently being printed to.";
    public const string PDOCqueryPageSettingsDescr =
    ...
    public const string PrintingPermissionAttributeInvalidPermissionLevel =
        "Permission level must be between PrintingPermissionLevel.NoPrinting and PrintingPermissionLevel.AllPrinting.";
    public const string PropertyValueInvalidEntry =
    ...
    public const string PSizeNotCustom =
    ...
    public const string TextParseFailedFormat =
        "Text \"{0}\" cannot be parsed. The expected text format is \"{1}\".";
    public const string TriStateCompareError =
    ...
    public const string InvalidEnumArgument =
    ...
    public const string LibgdiplusNotFound =
        "The native library \"libgdiplus\" is not installed on the system, or was otherwise unable to be loaded.";
}
