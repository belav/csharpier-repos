...
namespace Test.Sys.Drawing
{
    ...
    public class ImageFixture
    {
        ...
        public void Clone()
        {
            ...
            Assert.AreEqual(
                DrawingTest.CalculateNorm((Bitmap)im1),
        ...
        public void GetBounds()
        {
            ...
            Assert.AreEqual(new RectangleF(0, 0, 256, 256), t.Bitmap.GetBounds(ref unit));
        ...
        public void GetThumbnailImage()
        {
            ...
            Image myThumbnail = t.Bitmap.GetThumbnailImage(10, 10, myCallback, IntPtr.Zero);
        ...
        {
            Assert.AreEqual(new Guid[] { FrameDimension.Page.Guid }, t.Bitmap.FrameDimensionsList);
        }
