...
namespace Test.Sys.Drawing
{
    ...
    public class BitmapFixture
    {
        ...
        public void CloneTest()
        {
            ...
            Assert.AreEqual(DrawingTest.CalculateNorm(t.Bitmap), DrawingTest.CalculateNorm(b1));
            t.Graphics.FillRectangle(Brushes.Black, 0, 0, 64, 64);
            Assert.IsFalse(DrawingTest.CalculateNorm(t.Bitmap) == DrawingTest.CalculateNorm(b1));
        }

        [Test]
        public void GetPixel()
        {
            Assert.AreEqual(Color.FromArgb(255, Color.White), t.Bitmap.GetPixel(0, 0));
            t.Graphics.FillRectangle(Brushes.Black, 30, 30, 30, 30);
            Assert.AreEqual(Color.FromArgb(255, Color.Black), t.Bitmap.GetPixel(31, 31));
        }
