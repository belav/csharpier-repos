...
namespace Test.Sys.Drawing
{
    ...
    public class RegionFixture
    {
        ...
        public void ctor_Rectangle()
        {
            ...
            Assert.AreEqual(r.GetRegionData().Data, r1.GetRegionData().Data);
        }
        ...
        public void Complement()
        {
            ...
            Assert.AreEqual(new RectangleF(100, 70, 50, 20), r.GetBounds(t.Graphics));
        }
        ...
        public void Exclude()
        {
            ...
            Assert.AreEqual(new RectangleF(50, 70, 50, 30), r.GetBounds(t.Graphics));
        }
        ...
        {
            Assert.AreEqual(
                new RectangleF[] { new Rectangle(50, 50, 50, 50) },
        ...
        public void Intersect()
        {
            ...
            Assert.AreEqual(new RectangleF(70, 70, 30, 30), r.GetBounds(t.Graphics));
        }
        ...
        public void IsInfinite()
        {
            ...
            Assert.AreEqual(new RectangleF[] { infiniteRect }, r.GetRegionScans(new Matrix()));
        ...
        public void IsVisible_int()
        {
            ...
            Assert.IsTrue(r.IsVisible(rectD.X, rectD.Y, rectD.Height, rectD.Width, t.Graphics));
            Assert.IsTrue(r.IsVisible(rectD));
            Assert.IsTrue(r.IsVisible(rectD.X, rectD.Y, rectD.Height, rectD.Width));
            Assert.IsFalse(r.IsVisible(new Point(rectD.Right, rectD.Bottom), t.Graphics));
        ...
        public void IsVisible_float()
        {
            ...
            Assert.IsTrue(r.IsVisible(rect.X, rect.Y, rect.Height, rect.Width, t.Graphics));
            Assert.IsTrue(r.IsVisible(rect));
            Assert.IsTrue(r.IsVisible(rect.X, rect.Y, rect.Height, rect.Width));
            Assert.IsFalse(r.IsVisible(new PointF(rect.Right, rect.Bottom), t.Graphics));
            Assert.IsFalse(r.IsVisible(new PointF(rect.Right, rect.Bottom)));
            Assert.IsFalse(r.IsVisible(new PointF(rect.Right - 0.1F, rect.Bottom - 0.1F)));
            Assert.IsTrue(r.IsVisible(new PointF(rect.Right - 1, rect.Bottom - 1)));
            ...
            Assert.IsFalse(r.IsVisible(new PointF(rect.X - 0.4F, rect.Y - 0.4F)));
        }
