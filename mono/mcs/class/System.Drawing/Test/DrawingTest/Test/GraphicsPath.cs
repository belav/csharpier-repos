...
namespace Test.Sys.Drawing
{
    ...
    public class GraphicsPathFixture
    {
        ...
        public void AddArc_Rectangle_Float_Float()
        {
            ...
            PointF[] expectedPoints = new PointF[]
            {
                new PointF(199.0466f, 148.5099f),
            ...
            byte[] expectedTypes = new byte[17]
            {
                (byte)PathPointType.Start,
                (byte)PathPointType.Bezier3,
                (byte)PathPointType.Bezier3,
        ...
        public void AddArc_RectangleF_Float_Float()
        {
            ...
            PointF[] expectedPoints = new PointF[]
            {
                new PointF(169.7277f, 129.2994f),
        ...
        public void PathData()
        {
            ...
            expectedTypes = new byte[]
            {
                ...
                (byte)PathPointType.Bezier3,
                (byte)(
                    PathPointType.Bezier3 | PathPointType.CloseSubpath | PathPointType.PathMarker
                ),
                (byte)PathPointType.Start,
                (byte)PathPointType.Line,
                (byte)PathPointType.Start,
        ...
        public void Transform_Matrix()
        {
            ...
            PointF[] expectedPoints = new PointF[]
            {
                new PointF(226.0865f, 5.313778f),
        ...
        public void Widen_Pen()
        {
            ...
            PointF[] expectedPoints = new PointF[]
            {
                new PointF(17.37995f, 8.663473f),
        ...
        public void Widen_Pen_Matrix()
        {
            ...
            PointF[] expectedPoints = new PointF[]
            {
                new PointF(26.07226f, 4.336054f),
        ...
        public void Widen_Pen_Matrix_Float()
        {
            ...
            PointF[] expectedPoints = new PointF[]
            {
                new PointF(26.08857f, 4.367013f),
        ...
        public void Print(GraphicsPath path)
        {
            ...
            for (int i = 0; i < path.PointCount; i++)
            {
                Console.WriteLine(
                    ...
                    path.PathPoints[i].X,
                    path.PathPoints[i].Y,
                    ToString((PathPointType)path.PathTypes[i])
                );
            }
        }
