...
{
    internal const string Can_not_use_encrypted_passwords_with_autogen_keys =
        "You must specify a non-autogenerated machine key to store passwords in the encrypted format. Either specify a different passwordFormat, or change the machineKey configuration to use a non-autogenerated decryption key.";
    internal const string CustomLoader_ForbiddenByHost =
        "The host forbids the use of custom loaders.";
    internal const string CustomLoader_MustImplementICustomLoader =
        "The provided type '{0}' must implement the ICustomLoader interface.";
    internal const string CustomLoader_NoAttributeFound =
        "The assembly '{0}' did not contain an assembly-level CustomLoaderAttribute.";
    internal const string CustomLoader_NotInFullTrust =
        "Custom loaders can only be used by fully-trusted applications (<trust level=\"Full\" />).";
    internal const string Membership_DuplicateEmail = "The E-mail address is already in use.";
    internal const string Membership_DuplicateProviderUserKey =
    ...
    internal const string Membership_InvalidPassword =
    ...
    internal const string Membership_InvalidProviderUserKey =
        "The provider user key supplied is invalid. It must be of type System.Guid.";
    internal const string Membership_InvalidQuestion =
    ...
    internal const string Membership_provider_name_invalid =
    ...
    internal const string Platform_not_supported =
        "This member is not supported on the .NET Framework Client Profile.";
