...
namespace MonoTests.System.Reflection
{
    ...
    public class AssemblyFileVersionAttributeTest
    {
        ...
        {
            Assert.AreEqual(attr.Version, "1.0.0.0", "#1");
        }

        [Test]
        public void TypeIdTest()
        {
            Assert.AreEqual(attr.TypeId, typeof(AssemblyFileVersionAttribute), "#1");
        }
        ...
        {
            Assert.AreEqual(attr.Match(new AssemblyFileVersionAttribute("Descrptn")), false, "#1");
        }
#endif
