...
namespace MonoTests.System.Reflection
{
    ...
    public class ModuleTest
    {
        static string BaseTempFolder = Path.Combine(
            Path.GetTempPath(),
            "MonoTests.System.Reflection.ModuleTest"
        );
        ...
        public void TestGlobalData()
        {
            ...
            AssemblyBuilder ab = Thread
                .GetDomain()
                .DefineDynamicAssembly(assemblyName, AssemblyBuilderAccess.RunAndSave, TempFolder);
            ...
            string[] expectedFieldNames = new string[] { "DATA", "DATA2", "DATA3", "DATA4" };
            ...
            Assert.IsNotNull(
                module.GetField("DATA_PRIVATE", BindingFlags.NonPublic | BindingFlags.Static),
                "#A6"
            );
...
/* We currently throw ArgumentException for this one */
        ...
        public void ResolveMethod()
        {
            ...
            Assert.AreEqual(
                t.GetMethod("ResolveMethod"),
                module.ResolveMethod(t.GetMethod("ResolveMethod").MetadataToken)
            );
        ...
        public void ResolveField()
        {
            ...
            Assert.AreEqual(
                t.GetField("aField"),
                module.ResolveField(t.GetField("aField").MetadataToken)
            );
        ...
        public void ResolveMember()
        {
            ...
            Assert.AreEqual(
                t.GetField("aField"),
                module.ResolveMember(t.GetField("aField").MetadataToken),
                "#2"
            );
            Assert.AreEqual(
                t.GetMethod("ResolveMember"),
                module.ResolveMember(t.GetMethod("ResolveMember").MetadataToken),
                "#3"
            );
