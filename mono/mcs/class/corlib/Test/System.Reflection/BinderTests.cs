...
namespace MonoTests.System.Reflection
{
    ...
    public class BinderTest
    {
        ...
        public void SelectAndInvokeAllProperties1()
        {
            ...
            */
            ...
            foreach (Type t in types)
            {
                ...
                Type gotten = (Type)
                    prop.GetValue(obj, new object[] { Activator.CreateInstance(t) });
        ...
        public void SelectAndInvokeAllProperties2()
        {
            ...
            MultiIndexer obj = new MultiIndexer();
            PropertyInfo prop1 = binder.SelectProperty(
                0,
                props,
                null,
                new Type[] { types[0] },
            ...
            PropertyInfo prop2 = binder.SelectProperty(
                0,
                props,
                null,
                new Type[] { types[1] },
        ...
        public void SelectMethod_AmbiguousMatch()
        {
            ...
            MethodInfo mi_single_param = type.GetMethod(
                "params_method1",
                flags,
                binder,
                types,
            ...
            Assert.AreEqual(
                typeof(object),
                mi_single_param.GetParameters()[0].ParameterType,
                "#B3"
            );
        ...
        public void SelectMethod_ByRef()
        {
            ...
            MethodInfo mi_run = type.GetMethod(
                "Run",
                flags,
                binder,
                new Type[] { typeof(int) },
            ...
            MethodInfo mi_run_ref = type.GetMethod(
                "Run",
                flags,
                binder,
        ...
        public void BindToMethod_ByRef()
        {
            ...
            match = new MethodBase[] { mi_run };
            selected = binder.BindToMethod(flags, match, ref args, null, culture, null, out state);
        ...
        public void BindToMethodNamedArgs_2()
        {
            ...
            typeof(BinderTest).InvokeMember(
                "TestMethod",
                BindingFlags.InvokeMethod,
                null,
                null,
        ...
        public void TestParamsAttribute()
        {
            ...
            mi = typeof(BinderTest).GetMethod(
                "params_method1",
        ...
        {
            MethodInfo mi = typeof(BinderTest).GetMethod(
                "params_method1",
                BindingFlags.Static | BindingFlags.Public,
                null,
        ...
        public void ChangeType()
        {
            ...
            Assert.AreEqual(
                42.0,
                typeof(BinderTest).GetMethod("DoubleMethod").Invoke(null, new object[] { (char)42 })
            );

            // Char -> Float
            Assert.AreEqual(
                42.0f,
                typeof(BinderTest).GetMethod("FloatMethod").Invoke(null, new object[] { (char)42 })
            );
        }
        ...
        public void TestExactBinding()
        {
            ...
            Assert.IsNull(
                typeof(BinderTest).GetMethod("MethodWithLongParam", flags, null, types, null)
            );
        }
        ...
        class Bug324998AGood
        {
            public virtual void f(int i1, int i2, bool b) { }
        }

        class Bug324998BGood : Bug324998AGood
        {
        ...
        class Bug324998BBad : Bug324998ABad
        {
            public override void f(int i1, int i2, bool b) { }
        }
