...
namespace MonoTests.System.Reflection
{
    ...
    public class AssemblyCultureAttributeTest
    {
        ...
        {
            Assert.AreEqual(attr.Culture, "India", "#1");
        }

        [Test]
        public void TypeIdTest()
        {
            Assert.AreEqual(attr.TypeId, typeof(AssemblyCultureAttribute), "#1");
        }
        ...
        {
            Assert.AreEqual(attr.Match(new AssemblyCultureAttribute("Spanish")), false, "#1");
        }
#endif
