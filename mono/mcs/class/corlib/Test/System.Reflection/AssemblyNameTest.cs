...
namespace MonoTests.System.Reflection
{
    ...
    public class AssemblyNameTest
    {
        ...
        public void FullName_PublicKey()
        {
            ...
            an.SetPublicKey(publicKey1);
            Assert.AreEqual(
                assemblyName + ", PublicKeyToken=" + GetTokenString(pk_token1),
                an.FullName,
                "#A1"
            );
            an.SetPublicKey((byte[])null);
            ...
            an.Name = assemblyName;
            Assert.AreEqual(
                assemblyName + ", PublicKeyToken=" + GetTokenString(pk_token3),
                an.FullName,
                "#D4"
            );
        }
        ...
        public void FullName_VersionCulture()
        {
            ...
            an.CultureInfo = CultureInfo.InvariantCulture;
            Assert.AreEqual(
                assemblyName + ", Version=" + assemblyVersion + ", Culture=neutral",
                an.FullName,
                "#1"
            );
            an.CultureInfo = new CultureInfo("en-US");
            Assert.AreEqual(
                assemblyName + ", Version=" + assemblyVersion + ", Culture=en-US",
                an.FullName,
                "#2"
            );
            an.CultureInfo = new CultureInfo("en");
            Assert.AreEqual(
                assemblyName + ", Version=" + assemblyVersion + ", Culture=en",
                an.FullName,
                "#3"
            );
        }
        ...
        {
            AssemblyBuilder ab = domain.DefineDynamicAssembly(name, AssemblyBuilderAccess.Run);
        ...
        public void Serialization()
        {
            ...
            Assert.AreEqual(
                an.VersionCompatibility,
                dsAssemblyName.VersionCompatibility,
                "VersionCompatibility"
            );
            ...
            Assert.AreEqual(
                an.GetPublicKeyToken(),
                dsAssemblyName.GetPublicKeyToken(),
                "PublicToken"
            );
        }
        ...
        public void Constructor1_Full()
        {
            ...
            Assert.AreEqual(AssemblyNameFlags.None, an.Flags, "Flags");
            Assert.AreEqual(
                "TestAssembly, Version=1.2.3.4, Culture=neutral, PublicKeyToken="
                    + GetTokenString(pk_token1),
                an.FullName,
                "FullName"
            );
        ...
        public void Constructor1_PublicKey_Mono()
        {
            ...
            Assert.AreEqual(AssemblyNameFlags.PublicKey, an.Flags, "Flags");
            Assert.AreEqual(
                "TestAssembly, PublicKeyToken=" + GetTokenString(pk_token1),
                an.FullName,
                "FullName"
            );
            Assert.AreEqual(AssemblyHashAlgorithm.None, an.HashAlgorithm, "HashAlgorithm");
        ...
        public void Constructor1_PublicKey_Ecma()
        {
            ...
            Assert.AreEqual(AssemblyNameFlags.None, an.Flags, "Flags");
            Assert.AreEqual(
                "TestAssembly, PublicKeyToken=" + GetTokenString(pk_token3),
                an.FullName,
                "FullName"
            );
            Assert.AreEqual(AssemblyHashAlgorithm.None, an.HashAlgorithm, "HashAlgorithm");
        ...
        public void Constructor1_PublicKey_Invalid()
        {
            ...
            try
            {
                new AssemblyName(
                    assemblyName
                        + ", PublicKey="
                );
                Assert.Fail("#A1");
            }
            catch (FileLoadException ex)
        ...
        public void Constructor1_Retargetable()
        {
            ...
            {
                new AssemblyName(
                    assemblyName + ", Version=1.0.0.0, Culture=neutral, Retargetable=Yes"
                );
                Assert.Fail("#D1");
            }
            catch (FileLoadException ex)
            ...
            {
                new AssemblyName(
                    assemblyName + ", Version=1.0.0.0, PublicKeyToken=null, Retargetable=Yes"
                );
                Assert.Fail("#E1");
            }
            catch (FileLoadException ex)
            ...
            an = new AssemblyName(
                assemblyName
                    + ", Version=1.0.0.0, Culture=neutral, PublicKeyToken=null, Retargetable=yEs"
            );
            ...
            Assert.AreEqual(
                "TestAssembly, Version=1.0.0.0, Culture=neutral, PublicKeyToken=null, Retargetable=Yes",
                an.FullName,
                "#F:FullName"
            );
            ...
            Assert.AreEqual(
                AssemblyVersionCompatibility.SameMachine,
                an.VersionCompatibility,
                "#F:VersionCompatibility"
            );

            an = new AssemblyName(
                assemblyName
                    + ", Version=1.0.0.0, Culture=neutral, PublicKeyToken=null, Retargetable=nO"
            );
            ...
            Assert.AreEqual(
                "TestAssembly, Version=1.0.0.0, Culture=neutral, PublicKeyToken="
                    + GetTokenString(pk_token1)
                    + ", Retargetable=Yes",
                an.FullName,
                "#H:FullName"
        ...
        public void Constructor1_Quoted()
        {
            ...
            an = new AssemblyName(
                "'System', Version=\"10.0.0.0\", Culture='Neutral', PublicKeyToken='b67a5c561934e089', Retargetable='Yes', ProcessorArchitecture='AMD64'"
            );
            Assert.AreEqual(
                "System, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b67a5c561934e089, Retargetable=Yes",
                an.ToString()
            );
        ...
        {
            string nameWithSpaces = String.Format(
                "MySql.Data.Tests, PublicKey      = \t  {0},  Culture   =\tneutral, Version=\t1.2.3.4",
                GetTokenString(publicKey1)
            );
            string fullName =
                "MySql.Data.Tests, Version=1.2.3.4, Culture=neutral, PublicKeyToken=ce5276d8687ec6dc";
        ...
        {
            var an1 = new AssemblyName(
                "TestDll, Version=1.0.0.0, Culture=Neutral, PublicKeyToken=b77a5c561934e089"
            );
            var an2 = new AssemblyName(
                "TestDll, Version=2.0.0.2001, Culture=en-US, PublicKeyToken=ab7a5c561934e089"
            );
