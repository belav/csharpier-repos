...
namespace MonoTests.System.Reflection
{
    ...
    public class AssemblyConfigurationAttributeTest
    {
        ...
        {
            Assert.AreEqual(attr.Configuration, "Config", "#1");
        }

        [Test]
        public void TypeIdTest()
        {
            Assert.AreEqual(attr.TypeId, typeof(AssemblyConfigurationAttribute), "#1");
        }
        ...
        {
            Assert.AreEqual(attr.Match(new AssemblyConfigurationAttribute("abcd")), false, "#1");
        }
#endif
