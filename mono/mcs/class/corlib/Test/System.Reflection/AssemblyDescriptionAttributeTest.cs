...
namespace MonoTests.System.Reflection
{
    ...
    public class AssemblyDescriptionAttributeTest
    {
        ...
        {
            Assert.AreEqual(attr.Description, "Emitted Assembly", "#1");
        }

        [Test]
        public void TypeIdTest()
        {
            Assert.AreEqual(attr.TypeId, typeof(AssemblyDescriptionAttribute), "#1");
        }
        ...
        {
            Assert.AreEqual(attr.Match(new AssemblyDescriptionAttribute("Descrptn")), false, "#1");
        }
#endif
