...
namespace MonoTests.System.Runtime.Serialization
{
    ...
    public class SerializationTest
    {
        ...
        public void DelegateSerializationTest()
        {
            ...
            var d2 = Delegate.CreateDelegate(
                typeof(Func<StringBuilder, int>),
                "val",
                typeof(SerializationTest).GetMethod("HandleE2")
            );
        ...
        void ReadData()
        {
            ...
            for (int n = 0; n < originalMsgData.Length; n++)
            {
                ...
                resps[n] = (IMessage)
                    f.DeserializeMethodResponse(ms, null, (IMethodCallMessage)calls[n]);
            }
    ...
    public class FalseISerializableSurrogate : ISerializationSurrogate
    {
        ...
        {
            ((FalseISerializable)obj).field = Convert.ToInt32(
                info.GetValue("field", typeof(string))
            );
            return obj;
        }
    }
    ...
    public class SomeValues
    {
        ...
        public void CheckEquals(SomeValues obj, string context)
        {
            ...
            SerializationTest.EqualsArray(
                context + "._almostEmpty",
                _almostEmpty,
                obj._almostEmpty
            );

            SerializationTest.EqualsArray(
                context + "._emptyObjectArray",
                _emptyObjectArray,
                obj._emptyObjectArray
            );
            SerializationTest.EqualsArray(
                context + "._emptyTypeArray",
                _emptyTypeArray,
                obj._emptyTypeArray
            );
            SerializationTest.EqualsArray(
                context + "._emptySimpleArray",
                _emptySimpleArray,
                obj._emptySimpleArray
            );
            SerializationTest.EqualsArray(
                context + "._emptyIntArray",
                _emptyIntArray,
                obj._emptyIntArray
            );
            SerializationTest.EqualsArray(
                context + "._emptyStringArray",
                _emptyStringArray,
                obj._emptyStringArray
            );
            SerializationTest.EqualsArray(
                context + "._emptyPointArray",
                _emptyPointArray,
                obj._emptyPointArray
            );
            ...
            SerializationTest.AssertEquals(
                "SomeValues._falseSerializable",
                _falseSerializable.field,
                2
            );
        }
    }
