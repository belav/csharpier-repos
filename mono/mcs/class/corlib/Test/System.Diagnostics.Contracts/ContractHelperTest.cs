...
namespace MonoTests.System.Diagnostics.Contracts
{
    ...
    public class ContractHelperTest : TestContractBase
    {
        ...
        {
            this.CheckAllKinds(
                (expected, ex, condition, kind, fnTest) => fnAssert(expected, ex, fnTest)
            );
        }
        ...
        public void TestRaiseContractFailedEventHandled()
        {
            ...
            this.CheckAllKinds(
                (expected, ex, condition, kind, fnTest) =>
                {
                    ...
                    Assert.IsNull(
                        msg,
                        "TestRaiseContractFailedEventHandled() expected null message"
                    );
                }
            );
        }
        ...
        public void TestRaiseContractMultipleHandlers1()
        {
            ...
            this.CheckAllKinds(
                (expected, ex, fnTest) =>
                {
                    ...
                    Assert.IsTrue(
                        visited1,
                        "TestRaiseContractMultipleHandlers1() handler 1 not visited"
                    );
                    Assert.IsTrue(
                        visited2,
            ...
            this.CheckAllKinds(
                (expected, expectedEx, fnTest) =>
                {
                    ...
                    catch (Exception ex)
                    {
                        ...
                        Assert.IsTrue(
                            visited1,
                            "TestRaiseContractMultipleHandlers2() handler 1 not visited"
                        );
                        Assert.IsTrue(
                            visited2,
            ...
            this.CheckAllKinds(
                (expected, expectedEx, fnTest) =>
                {
                    ...
                    try
                    {
                        fnTest();
                        Assert.Fail(
                            "TestRaiseContractMultipleHandlers3() failed to throw exception"
                        );
                    }
                    catch (Exception ex)
                    {
                        ...
                        Assert.IsTrue(
                            visited1,
                            "TestRaiseContractMultipleHandlers3() handler 1 not visited"
                        );
                        Assert.IsTrue(
                            visited2,
