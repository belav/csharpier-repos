...
namespace MonoTests.System.Security.Permissions
{
    ...
    public class FileIOPermissionTest
    {
        ...
        public void ConstructorString()
        {
            ...
            Assert.IsTrue(
                pathsInPermission.Length == 1,
                "Does not contain correct number of paths. Expected 1 but got: "
                    + pathsInPermission.Length
            );
            Assert.IsTrue(
                pathsInPermission[0] == pathToAdd,
                "Does not contain expected path from constructor: " + pathToAdd
            );
        }
        ...
        public void ConstructorStringArray()
        {
            ...
            pathsInPermission = p.GetPathList(FileIOPermissionAccess.Read);
            Assert.IsTrue(
                pathsInPermission.Length == 2,
                "Does not contain correct number of paths. Expected 2 but got: "
                    + pathsInPermission.Length
            );
            foreach (string s in pathsInPermission)
            {
                Assert.IsTrue(
                    Array.IndexOf(pathsInPermission, s) >= 0,
                    "Unexpected path in the Permission: " + s
                );
            }
        }
        ...
        public void AddPathListStringArray()
        {
            ...
            Assert.IsTrue(
                pathsInPermission.Length == 2,
                "Should still contain correct number Read paths. Expected 2 but got: "
                    + pathsInPermission.Length
            );
            foreach (string s in pathsInPermission)
            {
            ...
            Assert.IsTrue(
                pathsInPermission.Length == 2,
                "Should contain correct number of Append paths. Expected 2 but got: "
                    + pathsInPermission.Length
            );
            foreach (string s in pathsInPermission)
            {
        ...
        public void Intersect()
        {
            ...
            Assert.IsTrue(
                pathsInPermission.Length == 2,
                "Should contain correct number of Read paths. Expected 2 but got: "
                    + pathsInPermission.Length
            );
            Assert.IsTrue(
                (intersection.AllFiles & FileIOPermissionAccess.Append) != 0,
                "Should have Append bit in AllFiles."
            );
            Assert.IsTrue(
                (intersection.AllLocalFiles & FileIOPermissionAccess.Write) != 0,
                "Should have Write bit in AllLocalFiles."
            );
            ...
            p2 = new FileIOPermission(
                FileIOPermissionAccess.Append | FileIOPermissionAccess.Read,
                pathArrayGood2
            );
            ...
            Assert.AreEqual(
                2,
                pathsInPermission.Length,
                "Should contain correct number of Read paths"
            );
            Assert.AreEqual(
                FileIOPermissionAccess.Append,
                intersection.AllFiles,
                "Should have only Append bit in AllFiles."
            );
            Assert.AreEqual(
                FileIOPermissionAccess.Write,
                intersection.AllLocalFiles,
                "Should have only Write bit in AllLocalFiles."
            );
            ...
            Assert.IsTrue(
                intersection.AllFiles == FileIOPermissionAccess.Append,
                "Should have only Append bit in AllFiles."
            );
            Assert.IsTrue(
                intersection.AllLocalFiles == FileIOPermissionAccess.Write,
                "Should have only Write bit in AllLocalFiles."
            );
        }
        ...
        public void IsSubsetOf()
        {
            ...
            Assert.IsTrue(
                ...
                "IsSubsetOf reflective test failed"
            );
        ...
        public void Union()
        {
            ...
            pathsInPermission = union.GetPathList(FileIOPermissionAccess.Read);
            Assert.IsTrue(
                pathsInPermission.Length == pathArrayGood.Length,
                "Path list should have 2 for Read"
            );
            pathsInPermission = union.GetPathList(FileIOPermissionAccess.Append);
            Assert.IsTrue(
                pathsInPermission.Length == pathArrayGood2.Length,
                "Path list should have 3 for Append"
            );
        ...
        public void Union_Partial()
        {
            ...
            string[] f2 = unix
                ? new string[] { "/dir/partial" }
                : new string[] { "c:\\dir\\partial" };
            Partial("1", f1, f2, 2);
            Partial("2", f2, f1, 2);
        ...
        public void ShortToLong()
        {
            ...
            Assert.AreEqual(
                FilePathUtil.GetLongPathName(filename),
                files[0],
