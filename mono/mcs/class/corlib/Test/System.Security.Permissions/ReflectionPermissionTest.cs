...
namespace MonoTests.System.Security.Permissions
{
    ...
    public class ReflectionPermissionTest
    {
        ...
        public void PermissionStateUnrestricted()
        {
            ...
            Assert.AreEqual(
                "true",
                (se.Attributes["Unrestricted"] as string),
                "ToXml-Unrestricted"
            );
        }
        ...
        {
            ReflectionPermission p = new ReflectionPermission(
            ...
            Assert.AreEqual(
                "TypeInformation",
                (se.Attributes["Flags"] as string),
                "ToXml-Flags=TypeInformation"
            );
        }
        ...
        public void Union()
        {
            ReflectionPermission p1 = new ReflectionPermission(
                ReflectionPermissionFlag.TypeInformation
            );
            ReflectionPermission p2 = new ReflectionPermission(
                ReflectionPermissionFlag.MemberAccess
            );
            ReflectionPermission p3 = (ReflectionPermission)p1.Union(p2);
            Assert.AreEqual(
                ReflectionPermissionFlag.MemberAccess | ReflectionPermissionFlag.TypeInformation,
                p3.Flags
            );
            ReflectionPermission p4 = new ReflectionPermission(
                ReflectionPermissionFlag.ReflectionEmit
            );
        ...
        public void Intersect()
        {
            ...
            ReflectionPermission p4 = new ReflectionPermission(
                ReflectionPermissionFlag.MemberAccess | ReflectionPermissionFlag.ReflectionEmit
            );
            p3 = (ReflectionPermission)p4.Intersect(p1);
            Assert.AreEqual(
                ReflectionPermissionFlag.MemberAccess,
                p3.Flags,
                "Intersect-MemberAccess"
            );
            // intersection in TypeInformation
            ReflectionPermission p5 = new ReflectionPermission(
                ReflectionPermissionFlag.TypeInformation | ReflectionPermissionFlag.ReflectionEmit
            );
            p3 = (ReflectionPermission)p5.Intersect(p2);
            Assert.AreEqual(
                ReflectionPermissionFlag.TypeInformation,
                p3.Flags,
                "Intersect-TypeInformation"
            );
        ...
        public void IsSubsetOf()
        {
            ...
            ReflectionPermission p3 = new ReflectionPermission(
                ReflectionPermissionFlag.ReflectionEmit
            );
