...
namespace MonoTests.System.Security.AccessControl
{
    ...
    public class RawSecurityDescriptorTest
    {
        ...
        public void GetBinaryForm()
        {
            ...
            ObjectAce objectAce = new ObjectAce(
                AceFlags.Inherited,
                AceQualifier.AccessAllowed,
                0x12345678,
                builtInAdmins,
                ObjectAceFlags.ObjectAceTypePresent | ObjectAceFlags.InheritedObjectAceTypePresent,
                new Guid("189c0dc7-b849-4dea-93a5-6d4cb8857a5c"),
                new Guid("53b4a3d4-fe39-468b-bc60-b4fcba772fa5"),
                false,
                null
            );
        ...
        public void GetSddlForm()
        {
            ...
            ace = new CommonAce(
                AceFlags.Inherited | AceFlags.ContainerInherit,
            ...
            sd.DiscretionaryAcl.InsertAce(0, ace);
            Assert.AreEqual(
                "O:BUD:(XD;CIID;0x12345678;;;S-1-5-21-324-23423-234-334)(A;;0x7fffffff;;;BA)",
            ...
            sd.DiscretionaryAcl.InsertAce(0, ace);
            Assert.AreEqual(
                "O:BUG:BAD:PARAI(A;;0x7fffffff;;;BA)S:AI",
                sd.GetSddlForm(AccessControlSections.All)
            );
