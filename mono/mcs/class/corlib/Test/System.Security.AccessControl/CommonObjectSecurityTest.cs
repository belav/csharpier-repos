...
namespace MonoTests.System.Security.AccessControl
{
    ...
    public class CommonObjectSecurityTest
    {
        ...
        public void AddAndGetAccessRulesWorkAndMergeCorrectly()
        {
            ...
            security.AddAccessRuleTest(
                new TestAccessRule<TestRights>(sid, TestRights.One, AccessControlType.Allow)
            );
            ...
            AuthorizationRuleCollection rules1 = security.GetAccessRules(
                false,
                true,
            ...
            Assert.IsFalse(security.access_rule_factory_called);
            AuthorizationRuleCollection rules2 = security.GetAccessRules(
                true,
                true,
                typeof(SecurityIdentifier)
            );
        ...
        public void AddAndPurgeWorks()
        {
            ...
            security.AddAccessRuleTest(
                new TestAccessRule<TestRights>(nta1, TestRights.One, AccessControlType.Allow)
            );
            security.AddAccessRuleTest(
                new TestAccessRule<TestRights>(nta2, TestRights.One, AccessControlType.Allow)
            );
        ...
        {
            public TestAccessRule(IdentityReference identity, T rules, AccessControlType type)
        ...
        class TestSecurity : CommonObjectSecurity
        {
            ...
            )
            {
                ...
                return new TestAccessRule<TestRights>(
                    identityReference,
            ...
            )
            {
                ...
                return new TestAuditRule<TestRights>(
                    identityReference,
                    (TestRights)accessMask,
                    inheritanceFlags,
                    propagationFlags,
