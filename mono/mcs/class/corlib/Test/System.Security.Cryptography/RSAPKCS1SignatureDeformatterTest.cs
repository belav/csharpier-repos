...
namespace MonoTests.System.Security.Cryptography
{
    ...
    {
        private static byte[] shaSignature =
        {
            0x51,
            0xE1,
            0x69,
        ...
        public void VerifySHA1SignatureWithNullKey()
        {
            ...
            try
            {
                ...
                Assert.Fail(
                    "VerifySHA1SignatureWithNullKey - Expected CryptographicUnexpectedOperationException but none"
                );
            }
            ...
            {
                Assert.Fail(
                    "VerifySHA1SignatureWithNullKey - Expected CryptographicUnexpectedOperationException but got: "
                        + e.ToString()
                );
            }
        }
        ...
        public void VerifySignatureHashNoKey()
        {
            ...
            try
            {
                ...
                fmt.VerifySignature(hash, shaSignature);
                Assert.Fail(
                    "VerifySignatureHashNoKey - Expected CryptographicUnexpectedOperationException but none"
                );
            }
            catch (CryptographicUnexpectedOperationException)
            {
            ...
            {
                Assert.Fail(
                    "VerifySignatureHashNoKey - Expected CryptographicUnexpectedOperationException but got: "
                        + e.ToString()
                );
            }
        }
        ...
        public void VerifySignatureSHA1HashBadSignatureLength()
        {
            ...
            try
            {
                fmt.VerifySignature(hash, badSignature);
                Assert.Fail(
                    "VerifySignatureSHA1HashBadSignatureLength - Expected CryptographicUnexpectedOperationException but none"
                );
            }
            catch (CryptographicUnexpectedOperationException)
            {
            ...
            {
                Assert.Fail(
                    "VerifySignatureSHA1HashBadSignatureLength - Expected CryptographicUnexpectedOperationException but got: "
                        + e.ToString()
                );
            }
        }
        ...
        public void VerifyBadSignatureMD5Hash()
        {
            ...
            try
            {
                fmt.VerifySignature(hash, badSignature);
                Assert.Fail(
                    "VerifyBadSignatureMD5Hash - Expected CryptographicUnexpectedOperationException but none"
                );
            }
            catch (CryptographicUnexpectedOperationException)
            {
            ...
            {
                Assert.Fail(
                    "VerifyBadSignatureMD5Hash - Expected CryptographicUnexpectedOperationException but got: "
                        + e.ToString()
                );
            }
        }
        ...
        public void VerifySignatureMD5HashBadSignatureLength()
        {
            ...
            try
            {
                fmt.VerifySignature(hash, badSignature);
                Assert.Fail(
                    "VerifySignatureMD5HashBadSignatureLength - Expected CryptographicUnexpectedOperationException but none"
                );
            }
            catch (CryptographicUnexpectedOperationException)
            {
            ...
            {
                Assert.Fail(
                    "VerifySignatureMD5HashBadSignatureLength - Expected CryptographicUnexpectedOperationException but got: "
                        + e.ToString()
                );
            }
        }
