...
namespace MonoTests.System.Security.Cryptography
{
    ...
    public class RijndaelManagedTest
    {
        ...
        public void ECB()
        {
            ...
            r.KeySize = 128;
            CheckECBRoundtrip(
                r.CreateEncryptor(key16, iv),
                r.CreateDecryptor(key16, iv),
                plaintext,
                exp16
            );
            ...
            r.KeySize = 192;
            CheckECBRoundtrip(
                r.CreateEncryptor(key24, iv),
                r.CreateDecryptor(key24, iv),
                plaintext,
                exp24
            );
            ...
            r.KeySize = 256;
            CheckECBRoundtrip(
                r.CreateEncryptor(key32, iv),
                r.CreateDecryptor(key32, iv),
                plaintext,
                exp32
            );
        }
        ...
        public void CreateEncryptor_IvNull()
        {
            ...
            Assert.IsFalse(
                BitConverter.ToString(data) == BitConverter.ToString(decdata),
                "Compare"
            );
