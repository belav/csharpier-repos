    ...
    public class SymmetricAlgorithmTest
    {
        ...
        public void TestRijndael_k128b128_ECB_Zeros()
        {
            ...
            catch (Exception e)
            {
                if (e.Message != "Input buffer contains insufficient data. ")
                    Assert.Fail(
                        "Rijndael_k128b128_ECB_Zeros: This isn't the expected exception: "
                            + e.ToString()
                    );
            }
        }
        ...
        public void TestRijndael_k128b128_CBC_Zeros()
        {
            ...
            catch (Exception e)
            {
                if (e.Message != "Input buffer contains insufficient data. ")
                    Assert.Fail(
                        "Rijndael_k128b128_CBC_Zeros: This isn't the expected exception: "
                            + e.ToString()
                    );
            }
        }
        ...
        public void TestRijndael_k128b192_ECB_Zeros()
        {
            ...
            catch (Exception e)
            {
                if (e.Message != "Input buffer contains insufficient data. ")
                    Assert.Fail(
                        "Rijndael_k128b192_ECB_Zeros: This isn't the expected exception: "
                            + e.ToString()
                    );
            }
        }
        ...
        public void TestRijndael_k128b192_CBC_Zeros()
        {
            ...
            catch (Exception e)
            {
                if (e.Message != "Input buffer contains insufficient data. ")
                    Assert.Fail(
                        "Rijndael_k128b192_CBC_Zeros: This isn't the expected exception: "
                            + e.ToString()
                    );
            }
        }
        ...
        public void TestRijndael_k128b256_ECB_Zeros()
        {
            ...
            catch (Exception e)
            {
                if (e.Message != "Input buffer contains insufficient data. ")
                    Assert.Fail(
                        "Rijndael_k128b256_ECB_Zeros: This isn't the expected exception: "
                            + e.ToString()
                    );
            }
        }
        ...
        public void TestRijndael_k128b256_CBC_Zeros()
        {
            ...
            catch (Exception e)
            {
                if (e.Message != "Input buffer contains insufficient data. ")
                    Assert.Fail(
                        "Rijndael_k128b256_CBC_Zeros: This isn't the expected exception: "
                            + e.ToString()
                    );
            }
        }
        ...
        public void TestRijndael_k192b128_ECB_Zeros()
        {
            ...
            catch (Exception e)
            {
                if (e.Message != "Input buffer contains insufficient data. ")
                    Assert.Fail(
                        "Rijndael_k192b128_ECB_Zeros: This isn't the expected exception: "
                            + e.ToString()
                    );
            }
        }
        ...
        public void TestRijndael_k192b128_CBC_Zeros()
        {
            ...
            catch (Exception e)
            {
                if (e.Message != "Input buffer contains insufficient data. ")
                    Assert.Fail(
                        "Rijndael_k192b128_CBC_Zeros: This isn't the expected exception: "
                            + e.ToString()
                    );
            }
        }
        ...
        public void TestRijndael_k192b192_ECB_Zeros()
        {
            ...
            catch (Exception e)
            {
                if (e.Message != "Input buffer contains insufficient data. ")
                    Assert.Fail(
                        "Rijndael_k192b192_ECB_Zeros: This isn't the expected exception: "
                            + e.ToString()
                    );
            }
        }
        ...
        public void TestRijndael_k192b192_CBC_Zeros()
        {
            ...
            catch (Exception e)
            {
                if (e.Message != "Input buffer contains insufficient data. ")
                    Assert.Fail(
                        "Rijndael_k192b192_CBC_Zeros: This isn't the expected exception: "
                            + e.ToString()
                    );
            }
        }
        ...
        public void TestRijndael_k192b256_ECB_Zeros()
        {
            ...
            catch (Exception e)
            {
                if (e.Message != "Input buffer contains insufficient data. ")
                    Assert.Fail(
                        "Rijndael_k192b256_ECB_Zeros: This isn't the expected exception: "
                            + e.ToString()
                    );
            }
        }
        ...
        public void TestRijndael_k192b256_CBC_Zeros()
        {
            ...
            catch (Exception e)
            {
                if (e.Message != "Input buffer contains insufficient data. ")
                    Assert.Fail(
                        "Rijndael_k192b256_CBC_Zeros: This isn't the expected exception: "
                            + e.ToString()
                    );
            }
        }
        ...
        public void TestRijndael_k256b128_ECB_Zeros()
        {
            ...
            catch (Exception e)
            {
                if (e.Message != "Input buffer contains insufficient data. ")
                    Assert.Fail(
                        "Rijndael_k256b128_ECB_Zeros: This isn't the expected exception: "
                            + e.ToString()
                    );
            }
        }
        ...
        public void TestRijndael_k256b128_CBC_Zeros()
        {
            ...
            catch (Exception e)
            {
                if (e.Message != "Input buffer contains insufficient data. ")
                    Assert.Fail(
                        "Rijndael_k256b128_CBC_Zeros: This isn't the expected exception: "
                            + e.ToString()
                    );
            }
        }
        ...
        public void TestRijndael_k256b192_ECB_Zeros()
        {
            ...
            catch (Exception e)
            {
                if (e.Message != "Input buffer contains insufficient data. ")
                    Assert.Fail(
                        "Rijndael_k256b192_ECB_Zeros: This isn't the expected exception: "
                            + e.ToString()
                    );
            }
        }
        ...
        public void TestRijndael_k256b192_CBC_Zeros()
        {
            ...
            catch (Exception e)
            {
                if (e.Message != "Input buffer contains insufficient data. ")
                    Assert.Fail(
                        "Rijndael_k256b192_CBC_Zeros: This isn't the expected exception: "
                            + e.ToString()
                    );
            }
        }
        ...
        public void TestRijndael_k256b256_ECB_Zeros()
        {
            ...
            catch (Exception e)
            {
                if (e.Message != "Input buffer contains insufficient data. ")
                    Assert.Fail(
                        "Rijndael_k256b256_ECB_Zeros: This isn't the expected exception: "
                            + e.ToString()
                    );
            }
        }
        ...
        public void TestRijndael_k256b256_CBC_Zeros()
        {
            ...
            catch (Exception e)
            {
                if (e.Message != "Input buffer contains insufficient data. ")
                    Assert.Fail(
                        "Rijndael_k256b256_CBC_Zeros: This isn't the expected exception: "
                            + e.ToString()
                    );
            }
        }
