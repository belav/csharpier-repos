...
namespace MonoTests.System.Security.Cryptography
{
    ...
    public class SignatureDescriptionTest
    {
        ...
        public void DSASignatureDescription()
        {
            ...
            SignatureDescription sd = (SignatureDescription)
            ...
            Assert.AreEqual(
                "System.Security.Cryptography.DSASignatureDeformatter",
                sd.DeformatterAlgorithm
            );
            Assert.AreEqual(
                "System.Security.Cryptography.DSASignatureFormatter",
                sd.FormatterAlgorithm
            );
            Assert.AreEqual(
                "System.Security.Cryptography.DSACryptoServiceProvider",
                sd.KeyAlgorithm
        ...
        void RSASignatureDescriptionCore(
            string name,
            string expectedDigestAlgorithm,
            string expectedSelectedDigestAlgorithm
        )
        {
            // internal class - we cannot create one without CryptoConfig
