...
namespace MonoTests.System.Security.Cryptography
{
    ...
    public class RandomNumberGeneratorTest
    {
        ...
        public void Runs()
        {
            ...
            Assert.IsTrue(
                ((runs[0, 0] >= 2315) && (runs[0, 0] <= 2685)),
                name + " 0-Runs length=1: " + runs[0, 0]
            );
            Assert.IsTrue(
                ((runs[1, 0] >= 1114) && (runs[1, 0] <= 1386)),
                name + " 0-Runs length=2: " + runs[1, 0]
            );
            Assert.IsTrue(
                ((runs[2, 0] >= 527) && (runs[2, 0] <= 723)),
                name + " 0-Runs length=3: " + runs[2, 0]
            );
            Assert.IsTrue(
                ((runs[3, 0] >= 240) && (runs[3, 0] <= 384)),
                name + " 0-Runs length=4: " + runs[3, 0]
            );
            Assert.IsTrue(
                ((runs[4, 0] >= 103) && (runs[4, 0] <= 209)),
                name + " 0-Runs length=5: " + runs[4, 0]
            );
            Assert.IsTrue(
                ((runs[5, 0] >= 103) && (runs[5, 0] <= 209)),
                name + " 0-Runs length=6+ " + runs[5, 0]
            );
            // check for runs of ones
            Assert.IsTrue(
                ((runs[0, 1] >= 2315) && (runs[0, 1] <= 2685)),
                name + " 1-Runs length=1: " + runs[0, 1]
            );
            Assert.IsTrue(
                ((runs[1, 1] >= 1114) && (runs[1, 1] <= 1386)),
                name + " 1-Runs length=2: " + runs[1, 1]
            );
            Assert.IsTrue(
                ((runs[2, 1] >= 527) && (runs[2, 1] <= 723)),
                name + " 1-Runs length=3: " + runs[2, 1]
            );
            Assert.IsTrue(
                ((runs[3, 1] >= 240) && (runs[3, 1] <= 384)),
                name + " 1-Runs length=4: " + runs[3, 1]
            );
            Assert.IsTrue(
                ((runs[4, 1] >= 103) && (runs[4, 1] <= 209)),
                name + " 1-Runs length=5: " + runs[4, 1]
            );
            Assert.IsTrue(
                ((runs[5, 1] >= 103) && (runs[5, 1] <= 209)),
                name + " 1-Runs length=6+ " + runs[5, 1]
            );
        }
