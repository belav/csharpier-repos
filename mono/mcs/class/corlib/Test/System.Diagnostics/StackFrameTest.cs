...
namespace MonoTests.System.Diagnostics
{
    ...
    public class StackFrameTest1
    {
        ...
        {
            Assert.AreEqual("dir/someFile", frame1.GetFileName(), "File name (1)");

            Assert.AreEqual("SomeFile2.cs", frame2.GetFileName(), "File name (2)");
        }
        ...
        {
            Assert.AreEqual(13, frame1.GetFileLineNumber(), "Line number (1)");

            Assert.AreEqual(24, frame2.GetFileLineNumber(), "Line number (2)");
        }
        ...
        {
            Assert.AreEqual(45, frame1.GetFileColumnNumber(), "Column number (1)");

            Assert.AreEqual(0, frame2.GetFileColumnNumber(), "Column number (2)");
        }
        ...
        public void TestGetMethod()
        {
            ...
            Assert.AreEqual("SetUp", frame1.GetMethod().Name, "Method name (1)");
            ...
            Assert.AreEqual("SetUp", frame2.GetMethod().Name, "Method name (2)");
        }
    }
    ...
    public class StackFrameTest2
    {
        ...
        public void TestGetFileLineNumber()
        {
            ...
            Assert.AreEqual(138, frame2.GetFileLineNumber(), "Line number (2)");

            Assert.AreEqual(0, frame3.GetFileLineNumber(), "Line number (3)");
        }
        ...
        public void TestGetFileColumnNumber()
        {
            Assert.AreEqual(0, frame1.GetFileColumnNumber(), "Column number (1)");

            Assert.AreEqual(4, frame2.GetFileColumnNumber(), "Column number (2)");

            Assert.AreEqual(0, frame3.GetFileColumnNumber(), "Column number (3)");
        }
        ...
        public void TestGetMethod()
        {
            Assert.IsNotNull(frame1.GetMethod(), "Method not null (1)");
            ...
            Assert.IsNotNull(frame2.GetMethod(), "Method not null (2)");
            ...
            Assert.IsNotNull(frame3.GetMethod(), "Method not null (3)");
            ...
            Assert.AreEqual("SetUp", frame3.GetMethod().Name, "Method name (3)");
        }
    }
    ...
    public class StackFrameTest3
    {
        ...
        public void TestGetFileName()
        {
            ...
            Assert.IsNotNull(frame2.GetFileName(), "File name (2) should not be null");
        ...
        public void TestGetFileLineNumber()
        {
            ...
            Assert.AreEqual(276, frame2.GetFileLineNumber(), "Line number (2)");
        }
