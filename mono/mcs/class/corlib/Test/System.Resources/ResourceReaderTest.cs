...
namespace MonoTests.System.Resources
{
    ...
    public class ResourceReaderTest
    {
        ...
        {
            m_ResourceFile = TestResourceHelper.GetFullPathOfResource(
                "Test/resources/MyResources.resources"
            );
            m_BadResourceFile = TestResourceHelper.GetFullPathOfResource(
        ...
        public void ConstructorString()
        {
            ...
            {
                Assert.Fail(
                    "Resource file is not where it should be:"
                        + Path.Combine(Directory.GetCurrentDirectory(), m_ResourceFile)
                );
            }
        ...
        public void GetResourceDataNullName()
        {
            ResourceReader r = new ResourceReader(
                TestResourceHelper.GetFullPathOfResource("Test/resources/StreamTest.resources")
            );
            string type;
            byte[] bytes;
