...
namespace MonoTests.System.Collections
{
    ...
    public class HashtableTest
    {
        ...
        public void TestCtor5()
        {
            ...
            try
            {
                ...
                Assert.Fail(
                    "must throw ArgumentOutOfRange exception, param: loadFactor, too low value"
                );
            }
            catch (ArgumentOutOfRangeException e)
            {
            ...
            try
            {
                ...
                Assert.Fail(
                    "must throw ArgumentOutOfRange exception, param: loadFactor, too high value"
                );
            }
            catch (ArgumentOutOfRangeException e)
            {
        ...
        static IEqualityComparer GetEqualityComparer(Hashtable h)
        {
            return (IEqualityComparer)
                typeof(Hashtable)
                    .GetField("_keycomparer", BindingFlags.NonPublic | BindingFlags.Instance)
                    .GetValue(h);
        }
        ...
        public void TestContains()
        {
            ...
            }
            {
                ...
                for (int i = 0; i < 10000; i += 2)
                {
                    ...
                    Assert.IsTrue(
                        !h.Contains(i + 1),
                        "hashtable does not contain " + ((int)(i + 1)).ToString()
                    );
                }
            }
        }
        ...
        public void TestUnderHeavyLoad()
        {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                String err =
                    "ht[\"" + key + "\"]=\"" + val + "\", expected \"" + cache[i + max] + "\"";
        ...
        public void TestCaseInsensitive()
        {
            ...
            Hashtable ciHashtable = new Hashtable(
                11,
                1.0f,
        ...
        public void SerializableSubClasses()
        {
            ...
            Assert.IsTrue(
                ht.GetEnumerator().GetType().IsSerializable,
                "GetEnumerator.IsSerializable"
            );
            Assert.IsTrue(
                Hashtable.Synchronized(ht).GetType().IsSerializable,
                "Synchronized.IsSerializable"
            );
        }
    ...
    class IDHashtable : Hashtable
    {
        ...
        public IDHashtable()
            : base(new IDHashCodeProvider(), new IDComparer()) { }
    }
