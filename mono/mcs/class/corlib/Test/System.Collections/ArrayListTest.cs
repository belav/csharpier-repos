        ...
        {
            {
                ...
                try
                {
                    ArrayList al1 = ArrayList.FixedSize(new ArrayList());
                    al1.Add("Hi!");
                }
            ...
            }
            {
                ...
                for (int i = 0; i < 3; i++)
                {
                    Assert.AreEqual(
                        chars[i + 3],
                        new_chars[i],
                        "range.ToArray with type didn't work"
                    );
                }
            }
        }
        ...
        {
            {
                ...
                try
                {
                    ArrayList al1 = ArrayList.FixedSize(new ArrayList(3));
                    al1.Remove(1);
                }
                catch (NotSupportedException)
                {
            ...
            }
            {
                ...
                try
                {
                    ArrayList al1 = ArrayList.ReadOnly(new ArrayList(3));
                    al1.Remove(1);
                }
                catch (NotSupportedException)
                {
