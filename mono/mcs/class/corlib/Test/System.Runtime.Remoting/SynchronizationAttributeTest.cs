...
namespace MonoTests.System.Runtime.Remoting
{
    ...
    class SincroBase : ContextBoundObject
    {
        ...
        public SynchRes CheckContext(Context ctx)
        {
            ...
            if (thisp == null)
                return SynchRes.NoSync;
            if (thisp == otherp)
                return SynchRes.SameSync;
        ...
        {
            SynchronizationAttribute thisp = (SynchronizationAttribute)
                Thread.CurrentContext.GetProperty("Synchronization");
            thisp.Locked = b;
        }
