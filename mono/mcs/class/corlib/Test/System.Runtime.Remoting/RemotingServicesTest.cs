...
namespace MonoTests.System.Runtime.Remoting
{
    ...
    public class RemotingServicesTest
    {
        ...
        {
            public void Init(
                CrossDomainSerializedObject applicationDependencies
            ) // racy exception here
            { }
        }
        ...
        private static void AppDomainWithRemotingSerialization(Assembly assembly, string name)
        {
            ...
            var appDomainObject = (AppDomainObject)
                appDomain.CreateInstanceAndUnwrap(
                    assembly.GetName().Name,
                    typeof(AppDomainObject).FullName
                );
        ...
        public void Bug46473() // concurrent serialization/deserialization
        {
            ...
            for (int i = 0; i < tasks.Length; i++)
            {
                ...
                tasks[i] = Task.Factory
                    .StartNew(() => AppDomainWithRemotingSerialization(assembly, name));
            }
