...
namespace MonoTests.System.Reflection.Emit
{
    public abstract class MethodBuilderTestIL
    {
        ...
        public void CallMethodRef()
        {
            ...
            var methodBuilder1 = typeBuilder.DefineMethod(
                "NewMethod1",
            ...
            var methodBuilder2 = typeBuilder.DefineMethod(
                "NewMethod2",
                MethodAttributes.Public | MethodAttributes.Static,
                typeof(string),
                Type.EmptyTypes
        ...
        public void CallMethodDef()
        {
            ...
            var methodBuilder1 = typeBuilder1.DefineMethod(
                "NewMethod1",
                MethodAttributes.Public | MethodAttributes.Static,
                typeof(string),
                Type.EmptyTypes
            ...
            var methodBuilder2 = typeBuilder2.DefineMethod(
                "NewMethod2",
                MethodAttributes.Public | MethodAttributes.Static,
                typeof(string),
                Type.EmptyTypes
