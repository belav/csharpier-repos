...
namespace MonoTests.System.Reflection.Emit
{
    ...
    public class DynamicMethodTest
    {
        ...
        public void DynamicMethodReference()
        {
            ...
            DynamicMethod write = new DynamicMethod(
                "Write",
                typeof(int),
                new Type[] { typeof(string) },
                typeof(DynamicMethodTest)
            ...
            HelloInvoker hi = (HelloInvoker)hello.CreateDelegate(typeof(HelloInvoker));
        ...
        public void SkipVisibility()
        {
            ...
            helloIL.EmitCall(
                OpCodes.Call,
                typeof(DynamicMethodTest).GetMethod(
                    "private_method",
            ...
            ReturnString del = (ReturnString)hello.CreateDelegate(typeof(ReturnString));
        ...
        {
            DynamicMethod m1 = new DynamicMethod(
                "f1",
                typeof(int),
                new Type[] { typeof(int) },
                typeof(object)
            );
            DynamicMethod m2 = new DynamicMethod(
                "f2",
                typeof(int),
                new Type[] { typeof(int) },
                typeof(object)
...
#pragma warning restore 414
        ...
        public void GetCustomAttributes()
        {
            ...
            Assert.IsTrue(
                method.IsDefined(methodImplAttrType, true),
                "MethodImplAttribute is defined"
            );
            ...
            Assert.AreEqual(
                Array.Empty<object>(),
                method.GetCustomAttributes(extensionAttrType, true)
            );
        }
        ...
        public void ExceptionHandling()
        {
            ...
            var lines = ExceptionHandling_Test_Support.CaughtStackTrace
        ...
        public void ExceptionHandlingWithExceptionDispatchInfo()
        {
            ...
            ig.Emit(
                OpCodes.Call,
                typeof(ExceptionHandlingWithExceptionDispatchInfo_Test_Support).GetMethod("ThrowMe")
            );

            ig.BeginCatchBlock(typeof(Exception));
            ig.Emit(
                OpCodes.Call,
                typeof(ExceptionHandlingWithExceptionDispatchInfo_Test_Support).GetMethod("Handler")
            );
            ig.EndExceptionBlock();
        ...
        public void ExceptionWrapping()
        {
            ...
            AssemblyBuilder ab2 = AppDomain.CurrentDomain
            ...
            AssemblyBuilder ab3 = AppDomain.CurrentDomain
            ...
            DynamicMethod invoke_with_module = new DynamicMethod(
                "throw_2",
                typeof(int),
                new Type[0],
                typeof(DynamicMethodTest).Module
            );
            DynamicMethod invoke_with_ab = new DynamicMethod(
                "throw_3",
                typeof(int),
                new Type[0],
                ab.ManifestModule
            );
            DynamicMethod invoke_with_ab2 = new DynamicMethod(
                "throw_4",
                typeof(int),
                new Type[0],
                ab2.ManifestModule
            );
            DynamicMethod invoke_with_ab3 = new DynamicMethod(
                "throw_5",
                typeof(int),
                new Type[0],
                ab3.ManifestModule
        ...
        public void TypedRef()
        {
            ...
            il.Emit(
                OpCodes.Call,
                GetType().GetMethod("AssertTypedRef", BindingFlags.NonPublic | BindingFlags.Static)
            );
            ...
            var f =
                (Func<TypedRefTarget, TypedRefTarget>)
                    method.CreateDelegate(typeof(Func<TypedRefTarget, TypedRefTarget>));
        ...
        static Action GenerateProblematicMethod(
            bool add_extra,
            bool mismatch = false,
            bool use_vts = false
        )
