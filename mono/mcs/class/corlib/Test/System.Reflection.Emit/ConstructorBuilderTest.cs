    ...
    public class ConstructorBuilderTest
    {
        ...
        public void CallingConvention()
        {
            ...
            */
            ...
            Assert.AreEqual(CallingConventions.Standard, cb4.CallingConvention, "#2");
        }
        ...
        {
            ConstructorBuilder cb = genClass.DefineConstructor(0, 0, new Type[1] { typeof(int) });
            cb.GetILGenerator().Emit(OpCodes.Ret);
        ...
        public void TestMethodImplementationFlags()
        {
            ...
            Assert.AreEqual(MethodImplAttributes.OPTIL, cb.GetMethodImplementationFlags(), "#A2");

            // Can not be called on a created type
            TypeBuilder tb = module.DefineType(genTypeName(), TypeAttributes.Public);
            ConstructorBuilder cb2 = tb.DefineConstructor(0, 0, new Type[0]);
        ...
        public void SetCustomAttribute1()
        {
            ...
            Type attrType = Type.GetType("System.Reflection.AssemblyKeyNameAttribute");
        ...
        public void SetCustomAttribute2()
        {
            ...
            TypeBuilder attrTb = module.DefineType(
                "TestAttribute",
                TypeAttributes.Public,
                typeof(Attribute)
            );
            ConstructorBuilder attrCb = attrTb.DefineDefaultConstructor(MethodAttributes.Public);

            CustomAttributeBuilder cab = new CustomAttributeBuilder(attrCb, new object[0]);
            cb.SetCustomAttribute(cab);
            attrTb.CreateType();

            Type emittedType = genClass.CreateType();
            ConstructorInfo ci = emittedType.GetConstructor(new Type[1] { typeof(int) });
