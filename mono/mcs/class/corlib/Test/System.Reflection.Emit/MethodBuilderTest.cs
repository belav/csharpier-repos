...
namespace MonoTests.System.Reflection.Emit
{
    ...
    public class MethodBuilderTest
    {
        ...
        {
            MethodBuilder mb = genClass.DefineMethod(genMethodName(), 0, typeof(void), new Type[0]);
            Assert.AreEqual(
                CallingConventions.Standard | CallingConventions.HasThis,
                mb.CallingConvention,
                "CallingConvetion defaults to Standard+HasThis"
            );
        ...
        public void TestName()
        {
            ...
            MethodBuilder mb = genClass.DefineMethod(name, 0, typeof(void), new Type[0]);
        ...
        public void TestReturnType()
        {
            ...
            MethodBuilder mb2 = genClass.DefineMethod(genMethodName(), 0, null, new Type[0]);
        ...
        */
        ...
        public void TestCreateMethodBody()
        {
            ...
            MethodBuilder mb2 = tb.DefineMethod(genMethodName(), 0, typeof(void), new Type[0]);
        ...
        {
            TypeBuilder tb = module.DefineType(genTypeName(), TypeAttributes.Public);
            MethodBuilder mb = tb.DefineMethod(genMethodName(), 0, typeof(void), new Type[0]);
        ...
        public void SetCustomAttribute_DllImport_DllName_Empty()
        {
            ...
            {
                mb.SetCustomAttribute(
                    new CustomAttributeBuilder(ctorInfo, new object[] { string.Empty })
                );
                Assert.Fail("#1");
            }
        ...
        public void SetCustomAttribute_DllImport_DllName_Null()
        {
            ...
            try
            {
                mb.SetCustomAttribute(new CustomAttributeBuilder(ctorInfo, new object[] { null }));
                Assert.Fail("#1");
            }
            catch (ArgumentException ex)
            {
        ...
        public void SetCustomAttribute_SuppressUnmanagedCodeSecurity()
        {
            ...
            ConstructorInfo attrCtor =
                typeof(SuppressUnmanagedCodeSecurityAttribute).GetConstructor(new Type[0]);
            ...
            Assert.AreEqual(
                ...
                emittedMethod.Attributes & MethodAttributes.HasSecurity,
                "#3"
            );
            //Assert.IsTrue ((mb.Attributes & MethodAttributes.HasSecurity) == 0, "#4");
            object[] emittedAttrs = emittedMethod.GetCustomAttributes(
        ...
        public void GetCustomAttributes()
        {
            ...
            mb.SetCustomAttribute(
                new CustomAttributeBuilder(
                    typeof(PrivateAttribute).GetConstructor(new Type[0]),
                    new object[] { }
                )
            );
        ...
        public void TestDynamicParams()
        {
            ...
            pb.SetCustomAttribute(
                new CustomAttributeBuilder(
                    typeof(ParamAttribute).GetConstructors()[0],
                    new object[] { }
                )
            );
        ...
        public void SetCustomAttribute_DllImport1()
        {
            ...
            DllImportAttribute attr = (DllImportAttribute)(
                (t.GetMethod(mname).GetCustomAttributes(typeof(DllImportAttribute), true))[0]
            );
        ...
        public void ILGen_InstantiatedGenericType()
        {
            ...
            Type genericFoo = typeof(GenericFoo<int>)
                .GetGenericTypeDefinition()
                .MakeGenericType(new Type[] { pars[0] });
        ...
        public void ILGen_InstantiatedTypeBuilder()
        {
            ...
            MethodInfo mi2 = mi.MakeGenericMethod(new Type[] { typeof(int) });
            Assert.AreEqual(
                generatedGenericType.MakeGenericType(new Type[] { typeof(int) }),
                mi2.Invoke(null, new object[] { 1 })
            );
        }
        ...
        public void CanCallVarargMethods()
        {
            ...
            il.EmitCall(
                OpCodes.Call,
                miVarargMethod,
                new Type[] { typeof(DateTime), typeof(string), typeof(DateTime), typeof(string) }
            );
            il.Emit(OpCodes.Ret);
        ...
        public void ParamerersOfGenericArgumentsAreProperlyEncoded()
        {
            ...
            Assert.AreEqual(
                re_foo_open.GetGenericArguments()[0],
                re_foo_open.GetParameters()[0].ParameterType,
                "#1"
            );
        }
        ...
        public void ArrayOfGenericParam()
        {
            ...
            var testMethod = tb.DefineMethod(
                "Method",
                MethodAttributes.Public
