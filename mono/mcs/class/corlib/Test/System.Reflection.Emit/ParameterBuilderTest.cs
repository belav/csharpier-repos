...
namespace MonoTests.System.Reflection.Emit
{
    ...
    public class ParameterBuilderTest
    {
        ...
        public void ParameterBuilderSetConstant_Bug3912()
        {
            ...
            var eb = mb.DefineEnum("TestEnum", TypeAttributes.Public, typeof(int));
        ...
        public void SetConstantNullable()
        {
            ...
            var paramTypes = new[] { typeof(int?), typeof(int?), typeof(E?), typeof(E?) };

            var methb = tb.DefineMethod(
                "Method",
