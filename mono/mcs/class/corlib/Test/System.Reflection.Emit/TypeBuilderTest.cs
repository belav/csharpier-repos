...
namespace MonoTests.System.Reflection.Emit
{
    ...
    public class TypeBuilderTest
    {
        ...
        protected void SetUp()
        {
            ...
            assembly = Thread
                .GetDomain()
                .DefineDynamicAssembly(assemblyName, AssemblyBuilderAccess.RunAndSave, tempDir);
        ...
        public void TestAssemblyQualifiedName()
        {
            ...
            Assert.AreEqual("A.B.C.D, " + assembly.GetName().FullName, tb.AssemblyQualifiedName);
        }
        ...
        {
            TypeBuilder tb3 = module.DefineType(
                genTypeName(),
        ...
        {
            Type[] badTypes = { typeof(object), typeof(string), typeof(DateTime) };
        ...
        {
            TypeBuilder enumToCreate = module.DefineType(
                genTypeName(),
                TypeAttributes.Public,
                typeof(Enum)
            );
            enumToCreate.DefineField(
                "value__",
                typeof(Int32),
                FieldAttributes.Public | FieldAttributes.SpecialName | FieldAttributes.RTSpecialName
            );

            TypeBuilder enumToCreate2 = module.DefineType(
                genTypeName(),
                TypeAttributes.Public,
                typeof(Enum)
            );
            ...
            enumToCreate2.DefineField(
                "value__",
                typeof(Int32),
                FieldAttributes.Public | FieldAttributes.SpecialName | FieldAttributes.RTSpecialName
            );

            FieldBuilder fb = enumToCreate2.DefineField(
                "A",
                enumToCreate,
        ...
        public void TestIsClass()
        {
            ...
            TypeBuilder tb2 = module.DefineType(
                genTypeName(),
                TypeAttributes.Interface | TypeAttributes.Abstract
            );
        ...
        public void IsSerializable()
        {
            ...
            ConstructorInfo[] ctors = typeof(SerializableAttribute).GetConstructors(
        ...
        public void SetParent_Parent_Null()
        {
            ...
            tb = module.DefineType(genTypeName(), TypeAttributes.Interface, typeof(IDisposable));
            try
            {
                tb.SetParent(null);
                Assert.Fail("#D1");
        ...
        public void DefineDefaultConstructor_Parent_DefaultCtorInaccessible()
        {
            ...
            tb = module.DefineType(genTypeName(), TypeAttributes.Class, parent_type);
        ...
        public void DefineEvent_Name_NullChar()
        {
            ...
            try
            {
                tb.DefineEvent("\0test", EventAttributes.None, typeof(int));
                Assert.Fail("#A1");
            }
            ...
            EventBuilder eb = tb.DefineEvent("te\0st", EventAttributes.None, typeof(int));
        ...
        public void DefineField1_Name_NullChar()
        {
            ...
            try
            {
                tb.DefineField("\0test", typeof(int), FieldAttributes.Private);
                Assert.Fail("#A1");
            }
            catch (ArgumentException ex)
            {
            ...
            FieldBuilder fb = tb.DefineField("te\0st", typeof(int), FieldAttributes.Private);
        ...
        public void DefineField1_Type_Null()
        {
            ...
            try
            {
                tb.DefineField("test", (Type)null, FieldAttributes.Private);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void TestDefineMethod_Abstract()
        {
            ...
            tb = module.DefineType(genTypeName(), TypeAttributes.Abstract | TypeAttributes.Public);
            tb.DefineMethod(
                "Run",
                MethodAttributes.Public | MethodAttributes.Abstract | MethodAttributes.Virtual,
                typeof(void),
        ...
        public void NestedTypeSave()
        {
            ...
            var tbuilder = tb.DefineNestedType(
                "Test.CodeGen",
                TypeAttributes.Public | TypeAttributes.Class
            );
            var entryp = tbuilder.DefineMethod(
                "Main",
                MethodAttributes.Public | MethodAttributes.Static,
                typeof(void),
                null
        ...
        public void DefineProperty_Name_NullChar()
        {
            ...
            PropertyBuilder pb = tb.DefineProperty("te\0st", 0, typeof(string), Type.EmptyTypes);
        ...
        public void TestGetMethod()
        {
            ...
            MethodBuilder mb1 = tb.DefineMethod(
                "create",
                MethodAttributes.Public | MethodAttributes.Static,
                fooOfT,
                Type.EmptyTypes
            ...
            Assert.AreEqual(
                tb.Name + "[System.Int32]",
                t2.MakeGenericType(typeof(int))
                    .GetMethod("foo")
                    .Invoke(null, null)
                    .GetType()
                    .ToString()
        ...
        public void GetConstructor2_Complete()
        {
            ...
            TypeBuilder redType = module.DefineType(genTypeName(), TypeAttributes.Public);
            CreateMembers(redType, "Red", true);

            TypeBuilder greenType = module.DefineType(
                genTypeName(),
                TypeAttributes.Public,
                redType
            );
            ...
            ctor = greenType.GetConstructor(flags, null, Type.EmptyTypes, new ParameterModifier[0]);
            Assert.IsNull(ctor, "#A7");

            ctor = redType.GetConstructor(
                flags,
                null,
                new Type[] { typeof(int), typeof(int) },
                new ParameterModifier[0]
            ...
            ctor = redType.GetConstructor(flags, null, Type.EmptyTypes, new ParameterModifier[0]);
            ...
            flags = BindingFlags.Static | BindingFlags.Public | BindingFlags.FlattenHierarchy;
            ...
            flags = BindingFlags.Static | BindingFlags.NonPublic | BindingFlags.FlattenHierarchy;
            ...
            flags = BindingFlags.Static | BindingFlags.Public | BindingFlags.DeclaredOnly;
            ...
            flags = BindingFlags.Static | BindingFlags.NonPublic | BindingFlags.DeclaredOnly;
        ...
        public void GetConstructors2_Incomplete()
        {
            ...
            try
            {
                tb.GetConstructors(BindingFlags.Public | BindingFlags.Instance);
                Assert.Fail("#1");
            }
            catch (NotSupportedException ex)
            {
        ...
        public void TestGetCustomAttributesOfTypeComplete()
        {
            ...
            Assert.AreEqual(
                0,
                tb.GetCustomAttributes(typeof(ObsoleteAttribute), false).Length,
                "#2"
            );
        }
        ...
        public void TestGetEventsComplete()
        {
            ...
            MethodBuilder onclickMethod = tb.DefineMethod(
                "OnChange",
                MethodAttributes.Public,
                typeof(void),
        ...
        public void TestGetEventsFlagsComplete()
        {
            ...
            MethodBuilder onchangeMethod = tb.DefineMethod(
                "OnChange",
                MethodAttributes.Public,
                typeof(void),
                new Type[] { typeof(Object) }
            ...
            // create public event
            EventBuilder changeEvent = tb.DefineEvent(
                "Change",
                EventAttributes.None,
                typeof(ResolveEventHandler)
            );
            ...
            EventBuilder redoChangeEvent = tb.DefineEvent(
                "RedoChange",
                EventAttributes.None,
                typeof(ResolveEventHandler)
            );
            ...
            Assert.AreEqual(
                tb.GetEvents(BindingFlags.Instance | BindingFlags.NonPublic).Length,
        ...
        public void TestGetEventsFlagsComplete_Inheritance()
        {
            ...
            TypeBuilder blueType = module.DefineType(genTypeName(), TypeAttributes.Public);
            CreateMembers(blueType, "Blue", false);

            TypeBuilder redType = module.DefineType(genTypeName(), TypeAttributes.Public, blueType);
        ...
        public void TestGetEventFlagsComplete()
        {
            ...
            Assert.AreEqual(
                tb.GetEvent("Change", BindingFlags.Instance | BindingFlags.Public),
            ...
            Assert.AreEqual(
                tb.GetEvent("Change", BindingFlags.Instance | BindingFlags.NonPublic),
        ...
        public void TestGetFieldsFlagsComplete()
        {
            ...
            Assert.AreEqual(
                tb.GetFields(BindingFlags.Instance | BindingFlags.Public).Length,
            ...
            Assert.AreEqual(
                tb.GetFields(BindingFlags.Instance | BindingFlags.NonPublic).Length,
        ...
        public void TestGetFieldFlagsIncomplete_Mono()
        {
            ...
            FieldInfo field = tb.GetField("TestField", BindingFlags.Public | BindingFlags.Instance);
            Assert.IsNotNull(field, "#A1");
            Assert.AreEqual("TestField", field.Name, "#A2");
            Assert.IsTrue(field is FieldBuilder, "#A3");

            field = tb.GetField("OtherField", BindingFlags.NonPublic | BindingFlags.Instance);
            Assert.IsNotNull(field, "#B1");
            Assert.AreEqual("OtherField", field.Name, "#B2");
            Assert.IsTrue(field is FieldBuilder, "#B3");

            Assert.IsNull(
                tb.GetField("TestField", BindingFlags.NonPublic | BindingFlags.Instance),
                "#C1"
            );
            Assert.IsNull(
                tb.GetField("TestField", BindingFlags.Public | BindingFlags.Static),
                "#C2"
            );
            Assert.IsNull(
                tb.GetField("OtherField", BindingFlags.Public | BindingFlags.Instance),
                "#C3"
            );
            Assert.IsNull(
                tb.GetField("OtherField", BindingFlags.Public | BindingFlags.Static),
                "#C4"
            );
            Assert.IsNull(
                tb.GetField("NotExist", BindingFlags.NonPublic | BindingFlags.Instance),
                "#C5"
            );
            Assert.IsNull(
                tb.GetField("NotExist", BindingFlags.Public | BindingFlags.Instance),
                "#C6"
            );
        }
        ...
        public void TestGetFieldFlagsComplete()
        {
            ...
            Assert.AreEqual(
                tb.GetField("TestField", BindingFlags.Instance | BindingFlags.Public).Name,
            ...
            Assert.AreEqual(
                tb.GetField("TestField", BindingFlags.Instance | BindingFlags.NonPublic),
        ...
        public void TestGetPropertiesFlagsIncomplete_Mono()
        {
            ...
            properties = tb.GetProperties(BindingFlags.Public | BindingFlags.Instance);
            ...
            properties = tb.GetProperties(BindingFlags.NonPublic | BindingFlags.Instance);
        ...
        public void TestGetPropertiesFlagsComplete()
        {
            ...
            Assert.AreEqual(
                1,
                tb.GetProperties(BindingFlags.Instance | BindingFlags.Public).Length
            );
            Assert.AreEqual(
                tb.GetProperties(BindingFlags.Instance | BindingFlags.Public).Length,
            ...
            Assert.AreEqual(
                0,
                tb.GetProperties(BindingFlags.Instance | BindingFlags.NonPublic).Length
            );
            Assert.AreEqual(
                tb.GetProperties(BindingFlags.Instance | BindingFlags.NonPublic).Length,
        ...
        public void TestGetPropertyFlagsComplete()
        {
            ...
            Assert.IsNotNull(
                emittedType.GetProperty("CustomerName", BindingFlags.Instance | BindingFlags.Public)
            );
            Assert.IsNull(
                emittedType.GetProperty(
                    "CustomerName",
        ...
        public void TestGetMethodsIncomplete_Mono()
        {
            ...
            TypeBuilder tb = module.DefineType(genTypeName(), TypeAttributes.Abstract);
            mb = tb.DefineMethod("Hello", MethodAttributes.Public, typeof(void), Type.EmptyTypes);
            ilgen = mb.GetILGenerator();
            ilgen.Emit(OpCodes.Ret);

            mb = tb.DefineMethod("Run", MethodAttributes.Private, typeof(void), Type.EmptyTypes);
            ilgen = mb.GetILGenerator();
            ilgen.Emit(OpCodes.Ret);
        ...
        public void TestGetMethodsComplete()
        {
            ...
            TypeBuilder tb = module.DefineType(genTypeName(), TypeAttributes.Abstract);
            mb = tb.DefineMethod("Hello", MethodAttributes.Public, typeof(string), Type.EmptyTypes);
            ilgen = mb.GetILGenerator();
            ilgen.Emit(OpCodes.Ldstr, "Hi! ");
            ilgen.Emit(OpCodes.Ldarg_1);
            MethodInfo infoMethod = typeof(string).GetMethod(
                "Concat",
                new Type[] { typeof(string), typeof(string) }
            );
        ...
        public void TestGetMethodsFlagsIncomplete_Mono()
        {
            ...
            methods = tb.GetMethods(BindingFlags.Public | BindingFlags.Instance);
        ...
        {
            TypeBuilder tb = module.DefineType(genTypeName());
            MethodBuilder helloMethod = tb.DefineMethod(
                "HelloMethod",
                MethodAttributes.Public,
                typeof(string),
                Type.EmptyTypes
            ...
            Assert.AreEqual(
                tb.GetMethods(BindingFlags.Instance | BindingFlags.Public).Length,
            ...
            Assert.AreEqual(
                tb.GetMethods(BindingFlags.Instance | BindingFlags.NonPublic).Length,
        ...
        public void TestGetMembersFlagsComplete()
        {
            ...
            Assert.AreEqual(
                tb.GetMembers(BindingFlags.Instance | BindingFlags.Public).Length,
                emittedType.GetMembers(BindingFlags.Instance | BindingFlags.Public).Length
            );
            Assert.AreEqual(
                tb.GetMembers(BindingFlags.Instance | BindingFlags.NonPublic).Length,
        ...
        public void TestGetInterfaces()
        {
            ...
            TypeBuilder tbInterface = module.DefineType(
                genTypeName(),
        ...
        public void TestEnums()
        {
            ...
            TypeBuilder enumToCreate = module.DefineType(genTypeName(), typeAttrs, typeof(Enum));
            enumToCreate.SetCustomAttribute(
                new CustomAttributeBuilder(
                    typeof(FlagsAttribute).GetConstructors()[0],
                    Type.EmptyTypes
                )
            );
            ...
            // add enum entries
            FieldBuilder fb = enumToCreate.DefineField(
                "A",
                enumToCreate,
                FieldAttributes.Public | FieldAttributes.Static | FieldAttributes.Literal
            );
        ...
        {
            TypeBuilder typeBuilder = module.DefineType(genTypeName(), TypeAttributes.Public);
        ...
        public void SetCustomAttribute_SuppressUnmanagedCodeSecurity()
        {
            ...
            CustomAttributeBuilder caBuilder = new CustomAttributeBuilder(attrCtor, new object[0]);
            ...
            Assert.AreEqual(
                ...
                emittedType.Attributes & TypeAttributes.HasSecurity,
                "#3"
            );
            //Assert.IsTrue ((tb.Attributes & TypeAttributes.HasSecurity) == 0, "#4");
            object[] emittedAttrs = emittedType.GetCustomAttributes(
        ...
        private PropertyBuilder DefineStringProperty(
            TypeBuilder tb,
            string propertyName,
            string fieldName,
        ...
        public void IsAssignableFrom_Created()
        {
            ...
            Assert.IsTrue(
                typeof(Foo[]).IsAssignableFrom(module.GetType(tb.FullName + "[]")),
                "#F1"
            );
            Assert.IsTrue(
                typeof(Bar[]).IsAssignableFrom(module.GetType(tb.FullName + "[]")),
                "#F2"
            );
            Assert.IsFalse(
                typeof(Baz[]).IsAssignableFrom(module.GetType(tb.FullName + "[]")),
                "#F3"
            );
            ...
            Assert.IsTrue(
                typeof(Foo[]).IsAssignableFrom(module.GetType(tb2.FullName + "[]")),
                "#L1"
            );
            Assert.IsTrue(
                typeof(Bar[]).IsAssignableFrom(module.GetType(tb2.FullName + "[]")),
                "#L2"
            );
            Assert.IsFalse(
                typeof(Baz[]).IsAssignableFrom(module.GetType(tb2.FullName + "[]")),
                "#L3"
            );
            ...
            Assert.IsTrue(
                typeof(Foo[]).IsAssignableFrom(module.GetType(tb3.FullName + "[]")),
                "#R1"
            );
            Assert.IsTrue(
                typeof(Bar[]).IsAssignableFrom(module.GetType(tb3.FullName + "[]")),
                "#R2"
            );
            Assert.IsFalse(
                typeof(Baz[]).IsAssignableFrom(module.GetType(tb3.FullName + "[]")),
                "#R3"
            );

            TypeBuilder tb4 = module.DefineType(
                genTypeName(),
                TypeAttributes.Public,
                null,
                new Type[] { typeof(IWater) }
        ...
        public void IsAssignableFrom_NotCreated()
        {
            TypeBuilder tb = module.DefineType(
                ...
                TypeAttributes.Public,
                typeof(MemoryStream),
                new Type[] { typeof(IThrowable), typeof(Bar), typeof(IComparable) }
            );
        ...
        public void IsAssignableFrom_NotCreated_Array()
        {
            ...
            Assert.IsTrue(typeof(Foo[]).IsAssignableFrom(module.GetType(tb.FullName + "[]")), "#1");
        ...
        public void CreateType_Interface_ParentInvalid()
        {
            ...
            tb = module.DefineType(genTypeName(), TypeAttributes.Interface, typeof(Exception));
            ...
            tb = module.DefineType(genTypeName(), TypeAttributes.Interface, typeof(object));
            ...
            tb = module.DefineType(genTypeName(), TypeAttributes.Interface, typeof(EmptyInterface));
        ...
        public void CreatedTypeInstantiationOverTypeBuilderArgsIsNotAGenericTypeDefinition()
        {
            TypeBuilder tb = module.DefineType(
                ...
                TypeAttributes.Public,
                typeof(object),
                new Type[] { typeof(IDelegateFactory) }
            );
        ...
        public void CreatedTypeAndTypeBuilderDontShareGenericArguments()
        {
            ...
            Assert.IsTrue(
                tb.GetGenericArguments()[0] != t.GetGenericArguments()[0],
                "#1 TypeBuilder and create type arguments are diferent"
            );
        }
        ...
        public void FieldOnTypeBuilderInstDontInflateWhenEncoded()
        {
            ...
            MethodBuilder main = P.DefineMethod(
                "Main",
                MethodAttributes.Public | MethodAttributes.Static
            );
            {
        ...
        public void FieldWithInitializedDataWorksWithCompilerRuntimeHelpers()
        {
            ...
            assembly = Thread
                .GetDomain()
                .DefineDynamicAssembly(
                    new AssemblyName(ASSEMBLY_NAME + "2"),
                    AssemblyBuilderAccess.RunAndSave,
                    tempDir
                );
            module = assembly.DefineDynamicModule("Instance.exe");
            ...
            MethodBuilder mb = tb2.DefineMethod(
                "Test",
                MethodAttributes.Public | MethodAttributes.Static,
                typeof(object),
                new Type[0]
        ...
        public void CreateTypeFailsWithInvalidMethodOverride()
        {
            ...
            MethodBuilder mc = tb.DefineMethod(
                "Create",
                MethodAttributes.Public,
                typeof(Delegate),
        ...
        public void GetCustomAttrOnFieldOfInflatedType()
        {
            ...
            fi = t.MakeGenericType(typeof(int))
        ...
        public void GetCustomAttrOnPropertyOfInflatedType()
        {
            ...
            PropertyBuilder property = DefineStringProperty(
                tb,
                "Name",
                "name",
                MethodAttributes.Public
        ...
        public void GetCustomAttrOnEventOfInflatedType()
        {
            ...
            ei = t.MakeGenericType(typeof(int))
                .GetEvents(BindingFlags.NonPublic | BindingFlags.Instance)[0];
        ...
        public void TestGenericFieldAccess() // bug #467415
        {
            ...
            AssemblyBuilder demoAssembly = domain.DefineDynamicAssembly(
                asmName,
                AssemblyBuilderAccess.RunAndSave
            );
            ...
            ModuleBuilder demoModule = demoAssembly.DefineDynamicModule(
                asmName.Name,
                asmName.Name + ".dll"
            );
            ...
            MethodBuilder factory = demoType.DefineMethod(
                "Factory",
                MethodAttributes.Public | MethodAttributes.Static
            );

            string[] typeParameterNames = { "T" };
            GenericTypeParameterBuilder[] typeParameters = factory.DefineGenericParameters(
                typeParameterNames
            );
        ...
        void CreateMembers(TypeBuilder tb, string suffix, bool defineCtors)
        {
            ...
            tb.DefineField("privateInstance" + suffix, typeof(string), FieldAttributes.Private);
            tb.DefineField("familyInstance" + suffix, typeof(string), FieldAttributes.Family);
            tb.DefineField(
                "famANDAssemInstance" + suffix,
                typeof(string),
                FieldAttributes.FamANDAssem
            );
            tb.DefineField(
                "famORAssemInstance" + suffix,
                typeof(string),
                FieldAttributes.FamORAssem
            );
            tb.DefineField("publicInstance" + suffix, typeof(string), FieldAttributes.Public);
            tb.DefineField("assemblyInstance" + suffix, typeof(string), FieldAttributes.Assembly);
            ...
            tb.DefineField(
                "famANDAssemStatic" + suffix,
                typeof(string),
                FieldAttributes.FamANDAssem | FieldAttributes.Static
            );
            tb.DefineField(
                "famORAssemStatic" + suffix,
                typeof(string),
            ...
            pb = tb.DefineProperty(
                "PrivateInstance" + suffix,
                PropertyAttributes.None,
                typeof(string),
                Type.EmptyTypes
            );
            mb = tb.DefineMethod(
                "get_PrivateInstance" + suffix,
                MethodAttributes.Private,
                typeof(string),
                Type.EmptyTypes
            );
            ...
            pb = tb.DefineProperty(
                "FamilyInstance" + suffix,
                PropertyAttributes.None,
                typeof(string),
                Type.EmptyTypes
            );
            mb = tb.DefineMethod(
                "get_FamilyInstance" + suffix,
                MethodAttributes.Family,
                typeof(string),
                Type.EmptyTypes
            );
            ...
            mb = tb.DefineMethod(
                "get_FamANDAssemInstance" + suffix,
                MethodAttributes.FamANDAssem,
                typeof(string),
                Type.EmptyTypes
            );
            ...
            pb = tb.DefineProperty(
                "PublicInstance" + suffix,
                PropertyAttributes.None,
                typeof(string),
                Type.EmptyTypes
            );
            mb = tb.DefineMethod(
                "get_PublicInstance" + suffix,
                MethodAttributes.Public,
                typeof(string),
                Type.EmptyTypes
            );
            ...
            pb = tb.DefineProperty(
                "AssemblyInstance" + suffix,
                PropertyAttributes.None,
                typeof(string),
                Type.EmptyTypes
            );
            mb = tb.DefineMethod(
                "get_AssemblyInstance" + suffix,
                MethodAttributes.Assembly,
                typeof(string),
                Type.EmptyTypes
            );
            ...
            eb = tb.DefineEvent(
                "OnPrivateInstance" + suffix,
                EventAttributes.None,
                typeof(EventHandler)
            );
            mb = tb.DefineMethod(
                "add_OnPrivateInstance" + suffix,
                MethodAttributes.Private,
                typeof(void),
                Type.EmptyTypes
            );
            ...
            eb = tb.DefineEvent(
                "OnFamilyInstance" + suffix,
                EventAttributes.None,
                typeof(EventHandler)
            );
            mb = tb.DefineMethod(
                "add_OnFamilyInstance" + suffix,
                MethodAttributes.Family,
                typeof(void),
                Type.EmptyTypes
            );
            ...
            eb = tb.DefineEvent(
                "OnFamANDAssemInstance" + suffix,
                EventAttributes.None,
                typeof(EventHandler)
            );
            mb = tb.DefineMethod(
                "add_OnFamANDAssemInstance" + suffix,
                MethodAttributes.FamANDAssem,
                typeof(void),
                Type.EmptyTypes
            );
            ...
            eb = tb.DefineEvent(
                "OnFamORAssemInstance" + suffix,
                EventAttributes.None,
                typeof(EventHandler)
            );
            mb = tb.DefineMethod(
                "add_OnFamORAssemInstance" + suffix,
                MethodAttributes.FamORAssem,
                typeof(void),
                Type.EmptyTypes
            );
            ...
            eb = tb.DefineEvent(
                "OnPublicInstance" + suffix,
                EventAttributes.None,
                typeof(EventHandler)
            );
            mb = tb.DefineMethod(
                "add_OnPublicInstance" + suffix,
                MethodAttributes.Public,
                typeof(void),
                Type.EmptyTypes
            );
            ...
            eb = tb.DefineEvent(
                "OnAssemblyInstance" + suffix,
                EventAttributes.None,
                typeof(EventHandler)
            );
            mb = tb.DefineMethod(
                "add_OnAssemblyInstance" + suffix,
                MethodAttributes.Family,
                typeof(void),
                Type.EmptyTypes
            );
            ...
            eb = tb.DefineEvent(
                "OnPrivateStatic" + suffix,
                EventAttributes.None,
                typeof(EventHandler)
            );
            mb = tb.DefineMethod(
                "add_OnPrivateStatic" + suffix,
                MethodAttributes.Private | MethodAttributes.Static,
                typeof(void),
                Type.EmptyTypes
            );
            ...
            eb = tb.DefineEvent(
                "OnFamilyStatic" + suffix,
                EventAttributes.None,
                typeof(EventHandler)
            );
            mb = tb.DefineMethod(
                "add_OnFamilyStatic" + suffix,
                MethodAttributes.Family | MethodAttributes.Static,
                typeof(void),
                Type.EmptyTypes
            );
            ...
            eb = tb.DefineEvent(
                "OnFamANDAssemStatic" + suffix,
                EventAttributes.None,
                typeof(EventHandler)
            );
            mb = tb.DefineMethod(
                "add_OnFamANDAssemStatic" + suffix,
                MethodAttributes.FamANDAssem | MethodAttributes.Static,
                typeof(void),
                Type.EmptyTypes
            );
            ...
            eb = tb.DefineEvent(
                "OnFamORAssemStatic" + suffix,
                EventAttributes.None,
                typeof(EventHandler)
            );
            mb = tb.DefineMethod(
                "add_OnFamORAssemStatic" + suffix,
                MethodAttributes.FamORAssem | MethodAttributes.Static,
                typeof(void),
                Type.EmptyTypes
            );
            ...
            eb = tb.DefineEvent(
                "OnPublicStatic" + suffix,
                EventAttributes.None,
                typeof(EventHandler)
            );
            mb = tb.DefineMethod(
                "add_OnPublicStatic" + suffix,
                MethodAttributes.Public | MethodAttributes.Static,
                typeof(void),
                Type.EmptyTypes
            );
            ...
            eb = tb.DefineEvent(
                "OnAssemblyStatic" + suffix,
                EventAttributes.None,
                typeof(EventHandler)
            );
            mb = tb.DefineMethod(
                "add_OnAssemblyStatic" + suffix,
                MethodAttributes.Family | MethodAttributes.Static,
                typeof(void),
                Type.EmptyTypes
            );
        ...
        public void TypeResolveGenericInstances()
        {
            ...
            Resolve1_Tb = tb1;
            FieldInfo field = TypeBuilder.GetField(
                typeof(Lookup<>).MakeGenericType(tb1),
                typeof(Lookup<>).GetField("t")
            );
            TypeBuilder tb2 = module.DefineType("Bar");
            ConstructorBuilder cb = tb2.DefineConstructor(
                MethodAttributes.Public,
                CallingConventions.Standard,
                Type.EmptyTypes
            );
        ...
        {
            TypeBuilder tb = module.DefineType(genTypeName());
            TypeBuilder nested = tb.DefineNestedType(
                "Bar",
            ...
            TypeBuilder nested2 = tb.DefineNestedType(
                "Bar2",
                TypeAttributes.Class | TypeAttributes.NestedPrivate
            );
        ...
        */
        ...
        public void UserTypes()
        {
            ...
            */
            ...
            try
            {
                ...
                ConstructorBuilder mb = tb.DefineConstructor(
                    MethodAttributes.Public,
                    CallingConventions.Standard,
                    new Type[] { t }
                );
        ...
        {
            TypeBuilder tb1 = module.DefineType(
                "Interface",
                TypeAttributes.Interface | TypeAttributes.Abstract
            );
        ...
        public void GetConstructorCheckCtorDeclaringType()
        {
            ...
            GenericTypeParameterBuilder[] typeParams = myType.DefineGenericParameters(
                typeParamNames
            );
        ...
        public void MemberRef_Caching_16096()
        {
            ...
            il.Emit(
                OpCodes.Newobj,
                TypeBuilder.GetConstructor(builder.MakeGenericType(g_args), ctor)
            );
            il.Emit(OpCodes.Ret);
        ...
        {
            // A: C<D<A>>
            var a_type = module.DefineType("A", TypeAttributes.Class, typeof(object));

            var cba = a_type.DefineConstructor(
                MethodAttributes.Public,
                CallingConventions.Standard,
                Type.EmptyTypes
            );
            ...
            var c_type = module.DefineType("B", TypeAttributes.Class, typeof(object));
            var cbb = c_type.DefineConstructor(
                MethodAttributes.Public,
                CallingConventions.Standard,
                Type.EmptyTypes
            );
            ...
            var d_type = module.DefineType("D", TypeAttributes.Class, typeof(object));
            var cbd = d_type.DefineConstructor(
                MethodAttributes.Public,
                CallingConventions.Standard,
                Type.EmptyTypes
            );
        ...
        public void GenericFieldInCreatedType()
        {
            ...
            */
            ...
            tbR.DefineField(
                "sr",
                tbS.MakeGenericType(new Type[] { tbR }),
                FieldAttributes.Public | FieldAttributes.Static
            );
        ...
        public void GenericFieldInCreatedTypeIncompleteTypeTLE()
        {
            ...
            */
            ...
            Assert.Throws<TypeLoadException>(
                delegate
                {
                    var ft = r.GetField("sr").FieldType;
                }
            );
        }
        ...
        public void FieldsWithSameName()
        {
            ...
            var f1 = typeBuilder.DefineField(
                "x",
                typeof(byte),
                FieldAttributes.Private | FieldAttributes.Static
            );
            var f2 = typeBuilder.DefineField(
                "x",
                typeof(sbyte),
                FieldAttributes.Private | FieldAttributes.Static
            );
        ...
        public void MethodsWithSameNameAndSig()
        {
            ...
            var m2 = typeBuilder.DefineMethod(
                "X",
                MethodAttributes.Private | MethodAttributes.Static,
                typeof(void),
                new Type[0]
        ...
        public void TwoAssembliesMidFlightTest()
        {
            ...
            var assembly2 = Thread
                .GetDomain()
                .DefineDynamicAssembly(assemblyName2, AssemblyBuilderAccess.RunAndSave, tempDir);
