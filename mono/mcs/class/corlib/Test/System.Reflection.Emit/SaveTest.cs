...
namespace MonoTests.System.Reflection.Emit
{
    ...
    public class SaveTest
    {
        ...
        public void Save()
        {
            ...
            TypeBuilder iface1 = moduleb.DefineType(
                "iface1",
            ...
            TypeBuilder tb1 = moduleb.DefineType(
                "type1",
            ...
            // Nested type
            TypeBuilder tb_nested = tb1.DefineNestedType(
                "type_nested",
            ...
            tbg.DefineField(
                "field_gparam",
                tbg.GetGenericArguments()[0],
                FieldAttributes.Public | FieldAttributes.Static
            );
            // Open type
            tbg.DefineField(
                "field_open",
                typeof(List<>).MakeGenericType(new Type[] { tbg.GetGenericArguments()[1] }),
                FieldAttributes.Public | FieldAttributes.Static
            );
            tbg.CreateType();
            ...
            tb3.DefineField(
                "field_non_szarray",
                Array.CreateInstance(typeof(int), new int[] { 10 }, new int[] { 1 }).GetType(),
                FieldAttributes.Public | FieldAttributes.Static
            );
            // Multi-dim array
            tb3.DefineField(
                "field_multi_dim_array",
                Array
                    .CreateInstance(typeof(int), new int[] { 10, 10 }, new int[] { 1, 1 })
                    .GetType(),
                FieldAttributes.Public | FieldAttributes.Static
            );
            // Type pointer
            ...
            tb3.DefineField(
                "field_ginst_tbuilder",
                tbg2.MakeGenericType(new Type[] { typeof(int), typeof(string) }),
                FieldAttributes.Public | FieldAttributes.Static
            );
            tb3.CreateType();

            // Fields
            TypeBuilder tb_fields = moduleb.DefineType(
                "type4",
            ...
            tb_fields
                .DefineField(
                    "field_int",
                    typeof(int),
                    FieldAttributes.Public | FieldAttributes.Static | FieldAttributes.HasDefault
                )
                .SetConstant(42);
            ...
            fb.SetCustomAttribute(
                new CustomAttributeBuilder(
                    ...
                    new object[] { UnmanagedType.U4 }
                )
            );
            fb = tb_fields.DefineField(
                "field_marshal_byval_array",
                typeof(int),
            ...
            fb.SetCustomAttribute(
                new CustomAttributeBuilder(
                    typeof(MarshalAsAttribute).GetConstructor(new Type[] { typeof(UnmanagedType) }),
                    new object[] { UnmanagedType.ByValTStr },
                    new FieldInfo[] { typeof(MarshalAsAttribute).GetField("SizeConst") },
                    new object[] { 16 }
                )
            );
		...
		fb.SetCustomAttribute (new CustomAttributeBuilder (typeof (MarshalAsAttribute).GetConstructor (new Type [] { typeof (UnmanagedType) }), new object [] { UnmanagedType.CustomMarshaler },
            ...
            TypeBuilder tb5 = moduleb.DefineType(
                "type_methods",
                TypeAttributes.Public,
                typeof(object)
            );
            ...
            var ctorb = tb5.DefineConstructor(
                MethodAttributes.Public,
                CallingConventions.VarArgs,
                new Type[] { typeof(int), typeof(object) },
                new Type[][] { cmods_req_1, null },
                new Type[][] { cmods_opt_1, null }
            );
            ...
            // Properties
            TypeBuilder tb_properties = moduleb.DefineType(
                "type_properties",
                TypeAttributes.Public,
                typeof(object)
            );
            var mb_get = tb_properties.DefineMethod(
                "get_method1",
                MethodAttributes.Public,
                CallingConventions.Standard,
                typeof(int),
            ...
            var mb_set = tb_properties.DefineMethod(
                "set_method1",
                MethodAttributes.Public,
                CallingConventions.Standard,
                typeof(int),
            ...
            var mb_other = tb_properties.DefineMethod(
                "other_method1",
                MethodAttributes.Public,
                CallingConventions.Standard,
                typeof(int),
            ...
            var propertyb = tb_properties.DefineProperty(
                "AProperty",
            ...
            // Events
            TypeBuilder tb_events = moduleb.DefineType(
                "type_events",
                TypeAttributes.Public,
                typeof(object)
            );
            var mb_add = tb_events.DefineMethod(
                "add_method1",
                MethodAttributes.Public,
                CallingConventions.Standard,
                typeof(int),
            ...
            var mb_raise = tb_events.DefineMethod(
                "raise_method1",
                MethodAttributes.Public,
                CallingConventions.Standard,
                typeof(int),
            ...
            var mb_remove = tb_events.DefineMethod(
                "remove_method1",
                MethodAttributes.Public,
                CallingConventions.Standard,
                typeof(int),
        ...
        void CheckAssembly(Assembly a)
        {
            ...
            Assert.AreEqual(
                typeof(List<>).MakeGenericType(new Type[] { gparams[1] }),
                field.FieldType
            );
            ...
            Assert.AreEqual(
                typeof(TimeZoneInfo.AdjustmentRule),
                t.GetField("field_nested_ref").FieldType
            );
            ...
            var arraytype1 = Array
                .CreateInstance(typeof(int), new int[] { 10 }, new int[] { 1 })
                .GetType();
            // FIXME:
		...
		Assert.AreEqual ("Cookie", marshal.MarshalCookie);
            ...
            var ctors = type_methods.GetConstructors(
            ...
            Assert.AreEqual(
                MethodImplAttributes.NoInlining | MethodImplAttributes.IL,
                ctor.GetMethodImplementationFlags()
            );
