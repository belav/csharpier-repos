...
namespace MonoTests.System.Reflection.Emit
{
    ...
    public class PropertyBuilderTest
    {
        ...
        protected void SetUp()
        {
            ...
            tb = module.DefineType("class1", TypeAttributes.Public);
        }

        [Test]
        public void TestProperties()
        {
            FieldBuilder propField = tb.DefineField(
                "propField",
                typeof(int),
            ...
            MethodBuilder propertyGet = tb.DefineMethod(
                "GetProp",
            ...
            MethodBuilder propertySet = tb.DefineMethod(
                "SetProp",
                MethodAttributes.Public,
                null,
                new Type[] { typeof(int) }
