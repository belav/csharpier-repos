...
namespace MonoTests.System.Reflection.Emit
{
    ...
    public class ModuleBuilderTest
    {
        static string tempDir = Path.Combine(
            Path.GetTempPath(),
            typeof(ModuleBuilderTest).FullName
        );
        ...
        public void TestGlobalMethods()
        {
            ...
            MethodBuilder method = module.DefinePInvokeMethod(
                "printf",
                "libc.so",
            ...
            method.SetImplementationFlags(
                MethodImplAttributes.PreserveSig | method.GetMethodImplementationFlags()
            );
        ...
        public void DefineType_InterfaceNotAbstract()
        {
            ...
            // fail on MS .NET 1.1
            TypeBuilder tb = mb.DefineType("ITest2", TypeAttributes.Interface, typeof(object));
            Assert.AreEqual(typeof(object), tb.BaseType, "#C1");

            tb = mb.DefineType("ITest3", TypeAttributes.Interface, typeof(IDisposable));
        ...
        public void DefineType_Parent_Interface()
        {
            ...
            tb = mb.DefineType("Foo", TypeAttributes.Class, typeof(ICollection));
            Assert.AreEqual(typeof(ICollection), tb.BaseType, "#1");

            tb = mb.DefineType("Bar", TypeAttributes.Interface, typeof(ICollection));
        ...
        public void DuplicateSymbolDocument()
        {
            ...
            ISymbolDocumentWriter doc1 = mb.DefineDocument(
                "foo.il",
                SymDocumentType.Text,
                SymLanguageType.ILAssembly,
                SymLanguageVendor.Microsoft
            );
            ISymbolDocumentWriter doc2 = mb.DefineDocument(
                "foo.il",
                SymDocumentType.Text,
                SymLanguageType.ILAssembly,
                SymLanguageVendor.Microsoft
        ...
        public void GetArrayMethodMultipleCallsTest()
        {
            ...
            var arrmi2 = modb.GetArrayMethod(
                int2D,
                "Get",
                CallingConventions.Standard | CallingConventions.HasThis,
                typeof(int),
        ...
        public void ResolveMethodDefWithGenericArguments()
        {
            ...
            var resolved_method = (MethodInfo)
                module.ResolveMember(0x06000001, new[] { typeof(string) }, Type.EmptyTypes);
        ...
        public void ResolveFieldDefWithGenericArguments()
        {
            ...
            var resolved_field = (FieldInfo)
                module.ResolveMember(0x04000001, new[] { typeof(string) }, Type.EmptyTypes);
        ...
        public void ResolveTypeDefWithGenericArguments()
        {
            ...
            var foo = (Type)
                module.ResolveMember(0x02000002, new[] { typeof(string) }, Type.EmptyTypes);
        ...
        public void ResolveFieldMemberRefWithGenericArguments()
        {
            ...
            var resolved_field = (FieldInfo)
                module.ResolveMember(0x0a000001, new[] { typeof(string) }, null);
            Assert.IsNotNull(resolved_field);
            Assert.AreEqual("field", resolved_field.Name);
        ...
        public void ResolveMethodMemberRefWithGenericArguments()
        {
            ...
            var resolved_method = (MethodInfo)
                module.ResolveMember(0x0a000002, new[] { typeof(string) }, null);
            Assert.IsNotNull(resolved_method);
            Assert.AreEqual("Method", resolved_method.Name);
        ...
        public void ResolveMethodSpecWithGenericArguments()
        {
            ...
            var resolved_method = (MethodInfo)
                module.ResolveMember(0x2b000001, new[] { typeof(string) }, new[] { typeof(int) });
            Assert.IsNotNull(resolved_method);
            Assert.AreEqual("Method", resolved_method.Name);
            Assert.AreEqual(typeof(string), resolved_method.GetParameters()[0].ParameterType);
        ...
        public void GetType_Escaped_Chars()
        {
            ...
            var escapedNestedName = escapedOuterName + "+" + "Nested\\,\\+\\*\\&\\[\\]\\\\";
        ...
        {
            AssemblyBuilder assm = AssemblyBuilder.DefineDynamicAssembly(
        ...
        public void GetCustomAttributesBeforeInstantiation()
        {
            ...
            ConstructorInfo ctor = typeof(MyAttribute).GetConstructor(
                new Type[] { typeof(String) }
            );
            ctor.GetHashCode();
            ...
            Assert.AreEqual(
                typeof(MyAttribute),
                ((MyAttribute)module.GetCustomAttributes(false)[0]).GetType()
            );
        ...
        public void GetExternalTypeBuilderCAttr()
        {
            ...
            ConstructorInfo ctor = tb.DefineConstructor(
                MethodAttributes.Public,
                CallingConventions.Standard,
                Type.EmptyTypes
            );
        ...
        public void SaveMemberRefGtd()
        {
            ...
            AssemblyBuilder ab = Thread
                .GetDomain()
                .DefineDynamicAssembly(an, AssemblyBuilderAccess.RunAndSave, tempDir);
            ...
            var il_gen = tb.DefineMethod("F", MethodAttributes.Public, typeof(string), null)
                .GetILGenerator();
            var il_gen2 = tb.DefineMethod("F2", MethodAttributes.Public, typeof(string), null)
                .GetILGenerator();

            var cbuilder = modulebuilder.DefineType("C", TypeAttributes.Public);
            var genericParams = cbuilder.DefineGenericParameters("X");

            var field1builder = cbuilder.DefineField(
                "field1",
                genericParams[0],
                FieldAttributes.Public
            );
            ...
            var fooBuilder = cbuilder.DefineMethod(
                "Foo",
                MethodAttributes.Public,
                cOfX,
            ...
            var barBuilder = cbuilder.DefineMethod(
                "Bar",
                MethodAttributes.Public,
                genericParams[0],
                new Type[] { genericParams[0] }
        ...
        public void FieldBuilder_DistinctTokens()
        {
            ...
            Assert.AreNotEqual(
                fbX1.MetadataToken,
                fbX2.MetadataToken,
                "MetadataToken T1.X != T2.X"
            );
            Assert.AreNotEqual(
                fbX1.MetadataToken,
                fbY1.MetadataToken,
                "MetadataToken T1.X != T1.Y"
            );
            Assert.AreNotEqual(
                fbY1.MetadataToken,
                fbX2.MetadataToken,
                "MetadataToken T1.Y != T2.X"
            );
