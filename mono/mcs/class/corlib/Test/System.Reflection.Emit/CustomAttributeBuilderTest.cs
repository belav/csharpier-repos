...
namespace MonoTests.System.Reflection.Emit
{
    ...
    public class CustomAttributeBuilderTest
    {
        static string tempDir = Path.Combine(
            Path.GetTempPath(),
            typeof(CustomAttributeBuilderTest).FullName
        );
        ...
        public void CtorOneTest()
        {
            ...
            AssemblyBuilder asmBuilder = Thread
                .GetDomain()
                .DefineDynamicAssembly(asmName, AssemblyBuilderAccess.Run);

            ModuleBuilder modBuilder = asmBuilder.DefineDynamicModule("TestModule");

            TypeBuilder typeBuilder = modBuilder.DefineType("TestType", TypeAttributes.Public);
        ...
        public void ArgumentExceptionTest_1()
        {
            ...
            ConstructorInfo classCtorInfo = typeof(CustomAttribute).GetConstructor(
        ...
        {
            ConstructorInfo classCtorInfo = typeof(CattrD).GetConstructors()[0];
        ...
        {
            ConstructorInfo classCtorInfo = typeof(CattrE).GetConstructors()[0];
        ...
        public void JaggedArrays()
        {
            ...
            tb.SetCustomAttribute(
                new CustomAttributeBuilder(
                    typeof(JaggedAttr).GetConstructors()[0],
                    new object[]
                    {
        ...
        public void CustomAttributeAcrossAssemblies()
        {
            ...
            var assemblyBuilder1 = AppDomain.CurrentDomain.DefineDynamicAssembly(
                assemblyName1,
                AssemblyBuilderAccess.Save,
                tempDir
            );
            ...
            var typeBuilder1 = moduleBuilder1.DefineType(
                "MyAttr",
                TypeAttributes.Public,
                typeof(Attribute)
            );
            ConstructorBuilder ctor = typeBuilder1.DefineDefaultConstructor(
                MethodAttributes.Public
            );
            typeBuilder1.CreateType();

            var assemblyName2 = new AssemblyName("Repro55681-2b");
            var assemblyBuilder2 = AppDomain.CurrentDomain.DefineDynamicAssembly(
                assemblyName2,
                AssemblyBuilderAccess.Save,
                tempDir
            );
        ...
        [DllImport("SomeLib")]
        private static extern void MethodForNullStringMarshalAsFields(
        ...
        public void NullStringMarshalAsFields()
        {
            ...
            var someMethod = this.GetType()
                .GetMethod(prototypeMethodName, BindingFlags.Static | BindingFlags.NonPublic);

            var typeBuilder = module.DefineType(
                "NewType" + module.ToString(),
            ...
            var attrCtor = typeof(MarshalAsAttribute).GetConstructor(
            ...
            var srcFields = typeof(MarshalAsAttribute).GetFields(
        ...
        public void MethodInfoGetParametersCrash()
        {
            ...
            var testAssembly = AppDomain.CurrentDomain.DefineDynamicAssembly(
                aName,
                AssemblyBuilderAccess.RunAndSave
            );
            ...
            var methodInfo = createdType.GetMethod(
                "TestMethod",
