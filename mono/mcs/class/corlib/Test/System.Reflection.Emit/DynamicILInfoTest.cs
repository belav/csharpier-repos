...
namespace MonoTests.System.Reflection.Emit
{
    ...
    public class DynamicILInfoTest
    {
        ...
        public void GetTokenFor_Method()
        {
            ...
            int token0 = il.GetTokenFor("ABCD");
            int token1 = il.GetTokenFor(
                typeof(string).GetMethod("ToLower", Type.EmptyTypes).MethodHandle
            );
            PutInteger4(token0, 0x0002, code);
        ...
        public void GetTokenFor_FieldInfo()
        {
            ...
            var f = typeof(DynamicILInfoTest)
                .GetField("aField", BindingFlags.Static | BindingFlags.NonPublic)
                .FieldHandle;
