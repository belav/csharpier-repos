...
namespace MonoTests.System.Reflection.Emit
{
    ...
    public class AssemblyBuilderTest
    {
        ...
        {
            return domain.DefineDynamicAssembly(genAssemblyName(), access, tempDir);
        }
        ...
        public void ManifestModule()
        {
            ...
            ab = domain.DefineDynamicAssembly(aname, AssemblyBuilderAccess.RunAndSave, tempDir);
        ...
        public void TestIsDefined()
        {
            CustomAttributeBuilder cab = new CustomAttributeBuilder(
                typeof(FooAttribute).GetConstructor(new Type[1] { typeof(string) }),
                new object[1] { "A" }
            );
            ab.SetCustomAttribute(cab);

            Assert.IsTrue(
                ab.IsDefined(typeof(FooAttribute), false),
                "IsDefined(FooAttribute) works"
            );
            Assert.IsFalse(
                ab.IsDefined(typeof(AssemblyVersionAttribute), false),
        ...
        public void TestSetCustomAttribute1()
        {
            ...
            ab.SetCustomAttribute(
                new CustomAttributeBuilder(
                    typeof(AssemblyCultureAttribute).GetConstructor(new Type[] { typeof(string) }),
                    new object[] { "bar" }
                )
            );
            ab.SetCustomAttribute(
                new CustomAttributeBuilder(
                    typeof(AssemblyAlgorithmIdAttribute).GetConstructor(
            ...
            ab.SetCustomAttribute(
                new CustomAttributeBuilder(
                    typeof(AssemblyFlagsAttribute).GetConstructor(new Type[] { typeof(uint) }),
                    new object[] { (uint)0xff }
                )
            );
            ab.SetCustomAttribute(
                new CustomAttributeBuilder(
                    typeof(AssemblyDelaySignAttribute).GetConstructor(new Type[] { typeof(bool) }),
                    new object[] { true }
                )
            );
            ab.SetCustomAttribute(
                new CustomAttributeBuilder(
                    typeof(FooAttribute).GetConstructor(Type.EmptyTypes),
                    new object[0]
                )
            );
            ...
            Assert.AreEqual(
                "TestSetCustomAttributeA, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null",
                check.FullName,
                "#A3"
            );
            ...
            Assert.AreEqual(
                ...
                ((AssemblyAlgorithmIdAttribute)attr).AlgorithmId,
                "#A14b"
            );
            ...
            Assert.AreEqual(
                "TestSetCustomAttributeB, Version=1.3.5.7, Culture=nl-BE, PublicKeyToken=null, Retargetable=Yes",
                check.FullName,
                "#B3"
            );
        ...
        public void StrongName_MissingKeyFile_NoDelay()
        {
            ab.SetCustomAttribute(
                new CustomAttributeBuilder(
                    typeof(AssemblyKeyFileAttribute).GetConstructor(new Type[] { typeof(string) }),
                    new object[] { "missing.snk" }
                )
            );
            ab.SetCustomAttribute(
                new CustomAttributeBuilder(
        ...
        public void StrongName_WithoutAttributes()
        {
            ...
            Assert.AreEqual(
                "0E-EA-7C-E6-5F-35-F2-D8",
                BitConverter.ToString(check.GetPublicKeyToken()),
                "#2"
            );
        ...
        public void GetReferencedAssemblies()
        {
            ...
            ab1 = domain.DefineDynamicAssembly(an1, AssemblyBuilderAccess.RunAndSave, tempDir);
            ab2 = domain.DefineDynamicAssembly(an2, AssemblyBuilderAccess.RunAndSave, tempDir);
            ab3 = domain.DefineDynamicAssembly(an3, AssemblyBuilderAccess.RunAndSave, tempDir);
            ...
            tb2 = mb2.DefineType("TestType2", TypeAttributes.Class | TypeAttributes.Public, tb1);
            tb2.CreateType();

            mb3 = ab3.DefineDynamicModule(an3.Name + ".dll");
            tb3 = mb3.DefineType("TestType3", TypeAttributes.Class | TypeAttributes.Public, tb1);
            tb3.CreateType();
            tb4 = mb3.DefineType("TestType4", TypeAttributes.Class | TypeAttributes.Public, tb2);
            tb4.CreateType();
            ...
            using (FileStream fs = File.OpenRead(assemblyFile))
            {
                ...
                Assert.AreEqual(
                    AssemblyVersionCompatibility.SameMachine,
                    refs[0].VersionCompatibility,
                    "#D2:VersionCompatibility"
                );
            ...
            using (FileStream fs = File.OpenRead(assemblyFile))
            {
                ...
                Assert.AreEqual(
                    an1.Name + ", Version=3.0.0.0, Culture=neutral, PublicKeyToken=null",
                    refs[0].FullName,
                    "#E2:FullName"
                );
                Assert.AreEqual(
            ...
            using (FileStream fs = File.OpenRead(assemblyFile))
            {
                ...
                Assert.AreEqual(
                    ProcessorArchitecture.None,
                    refs[1].ProcessorArchitecture,
                    "#F3:PA"
                );
                Assert.AreEqual(new Version(1, 2, 3, 4), refs[1].Version, "#F3:Version");
                Assert.AreEqual(
                    AssemblyVersionCompatibility.SameMachine,
                    refs[1].VersionCompatibility,
                    "#F3:VersionCompatibility"
                );
        ...
        public void AssemblyName_Culture()
        {
            ...
            const string fullName =
                "AssemblyNameTest, Version=1.0.0.0, Culture=en-US, PublicKeyToken=null";
        ...
        public void AssemblyName_PublicKey()
        {
            ...
            Assert.AreEqual(
                "AssemblyNameTest_PublicKey, Version=1.2.3.4",
            ...
            AssemblyName bakedName = AssemblyName.GetAssemblyName(
                Path.Combine(tempDir, "AssemblyNameTest_PublicKey.dll")
            );
        ...
        public void AssemblyName_MoreCultureInfo()
        {
            ...
            Assert.AreEqual(
                "AssemblyNameTest_MoreCultureInfo, Version=1.2.3.4",
                assemblyName.FullName,
                "#A2"
            );
            ...
            AssemblyName bakedName = AssemblyName.GetAssemblyName(
                Path.Combine(tempDir, "AssemblyNameTest_MoreCultureInfo.dll")
            );
        ...
        public void AssemblyName_NoVersion()
        {
            ...
            const string fullName =
                "AssemblyNameTest, Version=0.0.0.0, Culture=neutral, PublicKeyToken=null";
        ...
        public void AssemblyName_Version()
        {
            ...
            string fullName =
                "AssemblyNameTest, Version=1.2.3.4, Culture=neutral, PublicKeyToken=null";
        ...
        private static void AssertAssemblyName(
            string tempDir,
        ...
        )
        {
            ...
            try
            {
                ...
                Helper helper = new Helper(
                    Path.Combine(tempDir, assemblyName.Name + ".dll"),
                    fullName
                );
        ...
        public void CannotCreateInstanceOfSaveOnlyAssembly()
        {
            ...
            var type_builder = mod_builder.DefineType(
                "Foo",
                TypeAttributes.Public
                    | TypeAttributes.Sealed
                    | TypeAttributes.Class
