...
namespace MonoTests.System.IO
{
    ...
    public class PathTest
    {
        ...
        bool Windows
        {
            get { return OS == OsType.Windows; }
        }

        bool Unix
        {
            get { return OS == OsType.Unix; }
        }

        bool Mac
        {
            get { return OS == OsType.Mac; }
        }
        ...
        public void GetDirectoryName()
        {
            ...
            if (Windows)
            {
                ...
                Assert.AreEqual(
                    @"\\server\share",
                    Path.GetDirectoryName(@"\\server\share\"),
                    "#D4"
                );
                Assert.AreEqual(
                    @"\\server\share",
                    Path.GetDirectoryName(@"\\server\share\dir"),
                    "#D5"
                );
                Assert.AreEqual(
                    @"\\server\share\dir",
                    Path.GetDirectoryName(@"\\server\share\dir\subdir"),
                    "#D6"
                );
            }
            else
        ...
        public void GetDirectoryName_Replaces_AltDirectorySeparatorChar()
        {
            Assert.AreEqual(
                $"foo{DSC}bar",
                Path.GetDirectoryName($"foo{ADSC}bar{ADSC}dingus"),
                "#1"
            );
        }
        ...
        public void GetFullPath_Unix()
        {
            ...
            Assert.AreEqual(
                Path.Combine(Environment.CurrentDirectory, "hey"),
        ...
        public void GetFullPath_Windows()
        {
            ...
            for (int i = 0; i < test.GetUpperBound(0); i++)
            {
                ...
                catch (Exception ex)
                {
                    Assert.Fail(
                        String.Format(
                            "GetFullPathWindows #{0} (\"{1}\") failed: {2}",
                            i,
                            root + test[i, 0],
                            ex.GetType()
                        )
            ...
            for (int i = 0; i < test.GetUpperBound(0); i++)
            {
                ...
                catch (Exception ex)
                {
                    Assert.Fail(
                        String.Format(
                            "GetFullPathWindows UNC #{0} (\"{1}\") failed: {2}",
                            i,
                            root + test[i, 0],
                            ex.GetType()
                        )
            ...
            for (int i = 0; i < test.GetUpperBound(0); i++)
            {
                ...
                catch (Exception ex)
                {
                    Assert.Fail(
                        String.Format(
                            "GetFullPathWindows UNC[2] #{0} (\"{1}\") failed: {2}",
                            i,
                            root + test[i, 0],
                            ex.GetType()
                        )
        ...
        public void GetFullPath2()
        {
            if (Windows)
            {
                ...
                // "//" is not allowed
                Assert.IsTrue(
                    Path.GetFullPath("readme.txt").EndsWith(@"\readme.txt"),
                    "GetFullPath w#07"
                );
                Assert.IsTrue(Path.GetFullPath("c").EndsWith(@"\c"), "GetFullPath w#08");
                Assert.IsTrue(
                    Path.GetFullPath(@"abc\def").EndsWith(@"abc\def"),
                    "GetFullPath w#09"
                );
                Assert.IsTrue(
                    Path.GetFullPath(@"\abc\def").EndsWith(@"\abc\def"),
                ...
                Assert.AreEqual(
                    Directory.GetCurrentDirectory() + @"\abc\def",
                    Path.GetFullPath(@"abc//def"),
                    "GetFullPath w#12"
                );
                Assert.AreEqual(
                    Directory.GetCurrentDirectory().Substring(0, 2) + @"\abc\def",
                    Path.GetFullPath("/abc/def"),
                    "GetFullPath w#13"
                );
        ...
        public void GetTempPath()
        {
            ...
            Assert.AreEqual(
                ...
                getTempPath[getTempPath.Length - 1],
                "GetTempPath #03"
            );
        }
        ...
        public void WindowsDriveC14N_77058()
        {
            ...
            Assert.AreEqual(
                @"C:\Windows\dir",
                Path.GetFullPath(@"C:\Windows\System32\..\dir"),
                "1"
            );
        ...
        public void Combine_3Params()
        {
            ...
            Assert.AreEqual(
                Concat(sep, "one", "two", "three"),
                Path.Combine("one", "two", "three"),
                "#A2-1"
            );
            Assert.AreEqual(
                Concat(sep, sep + "one", "two", "three"),
                Path.Combine(sep + "one", "two", "three"),
                "#A2-2"
            );
            Assert.AreEqual(
                Concat(sep, sep + "one", "two", "three"),
                Path.Combine(sep + "one" + sep, "two", "three"),
                "#A2-3"
            );
            Assert.AreEqual(
                Concat(sep, sep + "two", "three"),
                Path.Combine(sep + "one" + sep, sep + "two", "three"),
                "#A2-4"
            );
            Assert.AreEqual(
                Concat(sep, sep + "three"),
                Path.Combine(sep + "one" + sep, sep + "two", sep + "three"),
                "#A2-5"
            );

            Assert.AreEqual(
                Concat(sep, sep + "one" + sep, "two", "three"),
                Path.Combine(sep + "one" + sep + sep, "two", "three"),
                "#A3"
            );
        ...
        public void Combine_4Params()
        {
            ...
            Assert.AreEqual(
                Concat(sep, "one", "two", "three", "four"),
                Path.Combine("one", "two", "three", "four"),
                "#A2-1"
            );
            Assert.AreEqual(
                Concat(sep, sep + "one", "two", "three", "four"),
            ...
            Assert.AreEqual(
                Concat(sep, sep + "two", "three", "four"),
                Path.Combine(sep + "one" + sep, sep + "two", "three", "four"),
                "#A2-4"
            );
            Assert.AreEqual(
                Concat(sep, sep + "three", "four"),
            ...
            Assert.AreEqual(
                Concat(sep, sep + "one" + sep, "two", "three", "four"),
                Path.Combine(sep + "one" + sep + sep, "two", "three", "four"),
                "#A3"
            );
        ...
        public void Combine_ManyParams()
        {
            ...
            Assert.AreEqual(
                Concat(sep, "one", "two", "three", "four", "five"),
                Path.Combine("one", "two", "three", "four", "five"),
                "#A2-1"
            );
            Assert.AreEqual(
                Concat(sep, sep + "one", "two", "three", "four", "five"),
            ...
            Assert.AreEqual(
                Concat(sep, sep + "one" + sep, "two", "three", "four", "five"),
                Path.Combine(sep + "one" + sep + sep, "two", "three", "four", "five"),
                "#A3"
            );
