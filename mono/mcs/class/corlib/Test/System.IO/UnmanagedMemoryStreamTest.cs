...
namespace MonoTests.System.IO
{
    ...
    public unsafe class UnmanagedMemoryStreamTest
    {
        ...
        {
            UnmanagedMemoryStream ums = new UnmanagedMemoryStream(mem_byteptr, length);
        ...
        public void Constructor2()
        {
            ...
            ums = new UnmanagedMemoryStream(mem_byteptr, length, 999, FileAccess.Read);
            ...
            ums = new UnmanagedMemoryStream(mem_byteptr, length, 666, FileAccess.Write);
            ...
            ums = new UnmanagedMemoryStream(mem_byteptr, 0, 0, FileAccess.ReadWrite);
