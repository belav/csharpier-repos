...
namespace MonoTests.System.IO
{
    ...
    public class FileStreamTest
    {
        ...
        public void CtorDirectoryNotFound_RelativePath()
        {
            ...
            string relativePath =
                "DirectoryDoesNotExist" + Path.DirectorySeparatorChar + "file.txt";
        ...
        public void CtorArgumentException2()
        {
            ...
            try
            {
                stream = new FileStream(
                    ...
                    FileMode.CreateNew,
                    FileAccess.Read,
                    FileShare.None | FileShare.Write
                );
            }
            finally
            {
        ...
        public void CtorArgumentOutOfRangeException5()
        {
            ...
            try
            {
                stream = new FileStream(
                    ...
                    FileMode.Open,
                    FileAccess.Read,
                    FileShare.Inheritable | FileShare.ReadWrite
                );
            }
            finally
            {
        ...
        public void FileShare_Delete()
        {
            ...
            using (
                Stream s = new FileStream(
                    ...
                    FileMode.OpenOrCreate,
                    FileAccess.Write,
                    FileShare.Inheritable | FileShare.Delete
                )
            )
            {
                s.Write(new byte[1] { 0x5 }, 0, 1);
        ...
        {
            string fname =
                TempFolder + DSC + ".." + DSC + "MonoTests.System.IO.Tests" + DSC + "tfile.txt";
