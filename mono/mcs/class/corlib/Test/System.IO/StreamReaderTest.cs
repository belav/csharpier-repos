    ...
    public class StreamReaderTest
    {
        ...
        public void TestCtor1()
        {
            ...
            }
            {
                ...
                FileStream f = new FileStream(_codeFileName, FileMode.Open, FileAccess.Read);
                StreamReader r = new StreamReader(f);
        ...
        public void Read_DoesntStopAtLineEndings()
        {
            MemoryStream ms = new MemoryStream(
                Encoding.ASCII.GetBytes("Line1\rLine2\r\nLine3\nLine4")
            );
        ...
        public void EndOfBufferIsCR()
        {
            using (
                StreamReader reader = new StreamReader(
                    TestResourceHelper.GetFullPathOfResource("Test/resources/Fergie.GED")
                )
            )
            {
                string line;
