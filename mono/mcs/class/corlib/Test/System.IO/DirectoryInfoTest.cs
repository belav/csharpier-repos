...
namespace MonoTests.System.IO
{
    ...
    public class DirectoryInfoTest
    {
        ...
        public void FullName()
        {
            ...
            Assert.AreEqual(
                Path.Combine(Directory.GetCurrentDirectory(), "something"),
                di.FullName,
                "#A2"
            );
            ...
            Assert.AreEqual(
                ...
                di.FullName[di.FullName.Length - 1],
                "#B2"
            );
        ...
        public void GetDirectories2()
        {
            ...
            try
            {
                ...
                Assert.AreEqual(
                    6,
                    info.GetDirectories("*", SearchOption.AllDirectories).Length,
                    "#9"
                );
            }
            finally
        ...
        public void GetDirectiories_SearchOptionAllDirectories()
        {
            ...
            DirectoryInfo baseDir = Directory.CreateDirectory(
                Path.Combine(TempFolder, "GetDirectiories_SearchOptionAllDirectories")
            );
            ...
            DirectoryInfo[] directoriesFound = baseDir.GetDirectories(
                directoryToBeLookedFor,
                SearchOption.AllDirectories
            );
            Assert.AreEqual(
                1,
                directoriesFound.Length,
                "There should be exactly one directory with the specified name."
            );
            Assert.AreEqual(
                directoryToBeLookedFor,
                directoriesFound[0].Name,
                "The name of the directory found should match the expected one."
            );
        }
        ...
        public void LastWriteTime()
        {
            ...
            time = TimeZone.CurrentTimeZone.ToLocalTime(Directory.GetLastWriteTimeUtc(TempFolder));
        ...
        private void Symlink_helper()
        {
            ...
            try
            {
                ...
                global::Mono.Unix.UnixSymbolicLinkInfo li =
                    new global::Mono.Unix.UnixSymbolicLinkInfo(link);
