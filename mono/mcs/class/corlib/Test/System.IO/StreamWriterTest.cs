...
namespace MonoTests.System.IO
{
    ...
    public class StreamWriterTest
    {
        ...
        {
            FileStream f = new FileStream(_codeFileName, FileMode.Append, FileAccess.Write);
        ...
        {
            FileStream f = new FileStream(_thisCodeFileName, FileMode.Open, FileAccess.Read);
            try
            {
                new StreamWriter(f);
                Assert.Fail("#B1");
        ...
        public void Constructor6_Path_InvalidChars()
        {
            ...
            {
                new StreamWriter(
                    "!$what? what? Huh? !$*#" + Path.InvalidPathChars[0],
                    false,
                    Encoding.UTF8
                );
                Assert.Fail("#A1");
