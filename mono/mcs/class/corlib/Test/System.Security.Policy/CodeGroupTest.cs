...
namespace MonoTests.System.Security.Policy
{
    ...
    public class MySecondCodeGroup : CodeGroup
    {
        ...
        public MySecondCodeGroup()
            : base(new AllMembershipCondition(), null) { }
    ...
    public class CodeGroupTest
    {
        ...
        {
            MyCodeGroup cg = new MyCodeGroup(
                null,
        ...
        public void Constructor()
        {
            ...
            Assert.IsNotNull(
                cg.PolicyStatement,
                "PolicyStatement property not set correctly by constructor."
            );
            Assert.IsNotNull(
                cg.MembershipCondition,
                "MembershipCondition property not set correctly by constructor."
            );
        }
        ...
        public void EqualsWithChildren()
        {
            ...
            MyCodeGroup cgChild = new MyCodeGroup(
            ...
            Assert.IsTrue(
                !cg.Equals(cg2, true),
                "Should not be equal when Child count is different"
            );
        ...
        public void RemoveChild()
        {
            ...
            MyCodeGroup cgChild2 = new MyCodeGroup(
                new ApplicationDirectoryMembershipCondition(),
                ps
            );
            ...
            Assert.AreEqual(
                2,
                cg.Children.Count,
                "Should be two children before the call to Remove()"
            );
            cg.RemoveChild(cgChild);
            Assert.AreEqual(
                1,
                cg.Children.Count,
                "Should be one children after the call to Remove()"
            );
            Assert.AreEqual(
                "ChildName2",
                ((CodeGroup)cg.Children[0]).Name,
                "Remaining child does not have correct name"
            );
        }
        ...
        public void ToXml()
        {
            ...
            Assert.IsTrue(
                s.StartsWith("<CodeGroup class=\"MonoTests.System.Security.Policy.MyCodeGroup,"),
                "ToXml-Starts"
            );
            Assert.IsTrue(
                s.EndsWith(
                    "version=\"1\"/>" + Environment.NewLine + "</CodeGroup>" + Environment.NewLine
                ),
                "ToXml-Ends"
            );
            ...
            s = se.ToString();
            Assert.IsTrue(
                s.IndexOf("<CodeGroup class=\"MonoTests.System.Security.Policy.MyCodeGroup,", 1)
                    > 0,
                "ToXml-Child"
            );
        }
        ...
        public void ToFromXmlRoundtrip_WithChildren_Second()
        {
            ...
            MySecondCodeGroup cgChild = new MySecondCodeGroup(
                new ApplicationDirectoryMembershipCondition(),
                ps
            );
            cgChild.Name = "ChildName";
