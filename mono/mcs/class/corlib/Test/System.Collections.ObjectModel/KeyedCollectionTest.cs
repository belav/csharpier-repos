...
namespace MonoTests.System.Collections.ObjectModel
{
    ...
    public class KeyedCollectionTest
    {
        ...
        {
            StrKeyCollection collection = new StrKeyCollection(EqualityComparer<string>.Default, 0);
        ...
        void InsertInvalidIndex(StrKeyCollection collection, int index)
        {
            ...
            {
                Assert.Fail(
                    "Invalid exception type: expected ArgumentOutOfRangeException, got "
                        + e.GetType().Name
                );
            }
        ...
        {
            StrKeyCollection collection = new StrKeyCollection(EqualityComparer<string>.Default, 4);
            collection.Add("One");
            try
            {
                collection.Add("One");
