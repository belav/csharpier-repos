...
namespace MonoTests.System.Text
{
    ...
    public class EncoderReplacementFallbackTest
    {
        ...
        {
            EncoderReplacementFallback f = new EncoderReplacementFallback();
        ...
        {
            new MyEncoding().EncoderFallback = new EncoderReplacementFallback();
        }
        ...
        {
            Encoding.Default.GetEncoder().Fallback = new EncoderReplacementFallback();
        }
