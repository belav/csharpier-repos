...
namespace MonoTests.System
{
    ...
    public class DecimalTestMicrosoft
    {
        ...
        private void VerifyAdd<T>(Decimal d1, Decimal d2, Decimal expected = Decimal.Zero)
            where T : Exception
        {
        ...
        private void VerifyDivide<T>(Decimal d1, Decimal d2, Decimal expected = Decimal.Zero)
            where T : Exception
        {
            bool expectFailure = typeof(T) != typeof(Exception);
        ...
        public void TestDivide()
        {
            ...
            //[] Overflow exceptions
            VerifyDivide<OverflowException>(
                79228162514264337593543950335m,
            ...
            VerifyDivide<OverflowException>(
                79228162514264337593543950335m,
                0.999999999999999999999m
            );
            VerifyDivide<OverflowException>(
                79228162514264337593543950335m,
                0.9999999999999999999999m
            );
            VerifyDivide<OverflowException>(
                79228162514264337593543950335m,
        ...
        private void VerifyMultiply<T>(Decimal d1, Decimal d2, Decimal expected = Decimal.Zero)
            where T : Exception
        {
            bool expectFailure = typeof(T) != typeof(Exception);
        ...
        public void TestMultiply()
        {
            ...
            VerifyMultiply<OverflowException>(
                79228162514264337593543950335m,
                1.000000000000000001m
            );
            VerifyMultiply<OverflowException>(
        ...
        private void VerifySubtract<T>(Decimal d1, Decimal d2, Decimal expected = Decimal.Zero)
            where T : Exception
        {
            bool expectFailure = typeof(T) != typeof(Exception);
