...
namespace MonoTests.System
{
    ...
    public class DateTimeOffsetTest
    {
        ...
        {
            DateTimeOffset dt1 = new DateTimeOffset(
                2007,
                12,
                16,
                15,
            ...
            DateTimeOffset dt3 = new DateTimeOffset(
                2007,
                12,
                16,
                14,
        ...
        public void UtcDateTime()
        {
            ...
            Assert.IsTrue(
                dt.UtcDateTime == new DateTime(2007, 12, 16, 14, 49, 00, DateTimeKind.Utc)
            );
        }
        ...
        public void ToStringWithFormat()
        {
            ...
            Assert.AreEqual(
                ...
                dto.ToString("D", new CultureInfo("en-us"))
            );
            ...
            Assert.AreEqual(
                "Wednesday, October 31, 2007 9:00 PM",
                dto.ToString("f", new CultureInfo("en-us"))
            );
            Assert.AreEqual(
            ...
            Assert.AreEqual(
                dto.ToString("m", new CultureInfo("en-us")),
                dto.ToString("M", new CultureInfo("en-us"))
            );
            Assert.AreEqual(
                "Thu, 01 Nov 2007 05:00:00 GMT",
                dto.ToString("R", new CultureInfo("en-us"))
            );
            Assert.AreEqual(
                dto.ToString("r", new CultureInfo("en-us")),
                dto.ToString("R", new CultureInfo("en-us"))
            ...
            Assert.AreEqual(
                dto.ToString("y", new CultureInfo("en-us")),
                dto.ToString("Y", new CultureInfo("en-us"))
            );
        }
        ...
        public void ToStringWithFormatAndCulture()
        {
            ...
            if (!GlobalizationMode.Invariant)
            {
                Assert.AreEqual(
                    ...
                    dto.ToString(format, new CultureInfo("fr-FR")),
                    "ts3"
                );
                Assert.AreEqual(
                    "jueves, nov. 01 2007 09:00:00 -07:00",
                    dto.ToString(format, new CultureInfo("es-ES")),
                    "ts4"
                );
            }
        }
        ...
        public void ParseExactDatesOnly()
        {
            ...
            foreach (string format in formats)
            {
                ...
                Assert.AreEqual(
                    dto.Date,
                    DateTimeOffset.ParseExact(serialized, format, fp).Date,
                    format
                );
            }
        }
        ...
        {
            DateTimeOffset o = DateTimeOffset.ParseExact(
                "Wed Mar 17 22:25:08 +0000 2010",
                "ddd MMM d H:m:ss K yyyy",
        ...
        public void ParseExactOffsetFormat()
        {
            ...
            for (int i = 0; i < dates.Length; i++)
                Assert.AreEqual(
                    offsets[i],
                    DateTimeOffset.ParseExact(dates[i], "d/MMM/yyyy:HH:mm:ss zzz", fp).Offset,
                    dates[i]
                );
        }
        ...
        public void Deserialization()
        {
            ...
            for (int i = 0; i < SerializationCases.Length; ++i)
            {
                ...
                Assert.AreEqual(
                    SerializationCases[i].Input.DateTime,
                    result.DateTime,
                    ".DateTime #" + i
                );
                ...
                Assert.AreEqual(
                    ...
                    SerializationCases[i].Input.DateTime.Kind,
                    ".DateTime.Kind==unspec #" + i
                );
                Assert.AreEqual(
                    SerializationCases[i].Input.DateTime.Kind,
                    result.DateTime.Kind,
                    ".DateTime.Kind #" + i
                );
            } //for
        }
        ...
        readonly TestRow[] SerializationCases =
        {
            ...
            new TestRow(
                new DateTimeOffset(new DateTime(2007, 01, 02, 12, 30, 50)),
...
#endif
            new TestRow(
                new DateTimeOffset(new DateTime(2007, 01, 02, 12, 30, 50), new TimeSpan(0, 0, 0)),
                "00-01-00-00-00-FF-FF-FF-FF-01-00-00-00-00-00-00-"
                    + "00-04-01-00-00-00-15-53-79-73-74-65-6D-2E-44-61-"
                    + "74-65-54-69-6D-65-4F-66-66-73-65-74-02-00-00-00-"
                    + "08-44-61-74-65-54-69-6D-65-0D-4F-66-66-73-65-74-"
            ...
            new TestRow(
                new DateTimeOffset(new DateTime(2007, 01, 02, 12, 30, 50), new TimeSpan(1, 0, 0)),
                "00-01-00-00-00-FF-FF-FF-FF-01-00-00-00-00-00-00-"
                    + "00-04-01-00-00-00-15-53-79-73-74-65-6D-2E-44-61-"
                    + "74-65-54-69-6D-65-4F-66-66-73-65-74-02-00-00-00-"
                    + "08-44-61-74-65-54-69-6D-65-0D-4F-66-66-73-65-74-"
            ...
            new TestRow(
                new DateTimeOffset(new DateTime(2007, 01, 02, 12, 30, 50), new TimeSpan(0, 30, 0)),
                "00-01-00-00-00-FF-FF-FF-FF-01-00-00-00-00-00-00-"
                    + "00-04-01-00-00-00-15-53-79-73-74-65-6D-2E-44-61-"
                    + "74-65-54-69-6D-65-4F-66-66-73-65-74-02-00-00-00-"
                    + "08-44-61-74-65-54-69-6D-65-0D-4F-66-66-73-65-74-"
            ...
            new TestRow(
                new DateTimeOffset(new DateTime(2007, 01, 02, 12, 30, 50), new TimeSpan(-5, 0, 0)),
                "00-01-00-00-00-FF-FF-FF-FF-01-00-00-00-00-00-00-"
                    + "00-04-01-00-00-00-15-53-79-73-74-65-6D-2E-44-61-"
                    + "74-65-54-69-6D-65-4F-66-66-73-65-74-02-00-00-00-"
                    + "08-44-61-74-65-54-69-6D-65-0D-4F-66-66-73-65-74-"
            ...
            new TestRow(
                new DateTimeOffset(
                    new DateTime(2007, 01, 02, 12, 30, 50),
            ...
            //----
            new TestRow(
                new DateTimeOffset(new DateTime(2007, 01, 02, 12, 30, 50, DateTimeKind.Utc)),
                "00-01-00-00-00-FF-FF-FF-FF-01-00-00-00-00-00-00-"
                    + "00-04-01-00-00-00-15-53-79-73-74-65-6D-2E-44-61-"
                    + "74-65-54-69-6D-65-4F-66-66-73-65-74-02-00-00-00-"
                    + "08-44-61-74-65-54-69-6D-65-0D-4F-66-66-73-65-74-"
            ...
            new TestRow(
                new DateTimeOffset(
                    new DateTime(2007, 01, 02, 12, 30, 50, DateTimeKind.Local),
                    new TimeSpan(0, 0, 0)
                ),
                "00-01-00-00-00-FF-FF-FF-FF-01-00-00-00-00-00-00-"
                    + "00-04-01-00-00-00-15-53-79-73-74-65-6D-2E-44-61-"
