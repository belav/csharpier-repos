    ...
    public class ModuleHandleTest
    {
        ...
        public void ResolveTypeToken()
        {
            ...
            Assert.AreEqual(
                ...
                Type.GetTypeFromHandle(
                    module.ResolveTypeHandle(typeof(ModuleHandleTest).MetadataToken)
                )
            );
        }
        ...
        public void ResolveFieldToken()
        {
            ...
            Assert.AreEqual(
                ...
                FieldInfo.GetFieldFromHandle(module.ResolveFieldHandle(fi.MetadataToken))
            );
        }
        ...
        public void ResolveMethodToken()
        {
            ...
            Assert.AreEqual(
                mi,
                MethodInfo.GetMethodFromHandle(module.ResolveMethodHandle(mi.MetadataToken))
            );
        }
