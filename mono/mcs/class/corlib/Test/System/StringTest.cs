    ...
    public class StringTest
    {
        ...
        public void CompareNotWorking2()
        {
            ...
            for (int i = 1; i <= (haystack.Length - needle.Length); i++)
            {
                if (i != 7)
                {
                    Assert.AreEqual(
                        -1,
                        String.Compare(needle, 0, haystack, i, 2, false),
                        "loop substring check #8/" + i
                    );
                }
            }
        }
        ...
        public void Compare()
        {
            ...
            Assert.AreEqual(
                ...
                "basic substring check #1"
            );
            Assert.AreEqual(
                -1,
                String.Compare(needle, 0, haystack, 0, 3),
                "basic substring check #2"
            );
            ...
            for (int i = 1; i <= (haystack.Length - needle.Length); i++)
            {
                ...
                {
                    Assert.IsTrue(
                        String.Compare(needle, 0, haystack, i, 2) != 0,
                        "loop substring check #1/" + i
                    );
                    Assert.IsTrue(
                        String.Compare(needle, 0, haystack, i, 3) != 0,
                        "loop substring check #2/" + i
                    );
                }
                else
                {
                    Assert.AreEqual(
                        0,
                        String.Compare(needle, 0, haystack, i, 2),
                        "loop substring check #3/" + i
                    );
                    Assert.AreEqual(
                        0,
                        String.Compare(needle, 0, haystack, i, 3),
                        "loop substring check #4/" + i
                    );
                }
            }
            ...
            for (int i = 1; i <= (haystack.Length - needle.Length); i++)
            {
                ...
                {
                    Assert.IsTrue(
                        String.Compare(needle, 0, haystack, i, 2, true) != 0,
                        "loop substring check #5/" + i
                    );
                    Assert.IsTrue(
                        String.Compare(needle, 0, haystack, i, 2, false) != 0,
                        "loop substring check #6/" + i
                    );
                }
                else
                {
                    Assert.AreEqual(
                        0,
                        String.Compare(needle, 0, haystack, i, 2, true),
                        "loop substring check #7/" + i
                    );
                }
            }
        ...
        public void CompareOrdinal()
        {
            ...
            for (int i = 1; i <= (haystack.Length - needle.Length); i++)
            {
                ...
                {
                    Assert.IsTrue(
                        String.CompareOrdinal(needle, 0, haystack, i, 2) != 0,
                        "loop substring check " + i
                    );
                    Assert.IsTrue(
                        String.CompareOrdinal(needle, 0, haystack, i, 3) != 0,
                        "loop substring check " + i
                    );
                }
                else
                {
                    Assert.AreEqual(
                        0,
                        String.CompareOrdinal(needle, 0, haystack, i, 2),
                        "loop substring check " + i
                    );
                    Assert.AreEqual(
                        0,
                        String.CompareOrdinal(needle, 0, haystack, i, 3),
                        "loop substring check " + i
                    );
                }
            }
        ...
        public void CompareOrdinalSubstringWithNull()
        {
            ...
            Assert.AreEqual(
                -1,
                string.CompareOrdinal(null, 0, greater, 0, 0),
                "substring strA null"
            );
            Assert.AreEqual(
                -1,
                string.CompareOrdinal(null, 4, greater, 0, 0),
                "substring strA null; indexA greater than strA.Length"
            );
            Assert.AreEqual(
                -1,
                string.CompareOrdinal(null, 0, greater, 4, 0),
                "substring strA null; indexB greater than strB.Length"
            );
            Assert.AreEqual(
                -1,
                string.CompareOrdinal(null, -1, greater, -1, -1),
                "substring strA null; indexA, indexB, length negative"
            );
            Assert.AreEqual(1, string.CompareOrdinal(lesser, 0, null, 0, 0), "substring strB null");
            Assert.AreEqual(
                1,
                string.CompareOrdinal(lesser, 4, null, 0, 0),
                "substring strB null; indexA greater than strA.Length"
            );
            Assert.AreEqual(
                1,
                string.CompareOrdinal(lesser, 0, null, 4, 0),
                "substring strB null; indexB greater than strB.Length"
            );
            Assert.AreEqual(
                1,
                string.CompareOrdinal(lesser, -1, null, -1, -1),
                "substring strB null; indexA, indexB, length negative"
            );
        }
        ...
        public void TestFormat()
        {
            ...
            Assert.AreEqual(
                "X   37X",
                String.Format("X{0,5}X", 37),
                "Single argument, right justified."
            );
            Assert.AreEqual(
                "X37   X",
                String.Format("X{0,-5}X", 37),
                "Single argument, left justified."
            );
            Assert.AreEqual("  7d", String.Format("{0, 4:x}", 125), "Whitespace in specifier");
            Assert.AreEqual(
                "The 3 wise men.",
                String.Format("The {0} wise {1}.", 3, "men"),
                "Two arguments."
            );
            Assert.AreEqual(
                "do re me fa so.",
                String.Format("{0} re {1} fa {2}.", "do", "me", "so"),
                "Three arguments."
            );
            Assert.AreEqual(
                "###00c0ffee#",
                String.Format("###{0:x8}#", 0xc0ffee),
                "Formatted argument."
            );
            Assert.AreEqual(
                "#  033#",
                String.Format("#{0,5:x3}#", 0x33),
                "Formatted argument, right justified."
            );
            Assert.AreEqual(
                "#033  #",
                String.Format("#{0,-5:x3}#", 0x33),
                "Formatted argument, left justified."
            );
            Assert.AreEqual(
                "typedef struct _MonoObject { ... } MonoObject;",
                String.Format("typedef struct _{0} {{ ... }} MonoObject;", "MonoObject"),
                "Escaped bracket"
            );
            Assert.AreEqual(
                "Could not find file \"a/b\"",
                String.Format("Could not find file \"{0}\"", "a/b"),
                "With Slash"
            );
            Assert.AreEqual(
                "Could not find file \"a\\b\"",
        ...
        public void Format3_Format_Null()
        {
            try
            {
                String.Format(CultureInfo.InvariantCulture, null, new object[] { 3 });
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void Format3_Args_Null()
        {
            try
            {
                String.Format(CultureInfo.InvariantCulture, "text", (object[])null);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void IndexOfStringComparison()
        {
            ...
            Assert.AreEqual(
                -1,
                text.IndexOf(text3, 7, 3, StringComparison.OrdinalIgnoreCase),
                "#2-5"
            );
            ...
            Assert.AreEqual(
                -1,
                text.IndexOf(text3, 5, 0, StringComparison.OrdinalIgnoreCase),
                "#2-6"
            );
            ...
            Assert.AreEqual(
                -1,
                text.IndexOf(text3, 5, 1, StringComparison.OrdinalIgnoreCase),
                "#2-7"
            );
            ...
            Assert.AreEqual(
                -1,
                text.IndexOf(text4, 13, StringComparison.OrdinalIgnoreCase),
                "#4-2"
            );
            ...
            Assert.AreEqual(
                -1,
                text.IndexOf(text4, 13, 0, StringComparison.OrdinalIgnoreCase),
                "#4-2"
            );
            ...
            Assert.AreEqual(
                12,
                text.IndexOf("6", 12, 1, StringComparison.OrdinalIgnoreCase),
                "#5-2"
            );
        }
        ...
        public void IndexOfOrdinalCountSmallerThanValueString()
        {
            ...
            Assert.AreEqual(
                -1,
                "Test".IndexOf("ST", 2, 1, StringComparison.OrdinalIgnoreCase),
                "#2"
            );
            Assert.AreEqual(-1, "Test".LastIndexOf("ST", 2, 1, StringComparison.Ordinal), "#3");
            Assert.AreEqual(
                -1,
                "Test".LastIndexOf("ST", 2, 1, StringComparison.OrdinalIgnoreCase),
                "#4"
            );
        }
        ...
        public void LastIndexOf()
        {
            ...
            Assert.AreEqual(
                0,
                s1.LastIndexOf("original", s1.Length - 2),
                "stepped string index #2"
            );
            Assert.AreEqual(
                -1,
                s1.LastIndexOf("original", s1.Length - 11),
                "stepped string index #3"
            );
            Assert.AreEqual(-1, s1.LastIndexOf("translator", 2), "stepped string index #4");
            Assert.AreEqual(
                0,
                string.Empty.LastIndexOf(string.Empty, 0),
                "stepped string index #5"
            );
            Assert.AreEqual(-1, string.Empty.LastIndexOf("A", -1), "stepped string index #6");
            Assert.AreEqual(
                10,
                s1.LastIndexOf("rig", s1.Length - 1, 10),
                "stepped limited string index #1"
            );
            Assert.AreEqual(
                -1,
                s1.LastIndexOf("rig", s1.Length, 3),
                "stepped limited string index #2"
            );
            Assert.AreEqual(
                10,
                s1.LastIndexOf("rig", s1.Length - 2, 15),
                "stepped limited string index #3"
            );
            Assert.AreEqual(
                -1,
                s1.LastIndexOf("rig", s1.Length - 2, 3),
                "stepped limited string index #4"
            );
        ...
        public void LastIndexOfStringComparison()
        {
            ...
            Assert.AreEqual(
                5,
                text.LastIndexOf(text3, 12, StringComparison.OrdinalIgnoreCase),
                "#2-2"
            );
            ...
            Assert.AreEqual(
                -1,
                text.LastIndexOf(text3, 0, StringComparison.OrdinalIgnoreCase),
                "#2-3"
            );
            ...
            Assert.AreEqual(
                5,
                text.LastIndexOf(text3, 6, StringComparison.OrdinalIgnoreCase),
                "#2-4"
            );
            ...
            Assert.AreEqual(
                5,
                text.LastIndexOf(text3, 7, 3, StringComparison.OrdinalIgnoreCase),
                "#2-5"
            );
            ...
            Assert.AreEqual(
                -1,
                text.LastIndexOf(text3, 5, 0, StringComparison.OrdinalIgnoreCase),
                "#2-6"
            );
            ...
            Assert.AreEqual(
                -1,
                text.LastIndexOf(text3, 5, 1, StringComparison.OrdinalIgnoreCase),
                "#2-7"
            );
            ...
            Assert.AreEqual(
                0,
                text.LastIndexOf(text4, 0, StringComparison.OrdinalIgnoreCase),
                "#3-2"
            );
            ...
            Assert.AreEqual(
                3,
                text.LastIndexOf(text4, 13, StringComparison.OrdinalIgnoreCase),
                "#4-2"
            );
            ...
            Assert.AreEqual(
                3,
                text.LastIndexOf(text4, 13, 14, StringComparison.OrdinalIgnoreCase),
                "#4-2"
            );
            ...
            Assert.AreEqual(
                0,
                text.LastIndexOf(text4, 1, 2, StringComparison.OrdinalIgnoreCase),
                "#5-2"
            );
        ...
        public void Replace()
        {
            ...
            Assert.AreEqual(
                "original",
                s1.Replace("original2", "original3"),
                "replace bigger that original"
            );
            ...
            Assert.AreEqual(
                "Original",
                s1.Replace("o", "O", false, CultureInfo.CurrentCulture),
        ...
        public void TestSplit()
        {
            ...
            Assert.AreEqual(
                0,
                "\x9\xa\xb\xc\xd\x20\x85\xa0\x1680\x2000\x2001\x2002\x2003\x2004\x2005\x2006\x2007\x2008\x2009\x200a\x2028\x2029\x202f\x205f\x3000"
        ...
        public void MoreSplit()
        {
            ...
            Assert.AreEqual(
                1,
                "encyclopædia".Split(new[] { "ae" }, StringSplitOptions.None).Length,
                "#03"
            );
        }
        ...
        public void SplitStringChars()
        {
            ...
            Assert.AreEqual(
                0,
                "    ".Split((char[])null, 2, StringSplitOptions.RemoveEmptyEntries).Length,
                "#12-00-0"
            );
        ...
        public void Normalize3()
        {
            ...
            var formC = new string(
                new char[] { '\u064A', '\u064F', '\u0624', '\u0652', '\u064a', '\u064f', '\u0624' }
            );
            var formD = new string(
                new char[]
                {
                    '\u064A',
                    '\u064F',
        ...
        public void NormalizeFormD()
        {
            ...
            Assert.AreEqual(
                "\u1E69".Normalize(NormalizationForm.FormD),
                "\u0073\u0323\u0307",
                "#2"
            );
            Assert.AreEqual(
                "\u1e4e".Normalize(NormalizationForm.FormD),
                "\u004f\u0303\u0308",
                "#3"
            );
            Assert.AreEqual(
                "\u1e2f".Normalize(NormalizationForm.FormD),
                "\u0069\u0308\u0301",
                "#4"
            );
        }
        ...
        {
            Assert.AreEqual(
                "\u0041\u030a\u0061\u030a".Normalize(NormalizationForm.FormC),
                "\u00c5\u00e5",
                "#1"
            );
            Assert.AreEqual("\u006E\u0303".Normalize(NormalizationForm.FormC), "\u00F1", "#2");
            Assert.AreEqual(
                "\u03B7\u0313\u0300\u0345".Normalize(NormalizationForm.FormC),
                "\u1F92",
                "#3"
            );
        }
        ...
        {
            Assert.AreEqual(
                "\u1E0A\u0323".Normalize(NormalizationForm.FormC),
                "\u1E0C\u0307",
                "#1"
            );
            Assert.AreEqual(
                "\u0044\u0323\u0307".Normalize(NormalizationForm.FormC),
                "\u1E0C\u0307",
                "#2"
            );
        }
        ...
        public void Emptiness()
        {
            ...
            Assert.AreSame(
                String.Empty,
                String.Concat((object)String.Empty, (object)String.Empty),
            ...
            Assert.AreEqual(
                String.Empty,
                String.Concat(String.Empty, String.Empty, String.Empty),
                "Concat(string,string,string)"
            );
            Assert.AreEqual(
                String.Empty,
                String.Concat((object)null, (object)(object)null, (object)null, (object)null),
                "Concat(null,null,null,null)-object"
            );
            Assert.AreSame(
                String.Empty,
                String.Concat((string)null, (string)(string)null, (string)null, (string)null),
                "Concat(null,null,null,null)-string"
            );
            Assert.AreSame(
                String.Empty,
                String.Concat(String.Empty, String.Empty, String.Empty, String.Empty),
                "Concat(string,string,string,string)"
            );
            Assert.AreEqual(
                String.Empty,
                String.Concat(new object[] { String.Empty, String.Empty }),
                "Concat(object[])"
            );
            Assert.AreEqual(
                String.Empty,
                String.Concat(new string[] { String.Empty, String.Empty }),
                "Concat(string[])"
            );
