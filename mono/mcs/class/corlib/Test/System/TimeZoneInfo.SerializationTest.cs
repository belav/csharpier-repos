    ...
    public class SerializedStringTests
    {
        ...
        public void SystemTimeZoneSerializationTests()
        {
            foreach (var tmz in TimeZoneInfo.GetSystemTimeZones())
            {
                ...
                Assert.AreEqual(
                    tmz.SupportsDaylightSavingTime,
                    tmzClone.SupportsDaylightSavingTime
                );
        ...
        {
            var tz1 = TimeZoneInfo.CreateCustomTimeZone(
                @"My\; Zone, @1!.",
                TimeSpan.FromMinutes(0),
                @"My\\; Zone 1 Name",
                "My; Zone 1 Standard Time"
            );
            Assert.AreEqual(
                @"My\\\; Zone, @1!.;0;My\\\\\; Zone 1 Name;My\; Zone 1 Standard Time;My\; Zone 1 Standard Time;;",
                tz1.ToSerializedString()
            );
        }
        ...
        {
            var tz2 = TimeZoneInfo.CreateCustomTimeZone(
                "My Zone 2",
                TimeSpan.FromHours(1.25),
                "My Zone 2 Name",
                "My Zone 2 Standard Time"
            );
            Assert.AreEqual(
                "My Zone 2;75;My Zone 2 Name;My Zone 2 Standard Time;My Zone 2 Standard Time;;",
                tz2.ToSerializedString()
            );
        }
        ...
        public void SerializeCustomZoneWithFloatingDaylightTransitions()
        {
            ...
            var tz3 = TimeZoneInfo.CreateCustomTimeZone(
                "My Zone 3",
                TimeSpan.FromHours(-4),
                "My Zone 3 Name",
                "My Zone 3 Standard Time",
                "My Zone 3 Daylight Time",
                tz3rules
            );
            Assert.AreEqual(
                "My Zone 3;-240;My Zone 3 Name;My Zone 3 Standard Time;My Zone 3 Daylight Time;[01:01:0001;12:31:9999;23;[1;00:00:00;1;1;];[1;00:00:00;12;31;];];",
                tz3.ToSerializedString()
            );
        }
        ...
        public void SerializeCustomZoneWithFixedDaylightTransitions()
        {
            ...
            var tz4 = TimeZoneInfo.CreateCustomTimeZone(
                "My Zone 4",
                TimeSpan.FromHours(-4),
                "My Zone 4 Name",
                "My Zone 4 Standard Time",
                "My Zone 4 Daylight Time",
                tz4rules
            );
            Assert.AreEqual(
                "My Zone 4;-240;My Zone 4 Name;My Zone 4 Standard Time;My Zone 4 Daylight Time;[01:01:0001;12:31:9999;23;[1;00:00:00;1;1;];[1;00:00:00;12;31;];];",
                tz4.ToSerializedString()
            );
        }
        ...
        public void SerializeCustomZoneWithMultipleDaylightRules()
        {
            ...
            var tz5 = TimeZoneInfo.CreateCustomTimeZone(
                "My Zone 5",
                TimeSpan.FromHours(-6.75),
                "My Zone 5 Name",
                "My Zone 5 Standard Time",
                "My Zone 5 Daylight Time",
                tz5rules
            );
            Assert.AreEqual(
                "My Zone 5;-405;My Zone 5 Name;My Zone 5 Standard Time;My Zone 5 Daylight Time;[01:01:0001;12:31:2012;23;[1;00:00:00;1;1;];[1;00:00:00;12;31;];][01:01:2013;12:31:9999;48;[1;00:00:00;1;1;];[1;00:00:00;12;31;];];",
                tz5.ToSerializedString()
            );
        }
        ...
        public void DeserializeCustomZoneWithOddNamingAndMultipleDaylightRules()
        {
            ...
            var tz1 = TimeZoneInfo.FromSerializedString(
                "My\\; Zone 5;-405;My Zone\\; 5 Name;My Zone 5\\; Standard Time;My Zone 5 Daylight\\; Time;[01:01:0001;12:31:2012;23;[0;02:15:59.999;3;2;2;];[0;02:15:59.999;6;2;2;];][01:01:2013;12:31:9999;48;[0;02:15:59.999;3;2;2;];[0;02:15:59.999;6;2;2;];];"
            );
        ...
        {
            var et = TimeZoneInfo.FromSerializedString(
