...
namespace MonoTests.System
{
    ...
    public class MathTest
    {
        ...
        public void TestAtan()
        {
            ...
            Assert.IsTrue(
                (Math.Abs(a - b) <= double_epsilon),
                "#1: " + a.ToString("G99") + " != " + b.ToString("G99")
            );
            ...
            Assert.IsTrue(
                ...
                "#2: "
                    + Math.Atan(double.PositiveInfinity).ToString("G99")
                    + " != "
                    + c.ToString("G99")
            );
            Assert.IsTrue(
                ...
                "#3: "
                    + Math.Atan(double.NegativeInfinity).ToString("G99")
                    + " != "
                    + d.ToString("G99")
            );
        }
        ...
        */
        ...
        public void TestSinh()
        {
            ...
            Assert.IsTrue(
                double.IsNegativeInfinity(Math.Sinh(Double.NegativeInfinity)),
                "SinH of -inf should be -inf"
            );
            Assert.IsTrue(
                double.IsPositiveInfinity(Math.Sinh(Double.PositiveInfinity)),
                "SinH of +inf should be +inf"
            );
        }
        ...
        public void TestTanh()
        {
            ...
            Assert.IsTrue(Double.IsNaN(Math.Tanh(Double.NaN)), "Tanh(NaN) should be NaN");
            Assert.IsTrue(1 == Math.Tanh(Double.PositiveInfinity), "Tanh(+Infinity) should be 1");
            Assert.IsTrue(-1 == Math.Tanh(Double.NegativeInfinity), "Tanh(-Infinity) should be -1");
        }
        ...
        public void TestLog2()
        {
            ...
            Assert.IsTrue(
                (Math.Abs(a - b) <= 1e-14),
                a + " != " + b + " because diff is " + Math.Abs(a - b)
            );
        ...
        public void TestDoubleRound3()
        {
            ...
            Assert.AreEqual(
                -1.2345D,
                Math.Round(-1.2345D, 4, MidpointRounding.AwayFromZero),
                "#1C"
            );
            ...
            Assert.AreEqual(
                -1.5432D,
                Math.Round(-1.5432D, 4, MidpointRounding.AwayFromZero),
                "#30"
            );
            ...
            Assert.AreEqual(
                63988D,
                Math.Round(63987.83593942D, 0, MidpointRounding.AwayFromZero),
                "#32"
            );

            Assert.AreEqual(
                -63988D,
                Math.Round(-63987.83593942D, 0, MidpointRounding.ToEven),
                "#33"
            );
            Assert.AreEqual(
                -63988D,
            ...
            Assert.AreEqual(
                63987.83594D,
                Math.Round(63987.83593942D, 5, MidpointRounding.ToEven),
                "#35"
            );
            Assert.AreEqual(
                63987.83594D,
                Math.Round(63987.83593942D, 5, MidpointRounding.AwayFromZero),
                "#36"
            );
            ...
            Assert.AreEqual(
                63987.83593942D,
                Math.Round(63987.83593942D, 8, MidpointRounding.ToEven),
                "#39"
            );
            Assert.AreEqual(
                63987.83593942D,
                Math.Round(63987.83593942D, 8, MidpointRounding.AwayFromZero),
                "#3A"
            );
