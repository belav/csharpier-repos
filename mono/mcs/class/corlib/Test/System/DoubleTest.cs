...
namespace MonoTests.System
{
    ...
    public class DoubleTest
    {
        ...
        public void Parse()
        {
            ...
            {
                Assert.Fail(
                    "#C2: Parse Failed NumberStyles.AllowThousands with e = " + e.ToString()
                );
            }
        ...
        public void CustomFormatHelper()
        {
            ...
            list.Add(new Element(1234567890d, "(###) ### - ####", "(123) 456 - 7890"));
            list.Add(new Element(1234567890d, "#.##", "1234567890"));
            ...
            list.Add(new Element(-1234d, "##;(##)", "(1234)"));
            list.Add(new Element(-1234d, "##;(##)", "(1234)"));
            list.Add(new Element(12345678901234567890.123d, "#####", "12345678901234600000"));
            list.Add(new Element(12345678901234567890.123d, "00000", "12345678901234600000"));
            list.Add(
                new Element(
            ...
            list.Add(new Element(12345678901234567890.123d, "#.##", "12345678901234600000"));
            list.Add(new Element(12345678901234567890.123d, "0.00", "12345678901234600000.00"));
            list.Add(new Element(12345678901234567890.123d, "00.00", "12345678901234600000.00"));
            list.Add(new Element(12345678901234567890.123d, "#,#", "12,345,678,901,234,600,000"));
            list.Add(new Element(12345678901234567890.123d, "#,,", "12345678901235"));
            list.Add(new Element(12345678901234567890.123d, "#,,,", "12345678901"));
            list.Add(new Element(12345678901234567890.123d, "#,##0,,", "12,345,678,901,235"));
            list.Add(new Element(12345678901234567890.123d, "#0.##%", "1234567890123460000000%"));
            list.Add(new Element(12345678901234567890.123d, "0.###E+0", "1.235E+19"));
            list.Add(new Element(12345678901234567890.123d, "0.###E+000", "1.235E+019"));
            list.Add(new Element(12345678901234567890.123d, "0.###E-000", "1.235E019"));
            list.Add(
                new Element(12345678901234567890.123d, "[##-##-##]", "[1234567890123460-00-00]")
            );
            list.Add(new Element(12345678901234567890.123d, "##;(##)", "12345678901234600000"));
            list.Add(new Element(12345678901234567890.123d, "##;(##)", "12345678901234600000"));
        ...
        {
            double value;
            Assert.IsFalse(Double.TryParse("error", NumberStyles.Integer, null, out value));
        }
        ...
        public void TryParse_NonDigitStrings()
        {
            ...
            Assert.IsFalse(
                Double.TryParse("with whitespace", NumberStyles.Any, null, out value),
                "#2"
            );
        ...
        public void ParseAdvanced()
        {
            Assert.AreEqual(
                ...
                double.Parse(
                    "(456 ) ",
                    NumberStyles.AllowParentheses | NumberStyles.AllowTrailingWhite,
            ...
            Assert.AreEqual(
                -456,
                double.Parse("(456)", NumberStyles.AllowParentheses, CultureInfo.InvariantCulture),
                "#2"
            );
            Assert.AreEqual(
                -3,
                double.Parse("3-", NumberStyles.AllowTrailingSign, CultureInfo.InvariantCulture),
                "#3"
            );
            Assert.AreEqual(
                -3.5,
            ...
            Assert.AreEqual(
                -900000,
                double.Parse(
                    "-9E5 " + CultureInfo.InvariantCulture.NumberFormat.CurrencySymbol + "   ",
                    NumberStyles.Any,
                    CultureInfo.InvariantCulture
                ),
                "#6"
