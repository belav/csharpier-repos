...
#endif
using System.Runtime.InteropServices;using System.Threading;using NUnit.Framework;
...
namespace MonoTests.System
{
    ...
    public class AttributeTest
    {
        ...
        {
            Assert.IsTrue(
                Attribute.IsDefined(typeof(MyDerivedClass), typeof(MyCustomAttribute)),
                "#1"
            );
            Assert.IsTrue(
                Attribute.IsDefined(typeof(MyDerivedClass), typeof(YourCustomAttribute)),
                "#2"
            );
            Assert.IsFalse(
                Attribute.IsDefined(typeof(MyDerivedClass), typeof(UnusedAttribute)),
                "#3"
            );
            Assert.IsTrue(
        ...
        public void TestGetCustomAttribute()
        {
            ...
            try
            {
                ...
                i++;
                Assert.IsNotNull(
                    Attribute.GetCustomAttribute(t, typeof(YourCustomAttribute)),
                    "#4"
                );
                i++;
                Assert.AreEqual(
        ...
        {
            PropertyInfo pi = typeof(TestBase).GetProperty("PropBase3");
            Assert.IsNotNull(Attribute.GetCustomAttribute(pi, typeof(PropTestAttribute)), "#A1");
            Assert.IsNotNull(
                Attribute.GetCustomAttribute(pi, typeof(PropTestAttribute), false),
                "#A2"
            );
            Assert.IsNotNull(
                Attribute.GetCustomAttribute(pi, typeof(PropTestAttribute), true),
                "#A3"
            );
            Assert.IsNull(Attribute.GetCustomAttribute(pi, typeof(ComVisibleAttribute)), "#A4");
            Assert.IsNull(
                Attribute.GetCustomAttribute(pi, typeof(ComVisibleAttribute), false),
                "#A5"
            );
            Assert.IsNull(
                Attribute.GetCustomAttribute(pi, typeof(ComVisibleAttribute), true),
                "#A6"
            );

            pi = typeof(TestBase).GetProperty("PropBase2");
            Assert.IsNotNull(Attribute.GetCustomAttribute(pi, typeof(PropTestAttribute)), "#C1");
            Assert.IsNotNull(
                Attribute.GetCustomAttribute(pi, typeof(PropTestAttribute), false),
                "#C2"
            );
            ...
            Assert.IsNotNull(Attribute.GetCustomAttribute(pi, typeof(ComVisibleAttribute)), "#C4");
            Assert.IsNotNull(
                Attribute.GetCustomAttribute(pi, typeof(ComVisibleAttribute), false),
                "#C5"
            );
            ...
            pi = typeof(TestSub).GetProperty("PropBase2");
            Assert.IsNotNull(Attribute.GetCustomAttribute(pi, typeof(PropTestAttribute)), "#D1");
            Assert.IsNotNull(
                Attribute.GetCustomAttribute(pi, typeof(PropTestAttribute), false),
                "#D2"
            );
            ...
            Assert.IsNotNull(Attribute.GetCustomAttribute(pi, typeof(ComVisibleAttribute)), "#D4");
            Assert.IsNotNull(
                Attribute.GetCustomAttribute(pi, typeof(ComVisibleAttribute), false),
                "#D5"
            );
        ...
        {
            PropertyInfo pi = typeof(TestSub).GetProperty("PropBase3");
            Assert.IsNotNull(Attribute.GetCustomAttribute(pi, typeof(PropTestAttribute)), "#B1");
            Assert.IsNull(
                Attribute.GetCustomAttribute(pi, typeof(PropTestAttribute), false),
                "#B2"
            );
            ...
            Assert.IsNull(Attribute.GetCustomAttribute(pi, typeof(ComVisibleAttribute)), "#B4");
            Assert.IsNull(
                Attribute.GetCustomAttribute(pi, typeof(ComVisibleAttribute), false),
                "#B5"
            );
        ...
        public void GetCustomAttributesTypeNoInherit()
        {
            ...
            Assert.AreEqual(1, GetAttributeCount(attributes, typeof(TestCustomAttribute)), "#A2");
            Assert.AreEqual(
                1,
                GetAttributeCount(attributes, typeof(DerivedTestCustomAttributeMultiple)),
                "#A3"
            );
            Assert.AreEqual(
                1,
                GetAttributeCount(attributes, typeof(DerivedTestCustomAttributeInherit)),
                "#A4"
            );

            attributes = Attribute.GetCustomAttributes(typeof(ClassB), false);
            Assert.AreEqual(4, attributes.Length, "#B1");
            Assert.AreEqual(1, GetAttributeCount(attributes, typeof(TestCustomAttribute)), "#B2");
            Assert.AreEqual(
                2,
                GetAttributeCount(attributes, typeof(DerivedTestCustomAttributeMultiple)),
                "#B3"
            ...
            Assert.AreEqual(
                1,
                GetAttributeCount(attributes, typeof(DerivedTestCustomAttributeMultipleInherit)),
                "#B4"
            );
        }
        ...
        {
            Assert.IsTrue(
                Attribute.IsDefined(typeof(object), typeof(SerializableAttribute), true),
                "#1"
            );
            Assert.IsFalse(
                Attribute.IsDefined(typeof(AttributeTest), typeof(SerializableAttribute), true),
                "#2"
            );
        }
...
#pragma warning restore
        ...
        {
            Assert.IsTrue(
                new ArrayAttribute(new int[] { 1, 2 }).Equals(
                    new ArrayAttribute(new int[] { 1, 2 })
                )
            );
            Assert.IsFalse(
                new ArrayAttribute(new int[] { 1, 2 }).Equals(
                    new ArrayAttribute(new int[] { 1, 1 })
                )
            );
        }
    }
    ...
    public class ParamAttributeTest
    {
        ...
        public void GetCustomAttributeTopLevel()
        {
            ...
            Assert.IsNotNull(
                Attribute.GetCustomAttribute(parameter, typeof(ParamNamespace.BarAttribute))
            );
        }
        ...
        {
            var parameter = GetParameter(typeof(ParamNamespace.Derived), "Bar", "bar");
            var data = (ParamNamespace.DataAttribute)
                Attribute.GetCustomAttribute(parameter, typeof(ParamNamespace.DataAttribute));
        ...
        {
            var parameter = GetParameter(typeof(ParamNamespace.Derived), "Bar", "baz");
            var attributes = (ParamNamespace.DataAttribute[])
                Attribute.GetCustomAttributes(
                    parameter,
                    typeof(ParamNamespace.DataAttribute),
                    true
                );
