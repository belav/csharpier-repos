    ...
    public class DecimalTest
    {
        ...
        public void TestToString()
        {
            ToStringTest[] tab =
            {
                ...
                new ToStringTest(
                    "C",
                    123456.7890m,
                    NumberFormatInfo.InvariantInfo.CurrencySymbol + "123,456.79"
                ),
                new ToStringTest(
                    "C",
                    -123456.7890m,
                ...
                new ToStringTest(
                    "C3",
                    1123456.7890m,
                    NumberFormatInfo.InvariantInfo.CurrencySymbol + "1,123,456.789"
                ),
            ...
            for (int i = 0; i < tab.Length; i++)
            {
                try
                {
                    ...
                    Assert.AreEqual(
                        tab[i].str,
                        s,
                        "A01 tab[" + i + "].format = '" + tab[i].format + "')"
                    );
                }
                catch (OverflowException)
                {
                    Assert.Fail(
                        tab[i].d.ToString(tab[i].format, nfi)
                            + " (format = '"
                            + tab[i].format
        ...
        public void TestNumberNegativePattern()
        {
            ...
            for (int i = 0; i < ergNumberNegativePattern.Length; i++)
            {
                ...
                Assert.AreEqual(
                    ergNumberNegativePattern[i],
                    d.ToString("N", nfi2),
                    "NumberNegativePattern #" + i
                );
            }
        }
        ...
        public void TestBrokenNFI()
        {
            Assert.AreEqual(
                5.3m,
                decimal.Parse("5.3", NumberStyles.Number, NfiBroken),
                "Parsing with broken NFI"
            );
        }
        ...
        ParseTest[] tab =
        {
            ...
            new ParseTest(
                "  47896396.457983645462346E10  ",
                478963964579836454.62346m,
                NumberStyles.Float
            ),
            new ParseTest(
                "-7922816251426433759354395033.250000000000001",
                -7922816251426433759354395033.3m
            ),
            new ParseTest("-00000000000000795033.2500000000000000", -795033.25m),
            new ParseTest(
                "-000000000000001922816251426433759354395033.300000000000000",
                -1922816251426433759354395033.3m
            ),
            new ParseTest(
                "-7922816251426433759354395033.150000000000",
                -7922816251426433759354395033.2m
            ),
            new ParseTest(
                "-7922816251426433759354395033.2400000000000",
                -7922816251426433759354395033.2m
            ),
            new ParseTest(
                "-7922816251426433759354395033.2600000000000",
                -7922816251426433759354395033.3m
            ),
            new ParseTest(
                "987654321098765432109876543.25999",
                987654321098765432109876543.3m,
                NumberStyles.Float
            ),
            new ParseTest(
                "987654321098765432109876543.25199",
                987654321098765432109876543.3m,
                NumberStyles.Float
            ),
            new ParseTest(
                "2.22222222222222222222222222225",
                2.2222222222222222222222222222m,
                NumberStyles.Float
            ),
        };
        ...
        public void TestFloorTruncate()
        {
            decimal[,] dtab =
            {
                ...
                { -1m, -1m, -1m },
                { 1.1m, 1m, 1m },
                { -1.000000000001m, -2m, -1m },
                { 12345.67890m, 12345m, 12345m },
        ...
        public void TestRound()
        {
            decimal[,] dtab =
            {
                { 1m, 0, 1m },
                { 1.234567890m, 1, 1.2m },
                { 1.234567890m, 2, 1.23m },
                { 1.23450000001m, 3, 1.235m },
                { 1.2355m, 3, 1.236m },
                { 1.234567890m, 4, 1.2346m },
                { 1.23567890m, 2, 1.24m },
        ...
        public void TestRoundFailures()
        {
            ...
            for (int i = 0; i < dtab.GetLength(0); i++)
            {
                ...
                {
                    Assert.Fail(
                        "FailRound: Round(" + dtab[i, 0] + "," + (int)dtab[i, 1] + ") != " + d
                    );
                }
            }
        }
        ...
        public void ToString_Defaults()
        {
            ...
            Assert.AreEqual(
                def,
                d.ToString((IFormatProvider)null),
        ...
        public void Parse_Int64_Overflow()
        {
            ...
            decimal d = Decimal.Parse(
                "9223372036854775808.0000000009",
                CultureInfo.InvariantCulture
            );
            long l = (long)d;
        }
        ...
        */
        ...
        public void TryParse()
        {
            ...
            Assert.AreEqual(
                false,
                Decimal.TryParse("123nx", NumberStyles.Number, CultureInfo.InvariantCulture, out r)
            );
            Assert.AreEqual(
                false,
                Decimal.TryParse(null, NumberStyles.Number, CultureInfo.InvariantCulture, out r)
            );
        ...
        public void Round_EvenValue()
        {
            ...
            Assert.AreEqual(
                2.2222222222222222m,
                Decimal.Round(2.22222222222222225m, 16),
                "2,2_5,16"
            );
            Assert.AreEqual(
                2.22222222222222222m,
                Decimal.Round(2.222222222222222225m, 17),
                "2,2_5,17"
            );
            Assert.AreEqual(
                2.222222222222222222m,
                Decimal.Round(2.2222222222222222225m, 18),
                "2,2_5,18"
            );
            Assert.AreEqual(
                2.2222222222222222222m,
                Decimal.Round(2.22222222222222222225m, 19),
                "2,2_5,19"
            );
            Assert.AreEqual(
                2.22222222222222222222m,
                Decimal.Round(2.222222222222222222225m, 20),
                "2,2_5,20"
            );
            Assert.AreEqual(
                2.222222222222222222222m,
                Decimal.Round(2.2222222222222222222225m, 21),
                "2,2_5,21"
            );
            Assert.AreEqual(
                2.2222222222222222222222m,
                Decimal.Round(2.22222222222222222222225m, 22),
                "2,2_5,22"
            );
            Assert.AreEqual(
                2.22222222222222222222222m,
                Decimal.Round(2.222222222222222222222225m, 23),
                "2,2_5,23"
            );
            Assert.AreEqual(
                2.222222222222222222222222m,
                Decimal.Round(2.2222222222222222222222225m, 24),
                "2,2_5,24"
            );
            Assert.AreEqual(
                2.2222222222222222222222222m,
                Decimal.Round(2.22222222222222222222222225m, 25),
                "2,2_5,25"
            );
            Assert.AreEqual(
                2.22222222222222222222222222m,
                Decimal.Round(2.222222222222222222222222225m, 26),
                "2,2_5,26"
            );
            Assert.AreEqual(
                2.222222222222222222222222222m,
                Decimal.Round(2.2222222222222222222222222225m, 27),
                "2,2_5,27"
            );
            Assert.AreEqual(
                2.2222222222222222222222222222m,
                Decimal.Round(2.22222222222222222222222222225m, 28),
                "2,2_5,28"
            );
        }
        ...
        public void Round_EvenValue_Negative()
        {
            ...
            Assert.AreEqual(
                -2.22222222222222m,
                Decimal.Round(-2.222222222222225m, 14),
                "-2,2_5,14"
            );
            Assert.AreEqual(
                -2.222222222222222m,
                Decimal.Round(-2.2222222222222225m, 15),
                "-2,2_5,15"
            );
            Assert.AreEqual(
                -2.2222222222222222m,
        ...
        public void ToString_G()
        {
            ...
            Assert.AreEqual(
                ...
                (0.0000000000000000000001m).ToString(),
                "22"
            );
            Assert.AreEqual(
                "0.00000000000000000000001",
                (0.00000000000000000000001m).ToString(),
                "23"
            );
            Assert.AreEqual(
                "0.000000000000000000000001",
                (0.000000000000000000000001m).ToString(),
                "24"
            );
            Assert.AreEqual(
                "0.0000000000000000000000001",
                (0.0000000000000000000000001m).ToString(),
                "25"
            );
            Assert.AreEqual(
                "0.00000000000000000000000001",
                (0.00000000000000000000000001m).ToString(),
                "26"
            );
            Assert.AreEqual(
                "0.000000000000000000000000001",
                (0.000000000000000000000000001m).ToString(),
                "27"
            );
            Assert.AreEqual(
                "0.0000000000000000000000000001",
                (0.0000000000000000000000000001m).ToString(),
                "28"
            );
        }
        ...
        public void RoundToString()
        {
            ...
            Assert.AreEqual(
                "3.01",
                Math.Round(3.01M, 5).ToString(CultureInfo.InvariantCulture),
                "#2"
            );
            Assert.AreEqual(
                "-3.01",
            ...
            Assert.AreEqual(
                "128",
                Math.Round(127.5M, 0).ToString(CultureInfo.InvariantCulture),
                "#4"
            );
        }
