...
namespace MonoTests.System
{
    ...
    public class UInt64Test
    {
        ...
        private string[] Results2 =
        {
            ...
            "1.8447e+19",
            "18,446,744,073,709,551,615.00000",
            "1,844,674,407,370,955,161,500.00000 %",
            "ffffffffffffffff",
        };
        private string[] ResultsNfi2 =
        {
            NumberFormatInfo.InvariantInfo.CurrencySymbol + "18,446,744,073,709,551,615.00000",
            "18446744073709551615",
            "1.84467e+019",
            "18446744073709551615.00000",
            "1.8447e+19",
        ...
        public void SetUp()
        {
            ...
            Results2[0] =
                NumberFormatInfo.CurrentInfo.CurrencySymbol + "18,446,744,073,709,551,615.00000";
        ...
        public void TestParseExponent()
        {
            ...
            Assert.AreEqual(
                21,
                ulong.Parse("2.1E1", NumberStyles.AllowDecimalPoint | NumberStyles.AllowExponent),
                "A#7"
            );
            Assert.AreEqual(
                520,
                ulong.Parse(".52E3", NumberStyles.AllowDecimalPoint | NumberStyles.AllowExponent),
                "A#8"
            );
            Assert.AreEqual(
                32500000,
                ulong.Parse("32.5E6", NumberStyles.AllowDecimalPoint | NumberStyles.AllowExponent),
                "A#9"
            );
            Assert.AreEqual(
                890,
        ...
        public void TestTryParse()
        {
            ...
            Assert.AreEqual(
                true,
                ulong.TryParse("100000000", NumberStyles.HexNumber, Nfi, out result)
            );
            Assert.AreEqual(true, ulong.TryParse("10000000000", out result));
            Assert.AreEqual(false, ulong.TryParse("-10000000000", out result));
            Assert.AreEqual(
                true,
                ulong.TryParse("7fffffff", NumberStyles.HexNumber, Nfi, out result)
            );
            Assert.AreEqual(int.MaxValue, result);
            Assert.AreEqual(
                true,
                ulong.TryParse("80000000", NumberStyles.HexNumber, Nfi, out result)
            );
            Assert.AreEqual(2147483648, result);
            Assert.AreEqual(
                true,
                ulong.TryParse("ffffffff", NumberStyles.HexNumber, Nfi, out result)
            );
