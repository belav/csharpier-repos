    ...
    public class EnumTest
    {
        ...
        public void TestFormat_Args()
        {
            ...
            Assert.AreEqual(
                ...
                Enum.Format(typeof(TestingEnum3), TestingEnum3.Test, "d"),
                "#H2"
            );
        ...
        {
            Assert.AreEqual(
                typeof(EnumOverlap).GetEnumName(0),
                Enum.GetName(typeof(EnumOverlap), 0),
                "#1"
            );
        ...
        public void ParseValue()
        {
            ...
            Assert.AreEqual(
                TestingEnum3.Test,
                Enum.Parse(t1.GetType(), "18446744073709551615", false)
            );
        }
        ...
        public void FlagTest()
        {
            ...
            for (int i = 0; i < 4; ++i)
                Assert.AreEqual(e[i].ToString(), Enum.Format(typeof(E), evalues[i], "f"), "#1" + i);
        ...
        public void GetHashCode_ShouldBeEqualToUnderlyingType()
        {
            ...
            Assert.AreEqual(
                EnUInt64.B.GetHashCode(),
                ((ulong)3488924689489L).GetHashCode(),
                "u64#1"
            );
        ...
        public void CompareTo_NotEqualToUnderlyingType()
        {
            ...
            Assert.AreEqual(
                int.MinValue.CompareTo(int.MinValue),
                EnInt32.A.CompareTo(EnInt32.A),
                "i32#0"
            );
            Assert.AreEqual(
                int.MinValue.CompareTo((int)88),
                EnInt32.A.CompareTo(EnInt32.B),
                "i32#1"
            );
            Assert.AreEqual(
                ((int)88).CompareTo(int.MinValue),
                EnInt32.B.CompareTo(EnInt32.A),
                "i32#2"
            );

            Assert.AreEqual(
                uint.MinValue.CompareTo(uint.MinValue),
                EnUInt32.A.CompareTo(EnUInt32.A),
                "u32#0"
            );
            Assert.AreEqual(
                uint.MinValue.CompareTo((uint)99),
                EnUInt32.A.CompareTo(EnUInt32.B),
                "u32#1"
            );
            Assert.AreEqual(
                ((uint)99).CompareTo(uint.MinValue),
                EnUInt32.B.CompareTo(EnUInt32.A),
                "u32#2"
            );

            Assert.AreEqual(
                long.MinValue.CompareTo(long.MinValue),
                EnInt64.A.CompareTo(EnInt64.A),
                "i64#0"
            );
            Assert.AreEqual(
                long.MinValue.CompareTo((long)456),
                EnInt64.A.CompareTo(EnInt64.D),
                "i64#1"
            );
            Assert.AreEqual(
                ((long)456).CompareTo(long.MinValue),
                EnInt64.D.CompareTo(EnInt64.A),
                "i64#2"
            );

            Assert.AreEqual(
                ulong.MinValue.CompareTo(ulong.MinValue),
                EnUInt64.A.CompareTo(EnUInt64.A),
                "u64#0"
            );
            Assert.AreEqual(
                ulong.MinValue.CompareTo((ulong)789),
                EnUInt64.A.CompareTo(EnUInt64.D),
                "u64#1"
            );
            Assert.AreEqual(
                ((ulong)789).CompareTo(ulong.MinValue),
                EnUInt64.D.CompareTo(EnUInt64.A),
                "u64#2"
            );
        }
        ...
        public void CompareOrder_FromGetNames()
        {
            ...
            Assert.AreEqual(
                "sbyte_Bb",
                Enum.GetName(typeof(EnumSByte), unchecked((EnumSByte)(0xF0)))
            );
            Assert.AreEqual("sbyte_Bb", r.GetValue(4).ToString());
            Assert.AreEqual(
                "sbyte_Dd",
                Enum.GetName(typeof(EnumSByte), unchecked((EnumSByte)(0xFF)))
            );
            ...
            Assert.AreEqual(
                "short_Bb",
                Enum.GetName(typeof(EnumShort), unchecked((EnumShort)(0xFF00)))
            );
            Assert.AreEqual("short_Bb", r.GetValue(4).ToString());
            Assert.AreEqual(
                "short_Dd",
                Enum.GetName(typeof(EnumShort), unchecked((EnumShort)(0xFFFF)))
            );
            ...
            Assert.AreEqual(
                "int_Bb",
                Enum.GetName(typeof(EnumInt), unchecked((EnumInt)(0xFFFF0000)))
            );
            Assert.AreEqual("int_Bb", r.GetValue(4).ToString());
            Assert.AreEqual(
                "int_Dd",
                Enum.GetName(typeof(EnumInt), unchecked((EnumInt)(0xFFFFFFFF)))
            );
            ...
            Assert.AreEqual(
                "ulong_Cc",
                Enum.GetName(typeof(EnumULong), (EnumULong)(0x0000000000000000))
            );
            ...
            Assert.AreEqual(
                "ulong_Aa",
                Enum.GetName(typeof(EnumULong), (EnumULong)(0x0000000000000005))
            );
            Assert.AreEqual("ulong_Ff", r.GetValue(2).ToString());
            Assert.AreEqual(
                "ulong_Ff",
                Enum.GetName(typeof(EnumULong), (EnumULong)(0x0000000000000064))
            );
            Assert.AreEqual("ulong_Ee", r.GetValue(3).ToString());
            Assert.AreEqual(
                "ulong_Ee",
                Enum.GetName(typeof(EnumULong), (EnumULong)(0x7FFFFFFFFFFFFFFF))
            );
            ...
            Assert.AreEqual(
                "long_Cc",
                Enum.GetName(typeof(EnumLong), (EnumLong)(0x0000000000000000))
            );
            Assert.AreEqual("long_Cc", r.GetValue(0).ToString());
            Assert.AreEqual(
                "long_Aa",
                Enum.GetName(typeof(EnumLong), (EnumLong)(0x0000000000000005))
            );
            Assert.AreEqual("long_Aa", r.GetValue(1).ToString());
            Assert.AreEqual(
                "long_Ff",
                Enum.GetName(typeof(EnumLong), (EnumLong)(0x0000000000000064))
            );
            Assert.AreEqual("long_Ff", r.GetValue(2).ToString());
            Assert.AreEqual(
                "long_Ee",
                Enum.GetName(typeof(EnumLong), (EnumLong)(0x7FFFFFFFFFFFFFFF))
            );
            Assert.AreEqual("long_Ee", r.GetValue(3).ToString());
            Assert.AreEqual(
                "long_Bb",
                Enum.GetName(typeof(EnumLong), unchecked((EnumLong)(0xFFFFFFFF00000000)))
            );
            Assert.AreEqual("long_Bb", r.GetValue(4).ToString());
            Assert.AreEqual(
                "long_Dd",
                Enum.GetName(typeof(EnumLong), unchecked((EnumLong)(0xFFFFFFFFFFFFFFFF)))
            );
