    ...
    public class ActivatorTest
    {
        ...
        public void CreateInstance_StringTypeNameDoesNotExists()
        {
            Activator.CreateInstance(
                (string)null,
                "MonoTests.System.ActivatorTestInternal.DoesntExistsCOMTest"
            );
        }
        ...
        public void CreateInstance_Nullable()
        {
            ...
            Assert.AreEqual(
                typeof(int),
                Activator.CreateInstance(typeof(Nullable<int>), new object[] { 5 }).GetType()
            );
            Assert.AreEqual(
                0,
                Activator.CreateInstance(typeof(Nullable<int>), new object[] { null })
            );
            Assert.AreEqual(
                typeof(int),
                Activator.CreateInstance(typeof(Nullable<int>), new object[] { null }).GetType()
            );
        ...
        {
            ObjectHandle objHandle = Activator.CreateInstanceFrom(
                testLocation,
                "MonoTests.System.ActivatorTestInternal.COMTest"
            );
        ...
        private const string CorlibPermissionPattern =
            "System.Security.Permissions.FileDialogPermission, mscorlib, Version={0}, Culture=neutral, PublicKeyToken=b77a5c561934e089";
        private const string SystemPermissionPattern =
            "System.Net.DnsPermission, System, Version={0}, Culture=neutral, PublicKeyToken=b77a5c561934e089";
        ...
        public void CreateInstanceCrossDomainNonSerializableArgs()
        {
            ...
            Activator.CreateInstance(
                ...
                BindingFlags.Public | BindingFlags.Instance,
                null,
                new object[] { ModuleHandle.EmptyHandle },
                null,
                null,
                null
            );
        ...
        {
            var a = (ParamsConstructor)
                Activator.CreateInstance(
                    typeof(ParamsConstructor),
                    new object[] { 42, "foo", "bar" }
                );
            ...
            a = (ParamsConstructor)
                Activator.CreateInstance(typeof(ParamsConstructor), new object[] { 42, "foo" });
            ...
            a = (ParamsConstructor)
                Activator.CreateInstance(typeof(ParamsConstructor), new object[] { 42 });
        ...
        {
            var a = (SimpleParamsConstructor)
                Activator.CreateInstance(
                    typeof(SimpleParamsConstructor),
                    new object[] { "foo", "bar" }
                );
            ...
            a = (SimpleParamsConstructor)
                Activator.CreateInstance(typeof(SimpleParamsConstructor), new object[0]);
        ...
        {
            var a = Activator.CreateInstance(
                typeof(ParamsConstructorWithObjectConversion),
                new object[] { (object)2 }
            );
            Assert.IsNotNull(a);
        }
