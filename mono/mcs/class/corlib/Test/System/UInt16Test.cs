...
namespace MonoTests.System
{
    ...
    public class UInt16Test
    {
        ...
        {
            NumberFormatInfo.InvariantInfo.CurrencySymbol + "65,535.00000",
            "65535",
            "6.55350e+004",
            "65535.00000",
            "65535",
        ...
        public void TestToString()
        {
            ...
            for (int i = 0; i < Formats1.Length; i++)
            {
                ...
                Assert.AreEqual(
                    Results1[i],
                    MyUInt16_2.ToString(Formats1[i]),
                    "A4:" + i.ToString()
                );
                Assert.AreEqual(
                    Results2[i],
                    MyUInt16_3.ToString(Formats2[i]),
                    "A5:" + i.ToString()
                );
            }
            ...
            for (int i = 0; i < Formats1.Length; i++)
            {
                Assert.AreEqual(
                    ResultsNfi1[i],
                    MyUInt16_2.ToString(Formats1[i], Nfi),
                    "A6:" + i.ToString()
                );
                Assert.AreEqual(
                    ResultsNfi2[i],
                    MyUInt16_3.ToString(Formats2[i], Nfi),
                    "A7:" + i.ToString()
                );
            }
            try
