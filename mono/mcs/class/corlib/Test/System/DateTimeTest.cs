...
namespace MonoTests.System
{
    ...
    public class DateTimeTest
    {
        ...
        public void Constructor_Max()
        {
            Assert.AreEqual(
                3155378975999990000,
                new DateTime(9999, 12, 31, 23, 59, 59, 999).Ticks,
                "Max"
            );
        }
        ...
        public void ParseExact_Formats_Empty()
        {
            ...
            try
            {
                DateTime.ParseExact("2002-02-25 04:25:13Z", formats, null, DateTimeStyles.None);
                Assert.Fail("#B1");
            }
            catch (FormatException ex)
            {
        ...
        public void ParseExact_String_Empty()
        {
            ...
            try
            {
                DateTime.ParseExact(string.Empty, new string[] { "G" }, null, DateTimeStyles.None);
                Assert.Fail("#C1");
            }
            catch (FormatException ex)
            {
        ...
        public void ParseExact_String_Null()
        {
            ...
            try
            {
                DateTime.ParseExact((string)null, new string[] { "G" }, null, DateTimeStyles.None);
                Assert.Fail("#C1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void TestParseExact5()
        {
            DateTime dt = DateTime.ParseExact(
                "Wed, 12 May 2004 20:51:09 -02:30",
                @"ddd, d MMM yyyy H:m:s zzz",
                CultureInfo.CreateSpecificCulture("en-us"),
                DateTimeStyles.AllowInnerWhite
            );
        ...
        public void TestParseExact()
        {
            ...
            t1 = DateTime.ParseExact(
                "Monday, 25 February 2002 05:25:13",
                "F",
                null,
                DateTimeStyles.AdjustToUniversal
            );
            ...
            t1 = DateTime.ParseExact("02/25/2002", "d", null, DateTimeStyles.AllowWhiteSpaces);
            Assert.AreEqual(myTicks[0], t1.Ticks, "#I4");

            t1 = DateTime.ParseExact("    02/25/2002", "d", null, DateTimeStyles.AllowLeadingWhite);
            ...
            {
                DateTime.ParseExact(
                    "Tue, 12 Apr 2005 10:10:04 +00000",
        ...
        public void TestParseDateFirst()
        {
            ...
            t1 = DateTime.Parse("Monday, 25 February 2002 05:25:22", new CultureInfo("hi-IN"));
            Assert.AreEqual(t2.Ticks, t1.Ticks, "#D7");
            t2 = new DateTime(2002, 2, 25, 5, 25, 0);
            t1 = DateTime.Parse("Monday, 25 February 2002 05:25", new CultureInfo("hi-IN"));
        ...
        public void TimeZoneAdjustment()
        {
            ...
            try
            {
                ...
                DateTime d3 = DateTime.ParseExact(
                    "Wed, 30 Jun 2004 00:00:00 GMT",
                    "ddd, dd MMM yyyy HH':'mm':'ss 'GMT'",
                    null
                );
                DateTime d4 = DateTime.ParseExact(
                    "2004-06-30 00:00:00Z",
                ...
                try
                {
                    ...
                    switch (ci.LCID)
                    {
                        ...
                        default:
                            ...
                            catch (FormatException ex)
                            {
                                Assert.Fail(
                                    String.Format(
                                        "stage 5.1 RFC1123: culture {0} {1} failed: {2}",
                                        i,
                                        ci,
                                        ex.Message
                                    )
                            ...
                            if (dt != TimeZone.CurrentTimeZone.ToUniversalTime(dt))
                                Assert.IsTrue(
                                    12 != dt.Hour,
                                    String.Format("bug #47720 on culture {0} {1}", ci.LCID, ci)
                                );
                            ...
                            catch (FormatException ex)
                            {
                                Assert.Fail(
                                    String.Format(
                                        "stage 6.1 RFC1123 variant: culture {0} {1} failed: {2}",
                                        i,
                                        ci,
                                        ex.Message
                                    )
                            ...
                            Assert.AreEqual(
                                ...
                                dt.Hour,
                                String.Format(
                                    "stage 7.1 RFC1123 variant on culture {0} {1}",
                                    ci.LCID,
                                    ci
                                )
                            );
                    ...
                    switch (ci.LCID)
                    {
                        ...
                        default:
                            ...
                            long tick2 = TimeZone.CurrentTimeZone
                            ...
                            Assert.AreEqual(
                                tick2,
                                dt.Ticks,
                                String.Format("GMT variant. culture={0} {1}", i, ci)
                            );
                            break;
                    }
                    ...
                    if (ci.LCID != 1079)
                    {
                        ...
                        Assert.AreEqual(
                            1,
                            dt.Hour,
                            String.Format("stage 18.1 RFC1123 UTC {0} {1}", i, ci)
                        );
                        stage = "19";
        ...
        {
            DateTime dt = DateTime.ParseExact(
                "2004-05-26T03:29:01.1234567-07:00",
        ...
        {
            Assert.IsTrue(
                DateTime.Parse("2004-05-26T03:29:01-0700").Ticks
        ...
        {
            Assert.IsTrue(
                DateTime.Parse("2004-05-26T03:29:01-07:00").Ticks
        ...
        public void Bug352210_New()
        {
            ...
            long ticksLocal =
                ticksUTC + TimeZone.CurrentTimeZone.GetUtcOffset(new DateTime(ticksUTC)).Ticks;
            ...
            try
            {
                ...
                dt = DateTime.ParseExact(
                    "2008-02-05 02:38:26 qqGMTqq",
                    "yyyy-MM-dd HH:mm:ss qqGMTqq",
                    ci
                );
        ...
        public void TestParseExactXmlTimeFormats()
        {
            ...
            Assert.AreEqual(
                ...
                DateTime
                    .ParseExact("13:30:44", xmlTimeFormats, DateTimeFormatInfo.InvariantInfo, style)
                    .Ticks
            );
            Assert.AreEqual(
                new DateTime(
        ...
        public void Kind()
        {
            ...
            DateTime now = new DateTime(
                utc.Ticks + TimeZone.CurrentTimeZone.GetUtcOffset(utc).Ticks,
                DateTimeKind.Local
            );
        ...
        public void InstanceMembersAndKind()
        {
            ...
            Assert.AreEqual(
                DateTimeKind.Utc,
                DateTime.UtcNow.Add(TimeSpan.FromMinutes(1)).Kind,
                "#2"
            );
            Assert.AreEqual(
                DateTimeKind.Utc,
                DateTime.UtcNow.Subtract(TimeSpan.FromMinutes(1)).Kind,
                "#3"
            );
            ...
            Assert.AreEqual(
                DateTimeKind.Utc,
                (DateTime.UtcNow + TimeSpan.FromMinutes(1)).Kind,
                "#12"
            );
            Assert.AreEqual(
                DateTimeKind.Utc,
        ...
        public void RoundtripBinary()
        {
            ...
            Assert.AreEqual(
                ...
                DateTime.FromBinary(dt3.ToBinary()).Kind,
                "#6"
            );

            Assert.AreEqual(
                TimeZone.CurrentTimeZone.GetUtcOffset(dt).Ticks,
                dt3.ToBinary() - (dt.ToBinary() & 0x7FFFFFFFFFFFFFFF),
                "#7"
            );
        }
        ...
        public void OmittedSecondsFraction()
        {
            ...
            Assert.AreEqual(
                "00:00:00.13579",
                today.AddTicks(1357900).ToString("HH:mm:ss.FFFFFFF"),
                "#1"
            );
            DateTime dt = DateTime.ParseExact(
                "00:00:00.13579",
        ...
        public void KindInPattern()
        {
            ...
            Assert.AreEqual(
                "00:00:00+09:00".Length,
                DateTime.Today.ToString("HH:mm:ssK").Length,
                "#3"
            );
        }
        ...
        public void RoundtripPattern()
        {
            ...
            Assert.AreEqual(
                ...
                DateTime.SpecifyKind(new DateTime(2000, 1, 1), DateTimeKind.Utc).ToString("o"),
                "#2"
            );
            Assert.AreEqual(
                "2000-01-01T00:00:00.0000000+09:00".Length,
                DateTime
                    .SpecifyKind(new DateTime(2000, 1, 1), DateTimeKind.Local)
                    .ToString("o")
                    .Length,
                "#3"
            );
            ...
            Assert.AreEqual(
                "1976-06-19T00:00:00.0000000",
                new DateTime(1976, 6, 19).ToString("O", culture),
                "#4"
            );
            Assert.AreEqual(
                "1976-06-19T00:00:00.0000000",
        ...
        public void KindPattern()
        {
            ...
            DateTime dt = DateTime.SpecifyKind(
                new DateTime(2007, 11, 1, 2, 30, 45),
                DateTimeKind.Utc
            );
        ...
        public void Parse_InvalidShortDate()
        {
            ...
            foreach (string culture in cultures)
            {
                ...
                Assert.AreEqual(
                    expected,
                    DateTime.Parse("2011-03-22 08:32:00+01:00", ci, DateTimeStyles.RoundtripKind),
                    "#a01 - " + culture
                );
                Assert.AreEqual(
                    expected,
                ...
                Assert.AreEqual(
                    expected2,
                    DateTime.Parse("2011-03-22T08:32:00", ci, DateTimeStyles.RoundtripKind),
                    "#a03 - " + culture
                );
                Assert.AreEqual(
                    expected2,
                ...
                Assert.AreEqual(
                    expected2,
                    DateTime.Parse("03/2011/22T08:32:00", ci, DateTimeStyles.RoundtripKind),
                    "#a05 - " + culture
                );
                Assert.AreEqual(
                    expected2,
                ...
                Assert.AreEqual(
                    expected,
                    DateTime.Parse("03/2011/22 08:32:00+01:00", ci, DateTimeStyles.RoundtripKind),
                    "#a07 - " + culture
                );
        ...
        public void Parse_DateWithTimeZone_TimeZoneShouldBeCorrectlyRead()
        {
            ...
            DateTimeOffset result = DateTimeOffset.Parse(
                testDateWithTimeZoneInfo,
                null,
        ...
        public void GenitiveMonth()
        {
            ...
            Assert.AreEqual("15 ????????", dt.ToString("m", ci));
        }
        ...
        {
            string date =
                "2014-08-25T01:20:23.601911612343423423465789789365674575676746756747467Z";
        ...
        {
            string date =
                "2014-08-25T01:20:23.60191161234342342346578978936567457567:6746756747467Z";
        ...
        {
            string date =
                "2014-08-25T01:20:23.6019116-12343423423465789789365674575676746756747467Z";
            DateTime.Parse(date, CultureInfo.InvariantCulture, DateTimeStyles.RoundtripKind);
        }
        ...
        {
            string date =
                "2014-08-25T01:20:23.601911612343423423465789789365674575676746756747467%Z";
            DateTime.Parse(date, CultureInfo.InvariantCulture, DateTimeStyles.RoundtripKind);
        }
        ...
        public void DateTimeKoCulture()
        {
            foreach (var culture in new[] { new CultureInfo("ko"), new CultureInfo("ko-KR") })
            {
                ...
                Assert.AreEqual("?? 11:00:00", dateTimeAm.ToString("T", culture.DateTimeFormat));
                Assert.AreEqual("?? 1:00:00", dateTimePm.ToString("T", culture.DateTimeFormat));
            }
        }
    }
}
