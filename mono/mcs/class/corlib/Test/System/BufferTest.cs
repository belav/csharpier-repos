...
namespace MonoTests.System
{
    ...
    public class BufferTest
    {
        ...
        public void GetByte()
        {
            ...
            Assert.IsTrue(
                errorThrown,
                "TestGetByte: ArgumentOutOfRangeException (negative index) not implemented"
            );
            ...
            Assert.IsTrue(
                errorThrown,
                "TestGetByte: ArgumentOutOfRangeException (index bigger/equal than array's size not thrown"
            );
        ...
        public void SetByte()
        {
            ...
            Assert.IsTrue(
                errorThrown,
                "TestSetByte: ArgumentOutOfRangeException (case: negative index) not thrown"
            );
            errorThrown = false;
            ...
            Assert.IsTrue(
                errorThrown,
                "TestSetByte: ArgumentOutOfRangeException (case: index bigger/equal than array'size"
            );
            errorThrown = false;
