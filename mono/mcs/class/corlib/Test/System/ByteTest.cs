...
namespace MonoTests.System
{
    ...
    public class ByteTest
    {
        ...
        {
            NumberFormatInfo.InvariantInfo.CurrencySymbol + "255.00000",
            "00255",
            "2.55000e+002",
            "255.00000",
            "255",
        ...
        public void TestParse()
        {
            //test Parse(string s)
            Assert.IsTrue(
                MyByte1 == Byte.Parse(MyString1),
                "MyByte1="
                    + MyByte1
                    + ", MyString1="
                    + MyString1
                    + ", Parse="
                    + Byte.Parse(MyString1)
            );
            ...
            catch (Exception e)
            {
                Assert.IsTrue(
                    ...
                    "Should get ArgumentNullException"
                );
            }
            try
            {
            ...
            catch (Exception e)
            {
                Assert.IsTrue(
                    ...
                    NumberFormatInfo.CurrentInfo.CurrencySymbol + "42 and NumberStyles.Integer"
                );
            }
            ...
            Assert.IsTrue(
                16 == Byte.Parse(" 10 ", NumberStyles.HexNumber, Nfi),
            ...
            catch (Exception e)
            {
                Assert.IsTrue(
                    typeof(FormatException) == e.GetType(),
                    NumberFormatInfo.CurrentInfo.CurrencySymbol + "42, NumberStyles.Integer, Nfi"
                );
            }
        ...
        public void TestToString()
        {
            ...
            Assert.AreEqual(
                MyString1,
                MyByte1.ToString(),
                "Compare failed for MyString1 and MyByte1"
            );
            Assert.AreEqual(
                MyString2,
                MyByte2.ToString(),
                "Compare failed for MyString2 and MyByte2"
            );
            Assert.AreEqual(
                MyString3,
                MyByte3.ToString(),
                "Compare failed for MyString3 and MyByte3"
            );
            ...
            for (int i = 0; i < Formats1.Length; i++)
            {
                Assert.AreEqual(
                    Results1[i],
                    MyByte2.ToString(Formats1[i]),
                    "Compare failed for Formats1[" + i.ToString() + "]"
                );
                Assert.AreEqual(
                    Results2[i],
                    MyByte3.ToString(Formats2[i]),
                    "Compare failed for Formats2[" + i.ToString() + "]"
                );
            }
            ...
            for (int i = 0; i < Formats1.Length; i++)
            {
                Assert.AreEqual(
                    Results1_Nfi[i],
                    MyByte2.ToString(Formats1[i], Nfi),
                    "Compare failed for Formats1[" + i.ToString() + "] with Nfi"
                );
                Assert.AreEqual(
                    Results2_Nfi[i],
                    MyByte3.ToString(Formats2[i], Nfi),
                    "Compare failed for Formats2[" + i.ToString() + "] with Nfi"
                );
            }
            try
            {
