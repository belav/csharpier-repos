...
namespace MonoTests.System
{
    ...
    public class TimeSpanTest
    {
        ...
        public void Parse_MinMaxValues()
        {
            Assert.AreEqual(
                TimeSpan.MaxValue,
                TimeSpan.Parse("10675199.02:48:05.4775807"),
                "MaxValue"
            );
            Assert.AreEqual(
                TimeSpan.MinValue,
        ...
        public void TryParse()
        {
            ...
            Assert.AreEqual(
                true,
                TimeSpan.TryParse("10675199.02:48:05.4775807", out result),
                "MaxValue#1"
            );
            Assert.AreEqual(TimeSpan.MaxValue, result, "MaxValue#2");
            Assert.AreEqual(
                true,
                TimeSpan.TryParse("-10675199.02:48:05.4775808", out result),
                "MinValue#1"
            );
            ...
            if (!GlobalizationMode.Invariant)
            {
                ...
                try
                {
                    ...
                    Assert.AreEqual(
                        true,
                        TimeSpan.TryParse("10:10:10,006", out result),
                        "#CultureSensitive1"
                    );
        ...
        public void TryParseErrors()
        {
            ...
            Assert.AreEqual(
                false,
                TimeSpan.TryParse("-10675199.02:48:05.4775809", out result),
                "UnderMinValue"
            );
        }
        ...
        public void TryParseOverloads()
        {
            ...
            if (!GlobalizationMode.Invariant)
            {
                ...
                Assert.AreEqual(
                    true,
                    TimeSpan.TryParse("11:50:50,006", french_culture, out result),
                    "#A1"
                );
            }
        ...
        public void ToStringCustomFormats()
        {
            ...
            Assert.AreEqual(
                "Result = 3 hours with 5 minutes and 7 seconds",
                ts.ToString(@"'Result = 'h' hours with 'm' minutes and 's' seconds'"),
                "#C3"
            );
