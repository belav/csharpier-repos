    ...
    public class AppDomainSetupTest
    {
        ...
        public void ConfigurationFile_Relative_ApplicationBase()
        {
            ...
            Assert.AreEqual(
                ...
                "Check relative to ApplicationBase"
            );
        }
        ...
        public void ApplicationBase4()
        {
            ...
            else
            {
                ...
                {
                    Assert.Fail(
                        "NotSupportedException expected but setup.ApplicationBase returned:"
        ...
        public void ApplicationBase6()
        {
            ...
            else
            {
                ...
                {
                    Assert.Fail(
                        "ArgumentException expected but setup.ApplicationBase returned:"
                            + setup.ApplicationBase
                    );
                }
