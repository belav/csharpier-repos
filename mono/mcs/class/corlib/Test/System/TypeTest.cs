...
namespace MonoTests.System
{
    ...
    class SampleGenericConstrained<U>
        where U : class, IFace1 { }
    ...
    public class TypeTest
    {
        ...
        private void GenericMethod<Q, T1>(Q q, T1 t)
            where T1 : IFace { }
        ...
        public void TestIsAssignableFrom()
        {
            ...
            Assert.AreEqual(
                typeof(ICloneable[][]).IsAssignableFrom(typeof(Duper[][])),
                true,
                "#12"
            );
            ...
            MethodInfo mi = typeof(TypeTest).GetMethod(
                "ByrefMethod",
        ...
        {
            var mi = typeof(TypeTest).GetMethod(
                "GenericMethod2",
                BindingFlags.Instance | BindingFlags.NonPublic
            );
            var gparams = mi.GetGenericArguments();
        ...
        public void TestGetMethodImpl()
        {
            ...
            Assert.AreEqual(
                typeof(NewVTable),
                typeof(NewVTable).GetMethod("TestVoid").DeclaringType,
                "#02"
            );
            ...
            Assert.AreEqual(
                typeof(Base),
                typeof(Base).GetMethod("TestInt", new Type[] { typeof(int) }).DeclaringType,
                "#03"
            );
            Assert.AreEqual(
                typeof(NewVTable),
                typeof(NewVTable).GetMethod("TestInt", new Type[] { typeof(int) }).DeclaringType,
                "#04"
            );
            ...
            Assert.AreEqual(
                0,
                typeof(NewVTable).GetMethod("Overload", new Type[0]).GetParameters().Length,
                "#05"
            );
        ...
        public void TestGetPropertyImpl()
        {
            ...
            Assert.AreEqual(
                typeof(NewVTable),
                typeof(NewVTable).GetProperty("Item", new Type[1] { typeof(Int32) }).DeclaringType,
                "#01"
            );
            ...
            Assert.AreEqual(
                typeof(NewVTable),
                typeof(NewVTable).GetProperty("Item", new Type[1] { typeof(Int16) }).DeclaringType,
                "#02"
            );
        ...
        public void GetProperties()
        {
            ...
            Assert.AreEqual(
                typeof(Derived2),
                typeof(Derived2).GetProperties()[0].DeclaringType,
                "#2"
            );
        ...
        class GetProperties_Overrides_Input
        {
            ...
            {
                public new virtual string Prop
                {
                    set { }
                }
            }
        ...
        public void GetProperties_Overrides()
        {
            ...
            var prop_2 = typeof(GetProperties_Overrides_Input.TestClass_HiddenProperty).GetProperty(
                "Prop"
            );
            Assert.AreEqual(
                typeof(GetProperties_Overrides_Input.TestClass_HiddenProperty),
                prop_2.DeclaringType
            );

            Assert.AreEqual(
                1,
                typeof(GetProperties_Overrides_Input.TestClass).GetProperties().Length
            );
            Assert.AreEqual(
                1,
                typeof(GetProperties_Overrides_Input.TestClass_Indexer).GetProperties().Length
            );
            Assert.AreEqual(
                1,
                typeof(GetProperties_Overrides_Input.TestClass_HiddenProperty)
        ...
        public void GetProperty5_Name_Null()
        {
            ...
            try
            {
                type.GetProperty((string)null, typeof(int), Type.EmptyTypes);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void GetProperty6_Name_Null()
        {
            ...
            try
            {
                type.GetProperty((string)null, typeof(int), Type.EmptyTypes, null);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void Name()
        {
            Assert.AreEqual(
                "Int32&",
                typeof(TypeTest).GetMethod("Reflected").GetParameters()[0].ParameterType.Name
            );
            Assert.AreEqual(
                "String[*]",
                Array
                    .CreateInstance(typeof(string), new int[] { 1 }, new int[] { 1 })
                    .GetType()
                    .Name
            );
        }
        ...
        public static void GenericMethod<T, T2>(T[] arr)
        ...
        {
            Assert.IsNotNull(
                typeof(TypeTest).GetProperty("Count", BindingFlags.Instance | BindingFlags.Public)
            );
            Assert.IsNull(
                typeof(TypeTest).GetProperty(
                    "Count",
                    BindingFlags.Instance | BindingFlags.NonPublic
                )
            );
        ...
        public void IsImport()
        {
            ...
            tb = module.DefineType(
                genTypeName(),
                TypeAttributes.Import | TypeAttributes.Interface | TypeAttributes.Abstract
            );
            type = tb.CreateType();
        ...
        public void ByrefTypes()
        {
            ...
            Assert.AreEqual(
                0,
                t.GetConstructors(BindingFlags.Public | BindingFlags.Instance).Length
            );
...
#pragma warning restore 169
        ...
        public void InvokeMember_VarArgs()
        {
            ...
            string result = (string)
                type.InvokeMember("bug336841", flags, null, null, new object[] { "1" });
        ...
        public void InvokeMember_WithoutDefaultValue()
        {
            ...
            try
            {
                typeof(Bug348522).InvokeMember(
                    "Test",
                    flags,
                    new FirstMethodBinder(),
                    new Bug348522(),
        ...
        public void GetCustomAttributes_Type()
        {
            ...
            attrs = typeof(bug82431A2).GetCustomAttributes(typeof(InheritAttribute), false);
            Assert.AreEqual(0, attrs.Length, "#I1");
            attrs = typeof(bug82431A2).GetCustomAttributes(typeof(InheritAttribute), true);
            Assert.AreEqual(0, attrs.Length, "#I2");

            attrs = typeof(bug82431A2).GetCustomAttributes(typeof(NotInheritAttribute), false);
            Assert.AreEqual(0, attrs.Length, "#J1");
            attrs = typeof(bug82431A2).GetCustomAttributes(typeof(NotInheritAttribute), true);
            Assert.AreEqual(0, attrs.Length, "#J2");

            attrs = typeof(bug82431A3).GetCustomAttributes(typeof(InheritAttribute), false);
            ...
            attrs = typeof(bug82431A3).GetCustomAttributes(typeof(InheritAttribute), true);
            ...
            attrs = typeof(bug82431A3).GetCustomAttributes(typeof(NotInheritAttribute), false);
            Assert.AreEqual(1, attrs.Length, "#L1");
            Assert.AreEqual(typeof(NotInheritAttribute), attrs[0].GetType(), "#L2");
            attrs = typeof(bug82431A3).GetCustomAttributes(typeof(NotInheritAttribute), true);
            Assert.AreEqual(1, attrs.Length, "#L3");
            Assert.AreEqual(typeof(NotInheritAttribute), attrs[0].GetType(), "#L4");

            attrs = typeof(bug82431B1).GetCustomAttributes(typeof(InheritAttribute), false);
            Assert.AreEqual(1, attrs.Length, "#M1");
            Assert.AreEqual(typeof(InheritAttribute), attrs[0].GetType(), "#M2");
            attrs = typeof(bug82431B1).GetCustomAttributes(typeof(InheritAttribute), true);
            Assert.AreEqual(1, attrs.Length, "#M3");
            Assert.AreEqual(typeof(InheritAttribute), attrs[0].GetType(), "#M4");

            attrs = typeof(bug82431B1).GetCustomAttributes(typeof(NotInheritAttribute), false);
            Assert.AreEqual(0, attrs.Length, "#N1");
            attrs = typeof(bug82431B1).GetCustomAttributes(typeof(NotInheritAttribute), true);
            Assert.AreEqual(0, attrs.Length, "#N2");

            attrs = typeof(bug82431B2).GetCustomAttributes(typeof(InheritAttribute), false);
            Assert.AreEqual(0, attrs.Length, "#O1");
            attrs = typeof(bug82431B2).GetCustomAttributes(typeof(InheritAttribute), true);
            Assert.AreEqual(1, attrs.Length, "#O2");
            Assert.AreEqual(typeof(InheritAttribute), attrs[0].GetType(), "#O3");

            attrs = typeof(bug82431B2).GetCustomAttributes(typeof(NotInheritAttribute), false);
            Assert.AreEqual(0, attrs.Length, "#P1");
            attrs = typeof(bug82431B2).GetCustomAttributes(typeof(NotInheritAttribute), true);
            Assert.AreEqual(0, attrs.Length, "#P2");

            attrs = typeof(bug82431B3).GetCustomAttributes(typeof(InheritAttribute), false);
            Assert.AreEqual(1, attrs.Length, "#Q1");
            Assert.AreEqual(typeof(NotInheritAttribute), attrs[0].GetType(), "#Q2");
            attrs = typeof(bug82431B3).GetCustomAttributes(typeof(InheritAttribute), true);
            ...
            attrs = typeof(bug82431B3).GetCustomAttributes(typeof(NotInheritAttribute), false);
            Assert.AreEqual(1, attrs.Length, "#R1");
            Assert.AreEqual(typeof(NotInheritAttribute), attrs[0].GetType(), "#R2");
            attrs = typeof(bug82431B3).GetCustomAttributes(typeof(NotInheritAttribute), true);
            Assert.AreEqual(1, attrs.Length, "#R3");
            Assert.AreEqual(typeof(NotInheritAttribute), attrs[0].GetType(), "#R4");

            attrs = typeof(bug82431B4).GetCustomAttributes(typeof(InheritAttribute), false);
            Assert.AreEqual(0, attrs.Length, "#S1");
            attrs = typeof(bug82431B4).GetCustomAttributes(typeof(InheritAttribute), true);
            Assert.AreEqual(1, attrs.Length, "#S2");
            Assert.AreEqual(typeof(InheritAttribute), attrs[0].GetType(), "#S3");

            attrs = typeof(bug82431B4).GetCustomAttributes(typeof(NotInheritAttribute), false);
            Assert.AreEqual(0, attrs.Length, "#T1");
            attrs = typeof(bug82431B4).GetCustomAttributes(typeof(NotInheritAttribute), true);
            Assert.AreEqual(0, attrs.Length, "#T2");

            attrs = typeof(A).GetCustomAttributes(typeof(string), false);
            Assert.AreEqual(0, attrs.Length, "#U1");
            attrs = typeof(A).GetCustomAttributes(typeof(string), true);
        ...
        public void GetConstructor2_Types_ItemNull()
        {
            ...
            try
            {
                type.GetConstructor(BindingFlags.Default, null, new Type[1] { null }, null);
                Assert.Fail("#1");
            }
            catch (ArgumentNullException ex)
            {
        ...
        public void IsAssignable()
        {
            ...
            Assert.IsTrue(
                ibar_short_type.IsAssignableFrom(baz_short_type),
                "Baz<short> -> IBar<short>"
            );

            Assert.IsFalse(
                ibar_int_type.IsAssignableFrom(baz_short_type),
                "Baz<short> -!-> IBar<int>"
            );
            Assert.IsFalse(
                ibar_short_type.IsAssignableFrom(baz_int_type),
                "Baz<int> -!-> IBar<short>"
            );
        ...
        public void GetCustomAttributesGenericInstance()
        {
            Assert.AreEqual(
                1,
                typeof(ComFoo<int>).GetCustomAttributes(typeof(ComVisibleAttribute), true).Length
            );
        }
        ...
        {
            Type t = Type.ReflectionOnlyGetType(
                typeof(int).AssemblyQualifiedName.ToString(),
                true,
                true
            );
...
*/
        ...
        public void GetGenericArguments_ArgumentsHaveAttributes()
        {
            ...
            Assert.AreEqual(
                1,
                tArgs[0].GetCustomAttributes(typeof(DocAttribute), true).Length,
                "#1"
            );
            Assert.AreEqual(
                1,
                tArgs[1].GetCustomAttributes(typeof(DocAttribute), true).Length,
                "#1"
            );
            Assert.AreEqual(
                1,
                mArgs[0].GetCustomAttributes(typeof(DocAttribute), true).Length,
                "#1"
            );
        }
        ...
        public void GetTypeCalledUsingReflection()
        {
            ...
            MethodInfo m = typeof(Type).GetMethod(
                "GetType",
                BindingFlags.Public | BindingFlags.Static,
                null,
            ...
            object r = m.Invoke(
                ...
                BindingFlags.Default,
                null,
                new object[] { "NoNamespaceClass" },
                CultureInfo.InvariantCulture
            );
            Assert.AreSame(expectedType, r, "#2");
        }

        public class BConstrained<Y>
            where Y : BConstrained<Y> { }
        ...
        public void TypeGetMemberReturnTypeTest()
        {
            ...
            for (int i = 0; i < flagsandtypes.Length; i++)
            {
                ...
                obj = GetType()
                    .GetMember("DummyMember", memtype, BindingFlags.Public | BindingFlags.Instance);
                Assert.AreEqual(
                    testtype.GetHashCode(),
        ...
        public void TypeGetMemberWildcardTypeTest()
        {
            ...
            Tuple<MemberTypes, Type, string>[] flagsandtypes = new Tuple<
                MemberTypes,
                Type,
                string
            >[]
            ...
            for (int i = 0; i < flagsandtypes.Length; i++)
            {
                ...
                obj = typeof(DummyReflectionWildcardClass).GetMember(
                    "Dummy" + wildcard,
                    memType,
                    BindingFlags.Public | BindingFlags.Instance
                );
                ...
                Assert.AreEqual(
                    testType.GetHashCode(),
                    obj.GetType().GetHashCode(),
                    "Expected #" + i + " A1: " + testType.FullName
                );
        ...
        public void Bug506757()
        {
            ...
            foreach (var m in t2.GetMethods(BindingFlags.Instance | BindingFlags.NonPublic))
                Assert.IsTrue(
                    ...
                    String.Format("{0}::{1}", m.DeclaringType, m.Name)
                );
        }
#endif
        ...
        public void DeclaringMethodOnlyWorksWithGenericArgs()
        {
            ...
            Assert.IsNull(
                typeof(DeclaringMethodBar<>).GetGenericArguments()[0].DeclaringMethod,
                "#2"
            );
        ...
        class GenericWithParamConstraints<A, B, C>
            where B : Foo<C>
            where A : B { }
        ...
        public void IsAssignableFromArrayEnumerator()
        {
            ...
            Assert.IsFalse(
                ieEqStr.IsAssignableFrom(arrStr),
                "string[] -!-> IEnumerator<IEquatable<string>>"
            );
            ...
            Assert.IsFalse(
                ieEqInt.IsAssignableFrom(arrInt),
                "int[] -!-> IEnumerator<IEquatable<int>>"
            );
        }
        ...
        {
            InterfaceMapping res = typeof(GetInterfaceMap).GetInterfaceMap(
                typeof(IGetInterfaceMap<object>)
            );
            Assert.AreEqual(typeof(IGetInterfaceMap<object>), res.InterfaceType);
            Assert.AreEqual(
                typeof(object),
                res.InterfaceMethods[0].GetParameters()[0].ParameterType
            );
        ...
        public void GetEnumUnderlyingType()
        {
            ...
            Assert.AreSame(
                typeof(short),
                new MyEnum() { is_enum = true, fields = 1 }.GetEnumUnderlyingType()
            );
        }
        ...
        public void GetEnumValue()
        {
            ...
            Assert.AreEqual(
                "A",
                new MyEnum() { fields = 1, is_enum = true }.GetEnumName(MyRealEnum.A),
                "#5"
            );
            Assert.AreEqual(
                "A",
                new MyEnum() { fields = 1, is_enum = true }.GetEnumName(MyRealEnum2.A),
                "#6"
            );
        ...
        public void IsEnumDefined()
        {
            ...
            Assert.IsFalse(
                new MyEnum() { is_enum = true, fields = 1 }.IsEnumDefined((short)99),
                "#14"
            );
        }
        ...
        public void GetTypeWithDelegates()
        {
            ...
            Assert.AreEqual(typeof(MyRealEnum).MakePointerType().MakeByRefType(), res, "#13");
            ...
            Assert.AreEqual(typeof(MyRealEnum).MakeArrayType(2).MakeByRefType(), res, "#14");
            ...
            Assert.AreEqual(typeof(MyRealEnum).MakePointerType().MakeArrayType(), res, "#15");
        ...
        public class CustomGetType : TypeDelegator
        {
            ...
            public CustomGetType(string name)
            {
                this.name = name;
            }
        ...
        public void GetTypeWithDelegatesAndUserTypes()
        {
            ...
            var res = Type.GetType(
                ...
                {
                    if (name == "Magic")
                        return new CustomGetType("MAGIC");
                    return asm == null
                        ? Type.GetType(name, false, ignore)
                        : asm.GetType(name, false, ignore);
                },
        ...
        public void NewGetTypeErrors()
        {
            ...
            MustAE(string.Format("{0}[[{1}]", typeof(Foo<>).FullName, typeof(MyRealEnum).FullName));
            MustAE(
                string.Format("{0}[[{1}],", typeof(Foo<>).FullName, typeof(MyRealEnum).FullName)
            );
            MustAE(
                string.Format("{0}[[{1}]_", typeof(Foo<>).FullName, typeof(MyRealEnum).FullName)
            );
        ...
        [Test]
        public void GetTypeParseGenericCorrectly()
        { //Bug #15124
            Assert.AreEqual(Type.GetType("MonoTests.System.Foo`1"), typeof(Foo<>), "#1");
            Assert.AreEqual(
                Type.GetType("MonoTests.System.Foo`1[System.Int32]"),
                typeof(Foo<int>),
                "#2"
            );
            Assert.AreEqual(
            ...
            Assert.AreEqual(
                Type.GetType("MonoTests.System.Foo`1[]"),
                typeof(Foo<>).MakeArrayType(),
                "#7"
            );
            Assert.AreEqual(
                Type.GetType("MonoTests.System.Foo`1[,]"),
                typeof(Foo<>).MakeArrayType(2),
                "#8"
            );
            Assert.AreEqual(
                Type.GetType("MonoTests.System.Foo`1[][]"),
                typeof(Foo<>).MakeArrayType().MakeArrayType(),
                "#9"
            );
        ...
        {
            Assert.AreEqual(
                Type.GetType("MonoTests.System.Foo`1", null, null),
                typeof(Foo<>),
                "#1"
            );
            Assert.AreEqual(
                Type.GetType("MonoTests.System.Foo`1[System.Int32]", null, null),
                typeof(Foo<int>),
                "#2"
            );
            Assert.AreEqual(
        ...
        public void FullNameGetTypeParseEscapeRoundtrip() // bug #26384
        {
            ...
            var nestedTb = tb.DefineNestedType(
                "Nested,+*&[]\\",
            ...
            var lookupNestedTy = Type.GetType(
                escapedNestedName + "," + nm.FullName,
                asmName =>
                {
                    if (asmName.FullName.Equals(nm.FullName))
                        return ab;
                    else
                ...
                (asm, name, ignore) =>
                {
                    if (asm == null)
                        ...
                        return asm.GetType(name, true, ignore);
                },
                true,
                false
            );
        ...
        public void GetTypeBadArity()
        {
            ...
            {
                Type.GetType(
                    "System.Collections.Generic.Dictionary`2[System.String,System.Int32,System.Int64]",
                    true
                );
        ...
        public class NonClosingStream : Stream, IDisposable
        {
    ...
    class UserType : Type
    {
        ...
        {
            get { return this.type == null ? null : this.type.Assembly; }
        }
