...
namespace MonoTests.System
{
    ...
    public class DelegateTest
    {
        ...
        public void GetMethodFromGenericClass()
        {
            ...
            MethodInfo target = typeof(GenericClass<int>)
                .GetMethod("Method")
        ...
        public void CoContraVariance()
        {
            CoContraVariantDelegate d = (CoContraVariantDelegate)
                Delegate.CreateDelegate(
                    typeof(CoContraVariantDelegate),
                    typeof(DelegateTest).GetMethod(
                        "CoContraVariantMethod",
        ...
        public void Virtual()
        {
            ...
            FooDelegate del = (FooDelegate)
                Delegate.CreateDelegate(typeof(FooDelegate), typeof(Iface).GetMethod("retarg"));
            C c = new C();
            Assert.AreEqual("Hello", del(c, "Hello"));

            // Combination with normal delegates
            FooDelegate del2 = (FooDelegate)
                Delegate.CreateDelegate(typeof(FooDelegate), typeof(Iface).GetMethod("retarg"));
            ...
            FooDelegate2 del5 = (FooDelegate2)
                Delegate.CreateDelegate(typeof(FooDelegate2), typeof(B).GetMethod("retarg3"));
        ...
        public void NullTarget_Instance()
        {
            Del1 d = (Del1)
                Delegate.CreateDelegate(
                    typeof(Del1),
                    null,
                    typeof(DelegateTest).GetMethod("method1")
                );
        ...
        public void NullTarget_Static()
        {
            Del2 d = (Del2)
                Delegate.CreateDelegate(
                    typeof(Del2),
                    null,
                    typeof(DelegateTest).GetMethod("method2")
                );
        ...
        public void HasTarget_Instance()
        {
            ...
            Del3 d = (Del3)
                Delegate.CreateDelegate(
                    typeof(Del3),
                    dt,
                    typeof(DelegateTest).GetMethod("method3")
                );
        ...
        public void HasTarget_Static()
        {
            Del4 d = (Del4)
                Delegate.CreateDelegate(
                    typeof(Del4),
                    "5",
                    typeof(DelegateTest).GetMethod("method4")
                );
        ...
        {
            var action = (ByRefDelegate)
                Delegate.CreateDelegate(
                    typeof(ByRefDelegate),
                    null,
                    typeof(FooStruct).GetMethod("GetProp")
                );
        ...
        {
            Delegate.CreateDelegate(typeof(Action), this.GetType().GetMethod("Banga"));
        }

        [Test] // #664205
        public void DynamicInvokeClosedStatic()
        {
            var d1 = Delegate.CreateDelegate(
                typeof(Func<int>),
                null,
                typeof(DelegateTest).GetMethod("DynamicInvokeClosedStaticDelegate_CB")
            );
        ...
        {
            var d1 = Delegate.CreateDelegate(
                typeof(Func<DelegateTest, int>),
                typeof(DelegateTest).GetMethod("DynamicInvokeOpenInstanceDelegate_CB")
            );
        ...
        public void CreateDelegateOfStaticMethodBoundToNull()
        {
            ...
            MethodInfo m = typeof(DelegateTest).GetMethod(
                "CreateDelegateOfStaticMethodBoundToNull_Helper"
            );
        ...
        public void CreateDelegateWithLdFtnAndAbstractMethod()
        {
...

            {
                ...
                il.Emit(
                    OpCodes.Newobj,
                    typeof(IntNoArgs).GetConstructor(new Type[] { typeof(object), typeof(IntPtr) })
                );
        ...
        public void CantBindValueTypeToFirstArg()
        {
            ...
            {
                Delegate.CreateDelegate(
                    typeof(Delegate695978_2),
                    10,
                    typeof(DelegateTest).GetMethod("MethodWithIntParam")
                );
        ...
        struct Struct695978
        {
            ...
            public static int test2(ref Struct695978 foo)
            {
                return foo.value + 20;
            }
        }
        ...
        public void DelegateWithValueTypeArguments()
        {
            ...
            var ar1 = (Delegate695978_1)
                Delegate.CreateDelegate(
                    typeof(Delegate695978_1),
                    typeof(Struct695978).GetMethod("test")
                );
            Assert.IsNotNull(ar1);
            Assert.AreEqual(110, ar1(ref es));

            var ar2 = (Delegate695978_2)
                Delegate.CreateDelegate(
                    typeof(Delegate695978_2),
                    null,
                    typeof(Struct695978).GetMethod("test")
            ...
            ar1 = (Delegate695978_1)
                Delegate.CreateDelegate(
                    typeof(Delegate695978_1),
                    typeof(Struct695978).GetMethod("test2")
                );
            Assert.IsNotNull(ar1);
        ...
        public void EnumBaseTypeConversion()
        {
            ...
            var d =
                Delegate.CreateDelegate(
                    typeof(Func<StringComparison, StringComparison, bool>),
                    dm.Method
                ) as Func<StringComparison, StringComparison, bool>;
            Assert.IsTrue(d(0, 0));
        }
