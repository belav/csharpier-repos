...
namespace MonoTests.System
{
    ...
    public class Int64Test
    {
        ...
        {
            "(" + NumberFormatInfo.InvariantInfo.CurrencySymbol + "9,223,372,036,854,775,808.00)",
            "-9223372036854775808",
            "-9.223372e+018",
            "-9223372036854775808.00",
            "-9223372036854775808",
        ...
        {
            "" + NumberFormatInfo.InvariantInfo.CurrencySymbol + "9,223,372,036,854,775,807.00000",
            "9223372036854775807",
            "9.22337e+018",
            "9223372036854775807.00000",
            "9.2234e+18",
        ...
        private const NumberStyles style1 =
        ...
        public void TestParseExponent()
        {
            ...
            Assert.AreEqual(
                21,
                long.Parse("2.1E1", NumberStyles.AllowDecimalPoint | NumberStyles.AllowExponent),
                "A#7"
            );
            Assert.AreEqual(
                520,
                long.Parse(".52E3", NumberStyles.AllowDecimalPoint | NumberStyles.AllowExponent),
                "A#8"
            );
            Assert.AreEqual(
                32500000,
                long.Parse("32.5E6", NumberStyles.AllowDecimalPoint | NumberStyles.AllowExponent),
                "A#9"
            );
            Assert.AreEqual(
                890,
                long.Parse("8.9000E2", NumberStyles.AllowDecimalPoint | NumberStyles.AllowExponent),
                "A#10"
            );
        ...
        public void TestTryParse()
        {
            ...
            Assert.AreEqual(
                true,
                long.TryParse("100000000", NumberStyles.HexNumber, Nfi, out result)
            );
            Assert.AreEqual(true, long.TryParse("10000000000", out result));
            Assert.AreEqual(true, long.TryParse("-10000000000", out result));
            Assert.AreEqual(
                true,
                long.TryParse("7fffffff", NumberStyles.HexNumber, Nfi, out result)
            );
            Assert.AreEqual(int.MaxValue, result);
            Assert.AreEqual(
                true,
                long.TryParse("80000000", NumberStyles.HexNumber, Nfi, out result)
            );
            Assert.AreEqual(2147483648, result);
            Assert.AreEqual(
                true,
                long.TryParse("ffffffff", NumberStyles.HexNumber, Nfi, out result)
            );
        ...
        public void TestToString()
        {
            ...
            for (int i = 0; i < Formats1.Length; i++)
            {
                Assert.AreEqual(
                    Results1[i],
                    MyInt64_2.ToString(Formats1[i]),
                    "MyInt64_2.ToString(Formats1[" + i + "])"
                );
                Assert.AreEqual(
                    Results2[i],
                    MyInt64_3.ToString(Formats2[i]),
                    "MyInt64_3.ToString(Formats2[" + i + "])"
                );
            }
            ...
            for (int i = 0; i < Formats1.Length; i++)
            {
                Assert.AreEqual(
                    ResultsNfi1[i],
                    MyInt64_2.ToString(Formats1[i], Nfi),
                    "MyInt64_2.ToString(Formats1[" + i + "], Nfi)"
                );
                Assert.AreEqual(
                    ResultsNfi2[i],
                    MyInt64_3.ToString(Formats2[i], Nfi),
                    "MyInt64_3.ToString(Formats2[" + i + "], Nfi)"
                );
            }
            try
        ...
        public void TestUserCurrency()
        {
            ...
            Assert.AreEqual(
                "1234/5/67:000 XYZ-",
                s,
                "Currency value type 1 is not what we want to try to parse"
            );
            ...
            Assert.AreEqual(
                "1234/5/67:000 XYZ",
                s,
                "Currency value type 2 is not what we want to try to parse"
            );
        ...
        public void Parse_MaxValue()
        {
            Assert.AreEqual(
                Int64.MaxValue,
                Int64.Parse("9223372036854775807"),
                "9223372036854775807"
            );
        }
