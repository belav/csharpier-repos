...
internal static partial class Interop
{
    internal static partial class Sys
    {
        ...
        internal static extern unsafe int ReadDirR_native(
            IntPtr dir,
            byte* buffer,
            int bufferSize,
        ...
        internal static IntPtr OpenDir(string path)
        {
            ...
            do
            {
                ...
                result == IntPtr.Zero && Marshal.GetLastWin32Error() == (int)Interop.Error.EINTR
            );
            return result;
        }
        ...
        internal static unsafe int ReadDirR(
            IntPtr dir,
            byte* buffer,
            int bufferSize,
            out DirectoryEntry outputEntry
