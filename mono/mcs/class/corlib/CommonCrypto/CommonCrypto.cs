...
namespace Crimson.CommonCrypto
{
    ...
    static class Cryptor
    {
        ...
        internal static extern CCCryptorStatus CCCryptorCreate(
            ...
            byte[] key, /* size_t */
            IntPtr keyLength, /* const void* */
            byte[] iv, /* CCCryptorRef* */
            ref IntPtr cryptorRef
        );
        ...
        )
        {
            ...
            CCCryptorStatus status = Cryptor.CCCryptorCreate(
                operation,
                algorithm,
                options,
                key,
