...
namespace System.Reflection.Emit
{
    ...
    public class OpCodes
    {
        ...
        public static readonly OpCode Nop = new OpCode(
            0xFF << 0
                | 0x00 << 8
                | (byte)StackBehaviour.Push0 << 16
                | (byte)StackBehaviour.Pop0 << 24,
            1 << 0
                | (byte)OpCodeType.Primitive << 8
                | (byte)OperandType.InlineNone << 16
        ...
        public static readonly OpCode Break = new OpCode(
            ...
            1 << 0
                | (byte)OpCodeType.Primitive << 8
                | (byte)OperandType.InlineNone << 16
                | (byte)FlowControl.Break << 24
        );

        public static readonly OpCode Ldarg_0 = new OpCode(
            0xFF << 0
                | 0x02 << 8
                | (byte)StackBehaviour.Push1 << 16
                | (byte)StackBehaviour.Pop0 << 24,
            1 << 0
                | (byte)OpCodeType.Macro << 8
                | (byte)OperandType.InlineNone << 16
                | (byte)FlowControl.Next << 24
        );
        ...
        public static readonly OpCode Ldarg_S = new OpCode(
            ...
            1 << 0
                | (byte)OpCodeType.Macro << 8
                | (byte)OperandType.ShortInlineVar << 16
                | (byte)FlowControl.Next << 24
        );
        ...
        public static readonly OpCode Ldnull = new OpCode(
            0xFF << 0
                | 0x14 << 8
                | (byte)StackBehaviour.Pushref << 16
                | (byte)StackBehaviour.Pop0 << 24,
            1 << 0
                | (byte)OpCodeType.Primitive << 8
                | (byte)OperandType.InlineNone << 16
        ...
        public static readonly OpCode Ldc_I4_S = new OpCode(
            ...
            1 << 0
                | (byte)OpCodeType.Macro << 8
                | (byte)OperandType.ShortInlineI << 16
                | (byte)FlowControl.Next << 24
        );
        ...
        public static readonly OpCode Ldc_I8 = new OpCode(
            0xFF << 0
                | 0x21 << 8
                | (byte)StackBehaviour.Pushi8 << 16
                | (byte)StackBehaviour.Pop0 << 24,
            1 << 0
                | (byte)OpCodeType.Primitive << 8
                | (byte)OperandType.InlineI8 << 16
                | (byte)FlowControl.Next << 24
        );
        ...
        public static readonly OpCode Ldc_R4 = new OpCode(
            0xFF << 0
                | 0x22 << 8
                | (byte)StackBehaviour.Pushr4 << 16
                | (byte)StackBehaviour.Pop0 << 24,
            1 << 0
                | (byte)OpCodeType.Primitive << 8
                | (byte)OperandType.ShortInlineR << 16
                | (byte)FlowControl.Next << 24
        );
        ...
        public static readonly OpCode Ldc_R8 = new OpCode(
            0xFF << 0
                | 0x23 << 8
                | (byte)StackBehaviour.Pushr8 << 16
                | (byte)StackBehaviour.Pop0 << 24,
            1 << 0
                | (byte)OpCodeType.Primitive << 8
                | (byte)OperandType.InlineR << 16
                | (byte)FlowControl.Next << 24
        );
        ...
        public static readonly OpCode Dup = new OpCode(
            0xFF << 0
                | 0x25 << 8
                | (byte)StackBehaviour.Push1_push1 << 16
                | (byte)StackBehaviour.Pop1 << 24,
            1 << 0
                | (byte)OpCodeType.Primitive << 8
                | (byte)OperandType.InlineNone << 16
        ...
        public static readonly OpCode Jmp = new OpCode(
            ...
            1 << 0
                | (byte)OpCodeType.Primitive << 8
                | (byte)OperandType.InlineMethod << 16
                | (byte)FlowControl.Call << 24
        );

        public static readonly OpCode Call = new OpCode(
            0xFF << 0
                | 0x28 << 8
                | (byte)StackBehaviour.Varpush << 16
                | (byte)StackBehaviour.Varpop << 24,
            1 << 0
                | (byte)OpCodeType.Primitive << 8
                | (byte)OperandType.InlineMethod << 16
                | (byte)FlowControl.Call << 24
        ...
        public static readonly OpCode Br_S = new OpCode(
            ...
            1 << 0
                | (byte)OpCodeType.Macro << 8
                | (byte)OperandType.ShortInlineBrTarget << 16
                | (byte)FlowControl.Branch << 24
        );
        ...
        public static readonly OpCode Brfalse_S = new OpCode(
            0xFF << 0
                | 0x2C << 8
                | (byte)StackBehaviour.Push0 << 16
                | (byte)StackBehaviour.Popi << 24,
            1 << 0
                | (byte)OpCodeType.Macro << 8
                | (byte)OperandType.ShortInlineBrTarget << 16
                | (byte)FlowControl.Cond_Branch << 24
        );
        ...
        public static readonly OpCode Beq_S = new OpCode(
            0xFF << 0
                | 0x2E << 8
                | (byte)StackBehaviour.Push0 << 16
                | (byte)StackBehaviour.Pop1_pop1 << 24,
            1 << 0
                | (byte)OpCodeType.Macro << 8
                | (byte)OperandType.ShortInlineBrTarget << 16
                | (byte)FlowControl.Cond_Branch << 24
        ...
        public static readonly OpCode Br = new OpCode(
            ...
            1 << 0
                | (byte)OpCodeType.Primitive << 8
                | (byte)OperandType.InlineBrTarget << 16
                | (byte)FlowControl.Branch << 24
        );
        ...
        public static readonly OpCode Switch = new OpCode(
            ...
            1 << 0
                | (byte)OpCodeType.Primitive << 8
                | (byte)OperandType.InlineSwitch << 16
                | (byte)FlowControl.Cond_Branch << 24
        );
        ...
        public static readonly OpCode Stind_Ref = new OpCode(
            0xFF << 0
                | 0x51 << 8
                | (byte)StackBehaviour.Push0 << 16
                | (byte)StackBehaviour.Popi_popi << 24,
            1 << 0
                | (byte)OpCodeType.Primitive << 8
                | (byte)OperandType.InlineNone << 16
                | (byte)FlowControl.Next << 24
        ...
        public static readonly OpCode Stind_I8 = new OpCode(
            0xFF << 0
                | 0x55 << 8
                | (byte)StackBehaviour.Push0 << 16
                | (byte)StackBehaviour.Popi_popi8 << 24,
            1 << 0
                | (byte)OpCodeType.Primitive << 8
                | (byte)OperandType.InlineNone << 16
                | (byte)FlowControl.Next << 24
        ...
        public static readonly OpCode Stind_R4 = new OpCode(
            0xFF << 0
                | 0x56 << 8
                | (byte)StackBehaviour.Push0 << 16
                | (byte)StackBehaviour.Popi_popr4 << 24,
            1 << 0
                | (byte)OpCodeType.Primitive << 8
                | (byte)OperandType.InlineNone << 16
                | (byte)FlowControl.Next << 24
        ...
        public static readonly OpCode Stind_R8 = new OpCode(
            0xFF << 0
                | 0x57 << 8
                | (byte)StackBehaviour.Push0 << 16
                | (byte)StackBehaviour.Popi_popr8 << 24,
            1 << 0
                | (byte)OpCodeType.Primitive << 8
                | (byte)OperandType.InlineNone << 16
                | (byte)FlowControl.Next << 24
        ...
        public static readonly OpCode Cpobj = new OpCode(
            ...
            1 << 0
                | (byte)OpCodeType.Objmodel << 8
                | (byte)OperandType.InlineType << 16
                | (byte)FlowControl.Next << 24
        );
        ...
        public static readonly OpCode Ldstr = new OpCode(
            ...
            1 << 0
                | (byte)OpCodeType.Objmodel << 8
                | (byte)OperandType.InlineString << 16
                | (byte)FlowControl.Next << 24
        );
        ...
        public static readonly OpCode Ldfld = new OpCode(
            ...
            1 << 0
                | (byte)OpCodeType.Objmodel << 8
                | (byte)OperandType.InlineField << 16
                | (byte)FlowControl.Next << 24
        );
        ...
        public static readonly OpCode Stfld = new OpCode(
            0xFF << 0
                | 0x7D << 8
                | (byte)StackBehaviour.Push0 << 16
                | (byte)StackBehaviour.Popref_pop1 << 24,
            1 << 0
                | (byte)OpCodeType.Objmodel << 8
                | (byte)OperandType.InlineField << 16
                | (byte)FlowControl.Next << 24
        ...
        public static readonly OpCode Stobj = new OpCode(
            0xFF << 0
                | 0x81 << 8
                | (byte)StackBehaviour.Push0 << 16
                | (byte)StackBehaviour.Popi_pop1 << 24,
            1 << 0
                | (byte)OpCodeType.Primitive << 8
                | (byte)OperandType.InlineType << 16
                | (byte)FlowControl.Next << 24
        ...
        public static readonly OpCode Ldelema = new OpCode(
            0xFF << 0
                | 0x8F << 8
                | (byte)StackBehaviour.Pushi << 16
                | (byte)StackBehaviour.Popref_popi << 24,
            1 << 0
                | (byte)OpCodeType.Objmodel << 8
                | (byte)OperandType.InlineType << 16
                | (byte)FlowControl.Next << 24
        ...
        public static readonly OpCode Stelem_I = new OpCode(
            0xFF << 0
                | 0x9B << 8
                | (byte)StackBehaviour.Push0 << 16
                | (byte)StackBehaviour.Popref_popi_popi << 24,
            1 << 0
                | (byte)OpCodeType.Objmodel << 8
                | (byte)OperandType.InlineNone << 16
                | (byte)FlowControl.Next << 24
        ...
        public static readonly OpCode Stelem_I8 = new OpCode(
            0xFF << 0
                | 0x9F << 8
                | (byte)StackBehaviour.Push0 << 16
                | (byte)StackBehaviour.Popref_popi_popi8 << 24,
            1 << 0
                | (byte)OpCodeType.Objmodel << 8
                | (byte)OperandType.InlineNone << 16
                | (byte)FlowControl.Next << 24
        ...
        public static readonly OpCode Stelem_R4 = new OpCode(
            0xFF << 0
                | 0xA0 << 8
                | (byte)StackBehaviour.Push0 << 16
                | (byte)StackBehaviour.Popref_popi_popr4 << 24,
            1 << 0
                | (byte)OpCodeType.Objmodel << 8
                | (byte)OperandType.InlineNone << 16
                | (byte)FlowControl.Next << 24
        ...
        public static readonly OpCode Stelem_R8 = new OpCode(
            0xFF << 0
                | 0xA1 << 8
                | (byte)StackBehaviour.Push0 << 16
                | (byte)StackBehaviour.Popref_popi_popr8 << 24,
            1 << 0
                | (byte)OpCodeType.Objmodel << 8
                | (byte)OperandType.InlineNone << 16
                | (byte)FlowControl.Next << 24
        ...
        public static readonly OpCode Stelem_Ref = new OpCode(
            0xFF << 0
                | 0xA2 << 8
                | (byte)StackBehaviour.Push0 << 16
                | (byte)StackBehaviour.Popref_popi_popref << 24,
            1 << 0
                | (byte)OpCodeType.Objmodel << 8
                | (byte)OperandType.InlineNone << 16
                | (byte)FlowControl.Next << 24
        ...
        public static readonly OpCode Stelem = new OpCode(
            0xFF << 0
                | 0xA4 << 8
                | (byte)StackBehaviour.Push0 << 16
                | (byte)StackBehaviour.Popref_popi_pop1 << 24,
            1 << 0
                | (byte)OpCodeType.Objmodel << 8
                | (byte)OperandType.InlineType << 16
                | (byte)FlowControl.Next << 24
        ...
        public static readonly OpCode Prefix7 = new OpCode(
            0xFF << 0
                ...
                | (byte)StackBehaviour.Pop0 << 24,
            1 << 0
                | (byte)OpCodeType.Nternal << 8
                | (byte)OperandType.InlineNone << 16
                | (byte)FlowControl.Meta << 24
        );
        ...
        public static readonly OpCode Cpblk = new OpCode(
            0xFE << 0
                | 0x17 << 8
                | (byte)StackBehaviour.Push0 << 16
                | (byte)StackBehaviour.Popi_popi_popi << 24,
            2 << 0
                | (byte)OpCodeType.Primitive << 8
                | (byte)OperandType.InlineNone << 16
                | (byte)FlowControl.Next << 24
