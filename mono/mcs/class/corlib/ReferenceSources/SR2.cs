...
partial class SR
{
    ...
    public const string net_ssl_io_already_shutdown =
        "Write operations are not allowed after the channel was shutdown.";

    public const string net_log_set_socketoption_reuseport_default_on =
        "net_log_set_socketoption_reuseport_default_on";
    public const string net_log_set_socketoption_reuseport_not_supported =
    ...
    public const string net_conflicting_options =
