...
namespace System.Globalization
{
    ...
    internal static partial class EncodingTable
    {
        ...
        {
            return new InternalEncodingDataItem() { webName = name, codePage = cp };
        }
        ...
        internal static InternalCodePageDataItem[] codePageDataPtr = new InternalCodePageDataItem[]
        {
            ...
            MapCodePageDataItem(
                1251,
                1251,
                "|windows-1251|windows-1251|koi8-r",
                MIMECONTF_MAILNEWS
                    | MIMECONTF_BROWSER
                    | MIMECONTF_SAVABLE_MAILNEWS
                    | MIMECONTF_SAVABLE_BROWSER
            ...
            MapCodePageDataItem(
                1254,
                1254,
                "|windows-1254|windows-1254|iso-8859-9",
                MIMECONTF_MAILNEWS
                    | MIMECONTF_BROWSER
                    | MIMECONTF_SAVABLE_MAILNEWS
                    | MIMECONTF_SAVABLE_BROWSER
    ...
    internal static partial class EncodingTable
    {
        ...
        */
        ...
        //
        private static Dictionary<string, int> hashByName = new Dictionary<string, int>(
        ...
        private static Dictionary<int, CodePageDataItem> hashByCodePage =
            new Dictionary<int, CodePageDataItem>();
        ...
        private static unsafe int internalGetCodePageFromName(String name)
        {
            ...
            throw new ArgumentException(
                String.Format(
                    ...
                    Environment.GetResourceString("Argument_EncodingNotSupported"),
                    name
                ),
                "name"
            );
        ...
        internal static unsafe EncodingInfo[] GetEncodings()
        {
            ...
            for (i = 0; i < lastCodePageItem; i++)
            {
                arrayEncodingInfo[i] = new EncodingInfo(
                    codePageDataPtr[i].codePage,
                    CodePageDataItem.CreateString(codePageDataPtr[i].Names, 0),
