...
namespace System.ServiceModel.Discovery
{
            ...
            IDiscoveryTargetContractCD1
    {
        ...
        internal DiscoveryMessageSequenceGenerator DiscoveryMessageSequenceGenerator
        {
            get;
            private set;
        }
        ...
        {
            return OnBeginFind(
                new DefaultFindRequestContext(message.Body.ToFindCriteria()),
                callback,
                state
            );
        }
        ...
        IAsyncResult IDiscoveryProxyContract11.BeginResolve(
        ...
        MessageContracts11.ResolveResponse IDiscoveryProxyContract11.EndResolve(IAsyncResult result)
        {
            ...
            return new MessageContracts11.ResolveResponse()
            {
        ...
        // IDiscoveryProxyContractApril2005
        IAsyncResult IDiscoveryProxyContractApril2005.BeginFind(
        ...
        MessageContractsApril2005.FindResponse IDiscoveryProxyContractApril2005.EndFind(
            IAsyncResult result
        )
        {
            OnEndFind(result);
        ...
        IAsyncResult IDiscoveryProxyContractApril2005.BeginResolve(
        ...
        MessageContractsApril2005.ResolveResponse IDiscoveryProxyContractApril2005.EndResolve(
            IAsyncResult result
        )
        {
            var ret = OnEndResolve(result);
            return new MessageContractsApril2005.ResolveResponse()
            {
        ...
        // IDiscoveryProxyContractCD1
        IAsyncResult IDiscoveryProxyContractCD1.BeginFind(
        ...
        IAsyncResult IDiscoveryProxyContractCD1.BeginResolve(
        ...
        MessageContractsCD1.ResolveResponse IDiscoveryProxyContractCD1.EndResolve(
            IAsyncResult result
        )
        {
            var ret = OnEndResolve(result);
        ...
        // IDiscoveryTargetContract11
        IAsyncResult IDiscoveryTargetContract11.BeginFind(
            MessageContracts11.FindRequest message,
            AsyncCallback callback,
            object state
        )
        ...
        IAsyncResult IDiscoveryTargetContract11.BeginResolve(
            MessageContracts11.ResolveRequest message,
            AsyncCallback callback,
            object state
        )
        ...
        IAsyncResult IDiscoveryTargetContract11.BeginOnlineAnnouncement(
            MessageContracts11.OnlineAnnouncement msg,
            AsyncCallback callback,
            object state
        )
        {
            var edm =
                msg.EndpointDiscoveryMetadata != null
                    ? msg.EndpointDiscoveryMetadata.ToEndpointDiscoveryMetadata()
                    : null;
            return OnBeginOnlineAnnouncement(
                DiscoveryMessageSequenceGenerator.Next(),
                edm,
                callback,
                state
        ...
        // IDiscoveryTargetContractApril2005
        IAsyncResult IDiscoveryTargetContractApril2005.BeginFind(
            MessageContractsApril2005.FindRequest message,
            AsyncCallback callback,
            object state
        )
        ...
        IAsyncResult IDiscoveryTargetContractApril2005.BeginResolve(
            MessageContractsApril2005.ResolveRequest message,
            AsyncCallback callback,
            object state
        )
        ...
        IAsyncResult IDiscoveryTargetContractApril2005.BeginOnlineAnnouncement(
            MessageContractsApril2005.OnlineAnnouncement msg,
            AsyncCallback callback,
            object state
        )
        {
        ...
        // IDiscoveryTargetContractCD1
        IAsyncResult IDiscoveryTargetContractCD1.BeginFind(
            MessageContractsCD1.FindRequest message,
            AsyncCallback callback,
            object state
        )
        ...
        IAsyncResult IDiscoveryTargetContractCD1.BeginResolve(
            MessageContractsCD1.ResolveRequest message,
            AsyncCallback callback,
            object state
        )
        ...
        IAsyncResult IDiscoveryTargetContractCD1.BeginOnlineAnnouncement(
            MessageContractsCD1.OnlineAnnouncement msg,
            AsyncCallback callback,
            object state
        )
        {
