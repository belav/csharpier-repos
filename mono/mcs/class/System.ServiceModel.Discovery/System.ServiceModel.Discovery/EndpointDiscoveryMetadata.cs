...
namespace System.ServiceModel.Discovery
{
    public class EndpointDiscoveryMetadata
    {
        ...
        internal static EndpointDiscoveryMetadata ReadXml(
            XmlReader reader,
        ...
        )
        {
            ...
            ret.Address = EndpointAddress.ReadFrom(
                version.MessageVersion.Addressing,
                reader,
                "EndpointReference",
                addrNS
            );
            ...
            if (reader.IsStartElement("XAddrs", version.Namespace))
                ret.ListenUris = new Collection<Uri>(
                    (Uri[])
                        reader.ReadElementContentAs(
                            typeof(Uri[]),
                            null,
