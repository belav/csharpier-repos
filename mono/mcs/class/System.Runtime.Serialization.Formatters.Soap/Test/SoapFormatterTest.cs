...
namespace MonoTests.System.Runtime.Serialization.Formatters.Soap
{
    ...
    internal class SimpleObject
    {
        ...
        public override bool Equals(object obj)
        {
            ...
            if (objCmp == null)
                return false;
            if (objCmp._name != this._name)
                return false;
            if (objCmp._id != this._id)
                return false;
            return true;
        }
    }
    ...
    public class SoapFormatterTest
    {
        ...
        public void TestObjects()
        {
            ...
            soapMsg.XmlNameSpace = SoapServices.CodeXmlNamespaceForClrTypeNamespace(
                "String",
                "System"
            );
        ...
        public static bool CheckArray(object objTest, object objReturn)
        {
            ...
            Assert.AreEqual(
                objTestAsArray.Length,
                objReturnAsArray.Length,
                "#Different lengths " + objTest
            );
        ...
        public void TestMethodSignatureSerialization()
        {
            Header h = new Header(
                "__MethodSignature",
                new Type[] { typeof(string), typeof(SignatureTest[]) },
                false,
