...
partial class SR
{
    ...
    public const string ArgumentException_NoDigitFound =
    ...
    public const string ArgumentException_IncompleteExponent =
        "Invalid JSON numeric literal; incomplete exponent.";
    public const string ArgumentException_InvalidLiteralFormat =
        "Invalid JSON string literal format.";
    public const string ArgumentException_StringNotClosed = "JSON string is not closed.";
    public const string ArgumentException_IncompleteEscapeSequence =
        "Invalid JSON string literal; incomplete escape sequence.";
    public const string ArgumentException_IncompleteEscapeLiteral =
        "Incomplete unicode character escape literal.";
    public const string ArgumentException_UnexpectedEscapeCharacter =
    ...
    public const string NotImplemented_GetFormattedString =
        "GetFormattedString from value type {0}.";
}
