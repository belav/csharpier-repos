...
*
*    public override ValueTask<int> ReadAsync(Memory<byte> buffer, CancellationToken
cancellationToken)
*
* Without System.dll internals being visible, the compiler would correctly resolve the call using
the
