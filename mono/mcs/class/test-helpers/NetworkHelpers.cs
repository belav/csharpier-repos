    ...
    public static class NetworkHelpers
    {
        ...
        public static IPEndPoint LocalEphemeralEndPoint()
        {
            ...
            throw new ApplicationException(
                $"Could not find available local port after {counter} retries"
            );
        }
        ...
        public static HttpListener CreateAndStartHttpListener(
            string host,
            int port,
            string path,
            AuthenticationSchemes? authSchemes = null,
            Action<HttpListener> initializer = null
        )
        {
        ...
        )
        {
            ...
            for (int i = 0; i < 10; i++)
            {
                try
                {
                    ...
                    var listener = CreateAndStartHttpListener(
                        host,
                        tentativePort,
                        path,
                        authSchemes,
