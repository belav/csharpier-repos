...
partial class SR
{
    ...
    public const string CannotWriteToDeflateStream =
    ...
    public const string InvalidArgumentOffsetCount =
        "Offset plus count is larger than the length of target array.";
    public const string InvalidBeginCall =
    ...
    public const string InvalidHuffmanData =
    ...
    public const string UnknownState =
        "Decoder is in some unknown state. This might be caused by corrupted data.";
    public const string ZLibErrorDLLLoadError =
    ...
    public const string ZLibErrorIncorrectInitParameters =
    ...
    public const string ZLibErrorVersionMismatch =
    ...
    public const string CreateInReadMode =
    ...
    public const string DeleteOnlyInUpdate =
    ...
    public const string EntryNameEncodingNotSupported =
        "The specified entry name encoding is not supported.";
    ...
    public const string FieldTooBigLocalHeaderOffset =
    ...
    public const string FieldTooBigOffsetToCD =
        "Offset to Central Directory cannot be held in an Int64.";
    public const string FieldTooBigOffsetToZip64EOCD =
        "Offset to Zip64 End Of Central Directory record cannot be held in an Int64.";
    public const string FieldTooBigStartDiskNumber =
        "Start Disk Number cannot be held in an Int64.";
    public const string FieldTooBigUncompressedSize =
        "Uncompressed Size cannot be held in an Int64.";
    public const string FrozenAfterWrite =
    ...
    public const string LengthAfterWrite =
    ...
    public const string NumEntriesWrong =
        "Number of entries expected in End Of Central Directory does not correspond to number of entries in Central Directory.";
    public const string OffsetLengthInvalid =
        "The offset and length parameters are not valid for the array that was given.";
    public const string ReadingNotSupported =
    ...
    public const string SeekingNotSupported =
        "This stream from ZipArchiveEntry does not support seeking.";
    public const string SetLengthRequiresSeekingAndWriting =
    ...
    public const string BrotliStream_Compress_UnsupportedOperation =
    ...
    public const string BrotliStream_Decompress_UnsupportedOperation =
    ...
    public const string BrotliStream_Decompress_InvalidStream =
