...
namespace System.Data.Services.Common
{
    ...
    internal class EpmTargetPathSegment
    {
        ...
        internal EpmTargetPathSegment(
            String segmentName,
            String segmentNamespaceUri,
            String segmentNamespacePrefix,
        ...
        {
            get { return this.segmentNamespaceUri; }
        }

        internal String SegmentNamespacePrefix
        {
            get { return this.segmentNamespacePrefix; }
        }
        ...
        {
            get { return this.EpmInfo != null; }
        }

        internal bool IsAttribute
        {
            get { return this.SegmentName[0] == '@'; }
        }

        internal EpmTargetPathSegment ParentSegment
        {
            get { return this.parentSegment; }
        }

        internal List<EpmTargetPathSegment> SubSegments
        {
            get { return this.subSegments; }
        }
    }
}
