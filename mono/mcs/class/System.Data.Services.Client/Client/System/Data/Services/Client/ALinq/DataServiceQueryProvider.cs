...
namespace System.Data.Services.Client
{
    ...
    internal sealed class DataServiceQueryProvider : IQueryProvider
    {
        ...
        public object Execute(Expression expression)
        {
            ...
            MethodInfo mi = typeof(DataServiceQueryProvider).GetMethod(
                "ReturnSingleton",
                BindingFlags.NonPublic | BindingFlags.Instance
            );
        ...
        {
            IQueryable<TElement> query = new DataServiceQuery<TElement>.DataServiceOrderedQuery(
                expression,
                this
            );
            ...
            if (ReflectionUtil.TryIdentifySequenceMethod(mce.Method, out sequenceMethod))
            {
                switch (sequenceMethod)
                {
                    ...
                    case SequenceMethod.Count:
                        return (TElement)
                            Convert.ChangeType(
                                ((DataServiceQuery<TElement>)query).GetQuerySetCount(this.Context),
                                typeof(TElement),
        ...
        internal QueryComponents Translate(Expression e)
        {
            ...
            {
                normalizerRewrites = new Dictionary<Expression, Expression>(
            ...
            Type lastSegmentType =
                re.Projection == null ? re.ResourceType : re.Projection.Selector.Parameters[0].Type;
