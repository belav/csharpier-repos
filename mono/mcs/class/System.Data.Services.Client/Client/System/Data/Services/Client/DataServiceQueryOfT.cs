...
namespace System.Data.Services.Client
{
    ...
    public class DataServiceQuery<TElement> : DataServiceQuery, IQueryable<TElement>
    {
        ...
        private DataServiceQuery(Expression expression, DataServiceQueryProvider provider)
        {
            ...
            Debug.Assert(
                provider is DataServiceQueryProvider,
                "Currently only support Web Query Provider"
            );
        ...
        {
            return DataServiceRequest.EndExecute<TElement>(
                this,
                this.queryProvider.Context,
                asyncResult
            );
        }
