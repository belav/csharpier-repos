...
namespace System.Data.Services.Client
{
    ...
    public sealed class LinkDescriptor : Descriptor
    {
        ...
        internal static readonly System.Collections.Generic.IEqualityComparer<LinkDescriptor> EquivalenceComparer =
            new Equivalent();
        ...
        private sealed class Equivalent
            : System.Collections.Generic.IEqualityComparer<LinkDescriptor>
        {
            ...
            public int GetHashCode(LinkDescriptor obj)
            {
                return obj.Source.GetHashCode()
                    ^ ((null != obj.Target) ? obj.Target.GetHashCode() : 0)
                    ^ obj.SourceProperty.GetHashCode();
            }
        }
    }
}
