...
namespace System.Data.Services.Client
{
    ...
    public abstract class DataServiceRequest
    {
        ...
        internal abstract QueryComponents QueryComponents { get; }
        ...
        internal static DataServiceRequest GetInstance(Type elementType, Uri requestUri)
        {
            ...
            return (DataServiceRequest)
                Activator.CreateInstance(genericType, new object[] { requestUri });
        }

        internal static IEnumerable<TElement> EndExecute<TElement>(
            object source,
            DataServiceContext context,
        ...
        )
        {
            ...
            catch (DataServiceQueryException ex)
            {
                ...
                if (
                    ...
                    && serviceEx != null
                    && serviceEx.StatusCode == (int)HttpStatusCode.NotFound
                )
                {
                    QueryOperationResponse qor = new QueryOperationResponse<TElement>(
                        new Dictionary<string, string>(ex.Response.Headers),
                        ex.Response.Query,
...
#if !ASTORIA_LIGHT
        internal QueryOperationResponse<TElement> Execute<TElement>(
            DataServiceContext context,
            QueryComponents queryComponents
        )
        {
            ...
            try
            {
                DataServiceRequest<TElement> serviceRequest = new DataServiceRequest<TElement>(
                    queryComponents,
                    this.Plan
                );
        ...
        internal long GetQuerySetCount(DataServiceContext context)
        {
            ...
            DataServiceRequest<long> serviceRequest = new DataServiceRequest<long>(
                this.QueryComponents,
                null
            );
            HttpWebRequest request = context.CreateRequest(
            ...
            try
            {
                ...
                {
                    throw new DataServiceQueryException(
                        Strings.DataServiceRequest_FailGetCount,
                        response.Failure
                    );
                }
            }
        ...
        internal IAsyncResult BeginExecute(
            object source,
            DataServiceContext context,
