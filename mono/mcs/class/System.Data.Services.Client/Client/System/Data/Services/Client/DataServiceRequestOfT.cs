...
namespace System.Data.Services.Client
{
    ...
    public sealed class DataServiceRequest<TElement> : DataServiceRequest
    {
        ...
        public DataServiceRequest(Uri requestUri)
        {
            ...
            elementType = ClientConvert.IsKnownType(elementType)
                ? elementType
                : TypeSystem.GetElementType(elementType);
            this.queryComponents = new QueryComponents(
                requestUri,
        ...
        {
            get { return this.queryComponents; }
        }
    }
}
