...
namespace System.Data.Services.Client
{
    ...
    internal abstract class DataServiceExpressionVisitor : ExpressionVisitor
    {
        internal override Expression Visit(Expression exp)
        {
            ...
            switch ((ResourceExpressionType)exp.NodeType)
            {
                ...
                case ResourceExpressionType.ResourceNavigationPropertySingleton:
                    return this.VisitNavigationPropertySingletonExpression(
        ...
        )
        {
            ...
            {
                npse = new NavigationPropertySingletonExpression(
                    npse.Type,
                    source,
                    npse.MemberExpression,
                    npse.MemberExpression.Type,
                    npse.ExpandPaths,
                    npse.CountOption,
                    npse.CustomQueryOptions,
                    npse.Projection
                );
            }
        ...
        internal virtual Expression VisitInputReferenceExpression(InputReferenceExpression ire)
        {
            Debug.Assert(
                ire != null,
                "ire != null -- otherwise caller never should have visited here"
            );
