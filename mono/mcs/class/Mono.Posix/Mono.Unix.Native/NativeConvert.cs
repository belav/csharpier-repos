...
namespace Mono.Unix.Native
{
    ...
    partial class NativeConvert
    {
        ...
        static int FromRealTimeSignum(Int32 offset, out Int32 rval)
        {
            if (!AndroidUtils.AreRealTimeSignalsSafe())
                throw new PlatformNotSupportedException(
                    "Real-time signals are not supported on this Android architecture"
                );
        ...
        public static string ToUnixPermissionString(FilePermissions value)
        {
            ...
            return have_device ? new string(access) : new string(access, 1, 9);
        }
        ...
        private static void SetUnixPermissionGroup(
            ...
            FilePermissions exec,
            char both,
            char setonly,
            FilePermissions setxbit
        )
        {
        ...
        private static char GetSymbolicMode(
            FilePermissions value,
            FilePermissions xbit,
            char both,
            char setonly,
        ...
        public static long ToTimeT(DateTime time)
        {
            if (time.Kind == DateTimeKind.Unspecified)
                throw new ArgumentException(
                    "DateTimeKind.Unspecified is not supported. Use Local or Utc times.",
                    "time"
                );
        ...
        public static unsafe bool TryCopy(Sockaddr source, IntPtr destination)
        {
            ...
            // SockaddrStorage has to be handled extra because the native code assumes that SockaddrStorage
            // input is used in-place
        ...
        private static extern unsafe int ToSockaddr(
            IntPtr source,
            long size,
            _SockaddrHeader* destination
        );
