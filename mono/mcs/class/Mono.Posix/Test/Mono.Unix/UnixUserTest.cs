...
namespace MonoTests.Mono.Unix
{
    ...
    public class UnixUserTest
    {
        ...
        public void ListAllUsers_ToString()
        {
            ...
            {
                Assert.Fail(
                    string.Format("#TLAU_TS: Exception listing local users: {0}", e.ToString())
                );
            }
        }
        ...
        public void ReentrantConstructors()
        {
            ...
            foreach (UnixUserInfo user in users)
            {
                ...
                catch (Exception e)
                {
                    Assert.Fail(
                        string.Format(
                            "#TRC: Exception constructing UnixUserInfo (string): {0}",
                            e.ToString()
                        )
                    );
                }
            ...
            foreach (uint uid in user_ids)
            {
                ...
                catch (Exception e)
                {
                    Assert.Fail(
                        string.Format(
                            "#TRC: Exception constructing UnixUserInfo (uint): {0}",
                            e.ToString()
                        )
                    );
                }
        ...
        public void NonReentrantSyscalls()
        {
            ...
            foreach (UnixUserInfo user in users)
            {
                ...
                catch (Exception e)
                {
                    Assert.Fail(
                        string.Format(
                            "#TNRS: Exception constructing UnixUserInfo (string): {0}",
                            e.ToString()
                        )
                    );
                }
            ...
            foreach (long uid in user_ids)
            {
                ...
                catch (Exception e)
                {
                    Assert.Fail(
                        string.Format(
                            "#TNRS: Exception constructing UnixUserInfo (uint): {0}",
                            e.ToString()
                        )
                    );
                }
        ...
        public void InvalidUsers_Constructor_Name()
        {
            ...
            foreach (string u in badUsers)
            {
                ...
                catch (Exception e)
                {
                    Assert.Fail(
                        string.Format(
                            "#TIUCN: invalid exception thrown: "
