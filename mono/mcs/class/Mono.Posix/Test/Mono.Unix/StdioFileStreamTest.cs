...
namespace MonoTests.System.IO
{
    ...
    public class StdioFileStreamTest
    {
        ...
        public void Write()
        {
            ...
            StdioFileStream stream = new StdioFileStream(
                path,
                FileMode.CreateNew,
        ...
        public void PositionAfterWrite()
        {
            ...
            Assert.AreEqual(
                "(Mono.Unix.FilePosition 00000000",
                (fp = stream.FilePosition).ToString().Substring(0, 32),
                "test#02"
            );
            fp.Dispose();
            ...
            Assert.AreEqual(
                "(Mono.Unix.FilePosition 0B000000",
                (fp = stream.FilePosition).ToString().Substring(0, 32),
                "test#04"
            );
            fp.Dispose();
        ...
        public void Seek()
        {
            ...
            StdioFileStream stream2 = new StdioFileStream(
                path,
                FileMode.Open,
                FileAccess.ReadWrite
            );
