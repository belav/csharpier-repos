    ...
    public class UnixEncodingTest
    {
        ...
        public void TestThrowOnInvalid()
        {
            ...
            Assert.AreEqual(
                ...
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-TestThrowOnInvalid"
            );
            ...
            Assert.AreEqual(
                "\x30\x31\u0000\xC0\u0000\xAF\x30\x32",
                s,
                "Output-TestThrowOnInvalid2"
            );
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-TestThrowOnInvalid2"
            );
        }
        ...
        public void T3_Malformed_2_LonelyStart_321()
        {
            ...
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T3_Malformed_2_LonelyStart_321"
            );
        }
        ...
        public void T3_Malformed_2_LonelyStart_322()
        {
            ...
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T3_Malformed_2_LonelyStart_322"
            );
        }
        ...
        public void T3_Malformed_2_LonelyStart_323()
        {
            ...
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T3_Malformed_2_LonelyStart_323"
            );
        }
        ...
        public void T3_Malformed_2_LonelyStart_324()
        {
            ...
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T3_Malformed_2_LonelyStart_324"
            );
        }
        ...
        public void T3_Malformed_3_LastContinuationMissing_331()
        {
            ...
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T3_Malformed_3_LastContinuationMissing_331"
            );
        }
        ...
        public void T3_Malformed_3_LastContinuationMissing_333()
        {
            ...
            Assert.AreEqual(
                "\u0000\xF0\u0000\x80\u0000\x80",
                s,
                "Output-T3_Malformed_3_LastContinuationMissing_333"
            );
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T3_Malformed_3_LastContinuationMissing_333"
            );
        }
        ...
        public void T3_Malformed_3_LastContinuationMissing_334()
        {
            ...
            Assert.AreEqual(
                "\u0000\xF8\u0000\x80\u0000\x80\u0000\x80",
                s,
                "Output-T3_Malformed_3_LastContinuationMissing_334"
            );
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T3_Malformed_3_LastContinuationMissing_334"
            );
        }
        ...
        public void T3_Malformed_3_LastContinuationMissing_335()
        {
            ...
            Assert.AreEqual(
                "\u0000\xFC\u0000\x80\u0000\x80\u0000\x80\u0000\x80",
                s,
                "Output-T3_Malformed_3_LastContinuationMissing_335"
            );
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T3_Malformed_3_LastContinuationMissing_335"
            );
        }
        ...
        public void T3_Malformed_3_LastContinuationMissing_336()
        {
            ...
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T3_Malformed_3_LastContinuationMissing_336"
            );
        }
        ...
        public void T3_Malformed_3_LastContinuationMissing_337()
        {
            ...
            Assert.AreEqual(
                "\u0000\xEF\u0000\xBF",
                s,
                "Output-T3_Malformed_3_LastContinuationMissing_337"
            );
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T3_Malformed_3_LastContinuationMissing_337"
            );
        }
        ...
        public void T3_Malformed_3_LastContinuationMissing_338()
        {
            ...
            Assert.AreEqual(
                "\u0000\xF7\u0000\xBF\u0000\xBF",
                s,
                "Output-T3_Malformed_3_LastContinuationMissing_338"
            );
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T3_Malformed_3_LastContinuationMissing_338"
            );
        }
        ...
        public void T3_Malformed_4_ConcatenationImcomplete()
        {
            ...
            Assert.AreEqual(
                ...
                s,
                "Output-T3_Malformed_4_ConcatenationImcomplete"
            );
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T3_Malformed_4_ConcatenationImcomplete"
            );
        }
        ...
        public void T4_Overlong_1_ASCII_Slash_411()
        {
            ...
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T4_Overlong_1_ASCII_Slash_411"
            );
        }
        ...
        public void T4_Overlong_1_ASCII_Slash_412()
        {
            ...
            Assert.AreEqual(
                "\u0000\xE0\u0000\x80\u0000\xAF",
                s,
                "Output-T4_Overlong_1_ASCII_Slash_413"
            );
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T4_Overlong_1_ASCII_Slash_413"
            );
        }
        ...
        public void T4_Overlong_1_ASCII_Slash_413()
        {
            ...
            Assert.AreEqual(
                "\u0000\xF0\u0000\x80\u0000\x80\u0000\xAF",
                s,
                "Output-T4_Overlong_1_ASCII_Slash_412"
            );
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T4_Overlong_1_ASCII_Slash_412"
            );
        }
        ...
        public void T4_Overlong_1_ASCII_Slash_414()
        {
            ...
            Assert.AreEqual(
                "\u0000\xF8\u0000\x80\u0000\x80\u0000\x80\u0000\xAF",
                s,
                "Output-T4_Overlong_1_ASCII_Slash_414"
            );
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T4_Overlong_1_ASCII_Slash_414"
            );
        }
        ...
        public void T4_Overlong_1_ASCII_Slash_415()
        {
            ...
            Assert.AreEqual(
                ...
                s,
                "Output-T4_Overlong_1_ASCII_Slash_415"
            );
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T4_Overlong_1_ASCII_Slash_415"
            );
        }
        ...
        public void T4_Overlong_2_MaximumBoundary_421()
        {
            ...
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T4_Overlong_2_MaximumBoundary_421"
            );
        }
        ...
        public void T4_Overlong_2_MaximumBoundary_422()
        {
            ...
            Assert.AreEqual(
                "\u0000\xE0\u0000\x9F\u0000\xBF",
                s,
                "Output-T4_Overlong_2_MaximumBoundary_422"
            );
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T4_Overlong_2_MaximumBoundary_422"
            );
        }
        ...
        public void T4_Overlong_2_MaximumBoundary_423()
        {
            ...
            Assert.AreEqual(
                "\u0000\xF0\u0000\x8F\u0000\xBF\u0000\xBF",
                s,
                "Output-T4_Overlong_2_MaximumBoundary_423"
            );
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T4_Overlong_2_MaximumBoundary_423"
            );
        }
        ...
        public void T4_Overlong_2_MaximumBoundary_424()
        {
            ...
            Assert.AreEqual(
                "\u0000\xF8\u0000\x87\u0000\xBF\u0000\xBF\u0000\xBF",
                s,
                "Output-T4_Overlong_2_MaximumBoundary_424"
            );
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T4_Overlong_2_MaximumBoundary_424"
            );
        }
        ...
        public void T4_Overlong_2_MaximumBoundary_425()
        {
            ...
            Assert.AreEqual(
                ...
                s,
                "Output-T4_Overlong_2_MaximumBoundary_425"
            );
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T4_Overlong_2_MaximumBoundary_425"
            );
        }
        ...
        public void T4_Overlong_3_NUL_431()
        {
            ...
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T4_Overlong_3_NUL_431"
            );
        }
        ...
        public void T4_Overlong_3_NUL_432()
        {
            ...
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T4_Overlong_3_NUL_432"
            );
        }
        ...
        public void T4_Overlong_3_NUL_433()
        {
            ...
            Assert.AreEqual(
                "\u0000\xF0\u0000\x80\u0000\x80\u0000\x80",
                s,
                "Output-T4_Overlong_3_NUL_433"
            );
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T4_Overlong_3_NUL_433"
            );
        }
        ...
        public void T4_Overlong_3_NUL_434()
        {
            ...
            Assert.AreEqual(
                "\u0000\xF8\u0000\x80\u0000\x80\u0000\x80\u0000\x80",
                s,
                "Output-T4_Overlong_3_NUL_434"
            );
            Assert.AreEqual(
                BitConverter.ToString(data),
                BitConverter.ToString(unix.GetBytes(s)),
                "Reconverted-T4_Overlong_3_NUL_434"
            );
        }
