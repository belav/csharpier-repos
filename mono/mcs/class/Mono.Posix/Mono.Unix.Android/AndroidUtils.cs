...
namespace Mono.Unix.Android
{
    internal sealed class AndroidUtils
    {
        ...
        delegate void DetectCPUAndArchitecture(
            out ushort builtForCPU,
        ...
        static AndroidUtils()
        {
            ...
            MethodInfo mi = androidRuntime.GetMethod(
                "DetectCPUAndArchitecture",
                BindingFlags.NonPublic | BindingFlags.Static
            );
            detectCPUAndArchitecture = (DetectCPUAndArchitecture)
                Delegate.CreateDelegate(typeof(DetectCPUAndArchitecture), mi);
        }
