...
using System;using System.IO;using System.Security;using System.Security.Cryptography.Xml;using System.Text;using System.Xml;using NUnit.Framework;
...
namespace MonoTests.System.Security.Cryptography.Xml
{
    ...
    public class XmlDsigC14NWithCommentsTransformTest
    {
        ...
        public void C14NSpecExample1()
        {
            ...
            Assert.AreEqual(
                C14NSpecExample1Output,
                res,
                "Example 1 from c14n spec - PIs, Comments, and Outside of Document Element (with comments)"
            );
        }
        ...
        public void C14NSpecExample2()
        {
            ...
            Assert.AreEqual(
                C14NSpecExample2Output,
                res,
                "Example 2 from c14n spec - Whitespace in Document Content (with comments)"
            );
        }
        ...
        public void C14NSpecExample3()
        {
            ...
            Assert.AreEqual(
                C14NSpecExample3Output,
                res,
                "Example 3 from c14n spec - Start and End Tags (with comments)"
            );
        }
        ...
        public void C14NSpecExample4()
        {
            ...
            Assert.AreEqual(
                C14NSpecExample4Output,
                res,
                "Example 4 from c14n spec - Character Modifications and Character References (with comments)"
            );
        }
        ...
        public void C14NSpecExample5()
        {
            ...
            Assert.AreEqual(
                C14NSpecExample5Output,
                res,
                "Example 5 from c14n spec - Entity References (with comments)"
            );
        }
        ...
        public void C14NSpecExample6()
        {
            ...
            Assert.AreEqual(
                C14NSpecExample6Output,
                res,
                "Example 6 from c14n spec - UTF-8 Encoding (with comments)"
            );
        }
