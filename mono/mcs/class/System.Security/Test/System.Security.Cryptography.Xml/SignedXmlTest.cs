...
using System;using System.Globalization;using System.IO;using System.Security.Cryptography;using System.Security.Cryptography.X509Certificates;using System.Security.Cryptography.Xml;using System.Text;using System.Xml;using NUnit.Framework;
...
";
            ...
            var ex = Assert.Throws<CryptographicException>(
                () => sut.CheckSignature(new HMACSHA1(Encoding.ASCII.GetBytes("secret"))),
                "Exception"
            );
        ...
        public void CheckSignature_WhenDefaultSignatureFormatValidatorIsUsedAndSignatureUsesTruncatedHmac_ReturnsFalse()
        {
            ...
            Assert.That(
                sut.CheckSignature(new HMACSHA256(Encoding.ASCII.GetBytes("secret"))),
                Is.False
            );
        }
...
";
            ...
            Assert.That(
                ex.Message,
                Is.StringContaining("length of the signature").IgnoreCase,
                "Message"
            );
        }
...
";
        ...
        public void ComputeSignature_WhenSignatureMethodIsNotSpecifiedAndRsaSigningKeyIsUsed_UsesRsaSha256Algorithm()
        {
            ...
            Assert.That(
                ...
                Is.EqualTo(SignedXml.XmlDsigRSASHA256Url)
            );
        }
        ...
        public void ComputeSignature_WhenNotSupportedSignatureMethodIsSpecified_ThrowsCryptographicException()
        {
            ...
            Assert.That(
                ex.Message,
                Is.EqualTo(SR.Cryptography_Xml_SignatureDescriptionNotCreated),
                "Message"
            );
        }
        ...
        public void ComputeSignature_WhenNotSupportedSignatureHashAlgorithmIsSpecified_ThrowsCryptographicException()
        {
            ...
            Assert.That(
                ex.Message,
                Is.EqualTo(SR.Cryptography_Xml_CreateHashAlgorithmFailed),
                "Message"
            );
        }
