...
namespace MonoTests.System.Security.Cryptography.Xml
{
    ...
    public class EncryptedXmlTest
    {
        ...
        void AssertDecryption1(string filename)
        {
            ...
            XmlElement el =
                doc.SelectSingleNode("/s:Envelope/s:Header/o:Security/e:EncryptedKey", nm)
                as XmlElement;
        ...
        public void GetIdElement_WhenElementNameMustBeNonColonizedAndItIsNotProvided_ThrowsArgumentNullException(
            string elementName
        )
        {
            ...
            var ex = Assert.Throws<ArgumentNullException>(
                () => sut.GetIdElement(new XmlDocument(), elementName),
                "Exception"
            );
