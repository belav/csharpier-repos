...
namespace MonoTests.System.Security.Cryptography.Xml
{
    ...
    public class XmlDsigExcC14NTransformTest
    {
        ...
        static string xml =
            "<Test  attrib='at ' xmlns=\"http://www.example.com/\" > \r\n &#xD; <Toto/> text &amp; </Test   >";

        // BAD for XmlDocument input (framework 1.0 result)
        static string c14xml1 =
            "<Test xmlns=\"http://www.example.com/\" attrib=\"at \"> \r\n \r <Toto></Toto> text &amp; </Test>";
        ...
        public void ExcC14NSpecExample1()
        {
            ...
            Assert.AreEqual(
                ExcC14NSpecExample1Output,
                res,
                "Example 1 from c14n spec - PIs, Comments, and Outside of Document Element (without comments)"
            );
        }
        ...
        public void ExcC14NSpecExample2()
        {
            ...
            Assert.AreEqual(
                ExcC14NSpecExample2Output,
                res,
                "Example 2 from c14n spec - Whitespace in Document Content (without comments)"
            );
        }
        ...
        public void ExcC14NSpecExample3()
        {
            ...
            Assert.AreEqual(
                ExcC14NSpecExample3Output,
                res,
                "Example 3 from c14n spec - Start and End Tags (without comments)"
            );
        }
        ...
        public void ExcC14NSpecExample4()
        {
            ...
            Assert.AreEqual(
                ExcC14NSpecExample4Output,
                res,
                "Example 4 from c14n spec - Character Modifications and Character References (without comments)"
            );
        }
        ...
        public void ExcC14NSpecExample5()
        {
            ...
            Assert.AreEqual(
                ExcC14NSpecExample5Output,
                res,
                "Example 5 from c14n spec - Entity References (without comments)"
            );
        }
        ...
        public void ExcC14NSpecExample6()
        {
            ...
            Assert.AreEqual(
                ExcC14NSpecExample6Output,
                res,
                "Example 6 from c14n spec - UTF-8 Encoding (without comments)"
            );
        }
