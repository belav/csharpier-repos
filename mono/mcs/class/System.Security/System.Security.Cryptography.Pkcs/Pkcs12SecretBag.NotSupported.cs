...
{
    /// <summary>Represents the SecretBag from PKCS#12, a container whose contents are arbitrary data
    // with a type identifier. This class cannot be inherited.</summary>
    public sealed class Pkcs12SecretBag : Pkcs12SafeBag
    {
        ...
        /// <summary>Gets the Object Identifier (OID) which identifies the data type of the secret
        // value.</summary>
        /// <returns>The Object Identifier (OID) which identifies the data type of the secret
        // value.</returns>
