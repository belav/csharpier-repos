...
partial class SR
{
    ...
    public const string ArrayInitializedStateNotEqual =
        "Object is not an array with the same initialization state as the array to compare it to.";
    public const string ArrayLengthsNotEqual =
