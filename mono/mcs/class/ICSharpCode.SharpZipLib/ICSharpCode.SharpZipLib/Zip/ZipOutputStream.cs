    ...
    public class ZipOutputStream : DeflaterOutputStream
    {
        ...
        public void PutNextEntry(ZipEntry entry)
        {
            ...
            if (headerInfoAvailable == true)
            {
                ...
                WriteLeInt(
                    entry.IsCrypted
                        ? (int)entry.CompressedSize + ZipConstants.CRYPTO_HEADER_SIZE
        ...
        public override void Finish()
        {
            ...
            foreach (ZipEntry entry in entries)
            {
                ...
                byte[] entryComment =
                    entry.Comment != null
                        ? ZipConstants.ConvertToArray(entry.Comment)
                        : new byte[0];
                ...
                ++numEntries;
                sizeEntries +=
                    ZipConstants.CENHDR + name.Length + extra.Length + entryComment.Length;
            }
