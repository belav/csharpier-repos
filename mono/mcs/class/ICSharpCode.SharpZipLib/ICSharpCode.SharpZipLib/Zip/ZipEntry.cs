...
namespace ICSharpCode.SharpZipLib.Zip
{
    ...
    public class ZipEntry : ICloneable
    {
        ...
        public ZipEntry(string name)
            : this(name, 0, ZipConstants.VERSION_MADE_BY) { }
        ...
        internal ZipEntry(string name, int versionRequiredToExtract)
            : this(name, versionRequiredToExtract, ZipConstants.VERSION_MADE_BY) { }
            ...
            get
            {
                ...
                else
                {
                    ...
                    else if (IsCrypted == true)
                    {
                        ...
                        (known & KNOWN_EXTERN_ATTRIBUTES) != 0
        ...
        {
            get { return (this.size > uint.MaxValue) || (this.compressedSize > uint.MaxValue); }
        }
