...
namespace Microsoft.Build.Utilities
{
    internal static class ProcessService
    {
        ...
        public static Dictionary<string, string> GlobalEnvironmentVariblesOverride
        {
            get
            {
                if (globalEnvironmentVariablesOverride == null)
                    globalEnvironmentVariablesOverride = new Dictionary<string, string>(
        ...
        public static ProcessWrapper StartProcess(
            string command,
            string arguments,
        ...
        public static ProcessWrapper StartProcess(
            ...
            string arguments,
            string workingDirectory,
            ProcessEventHandler outputStreamChanged,
            ProcessEventHandler errorStreamChanged
        )
        {
            return StartProcess(
                command,
        ...
        {
            return StartProcess(
                CreateProcessStartInfo(command, arguments, workingDirectory, redirectStandardInput),
                outputStreamChanged,
                errorStreamChanged,
                exited,
                null
        ...
        public static ProcessWrapper StartProcess(
            ...
            TextWriter errorWriter,
            EventHandler exited,
            Dictionary<string, string> environmentOverride
        )
        {
            ProcessEventHandler wout = OutWriter.GetWriteHandler(outWriter);
            ProcessEventHandler werr = OutWriter.GetWriteHandler(errorWriter);
        ...
        public static void ProcessEnvironmentVariableOverrides(
