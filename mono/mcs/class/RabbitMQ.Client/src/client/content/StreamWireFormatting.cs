    ...
    public class StreamWireFormatting
    {
        ...
        public static object ReadNonnullObject(string target, NetworkBinaryReader reader)
        {
            ...
            if (value == null)
            {
                throw new ProtocolViolationException(
                    string.Format("Null {0} value not permitted", target)
                );
            }
            return value;
        }
        ...
        public static object ReadObject(NetworkBinaryReader reader)
        {
            ...
            switch (typeTag)
            {
                    ...
                    switch (value)
                    {
                        ...
                        default:
                        {
                            string message = string.Format(
                                "Invalid boolean value in StreamMessage: {0}",
                                value
                            );
                ...
                {
                    string message = string.Format(
                        "Invalid type tag in StreamMessage: {0}",
                        typeTag
                    );
                    throw new ProtocolViolationException(message);
                }
        ...
        public static void WriteObject(NetworkBinaryWriter writer, object value)
        {
            ...
            {
                WriteBytes(writer, ((BinaryTableValue)value).Bytes);
            }
            ...
            {
                string message = string.Format(
                    "Invalid object in StreamMessage.WriteObject: {0}",
                    value
                );
                throw new ProtocolViolationException(message);
            }
