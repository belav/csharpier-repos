...
namespace RabbitMQ.Client.Framing.Impl.v0_8
{
    public abstract class ProtocolBase : AbstractProtocolBase
    {
        ...
        {
            request = new Command(
                new RabbitMQ.Client.Framing.Impl.v0_8.ConnectionClose(reasonCode, reasonText, 0, 0)
            );
        ...
        {
            request = new Command(
                new RabbitMQ.Client.Framing.Impl.v0_8.ChannelClose(reasonCode, reasonText, 0, 0)
            );
