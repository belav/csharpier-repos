...
namespace DHIWebService
{
    ...
    [System.ServiceModel.ServiceContractAttribute(
        Namespace = "IBEWebSvc",
        ConfigurationName = "DHIWebService.IDHIService"
    )]
    public interface IDHIService
    {
        [System.ServiceModel.OperationContractAttribute(
            AsyncPattern = true,
            Action = "IBEWebSvc/IDHIService/Login",
            ReplyAction = "IBEWebSvc/IDHIService/LoginResponse"
        )]
    ...
    public partial class LoginRequest
    {
        ...
        public LoginRequest(
            DHIWebService.ClientLoginData clientLoginData,
            DHIWebService.Login credentials
        )
        {
            ...
            DHIWebService.IDHIService
    {
        ...
        System.IAsyncResult DHIWebService.IDHIService.BeginLogin(
            DHIWebService.LoginRequest request,
            System.AsyncCallback callback,
            object asyncState
        )
        ...
        private System.IAsyncResult OnBeginLogin(
            object[] inValues,
            System.AsyncCallback callback,
            object asyncState
        )
        ...
        {
            DHIWebService.LoginResponse retVal = ((DHIWebService.IDHIService)(this)).EndLogin(
                result
            );
        ...
        private void OnLoginCompleted(object state)
        {
            if ((this.LoginCompleted != null))
            {
                ...
                this.LoginCompleted(
                    this,
                    new LoginCompletedEventArgs(e.Results, e.Error, e.Cancelled, e.UserState)
                );
            }
        }
        ...
        public void LoginAsync(DHIWebService.LoginRequest request, object userState)
        {
            ...
            {
                this.onLoginCompletedDelegate = new System.Threading.SendOrPostCallback(
                    this.OnLoginCompleted
                );
            }
            base.InvokeAsync(
                this.onBeginLoginDelegate,
                new object[] { request },
                this.onEndLoginDelegate,
                this.onLoginCompletedDelegate,
                userState
            );
        }
        ...
        DHIWebService.LoginResponse DHIWebService.IDHIService.Login(
            DHIWebService.LoginRequest request
        )
        {
