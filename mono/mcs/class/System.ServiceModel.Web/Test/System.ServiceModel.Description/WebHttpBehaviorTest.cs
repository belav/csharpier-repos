...
namespace MonoTests.System.ServiceModel.Description
{
    ...
    {
        public IClientMessageFormatter DoGetReplyClientFormatter(
        ...
        public IClientMessageFormatter DoGetRequestClientFormatter(
            OperationDescription operationDescription,
            ServiceEndpoint endpoint
        )
        {
...
#if !MOBILE
        public IDispatchMessageFormatter DoGetReplyDispatchFormatter(
            OperationDescription operationDescription,
            ServiceEndpoint endpoint
        )
        {
        ...
        public IDispatchMessageFormatter DoGetRequestDispatchFormatter(
            OperationDescription operationDescription,
            ServiceEndpoint endpoint
        )
        {
    ...
    public class WebHttpBehaviorTest
    {
        ...
        public void ApplyDispatchBehavior()
        {
            ...
            IChannelListener l = new WebHttpBinding().BuildChannelListener<IReplyChannel>(
            ...
            Assert.AreEqual(
                ...
                ed.DispatchRuntime.OperationSelector.GetType(),
                "#2-2"
            );
        ...
        public void TestWebGetExists()
        {
            ...
            Assert.IsTrue(
                od.Behaviors.Contains(typeof(WebGetAttribute)),
                "Operation is recognized as WebGet"
            );
        }
