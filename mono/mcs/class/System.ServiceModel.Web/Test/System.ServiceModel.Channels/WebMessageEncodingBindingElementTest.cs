...
using System;using System.IO;using System.ServiceModel;using System.ServiceModel.Channels;using System.Text;using NUnit.Framework;
...
namespace MonoTests.System.ServiceModel
{
    ...
    public class WebMessageEncodingBindingElementTest
    {
        ...
        public void MessageEncoderWriteMessageXml()
        {
            ...
            Assert.AreEqual(
                "<int xmlns=\"http://schemas.microsoft.com/2003/10/Serialization/\">135</int>",
        ...
        BindingContext CreateBindingContext()
        {
            return new BindingContext(
                new CustomBinding(new HttpTransportBindingElement() { AllowCookies = true }),
        ...
        public void CanBuildChannelFactory()
        {
            ...
            Assert.IsFalse(
                m.CanBuildChannelFactory<IRequestSessionChannel>(CreateBindingContext2()),
                "#11"
            );
            Assert.IsFalse(
            ...
            Assert.IsFalse(
                t.CanBuildChannelFactory<IRequestSessionChannel>(CreateBindingContext2()),
                "#15"
            );
            Assert.IsFalse(
        ...
        public void CanBuildChannelListener()
        {
            ...
            var m = new WebMessageEncodingBindingElement();
            Assert.IsFalse(
                m.CanBuildChannelListener<IRequestChannel>(CreateBindingContext()),
                "#1"
            );
            Assert.IsTrue(m.CanBuildChannelListener<IReplyChannel>(CreateBindingContext()), "#2");
            Assert.IsFalse(
                m.CanBuildChannelListener<IRequestSessionChannel>(CreateBindingContext()),
                "#3"
            );
            ...
            var h = new HttpTransportBindingElement();
            Assert.IsFalse(
                h.CanBuildChannelListener<IRequestChannel>(CreateBindingContext()),
                "#5"
            );
            Assert.IsTrue(h.CanBuildChannelListener<IReplyChannel>(CreateBindingContext()), "#6");
            Assert.IsFalse(
                h.CanBuildChannelListener<IRequestSessionChannel>(CreateBindingContext()),
                "#7"
            );
            ...
            // with TcpTransport
            Assert.IsFalse(
                m.CanBuildChannelListener<IRequestChannel>(CreateBindingContext2()),
                "#9"
            );
            Assert.IsFalse(
                m.CanBuildChannelListener<IReplyChannel>(CreateBindingContext2()),
                "#10"
            );
            Assert.IsFalse(
                m.CanBuildChannelListener<IRequestSessionChannel>(CreateBindingContext2()),
                "#11"
            );
            Assert.IsFalse(
                m.CanBuildChannelListener<IDuplexChannel>(CreateBindingContext2()),
                "#12"
            );
            ...
            var t = new TcpTransportBindingElement();
            Assert.IsFalse(
                t.CanBuildChannelListener<IRequestChannel>(CreateBindingContext2()),
                "#13"
            );
            Assert.IsFalse(
                t.CanBuildChannelListener<IReplyChannel>(CreateBindingContext2()),
                "#14"
            );
            Assert.IsFalse(
                t.CanBuildChannelListener<IRequestSessionChannel>(CreateBindingContext2()),
                "#15"
            );
            Assert.IsFalse(
                t.CanBuildChannelListener<IDuplexChannel>(CreateBindingContext2()),
                "#16"
            );
        }
        ...
        public void BuildChannelFactory()
        {
            ...
            Assert.AreEqual(
                ...
                new HttpTransportBindingElement()
                    .BuildChannelFactory<IRequestChannel>(CreateBindingContext())
                    .GetType(),
                "#1"
            );
        }
