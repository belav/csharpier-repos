    ...
    public sealed class ILTables
    {
        ...
        public static Hashtable Directives
        {
            get
            {
                ...
                directives[".publickeytoken"] = new ILToken(
        ...
        public static Hashtable Keywords
        {
            get
            {
                ...
                keywords["streamed_object"] = new ILToken(
                ...
                keywords["callmostderived"] = new ILToken(
                ...
                keywords["noncaslinkdemand"] = new ILToken(
                    Token.K_NONCASLINKDEMAND,
                    "noncaslinkdemand"
                );
                keywords["noncasinheritance"] = new ILToken(
                ...
                keywords["enablejittracking"] = new ILToken(
                    Token.K_ENABLEJITTRACKING,
                    "enablejittracking"
                );
                keywords["disablejitoptimizer"] = new ILToken(
                ...
                keywords["beforefieldinit"] = new ILToken(
                ...
                keywords["compilercontrolled"] = new ILToken(
                ...
                keywords["auto"] = new ILToken(Token.K_AUTO, "auto");
                keywords["aggressiveinlining"] = new ILToken(
                    Token.K_AGGRESSIVEINLINING,
                    "aggressiveinlining"
                );
