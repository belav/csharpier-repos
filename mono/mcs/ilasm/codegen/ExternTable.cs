...
namespace Mono.ILASM
{
    ...
    public class ExternModule : ExternRef
    {
        ...
        public ExternModule(string name)
            : base(name) { }
    ...
    public class ExternAssembly : ExternRef, IDeclSecurityTarget
    {
        ...
        public ExternAssembly(string name, AssemblyName asmb_name, PEAPI.AssemAttr attr)
            : base(name)
        {
            this.name = name;
    ...
    public class ExternTable
    {
        ...
        public ExternTypeRef GetTypeRef(string asmb_name, string full_name, bool is_valuetype)
        {
            ...
            if (assembly_table == null && (asmb_name == "mscorlib" || asmb_name == "corlib"))
            {
                ...
                Report.Warning(
                    String.Format(
                        "Reference to undeclared extern assembly '{0}', adding.",
                        asmb_name
                    )
                );
                AddCorlib();
        ...
        public static void GetNameAndNamespace(
            string full_name,
            out string name_space,
            out string name
        )
        {
