...
namespace Mono.ILASM
{
    public class GlobalMethodRef : BaseMethodRef
    {
        ...
        public override void Resolve(CodeGen code_gen)
        {
            ...
            {
                string sig = MethodDef.CreateSignature(
                    ret_type,
                    call_conv,
                    name,
                    param,
            ...
            else
            {
                ...
                string sig_only_required_params = MethodDef.CreateSignature(
                    ret_type,
                    call_conv,
                    name,
                    param,
                ...
                string sig_with_optional_params = MethodDef.CreateSignature(
                    ret_type,
                    call_conv,
                    name,
                    param,
                ...
                peapi_method = code_gen.ResolveVarargMethod(
