...
namespace Mono.ILASM
{
    ...
    public class ParamDef : ICustomAttrTarget
    {
        ...
        public static readonly ParamDef Ellipsis = new ParamDef(
            new PEAPI.ParamAttr(),
            "ELLIPSIS",
            null
        );

        public ParamDef(PEAPI.ParamAttr attr, string name, BaseTypeRef typeref)
        {
            this.attr = attr;
            this.name = name;
        ...
        public void Define(CodeGen code_gen)
        {
            ...
            peapi_param = new PEAPI.Param(attr, name, typeref.PeapiType);
            if (defval != null)
            {
