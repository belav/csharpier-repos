...
namespace Mono.ILASM
{
    ...
    public class PeapiTypeRef
    {
        ...
        public void MakeBoundArray(ArrayList bound_list)
        {
            ...
            peapi_type = new PEAPI.BoundArray(peapi_type, (uint)dimen, lobounds, sizes);
        ...
        PEAPI.Type GetType(CodeGen code_gen, PEAPI.CustomModifier modifier, BaseTypeRef klass)
        {
            ...
            return new PEAPI.CustomModifiedType(
                peapi_type,
                modifier,
                code_gen.PEFile.AddPrimitiveType((PEAPI.PrimitiveType)pt.PeapiType)
            );
