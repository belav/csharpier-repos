...
/* if (!value) error: unsetting entrypoint ? */
        ...
        public GlobalMethodRef GetGlobalMethodRef(
...
namespace also */
        ...
        public void BeginMethodDef(MethodDef methoddef)
        {
            ...
            {
                global_method_table.Add(methoddef.Signature, methoddef);
            }
        ...
        {
            current_customattrtarget = current_assemblyref = ExternTable.AddAssembly(
                name,
                asmb_name,
                attr
            );
        ...
        public void Write()
        {
            ...
            try
            {
                ...
                pefile = new PEFile(
                    ThisAssembly != null ? ThisAssembly.Name : null,
                    ThisModule.Name,
                    is_dll,
                    ThisAssembly != null,
                    null,
        ...
        public PEAPI.Method ResolveVarargMethod(
            string sig_only_required_params,
        ...
        public PEAPI.Field ResolveField(string name, string type_name)
        {
            ...
            if (fielddef == null)
                Report.Error(
                    String.Format("Unable to resolve global field : {0} {1}", type_name, name)
                );
        ...
        {
            if (current_namespace == null || current_namespace == String.Empty)
                return name;
