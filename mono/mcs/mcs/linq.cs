...
namespace Mono.CSharp.Linq
{
    public class QueryExpression : AQueryClause
    {
        ...
        public override Expression BuildQueryClause(
            ResolveContext ec,
            Expression lSide,
    ...
    public abstract class AQueryClause : ShimExpression
    {
        ...
        protected class QueryExpressionInvocation : Invocation, OverloadResolver.IErrorHandler
        {
            ...
            protected override MethodGroupExpr DoResolveOverload(ResolveContext rc)
            {
                ...
                {
                    return mg.OverloadResolve(
                        rc,
                        ref arguments,
                        this,
                        OverloadResolver.Restrictions.None
                    );
                }
            }
            ...
            bool OverloadResolver.IErrorHandler.TypeInferenceFailed(
                ResolveContext rc,
                MemberSpec best
            )
            {
                ...
                if (source_type != null)
                {
                    ...
                    if (
                        TypeManager.IsGenericType(source_type)
                        && InflatedTypeSpec.ContainsTypeParameter(source_type)
                    )
                    {
                        TypeInferenceContext tic = new TypeInferenceContext(
                            source_type.TypeArguments
                        );
                        ...
                        if (tic.FixAllTypes(rc))
                        {
                            source_type = source_type
                                .GetDefinition()
                                .MakeGenericType(rc, tic.InferredTypeArguments);
                        }
                    }
        ...
        public virtual Expression BuildQueryClause(
            ResolveContext ec,
            Expression lSide,
            Parameter parameter
        )
        ...
        protected Invocation CreateQueryExpression(Expression lSide, Arguments arguments)
        {
            return new QueryExpressionInvocation(
                new QueryExpressionAccess(lSide, MethodName, loc),
                arguments
            );
        }
    ...
    public abstract class ARangeVariableQueryClause : AQueryClause
    {
        ...
        protected ARangeVariableQueryClause(
            QueryBlock block,
        ...
        {
            return new QueryExpressionInvocation(
                new QueryExpressionAccess(lSide, "Cast", new TypeArguments(IdentifierType), loc),
                null
            );
        }
        ...
        )
        {
            ...
            args.Add(
                new AnonymousTypeParameter(
                    new RangeParameterReference(parameter),
                    parameter.Name,
                    parameter.Location
                )
            );
            ...
            return new NewAnonymousType(
                args,
                rc.MemberContext.CurrentMemberDefinition.Parent,
                name.Location
            );
        }
    ...
    public class QueryStartClause : ARangeVariableQueryClause
    {
        ...
        )
        {
            ...
            return next.BuildQueryClause(
                ec,
                lSide,
                new ImplicitLambdaParameter(identifier.Name, identifier.Location)
            );
        }
    ...
    public class GroupBy : AQueryClause
    {
        ...
        {
            get { return element_selector; }
        }

        protected override void CreateArguments(
            ResolveContext ec,
            Parameter parameter,
            ref Arguments args
        )
    ...
    public class SelectMany : ARangeVariableQueryClause
    {
        ...
        )
        {
            ...
            {
                result_selector_expr = CreateRangeVariableType(
                    ec,
                    parameter,
                    target,
                    new SimpleName(target.Name, target.Location)
                );
    ...
    public class QueryBlock : ParametersBlock
    {
        ...
        public override void Error_AlreadyDeclared(
            string name,
        ...
        public void SetParameter(Parameter parameter)
        {
            ...
            base.parameter_info = new ParameterInfo[] { new ParameterInfo(this, 0) };
        }
