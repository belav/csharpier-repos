...
namespace Mono.CSharp
{
    ...
    public class Delegate : TypeDefinition, IParametersMember
    {
            ...
            : base(parent, name, attrs, MemberKind.Delegate)
        {
            ...
            ModFlags = ModifiersExtensions.Check(
                AllowedModifiers,
                mod_flags,
                IsTopLevel ? Modifiers.INTERNAL : Modifiers.PRIVATE,
                name.Location,
                Report
            );
        ...
        {
            get { return AttributeTargets.Delegate; }
        }
        ...
        ReturnParameter CreateReturnBuilder()
        {
            return return_attributes
                ?? (
                    return_attributes = new ReturnParameter(
                        this,
                        InvokeBuilder.MethodBuilder,
                        Location
                    )
                );
        }
        ...
        protected override bool DoDefineMembers()
        {
            ...
            var ctor_parameters = ParametersCompiled.CreateFullyResolved(
                ...
                {
                    new Parameter(
                        new TypeExpression(builtin_types.Object, Location),
                        "object",
                    ...
                    new Parameter(
                        new TypeExpression(builtin_types.IntPtr, Location),
                        "method",
                        Parameter.Modifier.NONE,
                        null,
                        Location
                ...
                new[] { builtin_types.Object, builtin_types.IntPtr }
            );
        ...
        void DefineAsyncMethods(TypeExpression returnType)
        {
            ...
            else
            {
                ...
                {
                    var p = parameters[i];
                    compiled[i] = new Parameter(
                        new TypeExpression(parameters.Types[i], Location),
                        p.Name,
                        p.ModFlags & Parameter.Modifier.RefOutMask,
                        p.OptAttributes == null ? null : p.OptAttributes.Clone(),
                        Location
                    );
                }
            ...
            async_parameters = ParametersCompiled.MergeGenerated(
                Compiler,
                async_parameters,
                false,
                new Parameter[]
                {
                    new Parameter(
                        new TypeExpression(async_callback.TypeSpec, Location),
                        "callback",
                        Parameter.Modifier.NONE,
                        null,
                        Location
                ...
                new[] { async_callback.TypeSpec, Compiler.BuiltinTypes.Object }
            );

            BeginInvokeBuilder = new Method(
                this,
                new TypeExpression(iasync_result.TypeSpec, Location),
                MethodModifiers,
                new MemberName("BeginInvoke"),
                async_parameters,
                null
            );
            ...
            if (out_params > 0)
            {
                ...
                for (int i = 0; i < Parameters.FixedParameters.Length; ++i)
                {
                    ...
                    end_params[param++] = new Parameter(
                        new TypeExpression(p.Type, Location),
                        p.Name,
                        p.ModFlags & Parameter.Modifier.RefOutMask,
                        p.OptAttributes == null ? null : p.OptAttributes.Clone(),
                        Location
            ...
            end_parameters = ParametersCompiled.MergeGenerated(
                Compiler,
                end_parameters,
                false,
                new Parameter(
            ...
            //
            EndInvokeBuilder = new Method(
                this,
                returnType,
                MethodModifiers,
                new MemberName("EndInvoke"),
                end_parameters,
                null
            );
        ...
        {
            var ctor = MemberCache.FindMember(
                delType,
        ...
        {
            var invoke = MemberCache.FindMember(
                delType,
        ...
        {
            get { return instance_expr; }
            set { instance_expr = value; }
        }
    }
    ...
    public abstract class DelegateCreation : Expression, OverloadResolver.IErrorHandler
    {
        ...
        public static Arguments CreateDelegateMethodArguments(
            ResolveContext rc,
        ...
        )
        {
            ...
            for (int i = 0; i < pd.Count; ++i)
            {
                ...
                delegate_arguments.Add(
                    new Argument(new TypeExpression(ptype, loc), atype_modifier)
                );
            }
        ...
        public override Expression CreateExpressionTree(ResolveContext ec)
        {
            ...
            else
            {
                ma = new MemberAccess(
                    new MemberAccess(
                        new QualifiedAliasMember("global", "System", loc),
                        "Delegate",
                        loc
                    ),
                    "CreateDelegate",
        ...
        void ResolveConditionalAccessReceiver(ResolveContext rc)
        {
            ...
            if (
                ...
                && method_group.HasConditionalAccess()
            )
            {
        ...
        protected override Expression DoResolve(ResolveContext ec)
        {
            ...
            Arguments arguments = CreateDelegateMethodArguments(
                ec,
                invoke_method.Parameters,
                invoke_method.Parameters.Types,
                loc
            );
            ...
            if (
                expr != null
                && (expr.Type.IsGenericParameter || !TypeSpec.IsReferenceType(expr.Type))
            )
            {
        ...
        public override void Emit(EmitContext ec)
        {
            ...
            if (
                !delegate_method.DeclaringType.IsDelegate
                && delegate_method.IsVirtual
                && !method_group.IsBase
            )
            {
                ec.Emit(OpCodes.Dup);
        ...
        void Error_ConversionFailed(ResolveContext ec, MethodSpec method, TypeSpec return_type)
        {
            var invoke_method = Delegate.GetInvokeMethod(type);
            string member_name =
                method_group.InstanceExpression != null
        ...
        bool OverloadResolver.IErrorHandler.ArgumentMismatch(
            ResolveContext rc,
            MemberSpec best,
            Argument arg,
            int index
    ...
    public class ImplicitDelegateCreation : DelegateCreation
    {
        ...
        protected override Expression DoResolve(ResolveContext ec)
        {
            ...
            mg_cache = new Field(
                parent,
                new TypeExpression(type, loc),
                Modifiers.STATIC | Modifiers.PRIVATE | Modifiers.COMPILER_GENERATED,
                new MemberName(CompilerGeneratedContainer.MakeName(null, "f", "mg$cache", id), loc),
                null
            );
            mg_cache.Define();
    ...
    class DelegateInvocation : ExpressionStatement
    {
        ...
        public override bool ContainsEmitWithAwait()
        {
            return InstanceExpr.ContainsEmitWithAwait()
                || (arguments != null && arguments.ContainsEmitWithAwait());
        }
        ...
        protected override Expression DoResolve(ResolveContext ec)
        {
            ...
            var res = new OverloadResolver(
                new MemberSpec[] { method },
                OverloadResolver.Restrictions.DelegateInvoke,
                loc
            );
        ...
        public override void Emit(EmitContext ec)
        {
            ...
            if (conditionalAccessReceiver)
                ec.CloseConditionalAccess(
                    type.IsNullableType && type != method.ReturnType ? type : null
                );
        }
