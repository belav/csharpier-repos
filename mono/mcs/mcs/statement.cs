...
namespace Mono.CSharp
{
    ...
    public abstract class ExitStatement : Statement
    {
        ...
        public override bool Resolve(BlockContext bc)
        {
            ...
            unwind_protect = bc.HasAny(
                ResolveContext.Options.TryScope | ResolveContext.Options.CatchScope
            );
            return res;
        }
    ...
    public class Return : ExitStatement
    {
        ...
        protected override bool DoResolve(BlockContext ec)
        {
            ...
            {
                if (
                    block_return_type.Kind == MemberKind.Void
                    || block_return_type == InternalType.ErrorType
                )
                    return true;
                ...
                if (ec.CurrentAnonymousMethod is AsyncInitializer)
                {
                    ...
                    if (
                        s_return_type.IsGenericTask
                        || (s_return_type.Arity == 1 && s_return_type.IsCustomTaskType())
                    )
            ...
            else
            {
                ...
                if (async_block != null)
                {
                    if (expr != null)
                    {
                        ...
                        //
                        if (
                            expr.Type == async_type
                            && async_type.TypeArguments[0]
            ...
            if (expr != null)
            {
                ...
                if (async_body != null)
                {
                    ...
                    if (storey.HoistedReturnValue != null)
                    {
                        ...
                        {
                            exit_label = TryFinally.EmitRedirectedReturn(
                                ec,
                                async_body,
                                unwind_protect
                            );
    ...
    public class GotoDefault : SwitchGoto
    {
        ...
        {
            ec.Emit(
                unwind_protect ? OpCodes.Leave : OpCodes.Br,
                ec.Switch.DefaultLabel.GetILLabel(ec)
            );
        }
    ...
    public class Break : LocalExitStatement
    {
        ...
        protected override void DoEmit(EmitContext ec)
        {
            ...
            {
                var async_body = (AsyncInitializer)ec.CurrentAnonymousMethod;
                l = TryFinally.EmitRedirectedJump(
                    ec,
                    async_body,
                    l,
                    enclosing_loop.Statement as Block,
                    unwind_protect
                );
            }
    ...
    public class BlockVariable : Statement
    {
        ...
        static void CreateEvaluatorVariable(BlockContext bc, LocalVariable li)
        {
            ...
            Field f = new Field(
                container,
                new TypeExpression(li.Type, li.Location),
                Modifiers.PUBLIC | Modifiers.STATIC,
                new MemberName(li.Name, li.Location),
                null
            );
        ...
        public bool Resolve(BlockContext bc, bool resolveDeclaratorInitializers)
        {
            ...
            bool eval_global =
                bc.Module.Compiler.Settings.StatementMode && bc.CurrentBlock is ToplevelBlock;
            if (eval_global)
            {
        ...
        protected virtual Expression ResolveInitializer(
            BlockContext bc,
            LocalVariable li,
            Expression initializer
        )
        {
            var a = new SimpleAssign(
                li.CreateReferenceExpression(bc, li.Location),
                initializer,
                li.Location
            );
    ...
    public class BlockConstant : BlockVariable
    {
        ...
        protected override Expression ResolveInitializer(
            BlockContext bc,
            LocalVariable li,
            Expression initializer
        )
        {
            ...
            if (c == null)
            {
                if (TypeSpec.IsReferenceType(li.Type))
                    initializer.Error_ConstantCanBeInitializedWithNullOnly(
                        bc,
                        li.Type,
    ...
    public sealed class LocalVariable : INamedBlockVariable, ILocalVariable
    {
        ...
        {
            get { return const_value; }
            set { const_value = value; }
        }
        ...
        {
            get { return (flags & Flags.Constant) != 0; }
        }

        public bool IsLocked
        {
            get { return (flags & Flags.IsLocked) != 0; }
            set { flags = value ? flags | Flags.IsLocked : flags & ~Flags.IsLocked; }
        }
        ...
        public bool IsFixed
        {
            get { return (flags & Flags.FixedVariable) == Flags.FixedVariable; }
            set { flags = value ? flags | Flags.FixedVariable : flags & ~Flags.FixedVariable; }
        }
        ...
        {
            get { return (flags & Flags.ReadonlyMask) != 0; }
        }
        ...
        public void CreateBuilder(EmitContext ec)
        {
            if ((flags & Flags.Used) == 0)
            {
                if (VariableInfo == null)
                {
                    ...
                    throw new InternalErrorException(
                        "VariableInfo is null and the variable `{0}' is not used",
                        name
                    );
                }
            ...
            {
                builder = ec.DeclareLocal(
                    ReferenceContainer.MakeType(ec.Module, ((PointerContainer)Type).Element),
                    IsFixed
                );
            }
            else
        ...
        public static LocalVariable CreateCompilerGenerated(
            TypeSpec type,
            Block block,
            Location loc,
            bool writeToSymbolFile = false,
            Flags additionalFlags = 0
        )
        {
            LocalVariable li = new LocalVariable(
                block,
                GetCompilerGeneratedName(block),
                Flags.CompilerGenerated | Flags.Used | additionalFlags,
                loc
            );
    ...
    public class Block : Statement
    {
        ...
        {
            get { return (flags & Flags.CatchBlock) != 0; }
        }

        public bool IsFinallyBlock
        {
            get { return (flags & Flags.FinallyBlock) != 0; }
        }
        ...
        public virtual void AddLocalName(
            string name,
            INamedBlockVariable li,
            bool canShadowChildrenBlockName = false
        )
        {
            ParametersBlock.TopBlock.AddLocalName(name, li, canShadowChildrenBlockName);
        }

        public virtual void Error_AlreadyDeclared(
            string name,
        ...
        public override bool Resolve(BlockContext bc)
        {
            ...
            {
                for (
                    resolving_init_idx = 0;
                    resolving_init_idx < scope_initializers.Count;
                    ++resolving_init_idx
                )
                {
        ...
        protected override void CloneTo(CloneContext clonectx, Statement t)
        {
            ...
            target.ParametersBlock = (ParametersBlock)(
                ParametersBlock == this ? target : clonectx.RemapBlockCopy(ParametersBlock)
            );
            target.Explicit = (ExplicitBlock)(
                Explicit == this ? target : clonectx.LookupBlock(Explicit)
            );
    ...
    public class ExplicitBlock : Block
    {
        ...
        {
            get { return (flags & Flags.AwaitBlock) != 0; }
        }
        ...
        public bool HasCapturedVariable
        {
            ...
            {
                flags = value
                    ? flags | Flags.HasCapturedVariable
                    : flags & ~Flags.HasCapturedVariable;
            }
        ...
        {
            get { return (flags & Flags.ReachableEnd) != 0; }
            set { flags = value ? flags | Flags.ReachableEnd : flags & ~Flags.ReachableEnd; }
        }
        ...
        public AnonymousMethodStorey CreateAnonymousMethodStorey(ResolveContext ec)
        {
            ...
            if (
                ...
                && ParametersBlock.Original == ec.CurrentAnonymousMethod.Block.Original
            )
            ...
            if (am_storey == null)
            {
                ...
                //
                am_storey = new AnonymousMethodStorey(
                    this,
                    ec.CurrentMemberDefinition.Parent.PartialContainer,
                    mc,
        ...
        protected void DefineStoreyContainer(EmitContext ec, AnonymousMethodStorey storey)
        {
            ...
            if (
                Original.Explicit.HasCapturedThis
                && Original.ParametersBlock.TopBlock.ThisReferencesFromChildrenBlock != null
            )
            {
                //
                ...
                for (Block b = Original.Explicit; b != null; b = b.Parent)
                {
                    ...
                    if (
                        b.Explicit == b.Explicit.ParametersBlock
                        && b.Explicit.ParametersBlock.StateMachine != null
                    )
                    {
                        if (storey.HoistedThis == null)
                            storey.HoistedThis = b.Explicit
                                .ParametersBlock
                                .StateMachine
                                .HoistedThis;
                ...
                if (storey.HoistedThis == null || !(storey.Parent is HoistedStoreyClass))
                {
                    ...
                    )
                    {
                        ...
                        for (
                            ;
                            block_on_path != null && block_on_path != Original;
                            block_on_path = block_on_path.Parent
                        )
                            ;
                        ...
                        for (
                            ExplicitBlock b = ref_block;
                            b.AnonymousMethodStorey != storey;
                            b = b.Parent.Explicit
                        )
                        {
                            ParametersBlock pb;
                            ...
                            if (b_storey != null)
                            {
                                ...
                                if (b.ParametersBlock.StateMachine == null)
                                {
                                    ...
                                    for (
                                        Block ab = b.AnonymousMethodStorey
                                            .OriginalSourceBlock
                                            .Parent;
                                        ab != null;
                                        ab = ab.Parent
                                    ...
                                    {
                                        var parent =
                                            storey == null || storey.Kind == MemberKind.Struct
                                                ? null
                                                : storey;
                            ...
                            if (pb != null && pb.StateMachine != null)
                            {
                                ...
                                while (parent_this_block.Parent != null)
                                {
                                    ...
                                    if (
                                        parent_this_block.StateMachine != null
                                        && parent_this_block.StateMachine.HoistedThis != null
                                    )
                                    {
                                        break;
                                    }
    ...
    public class ParametersBlock : ExplicitBlock
    {
        ...
        {
            get { return (flags & Flags.HasReferenceToStoreyForInstanceLambdas) != 0; }
            set
            {
                flags = value
                    ? flags | Flags.HasReferenceToStoreyForInstanceLambdas
                    : flags & ~Flags.HasReferenceToStoreyForInstanceLambdas;
            }
        }
        ...
        public bool IsAsync
        {
            get { return (flags & Flags.HasAsyncModifier) != 0; }
            set
            {
        ...
        {
            get { return top_block; }
            set { top_block = value; }
        }

        public bool Resolved
        {
            get { return (flags & Flags.Resolved) != 0; }
        }
                            ...
                            foreach (var lentry in list)
                            {
                                list_clone.Add(
                                    RemapLabeledStatement(
                                        lentry,
                                        clonectx.RemapBlockCopy(lentry.Block)
                                    )
                                );
                            }
        ...
        public override bool Resolve(BlockContext bc)
        {
            ...
            catch (Exception e)
            {
                if (
                    ...
                    || bc.Report.IsDisabled
                    || e is FatalException
                    || bc.Report.Printer is NullReportPrinter
                    || bc.Module.Compiler.Settings.BreakOnInternalError
                )
                    throw;
            ...
            if (IsAsync)
            {
                ...
                if (
                    ...
                    && !am.ReturnTypeInference.HasBounds(0)
                )
                {
                    am.ReturnTypeInference = null;
        ...
        public ToplevelBlock ConvertToIterator(
            IMethodData method,
            TypeDefinition host,
        ...
        public ParametersBlock ConvertToAsyncTask(
    ...
    public class ToplevelBlock : ParametersBlock
    {
        ...
        {
            get { return (flags & Flags.Iterator) != 0; }
            set { flags = value ? flags | Flags.Iterator : flags & ~Flags.Iterator; }
        }
        ...
        public void AddThisVariable(BlockContext bc)
        {
            ...
            this_variable = new LocalVariable(
                this,
                "this",
                LocalVariable.Flags.IsThis | LocalVariable.Flags.Used,
                StartLocation
            );
    ...
    public class Switch : LoopStatement
    {
        ...
        {
            get { return new_expr == null && SwitchType != null; }
        }

        public List<SwitchLabel> RegisteredLabels
        {
            get { return case_labels; }
        }
        ...
        void EmitTableSwitch(EmitContext ec, Expression val)
        {
            if (labels != null && labels.Count > 0)
            {
                ...
                TypeSpec compare_type = SwitchType.IsEnum
                    ? EnumSpec.GetUnderlyingType(SwitchType)
                    : SwitchType;
                ...
                for (int range_index = ranges.Count - 1; range_index >= 0; --range_index)
                {
                    ...
                    else
                    {
                        ...
                        if (
                            compare_type.BuiltinType == BuiltinTypeSpec.Type.Long
                            || compare_type.BuiltinType == BuiltinTypeSpec.Type.ULong
                        )
                        {
        ...
        public override bool Resolve(BlockContext ec)
        {
            ...
            else
            {
                ...
                if (
                    SwitchType.BuiltinType == BuiltinTypeSpec.Type.Bool
            ...
            if (
                constant == null
                && SwitchType.BuiltinType == BuiltinTypeSpec.Type.String
                && string_labels.Count > 6
            )
            {
        ...
        public override Reachability MarkReachable(Reachability rc)
        {
            ...
            for (int i = 0; i < block.Statements.Count; ++i)
            {
                ...
                if (sl != null && sl.SectionStart)
                {
                    ...
                    if (section_rc.IsUnreachable)
                    {
                        ...
                        //
                        section_rc =
                            constant_label != null && constant_label != sl
            ...
            if (!section_rc.IsUnreachable && prev_label != null)
            {
                ...
                var s = new MissingBreak(prev_label) { FallOut = true };
        ...
        void ResolveStringSwitchMap(ResolveContext ec)
        {
            ...
            {
                string_dictionary_type = new TypeExpression(
                    ec.Module.PredefinedTypes.Hashtable.TypeSpec,
                    loc
                );
            }
            else
            ...
            Field field = new Field(
                ...
                new MemberName(
                    CompilerGeneratedContainer.MakeName(
                        null,
                        "f",
                        "switch$map",
                        ec.Module.CounterSwitchTypes++
                    ),
                    loc
                ),
                null
            ...
            Expression initializer = new NewInitialize(
                string_dictionary_type,
                args,
                new CollectionOrObjectInitializers(init, loc),
                loc
            );
        ...
        void DoEmitStringSwitch(EmitContext ec)
        {
            ...
            if (switch_cache_field.Type.IsGeneric)
            {
                ...
                Expression get_item = new Invocation(
                    new MemberAccess(switch_cache_field, "TryGetValue", loc),
                    get_value_args
                ).Resolve(rc);
                if (get_item == null)
                    return;
            ...
            else
            {
                ...
                Expression get_item = new ElementAccess(
                    switch_cache_field,
                    get_value_args,
                    loc
                ).Resolve(rc);
                ...
                ExpressionStatement get_item_int = (ExpressionStatement)
                    new SimpleAssign(
                        string_switch_variable,
                        new Cast(new TypeExpression(ec.BuiltinTypes.Int, loc), get_item_object, loc)
                    ).Resolve(rc);
        ...
        void EmitShortSwitch(EmitContext ec)
        {
            ...
            for (int i = 0; i < case_labels.Count; ++i)
            {
                ...
                if (
                    constant.IsZeroInteger
                    && constant.Type.BuiltinType != BuiltinTypeSpec.Type.Long
                    && constant.Type.BuiltinType != BuiltinTypeSpec.Type.ULong
                )
                {
    ...
    public abstract class ResumableStatement : Statement
    {
        ...
        public virtual void EmitForDispose(
            EmitContext ec,
            LocalBuilder pc,
            Label end,
    ...
    public abstract class TryFinallyBlock : ExceptionStatement
    {
        ...
        public override void EmitForDispose(
            EmitContext ec,
            LocalBuilder pc,
            Label end,
            bool have_dispatcher
    ...
    public abstract class ExceptionStatement : ResumableStatement
    {
        ...
        protected virtual void EmitTryBodyPrepare(EmitContext ec)
        {
            ...
            if (resume_points != null && first_catch_resume_pc != 0)
            {
                ...
                var labels = new Label[
                    first_catch_resume_pc > 0 ? first_catch_resume_pc : resume_points.Count
                ];
                for (int i = 0; i < labels.Length; ++i)
        ...
        public int AddResumePoint(
            ResumableStatement stmt,
            int pc,
    ...
    public class Lock : TryFinallyBlock
    {
        ...
        public override bool Resolve(BlockContext ec)
        {
            ...
            {
                expr = Convert.ImplicitTypeParameterConversion(
                    expr,
                    (TypeParameterSpec)expr.Type,
                    ec.BuiltinTypes.Object
                );
            }
            ...
            //
            expr_copy = TemporaryVariableReference.Create(
                ec.BuiltinTypes.Object,
                ec.CurrentBlock,
                loc
            );
            ...
            {
                lock_taken = TemporaryVariableReference.Create(
                    ec.BuiltinTypes.Bool,
                    ec.CurrentBlock,
                    loc
                );
    ...
    public class Fixed : Statement
    {
        ...
        class StringEmitter : Emitter
        {
            ...
            protected override Expression DoResolve(ResolveContext rc)
            {
                pinned_string = new LocalVariable(
                    vi.Block,
                    "$pinned",
                    LocalVariable.Flags.FixedVariable
                        | LocalVariable.Flags.CompilerGenerated
                        | LocalVariable.Flags.Used,
                    vi.Location
                );
        ...
        public class VariableDeclaration : BlockVariable
        {
            ...
            )
            {
                ...
                if (ac != null)
                {
                    ...
                    else
                    {
                        ...
                        res_init = new CompilerAssign(
                            expr_variable.CreateReferenceExpression(bc, loc),
                            res,
                            loc
                        );
                    ...
                    //
                    converted = new Conditional(
                        new BooleanExpression(
                            new Binary(
                                Binary.Operator.LogicalOr,
                                new Binary(
                                ...
                                new Binary(
                                    Binary.Operator.Equality,
                                    new MemberAccess(res, "Length"),
                                    new IntConstant(bc.BuiltinTypes, 0, loc)
                                )
                            )
                        ),
                        new NullLiteral(loc),
                ...
                res = new Invocation.Predefined(method, null).ResolveLValue(
                    bc,
                    EmptyExpression.OutAccess
                );
                if (res == null)
                    return null;
            ...
            MethodGroupExpr GetPinnableReference(BlockContext bc, Expression expr)
            {
                ...
                var mexpr = Expression.MemberLookup(
                    bc,
                    false,
                    type,
                ...
                if (
                    mg == null
                    || mg.BestCandidate.IsStatic
                    || !mg.BestCandidate.IsPublic
                    || mg.BestCandidateReturnType.Kind != MemberKind.ByRef
                    || !mg.BestCandidate.Parameters.IsEmpty
                )
                {
            ...
            using (bc.Set(ResolveContext.Options.CatchScope))
            {
                if (type_expr == null)
                {
                    if (CreateExceptionVariable(bc.Module.Compiler.BuiltinTypes.Object))
                    {
                        ...
                        assign = new CompilerAssign(
                            new LocalVariableReference(li, Location.Null),
                            source,
                            Location.Null
                        );
                ...
                else
                {
                    ...
                    if (
                        type.BuiltinType != BuiltinTypeSpec.Type.Exception
    ...
    public class TryFinally : TryFinallyBlock
    {
        ...
        public static Label EmitRedirectedJump(
            EmitContext ec,
        ...
        public static Label EmitRedirectedReturn(
            EmitContext ec,
            AsyncInitializer initializer,
            bool unwindProtect
        )
        ...
        )
        {
            if (redirected_jumps == null)
            {
                ...
                if (setReturnState)
                    initializer.HoistedReturnState = ec.GetTemporaryField(
                        ec.Module.Compiler.BuiltinTypes.Int,
                        true
                    );
            }
            ...
            if (setReturnState)
            {
                var value = new IntConstant(
                    initializer.HoistedReturnState.Type,
                    index,
                    Location.Null
                );
    ...
    public class TryCatch : ExceptionStatement
    {
        ...
        {
            get { return catch_sm != null; }
        }

        public bool IsTryCatchFinally
        {
            get { return inside_try_finally; }
        }
            ...
            foreach (Catch c in clauses)
            {
                ...
                if (catch_sm != null)
                {
                    if (state_variable == null)
                    {
                        ...
                        //
                        state_variable = ec.DeclareLocal(
                            ec.Module.Compiler.BuiltinTypes.Int,
                            false
                        );
                    }
    ...
    public class Using : TryFinallyBlock
    {
        public class VariableDeclaration : BlockVariable
        {
            ...
            )
            {
                if (li.Type.BuiltinType == BuiltinTypeSpec.Type.Dynamic)
                {
                    ...
                    initializer = new DynamicConversion(
                        bc.BuiltinTypes.IDisposable,
                        0,
                        args,
                        initializer.Location
                    ).Resolve(bc);
                    ...
                    var var = LocalVariable.CreateCompilerGenerated(
                        initializer.Type,
                        bc.CurrentBlock,
                        loc
                    );
                    ...
                    return base.ResolveInitializer(
                        bc,
                        li,
                        new SimpleAssign(var.CreateReferenceExpression(bc, loc), initializer, loc)
                    );
                }
            ...
            protected virtual void CheckIDiposableConversion(
                BlockContext bc,
                LocalVariable li,
                Expression initializer
            )
            {
                ...
                if (
                    type.BuiltinType != BuiltinTypeSpec.Type.IDisposable
                    && !CanConvertToIDisposable(bc, type)
                )
                {
            ...
            protected virtual Statement CreateDisposeCall(BlockContext bc, LocalVariable lv)
            {
                ...
                //
                Statement dispose = new StatementExpression(
                    new Invocation(dispose_mg, null),
                    Location.Null
                );
                ...
                if (!TypeSpec.IsValueType(type) || type.IsNullableType)
                    dispose = new If(
                        new Binary(Binary.Operator.Inequality, lvr, new NullLiteral(loc)),
                        dispose,
                        dispose.loc
                    );
        ...
        public Expression Expr
        {
            get { return decl.Variable == null ? decl.Initializer : null; }
        }
    ...
    public class Foreach : LoopStatement
    {
        ...
        sealed class ArrayForeach : IteratorStatement
        {
            ...
            public override bool Resolve(BlockContext ec)
            {
                ...
                {
                    var v = TemporaryVariableReference.Create(
                        ec.BuiltinTypes.Int,
                        variables_block,
                        loc
                    );
                    variables[i] = v;
                    counter[i] = new StatementExpression(
                        new UnaryMutator(UnaryMutator.Mode.PostIncrement, v, Location.Null)
                    );
                    ...
                    {
                        lengths[i] = TemporaryVariableReference.Create(
                            ec.BuiltinTypes.Int,
                            variables_block,
                            loc
                        );
                        ...
                        length_exprs[i] = new Invocation(
                            new MemberAccess(copy, "GetLength"),
                            args
                        ).Resolve(ec);
                    }
        ...
        sealed class CollectionForeach : IteratorStatement, OverloadResolver.IErrorHandler
        {
            class RuntimeDispose : Using.VariableDeclaration
            {
                ...
                protected override void CheckIDiposableConversion(
                    BlockContext bc,
                    LocalVariable li,
                    Expression initializer
                )
                ...
                protected override Statement CreateDisposeCall(BlockContext bc, LocalVariable lv)
                {
                    ...
                    var dispose_variable = LocalVariable.CreateCompilerGenerated(
                        idt,
                        bc.CurrentBlock,
                        loc
                    );

                    var idisaposable_test = new Binary(
                        Binary.Operator.Inequality,
                        new CompilerAssign(
                            dispose_variable.CreateReferenceExpression(bc, loc),
                            new As(
                                lv.CreateReferenceExpression(bc, loc),
                                new TypeExpression(dispose_variable.Type, loc),
                                loc
                            ),
                            loc
                        ),
                    ...
                    var dispose_mg = MethodGroupExpr.CreatePredefined(m, idt, loc);
                    dispose_mg.InstanceExpression = dispose_variable.CreateReferenceExpression(
                        bc,
                        loc
                    );
            ...
            MethodGroupExpr ResolveGetEnumerator(ResolveContext rc)
            {
                ...
                if (mg != null)
                {
                    ...
                    mg = mg.OverloadResolve(
                        ...
                        OverloadResolver.Restrictions.ProbingOnly
                            | OverloadResolver.Restrictions.GetEnumeratorLookup
                    );
                ...
                if (ifaces != null)
                {
                    foreach (var iface in ifaces)
                    {
                        if (
                            gen_ienumerable != null
                            && iface.MemberDefinition == gen_ienumerable.TypeSpec.MemberDefinition
                        )
                        {
                            if (
                                iface_candidate != null
                                && iface_candidate
                            ...
                            iface_candidate = new PredefinedMember<MethodSpec>(
                                rc.Module,
                                iface,
                                MemberFilter.Method(
                                    "GetEnumerator",
                        ...
                        if (
                            iface.BuiltinType == BuiltinTypeSpec.Type.IEnumerable
                            && iface_candidate == null
                        )
                        {
            ...
            public override bool Resolve(BlockContext ec)
            {
                ...
                enumerator_variable = TemporaryVariableReference.Create(
                    get_enumerator.ReturnType,
                    variable.Block,
                    loc
                );
                ...
                statement = new While(
                    new BooleanExpression(new Invocation(move_next_mg, null)),
                    for_each.body,
                    Location.Null
                );
                ...
                else
                {
                    ...
                    //
                    var vd = new Using.VariableDeclaration(
                        enumerator_variable.LocalInfo,
                        Location.Null
                    );
                    vd.Initializer = init;
                    statement = new Using(vd, statement, Location.Null);
