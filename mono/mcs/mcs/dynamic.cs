...
namespace Mono.CSharp
{
    ...
    class DynamicExpressionStatement : ExpressionStatement
    {
        ...
        protected class BinderFlags : EnumConstant
        {
            ...
            protected override Expression DoResolve(ResolveContext ec)
            {
                Child = new IntConstant(
                    ec.BuiltinTypes,
                    (int)(flags | statement.flags),
                    statement.loc
                );
        ...
        protected bool DoResolveCore(ResolveContext rc)
        {
            ...
            if (
                rc.CurrentTypeParameters != null
                && rc.CurrentTypeParameters[0].IsMethodTypeParameter
            )
        ...
        )
        {
            ...
            if (!has_ref_out_argument)
            {
                ...
                if (type_ns != null)
                {
                    te = type_ns.LookupType(
                        module,
                        d_name,
                        dyn_args_count + default_args,
                        LookupMode.Normal,
                        loc
                    );
                }
                ...
                if (te != null)
                {
                    if (!isStatement)
                    {
                        ...
                        if (targs_for_instance != null)
                            targs_for_instance[targs_for_instance.Length - 1] = new TypeExpression(
                                t,
                                loc
                            );
                    ...
                    if (targs_for_instance != null)
                        del_type_instance_access = new GenericTypeExpr(
                            te,
                            new TypeArguments(targs_for_instance),
                            loc
                        );
                    else
            ...
            if (del_type == null)
            {
                ...
                d = new Delegate(
                    site,
                    new TypeExpression(rt, loc),
                    Modifiers.INTERNAL | Modifiers.COMPILER_GENERATED,
                    new MemberName("Container" + index.ToString("X")),
                    new ParametersCompiled(p),
                    null
                );
            ...
            var site_type_decl = new GenericTypeExpr(
                module.PredefinedTypes.CallSiteGeneric.TypeSpec,
            ...
            if (del_type_instance_access == null)
            {
                ...
                del_type_instance_access = new TypeExpression(
                    MemberCache.GetMember(dt, d.CurrentType),
                    loc
                );
            }

            var instanceAccessExprType = new GenericTypeExpr(
                module.PredefinedTypes.CallSiteGeneric.TypeSpec,
                new TypeArguments(del_type_instance_access),
                loc
            );
            ...
            {
                var tparams =
                    gt.MemberDefinition.TypeParametersCount > 0
                        ? gt.MemberDefinition.TypeParameters
            ...
            StatementExpression s = new StatementExpression(
                new SimpleAssign(
                    site_field_expr,
                    new Invocation(new MemberAccess(instanceAccessExprType, "Create"), args)
                )
            );
            ...
            using (ec.With(BuilderContext.Options.OmitDebugInfo, true))
            {
                ...
                if (s.Resolve(bc))
                {
                    Statement init = new If(
                        new Binary(Binary.Operator.Equality, site_field_expr, new NullLiteral(loc)),
                        s,
                        loc
                    );
                    init.Emit(ec);
                ...
                var target = new DelegateInvocation(
                    new MemberAccess(site_field_expr, "Target", loc).Resolve(bc),
                    args,
                    false,
                    loc
                ).Resolve(bc);
        ...
        public static MemberAccess GetBinderNamespace(Location loc)
        {
            return new MemberAccess(
                new MemberAccess(
                    new QualifiedAliasMember(QualifiedAliasMember.GlobalAlias, "Microsoft", loc),
                    "CSharp",
                    loc
                ),
                "RuntimeBinder",
    ...
    class DynamicEventCompoundAssign : ExpressionStatement
    {
        ...
        public DynamicEventCompoundAssign(
            string name,
            Arguments args,
        ...
        public override void EmitStatement(EmitContext ec)
        {
            var stmt = new If(
                ...
                new StatementExpression(assign),
                loc
            );
            using (ec.With(BuilderContext.Options.OmitDebugInfo, true))
            {
    ...
    class DynamicConversion : DynamicExpressionStatement, IDynamicBinder
    {
        ...
        public Expression CreateCallSiteBinder(ResolveContext ec, Arguments args)
        {
            ...
            flags |= ec.HasSet(ResolveContext.Options.CheckedScope)
    ...
    class DynamicIndexBinder : DynamicMemberAssignable
    {
        ...
        protected override Expression CreateCallSiteBinder(
            ResolveContext ec,
            Arguments args,
            bool isSet
        )
        ...
        protected override Arguments CreateSetterArguments(ResolveContext rc, Expression rhs)
        {
            ...
            for (int i = 0; i < Arguments.Count; ++i)
            {
                ...
                expr = new SimpleAssign(
                    temp.CreateReferenceExpression(rc, expr.Location),
                    expr
                ).Resolve(rc);
        ...
        {
            get { return conditional_access_receiver; }
        }
    ...
    class DynamicInvocation : DynamicExpressionStatement, IDynamicBinder
    {
        ...
        public static DynamicInvocation CreateSpecialNameInvoke(
            ATypeNameExpression member,
            Arguments args,
            Location loc
        )
        ...
        public Expression CreateCallSiteBinder(ResolveContext ec, Arguments args)
        {
            ...
            if (is_member_access)
                binder_args.Add(
                    new Argument(new StringLiteral(ec.BuiltinTypes, member.Name, member.Location))
                );
            ...
            {
                real_args = new ImplicitlyTypedArrayCreation(
                    args.CreateDynamicBinderArguments(ec),
                    loc
                );
            }
            ...
            return new Invocation(
                GetBinder(is_member_access ? "InvokeMember" : "Invoke", loc),
                binder_args
            );
        }
    ...
    class DynamicMemberBinder : DynamicMemberAssignable
    {
        ...
        protected override Expression DoResolve(ResolveContext rc)
        {
            if (!rc.HasSet(ResolveContext.Options.DontSetConditionalAccessReceiver))
                conditionalAccessReceiver =
                    HasConditionalAccess() || Arguments[0].Expr.HasConditionalAccess();
        ...
        protected override bool IsConditionalAccessReceiver
        {
            get { return conditionalAccessReceiver; }
        }
    }
            ...
            IAssignMethod
    {
        ...
        protected abstract Expression CreateCallSiteBinder(
            ResolveContext ec,
            Arguments args,
            bool isSet
        );
    ...
    class DynamicUnaryConversion : DynamicExpressionStatement, IDynamicBinder
    {
        ...
        public static DynamicUnaryConversion CreateIsTrue(
            ResolveContext rc,
            Arguments args,
            Location loc
        )
        ...
        public static DynamicUnaryConversion CreateIsFalse(
            ResolveContext rc,
            Arguments args,
            Location loc
        )
        ...
        public Expression CreateCallSiteBinder(ResolveContext ec, Arguments args)
        {
            ...
            var flags = ec.HasSet(ResolveContext.Options.CheckedScope)
                ? CSharpBinderFlags.CheckedContext
                : 0;
            ...
            binder_args.Add(
                new Argument(
                    new MemberAccess(new MemberAccess(sle, "ExpressionType", loc), name, loc)
                )
            );
            binder_args.Add(new Argument(new TypeOf(ec.CurrentType, loc)));
            binder_args.Add(
    ...
    sealed class DynamicSiteClass : HoistedStoreyClass
    {
        ...
        public FieldSpec CreateCallSiteField(FullNamedExpression type, Location loc)
        {
            ...
            Field f = new HoistedField(
                this,
                type,
                Modifiers.PUBLIC | Modifiers.STATIC,
                "Site" + index.ToString("X"),
                null,
                loc
            );
            f.Define();
