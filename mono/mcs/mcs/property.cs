...
namespace Mono.CSharp
{
    ...
    public abstract class PropertyBasedMember : InterfaceMemberBase
    {
        ...
        protected void CheckReservedNameConflict(string prefix, MethodSpec accessor)
        {
            ...
            var conflict = MemberCache.FindMember(
                Parent.Definition,
    ...
    public class PropertySpec : MemberSpec, IInterfaceMemberSpec
    {
        ...
        public bool HasDifferentAccessibility
        {
            get
            {
                return HasGet
                    && HasSet
                    && (Get.Modifiers & Modifiers.AccessibilityMask)
    ...
    abstract public class PropertyBase : PropertyBasedMember
    {
        public class GetMethod : PropertyMethod
        {
            ...
            public override void Define(TypeContainer parent)
            {
                ...
                Spec = new MethodSpec(
                    MemberKind.Method,
                    parent.PartialContainer.Definition,
                    this,
                    ReturnType,
                    ParameterInfo,
                    ModFlags
            ...
            {
                get { return method.MemberType; }
            }

            public override ParametersCompiled ParameterInfo
            {
                get { return ParametersCompiled.EmptyReadOnlyParameters; }
            }
        ...
        {
            static readonly string[] attribute_targets = new string[]
            {
                "method",
                "param",
                "return",
            ...
            protected override void ApplyToExtraTarget(
                Attribute a,
                MethodSpec ctor,
                byte[] cdata,
            ...
            public override TypeSpec ReturnType
            {
                get { return Parent.Compiler.BuiltinTypes.Void; }
            }
        ...
        public abstract class PropertyMethod : AbstractPropertyEventMethod
        {
            const Modifiers AllowedModifiers =
                Modifiers.PUBLIC | Modifiers.PROTECTED | Modifiers.INTERNAL | Modifiers.PRIVATE;
            ...
            {
                get { return (ModFlags & Modifiers.PROPERTY_CUSTOM) != 0; }
            }
            ...
            {
                if (
                    !ModifiersExtensions.IsRestrictedModifier(
                        modflags & Modifiers.AccessibilityMask,
                        method.ModFlags & Modifiers.AccessibilityMask
                    )
                )
                {
                    Report.Error(
        ...
        public override AttributeTargets AttributeTargets
        {
            get { return AttributeTargets.Property; }
        }
        ...
        void CheckMissingAccessor(MemberKind kind, ParametersCompiled parameters, bool get)
        {
            if (IsExplicitImpl)
            {
                ...
                var implementing =
                    MemberCache.FindMember(InterfaceType, filter, BindingRestriction.DeclaredOnly)
                    as PropertySpec;
        ...
        protected override bool CheckOverrideAgainstBase(MemberSpec base_member)
        {
            ...
            if (Get == null)
            {
                if (
                    ...
                    && base_prop.HasGet
                    && !base_prop.Get.IsAccessible(this)
                )
                {
                    ...
                    Report.Error(
                        ...
                        GetSignatureForError(),
                        base_prop.GetSignatureForError()
                    );
                    ok = false;
                }
            }
            ...
            if (
                (Set == null || !Set.HasCustomAccessModifier)
                && (Get == null || !Get.HasCustomAccessModifier)
            )
            {
        ...
        protected override void DoMemberTypeIndependentChecks()
        {
            ...
            {
                if (
                    (Get.ModFlags & Modifiers.AccessibilityMask) != 0
    ...
    public class Property : PropertyBase
    {
        public sealed class BackingFieldDeclaration : Field
        {
            ...
            const Modifiers DefaultModifiers =
                Modifiers.BACKING_FIELD
                | Modifiers.COMPILER_GENERATED
                | Modifiers.PRIVATE
                | Modifiers.DEBUGGER_HIDDEN;

            public BackingFieldDeclaration(Property p, bool readOnly)
                : base(
                    p.Parent,
                    p.type_expr,
                    DefaultModifiers | (p.ModFlags & (Modifiers.STATIC | Modifiers.UNSAFE)),
                    new MemberName(
                        "<" + p.GetFullName(p.MemberName) + ">k__BackingField",
                        p.Location
                    ),
                    null
                )
        ...
        void CreateAutomaticProperty()
        {
            ...
            if (Initializer != null)
            {
                ...
                Parent.RegisterFieldForInitialization(
                    BackingField,
                    new FieldInitializer(BackingField, Initializer, Location)
                );
            ...
            if (Set != null)
            {
                ...
                Assign a = new SimpleAssign(
                    fe,
                    new SimpleName("value", Location.Null),
                    Location.Null
                );
        ...
        public override bool Define()
        {
            ...
            bool auto =
                AccessorFirst.Block == null
                && (AccessorSecond == null || AccessorSecond.Block == null)
            ...
            if (auto)
            {
                ...
                if (MemberType.Kind == MemberKind.ByRef)
                {
                    Report.Error(
                        8145,
                        Location,
                        "Auto-implemented property `{0}' cannot return by reference",
                        GetSignatureForError()
                    );
                    return false;
                }
        ...
        {
            if (
                (AccessorFirst.ModFlags & (Modifiers.STATIC | Modifiers.AutoProperty))
                    == Modifiers.AutoProperty
    ...
    public class EventProperty : Event
    {
        ...
        {
            protected AEventPropertyAccessor(
                EventProperty method,
                string prefix,
                Attributes attrs,
                Location loc
            )
    ...
    public class EventField : Event
    {
        abstract class EventFieldAccessor : AEventAccessor
        {
            ...
            {
                if (
                    (method.ModFlags & (Modifiers.ABSTRACT | Modifiers.EXTERN)) == 0
                    && !Compiler.Settings.WriteMetadataOnly
                )
                {
            ...
            void FabricateBodyStatement()
            {
                ...
                if (!IsStatic)
                    f_expr.InstanceExpression = new CompilerGeneratedThis(
                        Parent.CurrentType,
                        Location
                    );

                var obj1 = LocalVariable.CreateCompilerGenerated(
                    field_info.MemberType,
                    block,
                    Location
                );
                var obj2 = LocalVariable.CreateCompilerGenerated(
                    field_info.MemberType,
                    block,
                    Location
                );
                ...
                block.AddStatement(
                    new StatementExpression(
                        new SimpleAssign(new LocalVariableReference(obj1, Location), f_expr)
                    )
                );

                var cond = new BooleanExpression(
                    new Binary(
                        Binary.Operator.Inequality,
                        new Cast(
                            new TypeExpression(Module.Compiler.BuiltinTypes.Object, Location),
                            new LocalVariableReference(obj1, Location),
                            Location
                        ),
                        new Cast(
                            new TypeExpression(Module.Compiler.BuiltinTypes.Object, Location),
                            new LocalVariableReference(obj2, Location),
                            Location
                        )
                    )
                );
                ...
                args.Add(
                    new Argument(
                        new Cast(
                            ...
                            new Invocation(
                                MethodGroupExpr.CreatePredefined(
                                    op_method,
                                    op_method.DeclaringType,
                                    Location
                                ),
                                args_oper
                            ),
                ...
                {
                    if (
                        Module.PredefinedMembers.MonitorEnter_v4.Get() != null
                        || Module.PredefinedMembers.MonitorEnter.Get() != null
                    )
                    {
                        ...
                        body.AddStatement(
                            new Lock(
                                ...
                                new StatementExpression(
                                    new SimpleAssign(f_expr, args[1].Expr, Location),
                                    Location
                                ),
                                Location
                            )
        ...
        protected override void DoMemberTypeIndependentChecks()
        {
            ...
            )
            {
                Report.Error(
                    8342,
                    Location,
                    "`{0}': Field-like instance events are not allowed in readonly structs",
                    GetSignatureForError()
                );
            }
        ...
        public override bool Define()
        {
            ...
            if (declarators != null)
            {
                if ((mod_flags_src & Modifiers.DEFAULT_ACCESS_MODIFIER) != 0)
                    mod_flags_src &= ~(
                        Modifiers.AccessibilityMask | Modifiers.DEFAULT_ACCESS_MODIFIER
                    );

                var t = new TypeExpression(MemberType, TypeExpression.Location);
                foreach (var d in declarators)
                {
                    var ef = new EventField(
                        Parent,
                        t,
                        mod_flags_src,
            ...
            backing_field = new Field(
                ...
                Modifiers.BACKING_FIELD
                    ...
                    | Modifiers.DEBUGGER_HIDDEN
                    | Modifiers.PRIVATE
                    | (ModFlags & (Modifiers.STATIC | Modifiers.UNSAFE)),
                MemberName,
                null
            );
    ...
    public abstract class Event : PropertyBasedMember
    {
        public abstract class AEventAccessor : AbstractPropertyEventMethod
        {
                ...
                : base(method, prefix, attrs, loc)
            {
                ...
                this.parameters = ParametersCompiled.CreateImplicitParameter(
        ...
        public override AttributeTargets AttributeTargets
        {
            get { return AttributeTargets.Event; }
        }
        ...
        public override Variance ExpectedMemberTypeVariance
        {
            get { return Variance.Contravariant; }
        }
    ...
    public class Indexer : PropertyBase, IParametersMember
    {
        ...
        const Modifiers AllowedInterfaceModifiers = Modifiers.NEW;
        ...
        public override bool Define()
        {
            ...
            if (OptAttributes != null)
            {
                Attribute indexer_attr = OptAttributes.Search(
                    Module.PredefinedAttributes.IndexerName
                );
                ...
                if (base_IndexerName != ShortName)
                {
                    SetMemberName(
                        new MemberName(
                            MemberName.Left,
                            base_IndexerName,
                            new TypeExpression(InterfaceType, Location),
                            Location
                        )
                    );
                }
    ...
    public class IndexerSpec : PropertySpec, IParametersMember
    {
        ...
        public override string GetSignatureForError()
        {
            return DeclaringType.GetSignatureForError()
                + ".this"
                + parameters.GetSignatureForError("[", "]", parameters.Count);
        }
