...
namespace Mono.CSharp
{
        ...
        public override TypeSpec Resolve(IMemberContext ec, int index)
        {
            if (parameter_type == null)
                throw new InternalErrorException(
                    "A type of implicit lambda parameter `{0}' is not set",
                    Name
                );
    ...
    public class Parameter : ParameterBase, IParameterData, ILocalVariable // TODO: INamedBlockVariable
    {
        ...
        {
            get { return default_expr as DefaultParameterValueExpression; }
        ...
        {
            get { return default_expr is DefaultParameterValueExpression; }
        }
        ...
        public virtual TypeSpec Resolve(IMemberContext rc, int index)
        {
            ...
            if (
                (modFlags & Parameter.Modifier.RefOutMask) != 0
            ...
            if (
                (modFlags & Modifier.This) != 0
                && (
                    parameter_type.IsPointer
        ...
        void ResolveCallerAttributes(ResolveContext rc)
        {
            ...
            Attribute callerMemberName = null,
                callerFilePath = null;
                ...
                if (atype == pa.CallerLineNumberAttribute)
                {
                    ...
                    if (
                        ...
                        && !Convert.ImplicitStandardConversionExists(
                            new IntConstant(caller_type, int.MaxValue, Location.Null),
                            parameter_type
                        )
                    )
                    {
        ...
        public void ResolveDefaultValue(ResolveContext rc)
        {
            ...
            if (def_attr != null)
            {
                ...
                if (
                    TypeSpecComparer.IsEqual(default_expr.Type, parameter_type)
                    || (
                        default_expr is NullConstant
                        && TypeSpec.IsReferenceType(parameter_type)
                        && !parameter_type.IsGenericParameter
                    )
                ...
                //
                var expr = Convert.ImplicitUserConversion(
                    dpa_rc,
                    default_expr,
                    parameter_type,
                    loc
        ...
        {
            get { return hoisted_variant; }
            set { hoisted_variant = value; }
        }
        ...
        public override AttributeTargets AttributeTargets
        {
            get { return AttributeTargets.Parameter; }
        }
        ...
        )
        {
            ...
            if (HasDefaultValue && default_expr.Type != null)
            {
                ...
                Constant c =
                    def_value != null ? def_value.Child as Constant : default_expr as Constant;
                if (c != null)
                {
        ...
        public ExpressionStatement CreateExpressionTreeVariable(BlockContext ec)
        {
            ...
            expr_tree_variable = TemporaryVariableReference.Create(
                ...
                ec.CurrentBlock.ParametersBlock,
                Location
            );
    ...
    public abstract class AParametersCollection
    {
        ...
        {
            get { return has_arglist ? CallingConventions.VarArgs : CallingConventions.Standard; }
        }
        ...
        public static bool HasSameParameterDefaults(
            AParametersCollection a,
            ...
            if (default_value)
            {
                ...
                for (int i = 0; i < Count; ++i)
                {
                    ...
                    if (c != null)
                    {
                        ...
                        //
                        c = Constant.ExtractConstantFromValue(
                            inflated_types[i],
                            c.GetValue(),
                            expr.Location
                        );
                        if (c == null)
                            expr = new DefaultValueExpression(
                                new TypeExpression(inflated_types[i], expr.Location),
                                expr.Location
                            );
                        else
                            expr = c;
    ...
    public class ParametersCompiled : AParametersCollection
    {
        ...
        public static ParametersCompiled CreateFullyResolved(
        ...
        public static ParametersCompiled Prefix(
        ...
        public static ParametersCompiled CreateImplicitParameter(
            FullNamedExpression texpr,
            Location loc
        )
        {
        ...
        public static int IsSameClsSignature(AParametersCollection a, AParametersCollection b)
        {
            ...
            for (int i = 0; i < a.Count; ++i)
            {
                ...
                if (
                    ac_a.Rank != ac_b.Rank
                    && TypeSpecComparer.Override.IsEqual(ac_a.Element, ac_b.Element)
                )
                {
                    res |= 1;
                    continue;
        ...
        public Expression CreateExpressionTree(BlockContext ec, Location loc)
        {
            ...
            foreach (Parameter p in FixedParameters)
            {
                ...
                StatementExpression se = new StatementExpression(
                    p.CreateExpressionTreeVariable(ec),
                    Location.Null
                );
                if (se.Resolve(ec))
                {
        ...
        public void Resolve(ResolveContext rc, Parameter p)
        {
            ...
            if (
                !(
                    ...
                    || expr is DefaultLiteralExpression
                    || (expr is New && ((New)expr).IsGeneratedStructConstructor)
                )
            )
            {
