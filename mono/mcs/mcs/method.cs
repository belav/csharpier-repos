...
namespace Mono.CSharp
{
    ...
    public sealed class MethodSpec : MemberSpec, IParametersMember
    {
        ...
        public static readonly MethodSpec Excluded = new MethodSpec(
            MemberKind.Method,
        ...
        {
            get { return IsGeneric ? GenericDefinition.TypeParametersCount : 0; }
        }
        ...
        {
            get { return Kind == MemberKind.Constructor; }
        }

        public new IMethodDefinition MemberDefinition
        {
            get { return (IMethodDefinition)definition; }
        }

        public IGenericMethodDefinition GenericDefinition
        {
            get { return (IGenericMethodDefinition)definition; }
        }
        ...
        {
            get { return IsStatic && parameters.HasExtensionMethodType; }
        }
        ...
        public bool IsVirtual
        {
            get
            {
                return (Modifiers & (Modifiers.VIRTUAL | Modifiers.ABSTRACT | Modifiers.OVERRIDE))
                    != 0;
            }
        }
        ...
        {
            get { return Kind == MemberKind.Operator || IsAccessor; }
        }
        ...
        public MethodBase GetMetaInfo()
        {
            ...
            if (inflatedMetaInfo == null)
            {
                if ((state & StateFlags.PendingMetaInflate) != 0)
                {
                    ...
                    {
                        if (IsConstructor)
                            inflatedMetaInfo = TypeBuilder.GetConstructor(
                                dt_meta,
                                (ConstructorInfo)MemberDefinition.Metadata
                            );
                        else
                            inflatedMetaInfo = TypeBuilder.GetMethod(
                                dt_meta,
                                (MethodInfo)MemberDefinition.Metadata
                            );
                    }
                    else
                    {
...
#else
                        inflatedMetaInfo = MethodInfo.GetMethodFromHandle(
                            MemberDefinition.Metadata.MethodHandle,
                            dt_meta.TypeHandle
                        );
#endif
                    }
        ...
        public override string GetSignatureForDocumentation()
        {
            ...
            name =
                DeclaringType.GetSignatureForDocumentation()
                + "."
                + name
        ...
        public override string GetSignatureForError()
        {
            ...
            else if (Kind == MemberKind.Operator)
            {
                ...
                {
                    name =
                        DeclaringType.GetSignatureForError() + ".operator " + Operator.GetName(op);
                }
            }
            else if (IsAccessor)
            {
        ...
        public MethodSpec MakeGenericMethod(IMemberContext context, params TypeSpec[] targs)
        {
            ...
            var inflator = new TypeParameterInflator(
                context,
                DeclaringType,
                GenericDefinition.TypeParameters,
                targs
            );
            ...
            inflated.constraints = TypeParameterSpec.InflateConstraints(
                inflator,
                constraints ?? GenericDefinition.TypeParameters
            );
    ...
    public abstract class MethodOrOperator : MethodCore, IMethodData, IMethodDefinition
    {
        ...
        )
        {
            ...
            {
                if (
                    (ModFlags & Modifiers.ASYNC) != 0
                    && (a.GetMethodImplOptions() & MethodImplOptions.Synchronized) != 0
                )
                {
                    Report.Error(
                        4015,
        ...
        {
            get { return AttributeTargets.Method; }
        }

        MethodBase IMethodDefinition.Metadata
        {
            get { return MethodData.MethodBuilder; }
        }
        ...
        public virtual EmitContext CreateEmitContext(
            ILGenerator ig,
        ...
        public static void Error_ReturnTypeCantBeRefAny(Location loc, TypeSpec t, Report Report)
        {
            Report.Error(
                1599,
                loc,
                "The return type of `{0}' is not allowed",
        ...
        {
            get { return (ModFlags & Modifiers.PARTIAL) != 0 && Block == null; }
        }
        ...
        public override string[] ConditionalConditions()
        {
            ...
            if (base_method == null)
            {
                ...
                Attribute[] attrs = OptAttributes.SearchMulti(
                    Module.PredefinedAttributes.Conditional
                );
                if (attrs == null)
                    return null;
    ...
    public class Method : MethodOrOperator, IGenericMethodDefinition
    {
            ...
            : base(
                ...
                parent.PartialContainer.Kind == MemberKind.Interface ? AllowedModifiersInterface
                    : parent.PartialContainer.Kind == MemberKind.Struct
                        ? AllowedModifiersStruct | Modifiers.ASYNC
        ...
        {
            get { return CurrentTypeParameters.Types; }
        }
        ...
        )
        {
            ...
            {
                const Modifiers invalid_partial_mod =
                    Modifiers.AccessibilityMask
                    | Modifiers.ABSTRACT
                    | Modifiers.EXTERN
                    | Modifiers.NEW
                    | Modifiers.OVERRIDE
        ...
        bool IsEntryPoint()
        {
            if (
                ...
                && ReturnType.BuiltinType != BuiltinTypeSpec.Type.Int
            )
                return false;
            ...
            return ac != null
                && ac.Rank == 1
                && ac.Element.BuiltinType == BuiltinTypeSpec.Type.String
            ...
            if (a.Type == pa.Conditional)
            {
                ...
                if (MethodData.implementing != null)
                {
                    ...
                    Report.Error(
                        ...
                        GetSignatureForError(),
                        TypeManager.CSharpSignature(MethodData.implementing)
                    );
                    return;
                }
            ...
            for (int i = 0; i < MemberName.Arity; i++)
            {
                ...
                if (block == null)
                {
                    ...
                    if (idx >= 0)
                    {
                        ...
                        b.Error_AlreadyDeclaredTypeParameter(
                            type_argument_name,
                ...
                if (local_tparam_targs != null)
                {
                    for (int ii = 0; ii < local_tparam_targs.Length; ++ii)
                    {
                        ...
                        for (int iii = ii + 1; iii < local_tparam_targs.Length; ++iii)
                        {
                            ...
                            if (
                                TypeSpecComparer.IsEqual(ta, tparam_checked)
                                || TypeSpec.IsBaseClass(ta, tparam_checked, false)
                            )
                            {
                                ...
                                Array.Copy(
                                    ...
                                    unique_tparams,
                                    iii,
                                    local_tparam_targs.Length - iii - 1
                                );
                            }
                            else if (!TypeSpec.IsBaseClass(tparam_checked, ta, false))
                            {
                                Constraints.Error_ConflictingConstraints(
                                    this,
                                    local_tparam,
                                    ta,
                                    tparam_checked,
                        ...
                        Constraints.CheckConflictingInheritedConstraint(
                            local_tparam,
                            ta,
                            this,
                            Location
        ...
        public static bool CheckImplementingMethodConstraints(
        ...
        public override bool Define()
        {
            ...
            if (
                member_type.Kind == MemberKind.Void
                && parameters.IsEmpty
                && MemberName.Arity == 0
            ...
            if (CurrentTypeParameters == null)
            {
                if (base_method != null && !IsExplicitImpl)
                {
                    if (
                        parameters.Count == 1
                        && ParameterTypes[0].BuiltinType == BuiltinTypeSpec.Type.Object
                ...
                if ((ModFlags & Modifiers.ASYNC) != 0)
                {
                    ...
                    )
                    {
                        Report.Error(
                            1983,
                            Location,
                            "The return type of an async method must be void or task type"
                        );
                    }

                    block = (ToplevelBlock)
                        block.ConvertToAsyncTask(
                            this,
            ...
            if (
                settings.NeedsEntryPoint
                && MemberName.Name == "Main"
                && !IsPartialDefinition
                && (settings.MainClass == null || settings.MainClass == Parent.TypeBuilder.FullName)
            )
            {
                if (IsEntryPoint())
                {
        ...
        public override void Emit()
        {
            try
            {
                ...
                if (
                    (ModFlags & Modifiers.PARTIAL) != 0
                    && (caching_flags & Flags.PartialDefinitionExists) == 0
                )
                {
                    Report.Error(
                        759,
    ...
    public class Constructor : MethodCore, IMethodData, IMethodDefinition
    {
        ...
        public override bool Define()
        {
            ...
            var ca =
                ModifiersExtensions.MethodAttr(ModFlags)
        ...
        protected override MemberSpec FindBaseMember(
    ...
    public class MethodData
    {
        ...
        public bool Define(TypeDefinition container, string method_full_name)
        {
            ...
            if (pending != null)
            {
                ...
                else
                {
                    if (implementing != null && !optional)
                    {
                        ...
                        else if (implementing.DeclaringType.IsInterface)
                        {
                            ...
                            else
                            {
                                PropertyBase.PropertyMethod pm =
                                    method as PropertyBase.PropertyMethod;
                                if (
                                    pm != null
                                    && pm.HasCustomAccessModifier
                        ...
                        if (
                            !NamedTupleSpec.CheckOverrideName(
                                member.MemberType,
            ...
            if (implementing != null)
            {
                ...
                else
                {
                    ...
                    if (implementing.DeclaringType.IsInterface)
                    {
                        ...
                        (flags & MethodAttributes.MemberAccessMask) == MethodAttributes.Private
                    )
                    {
            ...
            if (implementing != null)
            {
                ...
                if (
                    (modifiers & (Modifiers.VIRTUAL | Modifiers.ABSTRACT | Modifiers.OVERRIDE)) == 0
                )
        ...
        public void Emit(TypeDefinition parent)
        {
            ...
            if (block != null)
            {
                ...
                if (block.Resolve(bc, method))
                {
                    ...
                    EmitContext ec = method.CreateEmitContext(
    ...
    {
        const Modifiers AllowedModifiers = Modifiers.UNSAFE | Modifiers.EXTERN;
            ...
            if (base_type != null && Block != null)
            {
                var base_dtor =
                    MemberCache.FindMember(
                        base_type,
                        new MemberFilter(MetadataName, 0, MemberKind.Destructor, null, null),
                        BindingRestriction.InstanceOnly
                    ) as MethodSpec;

                if (base_dtor == null)
                    throw new NotImplementedException();

                MethodGroupExpr method_expr = MethodGroupExpr.CreatePredefined(
                    base_dtor,
                    base_type,
                    Location
                );
                ...
                // debugger scope
                //
                finaly_block.AddStatement(
                    new StatementExpression(
                        new Invocation(method_expr, new Arguments(0)),
                        Location.Null
                    )
                );
    ...
    public abstract class AbstractPropertyEventMethod : MemberCore, IMethodData, IMethodDefinition
    {
        ...
        protected AbstractPropertyEventMethod(
            InterfaceMemberBase member,
            string prefix,
            Attributes attrs,
            Location loc
        ...
        public TypeSpec[] ParameterTypes
        {
            get { return ParameterInfo.Types; }
        }

        MethodBase IMethodDefinition.Metadata
        {
            get { return method_data.MethodBuilder; }
        }
        ...
        protected virtual void ApplyToExtraTarget(
            Attribute a,
            MethodSpec ctor,
            byte[] cdata,
            PredefinedAttributes pa
    ...
    public class Operator : MethodOrOperator
    {
        const Modifiers AllowedModifiers =
            Modifiers.PUBLIC | Modifiers.UNSAFE | Modifiers.EXTERN | Modifiers.STATIC;
        ...
        public Operator(
            ...
            : base(
                ...
                mod_flags,
                AllowedModifiers,
                new MemberName(GetMetadataName(type), loc),
                attrs,
                parameters
            )
        {
        ...
        public override bool Define()
        {
            ...
            {
                if (
                    first_arg_type_unwrap == return_type_unwrap
                    && first_arg_type_unwrap == declaring_type
                )
                {
                    Report.Error(
                        555,
            ...
            {
                if (
                    first_arg_type != declaring_type
                    || parameters.Types[1].BuiltinType != BuiltinTypeSpec.Type.Int
                )
                {
                    Report.Error(
                        564,
            ...
            else if (parameters.Count == 1)
            {
                ...
                if (OperatorType == OpType.Increment || OperatorType == OpType.Decrement)
                {
                    if (
                        ...
                        && !TypeSpec.IsBaseClass(return_type, declaring_type, false)
                    )
                    {
                        Report.Error(
                            448,
        ...
        public override string GetSignatureForError()
        {
            ...
            if (OperatorType == OpType.Implicit || OperatorType == OpType.Explicit)
            {
                sb.AppendFormat(
                    ...
                    member_type == null
                        ? type_expr.GetSignatureForError()
                        : member_type.GetSignatureForError()
                );
            }
            else
            {
