...
namespace Mono.CSharp
{
    ...
    public class Argument
    {
        ...
        {
            get { return (ArgType & AType.ExtensionType) == AType.ExtensionType; }
        }
    ...
    public class Arguments
    {
        sealed class ArgumentsOrdered : Arguments
        {
            ...
            public override void FlowAnalysis(
                FlowAnalysisContext fc,
                List<MovableArgument> movable = null
            )
            {
            ...
            foreach (Argument a in args)
            {
                ...
                if (a.Expr is Constant)
                {
                    info_flags = new Binary(
                        Binary.Operator.BitwiseOr,
                        info_flags,
                        new MemberAccess(
                            new MemberAccess(binder, info_flags_enum, loc),
                            "Constant",
                            loc
                        )
                    );
                ...
                if (
                    ...
                    && arg_type != InternalType.NullLiteral
                )
                {
                ...
                all.Add(
                    new Invocation(
                        new MemberAccess(
                            new MemberAccess(binder, "CSharpArgumentInfo", loc),
                            "Create",
                            loc
                        ),
                        dargs
        ...
        public static Arguments CreateForExpressionTree(
            ResolveContext rc,
            Arguments args,
            params Expression[] e
        )
        ...
        public virtual void FlowAnalysis(
            FlowAnalysisContext fc,
            List<MovableArgument> movable = null
        )
        {
        ...
        public static System.Linq.Expressions.Expression[] MakeExpression(
            Arguments args,
            BuilderContext ctx
        )
        {
