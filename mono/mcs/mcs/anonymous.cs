...
namespace Mono.CSharp
{
    public abstract class CompilerGeneratedContainer : ClassOrStruct
    {
        ...
        protected CompilerGeneratedContainer(
        ...
        protected static MemberName MakeMemberName(
            MemberBase host,
            string name,
            int unique_id,
    ...
    public class AnonymousMethodStorey : HoistedStoreyClass
    {
        ...
        public AnonymousMethodStorey(
            ...
            : base(
                ...
                MakeMemberName(
                    host,
                    name,
                    parent.PartialContainer.CounterAnonymousContainers,
                    tparams,
                    block.StartLocation
                ),
                tparams,
        ...
        protected Field AddCompilerGeneratedField(
            string name,
            FullNamedExpression type,
            bool privateAccess
        )
        {
            Modifiers mod =
                ...
                | (privateAccess ? Modifiers.PRIVATE : Modifiers.INTERNAL);
        ...
        public void CaptureLocalVariable(ResolveContext ec, LocalVariable localVariable)
        {
            ...
            if (hoisted == null)
            {
                hoisted = new HoistedLocalVariable(
                    this,
                    localVariable,
                    GetVariableMangledName(ec, localVariable)
                );
            ...
            if (
                ec.CurrentBlock.Explicit != localVariable.Block.Explicit
                && !(hoisted.Storey is StateMachine)
                && hoisted.Storey != null
            )
        ...
        public void CaptureParameter(
            ResolveContext ec,
            ParametersBlock.ParameterInfo parameterInfo,
        ...
        TypeExpr CreateStoreyTypeExpression(EmitContext ec)
        {
            ...
            if (CurrentTypeParameters != null)
            {
                ...
                //
                var tparams =
                    ec.CurrentAnonymousMethod != null && ec.CurrentAnonymousMethod.Storey != null
        ...
        public void EmitStoreyInstantiation(EmitContext ec, ExplicitBlock block)
        {
            ...
            {
                var local = TemporaryVariableReference.Create(
                    source.Type,
                    block,
                    Location,
                    writeToSymbolFile: true
                );
            ...
            if (used_parent_storeys != null)
            {
                foreach (StoreyFieldPair sf in used_parent_storeys)
                {
                    ...
                    SimpleAssign a = new SimpleAssign(
                        f_set_expr,
                        sf.Storey.GetStoreyInstanceExpression(ec)
                    );
    ...
    public class AnonymousMethodExpression : Expression
    {
        ...
        {
            get { return Parameters != ParametersCompiled.Undefined; }
        }
        ...
        protected bool VerifyExplicitParameters(
            ResolveContext ec,
        ...
        {
            if (
                VerifyParameterCompatibility(ec, tic, delegate_type, parameters, ec.IsInProbingMode)
            )
                return true;
        ...
        protected bool VerifyParameterCompatibility(
            ResolveContext ec,
            TypeInferenceContext tic,
            TypeSpec delegate_type,
        ...
        )
        {
            ...
            for (int i = 0; i < Parameters.Count; ++i)
            {
                ...
                if (
                    Parameters.FixedParameters[i].ModFlags != p_mod
                    && p_mod != Parameter.Modifier.PARAMS
                )
                {
                    if (ignore_errors)
                        return false;
        ...
        //
        public bool ExplicitTypeInference(
        ...
        public TypeSpec InferReturnType(
            ResolveContext ec,
            TypeInferenceContext tic,
            TypeSpec delegate_type
        )
        {
            ...
            using (
                ec.Set(ResolveContext.Options.ProbingMode | ResolveContext.Options.InferReturnType)
            )
            {
                ReportPrinter prev;
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (body.DirectMethodGroupConversion != null)
                    {
                        ...
                        var expr = new ImplicitDelegateCreation(
                            delegate_type,
                            body.DirectMethodGroupConversion,
                            loc
                        )
                        {
        ...
        protected virtual ParametersCompiled ResolveParameters(
            ResolveContext ec,
            TypeInferenceContext tic,
            TypeSpec delegate_type
        )
            ...
            if (Parameters == ParametersCompiled.Undefined)
            {
                ...
                for (int i = 0; i < delegate_parameters.Count; i++)
                {
                    ...
                    fixedpars[i] = new Parameter(
                        new TypeExpression(delegate_parameters.Types[i], loc),
                        null,
                        delegate_parameters.FixedParameters[i].ModFlags,
                        null,
                        loc
                    );
                }
        ...
        protected override Expression DoResolve(ResolveContext rc)
        {
            ...
            if (
                ...
                && rc.CurrentMemberDefinition.Parent.PartialContainer.PrimaryConstructorParameters
                    != null
            )
            {
        ...
        public static void Error_AddressOfCapturedVar(
            ResolveContext rc,
            IVariableReference var,
            Location loc
        )
        {
        ...
        AnonymousMethodBody CompatibleMethodBody(
            ResolveContext ec,
            TypeInferenceContext tic,
            TypeSpec return_type,
            TypeSpec delegate_type,
            ref HashSet<LocalVariable> undeclaredVariables
        )
        {
            ...
            ParametersBlock b = ec.IsInProbingMode
                ? (ParametersBlock)Block.PerformClone(ref undeclaredVariables)
                : Block;
            ...
            return CompatibleMethodFactory(
                return_type ?? InternalType.ErrorType,
                delegate_type,
                p,
                b
            );
        ...
        protected virtual AnonymousMethodBody CompatibleMethodFactory(
            TypeSpec return_type,
            TypeSpec delegate_type,
    ...
    public abstract class AnonymousExpression : ExpressionStatement
    {
                    ...
                    if (!parameters.IsEmpty)
                    {
                        ...
                        if (mutated != parameters.Types)
                            parameters = ParametersCompiled.CreateFullyResolved(
                                (Parameter[])parameters.FixedParameters,
                                mutated
                            );
                    }
        ...
        public AnonymousExpression Compatible(ResolveContext ec, AnonymousExpression ae)
        {
            ...
            if (
                block.IsAsync
                && block.Original.ParametersBlock.HasCapturedThis
                && ec.CurrentAnonymousMethod != null
                && ec.CurrentAnonymousMethod.block.IsAsync
            )
            {
                //
    ...
    public class AnonymousMethodBody : AnonymousExpression
    {
        ...
        AnonymousMethodMethod DoCreateMethodHost(EmitContext ec)
        {
            ...
            string name = CompilerGeneratedContainer.MakeName(
                parent != storey ? block_name : null,
                "m",
                null,
                parent.PartialContainer.CounterAnonymousMethods++
            );
            ...
            return new AnonymousMethodMethod(
                ...
                this,
                storey,
                new TypeExpression(ReturnType, Location),
                modifiers,
                member_name,
                method_parameters
            );
        ...
        public override void Emit(EmitContext ec)
        {
            ...
            if (is_static && am_cache == null && !ec.IsStaticConstructor)
            {
                ...
                if (!method.MemberName.IsGeneric)
                {
                    ...
                    var cache_type =
                        storey != null && storey.Mutator != null
                            ? storey.Mutator.Mutate(type)
                            : type;

                    am_cache = new Field(
                        parent,
                        new TypeExpression(cache_type, loc),
                        Modifiers.STATIC | Modifiers.PRIVATE | Modifiers.COMPILER_GENERATED,
                        new MemberName(
                            CompilerGeneratedContainer.MakeName(null, "f", "am$cache", id),
                            loc
                        ),
                        null
                    );
            ...
            else if (storey != null)
            {
                Expression e = storey
                    ...
                    .Resolve(new ResolveContext(ec.MemberContext));
                if (e != null)
                {
                    e.Emit(ec);
                }
                ...
                else
                {
                    ...
                    ec.Emit(
                        ...
                        TypeBuilder.GetMethod(
                            t.GetMetaInfo(),
                            (MethodInfo)delegate_method.GetMetaInfo()
                        )
                    );
                }
            }
            else
            {
                if (delegate_method.IsGeneric)
                {
                    ...
                    var sm =
                        ec.CurrentAnonymousMethod == null
                            ? null
                            : ec.CurrentAnonymousMethod.Storey as StateMachine;
    ...
    public class AnonymousTypeClass : CompilerGeneratedContainer
    {
        ...
        public static AnonymousTypeClass Create(
            TypeContainer parent,
            IList<AnonymousTypeParameter> parameters,
            Location loc
        )
        {
            ...
            else
            {
                ...
                for (int i = 0; i < parameters.Count; ++i)
                {
                    ...
                    tparams.Add(
                        new TypeParameter(
                            i,
                            new MemberName(t_args[i].Name, p.Location),
                            null,
                            null,
                            Variance.None
                        )
                    );
                    ctor_params[i] = new Parameter(
                        t_args[i],
                        p.Name,
            ...
            //
            AnonymousTypeClass a_type = new AnonymousTypeClass(
                parent.Module,
                new MemberName(name, tparams, loc),
                parameters,
                loc
            );
            ...
            for (int i = 0; i < parameters.Count; ++i)
            {
                ...
                Field f = new Field(
                    a_type,
                    t_args[i],
                    Modifiers.PRIVATE | Modifiers.READONLY | Modifiers.DEBUGGER_HIDDEN,
                ...
                get_block.AddStatement(
                    new Return(new MemberAccess(new This(p.Location), f.Name), p.Location)
                );
        ...
        protected override bool DoDefineMembers()
        {
            ...
            var equals_parameters = ParametersCompiled.CreateFullyResolved(
                new Parameter(
                    new TypeExpression(Compiler.BuiltinTypes.Object, loc),
                    "obj",
                    0,
                    null,
                    loc
            ...
            Method equals = new Method(
                this,
                new TypeExpression(Compiler.BuiltinTypes.Bool, loc),
            ...
            Method tostring = new Method(
                this,
                new TypeExpression(Compiler.BuiltinTypes.String, loc),
                Modifiers.PUBLIC | Modifiers.OVERRIDE | Modifiers.DEBUGGER_HIDDEN,
            ...
            equals_block.AddStatement(
                new BlockVariable(new TypeExpression(li_other.Type, loc), li_other)
            );
            ...
            for (int i = 0; i < parameters.Count; ++i)
            {
                ...
                MemberAccess equality_comparer = new MemberAccess(
                    new MemberAccess(
                        system_collections_generic,
                        "EqualityComparer",
                        new TypeArguments(new SimpleName(CurrentTypeParameters[i].Name, loc)),
                        loc
                    ),
                    "Default",
                    loc
                ...
                Expression field_equal = new Invocation(
                    new MemberAccess(equality_comparer, "Equals", loc),
                    arguments_equal
                );

                Arguments arguments_hashcode = new Arguments(1);
                arguments_hashcode.Add(
                    new Argument(new MemberAccess(new This(f.Location), f.Name))
                );
                Expression field_hashcode = new Invocation(
                    new MemberAccess(equality_comparer, "GetHashCode", loc),
                    arguments_hashcode
                );

                IntConstant FNV_prime = new IntConstant(Compiler.BuiltinTypes, 16777619, loc);
                rs_hashcode = new Binary(
                    Binary.Operator.Multiply,
                    new Binary(Binary.Operator.ExclusiveOr, rs_hashcode, field_hashcode),
                    FNV_prime
                );

                Expression field_to_string = new Conditional(
                    new BooleanExpression(
                        new Binary(
                            Binary.Operator.Inequality,
                            new MemberAccess(new This(f.Location), f.Name),
                            new NullLiteral(loc)
                        )
                    ),
                    new Invocation(
                    ...
                    new StringConstant(Compiler.BuiltinTypes, string.Empty, loc),
                    loc
                );
            ...
            equals_block.AddStatement(
                new StatementExpression(
                    new SimpleAssign(
                        other_variable_assign,
                        new As(equals_block.GetParameterReference(0, loc), current_type, loc),
                        loc
                    )
                )
            );

            Expression equals_test = new Binary(
                Binary.Operator.Inequality,
                other_variable,
                new NullLiteral(loc)
            );
            ...
            Method hashcode = new Method(
                this,
                new TypeExpression(Compiler.BuiltinTypes.Int, loc),
                Modifiers.PUBLIC | Modifiers.OVERRIDE | Modifiers.DEBUGGER_HIDDEN,
            ...
            var li_hash = LocalVariable.CreateCompilerGenerated(
                Compiler.BuiltinTypes.Int,
                hashcode_top,
                loc
            );
            hashcode_block.AddStatement(
                new BlockVariable(new TypeExpression(li_hash.Type, loc), li_hash)
            );
            LocalVariableReference hash_variable_assign = new LocalVariableReference(li_hash, loc);
            hashcode_block.AddStatement(
                new StatementExpression(new SimpleAssign(hash_variable_assign, rs_hashcode))
            );
            ...
            hashcode_block.AddStatement(
                new StatementExpression(
                    new CompoundAssign(
                        ...
                        hash_variable,
                        new Binary(
                            Binary.Operator.LeftShift,
                            hash_variable,
                            new IntConstant(Compiler.BuiltinTypes, 13, loc)
                        )
                    )
                )
            );
            hashcode_block.AddStatement(
                new StatementExpression(
                    new CompoundAssign(
                        Binary.Operator.ExclusiveOr,
                        hash_variable,
                        new Binary(
                            Binary.Operator.RightShift,
                            hash_variable,
                            new IntConstant(Compiler.BuiltinTypes, 7, loc)
                        )
                    )
                )
            );
                ...
                new StatementExpression(
                    new CompoundAssign(
                        ...
                        new Binary(
                            Binary.Operator.LeftShift,
                            hash_variable,
                            new IntConstant(Compiler.BuiltinTypes, 3, loc)
                        )
                    )
                )
            );
                ...
                new StatementExpression(
                    new CompoundAssign(
                        ...
                        new Binary(
                            Binary.Operator.RightShift,
                            hash_variable,
                            new IntConstant(Compiler.BuiltinTypes, 17, loc)
                        )
                    )
                )
            );
                ...
                new StatementExpression(
                    new CompoundAssign(
                        ...
                        new Binary(
                            Binary.Operator.LeftShift,
                            hash_variable,
                            new IntConstant(Compiler.BuiltinTypes, 5, loc)
                        )
                    )
                )
            );
