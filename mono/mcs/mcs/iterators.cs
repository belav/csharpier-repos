...
{
    public abstract class YieldStatement<T> : ResumableStatement
        where T : StateMachineInitializer
    {
        ...
        public void RegisterResumePoint()
        {
            ...
            {
                resume_pc = inside_try_block.AddResumePoint(
                    this,
                    resume_pc,
                    machine_initializer,
                    inside_catch_block
    ...
    public abstract class StateMachine : AnonymousMethodStorey
    {
        ...
        {
            pc_field = AddCompilerGeneratedField(
                "$PC",
                new TypeExpression(Compiler.BuiltinTypes.Int, Location)
            );

            return base.DoDefineMembers();
        }

        protected override string GetVariableMangledName(
            ResolveContext rc,
    ...
    class IteratorStorey : StateMachine
    {
        class GetEnumeratorMethod : StateMachineMethod
        {
            sealed class GetEnumeratorStatement : Statement
            {
                ...
                public override bool Resolve(BlockContext ec)
                {
                    ...
                    {
                        init = new List<Expression>(
                            host.hoisted_params == null ? 1 : host.HoistedParameters.Count + 1
                        );
                    ...
                    if (host.hoisted_params != null)
                    {
                        ...
                        for (int i = 0; i < host.hoisted_params.Count; ++i)
                        {
                            ...
                            from.InstanceExpression = new CompilerGeneratedThis(
                                ec.CurrentType,
                                loc
                            );
                    ...
                    if (new_storey != null)
                        new_storey = Convert.ImplicitConversionRequired(
                            ec,
                            new_storey,
                            host_method.MemberType,
                            loc
                        );
            ...
            public static GetEnumeratorMethod Create(
                IteratorStorey host,
                FullNamedExpression returnType,
                MemberName name
            )
        ...
        class DisposeMethod : StateMachineMethod
        {
            ...
            public DisposeMethod(IteratorStorey host)
                : base(
                    host,
                    null,
                    new TypeExpression(host.Compiler.BuiltinTypes.Void, host.Location),
        ...
        public IteratorStorey(Iterator iterator)
            : base(
                iterator.Container.ParametersBlock,
                iterator.Host,
                iterator.OriginalMethod as MemberBase,
                iterator.OriginalMethod.CurrentTypeParameters,
                "Iterator",
                MemberKind.Class
            )
        {
        ...
        protected override TypeSpec[] ResolveBaseTypes(out FullNamedExpression base_class)
        {
            ...
            if (Iterator.IsEnumerable)
            {
                ...
                {
                    generic_enumerable_type = Module
                        .PredefinedTypes
                        .IEnumerableGeneric
                        .TypeSpec
            ...
            {
                generic_enumerator_type = ienumerator_generic
                    .TypeSpec
                    .MakeGenericType(Module, new[] { mtype });
        ...
        protected override bool DoDefineMembers()
        {
            ...
            disposing_field = AddCompilerGeneratedField(
                "$disposing",
                new TypeExpression(Compiler.BuiltinTypes.Bool, Location)
            );
            ...
            if (Iterator.IsEnumerable)
            {
                FullNamedExpression explicit_iface = new TypeExpression(
                    Compiler.BuiltinTypes.IEnumerable,
                    Location
                );
                ...
                if (generic_enumerator_type != null)
                {
                    ...
                    var gname = new MemberName(
                        "GetEnumerator",
                        null,
                        explicit_iface,
                        Location.Null
                    );
                    Method gget_enumerator = GetEnumeratorMethod.Create(
                        this,
                        new TypeExpression(generic_enumerator_type, Location),
                        gname
                    );
                    ...
                    //
                    var stmt = new Return(
                        new Invocation(new DynamicMethodGroupExpr(gget_enumerator, Location), null),
                        Location
                    );
                    Method get_enumerator = GetEnumeratorMethod.Create(
                        this,
                        new TypeExpression(Compiler.BuiltinTypes.IEnumerator, Location),
                        name,
                        stmt
                    );
        ...
        void Define_Current(bool is_generic)
        {
            ...
            {
                explicit_iface = new TypeExpression(
                    Module.Compiler.BuiltinTypes.IEnumerator,
                    Location
                );
            ...
            get_block.AddStatement(
                new Return(new DynamicFieldExpr(CurrentField, Location), Location)
            );

            Property current = new Property(
                this,
                type,
                Modifiers.DEBUGGER_HIDDEN | Modifiers.COMPILER_GENERATED,
                name,
                null
            );
            current.Get = new Property.GetMethod(
                current,
    ...
    public class StateMachineMethod : Method
    {
        ...
        public StateMachineMethod(
            ...
            Modifiers mod,
            MemberName name,
            ToplevelBlock.Flags blockFlags
        )
            : base(
                host,
                returnType,
                mod | Modifiers.COMPILER_GENERATED,
                name,
                ParametersCompiled.EmptyReadOnlyParameters,
                null
            )
    ...
    public abstract class StateMachineInitializer : AnonymousExpression
    {
        ...
        protected StateMachineInitializer(
            ParametersBlock block,
            TypeDefinition host,
            TypeSpec returnType
        )
        ...
        protected override Expression DoResolve(ResolveContext rc)
        {
            ...
            {
                var move_next = new StateMachineMethod(
                    storey,
                    this,
                    new TypeExpression(ReturnType, loc),
                    Modifiers.PUBLIC,
        ...
        //
        public virtual void InjectYield(
            EmitContext ec,
            Expression expr,
            int resume_pc,
            bool unwind_protect,
    ...
    public class Iterator : StateMachineInitializer
    {
        ...
        public Method CreateFinallyHost(TryFinallyBlock block)
        {
            var method = new Method(
                storey,
                new TypeExpression(storey.Compiler.BuiltinTypes.Void, loc),
                Modifiers.COMPILER_GENERATED,
                new MemberName(
        ...
        public override void InjectYield(
            EmitContext ec,
            Expression expr,
            int resume_pc,
            bool unwind_protect,
