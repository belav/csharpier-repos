...
class C
{
    static async Task<string> TestCompositionCall_1()
    {
        return await Task
            ...
            + await Task.Factory.StartNew(() => "b").ConfigureAwait(false)
            + "c";
    }
    ...
    {
        return await M(await Task.Factory.StartNew(() => (byte)4).ConfigureAwait(false))
            .ConfigureAwait(false);
    }
    ...
    static async Task<int> TestCompositionPair_2()
    {
        return await Task
                ...
                .ConfigureAwait(false) - await Task.Factory.StartNew(() => 4).ConfigureAwait(false);
    }

    static async Task<int> TestCompositionPair_3()
    {
        return -8 * await Task.Factory.StartNew(() => 4).ConfigureAwait(false);
    }
