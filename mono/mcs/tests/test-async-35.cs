    ...
    class C
    {
        ...
        public static int Main()
        {
            ...
            var c = typeof(C)
                ...
                .Where(l => l.IsDefined(typeof(AsyncStateMachineAttribute)))
                .Count();
            ...
            var n = typeof(C)
                ...
                .Single(l => l.Name.Contains("NestedAsyncAnonymousMethod"));
            if (n == null)
                return 12;

            m = n.GetMethods(BindingFlags.NonPublic | BindingFlags.Static)
                .Single(l => l.Name.Contains("m__"));
