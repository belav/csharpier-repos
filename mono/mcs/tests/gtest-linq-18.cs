...
public class C
{
    ...
    public static int Main()
    {
        ...
        var e = from ck in x let xy = Test(c => c == ck) where ck == 'v' select Test(c => c == ck);

        var e2 = from ck in x where Test(c => c == ck) select Test(c => c == ck);
        ...
        var e5 = from a in x join b in x on Test(a2 => a2 == a) equals Test(b2 => b2 == b) select a;
