...
class Program
{
    ...
    {
        public static bool s<TVector>(Ray<TVector> ray, BoundingBoxN<TVector> box)
            where TVector : IVector<TVector>
        {
    ...
    public interface IEpsilonEquatable<
        TType,
        TEpsilon
    > // ReSharper enable TypeParameterCanBeVariant
    { }
