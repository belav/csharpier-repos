...
public class Test
{
    ...
    public static int Main()
    {
        ...
        {
            Top = { P1 = { X = 0, Y = 5 }, P2 = { X = 5, Y = 5 } },
            Bottom = { P1 = { X = 0, Y = 0 }, P2 = { X = 5, Y = 0 } },
            Right = { P1 = { X = 5, Y = 5 }, P2 = { X = 5, Y = 0 } },
            Left = { P1 = { X = 0, Y = 0 }, P2 = { X = 0, Y = 5 } },
        };
        if (
            rectangle.Top.P1.X != 0
            || rectangle.Bottom.P2.X != 5
            || rectangle.Right.P2.Y != 0
            || rectangle.Left.P1.Y != 0
        )
            return 2;
        ...
        if (
            library.Name != "New York Public Library"
            || library.PhoneNumber != "212-621-0626"
        ...
        if (
            box.Thing1.Number != 1
            || box.Thing1.Name != "Wilber"
            || box.Thing2.Number != 2
            || box.Thing2.Name != "Chris"
        )
            return 5;
        ...
        if (
            library2.Books[0] != "The Hound of Baskerville"
