...
#endif
{
    ...
    {
        var d = new Pair<string, Type>.Transform<KeyValuePair<string, Type>>(
            Pair<string, Type>.make_pair
        );
    ...
    public static int test_0_fullaot_sflda_cctor()
    {
        ...
        List<DocType> categories = documents
            .Select(d => d.Type)
            .Distinct()
            .ToList<DocType>()
            .OrderBy(d => d)
    ...
    public static int test_0_delegate_8_args()
    {
        ...
        Action<string, string, string, string, string, string, string, string> test = (
            a,
            b,
            c,
            d,
