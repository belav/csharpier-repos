...
public class EmitTest
{
    ...
    {
        ConstructorBuilder mb = genericFoo.DefineConstructor(
    ...
    {
        MethodBuilder mb = genericFoo.DefineMethod(
            "TestEvents",
            MethodAttributes.Public,
            typeof(void),
            null
    ...
    public static int Main()
    {
        ...
        TypeBuilder genericFoo = module.DefineType(
            "GenericFoo",
        ...
        TypeBuilder moduletype = module.DefineType(
            "ModuleType",
            TypeAttributes.Public,
            typeof(object)
        );
        MethodBuilder main = moduletype.DefineMethod(
            "Main",
