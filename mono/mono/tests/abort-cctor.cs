...
class Driver
{
    ...
    class StaticConstructor1
    {
        ...
        static StaticConstructor1()
        {
            try
            {
                ...
                Console.WriteLine(
                    "StaticConstructor1.StaticConstructor1 (2) waited {0}",
    ...
    static void IsStaticConstructor1Viable()
    {
        ...
        Console.WriteLine(
            "Did it get to the end? {0} Did it catch an exception {1}",
            StaticConstructor1.gotToEnd,
            StaticConstructor1.caughtException
        );
        ...
        static StaticConstructor4()
        {
            try
            {
                ...
                if (sw.ElapsedMilliseconds < 900)
                    throw new Exception("Bad abort broke our sleep");
                Console.WriteLine(
                    "StaticConstructor4.StaticConstructor4 (2) waited {0}",
                    sw.ElapsedMilliseconds
                );
                gotToEnd = true;
            }
    ...
    static void IsStaticConstructor4Viable()
    {
        ...
        Console.WriteLine(
            "IsStaticConstructor4Viable: Did it get to the end? {0} Did it catch an exception {1} and end of the finally block {2}",
            StaticConstructor4.gotToEnd,
            StaticConstructor4.caughtException,
    ...
    {
        Console.WriteLine(
            "IsStaticConstructor6Viable? got to inner finally? {0} got to outer finally? {1}",
