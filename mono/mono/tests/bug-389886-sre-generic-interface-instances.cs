...
namespace TestApp
{
    class Program
    {
        ...
        static int Main()
        {
            ...
            ConstructorBuilder parent_constructor = parent.DefineDefaultConstructor(
                MethodAttributes.Public
            );

            ConstructorBuilder ctor = child.DefineConstructor(
                MethodAttributes.Public,
            ...
            MethodBuilder foo_mb = child.DefineMethod(
                "Foo",
            ...
            MethodBuilder main_mb = main.DefineMethod(
                "Main",
