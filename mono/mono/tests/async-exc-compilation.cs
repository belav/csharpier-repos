...
class MainClass
{
    ...
    public static void Run()
    {
        try
        {
            // Call a method which takes a lot of time to compile
            // We should receive the abort exception while compiling this method
            Long(5);
    ...
    // This method should take a lot of time for the JIT to compile
    public static int Long(int arg)
    {
        // Make an inifite loop not going into unmanaged code
        while (arg == 5)
            ;
...
class MyRealProxy : RealProxy, IRemotingTypeInfo
{
    ...
    {
        get { return ""; }
        set { throw new Exception("Should not be called"); }
    }

    public bool CanCastToCalled
    {
        get { return can_cast_to_called; }
        set { can_cast_to_called = value; }
    }
}
