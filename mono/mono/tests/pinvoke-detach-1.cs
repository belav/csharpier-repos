...
public class Tests
{
    ...
    public static extern bool mono_test_attach_invoke_foreign_thread(
        string assm_name,
        string name_space,
        string class_name,
        string method_name,
    ...
    {
        was_called = 0;
        bool skipped = mono_test_attach_invoke_foreign_thread(
            typeof(Tests).Assembly.Location,
            "",
            "Tests",
            "MethodInvokedFromNative",
            null
        );
    ...
    {
        bool skipped = mono_test_attach_invoke_block_foreign_thread(
            typeof(Tests).Assembly.Location,
            "",
            "Tests",
            "MethodInvokedFromNative2",
            null
        );
        GC.Collect(); // should not hang waiting for the foreign thread
