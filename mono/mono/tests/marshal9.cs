...
public class Tests
{
    ...
    private static extern object mono_test_marshal_pass_return_custom(
        int i,
        [MarshalAs(
            UnmanagedType.CustomMarshaler,
            MarshalTypeRef = typeof(Marshal1),
    ...
    [DllImport("libtest")]
    private static extern int mono_test_marshal_pass_out_custom(
        int i,
        [
            MarshalAs(
                UnmanagedType.CustomMarshaler,
...
/* 10 + 5 + 5 + 5 */
    ...
    [DllImport("libtest")]
    private static extern int mono_test_marshal_pass_inout_custom(
        int i,
        [
            MarshalAs(
                UnmanagedType.CustomMarshaler,
    ...
    [DllImport("libtest")]
    private static extern int mono_test_marshal_pass_out_byval_custom(
        int i,
        [
            MarshalAs(
                UnmanagedType.CustomMarshaler,
    ...
    [DllImport("libtest")]
    private static extern int mono_test_marshal_pass_byref_custom(
        int i,
        [MarshalAs(
            UnmanagedType.CustomMarshaler,
            MarshalTypeRef = typeof(Marshal1),
...
/* 10 + 5 + 5 + 5 */
    ...
    private static extern object mono_test_marshal_pass_return_custom_null(
        int i,
        [MarshalAs(
            UnmanagedType.CustomMarshaler,
            MarshalTypeRef = typeof(Marshal1),
    ...
    public delegate object pass_return_int_delegate(
        [MarshalAs(
            UnmanagedType.CustomMarshaler,
            MarshalTypeRef = typeof(Marshal1),
            MarshalCookie = "5"
    ...
    [DllImport("libtest")]
    private static extern int mono_test_marshal_pass_return_custom_in_delegate(
        pass_return_int_delegate del
    );

    [DllImport("libtest")]
    private static extern int mono_test_marshal_pass_return_custom_null_in_delegate(
        pass_return_int_delegate del
    );
    ...
    public static int test_0_pass_return_delegate()
    {
        ...
        int res = mono_test_marshal_pass_return_custom_in_delegate(
            new pass_return_int_delegate(pass_return_int)
        );
    ...
    public static int test_0_pass_return_null_delegate()
    {
        ...
        int res = mono_test_marshal_pass_return_custom_null_in_delegate(
            new pass_return_int_delegate(pass_return_null)
        );
...
*/
    ...
    private static extern IntPtr mono_test_marshal_pass_return_custom2(
        ...
        [MarshalAs(
            UnmanagedType.CustomMarshaler,
            MarshalTypeRef = typeof(Marshal3),
            MarshalCookie = "5"
        )]
            object number,
        int j
...
*/
    ...
    private static extern IntPtr mono_test_marshal_pass_return_custom3(
        int i,
        [MarshalAs(
            UnmanagedType.CustomMarshaler,
            MarshalTypeRef = typeof(Marshal3),
    ...
    [DllImport("libtest", EntryPoint = "mono_test_marshal_pass_return_custom2")]
    private static extern IntPtr mono_test_marshal_pass_return_custom4(
        int i,
        [MarshalAs(
            UnmanagedType.CustomMarshaler,
            MarshalTypeRef = typeof(Marshal4),
            MarshalCookie = "5"
        )]
            object number,
        int j
    ...
    [DllImport("libtest", EntryPoint = "mono_test_marshal_pass_return_custom2")]
    private static extern IntPtr mono_test_marshal_pass_return_custom5(
        int i,
        [MarshalAs(
            UnmanagedType.CustomMarshaler,
            MarshalTypeRef = typeof(Marshal5),
            MarshalCookie = "5"
        )]
            object number,
        int j
    ...
    public delegate void custom_out_param_delegate(
        [MarshalAs(
            UnmanagedType.CustomMarshaler,
    ...
    [DllImport("libtest")]
    private static extern int mono_test_marshal_custom_out_param_delegate(
        custom_out_param_delegate del
    );
    ...
    public static int test_0_native_to_managed_custom_parameter()
    {
        ...
        int res = mono_test_marshal_custom_out_param_delegate(
            new custom_out_param_delegate(custom_out_param)
        );
