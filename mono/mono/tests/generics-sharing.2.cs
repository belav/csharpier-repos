...
namespace GenericSharingTest
{
    ...
    public class MyCons<T>
    {
        ...
        {
            Console.WriteLine(
                "car " + _car.ToString() /* + " cdr " + _cdr.ToString () */
            );
        }
        ...
        public static MyCons<T> returnList(MyCons<T> l)
        {
            return l;
        }

        public static MyCons<T> returnCdr(MyCons<T> cons)
        {
            return returnList(cons.cdr);
        }
    }
    ...
    public class MyDict<N, M>
    {
        ...
        public MyDict(N n, M m)
        {
            p = new MyPair<N, M>(n, m);
        }
    }
