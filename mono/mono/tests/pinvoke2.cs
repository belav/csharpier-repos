...
public unsafe class Tests
{
    ...
    public static extern int mono_test_marshal_bool_in_as_I1(
        [MarshalAs(UnmanagedType.I1)] bool bTrue,
        [MarshalAs(UnmanagedType.I1)] bool bFalse
    );

    [DllImport("libtest", EntryPoint = "mono_test_marshal_bool_in_as_I1_U1")]
    public static extern int mono_test_marshal_bool_in_as_U1(
        [MarshalAs(UnmanagedType.U1)] bool bTrue,
        [MarshalAs(UnmanagedType.U1)] bool bFalse
    );

    [DllImport("libtest", EntryPoint = "mono_test_marshal_bool_out_as_I1_U1")]
    public static extern int mono_test_marshal_bool_out_as_I1(
        [MarshalAs(UnmanagedType.I1)] out bool bTrue,
        [MarshalAs(UnmanagedType.I1)] out bool bFalse
    );

    [DllImport("libtest", EntryPoint = "mono_test_marshal_bool_out_as_I1_U1")]
    public static extern int mono_test_marshal_bool_out_as_U1(
        [MarshalAs(UnmanagedType.U1)] out bool bTrue,
        [MarshalAs(UnmanagedType.U1)] out bool bFalse
    );

    [DllImport("libtest", EntryPoint = "mono_test_marshal_bool_ref_as_I1_U1")]
    public static extern int mono_test_marshal_bool_ref_as_I1(
        [MarshalAs(UnmanagedType.I1)] ref bool bTrue,
        [MarshalAs(UnmanagedType.I1)] ref bool bFalse
    );

    [DllImport("libtest", EntryPoint = "mono_test_marshal_bool_ref_as_I1_U1")]
    public static extern int mono_test_marshal_bool_ref_as_U1(
        [MarshalAs(UnmanagedType.U1)] ref bool bTrue,
        [MarshalAs(UnmanagedType.U1)] ref bool bFalse
    );
    ...
    public static extern int mono_test_marshal_unicode_string_array(
        string[] a1,
        [MarshalAs(UnmanagedType.LPArray, ArraySubType = UnmanagedType.LPStr)] string[] a2
    );
    ...
    public static extern int mono_test_marshal_out_array(
        [Out] [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] int[] a1,
        int n
    );

    [DllImport("libtest", EntryPoint = "mono_test_marshal_out_byref_array_out_size_param")]
    public static extern int mono_test_marshal_out_byref_array_out_size_param(
        [Out] [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] out int[] a1,
        out int n
    );

    [DllImport("libtest", EntryPoint = "mono_test_marshal_out_lparray_out_size_param")]
    public static extern int mono_test_marshal_out_lparray_out_size_param(
        [Out] [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] int[] a1,
        out int n
    );
    ...
    public static extern int mono_test_marshal_byref_struct(
        ref SimpleStruct ss,
        bool a,
        bool b,
        bool c,
    ...
    [DllImport("libtest", EntryPoint = "mono_test_marshal_byref_struct")]
    public static extern int mono_test_marshal_byref_struct_in(
        [In] ref SimpleStruct ss,
        bool a,
        bool b,
        bool c,
        String d
    ...
    [DllImport("libtest", EntryPoint = "mono_test_marshal_byref_struct")]
    public static extern int mono_test_marshal_byref_struct_inout(
        [In, Out] ref SimpleStruct ss,
        bool a,
        bool b,
        bool c,
        String d
    ...
    public static extern int mono_test_marshal_lpstruct(
        [In, MarshalAs(UnmanagedType.LPStruct)] SimpleStruct ss
    );

    [DllImport("libtest", EntryPoint = "mono_test_marshal_lpstruct_blittable")]
    public static extern int mono_test_marshal_lpstruct_blittable(
        [In, MarshalAs(UnmanagedType.LPStruct)] Point p
    );
    ...
    public static extern SimpleClass mono_test_marshal_class(
        int i,
        int j,
        int k,
        SimpleClass ss,
    ...
    [DllImport(
        "libtest",
        EntryPoint = "mono_test_marshal_stringbuilder_out_unicode",
        CharSet = CharSet.Unicode
    )]
    ...
    [DllImport(
        "libtest",
        EntryPoint = "mono_test_marshal_stringbuilder_utf16_tolower",
        CharSet = CharSet.Unicode
    )]
    public static extern void mono_test_marshal_stringbuilder_utf16_tolower(
        StringBuilder sb,
        int len
    );
    ...
    public static extern void mono_test_marshal_stringbuilder_utf16_tolower_in(
        [In] StringBuilder sb,
        int len
    );
    ...
    public static extern int mono_test_asany_unicode(
    ...
    */
    ...
    {
        return mono_test_marshal_unicode_string_array(
            new String[] { "ABC", "DEF" },
            new String[] { "ABC", "DEF" }
        );
    }
    ...
    public static extern Amd64Struct1 mono_test_marshal_amd64_pass_return_struct1_many_args(
        Amd64Struct1 s,
        int i1,
        int i2,
        int i3,
    ...
    public static int test_0_amd64_struct1_many_args()
    {
        ...
        Amd64Struct1 s2 = mono_test_marshal_amd64_pass_return_struct1_many_args(
            s,
            1,
            2,
            3,
    ...
    public static extern TestStruct5 mono_test_marshal_ia64_pass_return_struct5(
        double d1,
        double d2,
        TestStruct5 s,
        int i,
    ...
    public static extern TestStruct6 mono_test_marshal_ia64_pass_return_struct6(
        double d1,
        double d2,
        TestStruct6 s,
        int i,
    ...
    [DllImport("libtest", EntryPoint = "mono_test_marshal_amd64_pass_return_struct1")]
    public static extern Amd64Struct1Gen<int> mono_test_marshal_amd64_pass_return_struct1_gen(
        Amd64Struct1Gen<int> s
    );
    ...
    */
    ...
    private static extern string mono_test_marshal_lpwstr_marshal2(string s, int length);
    ...
    private static extern void mono_test_marshal_lpwstr_out_marshal2(out string s);
    ...
    [DllImport(
        "libtest",
        EntryPoint = "mono_test_marshal_unicode_char_array",
        CharSet = CharSet.Unicode
    )]
    ...
    [DllImport(
        "libtest",
        EntryPoint = "_mono_test_native_thiscall1",
    ...
    [DllImport(
        "libtest",
        EntryPoint = "_mono_test_native_thiscall2",
        CallingConvention = CallingConvention.ThisCall
    )]
    ...
    [DllImport(
        "libtest",
        EntryPoint = "_mono_test_native_thiscall3",
        CallingConvention = CallingConvention.ThisCall
    )]
    ...
    public static int test_0_native_thiscall()
    {
        ...
        if (
            mono_test_native_thiscall(new TinyStruct(1288082683), -421187449, -1733670329)
            != -866775098
        )
            return 6;
    ...
    [DllImport(
        "libtest",
        EntryPoint = "_mono_test_managed_thiscall1",
        CallingConvention = CallingConvention.StdCall
    )]
    ...
    [DllImport(
        "libtest",
        EntryPoint = "_mono_test_managed_thiscall2",
        CallingConvention = CallingConvention.StdCall
    )]
    ...
    [DllImport(
        "libtest",
        EntryPoint = "_mono_test_managed_thiscall3",
        CallingConvention = CallingConvention.StdCall
    )]
    ...
    public static int test_0_managed_thiscall()
    {
        ...
        if (
            mono_test_managed_thiscall(new ThisCallDelegate1(thiscall_test_fn1), 517457506)
            != 263895844
        )
            return 1;

        if (
            mono_test_managed_thiscall(
                new ThisCallDelegate2(thiscall_test_fn2),
                562348159,
                -1982007353
            ) != -1877791296
        )
        ...
        if (
            mono_test_managed_thiscall(
                new ThisCallDelegate3(thiscall_test_fn3),
                -316986071,
                1233912683,
                1244266772
            ) != 1545254036
        ...
        if (
            mono_test_managed_thiscall(new ThisCallDelegateS1(thiscall_test_fn1), 517457506)
            != 263895844
        )
            return 4;
        ...
        if (
            mono_test_managed_thiscall(
                new ThisCallDelegateS2(thiscall_test_fn2),
                562348159,
                -1982007353
            ) != -1877791296
        )
        ...
        if (
            mono_test_managed_thiscall(
                new ThisCallDelegateS3(thiscall_test_fn3),
                -316986071,
                1233912683,
                1244266772
            ) != 1545254036
