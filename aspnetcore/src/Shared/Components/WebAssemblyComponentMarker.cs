...
internal struct WebAssemblyComponentMarker
{
    ...
    public WebAssemblyComponentMarker(
        string type,
        string assembly,
        string typeName,
        ...
        (Type, Assembly, TypeName, ParameterDefinitions, ParameterValues, PrerenderId) = (
            type,
            assembly,
            typeName,
    ...
    internal static WebAssemblyComponentMarker NonPrerendered(
        string assembly,
        string typeName,
        string parameterDefinitions,
        string parameterValues
    ) =>
        new WebAssemblyComponentMarker(
            ClientMarkerType,
            assembly,
            typeName,
            parameterDefinitions,
    ...
    internal static WebAssemblyComponentMarker Prerendered(
        string assembly,
        string typeName,
        string parameterDefinitions,
        string parameterValues
