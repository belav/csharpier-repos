...
namespace Common.Tests.Tests.System.Net.aspnetcore.Http3
{
    public class VariableLengthIntegerHelperTests
    {
        ...
        public void TryRead_FromReadOnlySpan_BufferEmpty()
        {
            ...
            bool isSuccess = VariableLengthIntegerHelper.TryRead(
                readOnlySpan,
                out long value,
                out int bytesRead
            );
        ...
        {
            ReadOnlySpan<byte> readOnlySpan = new ReadOnlySpan<byte>(new byte[] { 1 });
            bool isSuccess = VariableLengthIntegerHelper.TryRead(
                readOnlySpan,
                out long value,
                out int bytesRead
        ...
        {
            ReadOnlySpan<byte> readOnlySpan = new ReadOnlySpan<byte>(new byte[] { 64, 1 });
            bool isSuccess = VariableLengthIntegerHelper.TryRead(
                readOnlySpan,
                out long value,
                out int bytesRead
        ...
        {
            ReadOnlySpan<byte> readOnlySpan = new ReadOnlySpan<byte>(new byte[] { 64 });
            bool isSuccess = VariableLengthIntegerHelper.TryRead(
                readOnlySpan,
                out long value,
                out int bytesRead
        ...
        {
            ReadOnlySpan<byte> readOnlySpan = new ReadOnlySpan<byte>(new byte[] { 128, 0, 0, 2 });
            bool isSuccess = VariableLengthIntegerHelper.TryRead(
                readOnlySpan,
                out long value,
                out int bytesRead
        ...
        {
            ReadOnlySpan<byte> readOnlySpan = new ReadOnlySpan<byte>(new byte[] { 128 });
            bool isSuccess = VariableLengthIntegerHelper.TryRead(
                readOnlySpan,
                out long value,
                out int bytesRead
        ...
        {
            ReadOnlySpan<byte> readOnlySpan = new ReadOnlySpan<byte>(new byte[] { 192 });
            bool isSuccess = VariableLengthIntegerHelper.TryRead(
                readOnlySpan,
                out long value,
                out int bytesRead
        ...
        {
            ReadOnlySequence<byte> readOnlySequence = new ReadOnlySequence<byte>(new byte[] { 1 });
        ...
        public void TryRead_FromSequenceReader_InitialFourByteLengthMask_SegmentedSequence()
        {
            ...
            MemorySegment<byte> memorySegment2 = memorySegment1.Append(
                new byte[] { 0, 0, 0, 0, 0, 0, 2 }
            );
            ReadOnlySequence<byte> readOnlySequence = new ReadOnlySequence<byte>(
                memorySegment1,
                0,
        ...
        public void GetInteger_ValidSegmentedSequence()
        {
            ...
            long result = VariableLengthIntegerHelper.GetInteger(
                readOnlySequence,
        ...
        public void TryWrite_BufferEmpty()
        {
            ...
            long longToEncode = 1;
            bool isSuccess = VariableLengthIntegerHelper.TryWrite(
                span,
                longToEncode,
        ...
        public void TryWrite_BufferNotEmpty_TwoByteLimit(long longToEncode, byte[] expected)
        {
        ...
        public void TryWrite_BufferNotEmpty_FourByteLimit(long longToEncode, byte[] expected)
        {
        ...
        public void TryWrite_BufferNotEmpty_EightByteLimit(long longToEncode, byte[] expected)
        {
