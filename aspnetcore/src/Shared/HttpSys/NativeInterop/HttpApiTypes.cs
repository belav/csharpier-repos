...
internal static unsafe class HttpApiTypes
{
    ...
    internal const int SniPropertySizeInBytes =
        (sizeof(ushort) * (HTTP_REQUEST_PROPERTY_SNI_HOST_MAX_LENGTH + 1)) + sizeof(uint);
    ...
    internal struct HTTP_REQUEST_PROPERTY_SNI
    {
        [MarshalAs(
            ...
            SizeConst = HTTP_REQUEST_PROPERTY_SNI_HOST_MAX_LENGTH + 1
        )]
