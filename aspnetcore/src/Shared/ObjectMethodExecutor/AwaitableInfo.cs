...
namespace Microsoft.Extensions.Internal
{
    internal readonly struct AwaitableInfo
    {
        ...
        public static bool IsTypeAwaitable(Type type, out AwaitableInfo awaitableInfo)
        {
            ...
            var isCompletedProperty = awaiterType.GetRuntimeProperties()
                .FirstOrDefault(
                    p =>
            ...
            var implementsINotifyCompletion = awaiterInterfaces.Any(
                t => t == typeof(INotifyCompletion)
            );
            ...
            var implementsICriticalNotifyCompletion = awaiterInterfaces.Any(
                t => t == typeof(ICriticalNotifyCompletion)
            );
            ...
            var getResultMethod = awaiterType.GetRuntimeMethods()
