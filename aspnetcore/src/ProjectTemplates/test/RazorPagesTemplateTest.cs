...
public class RazorPagesTemplateTest : LoggedTest
{
    ...
    public Task RazorPagesTemplate_IndividualAuth_LocalDb(bool useProgramMain) =>
        RazorPagesTemplate_IndividualAuth_Core(useLocalDB: true, useProgramMain);
    ...
    public Task RazorPagesTemplate_IndividualAuth(bool useProgramMain) =>
        RazorPagesTemplate_IndividualAuth_Core(useLocalDB: false, useProgramMain);
