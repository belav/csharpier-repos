...
{
    public BlazorWasmTemplateAuthTest(ProjectFactoryFixture projectFactory) : base(projectFactory)
    { }
    ...
    [ConditionalFact]
    [SkipOnHelix(
        "https://github.com/dotnet/aspnetcore/issues/34554",
        Queues = "Windows.10.Arm64v8.Open"
    )]
    ...
    )
    {
        ...
        var args = new[]
        {
            ArgConstants.Hosted,
            useLocalDb ? "-uld" : "",
            useProgramMain ? ArgConstants.UseProgramMain : "",
            noHttps ? ArgConstants.NoHttps : ""
        };
    ...
    public static TheoryData<TemplateInstance> TemplateDataIndividualB2C =>
        new TheoryData<TemplateInstance>
        {
            new TemplateInstance(
                ...
                ArgConstants.Domain,
                "my-domain",
                ArgConstants.DefaultScope,
                "full",
                ArgConstants.AppIdUri,
                "ApiUri",
                ArgConstants.AppIdClientId,
                "1234123413241324"
            ),
            new TemplateInstance(
                "blazorwasmhostedaadb2c_program_main",
                "IndividualB2C",
                ArgConstants.Hosted,
                ArgConstants.AadB2cInstance,
                "example.b2clogin.com",
    ...
    public static TheoryData<TemplateInstance> TemplateDataSingleOrg =>
        new TheoryData<TemplateInstance>
        {
            ...
            new TemplateInstance(
                ...
                "SingleOrg",
                ArgConstants.Hosted,
                ArgConstants.CalledApiUrl,
                "\"https://graph.microsoft.com\"",
                ArgConstants.CalledApiScopes,
                "user.readwrite",
                ArgConstants.Domain,
                "my-domain",
                ArgConstants.TenantId,
    ...
    public static TheoryData<TemplateInstance> TemplateDataSingleOrgProgramMain =>
        new TheoryData<TemplateInstance>
        {
            ...
            new TemplateInstance(
                "blazorwasmhostedaadgraph_program_main",
                "SingleOrg",
                ArgConstants.Hosted,
                ArgConstants.CallsGraph,
                ArgConstants.Domain,
            ...
            new TemplateInstance(
                "blazorwasmhostedaadapi_program_main",
                "SingleOrg",
                ArgConstants.Hosted,
                ArgConstants.CalledApiUrl,
                "\"https://graph.microsoft.com\"",
