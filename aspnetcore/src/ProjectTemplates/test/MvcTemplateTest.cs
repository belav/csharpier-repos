...
public class MvcTemplateTest : LoggedTest
{
    ...
    public Task MvcTemplate_IndividualAuth_LocalDb(bool useProgramMain) =>
        MvcTemplate_IndividualAuth_Core(useLocalDB: true, useProgramMain);
    ...
    public Task MvcTemplate_IndividualAuth(bool useProgramMain) =>
        MvcTemplate_IndividualAuth_Core(useLocalDB: false, useProgramMain);
