...
namespace Templates.Test
{
    public class BlazorWasmTemplateTest : BlazorTemplateTest
    {
        ...
        private void ValidatePublishedServiceWorker(Project project)
        {
            ...
            var serviceWorkerAssetsManifestContents = ReadFile(
                publishDir,
        ...
        )
        {
            ...
            var clientsProperty = element.GetProperty("IdentityServer")
                .EnumerateObject()
                .Single()
                .Value.EnumerateObject()
                .Single();
            var replacedSection = element.GetRawText()
                .Replace(
                    clientsProperty.Name,
                    serverProject.ProjectName.Replace(".Server", ".Client")
                );
            ...
            var migrationsResult = await serverProject.RunDotNetEfCreateMigrationAsync(
                "blazorwasm"
            );
            Assert.True(
