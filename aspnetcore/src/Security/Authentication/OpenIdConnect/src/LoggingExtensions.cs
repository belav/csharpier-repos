...
namespace Microsoft.Extensions.Logging
{
    internal static class LoggingExtensions
    {
        private static Action<
            ILogger,
            Exception?
        > _redirectToIdentityProviderForSignOutHandledResponse;
        ...
        static LoggingExtensions()
        {
            ...
            _enteringOpenIdAuthenticationHandlerHandleUnauthorizedAsync =
                LoggerMessage.Define<string>(
                    eventId: new EventId(
                        4,
                        "EnteringOpenIdAuthenticationHandlerHandleUnauthorizedAsync"
                    ),
            ...
            _enteringOpenIdAuthenticationHandlerHandleRemoteAuthenticateAsync =
                LoggerMessage.Define<string>(
                    eventId: new EventId(
                        9,
                        "EnteringOpenIdAuthenticationHandlerHandleRemoteAuthenticateAsync"
                    ),
                    logLevel: LogLevel.Trace,
        ...
        public static void ResponseErrorWithStatusCode(
            this ILogger logger,
            string error,
            string errorDescription,
            string errorUri,
