...
namespace Microsoft.AspNetCore.Authentication.OpenIdConnect
{
          ...
          IAuthenticationSignOutHandler
    {
        ...
        private async Task HandleChallengeAsyncInternal(AuthenticationProperties properties)
        {
            ...
            var message = new OpenIdConnectMessage
            {
                ...
                Scope = string
                    .Join(
                        " ",
                        properties.GetParameter<ICollection<string>>(
            ...
            if (HttpMethods.IsGet(Request.Method))
            {
                ...
                )
                {
                    ...
                    return HandleRequestResult.Fail(
                        "An OpenID Connect response cannot contain an "
            ...
            try
            {
                ...
                if (!string.IsNullOrEmpty(authorizationResponse.Code))
                {
                    var authorizationCodeReceivedContext =
                        await RunAuthorizationCodeReceivedEventAsync(
                            authorizationResponse,
                            user,
                            properties!,
                            jwt
                    ...
                    var tokenEndpointRequest =
                        authorizationCodeReceivedContext.TokenEndpointRequest;
                    ...
                    var tokenEndpointUser = ValidateToken(
                        tokenEndpointResponse.IdToken,
                        properties,
                        validationParameters,
                        out var tokenEndpointJwt
                    );
        ...
        )
        {
            ...
            {
                properties.Items[OpenIdConnectSessionProperties.SessionState] =
        ...
        )
        {
            ...
            var responseMessage = await Backchannel.SendAsync(
                requestMessage,
