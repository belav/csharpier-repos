...
namespace Microsoft.Extensions.Logging
{
    internal static class LoggingExtensions
    {
        private static readonly Action<
            ...
            string,
            Exception?
        > _authenticationSchemeAuthenticated;
        private static readonly Action<
            ILogger,
            string,
            Exception?
        > _authenticationSchemeNotAuthenticated;
        private static readonly Action<
            ILogger,
            string,
            string,
        ...
        private static readonly Action<
            ...
            string,
            Exception?
        > _unexpectedCorrelationCookieValue;
        ...
        public static void AuthenticationSchemeNotAuthenticatedWithFailure(
            this ILogger logger,
            string authenticationScheme,
        ...
        public static void UnexpectedCorrelationCookieValue(
            this ILogger logger,
            string cookieName,
            string cookieValue
        )
