...
public static class AuthenticationServiceCollectionExtensions
{
    ...
    /// <returns>A <see cref="AuthenticationBuilder"/> that can be used to further configure
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    /// <summary>
    /// Registers services required by authentication services. <paramref name="defaultScheme"/>
    ...
    /// <summary>
    /// Registers services required by authentication services and configures <see
    // cref="AuthenticationOptions"/>.
    /// </summary>
    /// <param name="services">The <see cref="IServiceCollection"/>.</param>
