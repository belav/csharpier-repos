...
/// See <see
// href="https://learn.microsoft.com/azure/active-directory/develop/v2-oauth2-auth-code-flow#request-an-authorization-code"/>
// for reference.
/// </summary>
public class MicrosoftChallengeProperties : OAuthChallengeProperties
{
    ...
    /// <summary>
    /// Gets or sets the value for the <c>response_mode</c> parameter used for a challenge request. The
    // response mode specifies the method
    /// that should be used to send the resulting token back to the app. Can be one of the following:
    // <c>query</c>, <c>fragment</c>, <c>form_post</c>.
    /// </summary>
    [Obsolete("This parameter is not supported in MicrosoftAccountHandler.")]
    ...
    /// <para>
    /// If included, authentication will skip the email-based discovery process that user goes through
    // on the sign-in page,
    ...
    /// <para>
    /// Can be used to pre-fill the username/email address field of the sign-in page for the user, if
    // their username is known ahead of time.
    /// </para>
    /// </summary>
    ...
    /// <para>
    /// Indicates the type of user interaction that is required. The only valid values at this time are
    // login, none, and consent.
    /// </para>
    /// </summary>
