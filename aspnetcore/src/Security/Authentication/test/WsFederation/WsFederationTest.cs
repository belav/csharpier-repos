    ...
    public class WsFederationTest
    {
        ...
        public async Task MissingConfigurationThrows()
        {
            using var host = new HostBuilder()
                .ConfigureWebHost(
                    builder => builder.UseTestServer().Configure(ConfigureApp).ConfigureServices(
                            services =>
                            {
        ...
        public async Task ValidTokenIsAccepted()
        {
            ...
            request.Content = CreateSignInContent(
                "WsFederation/ValidToken.xml",
                queryItems["wctx"]
            );
        ...
        public async Task ValidUnsolicitedTokenIsRefused()
        {
            ...
            Assert.Contains(
                "Unsolicited logins are not allowed.",
        ...
        public async Task ValidUnsolicitedTokenIsAcceptedWhenAllowed()
        {
            ...
            var response = await httpClient.PostAsync(
                httpClient.BaseAddress + "signin-wsfed",
                form
            );
                                ...
                                services.AddAuthentication(
                                    ...
                                    options =>
                                    {
                                        ...
                                        options.SecurityTokenHandlers =
                                            ...
                                            {
                                                new TestSecurityTokenValidator()
                                            };
                                        ...
                                        options.Events = new WsFederationEvents()
                                        {
                                            ...
                                            {
                                                context.HttpContext.Items["AuthenticationFailed"] =
                                                    true;
                                            ...
                                            {
                                                context.Response.Headers["EventHeader"] =
                                                    "OnRemoteSignOut";
                                                return Task.FromResult(0);
                                            }
                                        };
