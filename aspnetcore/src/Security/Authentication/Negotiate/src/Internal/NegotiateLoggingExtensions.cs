...
namespace Microsoft.Extensions.Logging
{
    internal static class NegotiateLoggingExtensions
    {
        ...
        public static void Reauthenticating(this ILogger logger) => _reauthenticating(logger, null);

        public static void Deferring(this ILogger logger) => _deferring(logger, null);
