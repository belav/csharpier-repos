    ...
    internal static class LoggingExtensions
    {
        ...
        static LoggingExtensions()
        {
            ...
            _certFailedValidation = LoggerMessage.Define<string, string>(
                ...
                logLevel: LogLevel.Warning,
                formatString: "Certificate validation failed, subject was {Subject}."
                    + Environment.NewLine
                    + "{ChainErrors}"
            );
        ...
        public static void CertificateFailedValidation(
            this ILogger logger,
            string subject,
        ...
        )
        {
            _certFailedValidation(
                logger,
                subject,
                String.Join(Environment.NewLine, chainedErrors),
                null
            );
        }
    }
