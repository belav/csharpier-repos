...
public class FacebookOptions : OAuthOptions
{
    ...
    /// </summary>
    /// <remarks>See <see
    // href="https://developers.facebook.com/docs/graph-api/security#appsecret_proof"/> for more
    // details.</remarks>
    ...
    /// </summary>
    /// <remarks>See <see href="https://developers.facebook.com/docs/graph-api/reference/user"/> for
    // more details.</remarks>
    /// <value>
    /// Defaults to include the following fields if none are specified: "name", "email", "first_name",
    // and "last_name".
    /// </value>
