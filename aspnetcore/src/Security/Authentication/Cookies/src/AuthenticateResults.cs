...
internal static class AuthenticateResults
{
    ...
    internal static AuthenticateResult MissingSessionId = AuthenticateResult.Fail(
        "SessionId missing"
    );
    internal static AuthenticateResult MissingIdentityInSession = AuthenticateResult.Fail(
        "Identity missing in session store"
    );
