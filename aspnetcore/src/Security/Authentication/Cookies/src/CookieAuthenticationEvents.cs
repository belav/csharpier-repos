...
namespace Microsoft.AspNetCore.Authentication.Cookies
{
    ...
    public class CookieAuthenticationEvents
    {
        ...
        /// </summary>
        public Func<
            RedirectContext<CookieAuthenticationOptions>,
            Task
        > OnRedirectToLogin { get; set; } =
            context =>
            {
        ...
        public Func<
            RedirectContext<CookieAuthenticationOptions>,
            Task
        > OnRedirectToAccessDenied { get; set; } =
            context =>
            {
                if (IsAjaxRequest(context.Request))
                {
        ...
        public virtual Task RedirectToLogout(
        ...
        /// </summary>
        /// <param name="context">The <see cref="RedirectContext{TOptions}"/>.</param>
        public virtual Task RedirectToReturnUrl(
            RedirectContext<CookieAuthenticationOptions> context
