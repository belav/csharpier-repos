...
/// <summary>
/// Encapsulates a failure result of <see
// cref="IAuthorizationService.AuthorizeAsync(ClaimsPrincipal, object,
...
public class AuthorizationFailure
{
    ...
    /// <summary>
    /// Failure was due to these requirements not being met via <see
    ...
    /// <summary>
    /// Allows <see cref="IAuthorizationHandler"/> to flow more detailed reasons for why authorization
    // failed.
    /// </summary>
    ...
    /// <summary>
    /// Return a failure due to <see
    // cref="AuthorizationHandlerContext.Fail(AuthorizationFailureReason)"/> being called.
    /// </summary>
    /// <returns>The failure.</returns>
    ...
    /// <summary>
    /// Return a failure due to some requirements not being met via <see
    // cref="AuthorizationHandlerContext.Succeed(IAuthorizationRequirement)"/>.
    /// </summary>
