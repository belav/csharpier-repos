...
{
    /// <summary>
    /// Adds the <see cref="CookiePolicyMiddleware"/> handler to the specified <see
    // cref="IApplicationBuilder"/>, which enables cookie policy capabilities.
    /// </summary>
    ...
    /// </summary>
    /// <param name="app">The <see cref="IApplicationBuilder"/> to add the handler to.</param>
    /// <param name="options">A <see cref="CookiePolicyOptions"/> that specifies options for the
    // handler.</param>
    /// <returns>A reference to this instance after the operation has completed.</returns>
