...
public class ResponseTrailersTests : LoggedTest
{
    ...
    [MinimumOSVersion(
        ...
        "10.0.19529",
        SkipReason = "Requires HTTP/2 Trailers support."
    )]
    ...
    public async Task ResponseTrailers_WithContentLengthBody_TrailersNotSent()
    {
        ...
        var responseFinished = new TaskCompletionSource(
        ...
        )
        {
            ...
            Assert.Equal(
                ...
                response.Content.Headers.GetValues(HeaderNames.ContentLength).Single()
            );
    ...
    public async Task ResponseTrailers_WithTrailersBeforeContentLengthBody_TrailersSent()
    {
        ...
        )
        {
            ...
            Assert.Equal(
                (2 * body.Length).ToString(CultureInfo.InvariantCulture),
                contentLength.First()
            );
    ...
    {
        var trailersReceived = new TaskCompletionSource(
            TaskCreationOptions.RunContinuationsAsynchronously
        );
        using (
            Utilities.CreateDynamicHttpsServer(
    ...
    public async Task ResponseTrailers_MultipleValues_SentAsSeparateHeaders()
    {
        ...
        )
        {
            ...
            Assert.Equal(
                ...
                response.TrailingHeaders.GetValues("TrailerName")
            );
        }
    }
    ...
    public async Task ResponseTrailers_LargeTrailers_Success()
    {
        ...
        )
        {
            ...
            Assert.Equal(
                values,
                response.TrailingHeaders.GetValues("ThisIsALongerHeaderNameThatStillWorksForReals")
            );
        }
    }
    ...
    public async Task ResponseTrailers_NullValues_Ignored(
        string headerName,
