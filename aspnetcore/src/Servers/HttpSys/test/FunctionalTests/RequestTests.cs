...
namespace Microsoft.AspNetCore.Server.HttpSys
{
    public class RequestTests
    {
        ...
        [InlineData(
            "/base葉path/",
            "/base%E8%91%89path/sub%E8%91%89path",
            "/base葉path",
            "/sub葉path"
        )]
        [InlineData("/basepath/", "/basepath/sub%2Fpath", "/basepath", "/sub%2Fpath")]
        public async Task Request_PathSplitting(
            string pathBase,
            string requestPath,
        ...
        public async Task Request_MultiplePrefixes(
            string requestPath,
            string expectedPathBase,
            string expectedPath
        ) {
        ...
        public async Task Request_WithNavigation_Removed(
            string basePath,
            string input,
            string expectedPathBase,
            string expectedPath
        ...
        public async Task Request_ControlCharacters_400()
        {
            ...
            using (
                ...
                for (var i = 0; i < 32; i++)
                {
                    ...
                    var responseStatusCode = response.Substring(9); // Skip "HTTP/1.1 "
                    Assert.True(
                        string.Equals("400", responseStatusCode),
