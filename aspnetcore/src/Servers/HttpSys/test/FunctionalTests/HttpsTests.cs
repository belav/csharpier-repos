    ...
    public class HttpsTests
    {
        ...
        public async Task Https_SetsITlsHandshakeFeature()
        {
            ...
            )
            {
                ...
                var cipherAlgorithm = (CipherAlgorithmType)result.GetProperty("cipherAlgorithm")
                    .GetInt32();
                Assert.True(
                ...
                var hashAlgorithm = (HashAlgorithmType)result.GetProperty("hashAlgorithm")
                    .GetInt32();
                Assert.True(
                    ...
                    async httpContext =>
                    {
                        try
                        {
                            ...
                            unsafe
                            {
                                ...
                                tlsCopy =
                                    Marshal.PtrToStructure<HttpApiTypes.HTTP_SSL_PROTOCOL_INFO>(
