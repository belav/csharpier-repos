...
namespace Microsoft.AspNetCore.Server.HttpSys.FunctionalTests
{
    public class Http2Tests : LoggedTest
    {
        ...
        [MinimumOSVersion(
            ...
            SkipReason = "Http2 requires Win10"
        )]
        public async Task EmptyResponse_200()
        {
            using var server = Utilities.CreateDynamicHttpsServer(
                out var address,
                httpContext =>
                {
            ...
            await new HostBuilder().UseHttp2Cat(
                    address,
                    async h2Connection =>
                    {
        ...
        public async Task RequestWithoutData_LengthRequired_Rejected(string method)
        {
            ...
            await new HostBuilder().UseHttp2Cat(
                    ...
                    async h2Connection =>
                    {
                        ...
                        var dataFrame = await h2Connection.ReceiveFrameAsync();
                        Http2Utilities.VerifyDataFrame(
                            dataFrame,
                            1,
                            endOfStream: false,
                            length: 344
        ...
        public async Task RequestWithoutData_Success(string method)
        {
            using var server = Utilities.CreateDynamicHttpsServer(
                ...
                httpContext =>
                {
                    ...
                    Assert.False(
                        httpContext.Request.Headers.ContainsKey(HeaderNames.TransferEncoding)
                    );
                    return Task.CompletedTask;
                }
            );
        ...
        public async Task RequestWithDataAndContentLength_Success(string method)
        {
            ...
            await new HostBuilder().UseHttp2Cat(
                    ...
                    async h2Connection =>
                    {
                        ...
                        Assert.Equal(
                            "Hello World",
                            Encoding.UTF8.GetString(dataFrame.Payload.Span)
                        );
        ...
        public async Task RequestWithDataAndNoContentLength_Success(string method)
        {
            using var server = Utilities.CreateDynamicHttpsServer(
                ...
                httpContext =>
                {
                    ...
                    Assert.Equal(
                        "chunked",
                        httpContext.Request.Headers[HeaderNames.TransferEncoding]
                    );
                    return httpContext.Request.Body.CopyToAsync(httpContext.Response.Body);
                }
            );
        ...
        [MaximumOSVersion(
            OperatingSystems.Windows,
            WindowsVersions.Win10_19H1,
            SkipReason = "This is last version without GoAway support"
        )]
        ...
        [MinimumOSVersion(
            OperatingSystems.Windows,
            WindowsVersions.Win10_19H2,
            SkipReason = "GoAway support was added in Win10_19H2."
        )]
                        ...
                        for (var i = 1; i < 200; i++)
                        {
                            ...
                            await h2Connection.ReceiveHeadersAsync(
                                ...
                                decodedHeaders =>
                                {
                                    // HTTP/2 filters out the connection header
                                    Assert.False(
                                        decodedHeaders.ContainsKey(HeaderNames.Connection)
                                    );
                                    Assert.Equal("200", decodedHeaders[HeaderNames.Status]);
                                }
                            );
        ...
        [MaximumOSVersion(
            OperatingSystems.Windows,
            WindowsVersions.Win10_20H1,
            SkipReason = "This is last version without custom Reset support"
        )]
        public async Task AppException_AfterHeaders_PriorOSVersions_ResetCancel()
        {
            ...
            await new HostBuilder().UseHttp2Cat(
                    ...
                    async h2Connection =>
                    {
                        ...
                        Http2Utilities.VerifyResetFrame(
                            resetFrame,
                            expectedStreamId: 1,
        ...
        [MaximumOSVersion(
            ...
            SkipReason = "This is last version without Reset support"
        )]
        ...
        {
            var appResult = new TaskCompletionSource<int>(
            ...
            await new HostBuilder().UseHttp2Cat(
                    ...
                    async h2Connection =>
                    {
                        ...
                        Http2Utilities.VerifyResetFrame(
                            resetFrame,
                            expectedStreamId: 1,
                            expectedErrorCode: (Http2ErrorCode)1111
                        );
        ...
        public async Task Reset_BeforeRequestBody_Resets()
        {
            ...
            await new HostBuilder().UseHttp2Cat(
                    ...
                    async h2Connection =>
                    {
                        ...
                        await h2Connection.StartStreamAsync(
                            1,
                            Http2Utilities.PostRequestHeaders,
                            endStream: false
                        );
            ...
            await new HostBuilder().UseHttp2Cat(
                    ...
                    async h2Connection =>
                    {
                        ...
                        Http2Utilities.VerifyResetFrame(
                            resetFrame,
                            expectedStreamId: 1,
                            expectedErrorCode: Http2ErrorCode.NO_ERROR
                        );
