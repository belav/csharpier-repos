...
public enum RequestQueueMode
{
    ...
    /// <summary>
    /// Attach to an existing queue with the name given. This will fail if the queue does not already
    // exist.
    ...
    /// <summary>
    /// Create a queue with the given name if it does not already exist, otherwise attach to the
    // existing queue.
    /// Most configuration options do not apply when attaching to an existing queue.
    /// </summary>
    CreateOrAttach,
