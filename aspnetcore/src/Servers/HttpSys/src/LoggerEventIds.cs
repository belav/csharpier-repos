...
namespace Microsoft.AspNetCore.Server.HttpSys
{
    ...
    {
        public static readonly EventId HttpSysListenerCtorError = new EventId(
            1,
            "HttpSysListenerCtorError"
        );
        ...
        public static readonly EventId WaitingForRequestsToDrain = new EventId(
            9,
            "WaitingForRequestsToDrain"
        );
        public static readonly EventId DisconnectRegistrationError = new EventId(
            10,
            "DisconnectRegistrationError"
        );
        public static readonly EventId RegisterDisconnectListener = new EventId(
            11,
            "RegisterDisconnectListener"
        );
        public static readonly EventId UnknownDisconnectError = new EventId(
            12,
            "UnknownDisconnectError"
        );
        public static readonly EventId DisconnectHandlerError = new EventId(
            13,
            "DisconnectHandlerError"
        );
        public static readonly EventId ListenerStarting = new EventId(14, "ListenerStarting");
        public static readonly EventId ListenerDisposeError = new EventId(
            15,
            "ListenerDisposeError"
        );
        public static readonly EventId RequestListenerProcessError = new EventId(
            16,
            "RequestListenerProcessError"
        );
        ...
        public static readonly EventId ChannelBindingUnsupported = new EventId(
            22,
            "ChannelBindingUnSupported"
        );
        public static readonly EventId ChannelBindingMissing = new EventId(
            23,
            "ChannelBindingMissing"
        );
        public static readonly EventId RequestError = new EventId(24, "RequestError");
        public static readonly EventId ErrorInReadingCertificate = new EventId(
            25,
            "ErrorInReadingCertificate"
        );
        public static readonly EventId ChannelBindingNeedsHttps = new EventId(
            26,
            "ChannelBindingNeedsHttps"
        );
        public static readonly EventId ChannelBindingRetrieved = new EventId(
            27,
            "ChannelBindingRetrived"
        );
        ...
        public static readonly EventId FewerBytesThanExpected = new EventId(
            33,
            "FewerBytesThanExpected"
        );
        ...
        public static readonly EventId FileSendAsyncCancelled = new EventId(
            39,
            "FileSendAsyncCancelled"
        );
        public static readonly EventId FileSendAsyncErrorIgnored = new EventId(
            40,
            "FileSendAsyncErrorIgnored"
        );
        ...
        public static readonly EventId RequestValidationFailed = new EventId(
            47,
            "RequestValidationFailed"
        );
        public static readonly EventId CreateDisconnectTokenError = new EventId(
            48,
            "CreateDisconnectTokenError"
        );
    }
}
