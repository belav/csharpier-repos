...
public class HttpParsingData
{
    public static IEnumerable<string[]> RequestLineValidData
    {
        get
        {
            ...
            var httpVersions = new[] { "HTTP/1.0", "HTTP/1.1", " HTTP/1.1", "   HTTP/1.1" };
    ...
    {
        get { return new[] { "\0", "/\0", "/\0\0", "/%C8\0" }.Concat(QueryStringWithNullCharData); }
    }
    ...
    public static TheoryData<string, string> HostHeaderData =>
        new TheoryData<string, string>
        {
            ...
            {
                "CONNECT user-images.githubusercontent.com:443",
