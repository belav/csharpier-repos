    ...
    public class HPackDecoderBenchmark
    {
        ...
        static HPackDecoderBenchmark()
        {
            ...
            _literalHeaderFieldNeverIndexed_NewName_Large =
                _literalHeaderFieldWithoutIndexingNewName.Concat(new byte[] { 0x7f, 0x82, 0x3f }) // 8193 encoded with 7-bit prefix, no Huffman encoding
            ...
            _indexedHeaderDynamic_Multiple = _indexedHeaderDynamic.Concat(_indexedHeaderDynamic)
