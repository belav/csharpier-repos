...
namespace Microsoft.AspNetCore.Server.Kestrel.Microbenchmarks
{
    public class DotSegmentRemovalBenchmark
    {
        ...
        private readonly byte[] _singleDotSegmentsAscii = Encoding.ASCII
            .GetBytes(_singleDotSegments);
        private readonly byte[] _doubleDotSegmentsAscii = Encoding.ASCII
            .GetBytes(_doubleDotSegments);
