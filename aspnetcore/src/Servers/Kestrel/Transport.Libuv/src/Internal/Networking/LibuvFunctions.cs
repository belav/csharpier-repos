...
namespace Microsoft.AspNetCore.Server.Kestrel.Transport.Libuv.Internal.Networking
{
    internal class LibuvFunctions
    {
        ...
        protected unsafe delegate int uv_write_func(
            UvRequest req,
        ...
        protected unsafe delegate int uv_write2_func(
            UvRequest req,
            UvStreamHandle handle,
            uv_buf_t* bufs,
            int nbufs,
        ...
        public unsafe void timer_start(
        ...
        private static class NativeMethods
        {
            ...
            [DllImport("libuv", CallingConvention = CallingConvention.Cdecl)]
            public static extern int uv_read_start(
                UvStreamHandle handle,
            ...
            [DllImport("libuv", CallingConvention = CallingConvention.Cdecl)]
            public static extern unsafe int uv_write(
                UvRequest req,
                UvStreamHandle handle,
                uv_buf_t* bufs,
                int nbufs,
            ...
            [DllImport("libuv", CallingConvention = CallingConvention.Cdecl)]
            public static extern unsafe int uv_write2(
                UvRequest req,
                UvStreamHandle handle,
                uv_buf_t* bufs,
                int nbufs,
            ...
            [DllImport("libuv", CallingConvention = CallingConvention.Cdecl)]
            public static extern unsafe int uv_timer_start(
                UvTimerHandle handle,
                uv_timer_cb cb,
                long timeout,
                long repeat
