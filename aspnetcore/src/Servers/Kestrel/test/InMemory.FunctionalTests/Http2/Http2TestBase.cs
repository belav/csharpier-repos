...
namespace Microsoft.AspNetCore.Server.Kestrel.Core.Tests
{
          ...
          IHttpHeadersHandler
    {
        ...
        protected static readonly IEnumerable<KeyValuePair<string, string>> _postRequestHeaders =
            new[]
            {
        ...
        protected readonly Dictionary<string, string> _receivedHeaders = new Dictionary<
            string,
            string
        ...
        protected readonly Dictionary<string, string> _receivedTrailers = new Dictionary<
            ...
            string
        >(StringComparer.OrdinalIgnoreCase);
        protected readonly Dictionary<string, string> _decodedHeaders = new Dictionary<
            string,
            string
        >(StringComparer.OrdinalIgnoreCase);
        ...
        public Http2TestBase()
        {
            ...
            _echoHost = context =>
            {
                context.Response.Headers[HeaderNames.Host] = context.Request.Headers[
                    HeaderNames.Host
                ];
        ...
        )
        {
            ...
            var connectionTask = _connection.ProcessRequestsAsync(
                new DummyApplication(application)
            );
        ...
        protected void StartHeartbeat()
        {
            if (_timer == null)
            {
                _timer = new Timer(
                    OnHeartbeat,
                    state: this,
                    dueTime: Heartbeat.Interval,
                    period: Heartbeat.Interval
                );
            }
        }
