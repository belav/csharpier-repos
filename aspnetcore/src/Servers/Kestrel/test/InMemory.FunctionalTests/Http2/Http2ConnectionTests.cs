...
public class Http2ConnectionTests : Http2TestBase
{
    ...
    public async Task RequestHeaderStringReuse_MultipleStreams_KnownHeaderClearedIfNotReused()
    {
        ...
        var headerReferences1 = typeof(HttpRequestHeaders)
            ...
            .GetValue(stream1.RequestHeaders);
        ...
        var headerReferences2 = typeof(HttpRequestHeaders)
            .GetField("_headers", privateFlags)
            .GetValue(stream2.RequestHeaders);
        var contentTypeValue2 = (StringValues)
            headerReferences2.GetType().GetField("_ContentType").GetValue(headerReferences2);
    ...
    public async Task AbortConnectionAfterTooManyEnhanceYourCalms()
    {
        ...
        await InitializeConnectionAsync(_ =>
            Task.FromException(new InvalidOperationException("No requests should be processed"))
        );

        // Reject *every* stream
        _connection.SendEnhanceYourCalmOnStartStream = true;

        var enhanceYourCalmMaximumCount =
            Http2Connection.EnhanceYourCalmTickWindowCount
    ...
    public async Task SETTINGS_KestrelDefaults_Sent()
    {
        ...
        Assert.Equal(
            1024 * 1024 - (int)Http2PeerSettings.DefaultInitialWindowSize,
    ...
    public async Task SETTINGS_Custom_Sent()
    {
        ...
        Assert.Equal(
            1024 * 1024u - Http2PeerSettings.DefaultInitialWindowSize,
