...
namespace Microsoft.AspNetCore.Server.Kestrel.InMemory.FunctionalTests
{
    public class HttpsConnectionMiddlewareTests : LoggedTest
    {
        ...
        private static X509Certificate2 _x509Certificate2NoExt = TestResources.GetTestCertificate(
            "no_extensions.pfx"
        );
            ...
            await using (
                var server = new TestServer(
                    context =>
                    {
                        ...
                        Assert.True(
                            tlsFeature.CipherAlgorithm > CipherAlgorithmType.Null,
                            "Cipher"
                        );
        ...
        public void ThrowsForCertificatesMissingServerEku(string testCertName)
        {
            ...
            Assert.Equal(
                CoreStrings.FormatInvalidServerCertificateEku(cert.Thumbprint),
                ex.Message
            );
        }
