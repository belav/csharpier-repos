...
namespace Microsoft.AspNetCore.Server.Kestrel.Core.Internal.Infrastructure
{
    internal class KestrelTrace : IKestrelTrace
    {
        ...
        private static readonly Action<ILogger, string, Exception?> _connectionKeepAlive =
            LoggerMessage.Define<string>(
                LogLevel.Debug,
                new EventId(9, "ConnectionKeepAlive"),
        ...
        private static readonly Action<ILogger, string, Exception?> _connectionDisconnect =
            LoggerMessage.Define<string>(
                LogLevel.Debug,
                new EventId(10, "ConnectionDisconnect"),
        ...
        private static readonly Action<ILogger, string, string, Exception> _applicationError =
            LoggerMessage.Define<string, string>(
                LogLevel.Error,
                new EventId(13, "ApplicationError"),
        ...
        private static readonly Action<ILogger, Exception?> _notAllConnectionsClosedGracefully =
            LoggerMessage.Define(
                LogLevel.Debug,
                new EventId(16, "NotAllConnectionsClosedGracefully"),
        ...
        private static readonly Action<ILogger, string, string, Exception> _connectionBadRequest =
            LoggerMessage.Define<string, string>(
                LogLevel.Debug,
                new EventId(17, "ConnectionBadRequest"),
        ...
        private static readonly Action<
            ...
            long,
            Exception?
        > _connectionHeadResponseBodyWrite = LoggerMessage.Define<string, long>(
            LogLevel.Debug,
            new EventId(18, "ConnectionHeadResponseBodyWrite"),
        ...
        private static readonly Action<ILogger, string, Exception> _requestProcessingError =
            LoggerMessage.Define<string>(
                LogLevel.Debug,
                new EventId(20, "RequestProcessingError"),
        ...
        private static readonly Action<ILogger, Exception?> _notAllConnectionsAborted =
            LoggerMessage.Define(
                LogLevel.Debug,
                new EventId(21, "NotAllConnectionsAborted"),
        ...
        private static readonly Action<
            ...
            TimeSpan,
            Exception?
        > _heartbeatSlow = LoggerMessage.Define<DateTimeOffset, TimeSpan, TimeSpan>(
            LogLevel.Warning,
            new EventId(22, "HeartbeatSlow"),
        ...
        private static readonly Action<ILogger, string, Exception?> _applicationNeverCompleted =
            LoggerMessage.Define<string>(
                LogLevel.Critical,
                new EventId(23, "ApplicationNeverCompleted"),
        ...
        private static readonly Action<ILogger, string, Exception?> _connectionRejected =
            LoggerMessage.Define<string>(
                LogLevel.Warning,
                new EventId(24, "ConnectionRejected"),
        ...
        private static readonly Action<ILogger, string, string, Exception?> _requestBodyStart =
            LoggerMessage.Define<string, string>(
                LogLevel.Debug,
                new EventId(25, "RequestBodyStart"),
                @"Connection id ""{ConnectionId}"", Request id ""{TraceIdentifier}"": started reading request body.",
        ...
        private static readonly Action<ILogger, string, string, Exception?> _requestBodyDone =
            LoggerMessage.Define<string, string>(
                LogLevel.Debug,
                new EventId(26, "RequestBodyDone"),
                @"Connection id ""{ConnectionId}"", Request id ""{TraceIdentifier}"": done reading request body.",
                skipEnabledCheck: true
            );
        ...
        private static readonly Action<
            ...
            double,
            Exception?
        > _requestBodyMinimumDataRateNotSatisfied = LoggerMessage.Define<string, string?, double>(
            LogLevel.Debug,
            new EventId(27, "RequestBodyMinimumDataRateNotSatisfied"),
        ...
        private static readonly Action<
            ...
            string?,
            Exception?
        > _responseMinimumDataRateNotSatisfied = LoggerMessage.Define<string, string?>(
            LogLevel.Debug,
            new EventId(28, "ResponseMinimumDataRateNotSatisfied"),
        ...
        private static readonly Action<ILogger, string, Exception> _http2ConnectionError =
            LoggerMessage.Define<string>(
                LogLevel.Debug,
                new EventId(29, "Http2ConnectionError"),
        ...
        private static readonly Action<ILogger, string, Exception> _http2StreamError =
            LoggerMessage.Define<string>(
                LogLevel.Debug,
                new EventId(30, "Http2StreamError"),
        ...
        private static readonly Action<ILogger, string, int, Exception> _hpackDecodingError =
            LoggerMessage.Define<string, int>(
                LogLevel.Debug,
                new EventId(31, "HPackDecodingError"),
        ...
        private static readonly Action<
            ...
            string,
            Exception?
        > _requestBodyNotEntirelyRead = LoggerMessage.Define<string, string>(
            LogLevel.Information,
            new EventId(32, "RequestBodyNotEntirelyRead"),
        ...
        private static readonly Action<
            ...
            string,
            Exception?
        > _requestBodyDrainTimedOut = LoggerMessage.Define<string, string>(
            LogLevel.Information,
            new EventId(33, "RequestBodyDrainTimedOut"),
        ...
        private static readonly Action<
            ...
            string,
            Exception?
        > _applicationAbortedConnection = LoggerMessage.Define<string, string>(
            LogLevel.Information,
            new EventId(34, "ApplicationAbortedConnection"),
        ...
        private static readonly Action<
            ...
            Http2ErrorCode,
            Exception
        > _http2StreamResetAbort = LoggerMessage.Define<string, Http2ErrorCode>(
            LogLevel.Debug,
            new EventId(35, "Http2StreamResetAbort"),
        ...
        private static readonly Action<ILogger, string, Exception?> _http2ConnectionClosing =
            LoggerMessage.Define<string>(
                LogLevel.Debug,
                new EventId(36, "Http2ConnectionClosing"),
        ...
        private static readonly Action<ILogger, string, int, Exception?> _http2ConnectionClosed =
            LoggerMessage.Define<string, int>(
                LogLevel.Debug,
                new EventId(48, "Http2ConnectionClosed"),
        ...
        private static readonly Action<
            ...
            object,
            Exception?
        > _http2FrameReceived = LoggerMessage.Define<string, Http2FrameType, int, int, object>(
            LogLevel.Trace,
            new EventId(37, "Http2FrameReceived"),
        ...
        private static readonly Action<
            ...
            object,
            Exception?
        > _http2FrameSending = LoggerMessage.Define<string, Http2FrameType, int, int, object>(
            LogLevel.Trace,
            new EventId(49, "Http2FrameSending"),
        ...
        private static readonly Action<ILogger, string, int, Exception> _hpackEncodingError =
            LoggerMessage.Define<string, int>(
                LogLevel.Information,
                new EventId(38, "HPackEncodingError"),
        ...
        private static readonly Action<
            ...
            string,
            Exception?
        > _http2MaxConcurrentStreamsReached = LoggerMessage.Define<string>(
            LogLevel.Debug,
            new EventId(40, "Http2MaxConcurrentStreamsReached"),
        ...
        private static readonly Action<ILogger, Exception?> _invalidResponseHeaderRemoved =
            LoggerMessage.Define(
                LogLevel.Warning,
                new EventId(41, "InvalidResponseHeaderRemoved"),
        ...
        private static readonly Action<ILogger, string, Exception> _http3ConnectionError =
            LoggerMessage.Define<string>(
                LogLevel.Debug,
                new EventId(42, "Http3ConnectionError"),
        ...
        private static readonly Action<ILogger, string, Exception?> _http3ConnectionClosing =
            LoggerMessage.Define<string>(
                LogLevel.Debug,
                new EventId(43, "Http3ConnectionClosing"),
                @"Connection id ""{ConnectionId}"" is closing."
            );
        ...
        private static readonly Action<ILogger, string, long, Exception?> _http3ConnectionClosed =
            LoggerMessage.Define<string, long>(
                LogLevel.Debug,
                new EventId(44, "Http3ConnectionClosed"),
                @"Connection id ""{ConnectionId}"" is closed. The last processed stream ID was {HighestOpenedStreamId}."
            );
        ...
        private static readonly Action<ILogger, string, string, Exception> _http3StreamAbort =
            LoggerMessage.Define<string, string>(
                LogLevel.Debug,
                new EventId(45, "Http3StreamAbort"),
        ...
        private static readonly Action<
            ...
            long,
            Exception?
        > _http3FrameReceived = LoggerMessage.Define<string, string, long, long>(
            LogLevel.Trace,
            new EventId(46, "Http3FrameReceived"),
        ...
        private static readonly Action<
            ...
            long,
            Exception?
        > _http3FrameSending = LoggerMessage.Define<string, string, long, long>(
            LogLevel.Trace,
            new EventId(47, "Http3FrameSending"),
        ...
        public virtual void ApplicationError(
            string connectionId,
        ...
        public virtual void HeartbeatSlow(
        ...
        public virtual void RequestBodyMinimumDataRateNotSatisfied(
            string connectionId,
            string? traceIdentifier,
            double rate
        )
        ...
        public virtual void HPackDecodingError(
            string connectionId,
            int streamId,
        ...
        public virtual void HPackEncodingError(
            string connectionId,
            int streamId,
