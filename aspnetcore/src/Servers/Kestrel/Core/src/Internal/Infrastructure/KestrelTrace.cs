...
internal sealed partial class KestrelTrace : ILogger
{
    ...
    public KestrelTrace(ILoggerFactory loggerFactory)
    {
        ...
        _badRequestsLogger = loggerFactory.CreateLogger(
            "Microsoft.AspNetCore.Server.Kestrel.BadRequests"
        );
        _connectionsLogger = loggerFactory.CreateLogger(
    ...
    private static partial void ApplicationError(
        ILogger logger,
        string connectionId,
    ...
    private static partial void ConnectionHeadResponseBodyWrite(
        ILogger logger,
        string connectionId,
        long count
    );
    ...
    private static partial void RequestProcessingError(
        ILogger logger,
        string connectionId,
        Exception ex
    );
    ...
    private static partial void HeartbeatSlow(
        ILogger logger,
        DateTimeOffset now,
    ...
    private static partial void RequestBodyStart(
        ILogger logger,
        string connectionId,
        string traceIdentifier
    );
    ...
    private static partial void RequestBodyDone(
        ILogger logger,
        string connectionId,
        string traceIdentifier
    );
    ...
    private static partial void RequestBodyMinimumDataRateNotSatisfied(
        ILogger logger,
        string connectionId,
        string? traceIdentifier,
        double rate
    ...
    private static partial void RequestBodyNotEntirelyRead(
        ILogger logger,
        string connectionId,
        string traceIdentifier
    );
    ...
    private static partial void RequestBodyDrainTimedOut(
        ILogger logger,
        string connectionId,
        string traceIdentifier
    );
    ...
    private static partial void ResponseMinimumDataRateNotSatisfied(
        ILogger logger,
        string connectionId,
        string? traceIdentifier
    );
    ...
    private static partial void ApplicationAbortedConnection(
        ILogger logger,
        string connectionId,
        string traceIdentifier
    );
    ...
    private static partial void Http2ConnectionError(
        ILogger logger,
        string connectionId,
    ...
    private static partial void Http2ConnectionClosed(
        ILogger logger,
        string connectionId,
    ...
    private static partial void Http2StreamError(
        ILogger logger,
        string connectionId,
    ...
    private static partial void Http2StreamResetAbort(
        ILogger logger,
        string traceIdentifier,
    ...
    private static partial void HPackDecodingError(
        ILogger logger,
        string connectionId,
        int streamId,
        Exception ex
    ...
    private static partial void HPackEncodingError(
        ILogger logger,
        string connectionId,
        int streamId,
        Exception ex
    ...
    private static partial void Http2FrameReceived(
        ILogger logger,
        string connectionId,
        Http2FrameType type,
        int id,
    ...
    private static partial void Http2FrameSending(
        ILogger logger,
        string connectionId,
        Http2FrameType type,
        int id,
    ...
    private static partial void Http2MaxConcurrentStreamsReached(
        ILogger logger,
        string connectionId
    );
    ...
    private static partial void Http3ConnectionError(
        ILogger logger,
        string connectionId,
    ...
    private static partial void Http3ConnectionClosed(
        ILogger logger,
        string connectionId,
    ...
    private static partial void Http3StreamAbort(
        ILogger logger,
        string traceIdentifier,
        string error,
        ConnectionAbortedException abortReason
    ...
    private static partial void Http3FrameReceived(
        ILogger logger,
        string connectionId,
        string type,
        long id,
    ...
    private static partial void Http3FrameSending(
        ILogger logger,
        string connectionId,
        string type,
        long id,
    ...
    private static partial void Http3OutboundControlStreamError(
        ILogger logger,
        string connectionId,
        Exception ex
    );
    ...
    private static partial void QPackDecodingError(
        ILogger logger,
        string connectionId,
        long streamId,
        Exception ex
    ...
    private static partial void QPackEncodingError(
        ILogger logger,
        string connectionId,
        long streamId,
        Exception ex
    ...
    private static partial void Http3GoAwayStreamId(
        ILogger logger,
        string connectionId,
        long goAwayStreamId
    );
