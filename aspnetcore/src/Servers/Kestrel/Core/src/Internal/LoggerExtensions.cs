...
namespace Microsoft.AspNetCore.Server.Kestrel.Core.Internal
{
    internal static class LoggerExtensions
    {
        ...
        private static readonly Action<
            ...
            string,
            Exception?
        > _locatedDevelopmentCertificate = LoggerMessage.Define<string, string>(
            LogLevel.Debug,
        ...
        private static readonly Action<
            ...
            string,
            Exception?
        > _failedToLocateDevelopmentCertificateFile = LoggerMessage.Define<string>(
            LogLevel.Debug,
        ...
        private static readonly Action<
            ...
            string,
            Exception?
        > _failedToLoadDevelopmentCertificate = LoggerMessage.Define<string>(
            LogLevel.Debug,
        ...
        public static void LocatedDevelopmentCertificate(
            ...
            _locatedDevelopmentCertificate(
                logger,
                certificate.Subject,
        ...
        public static void UnableToLocateDevelopmentCertificate(
            this ILogger<KestrelServer> logger
        ) => _unableToLocateDevelopmentCertificate(logger, null);

        public static void FailedToLocateDevelopmentCertificateFile(
            this ILogger<KestrelServer> logger,
            string certificatePath
        ) => _failedToLocateDevelopmentCertificateFile(logger, certificatePath, null);

        public static void FailedToLoadDevelopmentCertificate(
            this ILogger<KestrelServer> logger,
            string certificatePath
        ) => _failedToLoadDevelopmentCertificate(logger, certificatePath, null);

        public static void BadDeveloperCertificateState(this ILogger<KestrelServer> logger) =>
            _badDeveloperCertificateState(logger, null);

        public static void DeveloperCertificateFirstRun(
            this ILogger<KestrelServer> logger,
            string message
        ) => _developerCertificateFirstRun(logger, message, null);

        public static void FailedToLoadCertificate(
            this ILogger<KestrelServer> logger,
            string certificatePath
        ) => _failedToLoadCertificate(logger, certificatePath, null);

        public static void FailedToLoadCertificateKey(
            this ILogger<KestrelServer> logger,
            string certificateKeyPath
        ) => _failedToLoadCertificateKey(logger, certificateKeyPath, null);
    }
}
