...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        Assert.Equal(
            CoreStrings.FormatBadRequest_InvalidRequestLine_Detail("GET "),
            exception.Message
        );
        Assert.Equal(StatusCodes.Status400BadRequest, exception.StatusCode);
    }
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    public void ParseHeadersThrowsOnInvalidRequestHeadersLineFeedTerminator(
        string rawHeaders,
        string expectedExceptionMessage
    )
    {
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    [Theory]
    [MemberData(nameof(RequestHeaderInvalidDataLineFeedTerminator))]
    public void ParseHeadersThrowsOnInvalidRequestHeadersWithGratuitouslySplitBuffersLineFeedTerminator(
        string rawHeaders,
        string expectedExceptionMessage
    )
    {
...
#pragma warning restore CS0618 // Type or member is obsolete
    ...
    [InlineData("Host:\r\nC", "onnection: keep-alive\r\n\r\n", true)]
    [InlineData("Connection: keep-alive", "\r\nHost:\r\n\r\n", true)]
    public void ParseHeaderLineWithSplitBuffers(
        string firstHeadersSegment,
        string secondHeadersSegment,
        bool quirkMode
    )
    {
    ...
    [InlineData("Header-1: value1\r\nHeader-2: value2", "\r\n")]
    [InlineData("Header-1: value1\r\nHeader-2: value2\r", "\n\r")]
    public void ParseHeadersWithSplitBuffersReturnsFalseWhenGivenIncompleteHeaders(
        string firstHeadersSegment,
        string secondHeadersSegment
    )
    {
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        Assert.Equal(
            CoreStrings.FormatBadRequest_InvalidRequestHeader_Detail(@"ab\x0A"),
            exception.Message
        );
        Assert.Equal(StatusCodes.Status400BadRequest, exception.StatusCode);
    }
    ...
    public static IEnumerable<object[]> RequestLineInvalidDataLineFeedTerminator =>
        HttpParsingData.RequestLineInvalidDataLineFeedTerminator.Select(requestLine =>
            new[] { requestLine }
        );
