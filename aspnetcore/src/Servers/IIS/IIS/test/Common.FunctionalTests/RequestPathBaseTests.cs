...
public class RequestPathBaseTests : FixtureLoggedTest
{
    ...
    [InlineData("/Sub/App/PathANDPathBase/PATH", "/Sub/App/PathANDPathBase", "/PATH")]
    public async Task RequestPathBase_Split(
        string url,
    ...
    [InlineData(
        "///Sub/App/PathAndPathBase/path1/path2",
    ...
    [InlineData("//Sub//App/PathAndPathBase//Path", "//Sub//App/PathAndPathBase", "//Path")]
    [InlineData(
        @"/Sub/ball/../App/PathAndPathBase/path1//path2",
        @"/Sub/App/PathAndPathBase",
        "/path1//path2"
    )]
    [InlineData(
    ...
    public async Task RequestPathBase_WithDoubleSlashes_Split(
        string url,
        string expectedPathBase,
        string expectedPath
    )
