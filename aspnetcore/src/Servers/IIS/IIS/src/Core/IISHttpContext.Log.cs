...
internal abstract partial class IISHttpContext
{
    private static partial class Log
    {
        ...
        [LoggerMessage(
            5,
            LogLevel.Debug,
            @"Connection ID ""{ConnectionId}"", Request ID ""{TraceIdentifier}"": The request was aborted by the client.",
            EventName = "RequestAborted"
        )]
        public static partial void RequestAborted(
            ILogger logger,
            string connectionId,
            string traceIdentifier
        );
