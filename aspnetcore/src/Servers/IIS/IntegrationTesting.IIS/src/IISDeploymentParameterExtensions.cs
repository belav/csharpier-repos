    ...
    public static class IISDeploymentParameterExtensions
    {
        ...
        )
        {
            ...
            parameters.AddServerConfigAction(
                element =>
                {
                    var windowsAuthentication = element.RequiredElement("system.webServer")
        ...
        )
        {
            parameters.AddServerConfigAction(
                element =>
                {
                    element.RequiredElement("system.webServer")
                        .RequiredElement("security")
                        .RequiredElement("authentication")
        ...
        )
        {
            ...
            deploymentParameters.EnableModule(
            ...
            deploymentParameters.ServerConfigActionList.Add(
                (element, _) =>
                {
                    ...
                    var addElement = webServerElement.GetOrAdd("tracing")
            ...
            deploymentParameters.ServerConfigActionList.Add(
                (element, _) =>
                {
                    ...
                    var traceProviderDefinitionsElement = webServerElement.GetOrAdd("tracing")
        ...
        )
        {
            ...
            parameters.ServerConfigActionList.Add(
                (element, _) =>
                {
                    ...
                    webServerElement.RequiredElement("globalModules")
