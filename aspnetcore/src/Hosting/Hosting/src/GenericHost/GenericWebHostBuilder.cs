...
#pragma warning restore CS0618 // Type or member is obsolete
                ...
                {
                    ScanAssemblyAndRegisterStartup(
                        context,
                        services,
                        webhostContext,
                        webHostOptions
    ...
    [UnconditionalSuppressMessage(
        "Trimmer",
        "IL2072",
        Justification = "Finding startup type in assembly requires unreferenced code. Surfaced to user in UseStartup(assemblyName)."
    )]
    private void ScanAssemblyAndRegisterStartup(
        HostBuilderContext context,
        IServiceCollection services,
        WebHostBuilderContext webhostContext,
    ...
    >(Func<WebHostBuilderContext, TStartup> startupFactory)
    {
        ...
        void ConfigureStartup(HostBuilderContext context, IServiceCollection services)
        {
            ...
            if (object.ReferenceEquals(_startupObject, startupFactory))
            {
                ...
                var instance =
                    startupFactory(webHostBuilderContext)
    ...
    )
    {
        ...
        try
        {
            ...
            if (
                StartupLoader.HasConfigureServicesIServiceProviderDelegate(
                    startupType,
        ...
        static void InvokeContainer(
            GenericWebHostBuilder genericWebHostBuilder,
        ...
        )
        {
            ...
            typeof(IHostBuilder)
                ...
                .InvokeWithoutWrappingExceptions(
                    genericWebHostBuilder._builder,
...
#pragma warning disable CS0618 // Type or member is obsolete
            if (
                serviceType == typeof(Microsoft.Extensions.Hosting.IHostingEnvironment)
