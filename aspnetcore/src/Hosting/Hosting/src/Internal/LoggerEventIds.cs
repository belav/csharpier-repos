...
namespace Microsoft.AspNetCore.Hosting
{
    internal static class LoggerEventIds
    {
        ...
        public static readonly EventId ApplicationStartupException = new EventId(
            6,
            "ApplicationStartupException"
        );
        public static readonly EventId ApplicationStoppingException = new EventId(
            7,
        ...
        public static readonly EventId HostedServiceStartException = new EventId(
            9,
            "HostedServiceStartException"
        );
        ...
        public static readonly EventId ServerShutdownException = new EventId(
            12,
            "ServerShutdownException"
        );
        public static readonly EventId HostingStartupAssemblyLoaded = new EventId(
            13,
            "HostingStartupAssemblyLoaded"
        );
        public static readonly EventId ServerListeningOnAddresses = new EventId(
            14,
            "ServerListeningOnAddresses"
        );
    }
}
