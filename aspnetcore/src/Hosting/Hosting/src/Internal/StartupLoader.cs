...
internal class StartupLoader
{
    ...
    )
    {
        ...
        var builder = (ConfigureServicesDelegateBuilder)Activator
            .CreateInstance(
...
#pragma warning restore CS0612 // Type or member is obsolete
    ...
    public static Type FindStartupType(string startupAssemblyName, string environmentName)
    {
        ...
        if (type == null)
        {
            ...
            var startupType1 = definedTypes.Where(
                info => info.Name.Equals(startupNameWithEnv, StringComparison.OrdinalIgnoreCase)
            );
            var startupType2 = definedTypes.Where(
                info => info.Name.Equals(startupNameWithoutEnv, StringComparison.OrdinalIgnoreCase)
            );
