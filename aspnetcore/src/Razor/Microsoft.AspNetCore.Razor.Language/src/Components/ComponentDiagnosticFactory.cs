...
internal static class ComponentDiagnosticFactory
{
    ...
    public static RazorDiagnostic Create_MultipleComponents(
        SourceSpan? span,
        string tagName,
    ...
    )
    {
        return RazorDiagnostic.Create(
            ...
            span ?? SourceSpan.Undefined,
            tagName,
            string.Join(", ", components.Select(c => c.DisplayName))
        );
    }
    ...
    public static RazorDiagnostic CreatePageDirective_CannotBeImported(SourceSpan source)
    {
        ...
        var diagnostic = RazorDiagnostic.Create(
            PageDirective_CannotBeImported,
            source,
            "page",
            fileName
        );
    ...
    {
        var diagnostic = RazorDiagnostic.Create(
            PageDirective_MustSpecifyRoute,
            source ?? SourceSpan.Undefined
        );
        return diagnostic;
    }
    ...
    )
    {
        var diagnostic = RazorDiagnostic.Create(
            ...
            attribute,
            Environment.NewLine
                + string.Join(Environment.NewLine, attributes.Select(p => p.TagHelper.DisplayName))
        );
        return diagnostic;
    }
    ...
    public static RazorDiagnostic CreateEventHandler_Duplicates(
        SourceSpan? source,
        string attribute,
        TagHelperDirectiveAttributeIntermediateNode[] attributes
    )
    ...
    public static RazorDiagnostic Create_ChildContentHasInvalidAttribute(
        SourceSpan? source,
        string attribute,
        string element
    )
    ...
    public static RazorDiagnostic Create_ChildContentHasInvalidParameter(
        SourceSpan? source,
        string attribute,
        string element
    )
    ...
    )
    {
        ...
        return RazorDiagnostic.Create(
            GenericComponentMissingTypeArgument,
            source ?? SourceSpan.Undefined,
            component.TagName,
            attributesText
        );
    ...
    public static RazorDiagnostic Create_ChildContentHasInvalidParameterOnComponent(
        SourceSpan? source,
        string attribute,
        string element
    )
    ...
    {
        return RazorDiagnostic.Create(
            UnsupportedComponentImportContent,
            source ?? SourceSpan.Undefined
        );
    }
    ...
    public static RazorDiagnostic Create_DuplicateMarkupAttributeDirective(
        string attributeName,
    ...
    public static RazorDiagnostic Create_DuplicateComponentParameterDirective(
        string attributeName,
        string directiveAttributeName,
        SourceSpan? source = null
    )
    ...
    public static RazorDiagnostic Create_InconsistentStartAndEndTagName(
        string startTagName,
        string endTagName,
        SourceSpan? source = null
    )
    ...
    public static RazorDiagnostic CreateEventHandlerParameter_Duplicates(
        SourceSpan? source,
        string attribute,
