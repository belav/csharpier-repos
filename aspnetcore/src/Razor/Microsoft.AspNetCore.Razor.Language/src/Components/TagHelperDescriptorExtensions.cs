    ...
    internal static class TagHelperDescriptorExtensions
    {
        ...
        public static bool IsFallbackBindTagHelper(this TagHelperDescriptor tagHelper)
        {
            ...
            return tagHelper.IsBindTagHelper()
                && tagHelper.Metadata
                    .TryGetValue(ComponentMetadata.Bind.FallbackKey, out var fallback)
        ...
        public static string GetExpressionAttributeName(this TagHelperDescriptor tagHelper)
        {
            ...
            tagHelper.Metadata
                .TryGetValue(ComponentMetadata.Bind.ExpressionAttribute, out var result);
            return result;
        }
        ...
        public static bool IsChildContentTagHelper(this TagHelperDescriptor tagHelper)
        {
            ...
            return tagHelper.Metadata.TryGetValue(ComponentMetadata.SpecialKindKey, out var value)
                && string
                    .Equals(
                        value,
