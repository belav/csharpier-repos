      ...
      IRazorOptimizationPass
{
    ...
    {
        private readonly Dictionary<string, (string name, IntermediateNode node)> _attributes =
            new Dictionary<string, (string, IntermediateNode)>(StringComparer.OrdinalIgnoreCase);
                ...
                )
                {
                    if (_attributes.TryGetValue(attribute.AttributeName, out var other))
                    {
                        ...
                        var originalAttributeName =
                            attribute.Annotations[ComponentMetadata.Common.OriginalAttributeName]
                                as string
