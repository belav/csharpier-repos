...
internal class ComponentComplexAttributeContentPass
        ...
        IRazorOptimizationPass
{
    ...
    private static bool TrySimplifyContent(IntermediateNode node)
    {
        ...
        else if (node.Children.Count == 1 && node.Children[0] is CSharpCodeIntermediateNode)
        {
