...
",
    ...
    public void WriteDocument_SHA1_WritesChecksumAndMarksAutoGenerated()
    {
        ...
        var sourceDocument = Mock.Of<RazorSourceDocument>(
            d =>
...
",
    ...
    public void WriteDocument_WritesNamespace()
    {
        ...
        builder.Add(new NamespaceDeclarationIntermediateNode() { Content = "TestNamespace", });
        ...
        builder.Add(
            new ClassDeclarationIntermediateNode()
            {
                ...
                TypeParameters = new List<TypeParameter>
                {
                    ...
                    {
                        ParameterName = "TKey",
                        Constraints = "where TKey : class"
                    },
                    new TypeParameter()
                    {
                        ParameterName = "TValue",
                        Constraints = "where TValue : class"
                    },
                },
                ClassName = "TestClass",
            }
