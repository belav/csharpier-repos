...
{
    /// <summary>
    /// When a set of <see cref="ITagHelper"/>s are executed, their <see
    // cref="Init(TagHelperContext)"/>'s
    ...
    /// <see cref="TagHelperContext.Items"/> should be done within this method to ensure they're added
    // prior to
    /// executing the children.
    /// </summary>
    /// <param name="context">Contains information associated with the current HTML tag.</param>
    /// <remarks>When more than one <see cref="ITagHelper"/> runs on the same element,
    /// <see cref="M:TagHelperOutput.GetChildContentAsync"/> may be invoked prior to <see
    // cref="ProcessAsync"/>.
    /// </remarks>
    ...
    /// <summary>
    /// Asynchronously executes the <see cref="TagHelper"/> with the given <paramref name="context"/>
    // and
    /// <paramref name="output"/>.
    /// </summary>
    /// <param name="context">Contains information associated with the current HTML tag.</param>
    /// <param name="output">A stateful HTML element used to generate an HTML tag.</param>
    /// <returns>A <see cref="Task"/> that on completion updates the <paramref
    // name="output"/>.</returns>
