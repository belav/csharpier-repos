...
public sealed class HtmlAttributeNameAttribute : Attribute
{
    ...
    /// <summary>
    /// Instantiates a new instance of the <see cref="HtmlAttributeNameAttribute"/> class with <see
    // cref="Name"/>
    /// equal to <c>null</c>.
    /// </summary>
    /// <remarks>
    ...
    /// </summary>
    /// <param name="name">
    /// HTML attribute name for the associated property. Must be <c>null</c> or empty if associated
    // property does
    ...
    /// </summary>
    /// <value>
    /// <c>null</c> or empty if and only if associated property does not have a public setter and is
    // compatible
    ...
    /// <see cref="System.Collections.Generic.IDictionary{TKey, TValue}"/>, default value is <c>Name +
    // "-"</c>.
    ...
    /// <summary>
    /// Gets an indication whether <see cref="DictionaryAttributePrefix"/> has been set. Used to
    // distinguish an
    /// uninitialized <see cref="DictionaryAttributePrefix"/> value from an explicit <c>null</c>
    // setting.
    /// </summary>
    /// <value><c>true</c> if <see cref="DictionaryAttributePrefix"/> was set. <c>false</c>
    // otherwise.</value>
