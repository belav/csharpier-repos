...
namespace Microsoft.CodeAnalysis.Razor.Workspaces
{
    public class DefaultTagHelperDescriptorFactoryTest
    {
        private static readonly Assembly _assembly =
            typeof(DefaultTagHelperDescriptorFactoryTest).GetTypeInfo().Assembly;
                        ...
                        new Action<RequiredAttributeDescriptorBuilder>[]
                        {
                            builder =>
                                builder.Name(string.Empty)
                                    .AddDiagnostic(
                                        AspNetCore.Razor.Language.RazorDiagnosticFactory
                        ...
                        new Action<RequiredAttributeDescriptorBuilder>[]
                        {
                            builder =>
                                builder.Name("n@me")
                                    .AddDiagnostic(
                                        AspNetCore.Razor.Language.RazorDiagnosticFactory
                                            .CreateTagHelper_InvalidTargetedAttributeName(
                                                "n@me",
                                                '@'
                                            )
                                    ),
        ...
        public static TheoryData RequiredAttributeParserData
        {
            get
            {
                Func<
                    ...
                    Action<RequiredAttributeDescriptorBuilder>
                > plain = (name, nameComparison) =>
                    (builder) => builder.Name(name).NameComparisonMode(nameComparison);
                ...
                Func<
                    ...
                    Action<RequiredAttributeDescriptorBuilder>
                > css = (name, value, valueComparison) =>
                    (builder) =>
                        builder.Name(name).Value(value).ValueComparisonMode(valueComparison);

                return new TheoryData<
                    string,
                    IEnumerable<Action<RequiredAttributeDescriptorBuilder>>
                >
                {
                    { null, Enumerable.Empty<Action<RequiredAttributeDescriptorBuilder>>() },
                    {
                        string.Empty,
                        Enumerable.Empty<Action<RequiredAttributeDescriptorBuilder>>()
                    },
                    {
                        "name",
                        new[]
                        {
                            plain("name", RequiredAttributeDescriptor.NameComparisonMode.FullMatch)
                        }
                    },
                    {
                        "name-*",
                    ...
                    },
                    {
                        ...
                        new[]
                        {
                            css("name", null, RequiredAttributeDescriptor.ValueComparisonMode.None)
                        }
                    },
                    {
                        "[ name ]",
            ...
            get
            {
                ...
                return new TheoryData<Type, TagHelperDescriptor>
                {
                    ...
                    },
                    {
                        ...
                        TagHelperDescriptorBuilder.Create(
                            typeof(MultiEnumTagHelper).FullName,
                            AssemblyName
                        )
                            .TypeName(typeof(MultiEnumTagHelper).FullName)
                            .TagMatchingRuleDescriptor(
                                ruleBuilder => ruleBuilder.RequireTagName("p")
                            )
                            .TagMatchingRuleDescriptor(
                                ruleBuilder => ruleBuilder.RequireTagName("input")
                            )
                            .BoundAttributeDescriptor(
                                builder =>
                                    builder.Name("non-enum-property")
                    ...
                    },
                    {
                        ...
                        TagHelperDescriptorBuilder.Create(
                            typeof(NestedEnumTagHelper).FullName,
                            AssemblyName
                        )
                            .TypeName(typeof(NestedEnumTagHelper).FullName)
                            .TagMatchingRuleDescriptor(
                                ruleBuilder => ruleBuilder.RequireTagName("nested-enum")
                            )
                            .BoundAttributeDescriptor(
                                builder =>
                                    builder.Name("non-enum-property")
                            ...
                            .BoundAttributeDescriptor(
                                builder =>
                                    builder.Name("nested-enum-property")
                                        .PropertyName(
                                            nameof(NestedEnumTagHelper.NestedEnumProperty)
                                        )
                                        .TypeName(
                                            $"{typeof(NestedEnumTagHelper).FullName}.{nameof(NestedEnumTagHelper.NestedEnum)}"
                                        )
                                        .AsEnum()
                            )
                            .Build()
                ...
                {
                    {
                        ...
                        TagHelperDescriptorBuilder.Create(
                            typeof(RequiredParentTagHelper).FullName,
                            AssemblyName
                        )
                            .TypeName(typeof(RequiredParentTagHelper).FullName)
                            .TagMatchingRuleDescriptor(
                                builder => builder.RequireTagName("input").RequireParentTag("div")
                            )
                            .Build()
                    },
                    {
                        ...
                        TagHelperDescriptorBuilder.Create(
                            typeof(MultiSpecifiedRequiredParentTagHelper).FullName,
                            AssemblyName
                        )
                            .TypeName(typeof(MultiSpecifiedRequiredParentTagHelper).FullName)
                            .TagMatchingRuleDescriptor(
                                builder => builder.RequireTagName("p").RequireParentTag("div")
                            )
                            .TagMatchingRuleDescriptor(
                                builder =>
                                    builder.RequireTagName("input").RequireParentTag("section")
                            )
                            .Build()
                    },
                    {
                        ...
                        TagHelperDescriptorBuilder.Create(
                            typeof(MultiWithUnspecifiedRequiredParentTagHelper).FullName,
                            AssemblyName
                        )
                ...
                {
                    {
                        ...
                        TagHelperDescriptorBuilder.Create(
                            typeof(RestrictChildrenTagHelper).FullName,
                            AssemblyName
                        )
                            .TypeName(typeof(RestrictChildrenTagHelper).FullName)
                            .TagMatchingRuleDescriptor(
                                builder => builder.RequireTagName("restrict-children")
                            )
                            .AllowChildTag("p")
                            .Build()
                    },
                    {
                        ...
                        TagHelperDescriptorBuilder.Create(
                            typeof(DoubleRestrictChildrenTagHelper).FullName,
                            AssemblyName
                        )
                            .TypeName(typeof(DoubleRestrictChildrenTagHelper).FullName)
                            .TagMatchingRuleDescriptor(
                                builder => builder.RequireTagName("double-restrict-children")
                            )
                            .AllowChildTag("p")
                    ...
                    },
                    {
                        ...
                        TagHelperDescriptorBuilder.Create(
                            typeof(MultiTargetRestrictChildrenTagHelper).FullName,
                            AssemblyName
                        )
                ...
                {
                    {
                        ...
                        TagHelperDescriptorBuilder.Create(
                            typeof(TagStructureTagHelper).FullName,
                            AssemblyName
                        )
                            .TypeName(typeof(TagStructureTagHelper).FullName)
                            .TagMatchingRuleDescriptor(
                                builder =>
                                    builder.RequireTagName("input")
                    ...
                    },
                    {
                        ...
                        TagHelperDescriptorBuilder.Create(
                            typeof(MultiSpecifiedTagStructureTagHelper).FullName,
                            AssemblyName
                        )
                            .TypeName(typeof(MultiSpecifiedTagStructureTagHelper).FullName)
                            .TagMatchingRuleDescriptor(
                                builder =>
                                    builder.RequireTagName("p")
                    ...
                    },
                    {
                        ...
                        TagHelperDescriptorBuilder.Create(
                            typeof(MultiWithUnspecifiedTagStructureTagHelper).FullName,
                            AssemblyName
                        )
                            ...
                            attributes: new Action<BoundAttributeDescriptorBuilder>[]
                            {
                                builder =>
                                    builder.Name("property")
                                        .PropertyName(
                                            nameof(InheritedEditorBrowsableTagHelper.Property)
                                        )
                                        .TypeName(typeof(int).FullName),
                            }
                        )
                        ...
                        CreateTagHelperDescriptor(
                            ...
                            attributes: new Action<BoundAttributeDescriptorBuilder>[]
                            {
                                builder =>
                                    builder.Name("property")
                                        .PropertyName(
                                            nameof(HiddenPropertyEditorBrowsableTagHelper.Property)
                                        )
                                        .TypeName(typeof(int).FullName),
                            }
                        )
                        ...
                        CreateTagHelperDescriptor(
                            ...
                            attributes: new Action<BoundAttributeDescriptorBuilder>[]
                            {
                                builder =>
                                    builder.Name("property")
                                        .PropertyName(
                                            nameof(OverriddenEditorBrowsableTagHelper.Property)
                                        )
                                        .TypeName(typeof(int).FullName),
                            }
                        )
                            ...
                            attributes: new Action<BoundAttributeDescriptorBuilder>[]
                            {
                                builder =>
                                    builder.Name("property2")
                                        .PropertyName(
                                            nameof(MultiPropertyEditorBrowsableTagHelper.Property2)
                                        )
                                        .TypeName(typeof(int).FullName),
                            }
                        )
                        ...
                        CreateTagHelperDescriptor(
                            ...
                            attributes: new Action<BoundAttributeDescriptorBuilder>[]
                            {
                                builder =>
                                    builder.Name("property")
                                        .PropertyName(
                                            nameof(MultiPropertyEditorBrowsableTagHelper.Property)
                                        )
                                        .TypeName(typeof(int).FullName),
                                builder =>
                                    builder.Name("property2")
                            ...
                            attributes: new Action<BoundAttributeDescriptorBuilder>[]
                            {
                                builder =>
                                    builder.Name("property2")
                                        .PropertyName(
                                            nameof(
                                                OverriddenPropertyEditorBrowsableTagHelper.Property2
                                            )
                                        )
                                        .TypeName(typeof(int).FullName),
                                builder =>
                                    builder.Name("property")
                                        .PropertyName(
                                            nameof(
                                                OverriddenPropertyEditorBrowsableTagHelper.Property
                                            )
                                        )
                                        .TypeName(typeof(int).FullName),
                            }
                        ...
                        CreateTagHelperDescriptor(
                            ...
                            attributes: new Action<BoundAttributeDescriptorBuilder>[]
                            {
                                builder =>
                                    builder.Name("property")
                                        .PropertyName(
                                            nameof(DefaultEditorBrowsableTagHelper.Property)
                                        )
                                        .TypeName(typeof(int).FullName),
                            }
                        )
        ...
        public static TheoryData HtmlCaseData
        {
            get
            {
                ...
                return new TheoryData<Type, string, string>
                {
                    ...
                    {
                        typeof(CAPSOnOUTSIDETagHelper),
                        "caps-on-outside",
                        "caps-on-outsideattribute"
                    },
                    { typeof(capsONInsideTagHelper), "caps-on-inside", "caps-on-insideattribute" },
                    {
                        typeof(One1Two2Three3TagHelper),
                        "one1-two2-three3",
                        "one1-two2-three3-attribute"
                    },
                    {
                        typeof(ONE1TWO2THREE3TagHelper),
                        "one1two2three3",
                        "one1two2three3-attribute"
                    },
                    {
                        typeof(First_Second_ThirdHiTagHelper),
                        "first_second_third-hi",
                        "first_second_third-attribute"
                    },
        ...
        {
            // Arrange
            var validProperty1 = typeof(OverriddenAttributeTagHelper)
                .GetProperty(nameof(OverriddenAttributeTagHelper.ValidAttribute1));
            var validProperty2 = typeof(OverriddenAttributeTagHelper)
                .GetProperty(nameof(OverriddenAttributeTagHelper.ValidAttribute2));
        ...
        {
            // Arrange
            var validProperty1 = typeof(InheritedOverriddenAttributeTagHelper)
                .GetProperty(nameof(InheritedOverriddenAttributeTagHelper.ValidAttribute1));
            var validProperty2 = typeof(InheritedOverriddenAttributeTagHelper)
                .GetProperty(nameof(InheritedOverriddenAttributeTagHelper.ValidAttribute2));
            var expectedDescriptor = CreateTagHelperDescriptor(
        ...
        {
            // Arrange
            var validProperty1 = typeof(InheritedNotOverriddenAttributeTagHelper)
                .GetProperty(nameof(InheritedNotOverriddenAttributeTagHelper.ValidAttribute1));
            var validProperty2 = typeof(InheritedNotOverriddenAttributeTagHelper)
                .GetProperty(nameof(InheritedNotOverriddenAttributeTagHelper.ValidAttribute2));
        ...
        {
            // Arrange
            var intProperty = typeof(SingleAttributeTagHelper)
                .GetProperty(nameof(SingleAttributeTagHelper.IntAttribute));
            var expectedDescriptor = CreateTagHelperDescriptor(
                "single-attribute",
        ...
        {
            // Arrange
            var validProperty = typeof(MissingAccessorTagHelper)
                .GetProperty(nameof(MissingAccessorTagHelper.ValidAttribute));
            var expectedDescriptor = CreateTagHelperDescriptor(
                "missing-accessor",
        ...
        {
            // Arrange
            var validProperty = typeof(NonPublicAccessorTagHelper)
                .GetProperty(nameof(NonPublicAccessorTagHelper.ValidAttribute));
            var expectedDescriptor = CreateTagHelperDescriptor(
                "non-public-accessor",
        ...
        {
            // Arrange
            var validProp = typeof(InheritedMultiTagTagHelper)
                .GetProperty(nameof(InheritedMultiTagTagHelper.ValidAttribute));
            var expectedDescriptor = CreateTagHelperDescriptor(
                "inherited-multi-tag",
        ...
        public static TheoryData<string, string[]> InvalidNameData
        {
            get
            {
                Func<string, string, string> onNameError = (invalidText, invalidCharacter) =>
                    $"Tag helpers cannot target tag name '{invalidText}' because it contains a '{invalidCharacter}' character.";
                var whitespaceErrorString = "Targeted tag name cannot be null or whitespace.";

                var data = GetInvalidNameOrPrefixData(
                    onNameError,
        ...
        {{
            ...
            // Assert
            var rule = Assert.Single(descriptor.TagMatchingRules);
            var errorMessages = rule.GetAllDiagnostics()
                .Select(diagnostic => diagnostic.GetMessage(CultureInfo.CurrentCulture))
                .ToArray();
        ...
        public static TheoryData InvalidTagHelperAttributeDescriptorData
        {
            get
            {
                var invalidBoundAttributeBuilder = new DefaultTagHelperDescriptorBuilder(
                    TagHelperConventions.DefaultKind,
                    nameof(InvalidBoundAttribute),
                    "Test"
                );
                            ...
                            CreateAttributeFor(
                                ...
                                attribute =>
                                {
                                    attribute.Name("int-attribute")
                                        .PropertyName(
                                            nameof(InvalidBoundAttributeWithValid.IntAttribute)
                                        )
                                        .TypeName(typeof(int).FullName);
                                }
                            ),
                    ...
                    },
                    {
                        ...
                        new[]
                        {
                            CreateAttributeFor(
                                ...
                                attribute =>
                                {
                                    attribute.Name("valid-something")
                                        .PropertyName(
                                            nameof(
                                                OverriddenInvalidBoundAttributeWithValid.DataSomething
                                            )
                                        )
                                        .TypeName(typeof(string).FullName);
                                }
                            ...
                            CreateAttributeFor(
                                ...
                                attribute =>
                                {
                                    attribute.Name("data-something")
                                        .PropertyName(
                                            nameof(
                                                OverriddenValidBoundAttributeWithInvalid.ValidSomething
                                            )
                                        )
                                        .TypeName(typeof(string).FullName);
                                }
                            ...
                            CreateAttributeFor(
                                ...
                                attribute =>
                                {
                                    attribute.Name("DATA-SOMETHING")
                                        .PropertyName(
                                            nameof(
                                                OverriddenValidBoundAttributeWithInvalidUpperCase.ValidSomething
                                            )
                                        )
                                        .TypeName(typeof(string).FullName);
                                }
        ...
        )
        {
            ...
            var id =
                AspNetCore.Razor.Language.RazorDiagnosticFactory.TagHelper_InvalidBoundAttributeNameStartsWith.Id;
            foreach (
                var attribute in descriptor.BoundAttributes
        ...
        )
        {
            ...
            // Assert
            var errorMessages = descriptor.GetAllDiagnostics()
                .Select(diagnostic => diagnostic.GetMessage(CultureInfo.CurrentCulture));
                ...
                {
                    {
                        ...
                        new[]
                        {
                            CreateAttributeFor(
                                ...
                                attribute =>
                                {
                                    attribute.Name("dictionary-property")
                                        .PropertyName(
                                            nameof(
                                                DefaultValidHtmlAttributePrefix.DictionaryProperty
                                            )
                                        )
                                        .TypeName(
                                            $"{dictionaryNamespace}<System.String, System.String>"
                                        )
                    ...
                    },
                    {
                        ...
                        new[]
                        {
                            CreateAttributeFor(
                                ...
                                attribute =>
                                {
                                    attribute.Name("valid-name")
                                        .PropertyName(
                                            nameof(
                                                SingleValidHtmlAttributePrefix.DictionaryProperty
                                            )
                                        )
                                        .TypeName(
                                            $"{dictionaryNamespace}<System.String, System.String>"
                    ...
                    },
                    {
                        ...
                        new[]
                        {
                            CreateAttributeFor(
                                ...
                                attribute =>
                                {
                                    attribute.Name("valid-name1")
                                        .PropertyName(
                                            nameof(
                                                MultipleValidHtmlAttributePrefix.DictionaryProperty
                                            )
                                        )
                                        .TypeName(
                            ...
                            CreateAttributeFor(
                                ...
                                attribute =>
                                {
                                    attribute.Name("valid-name2")
                                        .PropertyName(
                                            nameof(
                                                MultipleValidHtmlAttributePrefix.DictionarySubclassProperty
                                            )
                                        )
                            ...
                            CreateAttributeFor(
                                ...
                                attribute =>
                                {
                                    attribute.Name("valid-name3")
                                        .PropertyName(
                                            nameof(
                                                MultipleValidHtmlAttributePrefix.DictionaryWithoutParameterlessConstructorProperty
                                            )
                                        )
                                        .TypeName(
                                            typeof(DictionaryWithoutParameterlessConstructor).FullName
                                        )
                                        .AsDictionaryAttribute(
                                            "valid-prefix3-",
                                            typeof(string).FullName
                            ...
                            CreateAttributeFor(
                                ...
                                attribute =>
                                {
                                    attribute.Name("valid-name4")
                                        .PropertyName(
                                            nameof(
                                                MultipleValidHtmlAttributePrefix.GenericDictionarySubclassProperty
                                            )
                                        )
                                        .TypeName(
                                            typeof(GenericDictionarySubclass<object>).Namespace
                                                + ".GenericDictionarySubclass<System.Object>"
                                        )
                                        .AsDictionaryAttribute(
                                            "valid-prefix4-",
                                            typeof(object).FullName
                            ...
                            CreateAttributeFor(
                                ...
                                attribute =>
                                {
                                    attribute.Name("valid-name5")
                                        .PropertyName(
                                            nameof(
                                                MultipleValidHtmlAttributePrefix.SortedDictionaryProperty
                                            )
                                        )
                                        .TypeName(
                                            typeof(SortedDictionary<string, int>).Namespace
                                                + ".SortedDictionary<System.String, System.Int32>"
                                        )
                                        .AsDictionaryAttribute(
                                            "valid-prefix5-",
                                            typeof(int).FullName
                            ...
                            CreateAttributeFor(
                                ...
                                attribute =>
                                {
                                    attribute.Name("valid-name6")
                                        .PropertyName(
                                            nameof(MultipleValidHtmlAttributePrefix.StringProperty)
                                        )
                                        .TypeName(typeof(string).FullName);
                                }
                            ),
                            CreateAttributeFor(
                                ...
                                attribute =>
                                {
                                    attribute.PropertyName(
                                        nameof(
                                            MultipleValidHtmlAttributePrefix.GetOnlyDictionaryProperty
                                        )
                                    )
                                        .TypeName(
                                            $"{dictionaryNamespace}<System.String, System.Int32>"
                                        )
                                        .AsDictionaryAttribute(
                                            "get-only-dictionary-property-",
                                            typeof(int).FullName
                                        );
                                }
                            ),
                            CreateAttributeFor(
                                ...
                                attribute =>
                                {
                                    attribute.PropertyName(
                                        nameof(
                                            MultipleValidHtmlAttributePrefix.GetOnlyDictionaryPropertyWithAttributePrefix
                                        )
                                    )
                                        .TypeName(
                                            $"{dictionaryNamespace}<System.String, System.String>"
                                    ...
                                    attribute.Name("valid-name")
                                        ...
                                        .AddDiagnostic(
                                            RazorDiagnosticFactory.CreateTagHelper_InvalidAttributePrefixNotNull(
                                                ...
                                                nameof(
                                                    SingleInvalidHtmlAttributePrefix.StringProperty
                                                )
                                            )
                                        );
                                }
                        ...
                        new[]
                        {
                            CreateAttributeFor(
                                ...
                                attribute =>
                                {
                                    attribute.Name("valid-name1")
                                        .PropertyName(
                                            nameof(MultipleInvalidHtmlAttributePrefix.LongProperty)
                                        )
                            ...
                            CreateAttributeFor(
                                ...
                                attribute =>
                                {
                                    attribute.Name("valid-name2")
                                        .PropertyName(
                                            nameof(
                                                MultipleInvalidHtmlAttributePrefix.DictionaryOfIntProperty
                                            )
                                        )
                                        .TypeName(
                            ...
                            CreateAttributeFor(
                                ...
                                attribute =>
                                {
                                    attribute.Name("valid-name3")
                                        .PropertyName(
                                            nameof(
                                                MultipleInvalidHtmlAttributePrefix.ReadOnlyDictionaryProperty
                                            )
                                        )
                                        .TypeName(
                                    ...
                                    attribute.Name("valid-name4")
                                        ...
                                        .AddDiagnostic(
                                            RazorDiagnosticFactory.CreateTagHelper_InvalidAttributePrefixNotNull(
                                                typeof(MultipleInvalidHtmlAttributePrefix).FullName,
                                                nameof(
                                                    MultipleInvalidHtmlAttributePrefix.IntProperty
                                                )
                                            )
                                        );
                                }
                            ...
                            CreateAttributeFor(
                                ...
                                attribute =>
                                {
                                    attribute.Name("valid-name5")
                                        .PropertyName(
                                            nameof(
                                                MultipleInvalidHtmlAttributePrefix.DictionaryOfIntSubclassProperty
                                            )
                                        )
                            ...
                            CreateAttributeFor(
                                ...
                                attribute =>
                                {
                                    attribute.PropertyName(
                                        nameof(
                                            MultipleInvalidHtmlAttributePrefix.GetOnlyDictionaryAttributePrefix
                                        )
                                    )
                                        .TypeName(
                                            $"{dictionaryNamespace}<System.Int32, System.String>"
                                        )
                                        .AsDictionaryAttribute(
                                            "valid-prefix6",
                                            typeof(string).FullName
                            ...
                            CreateAttributeFor(
                                ...
                                attribute =>
                                {
                                    attribute.PropertyName(
                                        nameof(
                                            MultipleInvalidHtmlAttributePrefix.GetOnlyDictionaryPropertyWithAttributeName
                                        )
                                    )
                                        .TypeName(
                                            $"{dictionaryNamespace}<System.String, System.Object>"
                                        )
                                        .AsDictionaryAttribute(
                                            "invalid-name7-",
                                            typeof(object).FullName
                ...
                {
                    {
                        ...
                        TagHelperDescriptorBuilder.Create(
                            typeof(MultipleDescriptorTagHelperWithOutputElementHint).FullName,
                            AssemblyName
                        )
                            .TypeName(
                                typeof(MultipleDescriptorTagHelperWithOutputElementHint).FullName
                    ...
                    },
                    {
                        ...
                        TagHelperDescriptorBuilder.Create(
                            typeof(InheritedOutputElementHintTagHelper).FullName,
                            AssemblyName
                        )
                            .TypeName(typeof(InheritedOutputElementHintTagHelper).FullName)
                            .TagMatchingRuleDescriptor(
                                builder => builder.RequireTagName("inherited-output-element-hint")
                            )
                            .Build()
                    },
                    {
                        ...
                        TagHelperDescriptorBuilder.Create(
                            typeof(OutputElementHintTagHelper).FullName,
                            AssemblyName
                        )
                            .TypeName(typeof(OutputElementHintTagHelper).FullName)
                            .TagMatchingRuleDescriptor(
                                builder => builder.RequireTagName("output-element-hint")
                            )
                    ...
                    },
                    {
                        ...
                        TagHelperDescriptorBuilder.Create(
                            typeof(OverriddenOutputElementHintTagHelper).FullName,
                            AssemblyName
                        )
                            .TypeName(typeof(OverriddenOutputElementHintTagHelper).FullName)
                            .TagMatchingRuleDescriptor(
                                builder => builder.RequireTagName("overridden-output-element-hint")
                            )
        ...
        /// </remarks>
        public class DocumentedTagHelper : "
                    + typeof(AspNetCore.Razor.TagHelpers.TagHelper).Name
                    + @"
        {
        }"
            );
...
";
        ...
        public class DocumentedTagHelper : "
                    + typeof(AspNetCore.Razor.TagHelpers.TagHelper).FullName
                    + @"
        {
            /// <summary>
...
",
            ...
            // Assert
            var documentations = descriptor.BoundAttributes
        ...
        )
        {
            ...
            {
                builder.TagMatchingRuleDescriptor(
                    ruleBuilder => ruleBuilder.RequireTagName(tagName)
                );
            }
        ...
        )
        {
            ...
            var attributeBuilder = new DefaultBoundAttributeDescriptorBuilder(
                tagHelperBuilder,
                TagHelperConventions.DefaultKind
            );
