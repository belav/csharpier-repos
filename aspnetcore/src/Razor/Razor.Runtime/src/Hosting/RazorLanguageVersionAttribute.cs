...
/// </summary>
/// <remarks>
/// This attribute is part of a set of metadata attributes that can be applied to an assembly at
// build
/// time by the Razor SDK. These attributes allow the Razor configuration to be loaded at runtime
// based
