...
namespace Microsoft.AspNetCore.Components.Forms
{
    internal static class InputFileInterop
    {
        ...
        public const string EnsureArrayBufferReadyForSharedMemoryInterop =
        ...
        public const string ReadFileDataSharedMemory =
            JsFunctionsPrefix + "readFileDataSharedMemory";
