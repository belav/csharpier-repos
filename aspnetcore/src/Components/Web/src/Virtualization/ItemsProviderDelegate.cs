...
/// <param name="request">The <see cref="ItemsProviderRequest"/> defining the request
// details.</param>
/// <returns>A <see cref="ValueTask"/> whose result is a <see cref="ItemsProviderResult{TItem}"/>
