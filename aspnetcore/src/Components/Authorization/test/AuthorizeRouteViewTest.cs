...
namespace Microsoft.AspNetCore.Components.Authorization
{
    ...
    {
        private readonly static IReadOnlyDictionary<string, object> EmptyParametersDictionary =
            ...
            Assert.Collection(
                ...
                edit =>
                    AssertPrependText(
                        batch,
                        edit,
                        "Hello from the page with message: Hello, world!"
                    )
            );
        }
        ...
        public void WithoutCascadedAuthenticationState_WrapsOutputInCascadingAuthenticationState()
        {
            ...
            // Assert
            var batch = _renderer.Batches.Single();
            var componentInstances = batch.ReferenceFrames.Where(
