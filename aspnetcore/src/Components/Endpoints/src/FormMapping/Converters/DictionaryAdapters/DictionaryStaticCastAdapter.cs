...
internal sealed class DictionaryStaticCastAdapter<
    TDictionaryInterface,
    TDictionaryImplementation,
    TDictionaryAdapter,
    TBuffer,
    TKey,
    TValue
    ...
    where TKey : IParsable<TKey>
{
    ...
    public static TBuffer Add(ref TBuffer buffer, TKey key, TValue element) =>
        TDictionaryAdapter.Add(ref buffer, key, element);

    public static TDictionaryInterface ToResult(TBuffer buffer) =>
        TDictionaryAdapter.ToResult(buffer);
}
