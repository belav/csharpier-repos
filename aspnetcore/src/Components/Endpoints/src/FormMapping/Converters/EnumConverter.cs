...
internal class EnumConverter<TEnum> : FormDataConverter<TEnum>, ISingleValueConverter<TEnum>
    ...
    public bool TryConvertValue(ref FormDataReader reader, string value, out TEnum result)
    {
        ...
        else
        {
            ...
            reader.AddMappingError(
                FormattableStringFactory.Create(FormDataResources.EnumMappingError, value, segment),
                value
            );
            result = default;
            return false;
