    ...
    public class Program
    {
        public static async Task Main(string[] args)
        {
            var createIndividualHosts = new Dictionary<string, (IHost host, string basePath)>
            {
                ...
                ["CORS (WASM)"] = (
                    BuildWebHost<CorsStartup>(CreateAdditionalArgs(args)),
                    "/subdir"
                ),
                ...
                ["Client-side with fallback"] = (
                    BuildWebHost<StartupWithMapFallbackToClientSideBlazor>(
                ...
                ["Save state"] = (
                    BuildWebHost<SaveState>(CreateAdditionalArgs(args)),
                    "/save-state"
                ),
