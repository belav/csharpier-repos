...
public class NavigationLockPrerenderingTest
    : ServerTestBase<BasicTestAppServerSiteFixture<LockedNavigationStartup>>
{
    ...
    public void NavigationIsLockedAfterPrerendering()
    {
        ...
        Browser.Equal("Prevented navigations: 0", () =>
            Browser.FindElement(By.Id("num-prevented-navigations")).Text
        );
        ...
        Browser.Equal("Prevented navigations: 1", () =>
            Browser.FindElement(By.Id("num-prevented-navigations")).Text
        );
