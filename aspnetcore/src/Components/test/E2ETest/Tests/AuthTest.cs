...
namespace Microsoft.AspNetCore.Components.E2ETest.Tests
{
    ...
    public class AuthTest : ServerTestBase<ToggleExecutionModeServerFixture<Program>>
    {
        ...
        public void CascadingAuthenticationState_Unauthenticated()
        {
            ...
            Browser.Equal(
                "False",
                () => appElement.FindElement(By.Id("identity-authenticated")).Text
            );
        ...
        public void CascadingAuthenticationState_Authenticated()
        {
            ...
            Browser.Equal(
                "someone cool",
                () => appElement.FindElement(By.Id("identity-name")).Text
            );
            Browser.Equal(
                "Test claim value",
                () => appElement.FindElement(By.Id("test-claim")).Text
            );
            AssertExpectedLayoutUsed();
        }
        ...
        public void AuthorizeViewCases_NoAuthorizationRule_Authorized()
        {
            ...
            Browser.Equal(
                ...
                () =>
                    appElement.FindElement(
                        By.CssSelector("#no-authorization-rule .authorized")
                    ).Text
            );
            AssertExpectedLayoutUsed();
        }
