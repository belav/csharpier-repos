...
public class BlazorWebJsInitializersTest
    : ServerTestBase<BasicTestAppServerSiteFixture<RazorComponentEndpointsStartup<App>>>
{
    ...
    public void InitializersRunsModernCallbacksByDefaultWhenPresent(
        bool streaming,
        bool webassembly,
        bool server,
        List<string> expectedInvokedCallbacks
    )
    {
        var url =
            $"{ServerPathBase}/initializers?streaming={streaming}&wasm={webassembly}&server={server}";
        Navigate(url);
    ...
    [Theory]
    [MemberData(nameof(InitializerTestData))]
    public void InitializersRunsClassicInitializersWhenEnabled(
        bool streaming,
        bool webassembly,
        bool server,
        List<string> expectedInvokedCallbacks
        ...
        {
            {
                ...
                false,
                [
                    "classic-and-modern-before-web-start",
                    "classic-and-modern-after-web-started",
                    "modern-before-web-start",
                    "modern-after-web-started",
                ]
            },
            {
                false,
