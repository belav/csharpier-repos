...
#pragma warning restore CA1852 // Seal internal types
{
    ...
    {
        // With ICU sharding enabled, bootstrapping WebAssembly will download a ICU shard based on the
        // browser language.
        // If the application author was to change the culture as part of their Program.MainAsync, we might
        // have
        // incomplete icu data for their culture. We would like to flag this as an error and notify the
        // author to
        // use the combined icu data file instead.
        //
        // The Initialize method is invoked as one of the first steps bootstrapping the app within
        // WebAssemblyHostBuilder.CreateDefault.
        // It allows us to capture the initial .NET culture that is configured based on the browser
        // language.
        // The current method is invoked as part of WebAssemblyHost.RunAsync i.e. after user code in
        // Program.MainAsync has run
