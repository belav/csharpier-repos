...
namespace Microsoft.AspNetCore.Components.Test
{
    public class RouteViewTest
    {
        ...
        public void RendersPageInsideLayoutView()
        {
            ...
            var routeViewFrames = _renderer.GetCurrentRenderTreeFrames(_routeViewComponentId)
                .AsEnumerable();
            Assert.Collection(
                routeViewFrames,
            ...
            var layoutViewFrames = _renderer.GetCurrentRenderTreeFrames(layoutViewComponentId)
                .AsEnumerable();
            Assert.Collection(
                layoutViewFrames,
            ...
            var testLayoutFrames = _renderer.GetCurrentRenderTreeFrames(testLayoutComponentId)
                .AsEnumerable();
            Assert.Collection(
                testLayoutFrames,
            ...
            var pageComponentId =
                batch.GetComponentFrames<ComponentWithLayout>().Single().ComponentId;
