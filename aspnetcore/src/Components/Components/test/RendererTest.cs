...
public class RendererTest
{
    ...
    public void CanDispatchEventsToNestedComponents()
    {
        ...
        var eventHandlerId = renderer.Batches[1].ReferenceFrames
    ...
    public async Task EventDispatching_DelegateParameter_MethodToDelegateConversion()
    {
        ...
        var eventHandlerId = renderer.Batches[0].ReferenceFrames
...
#nullable enable
        var value = "value";
        var eventCallback = new EventCallback<string?>(
            component,
            (string? __value) =>
            {
                value = __value;
                    ...
                    RuntimeHelpers.CreateInferredEventCallback(
                        ...
                        async __value =>
                        {
                            ...
                            await EventCallback.Factory
                                .Create(component, () => Task.CompletedTask)
                                .InvokeAsync();
                        },
                        value
                    ),
