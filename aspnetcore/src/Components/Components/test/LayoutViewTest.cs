...
namespace Microsoft.AspNetCore.Components.Test
{
    public class LayoutViewTest
    {
        ...
        public void GivenNoParameters_RendersNothing()
        {
            ...
            var frames = _renderer
                .GetCurrentRenderTreeFrames(_layoutViewComponentId)
                .AsEnumerable();
        ...
        public void GivenLayoutButNoContent_RendersLayoutWithEmptyBody()
        {
            ...
            var rootLayoutFrames = _renderer
                .GetCurrentRenderTreeFrames(rootLayoutComponentId)
                .AsEnumerable();
            Assert.Collection(
                rootLayoutFrames,
        ...
        public void RendersContentInsideNestedLayout()
        {
            ...
            var nestedLayoutFrames = _renderer
                .GetCurrentRenderTreeFrames(nestedLayoutComponentId)
                .AsEnumerable();
            Assert.Collection(
                nestedLayoutFrames,
