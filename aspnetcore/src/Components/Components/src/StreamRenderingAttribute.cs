...
/// server-side HTML rendering from a Razor Component endpoint). In other hosting models it has no
// effect.
///
/// If a component type does not declare this attribute, then instances of that component type will
// share
...
public class StreamRenderingAttribute : Attribute
{
    ...
    /// </summary>
    /// <param name="enabled">A flag to indicate whether this component and its descendants should
    // stream their rendering. The default value is true.</param>
