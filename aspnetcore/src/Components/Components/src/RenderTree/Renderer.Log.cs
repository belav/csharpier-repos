    ...
    public abstract partial class Renderer
    {
        internal static class Log
        {
            private static readonly Action<
                ...
                Type,
                Exception
            > _initializingChildComponent = LoggerMessage.Define<int, Type, int, Type>(
                LogLevel.Debug,
                new EventId(1, "InitializingChildComponent"),
                "Initializing component {ComponentId} ({ComponentType}) as child of {ParentComponentId} ({ParentComponentId})",
            ...
            private static readonly Action<
                ...
                Type,
                Exception
            > _initializingRootComponent = LoggerMessage.Define<int, Type>(
                LogLevel.Debug,
                new EventId(2, "InitializingRootComponent"),
            ...
            private static readonly Action<ILogger, int, Type, Exception> _renderingComponent =
                LoggerMessage.Define<int, Type>(
                    LogLevel.Debug,
                    new EventId(3, "RenderingComponent"),
            ...
            private static readonly Action<ILogger, int, Type, Exception> _disposingComponent =
                LoggerMessage.Define<int, Type>(
                    LogLevel.Debug,
                    new EventId(4, "DisposingComponent"),
