...
public abstract partial class Renderer
{
    internal static partial class Log
    {
        [LoggerMessage(
            1,
            LogLevel.Debug,
            "Initializing component {ComponentId} ({ComponentType}) as child of {ParentComponentId} ({ParentComponentType})",
        ...
        [LoggerMessage(
            2,
            LogLevel.Debug,
            "Initializing root component {ComponentId} ({ComponentType})",
        ...
        public static void InitializingComponent(
            ILogger logger,
        ...
        )
        {
            if (logger.IsEnabled(LogLevel.Debug)) // This is almost always false, so skip the evaluations
            {
                ...
                {
                    InitializingChildComponent(
                        logger,
                        componentState.ComponentId,
                        componentState.Component.GetType(),
                        parentComponentState.ComponentId,
                        parentComponentState.Component.GetType()
                    );
                }
            }
        }
        ...
        [LoggerMessage(
            3,
            LogLevel.Debug,
            "Rendering component {ComponentId} of type {ComponentType}",
        ...
        [LoggerMessage(
            4,
            LogLevel.Debug,
            "Disposing component {ComponentId} of type {ComponentType}",
        ...
        [LoggerMessage(
            5,
            LogLevel.Debug,
            "Handling event {EventId} of type '{EventType}'",
        ...
        [LoggerMessage(
            6,
            LogLevel.Debug,
            "Skipping attempt to raise event {EventId} of type '{EventType}' because the component ID {ComponentId} was already disposed",
            EventName = "SkippingEventOnDisposedComponent",
            SkipEnabledCheck = true
        )]
        public static partial void SkippingEventOnDisposedComponent(
            ILogger logger,
            int componentId,
            ulong eventId,
            string eventType
        ...
        public static void SkippingEventOnDisposedComponent(
            ILogger logger,
            int componentId,
        ...
        )
        {
            if (logger.IsEnabled(LogLevel.Debug)) // This is almost always false, so skip the evaluations
            {
                SkippingEventOnDisposedComponent(
                    logger,
                    componentId,
                    eventHandlerId,
