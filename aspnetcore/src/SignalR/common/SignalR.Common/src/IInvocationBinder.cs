...
/// <summary>
/// Class used by <see cref="IHubProtocol"/>s to get the <see cref="Type"/>(s) expected by the hub
// message being deserialized.
/// </summary>
public interface IInvocationBinder
{
    /// <summary>
    /// Gets the <see cref="Type"/> the invocation represented by the <paramref name="invocationId"/> is
    // expected to contain.
    /// </summary>
    ...
    /// <summary>
    /// Gets the list of <see cref="Type"/>s the method represented by <paramref name="methodName"/>
    // takes as arguments.
    /// </summary>
    ...
    /// <returns>A string that represents the target or null if the target string couldn't be
    // determined.</returns>
