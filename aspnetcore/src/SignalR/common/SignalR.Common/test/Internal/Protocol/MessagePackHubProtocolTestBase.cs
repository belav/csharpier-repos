...
{
    protected static readonly IDictionary<string, string> TestHeaders = new Dictionary<
        string,
        string
    >
    {
    ...
    public static IDictionary<string, ProtocolTestData> BaseTestData =>
        new[]
        {
            ...
            new ProtocolTestData(
                ...
                message: AddHeaders(
                    TestHeaders,
                    CompletionMessage.WithError("xyz", error: "Error not found!")
                ),
            ...
            // Ping Messages
            new ProtocolTestData(name: "Ping", message: PingMessage.Instance, binary: "kQY="),
            // Close Messages
            new ProtocolTestData(
                name: "CloseMessage",
            ...
            // Ack Message
            new ProtocolTestData(name: "AckMessage", message: new AckMessage(42), binary: "kggq"),
            // Sequence Message
            new ProtocolTestData(
    ...
    protected void TestParseMessages(ProtocolTestData testData)
    {
        ...
        Assert.True(
            HubProtocol.TryParseMessage(ref data, new TestBinder(testData.Message), out var message)
        );
    ...
    public void ParseMessageWithExtraData()
    {
        ...
        var data = new ReadOnlySequence<byte>(bytes);
        Assert.True(
            HubProtocol.TryParseMessage(ref data, new TestBinder(expectedMessage), out var message)
        );
    ...
    protected void TestWriteMessages(ProtocolTestData testData)
    {
        ...
        Assert.True(
            string.Equals(actual, testData.Binary, StringComparison.Ordinal),
            $"Binary encoding changed from{Environment.NewLine} [{testData.Binary}]{Environment.NewLine} to{Environment.NewLine} [{actual}]{Environment.NewLine}Please verify the MsgPack output and update the baseline"
        );
    }
    ...
    public static IDictionary<string, InvalidMessageData> BaseInvalidPayloads =>
        new[]
        {
            ...
            new InvalidMessageData(
                "MessageTypeString",
                new byte[] { 0x91, 0xa3, (byte)'f', (byte)'o', (byte)'o' },
                "Reading 'messageType' as Int32 failed."
            ),
            // Headers
            new InvalidMessageData(
                "HeadersNotAMap",
                new byte[] { 0x92, 1, 0xa3, (byte)'f', (byte)'o', (byte)'o' },
                "Reading map length for 'headers' failed."
            ),
            new InvalidMessageData(
                "HeaderKeyInt",
                new byte[] { 0x92, 1, 0x82, 0x2a, 0xa3, (byte)'f', (byte)'o', (byte)'o' },
                "Reading 'headers[0].Key' as String failed."
            ),
            new InvalidMessageData(
                "HeaderValueInt",
                new byte[] { 0x92, 1, 0x82, 0xa3, (byte)'f', (byte)'o', (byte)'o', 42 },
                "Reading 'headers[0].Value' as String failed."
            ),
            new InvalidMessageData(
                "HeaderKeyArray",
                new byte[]
            ...
            new InvalidMessageData(
                "HeaderKeyEmptyString",
                new byte[] { 0x92, 1, 0x82, 0xa0, 0xa3, (byte)'f', (byte)'o', (byte)'o' },
                "Null or empty key in header."
            ),
            new InvalidMessageData(
                "HeaderValueEmptyString",
                new byte[] { 0x92, 1, 0x82, 0xa3, (byte)'f', (byte)'o', (byte)'o', 0xa0 },
                "Null or empty value in header."
            ),
            // InvocationMessage
            new InvalidMessageData(
                "InvocationMissingId",
                new byte[] { 0x92, 1, 0x80 },
                "Reading 'invocationId' as String failed."
            ),
            new InvalidMessageData(
                "InvocationIdBoolean",
                new byte[] { 0x91, 1, 0x80, 0xc2 },
                "Reading 'invocationId' as String failed."
            ),
            new InvalidMessageData(
                "InvocationTargetMissing",
                new byte[] { 0x93, 1, 0x80, 0xa3, (byte)'a', (byte)'b', (byte)'c' },
                "Reading 'target' as String failed."
            ),
            new InvalidMessageData(
                "InvocationTargetInt",
                new byte[] { 0x94, 1, 0x80, 0xa3, (byte)'a', (byte)'b', (byte)'c', 42 },
                "Reading 'target' as String failed."
            ),
            new InvalidMessageData(
                "InvocationTargetEmptyString",
                new byte[] { 0x94, 1, 0x80, 0xa3, (byte)'a', (byte)'b', (byte)'c', 0xa0 },
                "Null or empty target for Invocation message."
            ),
            new InvalidMessageData(
                "InvocationEmptyStringStreamId",
                new byte[]
                {
                    0x96,
                    1,
            ...
            new InvalidMessageData(
                "StreamInvocationMissingId",
                new byte[] { 0x92, 4, 0x80 },
                "Reading 'invocationId' as String failed."
            ),
            new InvalidMessageData(
                "StreamInvocationEmptyStringId",
                new byte[] { 0x93, 4, 0x80, 0xa0 },
                "Null or empty invocation ID for StreamInvocation message."
            ),
            new InvalidMessageData(
                "StreamInvocationIdBoolean",
                new byte[] { 0x93, 4, 0x80, 0xc2 },
                "Reading 'invocationId' as String failed."
            ),
            new InvalidMessageData(
                "StreamInvocationTargetMissing",
                new byte[] { 0x93, 4, 0x80, 0xa3, (byte)'a', (byte)'b', (byte)'c' },
                "Reading 'target' as String failed."
            ),
            new InvalidMessageData(
                "StreamInvocationTargetInt",
                new byte[] { 0x94, 4, 0x80, 0xa3, (byte)'a', (byte)'b', (byte)'c', 42 },
                "Reading 'target' as String failed."
            ),
            new InvalidMessageData(
                "StreamInvocationTargetEmptyString",
                new byte[] { 0x94, 4, 0x80, 0xa3, (byte)'a', (byte)'b', (byte)'c', 0xa0 },
                "Null or empty target for StreamInvocation message."
            ),
            // StreamItemMessage
            new InvalidMessageData(
                "StreamItemMissingId",
                new byte[] { 0x92, 2, 0x80 },
                "Reading 'invocationId' as String failed."
            ),
            new InvalidMessageData(
                "StreamItemEmptyStringId",
                new byte[] { 0x93, 2, 0x80, 0xa0 },
                "Null or empty invocation ID for StreamItem message."
            ),
            new InvalidMessageData(
                "StreamItemInvocationIdBoolean",
                new byte[] { 0x93, 2, 0x80, 0xc2 },
                "Reading 'invocationId' as String failed."
            ),
            ...
            new InvalidMessageData(
                "CompletionMissingId",
                new byte[] { 0x92, 3, 0x80 },
                "Reading 'invocationId' as String failed."
            ),
            new InvalidMessageData(
                "CompletionEmptyStringId",
                new byte[] { 0x93, 3, 0x80, 0xa0 },
                "Null or empty invocation ID for Completion message."
            ),
            new InvalidMessageData(
                "CompletionIdBoolean",
                new byte[] { 0x93, 3, 0x80, 0xc2 },
                "Reading 'invocationId' as String failed."
            ),
            new InvalidMessageData(
                "CompletionResultKindString",
                new byte[]
                {
                    0x94,
                    3,
            ...
            new InvalidMessageData(
                "CompletionResultKindOutOfRange",
                new byte[] { 0x94, 3, 0x80, 0xa3, (byte)'x', (byte)'y', (byte)'z', 42 },
                "Invalid invocation result kind."
            ),
            new InvalidMessageData(
                "CompletionErrorMissing",
                new byte[] { 0x94, 3, 0x80, 0xa3, (byte)'x', (byte)'y', (byte)'z', 0x01 },
                "Reading 'error' as String failed."
            ),
            new InvalidMessageData(
                "CompletionErrorInt",
                new byte[] { 0x95, 3, 0x80, 0xa3, (byte)'x', (byte)'y', (byte)'z', 0x01, 42 },
                "Reading 'error' as String failed."
            ),
            ...
            new InvalidMessageData(
                "CancelInvocationMissingId",
                new byte[] { 0x92, 5, 0x80 },
                "Reading 'invocationId' as String failed."
            ),
            new InvalidMessageData(
                "CancelInvocationEmptyStringId",
                new byte[] { 0x93, 5, 0x80, 0xa0 },
                "Null or empty invocation ID for CancelInvocation message."
            ),
            // AckMessage
            new InvalidMessageData(
                "AckSequenceIdMissing",
                new byte[] { 0x91, 8 },
                "Reading 'sequenceId' as Int64 failed."
            ),
            new InvalidMessageData(
                "AckSequenceIdNull",
                new byte[] { 0x91, 8, 0xc0 },
                "Reading 'sequenceId' as Int64 failed."
            ),
            // SequenceMessage
            new InvalidMessageData(
                "SequenceMessageSequenceIdMissing",
                new byte[] { 0x91, 9 },
                "Reading 'sequenceId' as Int64 failed."
            ),
            new InvalidMessageData(
                "SequenceMessageSequenceIdNull",
                new byte[] { 0x91, 9, 0xc0 },
                "Reading 'sequenceId' as Int64 failed."
            ),
        }.ToDictionary(t => t.Name);

    public static IEnumerable<object[]> BaseInvalidPayloadNames =>
        BaseInvalidPayloads.Keys.Select(name => new object[] { name });
    ...
    public static IDictionary<string, InvalidMessageData> ArgumentBindingErrors =>
        new[]
        {
            // InvocationMessage
            new InvalidMessageData(
                "InvocationArgumentArrayMissing",
                new byte[]
                {
                    0x94,
                    1,
            ...
            new InvalidMessageData(
                "InvocationArgumentArrayNotAnArray",
                new byte[]
                {
                    0x95,
                    1,
            ...
            new InvalidMessageData(
                "InvocationArgumentArraySizeMismatchEmpty",
                new byte[]
                {
                    0x95,
                    1,
            ...
            new InvalidMessageData(
                "InvocationArgumentArraySizeMismatchTooLarge",
                new byte[]
                {
                    0x95,
                    1,
            ...
            // StreamInvocationMessage
            new InvalidMessageData(
                "StreamInvocationArgumentArrayMissing",
                new byte[]
                {
                    0x94,
                    4,
            ...
            new InvalidMessageData(
                "StreamInvocationArgumentArrayNotAnArray",
                new byte[]
                {
                    0x95,
                    4,
            ...
            new InvalidMessageData(
                "StreamInvocationArgumentArraySizeMismatchEmpty",
                new byte[]
                {
                    0x95,
                    4,
            ...
            new InvalidMessageData(
                "StreamInvocationArgumentArraySizeMismatchTooLarge",
                new byte[]
                {
                    0x95,
                    4,
            ...
            new InvalidMessageData(
                "StreamInvocationArgumentTypeMismatch",
                new byte[]
                {
                    0x95,
                    4,
    ...
    public static IEnumerable<object[]> ArgumentBindingErrorNames =>
        ArgumentBindingErrors.Keys.Select(name => new object[] { name });
