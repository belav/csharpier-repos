...
public abstract class MessagePackHubProtocolTestBase
{
    ...
    public static IDictionary<string, InvalidMessageData> BaseInvalidPayloads =>
        new[]
        {
            ...
            new InvalidMessageData(
                "CompletionResultMissing",
                new byte[] { 0x94, 3, 0x80, 0xa3, (byte)'x', (byte)'y', (byte)'z', 0x03 },
                "Deserializing object of the `String` type for 'argument' failed."
            ),
            new InvalidMessageData(
                "CompletionResultTypeMismatch",
                new byte[] { 0x95, 3, 0x80, 0xa3, (byte)'x', (byte)'y', (byte)'z', 0x03, 42 },
                "Deserializing object of the `String` type for 'argument' failed."
            ),
        }.ToDictionary(t => t.Name);
