...
public class MessagePackHubProtocolTests : MessagePackHubProtocolTestBase
{
    ...
    public void WriteAndParseDateTimeConvertsToUTC(DateTimeKind dateTimeKind)
    {
        ...
        try
        {
            ...
            HubProtocol.TryParseMessage(
                ref bytes,
                new TestBinder(typeof(DateTime)),
                out var hubMessage
            );
            ...
            var expectedUtcDateTime =
                (originalDateTime.Kind == DateTimeKind.Local)
                    ? originalDateTime.ToUniversalTime()
                    : originalDateTime;
    ...
    public void WriteAndParseDateTimeOffset()
    {
        ...
        try
        {
            ...
            HubProtocol.TryParseMessage(
                ref bytes,
                new TestBinder(typeof(DateTimeOffset)),
                out var hubMessage
            );
    ...
    public static IDictionary<string, MessagePackHubProtocolTestBase.ProtocolTestData> TestData =>
        new[]
        {
            // Completion messages
            ...
            new ProtocolTestData(
                ...
                message: CompletionMessage.WithResult(
                    "xyz",
                    payload: new[] { new CustomObject(), new CustomObject() }
                ),
            ...
            new ProtocolTestData(
                ...
                message: new InvocationMessage(
                    "method",
                    new object[] { 42, "string", new CustomObject() }
                ),
            ...
            new ProtocolTestData(
                ...
                message: new InvocationMessage(
                    "method",
                    new object[] { new CustomObject(), new CustomObject() }
                ),
            ...
            new ProtocolTestData(
                ...
                message: new StreamItemMessage(
                    "xyz",
                    item: new[] { new CustomObject(), new CustomObject() }
                ),
    ...
    public static IDictionary<string, ClientResultTestData> ClientResultData =>
        new[]
        {
            ...
            new ClientResultTestData(
                "ComplexResult",
                "lQOAo3h5egOGqlN0cmluZ1Byb3CoU2lnbmFsUiGqRG91YmxlUHJvcMtAGSH7VELPEqdJbnRQcm9wKqxEYXRlVGltZVByb3DW/1jsHICoTnVsbFByb3DAq0J5dGVBcnJQcm9wxAMBAgM=",
                typeof(CustomObject),
                new CustomObject()
            ),
        }.ToDictionary(t => t.Name);
