...
internal sealed class ClientResultsManager : IInvocationBinder
{
    ...
    public void AddInvocation(
        string invocationId,
        (Type Type, string ConnectionId, object Tcs, Action<
            object,
            CompletionMessage
    ...
    public (Type Type, string ConnectionId, object Tcs, Action<
        object,
        CompletionMessage
    ...
    internal sealed class TaskCompletionSourceWithCancellation<T> : TaskCompletionSource<T>
    {
        ...
        public new void SetCanceled()
        {
            ...
            _clientResultsManager.TryCompleteResult(
                _connectionId,
                CompletionMessage.WithError(_invocationId, "Canceled")
            );
        }
