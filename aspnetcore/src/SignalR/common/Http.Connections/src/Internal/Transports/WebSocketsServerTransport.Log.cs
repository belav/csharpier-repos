...
internal partial class WebSocketsServerTransport
{
    private static class Log
    {
        ...
        private static readonly Action<
            ...
            string,
            Exception?
        > _clientClosed = LoggerMessage.Define<WebSocketCloseStatus?, string>(
            LogLevel.Debug,
            new EventId(3, "ClientClosed"),
        ...
        private static readonly Action<ILogger, Exception?> _waitingForSend = LoggerMessage.Define(
            LogLevel.Debug,
            new EventId(4, "WaitingForSend"),
            "Waiting for the application to finish sending data."
        );

        private static readonly Action<ILogger, Exception?> _failedSending = LoggerMessage.Define(
            LogLevel.Debug,
            new EventId(5, "FailedSending"),
            "Application failed during sending. Sending InternalServerError close frame."
        );

        private static readonly Action<ILogger, Exception?> _finishedSending = LoggerMessage.Define(
            LogLevel.Debug,
            new EventId(6, "FinishedSending"),
        ...
        private static readonly Action<
            ...
            bool,
            Exception?
        > _messageReceived = LoggerMessage.Define<WebSocketMessageType, int, bool>(
            LogLevel.Trace,
            new EventId(9, "MessageReceived"),
        ...
        private static readonly Action<ILogger, int, Exception?> _messageToApplication =
            LoggerMessage.Define<int>(
                LogLevel.Trace,
                new EventId(10, "MessageToApplication"),
        ...
        private static readonly Action<ILogger, Exception?> _errorWritingFrame =
            LoggerMessage.Define(
                LogLevel.Debug,
                new EventId(12, "ErrorWritingFrame"),
                "Error writing frame."
            );
        ...
        private static readonly Action<ILogger, Exception?> _closedPrematurely =
            LoggerMessage.Define(
                LogLevel.Debug,
                new EventId(14, "ClosedPrematurely"),
        ...
        private static readonly Action<ILogger, Exception?> _closingWebSocketFailed =
            LoggerMessage.Define(
                LogLevel.Debug,
                new EventId(15, "ClosingWebSocketFailed"),
