...
internal sealed partial class HttpConnectionDispatcher
{
    internal static partial class Log
    {
        ...
        [LoggerMessage(
            17,
            LogLevel.Warning,
            "The name of the user changed from '{PreviousUserName}' to '{CurrentUserName}'.",
            EventName = "UserNameChanged"
        )]
        private static partial void UserNameChangedInternal(
            ILogger logger,
        ...
        [LoggerMessage(
            18,
            LogLevel.Debug,
            "Exception from IStatefulReconnectFeature.NotifyOnReconnect callback.",
            EventName = "NotifyOnReconnectError"
        )]
