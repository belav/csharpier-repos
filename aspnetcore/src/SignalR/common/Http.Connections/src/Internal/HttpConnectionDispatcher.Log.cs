        ...
        internal static class Log
        {
            private static readonly Action<ILogger, string, Exception?> _connectionDisposed =
                LoggerMessage.Define<string>(
                    LogLevel.Debug,
                    new EventId(1, "ConnectionDisposed"),
            ...
            private static readonly Action<
                ...
                string,
                Exception?
            > _connectionAlreadyActive = LoggerMessage.Define<string, string>(
                LogLevel.Debug,
                new EventId(2, "ConnectionAlreadyActive"),
            ...
            private static readonly Action<ILogger, Exception?> _establishedConnection =
                LoggerMessage.Define(
                    LogLevel.Debug,
                    new EventId(4, "EstablishedConnection"),
            ...
            private static readonly Action<ILogger, Exception?> _resumingConnection =
                LoggerMessage.Define(
                    LogLevel.Debug,
                    new EventId(5, "ResumingConnection"),
            ...
            > _transportNotSupported = LoggerMessage.Define<HttpTransportType>(
                LogLevel.Debug,
                new EventId(7, "TransportNotSupported"),
            ...
            private static readonly Action<
                ...
                HttpTransportType,
                Exception?
            > _cannotChangeTransport = LoggerMessage.Define<HttpTransportType, HttpTransportType>(
                LogLevel.Debug,
                new EventId(8, "CannotChangeTransport"),
            ...
            private static readonly Action<ILogger, Exception?> _postNotallowedForWebsockets =
                LoggerMessage.Define(
                    LogLevel.Debug,
                    new EventId(9, "PostNotAllowedForWebSockets"),
            ...
            private static readonly Action<ILogger, Exception?> _negotiationRequest =
                LoggerMessage.Define(
                    LogLevel.Debug,
                    new EventId(10, "NegotiationRequest"),
            ...
            private static readonly Action<
                ...
                HttpTransportType,
                Exception?
            > _receivedDeleteRequestForUnsupportedTransport =
                LoggerMessage.Define<HttpTransportType>(
                    LogLevel.Trace,
                    new EventId(11, "ReceivedDeleteRequestForUnsupportedTransport"),
            ...
            private static readonly Action<ILogger, Exception?> _terminatingConnection =
                LoggerMessage.Define(
                    LogLevel.Trace,
                    new EventId(12, "TerminatingConection"),
            ...
            private static readonly Action<
                ...
                string,
                Exception?
            > _connectionDisposedWhileWriteInProgress = LoggerMessage.Define<string>(
                LogLevel.Debug,
                new EventId(13, "ConnectionDisposedWhileWriteInProgress"),
            ...
            private static readonly Action<
                ...
                string,
                Exception?
            > _failedToReadHttpRequestBody = LoggerMessage.Define<string>(
                LogLevel.Debug,
                new EventId(14, "FailedToReadHttpRequestBody"),
            ...
            private static readonly Action<
                ...
                int,
                Exception?
            > _negotiateProtocolVersionMismatch = LoggerMessage.Define<int>(
                LogLevel.Debug,
                new EventId(15, "NegotiateProtocolVersionMismatch"),
            ...
            private static readonly Action<
                ...
                string,
                Exception?
            > _invalidNegotiateProtocolVersion = LoggerMessage.Define<string>(
                LogLevel.Debug,
                new EventId(16, "InvalidNegotiateProtocolVersion"),
            ...
            public static void ConnectionAlreadyActive(
                ILogger logger,
                string connectionId,
                string requestId
            )
            ...
            public static void CannotChangeTransport(
                ILogger logger,
            ...
            public static void ConnectionDisposedWhileWriteInProgress(
                ILogger logger,
                string connectionId,
                Exception ex
            )
            ...
            public static void FailedToReadHttpRequestBody(
                ILogger logger,
                string connectionId,
                Exception ex
            )
