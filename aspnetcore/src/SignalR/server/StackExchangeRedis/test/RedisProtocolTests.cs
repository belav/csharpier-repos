...
public class RedisProtocolTests
{
    ...
    public static IEnumerable<object[]> AckTestData = _ackTestData.Keys.Select(k =>
        new object[] { k }
    );
    ...
    public static IEnumerable<object[]> GroupCommandTestData = _groupCommandTestData.Keys.Select(
        k => new object[] { k }
    );
    ...
    private static readonly InvocationMessage _testMessage = new InvocationMessage(
        "target",
        Array.Empty<object>()
    );
    ...
    public static IEnumerable<object[]> InvocationTestData = _invocationTestData.Keys.Select(k =>
        new object[] { k }
    );
    ...
    public void WriteInvocation(string testName)
    {
        ...
        var encoded = protocol.WriteInvocation(
            ...
            excludedConnectionIds: expected.ExcludedConnectionIds
        );
    ...
    private static readonly Dictionary<
        string,
        ProtocolTestData<RedisCompletion>
    > _completionMessageTestData = new[]
    {
        CreateTestData<RedisCompletion>(
            ...
            new RedisCompletion(
                ...
                new ReadOnlySequence<byte>(
                    Encoding.UTF8.GetBytes("{\"type\":3,\"invocationId\":\"1\",\"result\":1}")
                )
            ),
            0x92,
            0xa4,
    ...
    public static IEnumerable<object[]> CompletionMessageTestData =
        _completionMessageTestData.Keys.Select(k => new object[] { k });
    ...
    public void ParseCompletionMessage(string testName)
    {
        ...
        Assert.Equal(
            ...
            completionMessage.CompletionMessage.ToArray()
        );
    }
