        ...
        private static class Log
        {
            ...
            private static readonly Action<ILogger, Exception?> _handshakeCanceled =
                LoggerMessage.Define(
                    LogLevel.Debug,
                    new EventId(2, "HandshakeCanceled"),
                    "Handshake was canceled."
                );

            private static readonly Action<ILogger, Exception?> _sentPing = LoggerMessage.Define(
                LogLevel.Trace,
                new EventId(3, "SentPing"),
            ...
            private static readonly Action<ILogger, Exception?> _transportBufferFull =
                LoggerMessage.Define(
                    LogLevel.Debug,
                    new EventId(4, "TransportBufferFull"),
            ...
            private static readonly Action<ILogger, Exception> _failedWritingMessage =
                LoggerMessage.Define(
                    LogLevel.Error,
                    new EventId(6, "FailedWritingMessage"),
            ...
            private static readonly Action<
                ...
                int,
                Exception?
            > _protocolVersionFailed = LoggerMessage.Define<string, int>(
                LogLevel.Debug,
                new EventId(7, "ProtocolVersionFailed"),
            ...
            private static readonly Action<ILogger, long, Exception?> _handshakeSizeLimitExceeded =
                LoggerMessage.Define<long>(
                    LogLevel.Debug,
                    new EventId(10, "HandshakeSizeLimitExceeded"),
            ...
            public static void ProtocolVersionFailed(
                ILogger logger,
                string protocolName,
                int version
            )
