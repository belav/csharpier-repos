...
namespace Microsoft.AspNetCore.SignalR.Internal
{
    ...
    {
        private readonly Dictionary<string, HubMethodDescriptor> _methods = new Dictionary<
            string,
            HubMethodDescriptor
        ...
        )
        {
            ...
            return SendInvocationError(
                bindingFailureMessage.InvocationId,
                connection,
                errorMessage
            );
        }
                    ...
                    else
                    {
                        ...
                        )
                        {
                            ...
                            catch (Exception ex)
                            {
                                ...
                                await dispatcher.SendInvocationError(
                                    hubMethodInvocationMessage.InvocationId,
                                    connection,
                                    ErrorMessageHelper.BuildErrorMessage(
                                        $"An unexpected error occurred invoking '{hubMethodInvocationMessage.Target}' on the server.",
                            ...
                            finally
                            {
                                ...
                                if (isStreamCall)
                                {
                                    await dispatcher.CleanupInvocation(
                                        connection,
                                        hubMethodInvocationMessage,
                                        hubActivator,
                                        hub,
        ...
        private ValueTask CleanupInvocation(
            HubConnectionContext connection,
        ...
        private Task<bool> IsHubMethodAuthorized(
