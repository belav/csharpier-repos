    ...
    public class HubConnectionHandlerTests : VerifiableLoggedTest
    {
        ...
        public async Task AsyncDisposablesInHubsAreSupported()
        {
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    var result = (
                        await client
                            .InvokeAsync(nameof(HubWithAsyncDisposable.Test))
                            .DefaultTimeout()
                    );
        ...
        public async Task AbortFromHubMethodForcesClientDisconnect()
        {
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    var close = Assert.IsType<CloseMessage>(
        ...
        public async Task MissingHandshakeAndMessageSentFromHubConnectionCanBeDisposedCleanly()
        {
            using (StartVerifiableLog())
            {
                ...
                var connectionHandler = serviceProvider.GetService<
                    HubConnectionHandler<SimpleHub>
                >();
            ...
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    Assert.Equal(
                        ...
                        ((HandshakeResponseMessage)message).Error
                    );
        ...
        public async Task LifetimeManagerOnDisconnectedAsyncCalledIfLifetimeManagerOnConnectedAsyncThrows()
        {
            using (StartVerifiableLog())
            {
                ...
                mockLifetimeManager
                    ...
                    .Throws(
                        new InvalidOperationException("Lifetime manager OnConnectedAsync failed.")
                    );
            ...
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    var result =
                        (
                            await client
                                .InvokeAsync(nameof(MethodHub.TaskValueMethod))
                                .DefaultTimeout()
                        ).Result;
            ...
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    var result =
                        (
                            await client
                                .InvokeAsync(nameof(MethodHub.ValueTaskMethod))
                                .DefaultTimeout()
                        ).Result;
        ...
        public async Task HubMethodsAreCaseInsensitive(Type hubType)
        {
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    var result =
                        (await client.InvokeAsync("echo", "hello").DefaultTimeout()).Result;
        ...
        public async Task HubMethodListeningToConnectionAbortedClosesOnConnectionContextAbort()
        {
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    await client
                        .SendInvocationAsync(nameof(MethodHub.BlockingMethod))
                        .DefaultTimeout();
        ...
        public async Task HubMethodCanBeRenamedWithAttribute()
        {
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    var result =
                        (await client.InvokeAsync("RenamedMethod").DefaultTimeout()).Result;
        ...
        public async Task NonBlockingInvocationDoesNotSendCompletion(string methodName)
        {
            ...
            using (StartVerifiableLog(ExpectedErrors))
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    await client
                        .SendInvocationAsync(methodName, nonBlocking: true)
                        .DefaultTimeout();
        ...
        public async Task CannotCallObjectMethodsOnHub()
        {
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    var result = await client
                        .InvokeAsync(nameof(MethodHub.ToString))
                        .DefaultTimeout();
                    Assert.Equal(
                    ...
                    result = await client
                        .InvokeAsync(nameof(MethodHub.GetHashCode))
                        .DefaultTimeout();
                    Assert.Equal(
        ...
        public async Task CannotCallDisposeMethodOnHub()
        {
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    var result = await client
                        .InvokeAsync(nameof(MethodHub.Dispose))
                        .DefaultTimeout();
        ...
        public async Task SendArraySendsArrayToAllClients()
        {
            using (StartVerifiableLog())
            {
                ...
                using (var secondClient = new TestClient())
                {
                    ...
                    await firstClient
                        .SendInvocationAsync(nameof(MethodHub.SendArray))
                        .DefaultTimeout();
        ...
        public async Task SendToOthers(Type hubType)
        {
            using (StartVerifiableLog())
            {
                ...
                using (var secondClient = new TestClient())
                {
                    ...
                    await firstClient
                        .SendInvocationAsync("SendToOthers", "To others")
                        .DefaultTimeout();
        ...
        public async Task SendToCaller(Type hubType)
        {
            using (StartVerifiableLog())
            {
                ...
                using (var secondClient = new TestClient())
                {
                    ...
                    await firstClient
                        .SendInvocationAsync("SendToCaller", "To caller")
                        .DefaultTimeout();
        ...
        public async Task InvokeMultipleGroups(Type hubType)
        {
            using (StartVerifiableLog())
            {
                ...
                using (var secondClient = new TestClient())
                {
                    ...
                    await firstClient
                        .SendInvocationAsync(
                            nameof(MethodHub.SendToMultipleGroups),
                            "test",
                            groupNames
                        )
                        .DefaultTimeout();
            ...
            using (StartVerifiableLog())
            {
                ...
                )
                {
                    ...
                    await client.Connected
                        .OrThrowIfOtherFails(connectionHandlerTask)
                        .DefaultTimeout();
        ...
        public async Task CanSendToConnectionsWithDifferentProtocols()
        {
            using (StartVerifiableLog())
            {
                ...
                using (var client2 = new TestClient(protocol: new MessagePackHubProtocol()))
                {
                    ...
                    await client1.SendInvocationAsync(
                        nameof(MethodHub.BroadcastMethod),
                        sentMessage
                    );
        ...
        public async Task HubOptionsCanUseCustomJsonSerializerSettings()
        {
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    await client
                        .SendInvocationAsync(nameof(MethodHub.BroadcastItem))
                        .DefaultTimeout();
            ...
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    var result =
                        (
                            await client
                                .InvokeAsync(nameof(MethodHub.HasHttpContext))
                                .DefaultTimeout()
                        ).Result;
            ...
            using (StartVerifiableLog())
            {
                ...
                var serviceProvider = HubConnectionHandlerTestUtils.CreateServiceProvider(
                    services =>
                        services.Configure<HubOptions>(
                            options =>
                                options.KeepAliveInterval = TimeSpan.FromMilliseconds(interval)
                        ),
                    LoggerFactory
                );
                var connectionHandler = serviceProvider.GetService<
        ...
        public async Task HubMethodInvokeDoesNotCountTowardsClientTimeout()
        {
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient(new JsonHubProtocol()))
                {
                    ...
                    var hubMethodTask = client.InvokeAsync(
            ...
            using (var client = new TestClient())
            {
                ...
                var ex = await Assert.ThrowsAsync<TimeoutException>(
                    async () =>
                    {
                        ...
                        var result = (CompletionMessage)await client
                            .ReadAsync()
                            .DefaultTimeout(5000);
                    }
                );
        ...
        public async Task UploadStreamedObjects()
        {
            ...
            using (var client = new TestClient())
            {
                ...
                var objects = new[]
                {
                    new SampleObject("solo", 322),
                    new SampleObject("ggez", 3145)
                };
        ...
        public async Task ConnectionAbortedIfSendFailsWithProtocolError()
        {
            using (StartVerifiableLog(write => write.EventId.Name == "FailedWritingMessage"))
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    await client
                        .SendInvocationAsync(nameof(MethodHub.ProtocolError))
                        .DefaultTimeout();
                    await connectionHandlerTask.DefaultTimeout();
                }
            }
        ...
        public async Task UploadStreamItemInvalidTypeAutoCasts()
        {
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    await client
                        .SendHubMessageAsync(new StreamItemMessage("id", 5))
                        .DefaultTimeout();
                    await client
                        .SendHubMessageAsync(new StreamItemMessage("id", 10))
                        .DefaultTimeout();

                    await client
                        .SendHubMessageAsync(CompletionMessage.Empty("id"))
                        .DefaultTimeout();
                    var response = (CompletionMessage)await client.ReadAsync().DefaultTimeout();
