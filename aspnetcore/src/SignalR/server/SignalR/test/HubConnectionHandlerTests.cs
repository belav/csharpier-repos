    ...
    public class HubConnectionHandlerTests : VerifiableLoggedTest
    {
        ...
        public async Task AsyncDisposablesInHubsAreSupported()
        {
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    var result = (
                        await client.InvokeAsync(nameof(HubWithAsyncDisposable.Test))
                            .DefaultTimeout()
                    );
        ...
        public async Task LifetimeManagerOnDisconnectedAsyncCalledIfLifetimeManagerOnConnectedAsyncThrows()
        {
            using (StartVerifiableLog())
            {
                ...
                mockLifetimeManager.Setup(m => m.OnConnectedAsync(It.IsAny<HubConnectionContext>()))
                    .Throws(
        ...
        public async Task HubMethodCanReturnValueFromTask()
        {
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    var result =
                        (
                            await client.InvokeAsync(nameof(MethodHub.TaskValueMethod))
                                .DefaultTimeout()
                        ).Result;
        ...
        public async Task HubMethodCanReturnValueFromValueTask()
        {
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    var result =
                        (
                            await client.InvokeAsync(nameof(MethodHub.ValueTaskValueMethod))
                                .DefaultTimeout()
                        ).Result;
        ...
        public async Task HubMethodCanReturnValueTask()
        {
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    var result =
                        (
                            await client.InvokeAsync(nameof(MethodHub.ValueTaskMethod))
                                .DefaultTimeout()
                        ).Result;
        ...
        public async Task CanCallInheritedHubMethodFromInheritingHub()
        {
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    var result =
                        (
                            await client.InvokeAsync(nameof(InheritedHub.BaseMethod), "string")
                                .DefaultTimeout()
                        ).Result;
        ...
        public async Task CanCallOverridenVirtualHubMethod()
        {
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    var result =
                        (
                            await client.InvokeAsync(nameof(InheritedHub.VirtualMethod), 10)
                                .DefaultTimeout()
                        ).Result;
            ...
            using (StartVerifiableLog())
            {
                ...
                using (var secondClient = new TestClient())
                {
                    ...
                    foreach (
                        ...
                        Assert.Single(invocation.Arguments);
                        var values = ((JArray)invocation.Arguments[0]).Select(t => t.Value<int>())
                            .ToArray();
        ...
        public async Task SendToAllExcept(Type hubType)
        {
            using (StartVerifiableLog())
            {
                ...
                using (var thirdClient = new TestClient())
                {
                    ...
                    await firstClient.SendInvocationAsync(
                            "SendToAllExcept",
                            "To second",
                            excludeThirdClientId
                        )
                        .DefaultTimeout();
                    await firstClient.SendInvocationAsync(
                            "SendToAllExcept",
                            "To third",
                            excludeSecondClientId
                        )
                        .DefaultTimeout();
        ...
        public async Task HubsCanAddAndSendToGroup(Type hubType)
        {
            using (StartVerifiableLog())
            {
                ...
                using (var secondClient = new TestClient())
                {
                    ...
                    var result =
                        (
                            await firstClient.InvokeAsync("GroupSendMethod", "testGroup", "test")
                                .DefaultTimeout()
                        ).Result;
                    ...
                    result =
                        (
                            await secondClient.InvokeAsync(
                                    nameof(MethodHub.GroupAddMethod),
                                    "testGroup"
                                )
                                .DefaultTimeout()
                        ).Result;
                    ...
                    await firstClient.SendInvocationAsync(
                            nameof(MethodHub.GroupSendMethod),
                            "testGroup",
                            "test"
                        )
                        .DefaultTimeout();
        ...
        public async Task HubsCanStreamResponses(string method, string protocolName)
        {
            using (StartVerifiableLog())
            {
                ...
                invocationBinder.Setup(b => b.GetStreamItemType(It.IsAny<string>()))
                ...
                using (
                    ...
                    await client.Connected.OrThrowIfOtherFails(connectionHandlerTask)
                        .DefaultTimeout();
        ...
        public async Task HubMethodWithAuthorizationProvidesResourceToAuthHandlers()
        {
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    var message = await client.InvokeAsync(
                            nameof(MethodHub.MultiParamAuthMethod),
                            "Hello",
                            "World!"
                        )
                        .DefaultTimeout();
        ...
        public async Task ConnectionUserIdIsAssignedByUserIdProvider()
        {
            using (StartVerifiableLog())
            {
                ...
                using (var client2 = new TestClient())
                {
                    ...
                    await client2.SendInvocationAsync(
                            nameof(MethodHub.SendToMultipleUsers),
                            new[] { "client1" },
                            "Hi!"
                        )
        ...
        public async Task CanGetHttpContextFromHubConnectionContext()
        {
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    var result =
                        (
                            await client.InvokeAsync(nameof(MethodHub.HasHttpContext))
                                .DefaultTimeout()
                        ).Result;
        ...
        public async Task StreamInvocationsDoNotBlockOtherInvocations()
        {
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    var streamInvocationId = await client.SendStreamInvocationAsync(
                            nameof(LongRunningHub.LongRunningStream),
                            null
                        )
                        .DefaultTimeout();
                    // Wait for the long running method to start
                    ...
                    await client.SendHubMessageAsync(
                            new CancelInvocationMessage(streamInvocationId)
                        )
                        .DefaultTimeout();
        ...
        public async Task SerializationExceptionsSendSelfArePassedToOnDisconnectedAsync()
        {
            using (StartVerifiableLog(write => write.EventId.Name == "FailedWritingMessage"))
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    await client.SendInvocationAsync(
                            nameof(ConnectionLifetimeHub.ProtocolErrorSelf)
                        )
                        .DefaultTimeout();
        ...
        public async Task UploadStreamItemInvalidType()
        {
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    await client.SendHubMessageAsync(
                            new StreamItemMessage("channelId", "not a number")
                        )
                        .DefaultTimeout();
                    var response = await client.ReadAsync().DefaultTimeout();
            ...
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    var connectionHandlerTask = await client.ConnectAsync(connectionHandler)
                        .DefaultTimeout();
                    await client.SendHubMessageAsync(
                            new StreamItemMessage("fake_id", "not a number")
                        )
                        .DefaultTimeout();
            ...
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    await client.BeginUploadStreamAsync(
                        ...
                        .DefaultTimeout();
                    await client.SendHubMessageAsync(
                            CompletionMessage.WithError("id", CustomErrorMessage)
                        )
                        .DefaultTimeout();
        ...
        public async Task UploadStreamAndStreamingMethodClosesStreamsOnServerWhenMethodCompletes()
        {
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    await client.SendStreamInvocationAsync(
        ...
        public async Task InvokeHubMethodCannotAcceptCancellationTokenAsArgument()
        {
            using (StartVerifiableLog())
            {
                ...
                using (var client = new TestClient())
                {
                    ...
                    var invocationId = await client.SendInvocationAsync(
        ...
        public async Task CanPassStreamingParameterToStreamHubMethod()
        {
            using (StartVerifiableLog())
            {
                ...
                using (
                    ...
                    var messagePromise = client.StreamAsync(
