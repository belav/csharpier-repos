...
public class UserAgentHeaderTest
{
    ...
    public void UserAgentHeaderIsCorrect(string testDataName)
    {
        ...
        Assert.Equal(
            testData.Expected,
            Constants.ConstructUserAgent(
                testData.Version,
                testData.DetailedVersion,
                testData.Os,
                testData.Runtime,
                testData.RuntimeVersion
            )
        );
    }

    public static Dictionary<string, UserAgentTestData> UserAgents =>
        new[]
        {
            new UserAgentTestData(
                "FullInfo",
                new Version(1, 4),
                "1.4.3-preview9",
                "Windows NT",
                ".NET",
                ".NET 4.8.7",
                "Microsoft SignalR/1.4 (1.4.3-preview9; Windows NT; .NET; .NET 4.8.7)"
            ),
            new UserAgentTestData(
                "EmptyOs",
                new Version(3, 1),
                ...
                ".NET",
                ".NET 4.8.9",
                "Microsoft SignalR/3.1 (3.1.0; Unknown OS; .NET; .NET 4.8.9)"
            ),
            new UserAgentTestData(
                "EmptyRuntimeVersion",
                new Version(3, 1),
                ...
                ".NET",
                "",
                "Microsoft SignalR/3.1 (3.1.0; Unknown OS; .NET; Unknown Runtime Version)"
            ),
            new UserAgentTestData(
                "EmptyDetailedVersion",
                new Version(3, 1),
                "",
                "Linux",
                ".NET",
