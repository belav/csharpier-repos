        ...
        )
        {
                ...
                (context, next) =>
                {
                    ...
                    if (!StringValues.IsNullOrEmpty(originHeader))
                    {
                        ...
                        context.Response.Headers[HeaderNames.AccessControlAllowOrigin] =
                            originHeader;
                        context.Response.Headers[HeaderNames.AccessControlAllowCredentials] =
                            "true";

                        var requestMethod = context.Request.Headers[
            ...
            app.Use(
                (context, next) =>
                {
                    ...
                    {
                        var newUrl =
                            context.Request.Query["baseUrl"]
                            + "/testHub?numRedirects="
                            + Interlocked.Increment(ref _numRedirects);
            ...
            app.UseEndpoints(
                endpoints =>
                {
                    ...
                    endpoints.MapGet(
                        ...
                        context =>
                        {
                            var attributes = Assembly.GetAssembly(typeof(Startup))
