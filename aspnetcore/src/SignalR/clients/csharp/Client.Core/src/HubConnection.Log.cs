...
public partial class HubConnection
{
    private static class Log
    {
        ...
        private static readonly Action<ILogger, Exception?> _receivedPing = LoggerMessage.Define(
            LogLevel.Trace,
        ...
        private static readonly Action<ILogger, Exception?> _receivedClose = LoggerMessage.Define(
            LogLevel.Debug,
        ...
        private static readonly Action<ILogger, Exception?> _reconnecting = LoggerMessage.Define(
            LogLevel.Information,
        ...
        private static readonly Action<
            ...
            HubConnectionState,
            Exception?
        > _attemptingStateTransition = LoggerMessage.Define<HubConnectionState, HubConnectionState>(
            LogLevel.Trace,
