...
public partial class HubConnection
{
    private static partial class Log
    {
        ...
        public static partial void ErrorSendingStreamCompletion(
            ILogger logger,
            string streamId,
            Exception exception
        );
        ...
        [LoggerMessage(
            ...
            EventName = "DroppingMessage"
        )]
        public static partial void DroppingMessage(
            ILogger logger,
            string messageType,
            string? invocationId
        );
        ...
        [LoggerMessage(
            ...
            EventName = "ReceivedSequenceMessage"
        )]
        ...
        [LoggerMessage(
            93,
            LogLevel.Debug,
            "HubProtocol '{Protocol} v{Version}' does not support Stateful Reconnect. Disabling the feature.",
            EventName = "DisablingReconnect"
        )]
