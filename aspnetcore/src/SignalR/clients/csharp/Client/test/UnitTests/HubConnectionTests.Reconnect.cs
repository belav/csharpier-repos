    ...
    public class Reconnect : VerifiableLoggedTest
    {
        ...
        public async Task HasCorrectRetryNumberAfterRetriesExhausted()
        {
            ...
            using (var logCollector = StartVerifiableLog(ExpectedErrors))
            {
                ...
                var attemptsLog = logs.SingleOrDefault(
                    r => r.Write.EventId.Name == "ReconnectAttemptsExhausted"
                );
                ...
                var waitingLog = logs.SingleOrDefault(
                    r => r.Write.EventId.Name == "AwaitingReconnectRetryDelay"
                );
