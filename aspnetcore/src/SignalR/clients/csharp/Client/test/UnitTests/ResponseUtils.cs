...
internal static class ResponseUtils
{
    ...
    {
        return request.Method == HttpMethod.Get
            && request.Headers.Accept.Any(h => h.MediaType == "text/event-stream");
    }
    ...
    public static string CreateNegotiationContent(
        string connectionId = "00000000-0000-0000-0000-000000000000",
