...
internal partial class WebSocketsTransport
{
    private static class Log
    {
        private static readonly Action<ILogger, TransferFormat, Uri, Exception?> _startTransport =
            LoggerMessage.Define<TransferFormat, Uri>(
        ...
        private static readonly Action<
            ...
            Exception?
        > _webSocketClosed = LoggerMessage.Define<WebSocketCloseStatus?>(
            LogLevel.Information,
            new EventId(11, "WebSocketClosed"),
        ...
        private static readonly Action<ILogger, long, Exception?> _receivedFromApp =
            LoggerMessage.Define<long>(
                LogLevel.Debug,
                new EventId(13, "ReceivedFromApp"),
        ...
        private static readonly Action<ILogger, Exception?> _sendMessageCanceled =
            LoggerMessage.Define(
                LogLevel.Information,
                new EventId(14, "SendMessageCanceled"),
        ...
        private static readonly Action<ILogger, Exception> _errorSendingMessage =
            LoggerMessage.Define(
                LogLevel.Error,
                new EventId(15, "ErrorSendingMessage"),
        ...
        private static readonly Action<ILogger, Exception?> _closingWebSocket =
            LoggerMessage.Define(
                LogLevel.Information,
                new EventId(16, "ClosingWebSocket"),
                "Closing WebSocket."
            );
        ...
        private static readonly Action<ILogger, Exception> _closingWebSocketFailed =
            LoggerMessage.Define(
                LogLevel.Debug,
                new EventId(17, "ClosingWebSocketFailed"),
                "Closing webSocket failed."
            );

        private static readonly Action<ILogger, Exception?> _cancelMessage = LoggerMessage.Define(
            LogLevel.Debug,
            new EventId(18, "CancelMessage"),
        ...
        private static readonly Action<ILogger, Exception?> _startedTransport =
            LoggerMessage.Define(
                LogLevel.Debug,
                new EventId(19, "StartedTransport"),
                "Started transport."
            );
        ...
        private static readonly Action<ILogger, Exception?> _headersNotSupported =
            LoggerMessage.Define(
                LogLevel.Warning,
                new EventId(20, "HeadersNotSupported"),
