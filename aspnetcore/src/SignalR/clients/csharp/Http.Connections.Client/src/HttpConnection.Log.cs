...
public partial class HttpConnection
{
    private static class Log
    {
        ...
        private static readonly Action<ILogger, Exception?> _skippingStart = LoggerMessage.Define(
            LogLevel.Debug,
            new EventId(2, "SkippingStart"),
        ...
        private static readonly Action<ILogger, Exception?> _disposingHttpConnection =
            LoggerMessage.Define(
                LogLevel.Debug,
                new EventId(4, "DisposingHttpConnection"),
                "Disposing HttpConnection."
            );

        private static readonly Action<ILogger, Exception?> _skippingDispose = LoggerMessage.Define(
            LogLevel.Debug,
            new EventId(5, "SkippingDispose"),
            "Skipping dispose, connection is already disposed."
        );

        private static readonly Action<ILogger, Exception?> _disposed = LoggerMessage.Define(
            LogLevel.Information,
            new EventId(6, "Disposed"),
        ...
        private static readonly Action<ILogger, string, Uri, Exception?> _startingTransport =
            LoggerMessage.Define<string, Uri>(
                LogLevel.Debug,
                new EventId(7, "StartingTransport"),
        ...
        private static readonly Action<ILogger, Uri, Exception?> _establishingConnection =
            LoggerMessage.Define<Uri>(
                LogLevel.Debug,
                new EventId(8, "EstablishingConnection"),
        ...
        private static readonly Action<ILogger, Uri, Exception> _errorWithNegotiation =
            LoggerMessage.Define<Uri>(
                LogLevel.Error,
                new EventId(10, "ErrorWithNegotiation"),
        ...
        private static readonly Action<
            ...
            HttpTransportType,
            Exception
        > _errorStartingTransport = LoggerMessage.Define<HttpTransportType>(
            LogLevel.Error,
            new EventId(11, "ErrorStartingTransport"),
        ...
        private static readonly Action<ILogger, string, Exception?> _transportNotSupported =
            LoggerMessage.Define<string>(
                LogLevel.Debug,
                new EventId(12, "TransportNotSupported"),
        ...
        private static readonly Action<
            ...
            string,
            Exception?
        > _transportDoesNotSupportTransferFormat = LoggerMessage.Define<string, string>(
            LogLevel.Debug,
        ...
        private static readonly Action<ILogger, string, Exception?> _transportDisabledByClient =
            LoggerMessage.Define<string>(
                LogLevel.Debug,
                new EventId(14, "TransportDisabledByClient"),
        ...
        private static readonly Action<ILogger, string, Exception> _transportFailed =
            LoggerMessage.Define<string>(
                LogLevel.Debug,
                new EventId(15, "TransportFailed"),
        ...
        private static readonly Action<
            ILogger,
            Exception?
        > _webSocketsNotSupportedByOperatingSystem = LoggerMessage.Define(
            LogLevel.Debug,
            new EventId(16, "WebSocketsNotSupportedByOperatingSystem"),
        ...
        private static readonly Action<ILogger, Exception> _transportThrewExceptionOnStop =
            LoggerMessage.Define(
                LogLevel.Error,
                new EventId(17, "TransportThrewExceptionOnStop"),
        ...
        private static readonly Action<ILogger, HttpTransportType, Exception?> _transportStarted =
            LoggerMessage.Define<HttpTransportType>(
                LogLevel.Debug,
                new EventId(18, "TransportStarted"),
        ...
        private static readonly Action<ILogger, Exception?> _serverSentEventsNotSupportedByBrowser =
            LoggerMessage.Define(
                LogLevel.Debug,
                new EventId(19, "ServerSentEventsNotSupportedByBrowser"),
        ...
        private static readonly Action<ILogger, Exception?> _cookiesNotSupported =
            LoggerMessage.Define(
                LogLevel.Trace,
                new EventId(20, "CookiesNotSupported"),
        ...
        public static void ErrorStartingTransport(
            ILogger logger,
            HttpTransportType transportType,
            Exception exception
        )
