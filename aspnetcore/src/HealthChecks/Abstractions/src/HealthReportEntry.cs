...
/// <summary>
/// Represents an entry in a <see cref="HealthReport"/>. Corresponds to the result of a single <see
// cref="IHealthCheck"/>.
/// </summary>
public struct HealthReportEntry
{
    ...
    /// <summary>
    /// Creates a new <see cref="HealthReportEntry"/> with the specified values for <paramref
    // name="status"/>, <paramref name="exception"/>,
    /// <paramref name="description"/>, and <paramref name="data"/>.
    /// </summary>
    /// <param name="status">A value indicating the health status of the component that was
    // checked.</param>
    ...
    // when checking for status (if any).</param>
    /// <param name="data">Additional key-value pairs describing the health of the component.</param>
    /// <param name="tags">Tags associated with the health check that generated the report
    // entry.</param>
    public HealthReportEntry(
        HealthStatus status,
        string? description,
    ...
    /// <summary>
    /// Gets an <see cref="System.Exception"/> representing the exception that was thrown when checking
    // for status (if any).
    /// </summary>
