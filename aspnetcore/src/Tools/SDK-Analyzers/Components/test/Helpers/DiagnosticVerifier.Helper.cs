...
public abstract partial class DiagnosticVerifier
{
    ...
    /// <summary>
    /// Given classes in the form of strings, their language, and an IDiagnosticAnalyzer to apply to it,
    ...
    /// <returns>A Tuple containing the Documents produced from the sources and their TextSpans if
    // relevant</returns>
