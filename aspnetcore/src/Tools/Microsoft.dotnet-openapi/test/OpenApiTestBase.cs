...
namespace Microsoft.DotNet.OpenApi.Tests
{
    public class OpenApiTestBase : IDisposable
    {
        ...
        protected const string ActualUrl =
  ...
  ""Packages""  :  {
    ...
    ""Newtonsoft.Json"": ""12.0.2""
        ...
        public TemporaryNSwagProject CreateBasicProject(bool withOpenApi)
        {
            ...
            var project = _tempDir.WithCSharpProject("testproj", sdk: "Microsoft.NET.Sdk.Web")
            ...
            tmp.WithContentFile("Startup.cs").Create();
        ...
        internal Application GetApplication(bool realHttp = false)
        {
            ...
            return new Application(_tempDir.Root, wrapper, _output, _error);
        }
        ...
        private IDictionary<string, Tuple<string, ContentDispositionHeaderValue>> DownloadMock()
        {
            ...
            return new Dictionary<string, Tuple<string, ContentDispositionHeaderValue>>
            {
                ...
                {
                    DifferentUrl,
                    Tuple.Create<string, ContentDispositionHeaderValue>(DifferentUrlContent, null)
                },
                {
                    PackageUrl,
                    Tuple.Create<string, ContentDispositionHeaderValue>(PackageUrlContent, null)
                },
                {
                    NoDispositionUrl,
                    Tuple.Create<string, ContentDispositionHeaderValue>(Content, null)
                },
        ...
        {
            Assert.True(
                string.IsNullOrEmpty(_error.ToString()),
                $"Threw error: {_error.ToString()}"
            );
    ...
    public class TestHttpClientWrapper : IHttpClientWrapper
    {
        ...
        public Task<IHttpResponseMessageWrapper> GetResponseAsync(string url)
        {
            ...
            return Task.FromResult<IHttpResponseMessageWrapper>(
                new TestHttpResponseMessageWrapper(stream, result?.Item2)
            );
        }
    }
