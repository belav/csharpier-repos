    ...
    where TRoleClaim : IdentityRoleClaim<TKey>, new()
{
    ...
    /// <summary>
    /// Gets or sets the <see cref="IdentityErrorDescriber"/> for any error that occurred with the
    // current operation.
    /// </summary>
    ...
    /// <returns>An instance of <typeparamref name="TKey"/> representing the provided <paramref
    // name="id"/>.</returns>
    ...
    /// <summary>
    /// Get the claims associated with the specified <paramref name="role"/> as an asynchronous
    // operation.
    /// </summary>
