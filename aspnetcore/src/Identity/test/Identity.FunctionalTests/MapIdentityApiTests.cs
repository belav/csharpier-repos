...
public class MapIdentityApiTests : LoggedTest
{
    ...
    {
        await using var app = await CreateAppAsync(
            services => AddIdentityApiEndpointsBearerOnly(services)
        );
        using var client = app.GetTestClient();
    ...
    public async Task CanEnableAndLoginWithTwoFactor(string addIdentityMode)
    {
        ...
        var twoFactorKeyContent = await twoFactorKeyResponse
            .Content
    ...
    public async Task CanLoginWithRecoveryCodeAndDisableTwoFactor()
    {
        ...
        var recoveryLoginContent = await recoveryLoginResponse
            .Content
            .ReadFromJsonAsync<JsonElement>();
    ...
    public async Task CanResetRecoveryCodes()
    {
        ...
        var resetRecoveryContent = await resetRecoveryResponse
            .Content
            .ReadFromJsonAsync<JsonElement>();
    ...
    public async Task CanUsePersistentTwoFactorCookies()
    {
        ...
        var persistent2faContent = await persistent2faResponse
            .Content
            .ReadFromJsonAsync<JsonElement>();
    ...
    public async Task CanChangeEmail(string addIdentityModes)
    {
        ...
        var originalNameIdentifier = infoResponse
            .GetProperty("claims")
            .GetProperty(ClaimTypes.NameIdentifier)
            .GetString();
        ...
        Assert.Equal(
            ...
            infoClaims.GetProperty(ClaimTypes.NameIdentifier).GetString()
        );
