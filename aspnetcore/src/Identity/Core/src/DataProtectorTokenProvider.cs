    ...
    where TUser : class
{
    ...
    /// <summary>
    /// Generates a protected token for the specified <paramref name="user"/> as an asynchronous
    // operation.
    /// </summary>
    /// <param name="purpose">The purpose the token will be used for.</param>
    /// <param name="manager">The <see cref="UserManager{TUser}"/> to retrieve user properties
    // from.</param>
    ...
    /// <summary>
    /// Validates the protected <paramref name="token"/> for the specified <paramref name="user"/> and
    // <paramref name="purpose"/> as an asynchronous operation.
    /// </summary>
    ...
    /// containing true if a token generated by this instance can be used as a Two Factor Authentication
    // token, otherwise false.
    /// </returns>
    /// <remarks>This method will always return false for instances of <see
    // cref="DataProtectorTokenProvider{TUser}"/>.</remarks>
