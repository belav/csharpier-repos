...
/// <summary>
/// Contains extension methods to <see cref="IServiceCollection"/> for configuring identity
// services.
/// </summary>
public static class IdentityServiceCollectionExtensions
{
    ...
    /// <returns>An <see cref="IdentityBuilder"/> for creating and configuring the identity
    // system.</returns>
