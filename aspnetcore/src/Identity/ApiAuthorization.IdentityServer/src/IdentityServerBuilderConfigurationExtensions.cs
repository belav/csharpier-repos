...
public static class IdentityServerBuilderConfigurationExtensions
{
    ...
    public static IIdentityServerBuilder AddApiResources(this IIdentityServerBuilder builder) =>
        builder.AddApiResources(configuration: null);
    ...
    )
    {
        ...
        builder
            .Services
            .AddSingleton<IEnumerable<ApiResource>>(sp =>
            {
    ...
    internal static IIdentityServerBuilder AddApiScopes(this IIdentityServerBuilder builder)
    {
        ...
        builder
            .Services
            .AddSingleton<IEnumerable<ApiScope>>(sp =>
            {
                var options = sp.GetRequiredService<IOptions<ApiAuthorizationOptions>>();
    ...
    )
    {
        ...
        builder
            .Services
            .AddSingleton<IEnumerable<IdentityResource>>(sp =>
            {
                var options = sp.GetRequiredService<IOptions<ApiAuthorizationOptions>>();
    ...
    )
    {
        ...
        builder
            .Services
            .AddSingleton<IEnumerable<Client>>(sp =>
            {
                var options = sp.GetRequiredService<IOptions<ApiAuthorizationOptions>>();
    ...
    )
    {
        ...
        builder
            .Services
            .AddSingleton<ISigningCredentialStore>(sp =>
            {
                var options = sp.GetRequiredService<IOptions<ApiAuthorizationOptions>>();
        ...
        builder
            .Services
            .AddSingleton<IValidationKeysStore>(sp =>
            {
                var options = sp.GetRequiredService<IOptions<ApiAuthorizationOptions>>();
