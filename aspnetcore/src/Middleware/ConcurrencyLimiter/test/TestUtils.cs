...
#pragma warning disable CS0618 // Type or member is obsolete
    ...
    public static ConcurrencyLimiterMiddleware CreateTestMiddleware_QueuePolicy(
    ...
    public static ConcurrencyLimiterMiddleware CreateTestMiddleware_StackPolicy(
        int maxConcurrentRequests,
        int requestQueueLimit,
        RequestDelegate onRejected = null,
        RequestDelegate next = null
...
internal class TestQueue : IQueuePolicy
{
    ...
    public static TestQueue AlwaysFalse = new TestQueue((_) => false);

    public static TestQueue AlwaysTrue = new TestQueue((_) => true);

    public static TestQueue AlwaysBlock = new TestQueue(
        async (_) =>
        {
