...
internal static partial class MigrationsEndPointMiddlewareLoggerExtensions
{
    ...
    public static partial void MigrationsEndPointMiddlewareException(
        this ILogger logger,
...
internal static partial class DatabaseErrorPageMiddlewareLoggerExtensions
{
    ...
    public static partial void ContextNotRegisteredDatabaseErrorPageMiddleware(
        this ILogger logger,
        string contextTypeName
    );
    ...
    public static partial void DatabaseErrorPageMiddlewareException(
        this ILogger logger,
        Exception exception
    );
}
...
internal static partial class DatabaseDeveloperPageExceptionFilterLoggerExtensions
{
    ...
    public static partial void ResponseStartedDatabaseDeveloperPageExceptionFilter(
        this ILogger logger
    );
}
