    ...
    internal static class LoggerExtensions
    {
        private static readonly Action<ILogger, Exception?> _wildcardDetected =
            LoggerMessage.Define(
                LogLevel.Debug,
                new EventId(0, "WildcardDetected"),
        ...
        private static readonly Action<ILogger, string, Exception?> _allowedHosts =
            LoggerMessage.Define<string>(
                LogLevel.Debug,
                new EventId(1, "AllowedHosts"),
                "Allowed hosts: {Hosts}",
                skipEnabledCheck: true
            );

        private static readonly Action<ILogger, Exception?> _allHostsAllowed = LoggerMessage.Define(
            LogLevel.Trace,
            new EventId(2, "AllHostsAllowed"),
        ...
        private static readonly Action<ILogger, string, Exception?> _requestRejectedMissingHost =
            LoggerMessage.Define<string>(
                ...
                new EventId(3, "RequestRejectedMissingHost"),
        ...
        private static readonly Action<ILogger, string, Exception?> _requestAllowedMissingHost =
            LoggerMessage.Define<string>(
                LogLevel.Debug,
                new EventId(4, "RequestAllowedMissingHost"),
        ...
        private static readonly Action<ILogger, string, Exception?> _allowedHostMatched =
            LoggerMessage.Define<string>(
                LogLevel.Trace,
                new EventId(5, "AllowedHostMatched"),
        ...
        private static readonly Action<ILogger, string, Exception?> _noAllowedHostMatched =
            LoggerMessage.Define<string>(
                LogLevel.Information,
                new EventId(6, "NoAllowedHostMatched"),
        ...
        public static void AllowedHosts(this ILogger logger, string allowedHosts) =>
            _allowedHosts(logger, allowedHosts, null);
        ...
        public static void AllowedHostMatched(this ILogger logger, string host) =>
            _allowedHostMatched(logger, host, null);
        public static void NoAllowedHostMatched(this ILogger logger, string host) =>
            _noAllowedHostMatched(logger, host, null);
    }
}
