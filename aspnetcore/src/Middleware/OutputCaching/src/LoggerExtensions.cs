...
internal static partial class LoggerExtensions
{
    ...
    [LoggerMessage(
        12,
        LogLevel.Error,
        "Unable to query output cache.",
        EventName = "UnableToQueryOutputCache"
    )]
    ...
    [LoggerMessage(
        13,
        LogLevel.Error,
        "Unable to write to output-cache.",
        EventName = "UnableToWriteToOutputCache"
    )]
    internal static partial void UnableToWriteToOutputCache(
        this ILogger logger,
        Exception exception
    );
}
