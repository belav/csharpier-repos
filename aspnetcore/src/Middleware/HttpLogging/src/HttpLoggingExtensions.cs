...
{
    public static void RequestLog(this ILogger logger, HttpLog requestLog) =>
        logger.Log(
    ...
    public static void ResponseLog(this ILogger logger, HttpLog responseLog) =>
        logger.Log(
            LogLevel.Information,
    ...
    public static void RequestResponseLog(this ILogger logger, HttpLog log) =>
        logger.Log(
            LogLevel.Information,
