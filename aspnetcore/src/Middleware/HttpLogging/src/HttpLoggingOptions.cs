...
{
    /// <summary>
    /// Fields to log for the Request and Response. Defaults to logging request and response properties
    // and headers.
    /// </summary>
    ...
    internal HashSet<string> _internalRequestHeaders = new HashSet<string>(
        26,
    ...
    internal HashSet<string> _internalResponseHeaders = new HashSet<string>(
        19,
        StringComparer.OrdinalIgnoreCase
    )
    {
    ...
    public MediaTypeOptions MediaTypeOptions { get; } =
        MediaTypeOptions.BuildDefaultMediaTypeOptions();
