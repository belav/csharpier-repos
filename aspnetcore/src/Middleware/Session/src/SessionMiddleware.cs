...
public class SessionMiddleware
{
    ...
    // pipeline.</param>
    /// <param name="loggerFactory">The <see cref="ILoggerFactory"/> representing the factory that used
    // to create logger instances.</param>
    /// <param name="dataProtectionProvider">The <see cref="IDataProtectionProvider"/> used to protect
    // and verify the cookie.</param>
    /// <param name="sessionStore">The <see cref="ISessionStore"/> representing the session
    // store.</param>
    ...
    private sealed class SessionEstablisher
    {
        ...
        // Returns true if the session has already been established, or if it still can be because the
