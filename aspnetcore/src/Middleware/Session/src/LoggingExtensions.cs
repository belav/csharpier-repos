...
internal static partial class LoggingExtensions
{
    ...
    public static partial void SessionLoaded(
        this ILogger logger,
        string sessionKey,
        string sessionId,
        int count
    ...
    public static partial void SessionStored(
        this ILogger logger,
        string sessionKey,
        string sessionId,
        int count
    ...
    public static partial void SessionCacheReadException(
        this ILogger logger,
        string sessionKey,
        Exception exception
    );
    ...
    public static partial void ErrorUnprotectingSessionCookie(
        this ILogger logger,
        Exception exception
    );
