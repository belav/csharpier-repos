...
internal interface IResponseCachingPolicyProvider
{
    ...
    /// <returns><c>true</c> if response caching logic should be attempted; otherwise
    // <c>false</c>.</returns>
    ...
    /// </summary>
    /// <param name="context">The <see cref="ResponseCachingContext"/>.</param>
    /// <returns><c>true</c> if cache lookup for this request is allowed; otherwise
    // <c>false</c>.</returns>
    ...
    /// </summary>
    /// <param name="context">The <see cref="ResponseCachingContext"/>.</param>
    /// <returns><c>true</c> if storage of the response for this request is allowed; otherwise
    // <c>false</c>.</returns>
