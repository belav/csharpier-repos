...
public class DbContextHealthCheckTest
{
    ...
    public async Task CheckAsync_CustomTestWithFailureStatusSpecified_Expected(
        HealthStatus? specifiedFailureStatus,
    ...
    public async Task CheckAsync_CustomTestRegardlessOfFailureStatusSpecified_IfThrowsException_Unhealthy(
