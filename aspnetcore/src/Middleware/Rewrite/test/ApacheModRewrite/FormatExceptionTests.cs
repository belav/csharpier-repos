...
public class FormatExceptionTests
{
    ...
    [InlineData(
        "BadExpression 1 2 3 4",
        "Could not parse the mod_rewrite file. Message: 'Too many tokens on line'.  Line number '1'."
    )]
    ...
    [InlineData(
        "RewriteCond %1 -getemp",
        "Could not parse the mod_rewrite file.  Line number '1'."
    )]
