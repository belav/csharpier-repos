...
namespace Microsoft.AspNetCore.Rewrite.Tests.ModRewrite
{
    public class ConditionPatternParserTest
    {
        ...
        public void ConditionPatternParser_CheckStringComp(
            string condition,
            int operation,
            string variable,
            int conditionType
        ...
        public void ConditionPatternParser_CheckFileOperations(
            string condition,
            int operation,
            int cond
        )
        {
            ...
            var expected = new ParsedModRewriteInput
            {
                ConditionType = (ConditionType)cond,
                OperationType = (OperationType)operation,
                Invert = false
            };
            Assert.True(CompareConditions(expected, results));
        ...
        [InlineData("!-U", (int)OperationType.ExistingUrl, (int)ConditionType.PropertyTest)]
        [InlineData("!-x", (int)OperationType.Executable, (int)ConditionType.PropertyTest)]
        public void ConditionPatternParser_CheckFileOperationsInverted(
            string condition,
            int operation,
            int cond
        )
        ...
        public void ConditionPatternParser_CheckIntComp(
            string condition,
            int operation,
            string variable,
            int cond
        ...
        [InlineData(
            "-gewow",
            "Unrecognized parameter type: '-gewow', terminated at string index: '3'"
        )]
        ...
        {
            if (
                i1.OperationType != i2.OperationType
