...
{
    /// <summary>
    /// Gets or sets the header used to retrieve the originating client IP. Defaults to the value
    // specified by
    ...
    /// Defaults to the value specified by <see
    // cref="ForwardedHeadersDefaults.XForwardedHostHeaderName"/>
    /// </summary>
    ...
    /// Defaults to the value specified by <see
    // cref="ForwardedHeadersDefaults.XForwardedProtoHeaderName"/>
    /// </summary>
    ...
    /// Defaults to the value specified by <see
    // cref="ForwardedHeadersDefaults.XForwardedPrefixHeaderName"/>
    /// </summary>
    public string ForwardedPrefixHeaderName { get; set; } =
        ForwardedHeadersDefaults.XForwardedPrefixHeaderName;

    /// <summary>
    /// Gets or sets the header used to store the original value of client IP before applying forwarded
    // headers.
    ...
    /// <summary>
    /// Gets or sets the header used to store the original value of the Host header field before
    // applying forwarded headers.
    /// Defaults to the value specified by <see
    // cref="ForwardedHeadersDefaults.XOriginalHostHeaderName"/>
    /// </summary>
    /// <seealso cref="ForwardedHeadersDefaults"/>
    ...
    /// <summary>
    /// Gets or sets the header used to store the original scheme (HTTP/HTTPS) before applying forwarded
    // headers.
    /// Defaults to the value specified by <see
    // cref="ForwardedHeadersDefaults.XOriginalProtoHeaderName"/>
    /// </summary>
    /// <seealso cref="ForwardedHeadersDefaults"/>
    ...
    /// Defaults to the value specified by <see
    // cref="ForwardedHeadersDefaults.XOriginalPrefixHeaderName"/>
    /// </summary>
    /// <seealso cref="ForwardedHeadersDefaults"/>
    ...
    /// Failing to restrict this these values may allow an attacker to spoof links generated by your
    // service.
    /// </summary>
    /// <remarks>
    /// <list type="bullet">
    ...
    /// <item><description>Subdomain wildcards are permitted. E.g. "*.example.com" matches subdomains
    // like foo.example.com,
    ///    but not the parent domain example.com.</description></item>
    /// <item><description>Unicode host names are allowed but will be converted to punycode for
    // matching.</description></item>
    /// <item><description>IPv6 addresses must include their bounding brackets and be in their
    // normalized form.</description></item>
    /// </list>
    /// </remarks>
