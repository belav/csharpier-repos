    ...
    public class Program
    {
        public static Task Main(string[] args)
        {
            ...
            var builder = new HostBuilder().ConfigureWebHost(
                webHostBuilder =>
                {
                    webHostBuilder.ConfigureLogging(loggingBuilder => loggingBuilder.AddConsole())
                    ...
                    else
                    {
                        ...
                        var urls =
                            ...
                            ?? webHostBuilder.GetSetting("server.urls");
                        ...
                        if (urls.Contains(";"))
                        {
                            throw new NotSupportedException(
                                "This test app does not support multiple endpoints."
                            );
                        }
