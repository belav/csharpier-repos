...
public class AutobahnTester : IDisposable
{
    ...
    public void Verify(AutobahnResult result)
    {
        ...
        {
            var serverExpectation = _expectations.FirstOrDefault(e =>
                e.Server == serverResult.Server && e.Ssl == serverResult.Ssl
            );
...
#pragma warning restore SYSLIB0039
        ...
        var resp = await RetryHelper.RetryRequest(
            ...
            CancellationTokenSource
                .CreateLinkedTokenSource(cancellationToken, result.HostShutdownToken)
                .Token
        );
