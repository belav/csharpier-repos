    ...
    public class DefaultFileVersionProviderTest
    {
        ...
        )
        {
            ...
            var cacheEntry = Mock.Of<ICacheEntry>(
                c => c.ExpirationTokens == new List<IChangeToken>()
            );
        ...
        )
        {
            ...
            {
                mockFileProvider.Setup(fp => fp.GetFileInfo(filePath))
            ...
            else
            {
                mockFileProvider.Setup(fp => fp.GetFileInfo(It.IsAny<string>()))
                    .Returns(
                        fileDoesNotExist ? doesNotExistMockFile.Object : existingMockFile.Object
                    );
            }
