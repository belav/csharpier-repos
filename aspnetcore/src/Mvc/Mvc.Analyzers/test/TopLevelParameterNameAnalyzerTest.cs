...
namespace Microsoft.AspNetCore.Mvc.Analyzers.TopLevelParameterNameAnalyzerTestFiles
{
    ...
    public class MyModel
    {
        ...
        var result = Diagnostic.WithLocation(0).WithArguments("MyModel", "model");
...
";
        var result = Diagnostic.WithLocation(0).WithArguments("TestModel", "parameter");
...
namespace Microsoft.AspNetCore.Mvc.Analyzers.TopLevelParameterNameAnalyzerTestFiles
{
    public class TestController
    {
        ...
        Assert.True(
            TopLevelParameterNameAnalyzer.SymbolCache.TryCreate(compilation, out var symbolCache)
        );
...
namespace TestApp
{
    ...
    internal sealed class TopLevelParameterNameCSharpAnalyzerTest
        : CSharpAnalyzerTest<TopLevelParameterNameAnalyzer, XUnitVerifier>
    {
        public TopLevelParameterNameCSharpAnalyzerTest(
        ...
        protected override IEnumerable<DiagnosticAnalyzer> GetDiagnosticAnalyzers() =>
            new[] { new TopLevelParameterNameAnalyzer() };
    }
}
