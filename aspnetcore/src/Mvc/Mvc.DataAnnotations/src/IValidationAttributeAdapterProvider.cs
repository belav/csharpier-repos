...
public interface IValidationAttributeAdapterProvider
{
    ...
    /// </summary>
    /// <param name="attribute">The <see cref="ValidationAttribute"/> to create an <see
    // cref="IAttributeAdapter"/>
    /// for.</param>
    /// <param name="stringLocalizer">The <see cref="IStringLocalizer"/> which will be used to create
    // messages.
    /// </param>
    /// <returns>An <see cref="IAttributeAdapter"/> for the given <paramref
