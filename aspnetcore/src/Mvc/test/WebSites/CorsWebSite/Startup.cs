...
public class Startup
{
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        {
            options.AddPolicy("AllowAnySimpleRequest", builder =>
            {
            ...
            options.AddPolicy("WithCredentials", builder =>
            {
                builder.AllowCredentials().WithOrigins("http://example.com");
            });

            options.AddPolicy("WithCredentialsAndOtherSettings", builder =>
            {
                builder
                    .AllowCredentials()
            ...
            options.AddPolicy("Allow example.com", builder =>
            {
                builder
                    .AllowCredentials()
                    .AllowAnyMethod()
