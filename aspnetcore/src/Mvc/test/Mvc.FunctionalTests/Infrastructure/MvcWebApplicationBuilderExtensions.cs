...
{
    /// <summary>
    /// Sets up an <see cref="IStartupFilter"/> that configures the <see
    // cref="CultureReplacerMiddleware"/> at the
    /// beginning of the pipeline to change the <see cref="CultureInfo.CurrentCulture"/> and <see
    // cref="CultureInfo.CurrentUICulture"/>
    /// of the thread so that they match the cultures in <paramref name="culture"/> and <paramref
    // name="uiCulture"/> for the rest of the
