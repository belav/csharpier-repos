    ...
    public class ControllerActionDescriptorProviderTests
    {
        ...
        public void GetDescriptors_DisplayNameIncludesAssemblyName()
        {
            ...
            var descriptor = descriptors.Single(
                ad => ad.ActionName == nameof(PersonController.GetPerson)
            );
        ...
        public void GetDescriptors_AddsControllerAndActionConstraints_ToConventionallyRoutedActions()
        {
            ...
            var actionConstraint = Assert.Single(
                action.RouteValues,
        ...
        public void GetDescriptors_ActionWithMultipleHttpMethods_LastHttpMethodMetadata()
        {
            ...
            // Assert
            var actions = descriptors.OfType<ControllerActionDescriptor>()
                .Where(
                    d =>
                        d.ActionName
        ...
        public void AttributeRouting_AcceptVerbsOnAction_CreatesActionPerControllerAttributeRouteCombination()
        {
            ...
            // Assert
            var actions = descriptors.Where(
                d => d.ActionName == nameof(MultiRouteAttributesController.AcceptVerbs)
            );
        ...
        public void AttributeRouting_AcceptVerbsOnAction_WithoutTemplate_MergesVerb()
        {
            ...
            // Assert
            var actions = descriptors.Where(
                d => d.ActionName == "AcceptVerbsRouteAttributeAndHttpPut"
            );
            Assert.Equal(4, actions.Count());
        ...
        public void AttributeRouting_AcceptVerbsOnAction_WithTemplate_DoesNotMergeVerb()
        {
            ...
            // Assert
            var actions = descriptors.Where(
                d => d.ActionName == "AcceptVerbsRouteAttributeWithTemplateAndHttpPut"
            );
            ...
            Assert.Single(
                unconstrainedActions,
                a => a.AttributeRouteInfo.Template.Equals("v1/List")
            );
            Assert.Single(
                unconstrainedActions,
                a => a.AttributeRouteInfo.Template.Equals("v2/List")
            );
        }
        ...
        public void AttributeRouting_AllowsDuplicateAttributeRoutedActions_WithTheSameTemplateAndSameHttpMethodsOnDifferentActions()
        {
            ...
            // Assert
            var controllerAndAction = Assert.Single(
                actions,
                a => a.ActionName.Equals(firstActionName)
            );
        ...
        public void ApiExplorer_SetsExtensionData_WhenVisible_CanOverrideControllerOnAction()
        {
            // Arrange
            var provider = GetProvider(
                typeof(ApiExplorerVisibilityOverrideController).GetTypeInfo()
            );
        ...
        public void ApplyConventions_RunsInOrderOfDecreasingScope()
        {
            ...
            applicationConvention.Setup(c => c.Apply(It.IsAny<ApplicationModel>())).Callback(
                () =>
                {
            ...
            controllerConvention.Setup(c => c.Apply(It.IsAny<ControllerModel>())).Callback(
                () =>
                {
            ...
            actionConvention.Setup(c => c.Apply(It.IsAny<ActionModel>())).Callback(
                () =>
                {
            ...
            parameterConvention.Setup(c => c.Apply(It.IsAny<ParameterModel>())).Callback(
                () =>
                {
        ...
        public void GetDescriptors_SplitsConstraintsBasedOnRoute()
        {
            // Arrange
            var provider = GetProvider(
                typeof(MultipleRouteProviderOnActionController).GetTypeInfo()
            );
        ...
        )
        {
            ...
            var actualLines = actualMessage.Split(
                new[] { Environment.NewLine },
                StringSplitOptions.None
            )
                .ToArray();
            ...
            var orderedExpectedLines = expectedLines.Skip(unorderedStart)
                .Take(unorderedLineCount)
                .OrderBy(l => l, StringComparer.Ordinal)
                .ToArray();

            var orderedActualLines = actualLines.Skip(unorderedStart)
                .Take(unorderedLineCount)
                .OrderBy(l => l, StringComparer.Ordinal)
                .ToArray();
        ...
        private class UserController : ControllerBase
        {
            ...
            {
                return string
                    .Format(CultureInfo.InvariantCulture, "User {0} retrieved successfully", id);
            }
        }
    }
}
