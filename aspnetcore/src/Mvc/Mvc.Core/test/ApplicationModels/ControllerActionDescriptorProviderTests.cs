...
namespace Microsoft.AspNetCore.Mvc.ApplicationModels
{
    public class ControllerActionDescriptorProviderTests
    {
            ...
            Action<ControllerActionDescriptor> InspectElement(string httpMethod)
            {
                return (descriptor) =>
                {
                    ...
                    var lastHttpMethodMetadata =
                        descriptor.EndpointMetadata.OfType<IHttpMethodMetadata>().Last();
                    Assert.Equal(
                        httpMethod,
        ...
        public void ApplyConventions_RunsInOrderOfDecreasingScope()
        {
            ...
            applicationConvention.Setup(c => c.Apply(It.IsAny<ApplicationModel>()))
                .Callback(
                    () =>
                    {
            ...
            controllerConvention.Setup(c => c.Apply(It.IsAny<ControllerModel>()))
                .Callback(
                    () =>
                    {
            ...
            actionConvention.Setup(c => c.Apply(It.IsAny<ActionModel>()))
                .Callback(
                    () =>
                    {
            ...
            parameterConvention.Setup(c => c.Apply(It.IsAny<ParameterModel>()))
                .Callback(
                    () =>
                    {
