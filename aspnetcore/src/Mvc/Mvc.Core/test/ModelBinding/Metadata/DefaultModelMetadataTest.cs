...
namespace Microsoft.AspNetCore.Mvc.ModelBinding.Metadata
{
    public class DefaultModelMetadataTest
    {
        ...
        public void DisplayFormatString_DoesNotCacheInitialDelegateValue()
        {
            ...
            var attributes = new ModelAttributes(
                Array.Empty<object>(),
                Array.Empty<object>(),
                null
            );
        ...
        public void PropertiesProperty_CallsProvider()
        {
            ...
            provider.Setup(p => p.GetMetadataForProperties(typeof(string)))
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        public void GetMetadataForProperties_CallsProvider()
        {
            ...
            var metadataProvider = new Mock<IModelMetadataProvider>();
            metadataProvider.Setup(mp => mp.GetMetadataForProperties(typeof(Exception)))
                .Verifiable();
            var metadata1 = new DefaultModelMetadata(
                metadataProvider.Object,
                detailsProvider.Object,
        ...
        public void CalculateHasValidators_TypeWithProperties_PropertyIsNotDefaultModelMetadata()
        {
            ...
            metadataProvider.Setup(mp => mp.GetMetadataForProperties(modelType))
        ...
        public void CalculateHasValidators_SelfReferencingType_HasValidatorOnNestedProperty()
        {
            ...
            metadataProvider.Setup(mp => mp.GetMetadataForProperties(typeof(BusinessUnit)))
        ...
        public void CalculateHasValidators_CollectionElementHasValidators()
        {
            ...
            metadataProvider.Setup(mp => mp.GetMetadataForType(modelType))
                .Returns(
        ...
        public void CalculateHasValidators_RecordType_ParametersWithNoValidators()
        {
            ...
            metadataProvider.Setup(mp => mp.GetMetadataForConstructor(constructor, modelType))
