...
public class ValidationMetadata
{
    ...
    /// <see cref="ModelMetadata.IsRequired"/> will be computed based on the model <see
    // cref="System.Type"/>.
    ...
    /// <summary>
    /// Gets or sets an <see cref="IPropertyValidationFilter"/> implementation that indicates whether
    // this model
    ...
    /// <see cref="ModelMetadata.IsComplexType"/> or <see cref="ModelMetadata.IsEnumerableType"/> is
    // <c>true</c>;
    /// <c>false</c> otherwise.
    /// </summary>
    ...
    /// <summary>
    /// Gets or sets a value that determines if validators can be constructed using metadata on
    // properties.
    /// </summary>
