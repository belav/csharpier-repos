...
public class MediaTypeCollection : Collection<string>
{
    ...
    /// </summary>
    /// <param name="item">The media type to be added to the end of the <see
    // cref="MediaTypeCollection"/>.</param>
    ...
    /// <summary>
    /// Removes the first occurrence of a specific media type from the <see
    // cref="MediaTypeCollection"/>.
    /// </summary>
    /// <param name="item"></param>
    /// <returns><see langword="true" /> if <paramref name="item"/> is successfully removed; otherwise,
    // <see langword="false" />.
