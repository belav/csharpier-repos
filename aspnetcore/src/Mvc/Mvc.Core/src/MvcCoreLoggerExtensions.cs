...
internal static partial class MvcCoreLoggerExtensions
{
    ...
    )
    {
        ...
        var authorizationFilters = filters.Where(f =>
            f is IAuthorizationFilter || f is IAsyncAuthorizationFilter
        );
    ...
    )
    {
        ...
        var exceptionFilters = filters.Where(f =>
            f is IExceptionFilter || f is IAsyncExceptionFilter
        );
