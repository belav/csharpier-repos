...
namespace Microsoft.AspNetCore.Mvc
{
    internal static class MvcCoreLoggerExtensions
    {
        ...
        private static readonly Action<
            ...
            string[],
            Exception
        > _actionMethodExecutingWithArguments;
        private static readonly Action<
            ILogger,
            string,
            string,
        ...
        private static readonly Action<
            ...
            string,
            Exception
        > _executingFileResult;
        private static readonly Action<
            ILogger,
            string,
            string,
            Exception
        > _executingFileResultWithNoFileName;
        ...
        private static readonly Action<
            ILogger,
            IEnumerable<MediaTypeSegmentWithQuality>,
            Exception
        ...
        private static readonly Action<
            ...
            string,
            Exception
        > _inputFormatterSelected;
        private static readonly Action<
            ILogger,
            IInputFormatter,
            string,
            Exception
        > _inputFormatterRejected;
        ...
        private static readonly Action<
            ...
            string,
            Exception
        > _redirectToRouteResultExecuting;
        ...
        private static readonly Action<
            ...
            Exception
        > _registeredModelBinderProviders;
        private static readonly Action<
            ILogger,
            string,
            Type,
        ...
        private static readonly Action<
            ...
            Type,
            Exception
        > _cannotCreateHeaderModelBinderCompatVersion_2_0;
        ...
        private static readonly Action<
            ...
            string,
            Exception
        > _noNonIndexBasedFormatFoundForCollection;
        private static readonly Action<
            ILogger,
            string,
            string,
            ...
            string,
            Exception
        > _attemptingToBindCollectionUsingIndices;
        private static readonly Action<
            ILogger,
            string,
            string,
        ...
        private static readonly Action<
            ...
            string,
            Exception
        > _unsupportedFormatFilterContentType;
        private static readonly Action<
            ILogger,
            string,
            MediaTypeCollection,
            Exception
        > _actionDoesNotSupportFormatFilterContentType;
        private static readonly Action<
            ILogger,
            string,
            Exception
        > _cannotApplyFormatFilterContentType;
        private static readonly Action<
            ILogger,
            Exception
        > _actionDoesNotExplicitlySpecifyContentTypes;
        private static readonly Action<
            ILogger,
            IEnumerable<MediaTypeSegmentWithQuality>,
            Exception
        ...
        private static readonly Action<
            ...
            Exception
        > _ifMatchPreconditionFailed;
        private static readonly Action<
            ILogger,
            DateTimeOffset?,
            DateTimeOffset?,
            Exception
        > _ifUnmodifiedSincePreconditionFailed;
        private static readonly Action<
            ILogger,
            DateTimeOffset?,
            DateTimeOffset?,
        ...
        private static readonly Action<
            ...
            EntityTagHeaderValue,
            Exception
        > _ifRangeETagPreconditionFailed;
        private static readonly Action<
            ILogger,
            IEnumerable<MediaTypeSegmentWithQuality>,
            MediaTypeCollection,
        ...
        private static readonly Action<
            ILogger,
            Exception
        > _selectingOutputFormatterWithoutUsingContentTypes;
        private static readonly Action<
            ILogger,
            MediaTypeCollection,
            Exception
        ...
        private static readonly Action<
            ...
            Type,
            Exception
        > _notMostEffectiveFilter;
        private static readonly Action<
            ILogger,
            IEnumerable<IOutputFormatter>,
            Exception
        ...
        static MvcCoreLoggerExtensions()
        {
            ...
            _actionDoesNotSupportFormatFilterContentType = LoggerMessage.Define<
                string,
                MediaTypeCollection
            >(
                LogLevel.Debug,
            ...
            _selectingOutputFormatterUsingAcceptHeader = LoggerMessage.Define<
                IEnumerable<MediaTypeSegmentWithQuality>
            >(
                LogLevel.Debug,
            ...
            _selectingOutputFormatterUsingAcceptHeaderAndExplicitContentTypes =
                LoggerMessage.Define<IEnumerable<MediaTypeSegmentWithQuality>, MediaTypeCollection>(
                    LogLevel.Debug,
                    new EventId(
                        7,
            ...
            _parameterBinderRequestPredicateShortCircuitOfProperty = LoggerMessage.Define<
                Type,
                string
            >(
                LogLevel.Debug,
        ...
        )
        {
            ...
            var resourceFilters = filters.Where(
                f => f is IResourceFilter || f is IAsyncResourceFilter
            );
        ...
        public static void ActionMethodExecuting(
            this ILogger logger,
        ...
        )
        {
            if (logger.IsEnabled(LogLevel.Information))
            {
                ...
                if (arguments != null && logger.IsEnabled(LogLevel.Trace))
                {
                    ...
                    {
                        convertedArguments[i] = Convert.ToString(
                            arguments[i],
        ...
        public static void ActionMethodExecuted(
            this ILogger logger,
            ControllerContext context,
        ...
        public static void AuthorizationFailure(this ILogger logger, IFilterMetadata filter)
        {
            _authorizationFailure(logger, filter, null);
        }

        public static void ResourceFilterShortCircuited(this ILogger logger, IFilterMetadata filter)
        {
            _resourceFilterShortCircuit(logger, filter, null);
        }

        public static void ResultFilterShortCircuited(this ILogger logger, IFilterMetadata filter)
        {
        ...
        public static void ActionFilterShortCircuited(this ILogger logger, IFilterMetadata filter)
        {
        ...
        public static void SignInResultExecuting(
            this ILogger logger,
        ...
        public static void ObjectResultExecuting(
            this ILogger logger,
            ObjectResult result,
            object value
        )
        ...
        public static void NotMostEffectiveFilter(
            this ILogger logger,
        ...
        public static void ModelStateInvalidFilterExecuting(this ILogger logger) =>
        ...
        )
        {
            if (logger.IsEnabled(LogLevel.Debug))
            {
                _inferredParameterSource(
                    logger,
                    parameterModel.Action.ActionMethod,
        ...
        public static void TransformingClientError(
            this ILogger logger,
            Type initialType,
            Type replacedType,
            int? statusCode
