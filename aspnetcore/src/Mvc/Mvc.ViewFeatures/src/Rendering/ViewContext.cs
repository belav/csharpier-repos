...
#nullable enable
    ...
    /// <param name="htmlHelperOptions">The <see cref="HtmlHelperOptions"/> to apply to this
    // instance.</param>
    public ViewContext(
        ...
        : base(viewContext)
    {
        ...
        // The dictionary needs to be initialized at this point so that child viewcontexts share the same
        // underlying storage;
    ...
    /// <summary>
    /// Element name used to wrap a top-level message generated by <see
    // cref="IHtmlHelper.ValidationSummary"/> and
    /// other overloads.
    /// </summary>
    ...
    /// <summary>
    /// Element name used to wrap a top-level message generated by <see
    // cref="IHtmlHelper.ValidationMessage"/> and
    /// other overloads.
    /// </summary>
    ...
    /// <summary>
    /// Gets a key/value collection that can be used to share data within the scope of this view
    // execution.
    /// </summary>
