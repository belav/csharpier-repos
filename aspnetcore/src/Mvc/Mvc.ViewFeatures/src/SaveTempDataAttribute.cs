...
public class SaveTempDataAttribute : Attribute, IFilterFactory, IOrderedFilter
{
    ...
    {
        // Since SaveTempDataFilter registers for a response's OnStarting callback, we want this filter to
        // run
        // as early as possible to get the opportunity to register the call back before any other result
        // filter
