...
/// </summary>
/// <remarks>
/// Literal &lt;form&gt; elements in a view will share the default <see cref="FormContext"/>
// instance unless tag
/// helpers are enabled.
/// </remarks>
...
public class FormContext
{
    ...
    /// <summary>
    /// Gets or sets an indication the current &lt;form&gt; element contains an antiforgery token. Do
    // not use
    /// unless <see cref="CanRenderAtEndOfForm"/> is <c>true</c>.
    /// </summary>
    /// <value>
    /// <c>true</c> if the current &lt;form&gt; element contains an antiforgery token; <c>false</c>
    // otherwise.
    /// </value>
    public bool HasAntiforgeryToken { get; set; }

    /// <summary>
    /// Gets an indication the <see cref="FormData"/> property bag has been used and likely contains
    // entries.
    /// </summary>
    /// <value>
    /// <c>true</c> if the backing field for <see cref="FormData"/> is non-<c>null</c>; <c>false</c>
    // otherwise.
    /// </value>
    public bool HasFormData => _formData != null;

    /// <summary>
    /// Gets an indication the <see cref="EndOfFormContent"/> collection has been used and likely
    // contains entries.
    /// </summary>
    /// <value>
    /// <c>true</c> if the backing field for <see cref="EndOfFormContent"/> is non-<c>null</c>;
    // <c>false</c>
    /// otherwise.
    /// </value>
    ...
    /// <summary>
    /// Gets an <see cref="IHtmlContent"/> collection that should be rendered just prior to the next
    // &lt;/form&gt;
    ...
    /// <summary>
    /// Gets or sets an indication whether extra content can be rendered at the end of the content of
    // this
    ...
    // In
    /// particular, <c>true</c> if the current &lt;form&gt; is associated with a tag helper or will be
    // generated by
    ...
    /// <summary>
    /// Gets a dictionary mapping full HTML field names to indications that the named field has been
    // rendered in
    /// this &lt;form&gt;.
    /// </summary>
    ...
    /// <summary>
    /// Gets a dictionary mapping full HTML field names to indications that corresponding value was
    // formatted
    ...
    /// <summary>
    /// Returns an indication based on <see cref="RenderedFields"/> that the given <paramref
    // name="fieldName"/> has
    ...
    /// <summary>
    /// Updates <see cref="RenderedFields"/> to indicate <paramref name="fieldName"/> has been rendered
    // in this
    /// &lt;form&gt;.
    /// </summary>
    /// <param name="fieldName">The full HTML name of a field that may have been rendered.</param>
    /// <param name="value">If <c>true</c>, the given <paramref name="fieldName"/> has been
    // rendered.</param>
