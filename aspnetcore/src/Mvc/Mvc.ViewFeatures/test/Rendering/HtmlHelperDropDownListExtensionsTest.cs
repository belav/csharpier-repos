...
namespace Microsoft.AspNetCore.Mvc.Core
{
    public class HtmlHelperDropDownListExtensionsTest
    {
        ...
        public void DropDownList_FindsSelectList()
        {
            // Arrange
            var expectedHtml =
                "<select id=\"HtmlEncode[[Property1]]\" name=\"HtmlEncode[[Property1]]\">"
            ...
            Assert.Equal(
                expectedHtml,
                HtmlContentUtilities.HtmlContentToString(dropDownListResult)
            );
        }
        ...
        public void DropDownList_FindsSelectList_UsesOptionLabel()
        {
            ...
            var expectedHtml =
                "<select id=\"HtmlEncode[[Property1]]\" name=\"HtmlEncode[[Property1]]\">"
                + "<option value=\"\">HtmlEncode[[--select--]]</option>"
                + Environment.NewLine
                + "<option value=\"HtmlEncode[[0]]\">HtmlEncode[[Zero]]</option>"
                + Environment.NewLine
        ...
        public void DropDownList_UsesSpecifiedExpressionAndSelectList()
        {
            // Arrange
            var expectedHtml =
                "<select id=\"HtmlEncode[[Property2]]\" name=\"HtmlEncode[[Property2]]\">"
        ...
        public void DropDownList_UsesSpecifiedExpressionAndSelectListAndHtmlAttributes()
        {
            // Arrange
            var expectedHtml =
                "<select id=\"HtmlEncode[[Property1]]\" Key=\"HtmlEncode[[Value]]\" name=\"HtmlEncode[[Property1]]\">"
                + "<option selected=\"HtmlEncode[[selected]]\" value=\"HtmlEncode[[4]]\">HtmlEncode[[Four]]</option>"
                + Environment.NewLine
                + "<option value=\"HtmlEncode[[5]]\">HtmlEncode[[Five]]</option>"
                + Environment.NewLine
            ...
            // Act
            var dropDownListResult = helper.DropDownList(
                "Property1",
                selectList,
        ...
        public void DropDownListFor_NullSelectListFindsListFromViewData()
        {
            ...
            Assert.Equal(
                expectedHtml,
                HtmlContentUtilities.HtmlContentToString(dropDownListForResult)
            );
        }
        ...
        public void DropDownListFor_UsesSpecifiedExpressionAndSelectListAndHtmlAttributes()
        {
            // Arrange
            var expectedHtml =
                "<select id=\"HtmlEncode[[Property3_2_]]\" Key=\"HtmlEncode[[Value]]\" name=\"HtmlEncode[[Property3[2]]]\">"
                + "<option selected=\"HtmlEncode[[selected]]\" value=\"HtmlEncode[[4]]\">HtmlEncode[[Four]]</option>"
                + Environment.NewLine
                + "<option value=\"HtmlEncode[[5]]\">HtmlEncode[[Five]]</option>"
                + Environment.NewLine
