...
namespace Microsoft.AspNetCore.Mvc.Rendering
{
    ...
    {
        private static readonly IEnumerable<string> _actionNames = new List<string>
        {
            null,
            "Details"
        };
        ...
        private static readonly IEnumerable<string> _routeNames = new List<string>
        {
            null,
            "default"
        };
        ...
        public static TheoryData<
            ...
            string,
            object
        > ActionNameControllerNameAndRouteValuesDataSet
        {
            get
            {
        ...
        public void BeginFormWithNoParameters_CallsHtmlGeneratorWithExpectedValues()
        {
            ...
            htmlGenerator.Setup(
                ...
                .Returns(tagBuilder)
                .Verifiable();
            htmlGenerator.Setup(g => g.GenerateAntiforgery(htmlHelper.ViewContext))
