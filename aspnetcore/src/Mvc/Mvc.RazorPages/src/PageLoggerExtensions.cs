...
namespace Microsoft.AspNetCore.Mvc.RazorPages
{
    internal static class PageLoggerExtensions
    {
        ...
        private static readonly Action<
            ...
            string,
            Exception
        > _pageModelFactoryExecuting;
        private static readonly Action<
            ILogger,
            string,
            string,
            Exception
        > _pageModelFactoryExecuted;
        ...
        private static readonly Action<
            ...
            Exception
        > _handlerMethodExecuting;
        private static readonly Action<
            ILogger,
            ModelValidationState,
            Exception
        > _implicitHandlerMethodExecuting;
        private static readonly Action<
            ILogger,
            string,
            string[],
            Exception
        > _handlerMethodExecutingWithArguments;
        ...
        public static void ExecutingHandlerMethod(
            this ILogger logger,
            PageContext context,
        ...
        public static void ExecutedHandlerMethod(
            this ILogger logger,
            PageContext context,
            HandlerMethodDescriptor handler,
        ...
        public static void ExecutedImplicitHandlerMethod(this ILogger logger, IActionResult result)
        {
            if (logger.IsEnabled(LogLevel.Information))
            {
                _implicitHandlerMethodExecuted(
                    logger,
                    Convert.ToString(result, CultureInfo.InvariantCulture),
                    null
                );
        ...
        public static void PageFilterShortCircuited(this ILogger logger, IFilterMetadata filter)
        {
