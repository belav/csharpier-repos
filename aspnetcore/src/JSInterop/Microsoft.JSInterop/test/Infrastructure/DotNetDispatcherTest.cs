...
public class DotNetDispatcherTest
{
    ...
    public void CanInvokeStaticVoidMethod()
    {
        ...
        var resultJson = DotNetDispatcher.Invoke(
            jsRuntime,
            new DotNetInvocationInfo(thisAssemblyName, "InvocableStaticVoid", default, default),
            null
        );
    ...
    public void CanInvokeStaticNonVoidMethod()
    {
        ...
        var resultJson = DotNetDispatcher.Invoke(
            jsRuntime,
            new DotNetInvocationInfo(thisAssemblyName, "InvocableStaticNonVoid", default, default),
            null
        );
        var result = JsonSerializer.Deserialize<TestDTO>(
            resultJson,
    ...
    public void CanInvokeStaticNonVoidMethodWithoutCustomIdentifier()
    {
        ...
        var resultJson = DotNetDispatcher.Invoke(
            ...
            new DotNetInvocationInfo(
                thisAssemblyName,
                nameof(SomePublicType.InvokableMethodWithoutCustomIdentifier),
                default,
                default
            ),
            null
    ...
    public void CanInvokeStaticWithParams()
    {
        ...
        var resultDto1 = JsonSerializer.Deserialize<TestDTO>(
            root[0].GetRawText(),
            jsRuntime.JsonSerializerOptions
        );
        ...
        Assert.True(
            resultDto2Ref.TryGetProperty(
                DotNetDispatcher.DotNetObjectRefKey.EncodedUtf8Bytes,
                out var property
            )
        );
    ...
    public void CanInvokeBaseInstanceVoidMethod()
    {
        ...
        var resultJson = DotNetDispatcher.Invoke(
            jsRuntime,
            new DotNetInvocationInfo(null, "BaseClassInvokableInstanceVoid", 1, default),
            null
        );
    ...
    public void DotNetObjectReferencesCanBeDisposed()
    {
        ...
        DotNetDispatcher.BeginInvokeDotNet(
            jsRuntime,
            new DotNetInvocationInfo(null, "__Dispose", objectRef.ObjectId, default),
            null
        );
    ...
    public async Task EndInvoke_WithErrorString()
    {
        ...
        var task = jsRuntime.InvokeAsync<TestDTO>("unimportant");
        var argsJson = JsonSerializer.Serialize(
            new object[] { jsRuntime.LastInvocationAsyncHandle, false, expected },
            jsRuntime.JsonSerializerOptions
        );
    ...
    public async Task EndInvoke_WithNullError()
    {
        ...
        var task = jsRuntime.InvokeAsync<TestDTO>("unimportant");
        var argsJson = JsonSerializer.Serialize(
            new object[] { jsRuntime.LastInvocationAsyncHandle, false, null },
            jsRuntime.JsonSerializerOptions
        );
    ...
    public void CanInvokeInstanceMethodWithParams()
    {
        ...
        var resultJson = DotNetDispatcher.Invoke(
            jsRuntime,
            new DotNetInvocationInfo(null, "InvokableInstanceMethod", 1, default),
            argsJson
        );
    ...
    public void CanInvokeNonGenericInstanceMethodOnGenericType()
    {
        ...
        jsRuntime.Invoke<object>("_setup", DotNetObjectReference.Create(targetInstance));
        ...
        var resultJson = DotNetDispatcher.Invoke(
            ...
            new DotNetInvocationInfo(
                null,
                nameof(GenericType<int>.EchoStringParameter),
                1,
                default
            ),
            argsJson
    ...
    public void CanInvokeMethodsThatAcceptGenericParametersOnGenericTypes()
    {
        ...
        var resultJson = DotNetDispatcher.Invoke(
            jsRuntime,
            new DotNetInvocationInfo(null, nameof(GenericType<string>.EchoParameter), 1, default),
            argsJson
        );
    ...
    public async Task CanInvokeAsyncMethod()
    {
        ...
        DotNetDispatcher.BeginInvokeDotNet(
            jsRuntime,
            new DotNetInvocationInfo(null, "InvokableAsyncMethod", 1, callId),
            argsJson
        );
        await resultTask;
        ...
        var result = JsonSerializer.Deserialize<SomePublicType.InvokableAsyncMethodResult>(
            resultJson,
            jsRuntime.JsonSerializerOptions
        );
    ...
    public async Task CanInvokeSyncThrowingMethod()
    {
        ...
        DotNetDispatcher.BeginInvokeDotNet(
            ...
            new DotNetInvocationInfo(
                thisAssemblyName,
                nameof(ThrowingClass.ThrowingMethod),
                default,
                callId
            ),
            default
        ...
        Assert.Contains(
            nameof(ThrowingClass.ThrowingMethod),
            jsRuntime.LastCompletionResult.Exception.ToString()
        );
    }
    ...
    public async Task CanInvokeAsyncThrowingMethod()
    {
        ...
        DotNetDispatcher.BeginInvokeDotNet(
            ...
            new DotNetInvocationInfo(
                thisAssemblyName,
                nameof(ThrowingClass.AsyncThrowingMethod),
                default,
                callId
            ),
            default
    ...
    public void BeginInvoke_ThrowsWithInvalid_DotNetObjectRef()
    {
        ...
        DotNetDispatcher.BeginInvokeDotNet(
            jsRuntime,
            new DotNetInvocationInfo(null, "InvokableInstanceVoid", 1, callId),
            null
        );
        ...
        var exception = jsRuntime.LastCompletionResult.Exception;
        Assert.StartsWith(
            "System.ArgumentException: There is no tracked object with id '1'. Perhaps the DotNetObjectReference instance was already disposed.",
            exception.ToString()
        );
    }
    ...
    public void ParseArguments_Works()
    {
        ...
        // Act
        var result = DotNetDispatcher.ParseArguments(
            new TestJSRuntime(),
            "SomeMethod",
            arguments,
    ...
    public void ParseArguments_NullArgument()
    {
        ...
        // Assert
        Assert.Collection(result, v => Assert.Equal(4, v), v => Assert.Null(v));
    }
    ...
    public void ParseArguments_Throws_WithIncorrectDotNetObjectRefUsage()
    {
        ...
        // Assert
        Assert.Equal(
            $"In call to '{method}', parameter of type '{nameof(TestDTO)}' at index 2 must be declared as type 'DotNetObjectRef<TestDTO>' to receive the incoming value.",
            ex.Message
        );
    }
    ...
    {
        Assert.ThrowsAny<JsonException>(
            () => DotNetDispatcher.EndInvokeJS(new TestJSRuntime(), "")
        );
    }
    ...
    {
        Assert.ThrowsAny<JsonException>(
            () => DotNetDispatcher.EndInvokeJS(new TestJSRuntime(), "{\"key\": \"value\"}")
        );
    }
    ...
    {
        Assert.ThrowsAny<JsonException>(
            () => DotNetDispatcher.EndInvokeJS(new TestJSRuntime(), "[7, false")
        );
    }
    ...
    {
        Assert.ThrowsAny<JsonException>(
            () => DotNetDispatcher.EndInvokeJS(new TestJSRuntime(), "[7, false, \"Hello\", 5]")
        );
    }
    ...
    public void EndInvokeJS_Works()
    {
        ...
        DotNetDispatcher.EndInvokeJS(
            jsRuntime,
            $"[{jsRuntime.LastInvocationAsyncHandle}, true, {{\"intVal\": 7}}]"
        );
    ...
    public void EndInvokeJS_WithArrayValue()
    {
        ...
        DotNetDispatcher.EndInvokeJS(
            jsRuntime,
            $"[{jsRuntime.LastInvocationAsyncHandle}, true, [1, 2, 3]]"
        );
    ...
    public void EndInvokeJS_WithNullValue()
    {
        ...
        DotNetDispatcher.EndInvokeJS(
            jsRuntime,
            $"[{jsRuntime.LastInvocationAsyncHandle}, true, null]"
        );
    ...
    public class SomePublicType
    {
        ...
        public static object[] MyInvocableWithParams(
            TestDTO dtoViaJson,
            int[] incrementAmounts,
            DotNetObjectReference<TestDTO> dtoByRef
        ) =>
            new object[]
            {
        ...
        [JSInvokable]
        public async Task<InvokableAsyncMethodResult> InvokableAsyncMethod(
            TestDTO dtoViaJson,
        ...
        )
        {
            ...
            return new InvokableAsyncMethodResult
            {
                ...
                SomeDTORef = DotNetObjectReference.Create(
                    new TestDTO // Return by ref
                    {
    ...
    {
        private TaskCompletionSource<object> _nextInvocationTcs =
