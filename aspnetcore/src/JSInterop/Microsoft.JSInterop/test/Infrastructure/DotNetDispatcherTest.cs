...
public class DotNetDispatcherTest
{
    ...
    public async Task CanInvokeAsyncMethodReturningValueTask()
    {
        ...
        DotNetDispatcher.BeginInvokeDotNet(
            ...
            new DotNetInvocationInfo(
                null,
                nameof(SomePublicType.InvokableAsyncMethodReturningValueTask),
                1,
                callId
            ),
            argsJson
    ...
    public async Task CanInvokeAsyncMethodReturningNonGenericValueTask()
    {
        ...
        DotNetDispatcher.BeginInvokeDotNet(
            ...
            new DotNetInvocationInfo(
                null,
                nameof(SomePublicType.InvokableAsyncMethodReturningValueTaskNonGeneric),
                1,
                callId
            ),
            argsJson
    ...
    public class SomePublicType
    {
        ...
        [JSInvokable]
        public async ValueTask<InvokableAsyncMethodResult> InvokableAsyncMethodReturningValueTask(
            TestDTO dtoViaJson,
            DotNetObjectReference<TestDTO> dtoByRefWrapper
        )
        {
            var dtoByRef = dtoByRefWrapper.Value;
            return await new ValueTask<InvokableAsyncMethodResult>(
