        ...
        var getter = _cachedResultGetters.GetOrAdd(
            ...
            taskInstanceType =>
            {
                ...
                return resultType == null
                  ...
                  : (ITaskResultGetter)Activator
                        .CreateInstance(typeof(TaskResultGetter<>).MakeGenericType(resultType))
                        !;
            }
        );
    ...
    private static ITcsResultSetter CreateResultSetter(object taskCompletionSource)
    {
        return _cachedResultSetters.GetOrAdd(
            ...
            tcsType =>
            {
                ...
                return (ITcsResultSetter)Activator
                    .CreateInstance(typeof(TcsResultSetter<>).MakeGenericType(resultType))
                    !;
            }
        );
    }
