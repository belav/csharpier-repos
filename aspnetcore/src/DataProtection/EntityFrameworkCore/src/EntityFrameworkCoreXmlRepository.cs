    ...
    where TContext : DbContext, IDataProtectionKeyContext
{
    ...
    // DataProtectionKey.Id is not used anywhere. Add DynamicDependency to prevent it from being
    // trimmed.
    // Note that in the future EF may annotate itself to include properties automatically, and the
    // annotation here could be removed.
