...
public class ManagedAuthenticatedEncryptorTests
{
    ...
    public void Encrypt_Decrypt_RoundTrips()
    {
        ...
        ManagedAuthenticatedEncryptor encryptor = new ManagedAuthenticatedEncryptor(
            kdk,
    ...
    public void Encrypt_KnownKey()
    {
        ...
        // Act
        byte[] retVal = encryptor.Encrypt(plaintext: plaintext, additionalAuthenticatedData: aad);
