...
namespace Microsoft.AspNetCore.DataProtection.Repositories
{
    public class FileSystemXmlRepositoryTests
    {
        ...
        public void DefaultKeyStorageDirectory_Property()
        {
            ...
            var expectedDir =
                new DirectoryInfo(Path.Combine(baseDir, "DataProtection-Keys")).FullName;
        ...
        public void Directory_Property()
        {
            WithUniqueTempDirectory(
                ...
                {
                    // Arrange
                    var repository = new FileSystemXmlRepository(
                        dirInfo,
        ...
        public void StoreElements_ThenRetrieve_SeesAllElements()
        {
            WithUniqueTempDirectory(
                dirInfo =>
                {
                    ...
                    // Assert
                    var orderedNames = allElements.Select(el => el.Name.LocalName)
                        .OrderBy(name => name);
        ...
        public void Logs_DockerEphemeralFolders()
        {
            ...
            WithUniqueTempDirectory(
                dirInfo =>
                {
                    ...
                    // Assert
                    Assert.Contains(
                        Resources.FormatFileSystem_EphemeralKeysLocationInContainer(
                            dirInfo.FullName
                        ),
