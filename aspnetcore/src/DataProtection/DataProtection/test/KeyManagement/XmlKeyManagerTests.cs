...
namespace Microsoft.AspNetCore.DataProtection.KeyManagement
{
    public class XmlKeyManagerTests
    {
        ...
        public void CreateNewKey_Internal_NoEscrowOrEncryption()
        {
            ...
            mockDescriptor.Setup(o => o.ExportToXml())
                .Returns(
                    new XmlSerializedDescriptorInfo(serializedDescriptor, typeof(MyDeserializer))
                );
            var expectedDescriptor = mockDescriptor.Object;
            var testEncryptorFactory = new TestEncryptorFactory(
                expectedDescriptor,
                expectedAuthenticatedEncryptor
            );
            ...
            mockXmlRepository.Setup(o => o.StoreElement(It.IsAny<XElement>(), It.IsAny<string>()))
                .Callback<XElement, string>(
                    (el, friendlyName) =>
                    {
            ...
            Assert.Same(
                expectedAuthenticatedEncryptor,
                testEncryptorFactory.CreateEncryptorInstance(newKey)
            );
            ...
            Assert.Equal(
                "key-3d6d01fd-c0e7-44ae-82dd-013b996b4093",
                friendlyNameStoredInRepository
            );
        }
        ...
        public void CreateNewKey_Internal_WithEscrowAndEncryption()
        {
            ...
            mockKeyEscrow.Setup(o => o.Store(It.IsAny<Guid>(), It.IsAny<XElement>()))
        ...
        public void GetAllKeys_IgnoresUnknownElements()
        {
            ...
            mockActivator.ReturnDescriptorGivenDeserializerTypeNameAndInput(
                "deserializer-A",
                "<elementA />",
                descriptorA
            );
            ...
            Assert.Equal(
                XmlConvert.ToDateTimeOffset("2015-02-01T00:00:00Z"),
                keys[0].ActivationDate
            );
            Assert.Equal(
                XmlConvert.ToDateTimeOffset("2015-03-01T00:00:00Z"),
                keys[0].ExpirationDate
            );
            ...
            Assert.Equal(
                XmlConvert.ToDateTimeOffset("2015-05-01T00:00:00Z"),
                keys[1].ActivationDate
            );
            Assert.Equal(
                XmlConvert.ToDateTimeOffset("2015-06-01T00:00:00Z"),
                keys[1].ExpirationDate
            );
        ...
        public void GetAllKeys_WithKeyDeserializationError_LogLevelDebug_DoesNotWriteSensitiveInformation()
        {
            ...
            // Assert
            Assert.False(
                loggerFactory.ToString().Contains("1A2B3C4D"),
                "The secret '1A2B3C4D' should not have been logged."
            );
        }
        ...
        public void GetAllKeys_WithKeyDeserializationError_LogLevelTrace_WritesSensitiveInformation()
        {
            ...
            Assert.True(
                loggerFactory.ToString().Contains("1A2B3C4D"),
                "The secret '1A2B3C4D' should have been logged."
            );
        }
        ...
        public void GetAllKeys_SurfacesRevocationDeserializationErrors()
        {
            ...
            Assert.Throws<FormatException>(
                () => RunGetAllKeysCore(xml, new Mock<IActivator>().Object)
            );
        }

        private static IReadOnlyCollection<IKey> RunGetAllKeysCore(
            string xml,
        ...
        public void RevokeSingleKey_Internal()
        {
            ...
            XmlAssert.Equal(expectedRepositoryXml, elementStoredInRepository);
            Assert.Equal(
                "revocation-a11f35fc-1fed-4bd4-b727-056a63b70932",
                friendlyNameStoredInRepository
            );
        }
