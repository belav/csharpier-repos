...
namespace Microsoft.AspNetCore.DataProtection.Cng.Internal
{
    public unsafe class CngAuthenticatedEncryptorBaseTests
    {
        ...
        {
            // Arrange
            var ciphertext = new ArraySegment<byte>(
            ...
            encryptorMock.Setup(o => o.DecryptHook(It.IsAny<IntPtr>(), 2, It.IsAny<IntPtr>(), 4))
                .Returns(
                    (
                        IntPtr pbCiphertext,
                        uint cbCiphertext,
        ...
        public void Decrypt_HandlesEmptyAADPointerFixup()
        {
            ...
            var encryptorMock = new Mock<MockableEncryptor>();
            encryptorMock.Setup(o => o.DecryptHook(It.IsAny<IntPtr>(), 2, It.IsAny<IntPtr>(), 0))
                .Returns(
                    (
                        IntPtr pbCiphertext,
                        uint cbCiphertext,
        ...
        public void Decrypt_HandlesEmptyCiphertextPointerFixup()
        {
            ...
            var encryptorMock = new Mock<MockableEncryptor>();
            encryptorMock.Setup(o => o.DecryptHook(It.IsAny<IntPtr>(), 0, It.IsAny<IntPtr>(), 4))
                .Returns(
                    (
                        IntPtr pbCiphertext,
                        uint cbCiphertext,
        ...
        internal abstract class MockableEncryptor : CngAuthenticatedEncryptorBase
        {
            ...
            protected override sealed unsafe byte[] DecryptImpl(
                byte* pbCiphertext,
                uint cbCiphertext,
            ...
            protected override sealed unsafe byte[] EncryptImpl(
                byte* pbPlaintext,
                uint cbPlaintext,
                byte* pbAdditionalAuthenticatedData,
                uint cbAdditionalAuthenticatedData,
