...
public interface IAuthenticatedEncryptor
{
    ...
    /// <returns>The original plaintext data (if the authentication tag was validated and decryption
    // succeeded).</returns>
    /// <remarks>All cryptography-related exceptions should be homogenized to
    // CryptographicException.</remarks>
