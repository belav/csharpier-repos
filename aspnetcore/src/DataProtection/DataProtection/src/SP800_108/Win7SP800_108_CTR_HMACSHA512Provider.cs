...
{
    internal unsafe sealed class Win7SP800_108_CTR_HMACSHA512Provider
        : ISP800_108_CTR_HMACSHA512Provider
    {
        ...
        public void DeriveKey(
            ...
            fixed (byte* pbTempInputBuffer = tempInputBuffer)
            {
                ...
                byte* pbTempInputContext = &pbTempInputLabel[
                    cbLabel + 1 /* 0x00 */
                ];
