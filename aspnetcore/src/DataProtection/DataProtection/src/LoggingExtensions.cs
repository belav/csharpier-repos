...
namespace Microsoft.Extensions.Logging
{
    ...
    internal static class LoggingExtensions
    {
        private static Action<
            ...
            DateTimeOffset,
            Exception?
        > _usingFallbackKeyWithExpirationAsDefaultKey;
        ...
        private static Action<
            ...
            string,
            Exception?
        > _performingUnprotectOperationToKeyWithPurposes;
        ...
        private static Action<
            ...
            DateTimeOffset,
            Exception?
        > _foundRevocationOfAllKeysCreatedPriorTo;
        ...
        private static Action<
            ...
            string?,
            Exception?
        > _revokingAllKeysAsOfForReason;

        private static Action<
            ILogger,
            string,
            Exception?
        > _keyCacheExpirationTokenTriggeredByOperation;

        private static Action<
            ILogger,
            XElement,
            Exception
        > _anExceptionOccurredWhileProcessingTheKeyElement;
        ...
        private static Action<
            ...
            string,
            Exception?
        > _descriptorDeserializerTypeForKeyIs;
        ...
        private static Action<
            ...
            string,
            Exception?
        >? _readingDataFromRegistryKeyValue;
        ...
        private static Action<
            ...
            string,
            Exception?
        > _usingEphemeralFileSystemLocationInContainer;
        ...
        static LoggingExtensions()
        {
            ...
            _anErrorOccurredWhileEncryptingToX509CertificateWithThumbprint =
                LoggerMessage.Define<string>(
                    eventId: new EventId(
                        28,
                        "ErrorOccurredWhileEncryptingToX509CertificateWithThumbprint"
                    ),
                    logLevel: LogLevel.Error,
            ...
            _exceptionOccurredWhileTryingToResolveCertificateWithThumbprint =
                LoggerMessage.Define<string>(
                    eventId: new EventId(
                        30,
                        "ExceptionOccurredWhileTryingToResolveCertificateWithThumbprint"
                    ),
                    logLevel: LogLevel.Error,
            ...
            _noXMLEncryptorConfiguredKeyMayBePersistedToStorageInUnencryptedForm =
                LoggerMessage.Define<Guid>(
                    eventId: new EventId(
                        35,
                        "NoXMLEncryptorConfiguredKeyMayBePersistedToStorageInUnencryptedForm"
                    ),
                    logLevel: LogLevel.Warning,
            ...
            _policyResolutionStatesThatANewKeyShouldBeAddedToTheKeyRing = LoggerMessage.Define(
                eventId: new EventId(
                    57,
                    "PolicyResolutionStatesThatANewKeyShouldBeAddedToTheKeyRing"
                ),
                logLevel: LogLevel.Debug,
        ...
        public static void UsingFallbackKeyWithExpirationAsDefaultKey(
            this ILogger logger,
            Guid keyId,
        ...
        public static void OpeningCNGAlgorithmFromProviderWithHMAC(
            this ILogger logger,
        ...
        public static void OpeningCNGAlgorithmFromProviderWithChainingModeCBC(
            this ILogger logger,
        ...
        public static void PerformingUnprotectOperationToKeyWithPurposes(
            this ILogger logger,
        ...
        public static void OpeningCNGAlgorithmFromProviderWithChainingModeGCM(
            this ILogger logger,
            string encryptionAlgorithm,
            string? encryptionAlgorithmProvider
        ) {
        ...
        public static void KeyIsIneligibleToBeTheDefaultKeyBecauseItsMethodFailed(
            this ILogger logger,
            Guid keyId,
            string p0,
            Exception exception
        ...
        public static void ConsideringKeyWithExpirationDateAsDefaultKey(
            this ILogger logger,
            Guid keyId,
            DateTimeOffset expirationDate
        ) {
        ...
        public static void ExceptionWhileProcessingRevocationElement(
            this ILogger logger,
        ...
        public static void RevokingAllKeysAsOfForReason(
            this ILogger logger,
        ...
        public static void ExceptionWhileProcessingKeyElement(
            this ILogger logger,
            XElement keyElement,
            Exception exception
        ) {
        ...
        public static void AnExceptionOccurredWhileProcessingElementDebug(
            this ILogger logger,
            XElement keyElement,
            Exception exception
        ) {
        ...
        public static void AnErrorOccurredWhileEncryptingToX509CertificateWithThumbprint(
            this ILogger logger,
            string thumbprint,
            Exception exception
        ) {
        ...
        public static void ExceptionWhileTryingToResolveCertificateWithThumbprint(
            this ILogger logger,
            string thumbprint,
            Exception exception
        ) {
        ...
        public static void PerformingProtectOperationToKeyWithPurposes(
            this ILogger logger,
            Guid defaultKeyId,
            string p0
        ) {
        ...
        public static void DescriptorDeserializerTypeForKeyIs(
            this ILogger logger,
            Guid keyId,
        ...
        public static void RevokingKeyForReason(
            this ILogger logger,
            Guid keyId,
            DateTimeOffset revocationDate,
            string? reason
        ...
        public static void NameIsNotSafeFileName(
            this ILogger logger,
            string friendlyName,
        ...
        public static void ReadingDataFromRegistryKeyValue(
            this ILogger logger,
            RegistryKey regKey,
            string valueName
        ) {
        ...
        public static void NameIsNotSafeRegistryValueName(
            this ILogger logger,
            string friendlyName,
            string newFriendlyName
        ) {
        ...
        public static void CreatingKey(
            this ILogger logger,
            Guid keyId,
