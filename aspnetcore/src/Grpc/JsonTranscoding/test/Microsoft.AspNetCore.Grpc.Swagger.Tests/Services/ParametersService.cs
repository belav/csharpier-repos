...
public class ParametersService : Params.Parameters.ParametersBase
{
    ...
    public override Task<ParamResponse> DemoParametersTwo(
        RequestOne requestId,
        ServerCallContext ctx
    )
    {
    ...
    public override Task<ParamResponse> DemoParametersThree(
        RequestTwo request,
        ServerCallContext ctx
    )
    {
    ...
    public override Task<ParamResponse> DemoParametersFour(
        RequestTwo request,
        ServerCallContext ctx
    )
    {
