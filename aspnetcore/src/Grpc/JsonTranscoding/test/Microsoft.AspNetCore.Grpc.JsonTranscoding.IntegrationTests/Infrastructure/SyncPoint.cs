...
public class SyncPoint
{
    ...
    {
        var taskCreationOptions = runContinuationsAsynchronously
    ...
    public void CancelWaitForSyncPoint(CancellationToken cancellationToken) =>
        _atSyncPoint.TrySetCanceled(cancellationToken);
