...
public class JsonResultTests
{
    ...
    public void JsonResult_Implements_IContentTypeHttpResult_Correctly()
    {
        ...
        var result = Assert.IsAssignableFrom<IContentTypeHttpResult>(
            new JsonHttpResult<string>(null, StatusCodes.Status200OK, contentType, null)
        );
    ...
    public void JsonResult_Implements_IStatusCodeHttpResult_Correctly()
    {
        ...
        var result = Assert.IsAssignableFrom<IStatusCodeHttpResult>(
            new JsonHttpResult<string>(null, StatusCodes.Status202Accepted, contentType, null)
        );
    ...
    public void JsonResult_Implements_IStatusCodeHttpResult_Correctly_WithNullStatus()
    {
        ...
        // Act & Assert
        var result = Assert.IsAssignableFrom<IStatusCodeHttpResult>(
            new JsonHttpResult<string>(null, statusCode: null, contentType, null)
        );
    ...
    public void JsonResult_Implements_IValueHttpResult_Correctly()
    {
        ...
        var result = Assert.IsAssignableFrom<IValueHttpResult>(
            new JsonHttpResult<string>(value, statusCode: null, contentType, null)
        );
