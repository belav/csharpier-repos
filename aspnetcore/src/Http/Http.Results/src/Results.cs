...
{
    /// <summary>
    /// Creates an <see cref="IResult"/> that on execution invokes <see
    ...
    /// <summary>
    /// Creates a <see cref="IResult"/> that on execution invokes <see
    ...
    /// <summary>
    /// Creates a <see cref="IResult"/> that serializes the specified <paramref name="data"/> object to
    // JSON.
    /// </summary>
...
#pragma warning disable RS0026 // Do not add multiple public overloads with optional parameters
    ...
    [RequiresUnreferencedCode(JsonHttpResultTrimmerWarning.SerializationUnreferencedCodeMessage)]
    [RequiresDynamicCode(JsonHttpResultTrimmerWarning.SerializationRequiresDynamicCodeMessage)]
    public static IResult Json<TValue>(
        TValue? data,
        JsonSerializerOptions? options = null,
        string? contentType = null,
        int? statusCode = null
...
#pragma warning restore RS0026 // Do not add multiple public overloads with optional parameters
    ...
    /// <list type="bullet">
    /// <item>
    /// <description>When <paramref name="permanent"/> and <paramref name="preserveMethod"/> are set,
    // sets the <see cref="StatusCodes.Status308PermanentRedirect"/> status code.</description>
    /// </item>
    /// <item>
    /// <description>When <paramref name="preserveMethod"/> is set, sets the <see
    // cref="StatusCodes.Status307TemporaryRedirect"/> status code.</description>
    /// </item>
    /// <item>
    /// <description>When <paramref name="permanent"/> is set, sets the <see
    // cref="StatusCodes.Status301MovedPermanently"/> status code.</description>
    /// </item>
    /// <item>
    ...
    // redirect (308) preserve the initial request method.</param>
    /// <returns>The created <see cref="IResult"/> for the response.</returns>
    public static IResult LocalRedirect(
...
#pragma warning restore RS0026 // Do not add multiple public overloads with optional parameters
    ...
    /// <returns>The created <see cref="IResult"/> for the response.</returns>
    public static IResult NotFound(object? value = null) => NotFound<object>(value);
    ...
    /// </summary>
    /// <returns>The created <see cref="IResult"/> for the response.</returns>
    public static IResult Unauthorized() => TypedResults.Unauthorized();
    ...
    /// <returns>The created <see cref="IResult"/> for the response.</returns>
    public static IResult BadRequest(object? error = null) => BadRequest<object>(error);
    ...
    /// <param name="error">An error object to be included in the HTTP response body.</param>
    /// <returns>The created <see cref="IResult"/> for the response.</returns>
    public static IResult Conflict(object? error = null) => Conflict<object>(error);
    ...
    /// <param name="value">The value to be included in the HTTP response body.</param>
    /// <returns>The created <see cref="IResult"/> for the response.</returns>
    public static IResult Ok(object? value = null) => Ok<object>(value);
    ...
    {
        // TypedResults.ValidationProblem() does not allow setting the statusCode so we do this manually
        // here
    ...
    /// <param name="value">The value to be included in the HTTP response body.</param>
    /// <returns>The created <see cref="IResult"/> for the response.</returns>
    public static IResult Created(string? uri, object? value) => Created<object>(uri, value);
    ...
    /// <param name="value">The value to be included in the HTTP response body.</param>
    /// <returns>The created <see cref="IResult"/> for the response.</returns>
    public static IResult Created(Uri? uri, object? value) => Created<object>(uri, value);
...
#pragma warning restore RS0026 // Do not add multiple public overloads with optional parameters
    ...
    public static IResult CreatedAtRoute<TValue>(
        ...
        value is null
            ? TypedResults.CreatedAtRoute(routeName, routeValues)
            : TypedResults.CreatedAtRoute(value, routeName, routeValues);
...
#pragma warning restore RS0026 // Do not add multiple public overloads with optional parameters
    ...
    /// <returns>The created <see cref="IResult"/> for the response.</returns>
    [RequiresUnreferencedCode(RouteValueDictionaryTrimmerWarning.Warning)]
    public static IResult AcceptedAtRoute(
        string? routeName = null,
        object? routeValues = null,
        object? value = null
...
#pragma warning restore RS0026 // Do not add multiple public overloads with optional parameters
    ...
    /// <returns>The created <see cref="IResult"/> for the response.</returns>
    [RequiresUnreferencedCode(RouteValueDictionaryTrimmerWarning.Warning)]
    public static IResult AcceptedAtRoute<TValue>(
        string? routeName = null,
        object? routeValues = null,
        TValue? value = default
    ) =>
        value is null
            ? TypedResults.AcceptedAtRoute(routeName, routeValues)
            : TypedResults.AcceptedAtRoute(value, routeName, routeValues);
