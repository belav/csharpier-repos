...
{
    public static string ToMessageString(this EndpointParameter endpointParameter) =>
        endpointParameter.Source switch
        {
    ...
    public static bool IsSerializableJsonResponse(
        this EndpointResponse endpointResponse,
        [NotNullWhen(true)] out ITypeSymbol? responseTypeSymbol
    )
    {
    ...
    public static string EmitHandlerArgument(this EndpointParameter endpointParameter) =>
        $"{endpointParameter.SymbolName}_local";
