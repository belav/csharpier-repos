...
public class RequestDelegateFactoryTests : LoggedTest
{
    ...
    public static IEnumerable<object[]> CustomResults
    {
        get
        {
            ...
            static object StaticResultAsTaskObject() =>
                Task.FromResult<object>(new CustomResult("Still not enough tests!"));
            static object StaticResultAsValueTaskObject() =>
                ValueTask.FromResult<object>(new CustomResult("Still not enough tests!"));

            // Object return type where the object is Task<IResult>
            static object StaticResultAsTaskIResult() =>
                Task.FromResult<IResult>(new CustomResult("Still not enough tests!"));

            // Object return type where the object is ValueTask<IResult>
            static object StaticResultAsValueTaskIResult() =>
                ValueTask.FromResult<IResult>(new CustomResult("Still not enough tests!"));
    ...
    public static IEnumerable<object[]> StringResult
    {
        get
        {
            ...
            static object StaticValueTaskStringAsObjectTestAction() =>
                ValueTask.FromResult("String Test");
...
#nullable enable
    ...
    public void CreateThrowsNotSupportedExceptionIfFromFormParameterIsNotIFormFileCollectionOrIFormFile()
    {
        ...
        {
            var nse = Assert.Throws<NotSupportedException>(
                () => RequestDelegateFactory.Create(handler)
            );
            Assert.Equal(
    ...
    [InlineData(
        "Authorization",
        "bearer my-token",
        "Support for binding parameters from an HTTP request's form is not currently supported if the request contains an \"Authorization\" HTTP request header. Use of an HTTP request form is not currently secure for HTTP requests in scenarios which require authentication."
    )]
    [InlineData(
        "Cookie",
        ".AspNetCore.Auth=abc123",
        "Support for binding parameters from an HTTP request's form is not currently supported if the request contains a \"Cookie\" HTTP request header. Use of an HTTP request form is not currently secure for HTTP requests in scenarios which require authentication."
    )]
...
#pragma warning restore SYSLIB0026 // Type or member is obsolete
        ...
        Assert.Equal(
            "Support for binding parameters from an HTTP request's form is not currently supported if the request is associated with a client certificate. Use of an HTTP request form is not currently secure for HTTP requests in scenarios which require authentication.",
            badHttpRequestException.Message
        );
        Assert.Equal(400, badHttpRequestException.StatusCode);
    }
        ...
        var factoryResult = RequestDelegateFactory.Create(
            ...
            new RequestDelegateFactoryOptions()
            {
                ...
                >()
                {
                    ...
                    {
                        var acceptsMetadata =
                            routeHandlerContext.EndpointMetadata.OfType<IAcceptsMetadata>();
                        var contentType = acceptsMetadata
                            .SingleOrDefault()
    ...
    public void Create_AddsDelegateMethodInfo_AsFirstMetadata()
    {
        ...
        {
            InitialEndpointMetadata = new[] { customMetadata }
        };
    ...
    public void Create_AddsDelegateAttributes_AsLastMetadata()
    {
        ...
        var options = new RequestDelegateFactoryOptions
        {
            InitialEndpointMetadata = new[] { new CustomEndpointMetadata() }
        };
    ...
    public void Create_CombinesDefaultMetadata_AndMetadataFromReturnTypesImplementingIEndpointMetadataProvider()
    {
        ...
        Assert.Contains(
            result.EndpointMetadata,
            m => m is DefaultMetadataCountMetadata { Count: 2 }
        );
    }
    ...
    public void Create_CombinesAllMetadata_InCorrectOrder()
    {
        // Arrange
        var @delegate = [Attribute1, Attribute2]
        (AddsCustomParameterMetadata param1) => new CountsDefaultEndpointMetadataResult();
        var options = new RequestDelegateFactoryOptions
        {
            InitialEndpointMetadata = new List<object>
            {
    ...
    private class CountsDefaultEndpointMetadataResult : IEndpointMetadataProvider, IResult
    {
        public static void PopulateMetadata(EndpointMetadataContext context)
        {
            ...
            context.EndpointMetadata?.Add(
                new DefaultMetadataCountMetadata { Count = defaultMetadataCount ?? 0 }
            );
        }
            ...
            IEndpointMetadataProvider
    {
        ...
        {
            context.EndpointMetadata?.Add(
                new CustomEndpointMetadata { Source = MetadataSource.Property }
            );
        }
    }
