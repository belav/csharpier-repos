...
public class ContentDispositionHeaderValueTest
{
    ...
    > ValidContentDispositionTestCases = new TheoryData<string, ContentDispositionHeaderValue>()
    {
        ...
        { @"foobar", new ContentDispositionHeaderValue("foobar") }, //  @"This should be equivalent to using ""attachment""."
        {
            ...
            new ContentDispositionHeaderValue("attachment")
            {
                Parameters = { new NameValueHeaderValue("example", @"""filename=example.txt""") },
            }
        },
        {
            ...
            new ContentDispositionHeaderValue("attachment")
            {
                Parameters = { new NameValueHeaderValue("filename*", "iso-8859-1''foo-%E4.html") },
            }
    ...
    public void FileNameWithSurrogatePairs_EncodedCorrectly()
    {
        ...
        Assert.Equal(
            "UTF-8\'\'File%20%F0%9F%A4%A9%20name.txt",
            contentDisposition.Parameters[1].Value
        );
    }
