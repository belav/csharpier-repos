...
public interface IProblemDetailsService
{
    ...
    /// </summary>
    /// <param name="context">The <see cref="ProblemDetailsContext"/> associated with the current
    ...
    /// <list type="bullet">
    /// <item><description>One of them reports that the response was written successfully,
    // or.</description></item>
    /// <item><description>All <see cref="IProblemDetailsWriter"/> were executed and none of them was
    // able to write the response successfully.</description></item>
    /// </list>
    /// </remarks>
    /// <exception cref="InvalidOperationException">If no <see cref="IProblemDetailsWriter"/> can write
    // to the given context.</exception>
