...
/// <summary>
/// A machine-readable format for specifying errors in HTTP API responses based on <see
...
public class ProblemDetails
{
    ...
    /// (e.g., using HTML [W3C.REC-html5-20141028]). When this member is not present, its value is
    // assumed to be
    /// "about:blank".
    /// </summary>
    ...
    // Extension members appear in the same namespace as
    /// other members of a problem type.
    /// </para>
    /// </summary>
    /// <remarks>
    /// The round-tripping behavior for <see cref="Extensions"/> is determined by the implementation of
    // the Input \ Output formatters.
    /// In particular, complex types or collection types may not round-trip to the original type when
