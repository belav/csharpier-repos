...
public class BindingAddressTests
{
    ...
    [InlineData(
        "http://www.example.com:NOTAPORT",
        "http",
        "www.example.com:NOTAPORT",
        80,
        "",
        "http://www.example.com:notaport:80"
    )]
    [InlineData(
        ...
        443,
        "",
        "https://www.example.com:notaport:443"
    )]
    [InlineData(
        "http://www.example.com:NOTAPORT/",
        "http",
    ...
    [InlineData(
        "http://foo:/tmp/kestrel-test.sock:5000/doesn't/matter",
        "http",
        "foo:",
        80,
        "/tmp/kestrel-test.sock:5000/doesn't/matter",
        "http://foo::80/tmp/kestrel-test.sock:5000/doesn't/matter"
    )]
    [InlineData(
        "http://unix:foo/tmp/kestrel-test.sock",
        "http",
        "unix:foo",
        80,
        "/tmp/kestrel-test.sock",
        "http://unix:foo:80/tmp/kestrel-test.sock"
    )]
    [InlineData(
        "http://unix:5000/tmp/kestrel-test.sock",
        "http",
        "unix",
        5000,
        "/tmp/kestrel-test.sock",
    ...
    [InlineData(
        "https://unix:/tmp/kestrel-test.sock",
        "https",
        "unix:/tmp/kestrel-test.sock",
        0,
        "",
    ...
    [InlineData(
        "http://unix:/tmp/kestrel-test.sock:5000/doesn't/matter",
        "http",
        "unix:/tmp/kestrel-test.sock",
        0,
        "5000/doesn't/matter",
    ...
    public void UnixSocketUrlsAreParsedCorrectlyOnUnix(
        string url,
        string scheme,
        string host,
        int port,
    ...
    [InlineData(
        "http://unix:/c:/foo/bar/pipe.socket:5000/doesn't/matter",
        "http",
        "unix:/c:/foo/bar/pipe.socket",
        0,
        "5000/doesn't/matter",
    ...
    public void UnixSocketUrlsAreParsedCorrectlyOnWindows(
        string url,
        string scheme,
        string host,
        int port,
