...
internal struct MutableFormOptionsMetadata(IFormOptionsMetadata formOptionsMetadata)
    : IFormOptionsMetadata
{
    internal FormOptions ResolveFormOptions(FormOptions baseFormOptions) =>
        new FormOptions
        {
            ...
            MultipartHeadersCountLimit =
                MultipartHeadersCountLimit ?? baseFormOptions.MultipartHeadersCountLimit,
