...
public static class LinkGeneratorEndpointNameAddressExtensions
{
    ...
    /// <param name="values">The route values. Used to expand parameters in the route template.
    // Optional.</param>
    /// <param name="pathBase">
    ...
    /// See the remarks section for details about the security implications of the <paramref
    // name="host"/>.
    /// </param>
    /// <param name="pathBase">
    /// An optional URI path base. Prepended to the path in the resulting URI. If not provided, the
