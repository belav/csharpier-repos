...
namespace Microsoft.AspNetCore.Routing.Tree
{
    public class LinkGenerationDecisionTreeTest
    {
        ...
        public void SelectMultipleEntries_BothMatch_NonOverlappingCriteria()
        {
            ...
            var context = CreateContext(
                new { controller = "Store", action = "Buy", slug = "1234" }
            );
        ...
        public void GetMatches_ControllersWithArea_AllValuesExplicit()
        {
            ...
            var entry1 = CreateMatch(
                new { controller = "Store", action = "Buy", area = (string)null, }
            );
            entry1.Entry.RouteTemplate = TemplateParser.Parse("a");
            entries.Add(entry1);
            ...
            var context = CreateContext(
                new { controller = "Store", action = "Buy", area = "Admin" }
            );
        ...
        public void GetMatches_LinkToControllerFromPage_WithArea()
        {
            ...
            var entry1 = CreateMatch(
                new { controller = "Home", action = "Index", area = "Admin", page = (string)null, }
            );
            entry1.Entry.RouteTemplate = TemplateParser.Parse("a");
            entries.Add(entry1);
        ...
        public void GetMatches_LinkToControllerFromPage_WithPageValue()
        {
            ...
            var context = CreateContext(
                new { controller = "Home", action = "Index", page = "16", },
                new { page = "/Store/Buy", }
            );
        ...
        public void GetMatches_LinkToControllerFromPage_WithPageValueAmbiguous()
        {
            ...
            var context = CreateContext(
                new { controller = "Home", action = "Index", page = "/Store/Buy", },
                new { page = "/Store/Buy", }
            );
        ...
        public void ToDebuggerDisplayString_GivesAFlattenedTree()
        {
            ...
            entries.Add(
                CreateMatch(
                    new { action = "Buy", controller = "Store", version = "V1" },
                    "Store/Buy/V1"
                )
            );
            entries.Add(
                CreateMatch(
                    new { action = "Buy", controller = "Store", area = "Admin" },
                    "Admin/Store/Buy"
                )
            );
            entries.Add(
                CreateMatch(new { action = "Buy", controller = "Products" }, "Products/Buy")
            );
            entries.Add(
                CreateMatch(
                    new { action = "Buy", controller = "Store", version = "V2" },
                    "Store/Buy/V2"
                )
            );
            entries.Add(CreateMatch(new { action = "Cart", controller = "Store" }, "Store/Cart"));
            entries.Add(
                CreateMatch(new { action = "Index", controller = "Home" }, "Home/Index/{id?}")
            );
            var tree = new LinkGenerationDecisionTree(entries);
            ...
            var expected =
                ...
                + newLine
                + " => action: Index => controller: Home (Matches: Home/Index/{id?})"
                + newLine;
