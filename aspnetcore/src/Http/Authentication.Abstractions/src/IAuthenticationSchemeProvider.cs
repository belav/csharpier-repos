...
public interface IAuthenticationSchemeProvider
{
    ...
    /// <summary>
    /// Returns the scheme that will be used by default for <see
    // cref="IAuthenticationService.AuthenticateAsync(HttpContext, string)"/>.
    ...
    /// </summary>
    /// <returns>The scheme that will be used by default for <see
    // cref="IAuthenticationService.AuthenticateAsync(HttpContext, string)"/>.</returns>
    Task<AuthenticationScheme?> GetDefaultAuthenticateSchemeAsync();

    /// <summary>
    /// Returns the scheme that will be used by default for <see
    // cref="IAuthenticationService.ChallengeAsync(HttpContext, string, AuthenticationProperties)"/>.
    /// This is typically specified via <see cref="AuthenticationOptions.DefaultChallengeScheme"/>.
    /// Otherwise, this will fallback to <see cref="AuthenticationOptions.DefaultScheme"/>.
    /// </summary>
    /// <returns>The scheme that will be used by default for <see
    // cref="IAuthenticationService.ChallengeAsync(HttpContext, string,
    // AuthenticationProperties)"/>.</returns>
    Task<AuthenticationScheme?> GetDefaultChallengeSchemeAsync();

    /// <summary>
    /// Returns the scheme that will be used by default for <see
    // cref="IAuthenticationService.ForbidAsync(HttpContext, string, AuthenticationProperties)"/>.
    ...
    /// </summary>
    /// <returns>The scheme that will be used by default for <see
    // cref="IAuthenticationService.ForbidAsync(HttpContext, string,
    // AuthenticationProperties)"/>.</returns>
    Task<AuthenticationScheme?> GetDefaultForbidSchemeAsync();

    /// <summary>
    /// Returns the scheme that will be used by default for <see
    // cref="IAuthenticationService.SignInAsync(HttpContext, string,
    ...
    /// <returns>The scheme that will be used by default for <see
    // cref="IAuthenticationService.SignInAsync(HttpContext, string,
    // System.Security.Claims.ClaimsPrincipal, AuthenticationProperties)"/>.</returns>
    Task<AuthenticationScheme?> GetDefaultSignInSchemeAsync();

    /// <summary>
    /// Returns the scheme that will be used by default for <see
    // cref="IAuthenticationService.SignOutAsync(HttpContext, string, AuthenticationProperties)"/>.
    ...
    /// </summary>
    /// <returns>The scheme that will be used by default for <see
    // cref="IAuthenticationService.SignOutAsync(HttpContext, string,
    // AuthenticationProperties)"/>.</returns>
