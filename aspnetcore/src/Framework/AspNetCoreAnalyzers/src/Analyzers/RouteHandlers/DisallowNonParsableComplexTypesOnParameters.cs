...
public partial class RouteHandlerAnalyzer : DiagnosticAnalyzer
{
    ...
    )
    {
        ...
        static bool IsRouteParameter(
            RouteUsageModel routeUsage,
            IParameterSymbol handlerDelegateParameter
        )
        {
            ...
            var resolvedParameter = routeUsage.UsageContext.ResolvedParameters.FirstOrDefault(
                rp => rp.Symbol.Name == handlerDelegateParameter.Name
            );
        ...
        )
        {
            ...
            if (
                parameter.HasAttributeImplementingInterface(fromMetadataInterfaceTypeSymbol)
