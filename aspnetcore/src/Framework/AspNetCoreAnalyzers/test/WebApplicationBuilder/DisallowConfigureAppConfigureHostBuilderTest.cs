...
partial public class DisallowConfigureAppConfigureHostBuilderTest
{
    [Fact]
...
";
        ...
        var expectedDiagnostic = new DiagnosticResult(
            ...
            .WithArguments("ConfigureAppConfiguration")
            .WithLocation(0);
...
";
        ...
        var expectedDiagnostic = new DiagnosticResult(
            ...
            .WithArguments("ConfigureHostConfiguration")
            .WithLocation(0);
...
";
        ...
        {
            new DiagnosticResult(DiagnosticDescriptors.DisallowConfigureAppConfigureHostBuilder)
                .WithArguments("ConfigureHostConfiguration")
                .WithLocation(0),
            new DiagnosticResult(DiagnosticDescriptors.DisallowConfigureAppConfigureHostBuilder)
                .WithArguments("ConfigureAppConfiguration")
