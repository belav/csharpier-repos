...
public static class TestData
{
    ...
    static TestData()
    {
        ...
        if (!RuntimeInformation.IsOSPlatform(OSPlatform.Windows) && !SkipOnHelixAttribute.OnHelix()) // Helix tests always run against the Windows assets (even on non-Windows)
        {
    ...
    public static bool VerifyPackageAssemblyVersions() =>
        string.Equals(
            GetTestDataValue("VerifyPackageAssemblyVersions"),
            "true",
            StringComparison.OrdinalIgnoreCase
        );
