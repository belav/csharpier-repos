...
namespace Microsoft.AspNetCore
{
    public class TargetingPackTests
    {
        ...
        public void PackageOverridesContainsCorrectEntries()
        {
            ...
            var packageOverridePath = Path.Combine(
                _targetingPackRoot,
                "data",
        ...
        public void PlatformManifestListsAllFiles()
        {
            ...
            var platformManifestPath = Path.Combine(
                _targetingPackRoot,
                "data",
            ...
            _output.WriteLine(
                string.Join(
                    ...
                    frameworkListEntries
                        .Select(i => i.Attribute("AssemblyName").Value)
                        .OrderBy(i => i)
                )
            );
            _output.WriteLine("==== expected assemblies ====");
        ...
        public void FrameworkListListsContainsCorrectPaths()
        {
            ...
            var expectedPaths = frameworkListEntries
                .Select(i => i.Attribute("Path").Value)
                .ToHashSet();
