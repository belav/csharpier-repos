                ...
                try
                {
                    ...
                    using (incposdbEntities entity = new incposdbEntities())
                    {
                        ...
                        var invListm = invListmtmp.Where(X => DateTime.Compare(
                           ...
                           , (DateTime)calc.changeDateformat(datenow, "yyyy-MM-dd")) == 0).ToList();
            ...
            else
            {
                ...
                try
                {
                    ...
                    using (incposdbEntities entity = new incposdbEntities())
                    {
                       ...
                       , (DateTime)calc.changeDateformat(datenow, "yyyy-MM")) == 0).ToList();
        ...
        public string GetMainNotification(string token)
        {
            ...
            else
            {
                ...
                // try
                {
                    ...
                    IEnumerable<CashTransferModel> cashesQuery = cc.GetCashTransferForPosById(posId, cashTransferType, cashSide);
